...
class UpdateRouteRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * configtype  操作类型。add_ip为增加集群路由，del_ip为删除集群路由。
    * configkey  路由ip地址，公网源数据所在的服务器ip。不能以0开头。
    * configvalue  路由子网掩码。如果上面ip取的是16位，子网掩码可以填255.255.0.0，24位的话子网掩码填255.255.255.0
    *
    * @var string[]
    */
    ...
    * Sets configtype
    *
    * @param string $configtype 操作类型。add_ip为增加集群路由，del_ip为删除集群路由。
    *
    * @return $this
    */
    ...
    * Sets configkey
    *
    * @param string $configkey 路由ip地址，公网源数据所在的服务器ip。不能以0开头。
    *
    * @return $this
    */
    ...
    * Sets configvalue
    *
    * @param string $configvalue 路由子网掩码。如果上面ip取的是16位，子网掩码可以填255.255.0.0，24位的话子网掩码填255.255.255.0
    *
    * @return $this
    */
