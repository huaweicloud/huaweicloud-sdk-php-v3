...
class ShowDataStoreFlavorDetailResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDataStoreFlavorDetailResponse';
    ...
    *  **参数解释**： 引擎版本。 **取值范围**： 不涉及
    *
    * @return \HuaweiCloud\SDK\Css\V1\Model\FlavorRespVersionBody[]|null
    */
    ...
    * Sets versions
    *
    * @param \HuaweiCloud\SDK\Css\V1\Model\FlavorRespVersionBody[]|null $versions **参数解释**： 引擎版本。 **取值范围**： 不涉及
    *
    * @return $this
    */
