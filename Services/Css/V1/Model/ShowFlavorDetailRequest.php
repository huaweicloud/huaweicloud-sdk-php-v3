...
class ShowFlavorDetailRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowFlavorDetailRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * flavorId  参数解释： 规格id。 约束限制： 不涉及 取值范围： 实例规格列表接口返回的id。 默认取值： 不涉及
    *
    * @var string[]
    */
    ...
    * Sets flavorId
    *
    * @param string $flavorId 参数解释： 规格id。 约束限制： 不涉及 取值范围： 实例规格列表接口返回的id。 默认取值： 不涉及
    *
    * @return $this
    */
