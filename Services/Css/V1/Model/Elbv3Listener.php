...
class Elbv3Listener implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'Elbv3Listener';
    ...
    */
    protected static $openAPITypes = [
            ...
            'protocol' => 'string',
            'protocolPort' => 'int',
            'ipgroup' => '\HuaweiCloud\SDK\Css\V1\Model\ListenerIpGroup'
    ];
    ...
    * Sets protocolPort
    *
    * @param int|null $protocolPort 监听器的前端监听端口。
    *
    * @return $this
    */
    ...
    *  ipgroup
    *
    * @return \HuaweiCloud\SDK\Css\V1\Model\ListenerIpGroup|null
    */
    ...
    * Sets ipgroup
    *
    * @param \HuaweiCloud\SDK\Css\V1\Model\ListenerIpGroup|null $ipgroup ipgroup
    *
    * @return $this
    */
