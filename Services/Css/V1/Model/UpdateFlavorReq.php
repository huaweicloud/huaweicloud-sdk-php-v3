...
class UpdateFlavorReq implements ModelInterface, ArrayAccess
{
    ...
    * needCheckClusterStatus  **参数解释**： 集群变更规格是否需要检查集群状态。
    * clusterLoadCheck  **参数解释**： 集群变更规格是否需要检查集群负载。
    *
    * @var string[]
    */
    ...
    */
    protected static $attributeMap = [
            ...
            'isAutoPay' => 'isAutoPay',
            'needCheckClusterStatus' => 'needCheckClusterStatus',
            'clusterLoadCheck' => 'clusterLoadCheck'
    ];
    ...
    * Sets operationType
    *
    * @param string|null $operationType **参数解释**： 变更规格的操作类型。
    *
    * @return $this
    */
    ...
    *
    * @param bool|null $needCheckClusterStatus **参数解释**： 集群变更规格是否需要检查集群状态。
    *
    * @return $this
    */
    ...
    *
    * @param bool|null $clusterLoadCheck **参数解释**： 集群变更规格是否需要检查集群负载。
    *
    * @return $this
    */
