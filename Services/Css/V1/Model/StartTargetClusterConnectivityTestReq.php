...
class StartTargetClusterConnectivityTestReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StartTargetClusterConnectivityTestReq';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * targetClusterId  目标集群ID
    *
    * @var string[]
    */
