...
class CssAsyncClient extends Client
{
     ...
     * @return response
     */
    public function rollingRestartAsync($request)
    {
        return $this->rollingRestartAsyncWithHttpInfo($request);
    }
     ...
     * @return response
     */
    public function startAutoCreateSnapshotsAsync($request)
    {
        return $this->startAutoCreateSnapshotsAsyncWithHttpInfo($request);
    }
    
    public function startAutoCreateSnapshotsAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function stopAutoCreateSnapshotsAsync($request)
    {
        return $this->stopAutoCreateSnapshotsAsyncWithHttpInfo($request);
    }
    
    public function stopAutoCreateSnapshotsAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function deleteLogstashConfAsync($request)
    {
        return $this->deleteLogstashConfAsyncWithHttpInfo($request);
    }
    
    public function deleteLogstashConfAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function deleteLogstashTemplateAsync($request)
    {
        return $this->deleteLogstashTemplateAsyncWithHttpInfo($request);
    }
    
    public function deleteLogstashTemplateAsyncWithHttpInfo($request){
        $collection_formats = [];
