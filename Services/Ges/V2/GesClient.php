...
class GesClient extends Client
{
     ...
     * @return response
     */
    public function exportBackup2($request)
    {
        return $this->exportBackup2WithHttpInfo($request);
    }

    public function exportBackup2WithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function importBackup2($request)
    {
        return $this->importBackup2WithHttpInfo($request);
    }

    public function importBackup2WithHttpInfo($request)
    {
