...
class DeleteVolumeInRecycleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteVolumeInRecycleRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * volumeId  **参数解释** 云硬盘ID。 可通过[查询所有云硬盘详情](evs_04_2006.xml)获取云硬盘ID。 **约束限制** 不涉及。 **取值范围** 不涉及。 **默认取值** 不涉及。
    *
    * @var string[]
    */
