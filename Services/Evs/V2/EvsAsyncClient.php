...
class EvsAsyncClient extends Client
{
    ...
    {
        $client = new ClientBuilder(new EvsAsyncClient());
        return $client;
    }
     ...
     * @return response
     */
    public function batchResizeVolumesAsync($request)
    {
        return $this->batchResizeVolumesAsyncWithHttpInfo($request);
    }
    
    public function batchResizeVolumesAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v5/{project_id}/volumes/batch-extend';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Evs\V2\Model\BatchResizeVolumesResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Evs\V2\Model\BatchResizeVolumesRequest',
            $asyncRequest = true);
    }
     ...
     * @return response
     */
    public function changeVolumeChargeModeAsync($request)
    {
        return $this->changeVolumeChargeModeAsyncWithHttpInfo($request);
    }
    
    public function changeVolumeChargeModeAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function deleteVolumeInRecycleAsync($request)
    {
        return $this->deleteVolumeInRecycleAsyncWithHttpInfo($request);
    }
    
    public function deleteVolumeInRecycleAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function listVolumesInRecycleAsync($request)
    {
        return $this->listVolumesInRecycleAsyncWithHttpInfo($request);
    }
    
    public function listVolumesInRecycleAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function revertVolumeInRecycleAsync($request)
    {
        return $this->revertVolumeInRecycleAsyncWithHttpInfo($request);
    }
    
    public function revertVolumeInRecycleAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function showVolumeInRecycleAsync($request)
    {
        return $this->showVolumeInRecycleAsyncWithHttpInfo($request);
    }
    
    public function showVolumeInRecycleAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v3/{project_id}/recycle-bin-volumes/{volume_id}';
        $formParams = [];
        $queryParams = [];
     ...
     * @return response
     */
    public function updateRecyclePolicyAsync($request)
    {
        return $this->updateRecyclePolicyAsyncWithHttpInfo($request);
    }
    
    public function updateRecyclePolicyAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v3/{project_id}/recycle-bin-volumes/policy';
        $formParams = [];
        $queryParams = [];
