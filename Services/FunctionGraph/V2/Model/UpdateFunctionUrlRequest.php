...
class UpdateFunctionUrlRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateFunctionUrlRequest';
    ...
    */
    protected static $openAPITypes = [
            'functionUrn' => 'string',
            'body' => '\HuaweiCloud\SDK\FunctionGraph\V2\Model\FunctionUrlRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\FunctionGraph\V2\Model\FunctionUrlRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\FunctionGraph\V2\Model\FunctionUrlRequestBody|null $body body
    *
    * @return $this
    */
