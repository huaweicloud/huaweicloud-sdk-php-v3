...
class EventInfoDetailResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'EventInfoDetailResp';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['detail'] === null) {
            ...
            if (!is_null($this->container['eventId']) && (mb_strlen($this->container['eventId']) > 9999)) {
