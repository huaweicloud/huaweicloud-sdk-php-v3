...
class UpdateAlarmActionRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAlarmActionRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * alarmEnabled  **参数解释**： 告警是否启用 **约束限制**： 不涉及 **取值范围**： - true：开启告警 - false：关闭告警 **默认取值**： 不涉及
    *
    * @var string[]
    */
    ...
    * Sets alarmEnabled
    *
    * @param bool $alarmEnabled **参数解释**： 告警是否启用 **约束限制**： 不涉及 **取值范围**： - true：开启告警 - false：关闭告警 **默认取值**： 不涉及
    *
    * @return $this
    */
