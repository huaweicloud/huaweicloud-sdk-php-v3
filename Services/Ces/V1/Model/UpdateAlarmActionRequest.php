...
class UpdateAlarmActionRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'alarmId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ces\V1\Model\UpdateAlarmActionRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ces\V1\Model\UpdateAlarmActionRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ces\V1\Model\UpdateAlarmActionRequestBody|null $body body
    *
    * @return $this
    */
