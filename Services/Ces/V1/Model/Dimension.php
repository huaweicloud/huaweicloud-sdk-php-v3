...
class Dimension implements ModelInterface, ArrayAccess
{
    ...
    * value  **参数解释**： 监控维度取值，例如ECS的ID。 **约束限制**： 不涉及。 **取值范围**： 长度为[0,256]个字符。 **默认取值**： 不涉及。
    *
    * @var string[]
    */
    ...
    */
    ...
    /**
    * Gets value
    *  **参数解释**： 监控维度取值，例如ECS的ID。 **约束限制**： 不涉及。 **取值范围**： 长度为[0,256]个字符。 **默认取值**： 不涉及。
    *
    * @return string|null
    */
    ...
    * Sets value
    *
    * @param string|null $value **参数解释**： 监控维度取值，例如ECS的ID。 **约束限制**： 不涉及。 **取值范围**： 长度为[0,256]个字符。 **默认取值**： 不涉及。
    *
    * @return $this
    */
