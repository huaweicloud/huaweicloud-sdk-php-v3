...
class CreateEventsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateEventsRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * eventName  **参数解释**： 事件名称。 **约束限制**： 不涉及。 **取值范围**： 必须以字母开头，只能包含0-9/a-z/A-Z/_，长度为[1,64]个字符。 **默认取值**： 不涉及。
    * eventSource  **参数解释**： 事件来源。 **约束限制**： 不涉及。 **取值范围**： 格式为service.item，根据实际情况自定义配置。 service和item必须是字符串，必须以字母开头，只能包含0-9/a-z/A-Z/_，service.item，长度为[3,32]个字符。 **默认取值**： 不涉及。
    * time  **参数解释**： 事件发生时间。UNIX时间戳，单位毫秒。 **约束限制**： 因为客户端到服务器端有延时，因此插入数据的时间戳应该在[当前时间-1小时+10秒，当前时间+10分钟-10秒]区间内，保证到达服务器时不会因为传输时延造成数据不能插入数据库。 **取值范围**： 插入数据的时间戳应该在[当前时间-1小时+10秒，当前时间+10分钟-10秒]区间内。 **默认取值**： 不涉及。
    * detail  detail
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['eventSource'] === null) {
            ...
            if ((mb_strlen($this->container['eventSource']) < 0)) {
                $invalidProperties[] = "invalid value for 'eventSource', the character length must be bigger than or equal to 0.";
            }
            if (!preg_match("/^((([a-z]|[A-Z]){1}([a-z]|[A-Z]|[0-9]|_)*\\.([a-z]|[A-Z]){1}([a-z]|[A-Z]|[0-9]|_)*)|)$/", $this->container['eventSource'])) {
                $invalidProperties[] = "invalid value for 'eventSource', must be conform to the pattern /^((([a-z]|[A-Z]){1}([a-z]|[A-Z]|[0-9]|_)*\\.([a-z]|[A-Z]){1}([a-z]|[A-Z]|[0-9]|_)*)|)$/.";
            }
    ...
    * Sets eventName
    *
    * @param string $eventName **参数解释**： 事件名称。 **约束限制**： 不涉及。 **取值范围**： 必须以字母开头，只能包含0-9/a-z/A-Z/_，长度为[1,64]个字符。 **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets eventSource
    *
    * @param string $eventSource **参数解释**： 事件来源。 **约束限制**： 不涉及。 **取值范围**： 格式为service.item，根据实际情况自定义配置。 service和item必须是字符串，必须以字母开头，只能包含0-9/a-z/A-Z/_，service.item，长度为[3,32]个字符。 **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets time
    *
    * @param int $time **参数解释**： 事件发生时间。UNIX时间戳，单位毫秒。 **约束限制**： 因为客户端到服务器端有延时，因此插入数据的时间戳应该在[当前时间-1小时+10秒，当前时间+10分钟-10秒]区间内，保证到达服务器时不会因为传输时延造成数据不能插入数据库。 **取值范围**： 插入数据的时间戳应该在[当前时间-1小时+10秒，当前时间+10分钟-10秒]区间内。 **默认取值**： 不涉及。
    *
    * @return $this
    */
