...
class DimensionResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DimensionResp';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  **参数解释**： 监控维度名称，如ECS的维度为instance_id。各服务资源的指标维度名称可查看：“[服务维度名称](ces_03_0059.xml)”。 **取值范围**： 以字母开头，只能包含字母、数字、“_”、“-”。长度[1,32]个字符。
    * value  **参数解释**： 监控维度取值，例如ECS的ID。 **取值范围**： 长度为[0,256]个字符。
    *
    * @var string[]
    */
    ...
    * Sets name
    *
    * @param string|null $name **参数解释**： 监控维度名称，如ECS的维度为instance_id。各服务资源的指标维度名称可查看：“[服务维度名称](ces_03_0059.xml)”。 **取值范围**： 以字母开头，只能包含字母、数字、“_”、“-”。长度[1,32]个字符。
    *
    * @return $this
    */
    ...
    * Sets value
    *
    * @param string|null $value **参数解释**： 监控维度取值，例如ECS的ID。 **取值范围**： 长度为[0,256]个字符。
    *
    * @return $this
    */
