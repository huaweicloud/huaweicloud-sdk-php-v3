...
class ListPolicyResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListPolicyResp';
    ...
    * type  **参数解释**： 告警策略类型，已废弃，不推荐使用。 **约束限制**： 不涉及。 **取值范围**： 长度为[0,32]个字符。          **默认取值**： 不涉及。
    ...
    * namespace  **参数解释**： 各服务命名空间，请参考“[服务命名空间](ces_03_0059.xml)”。 **取值范围**： 格式为service.item；service和item必须是字符串，必须以字母开头，只能包含0-9/a-z/A-Z/_。长度为[0,32]个字符。
    * dimensionName  **参数解释**： 指标维度名称，各服务资源的指标维度名称可查看：“[服务维度名称](ces_03_0059.xml)”。 **取值范围**： 必须以字母开头，多维度用\",\"分隔，只能包含0-9/a-z/A-Z/_/-，每个维度的最大长度为32。目前最大支持4个维度。举例：单维度场景：instance_id；多维度场景：instance_id,disk
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'period' => '\HuaweiCloud\SDK\Ces\V2\Model\PeriodResp',
            'filter' => 'string',
            ...
            'type' => 'string',
            'count' => 'int',
            'suppressDuration' => '\HuaweiCloud\SDK\Ces\V2\Model\SuppressDurationResp',
            'level' => 'int',
            'namespace' => 'string',
    ...
    *  period
    *
    * @return \HuaweiCloud\SDK\Ces\V2\Model\PeriodResp|null
    */
    ...
    * Sets period
    *
    * @param \HuaweiCloud\SDK\Ces\V2\Model\PeriodResp|null $period period
    *
    * @return $this
    */
    ...
    * Sets type
    *
    * @param string|null $type **参数解释**： 告警策略类型，已废弃，不推荐使用。 **约束限制**： 不涉及。 **取值范围**： 长度为[0,32]个字符。          **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    *  suppressDuration
    *
    * @return \HuaweiCloud\SDK\Ces\V2\Model\SuppressDurationResp|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Ces\V2\Model\SuppressDurationResp|null $suppressDuration suppressDuration
    *
    * @return $this
    */
    ...
    * Sets namespace
    *
    * @param string|null $namespace **参数解释**： 各服务命名空间，请参考“[服务命名空间](ces_03_0059.xml)”。 **取值范围**： 格式为service.item；service和item必须是字符串，必须以字母开头，只能包含0-9/a-z/A-Z/_。长度为[0,32]个字符。
    *
    * @return $this
    */
    ...
    * Sets dimensionName
    *
    * @param string|null $dimensionName **参数解释**： 指标维度名称，各服务资源的指标维度名称可查看：“[服务维度名称](ces_03_0059.xml)”。 **取值范围**： 必须以字母开头，多维度用\",\"分隔，只能包含0-9/a-z/A-Z/_/-，每个维度的最大长度为32。目前最大支持4个维度。举例：单维度场景：instance_id；多维度场景：instance_id,disk
    *
    * @return $this
    */
