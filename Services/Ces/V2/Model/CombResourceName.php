...
class CombResourceName implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CombResourceName';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * resourceName  **参数解释** 资源名称条件值 **约束限制** 不涉及 **取值范围** 长度[1,128]个字符 **默认取值** 不涉及
    * operator  **参数解释** 实例操作符，含义是真实资源的名称与资源名称条件值的运算关系。 **约束限制** 不涉及 **取值范围** - include: 表示包含 - prefix: 表示前缀 - suffix: 表示后缀 - notInclude: 表示不包含 - equal: 表示相等 **默认取值** 不涉及
    ...
    * Sets resourceName
    *
    * @param string|null $resourceName **参数解释** 资源名称条件值 **约束限制** 不涉及 **取值范围** 长度[1,128]个字符 **默认取值** 不涉及
    *
    * @return $this
    */
    ...
    * Sets operator
    *
    * @param string $operator **参数解释** 实例操作符，含义是真实资源的名称与资源名称条件值的运算关系。 **约束限制** 不涉及 **取值范围** - include: 表示包含 - prefix: 表示前缀 - suffix: 表示后缀 - notInclude: 表示不包含 - equal: 表示相等 **默认取值** 不涉及
    *
    * @return $this
    */
