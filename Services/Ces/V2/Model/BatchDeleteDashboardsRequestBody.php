...
class BatchDeleteDashboardsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteDashboardsRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * dashboardIds  **参数解释** 监控看板id列表 **约束限制** 包含的监控看板id对象个数为[1,50]
    *
    * @var string[]
    */
    ...
    * Sets dashboardIds
    *
    * @param string[]|null $dashboardIds **参数解释** 监控看板id列表 **约束限制** 包含的监控看板id对象个数为[1,50]
    *
    * @return $this
    */
