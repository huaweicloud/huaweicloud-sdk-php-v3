...
class EpResourceStatistics implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'EpResourceStatistics';
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['extendRelationId']) && (mb_strlen($this->container['extendRelationId']) > 64)) {
                $invalidProperties[] = "invalid value for 'extendRelationId', the character length must be smaller than or equal to 64.";
            }
