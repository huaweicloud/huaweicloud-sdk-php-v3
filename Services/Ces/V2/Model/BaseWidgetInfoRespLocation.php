...
class BaseWidgetInfoRespLocation implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BaseWidgetInfoResp_location';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * top  **参数解释** 监控视图的上坐标              **取值范围** 最小值为0，最大值为2147483647
    * left  **参数解释** 监控视图的左坐标              **取值范围** 最小值为0，最大值为9
    * width  **参数解释** 监控视图图表宽度               **取值范围** 最小值为3，最大值为12
    * height  **参数解释** 监控视图图表高度             **取值范围** 最小值为3，最大值为2147483647
    *
    * @var string[]
    */
    ...
    * Sets top
    *
    * @param int $top **参数解释** 监控视图的上坐标              **取值范围** 最小值为0，最大值为2147483647
    *
    * @return $this
    */
    ...
    * Sets left
    *
    * @param int $left **参数解释** 监控视图的左坐标              **取值范围** 最小值为0，最大值为9
    *
    * @return $this
    */
    ...
    * Sets width
    *
    * @param int $width **参数解释** 监控视图图表宽度               **取值范围** 最小值为3，最大值为12
    *
    * @return $this
    */
    ...
    * Sets height
    *
    * @param int $height **参数解释** 监控视图图表高度             **取值范围** 最小值为3，最大值为2147483647
    *
    * @return $this
    */
