...
class ExtraInfo implements ModelInterface, ArrayAccess
{
    ...
    * originMetricName  **参数解释** 指标名称 **约束限制** 不涉及 **取值范围** 长度为[1,4096]个字符 **默认取值** 不涉及
    * metricPrefix  **参数解释** 指标名称前缀 **约束限制** 不涉及           **取值范围** 长度为[1,4096]个字符 **默认取值** 不涉及
    * metricType  **参数解释** 指标类型 **约束限制** 不涉及           **取值范围** 长度为[1,32]个字符 **默认取值** 不涉及
    * customProcName  **参数解释** 自定义进程名称 **约束限制** 不涉及           **取值范围** 长度为[1,250]个字符 **默认取值** 不涉及
    *
    * @var string[]
    */
    ...
    *
    * @param string $originMetricName **参数解释** 指标名称 **约束限制** 不涉及 **取值范围** 长度为[1,4096]个字符 **默认取值** 不涉及
    *
    * @return $this
    */
    ...
    * Sets metricPrefix
    *
    * @param string|null $metricPrefix **参数解释** 指标名称前缀 **约束限制** 不涉及           **取值范围** 长度为[1,4096]个字符 **默认取值** 不涉及
    *
    * @return $this
    */
    ...
    * Sets metricType
    *
    * @param string|null $metricType **参数解释** 指标类型 **约束限制** 不涉及           **取值范围** 长度为[1,32]个字符 **默认取值** 不涉及
    *
    * @return $this
    */
    ...
    * Sets customProcName
    *
    * @param string|null $customProcName **参数解释** 自定义进程名称 **约束限制** 不涉及           **取值范围** 长度为[1,250]个字符 **默认取值** 不涉及
    *
    * @return $this
    */
