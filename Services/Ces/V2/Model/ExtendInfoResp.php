...
class ExtendInfoResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExtendInfoResp';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * filter  **参数解释** 表示指标聚合方式 **取值范围** 枚举值： - average 平均值 - min 最小值 - max 最大值 - sum 求和值
    * period  **参数解释** 表示指标聚合周期 **取值范围** - 1 原始值 - 60 一分钟 - 300 5分钟 - 1200 20分钟 - 3600 1小时 - 14400 4小时 - 86400 1天
    * displayTime  **参数解释** 展示时间 **取值范围** 枚举值： - 0 自定义时间 - 5 5分钟 - 15 15分钟 - 30 30分钟 - 60 1小时 - 120 2小时 - 180 3小时 - 720 12小时 - 1440 24小时 - 10080 7天 - 43200 30天
    * refreshTime  **参数解释** 刷新时间 **取值范围** 枚举值： - 0 不刷新 - 10 10秒 - 60 1分钟 - 300 5分钟 - 1200 20分钟
    * from  **参数解释** 开始时间 **取值范围** 时间戳取值为[0,9999999999999]
    * to  **参数解释** 结束时间 **取值范围** 时间戳取值为[0,9999999999999]
    * screenColor  **参数解释** 监控大屏背景颜色 **取值范围** 背景颜色长度最长为100个字符
    * enableScreenAutoPlay  **参数解释** 监控大屏是否自动切换 **取值范围** - true 是 - false 否
    * timeInterval  **参数解释**  监控大屏自动切换时间间隔  **取值范围**  枚举值：  - 10000 10秒  - 30000 30秒  - 60000 1分钟
    * enableLegend  **参数解释** 是否开启图例 **取值范围** - true 是 - false 否
    * fullScreenWidgetNum  **参数解释** 大屏展示视图数量 **取值范围** 视图数量为[0,65535]
    *
    * @var string[]
    */
    ...
    * Sets filter
    *
    * @param string|null $filter **参数解释** 表示指标聚合方式 **取值范围** 枚举值： - average 平均值 - min 最小值 - max 最大值 - sum 求和值
    *
    * @return $this
    */
    ...
    * Sets period
    *
    * @param string|null $period **参数解释** 表示指标聚合周期 **取值范围** - 1 原始值 - 60 一分钟 - 300 5分钟 - 1200 20分钟 - 3600 1小时 - 14400 4小时 - 86400 1天
    *
    * @return $this
    */
    ...
    * Sets displayTime
    *
    * @param int|null $displayTime **参数解释** 展示时间 **取值范围** 枚举值： - 0 自定义时间 - 5 5分钟 - 15 15分钟 - 30 30分钟 - 60 1小时 - 120 2小时 - 180 3小时 - 720 12小时 - 1440 24小时 - 10080 7天 - 43200 30天
    *
    * @return $this
    */
    ...
    * Sets refreshTime
    *
    * @param int|null $refreshTime **参数解释** 刷新时间 **取值范围** 枚举值： - 0 不刷新 - 10 10秒 - 60 1分钟 - 300 5分钟 - 1200 20分钟
    *
    * @return $this
    */
    ...
    * Sets from
    *
    * @param int|null $from **参数解释** 开始时间 **取值范围** 时间戳取值为[0,9999999999999]
    *
    * @return $this
    */
    ...
    * Sets to
    *
    * @param int|null $to **参数解释** 结束时间 **取值范围** 时间戳取值为[0,9999999999999]
    *
    * @return $this
    */
    ...
    * Sets screenColor
    *
    * @param string|null $screenColor **参数解释** 监控大屏背景颜色 **取值范围** 背景颜色长度最长为100个字符
    *
    * @return $this
    */
    ...
    *
    * @param bool|null $enableScreenAutoPlay **参数解释** 监控大屏是否自动切换 **取值范围** - true 是 - false 否
    *
    * @return $this
    */
    ...
    * Sets timeInterval
    *
    * @param int|null $timeInterval **参数解释**  监控大屏自动切换时间间隔  **取值范围**  枚举值：  - 10000 10秒  - 30000 30秒  - 60000 1分钟
    *
    * @return $this
    */
    ...
    * Sets enableLegend
    *
    * @param bool|null $enableLegend **参数解释** 是否开启图例 **取值范围** - true 是 - false 否
    *
    * @return $this
    */
    ...
    *
    * @param int|null $fullScreenWidgetNum **参数解释** 大屏展示视图数量 **取值范围** 视图数量为[0,65535]
    *
    * @return $this
    */
