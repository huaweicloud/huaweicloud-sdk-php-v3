...
class ProductResource implements ModelInterface, ArrayAccess
{
    ...
    * productName  资源所属的云产品，一般由\"服务命名空间,服务首层维度名称\"组成，如\"SYS.ECS,instance_id\"
    * namespace  查询服务的命名空间，各服务命名空间请参考“[服务命名空间](ces_03_0059.xml)”
    * productInstances  产品实例详情
    *
    * @var string[]
    */
    ...
    * Sets productName
    *
    * @param string $productName 资源所属的云产品，一般由\"服务命名空间,服务首层维度名称\"组成，如\"SYS.ECS,instance_id\"
    *
    * @return $this
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Ces\V2\Model\ProductInstance[] $productInstances 产品实例详情
    *
    * @return $this
    */
