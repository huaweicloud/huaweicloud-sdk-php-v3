...
class UpdateAlarmRulePoliciesReqBodyV2 implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAlarmRulePoliciesReqBodyV2';
    ...
    */
    protected static $openAPITypes = [
            'policies' => '\HuaweiCloud\SDK\Ces\V2\Model\UpdatePolicyReq[]'
    ];
