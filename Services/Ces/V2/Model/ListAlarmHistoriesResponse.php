...
class ListAlarmHistoriesResponse implements ModelInterface, ArrayAccess
{
    ...
    * alarmHistories  **参数解释**： 告警记录列表。
    * count  **参数解释**： 告警记录总数。 **取值范围**： [0,2147483647]
    *
    * @var string[]
    */
    ...
    * Sets alarmHistories
    *
    * @param \HuaweiCloud\SDK\Ces\V2\Model\AlarmHistoryItemV2[]|null $alarmHistories **参数解释**： 告警记录列表。
    *
    * @return $this
    */
    ...
    * Sets count
    *
    * @param int|null $count **参数解释**： 告警记录总数。 **取值范围**： [0,2147483647]
    *
    * @return $this
    */
