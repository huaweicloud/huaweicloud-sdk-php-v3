...
class GetResourceGroupRespResourceStatistics implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GetResourceGroupResp_resource_statistics';
