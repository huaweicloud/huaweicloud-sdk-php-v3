...
class ThresholdInfoResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ThresholdInfoResp';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * threshold  **参数解释** 监控视图辅助线的阈值 **取值范围** 最小值为0，最大值为2147483647
    * thresholdColor  **参数解释** 监控视图辅助线的颜色        **取值范围** - \"#B50E65\":紫色 - \"#F23030\":红色 - \"#FF8800\":橙色 - \"#F2E70C\":黄色
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['threshold']) && ($this->container['threshold'] > 2147483647)) {
    ...
    * Sets threshold
    *
    * @param float|null $threshold **参数解释** 监控视图辅助线的阈值 **取值范围** 最小值为0，最大值为2147483647
    *
    * @return $this
    */
    ...
    * Sets thresholdColor
    *
    * @param string|null $thresholdColor **参数解释** 监控视图辅助线的颜色        **取值范围** - \"#B50E65\":紫色 - \"#F23030\":红色 - \"#FF8800\":橙色 - \"#F2E70C\":黄色
    *
    * @return $this
    */
