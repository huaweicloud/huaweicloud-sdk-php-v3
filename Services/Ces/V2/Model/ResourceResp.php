...
class ResourceResp implements ModelInterface, ArrayAccess
{
    ...
    * dimensions  **参数解释** 资源的维度信息
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'namespace' => 'string',
            'dimensions' => '\HuaweiCloud\SDK\Ces\V2\Model\ResourceDimensionResp[]'
    ];
    ...
    * Sets namespace
    *
    * @param string $namespace **参数解释** 查询服务的命名空间，各服务命名空间请参考“[服务命名空间](ces_03_0059.xml)” **取值范围** 格式为service.item；service和item必须是字符串，必须以字母开头，只能包含0-9/a-z/A-Z/_。字符串的长度必须在 3 到 32个字符之间。
    *
    * @return $this
    */
    ...
    *  **参数解释** 资源的维度信息
    *
    * @return \HuaweiCloud\SDK\Ces\V2\Model\ResourceDimensionResp[]
    */
    ...
    * Sets dimensions
    *
    * @param \HuaweiCloud\SDK\Ces\V2\Model\ResourceDimensionResp[] $dimensions **参数解释** 资源的维度信息
    *
    * @return $this
    */
