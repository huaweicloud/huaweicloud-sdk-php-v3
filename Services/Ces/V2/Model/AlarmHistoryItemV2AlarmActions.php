...
class AlarmHistoryItemV2AlarmActions implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AlarmHistoryItemV2_alarm_actions';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * type  **参数解释**： 通知类型。 **取值范围**： 枚举值。notification为SMN通知，contact为云账号联系人，contactGroup为通知组。autoscaling为AS通知，只在AS中使用，不推荐客户使用。groupwatch、ecsRecovery及iecAction，已废弃，不推荐使用。
    ...
    * Sets type
    *
    * @param string|null $type **参数解释**： 通知类型。 **取值范围**： 枚举值。notification为SMN通知，contact为云账号联系人，contactGroup为通知组。autoscaling为AS通知，只在AS中使用，不推荐客户使用。groupwatch、ecsRecovery及iecAction，已废弃，不推荐使用。
    *
    * @return $this
    */
