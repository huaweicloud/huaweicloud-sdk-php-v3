...
class WidgetMetric implements ModelInterface, ArrayAccess
{
    ...
    * alias  **参数解释** 监控视图的指标别名列表 **约束限制** 当资源类型为指定资源时才允许传该参数 包含的指标别名对象个数为[0,200]
    * extraInfo  extraInfo
    * yAxisPosition  **参数解释** 阈值线所在的Y轴位置 **约束限制** 不涉及                **取值范围** 枚举值： - left 左Y轴 - right 右Y轴 **默认取值** 不涉及
    ...
    * Sets alias
    *
    * @param string[]|null $alias **参数解释** 监控视图的指标别名列表 **约束限制** 当资源类型为指定资源时才允许传该参数 包含的指标别名对象个数为[0,200]
    *
    * @return $this
    */
    ...
    * Sets yAxisPosition
    *
    * @param string|null $yAxisPosition **参数解释** 阈值线所在的Y轴位置 **约束限制** 不涉及                **取值范围** 枚举值： - left 左Y轴 - right 右Y轴 **默认取值** 不涉及
    *
    * @return $this
    */
