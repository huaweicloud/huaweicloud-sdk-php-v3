...
class AlarmHistoryItemV2Metric implements ModelInterface, ArrayAccess
{
    ...
    * namespace  **参数解释**： 查询服务的命名空间，各服务命名空间请参考“[服务命名空间](ces_03_0059.xml)”。 **取值范围**： 格式为service.item；service和item必须是字符串，必须以字母开头，只能包含0-9/a-z/A-Z/_。字符串的长度在 0 到 32个字符之间。
    ...
    * Sets namespace
    *
    * @param string|null $namespace **参数解释**： 查询服务的命名空间，各服务命名空间请参考“[服务命名空间](ces_03_0059.xml)”。 **取值范围**： 格式为service.item；service和item必须是字符串，必须以字母开头，只能包含0-9/a-z/A-Z/_。字符串的长度在 0 到 32个字符之间。
    *
    * @return $this
    */
    ...
    * Sets dimensions
    *
    * @param \HuaweiCloud\SDK\Ces\V2\Model\AlarmHistoryItemV2MetricDimensions[]|null $dimensions **参数解释**： 资源列表。 **取值范围**： 不涉及。
    *
    * @return $this
    */
