...
class AlarmHistoryItemV2Metric implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AlarmHistoryItemV2_metric';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * namespace  **参数解释**： 查询服务的命名空间，各服务命名空间请参考“[服务命名空间](ces_03_0059.xml)”。 **取值范围**： 字符串长度在 3 到 32 之间。
    * metricName  **参数解释**： 资源的监控指标名称。如：弹性云服务器中的监控指标cpu_util，表示弹性服务器的CPU使用率；文档数据库中的指标mongo001_command_ps，表示command执行频率；各服务的指标名称可查看：“[服务指标名称](ces_03_0059.xml)”。 **取值范围**： 字符串长度在 1 到 64 之间。
    * dimensions  **参数解释**： 指标维度。 **取值范围**： 不涉及。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'namespace' => 'string',
            'metricName' => 'string',
            'dimensions' => '\HuaweiCloud\SDK\Ces\V2\Model\AlarmHistoryItemV2MetricDimensions[]'
    ];
    ...
    * Sets namespace
    *
    * @param string|null $namespace **参数解释**： 查询服务的命名空间，各服务命名空间请参考“[服务命名空间](ces_03_0059.xml)”。 **取值范围**： 字符串长度在 3 到 32 之间。
    *
    * @return $this
    */
    ...
    * Sets metricName
    *
    * @param string|null $metricName **参数解释**： 资源的监控指标名称。如：弹性云服务器中的监控指标cpu_util，表示弹性服务器的CPU使用率；文档数据库中的指标mongo001_command_ps，表示command执行频率；各服务的指标名称可查看：“[服务指标名称](ces_03_0059.xml)”。 **取值范围**： 字符串长度在 1 到 64 之间。
    *
    * @return $this
    */
    ...
    *  **参数解释**： 指标维度。 **取值范围**： 不涉及。
    *
    * @return \HuaweiCloud\SDK\Ces\V2\Model\AlarmHistoryItemV2MetricDimensions[]|null
    */
    ...
    * Sets dimensions
    *
    * @param \HuaweiCloud\SDK\Ces\V2\Model\AlarmHistoryItemV2MetricDimensions[]|null $dimensions **参数解释**： 指标维度。 **取值范围**： 不涉及。
    *
    * @return $this
    */
