...
class BatchUpdateOneClickAlarmsEnabledStateRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchUpdateOneClickAlarmsEnabledStateRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * alarmIds  需要批量启停的告警规则的ID列表
    * alarmEnabled  **参数解释**： 是否开启告警规则。     **约束限制**： 不涉及。 **取值范围**： 布尔值。 - true:开启。 - false:关闭。 **默认取值**： true
    * retainWhenAllDisabled  一键告警中的规则全部被停用时是否保留规则信息。true:保留；false:删除。
    *
    * @var string[]
    */
    ...
    *
    * @param bool|null $retainWhenAllDisabled 一键告警中的规则全部被停用时是否保留规则信息。true:保留；false:删除。
    *
    * @return $this
    */
