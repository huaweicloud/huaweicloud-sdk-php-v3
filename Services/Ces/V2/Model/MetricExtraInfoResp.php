...
class MetricExtraInfoResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MetricExtraInfoResp';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * originMetricName  **参数解释**： 原始指标名称。 **取值范围**： 长度为[0,4096]个字符。
    * metricPrefix  **参数解释**： 指标名称前缀。 **取值范围**： 长度为[0,4096]个字符。
    * customProcName  **参数解释**： 用户进程名称。 **取值范围**： 长度为[0,250]个字符。
    * metricType  **参数解释**： 指标类型。 **取值范围**： 长度为[0,32]个字符。
    *
    * @var string[]
    */
    ...
    *
    * @param string|null $originMetricName **参数解释**： 原始指标名称。 **取值范围**： 长度为[0,4096]个字符。
    *
    * @return $this
    */
    ...
    * Sets metricPrefix
    *
    * @param string|null $metricPrefix **参数解释**： 指标名称前缀。 **取值范围**： 长度为[0,4096]个字符。
    *
    * @return $this
    */
    ...
    * Sets customProcName
    *
    * @param string|null $customProcName **参数解释**： 用户进程名称。 **取值范围**： 长度为[0,250]个字符。
    *
    * @return $this
    */
    ...
    * Sets metricType
    *
    * @param string|null $metricType **参数解释**： 指标类型。 **取值范围**： 长度为[0,32]个字符。
    *
    * @return $this
    */
