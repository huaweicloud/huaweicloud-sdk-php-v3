...
class BaseWidgetInfoProperties implements ModelInterface, ArrayAccess
{
    ...
    * legendValues  当前时序数据需要在图例中展示的统计值名称列表，表格不支持该参数；条形图和柱状图仅支持配置当前值
    ...
    * Sets topN
    *
    * @param int|null $topN Top前N个；折线图时为随机展示的时序数据条数
    *
    * @return $this
    */
    ...
    * Sets legendValues
    *
    * @param string[]|null $legendValues 当前时序数据需要在图例中展示的统计值名称列表，表格不支持该参数；条形图和柱状图仅支持配置当前值
    *
    * @return $this
    */
