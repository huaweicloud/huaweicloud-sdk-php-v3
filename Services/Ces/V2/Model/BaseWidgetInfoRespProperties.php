...
class BaseWidgetInfoRespProperties implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BaseWidgetInfoResp_properties';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * filter  **参数解释** 聚合类型 **取值范围** 目前只有TopN这一种类型，折线图不支持该参数
    * topN  **参数解释** Top前N个；折线图时为随机展示的时序数据条数 **取值范围** 最小值为1，最大值为2147483647
    * order  **参数解释** 排序字段 **取值范围** - asc:正序 - desc:倒序
    * description  **参数解释** 监控视图的描述信息 **取值范围** 长度为[0,200]个字符
    ...
    * legendLocation  **参数解释** 图例位置标记 **取值范围** - hide:表示隐藏图例 - right:表示图例放在监控视图右侧 - bottom:表示图例放在监控视图底部
    * legendValues  **参数解释** 当前时序数据需要在图例中展示的统计值名称列表
    * thresholds  **参数解释** 监控视图的阈值辅助线配置
    * isAllCompareEnable  **参数解释** 同比环比总开关是否生效 **取值范围** - true:生效 - false:不生效
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'legendValues' => 'string[]',
            'thresholds' => '\HuaweiCloud\SDK\Ces\V2\Model\ThresholdInfoResp[]',
    ...
    * Sets filter
    *
    * @param string|null $filter **参数解释** 聚合类型 **取值范围** 目前只有TopN这一种类型，折线图不支持该参数
    *
    * @return $this
    */
    ...
    * Sets topN
    *
    * @param int|null $topN **参数解释** Top前N个；折线图时为随机展示的时序数据条数 **取值范围** 最小值为1，最大值为2147483647
    *
    * @return $this
    */
    ...
    * Sets description
    *
    * @param string|null $description **参数解释** 监控视图的描述信息 **取值范围** 长度为[0,200]个字符
    *
    * @return $this
    */
    ...
    * Sets legendLocation
    *
    * @param string|null $legendLocation **参数解释** 图例位置标记 **取值范围** - hide:表示隐藏图例 - right:表示图例放在监控视图右侧 - bottom:表示图例放在监控视图底部
    *
    * @return $this
    */
    ...
    * Sets legendValues
    *
    * @param string[]|null $legendValues **参数解释** 当前时序数据需要在图例中展示的统计值名称列表
    *
    * @return $this
    */
    ...
    *  **参数解释** 监控视图的阈值辅助线配置
    *
    * @return \HuaweiCloud\SDK\Ces\V2\Model\ThresholdInfoResp[]|null
    */
    ...
    * Sets thresholds
    *
    * @param \HuaweiCloud\SDK\Ces\V2\Model\ThresholdInfoResp[]|null $thresholds **参数解释** 监控视图的阈值辅助线配置
    *
    * @return $this
    */
    ...
    *
    * @param bool|null $isAllCompareEnable **参数解释** 同比环比总开关是否生效 **取值范围** - true:生效 - false:不生效
    *
    * @return $this
    */
