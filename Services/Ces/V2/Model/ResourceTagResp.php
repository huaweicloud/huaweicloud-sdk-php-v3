...
class ResourceTagResp implements ModelInterface, ArrayAccess
{
    ...
    * key  **参数解释**： 标签名。 **取值范围**： 长度[1,128]个unicode字符。
    * value  **参数解释**： 标签值。 **取值范围**： 长度为[0,255]个unicode字符。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['key']) && !preg_match("/^((?!\\s)(?!_sys_)[\\p{L}\\p{Z}\\p{N}_.:=+\\-@]*)(?<!\\s)$/", $this->container['key'])) {
    ...
    * Sets key
    *
    * @param string|null $key **参数解释**： 标签名。 **取值范围**： 长度[1,128]个unicode字符。
    *
    * @return $this
    */
    ...
    * Sets value
    *
    * @param string|null $value **参数解释**： 标签值。 **取值范围**： 长度为[0,255]个unicode字符。
    *
    * @return $this
    */
