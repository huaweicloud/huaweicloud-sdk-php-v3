...
class AddResourcesReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddResourcesReq';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * resources  手动创建，选择资源层级为子维度时的资源信息。每次修改资源时只需要传递新增的资源
    * productResources  手动创建，选择资源层级为云产品时的资源详情。每次修改资源时需要将已有资源和新增的资源一起传递
    *
    * @var string[]
    */
    ...
    * Sets resources
    *
    * @param \HuaweiCloud\SDK\Ces\V2\Model\Resource[]|null $resources 手动创建，选择资源层级为子维度时的资源信息。每次修改资源时只需要传递新增的资源
    *
    * @return $this
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Ces\V2\Model\ProductResource[]|null $productResources 手动创建，选择资源层级为云产品时的资源详情。每次修改资源时需要将已有资源和新增的资源一起传递
    *
    * @return $this
    */
