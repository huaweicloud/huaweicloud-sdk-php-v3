...
class ProductMetricResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ProductMetricResp';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * dimensionName  **参数解释**： 按云产品维度屏蔽时的资源维度信息。    **取值范围**： 长度为[0,128]个字符，有多个时用\",\"连接。
    ...
    * Sets dimensionName
    *
    * @param string $dimensionName **参数解释**： 按云产品维度屏蔽时的资源维度信息。    **取值范围**： 长度为[0,128]个字符，有多个时用\",\"连接。
    *
    * @return $this
    */
