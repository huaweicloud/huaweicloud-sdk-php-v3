...
class ResourceCategoryResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResourceCategoryResp';
    ...
    * Sets dimensionNames
    *
    * @param string[] $dimensionNames **参数解释**： 资源的维度信息列表
    *
    * @return $this
    */
