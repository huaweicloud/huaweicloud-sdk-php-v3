...
class DimensionInfo implements ModelInterface, ArrayAccess
{
    ...
    * filterType  **参数解释**： 资源类型。 **约束限制** 1、view参数取值为柱状图 条形图 环形柱状图 表格时，filter_type参数不支持指定资源类型 2、rollup_enable参数为空时，filter_type参数不支持资源分组类型 **取值范围**： - all_instances: 全部资源 - specific_instances: 指定资源 - resource_groups：资源分组 **默认取值** 不涉及
    ...
    */
    ...
    const FILTER_TYPE_RESOURCE_GROUPS = 'resource_groups';
    ...
    */
    public function getFilterTypeAllowableValues()
    {
        return [
            ...
            self::FILTER_TYPE_RESOURCE_GROUPS,
        ];
    }
    ...
    * Sets filterType
    *
    * @param string $filterType **参数解释**： 资源类型。 **约束限制** 1、view参数取值为柱状图 条形图 环形柱状图 表格时，filter_type参数不支持指定资源类型 2、rollup_enable参数为空时，filter_type参数不支持资源分组类型 **取值范围**： - all_instances: 全部资源 - specific_instances: 指定资源 - resource_groups：资源分组 **默认取值** 不涉及
    *
    * @return $this
    */
