...
class ListAlarmRespBodyAlarms implements ModelInterface, ArrayAccess
{
    ...
    * alarmId  **参数解释**： 告警规则id。如 al16558829757444BVVxr999 **取值范围**： 以al开头，后跟22个数字或字母。长度为24个字符。
    ...
    * Sets alarmId
    *
    * @param string|null $alarmId **参数解释**： 告警规则id。如 al16558829757444BVVxr999 **取值范围**： 以al开头，后跟22个数字或字母。长度为24个字符。
    *
    * @return $this
    */
