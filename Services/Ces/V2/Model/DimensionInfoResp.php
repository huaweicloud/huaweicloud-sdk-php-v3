...
class DimensionInfoResp implements ModelInterface, ArrayAccess
{
    ...
    * filterType  **参数解释**： 资源类型。 **取值范围**： - all_instances: 全部资源 - specific_instances: 指定资源 - resource_groups:资源分组
    * values  **参数解释**： 维度值列表。
    *
    * @var string[]
    */
    ...
    * Sets filterType
    *
    * @param string|null $filterType **参数解释**： 资源类型。 **取值范围**： - all_instances: 全部资源 - specific_instances: 指定资源 - resource_groups:资源分组
    *
    * @return $this
    */
    ...
    * Sets values
    *
    * @param string[]|null $values **参数解释**： 维度值列表。
    *
    * @return $this
    */
