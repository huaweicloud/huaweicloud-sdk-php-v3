...
class UpdateResourceGroupAssociationAlarmTemplateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateResourceGroupAssociationAlarmTemplateRequest';
    ...
    */
    protected static $openAPITypes = [
            'groupId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ces\V2\Model\AsyncAssociateRGAndTemplatesReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ces\V2\Model\AsyncAssociateRGAndTemplatesReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ces\V2\Model\AsyncAssociateRGAndTemplatesReq|null $body body
    *
    * @return $this
    */
