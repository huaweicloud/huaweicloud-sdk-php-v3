...
class TagResp implements ModelInterface, ArrayAccess
{
    ...
    * key  **参数解释**： 标签名。 **取值范围**： 最大长度128个unicode字符。
    * values  **参数解释**： 标签值。 **取值范围**： 每个值最大长度255个unicode字符。如果values为空列表，则表示查询任意value
    *
    * @var string[]
    */
    ...
    * Sets key
    *
    * @param string|null $key **参数解释**： 标签名。 **取值范围**： 最大长度128个unicode字符。
    *
    * @return $this
    */
    ...
    * Sets values
    *
    * @param string[]|null $values **参数解释**： 标签值。 **取值范围**： 每个值最大长度255个unicode字符。如果values为空列表，则表示查询任意value
    *
    * @return $this
    */
