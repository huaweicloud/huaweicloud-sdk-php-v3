...
class ListKeyPolicyResponseBodyKeyspacePolicies implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListKeyPolicyResponseBody_keyspace_policies';
    ...
    */
    protected static $openAPITypes = [
            ...
            'policyName' => 'string',
            'keyspaceId' => 'string',
            'policy' => '\HuaweiCloud\SDK\Kms\V2\Model\ListKeyPolicyResponseBodyPolicy',
            'description' => 'string',
            'createdBy' => 'string',
            'createTime' => 'string',
    ...
    * Sets policyId
    *
    * @param string $policyId **参数解释：** 密钥策略ID **取值范围：** 不涉及
    *
    * @return $this
    */
    ...
    * Sets policyName
    *
    * @param string $policyName **参数解释：** 密钥策略名称 **取值范围：** 不涉及
    *
    * @return $this
    */
    ...
    *  policy
    *
    * @return \HuaweiCloud\SDK\Kms\V2\Model\ListKeyPolicyResponseBodyPolicy
    */
    ...
    * Sets policy
    *
    * @param \HuaweiCloud\SDK\Kms\V2\Model\ListKeyPolicyResponseBodyPolicy $policy policy
    *
    * @return $this
    */
    ...
    * Sets createdBy
    *
    * @param string $createdBy **参数解释：** 密钥策略创建人 **取值范围：** 不涉及
    *
    * @return $this
    */
    ...
    * Sets createTime
    *
    * @param string $createTime **参数解释：** 密钥策略创建时间 **取值范围：** 不涉及
    *
    * @return $this
    */
    ...
    * Sets lastModifyTime
    *
    * @param string $lastModifyTime **参数解释：** 密钥策略最近修改时间 **取值范围：** 不涉及
    *
    * @return $this
    */
    ...
    * Sets lastAccessTime
    *
    * @param string $lastAccessTime **参数解释：** 密钥策略最近访问时间 **取值范围：** 不涉及
    *
    * @return $this
    */
