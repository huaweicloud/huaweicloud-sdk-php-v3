...
class RotateOnDemandRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RotateOnDemandRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * keyId  **参数解释：** 密钥ID **约束限制：** - 36字节ID - 满足正则匹配“^[0-9a-z]{8}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{12}$” **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @var string[]
    */
    ...
    * Sets keyId
    *
    * @param string $keyId **参数解释：** 密钥ID **约束限制：** - 36字节ID - 满足正则匹配“^[0-9a-z]{8}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{12}$” **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @return $this
    */
