...
class ReplicateKeyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ReplicateKeyRequest';
    ...
    */
    protected static $openAPITypes = [
            'keyId' => 'string',
            'body' => '\HuaweiCloud\SDK\Kms\V2\Model\ReplicateKeyRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Kms\V2\Model\ReplicateKeyRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Kms\V2\Model\ReplicateKeyRequestBody|null $body body
    *
    * @return $this
    */
