...
class UpdatePrimaryRegionResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['primaryRegion']) && (mb_strlen($this->container['primaryRegion']) > 255)) {
                $invalidProperties[] = "invalid value for 'primaryRegion', the character length must be smaller than or equal to 255.";
            }
            if (!is_null($this->container['primaryRegion']) && (mb_strlen($this->container['primaryRegion']) < 1)) {
    ...
    * Sets keyId
    *
    * @param string|null $keyId 密钥ID，36字节，满足正则匹配“^[0-9a-z]{8}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{12}$”。 例如：0d0466b0-e727-4d9c-b35d-f84bb474a37f。
    *
    * @return $this
    */
    ...
    * Sets primaryRegion
    *
    * @param string|null $primaryRegion 密钥所在主区域编码。如cn-north-4。
    *
    * @return $this
    */
