...
class UpdatePrimaryRegionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePrimaryRegionRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * keyId  待更新的密钥ID，36字节，满足正则匹配“^[0-9a-z]{8}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{12}$”。 例如：0d0466b0-e727-4d9c-b35d-f84bb474a37f。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'keyId' => 'string',
            'body' => '\HuaweiCloud\SDK\Kms\V2\Model\UpdatePrimaryRegionRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Kms\V2\Model\UpdatePrimaryRegionRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Kms\V2\Model\UpdatePrimaryRegionRequestBody|null $body body
    *
    * @return $this
    */
