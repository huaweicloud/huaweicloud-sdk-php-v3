...
class ListAccessPointResponseBodyPageInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAccessPointResponseBody_page_info';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * nextMarker  **参数解释：** 下一页的marker **取值范围：** 不涉及
    * currentCount  **参数解释：** 本页数量 **取值范围：** 不涉及
    *
    * @var string[]
    */
    ...
    * Sets nextMarker
    *
    * @param string $nextMarker **参数解释：** 下一页的marker **取值范围：** 不涉及
    *
    * @return $this
    */
    ...
    * Sets currentCount
    *
    * @param int $currentCount **参数解释：** 本页数量 **取值范围：** 不涉及
    *
    * @return $this
    */
