...
class CreateDatakeyCapsuleResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateDatakeyCapsuleResponse';
    ...
    * datakeyCapsule  **参数解释：** 密钥胶囊 **取值范围：** 不涉及
    *
    * @var string[]
    */
    ...
    * Sets datakeyCapsule
    *
    * @param string|null $datakeyCapsule **参数解释：** 密钥胶囊 **取值范围：** 不涉及
    *
    * @return $this
    */
