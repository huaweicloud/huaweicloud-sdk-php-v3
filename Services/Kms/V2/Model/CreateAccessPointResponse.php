...
class CreateAccessPointResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAccessPointResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * accessPointId  **参数解释：** 创建的接入点ID **取值范围：** 不涉及
    *
    * @var string[]
    */
    ...
    * Sets accessPointId
    *
    * @param string|null $accessPointId **参数解释：** 创建的接入点ID **取值范围：** 不涉及
    *
    * @return $this
    */
