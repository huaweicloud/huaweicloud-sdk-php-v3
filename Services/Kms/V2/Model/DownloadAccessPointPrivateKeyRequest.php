...
class DownloadAccessPointPrivateKeyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DownloadAccessPointPrivateKeyRequest';
