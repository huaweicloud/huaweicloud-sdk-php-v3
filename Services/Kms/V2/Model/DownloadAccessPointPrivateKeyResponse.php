...
class DownloadAccessPointPrivateKeyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DownloadAccessPointPrivateKeyResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * accessPointId  **参数解释：** 接入点ID **取值范围：** 不涉及
    * privateKey  **参数解释：** 通用类型接入点私钥 **取值范围：** 不涉及
    *
    * @var string[]
    */
    ...
    * Sets accessPointId
    *
    * @param string|null $accessPointId **参数解释：** 接入点ID **取值范围：** 不涉及
    *
    * @return $this
    */
    ...
    * Sets privateKey
    *
    * @param string|null $privateKey **参数解释：** 通用类型接入点私钥 **取值范围：** 不涉及
    *
    * @return $this
    */
