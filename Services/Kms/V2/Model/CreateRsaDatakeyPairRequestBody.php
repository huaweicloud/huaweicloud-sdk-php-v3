...
class CreateRsaDatakeyPairRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * Sets keySpec
    *
    * @param string $keySpec 需要包含算法、长度、曲线信息。可选值有RSA_2048 | RSA_3072 | RSA_4096
    *
    * @return $this
    */
