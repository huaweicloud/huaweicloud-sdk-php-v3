...
class AssociateAliasResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateAliasResponse';
    ...
    * Sets aliasUrn
    *
    * @param string|null $aliasUrn 别名资源定位符
    *
    * @return $this
    */
