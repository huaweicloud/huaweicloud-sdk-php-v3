...
class ExternalCreateGlobalDcGateway implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExternalCreateGlobalDcGateway';
    ...
    * Sets status
    *
    * @param string|null $status 状态值 - ACTIVE 正常 - ERROR 异常
    *
    * @return $this
    */
