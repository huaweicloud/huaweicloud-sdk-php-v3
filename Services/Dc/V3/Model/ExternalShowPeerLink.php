...
class ExternalShowPeerLink implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExternalShowPeerLink';
    ...
    * Sets createOwner
    *
    * @param string|null $createOwner 创建者
    *
    * @return $this
    */
