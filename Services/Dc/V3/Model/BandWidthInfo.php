...
class BandWidthInfo implements ModelInterface, ArrayAccess
{
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['bandwidthSize']) && ($this->container['bandwidthSize'] > 268435455)) {
                $invalidProperties[] = "invalid value for 'bandwidthSize', must be smaller than or equal to 268435455.";
            }
    ...
    * Sets gcbId
    *
    * @param string|null $gcbId 购买全域互连带宽包ID
    *
    * @return $this
    */
