...
class BindGlobalEipsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BindGlobalEipsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Dc\V3\Model\CreateBindingGeipRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dc\V3\Model\CreateBindingGeipRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dc\V3\Model\CreateBindingGeipRequestBody|null $body body
    *
    * @return $this
    */
