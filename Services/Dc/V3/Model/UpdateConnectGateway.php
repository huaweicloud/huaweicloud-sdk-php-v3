...
class UpdateConnectGateway implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateConnectGateway';
    ...
    * Sets addressFamily
    *
    * @param string|null $addressFamily 地址族信息
    *
    * @return $this
    */
