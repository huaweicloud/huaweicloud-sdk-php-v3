...
class UnbindGlobalEipsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UnbindGlobalEipsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Dc\V3\Model\CreateUnbindingGeipRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dc\V3\Model\CreateUnbindingGeipRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dc\V3\Model\CreateUnbindingGeipRequestBody|null $body body
    *
    * @return $this
    */
