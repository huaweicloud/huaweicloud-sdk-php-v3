...
class ListGlobalDcGatewaysResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGlobalDcGatewaysResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * globalDcGateways  全域接入网关列表。
    * pageInfo  pageInfo
    * requestId  请求ID。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'globalDcGateways' => '\HuaweiCloud\SDK\Dc\V3\Model\GlobalDcGatewayEntry[]',
    ...
    *
    * @param \HuaweiCloud\SDK\Dc\V3\Model\GlobalDcGatewayEntry[]|null $globalDcGateways 全域接入网关列表。
    *
    * @return $this
    */
