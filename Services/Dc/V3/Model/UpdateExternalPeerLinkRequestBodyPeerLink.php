...
class UpdateExternalPeerLinkRequestBodyPeerLink implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateExternalPeerLinkRequestBody_peer_link';
    ...
    * Sets name
    *
    * @param string|null $name 接入网关关联连接的名字
    *
    * @return $this
    */
