...
class CreateVifPeerDetectionRequestBodyVifPeerDetection implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateVifPeerDetectionRequestBody_vif_peer_detection';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * vifPeerId  虚拟接口对等体实例id
    *
    * @var string[]
    */
    ...
    * Sets vifPeerId
    *
    * @param string $vifPeerId 虚拟接口对等体实例id
    *
    * @return $this
    */
