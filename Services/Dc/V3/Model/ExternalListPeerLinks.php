...
class ExternalListPeerLinks implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExternalListPeerLinks';
    ...
    * Sets createOwner
    *
    * @param string|null $createOwner createOwner
    *
    * @return $this
    */
