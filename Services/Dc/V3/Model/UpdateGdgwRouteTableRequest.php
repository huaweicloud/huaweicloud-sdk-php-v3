...
class UpdateGdgwRouteTableRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateGdgwRouteTableRequest';
    ...
    */
    protected static $openAPITypes = [
            'gdgwId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dc\V3\Model\UpdateGdgwRoutetableRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dc\V3\Model\UpdateGdgwRoutetableRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dc\V3\Model\UpdateGdgwRoutetableRequestBody|null $body body
    *
    * @return $this
    */
