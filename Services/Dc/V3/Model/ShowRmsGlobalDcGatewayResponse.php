...
class ShowRmsGlobalDcGatewayResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowRmsGlobalDcGatewayResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'globalDcGateway' => '\HuaweiCloud\SDK\Dc\V3\Model\RmsShowGlobalDcGateway',
            'xRequestId' => 'string'
    ];
    ...
    *  globalDcGateway
    *
    * @return \HuaweiCloud\SDK\Dc\V3\Model\RmsShowGlobalDcGateway|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Dc\V3\Model\RmsShowGlobalDcGateway|null $globalDcGateway globalDcGateway
    *
    * @return $this
    */
