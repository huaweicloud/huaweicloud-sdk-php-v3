...
class ListGlobalDcGatewayResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGlobalDcGatewayResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * requestId  请求ID
    * globalDcGateways  globalDcGateways
    * pageInfo  pageInfo
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'globalDcGateways' => '\HuaweiCloud\SDK\Dc\V3\Model\ExternalListGlobalDcGateways[]',
    ...
    *  globalDcGateways
    *
    * @return \HuaweiCloud\SDK\Dc\V3\Model\ExternalListGlobalDcGateways[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Dc\V3\Model\ExternalListGlobalDcGateways[]|null $globalDcGateways globalDcGateways
    *
    * @return $this
    */
