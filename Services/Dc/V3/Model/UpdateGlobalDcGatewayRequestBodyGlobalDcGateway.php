...
class UpdateGlobalDcGatewayRequestBodyGlobalDcGateway implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateGlobalDcGatewayRequestBody_global_dc_gateway';
