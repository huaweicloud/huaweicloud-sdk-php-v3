...
class BindingGeipBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BindingGeipBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * globalEipId  全局弹性公网IP的ID
    * type  geip子网类型
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['globalEipId'] === null) {
            ...
            if ((mb_strlen($this->container['globalEipId']) < 0)) {
                $invalidProperties[] = "invalid value for 'globalEipId', the character length must be bigger than or equal to 0.";
            }
    ...
    * Sets globalEipId
    *
    * @param string $globalEipId 全局弹性公网IP的ID
    *
    * @return $this
    */
    ...
    * Sets type
    *
    * @param string|null $type geip子网类型
    *
    * @return $this
    */
