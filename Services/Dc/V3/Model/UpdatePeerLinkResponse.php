...
class UpdatePeerLinkResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePeerLinkResponse';
    ...
    *  peerLink
    *
    * @return \HuaweiCloud\SDK\Dc\V3\Model\ExternalUpdatePeerLink|null
    */
    ...
    * Sets peerLink
    *
    * @param \HuaweiCloud\SDK\Dc\V3\Model\ExternalUpdatePeerLink|null $peerLink peerLink
    *
    * @return $this
    */
