...
class ExternalUpdateGlobalDcGateway implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExternalUpdateGlobalDcGateway';
    ...
    * Sets regionId
    *
    * @param string|null $regionId 租户ID
    *
    * @return $this
    */
