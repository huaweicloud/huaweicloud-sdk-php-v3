...
class UpdateGdgwRoutetableRequestBodyGdgwRoutetableAddRoutes implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateGdgwRoutetableRequestBody_gdgw_routetable_add_routes';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['destination'] === null) {
            ...
            if ((mb_strlen($this->container['destination']) > 255)) {
    ...
    * Sets description
    *
    * @param string|null $description 说明信息
    *
    * @return $this
    */
