...
class UpdateConnectGatewayRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateConnectGatewayRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Dc\V3\Model\UpdateConnectGatewayRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dc\V3\Model\UpdateConnectGatewayRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dc\V3\Model\UpdateConnectGatewayRequestBody|null $body body
    *
    * @return $this
    */
