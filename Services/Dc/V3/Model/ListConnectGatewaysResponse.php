...
class ListConnectGatewaysResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListConnectGatewaysResponse';
    ...
    */
    ...
    /**
    * Gets connectGateways
    *  connectGateways
    *
    * @return \HuaweiCloud\SDK\Dc\V3\Model\ConnectGatewayResponse[]|null
    */
    public function getConnectGateways()
    {
        return $this->container['connectGateways'];
    }

    /**
    * Sets connectGateways
    *
    * @param \HuaweiCloud\SDK\Dc\V3\Model\ConnectGatewayResponse[]|null $connectGateways connectGateways
    *
    * @return $this
    */
