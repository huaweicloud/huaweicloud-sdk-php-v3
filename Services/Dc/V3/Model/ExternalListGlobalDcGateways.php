...
class ExternalListGlobalDcGateways implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExternalListGlobalDcGateways';
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\Dc\V3\Model\Tag[]|null $tags 标签
    *
    * @return $this
    */
