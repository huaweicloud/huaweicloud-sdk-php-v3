...
class ShowGlobalDcGatewayResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowGlobalDcGatewayResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'globalDcGateway' => '\HuaweiCloud\SDK\Dc\V3\Model\ExternalShowGlobalDcGateway',
            'xRequestId' => 'string'
    ];
    ...
    *  globalDcGateway
    *
    * @return \HuaweiCloud\SDK\Dc\V3\Model\ExternalShowGlobalDcGateway|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Dc\V3\Model\ExternalShowGlobalDcGateway|null $globalDcGateway globalDcGateway
    *
    * @return $this
    */
