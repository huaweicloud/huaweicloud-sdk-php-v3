...
class AddKmsKeyRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddKmsKeyRequestBody';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['keyId'] === null) {
            ...
            if (!preg_match("/^[0-9a-z]{8}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{12}$/", $this->container['keyId'])) {
    ...
    * Sets keyId
    *
    * @param string $keyId 在DEW服务上创建的用户主密钥对应的密钥ID，具体参考在DEW服务上创建密钥章节。
    *
    * @return $this
    */
