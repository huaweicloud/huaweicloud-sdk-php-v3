...
class UpdateKmsKeyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateKmsKeyRequest';
    ...
    */
    protected static $openAPITypes = [
            'topicUrn' => 'string',
            'id' => 'string',
            'body' => '\HuaweiCloud\SDK\Smn\V2\Model\UpdateKmsKeyRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Smn\V2\Model\UpdateKmsKeyRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Smn\V2\Model\UpdateKmsKeyRequestBody|null $body body
    *
    * @return $this
    */
