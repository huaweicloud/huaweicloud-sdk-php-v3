...
class BatchDeleteSubscriptionsResponseItemInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteSubscriptionsResponseItemInfo';
    ...
    * Sets code
    *
    * @param string|null $code 服务异常错误信息编码。
    *
    * @return $this
    */
    ...
    * Sets message
    *
    * @param string|null $message 服务异常错误信息描述。
    *
    * @return $this
    */
