...
class BatchDeleteSubscriptionsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteSubscriptionsRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * subscriptionUrns  订阅者信息列表。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'subscriptionUrns' => '\HuaweiCloud\SDK\Smn\V2\Model\BatchDeleteSubscriptionsRequestItemInfo[]'
    ];
    ...
    *  订阅者信息列表。
    *
    * @return \HuaweiCloud\SDK\Smn\V2\Model\BatchDeleteSubscriptionsRequestItemInfo[]
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Smn\V2\Model\BatchDeleteSubscriptionsRequestItemInfo[] $subscriptionUrns 订阅者信息列表。
    *
    * @return $this
    */
