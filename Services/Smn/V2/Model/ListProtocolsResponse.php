...
class ListProtocolsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListProtocolsResponse';
    ...
    * Sets protocols
    *
    * @param string[]|null $protocols 协议列表。
    *
    * @return $this
    */
