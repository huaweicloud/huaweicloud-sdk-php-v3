...
class BatchDeleteSubscriptionsRequestItemInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteSubscriptionsRequestItemInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * subscriptionUrn  订阅者的唯一的资源标识。
    *
    * @var string[]
    */
    ...
    *
    * @param string $subscriptionUrn 订阅者的唯一的资源标识。
    *
    * @return $this
    */
