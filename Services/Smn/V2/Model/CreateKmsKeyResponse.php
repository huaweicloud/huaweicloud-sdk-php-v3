...
class CreateKmsKeyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateKmsKeyResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * requestId  请求的唯一标识ID。
    * id  所使用密钥对应的ID。该ID由SMN生成，是主题下的该密钥的唯一标识ID。
    *
    * @var string[]
    */
    ...
    * Sets id
    *
    * @param string|null $id 所使用密钥对应的ID。该ID由SMN生成，是主题下的该密钥的唯一标识ID。
    *
    * @return $this
    */
