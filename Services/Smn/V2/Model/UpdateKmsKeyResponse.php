...
class UpdateKmsKeyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateKmsKeyResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * requestId  请求的唯一标识ID。
    * id  主题下密钥的唯一标识ID。该ID由SMN自动生成。
    *
    * @var string[]
    */
    ...
    * Sets id
    *
    * @param string|null $id 主题下密钥的唯一标识ID。该ID由SMN自动生成。
    *
    * @return $this
    */
