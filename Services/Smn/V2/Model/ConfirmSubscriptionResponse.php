...
class ConfirmSubscriptionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ConfirmSubscriptionResponse';
    ...
    *
    * @param string|null $subscriptionUrn 订阅者的唯一的资源标识。
    *
    * @return $this
    */
