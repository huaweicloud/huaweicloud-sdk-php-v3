...
class PollingPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PollingPolicyRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * order  当前轮询的序号。
    * subscriptionUrns  订阅终端urn列表。
    *
    * @var string[]
    */
    ...
    *
    * @param string[] $subscriptionUrns 订阅终端urn列表。
    *
    * @return $this
    */
