...
class UpdateClusterSshRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateClusterSshRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * clusterId  集群ID
    * enable  开启/关闭集群节点授权
    * expireTime  开启集群节点授权截止时间，仅enable为true时需要传递，如不传该值默认为1天授权时间
    *
    * @var string[]
    */
    ...
    * Sets expireTime
    *
    * @param float|null $expireTime 开启集群节点授权截止时间，仅enable为true时需要传递，如不传该值默认为1天授权时间
    *
    * @return $this
    */
