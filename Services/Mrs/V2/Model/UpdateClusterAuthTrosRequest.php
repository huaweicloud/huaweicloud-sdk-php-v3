...
class UpdateClusterAuthTrosRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateClusterAuthTrosRequest';
    ...
    */
    protected static $openAPITypes = [
            'clusterId' => 'string',
            'body' => '\HuaweiCloud\SDK\Mrs\V2\Model\ClusterAuthTros'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Mrs\V2\Model\ClusterAuthTros|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Mrs\V2\Model\ClusterAuthTros|null $body body
    *
    * @return $this
    */
