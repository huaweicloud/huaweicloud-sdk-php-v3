...
class UploadIpdImageInIssueResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UploadIpdImageInIssueResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * status  请求状态,成功为success，失败时会抛出异常
    * message  请求信息，一般情况为空。
    * result  result
    *
    * @var string[]
    ...
    * Sets status
    *
    * @param string|null $status 请求状态,成功为success，失败时会抛出异常
    *
    * @return $this
    */
    ...
    * Sets message
    *
    * @param string|null $message 请求信息，一般情况为空。
    *
    * @return $this
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\IssueEntity|null $result result
    *
    * @return $this
    */
