...
class IssueNewAuthor implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'IssueNew_author';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * firstName  **参数解释：** 用户名称。 **取值范围：** 不涉及。
    * lastName  **参数解释：** 用户姓名。 **取值范围：** 不涉及。
    * identifier  **参数解释：** 作者唯一标识。 **取值范围：** 不涉及。
    * imageId  **参数解释：** 用户头像id。 **取值范围：** 不涉及。
    * authorNickName  **参数解释：** 用户昵称。 **取值范围：** 不涉及。
    * name  **参数解释：** 带租户信息的用户名（租户名称_用户名）。 **取值范围：** 不涉及。
    * id  **参数解释：** 用户id。 **取值范围：** 不涉及。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['authorNickName']) && (mb_strlen($this->container['authorNickName']) > 60)) {
                $invalidProperties[] = "invalid value for 'authorNickName', the character length must be smaller than or equal to 60.";
            }
            if (!is_null($this->container['authorNickName']) && (mb_strlen($this->container['authorNickName']) < 2)) {
                $invalidProperties[] = "invalid value for 'authorNickName', the character length must be bigger than or equal to 2.";
            }
    ...
    * Sets firstName
    *
    * @param string|null $firstName **参数解释：** 用户名称。 **取值范围：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets identifier
    *
    * @param string|null $identifier **参数解释：** 作者唯一标识。 **取值范围：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets authorNickName
    *
    * @param string|null $authorNickName **参数解释：** 用户昵称。 **取值范围：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string|null $name **参数解释：** 带租户信息的用户名（租户名称_用户名）。 **取值范围：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets id
    *
    * @param int|null $id **参数解释：** 用户id。 **取值范围：** 不涉及。
    *
    * @return $this
    */
