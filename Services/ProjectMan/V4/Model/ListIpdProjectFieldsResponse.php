...
class ListIpdProjectFieldsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListIpdProjectFieldsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * status  **参数解释**： 返回状态。 **取值范围**： success：响应成功。 error：响应失败
    * message  **参数解释**： 请求失败信息。 **取值范围**： 不涉及
    * result  result
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'message' => 'string',
            'result' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\FieldListResult'
    ];
    ...
    * Sets message
    *
    * @param string|null $message **参数解释**： 请求失败信息。 **取值范围**： 不涉及
    *
    * @return $this
    */
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\FieldListResult|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\FieldListResult|null $result result
    *
    * @return $this
    */
