...
class ShowTenantIssueListResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowTenantIssueListResponse';
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'message' => 'string',
            'result' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\IssueDetailsResponse[]'
    ];
    ...
    *  **参数解释**： 查询结果。
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\IssueDetailsResponse[]|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\IssueDetailsResponse[]|null $result **参数解释**： 查询结果。
    *
    * @return $this
    */
