...
class ProcessInstanceResponseResultModifiedBy implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ProcessInstanceResponse_result_modified_by';
