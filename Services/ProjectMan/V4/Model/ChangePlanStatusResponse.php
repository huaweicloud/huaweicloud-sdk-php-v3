...
class ChangePlanStatusResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangePlanStatusResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * status  **参数解释**： 返回状态。 **取值范围**： - success：操作成功 - error：操作失败
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'message' => 'string',
            'result' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\StatusChangeResult'
    ];
    ...
    * Sets status
    *
    * @param string|null $status **参数解释**： 返回状态。 **取值范围**： - success：操作成功 - error：操作失败
    *
    * @return $this
    */
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\StatusChangeResult|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\StatusChangeResult|null $result result
    *
    * @return $this
    */
