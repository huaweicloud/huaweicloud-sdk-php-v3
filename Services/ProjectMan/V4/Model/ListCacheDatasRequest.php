...
class ListCacheDatasRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCacheDatasRequest';
    ...
    * type  **参数解释：** 字段类型。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： backlog。
    *
    * @var string[]
    */
    ...
    * Sets type
    *
    * @param string|null $type **参数解释：** 字段类型。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： backlog。
    *
    * @return $this
    */
