...
class UpdateIpdThirdPartyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateIpdThirdPartyResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * status  响应状态。
    * message  修改工作项下外部链接失败的原因。
    * result  result
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'message' => 'string',
            'result' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\UpdateThirdPartyAssociateResponseResult'
    ];
    ...
    * Sets message
    *
    * @param string|null $message 修改工作项下外部链接失败的原因。
    *
    * @return $this
    */
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\UpdateThirdPartyAssociateResponseResult|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\UpdateThirdPartyAssociateResponseResult|null $result result
    *
    * @return $this
    */
