...
class ListProjectDemandStaticV4Response implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListProjectDemandStaticV4Response';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * demandStatistics  需求统计
    *
    * @var string[]
    */
    ...
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\DemandStatisticResponseV4[]|null $demandStatistics 需求统计
    *
    * @return $this
    */
