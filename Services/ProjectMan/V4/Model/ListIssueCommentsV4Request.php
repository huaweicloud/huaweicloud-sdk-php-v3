...
class ListIssueCommentsV4Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListIssueCommentsV4Request';
    ...
    * Sets limit
    *
    * @param int|null $limit 每页显示的条数,最大显示100条
    *
    * @return $this
    */
