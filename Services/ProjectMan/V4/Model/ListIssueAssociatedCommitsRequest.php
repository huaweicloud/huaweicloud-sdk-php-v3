...
class ListIssueAssociatedCommitsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListIssueAssociatedCommitsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * projectId  devcloud项目的32位id
    * issueId  工作项ID
    * type  查询类型：commit（提交记录） || branch（分支记录）
    * limit  每页数量
    * offset  偏移量
    *
    * @var string[]
    ...
    * Sets type
    *
    * @param string|null $type 查询类型：commit（提交记录） || branch（分支记录）
    *
    * @return $this
    */
