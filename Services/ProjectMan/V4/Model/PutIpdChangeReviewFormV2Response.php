...
class PutIpdChangeReviewFormV2Response implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PutIpdChangeReviewFormV2Response';
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'message' => 'string',
            'result' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\ReviewEntity'
    ];
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\ReviewEntity|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\ReviewEntity|null $result result
    *
    * @return $this
    */
