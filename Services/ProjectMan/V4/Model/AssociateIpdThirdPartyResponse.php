...
class AssociateIpdThirdPartyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateIpdThirdPartyResponse';
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'message' => 'string',
            'result' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\IssuesAssociationRespResult'
    ];
    ...
    * Sets message
    *
    * @param string|null $message 关联失败的原因。
    *
    * @return $this
    */
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\IssuesAssociationRespResult|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\IssuesAssociationRespResult|null $result result
    *
    * @return $this
    */
