...
class UpdateIpdThirdPartyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateIpdThirdPartyRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'issueId' => 'string',
            'body' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\UpdateThirdPartyAssociateVO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\UpdateThirdPartyAssociateVO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\UpdateThirdPartyAssociateVO|null $body body
    *
    * @return $this
    */
