...
class IssueDetailResponseV2StoryPoint implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'IssueDetailResponseV2_story_point';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  **参数解释：** 工作项的故事点id。 **取值范围：** 不涉及。
    * name  **参数解释：** 工作项的故事点名称。 **取值范围：** 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets id
    *
    * @param int|null $id **参数解释：** 工作项的故事点id。 **取值范围：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string|null $name **参数解释：** 工作项的故事点名称。 **取值范围：** 不涉及。
    *
    * @return $this
    */
