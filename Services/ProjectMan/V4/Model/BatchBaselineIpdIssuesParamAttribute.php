...
class BatchBaselineIpdIssuesParamAttribute implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchBaselineIpdIssuesParam_attribute';
