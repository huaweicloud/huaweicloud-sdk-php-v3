...
class ProcessInstanceResponseResultAssignee implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ProcessInstanceResponse_result_assignee';
    ...
    * Sets hasRemoved
    *
    * @param string|null $hasRemoved 用户是否已移出项目
    *
    * @return $this
    */
