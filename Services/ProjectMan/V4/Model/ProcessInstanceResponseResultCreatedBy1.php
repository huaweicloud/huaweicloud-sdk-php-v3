...
class ProcessInstanceResponseResultCreatedBy1 implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ProcessInstanceResponse_result_created_by_1';
