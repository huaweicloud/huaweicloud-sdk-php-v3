...
class FieldCodeValuePair implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'FieldCodeValuePair';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * code  工作项字段code值
    * value  工作项自定义字段值，为多选时用英文逗号分隔
    *
    * @var string[]
    */
    ...
    * Sets code
    *
    * @param string|null $code 工作项字段code值
    *
    * @return $this
    */
    ...
    * Sets value
    *
    * @param string|null $value 工作项自定义字段值，为多选时用英文逗号分隔
    *
    * @return $this
    */
