...
class IssueRecordV4User implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'IssueRecordV4_user';
    ...
    * Sets userName
    *
    * @param string|null $userName 登录名
    *
    * @return $this
    */
    ...
    * Sets userId
    *
    * @param string|null $userId 用户32位的uuid
    *
    * @return $this
    */
