...
class BatchUpdateBaselineResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchUpdateBaselineResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * status  **参数解释**： 返回状态。 **取值范围**： - success：批量操作成功 - error：批量操作失败
    * message  **参数解释**： 返回消息。 **取值范围**： 不涉及。
    * result  result
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'message' => 'string',
            'result' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\BatchResultVO'
    ];
    ...
    * Sets status
    *
    * @param string|null $status **参数解释**： 返回状态。 **取值范围**： - success：批量操作成功 - error：批量操作失败
    *
    * @return $this
    */
    ...
    * Sets message
    *
    * @param string|null $message **参数解释**： 返回消息。 **取值范围**： 不涉及。
    *
    * @return $this
    */
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\BatchResultVO|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\BatchResultVO|null $result result
    *
    * @return $this
    */
