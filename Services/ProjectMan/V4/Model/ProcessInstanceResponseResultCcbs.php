...
class ProcessInstanceResponseResultCcbs implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ProcessInstanceResponse_result_ccbs';
    ...
    * Sets imageId
    *
    * @param string|null $imageId 用户头像id
    *
    * @return $this
    */
    ...
    * Sets opinion
    *
    * @param string|null $opinion 评审信息
    *
    * @return $this
    */
    ...
    * Sets ccbId
    *
    * @param string|null $ccbId 评审对象id
    *
    * @return $this
    */
    ...
    * Sets hasRemoved
    *
    * @param string|null $hasRemoved 用户已移出项目
    *
    * @return $this
    */
