...
class FieldLongDateVO implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'FieldLongDateVO';
    ...
    * Sets createdDate
    *
    * @param int|null $createdDate 字段创建时间。时间戳格式，单位毫秒。
    *
    * @return $this
    */
    ...
    * Sets modifiedDate
    *
    * @param int|null $modifiedDate 字段最后修改时间。时间戳格式，单位毫秒。
    *
    * @return $this
    */
