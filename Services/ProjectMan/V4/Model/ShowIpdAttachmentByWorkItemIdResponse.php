...
class ShowIpdAttachmentByWorkItemIdResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowIpdAttachmentByWorkItemIdResponse';
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'message' => 'string',
            'result' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\AttachmentEntity[]'
    ];
    ...
    *  附件列表
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\AttachmentEntity[]|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\AttachmentEntity[]|null $result 附件列表
    *
    * @return $this
    */
