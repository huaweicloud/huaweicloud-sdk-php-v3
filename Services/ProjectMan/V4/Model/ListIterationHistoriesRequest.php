...
class ListIterationHistoriesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListIterationHistoriesRequest';
    ...
    * Sets limit
    *
    * @param int|null $limit 每页数量，最大为100
    *
    * @return $this
    */
