...
class ProjectModule implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ProjectModule';
    ...
    */
    protected static $openAPITypes = [
            ...
            'deepth' => 'int',
            'isParent' => 'bool',
            'children' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\ProjectChildModule[]'
    ];
    ...
    *  子模块信息
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\ProjectChildModule[]|null
    */
    ...
    * Sets children
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\ProjectChildModule[]|null $children 子模块信息
    *
    * @return $this
    */
