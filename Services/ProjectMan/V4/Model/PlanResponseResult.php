...
class PlanResponseResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PlanResponseResult';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  **参数解释：** 发布、迭代、里程碑的ID **取值范围：** 不涉及
    * title  **参数解释：** 标题 **取值范围：** 不涉及
    * category  **参数解释：** 分类，枚举类型 **取值范围：** - PI：发布 - Iteration：迭代 - PlanMilestone：里程碑
    * description  **参数解释：** 描述 **取值范围：** 不涉及
    * state  **参数解释：** 作废标识，枚举类型。 **取值范围：** - 正在工作：可正常操作的发布。 - 作废：软删除后的发布。 - 删除：彻底删除后的发布。
    ...
    * planStartDate  **参数解释：** 计划开始时间，unix时间戳，单位：毫秒。 **取值范围：** 不涉及
    * planEndDate  **参数解释：** 计划完成时间，unix时间戳，单位：毫秒。 **取值范围：** 不涉及
    * createdDate  **参数解释：** 创建时间，unix时间戳，单位：毫秒 **取值范围：** 不涉及
    * parentId  **参数解释：** 父计划ID，当计划类型为迭代(Iteration)时，用于指定所属的发布计划。 **取值范围：** 长度为18~19个字符的数字字符串。
    * baseline  **参数解释：** 基线状态，枚举类型，标识计划是否已纳入基线管理。 **取值范围：** - baselined：已基线 - unbaseline：未基线 - \"\"：未基线
    * workload  **参数解释：** 预估工作量，用于标识计划所需的人力或时间投入，单位人/天。 **取值范围：** 最大长度11个字符。
    * owner  **参数解释：** 责任人ID，标识计划的负责人。 **取值范围：** 长度为32位的字符串。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'state' => 'string',
            'status' => 'string',
            'children' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\PlanResponseResult[]',
            'createdBy' => 'string',
            'modifiedBy' => 'string',
            'planStartDate' => 'int',
            'planEndDate' => 'int',
    ...
    * Sets id
    *
    * @param string|null $id **参数解释：** 发布、迭代、里程碑的ID **取值范围：** 不涉及
    *
    * @return $this
    */
    ...
    * Sets state
    *
    * @param string|null $state **参数解释：** 作废标识，枚举类型。 **取值范围：** - 正在工作：可正常操作的发布。 - 作废：软删除后的发布。 - 删除：彻底删除后的发布。
    *
    * @return $this
    */
    ...
    *  **参数解释：** 子项目迭代信息
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\PlanResponseResult[]|null
    */
    ...
    * Sets children
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\PlanResponseResult[]|null $children **参数解释：** 子项目迭代信息
    *
    * @return $this
    */
    ...
    * Sets planStartDate
    *
    * @param int|null $planStartDate **参数解释：** 计划开始时间，unix时间戳，单位：毫秒。 **取值范围：** 不涉及
    *
    * @return $this
    */
    ...
    * Sets planEndDate
    *
    * @param int|null $planEndDate **参数解释：** 计划完成时间，unix时间戳，单位：毫秒。 **取值范围：** 不涉及
    *
    * @return $this
    */
    ...
    * Sets parentId
    *
    * @param string|null $parentId **参数解释：** 父计划ID，当计划类型为迭代(Iteration)时，用于指定所属的发布计划。 **取值范围：** 长度为18~19个字符的数字字符串。
    *
    * @return $this
    */
    ...
    * Sets baseline
    *
    * @param string|null $baseline **参数解释：** 基线状态，枚举类型，标识计划是否已纳入基线管理。 **取值范围：** - baselined：已基线 - unbaseline：未基线 - \"\"：未基线
    *
    * @return $this
    */
    ...
    * Sets workload
    *
    * @param string|null $workload **参数解释：** 预估工作量，用于标识计划所需的人力或时间投入，单位人/天。 **取值范围：** 最大长度11个字符。
    *
    * @return $this
    */
    ...
    * Sets owner
    *
    * @param string|null $owner **参数解释：** 责任人ID，标识计划的负责人。 **取值范围：** 长度为32位的字符串。
    *
    * @return $this
    */
