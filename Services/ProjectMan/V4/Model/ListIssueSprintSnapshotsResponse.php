...
class ListIssueSprintSnapshotsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListIssueSprintSnapshotsResponse';
    ...
    */
    protected static $openAPITypes = [
            'result' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\SnapshotsVO[]',
            'status' => 'string',
            'message' => 'string'
    ];
    ...
    *  快照列表。
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\SnapshotsVO[]|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\SnapshotsVO[]|null $result 快照列表。
    *
    * @return $this
    */
    ...
    * Sets message
    *
    * @param string|null $message 请求失败信息。
    *
    * @return $this
    */
