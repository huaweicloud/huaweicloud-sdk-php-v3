...
class ShowIpdThirdPartyAssociatedResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowIpdThirdPartyAssociatedResponse';
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'message' => 'string',
            'result' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\ThirdPartyAssociatedResult'
    ];
    ...
    * Sets message
    *
    * @param string|null $message 查询失败的原因。
    *
    * @return $this
    */
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\ThirdPartyAssociatedResult|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\ThirdPartyAssociatedResult|null $result result
    *
    * @return $this
    */
