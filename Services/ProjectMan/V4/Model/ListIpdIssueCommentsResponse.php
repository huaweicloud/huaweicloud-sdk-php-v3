...
class ListIpdIssueCommentsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListIpdIssueCommentsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * status  **参数解释**： 响应状态。 **取值范围**： 不涉及。
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'message' => 'string',
            'result' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\CommentResult'
    ];
    ...
    * Sets status
    *
    * @param string|null $status **参数解释**： 响应状态。 **取值范围**： 不涉及。
    *
    * @return $this
    */
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\CommentResult|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\CommentResult|null $result result
    *
    * @return $this
    */
