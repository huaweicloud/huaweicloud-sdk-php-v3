...
class ShowIssuesWrokFlowConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowIssuesWrokFlowConfigRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * projectId  devcloud项目的32位id
    * trackerId  工作项类型id [2,3,4,5,6,7]
    *
    * @var string[]
    */
    ...
    * Sets trackerId
    *
    * @param int $trackerId 工作项类型id [2,3,4,5,6,7]
    *
    * @return $this
    */
