...
class DeleteIpdLabelResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteIpdLabelResponse';
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'message' => 'string',
            'result' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\LabelEntity'
    ];
    ...
    * Sets message
    *
    * @param string|null $message 请求失败原因
    *
    * @return $this
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\LabelEntity|null $result result
    *
    * @return $this
    */
