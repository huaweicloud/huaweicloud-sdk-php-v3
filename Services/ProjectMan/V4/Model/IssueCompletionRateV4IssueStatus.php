...
class IssueCompletionRateV4IssueStatus implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'IssueCompletionRateV4_issue_status';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * closedNum  已关闭的工作项
    * newNum  新建的工作项
    * processNum  进行中的工作项数目
    * rejectedNum  已经拒绝的工作项
    * solvedNum  已经解决的工作项
    * testNum  测试中的工作项
    *
    * @var string[]
    ...
    * Sets closedNum
    *
    * @param int|null $closedNum 已关闭的工作项
    *
    * @return $this
    */
    ...
    * Sets processNum
    *
    * @param int|null $processNum 进行中的工作项数目
    *
    * @return $this
    */
    ...
    * Sets rejectedNum
    *
    * @param int|null $rejectedNum 已经拒绝的工作项
    *
    * @return $this
    */
    ...
    * Sets solvedNum
    *
    * @param int|null $solvedNum 已经解决的工作项
    *
    * @return $this
    */
    ...
    * Sets testNum
    *
    * @param int|null $testNum 测试中的工作项
    *
    * @return $this
    */
