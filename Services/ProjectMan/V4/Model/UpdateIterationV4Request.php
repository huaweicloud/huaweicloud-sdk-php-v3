...
class UpdateIterationV4Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateIterationV4Request';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'iterationId' => 'int',
            'body' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\UpdateIterationRequestV4'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\UpdateIterationRequestV4|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\UpdateIterationRequestV4|null $body body
    *
    * @return $this
    */
