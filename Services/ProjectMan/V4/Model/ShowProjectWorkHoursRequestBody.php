...
class ShowProjectWorkHoursRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowProjectWorkHoursRequestBody';
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['beginTime']) && !preg_match("/[0-9]{4}-[0-9]{1,2}-[0-9]{1,2}/", $this->container['beginTime'])) {
                $invalidProperties[] = "invalid value for 'beginTime', must be conform to the pattern /[0-9]{4}-[0-9]{1,2}-[0-9]{1,2}/.";
            }
            if (!is_null($this->container['endTime']) && !preg_match("/[0-9]{4}-[0-9]{1,2}-[0-9]{1,2}/", $this->container['endTime'])) {
                $invalidProperties[] = "invalid value for 'endTime', must be conform to the pattern /[0-9]{4}-[0-9]{1,2}-[0-9]{1,2}/.";
            }
