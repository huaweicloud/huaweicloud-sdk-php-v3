...
class AssociateIpdThirdPartyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateIpdThirdPartyRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * projectId  项目32位ID，项目唯一标识，通过查询IPD项目列表获取，响应消息体中的project_id字段的值就是项目ID。
    * issueId  工作项唯一ID。可以通过查询工作项列表或者查询树状工作项获取，响应消息体中的ID字段的值就是工作项ID。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'issueId' => 'string',
            'body' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\CreateThirdPartyAssociateVO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\CreateThirdPartyAssociateVO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\CreateThirdPartyAssociateVO|null $body body
    *
    * @return $this
    */
