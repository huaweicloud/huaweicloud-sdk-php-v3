...
class ShowIpdAttachmentByWorkItemIdRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowIpdAttachmentByWorkItemIdRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * projectId  工作项所属项目Id
    * issueId  工作项Id
    * sourceProjectId  原始需求跨项目时，提出项目Id
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['issueId'] === null) {
            ...
            if (!is_null($this->container['sourceProjectId']) && (mb_strlen($this->container['sourceProjectId']) > 32)) {
                $invalidProperties[] = "invalid value for 'sourceProjectId', the character length must be smaller than or equal to 32.";
            }
            if (!is_null($this->container['sourceProjectId']) && (mb_strlen($this->container['sourceProjectId']) < 32)) {
                $invalidProperties[] = "invalid value for 'sourceProjectId', the character length must be bigger than or equal to 32.";
            }
    ...
    *
    * @param string|null $sourceProjectId 原始需求跨项目时，提出项目Id
    *
    * @return $this
    */
