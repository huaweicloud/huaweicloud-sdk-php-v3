...
class IssueDetailResponseV2Priority implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'IssueDetailResponseV2_priority';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  **参数解释：** 工作项的优先级id。 **取值范围：** 不涉及。
    * name  **参数解释：** 工作项的优先级名称。 **取值范围：** 高，中，低。
    *
    * @var string[]
    */
    ...
    * Sets id
    *
    * @param int|null $id **参数解释：** 工作项的优先级id。 **取值范围：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string|null $name **参数解释：** 工作项的优先级名称。 **取值范围：** 高，中，低。
    *
    * @return $this
    */
