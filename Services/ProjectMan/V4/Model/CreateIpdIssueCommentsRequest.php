...
class CreateIpdIssueCommentsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateIpdIssueCommentsRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'issueId' => 'string',
            'body' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\CommentCreateVO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\CommentCreateVO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\CommentCreateVO|null $body body
    *
    * @return $this
    */
