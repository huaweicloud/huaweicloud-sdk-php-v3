...
class CreateIpdLabelResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateIpdLabelResponse';
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'message' => 'string',
            'result' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\LabelCreateResult'
    ];
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\LabelCreateResult|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\LabelCreateResult|null $result result
    *
    * @return $this
    */
