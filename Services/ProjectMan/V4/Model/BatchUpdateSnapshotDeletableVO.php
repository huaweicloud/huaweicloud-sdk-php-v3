...
class BatchUpdateSnapshotDeletableVO implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchUpdateSnapshotDeletableVO';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * ids  快照ID列表。通过接口查询工作项计划管理快照列表获取响应参数中的id字段。
    * deletable  是否为可删除标识。
    *
    * @var string[]
    */
    ...
    * Sets ids
    *
    * @param string[] $ids 快照ID列表。通过接口查询工作项计划管理快照列表获取响应参数中的id字段。
    *
    * @return $this
    */
