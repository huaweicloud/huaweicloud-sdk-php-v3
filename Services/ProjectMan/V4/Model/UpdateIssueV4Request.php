...
class UpdateIssueV4Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateIssueV4Request';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'issueId' => 'int',
            'body' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\IssueRequestV4'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\IssueRequestV4|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\IssueRequestV4|null $body body
    *
    * @return $this
    */
