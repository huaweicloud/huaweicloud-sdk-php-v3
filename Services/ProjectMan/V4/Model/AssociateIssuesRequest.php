...
class AssociateIssuesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateIssuesRequest';
    ...
    * dstDomainId  目标项目的32位UUID，项目唯一标识。通过查询IPD项目列表获取，响应消息体中的id字段的值就是项目ID。非跨项目场景，与请求路径中的project_id一致。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'issueId' => 'string',
            'dstDomainId' => 'string',
            'body' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\IssueAssociateVO'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['dstDomainId'] = isset($data['dstDomainId']) ? $data['dstDomainId'] : null;
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['dstDomainId'] === null) {
            $invalidProperties[] = "'dstDomainId' can't be null";
        }
    ...
    * @return string
    */
    public function getDstDomainId()
    {
        return $this->container['dstDomainId'];
    }
    ...
    * @return $this
    */
    public function setDstDomainId($dstDomainId)
    {
        $this->container['dstDomainId'] = $dstDomainId;
        return $this;
    }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\IssueAssociateVO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\IssueAssociateVO|null $body body
    *
    * @return $this
    */
