...
class BatchUpdateIpdIssuesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchUpdateIpdIssuesResponse';
    ...
    */
    protected static $openAPITypes = [
            'result' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\IssueBatchOperateEntitiesResult[]',
            'status' => 'string',
            'message' => 'string'
    ];
    ...
    *  **参数解释**： 批量编辑的结果。
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\IssueBatchOperateEntitiesResult[]|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\IssueBatchOperateEntitiesResult[]|null $result **参数解释**： 批量编辑的结果。
    *
    * @return $this
    */
