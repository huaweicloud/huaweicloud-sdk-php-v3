...
class UpdatePlanInfoResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePlanInfoResponse';
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\PlanResponseResult|null $result result
    *
    * @return $this
    */
