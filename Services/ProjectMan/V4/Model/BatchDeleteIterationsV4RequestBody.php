...
class BatchDeleteIterationsV4RequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteIterationsV4RequestBody';
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['iterationIds'] === null) {
            $invalidProperties[] = "'iterationIds' can't be null";
        }
