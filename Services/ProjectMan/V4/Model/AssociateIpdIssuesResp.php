...
class AssociateIpdIssuesResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateIpdIssuesResp';
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'message' => 'string',
            'result' => 'map[string,\HuaweiCloud\SDK\ProjectMan\V4\Model\AssociateRespDetail[]]'
    ];
    ...
    *  关联工作项的响应结果。
    *
    * @return map[string,\HuaweiCloud\SDK\ProjectMan\V4\Model\AssociateRespDetail[]]|null
    */
    ...
    * Sets result
    *
    * @param map[string,\HuaweiCloud\SDK\ProjectMan\V4\Model\AssociateRespDetail[]]|null $result 关联工作项的响应结果。
    *
    * @return $this
    */
