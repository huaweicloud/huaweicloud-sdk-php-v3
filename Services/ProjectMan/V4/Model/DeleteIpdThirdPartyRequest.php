...
class DeleteIpdThirdPartyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteIpdThirdPartyRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'issueId' => 'string',
            'body' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\DeleteThirdPartyAssociateVO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\DeleteThirdPartyAssociateVO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\DeleteThirdPartyAssociateVO|null $body body
    *
    * @return $this
    */
