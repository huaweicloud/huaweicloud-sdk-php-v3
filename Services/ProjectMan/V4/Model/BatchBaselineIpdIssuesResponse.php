...
class BatchBaselineIpdIssuesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchBaselineIpdIssuesResponse';
    ...
    */
    protected static $openAPITypes = [
            'result' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\BatchBaselineIssueResponseResult[]',
            'status' => 'string',
            'message' => 'string'
    ];
    ...
    *  批量基线工作项的结果列表。
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\BatchBaselineIssueResponseResult[]|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\BatchBaselineIssueResponseResult[]|null $result 批量基线工作项的结果列表。
    *
    * @return $this
    */
    ...
    * Sets message
    *
    * @param string|null $message 操作失败原因。
    *
    * @return $this
    */
