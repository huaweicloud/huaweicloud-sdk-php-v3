...
class ShowIpdProjectListResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowIpdProjectListResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * status  **参数解释**： 返回状态。 **取值范围**： - success：响应成功 - error：响应失败
    * message  **参数解释**： 失败信息。 **取值范围**： 不涉及
    * result  **参数解释**： 项目信息列表。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'message' => 'string',
            'result' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\ProjectInfoVO[]'
    ];
    ...
    * Sets message
    *
    * @param string|null $message **参数解释**： 失败信息。 **取值范围**： 不涉及
    *
    * @return $this
    */
    ...
    *  **参数解释**： 项目信息列表。
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\ProjectInfoVO[]|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\ProjectInfoVO[]|null $result **参数解释**： 项目信息列表。
    *
    * @return $this
    */
