...
class DownloadIpdImageInIssueRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DownloadIpdImageInIssueRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * projectId  项目Id
    * issueId  图片绑定的工作项id
    * fileName  工作项描述中的图片名称,如f401ab8826b1426285910e6c5da80d07.png
    *
    * @var string[]
    */
