...
class CreateSystemIssueRequestV4 implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSystemIssueRequestV4';
    ...
    * domainId  id 领域, 14 '性能', 15 '功能', 16 '可靠性' 17 '网络安全' 18 '可维护性' 19 '其他DFX' 20 '可用性'
    * doneRatio  工作项进度值
    * endTime  结束时间，年-月-日
    ...
    * moduleId  模块id
    * name  标题
    * parentIssueId  父工作项的id,创建子工作项时必填，父工作项的类型tracker_id不能为2,3
    * priorityId  优先级,   1 低,   2 中,   3 高,
    * severityId  重要程度,   10 关键,   11 重要,   12 一般,   13 提示,
    * statusId  状态   id, 新建   1, 进行中 2, 已解决 3, 测试中 4, 已关闭 5, 已拒绝 6,
    * trackerId  工作项类型, 2任务/Task,3缺陷/Bug,5Epic,6Feature,7Story;     5 只能为 6 的父工作项类型;     6 只能为 7 的父工作项类型;     7 只能为 2,3的父;
    ...
    */
    protected static $openAPITypes = [
            ...
            'creator' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\Creator',
            'customFields' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\ScrumCustomField[]'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['priorityId'] === null) {
            $invalidProperties[] = "'priorityId' can't be null";
        }
    ...
    * Sets domainId
    *
    * @param int|null $domainId id 领域, 14 '性能', 15 '功能', 16 '可靠性' 17 '网络安全' 18 '可维护性' 19 '其他DFX' 20 '可用性'
    *
    * @return $this
    */
    ...
    * Sets parentIssueId
    *
    * @param int|null $parentIssueId 父工作项的id,创建子工作项时必填，父工作项的类型tracker_id不能为2,3
    *
    * @return $this
    */
    ...
    * Sets priorityId
    *
    * @param int $priorityId 优先级,   1 低,   2 中,   3 高,
    *
    * @return $this
    */
    ...
    * Sets statusId
    *
    * @param int|null $statusId 状态   id, 新建   1, 进行中 2, 已解决 3, 测试中 4, 已关闭 5, 已拒绝 6,
    *
    * @return $this
    */
    ...
    * Sets trackerId
    *
    * @param int $trackerId 工作项类型, 2任务/Task,3缺陷/Bug,5Epic,6Feature,7Story;     5 只能为 6 的父工作项类型;     6 只能为 7 的父工作项类型;     7 只能为 2,3的父;
    *
    * @return $this
    */
    ...
    *  creator
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\Creator
    */
    ...
    * Sets creator
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\Creator $creator creator
    *
    * @return $this
    */
    ...
    *  用户自定义字段
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\ScrumCustomField[]|null
    */
    ...
    * Sets customFields
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\ScrumCustomField[]|null $customFields 用户自定义字段
    *
    * @return $this
    */
