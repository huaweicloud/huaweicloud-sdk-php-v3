...
class IssueDetailResponseV2ParentIssue implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'IssueDetailResponseV2_parent_issue';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  **参数解释：** 工作项的父工作项id。 **取值范围：** 不涉及。
    * name  **参数解释：** 工作项的父工作项名称。 **取值范围：** 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets id
    *
    * @param int|null $id **参数解释：** 工作项的父工作项id。 **取值范围：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string|null $name **参数解释：** 工作项的父工作项名称。 **取值范围：** 不涉及。
    *
    * @return $this
    */
