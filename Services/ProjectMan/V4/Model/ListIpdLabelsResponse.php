...
class ListIpdLabelsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListIpdLabelsResponse';
    ...
    */
    protected static $openAPITypes = [
            'result' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\LabelListResponse',
            'status' => 'string',
            'message' => 'string'
    ];
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\LabelListResponse|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\LabelListResponse|null $result result
    *
    * @return $this
    */
    ...
    * Sets message
    *
    * @param string|null $message 请求失败时的错误信息。
    *
    * @return $this
    */
