...
class DeleteIpdThirdPartyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteIpdThirdPartyResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * status  响应状态。
    * message  删除工作项下外部链接失败的原因。
    * result  result
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'message' => 'string',
            'result' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\DeleteThirdPartyAssociateResponseResult'
    ];
    ...
    * Sets message
    *
    * @param string|null $message 删除工作项下外部链接失败的原因。
    *
    * @return $this
    */
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\DeleteThirdPartyAssociateResponseResult|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\DeleteThirdPartyAssociateResponseResult|null $result result
    *
    * @return $this
    */
