...
class ListIssueItemResponse implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListIssueItemResponse';
    ...
    * deleted  是否已经删除,true 已经删除， false 未删除
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'order' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\IssueResponseV4Order',
    ...
    *  order
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\IssueResponseV4Order|null
    */
    ...
    * Sets order
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\IssueResponseV4Order|null $order order
    *
    * @return $this
    */
    ...
    * Sets deleted
    *
    * @param bool|null $deleted 是否已经删除,true 已经删除， false 未删除
    *
    * @return $this
    */
