...
class ListScrumProjectStatusesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListScrumProjectStatusesRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * projectId  devcloud项目的32位id
    * offset  查询偏移量
    * limit  一次返回的数据,最小1,最大100
    * trackerId  自定义字段支持的工作项类型 2任务/Task,3缺陷/Bug,5Epic,6Feature,7Story
    *
    * @var string[]
    */
    ...
    * Sets limit
    *
    * @param int|null $limit 一次返回的数据,最小1,最大100
    *
    * @return $this
    */
    ...
    * Sets trackerId
    *
    * @param int|null $trackerId 自定义字段支持的工作项类型 2任务/Task,3缺陷/Bug,5Epic,6Feature,7Story
    *
    * @return $this
    */
