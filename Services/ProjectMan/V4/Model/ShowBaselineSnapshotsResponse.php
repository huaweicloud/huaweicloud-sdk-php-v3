...
class ShowBaselineSnapshotsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowBaselineSnapshotsResponse';
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'message' => 'string',
            'result' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\FeatureSetOpenApiVO[]'
    ];
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\FeatureSetOpenApiVO[]|null $result 返回结果
    *
    * @return $this
    */
