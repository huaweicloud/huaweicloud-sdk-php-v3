...
class UpdateProjectModuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateProjectModuleRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'moduleId' => 'int',
            'body' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\UpdateProjectModuleRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\UpdateProjectModuleRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\UpdateProjectModuleRequestBody|null $body body
    *
    * @return $this
    */
