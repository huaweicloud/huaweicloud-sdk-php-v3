...
class IssueDetailResponseV2Tracker implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'IssueDetailResponseV2_tracker';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  **参数解释：** 工作项的类型id。 **取值范围：** 2，3，5，6，7。
    * name  **参数解释：** 工作项的类型名称。 **取值范围：** 2：任务/Task 3：缺陷/Bug 5：Epic 6：Feature 7：Story。
    *
    * @var string[]
    */
    ...
    * Sets id
    *
    * @param int|null $id **参数解释：** 工作项的类型id。 **取值范围：** 2，3，5，6，7。
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string|null $name **参数解释：** 工作项的类型名称。 **取值范围：** 2：任务/Task 3：缺陷/Bug 5：Epic 6：Feature 7：Story。
    *
    * @return $this
    */
