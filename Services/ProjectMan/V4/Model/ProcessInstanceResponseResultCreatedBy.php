...
class ProcessInstanceResponseResultCreatedBy implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ProcessInstanceResponse_result_created_by';
