...
class ListDomainNotAddedProjectsV4ResponseBodyCreator implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDomainNotAddedProjectsV4ResponseBody_creator';
    ...
    * Sets userId
    *
    * @param string|null $userId 创建人id
    *
    * @return $this
    */
    ...
    * Sets userName
    *
    * @param string|null $userName 创建人姓名
    *
    * @return $this
    */
    ...
    * Sets domainId
    *
    * @param string|null $domainId 创建人租户id
    *
    * @return $this
    */
    ...
    * Sets domainName
    *
    * @param string|null $domainName 创建人租户名称
    *
    * @return $this
    */
    ...
    * Sets nickName
    *
    * @param string|null $nickName 创建人租户昵称
    *
    * @return $this
    */
