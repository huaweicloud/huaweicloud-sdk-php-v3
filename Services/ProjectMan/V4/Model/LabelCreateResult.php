...
class LabelCreateResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'LabelCreateResult';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  标签ID，可通过查询标签列表接口获取，响应消息体中的id字段的值就是标签ID。 18~19个字符的数字字符串。
    ...
    * Sets id
    *
    * @param string|null $id 标签ID，可通过查询标签列表接口获取，响应消息体中的id字段的值就是标签ID。 18~19个字符的数字字符串。
    *
    * @return $this
    */
    ...
    * Sets title
    *
    * @param string|null $title 标签标题。 2~256个字符。
    *
    * @return $this
    */
