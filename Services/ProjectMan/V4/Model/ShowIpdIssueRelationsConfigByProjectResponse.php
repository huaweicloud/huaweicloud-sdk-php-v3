...
class ShowIpdIssueRelationsConfigByProjectResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowIpdIssueRelationsConfigByProjectResponse';
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'message' => 'string',
            'result' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\RelationConfig'
    ];
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\RelationConfig|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\RelationConfig|null $result result
    *
    * @return $this
    */
