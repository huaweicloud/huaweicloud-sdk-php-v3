...
class MetricRequest3Dividend implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MetricRequest3_dividend';
    ...
    */
    ...
    {
        $this->container['onTime'] = isset($data['onTime']) ? $data['onTime'] : null;
    ...
    */
    ...
    {
        return $this->container['onTime'];
    }

    /**
    * Sets onTime
    *
    * @param string|null $onTime 是否按时
    *
    * @return $this
    */
    public function setOnTime($onTime)
    {
        $this->container['onTime'] = $onTime;
        return $this;
    }
