...
class UpdateIpdLabelResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateIpdLabelResponse';
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'message' => 'string',
            'result' => '\HuaweiCloud\SDK\ProjectMan\V4\Model\LabelUpdateResult'
    ];
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\ProjectMan\V4\Model\LabelUpdateResult|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\ProjectMan\V4\Model\LabelUpdateResult|null $result result
    *
    * @return $this
    */
