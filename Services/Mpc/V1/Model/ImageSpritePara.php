...
class ImageSpritePara implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImageSpritePara';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * sampleType  采样类型，取值： - PERCENT：按百分比 - TIME：按时间间隔
    * sampleInterval  采样间隔。 -当 sample_type 为 PERCENT 时，指定采样间隔的百分比，范围(0,100]。 -当 sample_type 为 TIME 时，指定采样间隔的时间，单位为秒,范围(0,360000]。
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sampleInterval'] === null) {
            ...
            if (($this->container['sampleInterval'] > 360000)) {
                $invalidProperties[] = "invalid value for 'sampleInterval', must be smaller than or equal to 360000.";
            }
            if (($this->container['sampleInterval'] < 0)) {
                $invalidProperties[] = "invalid value for 'sampleInterval', must be bigger than or equal to 0.";
            }
    ...
    * Sets sampleInterval
    *
    * @param int $sampleInterval 采样间隔。 -当 sample_type 为 PERCENT 时，指定采样间隔的百分比，范围(0,100]。 -当 sample_type 为 TIME 时，指定采样间隔的时间，单位为秒,范围(0,360000]。
    *
    * @return $this
    */
