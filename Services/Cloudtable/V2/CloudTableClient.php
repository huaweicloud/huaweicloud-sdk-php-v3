...
class CloudTableClient extends Client
{
     ...
     * @return response
     */
    public function enableComponent($request)
    {
        return $this->enableComponentWithHttpInfo($request);
    }
     ...
     * @return response
     */
    public function expandClusterComponent($request)
    {
        return $this->expandClusterComponentWithHttpInfo($request);
    }
     ...
     * @return response
     */
    public function rebootCloudTableCluster($request)
    {
        return $this->rebootCloudTableClusterWithHttpInfo($request);
    }
     ...
     * @return response
     */
    public function showClusterSetting($request)
    {
        return $this->showClusterSettingWithHttpInfo($request);
    }
     ...
     * @return response
     */
    public function updateClusterSetting($request)
    {
        return $this->updateClusterSettingWithHttpInfo($request);
    }
     ...
     * @return response
     */
    public function createCloudTableCluster($request)
    {
        return $this->createCloudTableClusterWithHttpInfo($request);
    }

    public function createCloudTableClusterWithHttpInfo($request)
    {
