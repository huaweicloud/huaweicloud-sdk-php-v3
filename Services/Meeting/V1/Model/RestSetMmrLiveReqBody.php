...
class RestSetMmrLiveReqBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RestSetMmrLiveReqBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * liveState  0：停止Mmr会议直播 1：启动Mmr会议直播
    *
    * @var string[]
    */
