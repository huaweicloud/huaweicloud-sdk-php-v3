...
class SetMmrLiveRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SetMmrLiveRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Meeting\V1\Model\RestSetMmrLiveReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Meeting\V1\Model\RestSetMmrLiveReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Meeting\V1\Model\RestSetMmrLiveReqBody|null $body body
    *
    * @return $this
    */
