...
class SearchPrivateCorpDigitalInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchPrivateCorpDigitalInfoRequest';
    ...
    * account  被绑定的登录账号或realNameAccount经过base64编码后的信息。
    * language  传译语言。
    *
    * @var string[]
    */
