...
class MeetingClient extends Client
{
     ...
     * @return response
     */
    public function searchCorpDigitalInfoList($request)
    {
        return $this->searchCorpDigitalInfoListWithHttpInfo($request);
    }

    public function searchCorpDigitalInfoListWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function searchPrivateCorpDigitalInfo($request)
    {
        return $this->searchPrivateCorpDigitalInfoWithHttpInfo($request);
    }

    public function searchPrivateCorpDigitalInfoWithHttpInfo($request)
    {
