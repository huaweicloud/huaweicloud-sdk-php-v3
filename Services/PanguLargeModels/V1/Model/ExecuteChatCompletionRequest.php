...
class ExecuteChatCompletionRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'contentType' => 'string',
            'deploymentId' => 'string',
            'body' => '\HuaweiCloud\SDK\PanguLargeModels\V1\Model\ChatCompletionReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\PanguLargeModels\V1\Model\ChatCompletionReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\PanguLargeModels\V1\Model\ChatCompletionReq|null $body body
    *
    * @return $this
    */
