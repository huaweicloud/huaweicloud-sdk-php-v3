...
class ChatCompletionReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChatCompletionReq';
    ...
    * topP  一种替代温度采样的方法，称为nucleus sampling，取值范围：(0, 1]，其中模型考虑具有top_p 概率质量的标记的结果。因此 0.1 意味着只考虑构成前 10% 概率质量的标记。我们通常建议更改此值或温度，但不要同时更改两者。通常建议更改top_p或temperature来调整生成文本的倾向性，但不要同时更改这两个参数。
    ...
    */
    protected static $openAPITypes = [
            'messages' => '\HuaweiCloud\SDK\PanguLargeModels\V1\Model\Message[]',
            'user' => 'string',
            'stream' => 'bool',
            'temperature' => 'float',
            'topP' => 'float',
    ...
    *  多轮对话问答对
    *
    * @return \HuaweiCloud\SDK\PanguLargeModels\V1\Model\Message[]
    */
    ...
    * Sets messages
    *
    * @param \HuaweiCloud\SDK\PanguLargeModels\V1\Model\Message[] $messages 多轮对话问答对
    *
    * @return $this
    */
    ...
    * Sets topP
    *
    * @param float|null $topP 一种替代温度采样的方法，称为nucleus sampling，取值范围：(0, 1]，其中模型考虑具有top_p 概率质量的标记的结果。因此 0.1 意味着只考虑构成前 10% 概率质量的标记。我们通常建议更改此值或温度，但不要同时更改两者。通常建议更改top_p或temperature来调整生成文本的倾向性，但不要同时更改这两个参数。
    *
    * @return $this
    */
