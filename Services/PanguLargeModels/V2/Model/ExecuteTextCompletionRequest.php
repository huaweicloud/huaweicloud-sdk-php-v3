...
class ExecuteTextCompletionRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'poolId' => 'string',
            'deploymentId' => 'string',
            'body' => '\HuaweiCloud\SDK\PanguLargeModels\V2\Model\TextCompletionReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\PanguLargeModels\V2\Model\TextCompletionReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\PanguLargeModels\V2\Model\TextCompletionReq|null $body body
    *
    * @return $this
    */
