...
class ChatCompletionReq implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'messages' => '\HuaweiCloud\SDK\PanguLargeModels\V2\Model\Message[]',
            'user' => 'string',
            'stream' => 'bool',
            'temperature' => 'float',
            'topP' => 'float',
    ...
    *  多轮对话问答对
    *
    * @return \HuaweiCloud\SDK\PanguLargeModels\V2\Model\Message[]
    */
    ...
    * Sets messages
    *
    * @param \HuaweiCloud\SDK\PanguLargeModels\V2\Model\Message[] $messages 多轮对话问答对
    *
    * @return $this
    */
