...
class PanguLargeModelsAsyncClient extends Client
{
    ...
    public function executeChatCompletionAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v2/{project_id}/pools/{pool_id}/deployments/{deployment_id}/chat/completions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $responseType='\HuaweiCloud\SDK\PanguLargeModels\V2\Model\ExecuteChatCompletionResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\PanguLargeModels\V2\Model\ExecuteChatCompletionRequest',
            $asyncRequest = true);
    }
    ...
    public function executeTextCompletionAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v2/{project_id}/pools/{pool_id}/deployments/{deployment_id}/text/completions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\PanguLargeModels\V2\Model\ExecuteTextCompletionResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\PanguLargeModels\V2\Model\ExecuteTextCompletionRequest',
            $asyncRequest = true);
    }
