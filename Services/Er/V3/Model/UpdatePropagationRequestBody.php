...
class UpdatePropagationRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePropagationRequestBody';
    ...
    *  routePolicy
    *
    * @return \HuaweiCloud\SDK\Er\V3\Model\ImportRoutePolicy
    */
    ...
    * Sets routePolicy
    *
    * @param \HuaweiCloud\SDK\Er\V3\Model\ImportRoutePolicy $routePolicy routePolicy
    *
    * @return $this
    */
