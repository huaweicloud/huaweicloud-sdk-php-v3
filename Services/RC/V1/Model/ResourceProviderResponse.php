...
class ResourceProviderResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'resourceTypes' => '\HuaweiCloud\SDK\Rc\V1\Model\ResourceTypeResponse[]'
    ];
    ...
    *  资源类型列表
    *
    * @return \HuaweiCloud\SDK\Rc\V1\Model\ResourceTypeResponse[]|null
    */
    ...
    * Sets resourceTypes
    *
    * @param \HuaweiCloud\SDK\Rc\V1\Model\ResourceTypeResponse[]|null $resourceTypes 资源类型列表
    *
    * @return $this
    */
