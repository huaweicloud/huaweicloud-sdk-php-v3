...
class AddResourcesRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddResourcesRequestBody';
    ...
    * Sets resourceIds
    *
    * @param string[] $resourceIds 资源标识列表
    *
    * @return $this
    */
