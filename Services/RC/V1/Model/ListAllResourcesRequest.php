...
class ListAllResourcesRequest implements ModelInterface, ArrayAccess
{
    ...
    * tags  标签列表
    * groupId  资源组ID
    * sortKey  排序字段列表，仅支持createdAt和updatedAt
    * sortValue  排序顺序列表，仅支持asc和desc
    *
    * @var string[]
    */
    ...
    * Sets sortKey
    *
    * @param string[]|null $sortKey 排序字段列表，仅支持createdAt和updatedAt
    *
    * @return $this
    */
    ...
    * Sets sortValue
    *
    * @param string[]|null $sortValue 排序顺序列表，仅支持asc和desc
    *
    * @return $this
    */
