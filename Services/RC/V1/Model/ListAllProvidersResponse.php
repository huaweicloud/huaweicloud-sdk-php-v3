...
class ListAllProvidersResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'resourceProviders' => '\HuaweiCloud\SDK\Rc\V1\Model\ResourceProviderResponse[]',
            'totalCount' => 'int'
    ];
    ...
    *  云服务详情列表
    *
    * @return \HuaweiCloud\SDK\Rc\V1\Model\ResourceProviderResponse[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Rc\V1\Model\ResourceProviderResponse[]|null $resourceProviders 云服务详情列表
    *
    * @return $this
    */
