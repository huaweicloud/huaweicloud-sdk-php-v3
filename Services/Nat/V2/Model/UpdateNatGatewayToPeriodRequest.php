...
class UpdateNatGatewayToPeriodRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateNatGatewayToPeriodRequest';
    ...
    */
    protected static $openAPITypes = [
            'natGatewayId' => 'string',
            'body' => '\HuaweiCloud\SDK\Nat\V2\Model\UpdateNatGatewayToPeriodRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Nat\V2\Model\UpdateNatGatewayToPeriodRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Nat\V2\Model\UpdateNatGatewayToPeriodRequestBody|null $body body
    *
    * @return $this
    */
