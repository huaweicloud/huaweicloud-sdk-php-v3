...
class BatchCreateRemediationExceptionsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateRemediationExceptionsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Config\V1\Model\BatchCreateRemediationExceptionsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Config\V1\Model\BatchCreateRemediationExceptionsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Config\V1\Model\BatchCreateRemediationExceptionsRequestBody|null $body body
    *
    * @return $this
    */
