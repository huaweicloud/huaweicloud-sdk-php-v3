...
class UpdateOrganizationConformancePackRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateOrganizationConformancePackRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Config\V1\Model\UpdateOrgConformancePackRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Config\V1\Model\UpdateOrgConformancePackRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Config\V1\Model\UpdateOrgConformancePackRequestBody|null $body body
    *
    * @return $this
    */
