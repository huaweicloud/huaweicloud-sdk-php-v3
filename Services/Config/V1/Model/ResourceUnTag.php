...
class ResourceUnTag implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResourceUnTag';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * key  键。最大长度128个unicode字符。 key符合3.1 KEY字符集规范。
    * value  值。每个值最大长度255个unicode字符。value符合3.2 VALUE字符集规范。
    *
    * @var string[]
    */
    ...
    * Sets key
    *
    * @param string $key 键。最大长度128个unicode字符。 key符合3.1 KEY字符集规范。
    *
    * @return $this
    */
    ...
    * Sets value
    *
    * @param string $value 值。每个值最大长度255个unicode字符。value符合3.2 VALUE字符集规范。
    *
    * @return $this
    */
