...
class UpdateConformancePackRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateConformancePackRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Config\V1\Model\UpdateConformancePackRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Config\V1\Model\UpdateConformancePackRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Config\V1\Model\UpdateConformancePackRequestBody|null $body body
    *
    * @return $this
    */
