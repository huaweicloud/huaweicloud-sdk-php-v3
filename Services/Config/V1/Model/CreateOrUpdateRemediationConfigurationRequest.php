...
class CreateOrUpdateRemediationConfigurationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateOrUpdateRemediationConfigurationRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Config\V1\Model\RemediationConfigurationRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Config\V1\Model\RemediationConfigurationRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Config\V1\Model\RemediationConfigurationRequestBody|null $body body
    *
    * @return $this
    */
