...
class CollectResourcesPolicyStatesSummaryRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CollectResourcesPolicyStatesSummaryRequest';
