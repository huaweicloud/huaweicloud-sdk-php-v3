...
class ListRemediationExecutionStatusesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRemediationExecutionStatusesRequest';
