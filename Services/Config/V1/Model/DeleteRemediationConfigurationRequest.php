...
class DeleteRemediationConfigurationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteRemediationConfigurationRequest';
