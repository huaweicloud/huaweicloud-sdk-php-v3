...
class ShowRemediationConfigurationResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowRemediationConfigurationResponse';
