...
class RemediationConfigurationRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RemediationConfigurationRequestBody';
    ...
    * targetRegionId  修正执行的目标的regionId。如果修正方式为RFS，该字段为空则Config服务会默认配置北京四（中国站）或香港一（国际站）的regionId；如果修正方式为FGS，该字段为空则Config服务会根据实例urn自动配置。
    ...
    */
    ...
    const TARGET_TYPE_FGS = 'fgs';
    const TARGET_TYPE_RFS = 'rfs';
    const AUTH_TYPE_AGENCY = 'agency';
    const AUTH_TYPE_TRUST_AGENCY = 'trustAgency';
    ...
    */
    ...
    {
        return [
            self::TARGET_TYPE_FGS,
            self::TARGET_TYPE_RFS,
        ];
    }
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['targetId'] === null) {
            ...
            if ((mb_strlen($this->container['targetId']) > 512)) {
                $invalidProperties[] = "invalid value for 'targetId', the character length must be smaller than or equal to 512.";
            }
            if (!is_null($this->container['targetRegionId']) && (mb_strlen($this->container['targetRegionId']) > 36)) {
                $invalidProperties[] = "invalid value for 'targetRegionId', the character length must be smaller than or equal to 36.";
            }
            if (!is_null($this->container['targetRegionId']) && (mb_strlen($this->container['targetRegionId']) < 1)) {
                $invalidProperties[] = "invalid value for 'targetRegionId', the character length must be bigger than or equal to 1.";
            }
            if (!is_null($this->container['targetRegionId']) && !preg_match("/[\\w-]+/", $this->container['targetRegionId'])) {
                $invalidProperties[] = "invalid value for 'targetRegionId', must be conform to the pattern /[\\w-]+/.";
            }
            if (!is_null($this->container['targetProjectId']) && (mb_strlen($this->container['targetProjectId']) > 36)) {
                $invalidProperties[] = "invalid value for 'targetProjectId', the character length must be smaller than or equal to 36.";
            }
            ...
            if (!is_null($this->container['targetProjectId']) && !preg_match("/[\\w-]+/", $this->container['targetProjectId'])) {
                $invalidProperties[] = "invalid value for 'targetProjectId', must be conform to the pattern /[\\w-]+/.";
            }
        if ($this->container['resourceParameter'] === null) {
            $invalidProperties[] = "'resourceParameter' can't be null";
        }
            ...
            if (!is_null($this->container['retryAttemptSeconds']) && ($this->container['retryAttemptSeconds'] > 43200)) {
                $invalidProperties[] = "invalid value for 'retryAttemptSeconds', must be smaller than or equal to 43200.";
            }
    ...
    * Sets targetType
    *
    * @param string $targetType 合规规则修正执行的方式。
    *
    * @return $this
    */
    ...
    * Sets targetId
    *
    * @param string $targetId 修正执行的目标ID。如果修正方式为fgs，则该值为函数工作流的函数urn；如果修正方式为rfs，则该值为资源编排服务的模板name与版本号，两者以/分割，如果没有指定默认V1。
    *
    * @return $this
    */
    ...
    * Sets targetRegionId
    *
    * @param string|null $targetRegionId 修正执行的目标的regionId。如果修正方式为RFS，该字段为空则Config服务会默认配置北京四（中国站）或香港一（国际站）的regionId；如果修正方式为FGS，该字段为空则Config服务会根据实例urn自动配置。
    *
    * @return $this
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Config\V1\Model\RemediationStaticParameter[]|null $staticParameter 修正执行的静态参数。
    *
    * @return $this
    */
    ...
    *  resourceParameter
    *
    * @return \HuaweiCloud\SDK\Config\V1\Model\RemediationResourceParameter
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Config\V1\Model\RemediationResourceParameter $resourceParameter resourceParameter
    *
    * @return $this
    */
