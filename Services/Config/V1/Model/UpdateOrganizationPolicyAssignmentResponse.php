...
class UpdateOrganizationPolicyAssignmentResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateOrganizationPolicyAssignmentResponse';
