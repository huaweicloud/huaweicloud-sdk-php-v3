...
class CheckScriptRiskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CheckScriptRiskRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xProjectId' => 'string',
            'xUserProfile' => 'string',
            'body' => '\HuaweiCloud\SDK\Coc\V1\Model\JobScriptAnalyzeRequest'
    ];
    ...
    * Sets xProjectId
    *
    * @param string|null $xProjectId 项目ID。
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\JobScriptAnalyzeRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\JobScriptAnalyzeRequest|null $body body
    *
    * @return $this
    */
