...
class CreateWarRoomResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateWarRoomResponse';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['data']) && (mb_strlen($this->container['data']) > 255)) {
                $invalidProperties[] = "invalid value for 'data', the character length must be smaller than or equal to 255.";
            }
    ...
    * Sets data
    *
    * @param string|null $data WarRoom id
    *
    * @return $this
    */
