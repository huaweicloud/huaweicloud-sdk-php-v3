...
class OperateScriptJobRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'OperateScriptJobRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xProjectId' => 'string',
            'xUserProfile' => 'string',
            'body' => '\HuaweiCloud\SDK\Coc\V1\Model\JobScriptOrderOperationBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\JobScriptOrderOperationBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\JobScriptOrderOperationBody|null $body body
    *
    * @return $this
    */
