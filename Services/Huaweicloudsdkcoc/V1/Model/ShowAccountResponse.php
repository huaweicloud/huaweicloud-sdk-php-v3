...
class ShowAccountResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAccountResponse';
    ...
    */
    protected static $openAPITypes = [
            'count' => 'int',
            'accountList' => '\HuaweiCloud\SDK\Coc\V1\Model\AccountRsp[]'
    ];
    ...
    *  账号list
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\AccountRsp[]|null
    */
    ...
    * Sets accountList
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\AccountRsp[]|null $accountList 账号list
    *
    * @return $this
    */
