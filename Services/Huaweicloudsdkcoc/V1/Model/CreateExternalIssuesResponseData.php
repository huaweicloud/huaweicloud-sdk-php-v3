...
class CreateExternalIssuesResponseData implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateExternalIssuesResponseData';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ticketId'] === null) {
            ...
            if ((mb_strlen($this->container['ticketId']) < 0)) {
