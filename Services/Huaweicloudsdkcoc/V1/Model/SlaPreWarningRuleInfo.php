...
class SlaPreWarningRuleInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SlaPreWarningRuleInfo';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['minute']) && ($this->container['minute'] > 60)) {
                $invalidProperties[] = "invalid value for 'minute', must be smaller than or equal to 60.";
            }
    ...
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\NotificationObjConfiguration[]|null $notificationObjConfiguration 通知对象配置
    *
    * @return $this
    */
