...
class ExecuteDocumentRequsetBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExecuteDocumentRequsetBody';
    ...
    */
    protected static $openAPITypes = [
            'version' => 'string',
            'parameters' => '\HuaweiCloud\SDK\Coc\V1\Model\ExecuteDocumentRequsetBodyParameters[]',
            'sysTags' => '\HuaweiCloud\SDK\Coc\V1\Model\ExecuteDocumentRequsetBodySysTags[]',
            'targetParameterName' => 'string',
            'targets' => '\HuaweiCloud\SDK\Coc\V1\Model\ExecuteDocumentRequsetBodyTargets[]',
            'documentType' => 'string',
            'description' => 'string'
    ];
    ...
    *  全局参数
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\ExecuteDocumentRequsetBodyParameters[]|null
    */
    ...
    * Sets parameters
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\ExecuteDocumentRequsetBodyParameters[]|null $parameters 全局参数
    *
    * @return $this
    */
    ...
    *  系统标签列表
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\ExecuteDocumentRequsetBodySysTags[]|null
    */
    ...
    * Sets sysTags
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\ExecuteDocumentRequsetBodySysTags[]|null $sysTags 系统标签列表
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\ExecuteDocumentRequsetBodyTargets[]|null
    */
    ...
    * Sets targets
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\ExecuteDocumentRequsetBodyTargets[]|null $targets 与target_parameter_name搭配使用。选择实例化target_parameter_name参数的方式。
    *
    * @return $this
    */
