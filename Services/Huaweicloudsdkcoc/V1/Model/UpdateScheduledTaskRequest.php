...
class UpdateScheduledTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'taskId' => 'string',
            'body' => '\HuaweiCloud\SDK\Coc\V1\Model\ScheduledTaskRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\ScheduledTaskRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\ScheduledTaskRequestBody|null $body body
    *
    * @return $this
    */
