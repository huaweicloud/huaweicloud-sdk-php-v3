...
class CustomBaselineRulePatchItem implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CustomBaselineRulePatchItem';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['createdTime']) && ($this->container['createdTime'] > 9223372036854775807)) {
                $invalidProperties[] = "invalid value for 'createdTime', must be smaller than or equal to 9223372036854775807.";
            }
    ...
    * Sets version
    *
    * @param string|null $version 补丁版本
    *
    * @return $this
    */
