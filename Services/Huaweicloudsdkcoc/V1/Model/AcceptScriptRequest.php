...
class AcceptScriptRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AcceptScriptRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xUserProfile' => 'string',
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\Coc\V1\Model\ApprovalJobScriptModel'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\ApprovalJobScriptModel|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\ApprovalJobScriptModel|null $body body
    *
    * @return $this
    */
