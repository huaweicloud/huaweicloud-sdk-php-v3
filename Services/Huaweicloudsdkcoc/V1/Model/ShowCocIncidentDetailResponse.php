...
class ShowCocIncidentDetailResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowCocIncidentDetailResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'errorCode' => 'string',
            'errorMsg' => 'string',
            'data' => '\HuaweiCloud\SDK\Coc\V1\Model\IncidentTicketInfoResponseData'
    ];
    ...
    *  data
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\IncidentTicketInfoResponseData|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\IncidentTicketInfoResponseData|null $data data
    *
    * @return $this
    */
