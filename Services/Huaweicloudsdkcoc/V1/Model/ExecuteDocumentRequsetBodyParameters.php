...
class ExecuteDocumentRequsetBodyParameters implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExecuteDocumentRequsetBody_parameters';
    ...
    * Sets value
    *
    * @param string|null $value 参数的value
    *
    * @return $this
    */
