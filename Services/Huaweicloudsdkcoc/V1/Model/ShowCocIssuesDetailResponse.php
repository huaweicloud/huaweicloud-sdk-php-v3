...
class ShowCocIssuesDetailResponse implements ModelInterface, ArrayAccess
{
    ...
    *  data
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\CocIssuesTicketDetailInfoResponseData
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\CocIssuesTicketDetailInfoResponseData $data data
    *
    * @return $this
    */
