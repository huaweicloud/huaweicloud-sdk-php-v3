...
class ExcutionStep implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExcutionStep';
    ...
    */
    protected static $openAPITypes = [
            ...
            'name' => 'string',
            'status' => 'string',
            'inputs' => '\HuaweiCloud\SDK\Coc\V1\Model\ExcutionStepInputs[]',
            'outputs' => '\HuaweiCloud\SDK\Coc\V1\Model\ExcutionStepInputs[]',
    ...
    *  步骤输入参数
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\ExcutionStepInputs[]|null
    */
    ...
    * Sets inputs
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\ExcutionStepInputs[]|null $inputs 步骤输入参数
    *
    * @return $this
    */
    ...
    * Sets outputs
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\ExcutionStepInputs[]|null $outputs 步骤输出参数
    *
    * @return $this
    */
