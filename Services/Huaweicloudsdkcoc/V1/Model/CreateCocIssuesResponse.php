...
class CreateCocIssuesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCocIssuesResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'errorCode' => 'string',
            'errorMsg' => 'string',
            'data' => '\HuaweiCloud\SDK\Coc\V1\Model\CreateExternalIssuesResponseData'
    ];
    ...
    *  data
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\CreateExternalIssuesResponseData|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\CreateExternalIssuesResponseData|null $data data
    *
    * @return $this
    */
