...
class EnableScheduledTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'EnableScheduledTaskRequest';
    ...
    */
    protected static $openAPITypes = [
            'taskId' => 'string',
            'body' => '\HuaweiCloud\SDK\Coc\V1\Model\EnableScheduledTaskRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\EnableScheduledTaskRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\EnableScheduledTaskRequestBody|null $body body
    *
    * @return $this
    */
