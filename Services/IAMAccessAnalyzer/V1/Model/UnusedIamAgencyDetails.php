...
class UnusedIamAgencyDetails implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UnusedIamAgencyDetails';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * lastAccessed  用户使用委托的最后访问时间。
    *
    * @var string[]
    */
    ...
    * Sets lastAccessed
    *
    * @param \DateTime|null $lastAccessed 用户使用委托的最后访问时间。
    *
    * @return $this
    */
