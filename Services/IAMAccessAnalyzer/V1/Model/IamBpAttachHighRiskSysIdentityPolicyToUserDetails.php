...
class IamBpAttachHighRiskSysIdentityPolicyToUserDetails implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'IamBpAttachHighRiskSysIdentityPolicyToUserDetails';
