...
class ListResourceConfigurationsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListResourceConfigurationsResponse';
    ...
    *  提权访问中的资源配置。
    *
    * @return \HuaweiCloud\SDK\IAMAccessAnalyzer\V1\Model\ResourceConfiguration[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\IAMAccessAnalyzer\V1\Model\ResourceConfiguration[]|null $resourceConfigurations 提权访问中的资源配置。
    *
    * @return $this
    */
