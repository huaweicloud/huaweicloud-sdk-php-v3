...
class NotificationSettingSummary implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NotificationSettingSummary';
    ...
    * Sets urn
    *
    * @param string $urn 消息通知配置的唯一资源标识符。
    *
    * @return $this
    */
    ...
    * Sets analyzerName
    *
    * @param string $analyzerName 分析器的名称。
    *
    * @return $this
    */
    ...
    * Sets analyzerType
    *
    * @param \HuaweiCloud\SDK\IAMAccessAnalyzer\V1\Model\AnalyzerType $analyzerType analyzerType
    *
    * @return $this
    */
    ...
    * Sets createdAt
    *
    * @param \DateTime $createdAt 创建消息通知配置的时间。
    *
    * @return $this
    */
    ...
    * Sets updatedAt
    *
    * @param \DateTime $updatedAt 上次更新消息通知配置的时间。
    *
    * @return $this
    */
