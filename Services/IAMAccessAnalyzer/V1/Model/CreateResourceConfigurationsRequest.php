...
class CreateResourceConfigurationsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateResourceConfigurationsRequest';
    ...
    */
    protected static $openAPITypes = [
            'analyzerId' => 'string',
            'body' => '\HuaweiCloud\SDK\IAMAccessAnalyzer\V1\Model\CreateResourceConfigurationsReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IAMAccessAnalyzer\V1\Model\CreateResourceConfigurationsReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IAMAccessAnalyzer\V1\Model\CreateResourceConfigurationsReqBody|null $body body
    *
    * @return $this
    */
