...
class UnusedIamUserPasswordDetails implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UnusedIamUserPasswordDetails';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * lastAccessed  用户密码的最后访问时间。
    *
    * @var string[]
    */
    ...
    * Sets lastAccessed
    *
    * @param \DateTime|null $lastAccessed 用户密码的最后访问时间。
    *
    * @return $this
    */
