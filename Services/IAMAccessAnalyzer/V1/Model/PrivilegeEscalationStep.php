...
class PrivilegeEscalationStep implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PrivilegeEscalationStep';
    ...
    * Sets resources
    *
    * @param string[] $resources 本步骤涉及到的资源。
    *
    * @return $this
    */
