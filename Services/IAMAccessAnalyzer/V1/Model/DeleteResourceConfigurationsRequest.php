...
class DeleteResourceConfigurationsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteResourceConfigurationsRequest';
    ...
    */
    protected static $openAPITypes = [
            'analyzerId' => 'string',
            'body' => '\HuaweiCloud\SDK\IAMAccessAnalyzer\V1\Model\DeleteResourceConfigurationReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IAMAccessAnalyzer\V1\Model\DeleteResourceConfigurationReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IAMAccessAnalyzer\V1\Model\DeleteResourceConfigurationReqBody|null $body body
    *
    * @return $this
    */
