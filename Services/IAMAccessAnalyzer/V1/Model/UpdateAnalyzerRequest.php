...
class UpdateAnalyzerRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAnalyzerRequest';
    ...
    */
    protected static $openAPITypes = [
            'analyzerId' => 'string',
            'body' => '\HuaweiCloud\SDK\IAMAccessAnalyzer\V1\Model\UpdateAnalyzerReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IAMAccessAnalyzer\V1\Model\UpdateAnalyzerReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IAMAccessAnalyzer\V1\Model\UpdateAnalyzerReqBody|null $body body
    *
    * @return $this
    */
