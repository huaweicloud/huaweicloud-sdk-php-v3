...
class BatchListMfaDevicesForUserRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchListMfaDevicesForUserRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\IdentityCenterStore\V1\Model\BatchListMfaDevicesForUserReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IdentityCenterStore\V1\Model\BatchListMfaDevicesForUserReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IdentityCenterStore\V1\Model\BatchListMfaDevicesForUserReqBody|null $body body
    *
    * @return $this
    */
