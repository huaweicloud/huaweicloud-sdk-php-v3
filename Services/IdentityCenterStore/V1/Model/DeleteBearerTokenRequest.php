...
class DeleteBearerTokenRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteBearerTokenRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tokenId'] === null) {
            ...
            if ((mb_strlen($this->container['tokenId']) < 1)) {
                $invalidProperties[] = "invalid value for 'tokenId', the character length must be bigger than or equal to 1.";
            }
            if (!preg_match("/^[a-zA-Z0-9-]{1,64}$/", $this->container['tokenId'])) {
                $invalidProperties[] = "invalid value for 'tokenId', must be conform to the pattern /^[a-zA-Z0-9-]{1,64}$/.";
            }
