...
class BatchDeleteSessionsReqBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteSessionsReqBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * sessionIds  用户登录会话标识符（ID）
    *
    * @var string[]
    */
    ...
    * Sets sessionIds
    *
    * @param string[] $sessionIds 用户登录会话标识符（ID）
    *
    * @return $this
    */
