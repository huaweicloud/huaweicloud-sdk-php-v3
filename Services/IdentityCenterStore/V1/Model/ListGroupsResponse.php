...
class ListGroupsResponse implements ModelInterface, ArrayAccess
{
    ...
    * groups  满足查询条件的用户组对象列表
    * pageInfo  pageInfo
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'groups' => '\HuaweiCloud\SDK\IdentityCenterStore\V1\Model\GroupDto[]',
    ...
    *  满足查询条件的用户组对象列表
    *
    * @return \HuaweiCloud\SDK\IdentityCenterStore\V1\Model\GroupDto[]|null
    */
    ...
    * Sets groups
    *
    * @param \HuaweiCloud\SDK\IdentityCenterStore\V1\Model\GroupDto[]|null $groups 满足查询条件的用户组对象列表
    *
    * @return $this
    */
