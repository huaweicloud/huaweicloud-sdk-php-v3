...
class AttributeOperationDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AttributeOperationDto';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * attributePath  要更新的属性的字符串表示
    * attributeValue  要更新的属性值。当属性为对象类型时，此处填写对象的JSON字符串。为null时表示删除对应属性
    *
    * @var string[]
    */
    ...
    * Sets attributePath
    *
    * @param string $attributePath 要更新的属性的字符串表示
    *
    * @return $this
    */
    ...
    * Sets attributeValue
    *
    * @param string|null $attributeValue 要更新的属性值。当属性为对象类型时，此处填写对象的JSON字符串。为null时表示删除对应属性
    *
    * @return $this
    */
