...
class DescribeGroupsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DescribeGroupsRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * groupIds  用户组唯一标识符（ID）列表
    *
    * @var string[]
    */
    ...
    * Sets groupIds
    *
    * @param string[] $groupIds 用户组唯一标识符（ID）列表
    *
    * @return $this
    */
