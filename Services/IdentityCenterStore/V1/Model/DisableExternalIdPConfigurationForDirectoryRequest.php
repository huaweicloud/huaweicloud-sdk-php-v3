...
class DisableExternalIdPConfigurationForDirectoryRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DisableExternalIdPConfigurationForDirectoryRequest';
