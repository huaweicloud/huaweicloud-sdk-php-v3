...
class BatchDeleteSessionsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteSessionsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'userId' => 'string',
            'body' => '\HuaweiCloud\SDK\IdentityCenterStore\V1\Model\BatchDeleteSessionsReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IdentityCenterStore\V1\Model\BatchDeleteSessionsReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IdentityCenterStore\V1\Model\BatchDeleteSessionsReqBody|null $body body
    *
    * @return $this
    */
