...
class EnableExternalIdPConfigurationForDirectoryRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'EnableExternalIdPConfigurationForDirectoryRequest';
