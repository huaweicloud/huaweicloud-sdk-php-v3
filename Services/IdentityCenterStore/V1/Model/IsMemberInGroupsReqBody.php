...
class IsMemberInGroupsReqBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'IsMemberInGroupsReqBody';
    ...
    * Sets groupIds
    *
    * @param string[] $groupIds 用户组标识符列表
    *
    * @return $this
    */
