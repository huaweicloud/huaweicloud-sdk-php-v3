...
class DescribeGroupMembershipRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DescribeGroupMembershipRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['membershipId'] === null) {
            ...
            if ((mb_strlen($this->container['membershipId']) > 64)) {
                $invalidProperties[] = "invalid value for 'membershipId', the character length must be smaller than or equal to 64.";
            }
            if ((mb_strlen($this->container['membershipId']) < 1)) {
                $invalidProperties[] = "invalid value for 'membershipId', the character length must be bigger than or equal to 1.";
            }
            if (!preg_match("/^[a-zA-Z0-9-]{1,64}$/", $this->container['membershipId'])) {
                $invalidProperties[] = "invalid value for 'membershipId', must be conform to the pattern /^[a-zA-Z0-9-]{1,64}$/.";
            }
