...
class ListGroupMembershipsForMemberRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGroupMembershipsForMemberRequest';
