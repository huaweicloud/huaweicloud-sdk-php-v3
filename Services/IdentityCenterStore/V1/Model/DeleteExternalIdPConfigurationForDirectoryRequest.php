...
class DeleteExternalIdPConfigurationForDirectoryRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteExternalIdPConfigurationForDirectoryRequest';
