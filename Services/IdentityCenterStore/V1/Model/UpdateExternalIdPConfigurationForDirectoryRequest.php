...
class UpdateExternalIdPConfigurationForDirectoryRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateExternalIdPConfigurationForDirectoryRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'idpId' => 'string',
            'body' => '\HuaweiCloud\SDK\IdentityCenterStore\V1\Model\UpdateExternalIdPConfigurationForDirectoryReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IdentityCenterStore\V1\Model\UpdateExternalIdPConfigurationForDirectoryReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IdentityCenterStore\V1\Model\UpdateExternalIdPConfigurationForDirectoryReqBody|null $body body
    *
    * @return $this
    */
