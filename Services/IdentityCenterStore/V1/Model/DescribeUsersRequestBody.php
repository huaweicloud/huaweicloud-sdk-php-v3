...
class DescribeUsersRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DescribeUsersRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * userIds  用户唯一标识符（ID）列表
    *
    * @var string[]
    */
    ...
    * Sets userIds
    *
    * @param string[] $userIds 用户唯一标识符（ID）列表
    *
    * @return $this
    */
