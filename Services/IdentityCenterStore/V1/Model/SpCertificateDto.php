...
class SpCertificateDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SpCertificateDto';
    ...
    *
    * @param string $x509certificate x509证书
    *
    * @return $this
    */
