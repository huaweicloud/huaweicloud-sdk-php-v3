...
class ResetPwdModeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResetPwdModeRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'userId' => 'string',
            'body' => '\HuaweiCloud\SDK\IdentityCenterStore\V1\Model\UpdatePwdModeReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IdentityCenterStore\V1\Model\UpdatePwdModeReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IdentityCenterStore\V1\Model\UpdatePwdModeReqBody|null $body body
    *
    * @return $this
    */
