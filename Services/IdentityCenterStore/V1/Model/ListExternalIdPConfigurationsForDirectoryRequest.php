...
class ListExternalIdPConfigurationsForDirectoryRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListExternalIdPConfigurationsForDirectoryRequest';
