...
class UpdateUserRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'userId' => 'string',
            'body' => '\HuaweiCloud\SDK\IdentityCenterStore\V1\Model\UpdateUserReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IdentityCenterStore\V1\Model\UpdateUserReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IdentityCenterStore\V1\Model\UpdateUserReqBody|null $body body
    *
    * @return $this
    */
