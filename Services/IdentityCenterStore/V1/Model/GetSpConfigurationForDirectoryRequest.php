...
class GetSpConfigurationForDirectoryRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GetSpConfigurationForDirectoryRequest';
