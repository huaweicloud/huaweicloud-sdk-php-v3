...
class UpdateMfaDeviceForUserRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateMfaDeviceForUserRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'userId' => 'string',
            'deviceId' => 'string',
            'body' => '\HuaweiCloud\SDK\IdentityCenterStore\V1\Model\UpdateMfaDeviceForUserReqBody'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['userId'] === null) {
            ...
            if (!preg_match("/^[a-zA-Z0-9-]{1,64}$/", $this->container['userId'])) {
                $invalidProperties[] = "invalid value for 'userId', must be conform to the pattern /^[a-zA-Z0-9-]{1,64}$/.";
            }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IdentityCenterStore\V1\Model\UpdateMfaDeviceForUserReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IdentityCenterStore\V1\Model\UpdateMfaDeviceForUserReqBody|null $body body
    *
    * @return $this
    */
