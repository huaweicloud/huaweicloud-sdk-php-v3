...
class RetrieveMfaDevicesForUserDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RetrieveMfaDevicesForUserDto';
    ...
    * Sets userId
    *
    * @param string $userId 用户唯一标识符（ID）
    *
    * @return $this
    */
