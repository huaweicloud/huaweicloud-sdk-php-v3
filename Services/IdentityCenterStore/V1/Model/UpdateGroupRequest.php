...
class UpdateGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'groupId' => 'string',
            'body' => '\HuaweiCloud\SDK\IdentityCenterStore\V1\Model\UpdateGroupReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IdentityCenterStore\V1\Model\UpdateGroupReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IdentityCenterStore\V1\Model\UpdateGroupReqBody|null $body body
    *
    * @return $this
    */
