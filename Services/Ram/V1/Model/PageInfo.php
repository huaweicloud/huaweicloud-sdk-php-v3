    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['previousMarker']) && !preg_match("/^\\d{1,}$/", $this->container['previousMarker'])) {
                $invalidProperties[] = "invalid value for 'previousMarker', must be conform to the pattern /^\\d{1,}$/.";
            }
            ...
            if (!is_null($this->container['nextMarker']) && !preg_match("/^\\d{1,}$/", $this->container['nextMarker'])) {
                $invalidProperties[] = "invalid value for 'nextMarker', must be conform to the pattern /^\\d{1,}$/.";
            }
