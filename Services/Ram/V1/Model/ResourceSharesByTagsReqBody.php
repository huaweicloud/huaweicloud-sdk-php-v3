...
class ResourceSharesByTagsReqBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResourceSharesByTagsReqBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * withoutAnyTag  不包含任意一个标签，该字段为true时查询所有不带标签的资源。
    * tags  包含标签，最多包含20个key，每个key下面的value最多20个，结构体不能缺失，key不能为空或者空字符串。Key不能重复，同一个key中values不能重复。返回包含所有标签的资源列表，key之间是\"与\"的关系，key-value结构中value是\"或\"的关系。无tag过滤条件时返回全量数据。
    * matches  资源共享实例绑定标签列表的匹配字段。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'withoutAnyTag' => 'bool',
            'tags' => '\HuaweiCloud\SDK\Ram\V1\Model\TagFilter[]',
            'matches' => '\HuaweiCloud\SDK\Ram\V1\Model\Match[]'
    ];
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\Ram\V1\Model\TagFilter[]|null $tags 包含标签，最多包含20个key，每个key下面的value最多20个，结构体不能缺失，key不能为空或者空字符串。Key不能重复，同一个key中values不能重复。返回包含所有标签的资源列表，key之间是\"与\"的关系，key-value结构中value是\"或\"的关系。无tag过滤条件时返回全量数据。
    *
    * @return $this
    */
    ...
    *  资源共享实例绑定标签列表的匹配字段。
    *
    * @return \HuaweiCloud\SDK\Ram\V1\Model\Match[]|null
    */
    ...
    * Sets matches
    *
    * @param \HuaweiCloud\SDK\Ram\V1\Model\Match[]|null $matches 资源共享实例绑定标签列表的匹配字段。
    *
    * @return $this
    */
