...
class SearchResourceShareCountByTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchResourceShareCountByTagsRequest';
