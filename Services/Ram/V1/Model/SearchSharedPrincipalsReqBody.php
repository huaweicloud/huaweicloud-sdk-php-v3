...
class SearchSharedPrincipalsReqBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchSharedPrincipalsReqBody';
    ...
    * Sets principals
    *
    * @param string[]|null $principals 指定资源使用者。
    *
    * @return $this
    */
