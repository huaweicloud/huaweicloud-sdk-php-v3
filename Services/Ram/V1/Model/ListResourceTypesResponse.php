...
class ListResourceTypesResponse implements ModelInterface, ArrayAccess
{
    ...
    * resourceTypes  云服务资源的详细信息列表。
    * pageInfo  pageInfo
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'resourceTypes' => '\HuaweiCloud\SDK\Ram\V1\Model\ResourceTypesSummary[]',
    ...
    *  云服务资源的详细信息列表。
    *
    * @return \HuaweiCloud\SDK\Ram\V1\Model\ResourceTypesSummary[]|null
    */
    ...
    * Sets resourceTypes
    *
    * @param \HuaweiCloud\SDK\Ram\V1\Model\ResourceTypesSummary[]|null $resourceTypes 云服务资源的详细信息列表。
    *
    * @return $this
    */
