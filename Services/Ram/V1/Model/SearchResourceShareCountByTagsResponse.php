...
class SearchResourceShareCountByTagsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchResourceShareCountByTagsResponse';
