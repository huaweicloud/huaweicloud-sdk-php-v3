...
class RejectResourceShareInvitationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RejectResourceShareInvitationRequest';
