...
class BatchCreateResourceShareTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateResourceShareTagsRequest';
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ram\V1\Model\TagResourceReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ram\V1\Model\TagResourceReqBody|null $body body
    *
    * @return $this
    */
