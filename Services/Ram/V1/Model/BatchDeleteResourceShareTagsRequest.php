...
class BatchDeleteResourceShareTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteResourceShareTagsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Ram\V1\Model\UntagResourceReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ram\V1\Model\UntagResourceReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ram\V1\Model\UntagResourceReqBody|null $body body
    *
    * @return $this
    */
