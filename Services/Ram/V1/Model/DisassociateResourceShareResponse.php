...
class DisassociateResourceShareResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DisassociateResourceShareResponse';
    ...
    *
    * @param \HuaweiCloud\SDK\Ram\V1\Model\ResourceShareAssociation[]|null $resourceShareAssociations resourceShareAssociations
    *
    * @return $this
    */
