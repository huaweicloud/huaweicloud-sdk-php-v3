...
class Untag implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'Untag';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * key  标签\"键\"的标识符或名称。
    * value  标签\"键\"对应的\"值\"。您可以将标签的值设置为空字符串，但不能设置为null。
    *
    * @var string[]
    */
    ...
    * Sets value
    *
    * @param string|null $value 标签\"键\"对应的\"值\"。您可以将标签的值设置为空字符串，但不能设置为null。
    *
    * @return $this
    */
