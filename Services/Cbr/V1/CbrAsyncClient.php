...
class CbrAsyncClient extends Client
{
     ...
     * @return response
     */
    public function changeOrderAsync($request)
    {
        return $this->changeOrderAsyncWithHttpInfo($request);
    }
    
    public function changeOrderAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function changeVaultChargeModeAsync($request)
    {
        return $this->changeVaultChargeModeAsyncWithHttpInfo($request);
    }
    
    public function changeVaultChargeModeAsyncWithHttpInfo($request){
        $collection_formats = [];
