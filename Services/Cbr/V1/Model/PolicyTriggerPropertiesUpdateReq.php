...
class PolicyTriggerPropertiesUpdateReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PolicyTriggerPropertiesUpdateReq';
    ...
    * startWindowMinutes  启动时间窗口大小，取值范围[60,480]或者为null。其中null表示取消设置启动时间窗口特性。
    *
    * @var string[]
    */
    ...
    *
    * @param int|null $startWindowMinutes 启动时间窗口大小，取值范围[60,480]或者为null。其中null表示取消设置启动时间窗口特性。
    *
    * @return $this
    */
