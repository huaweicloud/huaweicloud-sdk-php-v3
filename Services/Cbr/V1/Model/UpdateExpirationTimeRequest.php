...
class UpdateExpirationTimeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateExpirationTimeRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * vaultId  存储库ID，默认取值不涉及。 [获取方法请参见\"[获取存储库ID](https://support.huaweicloud.com/api-cbr/ListVault.html)\"。](tag:hws) [获取方法请参见\"[获取存储库ID](https://support.huaweicloud.com/intl/zh-cn/api-cbr/ListVault.html)\"。](tag:hws_hk)
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'vaultId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cbr\V1\Model\UpdateExpirationTimeReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cbr\V1\Model\UpdateExpirationTimeReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cbr\V1\Model\UpdateExpirationTimeReq|null $body body
    *
    * @return $this
    */
