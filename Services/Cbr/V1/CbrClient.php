...
class CbrClient extends Client
{
     ...
     * @return response
     */
    public function changeVaultChargeMode($request)
    {
        return $this->changeVaultChargeModeWithHttpInfo($request);
    }

    public function changeVaultChargeModeWithHttpInfo($request)
    {
        $resourcePath = '/v3/{project_id}/vaults/change-charge-mode';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Cbr\V1\Model\ChangeVaultChargeModeResponse',
            $requestType='\HuaweiCloud\SDK\Cbr\V1\Model\ChangeVaultChargeModeRequest');
    }
     ...
     * @return response
     */
    public function showFeature($request)
    {
        return $this->showFeatureWithHttpInfo($request);
    }

    public function showFeatureWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function updateExpirationTime($request)
    {
        return $this->updateExpirationTimeWithHttpInfo($request);
    }

    public function updateExpirationTimeWithHttpInfo($request)
    {
