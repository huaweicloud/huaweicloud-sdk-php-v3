...
class ModelArtsClient extends Client
{
     ...
     * @return response
     */
    public function attachDevServerPort($request)
    {
        return $this->attachDevServerPortWithHttpInfo($request);
    }

    public function attachDevServerPortWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function batchDrainPoolNodes($request)
    {
        return $this->batchDrainPoolNodesWithHttpInfo($request);
    }

    public function batchDrainPoolNodesWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function createInferTempApiKey($request)
    {
        return $this->createInferTempApiKeyWithHttpInfo($request);
    }

    public function createInferTempApiKeyWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function detachDevServerPort($request)
    {
        return $this->detachDevServerPortWithHttpInfo($request);
    }

    public function detachDevServerPortWithHttpInfo($request)
    {
