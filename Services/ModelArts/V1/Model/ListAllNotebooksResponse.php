...
class ListAllNotebooksResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAllNotebooksResponse';
    ...
    */
    protected static $openAPITypes = [
            'current' => 'int',
            'data' => '\HuaweiCloud\SDK\ModelArts\V1\Model\NotebookResp[]',
            'pages' => 'int',
            'size' => 'int',
            'total' => 'int'
    ];
    ...
    *  **参数解释**：Notebook实例数据。
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\NotebookResp[]|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\NotebookResp[]|null $data **参数解释**：Notebook实例数据。
    *
    * @return $this
    */
