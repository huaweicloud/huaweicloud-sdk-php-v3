...
class GroupConfigResponse implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GroupConfigResponse';
    ...
    * Sets name
    *
    * @param string $name **参数解释：** 部署名称。 **取值范围：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets weight
    *
    * @param int $weight **参数解释：** 权重百分比，分配到此模型的流量权重，仅当模型部署为在线服务时需要配置。 **取值范围：** [0, 100]。
    *
    * @return $this
    */
