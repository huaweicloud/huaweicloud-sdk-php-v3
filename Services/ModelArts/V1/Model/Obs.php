...
class Obs implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'Obs';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * obsPath  **参数解释**：需要挂载的obs路径。如：“/test-bucket/path”。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。
    * localPath  **参数解释**：挂载到训练容器中的路径，如：“/example/path”。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。
    *
    * @var string[]
    */
    ...
    * Sets obsPath
    *
    * @param string|null $obsPath **参数解释**：需要挂载的obs路径。如：“/test-bucket/path”。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。
    *
    * @return $this
    */
    ...
    * Sets localPath
    *
    * @param string|null $localPath **参数解释**：挂载到训练容器中的路径，如：“/example/path”。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。
    *
    * @return $this
    */
