...
class WorkflowServicePackage implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'WorkflowServicePackage';
    ...
    *  order
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\WorkflowPoolOrder
    */
    ...
    * Sets order
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\WorkflowPoolOrder $order order
    *
    * @return $this
    */
