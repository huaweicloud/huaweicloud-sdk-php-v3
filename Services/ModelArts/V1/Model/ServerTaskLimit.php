...
class ServerTaskLimit implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ServerTaskLimit';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * maxTask  **参数解释：** 单个服务任务限制总数。 **取值范围：** [0, 10000]。
    *
    * @var string[]
    */
    ...
    * Sets maxTask
    *
    * @param int|null $maxTask **参数解释：** 单个服务任务限制总数。 **取值范围：** [0, 10000]。
    *
    * @return $this
    */
