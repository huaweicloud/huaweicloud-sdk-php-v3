...
class TrainingExperimentStatistic implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TrainingExperimentStatistic';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * jobCount  **参数解释**：当前实验下的训练作业总个数。 **取值范围**：不涉及。
    *
    * @var string[]
    */
    ...
    * Sets jobCount
    *
    * @param int|null $jobCount **参数解释**：当前实验下的训练作业总个数。 **取值范围**：不涉及。
    *
    * @return $this
    */
