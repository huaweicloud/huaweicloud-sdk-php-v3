...
class CreateNotebookTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateNotebookTagsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * resourceId  **参数解释**：Notebook实例ID。ID格式为通用唯一识别码（Universally Unique Identifier，简称UUID），可通过调用[查询Notebook实例列表接口](https://support.huaweicloud.com/api-modelarts/ListNotebooks.html#section0)获取。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。
    ...
    */
    protected static $openAPITypes = [
            'resourceId' => 'string',
            'workspaceId' => 'string',
            'body' => '\HuaweiCloud\SDK\ModelArts\V1\Model\CreateTmsTagsRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\CreateTmsTagsRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\CreateTmsTagsRequest|null $body body
    *
    * @return $this
    */
