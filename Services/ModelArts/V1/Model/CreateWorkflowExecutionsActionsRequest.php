...
class CreateWorkflowExecutionsActionsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateWorkflowExecutionsActionsRequest';
    ...
    */
    protected static $openAPITypes = [
            'workflowId' => 'string',
            'executionId' => 'string',
            'body' => '\HuaweiCloud\SDK\ModelArts\V1\Model\ExecutionAction'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\ExecutionAction|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\ExecutionAction|null $body body
    *
    * @return $this
    */
