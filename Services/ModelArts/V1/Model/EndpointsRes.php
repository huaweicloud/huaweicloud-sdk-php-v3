...
class EndpointsRes implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'EndpointsRes';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * devService  **参数解释**：访问Notebook的途径。 **取值范围**：枚举类型，取值如下： - NOTEBOOK：可以通过https协议访问Notebook。 - SSH：可以通过SSH协议远程连接Notebook。
    * service  **参数解释**：访问Notebook的途径。 **取值范围**：枚举类型，取值如下： - NOTEBOOK：可以通过https协议访问Notebook。 - SSH：可以通过SSH协议远程连接Notebook。
    * uri  **参数解释**：实例私有IP地址。 **取值范围**：不涉及。
    * keyPairNames  **参数解释**：SSH密钥对名称列表，允许设置多个密钥对实现同时对SSH实例的访问。 **取值范围**：不涉及。
    *
    * @var string[]
    */
    ...
    */
    ...
    const SERVICE_NOTEBOOK = 'NOTEBOOK';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['uri']) && (mb_strlen($this->container['uri']) > 256)) {
                $invalidProperties[] = "invalid value for 'uri', the character length must be smaller than or equal to 256.";
            }
    ...
    * Sets devService
    *
    * @param string|null $devService **参数解释**：访问Notebook的途径。 **取值范围**：枚举类型，取值如下： - NOTEBOOK：可以通过https协议访问Notebook。 - SSH：可以通过SSH协议远程连接Notebook。
    *
    * @return $this
    */
    ...
    * Sets service
    *
    * @param string|null $service **参数解释**：访问Notebook的途径。 **取值范围**：枚举类型，取值如下： - NOTEBOOK：可以通过https协议访问Notebook。 - SSH：可以通过SSH协议远程连接Notebook。
    *
    * @return $this
    */
    ...
    * Sets uri
    *
    * @param string|null $uri **参数解释**：实例私有IP地址。 **取值范围**：不涉及。
    *
    * @return $this
    */
    ...
    * Sets keyPairNames
    *
    * @param string[]|null $keyPairNames **参数解释**：SSH密钥对名称列表，允许设置多个密钥对实现同时对SSH实例的访问。 **取值范围**：不涉及。
    *
    * @return $this
    */
