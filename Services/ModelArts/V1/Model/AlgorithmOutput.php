...
class AlgorithmOutput implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AlgorithmOutput';
    ...
    * remote  remote
    * mode  数据传输模式，默认为“upload_periodically”。
    * period  数据传输周期，默认为30s。
    *
    * @var string[]
    */
    ...
    * Sets mode
    *
    * @param string|null $mode 数据传输模式，默认为“upload_periodically”。
    *
    * @return $this
    */
    ...
    * Sets period
    *
    * @param string|null $period 数据传输周期，默认为30s。
    *
    * @return $this
    */
