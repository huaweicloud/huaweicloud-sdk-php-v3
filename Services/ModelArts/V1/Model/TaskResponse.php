...
class TaskResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'role' => 'string',
            'algorithm' => '\HuaweiCloud\SDK\ModelArts\V1\Model\TaskResponseAlgorithm',
            'taskResource' => '\HuaweiCloud\SDK\ModelArts\V1\Model\FlavorResponse',
            'logExportPath' => '\HuaweiCloud\SDK\ModelArts\V1\Model\TaskResponseLogExportPath'
    ];
    ...
    * Sets role
    *
    * @param string|null $role 任务角色，该功能暂未支持。
    *
    * @return $this
    */
    ...
    *  algorithm
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\TaskResponseAlgorithm|null
    */
    ...
    * Sets algorithm
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\TaskResponseAlgorithm|null $algorithm algorithm
    *
    * @return $this
    */
    ...
    * Sets taskResource
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\FlavorResponse|null $taskResource taskResource
    *
    * @return $this
    */
    ...
    *  logExportPath
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\TaskResponseLogExportPath|null
    */
    ...
    * Sets logExportPath
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\TaskResponseLogExportPath|null $logExportPath logExportPath
    *
    * @return $this
    */
