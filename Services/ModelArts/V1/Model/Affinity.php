...
class Affinity implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'Affinity';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * affinityType  **参数解释：** 节点亲和类型。 **约束限制：** 不涉及。 **取值范围：** - AFFINITY：亲和。 - ANTI_AFFINITY：反亲和。 **默认取值：** 不涉及。
    * required  **参数解释：** 是否设置强亲和。 **约束限制：** 不涉及。 **取值范围：** - true：设置强亲和。 - false：不设置强亲和。 **默认取值：** 不涉及。
    * selectionMode  **参数解释：** 选择节点方式。 **约束限制：** 不涉及。 **取值范围：** IP **默认取值：** 不涉及。
    * targets  **参数解释：** 通过上述方式选择的列表，长度不能超过20。 **约束限制：** 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets affinityType
    *
    * @param string $affinityType **参数解释：** 节点亲和类型。 **约束限制：** 不涉及。 **取值范围：** - AFFINITY：亲和。 - ANTI_AFFINITY：反亲和。 **默认取值：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets required
    *
    * @param bool $required **参数解释：** 是否设置强亲和。 **约束限制：** 不涉及。 **取值范围：** - true：设置强亲和。 - false：不设置强亲和。 **默认取值：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets selectionMode
    *
    * @param string $selectionMode **参数解释：** 选择节点方式。 **约束限制：** 不涉及。 **取值范围：** IP **默认取值：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets targets
    *
    * @param map[string,string] $targets **参数解释：** 通过上述方式选择的列表，长度不能超过20。 **约束限制：** 不涉及。
    *
    * @return $this
    */
