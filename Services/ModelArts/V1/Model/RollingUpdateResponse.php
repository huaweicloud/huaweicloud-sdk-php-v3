...
class RollingUpdateResponse implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RollingUpdateResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * maxSurge  **参数解释：** 滚动更新时最多可以启动多少个Pod。 **取值范围：** 不涉及。
    * maxUnavailable  **参数解释：** 滚动更新时最多可以删除多少个Pod。 **取值范围：** 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets maxSurge
    *
    * @param string|null $maxSurge **参数解释：** 滚动更新时最多可以启动多少个Pod。 **取值范围：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets maxUnavailable
    *
    * @param string|null $maxUnavailable **参数解释：** 滚动更新时最多可以删除多少个Pod。 **取值范围：** 不涉及。
    *
    * @return $this
    */
