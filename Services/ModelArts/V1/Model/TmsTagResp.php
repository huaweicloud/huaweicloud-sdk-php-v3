...
class TmsTagResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TmsTagResp';
    ...
    * Sets key
    *
    * @param string $key **参数解释**：TMS标签的key。 **取值范围**：不涉及。
    *
    * @return $this
    */
    ...
    * Sets value
    *
    * @param string $value **参数解释**：TMS标签的value。 **取值范围**：不涉及。
    *
    * @return $this
    */
