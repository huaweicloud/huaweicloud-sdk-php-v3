...
class PatchNodePoolRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PatchNodePoolRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * poolName  **参数解释**：资源池名称。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。
    * nodepoolName  **参数解释**：节点池名称。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。
    * contentType  **参数解释**：消息体的类型（格式）。 **约束限制**：不涉及。 **取值范围**：可选值如下： - application/merge-patch+json **默认取值**：不涉及。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'nodepoolName' => 'string',
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\ModelArts\V1\Model\PatchNodePoolRequestBody'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['nodepoolName'] === null) {
            $invalidProperties[] = "'nodepoolName' can't be null";
        }
    ...
    * Sets contentType
    *
    * @param string $contentType **参数解释**：消息体的类型（格式）。 **约束限制**：不涉及。 **取值范围**：可选值如下： - application/merge-patch+json **默认取值**：不涉及。
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\PatchNodePoolRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\PatchNodePoolRequestBody|null $body body
    *
    * @return $this
    */
