...
class WorkspaceResponse implements ModelInterface, ArrayAccess
{
    ...
    * name  工作空间名称。
    * description  工作空间描述。
    * id  工作空间ID，系统生成的32位UUID，不带橫线。默认的工作空间id为'0'。
    ...
    * Sets id
    *
    * @param string|null $id 工作空间ID，系统生成的32位UUID，不带橫线。默认的工作空间id为'0'。
    *
    * @return $this
    */
