...
class CombineInferTmsTags implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CombineInferTmsTags';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * key  **参数解释：** 标签的key。 **取值范围：** 不涉及。
    * values  **参数解释：** 相同key的标签value合并后的列表。 **取值范围：** 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets key
    *
    * @param string $key **参数解释：** 标签的key。 **取值范围：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets values
    *
    * @param string[] $values **参数解释：** 相同key的标签value合并后的列表。 **取值范围：** 不涉及。
    *
    * @return $this
    */
