...
class UpdateWorkflowSubscriptionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateWorkflowSubscriptionRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * subscriptionId  消息订阅ID。
    * workflowId  工作流的ID。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'workflowId' => 'string',
            'body' => '\HuaweiCloud\SDK\ModelArts\V1\Model\Subscription'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\Subscription|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\Subscription|null $body body
    *
    * @return $this
    */
