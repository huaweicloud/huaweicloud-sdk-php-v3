...
class BatchBindInferApiKeysResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchBindInferApiKeysResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * total  **参数解释：** 请求绑定apikey总个数。 **取值范围：** 不涉及。
    * successCount  **参数解释：** 绑定apikey成功个数。 **取值范围：** 不涉及。
    * successItems  **参数解释：** 绑定成功的apikey列表。
    * failureCount  **参数解释：** 绑定apikey失败个数。 **取值范围：** 不涉及。
    * failureItems  **参数解释：** 绑定失败的apikey列表。
    *
    * @var string[]
    */
    ...
    * Sets total
    *
    * @param int|null $total **参数解释：** 请求绑定apikey总个数。 **取值范围：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets successCount
    *
    * @param int|null $successCount **参数解释：** 绑定apikey成功个数。 **取值范围：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets successItems
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\ApiKeyResponseV2[]|null $successItems **参数解释：** 绑定成功的apikey列表。
    *
    * @return $this
    */
    ...
    * Sets failureCount
    *
    * @param int|null $failureCount **参数解释：** 绑定apikey失败个数。 **取值范围：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets failureItems
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\ApiKeyFailureResponse[]|null $failureItems **参数解释：** 绑定失败的apikey列表。
    *
    * @return $this
    */
