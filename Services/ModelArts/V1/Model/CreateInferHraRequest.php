...
class CreateInferHraRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateInferHraRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'deploymentId' => 'string',
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\ModelArts\V1\Model\CreateHraRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\CreateHraRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\CreateHraRequestBody|null $body body
    *
    * @return $this
    */
