...
class ShowPoolNodeConfigTemplateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowPoolNodeConfigTemplateRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * poolName  **参数解释**：池名称。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。
    *
    * @var string[]
    */
