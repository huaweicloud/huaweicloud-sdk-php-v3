...
class CreateWorkflowStepExecutionsActionsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateWorkflowStepExecutionsActionsResponse';
