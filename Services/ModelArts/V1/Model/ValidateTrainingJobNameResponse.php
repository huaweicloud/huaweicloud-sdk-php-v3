...
class ValidateTrainingJobNameResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ValidateTrainingJobNameResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * isDuplicate  训练作业名称是否重复，true表示已存在，false表示不存在。
    *
    * @var string[]
    */
    ...
    * Sets isDuplicate
    *
    * @param bool|null $isDuplicate 训练作业名称是否重复，true表示已存在，false表示不存在。
    *
    * @return $this
    */
