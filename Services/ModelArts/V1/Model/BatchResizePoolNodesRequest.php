...
class BatchResizePoolNodesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchResizePoolNodesRequest';
    ...
    */
    protected static $openAPITypes = [
            'poolName' => 'string',
            'body' => '\HuaweiCloud\SDK\ModelArts\V1\Model\BatchResizeRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\BatchResizeRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\BatchResizeRequestBody|null $body body
    *
    * @return $this
    */
