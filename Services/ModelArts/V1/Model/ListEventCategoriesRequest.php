...
class ListEventCategoriesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListEventCategoriesRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * flavorType  **参数解释**：规格类型 **约束限制**：不涉及。 **取值范围**：可选值如下： - CPU - GPU - Ascend  **默认取值**：不涉及。
    *
    * @var string[]
    */
    ...
    * Sets flavorType
    *
    * @param string|null $flavorType **参数解释**：规格类型 **约束限制**：不涉及。 **取值范围**：可选值如下： - CPU - GPU - Ascend  **默认取值**：不涉及。
    *
    * @return $this
    */
