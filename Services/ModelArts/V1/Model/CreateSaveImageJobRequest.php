...
class CreateSaveImageJobRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSaveImageJobRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'taskId' => 'string',
            'body' => '\HuaweiCloud\SDK\ModelArts\V1\Model\ImageSaveJob'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\ImageSaveJob|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\ImageSaveJob|null $body body
    *
    * @return $this
    */
