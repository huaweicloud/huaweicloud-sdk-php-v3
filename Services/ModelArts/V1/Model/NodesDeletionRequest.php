...
class NodesDeletionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NodesDeletionRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * deleteNodeNames  **参数解释**：待删除的节点名称列表。 **约束限制**：不涉及。
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['deleteNodeNames'] === null) {
            $invalidProperties[] = "'deleteNodeNames' can't be null";
        }
    ...
    *
    * @param string[] $deleteNodeNames **参数解释**：待删除的节点名称列表。 **约束限制**：不涉及。
    *
    * @return $this
    */
