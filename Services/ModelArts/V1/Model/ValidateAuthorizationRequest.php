...
class ValidateAuthorizationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ValidateAuthorizationRequest';
    ...
    */
    protected static $openAPITypes = [
            'workspaceId' => 'string',
            'body' => '\HuaweiCloud\SDK\ModelArts\V1\Model\ValidateAuthorizationRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\ValidateAuthorizationRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\ValidateAuthorizationRequestBody|null $body body
    *
    * @return $this
    */
