...
class ResourceFlavorListMetadata implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResourceFlavorList_metadata';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * continue  **参数解释**：分页查询的偏移标志。 **取值范围**：取值来自用户上一次分页查询响应结果中metadata.continue中的值，值为空默认无偏移。
    * remainingItemCount  **参数解释**：分页查询中剩余资源的数量。 **默认取值**：不涉及。
    *
    * @var string[]
    */
    ...
    * Sets continue
    *
    * @param string|null $continue **参数解释**：分页查询的偏移标志。 **取值范围**：取值来自用户上一次分页查询响应结果中metadata.continue中的值，值为空默认无偏移。
    *
    * @return $this
    */
    ...
    *
    * @param int|null $remainingItemCount **参数解释**：分页查询中剩余资源的数量。 **默认取值**：不涉及。
    *
    * @return $this
    */
