...
class AIServiceInstance implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AIServiceInstance';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  **参数解释**：部署实例id。 **取值范围**：不涉及。
    * status  **参数解释**：部署实例状态。 **取值范围**：- CREATING - RUNNING  - FAILED  -DELETED - ERROR
    * endpoints  **参数解释**：调用方式信息。 **取值范围**：不涉及。
    *
    * @var string[]
    */
    ...
    * Sets id
    *
    * @param string|null $id **参数解释**：部署实例id。 **取值范围**：不涉及。
    *
    * @return $this
    */
    ...
    * Sets endpoints
    *
    * @param string|null $endpoints **参数解释**：调用方式信息。 **取值范围**：不涉及。
    *
    * @return $this
    */
