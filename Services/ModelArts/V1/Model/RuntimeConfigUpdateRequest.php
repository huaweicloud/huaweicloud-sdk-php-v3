...
class RuntimeConfigUpdateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RuntimeConfigUpdateRequest';
    ...
    */
    protected static $openAPITypes = [
            'serviceInvoke' => '\HuaweiCloud\SDK\ModelArts\V1\Model\ServiceInvokeUpdateRequest',
            'serviceLimit' => '\HuaweiCloud\SDK\ModelArts\V1\Model\ServiceLimit',
    ...
    *  serviceInvoke
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\ServiceInvokeUpdateRequest
    */
    ...
    * Sets serviceInvoke
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\ServiceInvokeUpdateRequest $serviceInvoke serviceInvoke
    *
    * @return $this
    */
    ...
    *  serviceLimit
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\ServiceLimit
    */
    ...
    * Sets serviceLimit
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\ServiceLimit $serviceLimit serviceLimit
    *
    * @return $this
    */
