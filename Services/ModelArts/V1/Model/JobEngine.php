...
class JobEngine implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'JobEngine';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * engineId  训练作业选择的引擎规格ID。engine_id，engine_name+engine_version和image_url方式三选一。
    * engineName  训练作业选择的引擎名称。如果已填写engine_id，则此参数无需填写。
    ...
    * Sets engineId
    *
    * @param string|null $engineId 训练作业选择的引擎规格ID。engine_id，engine_name+engine_version和image_url方式三选一。
    *
    * @return $this
    */
    ...
    * Sets engineName
    *
    * @param string|null $engineName 训练作业选择的引擎名称。如果已填写engine_id，则此参数无需填写。
    *
    * @return $this
    */
    ...
    * Sets engineVersion
    *
    * @param string|null $engineVersion 训练作业选择的引擎版本名称。如果已填写engine_id，则此参数无需填写。
    *
    * @return $this
    */
    ...
    * Sets imageUrl
    *
    * @param string|null $imageUrl 训练作业选择的自定义镜像地址，地址从swr服务获取。
    *
    * @return $this
    */
    ...
    *
    * @param bool|null $installSysPackages 是否需要安装训练平台指定的 moxing 版本。true为需要。只有填写了engine_name，engine_version，image_url参数时支持该设置。
    *
    * @return $this
    */
