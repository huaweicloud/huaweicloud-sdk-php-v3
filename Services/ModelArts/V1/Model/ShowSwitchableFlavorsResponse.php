...
class ShowSwitchableFlavorsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowSwitchableFlavorsResponse';
    ...
    */
    protected static $openAPITypes = [
            'current' => 'int',
            'data' => '\HuaweiCloud\SDK\ModelArts\V1\Model\NotebookFlavor[]',
            'pages' => 'int',
            'size' => 'int',
            'total' => 'int',
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\NotebookFlavor[]|null $data **参数解释**：分页数据。
    *
    * @return $this
    */
    ...
    * Sets flavors
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\NotebookFlavor[]|null $flavors **参数解释**：分页数据。
    *
    * @return $this
    */
