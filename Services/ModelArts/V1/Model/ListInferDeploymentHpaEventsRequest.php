...
class ListInferDeploymentHpaEventsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInferDeploymentHpaEventsRequest';
    ...
    * offset  **参数解释：** 分页列表的起始页，从0开始计数。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 0。
    * sortKey  **参数解释：** 排序字段，多个字段以\",\"分隔，支持create_at, update_at，默认值update_at。 **约束限制：** 不涉及。 **取值范围：** - lastProbeTime：按照执行记录事件排序。 - status：按状态排序。 **默认取值：** update_at。
    ...
    * Sets offset
    *
    * @param int|null $offset **参数解释：** 分页列表的起始页，从0开始计数。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 0。
    *
    * @return $this
    */
    ...
    * Sets sortKey
    *
    * @param string|null $sortKey **参数解释：** 排序字段，多个字段以\",\"分隔，支持create_at, update_at，默认值update_at。 **约束限制：** 不涉及。 **取值范围：** - lastProbeTime：按照执行记录事件排序。 - status：按状态排序。 **默认取值：** update_at。
    *
    * @return $this
    */
