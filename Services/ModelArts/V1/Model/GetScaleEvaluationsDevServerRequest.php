...
class GetScaleEvaluationsDevServerRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GetScaleEvaluationsDevServerRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['id'] === null) {
            ...
            if (!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", $this->container['id'])) {
