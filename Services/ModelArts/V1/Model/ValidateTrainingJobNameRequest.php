...
class ValidateTrainingJobNameRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ValidateTrainingJobNameRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * jobName  **参数解释**：训练作业名称。 **约束限制**：1 - 64字符，字母、数字、下划线和中划线。 **取值范围**：不涉及。 **默认取值**：不涉及。
