...
class BatchRebootPoolNodesRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchRebootPoolNodesRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * nodeNames  **参数解释**：节点名称集合。 **约束限制**：不涉及。
    *
    * @var string[]
    */
    ...
    * Sets nodeNames
    *
    * @param string[] $nodeNames **参数解释**：节点名称集合。 **约束限制**：不涉及。
    *
    * @return $this
    */
