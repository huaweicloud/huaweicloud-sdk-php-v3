...
class CreateInferDeploymentRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateInferDeploymentRequest';
    ...
    */
    protected static $openAPITypes = [
            'serviceId' => 'string',
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\ModelArts\V1\Model\GroupConfig'
    ];
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\GroupConfig|null $body body
    *
    * @return $this
    */
