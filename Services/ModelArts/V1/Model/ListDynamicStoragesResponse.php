...
class ListDynamicStoragesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDynamicStoragesResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * current  **参数解释**：当前页数。 **取值范围**：正整数。
    * data  **参数解释**：动态挂载存储实例数据。
    ...
    */
    protected static $openAPITypes = [
            'current' => 'int',
            'data' => '\HuaweiCloud\SDK\ModelArts\V1\Model\DataVolumesRes[]',
            'pages' => 'int',
            'size' => 'int',
            'total' => 'int'
    ];
    ...
    *  **参数解释**：动态挂载存储实例数据。
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\DataVolumesRes[]|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\DataVolumesRes[]|null $data **参数解释**：动态挂载存储实例数据。
    *
    * @return $this
    */
