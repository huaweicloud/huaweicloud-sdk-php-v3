...
class TmsTagForDeletion implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TmsTagForDeletion';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * key  **参数解释：** Tms标签的key。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    * value  **参数解释：** Tms标签的value，非必填。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets key
    *
    * @param string $key **参数解释：** Tms标签的key。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets value
    *
    * @param string|null $value **参数解释：** Tms标签的value，非必填。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    *
    * @return $this
    */
