...
class InferTmsTag implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'InferTmsTag';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * key  **参数解释：** 标签键字段。 **约束限制：** 不涉及。 **取值范围：** 长度为1~128，标签的键可以包含任意语种字母、数字、空格，以及_ . : = + - @特殊字符，但首尾不能含有空格，不能以_sys_开头。 **默认取值：** 不涉及。
    * value  **参数解释：** 标签值字段。 **约束限制：** 字母、数字、下划线、点、斜杠、等号、加号、减号和@符号。 **取值范围：** 长度为0~255。 **默认取值：** 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets key
    *
    * @param string $key **参数解释：** 标签键字段。 **约束限制：** 不涉及。 **取值范围：** 长度为1~128，标签的键可以包含任意语种字母、数字、空格，以及_ . : = + - @特殊字符，但首尾不能含有空格，不能以_sys_开头。 **默认取值：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets value
    *
    * @param string $value **参数解释：** 标签值字段。 **约束限制：** 字母、数字、下划线、点、斜杠、等号、加号、减号和@符号。 **取值范围：** 长度为0~255。 **默认取值：** 不涉及。
    *
    * @return $this
    */
