...
class PoolNodeAz implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PoolNodeAz';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * az  **参数解释**：可用区名称。 **取值范围**：不涉及。
    * count  **参数解释**：可用区资源实例的数量。 **取值范围**：不涉及。
    *
    * @var string[]
    */
    ...
    * Sets az
    *
    * @param string $az **参数解释**：可用区名称。 **取值范围**：不涉及。
    *
    * @return $this
    */
    ...
    * Sets count
    *
    * @param int $count **参数解释**：可用区资源实例的数量。 **取值范围**：不涉及。
    *
    * @return $this
    */
