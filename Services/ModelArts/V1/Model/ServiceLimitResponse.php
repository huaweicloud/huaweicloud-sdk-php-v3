...
class ServiceLimitResponse implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ServiceLimitResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * rateLimit  rateLimit
    * requestSizeLimit  **参数解释：** 请求大小限制。 **取值范围：** 1-50M。
    * requestTimeout  **参数解释：** 超时时间。 **取值范围：** 1到7200秒。
    * ipWhiteList  **参数解释：** IP白名单。
    * ipBlackList  **参数解释：** IP黑名单。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'rateLimit' => '\HuaweiCloud\SDK\ModelArts\V1\Model\RateLimitResponse',
    ...
    *  rateLimit
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\RateLimitResponse
    */
    ...
    * Sets rateLimit
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\RateLimitResponse $rateLimit rateLimit
    *
    * @return $this
    */
    ...
    *
    * @param int $requestSizeLimit **参数解释：** 请求大小限制。 **取值范围：** 1-50M。
    *
    * @return $this
    */
    ...
    * Sets requestTimeout
    *
    * @param int $requestTimeout **参数解释：** 超时时间。 **取值范围：** 1到7200秒。
    *
    * @return $this
    */
    ...
    * Sets ipWhiteList
    *
    * @param string[]|null $ipWhiteList **参数解释：** IP白名单。
    *
    * @return $this
    */
    ...
    * Sets ipBlackList
    *
    * @param string[]|null $ipBlackList **参数解释：** IP黑名单。
    *
    * @return $this
    */
