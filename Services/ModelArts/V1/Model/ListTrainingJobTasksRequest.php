...
class ListTrainingJobTasksRequest implements ModelInterface, ArrayAccess
{
    ...
    * Sets scheduleCount
    *
    * @param int|null $scheduleCount 归属于训练作业的第几次调度
    *
    * @return $this
    */
