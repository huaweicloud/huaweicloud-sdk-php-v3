...
class BatchUnbindInferApiKeysRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchUnbindInferApiKeysRequest';
    ...
    */
    protected static $openAPITypes = [
            'serviceId' => 'string',
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\ModelArts\V1\Model\BatchUnBindApiKeyRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\BatchUnBindApiKeyRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\BatchUnBindApiKeyRequest|null $body body
    *
    * @return $this
    */
