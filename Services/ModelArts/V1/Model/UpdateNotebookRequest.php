...
class UpdateNotebookRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateNotebookRequest';
    ...
    */
    protected static $openAPITypes = [
            'id' => 'string',
            'body' => '\HuaweiCloud\SDK\ModelArts\V1\Model\NotebookUpdateRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\NotebookUpdateRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\NotebookUpdateRequest|null $body body
    *
    * @return $this
    */
