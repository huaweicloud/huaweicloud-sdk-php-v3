...
class FlavorInfoResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'disk' => '\HuaweiCloud\SDK\ModelArts\V1\Model\DiskResponse'
    ];
    ...
    *  disk
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\DiskResponse|null
    */
    ...
    * Sets disk
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\DiskResponse|null $disk disk
    *
    * @return $this
    */
