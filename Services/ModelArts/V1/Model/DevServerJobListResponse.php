...
class DevServerJobListResponse implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DevServerJobListResponse';
    ...
    * description  **参数解释**：任务描述。 **取值范围**：不涉及。
    * type  **参数解释**：任务类型。 **取值范围**：- COMMON  -SERVICE_DEPLOY  等。
    * status  **参数解释**：任务状态。 **取值范围**：- PROCESSING,  -FINISHED,  -DELETED。
    ...
    * Sets description
    *
    * @param string|null $description **参数解释**：任务描述。 **取值范围**：不涉及。
    *
    * @return $this
    */
    ...
    * Sets type
    *
    * @param string|null $type **参数解释**：任务类型。 **取值范围**：- COMMON  -SERVICE_DEPLOY  等。
    *
    * @return $this
    */
    ...
    * Sets status
    *
    * @param string|null $status **参数解释**：任务状态。 **取值范围**：- PROCESSING,  -FINISHED,  -DELETED。
    *
    * @return $this
    */
