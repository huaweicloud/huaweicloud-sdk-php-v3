...
class CreateOrderRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * actionType  **参数解释**：订单类型。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。
    *
    * @var string[]
    */
    ...
    * Sets actionType
    *
    * @param string|null $actionType **参数解释**：订单类型。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。
    *
    * @return $this
    */
