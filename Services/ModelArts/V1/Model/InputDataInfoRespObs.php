...
class InputDataInfoRespObs implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'InputDataInfoResp_obs';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * obsUrl  **参数解释**：训练作业需要的数据集OBS路径URL。如：“/usr/data/”。 **取值范围**：不涉及。
    *
    * @var string[]
    */
    ...
    * Sets obsUrl
    *
    * @param string $obsUrl **参数解释**：训练作业需要的数据集OBS路径URL。如：“/usr/data/”。 **取值范围**：不涉及。
    *
    * @return $this
    */
