...
class BatchUnlockPoolNodesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchUnlockPoolNodesRequest';
    ...
    */
    protected static $openAPITypes = [
            'poolName' => 'string',
            'body' => '\HuaweiCloud\SDK\ModelArts\V1\Model\BatchLockPoolNodesRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\BatchLockPoolNodesRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\BatchLockPoolNodesRequestBody|null $body body
    *
    * @return $this
    */
