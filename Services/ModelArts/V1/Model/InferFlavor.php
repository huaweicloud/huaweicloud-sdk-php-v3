...
class InferFlavor implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'InferFlavor';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * arch  **参数解释：** 架构类型。 **取值范围：** - X86_64 - arm64
    * ascend  ascend
    * billing  billing
    * category  **参数解释：** 规格处理器类型。 **取值范围：** - CPU - GPU - [ASCEND](tag:hws,hws_hk,hk,fcs_super)
    * description  **参数解释：** 规格描述信息。 **取值范围：** 不涉及。
    * feature  **参数解释：** 规格类别。 **取值范围：** - DEFAULT：CodeLab规格。 - NOTEBOOK：Notebook规格。
    * free  **参数解释：** 是否为免费规格。 **取值范围：** - true: 免费规格。 - false: 付费规格。
    * gpu  gpu
    * id  **参数解释：** 规格ID。 **取值范围：** 不涉及。
    * memory  **参数解释：** 内存大小。 **取值范围：** 不涉及。
    * name  **参数解释：** 规格名称。 **取值范围：** 不涉及。
    * soldOut  **参数解释：** 资源是否充足。 **取值范围：** - true 资源不足。 - false 资源充足。
    * storages  **参数解释：** 规格支持的存储类型。
    * vcpus  **参数解释：** CPU核数。 **取值范围：** 不涉及。
    * evsMaxSize  **参数解释：** EVS磁盘最大容量。 **取值范围：** 不涉及。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'arch' => 'string',
            'ascend' => '\HuaweiCloud\SDK\ModelArts\V1\Model\AscendResource',
            'billing' => '\HuaweiCloud\SDK\ModelArts\V1\Model\BillingResource',
            'category' => 'string',
            'description' => 'string',
            'feature' => 'string',
            'free' => 'bool',
            'gpu' => '\HuaweiCloud\SDK\ModelArts\V1\Model\GPUResource',
            'id' => 'string',
            'memory' => 'int',
            'name' => 'string',
            'soldOut' => 'bool',
    ...
    * Sets arch
    *
    * @param string|null $arch **参数解释：** 架构类型。 **取值范围：** - X86_64 - arm64
    *
    * @return $this
    */
    ...
    *  ascend
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\AscendResource|null
    */
    ...
    * Sets ascend
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\AscendResource|null $ascend ascend
    *
    * @return $this
    */
    ...
    *  billing
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\BillingResource|null
    */
    ...
    * Sets billing
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\BillingResource|null $billing billing
    *
    * @return $this
    */
    ...
    * Sets category
    *
    * @param string|null $category **参数解释：** 规格处理器类型。 **取值范围：** - CPU - GPU - [ASCEND](tag:hws,hws_hk,hk,fcs_super)
    *
    * @return $this
    */
    ...
    * Sets feature
    *
    * @param string|null $feature **参数解释：** 规格类别。 **取值范围：** - DEFAULT：CodeLab规格。 - NOTEBOOK：Notebook规格。
    *
    * @return $this
    */
    ...
    * Sets free
    *
    * @param bool|null $free **参数解释：** 是否为免费规格。 **取值范围：** - true: 免费规格。 - false: 付费规格。
    *
    * @return $this
    */
    ...
    *  gpu
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\GPUResource|null
    */
    ...
    * Sets gpu
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\GPUResource|null $gpu gpu
    *
    * @return $this
    */
    ...
    * Sets soldOut
    *
    * @param bool|null $soldOut **参数解释：** 资源是否充足。 **取值范围：** - true 资源不足。 - false 资源充足。
    *
    * @return $this
    */
    ...
    * Sets storages
    *
    * @param string[]|null $storages **参数解释：** 规格支持的存储类型。
    *
    * @return $this
    */
    ...
    * Sets evsMaxSize
    *
    * @param string|null $evsMaxSize **参数解释：** EVS磁盘最大容量。 **取值范围：** 不涉及。
    *
    * @return $this
    */
