...
class ServiceInvokeUpdateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ServiceInvokeUpdateRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * port  **参数解释：** 服务端口号。 **约束限制：**  不涉及。  **取值范围：** [1, 65535]。 **默认取值：**  不涉及。
    * protocol  参数解释： 服务请求协议。当选择WSS与WS时，服务接口会升级为WebSocket。开启WebSocket时，不支持同时设置“服务流量限制”。 约束限制： 异步服务仅支持HTTPS, HTTP。 取值范围： HTTP：HTTP协议。 HTTPS：HTTPS协议。 WSS：WebSocket Secure协议。 WS：WebSocket协议。 默认取值： 不涉及。
    * authType  **参数解释：** 认证类型。 **约束限制：** 不涉及。 **取值范围：** - TOKEN：IAM Token认证。 - API_KEY：API Key认证。 - NONE：无认证。 **默认取值：** 不涉及。
    * internetAccessEnable  **参数解释：** 外网访问。 不涉及。 **约束限制：** 不涉及。 **取值范围：** - TRUE：要外网访问。 - FALSE：无需内网审批。 **默认取值：** 不涉及。
    * intranetApprovalEnable  **参数解释：** 内网审批。 **约束限制：** 不涉及。 **取值范围：** - TRUE：要内网审批。 - FALSE：无需内网审批。 **默认取值：** 不涉及。
    * dynamicRoutingEnable  **参数解释：** 动态路由开关。 **约束限制：** 不涉及。 **取值范围：** - TRUE：开启动态路由。 - FALSE：不开启动态路由。 **默认取值：** 不涉及。
    * strategy  **参数解释：** 智能路由策略（861版本该字段在高级配置中）。 **约束限制：** 不涉及。 **取值范围：** - ROUND_ROBIN：轮询。 - ORIGIN_IP_HASH：源IP哈希。 - MIN_CONN：最小连接数。 - MIN_FIRST_TOKEN_TIME：最小首token时延。 - COMPOSITE： 综合负载。 - SLO_BASED：SLO优先级。 **默认取值：** 不涉及。
    * metricApiScheme  **参数解释：** 指标接口服务请求协议。 **约束限制：** 不涉及。 **取值范围：** - HTTP：HTTP协议。 - HTTPS：HTTPS协议。 **默认取值：** 不涉及。
    * metricApiPort  **参数解释：** 指标接口端口号。 **约束限制：** 不涉及。 **取值范围：** [1, 65535]。 **默认取值：** 不涉及。
    * metricApiPath  **参数解释：** 指标接口path。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    * emsEnable  **参数解释：** 是否开启EMS加速。 **约束限制：** 不涉及。 **取值范围：** - TRUE：开启EMS加速。 - FALSE：不开启EMS加速。 **默认取值：** 不涉及。
    * requestRetryEnable  **参数解释：** proxy支持请求重调度开关。 **约束限制：** 不涉及。 **取值范围：** - true：开启proxy支持请求重调度。 - false：不开启proxy支持请求重调度。 **默认取值：** false
    * requestRetryCntMax  **参数解释：** proxy支持请求重调度的重试次数 **约束限制：**  不涉及。  **取值范围：** [1, 10]。 **默认取值：**  不涉及。
    * requestRetryIntervalMs  **参数解释：** proxy支持请求重调度的重试间隔，单位ms **约束限制：**  不涉及。  **取值范围：** [1, 10000]。 **默认取值：**  不涉及。
    * fuseConfigs  fuseConfigs
    * elbConnection  elbConnection
    * customUrls  **参数解释：** 服务的自定义调用地址。 **取值范围：**  不涉及。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'elbConnection' => '\HuaweiCloud\SDK\ModelArts\V1\Model\ElbConnectionUpdateRequest',
            'customUrls' => 'string[]'
    ];
    ...
    * Sets port
    *
    * @param int $port **参数解释：** 服务端口号。 **约束限制：**  不涉及。  **取值范围：** [1, 65535]。 **默认取值：**  不涉及。
    *
    * @return $this
    */
    ...
    * Sets protocol
    *
    * @param string $protocol 参数解释： 服务请求协议。当选择WSS与WS时，服务接口会升级为WebSocket。开启WebSocket时，不支持同时设置“服务流量限制”。 约束限制： 异步服务仅支持HTTPS, HTTP。 取值范围： HTTP：HTTP协议。 HTTPS：HTTPS协议。 WSS：WebSocket Secure协议。 WS：WebSocket协议。 默认取值： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets authType
    *
    * @param string $authType **参数解释：** 认证类型。 **约束限制：** 不涉及。 **取值范围：** - TOKEN：IAM Token认证。 - API_KEY：API Key认证。 - NONE：无认证。 **默认取值：** 不涉及。
    *
    * @return $this
    */
    ...
    *
    * @param bool|null $internetAccessEnable **参数解释：** 外网访问。 不涉及。 **约束限制：** 不涉及。 **取值范围：** - TRUE：要外网访问。 - FALSE：无需内网审批。 **默认取值：** 不涉及。
    *
    * @return $this
    */
    ...
    *
    * @param bool|null $intranetApprovalEnable **参数解释：** 内网审批。 **约束限制：** 不涉及。 **取值范围：** - TRUE：要内网审批。 - FALSE：无需内网审批。 **默认取值：** 不涉及。
    *
    * @return $this
    */
    ...
    *
    * @param bool|null $dynamicRoutingEnable **参数解释：** 动态路由开关。 **约束限制：** 不涉及。 **取值范围：** - TRUE：开启动态路由。 - FALSE：不开启动态路由。 **默认取值：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets strategy
    *
    * @param string|null $strategy **参数解释：** 智能路由策略（861版本该字段在高级配置中）。 **约束限制：** 不涉及。 **取值范围：** - ROUND_ROBIN：轮询。 - ORIGIN_IP_HASH：源IP哈希。 - MIN_CONN：最小连接数。 - MIN_FIRST_TOKEN_TIME：最小首token时延。 - COMPOSITE： 综合负载。 - SLO_BASED：SLO优先级。 **默认取值：** 不涉及。
    *
    * @return $this
    */
    ...
    *
    * @param string|null $metricApiScheme **参数解释：** 指标接口服务请求协议。 **约束限制：** 不涉及。 **取值范围：** - HTTP：HTTP协议。 - HTTPS：HTTPS协议。 **默认取值：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets metricApiPort
    *
    * @param string|null $metricApiPort **参数解释：** 指标接口端口号。 **约束限制：** 不涉及。 **取值范围：** [1, 65535]。 **默认取值：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets metricApiPath
    *
    * @param string|null $metricApiPath **参数解释：** 指标接口path。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets emsEnable
    *
    * @param bool|null $emsEnable **参数解释：** 是否开启EMS加速。 **约束限制：** 不涉及。 **取值范围：** - TRUE：开启EMS加速。 - FALSE：不开启EMS加速。 **默认取值：** 不涉及。
    *
    * @return $this
    */
    ...
    *
    * @param bool|null $requestRetryEnable **参数解释：** proxy支持请求重调度开关。 **约束限制：** 不涉及。 **取值范围：** - true：开启proxy支持请求重调度。 - false：不开启proxy支持请求重调度。 **默认取值：** false
    *
    * @return $this
    */
    ...
    *
    * @param int|null $requestRetryCntMax **参数解释：** proxy支持请求重调度的重试次数 **约束限制：**  不涉及。  **取值范围：** [1, 10]。 **默认取值：**  不涉及。
    *
    * @return $this
    */
    ...
    *
    * @param int|null $requestRetryIntervalMs **参数解释：** proxy支持请求重调度的重试间隔，单位ms **约束限制：**  不涉及。  **取值范围：** [1, 10000]。 **默认取值：**  不涉及。
    *
    * @return $this
    */
    ...
    *  elbConnection
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\ElbConnectionUpdateRequest|null
    */
    ...
    * Sets elbConnection
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\ElbConnectionUpdateRequest|null $elbConnection elbConnection
    *
    * @return $this
    */
    ...
    * Sets customUrls
    *
    * @param string[]|null $customUrls **参数解释：** 服务的自定义调用地址。 **取值范围：**  不涉及。
    *
    * @return $this
    */
