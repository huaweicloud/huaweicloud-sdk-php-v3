...
class ListAuthoringClustersResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAuthoringClustersResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * current  **参数解释**：当前页数。 **取值范围**：正整数。
    * data  **参数解释**：Notebook实例数据。
    ...
    */
    protected static $openAPITypes = [
            'current' => 'int',
            'data' => '\HuaweiCloud\SDK\ModelArts\V1\Model\ClusterResponse[]',
            'pages' => 'int',
            'size' => 'int',
            'total' => 'int'
    ];
    ...
    *  **参数解释**：Notebook实例数据。
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\ClusterResponse[]|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\ClusterResponse[]|null $data **参数解释**：Notebook实例数据。
    *
    * @return $this
    */
