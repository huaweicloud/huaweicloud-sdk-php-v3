...
class BatchUpdatePoolNodesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchUpdatePoolNodesRequest';
    ...
    */
    protected static $openAPITypes = [
            'poolName' => 'string',
            'body' => '\HuaweiCloud\SDK\ModelArts\V1\Model\BatchUpdatePoolNodesRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\BatchUpdatePoolNodesRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\BatchUpdatePoolNodesRequestBody|null $body body
    *
    * @return $this
    */
