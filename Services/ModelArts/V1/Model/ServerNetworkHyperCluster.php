...
class ServerNetworkHyperCluster implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ServerNetwork_hyper_cluster';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  参数解释：HyperCluster的id。 约束限制：不涉及。 取值范围：不涉及。 默认取值：不涉及。
    * hyperClusterSubnetId  参数解释：HyperCluster的子网id。 约束限制：不涉及。 取值范围：不涉及。 默认取值：不涉及。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['hyperClusterSubnetId']) && !preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", $this->container['hyperClusterSubnetId'])) {
                $invalidProperties[] = "invalid value for 'hyperClusterSubnetId', must be conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.";
            }
    ...
    * Sets id
    *
    * @param string|null $id 参数解释：HyperCluster的id。 约束限制：不涉及。 取值范围：不涉及。 默认取值：不涉及。
    *
    * @return $this
    */
    ...
    *
    * @param string|null $hyperClusterSubnetId 参数解释：HyperCluster的子网id。 约束限制：不涉及。 取值范围：不涉及。 默认取值：不涉及。
    *
    * @return $this
    */
