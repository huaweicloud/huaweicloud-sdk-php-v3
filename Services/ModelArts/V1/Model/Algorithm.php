...
class Algorithm implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'Algorithm';
    ...
    */
    protected static $openAPITypes = [
            'metadata' => '\HuaweiCloud\SDK\ModelArts\V1\Model\AlgorithmMetadata',
            'jobConfig' => '\HuaweiCloud\SDK\ModelArts\V1\Model\AlgorithmJobConfig',
            'resourceRequirements' => '\HuaweiCloud\SDK\ModelArts\V1\Model\ResourceRequirement[]',
            'advancedConfig' => '\HuaweiCloud\SDK\ModelArts\V1\Model\AlgorithmAdvancedConfig'
    ];
    ...
    *  metadata
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\AlgorithmMetadata|null
    */
    ...
    * Sets metadata
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\AlgorithmMetadata|null $metadata metadata
    *
    * @return $this
    */
    ...
    *  jobConfig
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\AlgorithmJobConfig|null
    */
    ...
    * Sets jobConfig
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\AlgorithmJobConfig|null $jobConfig jobConfig
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\ResourceRequirement[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\ResourceRequirement[]|null $resourceRequirements 算法资源约束。可不设置。设置后，在算法使用于训练作业时，控制台会过滤可用的公共资源池。
    *
    * @return $this
    */
    ...
    *  advancedConfig
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\AlgorithmAdvancedConfig|null
    */
    ...
    * Sets advancedConfig
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\AlgorithmAdvancedConfig|null $advancedConfig advancedConfig
    *
    * @return $this
    */
