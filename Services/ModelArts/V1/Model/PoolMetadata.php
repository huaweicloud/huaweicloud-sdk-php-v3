...
class PoolMetadata implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PoolMetadata';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  **参数解释**：资源池的ID。 **取值范围**：不涉及。
    * creationTimestamp  **参数解释**：资源池的创建时间。例如\"2025-11-01T03:49:41Z\"。 **取值范围**：不涉及。
    * labels  labels
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['name'] === null) {
            ...
            if (!preg_match("/^[a-z][-a-z0-9]{2,126}[a-z0-9]$/", $this->container['name'])) {
                $invalidProperties[] = "invalid value for 'name', must be conform to the pattern /^[a-z][-a-z0-9]{2,126}[a-z0-9]$/.";
            }
    ...
    * Sets name
    *
    * @param string $name **参数解释**：资源池的ID。 **取值范围**：不涉及。
    *
    * @return $this
    */
    ...
    *
    * @param string $creationTimestamp **参数解释**：资源池的创建时间。例如\"2025-11-01T03:49:41Z\"。 **取值范围**：不涉及。
    *
    * @return $this
    */
