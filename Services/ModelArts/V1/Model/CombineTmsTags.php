...
class CombineTmsTags implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CombineTmsTags';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * key  **参数解释**：标签的key。 **取值范围**：长度限制为128个字符，支持任意语种字母、数字、空格，以及_ . : = + - @特殊字符，但首尾不能含有空格，不能以_sys_开头。
    * values  **参数解释**：相同key的标签value合并后的列表。
    *
    * @var string[]
    */
    ...
    * Sets key
    *
    * @param string $key **参数解释**：标签的key。 **取值范围**：长度限制为128个字符，支持任意语种字母、数字、空格，以及_ . : = + - @特殊字符，但首尾不能含有空格，不能以_sys_开头。
    *
    * @return $this
    */
    ...
    * Sets values
    *
    * @param string[] $values **参数解释**：相同key的标签value合并后的列表。
    *
    * @return $this
    */
