...
class CreateInferDeploymentHpaRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateInferDeploymentHpaRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'deploymentId' => 'string',
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\ModelArts\V1\Model\CreateHpaRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\CreateHpaRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\CreateHpaRequestBody|null $body body
    *
    * @return $this
    */
