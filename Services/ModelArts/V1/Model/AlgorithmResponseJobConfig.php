...
class AlgorithmResponseJobConfig implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AlgorithmResponse_job_config';
    ...
    */
    protected static $openAPITypes = [
            ...
            'inputs' => '\HuaweiCloud\SDK\ModelArts\V1\Model\AlgorithmResponseJobConfigInputs[]',
            'outputs' => '\HuaweiCloud\SDK\ModelArts\V1\Model\AlgorithmResponseJobConfigOutputs[]',
            'engine' => '\HuaweiCloud\SDK\ModelArts\V1\Model\AlgorithmResponseJobConfigEngine',
            'codeTree' => '\HuaweiCloud\SDK\ModelArts\V1\Model\CodeTreeNode',
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['codeTree'] = isset($data['codeTree']) ? $data['codeTree'] : null;
    ...
    * Sets parameters
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\Parameter[]|null $parameters 算法的运行参数。
    *
    * @return $this
    */
    ...
    *  算法的数据输入。
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\AlgorithmResponseJobConfigInputs[]|null
    */
    ...
    * Sets inputs
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\AlgorithmResponseJobConfigInputs[]|null $inputs 算法的数据输入。
    *
    * @return $this
    */
    ...
    *  算法的数据输出。
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\AlgorithmResponseJobConfigOutputs[]|null
    */
    ...
    * Sets outputs
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\AlgorithmResponseJobConfigOutputs[]|null $outputs 算法的数据输出。
    *
    * @return $this
    */
    ...
    *  engine
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\AlgorithmResponseJobConfigEngine|null
    */
    ...
    * Sets engine
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\AlgorithmResponseJobConfigEngine|null $engine engine
    *
    * @return $this
    */
    ...
    *  codeTree
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\CodeTreeNode|null
    */
    public function getCodeTree()
    {
        return $this->container['codeTree'];
    }

    /**
    * Sets codeTree
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\CodeTreeNode|null $codeTree codeTree
    *
    * @return $this
    */
    public function setCodeTree($codeTree)
    {
        $this->container['codeTree'] = $codeTree;
        return $this;
    }
