...
class UserTags implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UserTags';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * key  **参数解释**：键。不得以\"CCE-\"或\"__type_baremetal\"开头\"。 **取值范围**：不涉及。
    ...
    * Sets key
    *
    * @param string $key **参数解释**：键。不得以\"CCE-\"或\"__type_baremetal\"开头\"。 **取值范围**：不涉及。
    *
    * @return $this
    */
    ...
    * Sets value
    *
    * @param string $value **参数解释**：值。 **取值范围**：不涉及。
    *
    * @return $this
    */
