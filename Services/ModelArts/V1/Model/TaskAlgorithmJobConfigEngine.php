...
class TaskAlgorithmJobConfigEngine implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'Task_algorithm_job_config_engine';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * engineId  **参数解释**：算法选择的引擎规格ID。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。
    * engineName  **参数解释**：算法选择的引擎规格名称。 **约束限制**：若填入engine_id则无需填写。 **取值范围**：不涉及。 **默认取值**：不涉及。
    * engineVersion  **参数解释**：算法选择的引擎规格版本。 **约束限制**：若填入engine_id则无需填写。 **取值范围**：不涉及。 **默认取值**：不涉及。
    ...
    * Sets engineId
    *
    * @param string|null $engineId **参数解释**：算法选择的引擎规格ID。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。
    *
    * @return $this
    */
    ...
    * Sets engineName
    *
    * @param string|null $engineName **参数解释**：算法选择的引擎规格名称。 **约束限制**：若填入engine_id则无需填写。 **取值范围**：不涉及。 **默认取值**：不涉及。
    *
    * @return $this
    */
    ...
    * Sets engineVersion
    *
    * @param string|null $engineVersion **参数解释**：算法选择的引擎规格版本。 **约束限制**：若填入engine_id则无需填写。 **取值范围**：不涉及。 **默认取值**：不涉及。
    *
    * @return $this
    */
