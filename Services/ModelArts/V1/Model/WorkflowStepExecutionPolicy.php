...
class WorkflowStepExecutionPolicy implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'WorkflowStepExecutionPolicy';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * executionPolicy  执行策略，可选值如下： - retry：重试 - stop：停止 - continue：继续运行
    * useCache  是否使用的是缓存。
    *
    * @var string[]
    */
    ...
    *
    * @param string|null $executionPolicy 执行策略，可选值如下： - retry：重试 - stop：停止 - continue：继续运行
    *
    * @return $this
    */
    ...
    * Sets useCache
    *
    * @param bool|null $useCache 是否使用的是缓存。
    *
    * @return $this
    */
