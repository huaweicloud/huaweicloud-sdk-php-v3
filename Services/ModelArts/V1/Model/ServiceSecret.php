...
class ServiceSecret implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ServiceSecret';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * secretEnable  **参数解释：** 是否启用密钥。 **约束限制：** 不涉及。 **取值范围：** - true：启用密钥。 - false：不启用密钥。 **默认取值：** false。
    * secretType  **参数解释：** 密钥类型。 **约束限制：** 不涉及。 **取值范围：** - custom：自定义密钥。 - [dew：DEW密钥。](tag:hws,hws_hk,fcs) **默认取值：** 不涉及。
    * secretVolumes  **参数解释：** 密钥挂载。 **约束限制：** 上限30个。
    * groupEnable  **参数解释：** 是否启用镜像的用户组。 **约束限制：** 不涉及。 **取值范围：** - true：启用镜像的用户组。 - false：不启用镜像的用户组。 **默认取值：** false。
    * groupId  **参数解释：** 镜像的用户组ID。 **约束限制：** 不涉及。 **取值范围：** 1000~4294967294。 **默认取值：** 不涉及。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'secretEnable' => 'bool',
            'secretType' => 'string',
            'secretVolumes' => '\HuaweiCloud\SDK\ModelArts\V1\Model\SecretVolume[]',
            'groupEnable' => 'bool',
            'groupId' => 'int'
    ];
    ...
    * Sets secretEnable
    *
    * @param bool|null $secretEnable **参数解释：** 是否启用密钥。 **约束限制：** 不涉及。 **取值范围：** - true：启用密钥。 - false：不启用密钥。 **默认取值：** false。
    *
    * @return $this
    */
    ...
    * Sets secretType
    *
    * @param string|null $secretType **参数解释：** 密钥类型。 **约束限制：** 不涉及。 **取值范围：** - custom：自定义密钥。 - [dew：DEW密钥。](tag:hws,hws_hk,fcs) **默认取值：** 不涉及。
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\SecretVolume[]|null
    */
    ...
    * Sets secretVolumes
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\SecretVolume[]|null $secretVolumes **参数解释：** 密钥挂载。 **约束限制：** 上限30个。
    *
    * @return $this
    */
    ...
    * Sets groupEnable
    *
    * @param bool|null $groupEnable **参数解释：** 是否启用镜像的用户组。 **约束限制：** 不涉及。 **取值范围：** - true：启用镜像的用户组。 - false：不启用镜像的用户组。 **默认取值：** false。
    *
    * @return $this
    */
    ...
    * Sets groupId
    *
    * @param int|null $groupId **参数解释：** 镜像的用户组ID。 **约束限制：** 不涉及。 **取值范围：** 1000~4294967294。 **默认取值：** 不涉及。
    *
    * @return $this
    */
