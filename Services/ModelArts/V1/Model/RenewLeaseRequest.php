...
class RenewLeaseRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RenewLeaseRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * duration  **参数解释**：续订时长，推荐该参数在leaseReq中配置，若请求参数中包含duration，则忽略leaseReq的值，且实例自动停止类别为定时停止。(单位:毫秒)。 **约束限制**：不涉及。 **取值范围**：3600000-259200000。 **默认取值**：3600000。
    ...
    */
    protected static $openAPITypes = [
            'duration' => 'int',
            'id' => 'string',
            'body' => '\HuaweiCloud\SDK\ModelArts\V1\Model\LeaseReq'
    ];
    ...
    * Sets duration
    *
    * @param int|null $duration **参数解释**：续订时长，推荐该参数在leaseReq中配置，若请求参数中包含duration，则忽略leaseReq的值，且实例自动停止类别为定时停止。(单位:毫秒)。 **约束限制**：不涉及。 **取值范围**：3600000-259200000。 **默认取值**：3600000。
    *
    * @return $this
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\LeaseReq|null $body body
    *
    * @return $this
    */
