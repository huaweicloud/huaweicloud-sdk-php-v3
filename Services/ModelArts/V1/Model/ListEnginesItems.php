...
class ListEnginesItems implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListEngines_items';
    ...
    */
    protected static $openAPITypes = [
            ...
            'v1Compatible' => 'bool',
            'runUser' => 'string',
            'imageInfo' => '\HuaweiCloud\SDK\ModelArts\V1\Model\ListEnginesImageInfo'
    ];
    ...
    *  imageInfo
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\ListEnginesImageInfo|null
    */
    ...
    * Sets imageInfo
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\ListEnginesImageInfo|null $imageInfo imageInfo
    *
    * @return $this
    */
