...
class DetachDynamicStorageRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DetachDynamicStorageRequest';
    ...
    * storageId  **参数解释**：存储ID。ID格式为通用唯一识别码（Universally Unique Identifier，简称UUID）。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['storageId'] === null) {
            $invalidProperties[] = "'storageId' can't be null";
        }
