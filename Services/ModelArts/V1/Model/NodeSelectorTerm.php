...
class NodeSelectorTerm implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NodeSelectorTerm';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * matchExpressions  **参数解释**：按节点标签列出的节点选择器要求。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。
    * matchFields  **参数解释**：按节点字段列出的节点选择器要求。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'matchExpressions' => '\HuaweiCloud\SDK\ModelArts\V1\Model\NodeSelectorRequirement[]',
            'matchFields' => '\HuaweiCloud\SDK\ModelArts\V1\Model\NodeSelectorRequirement[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\NodeSelectorRequirement[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\NodeSelectorRequirement[]|null $matchExpressions **参数解释**：按节点标签列出的节点选择器要求。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。
    *
    * @return $this
    */
    ...
    * Sets matchFields
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\NodeSelectorRequirement[]|null $matchFields **参数解释**：按节点字段列出的节点选择器要求。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。
    *
    * @return $this
    */
