...
class GPUResource implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GPUResource';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * gpu  **参数解释：** GPU卡数。 **取值范围：** 不涉及。
    * gpuMemory  **参数解释：** GPU内存。 **取值范围：** 不涉及。
    * type  **参数解释：** GPU类型。 **取值范围：** 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets gpu
    *
    * @param int|null $gpu **参数解释：** GPU卡数。 **取值范围：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets gpuMemory
    *
    * @param string|null $gpuMemory **参数解释：** GPU内存。 **取值范围：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets type
    *
    * @param string|null $type **参数解释：** GPU类型。 **取值范围：** 不涉及。
    *
    * @return $this
    */
