...
class ShowTrainingJobFlavorsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowTrainingJobFlavorsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalCount  训练作业资源规格总数。
    * flavors  训练作业资源规格列表。
    *
    * @var string[]
    */
    ...
    * Sets totalCount
    *
    * @param int|null $totalCount 训练作业资源规格总数。
    *
    * @return $this
    */
