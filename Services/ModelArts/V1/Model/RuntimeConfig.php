...
class RuntimeConfig implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'serviceInvoke' => '\HuaweiCloud\SDK\ModelArts\V1\Model\ServiceInvoke',
    ...
    *  serviceInvoke
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\ServiceInvoke
    */
    ...
    * Sets serviceInvoke
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\ServiceInvoke $serviceInvoke serviceInvoke
    *
    * @return $this
    */
