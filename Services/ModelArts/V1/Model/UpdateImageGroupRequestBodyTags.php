...
class UpdateImageGroupRequestBodyTags implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateImageGroupRequestBody_tags';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * key  **参数解释**：标签键 **约束限制**：最大支持20个标签键。 **取值范围**：key值最大支持长度128 **默认取值**：null。
    * value  **参数解释**：标签值 **约束限制**：最大支持20个标签值。 **取值范围**：value值最大支持长度255 **默认取值**：null。
    *
    * @var string[]
    */
    ...
    * Sets key
    *
    * @param string|null $key **参数解释**：标签键 **约束限制**：最大支持20个标签键。 **取值范围**：key值最大支持长度128 **默认取值**：null。
    *
    * @return $this
    */
    ...
    * Sets value
    *
    * @param string|null $value **参数解释**：标签值 **约束限制**：最大支持20个标签值。 **取值范围**：value值最大支持长度255 **默认取值**：null。
    *
    * @return $this
    */
