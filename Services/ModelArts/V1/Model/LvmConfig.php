...
class LvmConfig implements ModelInterface, ArrayAccess
{
    ...
    * path  **参数解释**：磁盘挂载路径。仅在用户配置中生效。支持包含：数字、大小写字母、点、中划线、下划线的绝对路径。 **取值范围**：不涉及。
    *
    * @var string[]
    */
    ...
    * Sets lvType
    *
    * @param string $lvType **参数解释**：LVM写入模式。 **取值范围**：可选项如下： - linear：线性模式。 - striped：条带模式，使用多块磁盘组成条带模式，能够提升磁盘性能。
    *
    * @return $this
    */
    ...
    * Sets path
    *
    * @param string|null $path **参数解释**：磁盘挂载路径。仅在用户配置中生效。支持包含：数字、大小写字母、点、中划线、下划线的绝对路径。 **取值范围**：不涉及。
    *
    * @return $this
    */
