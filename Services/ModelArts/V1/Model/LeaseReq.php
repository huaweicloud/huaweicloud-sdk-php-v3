...
class LeaseReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'LeaseReq';
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['duration']) && ($this->container['duration'] > 259200000)) {
                $invalidProperties[] = "invalid value for 'duration', must be smaller than or equal to 259200000.";
            }
            if (!is_null($this->container['duration']) && ($this->container['duration'] < 3600000)) {
                $invalidProperties[] = "invalid value for 'duration', must be bigger than or equal to 3600000.";
            }
