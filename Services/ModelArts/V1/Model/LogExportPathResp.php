...
class LogExportPathResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'LogExportPathResp';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * obsUrl  **参数解释**：训练作业日志保存的OBS地址，如：“obs://example/path”。 **取值范围**：不涉及。
    * hostPath  **参数解释**：训练作业日志保存的宿主机的路径，如：“/example/path”。 **取值范围**：不涉及。
    *
    * @var string[]
    */
    ...
    * Sets obsUrl
    *
    * @param string|null $obsUrl **参数解释**：训练作业日志保存的OBS地址，如：“obs://example/path”。 **取值范围**：不涉及。
    *
    * @return $this
    */
    ...
    * Sets hostPath
    *
    * @param string|null $hostPath **参数解释**：训练作业日志保存的宿主机的路径，如：“/example/path”。 **取值范围**：不涉及。
    *
    * @return $this
    */
