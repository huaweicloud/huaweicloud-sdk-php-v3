...
class ShowWorkflowStepExecutionMetricsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowWorkflowStepExecutionMetricsRequest';
