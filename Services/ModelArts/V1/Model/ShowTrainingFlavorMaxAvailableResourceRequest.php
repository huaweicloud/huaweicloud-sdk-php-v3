...
class ShowTrainingFlavorMaxAvailableResourceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowTrainingFlavorMaxAvailableResourceRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * flavorId  **参数解释**：资源规格ID。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。
