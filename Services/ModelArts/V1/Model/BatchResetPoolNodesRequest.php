...
class BatchResetPoolNodesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchResetPoolNodesRequest';
    ...
    */
    protected static $openAPITypes = [
            'poolName' => 'string',
            'body' => '\HuaweiCloud\SDK\ModelArts\V1\Model\ResetNodesRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\ResetNodesRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\ResetNodesRequest|null $body body
    *
    * @return $this
    */
