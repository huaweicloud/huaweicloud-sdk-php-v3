...
class CountInferServicesByTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CountInferServicesByTagsRequest';
    ...
    */
    protected static $openAPITypes = [
            'contentType' => 'string',
            'workspaceId' => 'string',
            'body' => '\HuaweiCloud\SDK\ModelArts\V1\Model\QueryTmsResourceCountRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\QueryTmsResourceCountRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\QueryTmsResourceCountRequest|null $body body
    *
    * @return $this
    */
