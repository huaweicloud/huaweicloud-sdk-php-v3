...
class ModifyInferIntranetConnectionsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ModifyInferIntranetConnectionsResponse';
