...
class TaskAlgorithmRemoteObs implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'Task_algorithm_remote_obs';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * obsUrl  **参数解释**：数据实际输出到OBS的路径。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。
    *
    * @var string[]
    */
    ...
    * Sets obsUrl
    *
    * @param string $obsUrl **参数解释**：数据实际输出到OBS的路径。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。
    *
    * @return $this
    */
