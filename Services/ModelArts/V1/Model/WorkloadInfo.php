...
class WorkloadInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'WorkloadInfo';
    ...
    * window  统计间隔，1s表示1秒，1m表示一分钟，1h为一小时。
    *
    * @var string[]
    */
    ...
    * Sets window
    *
    * @param string|null $window 统计间隔，1s表示1秒，1m表示一分钟，1h为一小时。
    *
    * @return $this
    */
