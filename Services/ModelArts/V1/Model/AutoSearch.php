...
class AutoSearch implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AutoSearch';
    ...
    */
    protected static $openAPITypes = [
            ...
            'rewardAttrs' => '\HuaweiCloud\SDK\ModelArts\V1\Model\RewardAttrs[]',
            'searchParams' => '\HuaweiCloud\SDK\ModelArts\V1\Model\SearchParams[]',
            'algoConfigs' => '\HuaweiCloud\SDK\ModelArts\V1\Model\AlgoConfigs[]'
    ];
    ...
    *  搜索指标列表。
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\RewardAttrs[]|null
    */
    ...
    * Sets rewardAttrs
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\RewardAttrs[]|null $rewardAttrs 搜索指标列表。
    *
    * @return $this
    */
    ...
    *  搜索参数。
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\SearchParams[]|null
    */
    ...
    * Sets searchParams
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\SearchParams[]|null $searchParams 搜索参数。
    *
    * @return $this
    */
    ...
    *  搜索算法配置。
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\AlgoConfigs[]|null
    */
    ...
    * Sets algoConfigs
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\AlgoConfigs[]|null $algoConfigs 搜索算法配置。
    *
    * @return $this
    */
