...
class ListTrainingJobStagesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTrainingJobStagesResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalCount  **参数解释**：总条数。 **取值范围**：不涉及。
    * runningRecords  **参数解释**：阶段记录。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalCount' => 'int',
            'runningRecords' => '\HuaweiCloud\SDK\ModelArts\V1\Model\StageRecord[]'
    ];
    ...
    *  **参数解释**：阶段记录。
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\StageRecord[]|null
    */
    ...
    * Sets runningRecords
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\StageRecord[]|null $runningRecords **参数解释**：阶段记录。
    *
    * @return $this
    */
