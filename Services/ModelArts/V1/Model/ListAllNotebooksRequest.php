...
class ListAllNotebooksRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAllNotebooksRequest';
    ...
    * poolId  **参数解释**：专属资源池ID，获取方法请参见[查询资源池列表](ListPools.xml)。 **约束限制**：不涉及。 **取值范围**：长度最长为64个字符，最短为4个字符，支持小写字母、数字、中划线，且必须是小写字母开头，小写字母或数字结尾。 **默认取值**：不涉及。
    ...
    * flavor  **参数解释**：实例的机器规格编码，支持模糊匹配查询。如下规格仅供参考，实际支持的规格以具体区域为准。 modelarts.vm.cpu.2u：Intel CPU通用规格，用于快速数据探索和实验。 modelarts.vm.cpu.8u：Intel CPU算力增强型，适用于密集计算场景下运算。 **约束限制**：不支持专属资源池的自定义规格查询。 **取值范围**：长度限制1-256字符，支持数字、大小写字母、小数点、下划线或中划线。 **默认取值**：不涉及。
    ...
    * tags  **参数解释**：实例标签信息。 **约束限制**：不涉及。 **取值范围**：不以逗号，竖划线开头，不以逗号结尾，不出现连续的竖划线和逗号，允许中文、西文、葡文等语言以及空格_.:/=+-@特殊字符，且字符间以逗号或者竖划线分割。例：tag_key1|tag_value1,tag_key2|tag_value2。 **默认取值**：不涉及。
    * swrPath  **参数解释**：SWR镜像路径，该参数是针对返回参数NotebookResp中Image的swr_path属性进行模糊匹配查询。 **约束限制**：不涉及。 **取值范围**：长度限制2048个字符，支持数字、大小写字母、下划线、中划线、点号、冒号和斜杠，0-2048个字符。 **默认取值**：不涉及。
    * poolName  **参数解释**：专属资源池名称，支持模糊匹配查询。 **约束限制**：不涉及。 **取值范围**：长度限制1-64字符，支持数字、大小写字母和中划线。 **默认取值**：不涉及。
    * description  **参数解释**：实例描述信息，支持模糊匹配查询。 **约束限制**：不涉及。 **取值范围**：长度限制为512字符，不可包含特殊字符<>。 **默认取值**：不涉及。
    * ip  **参数解释**：节点IP。 **约束限制**：不涉及。 **取值范围**：正确的IPv4地址，暂不支持IPv6地址。 **默认取值**：不涉及。
    * username  **参数解释**：实例创建用户名称，支持模糊匹配查询。 **约束限制**：不涉及。 **取值范围**：长度限制1-256字符，支持数字、大小写字母、小数点、下划线或中划线。 **默认取值**：不涉及。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['flavor']) && !preg_match("/^[0-9a-zA-Z-_.]{1,256}$/", $this->container['flavor'])) {
                $invalidProperties[] = "invalid value for 'flavor', must be conform to the pattern /^[0-9a-zA-Z-_.]{1,256}$/.";
            }
            ...
            if (!is_null($this->container['tags']) && !preg_match("/^(?![,\\|])(?!,$)[\\p{L}\\p{Z}\\p{N}_.:\/=+\\-@]+(?:[,\\|][\\p{L}\\p{Z}\\p{N}_.:\/=+\\-@]+)*(\\|?)$/", $this->container['tags'])) {
                $invalidProperties[] = "invalid value for 'tags', must be conform to the pattern /^(?![,\\|])(?!,$)[\\p{L}\\p{Z}\\p{N}_.:\/=+\\-@]+(?:[,\\|][\\p{L}\\p{Z}\\p{N}_.:\/=+\\-@]+)*(\\|?)$/.";
            }
            if (!is_null($this->container['swrPath']) && !preg_match("/^[-_\/a-zA-Z0-9.:]{0,2048}$/", $this->container['swrPath'])) {
                $invalidProperties[] = "invalid value for 'swrPath', must be conform to the pattern /^[-_\/a-zA-Z0-9.:]{0,2048}$/.";
            }
            if (!is_null($this->container['poolName']) && !preg_match("/^[0-9a-zA-Z-_.]{1,256}$/", $this->container['poolName'])) {
                $invalidProperties[] = "invalid value for 'poolName', must be conform to the pattern /^[0-9a-zA-Z-_.]{1,256}$/.";
            }
            ...
            if (!is_null($this->container['ip']) && !preg_match("/([1-9]|[1-9]\\d|1\\d{2}|2[0-4]\\d|25[0-5])(\\.(\\d|[1-9]\\d|1\\d{2}|2[0-4]\\d|25[0-5])){3}/", $this->container['ip'])) {
                $invalidProperties[] = "invalid value for 'ip', must be conform to the pattern /([1-9]|[1-9]\\d|1\\d{2}|2[0-4]\\d|25[0-5])(\\.(\\d|[1-9]\\d|1\\d{2}|2[0-4]\\d|25[0-5])){3}/.";
            }
            if (!is_null($this->container['username']) && !preg_match("/^[0-9a-zA-Z-_.]{1,256}$/", $this->container['username'])) {
                $invalidProperties[] = "invalid value for 'username', must be conform to the pattern /^[0-9a-zA-Z-_.]{1,256}$/.";
            }
    ...
    * Sets poolId
    *
    * @param string|null $poolId **参数解释**：专属资源池ID，获取方法请参见[查询资源池列表](ListPools.xml)。 **约束限制**：不涉及。 **取值范围**：长度最长为64个字符，最短为4个字符，支持小写字母、数字、中划线，且必须是小写字母开头，小写字母或数字结尾。 **默认取值**：不涉及。
    *
    * @return $this
    */
    ...
    * Sets flavor
    *
    * @param string|null $flavor **参数解释**：实例的机器规格编码，支持模糊匹配查询。如下规格仅供参考，实际支持的规格以具体区域为准。 modelarts.vm.cpu.2u：Intel CPU通用规格，用于快速数据探索和实验。 modelarts.vm.cpu.8u：Intel CPU算力增强型，适用于密集计算场景下运算。 **约束限制**：不支持专属资源池的自定义规格查询。 **取值范围**：长度限制1-256字符，支持数字、大小写字母、小数点、下划线或中划线。 **默认取值**：不涉及。
    *
    * @return $this
    */
    ...
    * Sets tags
    *
    * @param string|null $tags **参数解释**：实例标签信息。 **约束限制**：不涉及。 **取值范围**：不以逗号，竖划线开头，不以逗号结尾，不出现连续的竖划线和逗号，允许中文、西文、葡文等语言以及空格_.:/=+-@特殊字符，且字符间以逗号或者竖划线分割。例：tag_key1|tag_value1,tag_key2|tag_value2。 **默认取值**：不涉及。
    *
    * @return $this
    */
    ...
    * Sets swrPath
    *
    * @param string|null $swrPath **参数解释**：SWR镜像路径，该参数是针对返回参数NotebookResp中Image的swr_path属性进行模糊匹配查询。 **约束限制**：不涉及。 **取值范围**：长度限制2048个字符，支持数字、大小写字母、下划线、中划线、点号、冒号和斜杠，0-2048个字符。 **默认取值**：不涉及。
    *
    * @return $this
    */
    ...
    * Sets poolName
    *
    * @param string|null $poolName **参数解释**：专属资源池名称，支持模糊匹配查询。 **约束限制**：不涉及。 **取值范围**：长度限制1-64字符，支持数字、大小写字母和中划线。 **默认取值**：不涉及。
    *
    * @return $this
    */
    ...
    * Sets description
    *
    * @param string|null $description **参数解释**：实例描述信息，支持模糊匹配查询。 **约束限制**：不涉及。 **取值范围**：长度限制为512字符，不可包含特殊字符<>。 **默认取值**：不涉及。
    *
    * @return $this
    */
    ...
    * Sets ip
    *
    * @param string|null $ip **参数解释**：节点IP。 **约束限制**：不涉及。 **取值范围**：正确的IPv4地址，暂不支持IPv6地址。 **默认取值**：不涉及。
    *
    * @return $this
    */
    ...
    * Sets username
    *
    * @param string|null $username **参数解释**：实例创建用户名称，支持模糊匹配查询。 **约束限制**：不涉及。 **取值范围**：长度限制1-256字符，支持数字、大小写字母、小数点、下划线或中划线。 **默认取值**：不涉及。
    *
    * @return $this
    */
