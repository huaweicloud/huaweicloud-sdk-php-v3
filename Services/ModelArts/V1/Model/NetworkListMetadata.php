...
class NetworkListMetadata implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NetworkListMetadata';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * continue  **参数解释**：分页查询时，下一次查询位置。 **取值范围**：不涉及。
    * remainingItemCount  **参数解释**：剩余资源个数。 **取值范围**：不涉及。
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['continue']) && !preg_match("/^[a-z][-a-z0-9]{2,126}[a-z0-9]$/", $this->container['continue'])) {
                $invalidProperties[] = "invalid value for 'continue', must be conform to the pattern /^[a-z][-a-z0-9]{2,126}[a-z0-9]$/.";
            }
    ...
    * Sets continue
    *
    * @param string|null $continue **参数解释**：分页查询时，下一次查询位置。 **取值范围**：不涉及。
    *
    * @return $this
    */
    ...
    *
    * @param int|null $remainingItemCount **参数解释**：剩余资源个数。 **取值范围**：不涉及。
    *
    * @return $this
    */
