...
class UpdateInferDeploymentRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateInferDeploymentRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'deploymentId' => 'string',
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\ModelArts\V1\Model\GroupConfigUpdateRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\GroupConfigUpdateRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\GroupConfigUpdateRequest|null $body body
    *
    * @return $this
    */
