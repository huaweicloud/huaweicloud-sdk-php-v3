...
class DetachDevServerPortRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DetachDevServerPortRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  **参数解释**：lite Server实例ID。 **约束限制**：^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$。 **取值范围**：1 - 64字符。 **默认取值**：不涉及。
    * portId  **参数解释**：要卸载的网卡ID。 **约束限制**：^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$。 **取值范围**：1 - 64字符。 **默认取值**：不涉及。
    *
    * @var string[]
    */
