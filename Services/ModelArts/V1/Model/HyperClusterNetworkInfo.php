...
class HyperClusterNetworkInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'HyperCluster_network_info';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * hyperClusterSubnetId  **参数解释**：hyper cluster的子网名称。 **取值范围**：^[-_.a-zA-Z0-9]{1,64}$。
    * isDefault  **参数解释**：是否默认。 **约束限制**：不涉及。 **取值范围**： - true：默认网络 - false：非默认网络
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['hyperClusterSubnetId']) && (mb_strlen($this->container['hyperClusterSubnetId']) > 128)) {
                $invalidProperties[] = "invalid value for 'hyperClusterSubnetId', the character length must be smaller than or equal to 128.";
            }
    ...
    *
    * @param string|null $hyperClusterSubnetId **参数解释**：hyper cluster的子网名称。 **取值范围**：^[-_.a-zA-Z0-9]{1,64}$。
    *
    * @return $this
    */
    ...
    * Sets isDefault
    *
    * @param bool|null $isDefault **参数解释**：是否默认。 **约束限制**：不涉及。 **取值范围**： - true：默认网络 - false：非默认网络
    *
    * @return $this
    */
