...
class NetworkMetadataLabels implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NetworkMetadataLabels';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * osModelartsName  **参数解释**：资源池的显示名称。 **取值范围**：只能以小写字母开头，数字、中划线组成，不能以中划线结尾，且长度为4-32。
    * osModelartsWorkspaceId  **参数解释**：工作空间ID。[获取方法请参见[查询工作空间列表](ListWorkspace.xml)。](tag:hc) **取值范围**：不涉及。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['osModelartsName'] === null) {
            ...
            if ((mb_strlen($this->container['osModelartsName']) > 32)) {
                $invalidProperties[] = "invalid value for 'osModelartsName', the character length must be smaller than or equal to 32.";
            }
    ...
    *
    * @param string $osModelartsName **参数解释**：资源池的显示名称。 **取值范围**：只能以小写字母开头，数字、中划线组成，不能以中划线结尾，且长度为4-32。
    *
    * @return $this
    */
    ...
    *
    * @param string|null $osModelartsWorkspaceId **参数解释**：工作空间ID。[获取方法请参见[查询工作空间列表](ListWorkspace.xml)。](tag:hc) **取值范围**：不涉及。
    *
    * @return $this
    */
