...
class ShowAutoSearchParamAnalysisResultPathRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAutoSearchParamAnalysisResultPathRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * parameterName  搜索参数名称
