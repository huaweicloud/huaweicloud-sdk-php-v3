...
class ListScheduledEventsResponse implements ModelInterface, ArrayAccess
{
    ...
    * events  **参数解释**：计划事件列表
    * count  **参数解释**：计划事件总数。 **取值范围**：不涉及。
    * xRequestId  xRequestId
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'events' => '\HuaweiCloud\SDK\ModelArts\V1\Model\ScheduledEvent[]',
            'count' => 'int',
            'xRequestId' => 'string'
    ];
    ...
    *  **参数解释**：计划事件列表
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\ScheduledEvent[]|null
    */
    ...
    * Sets events
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\ScheduledEvent[]|null $events **参数解释**：计划事件列表
    *
    * @return $this
    */
    ...
    * Sets count
    *
    * @param int|null $count **参数解释**：计划事件总数。 **取值范围**：不涉及。
    *
    * @return $this
    */
