...
class WorkflowSchedulePolicies implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'WorkflowSchedulePolicies';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * onFailure  定时调度策略中的标记，失败时触发。
    * onRunning  定时调度策略中的标记，running时触发。
    *
    * @var string[]
    */
    ...
    * Sets onFailure
    *
    * @param string|null $onFailure 定时调度策略中的标记，失败时触发。
    *
    * @return $this
    */
    ...
    * Sets onRunning
    *
    * @param string|null $onRunning 定时调度策略中的标记，running时触发。
    *
    * @return $this
    */
