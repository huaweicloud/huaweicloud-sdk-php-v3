...
class OutputResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'OutputResp';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  **参数解释**：数据输出通道名称。 **取值范围**：不涉及。
    * description  **参数解释**：数据输出通道描述信息。 **取值范围**：不涉及。
    * localDir  **参数解释**：数据输出通道映射的容器本地路径。 **取值范围**：不涉及。
    ...
    */
    protected static $openAPITypes = [
            ...
            'localDir' => 'string',
            'accessMethod' => 'string',
            'remote' => '\HuaweiCloud\SDK\ModelArts\V1\Model\RemoteResp'
    ];
    ...
    * Sets name
    *
    * @param string $name **参数解释**：数据输出通道名称。 **取值范围**：不涉及。
    *
    * @return $this
    */
    ...
    * Sets description
    *
    * @param string|null $description **参数解释**：数据输出通道描述信息。 **取值范围**：不涉及。
    *
    * @return $this
    */
    ...
    * Sets localDir
    *
    * @param string|null $localDir **参数解释**：数据输出通道映射的容器本地路径。 **取值范围**：不涉及。
    *
    * @return $this
    */
    ...
    *  remote
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\RemoteResp
    */
    ...
    * Sets remote
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\RemoteResp $remote remote
    *
    * @return $this
    */
