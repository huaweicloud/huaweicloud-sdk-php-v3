...
class JobAlgorithmResponsePoliciesAutoSearchSearchParams implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'JobAlgorithmResponse_policies_auto_search_search_params';
