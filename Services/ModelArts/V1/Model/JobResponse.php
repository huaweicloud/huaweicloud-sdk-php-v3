...
class JobResponse implements ModelInterface, ArrayAccess
{
    ...
    * Sets kind
    *
    * @param string $kind **参数解释**：训练作业类型。 **取值范围**： - job：普通作业 - federated_pool_job：资源池联邦作业 - edge_job：边缘作业 - hetero_job：异构作业 - mrs_job：MRS作业 - autosearch_job：自动化搜索作业 - diag_job：诊断作业 - visualization_job：可视化作业
    *
    * @return $this
    */
    ...
    *  metadata
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\JobMetadataResponse
    */
    ...
    * Sets metadata
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\JobMetadataResponse $metadata metadata
    *
    * @return $this
    */
