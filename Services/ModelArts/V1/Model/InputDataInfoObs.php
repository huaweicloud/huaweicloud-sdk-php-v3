...
class InputDataInfoObs implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'InputDataInfo_obs';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * obsUrl  训练作业需要的数据集OBS路径URL。如：“/usr/data/”。
    *
    * @var string[]
    */
    ...
    * Sets obsUrl
    *
    * @param string $obsUrl 训练作业需要的数据集OBS路径URL。如：“/usr/data/”。
    *
    * @return $this
    */
