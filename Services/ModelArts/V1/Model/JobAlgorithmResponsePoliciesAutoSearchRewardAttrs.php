...
class JobAlgorithmResponsePoliciesAutoSearchRewardAttrs implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'JobAlgorithmResponse_policies_auto_search_reward_attrs';
