...
class DeleteImageResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteImageResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * arch  **参数解释**：该镜像所支持处理器架构类型。 **取值范围**：枚举类型，取值如下： - X86_64：x86处理器架构。 - AARCH64：ARM体系架构。
    * createAt  **参数解释**：镜像创建的时间，UTC毫秒。 **取值范围**：不涉及。
    * description  **参数解释**：该镜像所对应的描述信息。 **取值范围**：长度限制512个字符。
    * devServices  **参数解释**：镜像支持的服务。 **取值范围**：枚举类型，取值如下： - NOTEBOOK：镜像支持通过https协议访问Notebook。 - SSH：镜像支持本地IDE通过SSH协议远程连接Notebook。
    ...
    * resourceCategories  **参数解释**：镜像支持的规格。枚举类型，取值如下： - CPU - GPU - [ASCEND](tag:hc,hk,fcs_super)
    ...
    * supportResCategories  **参数解释**：镜像支持的规格。 枚举类型，取值如下： - CPU - GPU - [ASCEND](tag:hc,hk,fcs_super)
    ...
    */
    protected static $attributeMap = [
            ...
            'supportResCategories' => 'support_res_categories',
            'swrPath' => 'swr_path',
            'tag' => 'tag',
            'type' => 'type',
            'updateAt' => 'update_at',
    ...
    */
    protected static $setters = [
            ...
            'supportResCategories' => 'setSupportResCategories',
            'swrPath' => 'setSwrPath',
            'tag' => 'setTag',
            'type' => 'setType',
    ...
    */
    protected static $getters = [
            ...
            'supportResCategories' => 'getSupportResCategories',
            'swrPath' => 'getSwrPath',
            'tag' => 'getTag',
            'type' => 'getType',
    ...
    */
    ...
    const SUPPORT_RES_CATEGORIES_ASCEND = 'ASCEND';
    const SUPPORT_RES_CATEGORIES_CPU = 'CPU';
    const SUPPORT_RES_CATEGORIES_GPU = 'GPU';
    ...
    * @return string[]
    */
    public function getSupportResCategoriesAllowableValues()
    {
        return [
            self::SUPPORT_RES_CATEGORIES_ASCEND,
            self::SUPPORT_RES_CATEGORIES_CPU,
            self::SUPPORT_RES_CATEGORIES_GPU,
        ];
    }
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['supportResCategories'] = isset($data['supportResCategories']) ? $data['supportResCategories'] : null;
    ...
    * Sets description
    *
    * @param string|null $description **参数解释**：该镜像所对应的描述信息。 **取值范围**：长度限制512个字符。
    *
    * @return $this
    */
    ...
    * Sets devServices
    *
    * @param string[]|null $devServices **参数解释**：镜像支持的服务。 **取值范围**：枚举类型，取值如下： - NOTEBOOK：镜像支持通过https协议访问Notebook。 - SSH：镜像支持本地IDE通过SSH协议远程连接Notebook。
    *
    * @return $this
    */
    ...
    *
    * @param string[]|null $resourceCategories **参数解释**：镜像支持的规格。枚举类型，取值如下： - CPU - GPU - [ASCEND](tag:hc,hk,fcs_super)
    *
    * @return $this
    */
    ...
    */
    ...
    /**
    * Gets supportResCategories
    *  **参数解释**：镜像支持的规格。 枚举类型，取值如下： - CPU - GPU - [ASCEND](tag:hc,hk,fcs_super)
    *
    * @return string[]|null
    */
    public function getSupportResCategories()
    {
        return $this->container['supportResCategories'];
    }

    /**
    * Sets supportResCategories
    *
    * @param string[]|null $supportResCategories **参数解释**：镜像支持的规格。 枚举类型，取值如下： - CPU - GPU - [ASCEND](tag:hc,hk,fcs_super)
    *
    * @return $this
    */
    public function setSupportResCategories($supportResCategories)
    {
        $this->container['supportResCategories'] = $supportResCategories;
        return $this;
    }
