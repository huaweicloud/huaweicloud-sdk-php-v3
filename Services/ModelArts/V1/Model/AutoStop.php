...
class AutoStop implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AutoStop';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * timeUnit  时间单位。可选取值如下： - HOURS
    * duration  运行时长，最小值为1。
    *
    * @var string[]
    */
    ...
    * Sets timeUnit
    *
    * @param string $timeUnit 时间单位。可选取值如下： - HOURS
    *
    * @return $this
    */
