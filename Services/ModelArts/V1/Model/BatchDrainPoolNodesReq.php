...
class BatchDrainPoolNodesReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDrainPoolNodesReq';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * nodeNames  **参数解释**：节点名称列表。 **约束限制**：节点不能超过10个。
    *
    * @var string[]
    */
    ...
    * Sets nodeNames
    *
    * @param string[] $nodeNames **参数解释**：节点名称列表。 **约束限制**：节点不能超过10个。
    *
    * @return $this
    */
