...
class TmsMatch implements ModelInterface, ArrayAccess
{
    ...
    * key  **参数解释：** 匹配项名称，目前只支持resource_name。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    * value  **参数解释：** 匹配项的值，不区分大小写，key为resource_name时使用模糊查询，匹配资源名称。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets key
    *
    * @param string $key **参数解释：** 匹配项名称，目前只支持resource_name。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets value
    *
    * @param string $value **参数解释：** 匹配项的值，不区分大小写，key为resource_name时使用模糊查询，匹配资源名称。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    *
    * @return $this
    */
