...
class UpdateInferDeploymentHpaRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateInferDeploymentHpaRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'deploymentId' => 'string',
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\ModelArts\V1\Model\UpdateHpaRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\UpdateHpaRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\UpdateHpaRequestBody|null $body body
    *
    * @return $this
    */
