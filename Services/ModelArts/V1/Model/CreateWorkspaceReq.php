...
class CreateWorkspaceReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateWorkspaceReq';
    ...
    */
    protected static $openAPITypes = [
            'grants' => '\HuaweiCloud\SDK\ModelArts\V1\Model\CreateWorkspaceReqGrants[]',
            'authType' => 'string',
    ...
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\CreateWorkspaceReqGrants[]|null
    */
    ...
    * Sets grants
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\CreateWorkspaceReqGrants[]|null $grants 授权用户列表，默认为空。需要与“auth_type”参数配合使用，且仅当授权类型为“INTERNAL”时才会生效。
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string $name 工作空间名称。长度限制为4-64字符[，支持中文、大小写字母、数字、中划线和下划线](tag:hc,hk)。同时'default'为系统预留的默认工作空间名称，用户无法自己创建名为'default'的工作空间。
    *
    * @return $this
    */
