...
class UpdateInferHraRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateInferHraRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'deploymentId' => 'string',
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\ModelArts\V1\Model\UpdateHraRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\UpdateHraRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\UpdateHraRequestBody|null $body body
    *
    * @return $this
    */
