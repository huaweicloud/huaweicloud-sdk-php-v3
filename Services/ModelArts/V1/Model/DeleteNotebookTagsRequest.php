...
class DeleteNotebookTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteNotebookTagsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * resourceId  **参数解释**：资源ID：如Notebook实例ID。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。
    ...
    */
    protected static $openAPITypes = [
            'resourceId' => 'string',
            'workspaceId' => 'string',
            'body' => '\HuaweiCloud\SDK\ModelArts\V1\Model\DeleteTmsTagsRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\DeleteTmsTagsRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\DeleteTmsTagsRequest|null $body body
    *
    * @return $this
    */
