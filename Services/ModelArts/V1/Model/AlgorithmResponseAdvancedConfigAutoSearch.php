...
class AlgorithmResponseAdvancedConfigAutoSearch implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AlgorithmResponse_advanced_config_auto_search';
    ...
    */
    protected static $openAPITypes = [
            ...
            'searchParams' => '\HuaweiCloud\SDK\ModelArts\V1\Model\AlgorithmResponseAdvancedConfigAutoSearchSearchParams[]',
    ...
    *  搜索参数。
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\AlgorithmResponseAdvancedConfigAutoSearchSearchParams[]|null
    */
    ...
    * Sets searchParams
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\AlgorithmResponseAdvancedConfigAutoSearchSearchParams[]|null $searchParams 搜索参数。
    *
    * @return $this
    */
