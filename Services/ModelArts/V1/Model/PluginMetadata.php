...
class PluginMetadata implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PluginMetadata';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  **参数解释**： 插件实例的名称。 **取值范围**： 不涉及。
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['name'] === null) {
            ...
            if (!preg_match("/^[a-z][a-z0-9-]{0,48}[a-z0-9]$/", $this->container['name'])) {
                $invalidProperties[] = "invalid value for 'name', must be conform to the pattern /^[a-z][a-z0-9-]{0,48}[a-z0-9]$/.";
            }
    ...
    * Sets name
    *
    * @param string $name **参数解释**： 插件实例的名称。 **取值范围**： 不涉及。
    *
    * @return $this
    */
