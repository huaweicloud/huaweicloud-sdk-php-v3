...
class NfsResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NfsResp';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * nfsServerPath  **参数解释**：nfs服务端路径，如：“10.10.10.10:/example/path”。 **取值范围**：不涉及。
    * localPath  **参数解释**：挂载到训练容器中的路径，如：“/example/path”。 **取值范围**：不涉及。
    * readOnly  **参数解释**：nfs挂载卷在容器中是否只读。 **取值范围**： - true：只读 - false：非只读
    *
    * @var string[]
    */
    ...
    * Sets nfsServerPath
    *
    * @param string|null $nfsServerPath **参数解释**：nfs服务端路径，如：“10.10.10.10:/example/path”。 **取值范围**：不涉及。
    *
    * @return $this
    */
    ...
    * Sets localPath
    *
    * @param string|null $localPath **参数解释**：挂载到训练容器中的路径，如：“/example/path”。 **取值范围**：不涉及。
    *
    * @return $this
    */
    ...
    * Sets readOnly
    *
    * @param bool|null $readOnly **参数解释**：nfs挂载卷在容器中是否只读。 **取值范围**： - true：只读 - false：非只读
    *
    * @return $this
    */
