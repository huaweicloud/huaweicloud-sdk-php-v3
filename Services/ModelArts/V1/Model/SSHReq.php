...
class SSHReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SSHReq';
    ...
    * Sets keyPairNames
    *
    * @param string[]|null $keyPairNames SSH密钥对名称，可以在云服务器控制台（ECS）“密钥对”页面创建和查看。
    *
    * @return $this
    */
