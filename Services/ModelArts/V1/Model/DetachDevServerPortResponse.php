...
class DetachDevServerPortResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DetachDevServerPortResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * portId  **参数解释**：卸载的网卡ID。 **取值范围**：^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$。
    *
    * @var string[]
    */
    ...
    * Sets portId
    *
    * @param string|null $portId **参数解释**：卸载的网卡ID。 **取值范围**：^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$。
    *
    * @return $this
    */
