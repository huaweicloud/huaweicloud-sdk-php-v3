...
class InferModelResponse implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'InferModelResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * source  **参数解释：** 代码来源类别。 **约束限制：** 不涉及。 **取值范围：** 如下参数不区分大小写 - OBS：对象存储服务。 - OBSFS：OBS的文件系统接口。 - EFS：弹性文件服务。 - [TRAIN：训练作业。](tag:hws) - LOCAL：挂载宿主机本地存储目录。 **默认取值：** 不涉及。
    * address  **参数解释：** 代码来源地址，格式遵循不同存储系统。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    * sourceId  **参数解释：** 来源ID。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    ...
    * Sets source
    *
    * @param string $source **参数解释：** 代码来源类别。 **约束限制：** 不涉及。 **取值范围：** 如下参数不区分大小写 - OBS：对象存储服务。 - OBSFS：OBS的文件系统接口。 - EFS：弹性文件服务。 - [TRAIN：训练作业。](tag:hws) - LOCAL：挂载宿主机本地存储目录。 **默认取值：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets sourceId
    *
    * @param string|null $sourceId **参数解释：** 来源ID。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    *
    * @return $this
    */
