...
class GroupModel implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GroupModel';
    ...
    * assetId  参数解释： 预置资产id。 取值范围： 支持1-64位字符，可包含字母、中文、数字、中划线、下划线。
    *
    * @var string[]
    */
    ...
    * Sets assetId
    *
    * @param string|null $assetId 参数解释： 预置资产id。 取值范围： 支持1-64位字符，可包含字母、中文、数字、中划线、下划线。
    *
    * @return $this
    */
