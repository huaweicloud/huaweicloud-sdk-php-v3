...
class UpdateWorkflowScheduleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateWorkflowScheduleRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * workflowId  工作流的ID。
    * scheduleId  工作流调度信息ID。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'workflowId' => 'string',
            'scheduleId' => 'string',
            'body' => '\HuaweiCloud\SDK\ModelArts\V1\Model\WorkflowScheduleUpdate'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\WorkflowScheduleUpdate|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\WorkflowScheduleUpdate|null $body body
    *
    * @return $this
    */
