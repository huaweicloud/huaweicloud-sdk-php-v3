...
class ShowTrainingExperimentDetailsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowTrainingExperimentDetailsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * experimentId  **参数解释**：实验ID。创建训练实验时自动生成返回。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。
    *
    * @var string[]
    */
