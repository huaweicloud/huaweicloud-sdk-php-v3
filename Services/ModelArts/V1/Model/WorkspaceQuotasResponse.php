...
class WorkspaceQuotasResponse implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'WorkspaceQuotasResponse';
    ...
    * unitEn  数量单位(英文)。
    * usedQuota  已用配额值。当quota为-1（不限制配额）时，used_quota为null。
    *
    * @var string[]
    */
    ...
    * Sets usedQuota
    *
    * @param int|null $usedQuota 已用配额值。当quota为-1（不限制配额）时，used_quota为null。
    *
    * @return $this
    */
