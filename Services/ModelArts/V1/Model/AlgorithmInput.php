...
class AlgorithmInput implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AlgorithmInput';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  数据输入通道名称。
    * localDir  数据输入输出通道映射的容器本地路径。
    * remote  remote
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'name' => 'string',
            'localDir' => 'string',
            'remote' => '\HuaweiCloud\SDK\ModelArts\V1\Model\AlgorithmRemote'
    ];
    ...
    * Sets localDir
    *
    * @param string|null $localDir 数据输入输出通道映射的容器本地路径。
    *
    * @return $this
    */
    ...
    *  remote
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\AlgorithmRemote
    */
    ...
    * Sets remote
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\AlgorithmRemote $remote remote
    *
    * @return $this
    */
