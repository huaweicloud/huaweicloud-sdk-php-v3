...
class ServiceResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['failureReason'] === null) {
            $invalidProperties[] = "'failureReason' can't be null";
        }
    ...
    * Sets failureReason
    *
    * @param string $failureReason **参数解释：** 在线服务失败原因。 **取值范围：** 不涉及。
    *
    * @return $this
    */
