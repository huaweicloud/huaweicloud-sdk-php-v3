...
class Taints implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'Taints';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * key  **参数解释**：键。 **取值范围**：不涉及。
    * value  **参数解释**：值。 **取值范围**：不涉及。
    * effect  **参数解释**：作用效果。 **取值范围**：不涉及。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['effect'] === null) {
            ...
            if ((mb_strlen($this->container['effect']) > 256)) {
                $invalidProperties[] = "invalid value for 'effect', the character length must be smaller than or equal to 256.";
            }
            if ((mb_strlen($this->container['effect']) < 1)) {
                $invalidProperties[] = "invalid value for 'effect', the character length must be bigger than or equal to 1.";
            }
    ...
    * Sets value
    *
    * @param string|null $value **参数解释**：值。 **取值范围**：不涉及。
    *
    * @return $this
    */
    ...
    * Sets effect
    *
    * @param string $effect **参数解释**：作用效果。 **取值范围**：不涉及。
    *
    * @return $this
    */
