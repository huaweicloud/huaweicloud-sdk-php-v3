...
class ApiKeyResponseV2 implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ApiKeyResponseV2';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['createTime'] === null) {
            ...
            if ((mb_strlen($this->container['createTime']) > 13)) {
        ...
        if ($this->container['scope'] === null) {
            ...
            if ((mb_strlen($this->container['scope']) > 64)) {
    ...
    * Sets name
    *
    * @param string $name **参数解释：** api-key的名称，在[创建API_KEY](CreateInferApiKey.xml)时自定义。 **取值范围：** 支持1-64个字符，可以包含字母、汉字、数字、连字符和下划线。
    *
    * @return $this
    */
    ...
    * Sets description
    *
    * @param string $description **参数解释：** api-key的描述，在[创建API_KEY](CreateInferApiKey.xml)时自定义。 **取值范围：** 支持1-256个字符，可以包含字母、汉字、数字、连字符和下划线。
    *
    * @return $this
    */
    ...
    * Sets createTime
    *
    * @param string $createTime **参数解释：** api-key的创建时间，根据创建时的当前时间自动生成。 **取值范围：** 毫秒级时间戳，13位数字，如1609459200000。
    *
    * @return $this
    */
    ...
    * Sets scope
    *
    * @param string $scope **参数解释：** api-key生效范围。 **取值范围：** - USER：表示生效范围为用户级别，可以访问该用户创建的所有在线服务。 - SERVICE：表示生效范围为单个服务，可以访问绑定该api-key的在线服务。
    *
    * @return $this
    */
    ...
    * Sets domainId
    *
    * @param string $domainId **参数解释：** 用户domain ID。获取方法请参见[获取账号名和账号ID](modelarts_03_0148.xml)。 **取值范围：** 账号ID。
    *
    * @return $this
    */
    ...
    * Sets projectId
    *
    * @param string $projectId **参数解释：** [用户项目ID](tag:hws,hws_hk,fcs,fcs_super)[资源空间ID](tag:hcs,hcs_sm)。获取方法请参见[[获取项目ID和名称](tag:hws,hws_hk,fcs,fcs_super)[获取资源空间ID和名称](tag:hcs,hcs_sm)](modelarts_03_0147.xml)。 **取值范围：** 账号的项目ID。
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\ServiceIdName[]
    */
    ...
    * Sets services
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\ServiceIdName[] $services **参数解释：** 绑定此api-key的在线服务列表。
    *
    * @return $this
    */
    ...
    * Sets workspaceId
    *
    * @param string $workspaceId **参数解释：** 工作空间ID。 **取值范围：** 工作空间ID。
    *
    * @return $this
    */
