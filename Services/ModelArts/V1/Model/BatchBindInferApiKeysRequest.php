...
class BatchBindInferApiKeysRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchBindInferApiKeysRequest';
    ...
    */
    protected static $openAPITypes = [
            'serviceId' => 'string',
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\ModelArts\V1\Model\BatchBindApiKeyRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\BatchBindApiKeyRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\BatchBindApiKeyRequest|null $body body
    *
    * @return $this
    */
