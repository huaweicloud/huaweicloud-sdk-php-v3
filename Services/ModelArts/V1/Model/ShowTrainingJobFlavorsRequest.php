...
class ShowTrainingJobFlavorsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowTrainingJobFlavorsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * flavorType  查询训练作业规格的类型，不填为查询所有。枚举值：  - CPU  - GPU  - [Ascend](tag:hc,hk,fcs_super)
    *
    * @var string[]
    */
    ...
    * Sets flavorType
    *
    * @param string|null $flavorType 查询训练作业规格的类型，不填为查询所有。枚举值：  - CPU  - GPU  - [Ascend](tag:hc,hk,fcs_super)
    *
    * @return $this
    */
