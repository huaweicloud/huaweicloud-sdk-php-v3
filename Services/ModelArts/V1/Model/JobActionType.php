...
class JobActionType implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'JobActionType';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * actionType  对训练作业的操作请求。参数值设置为terminate时，表示终止训练作业操作。
    *
    * @var string[]
    */
    ...
    * Sets actionType
    *
    * @param string $actionType 对训练作业的操作请求。参数值设置为terminate时，表示终止训练作业操作。
    *
    * @return $this
    */
