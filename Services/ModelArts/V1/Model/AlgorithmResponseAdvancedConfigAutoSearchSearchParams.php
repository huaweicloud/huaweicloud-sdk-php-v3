...
class AlgorithmResponseAdvancedConfigAutoSearchSearchParams implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AlgorithmResponse_advanced_config_auto_search_search_params';
