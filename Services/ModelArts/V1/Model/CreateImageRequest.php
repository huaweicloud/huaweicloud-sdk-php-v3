...
class CreateImageRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'id' => 'string',
            'body' => '\HuaweiCloud\SDK\ModelArts\V1\Model\ImageCreateReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\ImageCreateReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\ImageCreateReq|null $body body
    *
    * @return $this
    */
