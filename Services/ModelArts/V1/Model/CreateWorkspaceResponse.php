...
class CreateWorkspaceResponse implements ModelInterface, ArrayAccess
{
    ...
    * owner  创建者名称。
    * authType  授权类型。默认值为PUBLIC。PUBLIC：租户内部公开访问。PRIVATE：仅创建者和主账号可访问。INTERNAL：创建者、主账号、指定IAM子账号可访问，需要与grants参数配合使用。
    ...
    */
    protected static $openAPITypes = [
            ...
            'status' => 'string',
            'statusInfo' => 'string',
            'grants' => '\HuaweiCloud\SDK\ModelArts\V1\Model\CreateWorkspaceResponseBodyGrants[]'
    ];
    ...
    * Sets authType
    *
    * @param string|null $authType 授权类型。默认值为PUBLIC。PUBLIC：租户内部公开访问。PRIVATE：仅创建者和主账号可访问。INTERNAL：创建者、主账号、指定IAM子账号可访问，需要与grants参数配合使用。
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\ModelArts\V1\Model\CreateWorkspaceResponseBodyGrants[]|null
    */
    ...
    * Sets grants
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\CreateWorkspaceResponseBodyGrants[]|null $grants 授权用户列表。默认为空。需要与“auth_type”参数配合使用，且仅当授权类型为“INTERNAL”时才会生效。
    *
    * @return $this
    */
