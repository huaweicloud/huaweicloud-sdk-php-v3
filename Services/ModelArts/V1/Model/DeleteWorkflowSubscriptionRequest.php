...
class DeleteWorkflowSubscriptionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteWorkflowSubscriptionRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * workflowId  工作流的ID。
    * subscriptionId  工作流的消息订阅ID。
    *
    * @var string[]
    */
