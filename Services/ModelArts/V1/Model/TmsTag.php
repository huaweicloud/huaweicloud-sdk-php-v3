...
class TmsTag implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TmsTag';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * key  **参数解释**：TMS标签的key。 **约束限制**：长度限制为128个字符，支持任意语种字母、数字、空格，以及_ . : = + - @特殊字符，但首尾不能含有空格，不能以_sys_开头。 **取值范围**：不涉及。 **默认取值**：不涉及。
    * value  **参数解释**：TMS标签的value。 **约束限制**：长度限制为255个字符，支持任意语种字母、数字、空格，以及_ . : / = + - @特殊字符。 **取值范围**：不涉及。 **默认取值**：不涉及。
    *
    * @var string[]
    */
    ...
    * Sets key
    *
    * @param string $key **参数解释**：TMS标签的key。 **约束限制**：长度限制为128个字符，支持任意语种字母、数字、空格，以及_ . : = + - @特殊字符，但首尾不能含有空格，不能以_sys_开头。 **取值范围**：不涉及。 **默认取值**：不涉及。
    *
    * @return $this
    */
    ...
    * Sets value
    *
    * @param string|null $value **参数解释**：TMS标签的value。 **约束限制**：长度限制为255个字符，支持任意语种字母、数字、空格，以及_ . : / = + - @特殊字符。 **取值范围**：不涉及。 **默认取值**：不涉及。
    *
    * @return $this
    */
