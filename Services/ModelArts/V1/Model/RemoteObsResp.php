...
class RemoteObsResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RemoteObsResp';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * obsUrl  **参数解释**：数据实际输出到OBS的路径。 **取值范围**：不涉及。
    *
    * @var string[]
    */
    ...
    * Sets obsUrl
    *
    * @param string $obsUrl **参数解释**：数据实际输出到OBS的路径。 **取值范围**：不涉及。
    *
    * @return $this
    */
