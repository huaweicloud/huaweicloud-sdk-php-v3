...
class PoolSpecUpdateResources implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PoolSpecUpdate_resources';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * flavor  **参数解释**：资源规格。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。
    * count  **参数解释**：相应规格的资源数量。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。
    * azs  **参数解释**：更新的AZ列表。
    *
    * @var string[]
    */
    ...
    * Sets flavor
    *
    * @param string $flavor **参数解释**：资源规格。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。
    *
    * @return $this
    */
    ...
    * Sets count
    *
    * @param int $count **参数解释**：相应规格的资源数量。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。
    *
    * @return $this
    */
    ...
    * Sets azs
    *
    * @param \HuaweiCloud\SDK\ModelArts\V1\Model\PoolNodeAz[]|null $azs **参数解释**：更新的AZ列表。
    *
    * @return $this
    */
