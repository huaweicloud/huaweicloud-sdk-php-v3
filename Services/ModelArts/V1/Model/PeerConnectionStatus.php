...
class PeerConnectionStatus implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PeerConnectionStatus';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * peerVpcId  **参数解释**：对端的VPC ID。 **取值范围**：不涉及。
    * peerSubnetId  **参数解释**：对端的子网ID。 **取值范围**：不涉及。
    * defaultGateWay  **参数解释**：创建默认路由的开关。 **取值范围**：默认为false不创建。
    * phase  **参数解释**：网络的连接状态。 **取值范围**：可选值如下： - Connecting：网络连接中 - Active：网络连接正常 - Abnormal：网络连接不正常
    *
    * @var string[]
    */
    ...
    * Sets defaultGateWay
    *
    * @param bool|null $defaultGateWay **参数解释**：创建默认路由的开关。 **取值范围**：默认为false不创建。
    *
    * @return $this
    */
    ...
    * Sets phase
    *
    * @param string|null $phase **参数解释**：网络的连接状态。 **取值范围**：可选值如下： - Connecting：网络连接中 - Active：网络连接正常 - Abnormal：网络连接不正常
    *
    * @return $this
    */
