...
class DeleteIpReputationRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteIpReputationRuleRequest';
    ...
    * ruleId  **参数解释：** 机房IP情报访问控制规则id，通过查询机房IP情报规则列表接口获取https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=WAF&api=ListIdcIpRule **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @var string[]
    */
