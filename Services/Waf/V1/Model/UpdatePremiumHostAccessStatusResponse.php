...
class UpdatePremiumHostAccessStatusResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePremiumHostAccessStatusResponse';
    ...
    * Sets accessStatus
    *
    * @param int|null $accessStatus **参数解释：** 域名接入状态 **约束限制：** 不涉及 **取值范围：** - 0 关闭 - 1 开启 **默认取值：** 不涉及
    *
    * @return $this
    */
