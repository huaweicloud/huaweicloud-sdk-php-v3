...
class BatchCreateIpReputationRuleResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateIpReputationRuleResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  **参数解释：** 规则ID，唯一标识该规则 **约束限制：** 同一个标签在多个规则中只能出现一次，即多个规则的标签列表不允许重合 **取值范围：** 不涉及 **默认取值：** 不涉及
    ...
    * timestamp  **参数解释：** 规则创建时间戳（毫秒级） **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    ...
    * Sets id
    *
    * @param string|null $id **参数解释：** 规则ID，唯一标识该规则 **约束限制：** 同一个标签在多个规则中只能出现一次，即多个规则的标签列表不允许重合 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @return $this
    */
    ...
    * Sets timestamp
    *
    * @param int|null $timestamp **参数解释：** 规则创建时间戳（毫秒级） **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @return $this
    */
