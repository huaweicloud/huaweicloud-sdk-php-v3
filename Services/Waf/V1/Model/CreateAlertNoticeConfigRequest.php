...
class CreateAlertNoticeConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAlertNoticeConfigRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * xLanguage  **参数解释：** 语言，默认值为en-us。zh-cn（中文）/en-us（英文） **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** zh-cn
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Waf\V1\Model\CreateAlertNoticeConfigBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\CreateAlertNoticeConfigBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\CreateAlertNoticeConfigBody|null $body body
    *
    * @return $this
    */
