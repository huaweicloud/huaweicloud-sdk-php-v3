...
class SecurityReportContentResponseReportContentInfoResponseCodeStatisticsInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SecurityReportContentResponse_report_content_info_response_code_statistics_info';
    ...
    */
    protected static $openAPITypes = [
            'responseSourceWafInfoList' => '\HuaweiCloud\SDK\Waf\V1\Model\SecurityReportContentResponseReportContentInfoResponseCodeStatisticsInfoResponseSourceWafInfoList[]',
            'responseSourceUpstreamInfoList' => '\HuaweiCloud\SDK\Waf\V1\Model\SecurityReportContentResponseReportContentInfoResponseCodeStatisticsInfoResponseSourceUpstreamInfoList[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\SecurityReportContentResponseReportContentInfoResponseCodeStatisticsInfoResponseSourceWafInfoList[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\SecurityReportContentResponseReportContentInfoResponseCodeStatisticsInfoResponseSourceWafInfoList[]|null $responseSourceWafInfoList **参数解释：** WAF响应码统计列表，包含各响应码按时间线的WAF返回数量。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\SecurityReportContentResponseReportContentInfoResponseCodeStatisticsInfoResponseSourceUpstreamInfoList[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\SecurityReportContentResponseReportContentInfoResponseCodeStatisticsInfoResponseSourceUpstreamInfoList[]|null $responseSourceUpstreamInfoList **参数解释：** 上游响应码统计列表，包含各响应码按时间线的上游返回数量。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @return $this
    */
