...
class AlertNoticeConfig implements ModelInterface, ArrayAccess
{
    ...
    * topicUrn  **参数解释：** 通知模板，关联用于发送告警通知的SMN主题URN **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    * sendfreq  **参数解释：** 通知频率，控制告警通知的发送间隔 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    * locale  **参数解释：** 地区，指定告警通知的语言或地域相关配置 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    ...
    * Sets topicUrn
    *
    * @param string|null $topicUrn **参数解释：** 通知模板，关联用于发送告警通知的SMN主题URN **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @return $this
    */
    ...
    * Sets locale
    *
    * @param string|null $locale **参数解释：** 地区，指定告警通知的语言或地域相关配置 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @return $this
    */
