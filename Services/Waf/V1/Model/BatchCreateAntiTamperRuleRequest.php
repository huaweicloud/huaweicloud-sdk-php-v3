...
class BatchCreateAntiTamperRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateAntiTamperRuleRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\Waf\V1\Model\BatchCreateAntiTamperRulesRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\BatchCreateAntiTamperRulesRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\BatchCreateAntiTamperRulesRequestBody|null $body body
    *
    * @return $this
    */
