...
class BatchCreateCustomRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateCustomRuleRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\Waf\V1\Model\BatchCreateCustomRuleRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\BatchCreateCustomRuleRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\BatchCreateCustomRuleRequestBody|null $body body
    *
    * @return $this
    */
