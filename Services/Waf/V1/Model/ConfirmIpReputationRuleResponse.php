...
class ConfirmIpReputationRuleResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ConfirmIpReputationRuleResponse';
    ...
    * timestamp  **参数解释：** 规则最后更新时间戳（毫秒级） **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    ...
    * Sets timestamp
    *
    * @param int|null $timestamp **参数解释：** 规则最后更新时间戳（毫秒级） **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @return $this
    */
