...
class CreateIpReputationRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateIpReputationRuleRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'policyId' => 'string',
            'body' => '\HuaweiCloud\SDK\Waf\V1\Model\CreateIpReputationRuleRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\CreateIpReputationRuleRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\CreateIpReputationRuleRequestBody|null $body body
    *
    * @return $this
    */
