...
class BatchCreateIpReputationRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateIpReputationRuleRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\Waf\V1\Model\BatchCreateIpReputationRuleRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\BatchCreateIpReputationRuleRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\BatchCreateIpReputationRuleRequestBody|null $body body
    *
    * @return $this
    */
