...
class ListResponseCodeTimelineRequest implements ModelInterface, ArrayAccess
{
    ...
    * from  **参数解释：** 起始时间 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    * to  **参数解释：** 结束时间 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    * hosts  **参数解释：** 要查询域名列表 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    * instances  **参数解释：** 要查询实例列表 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    * responseSource  **参数解释：** 响应源 **约束限制：** 不涉及 **取值范围：** 可选值为WAF、UPSTREAM **默认取值：** 不涉及
    * groupBy  **参数解释：** 展示维度，按天展示时传\"DAY\" **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @var string[]
    */
    ...
    * Sets from
    *
    * @param int $from **参数解释：** 起始时间 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @return $this
    */
    ...
    * Sets to
    *
    * @param int $to **参数解释：** 结束时间 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @return $this
    */
    ...
    * Sets hosts
    *
    * @param string[]|null $hosts **参数解释：** 要查询域名列表 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @return $this
    */
    ...
    * Sets instances
    *
    * @param string[]|null $instances **参数解释：** 要查询实例列表 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @return $this
    */
    ...
    * Sets responseSource
    *
    * @param string|null $responseSource **参数解释：** 响应源 **约束限制：** 不涉及 **取值范围：** 可选值为WAF、UPSTREAM **默认取值：** 不涉及
    *
    * @return $this
    */
    ...
    * Sets groupBy
    *
    * @param string|null $groupBy **参数解释：** 展示维度，按天展示时传\"DAY\" **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @return $this
    */
