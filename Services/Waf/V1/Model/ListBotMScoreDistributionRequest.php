...
class ListBotMScoreDistributionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListBotMScoreDistributionRequest';
    ...
    * domains  **参数解释：** 域名,查询的域名列表，与hosts二选一，如果hosts不为空，以hosts为准 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    ...
    * Sets domains
    *
    * @param string[]|null $domains **参数解释：** 域名,查询的域名列表，与hosts二选一，如果hosts不为空，以hosts为准 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @return $this
    */
