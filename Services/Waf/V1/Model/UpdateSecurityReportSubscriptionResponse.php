...
class UpdateSecurityReportSubscriptionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateSecurityReportSubscriptionResponse';
