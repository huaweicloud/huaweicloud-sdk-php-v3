...
class BatchDeleteAlertNoticeConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'xLanguage' => 'string',
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\Waf\V1\Model\BatchDeleteAlertNoticeConfigBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\BatchDeleteAlertNoticeConfigBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\BatchDeleteAlertNoticeConfigBody|null $body body
    *
    * @return $this
    */
