...
class SecurityReportSubscriptionResponseReportContentSubscription implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SecurityReportSubscriptionResponse_report_content_subscription';
    ...
    * topAbnormalUrlsEnable  **参数解释：** 是否启用TOP异常URL统计（true表示启用，false表示禁用）。 **约束限制：** 不涉及 **取值范围：** 仅支持true、false两个布尔值 **默认取值：** true
    *
    * @var string[]
    */
    ...
    *
    * @param bool|null $topAbnormalUrlsEnable **参数解释：** 是否启用TOP异常URL统计（true表示启用，false表示禁用）。 **约束限制：** 不涉及 **取值范围：** 仅支持true、false两个布尔值 **默认取值：** true
    *
    * @return $this
    */
