...
class ConfirmAsyncJobRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ConfirmAsyncJobRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * jobId  **参数解释：** 异步任务的任务id **约束限制：** 不涉及 **取值范围：** 只能由英文字母、数字组成，且长度为32个字符。 **默认取值：** 不涉及
