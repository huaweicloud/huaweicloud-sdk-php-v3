...
class ListSecurityReportSendingRecordsRequest implements ModelInterface, ArrayAccess
{
    ...
    * reportName  **参数解释：** 查询的报告名称 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    * reportCategory  **参数解释：** 查询的报告类别 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    ...
    * Sets reportName
    *
    * @param string|null $reportName **参数解释：** 查询的报告名称 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @return $this
    */
    ...
    * Sets reportCategory
    *
    * @param string|null $reportCategory **参数解释：** 查询的报告类别 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @return $this
    */
    ...
    * Sets offset
    *
    * @param int|null $offset **参数解释：** 偏移量，表示查询该偏移量之后的记录。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @return $this
    */
