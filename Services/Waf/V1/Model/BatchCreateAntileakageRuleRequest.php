...
class BatchCreateAntileakageRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateAntileakageRuleRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\Waf\V1\Model\BatchCreateAntileakageRuleRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\BatchCreateAntileakageRuleRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\BatchCreateAntileakageRuleRequestBody|null $body body
    *
    * @return $this
    */
