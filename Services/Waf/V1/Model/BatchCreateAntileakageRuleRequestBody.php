...
class BatchCreateAntileakageRuleRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateAntileakageRuleRequestBody';
