...
class AlterWafProductInfo implements ModelInterface, ArrayAccess
{
    ...
    * resourceSpecCode  waf规格   - detection: 入门版   - professional：标准版   - enterprise：专业版   ultimate：铂金版
    *
    * @var string[]
    */
    ...
    *
    * @param string|null $resourceSpecCode waf规格   - detection: 入门版   - professional：标准版   - enterprise：专业版   ultimate：铂金版
    *
    * @return $this
    */
