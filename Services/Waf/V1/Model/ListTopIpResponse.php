...
class ListTopIpResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTopIpResponse';
    ...
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'items' => '\HuaweiCloud\SDK\Waf\V1\Model\CountItem[]'
    ];
