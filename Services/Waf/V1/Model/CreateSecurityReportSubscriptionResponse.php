...
class CreateSecurityReportSubscriptionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSecurityReportSubscriptionResponse';
