...
class DeleteBotMTrafficDetectionConditionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteBotMTrafficDetectionConditionRequest';
