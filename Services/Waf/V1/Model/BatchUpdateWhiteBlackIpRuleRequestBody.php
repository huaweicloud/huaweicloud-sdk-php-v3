...
class BatchUpdateWhiteBlackIpRuleRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchUpdateWhiteBlackIpRuleRequestBody';
    ...
    */
    protected static $openAPITypes = [
            ...
            'start' => 'int',
            'terminal' => 'int',
            'policyRuleIds' => '\HuaweiCloud\SDK\Waf\V1\Model\BatchUpdateWhiteBlackIpRuleRequestBodyPolicyRuleIds[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\BatchUpdateWhiteBlackIpRuleRequestBodyPolicyRuleIds[]
    */
    ...
    * Sets policyRuleIds
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\BatchUpdateWhiteBlackIpRuleRequestBodyPolicyRuleIds[] $policyRuleIds **参数解释：** 策略和规则id数组，关联防护策略与对应的规则集合 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @return $this
    */
