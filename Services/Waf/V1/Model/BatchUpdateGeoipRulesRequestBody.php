...
class BatchUpdateGeoipRulesRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * status  **参数解释：** 规则状态，控制地理位置访问控制规则的启用/禁用（如1表示启用，0表示禁用） **约束限制：** 不涉及 **取值范围：** - 0 - 1  **默认取值：** 不涉及
    ...
    * white  **参数解释：** 放行或者拦截，1表示放行指定地理位置，2表示拦截指定地理位置 **约束限制：** 不涉及 **取值范围：** - 1 - 2  **默认取值：** 不涉及
    *
    * @var string[]
    */
    ...
    * Sets status
    *
    * @param int|null $status **参数解释：** 规则状态，控制地理位置访问控制规则的启用/禁用（如1表示启用，0表示禁用） **约束限制：** 不涉及 **取值范围：** - 0 - 1  **默认取值：** 不涉及
    *
    * @return $this
    */
    ...
    * Sets white
    *
    * @param int|null $white **参数解释：** 放行或者拦截，1表示放行指定地理位置，2表示拦截指定地理位置 **约束限制：** 不涉及 **取值范围：** - 1 - 2  **默认取值：** 不涉及
    *
    * @return $this
    */
