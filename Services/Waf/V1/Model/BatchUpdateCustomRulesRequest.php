...
class BatchUpdateCustomRulesRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Waf\V1\Model\BatchUpdateCustomRulesRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\BatchUpdateCustomRulesRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\BatchUpdateCustomRulesRequestBody|null $body body
    *
    * @return $this
    */
