...
class ListSecurityReportSendingRecordResponseItems implements ModelInterface, ArrayAccess
{
    ...
    * reportCategory  **参数解释：** 报告类别，该发送记录对应报告的类型（如日报、周报）。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    ...
    * Sets reportCategory
    *
    * @param string $reportCategory **参数解释：** 报告类别，该发送记录对应报告的类型（如日报、周报）。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @return $this
    */
