...
class ShowSecurityReportContentRequest implements ModelInterface, ArrayAccess
{
    ...
    * reportId  **参数解释：** 报告ID，请从接口 “查询安全报告发送记录”（ListSecurityReportSendingRecords）中获取 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    * subscriptionId  **参数解释：** 需要删除的订阅id，从“查询安全报告订阅列表”（ListSecurityReportSubscriptions）中获取 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @var string[]
    */
