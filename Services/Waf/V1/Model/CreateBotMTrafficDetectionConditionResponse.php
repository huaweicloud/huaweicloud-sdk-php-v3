...
class CreateBotMTrafficDetectionConditionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateBotMTrafficDetectionConditionResponse';
