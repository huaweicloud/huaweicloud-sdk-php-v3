...
class UpdateSecurityReportSubscriptionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateSecurityReportSubscriptionRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * contentType  **参数解释：** 内容类型 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** application/json;charset=utf8
    * subscriptionId  **参数解释：** 需要删除的订阅id，从“查询安全报告订阅列表”中获取 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Waf\V1\Model\UpdateSecurityReportSubscriptionRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\UpdateSecurityReportSubscriptionRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\UpdateSecurityReportSubscriptionRequestBody|null $body body
    *
    * @return $this
    */
