...
class BatchCreateWhiteblackipRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateWhiteblackipRuleRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\Waf\V1\Model\BacthCreateWhiteBlackIpRuleRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\BacthCreateWhiteBlackIpRuleRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\BacthCreateWhiteBlackIpRuleRequestBody|null $body body
    *
    * @return $this
    */
