...
class ListBotMTopnRequestRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListBotMTopnRequestRequest';
    ...
    * topn  **参数解释：** n的取值 **约束限制：** 不涉及 **取值范围：** 1-20 **默认取值：** 5
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['endTime'] === null) {
            ...
            if (!is_null($this->container['topn']) && ($this->container['topn'] > 20)) {
                $invalidProperties[] = "invalid value for 'topn', must be smaller than or equal to 20.";
            }
    ...
    * Sets topn
    *
    * @param int|null $topn **参数解释：** n的取值 **约束限制：** 不涉及 **取值范围：** 1-20 **默认取值：** 5
    *
    * @return $this
    */
