...
class SecurityReportContentResponseReportContentInfoTopAbnormalUrlsInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SecurityReportContentResponse_report_content_info_top_abnormal_urls_info';
    ...
    */
    protected static $openAPITypes = [
            'abnormal502InfoList' => '\HuaweiCloud\SDK\Waf\V1\Model\SecurityReportContentResponseReportContentInfoTopAbnormalUrlsInfoAbnormal502InfoList[]',
            'abnormal500InfoList' => '\HuaweiCloud\SDK\Waf\V1\Model\SecurityReportContentResponseReportContentInfoTopAbnormalUrlsInfoAbnormal500InfoList[]',
            'abnormal404InfoList' => '\HuaweiCloud\SDK\Waf\V1\Model\SecurityReportContentResponseReportContentInfoTopAbnormalUrlsInfoAbnormal404InfoList[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\SecurityReportContentResponseReportContentInfoTopAbnormalUrlsInfoAbnormal502InfoList[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\SecurityReportContentResponseReportContentInfoTopAbnormalUrlsInfoAbnormal502InfoList[]|null $abnormal502InfoList **参数解释：** TOP返回502错误的URL列表，按错误次数排序。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\SecurityReportContentResponseReportContentInfoTopAbnormalUrlsInfoAbnormal500InfoList[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\SecurityReportContentResponseReportContentInfoTopAbnormalUrlsInfoAbnormal500InfoList[]|null $abnormal500InfoList **参数解释：** TOP返回500错误的URL列表，按错误次数排序。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\SecurityReportContentResponseReportContentInfoTopAbnormalUrlsInfoAbnormal404InfoList[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\SecurityReportContentResponseReportContentInfoTopAbnormalUrlsInfoAbnormal404InfoList[]|null $abnormal404InfoList **参数解释：** TOP返回404错误的URL列表，按错误次数排序。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @return $this
    */
