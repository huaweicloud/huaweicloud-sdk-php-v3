...
class BatchUpdateIgnoreRuleRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchUpdateIgnoreRuleRequestBody';
    ...
    * advanced  advanced
    * description  屏蔽规则描述
    * policyRuleIds  **参数解释：** 策略ID和规则id数组，规则ID与规则所属的策略ID **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'description' => 'string',
            'policyRuleIds' => '\HuaweiCloud\SDK\Waf\V1\Model\BatchUpdateIgnoreRuleRequestBodyPolicyRuleIds[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Waf\V1\Model\BatchUpdateIgnoreRuleRequestBodyPolicyRuleIds[]
    */
    ...
    * Sets policyRuleIds
    *
    * @param \HuaweiCloud\SDK\Waf\V1\Model\BatchUpdateIgnoreRuleRequestBodyPolicyRuleIds[] $policyRuleIds **参数解释：** 策略ID和规则id数组，规则ID与规则所属的策略ID **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @return $this
    */
