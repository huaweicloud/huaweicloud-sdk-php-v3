...
class SecurityReportContentResponseReportContentInfoTimeline implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SecurityReportContentResponse_report_content_info_timeline';
