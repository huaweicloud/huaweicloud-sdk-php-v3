...
class BatchUpdateAntileakageRuleRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchUpdateAntileakageRuleRequestBody';
