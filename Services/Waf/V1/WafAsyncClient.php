...
class WafAsyncClient extends Client
{
     ...
     * @return response
     */
    public function batchDeleteCcRulesAsync($request)
    {
        return $this->batchDeleteCcRulesAsyncWithHttpInfo($request);
    }
    
    public function batchDeleteCcRulesAsyncWithHttpInfo($request){
        $collection_formats = [];
