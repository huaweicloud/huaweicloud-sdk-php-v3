...
class WafAsyncClient extends Client
{
     ...
     * @return response
     */
    public function batchUpdateBotMRuleActionAsync($request)
    {
        return $this->batchUpdateBotMRuleActionAsyncWithHttpInfo($request);
    }
    
    public function batchUpdateBotMRuleActionAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function batchUpdateBotMRuleStatusAsync($request)
    {
        return $this->batchUpdateBotMRuleStatusAsyncWithHttpInfo($request);
    }
    
    public function batchUpdateBotMRuleStatusAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v1/{project_id}/waf/policy/{policy_id}/bot-manager/rule/batch-update-status';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Waf\V1\Model\BatchUpdateBotMRuleStatusResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Waf\V1\Model\BatchUpdateBotMRuleStatusRequest',
            $asyncRequest = true);
    }
    ...
    /**
     * **参数解释：** 批量修改防护状态 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
     *
     * **参数解释：**
     * 批量修改防护状态
     * **约束限制：**
     ...
     * @return response
     */
    public function batchUpdateProtectStatusAsync($request)
    {
        return $this->batchUpdateProtectStatusAsyncWithHttpInfo($request);
    }
    
    public function batchUpdateProtectStatusAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v1/{project_id}/waf/instance/protect_status';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Waf\V1\Model\BatchUpdateProtectStatusResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Waf\V1\Model\BatchUpdateProtectStatusRequest',
            $asyncRequest = true);
    }
    ...
    public function confirmAsyncJobAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v1/{projectid}/waf/async-job/{job_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
     ...
     * @return response
     */
    public function createBotMTrafficDetectionConditionAsync($request)
    {
        return $this->createBotMTrafficDetectionConditionAsyncWithHttpInfo($request);
    }
    
    public function createBotMTrafficDetectionConditionAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v1/{project_id}/waf/policy/{policy_id}/bot-manager/traffic-detection-condition';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Waf\V1\Model\CreateBotMTrafficDetectionConditionResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Waf\V1\Model\CreateBotMTrafficDetectionConditionRequest',
            $asyncRequest = true);
    }
     ...
     * @return response
     */
    public function deleteBotMTrafficDetectionConditionAsync($request)
    {
        return $this->deleteBotMTrafficDetectionConditionAsyncWithHttpInfo($request);
    }
    
    public function deleteBotMTrafficDetectionConditionAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v1/{project_id}/waf/policy/{policy_id}/bot-manager/traffic-detection-condition/{condition_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Waf\V1\Model\DeleteBotMTrafficDetectionConditionResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Waf\V1\Model\DeleteBotMTrafficDetectionConditionRequest',
            $asyncRequest = true);
    }
     ...
     * @return response
     */
    public function listBotMRequestDistributionAsync($request)
    {
        return $this->listBotMRequestDistributionAsyncWithHttpInfo($request);
    }
    
    public function listBotMRequestDistributionAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function listBotMRulesAsync($request)
    {
        return $this->listBotMRulesAsyncWithHttpInfo($request);
    }
    
    public function listBotMRulesAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function listBotMScoreDistributionAsync($request)
    {
        return $this->listBotMScoreDistributionAsyncWithHttpInfo($request);
    }
    
    public function listBotMScoreDistributionAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function listBotMTimelineAsync($request)
    {
        return $this->listBotMTimelineAsyncWithHttpInfo($request);
    }
    
    public function listBotMTimelineAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function listBotMTopnRequestAsync($request)
    {
        return $this->listBotMTopnRequestAsyncWithHttpInfo($request);
    }
    
    public function listBotMTopnRequestAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function listLlmGuardPolicyRulesAsync($request)
    {
        return $this->listLlmGuardPolicyRulesAsyncWithHttpInfo($request);
    }
    
    public function listLlmGuardPolicyRulesAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function updateBotMCategoryStatusAsync($request)
    {
        return $this->updateBotMCategoryStatusAsyncWithHttpInfo($request);
    }
    
    public function updateBotMCategoryStatusAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function updateBotMRuleDefenseStrategyAsync($request)
    {
        return $this->updateBotMRuleDefenseStrategyAsyncWithHttpInfo($request);
    }
    
    public function updateBotMRuleDefenseStrategyAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function updateBotMTrafficDetectionConditionAsync($request)
    {
        return $this->updateBotMTrafficDetectionConditionAsyncWithHttpInfo($request);
    }
    
    public function updateBotMTrafficDetectionConditionAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v1/{project_id}/waf/policy/{policy_id}/bot-manager/traffic-detection-condition/{condition_id}';
        $formParams = [];
        $queryParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Waf\V1\Model\UpdateBotMTrafficDetectionConditionResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Waf\V1\Model\UpdateBotMTrafficDetectionConditionRequest',
            $asyncRequest = true);
    }
    ...
    public function confirmDnsDomainAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v1/{projectid}/waf/dns-domain';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
