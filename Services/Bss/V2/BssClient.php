...
class BssClient extends Client
{
     ...
     * @return response
     */
    public function listBusinessDiscountInfo($request)
    {
        return $this->listBusinessDiscountInfoWithHttpInfo($request);
    }

    public function listBusinessDiscountInfoWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function listCustomerCouponChangeRecords($request)
    {
        return $this->listCustomerCouponChangeRecordsWithHttpInfo($request);
    }

    public function listCustomerCouponChangeRecordsWithHttpInfo($request)
    {
        $resourcePath = '/v2/promotions/benefits/account-change-records';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Bss\V2\Model\ListCustomerCouponChangeRecordsResponse',
            $requestType='\HuaweiCloud\SDK\Bss\V2\Model\ListCustomerCouponChangeRecordsRequest');
    }
     ...
     * @return response
     */
    public function showRealNameAuthQrCode($request)
    {
        return $this->showRealNameAuthQrCodeWithHttpInfo($request);
    }

    public function showRealNameAuthQrCodeWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function showRealNameAuthStatus($request)
    {
        return $this->showRealNameAuthStatusWithHttpInfo($request);
    }

    public function showRealNameAuthStatusWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function updatePeriodToOnDemandInstantly($request)
    {
        return $this->updatePeriodToOnDemandInstantlyWithHttpInfo($request);
    }

    public function updatePeriodToOnDemandInstantlyWithHttpInfo($request)
    {
