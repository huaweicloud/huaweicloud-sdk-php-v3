...
class BssAsyncClient extends Client
{
    ...
    {
        $client = new ClientBuilder(new BssAsyncClient(), "GlobalCredentials");
        return $client;
    }
     ...
     * @return response
     */
    public function listCustomerCouponChangeRecordsAsync($request)
    {
        return $this->listCustomerCouponChangeRecordsAsyncWithHttpInfo($request);
    }
    
    public function listCustomerCouponChangeRecordsAsyncWithHttpInfo($request){
        $collection_formats = [];
