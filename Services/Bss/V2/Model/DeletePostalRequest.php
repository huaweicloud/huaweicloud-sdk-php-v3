...
class DeletePostalRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeletePostalRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * addressId  |参数名称：邮寄地址ID|
    *
    * @var string[]
    */
    ...
    * Sets addressId
    *
    * @param string $addressId |参数名称：邮寄地址ID|
    *
    * @return $this
    */
