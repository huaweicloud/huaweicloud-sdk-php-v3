...
class CreateCustomerV2Req implements ModelInterface, ArrayAccess
{
    ...
    * cooperationType  合作类型。 1：顾问销售。 不传递或传递非1的值，默认会创建成代售模式的客户。(字段预下线，新用户不再提供)
    ...
    *
    * @param string|null $cooperationType 合作类型。 1：顾问销售。 不传递或传递非1的值，默认会创建成代售模式的客户。(字段预下线，新用户不再提供)
    *
    * @return $this
    */
