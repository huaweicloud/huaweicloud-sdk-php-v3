...
class QueryResRecordsDetailReq implements ModelInterface, ArrayAccess
{
    ...
    * limit  页面大小。默认值为10。
    * method  查询方式。 oneself：客户自己sub_customer：企业子客户all：客户自己和企业子客户 默认为all，如果没有企业子客户，all的时候也是查询客户自己的数据。
    ...
    * Sets method
    *
    * @param string|null $method 查询方式。 oneself：客户自己sub_customer：企业子客户all：客户自己和企业子客户 默认为all，如果没有企业子客户，all的时候也是查询客户自己的数据。
    *
    * @return $this
    */
