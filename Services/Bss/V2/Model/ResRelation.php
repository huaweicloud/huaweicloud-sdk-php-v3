...
class ResRelation implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'relationInfos' => '\HuaweiCloud\SDK\Bss\V2\Model\RelationInfo[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Bss\V2\Model\RelationInfo[]|null
    */
    ...
    * Sets relationInfos
    *
    * @param \HuaweiCloud\SDK\Bss\V2\Model\RelationInfo[]|null $relationInfos |参数名称：当前费用对应资源ID关联的资源信息。| |参数约束及描述：当前费用对应资源ID关联的资源信息，数组个数不超过2层|
    *
    * @return $this
    */
