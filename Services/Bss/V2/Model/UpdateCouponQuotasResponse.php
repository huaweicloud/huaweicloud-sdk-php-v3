...
class UpdateCouponQuotasResponse implements ModelInterface, ArrayAccess
{
    ...
    * errorDetails  发放失败的精英服务商额度信息，具体参见表1，只有HTTP STATUS 200的时候才有这个结构体。
    * simpleQuotaInfos  发放成功的精英服务商额度信息，具体参见表2，只有HTTP STATUS 200的时候才有这个结构体。
    *
    * @var string[]
    */
    ...
    * Sets errorDetails
    *
    * @param \HuaweiCloud\SDK\Bss\V2\Model\ErrorDetail[]|null $errorDetails 发放失败的精英服务商额度信息，具体参见表1，只有HTTP STATUS 200的时候才有这个结构体。
    *
    * @return $this
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Bss\V2\Model\QuotaSimpleInfo[]|null $simpleQuotaInfos 发放成功的精英服务商额度信息，具体参见表2，只有HTTP STATUS 200的时候才有这个结构体。
    *
    * @return $this
    */
