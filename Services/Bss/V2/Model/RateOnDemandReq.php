...
class RateOnDemandReq implements ModelInterface, ArrayAccess
{
    ...
    * projectId  项目ID。 使用客户Token，可以调用通过assume_role方式获取用户token接口获取“regionId”的取值对应的“project id”。具体请参见如何将合作伙伴Token置换为客户Token的步骤2。
    ...
    * Sets projectId
    *
    * @param string $projectId 项目ID。 使用客户Token，可以调用通过assume_role方式获取用户token接口获取“regionId”的取值对应的“project id”。具体请参见如何将合作伙伴Token置换为客户Token的步骤2。
    *
    * @return $this
    */
