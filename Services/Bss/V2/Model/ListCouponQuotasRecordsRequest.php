...
class ListCouponQuotasRecordsRequest implements ModelInterface, ArrayAccess
{
    ...
    *
    * @param string|null $operationTimeBegin 查询条件：操作起始时间。UTC时间，格式：yyyy-MM-dd'T'HH:mm:ss'Z'，如“2019-05-06T08:05:01Z”。其中，HH范围是0～23，mm和ss范围是0～59。此参数不携带或携带值为空时，不作为筛选条件。不支持携带值为空串。
    *
    * @return $this
    */
    ...
    *
    * @param string|null $operationTimeEnd 查询条件：操作截止时间。UTC时间，格式：yyyy-MM-dd'T'HH:mm:ss'Z'，如“2019-05-06T08:05:01Z”。其中，HH范围是0～23，mm和ss范围是0～59。此参数不携带或携带值为空时，不作为筛选条件。不支持携带值为空串。
    *
    * @return $this
    */
    ...
    * Sets parentQuotaId
    *
    * @param string|null $parentQuotaId 父额度ID。这即华为云总经销商给云经销商发放代金券额度时，华为云总经销商的额度ID，或者从云经销商回收代金券额度时，回收的华为云总经销商的额度ID。此参数不携带或携带值为空时，不作为筛选条件。携带值为空串或携带值为null时，作为筛选条件。
    *
    * @return $this
    */
