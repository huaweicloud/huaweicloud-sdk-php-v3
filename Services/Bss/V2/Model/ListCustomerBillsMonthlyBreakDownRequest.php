...
class ListCustomerBillsMonthlyBreakDownRequest implements ModelInterface, ArrayAccess
{
    ...
    * Sets sharedMonth
    *
    * @param string $sharedMonth 查询分摊成本的月份，格式：YYYY-MM。
    *
    * @return $this
    */
    ...
    *
    * @param string|null $resourceTypeCode 资源类型编码，例如ECS的VM为“hws.resource.type.vm”。您可以调用[查询资源类型列表](https://support.huaweicloud.com/api-oce/zh-cn_topic_0000001256519451.html)接口获取。
    *
    * @return $this
    */
