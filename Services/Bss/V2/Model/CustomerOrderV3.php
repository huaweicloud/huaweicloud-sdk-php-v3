...
class CustomerOrderV3 implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'subOrderInfos' => '\HuaweiCloud\SDK\Bss\V2\Model\SubCustomerOrderV3[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Bss\V2\Model\SubCustomerOrderV3[]|null
    */
    ...
    * Sets subOrderInfos
    *
    * @param \HuaweiCloud\SDK\Bss\V2\Model\SubCustomerOrderV3[]|null $subOrderInfos 客户订单下属的订单详情信息。具体请参见表 SubCustomerOrderV3 说明：当查询订单为组合交易订单时，订单信息会返回下属的订单信息，当查询为普通订单时，此字段返回为空
    *
    * @return $this
    */
