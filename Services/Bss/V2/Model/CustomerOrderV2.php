...
class CustomerOrderV2 implements ModelInterface, ArrayAccess
{
    ...
    *
    * @param \HuaweiCloud\SDK\Bss\V2\Model\EnterpriseProject[]|null $enterpriseProjects 客户订单企业项目信息。具体请参见表 EnterpriseProject。
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\Bss\V2\Model\SubCustomerOrderV2[]|null
    */
    ...
    * Sets subOrderInfos
    *
    * @param \HuaweiCloud\SDK\Bss\V2\Model\SubCustomerOrderV2[]|null $subOrderInfos 客户订单下属的订单详情信息。具体请参见表 SubCustomerOrderV2 说明：当查询订单为组合交易订单时，订单信息会返回下属的订单信息，当查询为普通订单时，此字段返回为空
    *
    * @return $this
    */
