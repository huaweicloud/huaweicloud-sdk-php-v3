...
class PeriodToOnDemandInstantlyReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PeriodToOnDemandInstantlyReq';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * resourceIds  |参数名称：资源ID列表。| |参数约束以及描述：该参数必填，数组范围限制:1-10，字符长度限制1-64。|
    *
    * @var string[]
    */
    ...
    * Sets resourceIds
    *
    * @param string[] $resourceIds |参数名称：资源ID列表。| |参数约束以及描述：该参数必填，数组范围限制:1-10，字符长度限制1-64。|
    *
    * @return $this
    */
