...
class OptionalDiscountRatingResultV2 implements ModelInterface, ArrayAccess
{
    ...
    * discountId  折扣优惠ID
    * amount  总额，即最终优惠后的金额。单位为元。amount= official_website_amount - discount_amount
    * officialWebsiteAmount  官网价。单位为元
    * discountAmount  可选折扣优惠额，如商务折扣、伙伴折扣、促销折扣和折扣券选用时的优惠额。单位为元
    ...
    * installmentOfficialDiscountAmount  分期金额的折扣价。单位为元
    * installmentAmount  分期金额的成交价。单位为元
    ...
    * Sets amount
    *
    * @param string|null $amount 总额，即最终优惠后的金额。单位为元。amount= official_website_amount - discount_amount
    *
    * @return $this
    */
    ...
    *
    * @param string|null $officialWebsiteAmount 官网价。单位为元
    *
    * @return $this
    */
    ...
    * Sets discountAmount
    *
    * @param string|null $discountAmount 可选折扣优惠额，如商务折扣、伙伴折扣、促销折扣和折扣券选用时的优惠额。单位为元
    *
    * @return $this
    */
    ...
    *
    * @param string|null $installmentOfficialDiscountAmount 分期金额的折扣价。单位为元
    *
    * @return $this
    */
    ...
    *
    * @param string|null $installmentAmount 分期金额的成交价。单位为元
    *
    * @return $this
    */
