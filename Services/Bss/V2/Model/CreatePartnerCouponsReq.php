...
class CreatePartnerCouponsReq implements ModelInterface, ArrayAccess
{
    ...
    * customerIds  客户账号ID。您可以调用查询客户列表接口获取customer_id。
    ...
    * memo  发券时的备注信息。
    * indirectPartnerId  精英服务商ID。获取方法请参见查询精英服务商列表。 精英服务商给子客户发放优惠券时，需要携带该参数。
    *
    * @var string[]
    */
    ...
    * Sets customerIds
    *
    * @param string[] $customerIds 客户账号ID。您可以调用查询客户列表接口获取customer_id。
    *
    * @return $this
    */
    ...
    *
    * @param string|null $indirectPartnerId 精英服务商ID。获取方法请参见查询精英服务商列表。 精英服务商给子客户发放优惠券时，需要携带该参数。
    *
    * @return $this
    */
