...
class ResourceSpecsQueryReq implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'regionCode' => 'string',
            'chargeMode' => 'string',
            'filters' => '\HuaweiCloud\SDK\Bss\V2\Model\ResourceSpecsFilter[]',
            'marker' => 'string',
            'limit' => 'int'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Bss\V2\Model\ResourceSpecsFilter[]|null
    */
    ...
    * Sets filters
    *
    * @param \HuaweiCloud\SDK\Bss\V2\Model\ResourceSpecsFilter[]|null $filters |参数名称：过滤条件| |参数的约束及描述：非必填，过滤条件列表，最多1个|
    *
    * @return $this
    */
