...
class ListPermissionSetsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListPermissionSetsResponse';
    ...
    */
    protected static $openAPITypes = [
            'permissionSets' => '\HuaweiCloud\SDK\IdentityCenter\V1\Model\PermissionSetDto[]',
    ...
    * Sets permissionSets
    *
    * @param \HuaweiCloud\SDK\IdentityCenter\V1\Model\PermissionSetDto[]|null $permissionSets 权限集列表
    *
    * @return $this
    */
