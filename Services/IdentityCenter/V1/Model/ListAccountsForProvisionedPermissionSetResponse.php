...
class ListAccountsForProvisionedPermissionSetResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAccountsForProvisionedPermissionSetResponse';
    ...
    * Sets accountIds
    *
    * @param string[]|null $accountIds 账户ID列表
    *
    * @return $this
    */
