...
class AttachManagedRoleToPermissionSetRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AttachManagedRoleToPermissionSetRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\IdentityCenter\V1\Model\ResourceAttachManagedPolicyToPermissionSetReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IdentityCenter\V1\Model\ResourceAttachManagedPolicyToPermissionSetReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IdentityCenter\V1\Model\ResourceAttachManagedPolicyToPermissionSetReqBody|null $body body
    *
    * @return $this
    */
