...
class AttachManagedPolicyToPermissionSetRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AttachManagedPolicyToPermissionSetRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\IdentityCenter\V1\Model\AttachManagedPolicyToPermissionSetReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IdentityCenter\V1\Model\AttachManagedPolicyToPermissionSetReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IdentityCenter\V1\Model\AttachManagedPolicyToPermissionSetReqBody|null $body body
    *
    * @return $this
    */
