...
class UpdateApplicationInstanceResponseConfigurationReqBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateApplicationInstanceResponseConfigurationReqBody';
