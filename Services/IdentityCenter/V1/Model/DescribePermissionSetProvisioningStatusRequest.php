...
class DescribePermissionSetProvisioningStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DescribePermissionSetProvisioningStatusRequest';
