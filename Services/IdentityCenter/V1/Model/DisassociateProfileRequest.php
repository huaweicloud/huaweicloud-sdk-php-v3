...
class DisassociateProfileRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DisassociateProfileRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\IdentityCenter\V1\Model\DisassociateProfileReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IdentityCenter\V1\Model\DisassociateProfileReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IdentityCenter\V1\Model\DisassociateProfileReqBody|null $body body
    *
    * @return $this
    */
