...
class DeleteCustomRoleFromPermissionSetRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteCustomRoleFromPermissionSetRequest';
