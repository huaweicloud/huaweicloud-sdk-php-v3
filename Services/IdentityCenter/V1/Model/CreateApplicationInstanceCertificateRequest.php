...
class CreateApplicationInstanceCertificateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateApplicationInstanceCertificateRequest';
