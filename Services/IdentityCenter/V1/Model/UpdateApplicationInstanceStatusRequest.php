...
class UpdateApplicationInstanceStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateApplicationInstanceStatusRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\IdentityCenter\V1\Model\UpdateApplicationInstanceStatusReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IdentityCenter\V1\Model\UpdateApplicationInstanceStatusReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IdentityCenter\V1\Model\UpdateApplicationInstanceStatusReqBody|null $body body
    *
    * @return $this
    */
