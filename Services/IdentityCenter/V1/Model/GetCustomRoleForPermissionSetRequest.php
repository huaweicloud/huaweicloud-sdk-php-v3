...
class GetCustomRoleForPermissionSetRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GetCustomRoleForPermissionSetRequest';
