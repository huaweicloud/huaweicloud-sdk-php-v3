...
class CreateAccountAssignmentReqBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAccountAssignmentReqBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * permissionSetId  权限集唯一标识
    * principalId  IAM身份中心中的一个实体身份唯一标识，例如用户或用户组
    * principalType  创建绑定的实体类型
    * targetId  待绑定的目标实体标识.
    ...
    * Sets principalType
    *
    * @param string $principalType 创建绑定的实体类型
    *
    * @return $this
    */
    ...
    * Sets targetId
    *
    * @param string $targetId 待绑定的目标实体标识.
    *
    * @return $this
    */
