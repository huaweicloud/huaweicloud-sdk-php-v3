...
class ListAccountAssignmentDeletionStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAccountAssignmentDeletionStatusRequest';
