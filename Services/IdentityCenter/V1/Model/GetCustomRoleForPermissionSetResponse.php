...
class GetCustomRoleForPermissionSetResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GetCustomRoleForPermissionSetResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * customRole  附加到权限集的自定义策略
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['customRole']) && !preg_match("/[\\u0009\\u000A\\u000D\\u0020-\\u00FF]+/", $this->container['customRole'])) {
    ...
    * Sets customRole
    *
    * @param string|null $customRole 附加到权限集的自定义策略
    *
    * @return $this
    */
