...
class ListManagedPoliciesInPermissionSetRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListManagedPoliciesInPermissionSetRequest';
