...
class GetIdentityCenterServiceStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GetIdentityCenterServiceStatusRequest';
