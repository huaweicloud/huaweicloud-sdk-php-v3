...
class CreateApplicationInstanceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateApplicationInstanceRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\IdentityCenter\V1\Model\CreateApplicationInstanceReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IdentityCenter\V1\Model\CreateApplicationInstanceReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IdentityCenter\V1\Model\CreateApplicationInstanceReqBody|null $body body
    *
    * @return $this
    */
