...
class DescribeAccountAssignmentCreationStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DescribeAccountAssignmentCreationStatusRequest';
