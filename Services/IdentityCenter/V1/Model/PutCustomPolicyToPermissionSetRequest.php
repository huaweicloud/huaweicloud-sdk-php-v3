...
class PutCustomPolicyToPermissionSetRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PutCustomPolicyToPermissionSetRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\IdentityCenter\V1\Model\PutCustomPolicyToPermissionSetReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IdentityCenter\V1\Model\PutCustomPolicyToPermissionSetReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IdentityCenter\V1\Model\PutCustomPolicyToPermissionSetReqBody|null $body body
    *
    * @return $this
    */
