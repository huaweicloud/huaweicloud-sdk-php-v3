...
class UpdateSsoConfigurationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateSsoConfigurationRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\IdentityCenter\V1\Model\UpdateSsoConfigurationReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IdentityCenter\V1\Model\UpdateSsoConfigurationReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IdentityCenter\V1\Model\UpdateSsoConfigurationReqBody|null $body body
    *
    * @return $this
    */
