...
class DeleteTagResourceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteTagResourceRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'resourceType' => 'string',
            'resourceId' => 'string',
            'body' => '\HuaweiCloud\SDK\IdentityCenter\V1\Model\DeleteTagResourceReqBody'
    ];
    ...
    */
    ...
    const RESOURCE_TYPE_IDENTITYCENTERPERMISSIONSET = 'identitycenter:permissionset';
    ...
    */
    ...
    {
        return [
            self::RESOURCE_TYPE_IDENTITYCENTERPERMISSIONSET,
        ];
    }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IdentityCenter\V1\Model\DeleteTagResourceReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IdentityCenter\V1\Model\DeleteTagResourceReqBody|null $body body
    *
    * @return $this
    */
