...
class PermissionSetProvisioningStatusMetadataDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PermissionSetProvisioningStatusMetadataDto';
    ...
    * Sets createdDate
    *
    * @param int|null $createdDate 权限集创建日期.
    *
    * @return $this
    */
