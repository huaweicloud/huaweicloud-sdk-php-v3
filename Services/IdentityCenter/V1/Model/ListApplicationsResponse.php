...
class ListApplicationsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'applications' => '\HuaweiCloud\SDK\IdentityCenter\V1\Model\ApplicationDto[]',
    ...
    *  应用程序列表
    *
    * @return \HuaweiCloud\SDK\IdentityCenter\V1\Model\ApplicationDto[]|null
    */
    ...
    * Sets applications
    *
    * @param \HuaweiCloud\SDK\IdentityCenter\V1\Model\ApplicationDto[]|null $applications 应用程序列表
    *
    * @return $this
    */
