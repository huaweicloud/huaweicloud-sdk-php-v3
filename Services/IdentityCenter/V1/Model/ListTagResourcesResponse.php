...
class ListTagResourcesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTagResourcesResponse';
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\IdentityCenter\V1\Model\TagDto[]|null $tags 标签列表。
    *
    * @return $this
    */
