...
class RegisterRegionReqBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RegisterRegionReqBody';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['regionId'] === null) {
            ...
            if (!preg_match("/^[a-zA-Z0-9-]{1,64}$/", $this->container['regionId'])) {
                $invalidProperties[] = "invalid value for 'regionId', must be conform to the pattern /^[a-zA-Z0-9-]{1,64}$/.";
            }
