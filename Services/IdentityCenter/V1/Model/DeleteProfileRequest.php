...
class DeleteProfileRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteProfileRequest';
    ...
    * profileId  应用程序实例与用户或用户组关联关系 ID
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['profileId'] === null) {
            ...
            if (!preg_match("/^p-[a-zA-Z0-9]{16}$/", $this->container['profileId'])) {
                $invalidProperties[] = "invalid value for 'profileId', must be conform to the pattern /^p-[a-zA-Z0-9]{16}$/.";
            }
