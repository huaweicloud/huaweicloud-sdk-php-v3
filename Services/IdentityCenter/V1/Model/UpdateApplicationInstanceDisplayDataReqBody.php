...
class UpdateApplicationInstanceDisplayDataReqBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateApplicationInstanceDisplayDataReqBody';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['displayName'] === null) {
            ...
            if ((mb_strlen($this->container['displayName']) > 100)) {
    ...
    * Sets displayName
    *
    * @param string $displayName 应用程序显示名
    *
    * @return $this
    */
