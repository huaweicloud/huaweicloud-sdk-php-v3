...
class CreateApplicationInstanceCertificateResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateApplicationInstanceCertificateResponse';
