...
class GetMfaDeviceManagementForIdentityStoreRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GetMfaDeviceManagementForIdentityStoreRequest';
