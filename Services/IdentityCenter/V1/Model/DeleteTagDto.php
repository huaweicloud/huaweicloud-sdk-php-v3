...
class DeleteTagDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteTagDto';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * key  标签的键
    * value  标签的值，可以为空字符串，但不能为null
    *
    * @var string[]
    */
    ...
    * Sets value
    *
    * @param string|null $value 标签的值，可以为空字符串，但不能为null
    *
    * @return $this
    */
