...
class UpdateApplicationInstanceServiceProviderConfigurationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateApplicationInstanceServiceProviderConfigurationRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\IdentityCenter\V1\Model\UpdateApplicationInstanceServiceProviderConfigurationReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IdentityCenter\V1\Model\UpdateApplicationInstanceServiceProviderConfigurationReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IdentityCenter\V1\Model\UpdateApplicationInstanceServiceProviderConfigurationReqBody|null $body body
    *
    * @return $this
    */
