...
class DescribeApplicationProviderResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DescribeApplicationProviderResponse';
    ...
    *
    * @param string|null $applicationProviderUrn 应用程序提供者URN
    *
    * @return $this
    */
    ...
    *
    * @param string|null $applicationProviderId 应用程序提供者唯一标识符（ID）
    *
    * @return $this
    */
