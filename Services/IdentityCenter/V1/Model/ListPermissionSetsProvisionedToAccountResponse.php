...
class ListPermissionSetsProvisionedToAccountResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListPermissionSetsProvisionedToAccountResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * permissionSets  满足查询条件的权限集ID列表
    * pageInfo  pageInfo
    *
    * @var string[]
    */
    ...
    * Sets permissionSets
    *
    * @param string[]|null $permissionSets 满足查询条件的权限集ID列表
    *
    * @return $this
    */
