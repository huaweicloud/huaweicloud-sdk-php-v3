...
class ListManagedRolesInPermissionSetRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListManagedRolesInPermissionSetRequest';
