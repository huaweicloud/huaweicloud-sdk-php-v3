...
class GetHaConfigurationResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GetHaConfigurationResponse';
    ...
    *
    * @param string|null $disasterRecoveryChoice 高可用选项，接受高可用或者拒绝高可用功能。
    *
    * @return $this
    */
