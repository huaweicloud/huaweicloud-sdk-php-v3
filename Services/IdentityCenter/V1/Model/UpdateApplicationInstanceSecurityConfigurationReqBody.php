...
class UpdateApplicationInstanceSecurityConfigurationReqBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateApplicationInstanceSecurityConfigurationReqBody';
