...
class GetCustomPolicyForPermissionSetResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GetCustomPolicyForPermissionSetResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * customPolicy  附加到权限集的自定义身份策略
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['customPolicy']) && !preg_match("/[\\u0009\\u000A\\u000D\\u0020-\\u00FF]+/", $this->container['customPolicy'])) {
    ...
    * Sets customPolicy
    *
    * @param string|null $customPolicy 附加到权限集的自定义身份策略
    *
    * @return $this
    */
