...
class ResourceDetachManagedPolicyFromPermissionSetReqBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResourceDetachManagedPolicyFromPermissionSetReqBody';
