...
class ListPermissionSetsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListPermissionSetsRequest';
    ...
    *
    * @param string|null $permissionSetId 权限集的全局唯一标识符（ID）。
    *
    * @return $this
    */
    ...
    * Sets permissionUrn
    *
    * @param string|null $permissionUrn 权限集的全局唯一URN。
    *
    * @return $this
    */
