...
class CreateApplicationInstanceResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateApplicationInstanceResponse';
    ...
    */
    protected static $openAPITypes = [
            'applicationInstance' => '\HuaweiCloud\SDK\IdentityCenter\V1\Model\ApplicationInstanceDto'
    ];
    ...
    *
    * @param \HuaweiCloud\SDK\IdentityCenter\V1\Model\ApplicationInstanceDto|null $applicationInstance applicationInstance
    *
    * @return $this
    */
