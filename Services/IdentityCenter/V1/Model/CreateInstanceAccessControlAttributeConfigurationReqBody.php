...
class CreateInstanceAccessControlAttributeConfigurationReqBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateInstanceAccessControlAttributeConfigurationReqBody';
