...
class UpdateApplicationInstanceResponseSchemaConfigurationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateApplicationInstanceResponseSchemaConfigurationRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\IdentityCenter\V1\Model\UpdateApplicationInstanceResponseSchemaConfigurationReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IdentityCenter\V1\Model\UpdateApplicationInstanceResponseSchemaConfigurationReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IdentityCenter\V1\Model\UpdateApplicationInstanceResponseSchemaConfigurationReqBody|null $body body
    *
    * @return $this
    */
