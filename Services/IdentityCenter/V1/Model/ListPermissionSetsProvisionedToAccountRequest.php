...
class ListPermissionSetsProvisionedToAccountRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListPermissionSetsProvisionedToAccountRequest';
    ...
    *
    * @param string|null $provisioningStatus 权限集授权状态
    *
    * @return $this
    */
