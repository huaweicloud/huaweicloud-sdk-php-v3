...
class DescribeAccountAssignmentDeletionStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DescribeAccountAssignmentDeletionStatusRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['requestId'] === null) {
            ...
            if (!preg_match("/^[a-zA-Z0-9-]{1,64}$/", $this->container['requestId'])) {
                $invalidProperties[] = "invalid value for 'requestId', must be conform to the pattern /^[a-zA-Z0-9-]{1,64}$/.";
            }
