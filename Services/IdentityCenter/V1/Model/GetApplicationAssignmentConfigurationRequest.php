...
class GetApplicationAssignmentConfigurationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GetApplicationAssignmentConfigurationRequest';
