...
class CreateTagResourceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateTagResourceRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'resourceType' => 'string',
            'resourceId' => 'string',
            'body' => '\HuaweiCloud\SDK\IdentityCenter\V1\Model\TagResourceReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IdentityCenter\V1\Model\TagResourceReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IdentityCenter\V1\Model\TagResourceReqBody|null $body body
    *
    * @return $this
    */
