...
class UpdateApplicationInstanceResponseSchemaConfigurationReqBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateApplicationInstanceResponseSchemaConfigurationReqBody';
