...
class ListAccountAssignmentsForPrincipalRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAccountAssignmentsForPrincipalRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * xSecurityToken  如果正在使用临时安全凭据，则此header是必需的，该值是临时安全凭据的安全令牌（会话令牌）。
    * instanceId  IAM Identity Center实例的全局唯一标识符（ID）
    * principalId  IAM Identity Center 身份主体的全局唯一标识符（ID）
    * principalType  IAM Identity Center 身份主体类型.
    * limit  每个请求返回的最大结果数。
    * marker  分页标记
    ...
    * Sets principalType
    *
    * @param string $principalType IAM Identity Center 身份主体类型.
    *
    * @return $this
    */
