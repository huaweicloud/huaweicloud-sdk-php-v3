...
class ListInstancesResponse implements ModelInterface, ArrayAccess
{
    ...
    * instances  IAM身份中心实例信息列表。
    * pageInfo  pageInfo
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'instances' => '\HuaweiCloud\SDK\IdentityCenter\V1\Model\InstanceMetadataEntryDto[]',
    ...
    *  IAM身份中心实例信息列表。
    *
    * @return \HuaweiCloud\SDK\IdentityCenter\V1\Model\InstanceMetadataEntryDto[]|null
    */
    ...
    * Sets instances
    *
    * @param \HuaweiCloud\SDK\IdentityCenter\V1\Model\InstanceMetadataEntryDto[]|null $instances IAM身份中心实例信息列表。
    *
    * @return $this
    */
