...
class UpdateApplicationInstanceServiceProviderConfigurationReqBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateApplicationInstanceServiceProviderConfigurationReqBody';
