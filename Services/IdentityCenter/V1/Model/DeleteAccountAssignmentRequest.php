...
class DeleteAccountAssignmentRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteAccountAssignmentRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\IdentityCenter\V1\Model\DeleteAccountAssignmentReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IdentityCenter\V1\Model\DeleteAccountAssignmentReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IdentityCenter\V1\Model\DeleteAccountAssignmentReqBody|null $body body
    *
    * @return $this
    */
