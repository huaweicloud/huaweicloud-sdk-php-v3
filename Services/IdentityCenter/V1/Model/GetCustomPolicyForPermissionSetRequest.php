...
class GetCustomPolicyForPermissionSetRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GetCustomPolicyForPermissionSetRequest';
