...
class ApplicationTemplateDisplayDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ApplicationTemplateDisplayDto';
    ...
    *
    * @param string|null $applicationType 应用程序类型
    *
    * @return $this
    */
