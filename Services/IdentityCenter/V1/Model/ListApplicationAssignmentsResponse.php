...
class ListApplicationAssignmentsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListApplicationAssignmentsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * applicationAssignments  应用程序分配的用户或用户组列表
    * pageInfo  pageInfo
    *
    * @var string[]
    */
    ...
    *
    * @param \HuaweiCloud\SDK\IdentityCenter\V1\Model\ApplicationAssignmentDto[]|null $applicationAssignments 应用程序分配的用户或用户组列表
    *
    * @return $this
    */
