...
class DescribeApplicationResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DescribeApplicationResponse';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['name']) && (mb_strlen($this->container['name']) > 225)) {
                $invalidProperties[] = "invalid value for 'name', the character length must be smaller than or equal to 225.";
            }
    ...
    * Sets createdDate
    *
    * @param int|null $createdDate 创建时间
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string|null $name 应用程序显示名
    *
    * @return $this
    */
