...
class ListAccountAssignmentCreationStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAccountAssignmentCreationStatusRequest';
