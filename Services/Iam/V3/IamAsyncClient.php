...
class IamAsyncClient extends Client
{
     ...
     * @return response
     */
    public function keystoneListFederationProjectsAsync($request)
    {
        return $this->keystoneListFederationProjectsAsyncWithHttpInfo($request);
    }
    
    public function keystoneListFederationProjectsAsyncWithHttpInfo($request){
        $collection_formats = [];
