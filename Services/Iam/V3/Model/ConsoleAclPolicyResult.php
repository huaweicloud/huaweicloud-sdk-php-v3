...
class ConsoleAclPolicyResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ConsoleAclPolicyResult';
    ...
    */
    protected static $openAPITypes = [
            ...
            'allowAddressNetmasksIpv6' => '\HuaweiCloud\SDK\Iam\V3\Model\AllowAddressNetmasksResultIPv6[]',
            'allowIpRangesIpv6' => '\HuaweiCloud\SDK\Iam\V3\Model\AllowIpRangesResultIPv6[]'
    ];
    ...
    *  允许访问的IPv6地址或网段。
    *
    * @return \HuaweiCloud\SDK\Iam\V3\Model\AllowAddressNetmasksResultIPv6[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Iam\V3\Model\AllowAddressNetmasksResultIPv6[]|null $allowAddressNetmasksIpv6 允许访问的IPv6地址或网段。
    *
    * @return $this
    */
    ...
    *  允许访问的IPv6地址区间。
    *
    * @return \HuaweiCloud\SDK\Iam\V3\Model\AllowIpRangesResultIPv6[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Iam\V3\Model\AllowIpRangesResultIPv6[]|null $allowIpRangesIpv6 允许访问的IPv6地址区间。
    *
    * @return $this
    */
