...
class CustomPolicy implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'version' => 'string',
            'statement' => '\HuaweiCloud\SDK\Iam\V3\Model\CustomStatement[]'
    ];
    ...
    *  授权语句，描述自定义策略的具体内容。
    *
    * @return \HuaweiCloud\SDK\Iam\V3\Model\CustomStatement[]
    */
    ...
    * Sets statement
    *
    * @param \HuaweiCloud\SDK\Iam\V3\Model\CustomStatement[] $statement 授权语句，描述自定义策略的具体内容。
    *
    * @return $this
    */
