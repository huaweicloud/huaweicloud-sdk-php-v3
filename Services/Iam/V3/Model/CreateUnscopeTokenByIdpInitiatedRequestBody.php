...
class CreateUnscopeTokenByIdpInitiatedRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateUnscopeTokenByIdpInitiatedRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * samlResponse  在IdP认证成功后返回的响应体。详情请参见：[获取联邦认证unscoped token(IdP initiated)](https://support.huaweicloud.com/api-iam/iam_02_0003.html)。
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['samlResponse'] === null) {
            $invalidProperties[] = "'samlResponse' can't be null";
        }
