...
class AgencyUpdateResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AgencyUpdateResult';
    ...
    * description  委托描述信息。
    * domainId  委托方账号ID。
    * duration  委托的期限。取值为\"FOREVER\"或“null”表示委托的期限为永久，取值为24表示委托的期限为一天，或为24小时。
