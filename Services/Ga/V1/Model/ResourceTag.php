...
class ResourceTag implements ModelInterface, ArrayAccess
{
    ...
    * key  标签键，取值范围： - key不能为空，长度1~128个字符（中文也可以输入128个字符）。 - 可用 UTF-8 格式表示的字母（包含中文）、数字和空格，以及以下字符_ . : = + - @。 - _sys_开头属于系统标签，租户不能输入。
    * value  标签值，取值范围： - 长度0~255个字符（中文也可以输入255个字符）。 - 可用 UTF-8 格式表示的字母（包含中文）、数字和空格，以及以下字符_ . : / = + - @。 - 资源标签值可以为空（empty or null）。
    *
    * @var string[]
    */
    ...
    * Sets key
    *
    * @param string $key 标签键，取值范围： - key不能为空，长度1~128个字符（中文也可以输入128个字符）。 - 可用 UTF-8 格式表示的字母（包含中文）、数字和空格，以及以下字符_ . : = + - @。 - _sys_开头属于系统标签，租户不能输入。
    *
    * @return $this
    */
    ...
    * Sets value
    *
    * @param string $value 标签值，取值范围： - 长度0~255个字符（中文也可以输入255个字符）。 - 可用 UTF-8 格式表示的字母（包含中文）、数字和空格，以及以下字符_ . : / = + - @。 - 资源标签值可以为空（empty or null）。
    *
    * @return $this
    */
