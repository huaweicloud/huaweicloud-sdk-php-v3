...
class ListAllPopsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAllPopsResponse';
    ...
    */
    protected static $openAPITypes = [
            'pops' => '\HuaweiCloud\SDK\Ga\V1\Model\PopOuterDetail[]',
    ...
    *  接入点列表。
    *
    * @return \HuaweiCloud\SDK\Ga\V1\Model\PopOuterDetail[]|null
    */
    ...
    * Sets pops
    *
    * @param \HuaweiCloud\SDK\Ga\V1\Model\PopOuterDetail[]|null $pops 接入点列表。
    *
    * @return $this
    */
