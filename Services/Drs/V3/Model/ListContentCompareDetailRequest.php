...
class ListContentCompareDetailRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListContentCompareDetailRequest';
    ...
    * targetDbName  目标库名称。
    * dbName  源库名称。
    * type  类型。 compare：对比 unCompare：无法对比
    * limit  每页显示的条目数量。
    ...
    * Sets type
    *
    * @param string|null $type 类型。 compare：对比 unCompare：无法对比
    *
    * @return $this
    */
