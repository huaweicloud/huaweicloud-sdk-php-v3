...
class ListDataCompareDetailRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDataCompareDetailRequest';
    ...
    * type  类型。 - compare：查询正常对比的项 - unCompare：查询无法对比的项
    * dbName  源数据库名。
    * targetDbName  目标数据库名。
    * queryTbName  表名过滤关键字。
    * limit  每页显示的条目数量。
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['queryTbName'] = isset($data['queryTbName']) ? $data['queryTbName'] : null;
    ...
    * Sets type
    *
    * @param string|null $type 类型。 - compare：查询正常对比的项 - unCompare：查询无法对比的项
    *
    * @return $this
    */
    ...
    * Sets dbName
    *
    * @param string|null $dbName 源数据库名。
    *
    * @return $this
    */
    ...
    * Sets targetDbName
    *
    * @param string|null $targetDbName 目标数据库名。
    *
    * @return $this
    */
    ...
    * @return string|null
    */
    public function getQueryTbName()
    {
        return $this->container['queryTbName'];
    }

    /**
    * Sets queryTbName
    *
    * @param string|null $queryTbName 表名过滤关键字。
    *
    * @return $this
    */
    public function setQueryTbName($queryTbName)
    {
        $this->container['queryTbName'] = $queryTbName;
        return $this;
    }
