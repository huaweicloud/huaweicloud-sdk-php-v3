...
class StartPromptlyDataLevelTableCompareJobRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StartPromptlyDataLevelTableCompareJobRequest';
