...
class ListContentCompareOverviewResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListContentCompareOverviewResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalCount  对比数量
    * contentCompareResultInfos  信息列表
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalCount' => 'int',
            'contentCompareResultInfos' => '\HuaweiCloud\SDK\Drs\V3\Model\NodeContentCompareOverviewResult[]'
    ];
    ...
    *  信息列表
    *
    * @return \HuaweiCloud\SDK\Drs\V3\Model\NodeContentCompareOverviewResult[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Drs\V3\Model\NodeContentCompareOverviewResult[]|null $contentCompareResultInfos 信息列表
    *
    * @return $this
    */
