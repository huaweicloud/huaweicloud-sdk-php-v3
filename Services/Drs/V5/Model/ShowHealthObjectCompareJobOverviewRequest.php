...
class ShowHealthObjectCompareJobOverviewRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowHealthObjectCompareJobOverviewRequest';
