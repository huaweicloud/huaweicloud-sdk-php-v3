...
class ObjectsHealthCompareOverviewInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ObjectsHealthCompareOverviewInfo';
    ...
    * Sets status
    *
    * @param int|null $status 对比结果： - 0：不一致。 - 2：一致。 - 3：未完成。
    *
    * @return $this
    */
