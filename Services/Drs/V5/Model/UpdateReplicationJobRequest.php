...
class UpdateReplicationJobRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateReplicationJobRequest';
    ...
    */
    protected static $openAPITypes = [
            'jobId' => 'string',
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\Drs\V5\Model\ModifyOfflineTaskReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Drs\V5\Model\ModifyOfflineTaskReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Drs\V5\Model\ModifyOfflineTaskReq|null $body body
    *
    * @return $this
    */
