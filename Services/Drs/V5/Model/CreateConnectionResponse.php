...
class CreateConnectionResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['connectionId']) && (mb_strlen($this->container['connectionId']) > 255)) {
                $invalidProperties[] = "invalid value for 'connectionId', the character length must be smaller than or equal to 255.";
            }
            if (!is_null($this->container['connectionId']) && (mb_strlen($this->container['connectionId']) < 1)) {
    ...
    * Sets createTime
    *
    * @param int|null $createTime 连接创建时间，格式为时间戳。
    *
    * @return $this
    */
