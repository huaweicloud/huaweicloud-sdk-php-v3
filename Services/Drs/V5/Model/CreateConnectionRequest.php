...
class CreateConnectionRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\Drs\V5\Model\CreateConnectionReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Drs\V5\Model\CreateConnectionReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Drs\V5\Model\CreateConnectionReq|null $body body
    *
    * @return $this
    */
