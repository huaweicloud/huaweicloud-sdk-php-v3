...
class CreateConnectionReq implements ModelInterface, ArrayAccess
{
    ...
    * name  连接名称。 约束：连接名称在4位到50位之间，不区分大小写，可以包含字母、数字、中划线或下划线，不能包括其他特殊字符。
    * dbType  连接类型，包含： - mysql - postgresql - mongodb - oracle
    * config  config
    ...
    * Sets name
    *
    * @param string $name 连接名称。 约束：连接名称在4位到50位之间，不区分大小写，可以包含字母、数字、中划线或下划线，不能包括其他特殊字符。
    *
    * @return $this
    */
    ...
    * Sets dbType
    *
    * @param string $dbType 连接类型，包含： - mysql - postgresql - mongodb - oracle
    *
    * @return $this
    */
