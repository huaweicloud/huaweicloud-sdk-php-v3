...
class ModifyColumnInfosResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ModifyColumnInfosResponse';
    ...
    * Sets modifyResult
    *
    * @param bool|null $modifyResult 修改结果
    *
    * @return $this
    */
