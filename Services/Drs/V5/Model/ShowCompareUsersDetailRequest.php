...
class ShowCompareUsersDetailRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowCompareUsersDetailRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * jobId  任务ID。
    * compareJobId  对比任务的ID。
    * xLanguage  请求语言类型。
    ...
    * Sets offset
    *
    * @param string|null $offset 偏移量，表示查询该偏移量后面的记录，默认为0。
    *
    * @return $this
    */
    ...
    * Sets limit
    *
    * @param string|null $limit 查询返回记录的数量限制，默认为10。
    *
    * @return $this
    */
