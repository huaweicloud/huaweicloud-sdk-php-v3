...
class ListUserJdbcDriversRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListUserJdbcDriversRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * limit  每页显示的条目数量。默认为10。
    * offset  偏移量，表示从此偏移量开始查询， offset 大于等于 0。默认为0。
    * driverType  指定待查询的驱动文件类型。取值范围： - db2：DB2 for LUW - informix：Informix
    * xLanguage  请求语言类型。
    *
    * @var string[]
    */
    ...
    * Sets driverType
    *
    * @param string $driverType 指定待查询的驱动文件类型。取值范围： - db2：DB2 for LUW - informix：Informix
    *
    * @return $this
    */
