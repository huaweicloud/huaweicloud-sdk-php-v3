...
class ModifyConnectionRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'xLanguage' => 'string',
            'connectionId' => 'string',
            'body' => '\HuaweiCloud\SDK\Drs\V5\Model\UpdateConnectionReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Drs\V5\Model\UpdateConnectionReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Drs\V5\Model\UpdateConnectionReq|null $body body
    *
    * @return $this
    */
