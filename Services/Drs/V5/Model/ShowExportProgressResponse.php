...
class ShowExportProgressResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowExportProgressResponse';
    ...
    * Sets processStatus
    *
    * @param string|null $processStatus 导出进度。
    *
    * @return $this
    */
