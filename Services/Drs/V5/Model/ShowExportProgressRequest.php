...
class ShowExportProgressRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowExportProgressRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * xLanguage  请求语言类型。
    * asyncJobId  导出创建模板接口返回的异步ID。
    *
    * @var string[]
    */
