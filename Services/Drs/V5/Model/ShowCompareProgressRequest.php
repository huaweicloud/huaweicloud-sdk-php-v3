...
class ShowCompareProgressRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowCompareProgressRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['jobId'] === null) {
            ...
            if ((mb_strlen($this->container['jobId']) > 256)) {
        ...
        if ($this->container['compareJobId'] === null) {
            ...
            if ((mb_strlen($this->container['compareJobId']) > 256)) {
                $invalidProperties[] = "invalid value for 'compareJobId', the character length must be smaller than or equal to 256.";
            }
            if ((mb_strlen($this->container['compareJobId']) < 0)) {
                $invalidProperties[] = "invalid value for 'compareJobId', the character length must be bigger than or equal to 0.";
            }
