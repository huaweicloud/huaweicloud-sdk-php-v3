...
class WordsListItem implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'WordsListItem';
    ...
    */
    protected static $openAPITypes = [
            ...
            'confidence' => 'float',
            'location' => 'int[][]',
            'charList' => '\HuaweiCloud\SDK\Ocr\V1\Model\CharListItem[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Ocr\V1\Model\CharListItem[]|null
    */
    ...
    * Sets charList
    *
    * @param \HuaweiCloud\SDK\Ocr\V1\Model\CharListItem[]|null $charList 单元格内文字段列表。输出顺序从左到右，从上到下。仅当入参\"return_text_location\"和\"return_char_location\"同时为true时存在。
    *
    * @return $this
    */
