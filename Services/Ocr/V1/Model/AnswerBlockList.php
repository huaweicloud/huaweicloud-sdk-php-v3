...
class AnswerBlockList implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AnswerBlockList';
    ...
    * Sets confidence
    *
    * @param float $confidence 文字块words的置信度。
    *
    * @return $this
    */
    ...
    * Sets location
    *
    * @param int[] $location 文字块words的区域位置信息，列表形式，分别表示文字块顶点的x, y坐标;坐标原点为图片左上角，x轴沿水平方向，y轴沿竖直方向。
    *
    * @return $this
    */
