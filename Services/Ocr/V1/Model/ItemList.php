...
class ItemList implements ModelInterface, ArrayAccess
{
    ...
    * quantity  数量。
    * unitPrice  单价。
    * licensePlateNumber  车牌号码。 当“advanced_mode”设置为“true”，且当“type”被识别为“toll”或“invoice_tag”被识别为“通行费”时才返回。
    * amount  金额。
    * taxRate  税率。
    * tax  税额。
    * endDate  通行日期止。 当“advanced_mode”设置为“true”，且当“type”被识别为“toll”或“invoice_tag”被识别为“通行费”时才返回。
    * startDate  通行日期起。 当“advanced_mode”设置为“true”，且当“type”被识别为“toll”或“invoice_tag”被识别为“通行费”时才返回。
    * vehicleType  车辆类型。 当“advanced_mode”设置为“true”，且当“type”被识别为“toll”或“invoice_tag”被识别为“通行费”时才返回。
    *
    * @var string[]
    */
    ...
    *
    * @param string|null $licensePlateNumber 车牌号码。 当“advanced_mode”设置为“true”，且当“type”被识别为“toll”或“invoice_tag”被识别为“通行费”时才返回。
    *
    * @return $this
    */
    ...
    * Sets endDate
    *
    * @param string|null $endDate 通行日期止。 当“advanced_mode”设置为“true”，且当“type”被识别为“toll”或“invoice_tag”被识别为“通行费”时才返回。
    *
    * @return $this
    */
    ...
    * Sets startDate
    *
    * @param string|null $startDate 通行日期起。 当“advanced_mode”设置为“true”，且当“type”被识别为“toll”或“invoice_tag”被识别为“通行费”时才返回。
    *
    * @return $this
    */
    ...
    * Sets vehicleType
    *
    * @param string|null $vehicleType 车辆类型。 当“advanced_mode”设置为“true”，且当“type”被识别为“toll”或“invoice_tag”被识别为“通行费”时才返回。
    *
    * @return $this
    */
