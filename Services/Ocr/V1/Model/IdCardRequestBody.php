...
class IdCardRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * returnVerification  返回校验身份证号等信息的开关，默认false，可选值如下所示：  - true：返回校验信息  - false：不反回校验信息
    *
    * @var string[]
    */
    ...
    *
    * @param bool|null $returnVerification 返回校验身份证号等信息的开关，默认false，可选值如下所示：  - true：返回校验信息  - false：不反回校验信息
    *
    * @return $this
    */
