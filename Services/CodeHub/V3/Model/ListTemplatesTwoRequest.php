...
class ListTemplatesTwoRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\CodeHub\V3\Model\RepositoryTemplateVO2'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\RepositoryTemplateVO2|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\RepositoryTemplateVO2|null $body body
    *
    * @return $this
    */
