...
class AddProtectRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'accessLevel' => '\HuaweiCloud\SDK\CodeHub\V3\Model\AddProtectAccessLevel'
    ];
    ...
    *  accessLevel
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\AddProtectAccessLevel
    */
    ...
    * Sets accessLevel
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\AddProtectAccessLevel $accessLevel accessLevel
    *
    * @return $this
    */
