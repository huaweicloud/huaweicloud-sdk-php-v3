...
class ListFilesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'result' => '\HuaweiCloud\SDK\CodeHub\V3\Model\FilesResponseInfo',
            'status' => 'string'
    ];
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\FilesResponseInfo|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\FilesResponseInfo|null $result result
    *
    * @return $this
    */
