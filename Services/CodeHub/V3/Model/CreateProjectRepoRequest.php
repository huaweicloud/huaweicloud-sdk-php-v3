...
class CreateProjectRepoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateProjectRepoRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'type' => 'string',
            'visibilityLevel' => 'int',
            'externalProjectInfo' => '\HuaweiCloud\SDK\CodeHub\V3\Model\ExternalKeyMessage'
    ];
    ...
    *  externalProjectInfo
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\ExternalKeyMessage|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\ExternalKeyMessage|null $externalProjectInfo externalProjectInfo
    *
    * @return $this
    */
