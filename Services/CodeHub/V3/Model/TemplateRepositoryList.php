...
class TemplateRepositoryList implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'projects' => '\HuaweiCloud\SDK\CodeHub\V3\Model\TemplateRepository[]',
            'total' => 'int'
    ];
    ...
    *  模板列表
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\TemplateRepository[]|null
    */
    ...
    * Sets projects
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\TemplateRepository[]|null $projects 模板列表
    *
    * @return $this
    */
