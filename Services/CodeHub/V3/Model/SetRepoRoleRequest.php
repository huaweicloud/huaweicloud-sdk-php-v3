...
class SetRepoRoleRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\CodeHub\V3\Model\SetRepoRoleRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\SetRepoRoleRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\SetRepoRoleRequestBody|null $body body
    *
    * @return $this
    */
