...
class UpdateMergeRequestApprovalStateRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'string',
            'mergeRequestIid' => 'int',
            'body' => '\HuaweiCloud\SDK\CodeHub\V3\Model\ApprovalActionTypeDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\ApprovalActionTypeDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\ApprovalActionTypeDto|null $body body
    *
    * @return $this
    */
