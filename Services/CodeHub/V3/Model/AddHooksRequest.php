...
class AddHooksRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\CodeHub\V3\Model\RepositoryHookRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\RepositoryHookRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\RepositoryHookRequest|null $body body
    *
    * @return $this
    */
