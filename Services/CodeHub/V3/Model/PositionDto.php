...
class PositionDto implements ModelInterface, ArrayAccess
{
    ...
    * Sets baseSha
    *
    * @param string|null $baseSha 源分支base提交节点
    *
    * @return $this
    */
    ...
    * Sets startSha
    *
    * @param string|null $startSha 目标分支最新提交节点
    *
    * @return $this
    */
    ...
    * Sets headSha
    *
    * @param string|null $headSha 源分支最新提交节点
    *
    * @return $this
    */
    ...
    * Sets oldPath
    *
    * @param string|null $oldPath 修改前文件路径
    *
    * @return $this
    */
    ...
    * Sets newPath
    *
    * @param string|null $newPath 修改后文件路径
    *
    * @return $this
    */
    ...
    * Sets positionType
    *
    * @param string|null $positionType 变更类型
    *
    * @return $this
    */
