...
class AddRepoMembersRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\CodeHub\V3\Model\CreateRepoMemberRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\CreateRepoMemberRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\CreateRepoMemberRequest|null $body body
    *
    * @return $this
    */
