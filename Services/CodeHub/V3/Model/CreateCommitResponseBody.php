...
class CreateCommitResponseBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'stats' => '\HuaweiCloud\SDK\CodeHub\V3\Model\CreateCommitResponseBodyStats'
    ];
    ...
    *  stats
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\CreateCommitResponseBodyStats|null
    */
    ...
    * Sets stats
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\CreateCommitResponseBodyStats|null $stats stats
    *
    * @return $this
    */
