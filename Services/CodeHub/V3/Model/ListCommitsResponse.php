...
class ListCommitsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'result' => '\HuaweiCloud\SDK\CodeHub\V3\Model\CommitInfo[]',
            'status' => 'string'
    ];
    ...
    *  提交列表
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\CommitInfo[]|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\CommitInfo[]|null $result 提交列表
    *
    * @return $this
    */
