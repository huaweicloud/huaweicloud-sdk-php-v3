...
class GetRepositoryByProjectIdRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GetRepositoryByProjectIdRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * repositoryUuid  仓库的uuid,用来指定需要查看的仓库
    *
    * @var string[]
    */
