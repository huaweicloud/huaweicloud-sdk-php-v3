...
class MergeRequestListDtoUser implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MergeRequestListDtoUser';
    ...
    * Sets canMerge
    *
    * @param bool|null $canMerge 当前用户是否可合入
    *
    * @return $this
    */
