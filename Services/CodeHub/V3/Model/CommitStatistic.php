...
class CommitStatistic implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CommitStatistic';
    ...
    * Sets additions
    *
    * @param int|null $additions 增加的行数
    *
    * @return $this
    */
    ...
    * Sets deletions
    *
    * @param int|null $deletions 删除的行数
    *
    * @return $this
    */
