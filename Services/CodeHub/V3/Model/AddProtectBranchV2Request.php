...
class AddProtectBranchV2Request implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'branchName' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeHub\V3\Model\AddProtectRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\AddProtectRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\AddProtectRequest|null $body body
    *
    * @return $this
    */
