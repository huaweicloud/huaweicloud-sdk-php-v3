...
class BranchList implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'branches' => '\HuaweiCloud\SDK\CodeHub\V3\Model\Branch[]',
            'total' => 'int'
    ];
    ...
    *  指定仓库的分支列表
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\Branch[]|null
    */
    ...
    * Sets branches
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\Branch[]|null $branches 指定仓库的分支列表
    *
    * @return $this
    */
