...
class CreateMergeRequestDiscussionRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'mergeRequestIid' => 'int',
            'body' => '\HuaweiCloud\SDK\CodeHub\V3\Model\CreateMergeRequestDiscussionBodyDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\CreateMergeRequestDiscussionBodyDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\CreateMergeRequestDiscussionBodyDto|null $body body
    *
    * @return $this
    */
