...
class BranchesItem implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'commit' => '\HuaweiCloud\SDK\CodeHub\V3\Model\CommitV2',
            'divergingCommitCounts' => '\HuaweiCloud\SDK\CodeHub\V3\Model\DivergingCommitCounts',
            'name' => 'string'
    ];
    ...
    *  commit
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\CommitV2|null
    */
    ...
    * Sets commit
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\CommitV2|null $commit commit
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\DivergingCommitCounts|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\DivergingCommitCounts|null $divergingCommitCounts divergingCommitCounts
    *
    * @return $this
    */
