...
class BranchResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'branches' => '\HuaweiCloud\SDK\CodeHub\V3\Model\BranchesItem[]',
            'total' => 'double'
    ];
    ...
    *  分支信息
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\BranchesItem[]|null
    */
    ...
    * Sets branches
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\BranchesItem[]|null $branches 分支信息
    *
    * @return $this
    */
