...
class CreateCommitResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'result' => '\HuaweiCloud\SDK\CodeHub\V3\Model\CreateCommitResponseBody',
            'status' => 'string'
    ];
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\CreateCommitResponseBody|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\CreateCommitResponseBody|null $result result
    *
    * @return $this
    */
