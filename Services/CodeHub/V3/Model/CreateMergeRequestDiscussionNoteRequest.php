...
class CreateMergeRequestDiscussionNoteRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'mergeRequestIid' => 'int',
            'discussionId' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeHub\V3\Model\CreateMergeRequestDiscussionNoteDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\CreateMergeRequestDiscussionNoteDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\CreateMergeRequestDiscussionNoteDto|null $body body
    *
    * @return $this
    */
