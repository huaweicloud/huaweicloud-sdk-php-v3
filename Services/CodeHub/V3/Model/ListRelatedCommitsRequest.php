...
class ListRelatedCommitsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRelatedCommitsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * repositoryUuid  仓库长id
    * type  关联工作项类型
    * search  查询关键字
    * page  页码
    * perPage  每页数量
