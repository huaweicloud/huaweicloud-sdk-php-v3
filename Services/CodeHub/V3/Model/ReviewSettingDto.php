...
class ReviewSettingDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'primaryCategories' => '\HuaweiCloud\SDK\CodeHub\V3\Model\CategoryDto[]',
            ...
            'secondaryCategories' => '\HuaweiCloud\SDK\CodeHub\V3\Model\CategoryDto[]'
    ];
    ...
    *  一级分类
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\CategoryDto[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\CategoryDto[]|null $primaryCategories 一级分类
    *
    * @return $this
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\CategoryDto[]|null $secondaryCategories 二级分类
    *
    * @return $this
    */
