...
class RepoCommitStatistics implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'codelines' => '\HuaweiCloud\SDK\CodeHub\V3\Model\RepoDailyCodeline[]',
            'count' => 'int',
            'event' => '\HuaweiCloud\SDK\CodeHub\V3\Model\RepoStatisticsEvent',
            'statistics' => '\HuaweiCloud\SDK\CodeHub\V3\Model\RepoStatistics[]',
            'total' => 'int'
    ];
    ...
    *  近15日每日代码提交行数
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\RepoDailyCodeline[]|null
    */
    ...
    * Sets codelines
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\RepoDailyCodeline[]|null $codelines 近15日每日代码提交行数
    *
    * @return $this
    */
    ...
    *  event
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\RepoStatisticsEvent|null
    */
    ...
    * Sets event
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\RepoStatisticsEvent|null $event event
    *
    * @return $this
    */
    ...
    *  仓库统计列表
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\RepoStatistics[]|null
    */
    ...
    * Sets statistics
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\RepoStatistics[]|null $statistics 仓库统计列表
    *
    * @return $this
    */
