...
class ShowDiffCommitResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'result' => '\HuaweiCloud\SDK\CodeHub\V3\Model\DiffCommitInfo[]',
            'status' => 'string'
    ];
    ...
    *  差异列表
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\DiffCommitInfo[]|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\DiffCommitInfo[]|null $result 差异列表
    *
    * @return $this
    */
