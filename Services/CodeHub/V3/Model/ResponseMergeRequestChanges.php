...
class ResponseMergeRequestChanges implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'pipeline' => '\HuaweiCloud\SDK\CodeHub\V3\Model\PipelineBasicDto',
            'diffRefs' => '\HuaweiCloud\SDK\CodeHub\V3\Model\DiffRefsDto',
            'mergeError' => 'string',
            'rebaseInProgress' => 'bool',
            'divergedCommitsCount' => 'int',
            'user' => '\HuaweiCloud\SDK\CodeHub\V3\Model\MergeRequestListDtoUser',
            'addedLines' => 'int',
            'removedLines' => 'int',
            'changes' => '\HuaweiCloud\SDK\CodeHub\V3\Model\MergeRequestDiffFileDto[]',
            'sourceProject' => '\HuaweiCloud\SDK\CodeHub\V3\Model\ProjectSimpleDto'
    ];
    ...
    *  pipeline
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\PipelineBasicDto|null
    */
    ...
    * Sets pipeline
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\PipelineBasicDto|null $pipeline pipeline
    *
    * @return $this
    */
    ...
    *  diffRefs
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\DiffRefsDto|null
    */
    ...
    * Sets diffRefs
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\DiffRefsDto|null $diffRefs diffRefs
    *
    * @return $this
    */
    ...
    *  user
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\MergeRequestListDtoUser|null
    */
    ...
    * Sets user
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\MergeRequestListDtoUser|null $user user
    *
    * @return $this
    */
    ...
    *  合并请求文件变更
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\MergeRequestDiffFileDto[]|null
    */
    ...
    * Sets changes
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\MergeRequestDiffFileDto[]|null $changes 合并请求文件变更
    *
    * @return $this
    */
    ...
    *  sourceProject
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\ProjectSimpleDto|null
    */
    ...
    * Sets sourceProject
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\ProjectSimpleDto|null $sourceProject sourceProject
    *
    * @return $this
    */
