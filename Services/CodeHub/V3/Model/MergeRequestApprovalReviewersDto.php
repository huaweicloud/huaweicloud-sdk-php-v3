...
class MergeRequestApprovalReviewersDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'approvalMergeRequestReviewers' => '\HuaweiCloud\SDK\CodeHub\V3\Model\ApprovalUserDto[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\CodeHub\V3\Model\ApprovalUserDto[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeHub\V3\Model\ApprovalUserDto[]|null $approvalMergeRequestReviewers approvalMergeRequestReviewers
    *
    * @return $this
    */
