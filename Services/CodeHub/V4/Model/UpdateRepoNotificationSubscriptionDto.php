...
class UpdateRepoNotificationSubscriptionDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'enabled' => 'bool',
            'configSource' => 'string',
            'webhookConfig' => '\HuaweiCloud\SDK\CodeHub\V4\Model\UpdateRepoWebHookSubscriptionDto',
    ...
    *  webhookConfig
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\UpdateRepoWebHookSubscriptionDto|null
    */
    ...
    * Sets webhookConfig
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\UpdateRepoWebHookSubscriptionDto|null $webhookConfig webhookConfig
    *
    * @return $this
    */
