...
class UpdateGroupMergeRequestTemplateResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateGroupMergeRequestTemplateResponse';
