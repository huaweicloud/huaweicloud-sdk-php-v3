...
class ListMergeRequestApproverSettingsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListMergeRequestApproverSettingsRequest';
    ...
    * targetType  **参数解释：** 审核配置类型。 **约束限制 ** - branch, 分支配置。 - file, 文件配置 （未启用）。 - project, 项目配置 （未启用）。
    ...
    */
    ...
    const TARGET_TYPE_PROJECT = 'project';
    ...
    * Sets targetType
    *
    * @param string|null $targetType **参数解释：** 审核配置类型。 **约束限制 ** - branch, 分支配置。 - file, 文件配置 （未启用）。 - project, 项目配置 （未启用）。
    *
    * @return $this
    */
