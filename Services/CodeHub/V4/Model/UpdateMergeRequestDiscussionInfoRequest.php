...
class UpdateMergeRequestDiscussionInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'mergeRequestIid' => 'int',
            'discussionId' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeHub\V4\Model\UpdateMergeRequestNoteDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\UpdateMergeRequestNoteDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\UpdateMergeRequestNoteDto|null $body body
    *
    * @return $this
    */
