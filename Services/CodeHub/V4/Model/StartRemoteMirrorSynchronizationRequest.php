...
class StartRemoteMirrorSynchronizationRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'body' => '\HuaweiCloud\SDK\CodeHub\V4\Model\RemoteMirrorSyncInfoDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\RemoteMirrorSyncInfoDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\RemoteMirrorSyncInfoDto|null $body body
    *
    * @return $this
    */
