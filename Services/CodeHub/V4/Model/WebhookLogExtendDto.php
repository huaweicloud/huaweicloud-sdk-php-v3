...
class WebhookLogExtendDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'createdAt' => 'string',
            'updatedAt' => 'string',
            'repository' => '\HuaweiCloud\SDK\CodeHub\V4\Model\WebhookRepositoryDto'
    ];
    ...
    *  repository
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\WebhookRepositoryDto|null
    */
    ...
    * Sets repository
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\WebhookRepositoryDto|null $repository repository
    *
    * @return $this
    */
