...
class PipelineDetailDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'isInvalid' => 'bool',
            'type' => 'string',
            'stages' => '\HuaweiCloud\SDK\CodeHub\V4\Model\PipelineStageDto[]',
            'isLatest' => 'bool',
            'triggerUser' => 'string',
            'allJobFinished' => 'bool'
    ];
    ...
    *  stages
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\PipelineStageDto[]|null
    */
    ...
    * Sets stages
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\PipelineStageDto[]|null $stages stages
    *
    * @return $this
    */
