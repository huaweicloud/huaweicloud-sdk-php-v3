...
class ShowProjectMergeRequestSettingResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowProjectMergeRequestSettingResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'evaluationTypes' => '\HuaweiCloud\SDK\CodeHub\V4\Model\EvaluationTypeDto[]',
            'canReopen' => 'bool',
    ...
    *  **参数解释：** 评价维度（MR评价设置）
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\EvaluationTypeDto[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\EvaluationTypeDto[]|null $evaluationTypes **参数解释：** 评价维度（MR评价设置）
    *
    * @return $this
    */
