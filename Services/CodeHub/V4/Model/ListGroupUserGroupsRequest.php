...
class ListGroupUserGroupsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGroupUserGroupsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * groupId  **参数解释：** 代码组id，代码组首页，Group ID后的数字Id
    * search  **参数解释：** 组织下用户组id。 **取值范围：** 字符串长度不少于1，不超过1000。
    ...
    * Sets search
    *
    * @param string|null $search **参数解释：** 组织下用户组id。 **取值范围：** 字符串长度不少于1，不超过1000。
    *
    * @return $this
    */
