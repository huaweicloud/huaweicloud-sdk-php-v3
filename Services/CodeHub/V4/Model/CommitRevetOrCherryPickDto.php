...
class CommitRevetOrCherryPickDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CommitRevetOrCherryPickDto';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * branch  revert目标分支
    * withNewMergeRequest  是否使用创建MR的形式Revert
    * message  提交信息
    *
    * @var string[]
    */
    ...
    * Sets branch
    *
    * @param string $branch revert目标分支
    *
    * @return $this
    */
    ...
    *
    * @param bool|null $withNewMergeRequest 是否使用创建MR的形式Revert
    *
    * @return $this
    */
