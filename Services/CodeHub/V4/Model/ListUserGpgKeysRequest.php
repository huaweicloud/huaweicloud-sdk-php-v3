...
class ListUserGpgKeysRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListUserGpgKeysRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * query  **参数解释：** key的标题名称。 **取值范围：** 字符串长度不少于1，不超过2000。
    *
    * @var string[]
    */
    ...
    * Sets query
    *
    * @param string|null $query **参数解释：** key的标题名称。 **取值范围：** 字符串长度不少于1，不超过2000。
    *
    * @return $this
    */
