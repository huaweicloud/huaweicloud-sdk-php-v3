...
class CreateCommitRevertRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'sha' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeHub\V4\Model\CommitRevetOrCherryPickDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\CommitRevetOrCherryPickDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\CommitRevetOrCherryPickDto|null $body body
    *
    * @return $this
    */
