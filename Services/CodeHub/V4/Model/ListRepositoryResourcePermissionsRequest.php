...
class ListRepositoryResourcePermissionsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRepositoryResourcePermissionsRequest';
