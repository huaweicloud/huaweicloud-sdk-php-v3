...
class LineDiscussionDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'discussions' => '\HuaweiCloud\SDK\CodeHub\V4\Model\MergeRequestBasicDiscussionDto[]',
            'line' => 'int',
            'type' => 'string'
    ];
    ...
    *  **参数解释：** 位于某一侧某行的检视意见集合。
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\MergeRequestBasicDiscussionDto[]|null
    */
    ...
    * Sets discussions
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\MergeRequestBasicDiscussionDto[]|null $discussions **参数解释：** 位于某一侧某行的检视意见集合。
    *
    * @return $this
    */
