...
class UpdateProjectReviewSettingsRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeHub\V4\Model\ReviewSettingParamDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\ReviewSettingParamDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\ReviewSettingParamDto|null $body body
    *
    * @return $this
    */
