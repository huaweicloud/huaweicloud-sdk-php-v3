...
class ListProjectMergeRequestTemplatesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListProjectMergeRequestTemplatesRequest';
