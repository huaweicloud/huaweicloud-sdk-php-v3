...
class ListProjectSubgroupsAndRepositoriesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListProjectSubgroupsAndRepositoriesRequest';
