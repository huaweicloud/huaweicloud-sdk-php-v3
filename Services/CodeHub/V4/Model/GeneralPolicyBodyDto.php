...
class GeneralPolicyBodyDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GeneralPolicyBodyDto';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['createBranchWhitelistUserIds']) && (mb_strlen($this->container['createBranchWhitelistUserIds']) > 1000)) {
                $invalidProperties[] = "invalid value for 'createBranchWhitelistUserIds', the character length must be smaller than or equal to 1000.";
            }
            if (!is_null($this->container['createBranchWhitelistUserIds']) && (mb_strlen($this->container['createBranchWhitelistUserIds']) < 0)) {
                $invalidProperties[] = "invalid value for 'createBranchWhitelistUserIds', the character length must be bigger than or equal to 0.";
            }
    ...
    */
    ...
    /**
    * Gets createBranchWhitelistUserIds
    *  **参数解释：** 开发人员创建分支权限例外白名单。多个用户ID使用逗号分隔。
    *
    * @return string|null
    */
    public function getCreateBranchWhitelistUserIds()
    {
        return $this->container['createBranchWhitelistUserIds'];
    }

    /**
    * Sets createBranchWhitelistUserIds
    *
    * @param string|null $createBranchWhitelistUserIds **参数解释：** 开发人员创建分支权限例外白名单。多个用户ID使用逗号分隔。
    *
    * @return $this
    */
