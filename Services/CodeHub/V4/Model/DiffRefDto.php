...
class DiffRefDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DiffRefDto';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * baseSha  目标分支以及源分支的共同祖先commitId
    * headSha  源分支的最新commitId
    * startSha  目标分支的最新commitId
    *
    * @var string[]
    */
    ...
    * Sets baseSha
    *
    * @param string|null $baseSha 目标分支以及源分支的共同祖先commitId
    *
    * @return $this
    */
    ...
    * Sets headSha
    *
    * @param string|null $headSha 源分支的最新commitId
    *
    * @return $this
    */
    ...
    * Sets startSha
    *
    * @param string|null $startSha 目标分支的最新commitId
    *
    * @return $this
    */
