...
class ShowRefCompareResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'commits' => '\HuaweiCloud\SDK\CodeHub\V4\Model\CommitDto[]',
            'diffs' => '\HuaweiCloud\SDK\CodeHub\V4\Model\DiffDto[]',
            'diffsFiles' => '\HuaweiCloud\SDK\CodeHub\V4\Model\DiffDto[]',
            'compareTimeout' => 'bool',
            'compareSameRef' => 'bool',
            'conflictFiles' => '\HuaweiCloud\SDK\CodeHub\V4\Model\ConflictFileDto[]',
            'addedLines' => 'int',
            'removedLines' => 'int',
            'commitsCount' => 'int',
            'diffsCount' => 'int',
    ...
    * Sets commits
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\CommitDto[]|null $commits commit相关信息列表
    *
    * @return $this
    */
    ...
    * Sets diffs
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\DiffDto[]|null $diffs 变更文件信息
    *
    * @return $this
    */
    ...
    * Sets diffsFiles
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\DiffDto[]|null $diffsFiles 变更文件信息
    *
    * @return $this
    */
    ...
    *  冲突文件
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\ConflictFileDto[]|null
    */
    ...
    * Sets conflictFiles
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\ConflictFileDto[]|null $conflictFiles 冲突文件
    *
    * @return $this
    */
