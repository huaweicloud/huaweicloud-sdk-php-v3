...
class ShowRepositoryPermissionInheritEnabledRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowRepositoryPermissionInheritEnabledRequest';
