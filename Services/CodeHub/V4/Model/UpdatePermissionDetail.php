...
class UpdatePermissionDetail implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePermissionDetail';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * permissionId  **参数解释：** 权限点id **取值范围：** 不涉及。
    * enabled  **参数解释：** 权限点状态 **取值范围：** - true, 开启。 - false, 关闭。
    *
    * @var string[]
    */
    ...
    * Sets permissionId
    *
    * @param int|null $permissionId **参数解释：** 权限点id **取值范围：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets enabled
    *
    * @param bool|null $enabled **参数解释：** 权限点状态 **取值范围：** - true, 开启。 - false, 关闭。
    *
    * @return $this
    */
