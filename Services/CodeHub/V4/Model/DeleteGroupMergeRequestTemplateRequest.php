...
class DeleteGroupMergeRequestTemplateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteGroupMergeRequestTemplateRequest';
