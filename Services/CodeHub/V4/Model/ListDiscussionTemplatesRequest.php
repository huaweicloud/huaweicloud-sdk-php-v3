...
class ListDiscussionTemplatesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDiscussionTemplatesRequest';
    ...
    * Sets isDefault
    *
    * @param bool|null $isDefault **参数解释：** 是否返回默认模板。
    *
    * @return $this
    */
