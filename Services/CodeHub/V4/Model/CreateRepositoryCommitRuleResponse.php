...
class CreateRepositoryCommitRuleResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateRepositoryCommitRuleResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'privilegedUsers' => '\HuaweiCloud\SDK\CodeHub\V4\Model\RepositoryUserBasicDto[]',
    ...
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\RepositoryUserBasicDto[]|null $privilegedUsers **参数解释：** 特权用户（特权用户可直接推送所有二进制文件入库）。
    *
    * @return $this
    */
