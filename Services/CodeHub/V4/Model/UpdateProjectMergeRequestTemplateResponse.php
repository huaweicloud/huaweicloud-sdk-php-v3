...
class UpdateProjectMergeRequestTemplateResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateProjectMergeRequestTemplateResponse';
