...
class UpdateMergeRequestSettingRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'body' => '\HuaweiCloud\SDK\CodeHub\V4\Model\UpdateMergeRequestSettingDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\UpdateMergeRequestSettingDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\UpdateMergeRequestSettingDto|null $body body
    *
    * @return $this
    */
