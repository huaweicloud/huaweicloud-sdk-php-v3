...
class ListGroupMergeRequestTemplatesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGroupMergeRequestTemplatesRequest';
