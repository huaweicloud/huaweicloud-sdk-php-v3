...
class GroupPermissionsDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GroupPermissionsDto';
    ...
    * groupId  **参数解释：** **参数解释：** 代码组id，代码组首页，Group ID后的数字Id
    *
    * @var string[]
    */
    ...
    * Sets projectId
    *
    * @param string|null $projectId **参数解释：** 项目的32位uuid，项目唯一标识，通过[[查询项目列表](https://support.huaweicloud.com/api-projectman/ListProjectsV4.html)](tag:hws)[[查询项目列表](https://support.huaweicloud.com/intl/en-us/api-projectman/ListProjectsV4.html)](tag:hws_hk)[查询项目列表](tag:hcs,hcs_sm)接口查询项目列表获取。 **取值范围：** 字符串长度32。
    *
    * @return $this
    */
    ...
    * Sets groupId
    *
    * @param string|null $groupId **参数解释：** **参数解释：** 代码组id，代码组首页，Group ID后的数字Id
    *
    * @return $this
    */
