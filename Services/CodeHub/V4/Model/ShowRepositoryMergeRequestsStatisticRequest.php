...
class ShowRepositoryMergeRequestsStatisticRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowRepositoryMergeRequestsStatisticRequest';
    ...
    * iids  **参数解释：** 合并请求iid。
    * fields  **参数解释：** 统计字段。 **约束限制 ** - commits_count，统计提交数 - changed_files_count，文件变更数 - notes_count， 检视意见数 - changed_lines_count，代码变更行数
    *
    * @var string[]
    */
    ...
    */
    ...
    const FIELDS_COMMITS_COUNT = 'commits_count';
    const FIELDS_CHANGED_FILES_COUNT = 'changed_files_count';
    const FIELDS_NOTES_COUNT = 'notes_count';
    const FIELDS_CHANGED_LINES_COUNT = 'changed_lines_count';
    ...
    */
    ...
    {
        return [
            self::FIELDS_COMMITS_COUNT,
            self::FIELDS_CHANGED_FILES_COUNT,
            self::FIELDS_NOTES_COUNT,
            self::FIELDS_CHANGED_LINES_COUNT,
        ];
    }
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['iids'] === null) {
            $invalidProperties[] = "'iids' can't be null";
        }
            $allowedValues = $this->getFieldsAllowableValues();
                if (!is_null($this->container['fields']) && !in_array($this->container['fields'], $allowedValues, true)) {
    ...
    * Sets fields
    *
    * @param string|null $fields **参数解释：** 统计字段。 **约束限制 ** - commits_count，统计提交数 - changed_files_count，文件变更数 - notes_count， 检视意见数 - changed_lines_count，代码变更行数
    *
    * @return $this
    */
