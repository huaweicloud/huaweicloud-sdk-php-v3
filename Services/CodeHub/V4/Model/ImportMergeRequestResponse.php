...
class ImportMergeRequestResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImportMergeRequestResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'author' => '\HuaweiCloud\SDK\CodeHub\V4\Model\UserBasicExternalDto',
            ...
            'subscribed' => 'bool',
            'mergedBy' => '\HuaweiCloud\SDK\CodeHub\V4\Model\UserBasicExternalDto',
            'mergedAt' => 'string',
            'closedBy' => '\HuaweiCloud\SDK\CodeHub\V4\Model\UserBasicExternalDto',
            'closedAt' => 'string',
            'userNotesCount' => 'int',
            'forceRemoveSourceBranch' => 'bool',
            'webUrl' => 'string',
            'mergeRequestDiff' => '\HuaweiCloud\SDK\CodeHub\V4\Model\MergeRequestDiffExternalDto',
            'mergeRequestReviewersCount' => 'int',
            'mergeRequestReviewCount' => 'int',
            'mergeRequestReviewerList' => '\HuaweiCloud\SDK\CodeHub\V4\Model\MergeRequestReviewerExternalDto[]',
            'mergeRequestAssigneeList' => '\HuaweiCloud\SDK\CodeHub\V4\Model\UserBasicExternalDto[]',
            'notes' => 'int',
            'codecheckState' => 'int',
            'codecheckDefectCount' => 'int',
            'mergeRequestRelatedWorkItems' => '\HuaweiCloud\SDK\CodeHub\V4\Model\MergeRequestRelatedWorkItemDto[]',
            ...
            'reviewMode' => 'string',
            'squash' => 'bool',
            'approvalMergeRequestApprovers' => '\HuaweiCloud\SDK\CodeHub\V4\Model\ApprovalUserDto[]',
            'approvalMergeRequestReviewers' => '\HuaweiCloud\SDK\CodeHub\V4\Model\ApprovalUserDto[]',
            'sourceRepository' => '\HuaweiCloud\SDK\CodeHub\V4\Model\ProjectSimpleDto',
            'targetRepository' => '\HuaweiCloud\SDK\CodeHub\V4\Model\ProjectSimpleDto',
            'isSourceBranchExist' => 'bool',
            'mergeRequestType' => 'string',
            'squashCommitMessage' => 'string',
            'autoMerge' => 'bool',
            'mergeError' => 'string',
            'jsonMergeError' => '\HuaweiCloud\SDK\CodeHub\V4\Model\MergeErrorDto',
    ...
    *  author
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\UserBasicExternalDto|null
    */
    ...
    * Sets author
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\UserBasicExternalDto|null $author author
    *
    * @return $this
    */
    ...
    * Sets mergedBy
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\UserBasicExternalDto|null $mergedBy mergedBy
    *
    * @return $this
    */
    ...
    * Sets closedBy
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\UserBasicExternalDto|null $closedBy closedBy
    *
    * @return $this
    */
    ...
    *  mergeRequestDiff
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\MergeRequestDiffExternalDto|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\MergeRequestDiffExternalDto|null $mergeRequestDiff mergeRequestDiff
    *
    * @return $this
    */
    ...
    *  评审人列表
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\MergeRequestReviewerExternalDto[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\MergeRequestReviewerExternalDto[]|null $mergeRequestReviewerList 评审人列表
    *
    * @return $this
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\UserBasicExternalDto[]|null $mergeRequestAssigneeList 合并人列表
    *
    * @return $this
    */
    ...
    *  合并请求关联单数量
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\MergeRequestRelatedWorkItemDto[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\MergeRequestRelatedWorkItemDto[]|null $mergeRequestRelatedWorkItems 合并请求关联单数量
    *
    * @return $this
    */
    ...
    *  审核模式审核人
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\ApprovalUserDto[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\ApprovalUserDto[]|null $approvalMergeRequestApprovers 审核模式审核人
    *
    * @return $this
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\ApprovalUserDto[]|null $approvalMergeRequestReviewers 审核模式检视人
    *
    * @return $this
    */
    ...
    *  sourceRepository
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\ProjectSimpleDto|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\ProjectSimpleDto|null $sourceRepository sourceRepository
    *
    * @return $this
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\ProjectSimpleDto|null $targetRepository targetRepository
    *
    * @return $this
    */
    ...
    *  jsonMergeError
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\MergeErrorDto|null
    */
    ...
    * Sets jsonMergeError
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\MergeErrorDto|null $jsonMergeError jsonMergeError
    *
    * @return $this
    */
