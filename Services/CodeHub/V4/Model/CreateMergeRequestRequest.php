...
class CreateMergeRequestRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'body' => '\HuaweiCloud\SDK\CodeHub\V4\Model\PostMergeRequestParamsDtoForOpenApi'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\PostMergeRequestParamsDtoForOpenApi|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\PostMergeRequestParamsDtoForOpenApi|null $body body
    *
    * @return $this
    */
