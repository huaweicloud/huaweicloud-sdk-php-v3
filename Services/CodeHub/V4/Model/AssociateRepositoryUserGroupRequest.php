...
class AssociateRepositoryUserGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateRepositoryUserGroupRequest';
