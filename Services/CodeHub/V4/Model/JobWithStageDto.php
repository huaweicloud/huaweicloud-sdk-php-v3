...
class JobWithStageDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'JobWithStageDto';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['stageId']) && ($this->container['stageId'] > 2147483647)) {
                $invalidProperties[] = "invalid value for 'stageId', must be smaller than or equal to 2147483647.";
            }
            if (!is_null($this->container['stageId']) && ($this->container['stageId'] < 1)) {
                $invalidProperties[] = "invalid value for 'stageId', must be bigger than or equal to 1.";
            }
            if (!is_null($this->container['stage']) && (mb_strlen($this->container['stage']) > 100000)) {
                $invalidProperties[] = "invalid value for 'stage', the character length must be smaller than or equal to 100000.";
            }
            if (!is_null($this->container['stage']) && (mb_strlen($this->container['stage']) < 1)) {
