...
class CreateProjectMergeRequestApproverSettingRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeHub\V4\Model\CreateMergeRequestApproverSettingDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\CreateMergeRequestApproverSettingDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\CreateMergeRequestApproverSettingDto|null $body body
    *
    * @return $this
    */
