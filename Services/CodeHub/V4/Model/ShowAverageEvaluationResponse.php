...
class ShowAverageEvaluationResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'evaluations' => '\HuaweiCloud\SDK\CodeHub\V4\Model\MergeRequestBaseEvaluationDto[]',
            'customEvaluations' => '\HuaweiCloud\SDK\CodeHub\V4\Model\MergeRequestCustomAverageEvaluationDto[]'
    ];
    ...
    *  **参数解释：** 单人评价详情。
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\MergeRequestBaseEvaluationDto[]|null
    */
    ...
    * Sets evaluations
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\MergeRequestBaseEvaluationDto[]|null $evaluations **参数解释：** 单人评价详情。
    *
    * @return $this
    */
    ...
    *  **参数解释：** 自定义评价维度详情。
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\MergeRequestCustomAverageEvaluationDto[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\MergeRequestCustomAverageEvaluationDto[]|null $customEvaluations **参数解释：** 自定义评价维度详情。
    *
    * @return $this
    */
