...
class UpdateProjectReviewSettingsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateProjectReviewSettingsResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'primaryCategories' => '\HuaweiCloud\SDK\CodeHub\V4\Model\CategoryDto[]',
            ...
            'codehubDefaultCategories' => '\HuaweiCloud\SDK\CodeHub\V4\Model\CategoryDto[]',
            'hicodeDefaultCategories' => '\HuaweiCloud\SDK\CodeHub\V4\Model\CategoryDto[]'
    ];
    ...
    *  **参数解释：** 检视意见分类(已勾选)。
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\CategoryDto[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\CategoryDto[]|null $primaryCategories **参数解释：** 检视意见分类(已勾选)。
    *
    * @return $this
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\CategoryDto[]|null $codehubDefaultCategories **参数解释：** 检视意见分类(所有可勾选的，需传参with_default_review_categories: true才返回)。
    *
    * @return $this
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\CategoryDto[]|null $hicodeDefaultCategories **参数解释：** 系统预置检视意见分类(需传参with_default_review_categories: true才返回)。
    *
    * @return $this
    */
