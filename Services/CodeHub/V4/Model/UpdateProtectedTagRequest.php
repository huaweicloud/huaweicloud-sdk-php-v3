...
class UpdateProtectedTagRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'tagName' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeHub\V4\Model\RepositoryProtectedTagActionBodyDto[]'
    ];
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\RepositoryProtectedTagActionBodyDto[]|null $body 保护Tag权限列表
    *
    * @return $this
    */
