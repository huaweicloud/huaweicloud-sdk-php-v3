...
class ExportTenantRepositoryBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExportTenantRepositoryBody';
    ...
    * Sets repositoryIds
    *
    * @param int[]|null $repositoryIds repositoryIds
    *
    * @return $this
    */
