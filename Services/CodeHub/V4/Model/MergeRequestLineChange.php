...
class MergeRequestLineChange implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MergeRequestLineChange';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * addedLines  合并请求新增代码行数
    * removedLines  合并请求删除代码行数
    *
    * @var string[]
    */
    ...
    * Sets addedLines
    *
    * @param int|null $addedLines 合并请求新增代码行数
    *
    * @return $this
    */
    ...
    * Sets removedLines
    *
    * @param int|null $removedLines 合并请求删除代码行数
    *
    * @return $this
    */
