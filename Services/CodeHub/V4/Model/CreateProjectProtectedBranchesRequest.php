...
class CreateProjectProtectedBranchesRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeHub\V4\Model\ProtectedBranchBodyApiDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\ProtectedBranchBodyApiDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\ProtectedBranchBodyApiDto|null $body body
    *
    * @return $this
    */
