...
class ApprovalReviewerInfoDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ApprovalReviewerInfoDto';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * reviewerIds  **参数解释：** 需要更新的检视人ID列表 数字以英文逗号分隔 111,222 **取值范围：** 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets reviewerIds
    *
    * @param string|null $reviewerIds **参数解释：** 需要更新的检视人ID列表 数字以英文逗号分隔 111,222 **取值范围：** 不涉及。
    *
    * @return $this
    */
