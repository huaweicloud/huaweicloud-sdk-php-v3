...
class UpdateRepositoryResourcePermissionsRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'resourceName' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeHub\V4\Model\UpdatePermissionBodyDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\UpdatePermissionBodyDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\UpdatePermissionBodyDto|null $body body
    *
    * @return $this
    */
