...
class BatchDeleteProtectedTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'body' => '\HuaweiCloud\SDK\CodeHub\V4\Model\BatchDeleteProtectedTagsBodyDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\BatchDeleteProtectedTagsBodyDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\BatchDeleteProtectedTagsBodyDto|null $body body
    *
    * @return $this
    */
