...
class TransferGroupResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'fullName' => 'string',
            'fullPath' => 'string',
            'myRole' => '\HuaweiCloud\SDK\CodeHub\V4\Model\GroupMyRoleDto',
            'name' => 'string',
            'parentId' => 'int',
            'creatorId' => 'int'
    ];
    ...
    *  myRole
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\GroupMyRoleDto|null
    */
    ...
    * Sets myRole
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\GroupMyRoleDto|null $myRole myRole
    *
    * @return $this
    */
