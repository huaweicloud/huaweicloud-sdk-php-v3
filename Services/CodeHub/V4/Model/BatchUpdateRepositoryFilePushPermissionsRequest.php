...
class BatchUpdateRepositoryFilePushPermissionsRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'body' => '\HuaweiCloud\SDK\CodeHub\V4\Model\BatchUpdateFilePushPermissionBodyDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\BatchUpdateFilePushPermissionBodyDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\BatchUpdateFilePushPermissionBodyDto|null $body body
    *
    * @return $this
    */
