...
class AssociateRemoteMirrorRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'body' => '\HuaweiCloud\SDK\CodeHub\V4\Model\RemoteMirrorDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\RemoteMirrorDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\RemoteMirrorDto|null $body body
    *
    * @return $this
    */
