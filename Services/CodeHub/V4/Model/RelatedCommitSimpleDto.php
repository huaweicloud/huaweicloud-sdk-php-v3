...
class RelatedCommitSimpleDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RelatedCommitSimpleDto';
    ...
    * Sets relatedId
    *
    * @param string|null $relatedId 关联工作项ID
    *
    * @return $this
    */
    ...
    * Sets relatedUrl
    *
    * @param string|null $relatedUrl 关联工作URL
    *
    * @return $this
    */
