...
class CreateBranchResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'latestPipeline' => '\HuaweiCloud\SDK\CodeHub\V4\Model\PipelineBasicDto',
            'openedMrCount' => 'int',
            'divergingCommitCounts' => '\HuaweiCloud\SDK\CodeHub\V4\Model\DivergingCommitCounts'
    ];
    ...
    * Sets latestPipeline
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\PipelineBasicDto|null $latestPipeline latestPipeline
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\DivergingCommitCounts|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\DivergingCommitCounts|null $divergingCommitCounts divergingCommitCounts
    *
    * @return $this
    */
