...
class UpdateTenantTrustedIpAddressRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateTenantTrustedIpAddressRequest';
    ...
    */
    protected static $openAPITypes = [
            'ipId' => 'int',
            'body' => '\HuaweiCloud\SDK\CodeHub\V4\Model\AddTrustedIpAddressRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\AddTrustedIpAddressRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\AddTrustedIpAddressRequestBody|null $body body
    *
    * @return $this
    */
