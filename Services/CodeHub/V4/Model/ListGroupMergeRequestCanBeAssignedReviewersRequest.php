...
class ListGroupMergeRequestCanBeAssignedReviewersRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGroupMergeRequestCanBeAssignedReviewersRequest';
