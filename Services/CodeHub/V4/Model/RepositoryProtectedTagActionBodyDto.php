...
class RepositoryProtectedTagActionBodyDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RepositoryProtectedTagActionBodyDto';
    ...
    * action  **参数解释：** 事件名称。 **约束限制：** 不涉及 **取值范围：** - create，创建。 **默认取值：** 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets action
    *
    * @param string|null $action **参数解释：** 事件名称。 **约束限制：** 不涉及 **取值范围：** - create，创建。 **默认取值：** 不涉及。
    *
    * @return $this
    */
