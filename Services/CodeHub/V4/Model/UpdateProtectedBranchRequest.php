...
class UpdateProtectedBranchRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'branchName' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeHub\V4\Model\ProtectedBranchProtectedActionBodyDto[]'
    ];
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\ProtectedBranchProtectedActionBodyDto[]|null $body 保护分支权限列表
    *
    * @return $this
    */
