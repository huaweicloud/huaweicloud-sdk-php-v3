...
class CreateMergeRequestResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateMergeRequestResponse';
    ...
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\ApprovalUserDto[]|null $approvalMergeRequestApprovers 审核人
    *
    * @return $this
    */
