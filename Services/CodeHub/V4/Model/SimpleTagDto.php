...
class SimpleTagDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'message' => 'string',
            'target' => 'string',
            'gpgKey' => '\HuaweiCloud\SDK\CodeHub\V4\Model\GpgKeyDto',
            'canDelete' => 'bool',
            'canRead' => 'bool',
            'canDownload' => 'bool'
    ];
    ...
    *  gpgKey
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\GpgKeyDto|null
    */
    ...
    * Sets gpgKey
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\GpgKeyDto|null $gpgKey gpgKey
    *
    * @return $this
    */
