...
class ShowLastPushEventInRepositoryResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'ref' => 'string',
            'createdAt' => 'string',
            'repository' => '\HuaweiCloud\SDK\CodeHub\V4\Model\RepositoryBriefDto'
    ];
    ...
    *  repository
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\RepositoryBriefDto|null
    */
    ...
    * Sets repository
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\RepositoryBriefDto|null $repository repository
    *
    * @return $this
    */
