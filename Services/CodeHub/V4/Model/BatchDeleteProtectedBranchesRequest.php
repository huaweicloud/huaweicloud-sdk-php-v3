...
class BatchDeleteProtectedBranchesRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'body' => '\HuaweiCloud\SDK\CodeHub\V4\Model\BatchDeleteProtectedBranchesBodyDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\BatchDeleteProtectedBranchesBodyDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\BatchDeleteProtectedBranchesBodyDto|null $body body
    *
    * @return $this
    */
