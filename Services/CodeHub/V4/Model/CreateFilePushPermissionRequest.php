...
class CreateFilePushPermissionRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'body' => '\HuaweiCloud\SDK\CodeHub\V4\Model\CreateRepositoryFilePushPermissionDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\CreateRepositoryFilePushPermissionDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\CreateRepositoryFilePushPermissionDto|null $body body
    *
    * @return $this
    */
