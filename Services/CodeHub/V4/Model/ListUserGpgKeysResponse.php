...
class ListUserGpgKeysResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'primaryKeyid' => 'string',
            'active' => 'bool',
            'subkeys' => '\HuaweiCloud\SDK\CodeHub\V4\Model\GpgSubKeyDto[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\GpgSubKeyDto[]|null
    */
    ...
    * Sets subkeys
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\GpgSubKeyDto[]|null $subkeys **参数解释：** 子钥列表。 **取值范围：** 列表长度不少于0，不超过1000。
    *
    * @return $this
    */
