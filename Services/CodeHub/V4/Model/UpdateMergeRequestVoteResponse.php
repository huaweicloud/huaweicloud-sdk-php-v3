...
class UpdateMergeRequestVoteResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'mergeRequestId' => 'int',
            'score' => 'int',
            'author' => '\HuaweiCloud\SDK\CodeHub\V4\Model\UserSafeDto'
    ];
    ...
    *  author
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\UserSafeDto|null
    */
    ...
    * Sets author
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\UserSafeDto|null $author author
    *
    * @return $this
    */
