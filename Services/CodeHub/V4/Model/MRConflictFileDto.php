...
class MRConflictFileDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'content' => 'string',
            'contentPath' => 'string',
            'sections' => '\HuaweiCloud\SDK\CodeHub\V4\Model\ConflictSectionDto[]',
            'type' => 'string',
            'errorMessage' => 'string'
    ];
    ...
    *  片段
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\ConflictSectionDto[]|null
    */
    ...
    * Sets sections
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\ConflictSectionDto[]|null $sections 片段
    *
    * @return $this
    */
