...
class ListRepositoryProtectedRefsUserGroupsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRepositoryProtectedRefsUserGroupsRequest';
