...
class BaseEventDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BaseEventDto';
    ...
    */
    protected static $openAPITypes = [
            'actionName' => 'string',
            'author' => '\HuaweiCloud\SDK\CodeHub\V4\Model\RepositoryEventAuthorDto',
            'authorId' => 'int',
    ...
    *  author
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\RepositoryEventAuthorDto|null
    */
    ...
    * Sets author
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\RepositoryEventAuthorDto|null $author author
    *
    * @return $this
    */
