...
class UpdateNotificationSubscriptionRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'type' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeHub\V4\Model\UpdateRepoNotificationSubscriptionDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\UpdateRepoNotificationSubscriptionDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\UpdateRepoNotificationSubscriptionDto|null $body body
    *
    * @return $this
    */
