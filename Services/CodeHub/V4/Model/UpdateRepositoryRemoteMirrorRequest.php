...
class UpdateRepositoryRemoteMirrorRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'body' => '\HuaweiCloud\SDK\CodeHub\V4\Model\RemoteMirrorUpdateBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\RemoteMirrorUpdateBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\RemoteMirrorUpdateBody|null $body body
    *
    * @return $this
    */
