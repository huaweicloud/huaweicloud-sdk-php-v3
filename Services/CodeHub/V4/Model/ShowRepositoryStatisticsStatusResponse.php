...
class ShowRepositoryStatisticsStatusResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'canStatistics' => 'bool',
            'reason' => 'int',
            'event' => '\HuaweiCloud\SDK\CodeHub\V4\Model\StatisticEventsDto',
            'xTotal' => 'string'
    ];
    ...
    *  event
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\StatisticEventsDto|null
    */
    ...
    * Sets event
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\StatisticEventsDto|null $event event
    *
    * @return $this
    */
