...
class ListCommitsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'dateTitle' => '\HuaweiCloud\SDK\CodeHub\V4\Model\DateTitleDto[]'
    ];
    ...
    * Sets commits
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\CommitDto[]|null $commits 提交列表
    *
    * @return $this
    */
    ...
    *  按天统计信息
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\DateTitleDto[]|null
    */
    ...
    * Sets dateTitle
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\DateTitleDto[]|null $dateTitle 按天统计信息
    *
    * @return $this
    */
