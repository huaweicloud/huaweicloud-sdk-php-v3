...
class ListUserKeysResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'keys' => '\HuaweiCloud\SDK\CodeHub\V4\Model\SSHKeyDto[]',
            'total' => 'int'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\SSHKeyDto[]|null
    */
    ...
    * Sets keys
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\SSHKeyDto[]|null $keys **参数解释：** 密钥列表。 **取值范围：** 列表长度不少于0，不超过1000。
    *
    * @return $this
    */
