...
class FileChangeDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'removedLines' => 'int',
            'contentSha' => 'string',
            'diffRefs' => '\HuaweiCloud\SDK\CodeHub\V4\Model\DiffRefDto'
    ];
    ...
    *  diffRefs
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\DiffRefDto|null
    */
    ...
    * Sets diffRefs
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\DiffRefDto|null $diffRefs diffRefs
    *
    * @return $this
    */
