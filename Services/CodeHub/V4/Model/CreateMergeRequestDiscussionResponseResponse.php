...
class CreateMergeRequestDiscussionResponseResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateMergeRequestDiscussionResponseResponse';
