...
class DeployKeyParamsDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeployKeyParamsDto';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * title  **参数解释：** 标题。 **取值范围：** 字符串长度不少于1，不超过1000。
    * key  **参数解释：** key值。 **取值范围：** 字符串长度不少于1，不超过1000。
    *
    * @var string[]
    */
    ...
    * Sets title
    *
    * @param string|null $title **参数解释：** 标题。 **取值范围：** 字符串长度不少于1，不超过1000。
    *
    * @return $this
    */
    ...
    * Sets key
    *
    * @param string|null $key **参数解释：** key值。 **取值范围：** 字符串长度不少于1，不超过1000。
    *
    * @return $this
    */
