...
class ShowProjectSettingsInheritCfgRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowProjectSettingsInheritCfgRequest';
