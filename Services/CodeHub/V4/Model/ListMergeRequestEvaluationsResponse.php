...
class ListMergeRequestEvaluationsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListMergeRequestEvaluationsResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'updatedAt' => 'string',
            'content' => 'string',
            'user' => '\HuaweiCloud\SDK\CodeHub\V4\Model\UserBasicDto',
            'customEvaluations' => '\HuaweiCloud\SDK\CodeHub\V4\Model\CustomEvaluationDto[]'
    ];
    ...
    * Sets user
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\UserBasicDto|null $user user
    *
    * @return $this
    */
    ...
    *  自定义评价
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\CustomEvaluationDto[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\CustomEvaluationDto[]|null $customEvaluations 自定义评价
    *
    * @return $this
    */
