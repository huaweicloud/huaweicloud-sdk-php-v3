...
class ListProductPermissionResourcesGrantedUsersRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListProductPermissionResourcesGrantedUsersRequest';
