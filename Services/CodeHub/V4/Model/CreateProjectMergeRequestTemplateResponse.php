...
class CreateProjectMergeRequestTemplateResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateProjectMergeRequestTemplateResponse';
