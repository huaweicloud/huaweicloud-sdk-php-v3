...
class CommitDiscussionDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'id' => 'string',
            'individualNote' => 'bool',
            'notes' => '\HuaweiCloud\SDK\CodeHub\V4\Model\CommitNoteDto[]',
            'repositoryId' => 'int',
            'noteableType' => 'string',
            'commitId' => 'string',
    ...
    *  **参数解释：** 评论列表(主评+回复)。
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\CommitNoteDto[]|null
    */
    ...
    * Sets notes
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\CommitNoteDto[]|null $notes **参数解释：** 评论列表(主评+回复)。
    *
    * @return $this
    */
