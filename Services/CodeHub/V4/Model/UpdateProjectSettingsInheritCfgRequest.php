...
class UpdateProjectSettingsInheritCfgRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeHub\V4\Model\SettingsInheritCfgBodyApiDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\SettingsInheritCfgBodyApiDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\SettingsInheritCfgBodyApiDto|null $body body
    *
    * @return $this
    */
