...
class ShowDiffCommitResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'diffs' => '\HuaweiCloud\SDK\CodeHub\V4\Model\DiffNoLineDto[]',
    ...
    *  **参数解释：** 差异信息。 **取值范围：** 不涉及。
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\DiffNoLineDto[]|null
    */
    ...
    * Sets diffs
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\DiffNoLineDto[]|null $diffs **参数解释：** 差异信息。 **取值范围：** 不涉及。
    *
    * @return $this
    */
