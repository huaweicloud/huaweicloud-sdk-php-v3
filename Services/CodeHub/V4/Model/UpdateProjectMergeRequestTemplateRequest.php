...
class UpdateProjectMergeRequestTemplateRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'templateId' => 'int',
            'body' => '\HuaweiCloud\SDK\CodeHub\V4\Model\CreateMergeRequestTemplateDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\CreateMergeRequestTemplateDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\CreateMergeRequestTemplateDto|null $body body
    *
    * @return $this
    */
