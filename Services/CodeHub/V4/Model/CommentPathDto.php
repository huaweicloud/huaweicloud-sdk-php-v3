...
class CommentPathDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'new' => '\HuaweiCloud\SDK\CodeHub\V4\Model\LineDiscussionDto[]',
            'old' => '\HuaweiCloud\SDK\CodeHub\V4\Model\LineDiscussionDto[]',
            'path' => 'string'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\LineDiscussionDto[]|null
    */
    ...
    * Sets new
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\LineDiscussionDto[]|null $new **参数解释：** 位于文件对比结果右侧的检视意见集合。
    *
    * @return $this
    */
    ...
    * Sets old
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\LineDiscussionDto[]|null $old **参数解释：** 位于文件对比结果左侧的检视意见集合。
    *
    * @return $this
    */
