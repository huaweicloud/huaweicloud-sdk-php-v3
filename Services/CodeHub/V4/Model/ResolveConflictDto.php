...
class ResolveConflictDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'files' => '\HuaweiCloud\SDK\CodeHub\V4\Model\ResolveConflictFileDto[]'
    ];
    ...
    *  **参数解释：** 冲突的文件
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\ResolveConflictFileDto[]
    */
    ...
    * Sets files
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\ResolveConflictFileDto[] $files **参数解释：** 冲突的文件
    *
    * @return $this
    */
