...
class CreateDirRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'body' => '\HuaweiCloud\SDK\CodeHub\V4\Model\RepositoryDirDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\RepositoryDirDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\RepositoryDirDto|null $body body
    *
    * @return $this
    */
