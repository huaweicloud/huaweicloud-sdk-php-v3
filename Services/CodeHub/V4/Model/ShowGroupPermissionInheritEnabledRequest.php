...
class ShowGroupPermissionInheritEnabledRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowGroupPermissionInheritEnabledRequest';
