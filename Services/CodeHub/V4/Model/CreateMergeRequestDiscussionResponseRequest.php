...
class CreateMergeRequestDiscussionResponseRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'mergeRequestIid' => 'int',
            'discussionId' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeHub\V4\Model\ReplyMergeRequestNoteDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\ReplyMergeRequestNoteDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\ReplyMergeRequestNoteDto|null $body body
    *
    * @return $this
    */
