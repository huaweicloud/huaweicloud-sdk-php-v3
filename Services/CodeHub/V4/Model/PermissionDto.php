...
class PermissionDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'roleName' => 'string',
            'roleNameCn' => 'string',
            'resourcePermissions' => 'map[string,\HuaweiCloud\SDK\CodeHub\V4\Model\ResourcePermissionDto]'
    ];
    ...
    *  **参数解释：** 资源权限对象。
    *
    * @return map[string,\HuaweiCloud\SDK\CodeHub\V4\Model\ResourcePermissionDto]|null
    */
    ...
    *
    * @param map[string,\HuaweiCloud\SDK\CodeHub\V4\Model\ResourcePermissionDto]|null $resourcePermissions **参数解释：** 资源权限对象。
    *
    * @return $this
    */
