...
class UpdateFileRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'filePath' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeHub\V4\Model\UpdateFileBodyDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeHub\V4\Model\UpdateFileBodyDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeHub\V4\Model\UpdateFileBodyDto|null $body body
    *
    * @return $this
    */
