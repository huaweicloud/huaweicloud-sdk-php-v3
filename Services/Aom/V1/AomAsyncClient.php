...
class AomAsyncClient extends Client
{
     ...
     * @return response
     */
    public function createFastExecuteScriptAsync($request)
    {
        return $this->createFastExecuteScriptAsyncWithHttpInfo($request);
    }
    
    public function createFastExecuteScriptAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/{project_id}/cms/fast-execute-script';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
