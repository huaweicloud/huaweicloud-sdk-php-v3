...
class AomClient extends Client
{
    ...
    {
        $client = new ClientBuilder(new AomClient());
        return $client;
    }
    ...
    {
        return $this->createEnvWithHttpInfo($request);
    }

    public function createEnvWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function createSubApp($request)
    {
        return $this->createSubAppWithHttpInfo($request);
    }

    public function createSubAppWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function deleteEnv($request)
    {
        return $this->deleteEnvWithHttpInfo($request);
    }

    public function deleteEnvWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function deleteSubApp($request)
    {
        return $this->deleteSubAppWithHttpInfo($request);
    }

    public function deleteSubAppWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function listResourceUnderNode($request)
    {
        return $this->listResourceUnderNodeWithHttpInfo($request);
    }

    public function listResourceUnderNodeWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function showAppByName($request)
    {
        return $this->showAppByNameWithHttpInfo($request);
    }

    public function showAppByNameWithHttpInfo($request)
    {
        $resourcePath = '/v1/applications';
        $formParams = [];
        $queryParams = [];
     ...
     * @return response
     */
    public function showComponentByName($request)
    {
        return $this->showComponentByNameWithHttpInfo($request);
    }

    public function showComponentByNameWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function showEnv($request)
    {
        return $this->showEnvWithHttpInfo($request);
    }

    public function showEnvWithHttpInfo($request)
    {
        $resourcePath = '/v1/environments/{environment_id}';
        $formParams = [];
        $queryParams = [];
     ...
     * @return response
     */
    public function showEnvByName($request)
    {
        return $this->showEnvByNameWithHttpInfo($request);
    }

    public function showEnvByNameWithHttpInfo($request)
    {
    ...
    {
        return $this->updateComponentWithHttpInfo($request);
    }

    public function updateComponentWithHttpInfo($request)
    {
        $resourcePath = '/v1/components/{component_id}';
        $formParams = [];
        $queryParams = [];
    ...
    {
        return $this->updateEnvWithHttpInfo($request);
    }

    public function updateEnvWithHttpInfo($request)
    {
        $resourcePath = '/v1/environments/{environment_id}';
        $formParams = [];
        $queryParams = [];
     ...
     * @return response
     */
    public function updateSubApp($request)
    {
        return $this->updateSubAppWithHttpInfo($request);
    }

    public function updateSubAppWithHttpInfo($request)
    {
        $resourcePath = '/v1/sub-applications/{sub_app_id}';
        $formParams = [];
        $queryParams = [];
