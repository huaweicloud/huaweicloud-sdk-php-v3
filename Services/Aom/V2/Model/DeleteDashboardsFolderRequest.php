...
class DeleteDashboardsFolderRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteDashboardsFolderRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * folderId  仪表盘分组id。
    * enterpriseProjectId  企业项目id。获取方式请参见：[获取企业项目ID](aom_04_0024.xml)。  - 删除单个企业项目下实例，填写企业项目id。  - 不填时，默认删除企业项目id为0的企业项目下实例。
    * deleteAll  是否删除仪表盘分组下的仪表盘。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['deleteAll'] === null) {
            $invalidProperties[] = "'deleteAll' can't be null";
        }
    ...
    *
    * @param string|null $enterpriseProjectId 企业项目id。获取方式请参见：[获取企业项目ID](aom_04_0024.xml)。  - 删除单个企业项目下实例，填写企业项目id。  - 不填时，默认删除企业项目id为0的企业项目下实例。
    *
    * @return $this
    */
    ...
    * Sets deleteAll
    *
    * @param bool $deleteAll 是否删除仪表盘分组下的仪表盘。
    *
    * @return $this
    */
