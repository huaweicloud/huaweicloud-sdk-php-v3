...
class NotificationTemplate implements ModelInterface, ArrayAccess
{
    ...
    * Sets createTime
    *
    * @param int $createTime 消息通知模板创建时间。
    *
    * @return $this
    */
    ...
    *
    * @param string $enterpriseProjectId 消息通知模板所属企业项目id。
    *
    * @return $this
    */
    ...
    * Sets modifyTime
    *
    * @param int $modifyTime 消息通知模板修改时间。
    *
    * @return $this
    */
    ...
    * Sets projectId
    *
    * @param string $projectId 消息通知模板所属项目id。
    *
    * @return $this
    */
