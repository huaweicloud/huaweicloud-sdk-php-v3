...
class AddNotificationTemplate implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddNotificationTemplate';
    ...
    * source  消息通知模板类型： - 不填：表示指标或事件模板 - LTS：表示日志模板
    *
    * @var string[]
    */
    ...
    * Sets source
    *
    * @param string|null $source 消息通知模板类型： - 不填：表示指标或事件模板 - LTS：表示日志模板
    *
    * @return $this
    */
