...
class EventModel implements ModelInterface, ArrayAccess
{
    ...
    * Sets metadata
    *
    * @param object|null $metadata 事件或者告警的详细信息，为键值对形式。必须字段为： - event_name：事件或者告警名称,类型为String； - event_severity：事件级别枚举值。类型为String，四种类型 \"Critical\", \"Major\", \"Minor\", \"Info\"； - event_type：事件类别枚举值。类型为String，event为普通告警，alarm为告警事件； - resource_provider：事件对应云服务名称。类型为String； - resource_type：事件对应资源类型。类型为String； - resource_id：事件对应资源信息。类型为String。
    *
    * @return $this
    */
    ...
    * Sets annotations
    *
    * @param object|null $annotations 事件或者告警附加字段，可以为空。
    *
    * @return $this
    */
    ...
    * Sets attachRule
    *
    * @param object|null $attachRule 事件或者告警预留字段，为空。
    *
    * @return $this
    */
