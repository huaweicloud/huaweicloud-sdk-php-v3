...
class ListRelationFileResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRelationFileResponse';
    ...
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'currentPage' => 'int',
            'fileList' => '\HuaweiCloud\SDK\Dsc\V1\Model\RelationSimpleInfo[]'
    ];
    ...
    * Sets fileList
    *
    * @param \HuaweiCloud\SDK\Dsc\V1\Model\RelationSimpleInfo[]|null $fileList 关系信息列表
    *
    * @return $this
    */
