...
class ListRelationColumnResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRelationColumnResponse';
    ...
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'columnList' => '\HuaweiCloud\SDK\Dsc\V1\Model\RelationSimpleInfo[]'
    ];
    ...
    * Sets columnList
    *
    * @param \HuaweiCloud\SDK\Dsc\V1\Model\RelationSimpleInfo[]|null $columnList 关系信息列表
    *
    * @return $this
    */
