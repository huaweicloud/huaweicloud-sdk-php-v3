...
class ListUsersResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'startIndex' => 'string',
            'schemas' => 'string[]',
            'resources' => '\HuaweiCloud\SDK\IdentityCenterSCIM\V1\Model\GetUserResp[]'
    ];
    ...
    * Sets itemsPerPage
    *
    * @param string|null $itemsPerPage 每页的元素个数
    *
    * @return $this
    */
    ...
    *  包含用户信息的列表
    *
    * @return \HuaweiCloud\SDK\IdentityCenterSCIM\V1\Model\GetUserResp[]|null
    */
    ...
    * Sets resources
    *
    * @param \HuaweiCloud\SDK\IdentityCenterSCIM\V1\Model\GetUserResp[]|null $resources 包含用户信息的列表
    *
    * @return $this
    */
