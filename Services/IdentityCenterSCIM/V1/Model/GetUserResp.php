...
class GetUserResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GetUserResp';
    ...
    * Sets addresses
    *
    * @param \HuaweiCloud\SDK\IdentityCenterSCIM\V1\Model\AddressItemDto[]|null $addresses 用户的地址信息列表
    *
    * @return $this
    */
    ...
    * Sets phoneNumbers
    *
    * @param \HuaweiCloud\SDK\IdentityCenterSCIM\V1\Model\PhoneNumberItemDto[]|null $phoneNumbers 用户的电话号码信息列表
    *
    * @return $this
    */
