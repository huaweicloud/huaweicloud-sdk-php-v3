...
class BulkDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BulkDto';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * supported  一个布尔值，表示服务提供商是否支持这种操作
    * maxOperations  一次可操作的最大个数
    * maxPayloadSize  最大有效载荷量
    *
    * @var string[]
    */
    ...
    * Sets maxOperations
    *
    * @param int|null $maxOperations 一次可操作的最大个数
    *
    * @return $this
    */
    ...
    * Sets maxPayloadSize
    *
    * @param int|null $maxPayloadSize 最大有效载荷量
    *
    * @return $this
    */
