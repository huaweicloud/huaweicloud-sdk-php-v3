...
class CreateGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'tenantId' => 'string',
            'body' => '\HuaweiCloud\SDK\IdentityCenterSCIM\V1\Model\CreateGroupReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IdentityCenterSCIM\V1\Model\CreateGroupReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IdentityCenterSCIM\V1\Model\CreateGroupReqBody|null $body body
    *
    * @return $this
    */
