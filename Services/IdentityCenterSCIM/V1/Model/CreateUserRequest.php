...
class CreateUserRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'tenantId' => 'string',
            'body' => '\HuaweiCloud\SDK\IdentityCenterSCIM\V1\Model\CreateUserReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IdentityCenterSCIM\V1\Model\CreateUserReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IdentityCenterSCIM\V1\Model\CreateUserReqBody|null $body body
    *
    * @return $this
    */
