...
class IdentityCenterSCIMClient extends Client
{
    ...
    {
        $client = new ClientBuilder(new IdentityCenterSCIMClient(), "IdentityCenterSCIMCredentials");
        return $client;
    }
    ...
    {
        return $this->getGroupWithHttpInfo($request);
    }

    public function getGroupWithHttpInfo($request)
    {
        $resourcePath = '/{tenant_id}/scim/v2/Groups/{group_id}';
        $formParams = [];
        $queryParams = [];
     ...
     * @return response
     */
    public function patchGroup($request)
    {
        return $this->patchGroupWithHttpInfo($request);
    }

    public function patchGroupWithHttpInfo($request)
    {
        $resourcePath = '/{tenant_id}/scim/v2/Groups/{group_id}';
        $formParams = [];
        $queryParams = [];
     ...
     * @return response
     */
    public function serviceProviderConfig($request)
    {
        return $this->serviceProviderConfigWithHttpInfo($request);
    }

    public function serviceProviderConfigWithHttpInfo($request)
    {
    ...
    {
        return $this->getUserWithHttpInfo($request);
    }

    public function getUserWithHttpInfo($request)
    {
        $resourcePath = '/{tenant_id}/scim/v2/Users/{user_id}';
        $formParams = [];
        $queryParams = [];
     ...
     * @return response
     */
    public function patchUser($request)
    {
        return $this->patchUserWithHttpInfo($request);
    }

    public function patchUserWithHttpInfo($request)
    {
        $resourcePath = '/{tenant_id}/scim/v2/Users/{user_id}';
        $formParams = [];
        $queryParams = [];
    ...
    {
        return $this->putUserWithHttpInfo($request);
    }

    public function putUserWithHttpInfo($request)
    {
        $resourcePath = '/{tenant_id}/scim/v2/Users/{user_id}';
        $formParams = [];
        $queryParams = [];
