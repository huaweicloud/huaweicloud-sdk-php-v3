...
class ListClustersResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'clusters' => '\HuaweiCloud\SDK\IoTEdge\V3\Model\QueryClusterBriefResponseDTO[]'
    ];
    ...
    *  每页记录数
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V3\Model\QueryClusterBriefResponseDTO[]|null
    */
    ...
    * Sets clusters
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V3\Model\QueryClusterBriefResponseDTO[]|null $clusters 每页记录数
    *
    * @return $this
    */
