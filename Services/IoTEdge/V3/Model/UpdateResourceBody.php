...
class UpdateResourceBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateResourceBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * clusterId  需要更改绑定的集群id。
    * action  操作类型, 绑定:bind、解绑:unbind。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['action'] === null) {
            ...
            if (!preg_match("/bind|unbind/", $this->container['action'])) {
                $invalidProperties[] = "invalid value for 'action', must be conform to the pattern /bind|unbind/.";
            }
    ...
    * Sets clusterId
    *
    * @param string $clusterId 需要更改绑定的集群id。
    *
    * @return $this
    */
    ...
    * Sets action
    *
    * @param string $action 操作类型, 绑定:bind、解绑:unbind。
    *
    * @return $this
    */
