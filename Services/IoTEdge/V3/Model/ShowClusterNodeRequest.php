...
class ShowClusterNodeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowClusterNodeRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['nodeName'] === null) {
            ...
            if ((mb_strlen($this->container['nodeName']) < 1)) {
                $invalidProperties[] = "invalid value for 'nodeName', the character length must be bigger than or equal to 1.";
            }
            if (!preg_match("/^[a-z0-9]{1,32}-(master|worker)-[0-9]{4}$/", $this->container['nodeName'])) {
