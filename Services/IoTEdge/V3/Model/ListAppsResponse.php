...
class ListAppsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'apps' => '\HuaweiCloud\SDK\IoTEdge\V3\Model\QueryAppBriefResponseDTO[]'
    ];
    ...
    *  每页记录数
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V3\Model\QueryAppBriefResponseDTO[]|null
    */
    ...
    * Sets apps
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V3\Model\QueryAppBriefResponseDTO[]|null $apps 每页记录数
    *
    * @return $this
    */
