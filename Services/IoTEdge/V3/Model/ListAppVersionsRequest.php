...
class ListAppVersionsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAppVersionsRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['appId'] === null) {
            ...
            if (!is_null($this->container['version']) && !preg_match("/[0-9]{1,9}\\.[0-9]{1,9}\\.[0-9]{1,9}/", $this->container['version'])) {
    ...
    * Sets version
    *
    * @param string|null $version 应用版本号
    *
    * @return $this
    */
