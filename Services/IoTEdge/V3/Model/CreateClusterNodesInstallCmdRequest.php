...
class CreateClusterNodesInstallCmdRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateClusterNodesInstallCmdRequest';
    ...
    */
    protected static $openAPITypes = [
            'clusterId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTEdge\V3\Model\CreateNodesInstallCmdV3RequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V3\Model\CreateNodesInstallCmdV3RequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V3\Model\CreateNodesInstallCmdV3RequestBody|null $body body
    *
    * @return $this
    */
