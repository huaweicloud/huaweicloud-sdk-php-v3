...
class CreateAppVersionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAppVersionRequest';
    ...
    */
    protected static $openAPITypes = [
            'appId' => 'string',
            'version' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTEdge\V3\Model\CreateAppVersionRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V3\Model\CreateAppVersionRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V3\Model\CreateAppVersionRequestBody|null $body body
    *
    * @return $this
    */
