...
class CreateNodesInstallCmdV3RequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateNodesInstallCmdV3RequestBody';
    ...
    */
    protected static $openAPITypes = [
            'nodeInfo' => '\HuaweiCloud\SDK\IoTEdge\V3\Model\NodeConfig[]'
    ];
    ...
    * Sets nodeInfo
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V3\Model\NodeConfig[]|null $nodeInfo 集群节点名称列表
    *
    * @return $this
    */
