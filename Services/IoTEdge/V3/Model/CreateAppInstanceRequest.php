...
class CreateAppInstanceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAppInstanceRequest';
    ...
    */
    protected static $openAPITypes = [
            'clusterId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTEdge\V3\Model\CreateAppInstanceRequestDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V3\Model\CreateAppInstanceRequestDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V3\Model\CreateAppInstanceRequestDTO|null $body body
    *
    * @return $this
    */
