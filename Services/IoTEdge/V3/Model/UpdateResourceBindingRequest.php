...
class UpdateResourceBindingRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateResourceBindingRequest';
    ...
    */
    protected static $openAPITypes = [
            'resourceId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTEdge\V3\Model\UpdateResourceBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V3\Model\UpdateResourceBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V3\Model\UpdateResourceBody|null $body body
    *
    * @return $this
    */
