...
class AddDeviceRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'edgeNodeId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTEdge\V2\Model\AddDeviceRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V2\Model\AddDeviceRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V2\Model\AddDeviceRequestBody|null $body body
    *
    * @return $this
    */
