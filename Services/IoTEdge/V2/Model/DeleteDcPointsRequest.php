...
class DeleteDcPointsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteDcPointsRequest';
    ...
    */
    protected static $openAPITypes = [
            'edgeNodeId' => 'string',
            'dsId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTEdge\V2\Model\DeleteDcPointsReqDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V2\Model\DeleteDcPointsReqDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V2\Model\DeleteDcPointsReqDTO|null $body body
    *
    * @return $this
    */
