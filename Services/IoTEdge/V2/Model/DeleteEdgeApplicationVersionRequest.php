...
class DeleteEdgeApplicationVersionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteEdgeApplicationVersionRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * edgeAppId  应用版本,应用内版本唯一。
    * version  应用版本ID，应用版本唯一。
    *
    * @var string[]
    */
