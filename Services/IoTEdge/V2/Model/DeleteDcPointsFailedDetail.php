...
class DeleteDcPointsFailedDetail implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteDcPointsFailedDetail';
    ...
    * Sets errorCode
    *
    * @param string $errorCode 点位删除失败错误码
    *
    * @return $this
    */
    ...
    * Sets errorMsg
    *
    * @param string $errorMsg 点位删除失败错误详情
    *
    * @return $this
    */
