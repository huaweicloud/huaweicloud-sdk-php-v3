...
class UpdateExternalEntityRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateExternalEntityRequest';
    ...
    */
    protected static $openAPITypes = [
            'edgeNodeId' => 'string',
            'externalId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTEdge\V2\Model\UpdateExternalEntityReqDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V2\Model\UpdateExternalEntityReqDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V2\Model\UpdateExternalEntityReqDTO|null $body body
    *
    * @return $this
    */
