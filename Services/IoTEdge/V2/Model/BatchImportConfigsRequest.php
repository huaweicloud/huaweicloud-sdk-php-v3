...
class BatchImportConfigsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchImportConfigsRequest';
    ...
    */
    protected static $openAPITypes = [
            'nodeId' => 'string',
            'iaId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTEdge\V2\Model\BatchImportConfigsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V2\Model\BatchImportConfigsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V2\Model\BatchImportConfigsRequestBody|null $body body
    *
    * @return $this
    */
