...
class ExecuteDeviceControlsSetRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExecuteDeviceControlsSetRequest';
    ...
    */
    protected static $openAPITypes = [
            'edgeNodeId' => 'string',
            'deviceId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTEdge\V2\Model\DeviceControlSetReqDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V2\Model\DeviceControlSetReqDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V2\Model\DeviceControlSetReqDTO|null $body body
    *
    * @return $this
    */
