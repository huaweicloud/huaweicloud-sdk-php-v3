...
class ImportPointsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImportPointsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * edgeNodeId  边缘节点ID
    * dsId  采集数据源id，创建数据源配置时设置，节点下唯一。
    * updateType  该字段PARTIAL则增量覆盖，已有点位更新，新增点位插入;该字段为COMPLETE则全量覆盖，则删除数据源下所有点位，插入当前导入所有点位
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'dsId' => 'string',
            'updateType' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTEdge\V2\Model\ImportPointsRequestBody'
    ];
    ...
    */
    ...
    const UPDATE_TYPE_COMPLETE = 'COMPLETE';
    ...
    */
    ...
    {
        return [
            self::UPDATE_TYPE_PARTIAL,
            self::UPDATE_TYPE_COMPLETE,
        ];
    }
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['updateType'] === null) {
            $invalidProperties[] = "'updateType' can't be null";
        }
            ...
            if (!preg_match("/(PARTIAL|COMPLETE)/", $this->container['updateType'])) {
                $invalidProperties[] = "invalid value for 'updateType', must be conform to the pattern /(PARTIAL|COMPLETE)/.";
            }
    ...
    * Sets updateType
    *
    * @param string $updateType 该字段PARTIAL则增量覆盖，已有点位更新，新增点位插入;该字段为COMPLETE则全量覆盖，则删除数据源下所有点位，插入当前导入所有点位
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V2\Model\ImportPointsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V2\Model\ImportPointsRequestBody|null $body body
    *
    * @return $this
    */
