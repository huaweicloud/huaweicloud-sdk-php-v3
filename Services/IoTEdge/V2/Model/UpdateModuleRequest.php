...
class UpdateModuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateModuleRequest';
    ...
    */
    protected static $openAPITypes = [
            'edgeNodeId' => 'string',
            'moduleId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTEdge\V2\Model\UpdateEdgeModuleReqDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V2\Model\UpdateEdgeModuleReqDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V2\Model\UpdateEdgeModuleReqDTO|null $body body
    *
    * @return $this
    */
