...
class AssociateNodeRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateNodeRequestBody';
    ...
    * Sets nodeId
    *
    * @param string|null $nodeId 资源所关联节点ID
    *
    * @return $this
    */
