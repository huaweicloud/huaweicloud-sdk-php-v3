...
class DeviceIoTDBPushInfoDetail implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeviceIoTDBPushInfoDetail';
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['storageGroup']) && (mb_strlen($this->container['storageGroup']) > 32)) {
                $invalidProperties[] = "invalid value for 'storageGroup', the character length must be smaller than or equal to 32.";
            }
            if (!is_null($this->container['storageGroup']) && (mb_strlen($this->container['storageGroup']) < 1)) {
                $invalidProperties[] = "invalid value for 'storageGroup', the character length must be bigger than or equal to 1.";
            }
            if (!is_null($this->container['storageGroup']) && !preg_match("/^[a-zA-Z0-9_.-]*$/", $this->container['storageGroup'])) {
    ...
    * Sets storageGroup
    *
    * @param string|null $storageGroup 数据存储的存储组
    *
    * @return $this
    */
