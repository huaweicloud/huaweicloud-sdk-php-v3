...
class CreateDcPointRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateDcPointRequest';
    ...
    */
    protected static $openAPITypes = [
            'edgeNodeId' => 'string',
            'dsId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTEdge\V2\Model\CreateDcPointReqDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V2\Model\CreateDcPointReqDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V2\Model\CreateDcPointReqDTO|null $body body
    *
    * @return $this
    */
