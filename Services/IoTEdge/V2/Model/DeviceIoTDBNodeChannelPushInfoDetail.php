...
class DeviceIoTDBNodeChannelPushInfoDetail implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeviceIoTDBNodeChannelPushInfoDetail';
