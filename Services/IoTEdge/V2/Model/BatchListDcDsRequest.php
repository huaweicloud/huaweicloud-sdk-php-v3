...
class BatchListDcDsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchListDcDsRequest';
    ...
    * Sets moduleId
    *
    * @param string|null $moduleId 数据源所属的模块id
    *
    * @return $this
    */
