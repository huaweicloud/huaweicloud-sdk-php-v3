...
class BatchListDcDsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchListDcDsResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'datasources' => '\HuaweiCloud\SDK\IoTEdge\V2\Model\QueryDcDsBriefRespDTO[]'
    ];
    ...
    *  每页记录数
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V2\Model\QueryDcDsBriefRespDTO[]|null
    */
    ...
    * Sets datasources
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V2\Model\QueryDcDsBriefRespDTO[]|null $datasources 每页记录数
    *
    * @return $this
    */
