...
class BatchImportConfigRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchImportConfigRequestBody';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['id'] === null) {
            ...
            if (!preg_match("/(^[a-z0-9]([a-z0-9-])*[a-z0-9]$)|(^[a-z0-9]$)/", $this->container['id'])) {
                $invalidProperties[] = "invalid value for 'id', must be conform to the pattern /(^[a-z0-9]([a-z0-9-])*[a-z0-9]$)|(^[a-z0-9]$)/.";
            }
        ...
        if ($this->container['value'] === null) {
            ...
            if ((mb_strlen($this->container['value']) > 2097152)) {
                $invalidProperties[] = "invalid value for 'value', the character length must be smaller than or equal to 2097152.";
            }
    ...
    * Sets value
    *
    * @param string $value 配置项详情，长度2MB以内
    *
    * @return $this
    */
    ...
    * Sets description
    *
    * @param string|null $description 配置项描述
    *
    * @return $this
    */
