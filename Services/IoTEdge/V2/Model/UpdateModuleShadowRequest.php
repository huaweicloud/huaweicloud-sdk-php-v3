...
class UpdateModuleShadowRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateModuleShadowRequest';
    ...
    */
    protected static $openAPITypes = [
            'edgeNodeId' => 'string',
            'moduleId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTEdge\V2\Model\UpdateModuleShadowsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V2\Model\UpdateModuleShadowsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V2\Model\UpdateModuleShadowsRequestBody|null $body body
    *
    * @return $this
    */
