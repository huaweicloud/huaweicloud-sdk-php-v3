...
class UpdateIaConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateIaConfigRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'iaId' => 'string',
            'configId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTEdge\V2\Model\UpdateIaConfigRequestDTO'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['configId'] === null) {
            ...
            if ((mb_strlen($this->container['configId']) > 32)) {
                $invalidProperties[] = "invalid value for 'configId', the character length must be smaller than or equal to 32.";
            }
            if ((mb_strlen($this->container['configId']) < 1)) {
                $invalidProperties[] = "invalid value for 'configId', the character length must be bigger than or equal to 1.";
            }
            if (!preg_match("/(^[a-z0-9]([a-z0-9-])*[a-z0-9]$)|(^[a-z0-9]$)/", $this->container['configId'])) {
                $invalidProperties[] = "invalid value for 'configId', must be conform to the pattern /(^[a-z0-9]([a-z0-9-])*[a-z0-9]$)|(^[a-z0-9]$)/.";
            }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V2\Model\UpdateIaConfigRequestDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V2\Model\UpdateIaConfigRequestDTO|null $body body
    *
    * @return $this
    */
