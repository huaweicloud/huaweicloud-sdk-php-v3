...
class CreateClientNodeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateClientNodeRequest';
    ...
    */
    protected static $openAPITypes = [
            'channelId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTEdge\V2\Model\CreateClientNodeRequestDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V2\Model\CreateClientNodeRequestDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V2\Model\CreateClientNodeRequestDTO|null $body body
    *
    * @return $this
    */
