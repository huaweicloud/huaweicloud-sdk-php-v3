...
class BatchListDcPointsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchListDcPointsRequest';
    ...
    * Sets pointId
    *
    * @param string|null $pointId 采集点位表id，创建点位表时设置，数据源下唯一。
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string|null $name 点位名称，允许中、数字、英文大小写、下划线、中划线、#%()*特殊字符.模糊查询
    *
    * @return $this
    */
    ...
    * Sets property
    *
    * @param string|null $property 属性，允许中、数字、英文大小写、下划线、中划线，精确查询
    *
    * @return $this
    */
    ...
    * Sets deviceId
    *
    * @param string|null $deviceId 设备标识，精确查询
    *
    * @return $this
    */
