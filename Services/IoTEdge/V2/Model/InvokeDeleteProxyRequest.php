...
class InvokeDeleteProxyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'InvokeDeleteProxyRequest';
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['iaUri'] = isset($data['iaUri']) ? $data['iaUri'] : null;
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['iaUri'] === null) {
            $invalidProperties[] = "'iaUri' can't be null";
        }
            if ((mb_strlen($this->container['iaUri']) > 128)) {
                $invalidProperties[] = "invalid value for 'iaUri', the character length must be smaller than or equal to 128.";
            }
            if ((mb_strlen($this->container['iaUri']) < 1)) {
                $invalidProperties[] = "invalid value for 'iaUri', the character length must be bigger than or equal to 1.";
            }
    ...
    * @return string
    */
    public function getIaUri()
    {
        return $this->container['iaUri'];
    }
    ...
    * @return $this
    */
    public function setIaUri($iaUri)
    {
        $this->container['iaUri'] = $iaUri;
        return $this;
    }
