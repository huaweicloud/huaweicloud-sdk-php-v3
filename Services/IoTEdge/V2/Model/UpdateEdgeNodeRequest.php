...
class UpdateEdgeNodeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateEdgeNodeRequest';
    ...
    */
    protected static $openAPITypes = [
            'edgeNodeId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTEdge\V2\Model\UpdateNodeReqDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V2\Model\UpdateNodeReqDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V2\Model\UpdateNodeReqDTO|null $body body
    *
    * @return $this
    */
