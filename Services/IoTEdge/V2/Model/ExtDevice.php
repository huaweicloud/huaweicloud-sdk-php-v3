    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['destination'] === null) {
            ...
            if (!preg_match("/^\/[a-zA-Z_0-9-\/]{0,1024}$/", $this->container['destination'])) {
                $invalidProperties[] = "invalid value for 'destination', must be conform to the pattern /^\/[a-zA-Z_0-9-\/]{0,1024}$/.";
            }
