...
class ItMqttConnectionInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ItMqttConnectionInfo';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['password'] === null) {
            ...
            if (!preg_match("/^[a-zA-Z0-9~!@#%^&*()_+{}|<>?-]*$/", $this->container['password'])) {
