...
class ListPushChannelsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListPushChannelsResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'channels' => '\HuaweiCloud\SDK\IoTEdge\V2\Model\ChannelDTO[]'
    ];
    ...
    *  通道信息
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V2\Model\ChannelDTO[]|null
    */
    ...
    * Sets channels
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V2\Model\ChannelDTO[]|null $channels 通道信息
    *
    * @return $this
    */
