...
class BatchConfirmConfigsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchConfirmConfigsRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['action'] === null) {
            ...
            if (!preg_match("/(confirm)/", $this->container['action'])) {
                $invalidProperties[] = "invalid value for 'action', must be conform to the pattern /(confirm)/.";
            }
