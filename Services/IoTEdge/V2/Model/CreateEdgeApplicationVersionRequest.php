...
class CreateEdgeApplicationVersionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateEdgeApplicationVersionRequest';
    ...
    */
    protected static $openAPITypes = [
            'edgeAppId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTEdge\V2\Model\CreateEdgeApplicationVersionDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V2\Model\CreateEdgeApplicationVersionDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V2\Model\CreateEdgeApplicationVersionDTO|null $body body
    *
    * @return $this
    */
