...
class ExecuteDeviceControlsReleaseRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExecuteDeviceControlsReleaseRequest';
    ...
    */
    protected static $openAPITypes = [
            'edgeNodeId' => 'string',
            'deviceId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTEdge\V2\Model\DeviceControlReleaseReqDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V2\Model\DeviceControlReleaseReqDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V2\Model\DeviceControlReleaseReqDTO|null $body body
    *
    * @return $this
    */
