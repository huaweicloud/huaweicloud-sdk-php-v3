...
class BatchListModulesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchListModulesResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'modules' => '\HuaweiCloud\SDK\IoTEdge\V2\Model\EdgeModuleDTO[]'
    ];
    ...
    *  每页记录数
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V2\Model\EdgeModuleDTO[]|null
    */
    ...
    * Sets modules
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V2\Model\EdgeModuleDTO[]|null $modules 每页记录数
    *
    * @return $this
    */
