...
class UpdateEdgeApplicationVersionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateEdgeApplicationVersionRequest';
    ...
    */
    protected static $openAPITypes = [
            'edgeAppId' => 'string',
            'version' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTEdge\V2\Model\UpdateEdgeAppVersionDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V2\Model\UpdateEdgeAppVersionDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V2\Model\UpdateEdgeAppVersionDTO|null $body body
    *
    * @return $this
    */
