...
class CreateReinstallCmdRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateReinstallCmdRequest';
    ...
    */
    protected static $openAPITypes = [
            'edgeNodeId' => 'string',
            'enableTpm' => 'bool',
            'body' => '\HuaweiCloud\SDK\IoTEdge\V2\Model\CreateReinstallCmdRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V2\Model\CreateReinstallCmdRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V2\Model\CreateReinstallCmdRequestBody|null $body body
    *
    * @return $this
    */
