...
class PulsarConnectionInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PulsarConnectionInfo';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['token'] === null) {
            ...
            if (!preg_match("/^[a-zA-Z0-9;._=-]*$/", $this->container['token'])) {
