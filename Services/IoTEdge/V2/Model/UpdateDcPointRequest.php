...
class UpdateDcPointRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDcPointRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'dsId' => 'string',
            'pointId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTEdge\V2\Model\UpdateDcPointReqDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V2\Model\UpdateDcPointReqDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V2\Model\UpdateDcPointReqDTO|null $body body
    *
    * @return $this
    */
