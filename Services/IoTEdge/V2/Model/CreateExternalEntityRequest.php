...
class CreateExternalEntityRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateExternalEntityRequest';
    ...
    */
    protected static $openAPITypes = [
            'edgeNodeId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTEdge\V2\Model\CreateExternalEntityReqDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V2\Model\CreateExternalEntityReqDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V2\Model\CreateExternalEntityReqDTO|null $body body
    *
    * @return $this
    */
