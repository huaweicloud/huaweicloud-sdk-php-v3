...
class BatchListEdgeAppVersionsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchListEdgeAppVersionsResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'versions' => '\HuaweiCloud\SDK\IoTEdge\V2\Model\QueryEdgeAppVersionBriefResponseDTO[]'
    ];
    ...
    *  每页记录数
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V2\Model\QueryEdgeAppVersionBriefResponseDTO[]|null
    */
    ...
    * Sets versions
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V2\Model\QueryEdgeAppVersionBriefResponseDTO[]|null $versions 每页记录数
    *
    * @return $this
    */
