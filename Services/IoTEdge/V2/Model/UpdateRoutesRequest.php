...
class UpdateRoutesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateRoutesRequest';
    ...
    */
    protected static $openAPITypes = [
            'edgeNodeId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTEdge\V2\Model\CreateRouterReqDTO[]'
    ];
    ...
    *  创建路由请求结构体
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V2\Model\CreateRouterReqDTO[]|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V2\Model\CreateRouterReqDTO[]|null $body 创建路由请求结构体
    *
    * @return $this
    */
