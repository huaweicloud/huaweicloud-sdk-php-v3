...
class AddAppConfigsTemplatesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddAppConfigsTemplatesResponse';
    ...
    * Sets configTabs
    *
    * @param object|null $configTabs 配置项数据
    *
    * @return $this
    */
    ...
    * Sets defaultValues
    *
    * @param object|null $defaultValues 默认数据
    *
    * @return $this
    */
