...
class QueryDcDsBriefRespDTO implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'QueryDcDsBriefRespDTO';
    ...
    * Sets moduleState
    *
    * @param string|null $moduleState 数采连接状态,RUNNING|STOPPED
    *
    * @return $this
    */
