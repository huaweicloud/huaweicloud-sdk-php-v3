...
class UpdateRoutesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateRoutesResponse';
    ...
    */
    protected static $openAPITypes = [
            'routes' => '\HuaweiCloud\SDK\IoTEdge\V2\Model\RouterRespDTO[]',
            'updateTime' => 'string'
    ];
    ...
    *  路由列表
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V2\Model\RouterRespDTO[]|null
    */
    ...
    * Sets routes
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V2\Model\RouterRespDTO[]|null $routes 路由列表
    *
    * @return $this
    */
