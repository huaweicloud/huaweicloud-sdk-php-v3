...
class DeviceMqttPushInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeviceMqttPushInfo';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['topic'] === null) {
            ...
            if (!preg_match("/^[a-zA-Z0-9_$\/-]*$/", $this->container['topic'])) {
    ...
    * Sets topic
    *
    * @param string $topic client推送的topic
    *
    * @return $this
    */
