...
class CreateModuleRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'edgeNodeId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTEdge\V2\Model\CreateEdgeModuleReqDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V2\Model\CreateEdgeModuleReqDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V2\Model\CreateEdgeModuleReqDTO|null $body body
    *
    * @return $this
    */
