...
class UpdateModuleStateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateModuleStateRequest';
    ...
    */
    protected static $openAPITypes = [
            'edgeNodeId' => 'string',
            'moduleId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTEdge\V2\Model\UpdateEdgeModuleStateReqDTO'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['moduleId'] === null) {
            ...
            if (!preg_match("/^[A-Za-z0-9-_]*$/", $this->container['moduleId'])) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTEdge\V2\Model\UpdateEdgeModuleStateReqDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTEdge\V2\Model\UpdateEdgeModuleStateReqDTO|null $body body
    *
    * @return $this
    */
