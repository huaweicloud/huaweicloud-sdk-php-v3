...
class WorkloadQueueUserReq implements ModelInterface, ArrayAccess
{
    ...
    * userList  **参数解释**： 资源池用户列表。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets userList
    *
    * @param \HuaweiCloud\SDK\Dws\V2\Model\WorkloadQueueUserReqUserList[] $userList **参数解释**： 资源池用户列表。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
