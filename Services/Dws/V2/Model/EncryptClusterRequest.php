...
class EncryptClusterRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'EncryptClusterRequest';
    ...
    */
    protected static $openAPITypes = [
            'clusterId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dws\V2\Model\EncryptClusterReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dws\V2\Model\EncryptClusterReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dws\V2\Model\EncryptClusterReq|null $body body
    *
    * @return $this
    */
