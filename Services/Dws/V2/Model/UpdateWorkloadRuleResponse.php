...
class UpdateWorkloadRuleResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateWorkloadRuleResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * workloadResCode  **参数解释**： 错误码，0表示成功。 **取值范围**： 不涉及。
    * workloadResStr  **参数解释**： 错误信息，成功时为空。 **取值范围**： 不涉及。
    *
    * @var string[]
    */
    ...
    *
    * @param int|null $workloadResCode **参数解释**： 错误码，0表示成功。 **取值范围**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets workloadResStr
    *
    * @param string|null $workloadResStr **参数解释**： 错误信息，成功时为空。 **取值范围**： 不涉及。
    *
    * @return $this
    */
