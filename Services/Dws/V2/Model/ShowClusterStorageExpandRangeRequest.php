...
class ShowClusterStorageExpandRangeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowClusterStorageExpandRangeRequest';
