...
class ListMonitorIndicatorDataRequest implements ModelInterface, ArrayAccess
{
    ...
    * indicatorName  **参数解释**： 指标名称。查询性能监控指标接口返回值中的indicator_name。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    * dim0  **参数解释**： 第一层级。根据indicator_name传入不同参数，详见请求示例。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    * dim1  **参数解释**： 第二层级。根据indicator_name传入不同参数，详见请求示例。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets dim1
    *
    * @param string|null $dim1 **参数解释**： 第二层级。根据indicator_name传入不同参数，详见请求示例。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
