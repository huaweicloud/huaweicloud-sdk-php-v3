...
class UserAuthorityReq implements ModelInterface, ArrayAccess
{
    ...
    * grantMembers  **参数解释**： 授权对象信息。 **约束限制**： 不涉及。 **取值范围**： 列表项最大值为100。 **默认取值**： 不涉及。
    * grantList  **参数解释**： 授权列表。 **约束限制**： 不涉及。 **取值范围**： 列表项最大值为2000。 **默认取值**： 不涉及。
    ...
    * Sets grantMembers
    *
    * @param string[]|null $grantMembers **参数解释**： 授权对象信息。 **约束限制**： 不涉及。 **取值范围**： 列表项最大值为100。 **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets grantList
    *
    * @param \HuaweiCloud\SDK\Dws\V2\Model\GrantAuthority[]|null $grantList **参数解释**： 授权列表。 **约束限制**： 不涉及。 **取值范围**： 列表项最大值为2000。 **默认取值**： 不涉及。
    *
    * @return $this
    */
