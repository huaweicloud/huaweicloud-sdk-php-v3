...
class PrivateEndpointResponse implements ModelInterface, ArrayAccess
{
    ...
    * domainNameStatus  **参数解释**： 内网域名状态。 **取值范围**： 不涉及。
    * elbIp  **参数解释**： ELB的内网IP信息。 **取值范围**： 不涉及。
    * bindManageIpStatus  **参数解释**： IP绑定状态。 **取值范围**： 不涉及。
    *
    * @var string[]
    */
    ...
    *
    * @param string|null $domainNameStatus **参数解释**： 内网域名状态。 **取值范围**： 不涉及。
    *
    * @return $this
    */
    ...
    *
    * @param int|null $bindManageIpStatus **参数解释**： IP绑定状态。 **取值范围**： 不涉及。
    *
    * @return $this
    */
