...
class UpdateLogicalClusterPlanRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateLogicalClusterPlanRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * clusterId  **参数解释**： 集群ID。获取方式方法请参见[获取集群ID](dws_02_00068.xml)。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    * planId  **参数解释**： 逻辑集群增删计划ID。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'clusterId' => 'string',
            'planId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dws\V2\Model\UpdateLogicalClusterPlanBo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dws\V2\Model\UpdateLogicalClusterPlanBo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dws\V2\Model\UpdateLogicalClusterPlanBo|null $body body
    *
    * @return $this
    */
