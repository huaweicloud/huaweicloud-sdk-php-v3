...
class ListElbsInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListElbsInfoRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * vpcId  **参数解释**： 虚拟私有云ID。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    ...
    * Sets vpcId
    *
    * @param string|null $vpcId **参数解释**： 虚拟私有云ID。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
