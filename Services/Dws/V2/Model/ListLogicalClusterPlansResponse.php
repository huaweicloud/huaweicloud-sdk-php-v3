...
class ListLogicalClusterPlansResponse implements ModelInterface, ArrayAccess
{
    ...
    * plans  **参数解释**： 逻辑集群增删计划对象列表。列表最大返回一般不超过20条。 **取值范围**： 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets plans
    *
    * @param \HuaweiCloud\SDK\Dws\V2\Model\LogicalClusterPlanVo[]|null $plans **参数解释**： 逻辑集群增删计划对象列表。列表最大返回一般不超过20条。 **取值范围**： 不涉及。
    *
    * @return $this
    */
