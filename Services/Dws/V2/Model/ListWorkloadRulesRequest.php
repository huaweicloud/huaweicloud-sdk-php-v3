...
class ListWorkloadRulesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListWorkloadRulesRequest';
    ...
    * limit  **参数解释**： 分页单页大小。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 10
    * ruleName  **参数解释**： 分页单页大小。 **约束限制**： 异常规则名称。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    * queueName  **参数解释**： 资源池名称。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['clusterId'] === null) {
            ...
            if (!is_null($this->container['queueName']) && (mb_strlen($this->container['queueName']) > 64)) {
                $invalidProperties[] = "invalid value for 'queueName', the character length must be smaller than or equal to 64.";
            }
    ...
    * Sets limit
    *
    * @param int|null $limit **参数解释**： 分页单页大小。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 10
    *
    * @return $this
    */
    ...
    * Sets ruleName
    *
    * @param string|null $ruleName **参数解释**： 分页单页大小。 **约束限制**： 异常规则名称。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets queueName
    *
    * @param string|null $queueName **参数解释**： 资源池名称。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
