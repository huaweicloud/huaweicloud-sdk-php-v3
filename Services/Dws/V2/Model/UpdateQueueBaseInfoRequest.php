...
class UpdateQueueBaseInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateQueueBaseInfoRequest';
    ...
    */
    protected static $openAPITypes = [
            'clusterId' => 'string',
            'queueName' => 'string',
            'body' => '\HuaweiCloud\SDK\Dws\V2\Model\UpdateWorkloadQueueReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dws\V2\Model\UpdateWorkloadQueueReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dws\V2\Model\UpdateWorkloadQueueReq|null $body body
    *
    * @return $this
    */
