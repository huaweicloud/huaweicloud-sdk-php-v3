...
class ListTargetFlavorsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTargetFlavorsResponse';
    ...
    * Sets count
    *
    * @param int|null $count **参数解释**： 规格数量。 **取值范围**： 不涉及。
    *
    * @return $this
    */
