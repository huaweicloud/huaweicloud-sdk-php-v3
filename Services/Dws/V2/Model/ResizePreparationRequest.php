...
class ResizePreparationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResizePreparationRequest';
    ...
    */
    protected static $openAPITypes = [
            'clusterId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dws\V2\Model\ExpandPreparationRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dws\V2\Model\ExpandPreparationRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dws\V2\Model\ExpandPreparationRequestBody|null $body body
    *
    * @return $this
    */
