...
class ListTagsForResourceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTagsForResourceRequest';
    ...
    * limit  **参数解释**： 分页大小，默认10。 **约束限制**： 不涉及。 **取值范围**： 有效值大于等于1。 **默认取值**： 10
    *
    * @var string[]
    */
    ...
    * Sets limit
    *
    * @param int|null $limit **参数解释**： 分页大小，默认10。 **约束限制**： 不涉及。 **取值范围**： 有效值大于等于1。 **默认取值**： 10
    *
    * @return $this
    */
