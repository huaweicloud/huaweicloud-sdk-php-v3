...
class ClusterDetail implements ModelInterface, ArrayAccess
{
    ...
    * status  **参数解释**： 集群状态。 **取值范围**： - CREATING：创建中 - AVAILABLE：可用 - FAILED：不可用 - CREATE_FAILED：创建失败 - DELETING：删除中 - DELETE_FAILED：删除失败 - DELETED：已删除 - FROZEN：普通冻结 - POLICE_FROZEN：公安冻结
    ...
    * nodeType  **参数解释**： 集群规格名称。 **取值范围**： 集群规格详情请参见[数据仓库规格](https://support.huaweicloud.com/productdesc-dws/dws_01_00018.html)。
    ...
    * Sets status
    *
    * @param string $status **参数解释**： 集群状态。 **取值范围**： - CREATING：创建中 - AVAILABLE：可用 - FAILED：不可用 - CREATE_FAILED：创建失败 - DELETING：删除中 - DELETE_FAILED：删除失败 - DELETED：已删除 - FROZEN：普通冻结 - POLICE_FROZEN：公安冻结
    *
    * @return $this
    */
    ...
    * Sets nodeType
    *
    * @param string $nodeType **参数解释**： 集群规格名称。 **取值范围**： 集群规格详情请参见[数据仓库规格](https://support.huaweicloud.com/productdesc-dws/dws_01_00018.html)。
    *
    * @return $this
    */
