...
class ClusterNodeInfo implements ModelInterface, ArrayAccess
{
    ...
    * status  **参数解释**： 节点状态。 **取值范围**： - CREATING：创建中。 - FREE：空闲。 - ACTIVE：正常。 - FAILED：不可用。 - CREATE_FAILED：创建失败。 - DELETING：删除中。 - FROZEN：冻结。 - STOPPED：关机。
    * subStatus  **参数解释**： 节点子状态。 **取值范围**： - READY：ECS已就绪。 - PREPARED：软件已部署。 - INITED：节点已正常。 - CREATED：节点已监控。
    ...
    * Sets status
    *
    * @param string|null $status **参数解释**： 节点状态。 **取值范围**： - CREATING：创建中。 - FREE：空闲。 - ACTIVE：正常。 - FAILED：不可用。 - CREATE_FAILED：创建失败。 - DELETING：删除中。 - FROZEN：冻结。 - STOPPED：关机。
    *
    * @return $this
    */
    ...
    * Sets subStatus
    *
    * @param string|null $subStatus **参数解释**： 节点子状态。 **取值范围**： - READY：ECS已就绪。 - PREPARED：软件已部署。 - INITED：节点已正常。 - CREATED：节点已监控。
    *
    * @return $this
    */
