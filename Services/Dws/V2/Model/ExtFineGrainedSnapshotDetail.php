...
class ExtFineGrainedSnapshotDetail implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExtFineGrainedSnapshotDetail';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * database  **参数解释**： 数据库名称。 **取值范围**： 不涉及。
    * schemaList  **参数解释**： 数据库模式列表。 **取值范围**： 不涉及。
    * tableList  **参数解释**： 数据库表列表。 **取值范围**： 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets schemaList
    *
    * @param string[]|null $schemaList **参数解释**： 数据库模式列表。 **取值范围**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets tableList
    *
    * @param string[]|null $tableList **参数解释**： 数据库表列表。 **取值范围**： 不涉及。
    *
    * @return $this
    */
