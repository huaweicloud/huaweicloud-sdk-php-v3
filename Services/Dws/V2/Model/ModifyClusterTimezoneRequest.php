...
class ModifyClusterTimezoneRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ModifyClusterTimezoneRequest';
    ...
    */
    protected static $openAPITypes = [
            'clusterId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dws\V2\Model\ClusterTimezoneReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dws\V2\Model\ClusterTimezoneReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dws\V2\Model\ClusterTimezoneReq|null $body body
    *
    * @return $this
    */
