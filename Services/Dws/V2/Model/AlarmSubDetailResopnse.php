...
class AlarmSubDetailResopnse implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AlarmSubDetailResopnse';
    ...
    * Sets id
    *
    * @param string $id **参数解释**：  告警配置ID。  **取值范围**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets alarmId
    *
    * @param string $alarmId **参数解释**：  告警定义ID。  **取值范围**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets alarmName
    *
    * @param string $alarmName **参数解释**：  告警名称。  **取值范围**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets nameSpace
    *
    * @param string $nameSpace **参数解释**：  所属服务。  **取值范围**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets alarmLevel
    *
    * @param string $alarmLevel **参数解释**：  告警级别。  **取值范围**：  不涉及。
    *
    * @return $this
    */
