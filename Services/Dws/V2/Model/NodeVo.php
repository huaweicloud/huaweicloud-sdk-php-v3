...
class NodeVo implements ModelInterface, ArrayAccess
{
    ...
    * id  **参数解释**： 节点实例ID。 **取值范围**： 不涉及。
    * name  **参数解释**： 节点实例名称。 **取值范围**： 不涉及。
    * status  **参数解释**： 节点状态。 **取值范围**： - ACTIVE：正常。 - FAILED：不可用。
    * instType  **参数解释**： 节点类型。 **取值范围**： - cn：协调节点。 - dn：数据节点。
    *
    * @var string[]
    */
    ...
    * Sets id
    *
    * @param string|null $id **参数解释**： 节点实例ID。 **取值范围**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string|null $name **参数解释**： 节点实例名称。 **取值范围**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets status
    *
    * @param string|null $status **参数解释**： 节点状态。 **取值范围**： - ACTIVE：正常。 - FAILED：不可用。
    *
    * @return $this
    */
    ...
    * Sets instType
    *
    * @param string|null $instType **参数解释**： 节点类型。 **取值范围**： - cn：协调节点。 - dn：数据节点。
    *
    * @return $this
    */
