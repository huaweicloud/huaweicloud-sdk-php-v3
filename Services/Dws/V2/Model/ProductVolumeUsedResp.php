...
class ProductVolumeUsedResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ProductVolumeUsedResp';
    ...
    * Sets volumeNum
    *
    * @param int|null $volumeNum **参数解释**： 节点使用的磁盘数量信息。 **取值范围**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets capacity
    *
    * @param int|null $capacity **参数解释**： 集群单节点的可用存储容量。 **取值范围**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets volumeSize
    *
    * @param int|null $volumeSize **参数解释**： 集群节点上单数据磁盘的物理存储容量。 **取值范围**： 不涉及。
    *
    * @return $this
    */
