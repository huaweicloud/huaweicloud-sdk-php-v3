...
class ListElbsInfoResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListElbsInfoResponse';
    ...
    * Sets elbs
    *
    * @param \HuaweiCloud\SDK\Dws\V2\Model\ClusterElbInfo[]|null $elbs **参数解释**： 弹性负载均衡列表。 **取值范围**： 不涉及。
    *
    * @return $this
    */
