...
class ListOperationalTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListOperationalTaskRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * clusterId  **参数解释**： 集群ID。获取方法请参见[获取集群ID](dws_02_00068.xml)。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    * timeZone  **参数解释**： 时区偏移量，默认为UTC时间（0偏移），即+0000。 **约束限制**： 不涉及。 **取值范围**： -2359~+2359 **默认取值**： +0000
    * type  **参数解释**： 任务类型。 **约束限制**： 仅支持两种值。 **取值范围**： Date：单次型任务； Window：周期型任务； **默认取值**： 无。
    ...
    * Sets timeZone
    *
    * @param string|null $timeZone **参数解释**： 时区偏移量，默认为UTC时间（0偏移），即+0000。 **约束限制**： 不涉及。 **取值范围**： -2359~+2359 **默认取值**： +0000
    *
    * @return $this
    */
    ...
    * Sets type
    *
    * @param string|null $type **参数解释**： 任务类型。 **约束限制**： 仅支持两种值。 **取值范围**： Date：单次型任务； Window：周期型任务； **默认取值**： 无。
    *
    * @return $this
    */
