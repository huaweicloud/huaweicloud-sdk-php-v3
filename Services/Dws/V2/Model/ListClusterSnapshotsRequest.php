...
class ListClusterSnapshotsRequest implements ModelInterface, ArrayAccess
{
    ...
    * sortDir  **参数解释**： 排序规则。 **约束限制**： 不涉及。 **取值范围**： asc：升序。 desc：降序。 **默认取值**： 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets limit
    *
    * @param int|null $limit **参数解释**： 分页单页大小。 **约束限制**： 不涉及。 **取值范围**： 大于0。 **默认取值**： 不限制。
    *
    * @return $this
    */
    ...
    * Sets sortDir
    *
    * @param string|null $sortDir **参数解释**： 排序规则。 **约束限制**： 不涉及。 **取值范围**： asc：升序。 desc：降序。 **默认取值**： 不涉及。
    *
    * @return $this
    */
