...
class UpdateInstanceBandwidthAutoScalingPolicyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateInstanceBandwidthAutoScalingPolicyResponse';
