...
class CreateInstanceBody implements ModelInterface, ArrayAccess
{
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['publicipId'] = isset($data['publicipId']) ? $data['publicipId'] : 'false';
        ...
        $this->container['instanceNum'] = isset($data['instanceNum']) ? $data['instanceNum'] : 1;
        ...
        $this->container['noPasswordAccess'] = isset($data['noPasswordAccess']) ? $data['noPasswordAccess'] : false;
