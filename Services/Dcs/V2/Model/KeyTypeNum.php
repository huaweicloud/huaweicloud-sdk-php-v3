...
class KeyTypeNum implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'KeyTypeNum';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * type  **参数解释**： Key的数据类型。 **取值范围**： string list set zset hash
    * num  **参数解释**： Key类型的总数量。 **取值范围**： 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets num
    *
    * @param int|null $num **参数解释**： Key类型的总数量。 **取值范围**： 不涉及。
    *
    * @return $this
    */
