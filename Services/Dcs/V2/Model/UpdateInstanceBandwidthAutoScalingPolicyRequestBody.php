...
class UpdateInstanceBandwidthAutoScalingPolicyRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateInstanceBandwidthAutoScalingPolicyRequestBody';
