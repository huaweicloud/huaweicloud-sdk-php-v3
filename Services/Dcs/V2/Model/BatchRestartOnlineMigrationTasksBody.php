...
class BatchRestartOnlineMigrationTasksBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchRestartOnlineMigrationTasksBody';
