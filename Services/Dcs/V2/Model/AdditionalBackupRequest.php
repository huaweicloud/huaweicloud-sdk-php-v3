...
class AdditionalBackupRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AdditionalBackupRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * isAdditionalBackup  是否高级备份
    * nodeId  节点ID
    *
    * @var string[]
    */
    ...
    *
    * @param bool|null $isAdditionalBackup 是否高级备份
    *
    * @return $this
    */
