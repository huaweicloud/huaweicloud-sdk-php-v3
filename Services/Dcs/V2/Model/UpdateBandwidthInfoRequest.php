...
class UpdateBandwidthInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateBandwidthInfoRequest';
    ...
    */
    protected static $openAPITypes = [
            'groupBandwidths' => '\HuaweiCloud\SDK\Dcs\V2\Model\UpdateGroupBandwidthInfoRequest[]'
    ];
    ...
    *  分片带宽列表。
    *
    * @return \HuaweiCloud\SDK\Dcs\V2\Model\UpdateGroupBandwidthInfoRequest[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Dcs\V2\Model\UpdateGroupBandwidthInfoRequest[]|null $groupBandwidths 分片带宽列表。
    *
    * @return $this
    */
