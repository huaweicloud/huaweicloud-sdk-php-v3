...
class ImageInfo implements ModelInterface, ArrayAccess
{
    ...
    * id  镜像ID，格式为UUID。
    * name  镜像的名称
    * osType  镜像的类型。取值为：Linux（包括SUSE/RedHat/CentOS/Oracle Linux/EulerOS/Ubuntu操作系统）Windows（Windows操作系统）Other（ESXi操作系统）
    * links  镜像相关快捷链接地址。
    *
    * @var string[]
    */
    ...
    * Sets osType
    *
    * @param string|null $osType 镜像的类型。取值为：Linux（包括SUSE/RedHat/CentOS/Oracle Linux/EulerOS/Ubuntu操作系统）Windows（Windows操作系统）Other（ESXi操作系统）
    *
    * @return $this
    */
    ...
    * Sets links
    *
    * @param \HuaweiCloud\SDK\Bms\V1\Model\Links[]|null $links 镜像相关快捷链接地址。
    *
    * @return $this
    */
