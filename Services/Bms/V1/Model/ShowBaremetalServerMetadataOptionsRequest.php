...
class ShowBaremetalServerMetadataOptionsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowBaremetalServerMetadataOptionsRequest';
