...
class FlavorDetailInfos implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'FlavorDetailInfos';
    ...
    * Sets disk
    *
    * @param int|null $disk 该裸金属服务器规格对应要求系统盘大小，0为不限制。
    *
    * @return $this
    */
    ...
    * Sets vcpus
    *
    * @param int|null $vcpus 该裸金属服务器规格对应的CPU核数
    *
    * @return $this
    */
