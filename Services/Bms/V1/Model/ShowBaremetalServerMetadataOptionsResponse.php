...
class ShowBaremetalServerMetadataOptionsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowBaremetalServerMetadataOptionsResponse';
