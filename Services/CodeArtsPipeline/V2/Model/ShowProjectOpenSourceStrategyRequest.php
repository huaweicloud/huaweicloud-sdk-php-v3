...
class ShowProjectOpenSourceStrategyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowProjectOpenSourceStrategyRequest';
