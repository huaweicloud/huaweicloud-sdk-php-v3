...
class PageInfoBusinessTypeDefinitionVOAllSteps implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PageInfoBusinessTypeDefinitionVO_all_steps';
