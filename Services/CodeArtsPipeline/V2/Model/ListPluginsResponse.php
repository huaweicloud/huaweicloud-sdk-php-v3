...
class ListPluginsResponse implements ModelInterface, ArrayAccess
{
    ...
    * limit  **参数解释**： 每次查询的条目数量。 **约束限制**： 不涉及。 **取值范围**： 大于等于0。 **默认取值**： 不涉及。
    * total  **参数解释**： 总条目数量。 **取值范围**： 大于等于0。
    * data  **参数解释**： 扩展插件列表。 **取值范围**： 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets limit
    *
    * @param int|null $limit **参数解释**： 每次查询的条目数量。 **约束限制**： 不涉及。 **取值范围**： 大于等于0。 **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\CodeArtsPipeline\V2\Model\PluginBasicVO[]|null $data **参数解释**： 扩展插件列表。 **取值范围**： 不涉及。
    *
    * @return $this
    */
