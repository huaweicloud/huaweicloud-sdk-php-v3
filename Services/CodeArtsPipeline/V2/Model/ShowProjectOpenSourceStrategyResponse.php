...
class ShowProjectOpenSourceStrategyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowProjectOpenSourceStrategyResponse';
