...
class LicensePropertyRules implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'LicenseProperty_rules';
    ...
    * Sets values
    *
    * @param string[]|null $values license详情
    *
    * @return $this
    */
