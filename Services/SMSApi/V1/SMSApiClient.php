...
class SMSApiClient extends Client
{
    ...
    {
        $client = new ClientBuilder(new SMSApiClient(), "SMSApiCredentials");
        return $client;
    }
     ...
     * @return response
     */
    public function batchSendDiffSms($request)
    {
        return $this->batchSendDiffSmsWithHttpInfo($request);
    }

    public function batchSendDiffSmsWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function batchSendSms($request)
    {
        return $this->batchSendSmsWithHttpInfo($request);
    }

    public function batchSendSmsWithHttpInfo($request)
    {
