...
class ListBranchesByRepositoryIdRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListBranchesByRepositoryIdRequest';
