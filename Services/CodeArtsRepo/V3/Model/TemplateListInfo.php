...
class TemplateListInfo implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'repos' => '\HuaweiCloud\SDK\CodeArtsRepo\V3\Model\DevstarRepoInfo[]',
            'totalCount' => 'int'
    ];
    ...
    *  仓库列表
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V3\Model\DevstarRepoInfo[]|null
    */
    ...
    * Sets repos
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V3\Model\DevstarRepoInfo[]|null $repos 仓库列表
    *
    * @return $this
    */
