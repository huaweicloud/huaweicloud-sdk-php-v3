...
class CreateCommitRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'repoId' => 'int',
            'body' => '\HuaweiCloud\SDK\CodeArtsRepo\V3\Model\CreateCommitRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V3\Model\CreateCommitRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V3\Model\CreateCommitRequestBody|null $body body
    *
    * @return $this
    */
