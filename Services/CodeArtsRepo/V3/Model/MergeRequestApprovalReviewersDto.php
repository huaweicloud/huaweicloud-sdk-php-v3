...
class MergeRequestApprovalReviewersDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MergeRequestApprovalReviewersDto';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * approvalMergeRequestReviewers  approvalMergeRequestReviewers
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'approvalMergeRequestReviewers' => '\HuaweiCloud\SDK\CodeArtsRepo\V3\Model\ApprovalUserDto[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V3\Model\ApprovalUserDto[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V3\Model\ApprovalUserDto[]|null $approvalMergeRequestReviewers approvalMergeRequestReviewers
    *
    * @return $this
    */
