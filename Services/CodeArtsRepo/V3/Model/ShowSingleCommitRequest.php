...
class ShowSingleCommitRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowSingleCommitRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * repoId  仓库短id
    * sha  commit id，仓库的branch名或tag名
    * stats  包括提交统计信息。默认值为true
    *
    * @var string[]
    */
    ...
    * Sets stats
    *
    * @param bool|null $stats 包括提交统计信息。默认值为true
    *
    * @return $this
    */
