...
class SpecificCommitInfoLastPipeline implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SpecificCommitInfo_last_pipeline';
    ...
    * Sets sha
    *
    * @param string|null $sha 提交对应的SHA id
    *
    * @return $this
    */
