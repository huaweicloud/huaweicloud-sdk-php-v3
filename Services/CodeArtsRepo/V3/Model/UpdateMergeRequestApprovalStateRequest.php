...
class UpdateMergeRequestApprovalStateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateMergeRequestApprovalStateRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * repositoryId  仓库的主键id
    * mergeRequestIid  合并请求的短id
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'repositoryId' => 'string',
            'mergeRequestIid' => 'int',
            'body' => '\HuaweiCloud\SDK\CodeArtsRepo\V3\Model\ApprovalActionTypeDto'
    ];
    ...
    *
    * @param int $mergeRequestIid 合并请求的短id
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V3\Model\ApprovalActionTypeDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V3\Model\ApprovalActionTypeDto|null $body body
    *
    * @return $this
    */
