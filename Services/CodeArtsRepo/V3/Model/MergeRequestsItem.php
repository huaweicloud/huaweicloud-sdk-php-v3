...
class MergeRequestsItem implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'id' => 'double',
            'iid' => 'double',
            'mergeRequestAssigneeList' => '\HuaweiCloud\SDK\CodeArtsRepo\V3\Model\Author[]',
            'mergeStatus' => 'string',
            'sourceBranch' => 'string',
            'state' => 'string',
            'targetBranch' => 'string',
    ...
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V3\Model\Author[]|null $mergeRequestAssigneeList 检视人
    *
    * @return $this
    */
