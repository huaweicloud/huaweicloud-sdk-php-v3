...
class ValidateHttpsInfoV2Request implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ValidateHttpsInfoV2Request';
    ...
    */
    protected static $openAPITypes = [
            'iamUserUuid' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeArtsRepo\V3\Model\PasswordRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V3\Model\PasswordRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V3\Model\PasswordRequest|null $body body
    *
    * @return $this
    */
