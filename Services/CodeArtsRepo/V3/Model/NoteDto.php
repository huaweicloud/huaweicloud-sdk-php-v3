...
class NoteDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => 'string',
            'attachment' => 'string',
            'author' => '\HuaweiCloud\SDK\CodeArtsRepo\V3\Model\UserBasicDto',
            'createdAt' => 'string',
            'updatedAt' => 'string',
            'system' => 'bool',
            'noteableId' => 'int',
            ...
            'resolvable' => 'bool',
            'isReply' => 'bool',
            'resolvedBy' => '\HuaweiCloud\SDK\CodeArtsRepo\V3\Model\UserBasicDto',
            'noteableIid' => 'int',
            'discussionId' => 'string',
            'project' => 'string',
            'diffFile' => 'string',
            ...
            'position' => '\HuaweiCloud\SDK\CodeArtsRepo\V3\Model\PositionDto',
            'resolved' => 'bool',
            'isOutdated' => 'bool'
    ];
    ...
    * Sets author
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V3\Model\UserBasicDto|null $author author
    *
    * @return $this
    */
    ...
    * Sets resolvedBy
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V3\Model\UserBasicDto|null $resolvedBy resolvedBy
    *
    * @return $this
    */
    ...
    *  position
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V3\Model\PositionDto|null
    */
    ...
    * Sets position
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V3\Model\PositionDto|null $position position
    *
    * @return $this
    */
