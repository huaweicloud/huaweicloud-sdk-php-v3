...
class ProjectSimpleDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'memberMgntMode' => 'int',
            'visibility' => 'string',
            'namespace' => '\HuaweiCloud\SDK\CodeArtsRepo\V3\Model\NamespaceBasicDto',
            'repoType' => 'string'
    ];
    ...
    *  namespace
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V3\Model\NamespaceBasicDto|null
    */
    ...
    * Sets namespace
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V3\Model\NamespaceBasicDto|null $namespace namespace
    *
    * @return $this
    */
