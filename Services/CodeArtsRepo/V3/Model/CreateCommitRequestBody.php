...
class CreateCommitRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'startBranch' => 'string',
            'actions' => '\HuaweiCloud\SDK\CodeArtsRepo\V3\Model\CommitAction[]',
            'authorEmail' => 'string',
            'authorName' => 'string',
            'stats' => 'bool',
            'force' => 'bool'
    ...
    *  提交处理列表
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V3\Model\CommitAction[]
    */
    ...
    * Sets actions
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V3\Model\CommitAction[] $actions 提交处理列表
    *
    * @return $this
    */
