...
class ShowMergeRequestRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowMergeRequestRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['mergeRequestId'] === null) {
            $invalidProperties[] = "'mergeRequestId' can't be null";
        }
    ...
    * Sets mergeRequestId
    *
    * @param int $mergeRequestId 合并请求id
    *
    * @return $this
    */
