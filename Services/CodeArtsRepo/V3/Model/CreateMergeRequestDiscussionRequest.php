...
class CreateMergeRequestDiscussionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateMergeRequestDiscussionRequest';
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'mergeRequestIid' => 'int',
            'body' => '\HuaweiCloud\SDK\CodeArtsRepo\V3\Model\CreateMergeRequestDiscussionBodyDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V3\Model\CreateMergeRequestDiscussionBodyDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V3\Model\CreateMergeRequestDiscussionBodyDto|null $body body
    *
    * @return $this
    */
