...
class AddHooksRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddHooksRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * groupName  组名(克隆地址中域名后面仓库名前的一段 示例：git@repo.alpha.devcloud.inhuawei.com:Demo00228/testword.git  组名：Demo00228 )
    * repositoryName  仓库名
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\CodeArtsRepo\V3\Model\RepositoryHookRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V3\Model\RepositoryHookRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V3\Model\RepositoryHookRequest|null $body body
    *
    * @return $this
    */
