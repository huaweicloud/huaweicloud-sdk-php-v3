...
class CreateCommitResponseBodyStats implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCommitResponseBody_stats';
    ...
    * Sets additions
    *
    * @param int|null $additions 变更增加的行数
    *
    * @return $this
    */
    ...
    * Sets deletions
    *
    * @param int|null $deletions 变更删除的行数
    *
    * @return $this
    */
