...
class DeleteHooksRequest implements ModelInterface, ArrayAccess
{
    ...
    * Sets hookId
    *
    * @param int $hookId 通过id删除指定仓库的hook
    *
    * @return $this
    */
