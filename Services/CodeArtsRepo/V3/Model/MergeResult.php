...
class MergeResult implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'closed' => 'double',
            'mergeRequests' => '\HuaweiCloud\SDK\CodeArtsRepo\V3\Model\MergeRequestsItem[]',
            'merged' => 'double',
            'opened' => 'double',
            'total' => 'double'
    ];
    ...
    *  合并请求详情
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V3\Model\MergeRequestsItem[]|null
    */
    ...
    * Sets mergeRequests
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V3\Model\MergeRequestsItem[]|null $mergeRequests 合并请求详情
    *
    * @return $this
    */
