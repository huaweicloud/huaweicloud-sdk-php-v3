...
class AddRepoMembersRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddRepoMembersRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\CodeArtsRepo\V3\Model\CreateRepoMemberRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V3\Model\CreateRepoMemberRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V3\Model\CreateRepoMemberRequest|null $body body
    *
    * @return $this
    */
