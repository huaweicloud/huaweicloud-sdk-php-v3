...
class ShowRepositoryGeneralCommitRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowRepositoryGeneralCommitRuleRequest';
