...
class ShowRepositoryResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'namespace' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\NamespaceBasicDto',
            'emptyRepo' => 'bool',
            'starred' => 'bool',
            'visibility' => 'string',
            'securityTag' => 'string',
            'security' => 'string',
            'networkType' => 'string',
            'owner' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RepositoryUserBasicDto',
            'creator' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RepositoryUserBasicDto',
            'creatorId' => 'int',
            'forkedFromRepository' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RepositorySimpleDto',
            'uuid' => 'string',
            'ancestorIds' => 'int[]',
            ...
            'mergeMethod' => 'string',
            'forkNetworkRepositories' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RepositoryIdentityDto[]',
            'permissions' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\PermissionsDto',
            'repositoryType' => 'string',
            'statistics' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RepositoryStatisticsDto',
            'branchCount' => 'int',
            'tagCount' => 'int',
            'labelCount' => 'int',
            'memberCount' => 'int'
    ...
    *  namespace
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\NamespaceBasicDto|null
    */
    ...
    * Sets namespace
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\NamespaceBasicDto|null $namespace namespace
    *
    * @return $this
    */
    ...
    * Sets owner
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RepositoryUserBasicDto|null $owner owner
    *
    * @return $this
    */
    ...
    * Sets creator
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RepositoryUserBasicDto|null $creator creator
    *
    * @return $this
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RepositorySimpleDto|null $forkedFromRepository forkedFromRepository
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RepositoryIdentityDto[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RepositoryIdentityDto[]|null $forkNetworkRepositories **参数解释：** fork关联仓库列表。 **约束限制：** 不涉及。
    *
    * @return $this
    */
    ...
    *  permissions
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\PermissionsDto|null
    */
    ...
    * Sets permissions
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\PermissionsDto|null $permissions permissions
    *
    * @return $this
    */
    ...
    *  statistics
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RepositoryStatisticsDto|null
    */
    ...
    * Sets statistics
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RepositoryStatisticsDto|null $statistics statistics
    *
    * @return $this
    */
