...
class ListGroupProtectedBranchesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGroupProtectedBranchesRequest';
    ...
    * limit  **参数解释：** 返回数量。
    * search  **参数解释：** 检索内容 **约束限制：** 保护分支名称 **取值范围：** 保护分支名称 **默认取值：** 不涉及
    * userActions  **参数解释：** 是否返回带有user_action结构的数据，user_action结构的数据为最新的结构，推荐传参为true **约束限制：** true,false **取值范围：** true,false **默认取值：** 默认不传参
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['userActions'] === null) {
            $invalidProperties[] = "'userActions' can't be null";
        }
    ...
    * Sets search
    *
    * @param string|null $search **参数解释：** 检索内容 **约束限制：** 保护分支名称 **取值范围：** 保护分支名称 **默认取值：** 不涉及
    *
    * @return $this
    */
    ...
    * Sets userActions
    *
    * @param bool $userActions **参数解释：** 是否返回带有user_action结构的数据，user_action结构的数据为最新的结构，推荐传参为true **约束限制：** true,false **取值范围：** true,false **默认取值：** 默认不传参
    *
    * @return $this
    */
