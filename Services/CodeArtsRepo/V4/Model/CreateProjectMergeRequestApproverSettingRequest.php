...
class CreateProjectMergeRequestApproverSettingRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateProjectMergeRequestApproverSettingRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\CreateMergeRequestApproverSettingDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\CreateMergeRequestApproverSettingDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\CreateMergeRequestApproverSettingDto|null $body body
    *
    * @return $this
    */
