...
class ListProjectMergeRequestsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListProjectMergeRequestsRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['projectId'] === null) {
            ...
            if (!is_null($this->container['topic']) && (mb_strlen($this->container['topic']) > 50)) {
                $invalidProperties[] = "invalid value for 'topic', the character length must be smaller than or equal to 50.";
            }
    ...
    * Sets topic
    *
    * @param string|null $topic **参数解释：** 合并请求主题
    *
    * @return $this
    */
