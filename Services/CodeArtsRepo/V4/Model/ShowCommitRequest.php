...
class ShowCommitRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowCommitRequest';
    ...
    * stats  **参数解释：** 是否包含状态信息。 **取值范围：** - true，包含。 - false，不包含。
    * showCodeChanges  **参数解释：** 是否包含代码变化信息。 **取值范围：** - true，包含。 - false，不包含。
    *
    * @var string[]
    */
    ...
    */
    protected static $attributeMap = [
            ...
            'sha' => 'sha',
            'stats' => 'stats',
            'showCodeChanges' => 'show_code_changes'
    ];
    ...
    */
    protected static $setters = [
            ...
            'sha' => 'setSha',
            'stats' => 'setStats',
            'showCodeChanges' => 'setShowCodeChanges'
    ];
    ...
    */
    protected static $getters = [
            ...
            'sha' => 'getSha',
            'stats' => 'getStats',
            'showCodeChanges' => 'getShowCodeChanges'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['showCodeChanges'] = isset($data['showCodeChanges']) ? $data['showCodeChanges'] : null;
    }
    ...
    * Sets stats
    *
    * @param bool|null $stats **参数解释：** 是否包含状态信息。 **取值范围：** - true，包含。 - false，不包含。
    *
    * @return $this
    */
    ...
    /**
    * Gets showCodeChanges
    *  **参数解释：** 是否包含代码变化信息。 **取值范围：** - true，包含。 - false，不包含。
    *
    * @return bool|null
    */
    public function getShowCodeChanges()
    {
        return $this->container['showCodeChanges'];
    }

    /**
    * Sets showCodeChanges
    *
    * @param bool|null $showCodeChanges **参数解释：** 是否包含代码变化信息。 **取值范围：** - true，包含。 - false，不包含。
    *
    * @return $this
    */
    public function setShowCodeChanges($showCodeChanges)
    {
        $this->container['showCodeChanges'] = $showCodeChanges;
        return $this;
    }
