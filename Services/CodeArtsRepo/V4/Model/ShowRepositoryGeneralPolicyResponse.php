...
class ShowRepositoryGeneralPolicyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowRepositoryGeneralPolicyResponse';
    ...
    *  **参数解释：** 开发人员创建分支权限白名单。
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\PushRuleDevelopersDto[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\PushRuleDevelopersDto[]|null $createBranchWhitelistUsers **参数解释：** 开发人员创建分支权限白名单。
    *
    * @return $this
    */
