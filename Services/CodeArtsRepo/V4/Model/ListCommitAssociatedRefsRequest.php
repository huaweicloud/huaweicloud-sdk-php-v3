...
class ListCommitAssociatedRefsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCommitAssociatedRefsRequest';
    ...
    * Sets type
    *
    * @param string $type **参数解释：** 分支或者tag。 **取值范围：** 只能为branch或者tag。 **约束限制：** 只能为branch或者tag。
    *
    * @return $this
    */
