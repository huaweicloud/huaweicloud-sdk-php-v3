...
class ShowUserRefPermissionResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'read' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UserRefPermissionBasicDto',
            'review' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UserRefPermissionBasicDto',
            'approval' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UserRefPermissionBasicDto',
            'createChange' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UserRefPermissionBasicDto',
            'merge' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UserRefPermissionBasicDto',
            'createDelete' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UserRefPermissionBasicDto',
            'push' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UserRefPermissionBasicDto'
    ];
    ...
    *  read
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UserRefPermissionBasicDto|null
    */
    ...
    * Sets read
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UserRefPermissionBasicDto|null $read read
    *
    * @return $this
    */
    ...
    * Sets review
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UserRefPermissionBasicDto|null $review review
    *
    * @return $this
    */
    ...
    * Sets approval
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UserRefPermissionBasicDto|null $approval approval
    *
    * @return $this
    */
    ...
    * Sets createChange
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UserRefPermissionBasicDto|null $createChange createChange
    *
    * @return $this
    */
    ...
    * Sets merge
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UserRefPermissionBasicDto|null $merge merge
    *
    * @return $this
    */
    ...
    * Sets createDelete
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UserRefPermissionBasicDto|null $createDelete createDelete
    *
    * @return $this
    */
    ...
    * Sets push
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UserRefPermissionBasicDto|null $push push
    *
    * @return $this
    */
