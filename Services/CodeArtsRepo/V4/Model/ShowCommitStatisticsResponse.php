...
class ShowCommitStatisticsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'commits' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\CommitStatisticsResultCommitDto[]',
    ...
    *  **参数解释：** 提交统计。
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\CommitStatisticsResultCommitDto[]|null
    */
    ...
    * Sets commits
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\CommitStatisticsResultCommitDto[]|null $commits **参数解释：** 提交统计。
    *
    * @return $this
    */
    ...
    * Sets statistics
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\StatisticDto[]|null $statistics **参数解释：** 提交人员统计。
    *
    * @return $this
    */
