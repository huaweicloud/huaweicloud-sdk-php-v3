...
class UpdateTenantTrustedIpAddressRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'ipId' => 'int',
            'body' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\AddTrustedIpAddressRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\AddTrustedIpAddressRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\AddTrustedIpAddressRequestBody|null $body body
    *
    * @return $this
    */
