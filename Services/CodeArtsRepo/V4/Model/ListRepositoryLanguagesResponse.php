...
class ListRepositoryLanguagesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'languages' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\LanguagesDto[]',
            'status' => 'string',
            'xTotal' => 'string'
    ];
    ...
    *  **参数解释：** 语言描述。
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\LanguagesDto[]|null
    */
    ...
    * Sets languages
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\LanguagesDto[]|null $languages **参数解释：** 语言描述。
    *
    * @return $this
    */
