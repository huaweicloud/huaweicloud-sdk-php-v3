...
class BlameDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'avatarUrl' => 'string',
            'lines' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\LineContentDto[]',
            'nickName' => 'string',
            'tenantName' => 'string',
            'userName' => 'string'
    ];
    ...
    *  行信息
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\LineContentDto[]|null
    */
    ...
    * Sets lines
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\LineContentDto[]|null $lines 行信息
    *
    * @return $this
    */
