...
class ImportMrParamsDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'mergedAt' => 'string',
            'closedAt' => 'string',
            'approvers' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ApproverParamDto[]',
            'diffRefs' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\DiffRefsParamDto[]',
            'squash' => 'bool',
    ...
    *  审核人列表
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ApproverParamDto[]|null
    */
    ...
    * Sets approvers
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ApproverParamDto[]|null $approvers 审核人列表
    *
    * @return $this
    */
    ...
    *  合并请求变更commit列表
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\DiffRefsParamDto[]
    */
    ...
    * Sets diffRefs
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\DiffRefsParamDto[] $diffRefs 合并请求变更commit列表
    *
    * @return $this
    */
