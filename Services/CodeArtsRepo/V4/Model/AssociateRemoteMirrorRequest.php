...
class AssociateRemoteMirrorRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateRemoteMirrorRequest';
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'body' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RemoteMirrorDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RemoteMirrorDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RemoteMirrorDto|null $body body
    *
    * @return $this
    */
