...
class ShowGroupResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'subgroupCount' => 'int',
            'visibility' => 'string',
            'sum' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\GroupSumDto'
    ];
    ...
    *  sum
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\GroupSumDto|null
    */
    ...
    * Sets sum
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\GroupSumDto|null $sum sum
    *
    * @return $this
    */
