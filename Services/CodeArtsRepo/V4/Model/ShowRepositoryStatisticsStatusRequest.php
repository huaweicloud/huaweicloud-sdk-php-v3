...
class ShowRepositoryStatisticsStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowRepositoryStatisticsStatusRequest';
