...
class ListMembersRequest implements ModelInterface, ArrayAccess
{
    ...
    * limit  **参数解释：** 返回数量。
    * permission  **参数解释：** 权限点。 **约束限制：** - repository，仓库。 - code，代码。 - member，成员。 - branch，分支。 - tag，Tag。 - mr，MR。 - label，标签。
    * action  **参数解释：** 权限动作点, 不同权限点有不同的动作。 **约束限制：** - repository：create,fork,delete,setting - code：push,download - member：create,update,delete - branch：create,delete - tag：create,delete - mr：create,update,comment,review,approve,merge,close,reopen - label：create,delete,update
    *
    * @var string[]
    */
    ...
    */
    ...
    const PERMISSION_REPOSITORY = 'repository';
    const PERMISSION_CODE = 'code';
    const PERMISSION_MEMBER = 'member';
    const PERMISSION_BRANCH = 'branch';
    const PERMISSION_TAG = 'tag';
    const PERMISSION_MR = 'mr';
    const PERMISSION_LABEL = 'label';
    const ACTION_REPOSITORYCREATEFORKDELETESETTING = 'repository：create,fork,delete,setting';
    const ACTION_CODEPUSHDOWNLOAD = 'code：push,download';
    const ACTION_MEMBERCREATEUPDATEDELETE = 'member：create,update,delete';
    const ACTION_BRANCHCREATEDELETE = 'branch：create,delete';
    const ACTION_TAGCREATEDELETE = 'tag：create,delete';
    const ACTION_MRCREATEUPDATECOMMENTREVIEWAPPROVEMERGECLOSEREOPEN = 'mr：create,update,comment,review,approve,merge,close,reopen';
    const ACTION_LABELCREATEDELETEUPDATE = 'label：create,delete,update';
    ...
    */
    ...
    {
        return [
            self::ACTION_REPOSITORYCREATEFORKDELETESETTING,
            self::ACTION_CODEPUSHDOWNLOAD,
            self::ACTION_MEMBERCREATEUPDATEDELETE,
            self::ACTION_BRANCHCREATEDELETE,
            self::ACTION_TAGCREATEDELETE,
            self::ACTION_MRCREATEUPDATECOMMENTREVIEWAPPROVEMERGECLOSEREOPEN,
            self::ACTION_LABELCREATEDELETEUPDATE,
        ];
    }
    ...
    * Sets permission
    *
    * @param string|null $permission **参数解释：** 权限点。 **约束限制：** - repository，仓库。 - code，代码。 - member，成员。 - branch，分支。 - tag，Tag。 - mr，MR。 - label，标签。
    *
    * @return $this
    */
    ...
    * Sets action
    *
    * @param string|null $action **参数解释：** 权限动作点, 不同权限点有不同的动作。 **约束限制：** - repository：create,fork,delete,setting - code：push,download - member：create,update,delete - branch：create,delete - tag：create,delete - mr：create,update,comment,review,approve,merge,close,reopen - label：create,delete,update
    *
    * @return $this
    */
