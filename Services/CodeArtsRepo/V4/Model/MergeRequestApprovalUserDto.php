...
class MergeRequestApprovalUserDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MergeRequestApprovalUserDto';
    ...
    * hasPermission  **参数解释：** 是否有相关权限。 **取值范围：** true：有权限。 false：没权限。
    *
    * @var string[]
    */
    ...
    * Sets hasPermission
    *
    * @param bool|null $hasPermission **参数解释：** 是否有相关权限。 **取值范围：** true：有权限。 false：没权限。
    *
    * @return $this
    */
