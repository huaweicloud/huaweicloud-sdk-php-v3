...
class ProtectedBranchBodyApiDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'name' => 'string',
            'actions' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ProtectedActionBasicApiDto[]'
    ];
    ...
    *  **参数解释：** 事件列表。
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ProtectedActionBasicApiDto[]|null
    */
    ...
    * Sets actions
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ProtectedActionBasicApiDto[]|null $actions **参数解释：** 事件列表。
    *
    * @return $this
    */
