...
class RepositoryProtectedActionBasicBodyDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RepositoryProtectedActionBasicBodyDto';
