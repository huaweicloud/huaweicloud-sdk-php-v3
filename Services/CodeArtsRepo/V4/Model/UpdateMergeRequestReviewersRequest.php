...
class UpdateMergeRequestReviewersRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateMergeRequestReviewersRequest';
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'mergeRequestIid' => 'int',
            'body' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ApprovalReviewerInfoDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ApprovalReviewerInfoDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ApprovalReviewerInfoDto|null $body body
    *
    * @return $this
    */
