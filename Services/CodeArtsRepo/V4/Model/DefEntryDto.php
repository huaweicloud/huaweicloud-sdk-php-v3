...
class DefEntryDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DefEntryDto';
    ...
    * Sets range
    *
    * @param string|null $range **参数解释：** 范围信息。 **约束限制：** 不涉及。
    *
    * @return $this
    */
