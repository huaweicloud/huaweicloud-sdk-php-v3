...
class GroupProtectedBranchApiDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GroupProtectedBranchApiDto';
    ...
    * namespaceId  **参数解释：** 代码组id。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'id' => 'int',
            'name' => 'string',
            'actions' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ProjectProtectedActionResultApiDto[]',
            'namespaceId' => 'int'
    ];
    ...
    * Sets namespaceId
    *
    * @param int|null $namespaceId **参数解释：** 代码组id。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @return $this
    */
