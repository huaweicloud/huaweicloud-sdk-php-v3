...
class RemoveDeployKeyFromSubmodulesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RemoveDeployKeyFromSubmodulesRequest';
