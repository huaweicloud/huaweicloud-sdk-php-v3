...
class ShowProjectMergeRequestSettingRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowProjectMergeRequestSettingRequest';
