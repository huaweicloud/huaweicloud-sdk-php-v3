...
class UserGroupDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UserGroupDto';
    ...
    * groupType  **参数解释：** 代码组类型。 **取值范围：** 字符串长度不少于1，不超过1000。
    * memberCount  **参数解释：** 成员数量。
    ...
    * Sets groupType
    *
    * @param string|null $groupType **参数解释：** 代码组类型。 **取值范围：** 字符串长度不少于1，不超过1000。
    *
    * @return $this
    */
    ...
    * Sets memberCount
    *
    * @param int|null $memberCount **参数解释：** 成员数量。
    *
    * @return $this
    */
