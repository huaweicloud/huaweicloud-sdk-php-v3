...
class ShowCommitResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowCommitResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'projectId' => 'int',
            'mergeRequest' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\SimpleMergeRequestDetailDto',
            'codeChanges' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\SimpleDiffDto[]'
    ];
    ...
    *  only for DevCloud
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RelatedCommitSimpleDto[]|null
    */
    ...
    * Sets relateUrl
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RelatedCommitSimpleDto[]|null $relateUrl only for DevCloud
    *
    * @return $this
    */
    ...
    *  stats
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\CommitStatsDto|null
    */
    ...
    * Sets stats
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\CommitStatsDto|null $stats stats
    *
    * @return $this
    */
    ...
    * Sets lastPipeline
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\PipelineBasicDto|null $lastPipeline lastPipeline
    *
    * @return $this
    */
    ...
    *  mergeRequest
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\SimpleMergeRequestDetailDto|null
    */
    ...
    * Sets mergeRequest
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\SimpleMergeRequestDetailDto|null $mergeRequest mergeRequest
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\SimpleDiffDto[]|null
    */
    ...
    * Sets codeChanges
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\SimpleDiffDto[]|null $codeChanges **参数解释：** 代码变更内容。 **取值范围：** 不涉及。
    *
    * @return $this
    */
