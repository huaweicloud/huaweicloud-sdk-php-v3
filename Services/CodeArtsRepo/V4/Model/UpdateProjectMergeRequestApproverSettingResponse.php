...
class UpdateProjectMergeRequestApproverSettingResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateProjectMergeRequestApproverSettingResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'appendReviewers' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UserBasicDto[]',
            'appendApproverIds' => 'int[]',
            'appendApprovers' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UserBasicDto[]',
            'onlyMergeWhenPipelinePass' => 'bool',
            'assigneeIds' => 'int[]',
            'assignees' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UserBasicDto[]',
            'approverIds' => 'int[]',
            'approvers' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UserBasicDto[]',
            'reviewerIds' => 'int[]',
            'reviewers' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UserBasicDto[]'
    ];
    ...
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UserBasicDto[]|null $appendReviewers 追加检视人实体列表
    *
    * @return $this
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UserBasicDto[]|null $appendApprovers 追加审核人实体列表
    *
    * @return $this
    */
    ...
    * Sets assignees
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UserBasicDto[]|null $assignees 合并人实体列表
    *
    * @return $this
    */
    ...
    * Sets approvers
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UserBasicDto[]|null $approvers 审核人实体列表
    *
    * @return $this
    */
    ...
    * Sets reviewers
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UserBasicDto[]|null $reviewers 检视人实体列表
    *
    * @return $this
    */
