...
class CreateProjectProtectedBranchesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateProjectProtectedBranchesRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ProtectedBranchBodyApiDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ProtectedBranchBodyApiDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ProtectedBranchBodyApiDto|null $body body
    *
    * @return $this
    */
