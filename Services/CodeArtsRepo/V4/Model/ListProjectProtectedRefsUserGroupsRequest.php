...
class ListProjectProtectedRefsUserGroupsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListProjectProtectedRefsUserGroupsRequest';
