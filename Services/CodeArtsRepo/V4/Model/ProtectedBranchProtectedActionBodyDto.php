...
class ProtectedBranchProtectedActionBodyDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'action' => 'string',
            'additionSwitchers' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ProtectedActionSwitcher[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ProtectedActionSwitcher[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ProtectedActionSwitcher[]|null $additionSwitchers **参数解释：** 附加开关。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    *
    * @return $this
    */
