...
class UpdateProtectedTagRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateProtectedTagRequest';
    ...
    * tagName  **参数解释：** 保护分Tag或通配符列表。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    * body  保护Tag权限列表
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'tagName' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RepositoryProtectedTagActionBodyDto[]'
    ];
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RepositoryProtectedTagActionBodyDto[]|null $body 保护Tag权限列表
    *
    * @return $this
    */
