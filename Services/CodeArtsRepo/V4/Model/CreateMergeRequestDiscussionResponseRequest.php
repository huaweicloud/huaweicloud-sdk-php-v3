...
class CreateMergeRequestDiscussionResponseRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateMergeRequestDiscussionResponseRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'mergeRequestIid' => 'int',
            'discussionId' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ReplyMergeRequestNoteDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ReplyMergeRequestNoteDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ReplyMergeRequestNoteDto|null $body body
    *
    * @return $this
    */
