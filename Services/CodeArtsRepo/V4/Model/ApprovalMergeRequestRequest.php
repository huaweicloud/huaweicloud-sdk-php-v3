...
class ApprovalMergeRequestRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ApprovalMergeRequestRequest';
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'mergeRequestIid' => 'int',
            'body' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ApprovalActionTypeDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ApprovalActionTypeDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ApprovalActionTypeDto|null $body body
    *
    * @return $this
    */
