...
class ShowRepositoryInheritSettingSourceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowRepositoryInheritSettingSourceRequest';
