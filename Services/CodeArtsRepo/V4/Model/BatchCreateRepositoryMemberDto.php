...
class BatchCreateRepositoryMemberDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'result' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\CreateRepositoryMemberResponseDto[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\CreateRepositoryMemberResponseDto[]|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\CreateRepositoryMemberResponseDto[]|null $result **参数解释：** 批量添加结果详情。 **约束限制：** 不涉及。
    *
    * @return $this
    */
