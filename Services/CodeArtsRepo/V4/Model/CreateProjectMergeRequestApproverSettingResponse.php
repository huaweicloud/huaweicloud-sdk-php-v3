...
class CreateProjectMergeRequestApproverSettingResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateProjectMergeRequestApproverSettingResponse';
