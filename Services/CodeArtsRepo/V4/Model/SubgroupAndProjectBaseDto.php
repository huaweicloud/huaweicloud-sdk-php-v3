...
class SubgroupAndProjectBaseDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'projectCreator' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ProjectCreatorDto',
            'starCount' => 'int',
            'tagList' => 'string[]',
    ...
    *  projectCreator
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ProjectCreatorDto|null
    */
    ...
    * Sets projectCreator
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ProjectCreatorDto|null $projectCreator projectCreator
    *
    * @return $this
    */
