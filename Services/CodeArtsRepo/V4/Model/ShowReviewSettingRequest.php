...
class ShowReviewSettingRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowReviewSettingRequest';
    ...
    */
    ...
    /**
    * Gets withDefaultReviewCategories
    *  **参数解释：** 额外返回可勾选检视意见分类和系统预置检视意见分类。 **取值范围：** - true, 返回可勾选检视意见分类和系统预置检视意见分类。 - false, 不返回可勾选检视意见分类和系统预置检视意见分类。
    *
    * @return bool|null
    */
    public function getWithDefaultReviewCategories()
    {
        return $this->container['withDefaultReviewCategories'];
    }

    /**
    * Sets withDefaultReviewCategories
    *
    * @param bool|null $withDefaultReviewCategories **参数解释：** 额外返回可勾选检视意见分类和系统预置检视意见分类。 **取值范围：** - true, 返回可勾选检视意见分类和系统预置检视意见分类。 - false, 不返回可勾选检视意见分类和系统预置检视意见分类。
    *
    * @return $this
    */
