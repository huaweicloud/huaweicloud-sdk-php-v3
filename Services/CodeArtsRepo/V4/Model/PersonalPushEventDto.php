...
class PersonalPushEventDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'author' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\PersonalEventAuthorDto',
    ...
    *  author
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\PersonalEventAuthorDto|null
    */
    ...
    * Sets author
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\PersonalEventAuthorDto|null $author author
    *
    * @return $this
    */
