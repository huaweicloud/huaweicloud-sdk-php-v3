...
class UpdateMergeRequestDiscussionInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateMergeRequestDiscussionInfoRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'mergeRequestIid' => 'int',
            'discussionId' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UpdateMergeRequestNoteDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UpdateMergeRequestNoteDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UpdateMergeRequestNoteDto|null $body body
    *
    * @return $this
    */
