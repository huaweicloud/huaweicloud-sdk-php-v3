...
class UpdateRepoNotificationSubscriptionDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateRepoNotificationSubscriptionDto';
    ...
    */
    protected static $openAPITypes = [
            'enabled' => 'bool',
            'configSource' => 'string',
            'webhookConfig' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UpdateRepoWebHookSubscriptionDto',
            'waringRepoUsageRate' => 'int',
            'subscriptEvents' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RepoSubscriptionEventDto[]'
    ];
    ...
    *  webhookConfig
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UpdateRepoWebHookSubscriptionDto|null
    */
    ...
    * Sets webhookConfig
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UpdateRepoWebHookSubscriptionDto|null $webhookConfig webhookConfig
    *
    * @return $this
    */
    ...
    *  **参数解释：** 通知事件。
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RepoSubscriptionEventDto[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RepoSubscriptionEventDto[]|null $subscriptEvents **参数解释：** 通知事件。
    *
    * @return $this
    */
