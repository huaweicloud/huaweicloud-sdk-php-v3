...
class WebhookLogExtendDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'WebhookLogExtendDto';
    ...
    */
    protected static $openAPITypes = [
            ...
            'createdAt' => 'string',
            'updatedAt' => 'string',
            'repository' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\WebhookRepositoryDto'
    ];
    ...
    *  repository
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\WebhookRepositoryDto|null
    */
    ...
    * Sets repository
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\WebhookRepositoryDto|null $repository repository
    *
    * @return $this
    */
