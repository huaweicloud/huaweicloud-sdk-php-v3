...
class ShowRepositoryNavigationSchemaRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowRepositoryNavigationSchemaRequest';
