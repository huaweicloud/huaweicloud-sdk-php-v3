...
class CreateCherryPickMergeRequestRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCherryPickMergeRequestRequest';
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'mergeRequestIid' => 'int',
            'body' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\MrCherryRevertDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\MrCherryRevertDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\MrCherryRevertDto|null $body body
    *
    * @return $this
    */
