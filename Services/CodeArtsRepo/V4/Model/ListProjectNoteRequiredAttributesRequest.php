...
class ListProjectNoteRequiredAttributesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListProjectNoteRequiredAttributesRequest';
