...
class UpdateRepositoryWebhookRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateRepositoryWebhookRequest';
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'hookId' => 'int',
            'body' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\WebhookParamsDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\WebhookParamsDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\WebhookParamsDto|null $body body
    *
    * @return $this
    */
