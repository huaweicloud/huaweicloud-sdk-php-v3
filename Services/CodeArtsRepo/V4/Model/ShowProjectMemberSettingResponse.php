...
class ShowProjectMemberSettingResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'roleSync' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RoleSyncDto[]'
    ];
    ...
    *  **参数解释：** 角色同步
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RoleSyncDto[]|null
    */
    ...
    * Sets roleSync
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RoleSyncDto[]|null $roleSync **参数解释：** 角色同步
    *
    * @return $this
    */
