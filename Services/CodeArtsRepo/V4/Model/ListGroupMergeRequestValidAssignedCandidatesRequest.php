...
class ListGroupMergeRequestValidAssignedCandidatesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGroupMergeRequestValidAssignedCandidatesRequest';
