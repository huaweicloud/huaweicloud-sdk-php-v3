...
class ShowNotificationSubscriptionsStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowNotificationSubscriptionsStatusRequest';
