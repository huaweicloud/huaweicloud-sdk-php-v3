...
class CreateMergeRequestDiscussionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateMergeRequestDiscussionResponse';
    ...
    */
    protected static $openAPITypes = [
            'id' => 'string',
            'individualNote' => 'bool',
            'notes' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\NoteDto[]',
            'repositoryId' => 'int',
            'noteableType' => 'string',
            'commitId' => 'string',
            ...
            'mergeRequestVersionParams' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\MergeRequestVersionParamsDto',
            'diffFile' => 'string',
            'addedLines' => 'int',
            'removedLines' => 'int'
    ];
    ...
    *  **参数解释：** 评论列表(主评+回复)。
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\NoteDto[]|null
    */
    ...
    * Sets notes
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\NoteDto[]|null $notes **参数解释：** 评论列表(主评+回复)。
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\MergeRequestVersionParamsDto|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\MergeRequestVersionParamsDto|null $mergeRequestVersionParams mergeRequestVersionParams
    *
    * @return $this
    */
