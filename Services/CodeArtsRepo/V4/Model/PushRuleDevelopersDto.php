...
class PushRuleDevelopersDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PushRuleDevelopersDto';
    ...
    * Sets id
    *
    * @param object|null $id **参数解释：** 主键ID。
    *
    * @return $this
    */
    ...
    * Sets userId
    *
    * @param object|null $userId **参数解释：** 用户ID。
    *
    * @return $this
    */
    ...
    * Sets userName
    *
    * @param object|null $userName **参数解释：** 用户名。
    *
    * @return $this
    */
