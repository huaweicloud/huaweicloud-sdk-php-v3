...
class ApprovalApproverInfoDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ApprovalApproverInfoDto';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * approverIds  **参数解释：** 需要更新的审核人ID列表 数字以英文逗号分隔 111,222 **取值范围：** 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets approverIds
    *
    * @param string|null $approverIds **参数解释：** 需要更新的审核人ID列表 数字以英文逗号分隔 111,222 **取值范围：** 不涉及。
    *
    * @return $this
    */
