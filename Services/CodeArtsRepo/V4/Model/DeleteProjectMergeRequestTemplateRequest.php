...
class DeleteProjectMergeRequestTemplateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteProjectMergeRequestTemplateRequest';
