...
class TenantRepoEncryptionSettingRequestDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TenantRepoEncryptionSettingRequestDto';
