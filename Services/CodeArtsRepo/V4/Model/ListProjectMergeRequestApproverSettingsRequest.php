...
class ListProjectMergeRequestApproverSettingsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListProjectMergeRequestApproverSettingsRequest';
