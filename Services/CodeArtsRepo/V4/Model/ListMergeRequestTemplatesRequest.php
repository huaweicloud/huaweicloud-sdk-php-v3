...
class ListMergeRequestTemplatesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListMergeRequestTemplatesRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * repositoryId  **参数解释：** 仓库的ID，通过[[查询用户所有仓库](https://support.huaweicloud.com/api-codeartsrepo/ListUserAllRepositories.html)](tag:hws)[[查询用户所有仓库](https://support.huaweicloud.com/intl/en-us/api-codeartsrepo/ListUserAllRepositories.html)](tag:hws_hk)[[查询用户所有仓库](https://support.huaweicloud.com/eu/api-codeartsrepo/ListUserAllRepositories.html)](tag:hws_eu)[查询项目列表](tag:hcs,hcs_sm)接口查询项目列表获取。 **约束限制：** 不涉及。
    * view  **参数解释：** 结果集返回的范围 **取值范围：** - default，返回模板名称为“default template”的模板。 - list，返回模板列表。
    * templateName  **参数解释：** 搜索的模板名称 **取值范围：** 字符串长度不少于1，不超过100000。
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['view'] === null) {
            ...
            if (!is_null($this->container['templateName']) && (mb_strlen($this->container['templateName']) > 100000)) {
                $invalidProperties[] = "invalid value for 'templateName', the character length must be smaller than or equal to 100000.";
            }
    ...
    * Sets view
    *
    * @param string $view **参数解释：** 结果集返回的范围 **取值范围：** - default，返回模板名称为“default template”的模板。 - list，返回模板列表。
    *
    * @return $this
    */
    ...
    * Sets templateName
    *
    * @param string|null $templateName **参数解释：** 搜索的模板名称 **取值范围：** 字符串长度不少于1，不超过100000。
    *
    * @return $this
    */
