...
class ShowRepoLastStatisticsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowRepoLastStatisticsRequest';
    ...
    * branchName  **参数解释：** 分支名称。 **约束限制：** 不涉及。 **取值范围：** 字符串长度不少于1，不超过2000。 **默认取值：** 不涉及。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['branchName'] === null) {
            ...
            if ((mb_strlen($this->container['branchName']) > 2000)) {
    ...
    * Sets branchName
    *
    * @param string $branchName **参数解释：** 分支名称。 **约束限制：** 不涉及。 **取值范围：** 字符串长度不少于1，不超过2000。 **默认取值：** 不涉及。
    *
    * @return $this
    */
