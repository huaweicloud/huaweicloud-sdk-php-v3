...
class MergeRequestApproverSettingResultDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MergeRequestApproverSettingResultDto';
