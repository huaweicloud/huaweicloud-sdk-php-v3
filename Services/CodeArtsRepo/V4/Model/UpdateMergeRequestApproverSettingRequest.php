...
class UpdateMergeRequestApproverSettingRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateMergeRequestApproverSettingRequest';
