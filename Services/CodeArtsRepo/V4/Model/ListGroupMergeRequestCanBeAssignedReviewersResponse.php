...
class ListGroupMergeRequestCanBeAssignedReviewersResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGroupMergeRequestCanBeAssignedReviewersResponse';
