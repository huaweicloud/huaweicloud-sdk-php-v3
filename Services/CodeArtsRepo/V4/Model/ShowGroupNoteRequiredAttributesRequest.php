...
class ShowGroupNoteRequiredAttributesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowGroupNoteRequiredAttributesRequest';
