...
class DownloadBlobsRawRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DownloadBlobsRawRequest';
    ...
    * blobId  **参数解释：** blob文件ID。通过[[查询某个仓库的文件信息](https://support.huaweicloud.com/api-codeartsrepo/ListFilesByQuery.html)](tag:hws)[[查询某个仓库的文件信息](https://support.huaweicloud.com/intl/en-us/api-codeartsrepo/ListFilesByQuery.html)](tag:hws_hk)[查询某个仓库的文件信息](tag:hcs,hcs_sm)接口查询某个仓库的文件信息获取。 **取值范围：** 不涉及。
    * fileName  **参数解释：** 下载文件名。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['blobId'] === null) {
            $invalidProperties[] = "'blobId' can't be null";
        }
            if ((mb_strlen($this->container['blobId']) > 40)) {
                $invalidProperties[] = "invalid value for 'blobId', the character length must be smaller than or equal to 40.";
            }
            if ((mb_strlen($this->container['blobId']) < 1)) {
    ...
    * Sets fileName
    *
    * @param string|null $fileName **参数解释：** 下载文件名。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    *
    * @return $this
    */
