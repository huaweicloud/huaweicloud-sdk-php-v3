...
class ShowRepositoryWebhookLogRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowRepositoryWebhookLogRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['logId'] === null) {
            ...
            if (($this->container['logId'] > 2147483647)) {
                $invalidProperties[] = "invalid value for 'logId', must be smaller than or equal to 2147483647.";
            }
            if (($this->container['logId'] < 1)) {
    ...
    * Sets logId
    *
    * @param int $logId **参数解释：**  Webhook 日志id。
    *
    * @return $this
    */
