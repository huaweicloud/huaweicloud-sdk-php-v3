...
class ListProjectMergeRequestCanBeAssignedUsersRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListProjectMergeRequestCanBeAssignedUsersRequest';
