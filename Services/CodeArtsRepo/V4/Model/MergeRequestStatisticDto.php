...
class MergeRequestStatisticDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'changedLinesCount' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\MergeRequestLineChange',
            'mergeError' => 'string',
    ...
    *  changedLinesCount
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\MergeRequestLineChange|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\MergeRequestLineChange|null $changedLinesCount changedLinesCount
    *
    * @return $this
    */
