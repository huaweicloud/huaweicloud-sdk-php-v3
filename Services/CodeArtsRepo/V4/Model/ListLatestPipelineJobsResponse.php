...
class ListLatestPipelineJobsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'id' => 'int',
            'status' => 'string',
            'stages' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\PipelineStageJobDto[]'
    ];
    ...
    *  stages
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\PipelineStageJobDto[]|null
    */
    ...
    * Sets stages
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\PipelineStageJobDto[]|null $stages stages
    *
    * @return $this
    */
