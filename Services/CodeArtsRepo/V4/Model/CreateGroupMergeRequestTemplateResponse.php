...
class CreateGroupMergeRequestTemplateResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateGroupMergeRequestTemplateResponse';
