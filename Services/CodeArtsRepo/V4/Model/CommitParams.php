...
class CommitParams implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'actions' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ActionDto[]',
            'startBranch' => 'string',
            'authorEmail' => 'string',
            'authorName' => 'string',
            'stats' => 'bool',
    ...
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ActionDto[]
    */
    ...
    * Sets actions
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ActionDto[] $actions **参数解释：** 在提交时执行的操作。 **取值范围：** 不涉及。
    *
    * @return $this
    */
