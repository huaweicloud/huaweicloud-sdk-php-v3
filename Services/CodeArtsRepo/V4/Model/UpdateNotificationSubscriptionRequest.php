...
class UpdateNotificationSubscriptionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateNotificationSubscriptionRequest';
    ...
    * type  **参数解释：** 通知类型。 **取值范围：**   - internal_message，站内信。   - email，邮件。   - qyweixin，企业微信。   - feishu，飞书。   - dingding，钉钉。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'type' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UpdateRepoNotificationSubscriptionDto'
    ];
    ...
    */
    ...
    const TYPE_INTERNAL_MESSAGE = 'internal_message';
    const TYPE_EMAIL = 'email';
    const TYPE_QYWEIXIN = 'qyweixin';
    const TYPE_FEISHU = 'feishu';
    const TYPE_DINGDING = 'dingding';
    ...
    * Sets type
    *
    * @param string $type **参数解释：** 通知类型。 **取值范围：**   - internal_message，站内信。   - email，邮件。   - qyweixin，企业微信。   - feishu，飞书。   - dingding，钉钉。
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UpdateRepoNotificationSubscriptionDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UpdateRepoNotificationSubscriptionDto|null $body body
    *
    * @return $this
    */
