...
class CommitDiscussionDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CommitDiscussionDto';
    ...
    */
    protected static $openAPITypes = [
            'id' => 'string',
            'individualNote' => 'bool',
            'notes' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\CommitNoteDto[]',
            'repositoryId' => 'int',
            'noteableType' => 'string',
            'commitId' => 'string',
    ...
    *  **参数解释：** 评论列表(主评+回复)。
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\CommitNoteDto[]|null
    */
    ...
    * Sets notes
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\CommitNoteDto[]|null $notes **参数解释：** 评论列表(主评+回复)。
    *
    * @return $this
    */
    ...
    * Sets diffFile
    *
    * @param bool|null $diffFile **参数解释：** 是否为修改文件。
    *
    * @return $this
    */
