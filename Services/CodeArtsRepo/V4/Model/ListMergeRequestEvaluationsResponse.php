...
class ListMergeRequestEvaluationsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'customEvaluations' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\CustomEvaluationDto[]'
    ];
    ...
    *  自定义评价
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\CustomEvaluationDto[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\CustomEvaluationDto[]|null $customEvaluations 自定义评价
    *
    * @return $this
    */
