...
class ShowNotificationSubscriptionsStatusResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'internalMessage' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RepoNotificationSubscriptionStateDto',
            'email' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RepoNotificationSubscriptionStateDto',
            'qyweixin' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RepoNotificationSubscriptionStateDto',
            'feishu' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RepoNotificationSubscriptionStateDto',
            'dingding' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RepoNotificationSubscriptionStateDto'
    ];
    ...
    *  internalMessage
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RepoNotificationSubscriptionStateDto|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RepoNotificationSubscriptionStateDto|null $internalMessage internalMessage
    *
    * @return $this
    */
    ...
    * Sets email
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RepoNotificationSubscriptionStateDto|null $email email
    *
    * @return $this
    */
    ...
    * Sets qyweixin
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RepoNotificationSubscriptionStateDto|null $qyweixin qyweixin
    *
    * @return $this
    */
    ...
    * Sets feishu
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RepoNotificationSubscriptionStateDto|null $feishu feishu
    *
    * @return $this
    */
    ...
    * Sets dingding
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\RepoNotificationSubscriptionStateDto|null $dingding dingding
    *
    * @return $this
    */
