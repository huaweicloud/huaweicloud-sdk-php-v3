...
class ListTenantEncryptedRepositoriesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTenantEncryptedRepositoriesRequest';
    ...
    * limit  **参数解释：** 返回数量。
    * orderBy  **参数解释：** 排序字段 repoName 仓库名称  ownerName | 仓库所有者名称 ownerName, 不传该字段时不进行排序
    ...
    */
    ...
    const ORDER_BY_REPO_NAME = 'repoName';
    const ORDER_BY_OWNER_NAME = 'ownerName';
    const SORT_ASC = 'asc';
    ...
    */
    ...
    {
        return [
            self::ORDER_BY_REPO_NAME,
            self::ORDER_BY_OWNER_NAME,
        ];
    }
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tenantId'] === null) {
            ...
            if ((mb_strlen($this->container['tenantId']) > 100000)) {
    ...
    * Sets tenantId
    *
    * @param string $tenantId **参数解释：** 租户id
    *
    * @return $this
    */
    ...
    * Sets orderBy
    *
    * @param string|null $orderBy **参数解释：** 排序字段 repoName 仓库名称  ownerName | 仓库所有者名称 ownerName, 不传该字段时不进行排序
    *
    * @return $this
    */
