...
class UpdateProjectNoteRequiredAttributesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateProjectNoteRequiredAttributesRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\PostNoteRequiredAttributeDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\PostNoteRequiredAttributeDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\PostNoteRequiredAttributeDto|null $body body
    *
    * @return $this
    */
