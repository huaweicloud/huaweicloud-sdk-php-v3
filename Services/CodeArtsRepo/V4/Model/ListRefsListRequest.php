...
class ListRefsListRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRefsListRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * repositoryId  **参数解释：** 仓库的ID，通过[[查询用户所有仓库](https://support.huaweicloud.com/api-codeartsrepo/ListUserAllRepositories.html)](tag:hws)[[查询用户所有仓库](https://support.huaweicloud.com/intl/en-us/api-codeartsrepo/ListUserAllRepositories.html)](tag:hws_hk)[[查询用户所有仓库](https://support.huaweicloud.com/eu/api-codeartsrepo/ListUserAllRepositories.html)](tag:hws_eu)[查询项目列表](tag:hcs,hcs_sm)接口查询项目列表获取。 **约束限制：** 不涉及。
    * type  **参数解释：** 分支或者tag。 **取值范围：** 只能为branch或者tag。 **约束限制：** 只能为branch或者tag。
    * search  **参数解释：** 搜索关键词。
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['repositoryId'] === null) {
            ...
            if (!is_null($this->container['search']) && (mb_strlen($this->container['search']) > 1000)) {
                $invalidProperties[] = "invalid value for 'search', the character length must be smaller than or equal to 1000.";
            }
    ...
    * Sets type
    *
    * @param string|null $type **参数解释：** 分支或者tag。 **取值范围：** 只能为branch或者tag。 **约束限制：** 只能为branch或者tag。
    *
    * @return $this
    */
    ...
    * Sets search
    *
    * @param string|null $search **参数解释：** 搜索关键词。
    *
    * @return $this
    */
