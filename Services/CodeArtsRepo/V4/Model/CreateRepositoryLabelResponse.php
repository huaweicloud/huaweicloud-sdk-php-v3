...
class CreateRepositoryLabelResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateRepositoryLabelResponse';
    ...
    * isRepositoryLabel  **参数解释：** 是否为仓库标签 **取值范围：** 不涉及
    *
    * @var string[]
    */
    ...
    */
    protected static $attributeMap = [
            ...
            'priority' => 'priority',
            'isRepositoryLabel' => 'is_repository_label'
    ];
    ...
    */
    protected static $setters = [
            ...
            'isRepositoryLabel' => 'setIsRepositoryLabel'
    ];
    ...
    */
    protected static $getters = [
            ...
            'isRepositoryLabel' => 'getIsRepositoryLabel'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['isRepositoryLabel'] = isset($data['isRepositoryLabel']) ? $data['isRepositoryLabel'] : null;
    }
    ...
    */
    ...
    /**
    * Gets isRepositoryLabel
    *  **参数解释：** 是否为仓库标签 **取值范围：** 不涉及
    *
    * @return bool|null
    */
    public function getIsRepositoryLabel()
    {
        return $this->container['isRepositoryLabel'];
    }

    /**
    * Sets isRepositoryLabel
    *
    * @param bool|null $isRepositoryLabel **参数解释：** 是否为仓库标签 **取值范围：** 不涉及
    *
    * @return $this
    */
    public function setIsRepositoryLabel($isRepositoryLabel)
    {
        $this->container['isRepositoryLabel'] = $isRepositoryLabel;
        return $this;
    }
