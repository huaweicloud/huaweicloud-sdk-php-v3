...
class UpdateProtectedBranchRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateProtectedBranchRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * repositoryId  **参数解释：** 仓库的ID，通过[[查询用户所有仓库](https://support.huaweicloud.com/api-codeartsrepo/ListUserAllRepositories.html)](tag:hws)[[查询用户所有仓库](https://support.huaweicloud.com/intl/en-us/api-codeartsrepo/ListUserAllRepositories.html)](tag:hws_hk)[[查询用户所有仓库](https://support.huaweicloud.com/eu/api-codeartsrepo/ListUserAllRepositories.html)](tag:hws_eu)[查询项目列表](tag:hcs,hcs_sm)接口查询项目列表获取。 **约束限制：** 不涉及。
    * branchName  **参数解释：** 保护分支名或通配符表达式。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    * body  保护分支权限列表
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'branchName' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ProtectedBranchProtectedActionBodyDto[]'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['branchName'] === null) {
            ...
            if ((mb_strlen($this->container['branchName']) > 255)) {
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ProtectedBranchProtectedActionBodyDto[]|null $body 保护分支权限列表
    *
    * @return $this
    */
