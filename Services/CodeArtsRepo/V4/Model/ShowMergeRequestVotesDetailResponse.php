...
class ShowMergeRequestVotesDetailResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'votes' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\MergeRequestVotesDto[]'
    ];
    ...
    *  **参数解释：** 个人打分详情。
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\MergeRequestVotesDto[]|null
    */
    ...
    * Sets votes
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\MergeRequestVotesDto[]|null $votes **参数解释：** 个人打分详情。
    *
    * @return $this
    */
