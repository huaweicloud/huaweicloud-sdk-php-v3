...
class ListGroupProtectedRefsUserGroupsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGroupProtectedRefsUserGroupsRequest';
