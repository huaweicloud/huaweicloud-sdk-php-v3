...
class ListProjectProtectedBranchesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListProjectProtectedBranchesRequest';
    ...
    * limit  **参数解释：** 返回数量。
    * search  **参数解释：** 保护分支名称。 **取值范围：** 字符串长度不少于1，不超过2000。
    * userActions  **参数解释：** 是否使用actions权限点的返回内容。 **取值范围：** 字符串长度不少于1，不超过2000。
    * view  **参数解释：** 参数值只有simple ，意为使用简单模式，只返回名称。 **取值范围：** 字符串长度不少于1，不超过2000。
    *
    * @var string[]
    */
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['userActions'] = isset($data['userActions']) ? $data['userActions'] : null;
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['projectId'] === null) {
            ...
            if (!is_null($this->container['view']) && (mb_strlen($this->container['view']) > 2000)) {
                $invalidProperties[] = "invalid value for 'view', the character length must be smaller than or equal to 2000.";
            }
            if (!is_null($this->container['view']) && (mb_strlen($this->container['view']) < 1)) {
                $invalidProperties[] = "invalid value for 'view', the character length must be bigger than or equal to 1.";
            }
    ...
    * Sets search
    *
    * @param string|null $search **参数解释：** 保护分支名称。 **取值范围：** 字符串长度不少于1，不超过2000。
    *
    * @return $this
    */
    ...
    */
    ...
    {
        return $this->container['userActions'];
    }

    /**
    * Sets userActions
    *
    * @param bool|null $userActions **参数解释：** 是否使用actions权限点的返回内容。 **取值范围：** 字符串长度不少于1，不超过2000。
    *
    * @return $this
    */
    public function setUserActions($userActions)
    {
        $this->container['userActions'] = $userActions;
        return $this;
    }
    ...
    * Sets view
    *
    * @param string|null $view **参数解释：** 参数值只有simple ，意为使用简单模式，只返回名称。 **取值范围：** 字符串长度不少于1，不超过2000。
    *
    * @return $this
    */
