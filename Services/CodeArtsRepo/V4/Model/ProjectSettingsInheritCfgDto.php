...
class ProjectSettingsInheritCfgDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ProjectSettingsInheritCfgDto';
    ...
    * Sets inheritMod
    *
    * @param string|null $inheritMod **参数解释：** 继承设置。 **约束限制：** 不涉及。 **取值范围：** - force_inherit，强制继承配置。 - custom，使用当前配置。 **默认取值：** 不涉及。
    *
    * @return $this
    */
