...
class ListMergeRequestConflictFilesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListMergeRequestConflictFilesRequest';
    ...
    * limit  **参数解释：** 返回数量。
    * hideContent  **参数解释：** 如为true,隐藏文件冲突详情
    *
    * @var string[]
    */
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['hideContent'] = isset($data['hideContent']) ? $data['hideContent'] : null;
    }
    ...
    */
    ...
    {
        return $this->container['hideContent'];
    }

    /**
    * Sets hideContent
    *
    * @param bool|null $hideContent **参数解释：** 如为true,隐藏文件冲突详情
    *
    * @return $this
    */
    public function setHideContent($hideContent)
    {
        $this->container['hideContent'] = $hideContent;
        return $this;
    }
