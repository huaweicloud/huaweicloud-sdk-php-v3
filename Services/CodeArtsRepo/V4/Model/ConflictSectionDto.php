...
class ConflictSectionDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'conflict' => 'bool',
            'lines' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ConflictSectionLineDto[]',
            'id' => 'string'
    ];
    ...
    *  冲突行列表
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ConflictSectionLineDto[]|null
    */
    ...
    * Sets lines
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ConflictSectionLineDto[]|null $lines 冲突行列表
    *
    * @return $this
    */
