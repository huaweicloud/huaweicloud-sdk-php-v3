...
class ShowRepositoryNavigationOutlineResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowRepositoryNavigationOutlineResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'filePath' => 'string',
            'revision' => 'string',
            'symbols' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\SymbolNodeDto[]'
    ];
    ...
    * Sets symbols
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\SymbolNodeDto[]|null $symbols **参数解释：** 符号列表。 **约束限制：** 不涉及。
    *
    * @return $this
    */
