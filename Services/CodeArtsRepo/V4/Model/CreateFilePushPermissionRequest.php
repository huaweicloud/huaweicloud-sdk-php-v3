...
class CreateFilePushPermissionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateFilePushPermissionRequest';
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'body' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\CreateRepositoryFilePushPermissionDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\CreateRepositoryFilePushPermissionDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\CreateRepositoryFilePushPermissionDto|null $body body
    *
    * @return $this
    */
