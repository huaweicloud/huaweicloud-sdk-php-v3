...
class ListCommitAssociatedMergeRequestsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCommitAssociatedMergeRequestsRequest';
