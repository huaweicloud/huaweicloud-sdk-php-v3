...
class UpdateProjectMergeRequestTemplateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateProjectMergeRequestTemplateRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'templateId' => 'int',
            'body' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\CreateMergeRequestTemplateDto'
    ];
    ...
    * Sets templateId
    *
    * @param int $templateId **参数解释：** 合并请求模板id。
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\CreateMergeRequestTemplateDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\CreateMergeRequestTemplateDto|null $body body
    *
    * @return $this
    */
