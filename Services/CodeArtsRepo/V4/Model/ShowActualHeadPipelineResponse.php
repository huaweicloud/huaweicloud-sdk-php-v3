...
class ShowActualHeadPipelineResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'data' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\PipelineDetailDto',
            'isValid' => 'bool'
    ];
    ...
    *  data
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\PipelineDetailDto|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\PipelineDetailDto|null $data data
    *
    * @return $this
    */
