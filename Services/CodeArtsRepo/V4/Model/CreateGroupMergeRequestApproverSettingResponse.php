...
class CreateGroupMergeRequestApproverSettingResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateGroupMergeRequestApproverSettingResponse';
