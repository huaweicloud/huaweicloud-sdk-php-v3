...
class ListProjectMergeRequestCanBeAssignedReviewersRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListProjectMergeRequestCanBeAssignedReviewersRequest';
