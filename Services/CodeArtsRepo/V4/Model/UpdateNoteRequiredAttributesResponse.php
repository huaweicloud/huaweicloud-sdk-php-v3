...
class UpdateNoteRequiredAttributesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateNoteRequiredAttributesResponse';
