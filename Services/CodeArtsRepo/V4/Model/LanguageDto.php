...
class LanguageDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'LanguageDto';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  **参数解释：** 语言名称。 **约束限制：** 不涉及。
    * extensionList  **参数解释：** 文件后缀名。 **约束限制：** 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets name
    *
    * @param string|null $name **参数解释：** 语言名称。 **约束限制：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets extensionList
    *
    * @param string[]|null $extensionList **参数解释：** 文件后缀名。 **约束限制：** 不涉及。
    *
    * @return $this
    */
