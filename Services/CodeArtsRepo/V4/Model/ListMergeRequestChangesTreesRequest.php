...
class ListMergeRequestChangesTreesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListMergeRequestChangesTreesRequest';
    ...
    */
    protected static $setters = [
            ...
            'approvalUserId' => 'setApprovalUserId',
    ...
    */
    protected static $getters = [
            ...
            'approvalUserId' => 'getApprovalUserId',
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['approvalUserId'] = isset($data['approvalUserId']) ? $data['approvalUserId'] : null;
    ...
    */
    ...
    {
        return $this->container['approvalUserId'];
    }

    /**
    * Sets approvalUserId
    *
    * @param int|null $approvalUserId **参数解释：** 审核人ID。
    *
    * @return $this
    */
    public function setApprovalUserId($approvalUserId)
    {
        $this->container['approvalUserId'] = $approvalUserId;
        return $this;
    }
