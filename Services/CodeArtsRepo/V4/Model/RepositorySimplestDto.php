...
class RepositorySimplestDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'forkedFromRepository' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ForkedFromRepositorySimplestDto',
            'permissions' => 'int',
            'archived' => 'bool',
            'memberCount' => 'int',
            'uuid' => 'string',
    ...
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ForkedFromRepositorySimplestDto|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ForkedFromRepositorySimplestDto|null $forkedFromRepository forkedFromRepository
    *
    * @return $this
    */
