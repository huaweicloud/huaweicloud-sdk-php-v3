...
class ProjectProtectedTagPo implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'updatedAt' => 'string',
            'name' => 'string',
            'actions' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ProjectProtectedActionResultDto[]'
    ];
    ...
    *  **参数解释：** 事件列表。
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ProjectProtectedActionResultDto[]|null
    */
    ...
    * Sets actions
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ProjectProtectedActionResultDto[]|null $actions **参数解释：** 事件列表。
    *
    * @return $this
    */
