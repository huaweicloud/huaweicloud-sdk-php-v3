...
class CommitMergeRequestDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'webUrl' => 'string',
            'timeStats' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\IssuableTimeStatsDto',
            'squash' => 'bool',
    ...
    * Sets assignee
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UserBasicDto[]|null $assignee **参数解释：** 合并请求的可合并人列表。
    *
    * @return $this
    */
    ...
    *  timeStats
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\IssuableTimeStatsDto|null
    */
    ...
    * Sets timeStats
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\IssuableTimeStatsDto|null $timeStats timeStats
    *
    * @return $this
    */
