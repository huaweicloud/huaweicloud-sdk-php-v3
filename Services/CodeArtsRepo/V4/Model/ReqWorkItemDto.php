...
class ReqWorkItemDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'subject' => 'string',
            'sequence' => 'string',
            'tracker' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ReqWorkItemBasicDto',
            'status' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ReqWorkItemBasicDto',
            'priority' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ReqWorkItemBasicDto'
    ];
    ...
    *  tracker
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ReqWorkItemBasicDto|null
    */
    ...
    * Sets tracker
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ReqWorkItemBasicDto|null $tracker tracker
    *
    * @return $this
    */
    ...
    * Sets status
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ReqWorkItemBasicDto|null $status status
    *
    * @return $this
    */
    ...
    * Sets priority
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\ReqWorkItemBasicDto|null $priority priority
    *
    * @return $this
    */
