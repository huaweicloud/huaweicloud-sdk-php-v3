...
class PipelineStageJobDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'sortId' => 'int',
            'status' => 'string',
            'jobs' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\BaseJobDto[]'
    ];
    ...
    *  jobs
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\BaseJobDto[]|null
    */
    ...
    * Sets jobs
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\BaseJobDto[]|null $jobs jobs
    *
    * @return $this
    */
