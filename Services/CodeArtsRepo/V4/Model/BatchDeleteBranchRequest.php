...
class BatchDeleteBranchRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteBranchRequest';
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'body' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\BatchDeleteBranchDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\BatchDeleteBranchDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\BatchDeleteBranchDto|null $body body
    *
    * @return $this
    */
