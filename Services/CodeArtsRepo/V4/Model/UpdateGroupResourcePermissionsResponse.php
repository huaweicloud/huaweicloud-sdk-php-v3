...
class UpdateGroupResourcePermissionsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateGroupResourcePermissionsResponse';
