...
class UpdateMergeRequestRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateMergeRequestRequest';
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'mergeRequestIid' => 'int',
            'body' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\PutMergeRequestParamsDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\PutMergeRequestParamsDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\PutMergeRequestParamsDto|null $body body
    *
    * @return $this
    */
