...
class GroupSumDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GroupSumDto';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * openMergeRequestsCount  打开状态MR计数
    *
    * @var string[]
    */
    ...
    *
    * @param int|null $openMergeRequestsCount 打开状态MR计数
    *
    * @return $this
    */
