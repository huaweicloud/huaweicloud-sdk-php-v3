...
class ShowTenantRepoEncryptionSettingRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowTenantRepoEncryptionSettingRequest';
