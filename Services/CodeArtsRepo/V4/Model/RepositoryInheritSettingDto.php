...
class RepositoryInheritSettingDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RepositoryInheritSettingDto';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  **参数解释：** 设置源类型。 **取值范围：** - protected_branches，保护分支设置。 - protected_tags，保护Tag设置。 - repository_settings，仓库设置。 - push_rules，提交规则设置。 - merge_requests，合并请求设置。 - mr_branch_policies，分支策略设置。 - reviews，检视意见设置。 - e2e_settings，E2E设置。 - watermark，水印设置。
    * inheritMod  **参数解释：** 继承设置。 **取值范围：** - inherit，继承上级配置。 - custom，使用当前仓库配置。 - force_inherit，强制继承上级配置。
    *
    * @var string[]
    */
    ...
    */
    public function getInheritModAllowableValues()
    {
        return [
            ...
            self::INHERIT_MOD_FORCE_INHERIT,
        ];
    }
    ...
    * Sets name
    *
    * @param string|null $name **参数解释：** 设置源类型。 **取值范围：** - protected_branches，保护分支设置。 - protected_tags，保护Tag设置。 - repository_settings，仓库设置。 - push_rules，提交规则设置。 - merge_requests，合并请求设置。 - mr_branch_policies，分支策略设置。 - reviews，检视意见设置。 - e2e_settings，E2E设置。 - watermark，水印设置。
    *
    * @return $this
    */
    ...
    * Sets inheritMod
    *
    * @param string|null $inheritMod **参数解释：** 继承设置。 **取值范围：** - inherit，继承上级配置。 - custom，使用当前仓库配置。 - force_inherit，强制继承上级配置。
    *
    * @return $this
    */
