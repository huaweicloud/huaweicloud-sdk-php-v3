...
class UpdatePermissionDto implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'roleId' => 'string',
            'roleName' => 'string',
            'permissions' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UpdatePermissionDetail[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UpdatePermissionDetail[]|null
    */
    ...
    * Sets permissions
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\UpdatePermissionDetail[]|null $permissions **参数解释：** 更新权限点详情 **取值范围：** 不涉及。
    *
    * @return $this
    */
