...
class CreateTenantKmsGrantResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateTenantKmsGrantResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * tenantId  **参数解释：** 租户id。 **取值范围：** 字符串长度不少于1，不超过1000。
    * assumed  **参数解释：** 是否有委托和授权。
    *
    * @var string[]
    */
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['assumed'] = isset($data['assumed']) ? $data['assumed'] : null;
    }
    ...
    */
    ...
    {
        return $this->container['assumed'];
    }

    /**
    * Sets assumed
    *
    * @param bool|null $assumed **参数解释：** 是否有委托和授权。
    *
    * @return $this
    */
    public function setAssumed($assumed)
    {
        $this->container['assumed'] = $assumed;
        return $this;
    }
