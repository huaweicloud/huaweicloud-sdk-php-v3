...
class UpdateMergeRequestVoteRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateMergeRequestVoteRequest';
    ...
    */
    protected static $openAPITypes = [
            'repositoryId' => 'int',
            'mergeRequestIid' => 'int',
            'body' => '\HuaweiCloud\SDK\CodeArtsRepo\V4\Model\MergeRequestVoteBodyDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\MergeRequestVoteBodyDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsRepo\V4\Model\MergeRequestVoteBodyDto|null $body body
    *
    * @return $this
    */
