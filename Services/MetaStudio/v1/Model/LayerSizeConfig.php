...
class LayerSizeConfig implements ModelInterface, ArrayAccess
{
    ...
    * width  图层图片宽度像素值（相对背景图片）。 > 横屏（16:9）背景图片像素为1920x1080；竖屏（9:16）背景图片像素为1080x1920。
    * height  图层图片高度像素值（相对背景图片）。 > 横屏（16:9）背景图片像素为1920x1080；竖屏（9:16）背景图片像素为1080x1920。
    *
    * @var string[]
    */
    ...
    * Sets width
    *
    * @param int|null $width 图层图片宽度像素值（相对背景图片）。 > 横屏（16:9）背景图片像素为1920x1080；竖屏（9:16）背景图片像素为1080x1920。
    *
    * @return $this
    */
    ...
    * Sets height
    *
    * @param int|null $height 图层图片高度像素值（相对背景图片）。 > 横屏（16:9）背景图片像素为1920x1080；竖屏（9:16）背景图片像素为1080x1920。
    *
    * @return $this
    */
