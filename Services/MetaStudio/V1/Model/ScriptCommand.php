...
class ScriptCommand implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'jobId' => 'string',
            'commandId' => 'string',
            'sceneScripts' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\LivePlayingScriptInfo[]'
    ];
    ...
    *  直播剧本列表。
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\LivePlayingScriptInfo[]|null
    */
    ...
    * Sets sceneScripts
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\LivePlayingScriptInfo[]|null $sceneScripts 直播剧本列表。
    *
    * @return $this
    */
