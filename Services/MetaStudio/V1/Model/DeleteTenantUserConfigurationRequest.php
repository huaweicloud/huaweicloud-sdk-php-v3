...
class DeleteTenantUserConfigurationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteTenantUserConfigurationRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xSdkDate' => 'string',
            'xProjectId' => 'string',
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\DeleteTenantUserConfigurationReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\DeleteTenantUserConfigurationReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\DeleteTenantUserConfigurationReq|null $body body
    *
    * @return $this
    */
