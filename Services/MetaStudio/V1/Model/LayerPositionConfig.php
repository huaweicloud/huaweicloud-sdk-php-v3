...
class LayerPositionConfig implements ModelInterface, ArrayAccess
{
    ...
    * layerIndex  **参数解释**： 图片、视频、人物图的层顺序。 > 图层顺序为0从1开始的整数，底层图层顺序是1，往上依次增加。  **约束限制**： 如果出现重复则重复图层叠加关系随机。
    *
    * @var string[]
    */
    ...
    * Sets layerIndex
    *
    * @param int $layerIndex **参数解释**： 图片、视频、人物图的层顺序。 > 图层顺序为0从1开始的整数，底层图层顺序是1，往上依次增加。  **约束限制**： 如果出现重复则重复图层叠加关系随机。
    *
    * @return $this
    */
