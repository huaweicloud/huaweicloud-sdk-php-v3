...
class SearchTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchTaskRequest';
    ...
    * resource  资源类型
    * businessId  业务id,比如问答时传入skill_id
    * beginTime  开始时间戳
    * endTime  结束时间戳
    *
    * @var string[]
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['businessId']) && !preg_match("/^[a-zA-Z0-9_-]*$/", $this->container['businessId'])) {
                $invalidProperties[] = "invalid value for 'businessId', must be conform to the pattern /^[a-zA-Z0-9_-]*$/.";
            }
            if (!is_null($this->container['beginTime']) && (mb_strlen($this->container['beginTime']) > 15)) {
                $invalidProperties[] = "invalid value for 'beginTime', the character length must be smaller than or equal to 15.";
            }
            if (!is_null($this->container['beginTime']) && !preg_match("/^[0-9]*$/", $this->container['beginTime'])) {
                $invalidProperties[] = "invalid value for 'beginTime', must be conform to the pattern /^[0-9]*$/.";
            }
            if (!is_null($this->container['endTime']) && (mb_strlen($this->container['endTime']) > 15)) {
                $invalidProperties[] = "invalid value for 'endTime', the character length must be smaller than or equal to 15.";
            }
            if (!is_null($this->container['endTime']) && !preg_match("/^[0-9]*$/", $this->container['endTime'])) {
                $invalidProperties[] = "invalid value for 'endTime', must be conform to the pattern /^[0-9]*$/.";
            }
    ...
    * Sets businessId
    *
    * @param string|null $businessId 业务id,比如问答时传入skill_id
    *
    * @return $this
    */
    ...
    * Sets beginTime
    *
    * @param string|null $beginTime 开始时间戳
    *
    * @return $this
    */
    ...
    * Sets endTime
    *
    * @param string|null $endTime 结束时间戳
    *
    * @return $this
    */
