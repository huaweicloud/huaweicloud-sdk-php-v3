...
class ShowKnowledgeQuestionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowKnowledgeQuestionResponse';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['question']) && (mb_strlen($this->container['question']) > 64)) {
