...
class CreateMetaStudioOrdersResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateMetaStudioOrdersResponse';
    ...
    * Sets orderId
    *
    * @param string|null $orderId 订购的订单结果信息列表；
    *
    * @return $this
    */
