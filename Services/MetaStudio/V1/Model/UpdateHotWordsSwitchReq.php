...
class UpdateHotWordsSwitchReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateHotWordsSwitchReq';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * robotId  应用ID。
    * enableHotWords  热词功能开关。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['enableHotWords'] === null) {
            $invalidProperties[] = "'enableHotWords' can't be null";
        }
    ...
    * Sets enableHotWords
    *
    * @param bool $enableHotWords 热词功能开关。
    *
    * @return $this
    */
