...
class ListKnowledgeLibraryRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListKnowledgeLibraryRequest';
    ...
    * limit  每页显示的条目数量。
    * language  角色语言  * CN：中文  * EN：英文
    * knowledgeType  知识库类型  * QUESTION_ANSWER：问答  * DOCUMENT：文档
    * name  知识库名称
    *
    * @var string[]
    */
    ...
    */
    ...
    const KNOWLEDGE_TYPE_QUESTION_ANSWER = 'QUESTION_ANSWER';
    const KNOWLEDGE_TYPE_DOCUMENT = 'DOCUMENT';
    ...
    * @return string[]
    */
    public function getKnowledgeTypeAllowableValues()
    {
        return [
            self::KNOWLEDGE_TYPE_QUESTION_ANSWER,
            self::KNOWLEDGE_TYPE_DOCUMENT,
        ];
    }
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            $allowedValues = $this->getKnowledgeTypeAllowableValues();
                if (!is_null($this->container['knowledgeType']) && !in_array($this->container['knowledgeType'], $allowedValues, true)) {
                $invalidProperties[] = sprintf(
                "invalid value for 'knowledgeType', must be one of '%s'",
                implode("', '", $allowedValues)
                );
            }
    ...
    * Sets language
    *
    * @param string|null $language 角色语言  * CN：中文  * EN：英文
    *
    * @return $this
    */
    ...
    * Sets knowledgeType
    *
    * @param string|null $knowledgeType 知识库类型  * QUESTION_ANSWER：问答  * DOCUMENT：文档
    *
    * @return $this
    */
