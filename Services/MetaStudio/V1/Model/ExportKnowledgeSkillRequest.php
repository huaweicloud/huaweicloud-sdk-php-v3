...
class ExportKnowledgeSkillRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExportKnowledgeSkillRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['exportType'] === null) {
            ...
            if (($this->container['exportType'] > 64)) {
                $invalidProperties[] = "invalid value for 'exportType', must be smaller than or equal to 64.";
            }
            if (($this->container['exportType'] < 0)) {
                $invalidProperties[] = "invalid value for 'exportType', must be bigger than or equal to 0.";
            }
    ...
    * Sets exportType
    *
    * @param int $exportType 导出格式类型。0：科大讯飞
    *
    * @return $this
    */
