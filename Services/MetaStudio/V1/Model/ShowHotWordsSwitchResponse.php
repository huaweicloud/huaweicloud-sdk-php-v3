...
class ShowHotWordsSwitchResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowHotWordsSwitchResponse';
    ...
    * Sets enableHotWords
    *
    * @param bool|null $enableHotWords 热词功能开关。
    *
    * @return $this
    */
