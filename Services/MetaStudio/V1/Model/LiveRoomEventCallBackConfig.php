...
class LiveRoomEventCallBackConfig implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'LiveRoomEventCallBackConfig';
    ...
    * isInheritancePlatformCallback  **参数解释**： 是否继承直播平台回调配置，默认true **约束限制**： 不涉及。 **取值范围**： true：继承直播平台callback配置 false：不继承直播平台callback配置 **默认取值**： false
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'isInheritancePlatformCallback' => 'bool'
    ];
    ...
    */
    protected static $openAPIFormats = [
        ...
        'isInheritancePlatformCallback' => null
    ];
    ...
    */
    protected static $attributeMap = [
            ...
            'isInheritancePlatformCallback' => 'is_inheritance_platform_callback'
    ];
    ...
    */
    protected static $setters = [
            ...
            'isInheritancePlatformCallback' => 'setIsInheritancePlatformCallback'
    ];
    ...
    */
    protected static $getters = [
            ...
            'isInheritancePlatformCallback' => 'getIsInheritancePlatformCallback'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['isInheritancePlatformCallback'] = isset($data['isInheritancePlatformCallback']) ? $data['isInheritancePlatformCallback'] : null;
    }
    ...
    */
    ...
    /**
    * Gets isInheritancePlatformCallback
    *  **参数解释**： 是否继承直播平台回调配置，默认true **约束限制**： 不涉及。 **取值范围**： true：继承直播平台callback配置 false：不继承直播平台callback配置 **默认取值**： false
    *
    * @return bool|null
    */
    public function getIsInheritancePlatformCallback()
    {
        return $this->container['isInheritancePlatformCallback'];
    }

    /**
    * Sets isInheritancePlatformCallback
    *
    * @param bool|null $isInheritancePlatformCallback **参数解释**： 是否继承直播平台回调配置，默认true **约束限制**： 不涉及。 **取值范围**： true：继承直播平台callback配置 false：不继承直播平台callback配置 **默认取值**： false
    *
    * @return $this
    */
    public function setIsInheritancePlatformCallback($isInheritancePlatformCallback)
    {
