...
class ListLivePlatformProductsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListLivePlatformProductsRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['platformId'] === null) {
            ...
            if ((mb_strlen($this->container['platformId']) < 1)) {
        ...
        if ($this->container['liveId'] === null) {
            ...
            if ((mb_strlen($this->container['liveId']) < 1)) {
                $invalidProperties[] = "invalid value for 'liveId', the character length must be bigger than or equal to 1.";
            }
