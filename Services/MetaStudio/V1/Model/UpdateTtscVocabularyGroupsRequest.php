...
class UpdateTtscVocabularyGroupsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateTtscVocabularyGroupsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xAppUserId' => 'string',
            'groupId' => 'string',
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\SaveTtscVocabularyGroupsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\SaveTtscVocabularyGroupsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\SaveTtscVocabularyGroupsRequestBody|null $body body
    *
    * @return $this
    */
