...
class ListTtscVocabularyConfigsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTtscVocabularyConfigsResponse';
    ...
    */
    protected static $openAPITypes = [
            'count' => 'int',
            'data' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\VocabularyConfig[]'
    ];
