...
class CreateTtscVocabularyConfigsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateTtscVocabularyConfigsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xProjectId' => 'string',
            'xAppUserId' => 'string',
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\SaveTtscVocabularyConfigsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\SaveTtscVocabularyConfigsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\SaveTtscVocabularyConfigsRequestBody|null $body body
    *
    * @return $this
    */
