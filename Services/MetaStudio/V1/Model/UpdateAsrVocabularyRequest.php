...
class UpdateAsrVocabularyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAsrVocabularyRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateAsrVocabularyReq'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['asrVocabularyId'] === null) {
            $invalidProperties[] = "'asrVocabularyId' can't be null";
        }
            if ((mb_strlen($this->container['asrVocabularyId']) > 64)) {
                $invalidProperties[] = "invalid value for 'asrVocabularyId', the character length must be smaller than or equal to 64.";
            }
            if ((mb_strlen($this->container['asrVocabularyId']) < 1)) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateAsrVocabularyReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateAsrVocabularyReq|null $body body
    *
    * @return $this
    */
