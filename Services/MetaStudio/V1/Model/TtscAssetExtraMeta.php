...
class TtscAssetExtraMeta implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TtscAssetExtraMeta';
    ...
    */
    protected static $openAPITypes = [
            'voiceModelMeta' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\TtscVoiceModelAssetMeta'
    ];
    ...
    *  voiceModelMeta
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\TtscVoiceModelAssetMeta|null
    */
    ...
    * Sets voiceModelMeta
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\TtscVoiceModelAssetMeta|null $voiceModelMeta voiceModelMeta
    *
    * @return $this
    */
