...
class ShowTenantNoticeConfigurationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowTenantNoticeConfigurationRequest';
