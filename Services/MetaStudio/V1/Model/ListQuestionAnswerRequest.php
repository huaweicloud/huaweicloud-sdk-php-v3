...
class ListQuestionAnswerRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListQuestionAnswerRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['knowledgeLibraryId'] === null) {
            ...
            if (!is_null($this->container['question']) && (mb_strlen($this->container['question']) > 128)) {
                $invalidProperties[] = "invalid value for 'question', the character length must be smaller than or equal to 128.";
            }
