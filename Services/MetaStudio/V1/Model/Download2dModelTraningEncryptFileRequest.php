...
class Download2dModelTraningEncryptFileRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'Download2dModelTraningEncryptFileRequest';
