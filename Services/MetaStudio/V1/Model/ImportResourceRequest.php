...
class ImportResourceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImportResourceRequest';
    ...
    * resource  资源名称
    * businessId  业务id,比如问答模板时传入skill_id
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'resource' => 'string',
            'businessId' => 'string',
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\ImportResourceRequestBody'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['resource'] === null) {
            ...
            if (!preg_match("/^[a-zA-Z0-9_-]*$/", $this->container['resource'])) {
    ...
    * Sets businessId
    *
    * @param string|null $businessId 业务id,比如问答模板时传入skill_id
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\ImportResourceRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\ImportResourceRequestBody|null $body body
    *
    * @return $this
    */
