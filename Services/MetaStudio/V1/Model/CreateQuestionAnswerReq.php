...
class CreateQuestionAnswerReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateQuestionAnswerReq';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['question'] === null) {
            ...
            if ((mb_strlen($this->container['question']) > 256)) {
