...
class ListInteractionRuleGroupsSummaryRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInteractionRuleGroupsSummaryRequest';
