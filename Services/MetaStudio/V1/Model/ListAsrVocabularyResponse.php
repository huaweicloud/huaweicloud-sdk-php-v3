...
class ListAsrVocabularyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAsrVocabularyResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'limit' => 'int',
            'count' => 'int',
            'data' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\AsrVocabularyInfo[]',
            'xRequestId' => 'string'
    ];
    ...
    *  热词表信息
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\AsrVocabularyInfo[]|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\AsrVocabularyInfo[]|null $data 热词表信息
    *
    * @return $this
    */
