...
class DeleteTtscVocabularyConfigsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteTtscVocabularyConfigsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'offset' => 'int',
            'limit' => 'int',
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\DeleteTtscVocabularyConfigsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\DeleteTtscVocabularyConfigsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\DeleteTtscVocabularyConfigsRequestBody|null $body body
    *
    * @return $this
    */
