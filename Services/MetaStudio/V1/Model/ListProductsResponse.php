...
class ListProductsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'count' => 'int',
            'products' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\ProductDetailInfo[]',
            'xRequestId' => 'string'
    ];
    ...
    * Sets count
    *
    * @param int|null $count **参数解释**： 商品信息总数
    *
    * @return $this
    */
    ...
    *  商品信息列表
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\ProductDetailInfo[]|null
    */
    ...
    * Sets products
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\ProductDetailInfo[]|null $products 商品信息列表
    *
    * @return $this
    */
