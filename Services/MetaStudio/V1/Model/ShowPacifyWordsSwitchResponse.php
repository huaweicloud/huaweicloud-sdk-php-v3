...
class ShowPacifyWordsSwitchResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowPacifyWordsSwitchResponse';
    ...
    *
    * @param bool|null $enablePacifyWords 安抚话术功能开关。
    *
    * @return $this
    */
