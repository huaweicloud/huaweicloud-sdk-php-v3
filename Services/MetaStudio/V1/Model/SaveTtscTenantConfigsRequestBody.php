...
class SaveTtscTenantConfigsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SaveTtscTenantConfigsRequestBody';
    ...
    * Sets key
    *
    * @param string $key 租户级的配置项，当前只用于词表
    *
    * @return $this
    */
