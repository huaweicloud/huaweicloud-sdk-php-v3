...
class TtscGroupAssetsConfig implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TtscGroupAssetsConfig';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * groupId  分组id
    * groupName  分组名称
    * assetIds  每个分组的资产id列表
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['groupId']) && (mb_strlen($this->container['groupId']) > 48)) {
                $invalidProperties[] = "invalid value for 'groupId', the character length must be smaller than or equal to 48.";
            }
    ...
    * Sets assetIds
    *
    * @param string[]|null $assetIds 每个分组的资产id列表
    *
    * @return $this
    */
