...
class UpdateHotQuestionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateHotQuestionRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateHotQuestionReq'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['hotQuestionId'] === null) {
            $invalidProperties[] = "'hotQuestionId' can't be null";
        }
            if ((mb_strlen($this->container['hotQuestionId']) > 64)) {
                $invalidProperties[] = "invalid value for 'hotQuestionId', the character length must be smaller than or equal to 64.";
            }
            if ((mb_strlen($this->container['hotQuestionId']) < 1)) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateHotQuestionReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateHotQuestionReq|null $body body
    *
    * @return $this
    */
