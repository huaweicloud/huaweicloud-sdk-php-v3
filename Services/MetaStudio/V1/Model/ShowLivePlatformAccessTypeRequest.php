...
class ShowLivePlatformAccessTypeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowLivePlatformAccessTypeRequest';
