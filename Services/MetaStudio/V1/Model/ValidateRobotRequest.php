...
class ValidateRobotRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ValidateRobotRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xProjectId' => 'string',
            'xAppUserId' => 'string',
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\ValidateRobotReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\ValidateRobotReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\ValidateRobotReq|null $body body
    *
    * @return $this
    */
