...
class ExecuteTransferAssetActionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExecuteTransferAssetActionRequest';
    ...
    * action  控制。 cancel：取消资产转移，仅转移发起方可调用。 accept：接受资产转移，仅转移接受方可调用。 accept_confirm：确认接受资产转移，仅转移接受方可调用，仅需要计费的转移需再次确认。 reject: 拒绝资产转移，仅转移接受方可调用。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'xSdkDate' => 'string',
            'action' => 'string',
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\TransJobRejectBody'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['action'] === null) {
            ...
            if (!preg_match("/cancel|accept|reject|accept_confirm/", $this->container['action'])) {
                $invalidProperties[] = "invalid value for 'action', must be conform to the pattern /cancel|accept|reject|accept_confirm/.";
            }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\TransJobRejectBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\TransJobRejectBody|null $body body
    *
    * @return $this
    */
