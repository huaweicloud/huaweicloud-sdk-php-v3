...
class UpdateLlmConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateLlmConfigRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xAppUserId' => 'string',
            'llmConfigId' => 'string',
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateLlmConfigReq'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['llmConfigId'] === null) {
            $invalidProperties[] = "'llmConfigId' can't be null";
        }
            if ((mb_strlen($this->container['llmConfigId']) > 64)) {
                $invalidProperties[] = "invalid value for 'llmConfigId', the character length must be smaller than or equal to 64.";
            }
            if ((mb_strlen($this->container['llmConfigId']) < 1)) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateLlmConfigReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateLlmConfigReq|null $body body
    *
    * @return $this
    */
