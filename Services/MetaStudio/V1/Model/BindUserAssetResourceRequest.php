...
class BindUserAssetResourceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BindUserAssetResourceRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xSdkDate' => 'string',
            'xProjectId' => 'string',
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\BindAssetResourceReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\BindAssetResourceReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\BindAssetResourceReq|null $body body
    *
    * @return $this
    */
