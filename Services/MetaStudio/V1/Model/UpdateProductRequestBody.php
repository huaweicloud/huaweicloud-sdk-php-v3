...
class UpdateProductRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateProductRequestBody';
    ...
    * Sets state
    *
    * @param string|null $state 商品状态枚举 * ACTIVED：已激活 * UNACTIVED：未激活
    *
    * @return $this
    */
