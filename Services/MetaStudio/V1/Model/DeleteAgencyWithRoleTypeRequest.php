...
class DeleteAgencyWithRoleTypeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteAgencyWithRoleTypeRequest';
    ...
    */
    ...
    const ROLE_TYPE_CBS = 'CBS';
    const ROLE_TYPE_SIS = 'SIS';
