...
class UpdatePluginConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePluginConfigRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\UpdatePluginConfigReq'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pluginConfigId'] === null) {
            $invalidProperties[] = "'pluginConfigId' can't be null";
        }
            if ((mb_strlen($this->container['pluginConfigId']) > 64)) {
                $invalidProperties[] = "invalid value for 'pluginConfigId', the character length must be smaller than or equal to 64.";
            }
            if ((mb_strlen($this->container['pluginConfigId']) < 1)) {
                $invalidProperties[] = "invalid value for 'pluginConfigId', the character length must be bigger than or equal to 1.";
            }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\UpdatePluginConfigReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\UpdatePluginConfigReq|null $body body
    *
    * @return $this
    */
