...
class ExportResourceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExportResourceRequest';
    ...
    * resource  资源名称
    * businessId  业务id,比如问答模板是传入skill_id
    *
    * @var string[]
    */
    ...
    * Sets businessId
    *
    * @param string|null $businessId 业务id,比如问答模板是传入skill_id
    *
    * @return $this
    */
