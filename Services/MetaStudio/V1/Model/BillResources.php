...
class BillResources implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BillResources';
    ...
    */
    protected static $openAPITypes = [
            'resourceType' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\BillResourceType',
            'resourceNums' => 'int'
    ];
    ...
    *  resourceType
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\BillResourceType|null
    */
    ...
    * Sets resourceType
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\BillResourceType|null $resourceType resourceType
    *
    * @return $this
    */
    ...
    * Sets resourceNums
    *
    * @param int|null $resourceNums 资源数量。
    *
    * @return $this
    */
