...
class SetTtscGroupAssetsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SetTtscGroupAssetsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xAppUserId' => 'string',
            'groupId' => 'string',
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\SetTtscGroupAssetsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\SetTtscGroupAssetsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\SetTtscGroupAssetsRequestBody|null $body body
    *
    * @return $this
    */
