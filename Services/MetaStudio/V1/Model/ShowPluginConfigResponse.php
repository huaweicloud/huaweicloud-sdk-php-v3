...
class ShowPluginConfigResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowPluginConfigResponse';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['pluginConfigId']) && (mb_strlen($this->container['pluginConfigId']) < 1)) {
    ...
    *  pluginProvider
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\PluginProviderEnum|null
    */
    ...
    * Sets pluginProvider
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\PluginProviderEnum|null $pluginProvider pluginProvider
    *
    * @return $this
    */
