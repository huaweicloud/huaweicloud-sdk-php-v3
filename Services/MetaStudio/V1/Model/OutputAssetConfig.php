...
class OutputAssetConfig implements ModelInterface, ArrayAccess
{
    ...
    * assetName  **参数解释**： 输出视频资产名称。 > * 视频资产名称最大长度支持256；文件名称最大长度支持240（超过长度的会被舍弃）  **约束限制**： 不涉及。 **取值范围**： 字符长度0-256位。 **默认取值**： 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets assetName
    *
    * @param string $assetName **参数解释**： 输出视频资产名称。 > * 视频资产名称最大长度支持256；文件名称最大长度支持240（超过长度的会被舍弃）  **约束限制**： 不涉及。 **取值范围**： 字符长度0-256位。 **默认取值**： 不涉及。
    *
    * @return $this
    */
