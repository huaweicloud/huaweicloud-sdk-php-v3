...
class CreateMetaStudioOrdersRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateMetaStudioOrdersRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xSdkDate' => 'string',
            'xProjectId' => 'string',
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\CreateMetaStudioOrdersReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\CreateMetaStudioOrdersReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\CreateMetaStudioOrdersReq|null $body body
    *
    * @return $this
    */
