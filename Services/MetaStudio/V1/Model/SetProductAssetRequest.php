...
class SetProductAssetRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SetProductAssetRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xAppUserId' => 'string',
            'productId' => 'string',
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\ProductAssetReleation'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\ProductAssetReleation|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\ProductAssetReleation|null $body body
    *
    * @return $this
    */
