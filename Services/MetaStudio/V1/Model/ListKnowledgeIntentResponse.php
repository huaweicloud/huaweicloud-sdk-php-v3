...
class ListKnowledgeIntentResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListKnowledgeIntentResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'limit' => 'int',
            'count' => 'int',
            'data' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\KnowledgeIntentInfo[]',
            'xRequestId' => 'string'
    ];
    ...
    *  技能信息
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\KnowledgeIntentInfo[]|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\KnowledgeIntentInfo[]|null $data 技能信息
    *
    * @return $this
    */
