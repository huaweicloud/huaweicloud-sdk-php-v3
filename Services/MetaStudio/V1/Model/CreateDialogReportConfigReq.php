...
class CreateDialogReportConfigReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateDialogReportConfigReq';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['enableDialogReport'] === null) {
            $invalidProperties[] = "'enableDialogReport' can't be null";
        }
    ...
    * Sets obsBucketName
    *
    * @param string $obsBucketName **参数解释**： 接收对话结果上报的obs桶名。 **约束限制**： 不涉及 **取值范围**： 字符长度1-64 **默认取值**： 不涉及
    *
    * @return $this
    */
    ...
    * Sets obsEndpoint
    *
    * @param string $obsEndpoint **参数解释**： 接收对话结果上报的obs终端节点。 **约束限制**： 需要为obs合法终端节点。 **取值范围**： 字符长度1-64 **默认取值**： 不涉及
    *
    * @return $this
    */
    ...
    *
    * @param bool $enableDialogReport 对话结果上报开关
    *
    * @return $this
    */
