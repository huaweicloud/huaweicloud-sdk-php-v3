...
class TransferAssetResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TransferAssetResponse';
    ...
    * Sets jobId
    *
    * @param string|null $jobId 资产转移任务ID
    *
    * @return $this
    */
