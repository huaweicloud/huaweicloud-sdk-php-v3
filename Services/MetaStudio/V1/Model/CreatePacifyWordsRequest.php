...
class CreatePacifyWordsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePacifyWordsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xProjectId' => 'string',
            'xAppUserId' => 'string',
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\CreatePacifyWordsReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\CreatePacifyWordsReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\CreatePacifyWordsReq|null $body body
    *
    * @return $this
    */
