...
class UpdatePacifyWordsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePacifyWordsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\UpdatePacifyWordsReq'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pacifyWordsId'] === null) {
            $invalidProperties[] = "'pacifyWordsId' can't be null";
        }
            if ((mb_strlen($this->container['pacifyWordsId']) > 64)) {
                $invalidProperties[] = "invalid value for 'pacifyWordsId', the character length must be smaller than or equal to 64.";
            }
            if ((mb_strlen($this->container['pacifyWordsId']) < 1)) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\UpdatePacifyWordsReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\UpdatePacifyWordsReq|null $body body
    *
    * @return $this
    */
