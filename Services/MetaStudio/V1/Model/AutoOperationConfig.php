...
class AutoOperationConfig implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AutoOperationConfig';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * operation  BLOCK: 冻结 DELETE：删除
    * operationTime  资源过期时间，格式遵循：RFC 3339 如\"2025-01-10T00:00:00Z\"
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['operation']) && (mb_strlen($this->container['operation']) < 1)) {
            ...
            if (!is_null($this->container['operationTime']) && (mb_strlen($this->container['operationTime']) < 20)) {
                $invalidProperties[] = "invalid value for 'operationTime', the character length must be bigger than or equal to 20.";
            }
    ...
    * Sets operation
    *
    * @param string|null $operation BLOCK: 冻结 DELETE：删除
    *
    * @return $this
    */
    ...
    * Sets operationTime
    *
    * @param string|null $operationTime 资源过期时间，格式遵循：RFC 3339 如\"2025-01-10T00:00:00Z\"
    *
    * @return $this
    */
