...
class UpdateKnowledgeQuestionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateKnowledgeQuestionRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xAppUserId' => 'string',
            'questionId' => 'string',
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateKnowledgeQuestionReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateKnowledgeQuestionReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateKnowledgeQuestionReq|null $body body
    *
    * @return $this
    */
