...
class SaveTtscTenantConfigsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SaveTtscTenantConfigsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xProjectId' => 'string',
            'xAppUserId' => 'string',
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\SaveTtscTenantConfigsRequestBody'
    ];
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\SaveTtscTenantConfigsRequestBody|null $body body
    *
    * @return $this
    */
