...
class CreateLargeFileRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateLargeFileRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xSdkDate' => 'string',
            'xAppUserId' => 'string',
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\LargeFilesCreateReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\LargeFilesCreateReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\LargeFilesCreateReq|null $body body
    *
    * @return $this
    */
