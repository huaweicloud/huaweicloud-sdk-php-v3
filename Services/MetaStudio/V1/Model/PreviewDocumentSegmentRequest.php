...
class PreviewDocumentSegmentRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PreviewDocumentSegmentRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'documentId' => 'string',
            'previewLines' => 'int',
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\DocumentSegmentParam'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['previewLines'] = isset($data['previewLines']) ? $data['previewLines'] : null;
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['documentId'] === null) {
            ...
            if (!is_null($this->container['previewLines']) && ($this->container['previewLines'] > 100)) {
                $invalidProperties[] = "invalid value for 'previewLines', must be smaller than or equal to 100.";
            }
            if (!is_null($this->container['previewLines']) && ($this->container['previewLines'] < 1)) {
                $invalidProperties[] = "invalid value for 'previewLines', must be bigger than or equal to 1.";
            }
    ...
    */
    ...
    {
        return $this->container['previewLines'];
    }

    /**
    * Sets previewLines
    *
    * @param int|null $previewLines 预览行数。
    *
    * @return $this
    */
    public function setPreviewLines($previewLines)
    {
        $this->container['previewLines'] = $previewLines;
        return $this;
    }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\DocumentSegmentParam|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\DocumentSegmentParam|null $body body
    *
    * @return $this
    */
