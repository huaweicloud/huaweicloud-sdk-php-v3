...
class ListLivePlatformsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListLivePlatformsRequest';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['accessType']) && (mb_strlen($this->container['accessType']) > 64)) {
                $invalidProperties[] = "invalid value for 'accessType', the character length must be smaller than or equal to 64.";
            }
            if (!is_null($this->container['accessType']) && (mb_strlen($this->container['accessType']) < 0)) {
                $invalidProperties[] = "invalid value for 'accessType', the character length must be bigger than or equal to 0.";
            }
