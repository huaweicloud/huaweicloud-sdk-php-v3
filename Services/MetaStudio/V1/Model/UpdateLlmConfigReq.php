...
class UpdateLlmConfigReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateLlmConfigReq';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['apiKey']) && (mb_strlen($this->container['apiKey']) > 128)) {
    ...
    * Sets name
    *
    * @param string|null $name 大语言模型配置名称。
    *
    * @return $this
    */
    ...
    * Sets llmUrl
    *
    * @param string|null $llmUrl 大语言模型地址。
    *
    * @return $this
    */
