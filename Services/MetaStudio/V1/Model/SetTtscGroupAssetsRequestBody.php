...
class SetTtscGroupAssetsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SetTtscGroupAssetsRequestBody';
    ...
    * Sets assetIds
    *
    * @param string[]|null $assetIds 资产id
    *
    * @return $this
    */
