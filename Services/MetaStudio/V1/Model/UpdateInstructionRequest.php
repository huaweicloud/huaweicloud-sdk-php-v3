...
class UpdateInstructionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateInstructionRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateInstructionReq'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['instructionId'] === null) {
            $invalidProperties[] = "'instructionId' can't be null";
        }
            if ((mb_strlen($this->container['instructionId']) > 64)) {
                $invalidProperties[] = "invalid value for 'instructionId', the character length must be smaller than or equal to 64.";
            }
            if ((mb_strlen($this->container['instructionId']) < 1)) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateInstructionReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateInstructionReq|null $body body
    *
    * @return $this
    */
