...
class UpdateQuestionAnswerRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateQuestionAnswerRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateQuestionAnswerReq'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['questionAnswerId'] === null) {
            $invalidProperties[] = "'questionAnswerId' can't be null";
        }
            if ((mb_strlen($this->container['questionAnswerId']) > 64)) {
                $invalidProperties[] = "invalid value for 'questionAnswerId', the character length must be smaller than or equal to 64.";
            }
            if ((mb_strlen($this->container['questionAnswerId']) < 1)) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateQuestionAnswerReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateQuestionAnswerReq|null $body body
    *
    * @return $this
    */
