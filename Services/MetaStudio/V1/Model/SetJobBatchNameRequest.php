...
class SetJobBatchNameRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SetJobBatchNameRequest';
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\SetJobBatchNameReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\SetJobBatchNameReq|null $body body
    *
    * @return $this
    */
