...
class UpdateSmartLiveUserConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateSmartLiveUserConfigRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xSdkDate' => 'string',
            'xProjectId' => 'string',
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateSmartLiveUserConfigReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateSmartLiveUserConfigReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateSmartLiveUserConfigReq|null $body body
    *
    * @return $this
    */
