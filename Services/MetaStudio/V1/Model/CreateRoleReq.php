...
class CreateRoleReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateRoleReq';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['roleBusinessList'] === null) {
            $invalidProperties[] = "'roleBusinessList' can't be null";
        }
        if ($this->container['llmSource'] === null) {
            $invalidProperties[] = "'llmSource' can't be null";
        }
    ...
    *  角色业务配置列表
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\RoleBusinessReq[]
    */
    ...
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\RoleBusinessReq[] $roleBusinessList 角色业务配置列表
    *
    * @return $this
    */
    ...
    *  llmSource
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\LlmSourceEnum
    */
    ...
    * Sets llmSource
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\LlmSourceEnum $llmSource llmSource
    *
    * @return $this
    */
