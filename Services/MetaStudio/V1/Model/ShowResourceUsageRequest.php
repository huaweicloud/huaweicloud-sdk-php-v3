...
class ShowResourceUsageRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowResourceUsageRequest';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['resource']) && (mb_strlen($this->container['resource']) > 256)) {
                $invalidProperties[] = "invalid value for 'resource', the character length must be smaller than or equal to 256.";
            }
            ...
            if (!is_null($this->container['business']) && (mb_strlen($this->container['business']) > 256)) {
                $invalidProperties[] = "invalid value for 'business', the character length must be smaller than or equal to 256.";
            }
            if (!is_null($this->container['business']) && (mb_strlen($this->container['business']) < 0)) {
                $invalidProperties[] = "invalid value for 'business', the character length must be bigger than or equal to 0.";
            }
