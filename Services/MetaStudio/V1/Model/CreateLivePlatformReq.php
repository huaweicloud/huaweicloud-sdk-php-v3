...
class CreateLivePlatformReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateLivePlatformReq';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['authConfig'] === null) {
            $invalidProperties[] = "'authConfig' can't be null";
        }
    ...
    *  authConfig
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\CustomPlatformAuthConfig
    */
    ...
    * Sets authConfig
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\CustomPlatformAuthConfig $authConfig authConfig
    *
    * @return $this
    */
