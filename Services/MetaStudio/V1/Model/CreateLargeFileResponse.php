...
class CreateLargeFileResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateLargeFileResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * fileId  文件ID。
    * uploadUrls  文件分段上传URL。
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['uploadUrls'] = isset($data['uploadUrls']) ? $data['uploadUrls'] : null;
    ...
    */
    ...
    {
        return $this->container['uploadUrls'];
    }

    /**
    * Sets uploadUrls
    *
    * @param string[]|null $uploadUrls 文件分段上传URL。
    *
    * @return $this
    */
    public function setUploadUrls($uploadUrls)
    {
        $this->container['uploadUrls'] = $uploadUrls;
        return $this;
    }
