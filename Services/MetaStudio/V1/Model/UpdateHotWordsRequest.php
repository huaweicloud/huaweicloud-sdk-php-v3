...
class UpdateHotWordsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateHotWordsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xAppUserId' => 'string',
            'hotWordsId' => 'string',
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateHotWordsReq'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['hotWordsId'] === null) {
            $invalidProperties[] = "'hotWordsId' can't be null";
        }
            if ((mb_strlen($this->container['hotWordsId']) > 64)) {
                $invalidProperties[] = "invalid value for 'hotWordsId', the character length must be smaller than or equal to 64.";
            }
            if ((mb_strlen($this->container['hotWordsId']) < 1)) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateHotWordsReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateHotWordsReq|null $body body
    *
    * @return $this
    */
