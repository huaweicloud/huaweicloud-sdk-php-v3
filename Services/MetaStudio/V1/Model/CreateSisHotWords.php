...
class CreateSisHotWords implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSisHotWords';
    ...
    * Sets sisProjectId
    *
    * @param string $sisProjectId SIS服务所在区域projectId
    *
    * @return $this
    */
    ...
    * Sets region
    *
    * @param int $region 对接SIS服务的区域。 > 0：北京四；3：上海一；
    *
    * @return $this
    */
