...
class UpdateInteractionRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateInteractionRuleRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'groupId' => 'string',
            'ruleId' => 'string',
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\CreateInteractionRuleReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\CreateInteractionRuleReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\CreateInteractionRuleReq|null $body body
    *
    * @return $this
    */
