...
class SmartChatVoiceConfig implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SmartChatVoiceConfig';
    ...
    * language  语言类型。默认值CN。 * CN：中文。 * EN：英文。
    * languageDesc  语言描述。
    *
    * @var string[]
    */
    ...
    * Sets language
    *
    * @param string|null $language 语言类型。默认值CN。 * CN：中文。 * EN：英文。
    *
    * @return $this
    */
