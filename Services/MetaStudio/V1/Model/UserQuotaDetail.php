...
class UserQuotaDetail implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UserQuotaDetail';
    ...
    */
    protected static $openAPITypes = [
            ...
            'videoTime2dModel' => 'int',
            'videoTimeFlexus2dModel' => 'int',
            'voiceCloneBasic' => 'int',
    ...
    */
    protected static $openAPIFormats = [
        ...
        'videoTime2dModel' => null,
        'videoTimeFlexus2dModel' => null,
    ...
    *
    * @param int|null $videoTime2dModel 分身数字人视频制作内容时间，单位分钟。-1表示无限制。
    *
    * @return $this
    */
    ...
    *
    * @param int|null $videoTimeFlexus2dModel 分身数字人视频制作flexus版内容时间，单位分钟。-1表示无限制。
    *
    * @return $this
    */
