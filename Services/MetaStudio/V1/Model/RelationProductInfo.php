...
class RelationProductInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RelationProductInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * productId  关联商品ID。如果配置，则段落切换回调中会携带该信息。美团平台对应goodsId
    * productTitle  关联商品标题/名称。如果配置，则段落切换回调中会携带该信息。美团平台对应goodsTitle
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['productTitle']) && (mb_strlen($this->container['productTitle']) < 0)) {
                $invalidProperties[] = "invalid value for 'productTitle', the character length must be bigger than or equal to 0.";
            }
    ...
    * Sets productId
    *
    * @param string|null $productId 关联商品ID。如果配置，则段落切换回调中会携带该信息。美团平台对应goodsId
    *
    * @return $this
    */
    ...
    * Sets productTitle
    *
    * @param string|null $productTitle 关联商品标题/名称。如果配置，则段落切换回调中会携带该信息。美团平台对应goodsTitle
    *
    * @return $this
    */
