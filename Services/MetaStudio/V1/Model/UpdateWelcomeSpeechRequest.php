...
class UpdateWelcomeSpeechRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateWelcomeSpeechRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateWelcomeSpeechReq'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['welcomeSpeechId'] === null) {
            $invalidProperties[] = "'welcomeSpeechId' can't be null";
        }
            if ((mb_strlen($this->container['welcomeSpeechId']) > 64)) {
                $invalidProperties[] = "invalid value for 'welcomeSpeechId', the character length must be smaller than or equal to 64.";
            }
            if ((mb_strlen($this->container['welcomeSpeechId']) < 1)) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateWelcomeSpeechReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\UpdateWelcomeSpeechReq|null $body body
    *
    * @return $this
    */
