...
class ShowTenantNoticeConfigurationResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowTenantNoticeConfigurationResponse';
    ...
    * Sets type
    *
    * @param string|null $type 通知类型。 * RESOURCE_EXPIRE：资源过期通知 * RESOURCE_LEFT：资源剩余量通知
    *
    * @return $this
    */
