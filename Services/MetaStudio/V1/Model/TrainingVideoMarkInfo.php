...
class TrainingVideoMarkInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TrainingVideoMarkInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * videoStartTime  训练视频起始时间。格式：“HH:MM:SS.mmm”。
    * videoEndTime  训练视频结束时间。格式：“HH:MM:SS.mmm”。
    *
    * @var string[]
    */
    ...
    * Sets videoStartTime
    *
    * @param string|null $videoStartTime 训练视频起始时间。格式：“HH:MM:SS.mmm”。
    *
    * @return $this
    */
    ...
    * Sets videoEndTime
    *
    * @param string|null $videoEndTime 训练视频结束时间。格式：“HH:MM:SS.mmm”。
    *
    * @return $this
    */
