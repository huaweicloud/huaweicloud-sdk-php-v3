...
class ShowPacifyWordsTriggerTimeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowPacifyWordsTriggerTimeRequest';
    ...
    * Sets language
    *
    * @param string $language 智能交互语言  * CN:中文  * EN:英文
    *
    * @return $this
    */
