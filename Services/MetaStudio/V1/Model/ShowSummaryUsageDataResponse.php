...
class ShowSummaryUsageDataResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowSummaryUsageDataResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * resourceType  资源类型
    * businessType  业务类型 * LIVE_2D：分身数字人视频直播 * VIDEO_2D：分身数字人视频制作
    * number  使用个数(视频制作的视频个数,直播的场次)
    * usage  使用量
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['number']) && ($this->container['number'] > 1000000)) {
                $invalidProperties[] = "invalid value for 'number', must be smaller than or equal to 1000000.";
            }
    ...
    * Sets number
    *
    * @param int|null $number 使用个数(视频制作的视频个数,直播的场次)
    *
    * @return $this
    */
