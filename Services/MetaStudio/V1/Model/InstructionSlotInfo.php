...
class InstructionSlotInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'InstructionSlotInfo';
    ...
    */
    protected static $openAPITypes = [
            'name' => 'string',
            'description' => 'string',
            'knowledgeLibraryList' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\SlotKnowledgeLibraryInfo[]'
    ];
    ...
    * Sets description
    *
    * @param string|null $description 槽位描述。
    *
    * @return $this
    */
    ...
    *  知识库列表
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\SlotKnowledgeLibraryInfo[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\SlotKnowledgeLibraryInfo[]|null $knowledgeLibraryList 知识库列表
    *
    * @return $this
    */
