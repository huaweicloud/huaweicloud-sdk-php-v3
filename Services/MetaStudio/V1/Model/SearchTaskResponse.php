...
class SearchTaskResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchTaskResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'limit' => 'int',
            'count' => 'int',
            'data' => '\HuaweiCloud\SDK\MetaStudio\V1\Model\QueryTaskResultDTO[]'
    ];
    ...
    *  查询数据
    *
    * @return \HuaweiCloud\SDK\MetaStudio\V1\Model\QueryTaskResultDTO[]|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\MetaStudio\V1\Model\QueryTaskResultDTO[]|null $data 查询数据
    *
    * @return $this
    */
