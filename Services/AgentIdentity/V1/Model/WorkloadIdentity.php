...
class WorkloadIdentity implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'WorkloadIdentity';
    ...
    *  apiKeySecret
    *
    * @return \HuaweiCloud\SDK\AgentIdentity\V1\Model\Secret|null
    */
    ...
    * Sets apiKeySecret
    *
    * @param \HuaweiCloud\SDK\AgentIdentity\V1\Model\Secret|null $apiKeySecret apiKeySecret
    *
    * @return $this
    */
