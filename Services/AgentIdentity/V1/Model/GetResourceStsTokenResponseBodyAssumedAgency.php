...
class GetResourceStsTokenResponseBodyAssumedAgency implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GetResourceStsTokenResponseBody_assumed_agency';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * urn  The URN of the assumed agency
    * id  A unique identifier that contains the agency ID and the agency session name
    *
    * @var string[]
    */
    ...
    * Sets urn
    *
    * @param string $urn The URN of the assumed agency
    *
    * @return $this
    */
    ...
    * Sets id
    *
    * @param string $id A unique identifier that contains the agency ID and the agency session name
    *
    * @return $this
    */
