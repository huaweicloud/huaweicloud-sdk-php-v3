...
class GetWorkloadIdentityAuthorizerConfigurationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GetWorkloadIdentityAuthorizerConfigurationRequest';
