...
class UpdateTokenVaultRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateTokenVaultRequest';
    ...
    */
    protected static $openAPITypes = [
            'tokenVaultId' => 'string',
            'body' => '\HuaweiCloud\SDK\AgentIdentity\V1\Model\UpdateTokenVaultReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\AgentIdentity\V1\Model\UpdateTokenVaultReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\AgentIdentity\V1\Model\UpdateTokenVaultReqBody|null $body body
    *
    * @return $this
    */
