...
class GetResourceStsTokenResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GetResourceStsTokenResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'assumedAgency' => '\HuaweiCloud\SDK\AgentIdentity\V1\Model\GetResourceStsTokenResponseBodyAssumedAgency',
            'credentials' => '\HuaweiCloud\SDK\AgentIdentity\V1\Model\GetResourceStsTokenResponseBodyCredentials'
    ];
    ...
    *  assumedAgency
    *
    * @return \HuaweiCloud\SDK\AgentIdentity\V1\Model\GetResourceStsTokenResponseBodyAssumedAgency|null
    */
    ...
    * Sets assumedAgency
    *
    * @param \HuaweiCloud\SDK\AgentIdentity\V1\Model\GetResourceStsTokenResponseBodyAssumedAgency|null $assumedAgency assumedAgency
    *
    * @return $this
    */
    ...
    *  credentials
    *
    * @return \HuaweiCloud\SDK\AgentIdentity\V1\Model\GetResourceStsTokenResponseBodyCredentials|null
    */
    ...
    * Sets credentials
    *
    * @param \HuaweiCloud\SDK\AgentIdentity\V1\Model\GetResourceStsTokenResponseBodyCredentials|null $credentials credentials
    *
    * @return $this
    */
