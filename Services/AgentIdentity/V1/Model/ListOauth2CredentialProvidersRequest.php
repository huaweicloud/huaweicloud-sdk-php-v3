...
class ListOauth2CredentialProvidersRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListOauth2CredentialProvidersRequest';
