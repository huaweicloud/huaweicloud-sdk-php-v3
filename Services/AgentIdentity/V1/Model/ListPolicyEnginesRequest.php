...
class ListPolicyEnginesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListPolicyEnginesRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * type  Filter by policy engine type. If not specified, all policy engine types are returned.
    * limit  每页显示的条目数量。
    * marker  分页标记。
    *
    * @var string[]
    ...
    *
    * @return \HuaweiCloud\SDK\AgentIdentity\V1\Model\PolicyEngineType|null
    */
    ...
    * Sets type
    *
    * @param \HuaweiCloud\SDK\AgentIdentity\V1\Model\PolicyEngineType|null $type Filter by policy engine type. If not specified, all policy engine types are returned.
    *
    * @return $this
    */
