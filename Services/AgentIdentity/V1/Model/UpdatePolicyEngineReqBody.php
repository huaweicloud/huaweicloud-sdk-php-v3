...
class UpdatePolicyEngineReqBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePolicyEngineReqBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * description  策略集的更新描述。
    * tags  自定义标签列表。
    *
    * @var string[]
    */
    ...
    * Sets description
    *
    * @param string|null $description 策略集的更新描述。
    *
    * @return $this
    */
