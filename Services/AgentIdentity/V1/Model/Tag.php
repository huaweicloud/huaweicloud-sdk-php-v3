...
class Tag implements ModelInterface, ArrayAccess
{
    ...
    * key  标签键，可以包含任意语种字母、数字、空格以及\"_\"、\".\"、\":\"、\"=\"、\"+\"、\"-\"、\"@\"符号的任意组合，但是首尾不能包含空格以及不能使用\"\\_sys\\_\"为开头，长度范围[1,128]。
    * value  标签值，可以包含任意语种字母、数字、空格以及\"_\"、\".\"、\":\"、\"/\"、\"=\"、\"+\"、\"-\"、\"@\"符号的任意组合，可以是空字符串，长度范围[0,255]。
    *
    * @var string[]
    */
    ...
    * Sets key
    *
    * @param string $key 标签键，可以包含任意语种字母、数字、空格以及\"_\"、\".\"、\":\"、\"=\"、\"+\"、\"-\"、\"@\"符号的任意组合，但是首尾不能包含空格以及不能使用\"\\_sys\\_\"为开头，长度范围[1,128]。
    *
    * @return $this
    */
    ...
    * Sets value
    *
    * @param string $value 标签值，可以包含任意语种字母、数字、空格以及\"_\"、\".\"、\":\"、\"/\"、\"=\"、\"+\"、\"-\"、\"@\"符号的任意组合，可以是空字符串，长度范围[0,255]。
    *
    * @return $this
    */
