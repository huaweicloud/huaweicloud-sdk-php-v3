...
class MicrosoftOauth2ProviderConfigInput implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MicrosoftOauth2ProviderConfigInput';
    ...
    * Sets tenantId
    *
    * @param string $tenantId The tenant ID for the Microsoft OAuth2 provider.
    *
    * @return $this
    */
