...
class StsTag implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StsTag';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * key  The key identifier, or name, of the tag
    * value  The string value that's associated with the key of the tag
    *
    * @var string[]
    */
    ...
    * Sets key
    *
    * @param string $key The key identifier, or name, of the tag
    *
    * @return $this
    */
    ...
    * Sets value
    *
    * @param string $value The string value that's associated with the key of the tag
    *
    * @return $this
    */
