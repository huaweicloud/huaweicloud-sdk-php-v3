...
class CreateWorkloadAccessTokenForUserIdRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateWorkloadAccessTokenForUserIdRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * workloadName  The unique identifier for the registered workload
    * userId  The ID of the user for whom to retrieve the access token
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['userId'] === null) {
            ...
            if ((mb_strlen($this->container['userId']) > 128)) {
    ...
    * Sets userId
    *
    * @param string $userId The ID of the user for whom to retrieve the access token
    *
    * @return $this
    */
