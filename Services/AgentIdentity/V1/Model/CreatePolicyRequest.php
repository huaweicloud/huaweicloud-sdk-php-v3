...
class CreatePolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\AgentIdentity\V1\Model\CreatePolicyReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\AgentIdentity\V1\Model\CreatePolicyReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\AgentIdentity\V1\Model\CreatePolicyReqBody|null $body body
    *
    * @return $this
    */
