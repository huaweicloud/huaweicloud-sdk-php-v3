...
class ListPoliciesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'policies' => '\HuaweiCloud\SDK\AgentIdentity\V1\Model\PolicySummary[]',
    ...
    *  policies
    *
    * @return \HuaweiCloud\SDK\AgentIdentity\V1\Model\PolicySummary[]|null
    */
    ...
    * Sets policies
    *
    * @param \HuaweiCloud\SDK\AgentIdentity\V1\Model\PolicySummary[]|null $policies policies
    *
    * @return $this
    */
