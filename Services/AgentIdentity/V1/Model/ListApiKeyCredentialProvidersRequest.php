...
class ListApiKeyCredentialProvidersRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListApiKeyCredentialProvidersRequest';
