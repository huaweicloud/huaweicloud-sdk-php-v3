...
class ApiKeyCredentialProvider implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ApiKeyCredentialProvider';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  The name of the credential provider.
    * urn  The Uniform Resource Name (URN) of the credential provider.
    ...
    */
    protected static $openAPITypes = [
            'name' => 'string',
            'urn' => 'string',
            'apiKeySecret' => '\HuaweiCloud\SDK\AgentIdentity\V1\Model\Secret',
            'createdAt' => '\DateTime',
            'updatedAt' => '\DateTime',
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['apiKeySecret'] = isset($data['apiKeySecret']) ? $data['apiKeySecret'] : null;
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['apiKeySecret'] === null) {
            $invalidProperties[] = "'apiKeySecret' can't be null";
        }
    ...
    * Sets urn
    *
    * @param string $urn The Uniform Resource Name (URN) of the credential provider.
    *
    * @return $this
    */
    ...
    */
    ...
    {
        return $this->container['apiKeySecret'];
    }

    /**
    * Sets apiKeySecret
    *
    * @param \HuaweiCloud\SDK\AgentIdentity\V1\Model\Secret $apiKeySecret apiKeySecret
    *
    * @return $this
    */
    public function setApiKeySecret($apiKeySecret)
    {
        $this->container['apiKeySecret'] = $apiKeySecret;
        return $this;
    }
