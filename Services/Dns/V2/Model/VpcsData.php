...
class VpcsData implements ModelInterface, ArrayAccess
{
    ...
    * outboundEndpointCount  VPC下出站终端节点的数量。
    *
    * @var string[]
    */
    ...
    */
    protected static $attributeMap = [
            ...
            'outboundEndpointCount' => 'outbound_endpoint_count'
    ];
    ...
    */
    protected static $setters = [
            ...
            'outboundEndpointCount' => 'setOutboundEndpointCount'
    ];
    ...
    */
    protected static $getters = [
            ...
            'outboundEndpointCount' => 'getOutboundEndpointCount'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['outboundEndpointCount'] = isset($data['outboundEndpointCount']) ? $data['outboundEndpointCount'] : null;
    }
    ...
    */
    ...
    /**
    * Gets outboundEndpointCount
    *  VPC下出站终端节点的数量。
    *
    * @return int|null
    */
    public function getOutboundEndpointCount()
    {
        return $this->container['outboundEndpointCount'];
    }

    /**
    * Sets outboundEndpointCount
    *
    * @param int|null $outboundEndpointCount VPC下出站终端节点的数量。
    *
    * @return $this
    */
    public function setOutboundEndpointCount($outboundEndpointCount)
    {
        $this->container['outboundEndpointCount'] = $outboundEndpointCount;
        return $this;
    }
