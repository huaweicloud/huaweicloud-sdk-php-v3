...
class DisassociateResolverRuleRouterResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DisassociateResolverRuleRouterResponse';
