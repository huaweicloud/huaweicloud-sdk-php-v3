...
class BatchCreatePublicRecordsetsTaskItem implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreatePublicRecordsetsTaskItem';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * zoneName  **参数解释：** 托管该记录的域名。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    ...
    * type  **参数解释：** 记录集的类型。 **约束限制：** 不涉及。 **取值范围：** - 公网域名的记录类型: A、CNAME、MX、AAAA、TXT、SRV、NS、CAA。  **默认取值：** 不涉及。
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['zoneName'] === null) {
            ...
            if ((mb_strlen($this->container['zoneName']) > 254)) {
                $invalidProperties[] = "invalid value for 'zoneName', the character length must be smaller than or equal to 254.";
            }
            if ((mb_strlen($this->container['zoneName']) < 3)) {
                $invalidProperties[] = "invalid value for 'zoneName', the character length must be bigger than or equal to 3.";
            }
    ...
    * Sets zoneName
    *
    * @param string $zoneName **参数解释：** 托管该记录的域名。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets type
    *
    * @param string $type **参数解释：** 记录集的类型。 **约束限制：** 不涉及。 **取值范围：** - 公网域名的记录类型: A、CNAME、MX、AAAA、TXT、SRV、NS、CAA。  **默认取值：** 不涉及。
    *
    * @return $this
    */
