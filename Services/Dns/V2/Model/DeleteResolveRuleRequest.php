...
class DeleteResolveRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteResolveRuleRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * resolverruleId  待删除resolverrule的ID。
    *
    * @var string[]
    */
    ...
    * Sets resolverruleId
    *
    * @param string $resolverruleId 待删除resolverrule的ID。
    *
    * @return $this
    */
