...
class DeletePtrRecordReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeletePtrRecordReq';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * floatingipIds  待删除PTR ID。
    *
    * @var string[]
    */
    ...
    * Sets floatingipIds
    *
    * @param string[]|null $floatingipIds 待删除PTR ID。
    *
    * @return $this
    */
