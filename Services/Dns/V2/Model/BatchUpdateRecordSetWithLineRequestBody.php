...
class BatchUpdateRecordSetWithLineRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchUpdateRecordSetWithLineRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * recordsets  **参数解释：** 记录集列表。 **约束限制：**  最多支持50个。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets recordsets
    *
    * @param \HuaweiCloud\SDK\Dns\V2\Model\BatchUpdateRecordSet[] $recordsets **参数解释：** 记录集列表。 **约束限制：**  最多支持50个。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    *
    * @return $this
    */
