...
class BatchSetRecordSetsStatusReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchSetRecordSetsStatusReq';
    ...
    * Sets status
    *
    * @param string|null $status 待设置Record Se状态，当前仅支持DISABLE或ENABLE。
    *
    * @return $this
    */
