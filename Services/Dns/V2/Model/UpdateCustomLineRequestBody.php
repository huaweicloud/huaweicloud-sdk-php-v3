...
class UpdateCustomLineRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateCustomLineRequestBody';
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['name']) && !preg_match("/[\\w\\u4e00-\\u9fa5\\._-]{1,80}/", $this->container['name'])) {
                $invalidProperties[] = "invalid value for 'name', must be conform to the pattern /[\\w\\u4e00-\\u9fa5\\._-]{1,80}/.";
            }
