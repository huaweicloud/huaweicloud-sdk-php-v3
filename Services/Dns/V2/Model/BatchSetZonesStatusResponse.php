...
class BatchSetZonesStatusResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchSetZonesStatusResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * zones  待删除zone类型，当前仅支持 public 或 private
    * metadata  metadata
    *
    * @var string[]
    */
    ...
    * Sets zones
    *
    * @param \HuaweiCloud\SDK\Dns\V2\Model\ZoneData[]|null $zones 待删除zone类型，当前仅支持 public 或 private
    *
    * @return $this
    */
