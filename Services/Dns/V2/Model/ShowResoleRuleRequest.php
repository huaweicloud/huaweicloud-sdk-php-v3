...
class ShowResoleRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowResoleRuleRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * resolverruleId  待查询resolverrule的ID。
    *
    * @var string[]
    */
    ...
    * Sets resolverruleId
    *
    * @param string $resolverruleId 待查询resolverrule的ID。
    *
    * @return $this
    */
