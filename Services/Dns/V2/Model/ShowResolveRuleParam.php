...
class ShowResolveRuleParam implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowResolveRuleParam';
    ...
    * Sets ipaddresses
    *
    * @param string[]|null $ipaddresses 规则关联的目标ip地址。
    *
    * @return $this
    */
