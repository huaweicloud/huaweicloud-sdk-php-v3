...
class ListPtrsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListPtrsRequest';
    ...
    * Sets resourceType
    *
    * @param string|null $resourceType 弹性公网IP类型。  取值范围： publicip：弹性公网IP（EIP）
    *
    * @return $this
    */
