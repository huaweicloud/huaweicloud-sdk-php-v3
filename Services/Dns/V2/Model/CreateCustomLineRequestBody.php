...
class CreateCustomLineRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCustomLineRequestBody';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['name'] === null) {
            ...
            if (!preg_match("/[\\w\\u4e00-\\u9fa5\\._-]{1,80}/", $this->container['name'])) {
