...
class DisassociateResolveRuleRouterResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DisassociateResolveRuleRouterResponse';
