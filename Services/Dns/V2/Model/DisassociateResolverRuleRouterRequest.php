...
class DisassociateResolverRuleRouterRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DisassociateResolverRuleRouterRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Dns\V2\Model\AssociateOrDisassociateRouterWithRuleRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dns\V2\Model\AssociateOrDisassociateRouterWithRuleRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dns\V2\Model\AssociateOrDisassociateRouterWithRuleRequestBody|null $body body
    *
    * @return $this
    */
