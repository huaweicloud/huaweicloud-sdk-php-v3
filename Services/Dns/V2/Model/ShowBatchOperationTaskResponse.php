...
class ShowBatchOperationTaskResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowBatchOperationTaskResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'successCount' => 'int',
            'errorCount' => 'int',
            'errorItems' => '\HuaweiCloud\SDK\Dns\V2\Model\ShowBatchOperationTaskErrorItem[]'
    ];
    ...
    *  批量操作任务列表。
    *
    * @return \HuaweiCloud\SDK\Dns\V2\Model\ShowBatchOperationTaskErrorItem[]|null
    */
    ...
    * Sets errorItems
    *
    * @param \HuaweiCloud\SDK\Dns\V2\Model\ShowBatchOperationTaskErrorItem[]|null $errorItems 批量操作任务列表。
    *
    * @return $this
    */
