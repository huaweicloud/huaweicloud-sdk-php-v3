...
class BatchDeleteRecordSetsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteRecordSetsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * recordsets  **参数解释：** 记录集列表信息。 **取值范围：** 不涉及。
    * metadata  metadata
    *
    * @var string[]
    */
    ...
    * Sets recordsets
    *
    * @param \HuaweiCloud\SDK\Dns\V2\Model\RecordsetData[]|null $recordsets **参数解释：** 记录集列表信息。 **取值范围：** 不涉及。
    *
    * @return $this
    */
