...
class BatchSetRecordSetsStatusRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * status  **参数解释：** 待设置记录集状态。 **约束限制：** 不涉及。 **取值范围：** - DISABLE：暂停解析 - ENABLE：启用解析  **默认取值：** 不涉及。
    * recordsetIds  **参数解释：** 待设置记录集ID列表。 **约束限制：** 最多支持50个。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets status
    *
    * @param string $status **参数解释：** 待设置记录集状态。 **约束限制：** 不涉及。 **取值范围：** - DISABLE：暂停解析 - ENABLE：启用解析  **默认取值：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets recordsetIds
    *
    * @param string[] $recordsetIds **参数解释：** 待设置记录集ID列表。 **约束限制：** 最多支持50个。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    *
    * @return $this
    */
