...
class ListRecordSetsWithLineRequest implements ModelInterface, ArrayAccess
{
    ...
    * zoneId  **参数解释：** 域名的ID。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    * lineId  **参数解释：** 解析线路ID。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    ...
    * sortKey  **参数解释：** 查询结果中记录集列表的排序字段。 **约束限制：** 不涉及。 **取值范围：** - name：记录集名称 - type：记录集类型 - created_at：创建时间 - updated_at：更新时间  **默认取值：** created_at
    * sortDir  **参数解释：** 查询结果中记录集列表的排序方式。 **约束限制：** 不涉及。 **取值范围：** - desc：降序排序 - asc：升序排序  **默认取值：** desc
    * healthCheckId  **参数解释：** 健康检查ID。 搜索模式默认为模糊搜索。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    * searchMode  **参数解释：** 查询条件搜索模式。 **约束限制：** 不涉及。 **取值范围：** - like：模糊搜索 - equal：精确搜索  **默认取值：** name默认模糊搜索，其他默认精确搜索。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['zoneId']) && !preg_match("/[0-9a-zA-Z-]{0,32}/", $this->container['zoneId'])) {
                $invalidProperties[] = "invalid value for 'zoneId', must be conform to the pattern /[0-9a-zA-Z-]{0,32}/.";
            }
            if (!is_null($this->container['type']) && !preg_match("/|A|AAAA|MX|CNAME|TXT|NS|SRV|CAA/", $this->container['type'])) {
                $invalidProperties[] = "invalid value for 'type', must be conform to the pattern /|A|AAAA|MX|CNAME|TXT|NS|SRV|CAA/.";
            }
            if (!is_null($this->container['records']) && (mb_strlen($this->container['records']) > 4096)) {
                $invalidProperties[] = "invalid value for 'records', the character length must be smaller than or equal to 4096.";
            }
            if (!is_null($this->container['sortKey']) && !preg_match("/|name|type|view_name|created_at|updated_at/", $this->container['sortKey'])) {
                $invalidProperties[] = "invalid value for 'sortKey', must be conform to the pattern /|name|type|view_name|created_at|updated_at/.";
            }
            ...
            if (!is_null($this->container['searchMode']) && !preg_match("/|like|equal/", $this->container['searchMode'])) {
                $invalidProperties[] = "invalid value for 'searchMode', must be conform to the pattern /|like|equal/.";
            }
    ...
    * Sets zoneId
    *
    * @param string|null $zoneId **参数解释：** 域名的ID。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets lineId
    *
    * @param string|null $lineId **参数解释：** 解析线路ID。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets type
    *
    * @param string|null $type **参数解释：** 记录集的类型。 **约束限制：** 不涉及。 **取值范围：** - 公网域名的记录类型: A、AAAA、MX、CNAME、TXT、SRV、NS、SOA、CAA。 - 内网域名的记录类型: A、AAAA、MX、CNAME、TXT、PTR、SRV、NS、SOA。  **默认取值：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets sortKey
    *
    * @param string|null $sortKey **参数解释：** 查询结果中记录集列表的排序字段。 **约束限制：** 不涉及。 **取值范围：** - name：记录集名称 - type：记录集类型 - created_at：创建时间 - updated_at：更新时间  **默认取值：** created_at
    *
    * @return $this
    */
    ...
    * Sets sortDir
    *
    * @param string|null $sortDir **参数解释：** 查询结果中记录集列表的排序方式。 **约束限制：** 不涉及。 **取值范围：** - desc：降序排序 - asc：升序排序  **默认取值：** desc
    *
    * @return $this
    */
    ...
    * Sets healthCheckId
    *
    * @param string|null $healthCheckId **参数解释：** 健康检查ID。 搜索模式默认为模糊搜索。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets searchMode
    *
    * @param string|null $searchMode **参数解释：** 查询条件搜索模式。 **约束限制：** 不涉及。 **取值范围：** - like：模糊搜索 - equal：精确搜索  **默认取值：** name默认模糊搜索，其他默认精确搜索。
    *
    * @return $this
    */
