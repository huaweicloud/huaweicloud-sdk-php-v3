...
class DisassociateEndpointIpaddressResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DisassociateEndpointIpaddressResponse';
