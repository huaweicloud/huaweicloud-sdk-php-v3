...
class DeleteRecordSetsResponse implements ModelInterface, ArrayAccess
{
    ...
    * type  **参数解释：** 记录类型。 **取值范围：** 不涉及。
    * ttl  **参数解释：** 解析记录在本地DNS服务器的缓存时间，缓存时间越长更新生效越慢，以秒为单位。 **取值范围：** 不涉及。
    ...
    * Sets type
    *
    * @param string|null $type **参数解释：** 记录类型。 **取值范围：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets ttl
    *
    * @param int|null $ttl **参数解释：** 解析记录在本地DNS服务器的缓存时间，缓存时间越长更新生效越慢，以秒为单位。 **取值范围：** 不涉及。
    *
    * @return $this
    */
