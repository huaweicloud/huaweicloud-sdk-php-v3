...
class EndpointResp implements ModelInterface, ArrayAccess
{
    ...
    * resolverRuleCount  该endpoint下的解析规则数量。 仅创建出站终端节点时返回该参数。
    * createTime  创建时间。
    * updateTime  更新时间。
    *
    * @var string[]
    ...
    * Sets name
    *
    * @param string|null $name endpoint的名称。
    *
    * @return $this
    */
    ...
    * Sets vpcId
    *
    * @param string|null $vpcId endpoint所属的vpc_id。
    *
    * @return $this
    */
    ...
    * Sets ipaddressCount
    *
    * @param int|null $ipaddressCount 该endpoint下的ip地址数量。
    *
    * @return $this
    */
    ...
    *
    * @param int|null $resolverRuleCount 该endpoint下的解析规则数量。 仅创建出站终端节点时返回该参数。
    *
    * @return $this
    */
