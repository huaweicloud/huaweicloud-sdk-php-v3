...
class ListEndpointIpaddressesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListEndpointIpaddressesRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * endpointId  待查询的ip地址列表所在的endpoint的ID。
    *
    * @var string[]
    */
    ...
    * Sets endpointId
    *
    * @param string $endpointId 待查询的ip地址列表所在的endpoint的ID。
    *
    * @return $this
    */
