...
class ShowDomainDetectionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDomainDetectionRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['zoneId'] === null) {
            ...
            if (!is_null($this->container['type']) && !preg_match("/|CNAME|TXT|MX/", $this->container['type'])) {
                $invalidProperties[] = "invalid value for 'type', must be conform to the pattern /|CNAME|TXT|MX/.";
            }
