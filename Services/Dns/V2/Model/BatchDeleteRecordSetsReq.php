...
class BatchDeleteRecordSetsReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteRecordSetsReq';
    ...
    * Sets zoneType
    *
    * @param string|null $zoneType Zone的类型，取值为public或private。
    *
    * @return $this
    */
    ...
    * Sets recordsetIds
    *
    * @param string[]|null $recordsetIds 待删除的Record Set ID列表。 最多支持100个。
    *
    * @return $this
    */
