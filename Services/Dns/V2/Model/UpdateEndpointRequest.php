...
class UpdateEndpointRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'endpointId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dns\V2\Model\UpdateEndpointRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dns\V2\Model\UpdateEndpointRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dns\V2\Model\UpdateEndpointRequestBody|null $body body
    *
    * @return $this
    */
