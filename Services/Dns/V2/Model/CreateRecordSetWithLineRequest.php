...
class CreateRecordSetWithLineRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'zoneId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dns\V2\Model\CreateRecordSetWithLineReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dns\V2\Model\CreateRecordSetWithLineReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dns\V2\Model\CreateRecordSetWithLineReq|null $body body
    *
    * @return $this
    */
