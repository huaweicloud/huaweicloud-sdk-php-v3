...
class AssociateResolveRuleRouterRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateResolveRuleRouterRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * resolverruleId  关联VPC的resolverrule的ID。
    * body  body
    *
    * @var string[]
    */
    ...
    * Sets resolverruleId
    *
    * @param string $resolverruleId 关联VPC的resolverrule的ID。
    *
    * @return $this
    */
