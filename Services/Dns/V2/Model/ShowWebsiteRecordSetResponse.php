...
class ShowWebsiteRecordSetResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowWebsiteRecordSetResponse';
    ...
    * Sets recordsets
    *
    * @param \HuaweiCloud\SDK\Dns\V2\Model\ListRecordSets[]|null $recordsets **参数解释：** 记录集列表信息。 **取值范围：** 不涉及。
    *
    * @return $this
    */
