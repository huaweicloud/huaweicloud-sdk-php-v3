...
class BatchCreateRecordSetsTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateRecordSetsTaskRequest';
    ...
    */
    protected static $openAPITypes = [
            'zoneId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dns\V2\Model\BatchCreateRecordSetsTaskRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dns\V2\Model\BatchCreateRecordSetsTaskRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dns\V2\Model\BatchCreateRecordSetsTaskRequestBody|null $body body
    *
    * @return $this
    */
