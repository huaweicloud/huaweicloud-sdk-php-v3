...
class ComponentOverview implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ComponentOverview';
    ...
    */
    protected static $openAPITypes = [
            ...
            'createTime' => 'int',
            'updateTime' => 'int',
            'instances' => '\HuaweiCloud\SDK\ServiceStage\V2\Model\ComponentInstanceOverView[]'
    ];
    ...
    *  组件部署信息列表。
    *
    * @return \HuaweiCloud\SDK\ServiceStage\V2\Model\ComponentInstanceOverView[]|null
    */
    ...
    * Sets instances
    *
    * @param \HuaweiCloud\SDK\ServiceStage\V2\Model\ComponentInstanceOverView[]|null $instances 组件部署信息列表。
    *
    * @return $this
    */
