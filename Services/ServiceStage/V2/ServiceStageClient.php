...
class ServiceStageClient extends Client
{
     ...
     * @return response
     */
    public function createCamInstance($request)
    {
        return $this->createCamInstanceWithHttpInfo($request);
    }

    public function createCamInstanceWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function deleteInstanceById($request)
    {
        return $this->deleteInstanceByIdWithHttpInfo($request);
    }

    public function deleteInstanceByIdWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function deployInstance($request)
    {
        return $this->deployInstanceWithHttpInfo($request);
    }

    public function deployInstanceWithHttpInfo($request)
    {
