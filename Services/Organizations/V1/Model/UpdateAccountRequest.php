...
class UpdateAccountRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'accountId' => 'string',
            'body' => '\HuaweiCloud\SDK\Organizations\V1\Model\UpdateAccountReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Organizations\V1\Model\UpdateAccountReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Organizations\V1\Model\UpdateAccountReqBody|null $body body
    *
    * @return $this
    */
