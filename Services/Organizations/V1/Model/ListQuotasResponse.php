...
class ListQuotasResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'quotas' => '\HuaweiCloud\SDK\Organizations\V1\Model\QuotasResourcesDto'
    ];
    ...
    *  quotas
    *
    * @return \HuaweiCloud\SDK\Organizations\V1\Model\QuotasResourcesDto|null
    */
    ...
    * Sets quotas
    *
    * @param \HuaweiCloud\SDK\Organizations\V1\Model\QuotasResourcesDto|null $quotas quotas
    *
    * @return $this
    */
