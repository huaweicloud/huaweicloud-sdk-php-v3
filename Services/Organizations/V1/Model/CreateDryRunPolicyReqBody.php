...
class CreateDryRunPolicyReqBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateDryRunPolicyReqBody';
    ...
    * name  要分配给策略的名称。
    * type  要创建的策略类型,service_control_policy服务控制策略。
    ...
    * Sets type
    *
    * @param string $type 要创建的策略类型,service_control_policy服务控制策略。
    *
    * @return $this
    */
