...
class ListDelegatedAdministratorsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDelegatedAdministratorsRequest';
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['servicePrincipal']) && (mb_strlen($this->container['servicePrincipal']) > 100)) {
                $invalidProperties[] = "invalid value for 'servicePrincipal', the character length must be smaller than or equal to 100.";
            }
            if (!is_null($this->container['servicePrincipal']) && (mb_strlen($this->container['servicePrincipal']) < 1)) {
    ...
    *
    * @param string|null $servicePrincipal 服务主体的名称。
    *
    * @return $this
    */
