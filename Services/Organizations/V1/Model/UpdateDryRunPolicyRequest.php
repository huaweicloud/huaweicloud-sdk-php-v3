...
class UpdateDryRunPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDryRunPolicyRequest';
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Organizations\V1\Model\UpdatePolicyReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Organizations\V1\Model\UpdatePolicyReqBody|null $body body
    *
    * @return $this
    */
