...
class UntagResourceRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'resourceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Organizations\V1\Model\UntagResourceReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Organizations\V1\Model\UntagResourceReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Organizations\V1\Model\UntagResourceReqBody|null $body body
    *
    * @return $this
    */
