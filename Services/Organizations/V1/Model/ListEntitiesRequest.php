...
class ListEntitiesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListEntitiesRequest';
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['parentId']) && (mb_strlen($this->container['parentId']) > 100)) {
                $invalidProperties[] = "invalid value for 'parentId', the character length must be smaller than or equal to 100.";
            }
            if (!is_null($this->container['parentId']) && !preg_match("/^(?:r-[0-9a-z]{4,32}|ou-[0-9a-z]{8,32})$/", $this->container['parentId'])) {
                $invalidProperties[] = "invalid value for 'parentId', must be conform to the pattern /^(?:r-[0-9a-z]{4,32}|ou-[0-9a-z]{8,32})$/.";
            }
            if (!is_null($this->container['childId']) && (mb_strlen($this->container['childId']) > 100)) {
                $invalidProperties[] = "invalid value for 'childId', the character length must be smaller than or equal to 100.";
            }
            if (!is_null($this->container['childId']) && !preg_match("/^(?:[\\w-]+|ou-[0-9a-z]{8,32})$/", $this->container['childId'])) {
                $invalidProperties[] = "invalid value for 'childId', must be conform to the pattern /^(?:[\\w-]+|ou-[0-9a-z]{8,32})$/.";
            }
    ...
    * Sets parentId
    *
    * @param string|null $parentId 父节点（根或组织单元）的唯一标识符（ID）。
    *
    * @return $this
    */
