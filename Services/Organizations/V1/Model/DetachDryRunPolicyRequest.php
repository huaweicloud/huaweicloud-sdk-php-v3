...
class DetachDryRunPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DetachDryRunPolicyRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'policyId' => 'string',
            'body' => '\HuaweiCloud\SDK\Organizations\V1\Model\PolicyTachReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Organizations\V1\Model\PolicyTachReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Organizations\V1\Model\PolicyTachReqBody|null $body body
    *
    * @return $this
    */
