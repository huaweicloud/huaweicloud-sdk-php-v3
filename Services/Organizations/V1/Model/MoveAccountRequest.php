...
class MoveAccountRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MoveAccountRequest';
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Organizations\V1\Model\MoveAccountReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Organizations\V1\Model\MoveAccountReqBody|null $body body
    *
    * @return $this
    */
