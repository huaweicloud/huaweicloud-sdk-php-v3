...
class DryRunConfigDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DryRunConfigDto';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * rootId  根的唯一标识符（ID）。
    * status  策略试运行的开启状态。enabled：启用；pending_enable：启用中；disabled：禁用；pending_disable：禁用中。
    * bucketName  用户桶名称。
    ...
    * createdAt  策略试运行配置的开启时间。
    * updatedAt  策略试运行配置的更新时间。
    *
    * @var string[]
    */
    ...
    */
    ...
    const STATUS_PENDING_ENABLE = 'pending_enable';
    const STATUS_DISABLED = 'disabled';
    const STATUS_PENDING_DISABLE = 'pending_disable';
    ...
    */
    public function getStatusAllowableValues()
    {
        return [
            self::STATUS_ENABLED,
            self::STATUS_PENDING_ENABLE,
            self::STATUS_DISABLED,
            self::STATUS_PENDING_DISABLE,
        ];
    }
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['status'] === null) {
            ...
            if (!is_null($this->container['bucketPrefix']) && (mb_strlen($this->container['bucketPrefix']) > 64)) {
                $invalidProperties[] = "invalid value for 'bucketPrefix', the character length must be smaller than or equal to 64.";
            }
    ...
    * Sets status
    *
    * @param string $status 策略试运行的开启状态。enabled：启用；pending_enable：启用中；disabled：禁用；pending_disable：禁用中。
    *
    * @return $this
    */
    ...
    * Sets createdAt
    *
    * @param \DateTime $createdAt 策略试运行配置的开启时间。
    *
    * @return $this
    */
    ...
    * Sets updatedAt
    *
    * @param \DateTime $updatedAt 策略试运行配置的更新时间。
    *
    * @return $this
    */
