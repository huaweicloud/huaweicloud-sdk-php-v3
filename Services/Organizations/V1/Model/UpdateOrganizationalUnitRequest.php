...
class UpdateOrganizationalUnitRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateOrganizationalUnitRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Organizations\V1\Model\UpdateOrganizationalUnitReqBody'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['organizationalUnitId'] === null) {
            ...
            if ((mb_strlen($this->container['organizationalUnitId']) > 35)) {
                $invalidProperties[] = "invalid value for 'organizationalUnitId', the character length must be smaller than or equal to 35.";
            }
            if (!preg_match("/^ou-[0-9a-z]{8,32}$/", $this->container['organizationalUnitId'])) {
                $invalidProperties[] = "invalid value for 'organizationalUnitId', must be conform to the pattern /^ou-[0-9a-z]{8,32}$/.";
            }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Organizations\V1\Model\UpdateOrganizationalUnitReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Organizations\V1\Model\UpdateOrganizationalUnitReqBody|null $body body
    *
    * @return $this
    */
