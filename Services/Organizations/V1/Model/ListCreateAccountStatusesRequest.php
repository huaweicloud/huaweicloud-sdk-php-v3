...
class ListCreateAccountStatusesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCreateAccountStatusesRequest';
    ...
    */
    ...
    const STATES_IN_PROGRESS = 'in_progress';
