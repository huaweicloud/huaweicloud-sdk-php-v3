...
class ListCloseAccountStatusesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCloseAccountStatusesRequest';
    ...
    */
    ...
    const STATES_PENDING_CLOSURE = 'pending_closure';
    const STATES_SUSPENDED = 'suspended';
    ...
    */
    ...
    {
        return [
            self::STATES_PENDING_CLOSURE,
            self::STATES_SUSPENDED,
        ];
    }
    ...
    * Sets states
    *
    * @param string[]|null $states 要包含在响应中的一个或多个状态的列表。如果此参数不存在，则所有请求都包含在响应中。
    *
    * @return $this
    */
