...
class TrustedServiceReqBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TrustedServiceReqBody';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['servicePrincipal'] === null) {
            ...
            if ((mb_strlen($this->container['servicePrincipal']) < 0)) {
                $invalidProperties[] = "invalid value for 'servicePrincipal', the character length must be bigger than or equal to 0.";
            }
