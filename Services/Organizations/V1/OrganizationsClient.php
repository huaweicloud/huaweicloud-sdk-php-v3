...
class OrganizationsClient extends Client
{
    ...
    {
        $client = new ClientBuilder(new OrganizationsClient(), "GlobalCredentials");
        return $client;
    }
    ...
    {
        return $this->createResourceAccountWithHttpInfo($request);
    }

    public function createResourceAccountWithHttpInfo($request)
    {
    ...
    {
        return $this->updateAccountWithHttpInfo($request);
    }

    public function updateAccountWithHttpInfo($request)
    {
        $resourcePath = '/v1/organizations/accounts/{account_id}';
        $formParams = [];
        $queryParams = [];
     ...
     * @return response
     */
    public function showDryRunConfig($request)
    {
        return $this->showDryRunConfigWithHttpInfo($request);
    }

    public function showDryRunConfigWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function updateDryRunConfig($request)
    {
        return $this->updateDryRunConfigWithHttpInfo($request);
    }

    public function updateDryRunConfigWithHttpInfo($request)
    {
        $resourcePath = '/v1/organizations/dry-run-config';
        $formParams = [];
        $queryParams = [];
     ...
     * @return response
     */
    public function attachDryRunPolicy($request)
    {
        return $this->attachDryRunPolicyWithHttpInfo($request);
    }

    public function attachDryRunPolicyWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function createDryRunPolicy($request)
    {
        return $this->createDryRunPolicyWithHttpInfo($request);
    }

    public function createDryRunPolicyWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function deleteDryRunPolicy($request)
    {
        return $this->deleteDryRunPolicyWithHttpInfo($request);
    }

    public function deleteDryRunPolicyWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function detachDryRunPolicy($request)
    {
        return $this->detachDryRunPolicyWithHttpInfo($request);
    }

    public function detachDryRunPolicyWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function listDryRunPolicies($request)
    {
        return $this->listDryRunPoliciesWithHttpInfo($request);
    }

    public function listDryRunPoliciesWithHttpInfo($request)
    {
        $resourcePath = '/v1/organizations/dry-run-policies';
        $formParams = [];
        $queryParams = [];
     ...
     * @return response
     */
    public function listEntitiesForDryRunPolicy($request)
    {
        return $this->listEntitiesForDryRunPolicyWithHttpInfo($request);
    }

    public function listEntitiesForDryRunPolicyWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function showDryRunPolicy($request)
    {
        return $this->showDryRunPolicyWithHttpInfo($request);
    }

    public function showDryRunPolicyWithHttpInfo($request)
    {
        $resourcePath = '/v1/organizations/dry-run-policies/{policy_id}';
        $formParams = [];
        $queryParams = [];
     ...
     * @return response
     */
    public function updateDryRunPolicy($request)
    {
        return $this->updateDryRunPolicyWithHttpInfo($request);
    }

    public function updateDryRunPolicyWithHttpInfo($request)
    {
        $resourcePath = '/v1/organizations/dry-run-policies/{policy_id}';
        $formParams = [];
        $queryParams = [];
