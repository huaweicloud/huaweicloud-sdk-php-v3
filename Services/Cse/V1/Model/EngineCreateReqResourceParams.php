...
class EngineCreateReqResourceParams implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'EngineCreateReq_resourceParams';
    ...
    * Sets isAutoRenew
    *
    * @param int|null $isAutoRenew 是否自动刷新
    *
    * @return $this
    */
