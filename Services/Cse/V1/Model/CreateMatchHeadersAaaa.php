...
class CreateMatchHeadersAaaa implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateMatch_headers_aaaa';
    ...
    *
    * @param bool|null $caseInsensitive caseInsensitive
    *
    * @return $this
    */
