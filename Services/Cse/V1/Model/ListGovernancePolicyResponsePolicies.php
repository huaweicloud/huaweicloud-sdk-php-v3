...
class ListGovernancePolicyResponsePolicies implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGovernancePolicyResponse_policies';
