...
class UpdateDesignTableQualityRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDesignTableQualityRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'contentType' => 'string',
            'tableId' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\UpdateDesignTableQualityParam'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\UpdateDesignTableQualityParam|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\UpdateDesignTableQualityParam|null $body body
    *
    * @return $this
    */
