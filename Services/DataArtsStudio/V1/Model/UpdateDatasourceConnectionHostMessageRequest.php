...
class UpdateDatasourceConnectionHostMessageRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDatasourceConnectionHostMessageRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'instanceId' => 'string',
            'connectionId' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\UpdateConnectionHostReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\UpdateConnectionHostReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\UpdateConnectionHostReq|null $body body
    *
    * @return $this
    */
