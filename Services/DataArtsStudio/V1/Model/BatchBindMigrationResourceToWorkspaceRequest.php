...
class BatchBindMigrationResourceToWorkspaceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchBindMigrationResourceToWorkspaceRequest';
    ...
    */
    protected static $openAPITypes = [
            'xProjectId' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\BatchBindMigrationResourceToWorkspaceRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\BatchBindMigrationResourceToWorkspaceRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\BatchBindMigrationResourceToWorkspaceRequestBody|null $body body
    *
    * @return $this
    */
