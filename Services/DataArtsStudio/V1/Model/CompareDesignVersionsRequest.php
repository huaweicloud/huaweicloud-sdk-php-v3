...
class CompareDesignVersionsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CompareDesignVersionsRequest';
