...
class ExportDesignModelTableDdlRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExportDesignModelTableDdlRequest';
    ...
    * Sets tbNames
    *
    * @param string[]|null $tbNames 待导出的表名。
    *
    * @return $this
    */
    ...
    * Sets withDb
    *
    * @param bool|null $withDb 导出的DDL包不包括数据库名。
    *
    * @return $this
    */
