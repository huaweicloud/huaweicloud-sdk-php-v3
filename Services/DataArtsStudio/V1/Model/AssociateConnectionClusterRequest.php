...
class AssociateConnectionClusterRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateConnectionClusterRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xProjectId' => 'string',
            'connectionId' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\AssociateConnectionClusterReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\AssociateConnectionClusterReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\AssociateConnectionClusterReq|null $body body
    *
    * @return $this
    */
