...
class DeleteDatasourceConnectionRoutesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteDatasourceConnectionRoutesResponse';
