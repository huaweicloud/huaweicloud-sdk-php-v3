...
class ExportDataServiceExcelRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExportDataServiceExcelRequest';
    ...
    * Sets body
    *
    * @param string[]|null $body API导出ID列表。
    *
    * @return $this
    */
