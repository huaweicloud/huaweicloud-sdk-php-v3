...
class BatchTagRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchTagRequest';
    ...
    */
    protected static $openAPITypes = [
            'instance' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\BatchRecommendationRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\BatchRecommendationRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\BatchRecommendationRequest|null $body body
    *
    * @return $this
    */
