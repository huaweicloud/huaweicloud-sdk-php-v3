...
class DynamicMaskingPolicyUpdateDTO implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DynamicMaskingPolicyUpdateDTO';
    ...
    */
    protected static $openAPITypes = [
            ...
            'connId' => 'string',
            'schemaName' => 'string',
            'policyList' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\DynamicMaskingPolicyUpdate[]'
    ];
    ...
    *  动态数据脱敏策略列表。
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\DynamicMaskingPolicyUpdate[]
    */
    ...
    * Sets policyList
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\DynamicMaskingPolicyUpdate[] $policyList 动态数据脱敏策略列表。
    *
    * @return $this
    */
