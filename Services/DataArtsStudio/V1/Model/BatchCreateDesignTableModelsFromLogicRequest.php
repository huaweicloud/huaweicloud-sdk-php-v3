...
class BatchCreateDesignTableModelsFromLogicRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateDesignTableModelsFromLogicRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'contentType' => 'string',
            'modelId' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\WorkspaceTransformVO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\WorkspaceTransformVO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\WorkspaceTransformVO|null $body body
    *
    * @return $this
    */
