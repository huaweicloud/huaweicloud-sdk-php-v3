...
class CreateDesignAtomicIndexRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateDesignAtomicIndexRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xProjectId' => 'string',
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\AtomicIndexVO'
    ];
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\AtomicIndexVO|null $body body
    *
    * @return $this
    */
