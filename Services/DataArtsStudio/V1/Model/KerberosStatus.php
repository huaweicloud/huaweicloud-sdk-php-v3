...
class KerberosStatus implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'KerberosStatus';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * clusterId  集群id
    * clusterName  集群名称
    * status  是否开启了kerberos认证,true:开启，false:未开启
    *
    * @var string[]
    */
    ...
    * Sets status
    *
    * @param bool|null $status 是否开启了kerberos认证,true:开启，false:未开启
    *
    * @return $this
    */
