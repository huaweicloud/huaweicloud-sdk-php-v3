...
class UpdateSecurityDataClassificationRuleGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateSecurityDataClassificationRuleGroupRequest';
    ...
    */
    protected static $openAPITypes = [
            'workspace' => 'string',
            'id' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\DataClassificationGroupUpdateDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\DataClassificationGroupUpdateDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\DataClassificationGroupUpdateDTO|null $body body
    *
    * @return $this
    */
