...
class SearchDesignLatestApprovalDiffRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchDesignLatestApprovalDiffRequest';
