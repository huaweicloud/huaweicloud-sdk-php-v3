...
class UpdateSecurityDataClassificationRuleGroupResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateSecurityDataClassificationRuleGroupResponse';
