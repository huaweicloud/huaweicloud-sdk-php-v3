...
class UpdatePermissionExpireTimeResultDTOResults implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePermissionExpireTimeResultDTO_results';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  权限id
    * message  更新有效期结果信息
    * status  更新结果状态。1成功 0失败
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['message']) && (mb_strlen($this->container['message']) > 65535)) {
    ...
    * Sets message
    *
    * @param string|null $message 更新有效期结果信息
    *
    * @return $this
    */
    ...
    * Sets status
    *
    * @param int|null $status 更新结果状态。1成功 0失败
    *
    * @return $this
    */
