...
class ListEntityDetailsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListEntityDetailsRequest';
    ...
    * Sets body
    *
    * @param string[]|null $body 批量获取资产信息请求体。
    *
    * @return $this
    */
