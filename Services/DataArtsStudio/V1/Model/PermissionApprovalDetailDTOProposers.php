...
class PermissionApprovalDetailDTOProposers implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PermissionApprovalDetailDTO_proposers';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  申请人id
    * name  申请人名称
    * type  申请人类型,USER,USER_GROUP,ROLE,WORKSPACE_ACCOUNT
    *
    * @var string[]
    */
    ...
    */
    ...
    const TYPE_WORKSPACE_ACCOUNT = 'WORKSPACE_ACCOUNT';
    ...
    * Sets type
    *
    * @param string|null $type 申请人类型,USER,USER_GROUP,ROLE,WORKSPACE_ACCOUNT
    *
    * @return $this
    */
