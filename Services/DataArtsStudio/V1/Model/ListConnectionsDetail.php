...
class ListConnectionsDetail implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListConnectionsDetail';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  连接ID，用于标识资源组网络连接的UUID。
    * name  创建连接时，用户自定义的连接名称。
    * status  连接状态，包括以下三种状态： NORMAL：正常 ABNORMAL：异常 FAILED：失败
    ...
    * Sets status
    *
    * @param string|null $status 连接状态，包括以下三种状态： NORMAL：正常 ABNORMAL：异常 FAILED：失败
    *
    * @return $this
    */
