...
class ShowSecuritySensitiveDataDiagnoseResultRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowSecuritySensitiveDataDiagnoseResultRequest';
