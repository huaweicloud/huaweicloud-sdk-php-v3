...
class CreateDatasourceConnectionRoutesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateDatasourceConnectionRoutesRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xProjectId' => 'string',
            'connectionId' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\CreateConnectionRoutesReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\CreateConnectionRoutesReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\CreateConnectionRoutesReq|null $body body
    *
    * @return $this
    */
