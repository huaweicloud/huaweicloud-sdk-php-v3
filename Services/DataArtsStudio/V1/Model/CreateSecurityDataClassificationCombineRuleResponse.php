...
class CreateSecurityDataClassificationCombineRuleResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSecurityDataClassificationCombineRuleResponse';
