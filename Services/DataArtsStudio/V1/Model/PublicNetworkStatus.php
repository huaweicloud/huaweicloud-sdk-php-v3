...
class PublicNetworkStatus implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PublicNetworkStatus';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * clusterId  集群id
    * clusterName  集群名称
    * status  是否开启了公网访问,true:开启，false:未开启
    * ip  公网ip地址
    *
    * @var string[]
    */
    ...
    * Sets status
    *
    * @param bool|null $status 是否开启了公网访问,true:开启，false:未开启
    *
    * @return $this
    */
