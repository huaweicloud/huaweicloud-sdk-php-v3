...
class DataClassificationGroupCombineRuleDTO implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DataClassificationGroupCombineRuleDTO';
    ...
    * Sets method
    *
    * @param string $method 规则方式, COMBINE
    *
    * @return $this
    */
