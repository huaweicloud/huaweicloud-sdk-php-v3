...
class CreateFactoryBaselineRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateFactoryBaselineRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspace' => 'string',
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\CreateBaselineRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\CreateBaselineRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\CreateBaselineRequest|null $body body
    *
    * @return $this
    */
