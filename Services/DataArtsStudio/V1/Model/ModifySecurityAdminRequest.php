...
class ModifySecurityAdminRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ModifySecurityAdminRequest';
    ...
    */
    protected static $openAPITypes = [
            'workspace' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\DlsAdmin'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\DlsAdmin|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\DlsAdmin|null $body body
    *
    * @return $this
    */
