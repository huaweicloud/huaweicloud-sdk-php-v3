...
class ListLogicEntitiesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListLogicEntitiesRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instance  实例ID，获取方法请参见[实例ID和工作空间ID](dataartsstudio_02_0350.xml)。
    * guid  主题目录资产guid，获取方法请参见[数据资产guid](dataartsstudio_02_0351.xml)。
    *
    * @var string[]
    */
