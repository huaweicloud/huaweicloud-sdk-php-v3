...
class DeleteDesignDimensionLogicTableRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteDesignDimensionLogicTableRequest';
