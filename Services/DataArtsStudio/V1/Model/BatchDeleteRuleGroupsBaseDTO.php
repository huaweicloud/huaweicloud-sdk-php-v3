...
class BatchDeleteRuleGroupsBaseDTO implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteRuleGroupsBaseDTO';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * ruleGroupIds  识别规则组id列表
    *
    * @var string[]
    */
    ...
    * Sets ruleGroupIds
    *
    * @param string[] $ruleGroupIds 识别规则组id列表
    *
    * @return $this
    */
