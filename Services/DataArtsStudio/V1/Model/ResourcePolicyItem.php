...
class ResourcePolicyItem implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResourcePolicyItem';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * resourceId  资源id
    * resourceName  资源名称
    * resourceType  资源类型:DATA_CONNECTION,AGENCY
    *
    * @var string[]
    */
    ...
    */
    ...
    const RESOURCE_TYPE_DATA_CONNECTION = 'DATA_CONNECTION';
    const RESOURCE_TYPE_AGENCY = 'AGENCY';
    ...
    */
    ...
    {
        return [
            self::RESOURCE_TYPE_DATA_CONNECTION,
            self::RESOURCE_TYPE_AGENCY,
        ];
    }
    ...
    * Sets resourceType
    *
    * @param string $resourceType 资源类型:DATA_CONNECTION,AGENCY
    *
    * @return $this
    */
