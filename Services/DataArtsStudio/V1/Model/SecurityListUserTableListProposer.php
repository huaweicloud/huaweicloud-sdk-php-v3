...
class SecurityListUserTableListProposer implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SecurityListUserTableList_proposer';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  必填，用户、用户组id，iam接口获取
    * name  非必填，用户、用户组name，iam接口获取
    * type  必填，枚举，0用户
    *
    * @var string[]
    */
    ...
    * Sets id
    *
    * @param string $id 必填，用户、用户组id，iam接口获取
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string|null $name 非必填，用户、用户组name，iam接口获取
    *
    * @return $this
    */
