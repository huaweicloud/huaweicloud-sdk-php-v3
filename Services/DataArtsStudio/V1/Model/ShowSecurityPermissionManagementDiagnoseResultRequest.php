...
class ShowSecurityPermissionManagementDiagnoseResultRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowSecurityPermissionManagementDiagnoseResultRequest';
