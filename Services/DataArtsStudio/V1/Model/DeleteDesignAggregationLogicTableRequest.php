...
class DeleteDesignAggregationLogicTableRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteDesignAggregationLogicTableRequest';
