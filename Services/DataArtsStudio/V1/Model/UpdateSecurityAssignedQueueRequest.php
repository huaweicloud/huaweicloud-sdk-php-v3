...
class UpdateSecurityAssignedQueueRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateSecurityAssignedQueueRequest';
    ...
    */
    protected static $openAPITypes = [
            'workspace' => 'string',
            'id' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\QueueSrcAssignUpdateDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\QueueSrcAssignUpdateDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\QueueSrcAssignUpdateDTO|null $body body
    *
    * @return $this
    */
