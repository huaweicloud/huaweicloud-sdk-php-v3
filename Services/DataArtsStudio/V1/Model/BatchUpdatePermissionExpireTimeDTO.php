...
class BatchUpdatePermissionExpireTimeDTO implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchUpdatePermissionExpireTimeDTO';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * ids  数据密级id列表，数据密级id可以通过查询接口获取。
    * expireTime  到期时间
    *
    * @var string[]
    */
    ...
    * Sets ids
    *
    * @param string[]|null $ids 数据密级id列表，数据密级id可以通过查询接口获取。
    *
    * @return $this
    */
