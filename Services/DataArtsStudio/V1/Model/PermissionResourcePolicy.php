...
class PermissionResourcePolicy implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PermissionResourcePolicy';
    ...
    * Sets resources
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\ResourcePolicyItem[] $resources 资源对象列表
    *
    * @return $this
    */
    ...
    * Sets members
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\MemberPolicyItem[] $members 成员列表
    *
    * @return $this
    */
