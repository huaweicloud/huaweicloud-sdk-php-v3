...
class BatchCreateSecurityPermissionSetPermissionsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateSecurityPermissionSetPermissionsRequest';
