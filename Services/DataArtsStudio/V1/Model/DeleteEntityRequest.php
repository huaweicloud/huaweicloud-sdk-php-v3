...
class DeleteEntityRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteEntityRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instance  实例ID，获取方法请参见[实例ID和工作空间ID](dataartsstudio_02_0350.xml)。
    * guid  资产的guid，获取方法请参见[数据开发作业ID](dataartsstudio_02_0351.xml)。
    *
    * @var string[]
    */
