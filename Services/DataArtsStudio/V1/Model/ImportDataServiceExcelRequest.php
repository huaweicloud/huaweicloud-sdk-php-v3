...
class ImportDataServiceExcelRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImportDataServiceExcelRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * workspace  工作空间ID，获取方法请参见[实例ID和工作空间ID](dataartsstudio_02_0350.xml)。
    * dlmType  数据服务的版本类型，指定SHARED共享版或EXCLUSIVE专享版。
    * contentType  消息体的类型（格式），此处为导入文件，取值为multipart/form-data。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'dlmType' => 'string',
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\ImportDataServiceExcelRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\ImportDataServiceExcelRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\ImportDataServiceExcelRequestBody|null $body body
    *
    * @return $this
    */
