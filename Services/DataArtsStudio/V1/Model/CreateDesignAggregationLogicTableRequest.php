...
class CreateDesignAggregationLogicTableRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateDesignAggregationLogicTableRequest';
