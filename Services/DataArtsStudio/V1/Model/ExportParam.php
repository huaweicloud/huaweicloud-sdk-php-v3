...
class ExportParam implements ModelInterface, ArrayAccess
{
    ...
    * ids  导出对象ID的列表，如：某几个逻辑模型的ID，ID字符串。
    ...
    * directoryId  所属目录ID，ID字符串。
    * bizCatalogId  所属业务分层的ID，ID字符串。
    * bizCatalogIdList  所属的业务分层的ID列表。
    * modelId  所属关系建模的模型ID，导出关系模型需要此参数，ID字符串。
    *
    * @var string[]
    */
    ...
    * Sets ids
    *
    * @param string[]|null $ids 导出对象ID的列表，如：某几个逻辑模型的ID，ID字符串。
    *
    * @return $this
    */
    ...
    * Sets directoryId
    *
    * @param string|null $directoryId 所属目录ID，ID字符串。
    *
    * @return $this
    */
    ...
    * Sets bizCatalogId
    *
    * @param string|null $bizCatalogId 所属业务分层的ID，ID字符串。
    *
    * @return $this
    */
    ...
    * Sets modelId
    *
    * @param string|null $modelId 所属关系建模的模型ID，导出关系模型需要此参数，ID字符串。
    *
    * @return $this
    */
