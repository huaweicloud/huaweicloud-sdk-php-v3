...
class ListDataServiceInstancesOverviewRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDataServiceInstancesOverviewRequest';
