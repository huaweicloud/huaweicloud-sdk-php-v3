...
class DeleteDatasourceConnectionRoutesRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['connectionId'] === null) {
            ...
            if ((mb_strlen($this->container['connectionId']) > 64)) {
            ...
            if (!preg_match("/^[a-zA-Z0-9\\-_]+$/", $this->container['connectionId'])) {
                $invalidProperties[] = "invalid value for 'connectionId', must be conform to the pattern /^[a-zA-Z0-9\\-_]+$/.";
            }
        if ($this->container['routeName'] === null) {
            $invalidProperties[] = "'routeName' can't be null";
        }
            if ((mb_strlen($this->container['routeName']) > 64)) {
                $invalidProperties[] = "invalid value for 'routeName', the character length must be smaller than or equal to 64.";
            }
            if ((mb_strlen($this->container['routeName']) < 1)) {
                $invalidProperties[] = "invalid value for 'routeName', the character length must be bigger than or equal to 1.";
            }
            if (!preg_match("/^[a-zA-Z0-9\\-_]+$/", $this->container['routeName'])) {
                $invalidProperties[] = "invalid value for 'routeName', must be conform to the pattern /^[a-zA-Z0-9\\-_]+$/.";
            }
