...
class ConnectionClusterInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ConnectionClusterInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * peerId  对等连接ID。
    * status  连接状态。 CREATING：资源组网络连接正在创建中； ACTIVE：资源组网络连接创建成功，与目的地址连接正常； FAILED：资源组网络连接创建失败。
    * name  集群名称。
    ...
    * Sets status
    *
    * @param string|null $status 连接状态。 CREATING：资源组网络连接正在创建中； ACTIVE：资源组网络连接创建成功，与目的地址连接正常； FAILED：资源组网络连接创建失败。
    *
    * @return $this
    */
