...
class DeclineSecurityApplicationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeclineSecurityApplicationRequest';
    ...
    */
    protected static $openAPITypes = [
            'workspace' => 'string',
            'id' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\ReasonDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\ReasonDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\ReasonDTO|null $body body
    *
    * @return $this
    */
