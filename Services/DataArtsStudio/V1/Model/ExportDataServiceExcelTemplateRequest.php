...
class ExportDataServiceExcelTemplateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExportDataServiceExcelTemplateRequest';
