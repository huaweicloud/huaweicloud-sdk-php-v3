...
class ShowSecurityDynamicMaskingPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowSecurityDynamicMaskingPolicyRequest';
