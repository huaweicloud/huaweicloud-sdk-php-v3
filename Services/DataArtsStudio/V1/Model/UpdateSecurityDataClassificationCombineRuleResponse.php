...
class UpdateSecurityDataClassificationCombineRuleResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateSecurityDataClassificationCombineRuleResponse';
