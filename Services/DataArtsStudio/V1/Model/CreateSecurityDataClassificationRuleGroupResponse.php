...
class CreateSecurityDataClassificationRuleGroupResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSecurityDataClassificationRuleGroupResponse';
