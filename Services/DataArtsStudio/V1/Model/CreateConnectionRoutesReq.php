...
class CreateConnectionRoutesReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateConnectionRoutesReq';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cidr'] === null) {
            ...
            if (!preg_match("/^[0-9]{1,3}(\\.[0-9]{1,3}){3}\/[0-9]{1,2}$/", $this->container['cidr'])) {
                $invalidProperties[] = "invalid value for 'cidr', must be conform to the pattern /^[0-9]{1,3}(\\.[0-9]{1,3}){3}\/[0-9]{1,2}$/.";
            }
