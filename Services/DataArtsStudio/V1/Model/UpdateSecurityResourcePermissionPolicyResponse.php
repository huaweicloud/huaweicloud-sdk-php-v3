...
class UpdateSecurityResourcePermissionPolicyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateSecurityResourcePermissionPolicyResponse';
