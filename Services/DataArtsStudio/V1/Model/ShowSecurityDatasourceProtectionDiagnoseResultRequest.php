...
class ShowSecurityDatasourceProtectionDiagnoseResultRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowSecurityDatasourceProtectionDiagnoseResultRequest';
