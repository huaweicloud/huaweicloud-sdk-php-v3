...
class SecurityGroupResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SecurityGroupResult';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * result  result
    * securityGroup  kerberos信息
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'result' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\DiagnoseResult',
            'securityGroup' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\SecurityGroupStatus[]'
    ];
    ...
    *  kerberos信息
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\SecurityGroupStatus[]|null
    */
    ...
    * Sets securityGroup
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\SecurityGroupStatus[]|null $securityGroup kerberos信息
    *
    * @return $this
    */
