...
class ImportDataMapLineageRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImportDataMapLineageRequest';
    ...
    */
    protected static $openAPITypes = [
            'instance' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\ImportDataMapLineageRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\ImportDataMapLineageRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\ImportDataMapLineageRequestBody|null $body body
    *
    * @return $this
    */
