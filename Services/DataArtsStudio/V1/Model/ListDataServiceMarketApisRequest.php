...
class ListDataServiceMarketApisRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDataServiceMarketApisRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'dlmType' => 'string',
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\MallParaDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\MallParaDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\MallParaDTO|null $body body
    *
    * @return $this
    */
