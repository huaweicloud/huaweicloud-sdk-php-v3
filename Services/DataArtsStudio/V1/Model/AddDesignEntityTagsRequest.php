...
class AddDesignEntityTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddDesignEntityTagsRequest';
    ...
    * Sets attrId
    *
    * @param string|null $attrId 属性的ID，ID字符串。
    *
    * @return $this
    */
