...
class ColumnConfig implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ColumnConfig';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['column'] === null) {
            ...
            if ((mb_strlen($this->container['column']) > 100)) {
                $invalidProperties[] = "invalid value for 'column', the character length must be smaller than or equal to 100.";
            }
            if ((mb_strlen($this->container['column']) < 1)) {
                $invalidProperties[] = "invalid value for 'column', the character length must be bigger than or equal to 1.";
            }
