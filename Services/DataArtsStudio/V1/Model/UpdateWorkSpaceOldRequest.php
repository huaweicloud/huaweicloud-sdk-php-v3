...
class UpdateWorkSpaceOldRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateWorkSpaceOldRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'workspaceId' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\WorkspaceDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\WorkspaceDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\WorkspaceDto|null $body body
    *
    * @return $this
    */
