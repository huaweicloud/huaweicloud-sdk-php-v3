...
class ShowRealTimeJobDetailsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowRealTimeJobDetailsRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['jobName'] === null) {
            ...
            if (!preg_match("/^[\\u4e00-\\u9fa5a-zA-Z0-9\\-_.]+$/", $this->container['jobName'])) {
                $invalidProperties[] = "invalid value for 'jobName', must be conform to the pattern /^[\\u4e00-\\u9fa5a-zA-Z0-9\\-_.]+$/.";
            }
