...
class ListSecurityMemberPermissionsByUserIdRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSecurityMemberPermissionsByUserIdRequest';
    ...
    * startExpireTime  过期时间开始时间戳，毫秒。
    * endExpireTime  过期时间结束时间戳，毫秒。
    * workspace  DataArts Studio工作空间ID
    * orderBy  排序参数,EXPIRE_TIME
    * orderByAsc  升序/降序。true升序，false降序
    *
    * @var string[]
    */
    ...
    */
    protected static $attributeMap = [
            ...
            'startExpireTime' => 'start_expire_time',
            'endExpireTime' => 'end_expire_time',
            'workspace' => 'workspace',
            'orderBy' => 'order_by',
    ...
    */
    protected static $setters = [
            ...
            'startExpireTime' => 'setStartExpireTime',
            'endExpireTime' => 'setEndExpireTime',
    ...
    */
    protected static $getters = [
            ...
            'startExpireTime' => 'getStartExpireTime',
            'endExpireTime' => 'getEndExpireTime',
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['startExpireTime'] = isset($data['startExpireTime']) ? $data['startExpireTime'] : null;
        $this->container['endExpireTime'] = isset($data['endExpireTime']) ? $data['endExpireTime'] : null;
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['userId'] === null) {
            ...
            if (!is_null($this->container['startExpireTime']) && ($this->container['startExpireTime'] > 2830012519194)) {
                $invalidProperties[] = "invalid value for 'startExpireTime', must be smaller than or equal to 2830012519194.";
            }
            if (!is_null($this->container['startExpireTime']) && ($this->container['startExpireTime'] < 0)) {
                $invalidProperties[] = "invalid value for 'startExpireTime', must be bigger than or equal to 0.";
            }
            if (!is_null($this->container['endExpireTime']) && ($this->container['endExpireTime'] > 2830012519194)) {
                $invalidProperties[] = "invalid value for 'endExpireTime', must be smaller than or equal to 2830012519194.";
            }
            if (!is_null($this->container['endExpireTime']) && ($this->container['endExpireTime'] < 0)) {
                $invalidProperties[] = "invalid value for 'endExpireTime', must be bigger than or equal to 0.";
            }
    ...
    * Sets schemaName
    *
    * @param string|null $schemaName Schema名，正向模糊匹配
    *
    * @return $this
    */
    ...
    */
    ...
    /**
    * Gets startExpireTime
    *  过期时间开始时间戳，毫秒。
    *
    * @return int|null
    */
    public function getStartExpireTime()
    {
        return $this->container['startExpireTime'];
    }

    /**
    * Sets startExpireTime
    *
    * @param int|null $startExpireTime 过期时间开始时间戳，毫秒。
    *
    * @return $this
    */
    public function setStartExpireTime($startExpireTime)
    {
        $this->container['startExpireTime'] = $startExpireTime;
        return $this;
    }
    ...
    * @return int|null
    */
    public function getEndExpireTime()
    {
        return $this->container['endExpireTime'];
    }

    /**
    * Sets endExpireTime
    *
    * @param int|null $endExpireTime 过期时间结束时间戳，毫秒。
    *
    * @return $this
    */
    public function setEndExpireTime($endExpireTime)
    {
        $this->container['endExpireTime'] = $endExpireTime;
        return $this;
    }
    ...
    * Sets orderByAsc
    *
    * @param bool|null $orderByAsc 升序/降序。true升序，false降序
    *
    * @return $this
    */
