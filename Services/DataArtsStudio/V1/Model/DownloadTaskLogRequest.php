...
class DownloadTaskLogRequest implements ModelInterface, ArrayAccess
{
    ...
    * taskId  作业任务ID。
    * path  需要下载内容的文件路径。
    * range  下载文件内容范围，如0-100，表示下载0-100字节范围的内容。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['taskId'] === null) {
            ...
            if (!preg_match("/^[a-zA-Z0-9\\-_]+$/", $this->container['taskId'])) {
                $invalidProperties[] = "invalid value for 'taskId', must be conform to the pattern /^[a-zA-Z0-9\\-_]+$/.";
            }
        if ($this->container['path'] === null) {
            ...
            if (!is_null($this->container['range']) && !preg_match("/^[0-9]{1,10}-[0-9]{1,10}$/", $this->container['range'])) {
                $invalidProperties[] = "invalid value for 'range', must be conform to the pattern /^[0-9]{1,10}-[0-9]{1,10}$/.";
            }
    ...
    * Sets range
    *
    * @param string|null $range 下载文件内容范围，如0-100，表示下载0-100字节范围的内容。
    *
    * @return $this
    */
