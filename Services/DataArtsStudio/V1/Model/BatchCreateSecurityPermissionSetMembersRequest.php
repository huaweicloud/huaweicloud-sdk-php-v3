...
class BatchCreateSecurityPermissionSetMembersRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateSecurityPermissionSetMembersRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspace' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\PermissionSetMemberBatchCreateDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\PermissionSetMemberBatchCreateDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\PermissionSetMemberBatchCreateDTO|null $body body
    *
    * @return $this
    */
