...
class UpdateDatasourceConnectionHostMessageResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDatasourceConnectionHostMessageResponse';
