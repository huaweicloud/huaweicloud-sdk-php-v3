...
class CreateDesignDerivativeIndexRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateDesignDerivativeIndexRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xProjectId' => 'string',
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\DerivativeIndexVO[]'
    ];
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\DerivativeIndexVO[]|null $body body
    *
    * @return $this
    */
