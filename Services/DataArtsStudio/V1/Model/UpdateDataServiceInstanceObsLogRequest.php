...
class UpdateDataServiceInstanceObsLogRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDataServiceInstanceObsLogRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'contentType' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\ObsLogDump'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\ObsLogDump|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\ObsLogDump|null $body body
    *
    * @return $this
    */
