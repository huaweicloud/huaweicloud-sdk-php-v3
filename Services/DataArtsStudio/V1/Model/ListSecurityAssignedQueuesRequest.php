...
class ListSecurityAssignedQueuesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSecurityAssignedQueuesRequest';
    ...
    * Sets type
    *
    * @param string|null $type 队列类型，MRS、DLI。
    *
    * @return $this
    */
