...
class DeleteDesignLatestApprovalRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteDesignLatestApprovalRequest';
    ...
    * bizId  待删除下展的实体ID。
    * bizType  待删除下展的实体类型。ATOMIC_INDEX(原子指标)、DERIVATIVE_INDEX(衍生指标)、DIMENSION(维度)、FACT_LOGIC_TABLE(事实表)、TABLE_MODEL(业务表：逻辑实体/物理表)、STANDARD_ELEMENT(数据标准)、AGGREGATION_LOGIC_TABLE(汇总表)、CODE_TABLE(码表)、BIZ_METRIC(业务指标)、COMPOUND_METRIC(复合指标)。
    *
    * @var string[]
    */
    ...
    */
    ...
    const BIZ_TYPE_ATOMIC_INDEX = 'ATOMIC_INDEX';
    const BIZ_TYPE_DERIVATIVE_INDEX = 'DERIVATIVE_INDEX';
    const BIZ_TYPE_DIMENSION = 'DIMENSION';
    const BIZ_TYPE_FACT_LOGIC_TABLE = 'FACT_LOGIC_TABLE';
    const BIZ_TYPE_TABLE_MODEL = 'TABLE_MODEL';
    const BIZ_TYPE_STANDARD_ELEMENT = 'STANDARD_ELEMENT';
    const BIZ_TYPE_AGGREGATION_LOGIC_TABLE = 'AGGREGATION_LOGIC_TABLE';
    const BIZ_TYPE_CODE_TABLE = 'CODE_TABLE';
    const BIZ_TYPE_BIZ_METRIC = 'BIZ_METRIC';
    const BIZ_TYPE_COMPOUND_METRIC = 'COMPOUND_METRIC';
    ...
    */
    ...
    {
        return [
            self::BIZ_TYPE_ATOMIC_INDEX,
            self::BIZ_TYPE_DERIVATIVE_INDEX,
            self::BIZ_TYPE_DIMENSION,
            self::BIZ_TYPE_FACT_LOGIC_TABLE,
            self::BIZ_TYPE_TABLE_MODEL,
            self::BIZ_TYPE_STANDARD_ELEMENT,
            self::BIZ_TYPE_AGGREGATION_LOGIC_TABLE,
            self::BIZ_TYPE_CODE_TABLE,
            self::BIZ_TYPE_BIZ_METRIC,
            self::BIZ_TYPE_COMPOUND_METRIC,
        ];
    }
    ...
    * Sets bizType
    *
    * @param string $bizType 待删除下展的实体类型。ATOMIC_INDEX(原子指标)、DERIVATIVE_INDEX(衍生指标)、DIMENSION(维度)、FACT_LOGIC_TABLE(事实表)、TABLE_MODEL(业务表：逻辑实体/物理表)、STANDARD_ELEMENT(数据标准)、AGGREGATION_LOGIC_TABLE(汇总表)、CODE_TABLE(码表)、BIZ_METRIC(业务指标)、COMPOUND_METRIC(复合指标)。
    *
    * @return $this
    */
