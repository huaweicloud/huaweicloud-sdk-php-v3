...
class ReasonDTO implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ReasonDTO';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['reason'] === null) {
            ...
            if ((mb_strlen($this->container['reason']) > 500)) {
