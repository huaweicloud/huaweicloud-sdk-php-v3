...
class UpdateSecurityDataClassificationCombineRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateSecurityDataClassificationCombineRuleRequest';
    ...
    */
    protected static $openAPITypes = [
            'workspace' => 'string',
            'id' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\DataClassificationCombineRuleDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\DataClassificationCombineRuleDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\DataClassificationCombineRuleDTO|null $body body
    *
    * @return $this
    */
