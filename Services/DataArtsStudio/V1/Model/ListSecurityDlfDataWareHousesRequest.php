...
class ListSecurityDlfDataWareHousesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSecurityDlfDataWareHousesRequest';
