...
class ShowSecurityResourcePermissionPolicyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowSecurityResourcePermissionPolicyResponse';
