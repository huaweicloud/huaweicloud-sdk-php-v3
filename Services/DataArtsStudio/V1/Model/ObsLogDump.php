...
class ObsLogDump implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ObsLogDump';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * logDump  是否开启Obs日志转储功能，true表示开启，false表示关闭。
    *
    * @var string[]
    */
    ...
    * Sets logDump
    *
    * @param bool|null $logDump 是否开启Obs日志转储功能，true表示开启，false表示关闭。
    *
    * @return $this
    */
