...
class ListAllTablesRequest implements ModelInterface, ArrayAccess
{
    ...
    * bizTypeList  查询的表类型，必填。TABLE_MODEL_LOGIC(逻辑实体)、TABLE_MODEL(物理表)、DIMENSION_LOGIC_TABLE(维度表)、FACT_LOGIC_TABLE(事实表)、AGGREGATION_LOGIC_TABLE(汇总表)。
    *
    * @var string[]
    */
    ...
    * Sets bizTypeList
    *
    * @param string[] $bizTypeList 查询的表类型，必填。TABLE_MODEL_LOGIC(逻辑实体)、TABLE_MODEL(物理表)、DIMENSION_LOGIC_TABLE(维度表)、FACT_LOGIC_TABLE(事实表)、AGGREGATION_LOGIC_TABLE(汇总表)。
    *
    * @return $this
    */
