...
class ShowSecurityDynamicMaskingPolicyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowSecurityDynamicMaskingPolicyResponse';
