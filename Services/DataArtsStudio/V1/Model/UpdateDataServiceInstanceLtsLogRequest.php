...
class UpdateDataServiceInstanceLtsLogRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDataServiceInstanceLtsLogRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'contentType' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\LtsLogDump'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\LtsLogDump|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\LtsLogDump|null $body body
    *
    * @return $this
    */
