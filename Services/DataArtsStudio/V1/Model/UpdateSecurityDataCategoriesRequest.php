...
class UpdateSecurityDataCategoriesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateSecurityDataCategoriesRequest';
    ...
    */
    protected static $openAPITypes = [
            'workspace' => 'string',
            'id' => 'string',
            'body' => '\HuaweiCloud\SDK\DataArtsStudio\V1\Model\DataCategoryUpdateDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DataArtsStudio\V1\Model\DataCategoryUpdateDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DataArtsStudio\V1\Model\DataCategoryUpdateDTO|null $body body
    *
    * @return $this
    */
