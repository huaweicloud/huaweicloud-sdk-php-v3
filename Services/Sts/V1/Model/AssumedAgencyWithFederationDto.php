...
class AssumedAgencyWithFederationDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssumedAgencyWithFederationDto';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * urn  **参数解释**： 信任委托会话的URN。  **取值范围**： 不涉及。
    * id  **参数解释**： 信任委托会话的唯一标识，包含了信任委托ID和信任委托会话名称信息。  **取值范围**： 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets urn
    *
    * @param string $urn **参数解释**： 信任委托会话的URN。  **取值范围**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets id
    *
    * @param string $id **参数解释**： 信任委托会话的唯一标识，包含了信任委托ID和信任委托会话名称信息。  **取值范围**： 不涉及。
    *
    * @return $this
    */
