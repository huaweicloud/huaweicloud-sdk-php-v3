...
class AssumeAgencyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssumeAgencyRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Sts\V1\Model\AssumeAgencyReqBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Sts\V1\Model\AssumeAgencyReqBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Sts\V1\Model\AssumeAgencyReqBody|null $body body
    *
    * @return $this
    */
