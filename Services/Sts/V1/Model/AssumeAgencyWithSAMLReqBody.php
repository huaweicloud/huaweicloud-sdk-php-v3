...
class AssumeAgencyWithSAMLReqBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssumeAgencyWithSAMLReqBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * durationSeconds  **参数解释**： 获得的临时安全凭证的有效时间（单位：秒）。  **约束限制**： 获得的临时安全凭证的有效时间（单位：秒）。请注意，该时间需要小于信任委托本身设置的最大会话持续时间。同时最终的会话持续时间以duration_seconds，  SAML身份验证响应中SessionNotOnOrAfter值和SessionDuration值三者中较短的一个为准。  **取值范围**： 取值范围为[900,43200]。  **默认取值**： 默认值为3600。
    ...
    * providerUrn  **参数解释**： SAML提供商的URN。  **约束限制**： 长度范围为[0,1500]。  **取值范围**： 不涉及。  **默认取值**： 不涉及。
    * agencyUrn  **参数解释**： 目标信任委托的URN。  **约束限制**： 长度范围为[0,1500]。  **取值范围**： 不涉及。  **默认取值**： 不涉及。
    * samlAssertion  **参数解释**： 由SAML身份提供商提供的Base64编码的SAML身份验证响应。  **约束限制**： 长度范围为[4,100000]。  **取值范围**： 不涉及。  **默认取值**： 不涉及。
    *
    * @var string[]
    */
    ...
    */
    protected static $setters = [
            ...
            'samlAssertion' => 'setSamlAssertion'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['samlAssertion'] = isset($data['samlAssertion']) ? $data['samlAssertion'] : null;
    }
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['samlAssertion'] === null) {
            $invalidProperties[] = "'samlAssertion' can't be null";
        }
            if ((mb_strlen($this->container['samlAssertion']) > 100000)) {
                $invalidProperties[] = "invalid value for 'samlAssertion', the character length must be smaller than or equal to 100000.";
            }
            if ((mb_strlen($this->container['samlAssertion']) < 4)) {
                $invalidProperties[] = "invalid value for 'samlAssertion', the character length must be bigger than or equal to 4.";
            }
            if (!preg_match("/^[a-zA-Z0-9+\/]*={0,2}$/", $this->container['samlAssertion'])) {
                $invalidProperties[] = "invalid value for 'samlAssertion', must be conform to the pattern /^[a-zA-Z0-9+\/]*={0,2}$/.";
            }
    ...
    *
    * @param int|null $durationSeconds **参数解释**： 获得的临时安全凭证的有效时间（单位：秒）。  **约束限制**： 获得的临时安全凭证的有效时间（单位：秒）。请注意，该时间需要小于信任委托本身设置的最大会话持续时间。同时最终的会话持续时间以duration_seconds，  SAML身份验证响应中SessionNotOnOrAfter值和SessionDuration值三者中较短的一个为准。  **取值范围**： 取值范围为[900,43200]。  **默认取值**： 默认值为3600。
    *
    * @return $this
    */
    ...
    * Sets providerUrn
    *
    * @param string $providerUrn **参数解释**： SAML提供商的URN。  **约束限制**： 长度范围为[0,1500]。  **取值范围**： 不涉及。  **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    */
    ...
    {
        return $this->container['samlAssertion'];
    }

    /**
    * Sets samlAssertion
    *
    * @param string $samlAssertion **参数解释**： 由SAML身份提供商提供的Base64编码的SAML身份验证响应。  **约束限制**： 长度范围为[4,100000]。  **取值范围**： 不涉及。  **默认取值**： 不涉及。
    *
    * @return $this
    */
    public function setSamlAssertion($samlAssertion)
    {
        $this->container['samlAssertion'] = $samlAssertion;
        return $this;
    }
