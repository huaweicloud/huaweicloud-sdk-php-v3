...
class StsAsyncClient extends Client
{
     ...
     * @return response
     */
    public function assumeAgencyWithOIDCAsync($request)
    {
        return $this->assumeAgencyWithOIDCAsyncWithHttpInfo($request);
    }
    
    public function assumeAgencyWithOIDCAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v5/agencies/assume-with-oidc';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Sts\V1\Model\AssumeAgencyWithOIDCResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Sts\V1\Model\AssumeAgencyWithOIDCRequest',
            $asyncRequest = true);
    }
     ...
     * @return response
     */
    public function assumeAgencyWithSAMLAsync($request)
    {
        return $this->assumeAgencyWithSAMLAsyncWithHttpInfo($request);
    }
    
    public function assumeAgencyWithSAMLAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v5/agencies/assume-with-saml';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Sts\V1\Model\AssumeAgencyWithSAMLResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Sts\V1\Model\AssumeAgencyWithSAMLRequest',
            $asyncRequest = true);
    }
