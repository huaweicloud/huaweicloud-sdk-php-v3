...
class StsClient extends Client
{
     ...
     * @return response
     */
    public function assumeAgencyWithOIDC($request)
    {
        return $this->assumeAgencyWithOIDCWithHttpInfo($request);
    }

    public function assumeAgencyWithOIDCWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function assumeAgencyWithSAML($request)
    {
        return $this->assumeAgencyWithSAMLWithHttpInfo($request);
    }

    public function assumeAgencyWithSAMLWithHttpInfo($request)
    {
