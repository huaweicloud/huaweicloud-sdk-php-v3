...
class ShowClickHouseLtsConfigResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowClickHouseLtsConfigResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceLtsConfigs  实例LTS配置信息。
    * totalCount  实例总数。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'instanceLtsConfigs' => '\HuaweiCloud\SDK\GaussDB\V3\Model\ChInstanceLtsConfigs[]',
            'totalCount' => 'int'
    ];
    ...
    *  实例LTS配置信息。
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\ChInstanceLtsConfigs[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\ChInstanceLtsConfigs[]|null $instanceLtsConfigs 实例LTS配置信息。
    *
    * @return $this
    */
