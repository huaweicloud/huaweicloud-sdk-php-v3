...
class ShowHtapErrorLogDetailRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowHtapErrorLogDetailRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\GaussDB\V3\Model\HtapErrorLogQueryRequestBody'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['xLanguage'] === null) {
            ...
            if ((mb_strlen($this->container['xLanguage']) > 10)) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\HtapErrorLogQueryRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\HtapErrorLogQueryRequestBody|null $body body
    *
    * @return $this
    */
