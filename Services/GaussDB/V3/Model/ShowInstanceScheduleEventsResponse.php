...
class ShowInstanceScheduleEventsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowInstanceScheduleEventsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalCount  **参数解释**：  事件总数。  **取值范围**：  不涉及。
    * inquiringCount  **参数解释**：  待授权的事件数。  **取值范围**：  不涉及。
    * scheduleCount  **参数解释**：  待执行的事件数。  **取值范围**：  不涉及。
    * executingCount  **参数解释**：  正在执行的事件数。  **取值范围**：  不涉及。
    * failedCount  **参数解释**：  执行失败的事件数。  **取值范围**：  不涉及。
    * events  **参数解释**：  事件详情列表，包含事件ID、事件类别、事件状态、事件级别、实例信息、执行时间等详细信息
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'executingCount' => 'int',
            'failedCount' => 'int',
            'events' => '\HuaweiCloud\SDK\GaussDB\V3\Model\ScheduleEventInfo[]'
    ];
    ...
    * Sets totalCount
    *
    * @param int|null $totalCount **参数解释**：  事件总数。  **取值范围**：  不涉及。
    *
    * @return $this
    */
    ...
    * Sets inquiringCount
    *
    * @param int|null $inquiringCount **参数解释**：  待授权的事件数。  **取值范围**：  不涉及。
    *
    * @return $this
    */
    ...
    * Sets scheduleCount
    *
    * @param int|null $scheduleCount **参数解释**：  待执行的事件数。  **取值范围**：  不涉及。
    *
    * @return $this
    */
    ...
    * Sets executingCount
    *
    * @param int|null $executingCount **参数解释**：  正在执行的事件数。  **取值范围**：  不涉及。
    *
    * @return $this
    */
    ...
    * Sets failedCount
    *
    * @param int|null $failedCount **参数解释**：  执行失败的事件数。  **取值范围**：  不涉及。
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\ScheduleEventInfo[]|null
    */
    ...
    * Sets events
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\ScheduleEventInfo[]|null $events **参数解释**：  事件详情列表，包含事件ID、事件类别、事件状态、事件级别、实例信息、执行时间等详细信息
    *
    * @return $this
    */
