...
class ShowTaurusDbTxnProgressRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowTaurusDbTxnProgressRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'instanceId' => 'string',
            'nodeId' => 'string',
            'body' => '\HuaweiCloud\SDK\GaussDB\V3\Model\TxnProgressRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\TxnProgressRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\TxnProgressRequestBody|null $body body
    *
    * @return $this
    */
