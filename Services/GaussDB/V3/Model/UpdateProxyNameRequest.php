...
class UpdateProxyNameRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateProxyNameRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'proxyId' => 'string',
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\GaussDB\V3\Model\ProxyUpdateProxyNameRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\ProxyUpdateProxyNameRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\ProxyUpdateProxyNameRequest|null $body body
    *
    * @return $this
    */
