...
class ShowStarRocksDatabaseUsersUserDetails implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowStarRocksDatabaseUsers_user_details';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * userName  数据库账户名。
    * dataBases  已授权数据库。
    * dml  DML授权。 - 0：读写权限 - 1：只读权限 - 2：只读和设置权限 - 3：读写和设置权限
    * ddl  DDL授权。 - 0：无DDL权限 - 1：有DDL权限
    *
    * @var string[]
    */
    ...
    * Sets dml
    *
    * @param int $dml DML授权。 - 0：读写权限 - 1：只读权限 - 2：只读和设置权限 - 3：读写和设置权限
    *
    * @return $this
    */
    ...
    * Sets ddl
    *
    * @param int $ddl DDL授权。 - 0：无DDL权限 - 1：有DDL权限
    *
    * @return $this
    */
