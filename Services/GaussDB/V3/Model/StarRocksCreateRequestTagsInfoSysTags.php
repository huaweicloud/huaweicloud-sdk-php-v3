...
class StarRocksCreateRequestTagsInfoSysTags implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StarRocksCreateRequest_tags_info_sys_tags';
    ...
    */
    ...
    const KEY_SYS_ENTERPRISE_PROJECT_ID = '_sys_enterprise_project_id';
    const VALUE__0 = '0';
    ...
    */
    ...
    {
        return [
            self::KEY_SYS_ENTERPRISE_PROJECT_ID,
        ];
    }
