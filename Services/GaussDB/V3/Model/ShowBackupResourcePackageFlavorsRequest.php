...
class ShowBackupResourcePackageFlavorsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowBackupResourcePackageFlavorsRequest';
