...
class ListStarRocksDataReplicationConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListStarRocksDataReplicationConfigRequest';
