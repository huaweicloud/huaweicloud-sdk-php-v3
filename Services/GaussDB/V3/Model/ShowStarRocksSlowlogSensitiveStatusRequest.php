...
class ShowStarRocksSlowlogSensitiveStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowStarRocksSlowlogSensitiveStatusRequest';
