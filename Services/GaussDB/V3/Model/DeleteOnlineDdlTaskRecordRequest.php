...
class DeleteOnlineDdlTaskRecordRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteOnlineDdlTaskRecordRequest';
    ...
    */
    protected static $openAPITypes = [
            'xLanguage' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\GaussDB\V3\Model\DeleteOnlineDDLTaskRecordRequestV3'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\DeleteOnlineDDLTaskRecordRequestV3|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\DeleteOnlineDDLTaskRecordRequestV3|null $body body
    *
    * @return $this
    */
