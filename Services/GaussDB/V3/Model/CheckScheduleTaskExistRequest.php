...
class CheckScheduleTaskExistRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CheckScheduleTaskExistRequest';
    ...
    */
    protected static $openAPITypes = [
            'xLanguage' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\GaussDB\V3\Model\CheckScheduleTaskExistRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\CheckScheduleTaskExistRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\CheckScheduleTaskExistRequestBody|null $body body
    *
    * @return $this
    */
