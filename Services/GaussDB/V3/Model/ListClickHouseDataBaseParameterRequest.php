...
class ListClickHouseDataBaseParameterRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListClickHouseDataBaseParameterRequest';
