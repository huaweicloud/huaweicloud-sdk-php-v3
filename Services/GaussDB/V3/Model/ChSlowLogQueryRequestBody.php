...
class ChSlowLogQueryRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChSlowLogQueryRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * nodeId  实例节点ID。
    * startTime  开始时间，格式为“yyyy-mm-ddThh:mm:ssZ”。  其中，T指某个时间的开始；Z指时区偏移量，例如偏移1个小时显示为+0100。
    * endTime  开始时间，格式为“yyyy-mm-ddThh:mm:ssZ”。  其中，T指某个时间的开始；Z指时区偏移量，例如偏移1个小时显示为+0100。
    * limit  查询记录数。
    ...
    * Sets endTime
    *
    * @param string $endTime 开始时间，格式为“yyyy-mm-ddThh:mm:ssZ”。  其中，T指某个时间的开始；Z指时区偏移量，例如偏移1个小时显示为+0100。
    *
    * @return $this
    */
    ...
    * Sets operateType
    *
    * @param string|null $operateType 慢日志操作类型。
    *
    * @return $this
    */
