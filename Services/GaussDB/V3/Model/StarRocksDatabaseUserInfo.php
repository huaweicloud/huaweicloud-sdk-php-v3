...
class StarRocksDatabaseUserInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StarRocksDatabaseUserInfo';
    ...
    * databases  数据库列表。
    * dml  DML权限，默认2。 取值范围： - 0：读写权限 - 1：只读权限 - 2：只读和设置权限 - 3：读写和设置权限
    * ddl  DDL权限，默认0。 取值范围： - 0：无DDL权限 - 1：有DDL权限
    *
    * @var string[]
    */
    ...
    * Sets dml
    *
    * @param int|null $dml DML权限，默认2。 取值范围： - 0：读写权限 - 1：只读权限 - 2：只读和设置权限 - 3：读写和设置权限
    *
    * @return $this
    */
    ...
    * Sets ddl
    *
    * @param int|null $ddl DDL权限，默认0。 取值范围： - 0：无DDL权限 - 1：有DDL权限
    *
    * @return $this
    */
