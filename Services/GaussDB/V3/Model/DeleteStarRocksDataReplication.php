...
class DeleteStarRocksDataReplication implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteStarRocksDataReplication';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * taskName  数据同步任务名。字符长度限制3~128位，仅支持英文大小写字母、数字以及下划线_。
    *
    * @var string[]
    */
    ...
    * Sets taskName
    *
    * @param string|null $taskName 数据同步任务名。字符长度限制3~128位，仅支持英文大小写字母、数字以及下划线_。
    *
    * @return $this
    */
