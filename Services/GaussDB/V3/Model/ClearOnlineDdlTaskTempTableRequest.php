...
class ClearOnlineDdlTaskTempTableRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ClearOnlineDdlTaskTempTableRequest';
    ...
    */
    protected static $openAPITypes = [
            'xLanguage' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\GaussDB\V3\Model\ClearOnlineDDLTaskTempTableRequestV3'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\ClearOnlineDDLTaskTempTableRequestV3|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\ClearOnlineDDLTaskTempTableRequestV3|null $body body
    *
    * @return $this
    */
