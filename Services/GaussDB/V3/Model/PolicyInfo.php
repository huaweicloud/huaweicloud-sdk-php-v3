...
class PolicyInfo implements ModelInterface, ArrayAccess
{
    ...
    * retentionDays  **参数解释**:  备份文件的保留天数。  **约束限制**：  不涉及。  **取值范围**：  1~732。 您也可以联系客服申请开通最大保留天数为3660。  **默认取值**：  不涉及。
    * policyType  **参数解释**:  备份策略类型。  **约束限制**：  不涉及。  **取值范围**：    - base：普通备份策略。    - sparse：稀疏备份策略。  **默认取值**：  不涉及。
    *
    * @var string[]
    */
    ...
    */
    ...
    /**
    * Gets retentionDays
    *  **参数解释**:  备份文件的保留天数。  **约束限制**：  不涉及。  **取值范围**：  1~732。 您也可以联系客服申请开通最大保留天数为3660。  **默认取值**：  不涉及。
    *
    * @return int
    */
    ...
    * Sets retentionDays
    *
    * @param int $retentionDays **参数解释**:  备份文件的保留天数。  **约束限制**：  不涉及。  **取值范围**：  1~732。 您也可以联系客服申请开通最大保留天数为3660。  **默认取值**：  不涉及。
    *
    * @return $this
    */
    ...
    /**
    * Gets policyType
    *  **参数解释**:  备份策略类型。  **约束限制**：  不涉及。  **取值范围**：    - base：普通备份策略。    - sparse：稀疏备份策略。  **默认取值**：  不涉及。
    *
    * @return string
    */
    ...
    * Sets policyType
    *
    * @param string $policyType **参数解释**:  备份策略类型。  **约束限制**：  不涉及。  **取值范围**：    - base：普通备份策略。    - sparse：稀疏备份策略。  **默认取值**：  不涉及。
    *
    * @return $this
    */
