...
class EventScheduleWindow implements ModelInterface, ArrayAccess
{
    ...
    * plannedDay  **参数解释**：  执行日期。  **约束限制**：  格式为“yyyy-mm-dd”。  **取值范围**：  大于或等于当前日期。  **默认取值**：  不涉及。
    * startTime  **参数解释**：  事件执行窗口开始时间。  **约束限制**：  格式为 “hh:mm”。当end_time有值时，该字段必传。  **取值范围**：  不涉及。  **默认取值**：  “01:00”。
    * endTime  **参数解释**：  事件执行窗口结束时间。  **约束限制**：  格式为 \"hh:mm\"。当start_time有值时，该字段必传。  **取值范围**：  不涉及。  **默认取值**：  “03:00”。
    *
    * @var string[]
    */
    ...
    * Sets plannedDay
    *
    * @param string $plannedDay **参数解释**：  执行日期。  **约束限制**：  格式为“yyyy-mm-dd”。  **取值范围**：  大于或等于当前日期。  **默认取值**：  不涉及。
    *
    * @return $this
    */
    ...
    * Sets startTime
    *
    * @param string|null $startTime **参数解释**：  事件执行窗口开始时间。  **约束限制**：  格式为 “hh:mm”。当end_time有值时，该字段必传。  **取值范围**：  不涉及。  **默认取值**：  “01:00”。
    *
    * @return $this
    */
    ...
    * Sets endTime
    *
    * @param string|null $endTime **参数解释**：  事件执行窗口结束时间。  **约束限制**：  格式为 \"hh:mm\"。当start_time有值时，该字段必传。  **取值范围**：  不涉及。  **默认取值**：  “03:00”。
    *
    * @return $this
    */
