...
class SwitchGaussMySqlProxyAltRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SwitchGaussMySqlProxyAltRequest';
    ...
    * proxyId  **参数解释**：  数据库代理ID，此参数是数据库代理的唯一标识。  获取方法请参见[查询数据库代理信息列表](https://support.huaweicloud.com/api-taurusdb/ShowGaussMySqlProxyList.html)。  **约束限制**：  不涉及。  **取值范围**：  只能由英文字母、数字组成，后缀为po01，长度为36个字符。  **默认取值**：  不涉及。
    ...
    */
    protected static $openAPITypes = [
            ...
            'proxyId' => 'string',
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\GaussDB\V3\Model\SwitchGaussMySqlProxyAltRequestBody'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['proxyId'] === null) {
            ...
            if ((mb_strlen($this->container['proxyId']) > 36)) {
    ...
    * Sets proxyId
    *
    * @param string $proxyId **参数解释**：  数据库代理ID，此参数是数据库代理的唯一标识。  获取方法请参见[查询数据库代理信息列表](https://support.huaweicloud.com/api-taurusdb/ShowGaussMySqlProxyList.html)。  **约束限制**：  不涉及。  **取值范围**：  只能由英文字母、数字组成，后缀为po01，长度为36个字符。  **默认取值**：  不涉及。
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\SwitchGaussMySqlProxyAltRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\SwitchGaussMySqlProxyAltRequestBody|null $body body
    *
    * @return $this
    */
