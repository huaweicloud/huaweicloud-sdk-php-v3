...
class ShowTaurusDbAdvancedBackupPolicyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowTaurusDbAdvancedBackupPolicyResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * beginTime  **参数解释**：  备份时间段开始时间。  **取值范围**：  非空，格式必须为hh:mm且有效，当前时间指UTC时间。
    * endTime  **参数解释**：  备份时间段结束时间。  **取值范围**：  非空，格式必须为hh:mm且有效，当前时间指UTC时间。end_time必须大于begin_time。
    * retentionNumBackupLevel1  **参数解释**：  一级备份保留数量。当一级备份开关开启时，返回此参数。  **取值范围**：  不涉及。
    * policies  **参数解释**：  备份策略集。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'policies' => '\HuaweiCloud\SDK\GaussDB\V3\Model\BackupPolicyInfo[]'
    ];
    ...
    * Sets beginTime
    *
    * @param string|null $beginTime **参数解释**：  备份时间段开始时间。  **取值范围**：  非空，格式必须为hh:mm且有效，当前时间指UTC时间。
    *
    * @return $this
    */
    ...
    * Sets endTime
    *
    * @param string|null $endTime **参数解释**：  备份时间段结束时间。  **取值范围**：  非空，格式必须为hh:mm且有效，当前时间指UTC时间。end_time必须大于begin_time。
    *
    * @return $this
    */
    ...
    *
    * @param int|null $retentionNumBackupLevel1 **参数解释**：  一级备份保留数量。当一级备份开关开启时，返回此参数。  **取值范围**：  不涉及。
    *
    * @return $this
    */
    ...
    *  **参数解释**：  备份策略集。
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\BackupPolicyInfo[]|null
    */
    ...
    * Sets policies
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\BackupPolicyInfo[]|null $policies **参数解释**：  备份策略集。
    *
    * @return $this
    */
