...
class UpgradeDatabasesSingleInstance implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpgradeDatabasesSingleInstance';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * currentVersion  实例当前的内核版本。
    * instanceId  实例id。
    *
    * @var string[]
    */
    ...
    * Sets currentVersion
    *
    * @param string $currentVersion 实例当前的内核版本。
    *
    * @return $this
    */
