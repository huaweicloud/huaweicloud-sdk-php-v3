...
class MysqlDatastoreInRes implements ModelInterface, ArrayAccess
{
    ...
    * kernelVersion  内核数据库版本。  完整的四位内核数据库版本号，获取方法请参见[查询数据库引擎的版本](https://support.huaweicloud.com/api-gaussdb/ShowGaussMySqlEngineVersion.html)返回的kernel_version字段。
    *
    * @var string[]
    */
    ...
    * Sets kernelVersion
    *
    * @param string|null $kernelVersion 内核数据库版本。  完整的四位内核数据库版本号，获取方法请参见[查询数据库引擎的版本](https://support.huaweicloud.com/api-gaussdb/ShowGaussMySqlEngineVersion.html)返回的kernel_version字段。
    *
    * @return $this
    */
