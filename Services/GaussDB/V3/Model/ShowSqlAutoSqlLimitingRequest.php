...
class ShowSqlAutoSqlLimitingRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowSqlAutoSqlLimitingRequest';
    ...
    */
    protected static $openAPITypes = [
            'xLanguage' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\GaussDB\V3\Model\ShowSqlAutoSqlLimitingReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\ShowSqlAutoSqlLimitingReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\ShowSqlAutoSqlLimitingReq|null $body body
    *
    * @return $this
    */
