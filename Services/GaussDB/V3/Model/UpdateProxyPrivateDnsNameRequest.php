...
class UpdateProxyPrivateDnsNameRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateProxyPrivateDnsNameRequest';
    ...
    * proxyId  **参数解释**：  数据库代理ID，严格匹配UUID规则。  **约束限制**：  不涉及。  **取值范围**：  只能由英文字母、数字组成，后缀为po01，长度为36个字符。  **默认取值**：  不涉及。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'instanceId' => 'string',
            'proxyId' => 'string',
            'body' => '\HuaweiCloud\SDK\GaussDB\V3\Model\UpdateProxyPrivateDnsName'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\UpdateProxyPrivateDnsName|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\UpdateProxyPrivateDnsName|null $body body
    *
    * @return $this
    */
