...
class ShowStarRocksSlowlogSensitiveStatusResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowStarRocksSlowlogSensitiveStatusResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * openSlowLogSwitch  **参数解释**:  慢日志开关状态。  **取值范围**：  - true，开启。 - false，关闭。
    *
    * @var string[]
    */
    ...
    *
    * @param string|null $openSlowLogSwitch **参数解释**:  慢日志开关状态。  **取值范围**：  - true，开启。 - false，关闭。
    *
    * @return $this
    */
