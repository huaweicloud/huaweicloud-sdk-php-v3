...
class ShowAutoExpandPolicyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAutoExpandPolicyResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * switchOption  **参数解释**：  自动扩容策略开关。
    * limitSize  **参数解释**：  存储自动扩容上限，单位GB。
    * triggerAvailablePercent  **参数解释**：  可用存储空间率。
    * stepPercent  **参数解释**：  扩容步长百分比。
    *
    * @var string[]
    */
    ...
    * Sets switchOption
    *
    * @param bool|null $switchOption **参数解释**：  自动扩容策略开关。
    *
    * @return $this
    */
    ...
    * Sets limitSize
    *
    * @param int|null $limitSize **参数解释**：  存储自动扩容上限，单位GB。
    *
    * @return $this
    */
    ...
    *
    * @param int|null $triggerAvailablePercent **参数解释**：  可用存储空间率。
    *
    * @return $this
    */
    ...
    * Sets stepPercent
    *
    * @param int|null $stepPercent **参数解释**：  扩容步长百分比。
    *
    * @return $this
    */
