...
class UpdateTaurusDbAdvancedBackupPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateTaurusDbAdvancedBackupPolicyRequest';
    ...
    */
    protected static $openAPITypes = [
            'xLanguage' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\GaussDB\V3\Model\UpdateTaurusBackupPolicyRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\UpdateTaurusBackupPolicyRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\UpdateTaurusBackupPolicyRequest|null $body body
    *
    * @return $this
    */
