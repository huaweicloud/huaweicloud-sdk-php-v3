...
class UpdateSlowlogSensitiveSwitchRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateSlowlogSensitiveSwitchRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * openSlowLogSwitch  慢日志开关状态。
    *
    * @var string[]
    */
    ...
    *
    * @param bool $openSlowLogSwitch 慢日志开关状态。
    *
    * @return $this
    */
