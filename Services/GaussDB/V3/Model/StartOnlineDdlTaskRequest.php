...
class StartOnlineDdlTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StartOnlineDdlTaskRequest';
    ...
    */
    protected static $openAPITypes = [
            'xLanguage' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\GaussDB\V3\Model\StartOnlineDDLTaskRequestV3'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\StartOnlineDDLTaskRequestV3|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\StartOnlineDDLTaskRequestV3|null $body body
    *
    * @return $this
    */
