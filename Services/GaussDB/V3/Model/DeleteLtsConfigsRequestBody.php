...
class DeleteLtsConfigsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'logConfigs' => '\HuaweiCloud\SDK\GaussDB\V3\Model\InstanceDeleteLtsConfig[]'
    ];
    ...
    *  日志配置列表
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\InstanceDeleteLtsConfig[]
    */
    ...
    * Sets logConfigs
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\InstanceDeleteLtsConfig[] $logConfigs 日志配置列表
    *
    * @return $this
    */
