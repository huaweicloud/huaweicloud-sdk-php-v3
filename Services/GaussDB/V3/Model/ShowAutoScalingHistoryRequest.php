...
class ShowAutoScalingHistoryRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAutoScalingHistoryRequest';
    ...
    * Sets limit
    *
    * @param string|null $limit 查询记录数。默认为20。
    *
    * @return $this
    */
