...
class CopyInstanceConfigurationsRequest implements ModelInterface, ArrayAccess
{
    ...
    * configurationId  参数组ID。  通过调用[查询实例详情信息](https://support.huaweicloud.com/api-taurusdb/ShowGaussMySqlInstanceInfo.html)接口获取。  请求响应成功后在响应消息体中包含的“configuration_id”的值即为configuration_id值。
    * body  body
    *
    * @var string[]
    */
