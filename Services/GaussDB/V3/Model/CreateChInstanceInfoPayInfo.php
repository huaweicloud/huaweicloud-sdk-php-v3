...
class CreateChInstanceInfoPayInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateChInstanceInfo_pay_info';
    ...
    * Sets payModel
    *
    * @param string $payModel 计费模式。默认0。 取值范围： - 0：按需计费 - 1：包周期
    *
    * @return $this
    */
    ...
    * Sets periodType
    *
    * @param string $periodType 包周期周期类型。 取值范围： - 2：包月 - 3：包年
    *
    * @return $this
    */
    ...
    * Sets isAutoRenew
    *
    * @param string $isAutoRenew 包周期是否自动续费。 取值范围： - 1：自动续费 - 0：不自动续费
    *
    * @return $this
    */
