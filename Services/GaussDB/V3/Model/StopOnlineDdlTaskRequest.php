...
class StopOnlineDdlTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StopOnlineDdlTaskRequest';
    ...
    */
    protected static $openAPITypes = [
            'xLanguage' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\GaussDB\V3\Model\StopOnlineDDLTaskRequestV3'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\StopOnlineDDLTaskRequestV3|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\StopOnlineDDLTaskRequestV3|null $body body
    *
    * @return $this
    */
