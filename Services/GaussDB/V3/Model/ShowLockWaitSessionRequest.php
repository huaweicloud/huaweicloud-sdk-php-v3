...
class ShowLockWaitSessionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowLockWaitSessionRequest';
    ...
    * nodeId  **参数解释**： 点ID。  获取方法请参见[查询实例详情信息](https://support.huaweicloud.com/api-taurusdb/ShowGaussMySqlInstanceInfoUnifyStatus.html)。 **约束限制**： 不涉及。 **取值范围**： 只能由英文字母、数字组成，且长度为36个字符。 **默认值**： 不涉及。
    * pid  **参数解释**： 会话进程ID。  获取方法请参见[查询节点用户会话线程](https://support.huaweicloud.com/api-taurusdb/ListTaurusDbNodeProcesses.html)。  **约束限制**： 不能为空。 **取值范围**： 正整数。 **默认取值**： 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets nodeId
    *
    * @param string $nodeId **参数解释**： 点ID。  获取方法请参见[查询实例详情信息](https://support.huaweicloud.com/api-taurusdb/ShowGaussMySqlInstanceInfoUnifyStatus.html)。 **约束限制**： 不涉及。 **取值范围**： 只能由英文字母、数字组成，且长度为36个字符。 **默认值**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets pid
    *
    * @param int $pid **参数解释**： 会话进程ID。  获取方法请参见[查询节点用户会话线程](https://support.huaweicloud.com/api-taurusdb/ListTaurusDbNodeProcesses.html)。  **约束限制**： 不能为空。 **取值范围**： 正整数。 **默认取值**： 不涉及。
    *
    * @return $this
    */
