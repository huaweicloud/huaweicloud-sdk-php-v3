...
class ListHtapStorageTypeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListHtapStorageTypeRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * database  HTAP数据库名。 取值范围： - star-rocks - click-house
    * versionName  数据库大版本号
