...
class ChSlowlogSensitiveResponse implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChSlowlogSensitiveResponse';
    ...
    *
    * @param string $openSlowLogSwitch 慢日志脱敏开关。
    *
    * @return $this
    */
