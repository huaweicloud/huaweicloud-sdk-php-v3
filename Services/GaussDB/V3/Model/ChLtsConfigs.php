...
class ChLtsConfigs implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChLtsConfigs';
    ...
    * Sets ltsGroupId
    *
    * @param string|null $ltsGroupId LTS日志组id。
    *
    * @return $this
    */
    ...
    * Sets ltsStreamId
    *
    * @param string|null $ltsStreamId LTS日志流id。
    *
    * @return $this
    */
    ...
    * Sets enabled
    *
    * @param bool|null $enabled LTS配置开关状态。
    *
    * @return $this
    */
