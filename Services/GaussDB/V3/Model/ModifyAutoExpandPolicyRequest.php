...
class ModifyAutoExpandPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ModifyAutoExpandPolicyRequest';
    ...
    */
    protected static $openAPITypes = [
            'xLanguage' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\GaussDB\V3\Model\ModifyAutoExpandPolicyReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\ModifyAutoExpandPolicyReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\ModifyAutoExpandPolicyReq|null $body body
    *
    * @return $this
    */
