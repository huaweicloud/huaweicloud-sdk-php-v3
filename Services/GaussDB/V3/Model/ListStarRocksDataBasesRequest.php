...
class ListStarRocksDataBasesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListStarRocksDataBasesRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['instanceId'] === null) {
            ...
            if (!is_null($this->container['limit']) && (mb_strlen($this->container['limit']) < 2)) {
                $invalidProperties[] = "invalid value for 'limit', the character length must be bigger than or equal to 2.";
            }
            if (!is_null($this->container['offset']) && (mb_strlen($this->container['offset']) > 5)) {
                $invalidProperties[] = "invalid value for 'offset', the character length must be smaller than or equal to 5.";
            }
            ...
            if (!is_null($this->container['databaseName']) && (mb_strlen($this->container['databaseName']) < 3)) {
                $invalidProperties[] = "invalid value for 'databaseName', the character length must be bigger than or equal to 3.";
            }
    ...
    * Sets offset
    *
    * @param string|null $offset 索引位置，偏移量。从第一条数据偏移offset条数据后开始查询（偏移0条数据，表示从第一条数据开始查询），必须为数字，不能为负数。
    *
    * @return $this
    */
    ...
    * Sets databaseName
    *
    * @param string|null $databaseName 查询的数据库名称，支持模糊搜索。
    *
    * @return $this
    */
