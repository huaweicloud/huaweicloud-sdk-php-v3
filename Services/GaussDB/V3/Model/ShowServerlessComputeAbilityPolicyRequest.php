...
class ShowServerlessComputeAbilityPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowServerlessComputeAbilityPolicyRequest';
