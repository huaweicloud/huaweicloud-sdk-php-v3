...
class UpdateDynamicServerlessPolicyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDynamicServerlessPolicyResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * jobId  **参数解释**：  配置动态Serverless功能的任务ID。  **取值范围**：  不涉及。
    *
    * @var string[]
    */
    ...
    * Sets jobId
    *
    * @param string|null $jobId **参数解释**：  配置动态Serverless功能的任务ID。  **取值范围**：  不涉及。
    *
    * @return $this
    */
