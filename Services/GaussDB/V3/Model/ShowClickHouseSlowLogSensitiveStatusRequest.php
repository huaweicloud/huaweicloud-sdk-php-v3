...
class ShowClickHouseSlowLogSensitiveStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowClickHouseSlowLogSensitiveStatusRequest';
