...
class DeleteDynamicServerlessPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteDynamicServerlessPolicyRequest';
