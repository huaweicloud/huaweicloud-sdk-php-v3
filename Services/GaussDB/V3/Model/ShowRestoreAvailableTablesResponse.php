...
class ShowRestoreAvailableTablesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowRestoreAvailableTablesResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalTables  **参数解释**:  实例总表数。  **取值范围**：  不涉及。
    * databases  **参数解释**：  数据库信息。
    *
    * @var string[]
    */
    ...
    * Sets totalTables
    *
    * @param int|null $totalTables **参数解释**:  实例总表数。  **取值范围**：  不涉及。
    *
    * @return $this
    */
    ...
    * Sets databases
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\RestoreDatabaseInfos[]|null $databases **参数解释**：  数据库信息。
    *
    * @return $this
    */
