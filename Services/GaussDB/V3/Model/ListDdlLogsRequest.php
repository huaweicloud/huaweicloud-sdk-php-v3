...
class ListDdlLogsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDdlLogsRequest';
    ...
    * Sets nodeId
    *
    * @param string $nodeId **参数解释**：  实例下的节点ID  **约束限制**：  不涉及。  **取值范围**：  不涉及。  **默认取值**：  不涉及。
    *
    * @return $this
    */
    ...
    * Sets limit
    *
    * @param int|null $limit **参数解释**：  每页显示条数。  **约束限制**：  不涉及。  **取值范围**：  1-100  **默认取值**：  10
    *
    * @return $this
    */
