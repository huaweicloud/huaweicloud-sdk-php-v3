...
class CreateBackupResourcePackageRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateBackupResourcePackageRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * specCode  **参数解释**：  备份资源包规格码。  **约束限制**：  不涉及。  **取值范围**：  备份资源包规格码可根据[查询备份资源包规格](https://support.huaweicloud.com/api-taurusdb/ShowBackupResourcePackageFlavors.html)接口获取。  **默认取值**：  不涉及。
    * num  **参数解释**：  备份资源包数量。  **约束限制**：  不涉及。  **取值范围**：  1-10。  **默认取值**：  不涉及。
    ...
    */
    protected static $openAPITypes = [
            'specCode' => 'string',
            'num' => 'int',
            'chargeInfo' => '\HuaweiCloud\SDK\GaussDB\V3\Model\TaurusDbChargeInfo'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['specCode'] === null) {
            ...
            if ((mb_strlen($this->container['specCode']) > 20)) {
    ...
    * Sets specCode
    *
    * @param string $specCode **参数解释**：  备份资源包规格码。  **约束限制**：  不涉及。  **取值范围**：  备份资源包规格码可根据[查询备份资源包规格](https://support.huaweicloud.com/api-taurusdb/ShowBackupResourcePackageFlavors.html)接口获取。  **默认取值**：  不涉及。
    *
    * @return $this
    */
    ...
    * Sets num
    *
    * @param int $num **参数解释**：  备份资源包数量。  **约束限制**：  不涉及。  **取值范围**：  1-10。  **默认取值**：  不涉及。
    *
    * @return $this
    */
    ...
    *  chargeInfo
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\TaurusDbChargeInfo
    */
    ...
    * Sets chargeInfo
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\TaurusDbChargeInfo $chargeInfo chargeInfo
    *
    * @return $this
    */
