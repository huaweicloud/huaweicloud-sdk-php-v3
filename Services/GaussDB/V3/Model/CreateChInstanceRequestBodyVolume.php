...
class CreateChInstanceRequestBodyVolume implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateChInstanceRequestBody_volume';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * ioType  磁盘IO类型。 取值范围： - SSD：超高IO - ESSD：极速型SSD
    * capacityInGb  磁盘容量。取值范围：50GB~32000GB。
    *
    * @var string[]
    */
    ...
    * Sets ioType
    *
    * @param string $ioType 磁盘IO类型。 取值范围： - SSD：超高IO - ESSD：极速型SSD
    *
    * @return $this
    */
    ...
    * Sets capacityInGb
    *
    * @param int $capacityInGb 磁盘容量。取值范围：50GB~32000GB。
    *
    * @return $this
    */
