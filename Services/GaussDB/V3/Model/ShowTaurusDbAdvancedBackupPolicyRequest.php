...
class ShowTaurusDbAdvancedBackupPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowTaurusDbAdvancedBackupPolicyRequest';
