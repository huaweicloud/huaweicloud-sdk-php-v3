...
class DeleteClickHouseDataBaseReplicationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteClickHouseDataBaseReplicationRequest';
