...
class DeleteDynamicServerlessPolicyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteDynamicServerlessPolicyResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * jobId  **参数解释**：  删除动态Serverless算力策略的任务ID。  **取值范围**：  不涉及。
    *
    * @var string[]
    */
    ...
    * Sets jobId
    *
    * @param string|null $jobId **参数解释**：  删除动态Serverless算力策略的任务ID。  **取值范围**：  不涉及。
    *
    * @return $this
    */
