...
class ProxyConfiguration implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ProxyConfiguration';
    ...
    * Sets dataType
    *
    * @param string|null $dataType 参数数据类型
    *
    * @return $this
    */
    ...
    * Sets elemType
    *
    * @param string|null $elemType 参数父标签类型
    *
    * @return $this
    */
    ...
    * Sets valueRange
    *
    * @param string|null $valueRange 取值范围
    *
    * @return $this
    */
