...
class DeleteChLtsConfigRequestBodyLogConfigs implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteChLtsConfigRequestBody_log_configs';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  ClickHouse实例ID，严格匹配UUID规则。
    * logType  日志类型。当前仅支持slow_log。
    *
    * @var string[]
    */
    ...
    * Sets logType
    *
    * @param string $logType 日志类型。当前仅支持slow_log。
    *
    * @return $this
    */
