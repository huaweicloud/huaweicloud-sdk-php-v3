...
class ListClickHouseDataBaseReplicationConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListClickHouseDataBaseReplicationConfigRequest';
