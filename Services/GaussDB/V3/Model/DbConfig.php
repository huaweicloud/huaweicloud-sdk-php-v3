...
class DbConfig implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DbConfig';
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['paramName']) && (mb_strlen($this->container['paramName']) > 1024)) {
                $invalidProperties[] = "invalid value for 'paramName', the character length must be smaller than or equal to 1024.";
            }
