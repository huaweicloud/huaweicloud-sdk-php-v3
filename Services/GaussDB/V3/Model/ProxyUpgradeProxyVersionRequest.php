...
class ProxyUpgradeProxyVersionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ProxyUpgradeProxyVersionRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * sourceVersion  升级前源内核版本号
    * targetVersion  目标升级内核版本号
    *
    * @var string[]
    */
    ...
    * Sets sourceVersion
    *
    * @param string $sourceVersion 升级前源内核版本号
    *
    * @return $this
    */
    ...
    * Sets targetVersion
    *
    * @param string $targetVersion 目标升级内核版本号
    *
    * @return $this
    */
