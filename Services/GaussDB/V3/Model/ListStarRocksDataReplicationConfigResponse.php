...
class ListStarRocksDataReplicationConfigResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListStarRocksDataReplicationConfigResponse';
