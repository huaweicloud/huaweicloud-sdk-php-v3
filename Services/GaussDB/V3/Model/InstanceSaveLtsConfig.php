...
class InstanceSaveLtsConfig implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'InstanceSaveLtsConfig';
    ...
    * Sets ltsStreamId
    *
    * @param string $ltsStreamId 日志流ID。
    *
    * @return $this
    */
