...
class CollectRealtimeSessionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CollectRealtimeSessionRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'nodeId' => 'string',
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\GaussDB\V3\Model\RealtimeSessionRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\RealtimeSessionRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\RealtimeSessionRequest|null $body body
    *
    * @return $this
    */
