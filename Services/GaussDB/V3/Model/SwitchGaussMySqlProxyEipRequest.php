...
class SwitchGaussMySqlProxyEipRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SwitchGaussMySqlProxyEipRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * xLanguage  请求语言类型。默认en-us。 取值范围： - en-us - zh-cn
    * instanceId  实例ID，此参数是实例的唯一标识。只能由英文字母、数字组成，后缀为in07，长度为36个字符。
    * proxyId  数据库代理ID，此参数是代理的唯一标识。只能由英文字母、数字组成，后缀为po01，长度为36个字符。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'instanceId' => 'string',
            'proxyId' => 'string',
            'body' => '\HuaweiCloud\SDK\GaussDB\V3\Model\SwitchGaussMySqlProxyEipRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\SwitchGaussMySqlProxyEipRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\SwitchGaussMySqlProxyEipRequestBody|null $body body
    *
    * @return $this
    */
