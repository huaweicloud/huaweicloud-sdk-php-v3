...
class UpdateSlowlogSensitiveStatusRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateSlowlogSensitiveStatusRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * openSlowLogSwitch  **参数解释**：  慢日志开关状态。  **约束限制**：  不涉及。  **取值范围**： - true，开启。 - false，关闭。            **默认取值**：  不涉及。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'openSlowLogSwitch' => 'bool'
    ];
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['openSlowLogSwitch'] === null) {
            $invalidProperties[] = "'openSlowLogSwitch' can't be null";
        }
    ...
    *
    * @param bool $openSlowLogSwitch **参数解释**：  慢日志开关状态。  **约束限制**：  不涉及。  **取值范围**： - true，开启。 - false，关闭。            **默认取值**：  不涉及。
    *
    * @return $this
    */
