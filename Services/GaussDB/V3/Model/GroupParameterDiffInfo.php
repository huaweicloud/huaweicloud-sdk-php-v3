...
class GroupParameterDiffInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GroupParameterDiffInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  **参数解释**：  参数名称。  **取值范围**：  不涉及。
    * sourceValue  **参数解释**：  源参数值（当前模板中的值）。  **取值范围**：  不涉及。
    * targetValue  **参数解释**：  目标参数值（系统默认模板中的值）。  **取值范围**：  不涉及。
    *
    * @var string[]
    */
    ...
    * Sets sourceValue
    *
    * @param string|null $sourceValue **参数解释**：  源参数值（当前模板中的值）。  **取值范围**：  不涉及。
    *
    * @return $this
    */
    ...
    * Sets targetValue
    *
    * @param string|null $targetValue **参数解释**：  目标参数值（系统默认模板中的值）。  **取值范围**：  不涉及。
    *
    * @return $this
    */
