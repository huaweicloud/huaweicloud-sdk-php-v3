...
class BatchUpdateBackupPolicyRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchUpdateBackupPolicyRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceIds  **参数解释**：  需要设置备份策略的实例ID列表。  获取方法请参见[查询实例列表](https://support.huaweicloud.com/api-taurusdb/ListGaussMySqlInstancesUnifyStatus.html)。  **约束限制**：  列表数量小于等于50。
    ...
    */
    protected static $openAPITypes = [
            'instanceIds' => 'string[]',
            'backupPolicy' => '\HuaweiCloud\SDK\GaussDB\V3\Model\MysqlBackupPolicyInfo'
    ];
    ...
    * Sets instanceIds
    *
    * @param string[] $instanceIds **参数解释**：  需要设置备份策略的实例ID列表。  获取方法请参见[查询实例列表](https://support.huaweicloud.com/api-taurusdb/ListGaussMySqlInstancesUnifyStatus.html)。  **约束限制**：  列表数量小于等于50。
    *
    * @return $this
    */
    ...
    *  backupPolicy
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\MysqlBackupPolicyInfo
    */
    ...
    * Sets backupPolicy
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\MysqlBackupPolicyInfo $backupPolicy backupPolicy
    *
    * @return $this
    */
