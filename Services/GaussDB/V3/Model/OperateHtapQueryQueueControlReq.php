...
class OperateHtapQueryQueueControlReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'OperateHtapQueryQueueControlReq';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * enableQueryQueueSelect  **参数解释**：  查询队列的开关状态。  **约束限制**：  不涉及。  **取值范围**：  - true：表示开启。 - false：表示关闭。  **默认值**：  false。
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['enableQueryQueueSelect'] === null) {
            $invalidProperties[] = "'enableQueryQueueSelect' can't be null";
        }
    ...
    *
    * @param string $enableQueryQueueSelect **参数解释**：  查询队列的开关状态。  **约束限制**：  不涉及。  **取值范围**：  - true：表示开启。 - false：表示关闭。  **默认值**：  false。
    *
    * @return $this
    */
