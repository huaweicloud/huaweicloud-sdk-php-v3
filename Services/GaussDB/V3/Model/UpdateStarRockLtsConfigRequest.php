...
class UpdateStarRockLtsConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateStarRockLtsConfigRequest';
    ...
    */
    protected static $openAPITypes = [
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\GaussDB\V3\Model\HtapCreateLTSConfigRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\HtapCreateLTSConfigRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\HtapCreateLTSConfigRequestBody|null $body body
    *
    * @return $this
    */
