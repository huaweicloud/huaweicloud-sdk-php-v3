...
class CheckClickHouseDataBaseConfigResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CheckClickHouseDataBaseConfigResponse';
    ...
    * Sets databaseName
    *
    * @param string|null $databaseName 源数据库名称。
    *
    * @return $this
    */
    ...
    *  源数据库配置检查结果。
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\ChDatabaseConfigCheckResult[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\ChDatabaseConfigCheckResult[]|null $dbConfigCheckResults 源数据库配置检查结果。
    *
    * @return $this
    */
