...
class ListClickHouseDataBaseReplicationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListClickHouseDataBaseReplicationRequest';
