...
class ShowAuditLogPolicyResponse implements ModelInterface, ArrayAccess
{
    ...
    * keepDays  **参数解释**：  审计日志保存天数，0表示关闭审计日志策略。   **取值范围**：  0~732。
    * auditTypes  **参数解释**：  审计记录的操作类型。空表示不过滤任何操作类型。  **取值范围**：  动态范围。
    * allAuditLogAction  **参数解释**：  审计记录的操作类型。空表示不过滤任何操作类型。  **取值范围**：  不涉及
    *
    * @var string[]
    */
    ...
    * Sets keepDays
    *
    * @param int|null $keepDays **参数解释**：  审计日志保存天数，0表示关闭审计日志策略。   **取值范围**：  0~732。
    *
    * @return $this
    */
    ...
    * Sets auditTypes
    *
    * @param string[]|null $auditTypes **参数解释**：  审计记录的操作类型。空表示不过滤任何操作类型。  **取值范围**：  动态范围。
    *
    * @return $this
    */
    ...
    *
    * @param string|null $allAuditLogAction **参数解释**：  审计记录的操作类型。空表示不过滤任何操作类型。  **取值范围**：  不涉及
    *
    * @return $this
    */
