...
class ChDatabaseConfigCheckResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChDatabaseConfigCheckResult';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * paramName  库同步配置参数名。
    * value  库同步配置参数值。
    * checkResult  校验结果。 取值范围： - success：成功 - fail：失败
    *
    * @var string[]
    */
    ...
    * Sets paramName
    *
    * @param string $paramName 库同步配置参数名。
    *
    * @return $this
    */
    ...
    * Sets checkResult
    *
    * @param string $checkResult 校验结果。 取值范围： - success：成功 - fail：失败
    *
    * @return $this
    */
