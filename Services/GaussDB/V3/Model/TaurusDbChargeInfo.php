...
class TaurusDbChargeInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TaurusDbChargeInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * periodType  **参数解释**：  订购周期类型。  **约束限制**：  不涉及。  **取值范围**：  - month：包月。 - year：包年。  **默认取值**：  不涉及。
    * periodNum  **参数解释**：  订购时间长度。  **约束限制**：  需要和period_type允许的订购时间长度对应。  **取值范围**：  - \"period_type\"为\"month\"时，取值为1~9。 - \"period_type\"为\"year\"时，取值为1~3。  **默认取值**：  不涉及。
    * isAutoRenew  **参数解释**：  是否自动续订，续订的周期和原周期相同，且续订时会自动支付。  **约束限制**：  不涉及。  **取值范围**：  - true：自动续订。 - false：不自动续订。  **默认取值**：  false。
    * isAutoPay  **参数解释**：  是否自动从客户的账户中支付，此字段不影响自动续订的支付方式。  **约束限制**：  不涉及。  **取值范围**：  - true：自动支付。 - false：手动支付。  **默认取值**：  false。
    *
    * @var string[]
    */
    ...
    * Sets periodType
    *
    * @param string $periodType **参数解释**：  订购周期类型。  **约束限制**：  不涉及。  **取值范围**：  - month：包月。 - year：包年。  **默认取值**：  不涉及。
    *
    * @return $this
    */
    ...
    * Sets periodNum
    *
    * @param int $periodNum **参数解释**：  订购时间长度。  **约束限制**：  需要和period_type允许的订购时间长度对应。  **取值范围**：  - \"period_type\"为\"month\"时，取值为1~9。 - \"period_type\"为\"year\"时，取值为1~3。  **默认取值**：  不涉及。
    *
    * @return $this
    */
    ...
    * Sets isAutoRenew
    *
    * @param bool|null $isAutoRenew **参数解释**：  是否自动续订，续订的周期和原周期相同，且续订时会自动支付。  **约束限制**：  不涉及。  **取值范围**：  - true：自动续订。 - false：不自动续订。  **默认取值**：  false。
    *
    * @return $this
    */
    ...
    * Sets isAutoPay
    *
    * @param bool|null $isAutoPay **参数解释**：  是否自动从客户的账户中支付，此字段不影响自动续订的支付方式。  **约束限制**：  不涉及。  **取值范围**：  - true：自动支付。 - false：手动支付。  **默认取值**：  false。
    *
    * @return $this
    */
