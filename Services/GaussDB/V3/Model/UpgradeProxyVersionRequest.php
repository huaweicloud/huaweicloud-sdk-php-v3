...
class UpgradeProxyVersionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpgradeProxyVersionRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'instanceId' => 'string',
            'proxyId' => 'string',
            'body' => '\HuaweiCloud\SDK\GaussDB\V3\Model\ProxyUpgradeProxyVersionRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\ProxyUpgradeProxyVersionRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\ProxyUpgradeProxyVersionRequest|null $body body
    *
    * @return $this
    */
