...
class SrCreateInstanceRspInstancePayInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SrCreateInstanceRsp_instance_pay_info';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * payModel  计费模式。 - 0：按需计费 - 1：包周期  StarRocks实例当前只支持按需计费，默认值为0
    * orderId  包周期计费ID。
    * period  包周期周期。
    * periodType  包周期周期类型。
    * isAutoRenew  包周期是否自动续费。
    *
    * @var string[]
    */
    ...
    * Sets payModel
    *
    * @param string|null $payModel 计费模式。 - 0：按需计费 - 1：包周期  StarRocks实例当前只支持按需计费，默认值为0
    *
    * @return $this
    */
    ...
    * Sets period
    *
    * @param string|null $period 包周期周期。
    *
    * @return $this
    */
    ...
    * Sets periodType
    *
    * @param string|null $periodType 包周期周期类型。
    *
    * @return $this
    */
    ...
    * Sets isAutoRenew
    *
    * @param string|null $isAutoRenew 包周期是否自动续费。
    *
    * @return $this
    */
