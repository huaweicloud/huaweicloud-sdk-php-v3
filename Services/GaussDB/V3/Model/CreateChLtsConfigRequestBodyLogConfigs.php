...
class CreateChLtsConfigRequestBodyLogConfigs implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateChLtsConfigRequestBody_log_configs';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  ClickHouse实例ID，严格匹配UUID规则。
    * logType  查询日志类型。当前仅支持slow_log。
    * ltsGroupId  LTS日志组id。
    ...
    * Sets logType
    *
    * @param string $logType 查询日志类型。当前仅支持slow_log。
    *
    * @return $this
    */
