...
class StarRocksCreateRequestBeVolume implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StarRocksCreateRequest_be_volume';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['capacityInGb'] === null) {
            ...
            if (($this->container['capacityInGb'] > 32000)) {
                $invalidProperties[] = "invalid value for 'capacityInGb', must be smaller than or equal to 32000.";
            }
