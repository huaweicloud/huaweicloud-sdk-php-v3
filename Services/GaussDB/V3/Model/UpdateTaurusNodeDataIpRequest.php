...
class UpdateTaurusNodeDataIpRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateTaurusNodeDataIpRequest';
    ...
    * nodeId  **参数解释**：  节点ID。  **约束限制**：  不涉及。  **取值范围**：  只能由英文字母、数字组成，前面为UUID，后缀为no07，长度为36个字符。  **默认取值**：  不涉及。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'instanceId' => 'string',
            'nodeId' => 'string',
            'body' => '\HuaweiCloud\SDK\GaussDB\V3\Model\ModifyNodeDataIpRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\GaussDB\V3\Model\ModifyNodeDataIpRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\GaussDB\V3\Model\ModifyNodeDataIpRequest|null $body body
    *
    * @return $this
    */
