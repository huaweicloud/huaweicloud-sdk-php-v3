...
class UpgradeAutopilotWorkFlowUpdateResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpgradeAutopilotWorkFlowUpdateResponse';
