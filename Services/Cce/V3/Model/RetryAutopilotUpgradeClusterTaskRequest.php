...
class RetryAutopilotUpgradeClusterTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RetryAutopilotUpgradeClusterTaskRequest';
