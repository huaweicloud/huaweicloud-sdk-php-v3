...
class ListAutopilotAddonTemplatesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAutopilotAddonTemplatesResponse';
    ...
    * items  **参数解释**： 插件模板列表。 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及
    *
    * @var string[]
    */
    ...
    * Sets items
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\AddonTemplate[]|null $items **参数解释**： 插件模板列表。 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及
    *
    * @return $this
    */
