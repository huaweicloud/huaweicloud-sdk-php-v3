...
class ShowAutopilotUpgradeClusterTaskResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAutopilotUpgradeClusterTaskResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * apiVersion  **参数解释：** API版本，默认为v3 **约束限制：** 不涉及 **取值范围：** - v3  **默认取值：** v3
    * kind  **参数解释：** 资源类型，默认为UpgradeTask **约束限制：** 不涉及 **取值范围：** - UpgradeTask  **默认取值：** UpgradeTask
    * metadata  metadata
    * spec  spec
    * status  status
    *
    ...
    * Sets kind
    *
    * @param string|null $kind **参数解释：** 资源类型，默认为UpgradeTask **约束限制：** 不涉及 **取值范围：** - UpgradeTask  **默认取值：** UpgradeTask
    *
    * @return $this
    */
