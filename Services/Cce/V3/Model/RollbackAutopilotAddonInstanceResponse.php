...
class RollbackAutopilotAddonInstanceResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RollbackAutopilotAddonInstanceResponse';
