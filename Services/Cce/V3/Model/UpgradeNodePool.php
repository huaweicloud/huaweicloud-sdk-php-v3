...
class UpgradeNodePool implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpgradeNodePool';
    ...
    *  spec
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\NodePoolUpgradeSpec
    */
    ...
    * Sets spec
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\NodePoolUpgradeSpec $spec spec
    *
    * @return $this
    */
