...
class V2JobTypeObject implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'V2JobTypeObject';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * uid  **参数解释**： Job UUID **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及
    * creationTimestamp  **参数解释**： Job 创建时间 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及
    * updateTimestamp  **参数解释**： Job 最后更新时间 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及
    *
    * @var string[]
    */
    ...
    * Sets uid
    *
    * @param string|null $uid **参数解释**： Job UUID **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及
    *
    * @return $this
    */
    ...
    *
    * @param string|null $creationTimestamp **参数解释**： Job 创建时间 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及
    *
    * @return $this
    */
    ...
    *
    * @param string|null $updateTimestamp **参数解释**： Job 最后更新时间 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及
    *
    * @return $this
    */
