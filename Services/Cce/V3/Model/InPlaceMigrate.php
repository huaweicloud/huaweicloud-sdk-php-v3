...
class InPlaceMigrate implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'InPlaceMigrate';
    ...
    *  spec
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\InPlaceMigratetoNodesSpec
    */
    ...
    * Sets spec
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\InPlaceMigratetoNodesSpec $spec spec
    *
    * @return $this
    */
