...
class GetClusterSupportConfigurationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GetClusterSupportConfigurationRequest';
