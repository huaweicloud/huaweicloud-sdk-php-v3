...
class DeleteAutopilotMaintenanceWindowRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteAutopilotMaintenanceWindowRequest';
