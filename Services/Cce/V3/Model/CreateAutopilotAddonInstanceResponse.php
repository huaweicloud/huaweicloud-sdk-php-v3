...
class CreateAutopilotAddonInstanceResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAutopilotAddonInstanceResponse';
