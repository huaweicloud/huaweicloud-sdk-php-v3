...
class ListAutopilotUpgradeClusterTasksRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAutopilotUpgradeClusterTasksRequest';
