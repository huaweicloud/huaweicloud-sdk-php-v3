...
class ShowAutopilotClusterUpgradeInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAutopilotClusterUpgradeInfoRequest';
