...
class ScaleNodePoolRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ScaleNodePoolRequest';
    ...
    */
    protected static $openAPITypes = [
            'clusterId' => 'string',
            'nodepoolId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cce\V3\Model\ScaleNodePoolRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\ScaleNodePoolRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\ScaleNodePoolRequestBody|null $body body
    *
    * @return $this
    */
