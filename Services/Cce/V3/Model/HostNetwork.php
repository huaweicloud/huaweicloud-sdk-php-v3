...
class HostNetwork implements ModelInterface, ArrayAccess
{
    ...
    * vpc  **参数解释：** 用于创建节点的VPC的ID。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及  获取方法如下： - 方法1：登录虚拟私有云服务的控制台界面，在虚拟私有云的详情页面查找VPC ID。 - 方法2：通过虚拟私有云服务的API接口查询。   [链接请参见[查询VPC列表](https://support.huaweicloud.com/api-vpc/vpc_api01_0003.html)。](tag:hws)   [链接请参见[查询VPC列表](https://support.huaweicloud.com/intl/zh-cn/api-vpc/vpc_api01_0003.html)。](tag:hws_hk)
    * subnet  **参数解释：** 用于创建节点的子网的网络ID。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及  获取方法如下： - 方法1：登录虚拟私有云服务的控制台界面，单击VPC下的子网，进入子网详情页面，查找网络ID。 - 方法2：通过虚拟私有云服务的查询子网列表接口查询，获取响应中neutron_network_id字段的值。   [链接请参见[查询子网列表](https://support.huaweicloud.com/api-vpc/vpc_subnet01_0003.html)。](tag:hws)   [链接请参见[查询子网列表](https://support.huaweicloud.com/intl/zh-cn/api-vpc/vpc_subnet01_0003.html)。](tag:hws_hk)
    ...
    * controlPlaneSecurityGroup  **参数解释：** 集群控制面节点安全组ID。 **约束限制：** 创建成功后自动生成，填写无效。 **取值范围：** 不涉及 **默认取值：** 不涉及
    * autoGenerateSecurityGroupHardeningConfig  autoGenerateSecurityGroupHardeningConfig
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'autoGenerateSecurityGroupHardeningConfig' => '\HuaweiCloud\SDK\Cce\V3\Model\AutoGenerateSecurityGroupHardeningConfigSpec'
    ];
    ...
    */
    protected static $openAPIFormats = [
        ...
        'subnet' => null,
        'securityGroup' => null,
        'controlPlaneSecurityGroup' => null,
        'autoGenerateSecurityGroupHardeningConfig' => null
    ];
    ...
    */
    protected static $setters = [
            ...
            'controlPlaneSecurityGroup' => 'setControlPlaneSecurityGroup',
            'autoGenerateSecurityGroupHardeningConfig' => 'setAutoGenerateSecurityGroupHardeningConfig'
    ];
    ...
    */
    protected static $getters = [
            ...
            'controlPlaneSecurityGroup' => 'getControlPlaneSecurityGroup',
            'autoGenerateSecurityGroupHardeningConfig' => 'getAutoGenerateSecurityGroupHardeningConfig'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['controlPlaneSecurityGroup'] = isset($data['controlPlaneSecurityGroup']) ? $data['controlPlaneSecurityGroup'] : null;
        $this->container['autoGenerateSecurityGroupHardeningConfig'] = isset($data['autoGenerateSecurityGroupHardeningConfig']) ? $data['autoGenerateSecurityGroupHardeningConfig'] : null;
    }
    ...
    * Sets vpc
    *
    * @param string $vpc **参数解释：** 用于创建节点的VPC的ID。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及  获取方法如下： - 方法1：登录虚拟私有云服务的控制台界面，在虚拟私有云的详情页面查找VPC ID。 - 方法2：通过虚拟私有云服务的API接口查询。   [链接请参见[查询VPC列表](https://support.huaweicloud.com/api-vpc/vpc_api01_0003.html)。](tag:hws)   [链接请参见[查询VPC列表](https://support.huaweicloud.com/intl/zh-cn/api-vpc/vpc_api01_0003.html)。](tag:hws_hk)
    *
    * @return $this
    */
    ...
    * Sets subnet
    *
    * @param string $subnet **参数解释：** 用于创建节点的子网的网络ID。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及  获取方法如下： - 方法1：登录虚拟私有云服务的控制台界面，单击VPC下的子网，进入子网详情页面，查找网络ID。 - 方法2：通过虚拟私有云服务的查询子网列表接口查询，获取响应中neutron_network_id字段的值。   [链接请参见[查询子网列表](https://support.huaweicloud.com/api-vpc/vpc_subnet01_0003.html)。](tag:hws)   [链接请参见[查询子网列表](https://support.huaweicloud.com/intl/zh-cn/api-vpc/vpc_subnet01_0003.html)。](tag:hws_hk)
    *
    * @return $this
    */
    ...
    */
    ...
    /**
    * Gets controlPlaneSecurityGroup
    *  **参数解释：** 集群控制面节点安全组ID。 **约束限制：** 创建成功后自动生成，填写无效。 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @return string|null
    */
    public function getControlPlaneSecurityGroup()
    {
        return $this->container['controlPlaneSecurityGroup'];
    }

    /**
    * Sets controlPlaneSecurityGroup
    *
    * @param string|null $controlPlaneSecurityGroup **参数解释：** 集群控制面节点安全组ID。 **约束限制：** 创建成功后自动生成，填写无效。 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @return $this
    */
    public function setControlPlaneSecurityGroup($controlPlaneSecurityGroup)
    {
        $this->container['controlPlaneSecurityGroup'] = $controlPlaneSecurityGroup;
        return $this;
    }

    /**
    * Gets autoGenerateSecurityGroupHardeningConfig
    *  autoGenerateSecurityGroupHardeningConfig
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\AutoGenerateSecurityGroupHardeningConfigSpec|null
    */
    public function getAutoGenerateSecurityGroupHardeningConfig()
    {
        return $this->container['autoGenerateSecurityGroupHardeningConfig'];
    }

    /**
    * Sets autoGenerateSecurityGroupHardeningConfig
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\AutoGenerateSecurityGroupHardeningConfigSpec|null $autoGenerateSecurityGroupHardeningConfig autoGenerateSecurityGroupHardeningConfig
    *
    * @return $this
    */
    public function setAutoGenerateSecurityGroupHardeningConfig($autoGenerateSecurityGroupHardeningConfig)
    {
        $this->container['autoGenerateSecurityGroupHardeningConfig'] = $autoGenerateSecurityGroupHardeningConfig;
        return $this;
    }
