...
class CreateAutopilotKubernetesClusterCertResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAutopilotKubernetesClusterCertResponse';
