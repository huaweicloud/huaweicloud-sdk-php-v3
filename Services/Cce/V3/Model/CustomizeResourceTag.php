...
class CustomizeResourceTag implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CustomizeResourceTag';
    ...
    * values  **参数解释：** Value值列表。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @var string[]
    */
    ...
    * Sets values
    *
    * @param string[]|null $values **参数解释：** Value值列表。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @return $this
    */
