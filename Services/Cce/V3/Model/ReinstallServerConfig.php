...
class ReinstallServerConfig implements ModelInterface, ArrayAccess
{
    ...
    * userTags  **参数解释**： 云服务器标签（资源标签），键必须唯一，CCE支持的最大用户自定义标签数量依region而定，自定义标签数上限为8个。 **约束限制**： 不涉及
    ...
    * Sets userTags
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\UserTag[]|null $userTags **参数解释**： 云服务器标签（资源标签），键必须唯一，CCE支持的最大用户自定义标签数量依region而定，自定义标签数上限为8个。 **约束限制**： 不涉及
    *
    * @return $this
    */
