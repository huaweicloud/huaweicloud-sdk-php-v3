...
class CreatePodIdentityAssociationResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePodIdentityAssociationResponse';
