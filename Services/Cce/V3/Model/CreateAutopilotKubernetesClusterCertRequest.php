...
class CreateAutopilotKubernetesClusterCertRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAutopilotKubernetesClusterCertRequest';
