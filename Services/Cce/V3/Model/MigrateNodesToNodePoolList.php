...
class MigrateNodesToNodePoolList implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'apiVersion' => 'string',
            'kind' => 'string',
            'nodeList' => '\HuaweiCloud\SDK\Cce\V3\Model\MigrateNodesToNodePool[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\MigrateNodesToNodePool[]
    */
    ...
    * Sets nodeList
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\MigrateNodesToNodePool[] $nodeList **参数解释**： 迁移节点列表，当前最多支持同迁移50个节点。 **约束限制**： 不涉及
    *
    * @return $this
    */
