...
class UpgradeInfoStatus implements ModelInterface, ArrayAccess
{
    ...
    * phase  **参数解释：** 升级任务状态 **约束限制：** 不涉及 **取值范围：** - Init：初始化 - Running：运行中 - Pause：暂停 - Success：成功 - Failed：失败  **默认取值：** 不涉及
    ...
    * Sets phase
    *
    * @param string|null $phase **参数解释：** 升级任务状态 **约束限制：** 不涉及 **取值范围：** - Init：初始化 - Running：运行中 - Pause：暂停 - Success：成功 - Failed：失败  **默认取值：** 不涉及
    *
    * @return $this
    */
