...
class GetAvaliableZoneResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GetAvaliableZoneResponse';
    ...
    */
    protected static $openAPITypes = [
            'body' => '\HuaweiCloud\SDK\Cce\V3\Model\GetAvailableZoneResponseBody[]'
    ];
