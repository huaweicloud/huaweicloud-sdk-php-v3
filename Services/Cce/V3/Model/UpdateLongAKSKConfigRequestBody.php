...
class UpdateLongAKSKConfigRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateLongAKSKConfigRequestBody';
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['enableLongAkskInNewCluster'] === null) {
            $invalidProperties[] = "'enableLongAkskInNewCluster' can't be null";
        }
    ...
    *
    * @param bool $enableLongAkskInNewCluster **参数解释：** 新建集群是否启用LongAKSK。 **约束限制：** 不涉及 **取值范围：** - false: 新建集群不启用LongAKSK - true: 新建集群启用LongAKSK  **默认取值：** 不涉及
    *
    * @return $this
    */
