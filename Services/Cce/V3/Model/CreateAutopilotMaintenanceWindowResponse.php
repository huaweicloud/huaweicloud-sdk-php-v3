...
class CreateAutopilotMaintenanceWindowResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAutopilotMaintenanceWindowResponse';
    ...
    * Sets weeklyPeriod
    *
    * @param string|null $weeklyPeriod 升级周期，从\"Monday,Tuesday,Wednesday,Thursday,Friday,Saturday,Sunday\"中进行选择，以英文逗号分隔 如：\"Friday,Saturday\"
    *
    * @return $this
    */
    ...
    * Sets startTime
    *
    * @param string|null $startTime 升级起始时间（UTC时间）
    *
    * @return $this
    */
    ...
    * Sets durationHours
    *
    * @param int|null $durationHours 升级时长
    *
    * @return $this
    */
