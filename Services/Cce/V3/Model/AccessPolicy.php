...
class AccessPolicy implements ModelInterface, ArrayAccess
{
    ...
    * clusters  **参数解释：** 集群ID的列表，允许使用通配符（“\\*”），表示所有集群。获取方式请参见[如何获取接口URI中参数](cce_02_0271.xml)。 **约束限制：** 当前最多支持同时授权200个集群。 **取值范围：** \\[\"\\*\"\\]或者集群ID列表。 **默认取值：** 不涉及
    * accessScope  accessScope
    * policyType  **参数解释：** 权限类型。 **约束限制：** 不涉及 **取值范围：** - CCEAdminPolicy：管理员权限 - CCEClusterAdminPolicy：运维权限 - CCEEditPolicy：开发权限 - CCEViewPolicy：只读权限  **默认取值：** 不涉及
    * principal  principal
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['accessScope'] === null) {
    ...
    * Sets clusters
    *
    * @param string[] $clusters **参数解释：** 集群ID的列表，允许使用通配符（“\\*”），表示所有集群。获取方式请参见[如何获取接口URI中参数](cce_02_0271.xml)。 **约束限制：** 当前最多支持同时授权200个集群。 **取值范围：** \\[\"\\*\"\\]或者集群ID列表。 **默认取值：** 不涉及
    *
    * @return $this
    */
    ...
    *  accessScope
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\AccessScope
    */
    ...
    * Sets accessScope
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\AccessScope $accessScope accessScope
    *
    * @return $this
    */
    ...
    * Sets policyType
    *
    * @param string $policyType **参数解释：** 权限类型。 **约束限制：** 不涉及 **取值范围：** - CCEAdminPolicy：管理员权限 - CCEClusterAdminPolicy：运维权限 - CCEEditPolicy：开发权限 - CCEViewPolicy：只读权限  **默认取值：** 不涉及
    *
    * @return $this
    */
    ...
    *  principal
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\Principal
    */
    ...
    * Sets principal
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\Principal $principal principal
    *
    * @return $this
    */
