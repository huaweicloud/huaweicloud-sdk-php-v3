...
class ListAutopilotUpgradeWorkFlowsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAutopilotUpgradeWorkFlowsResponse';
