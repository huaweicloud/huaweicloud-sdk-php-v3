...
class MigrateToNodePoolRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MigrateToNodePoolRequest';
    ...
    */
    protected static $openAPITypes = [
            'clusterId' => 'string',
            'nodepoolId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cce\V3\Model\MigrateNodesToNodePoolList'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\MigrateNodesToNodePoolList|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\MigrateNodesToNodePoolList|null $body body
    *
    * @return $this
    */
