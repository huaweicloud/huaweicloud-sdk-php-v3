...
class CreateAutopilotClusterMasterSnapshotRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAutopilotClusterMasterSnapshotRequest';
