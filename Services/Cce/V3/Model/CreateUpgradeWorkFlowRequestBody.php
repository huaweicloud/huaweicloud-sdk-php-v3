...
class CreateUpgradeWorkFlowRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * kind  **参数解释：** API类型，固定值\"WorkFlowTask\"，该值不可修改。 **约束限制：** 该值不可修改 **取值范围：** - WorkFlowTask  **默认取值：** WorkFlowTask
    ...
    * Sets kind
    *
    * @param string $kind **参数解释：** API类型，固定值\"WorkFlowTask\"，该值不可修改。 **约束限制：** 该值不可修改 **取值范围：** - WorkFlowTask  **默认取值：** WorkFlowTask
    *
    * @return $this
    */
