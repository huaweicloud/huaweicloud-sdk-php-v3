...
class NodeOwnerReference implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NodeOwnerReference';
    ...
    * Sets nodepoolName
    *
    * @param string|null $nodepoolName 节点池名称
    *
    * @return $this
    */
    ...
    * Sets nodepoolId
    *
    * @param string|null $nodepoolId 节点池UID
    *
    * @return $this
    */
