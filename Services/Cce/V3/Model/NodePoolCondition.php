...
class NodePoolCondition implements ModelInterface, ArrayAccess
{
    ...
    * status  **参数解释**： Condition当前状态。 **约束限制**： 不涉及 **取值范围**： - \"True\"：满足当前状态 - \"False\"：不满足当前状态  **默认取值**： 不涉及
    ...
    */
    ...
    const TYPE_UNEXPECTED_PERIOD_NODES_INCLUDED = 'UnexpectedPeriodNodesIncluded';
    ...
    */
    public function getTypeAllowableValues()
    {
        return [
            ...
            self::TYPE_ERROR,
            self::TYPE_UNEXPECTED_PERIOD_NODES_INCLUDED,
        ];
    }
    ...
    * Sets status
    *
    * @param string|null $status **参数解释**： Condition当前状态。 **约束限制**： 不涉及 **取值范围**： - \"True\"：满足当前状态 - \"False\"：不满足当前状态  **默认取值**： 不涉及
    *
    * @return $this
    */
