...
class DelayUpgradePlanRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DelayUpgradePlanRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * notBefore  新的自动升级计划启动时间，必须早于notBeforeDeadline
    *
    * @var string[]
    */
    ...
    * Sets notBefore
    *
    * @param \DateTime $notBefore 新的自动升级计划启动时间，必须早于notBeforeDeadline
    *
    * @return $this
    */
