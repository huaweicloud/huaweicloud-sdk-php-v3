...
class CreateAutopilotUpgradeWorkFlowResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAutopilotUpgradeWorkFlowResponse';
