...
class ListAutopilotUpgradeWorkFlowsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAutopilotUpgradeWorkFlowsRequest';
