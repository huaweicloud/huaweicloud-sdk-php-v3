...
class DeleteAddonInstanceRequest implements ModelInterface, ArrayAccess
{
    ...
    * clusterId  **参数解释**： 集群ID（废弃中），获取方式请参见[如何获取接口URI中参数](cce_02_0271.xml)。 **约束限制**： 不涉及 **取值范围**： UUID格式 **默认取值**： 不涉及
    *
    * @var string[]
    */
    ...
    * Sets clusterId
    *
    * @param string|null $clusterId **参数解释**： 集群ID（废弃中），获取方式请参见[如何获取接口URI中参数](cce_02_0271.xml)。 **约束限制**： 不涉及 **取值范围**： UUID格式 **默认取值**： 不涉及
    *
    * @return $this
    */
