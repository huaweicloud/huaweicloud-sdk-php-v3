...
class ShowAutopilotClusterEndpointsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAutopilotClusterEndpointsRequest';
