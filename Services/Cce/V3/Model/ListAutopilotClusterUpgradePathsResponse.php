...
class ListAutopilotClusterUpgradePathsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAutopilotClusterUpgradePathsResponse';
