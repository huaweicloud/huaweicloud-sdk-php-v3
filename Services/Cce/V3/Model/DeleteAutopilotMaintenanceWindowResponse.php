...
class DeleteAutopilotMaintenanceWindowResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteAutopilotMaintenanceWindowResponse';
