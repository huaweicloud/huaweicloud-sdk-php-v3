...
class ShowAutopilotMaintenanceWindowRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAutopilotMaintenanceWindowRequest';
