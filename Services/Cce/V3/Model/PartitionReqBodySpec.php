...
class PartitionReqBodySpec implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PartitionReqBody_spec';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * hostNetwork  hostNetwork
    * containerNetwork  **参数解释**： 分区容器子网 **约束限制**： 列表长度不能大于20 **取值范围**： 不涉及 **默认取值**： 不涉及
    ...
    */
    protected static $openAPITypes = [
            'hostNetwork' => '\HuaweiCloud\SDK\Cce\V3\Model\PartitionReqBodySpecHostNetwork',
            'containerNetwork' => '\HuaweiCloud\SDK\Cce\V3\Model\PartitionReqBodySpecContainerNetwork[]',
    ...
    *  hostNetwork
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\PartitionReqBodySpecHostNetwork|null
    */
    ...
    * Sets hostNetwork
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\PartitionReqBodySpecHostNetwork|null $hostNetwork hostNetwork
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\PartitionReqBodySpecContainerNetwork[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\PartitionReqBodySpecContainerNetwork[]|null $containerNetwork **参数解释**： 分区容器子网 **约束限制**： 列表长度不能大于20 **取值范围**： 不涉及 **默认取值**： 不涉及
    *
    * @return $this
    */
