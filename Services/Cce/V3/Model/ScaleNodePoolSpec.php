...
class ScaleNodePoolSpec implements ModelInterface, ArrayAccess
{
    ...
    * scaleGroups  **参数解释**： 节点池中的伸缩组名称，通过[获取指定的节点池](cce_02_0355.xml)接口获取伸缩组名称，默认伸缩组名称为\"default\"，扩展伸缩组名称可通过extensionScaleGroups字段的元数据名称获取。扩容时可选择多个伸缩组，系统将按照尽量均分或随机策略在所选(伸缩组的)可用区之间分配扩容节点数，缩容时则仅能指定单个伸缩组进行操作。 **约束限制**： 如果要伸缩默认伸缩组填\"default\" **取值范围**： 不涉及 **默认取值**： 不涉及
    * options  options
    *
    * @var string[]
    */
    ...
    * Sets scaleGroups
    *
    * @param string[] $scaleGroups **参数解释**： 节点池中的伸缩组名称，通过[获取指定的节点池](cce_02_0355.xml)接口获取伸缩组名称，默认伸缩组名称为\"default\"，扩展伸缩组名称可通过extensionScaleGroups字段的元数据名称获取。扩容时可选择多个伸缩组，系统将按照尽量均分或随机策略在所选(伸缩组的)可用区之间分配扩容节点数，缩容时则仅能指定单个伸缩组进行操作。 **约束限制**： 如果要伸缩默认伸缩组填\"default\" **取值范围**： 不涉及 **默认取值**： 不涉及
    *
    * @return $this
    */
