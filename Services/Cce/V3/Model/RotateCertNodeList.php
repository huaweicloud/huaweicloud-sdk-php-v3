...
class RotateCertNodeList implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RotateCertNodeList';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * apiVersion  **参数解释**： API版本 **约束限制**： 固定值，不允许修改 **取值范围**： 不涉及 **默认取值**： v3
    * kind  **参数解释**： API类型 **约束限制**： 固定值，不允许修改 **取值范围**： 不涉及 **默认取值**： List
    * nodeList  **参数解释**： 需轮转证书的节点列表，当前最多支持同时轮转200个节点。 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'apiVersion' => 'string',
            'kind' => 'string',
            'nodeList' => '\HuaweiCloud\SDK\Cce\V3\Model\RotateCertNode[]'
    ];
    ...
    * Sets apiVersion
    *
    * @param string $apiVersion **参数解释**： API版本 **约束限制**： 固定值，不允许修改 **取值范围**： 不涉及 **默认取值**： v3
    *
    * @return $this
    */
    ...
    * Sets kind
    *
    * @param string $kind **参数解释**： API类型 **约束限制**： 固定值，不允许修改 **取值范围**： 不涉及 **默认取值**： List
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\RotateCertNode[]
    */
    ...
    * Sets nodeList
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\RotateCertNode[] $nodeList **参数解释**： 需轮转证书的节点列表，当前最多支持同时轮转200个节点。 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及
    *
    * @return $this
    */
