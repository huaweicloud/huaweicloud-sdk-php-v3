...
class ShowAutopilotUpgradeClusterTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAutopilotUpgradeClusterTaskRequest';
