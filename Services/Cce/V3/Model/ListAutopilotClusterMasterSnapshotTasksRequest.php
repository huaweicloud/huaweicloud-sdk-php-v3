...
class ListAutopilotClusterMasterSnapshotTasksRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAutopilotClusterMasterSnapshotTasksRequest';
