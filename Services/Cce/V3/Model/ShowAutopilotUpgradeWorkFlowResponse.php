...
class ShowAutopilotUpgradeWorkFlowResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAutopilotUpgradeWorkFlowResponse';
