...
class ShowAutopilotClusterConfigResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAutopilotClusterConfigResponse';
    ...
    */
    protected static $openAPITypes = [
            'ttlInDays' => 'int',
            'logConfigs' => '\HuaweiCloud\SDK\Cce\V3\Model\AutopilotClusterLogConfigLogConfigs[]'
    ];
    ...
    *  日志配置项
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\AutopilotClusterLogConfigLogConfigs[]|null
    */
    ...
    * Sets logConfigs
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\AutopilotClusterLogConfigLogConfigs[]|null $logConfigs 日志配置项
    *
    * @return $this
    */
