...
class ShowAutopilotMaintenanceWindowResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAutopilotMaintenanceWindowResponse';
