...
class CapacityReservationSpecification implements ModelInterface, ArrayAccess
{
    ...
    * id  私有池id，preference为none时忽略该值
    * preference  私有池容量选项，为 none 时表示不指定容量预留，为 targeted 时表示指定容量预留，此时 id 不能为空
    *
    * @var string[]
    */
    ...
    * Sets id
    *
    * @param string|null $id 私有池id，preference为none时忽略该值
    *
    * @return $this
    */
    ...
    * Sets preference
    *
    * @param string|null $preference 私有池容量选项，为 none 时表示不指定容量预留，为 targeted 时表示指定容量预留，此时 id 不能为空
    *
    * @return $this
    */
