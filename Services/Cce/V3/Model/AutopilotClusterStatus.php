...
class AutopilotClusterStatus implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AutopilotClusterStatus';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * phase  集群状态，取值如下 - Available：可用，表示集群处于正常状态。 - Unavailable：不可用，表示集群异常，需手动删除。 - Creating：创建中，表示集群正处于创建过程中。 - Deleting：删除中，表示集群正处于删除过程中。 - Upgrading：升级中，表示集群正处于升级过程中。 - RollingBack：回滚中，表示集群正处于回滚过程中。 - RollbackFailed：回滚异常，表示集群回滚异常。 - Error：错误，表示集群资源异常，可尝试手动删除。
    ...
    */
    protected static $openAPITypes = [
            ...
            'reason' => 'string',
            'message' => 'string',
            'endpoints' => '\HuaweiCloud\SDK\Cce\V3\Model\AutopilotClusterEndpoints[]',
            'isLocked' => 'bool',
            'lockScene' => 'string',
            'lockSource' => 'string',
            'lockSourceId' => 'string',
    ...
    * Sets phase
    *
    * @param string|null $phase 集群状态，取值如下 - Available：可用，表示集群处于正常状态。 - Unavailable：不可用，表示集群异常，需手动删除。 - Creating：创建中，表示集群正处于创建过程中。 - Deleting：删除中，表示集群正处于删除过程中。 - Upgrading：升级中，表示集群正处于升级过程中。 - RollingBack：回滚中，表示集群正处于回滚过程中。 - RollbackFailed：回滚异常，表示集群回滚异常。 - Error：错误，表示集群资源异常，可尝试手动删除。
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\AutopilotClusterEndpoints[]|null
    */
    ...
    * Sets endpoints
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\AutopilotClusterEndpoints[]|null $endpoints 集群中 kube-apiserver 的访问地址。
    *
    * @return $this
    */
