...
class ListAutopilotClustersResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAutopilotClustersResponse';
    ...
    */
    protected static $openAPITypes = [
            'kind' => 'string',
            'apiVersion' => 'string',
            'items' => '\HuaweiCloud\SDK\Cce\V3\Model\AutopilotCluster[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\AutopilotCluster[]|null
    */
    ...
    * Sets items
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\AutopilotCluster[]|null $items 集群对象列表，包含了当前项目下所有集群的详细信息。您可通过items.metadata.name下的值来找到对应的集群。
    *
    * @return $this
    */
