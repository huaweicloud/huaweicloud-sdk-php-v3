...
class UpdateAutopilotMaintenanceWindowResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAutopilotMaintenanceWindowResponse';
