...
class UpgradeNodePoolRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpgradeNodePoolRequest';
    ...
    */
    protected static $openAPITypes = [
            'clusterId' => 'string',
            'nodepoolId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cce\V3\Model\UpgradeNodePool'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cce\V3\Model\UpgradeNodePool|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cce\V3\Model\UpgradeNodePool|null $body body
    *
    * @return $this
    */
