...
class PackageProductRequestDetail implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PackageProductRequestDetail';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * resourceSpecCode  **参数解释：** 套餐包规格，通过套餐包列表接口获取。 **约束限制：** 不涉及 **取值范围：** 只支持通过套餐包列表接口获取的套餐包规格。 **默认取值：** 不涉及
    * subscriptionNum  **参数解释：** 套餐包订购数量。 **约束限制：** 不涉及 **取值范围：** [1-10] **默认取值：** 0
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['resourceSpecCode'] === null) {
            ...
            if ((mb_strlen($this->container['resourceSpecCode']) > 256)) {
                $invalidProperties[] = "invalid value for 'resourceSpecCode', the character length must be smaller than or equal to 256.";
            }
            ...
            if (!preg_match("/^[a-zA-Z0-9\\-.]+$/", $this->container['resourceSpecCode'])) {
                $invalidProperties[] = "invalid value for 'resourceSpecCode', must be conform to the pattern /^[a-zA-Z0-9\\-.]+$/.";
            }
        if ($this->container['subscriptionNum'] === null) {
            $invalidProperties[] = "'subscriptionNum' can't be null";
        }
            if (($this->container['subscriptionNum'] > 10)) {
                $invalidProperties[] = "invalid value for 'subscriptionNum', must be smaller than or equal to 10.";
            }
    ...
    *
    * @param string $resourceSpecCode **参数解释：** 套餐包规格，通过套餐包列表接口获取。 **约束限制：** 不涉及 **取值范围：** 只支持通过套餐包列表接口获取的套餐包规格。 **默认取值：** 不涉及
    *
    * @return $this
    */
    ...
    *
    * @param int $subscriptionNum **参数解释：** 套餐包订购数量。 **约束限制：** 不涉及 **取值范围：** [1-10] **默认取值：** 0
    *
    * @return $this
    */
