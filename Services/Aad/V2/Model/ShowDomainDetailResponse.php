...
class ShowDomainDetailResponse implements ModelInterface, ArrayAccess
{
    ...
    * domainName  域名
    * cname  cname
    * domainStatus  域名状态 0-正常，1-冻结
    * ppEnable  是否开启pp 0-关闭，1-开启
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['cname']) && (mb_strlen($this->container['cname']) > 32768)) {
                $invalidProperties[] = "invalid value for 'cname', the character length must be smaller than or equal to 32768.";
            }
            if (!is_null($this->container['cname']) && (mb_strlen($this->container['cname']) < 0)) {
                $invalidProperties[] = "invalid value for 'cname', the character length must be bigger than or equal to 0.";
            }
            if (!is_null($this->container['domainStatus']) && (mb_strlen($this->container['domainStatus']) > 32768)) {
                $invalidProperties[] = "invalid value for 'domainStatus', the character length must be smaller than or equal to 32768.";
            }
            if (!is_null($this->container['domainStatus']) && (mb_strlen($this->container['domainStatus']) < 0)) {
                $invalidProperties[] = "invalid value for 'domainStatus', the character length must be bigger than or equal to 0.";
            }
    ...
    * Sets domainStatus
    *
    * @param string|null $domainStatus 域名状态 0-正常，1-冻结
    *
    * @return $this
    */
    ...
    * Sets ppEnable
    *
    * @param int|null $ppEnable 是否开启pp 0-关闭，1-开启
    *
    * @return $this
    */
