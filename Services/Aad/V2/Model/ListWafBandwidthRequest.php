...
class ListWafBandwidthRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListWafBandwidthRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * domains  不传时代表全部域名
    * valueType  平均值 mean、峰值 peak
