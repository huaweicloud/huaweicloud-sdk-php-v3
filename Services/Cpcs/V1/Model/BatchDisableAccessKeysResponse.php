...
class BatchDisableAccessKeysResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDisableAccessKeysResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * accessKeyIds  禁用的访问密钥id列表
    *
    * @var string[]
    */
    ...
    * Sets accessKeyIds
    *
    * @param string[]|null $accessKeyIds 禁用的访问密钥id列表
    *
    * @return $this
    */
