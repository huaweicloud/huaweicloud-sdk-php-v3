...
class BatchEnableAccessKeysResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchEnableAccessKeysResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * accessKeyIds  启用的访问密钥id列表
    *
    * @var string[]
    */
    ...
    * Sets accessKeyIds
    *
    * @param string[]|null $accessKeyIds 启用的访问密钥id列表
    *
    * @return $this
    */
