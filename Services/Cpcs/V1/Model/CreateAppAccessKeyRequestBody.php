...
class CreateAppAccessKeyRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAppAccessKeyRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * keyName  访问密钥名称
    * accessKey  访问密钥ak，默认为空，系统自动生成
    * secretKey  访问密钥sk，默认为空，系统自动生成
    *
    * @var string[]
    */
    ...
    * Sets accessKey
    *
    * @param string|null $accessKey 访问密钥ak，默认为空，系统自动生成
    *
    * @return $this
    */
    ...
    * Sets secretKey
    *
    * @param string|null $secretKey 访问密钥sk，默认为空，系统自动生成
    *
    * @return $this
    */
