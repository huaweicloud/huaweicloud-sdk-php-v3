...
class AuthorizeAccessKeysRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AuthorizeAccessKeysRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * appId  所需要绑定的应用ID
    * accessKeyIds  需要被授权的应用访问密钥的ID列表，若需要授予应用所有访问密钥权限，则仅传入一个元素，且该元素值为“all”，如body为“{\"access_key_ids\": [\"all\"]}”
    *
    * @var string[]
    */
    ...
    * Sets accessKeyIds
    *
    * @param string[] $accessKeyIds 需要被授权的应用访问密钥的ID列表，若需要授予应用所有访问密钥权限，则仅传入一个元素，且该元素值为“all”，如body为“{\"access_key_ids\": [\"all\"]}”
    *
    * @return $this
    */
