...
class CcspClusterInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CcspClusterInfo';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['taskDetails'] === null) {
            $invalidProperties[] = "'taskDetails' can't be null";
        }
        if ($this->container['ccspId'] === null) {
            $invalidProperties[] = "'ccspId' can't be null";
        }
        if ($this->container['distributedType'] === null) {
            $invalidProperties[] = "'distributedType' can't be null";
        }
        ...
        if ($this->container['sharedCcsp'] === null) {
            $invalidProperties[] = "'sharedCcsp' can't be null";
        }
    ...
    *
    * @param string $distributedType 分布类型
    *
    * @return $this
    */
    ...
    * Sets serviceType
    *
    * @param string $serviceType 集群所属的服务
    *
    * @return $this
    */
    ...
    * Sets type
    *
    * @param string $type 集群的类型： - **SHARED** : 应用共享； - **EXCLUSIVE** : 应用独享
    *
    * @return $this
    */
    ...
    * Sets instanceNum
    *
    * @param int $instanceNum 集群中包含的服务实例数量
    *
    * @return $this
    */
    ...
    * Sets createTime
    *
    * @param int $createTime 集群的创建时间，UNIX时间戳，单位毫秒
    *
    * @return $this
    */
    ...
    * Sets sharedCcsp
    *
    * @param bool $sharedCcsp 是否共享ccsp
    *
    * @return $this
    */
