...
class ShowClusterAccessKeyListResponseBodyResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowClusterAccessKeyListResponseBody_result';
