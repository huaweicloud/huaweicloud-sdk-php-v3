...
class ShowResourceDetailCertificateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowResourceDetailCertificateRequest';
    ...
    * Sets to
    *
    * @param int|null $to 查询终止时间戳，毫秒级时间戳，默认为0，默认查询到当前时间
    *
    * @return $this
    */
