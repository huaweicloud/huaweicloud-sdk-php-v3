...
class CreateAppAccessKeyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAppAccessKeyResponse';
    ...
    * Sets accessKeyId
    *
    * @param string|null $accessKeyId 访问密钥的id
    *
    * @return $this
    */
