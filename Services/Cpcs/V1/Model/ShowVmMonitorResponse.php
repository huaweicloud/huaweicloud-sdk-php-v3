...
class ShowVmMonitorResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowVmMonitorResponse';
    ...
    *  指标的时间序列
    *
    * @return \HuaweiCloud\SDK\Cpcs\V1\Model\Datapoint[]|null
    */
    ...
    * Sets datapoints
    *
    * @param \HuaweiCloud\SDK\Cpcs\V1\Model\Datapoint[]|null $datapoints 指标的时间序列
    *
    * @return $this
    */
    ...
    * Sets metricName
    *
    * @param string|null $metricName 指标名称，比如:cpu_util
    *
    * @return $this
    */
