...
class ShowAvailableAzResponsebodyLocales implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAvailableAzResponsebody_locales';
