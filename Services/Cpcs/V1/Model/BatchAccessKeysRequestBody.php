...
class BatchAccessKeysRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchAccessKeysRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * accessKeyIds  所需要绑定的访问密钥ID
    *
    * @var string[]
    */
    ...
    * Sets accessKeyIds
    *
    * @param string[] $accessKeyIds 所需要绑定的访问密钥ID
    *
    * @return $this
    */
