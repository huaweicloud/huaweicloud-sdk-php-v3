...
class ListDedicatedHostTypesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDedicatedHostTypesResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * dedicatedHostTypes  可用的专属主机类型。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'dedicatedHostTypes' => '\HuaweiCloud\SDK\DeH\V1\Model\RespHostType[]'
    ];
    ...
    *  可用的专属主机类型。
    *
    * @return \HuaweiCloud\SDK\DeH\V1\Model\RespHostType[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\DeH\V1\Model\RespHostType[]|null $dedicatedHostTypes 可用的专属主机类型。
    *
    * @return $this
    */
