...
class ReqUpdateDehMessage implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ReqUpdateDehMessage';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * autoPlacement  在创建云服务器时（未指定专属主机ID），是否允许云服务器自动分配在一台可用的专属主机上。  取值范围：“on”或“off”。
    * name  专属主机名称。
    *
    * @var string[]
    */
    ...
    * Sets autoPlacement
    *
    * @param string|null $autoPlacement 在创建云服务器时（未指定专属主机ID），是否允许云服务器自动分配在一台可用的专属主机上。  取值范围：“on”或“off”。
    *
    * @return $this
    */
