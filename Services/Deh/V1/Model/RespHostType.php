...
class RespHostType implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RespHostType';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * hostType  专属主机类型。
    * hostTypeName  专属主机类型名字。
    *
    * @var string[]
    */
    ...
    * Sets hostTypeName
    *
    * @param string $hostTypeName 专属主机类型名字。
    *
    * @return $this
    */
