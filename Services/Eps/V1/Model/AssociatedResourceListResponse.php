...
class AssociatedResourceListResponse implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociatedResourceListResponse';
