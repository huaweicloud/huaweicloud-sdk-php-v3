...
class ListMigrationRecordRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListMigrationRecordRequest';
    ...
    * Sets offset
    *
    * @param string|null $offset 索引位置，从offset指定的下一条数据开始查询
    *
    * @return $this
    */
