...
class ListInstanceRepositoriesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstanceRepositoriesRequest';
    ...
    * orderType  排序方式，支持desc、asc，默认desc
    * namespaceId  所属命名空间ID
    *
    * @var string[]
    */
    ...
    * Sets orderType
    *
    * @param string|null $orderType 排序方式，支持desc、asc，默认desc
    *
    * @return $this
    */
    ...
    * Sets namespaceId
    *
    * @param int|null $namespaceId 所属命名空间ID
    *
    * @return $this
    */
