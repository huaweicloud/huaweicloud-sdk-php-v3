...
class ListInstanceSignPolicyExecTasksRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstanceSignPolicyExecTasksRequest';
