...
class CreateWebhookPolicyRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateWebhookPolicyRequestBody';
    ...
    * Sets eventTypes
    *
    * @param string[] $eventTypes 触发器触发条件，当前支持PUSH_ARTIFACT
    *
    * @return $this
    */
