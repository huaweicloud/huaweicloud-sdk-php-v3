...
class ListInstanceWebhooksRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstanceWebhooksRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  企业仓库实例ID
    * orderColumn  排序字段，支持created_at、updated_at、name，默认为created_at
    * orderType  排序方式，支持desc、asc，默认desc;order_type需要与order_column配合使用
    * name  策略名称，模糊查询
    ...
    * Sets orderType
    *
    * @param string|null $orderType 排序方式，支持desc、asc，默认desc;order_type需要与order_column配合使用
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string|null $name 策略名称，模糊查询
    *
    * @return $this
    */
