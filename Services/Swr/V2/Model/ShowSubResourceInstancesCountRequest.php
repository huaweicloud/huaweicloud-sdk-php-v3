...
class ShowSubResourceInstancesCountRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowSubResourceInstancesCountRequest';
