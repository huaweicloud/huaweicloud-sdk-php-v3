...
class ListInstanceSignPolicyExecutionsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstanceSignPolicyExecutionsRequest';
