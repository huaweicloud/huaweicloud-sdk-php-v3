...
class ListInstanceReplicationPolicyExecSubTasksRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstanceReplicationPolicyExecSubTasksRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  企业仓库实例ID
    * executionId  同步策略执行记录ID
    * taskId  任务ID
    ...
    * Sets executionId
    *
    * @param int $executionId 同步策略执行记录ID
    *
    * @return $this
    */
