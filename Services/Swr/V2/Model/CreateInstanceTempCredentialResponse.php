...
class CreateInstanceTempCredentialResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateInstanceTempCredentialResponse';
    ...
    * Sets authToken
    *
    * @param string|null $authToken 临时访问凭证密码
    *
    * @return $this
    */
    ...
    * Sets tokenId
    *
    * @param string|null $tokenId 临时访问凭证ID
    *
    * @return $this
    */
    ...
    * Sets userId
    *
    * @param string|null $userId 临时访问凭证的用户ID
    *
    * @return $this
    */
