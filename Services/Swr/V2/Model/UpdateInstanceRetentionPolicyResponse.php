...
class UpdateInstanceRetentionPolicyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateInstanceRetentionPolicyResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * algorithm  算法，目前只支持or
    * enabled  是否启用或者关闭所有retentionRules
    * rules  匹配规则，数组长度只允许为1，配置repo范围、tag范围以及作用规则
    * trigger  trigger
    ...
    * Sets algorithm
    *
    * @param string|null $algorithm 算法，目前只支持or
    *
    * @return $this
    */
    ...
    * Sets enabled
    *
    * @param bool|null $enabled 是否启用或者关闭所有retentionRules
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\Swr\V2\Model\RetentionRule[]|null
    */
    ...
    * Sets rules
    *
    * @param \HuaweiCloud\SDK\Swr\V2\Model\RetentionRule[]|null $rules 匹配规则，数组长度只允许为1，配置repo范围、tag范围以及作用规则
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string|null $name 策略名称，由字母、汉字、数字、下划线（_）、中划线 (-)组成，1-256个字符。
    *
    * @return $this
    */
