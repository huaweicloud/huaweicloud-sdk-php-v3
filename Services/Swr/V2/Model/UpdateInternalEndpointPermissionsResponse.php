...
class UpdateInternalEndpointPermissionsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateInternalEndpointPermissionsResponse';
