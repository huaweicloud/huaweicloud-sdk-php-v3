...
class UpdateDomainNameResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDomainNameResponse';
    ...
    */
    protected static $openAPITypes = [
            'domainNameInfo' => '\HuaweiCloud\SDK\Swr\V2\Model\DomainNameInfo'
    ];
    ...
    * Sets domainNameInfo
    *
    * @param \HuaweiCloud\SDK\Swr\V2\Model\DomainNameInfo|null $domainNameInfo domainNameInfo
    *
    * @return $this
    */
