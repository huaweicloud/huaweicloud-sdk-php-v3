...
class ListInstanceRetentionPolicyExecutionsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstanceRetentionPolicyExecutionsRequest';
