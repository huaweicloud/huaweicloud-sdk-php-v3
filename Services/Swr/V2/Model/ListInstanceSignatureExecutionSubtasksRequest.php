...
class ListInstanceSignatureExecutionSubtasksRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstanceSignatureExecutionSubtasksRequest';
    ...
    * Sets executionId
    *
    * @param int $executionId 签名策略执行记录ID
    *
    * @return $this
    */
