...
class ListInstanceResourceInstancesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstanceResourceInstancesRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * resourceType  资源类型，支持的资源类型为：instances
    * offset  起始索引，默认值为0。**注意：offset和limit参数需要配套使用。**
    * limit  返回条数，默认为200，最小值为1，最大值为200。**注意：offset和limit参数需要配套使用。**
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'offset' => 'int',
            'limit' => 'int',
            'body' => '\HuaweiCloud\SDK\Swr\V2\Model\ListResourceInstancesRequestBody'
    ];
    ...
    * Sets limit
    *
    * @param int|null $limit 返回条数，默认为200，最小值为1，最大值为200。**注意：offset和limit参数需要配套使用。**
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Swr\V2\Model\ListResourceInstancesRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Swr\V2\Model\ListResourceInstancesRequestBody|null $body body
    *
    * @return $this
    */
