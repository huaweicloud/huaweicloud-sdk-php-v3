...
class ListInternalEndpointConnectionsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInternalEndpointConnectionsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  企业仓库实例ID
    * limit  返回条数，默认为10，最大值为1000。**注意：offset和limit参数需要配套使用。**
    ...
    * Sets limit
    *
    * @param int|null $limit 返回条数，默认为10，最大值为1000。**注意：offset和limit参数需要配套使用。**
    *
    * @return $this
    */
