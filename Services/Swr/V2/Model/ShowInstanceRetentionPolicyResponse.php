...
class ShowInstanceRetentionPolicyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowInstanceRetentionPolicyResponse';
    ...
    *  匹配规则
    *
    * @return \HuaweiCloud\SDK\Swr\V2\Model\RetentionRuleResponseBody[]|null
    */
    ...
    * Sets rules
    *
    * @param \HuaweiCloud\SDK\Swr\V2\Model\RetentionRuleResponseBody[]|null $rules 匹配规则
    *
    * @return $this
    */
    ...
    * Sets enabled
    *
    * @param bool|null $enabled 是否开启策略
    *
    * @return $this
    */
