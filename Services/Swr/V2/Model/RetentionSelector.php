...
class RetentionSelector implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RetentionSelector';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * kind  匹配类型，目前只支持doublestar
    * decoration  选择器匹配类型 制品仓库选择器可选repoMatches，repoMatches制品版本可选matches，excludes
    ...
    * Sets decoration
    *
    * @param string $decoration 选择器匹配类型 制品仓库选择器可选repoMatches，repoMatches制品版本可选matches，excludes
    *
    * @return $this
    */
