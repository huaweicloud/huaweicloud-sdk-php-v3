...
class DeleteInstanceRetentionPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteInstanceRetentionPolicyRequest';
