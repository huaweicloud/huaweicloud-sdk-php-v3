...
class UpdateInstanceRetentionPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateInstanceRetentionPolicyRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'policyId' => 'int',
            'body' => '\HuaweiCloud\SDK\Swr\V2\Model\UpdateRetentionPolicyRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Swr\V2\Model\UpdateRetentionPolicyRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Swr\V2\Model\UpdateRetentionPolicyRequestBody|null $body body
    *
    * @return $this
    */
