...
class ShowDomainResourceReportsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDomainResourceReportsRequest';
    ...
    */
    ...
    const RESOURCE_TYPE_DOWNFLOW = 'downflow';
    const RESOURCE_TYPE_STORE = 'store';
    ...
    */
    ...
    {
        return [
            self::RESOURCE_TYPE_DOWNFLOW,
            self::RESOURCE_TYPE_STORE,
        ];
    }
