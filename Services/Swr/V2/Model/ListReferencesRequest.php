...
class ListReferencesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListReferencesRequest';
    ...
    * repository  镜像仓库名称
    * tag  签名镜像的版本号
    * limit  返回条数。如果不传该参数默认返回10条记录，最大支持10条记录
    * marker  分页查询时的起始标记，接口的返回值next_marker为下一次查询的起始标记
    *
    * @var string[]
    */
    ...
    * Sets limit
    *
    * @param int|null $limit 返回条数。如果不传该参数默认返回10条记录，最大支持10条记录
    *
    * @return $this
    */
    ...
    * Sets marker
    *
    * @param string|null $marker 分页查询时的起始标记，接口的返回值next_marker为下一次查询的起始标记
    *
    * @return $this
    */
