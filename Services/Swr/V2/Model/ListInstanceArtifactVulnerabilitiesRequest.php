...
class ListInstanceArtifactVulnerabilitiesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstanceArtifactVulnerabilitiesRequest';
