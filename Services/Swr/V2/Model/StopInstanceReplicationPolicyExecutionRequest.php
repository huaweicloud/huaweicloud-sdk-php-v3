...
class StopInstanceReplicationPolicyExecutionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StopInstanceReplicationPolicyExecutionRequest';
