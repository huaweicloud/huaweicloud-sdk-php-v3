...
class UpdateRetentionPolicyRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateRetentionPolicyRequestBody';
    ...
    * Sets rules
    *
    * @param \HuaweiCloud\SDK\Swr\V2\Model\RetentionRule[] $rules 匹配规则，数组长度只允许为1，配置repo范围、tag范围以及作用规则
    *
    * @return $this
    */
