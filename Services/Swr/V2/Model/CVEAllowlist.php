...
class CVEAllowlist implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CVEAllowlist';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  白名单ID
    * namespaceId  漏洞白名单列表所属的命名空间ID
    * expiresAt  漏洞白名单的有效期时间，如果没有配置，则永不过期
    * items  漏洞列表
    * creationTime  漏洞白名单的创建时间
    * updateTime  漏洞白名单的更新时间
    *
    * @var string[]
    */
    ...
    * Sets expiresAt
    *
    * @param int|null $expiresAt 漏洞白名单的有效期时间，如果没有配置，则永不过期
    *
    * @return $this
    */
    ...
    * Sets creationTime
    *
    * @param string|null $creationTime 漏洞白名单的创建时间
    *
    * @return $this
    */
    ...
    * Sets updateTime
    *
    * @param string|null $updateTime 漏洞白名单的更新时间
    *
    * @return $this
    */
