...
class ListInstanceReplicationPolicyExecutionsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstanceReplicationPolicyExecutionsRequest';
    ...
    * Sets policyId
    *
    * @param int|null $policyId 同步策略ID
    *
    * @return $this
    */
