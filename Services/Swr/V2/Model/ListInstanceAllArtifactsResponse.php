...
class ListInstanceAllArtifactsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstanceAllArtifactsResponse';
    ...
    */
    protected static $openAPITypes = [
            'artifacts' => '\HuaweiCloud\SDK\Swr\V2\Model\Artifact[]',
            'nextMarker' => 'int'
    ];
    ...
    *  制品列表
    *
    * @return \HuaweiCloud\SDK\Swr\V2\Model\Artifact[]|null
    */
    ...
    * Sets artifacts
    *
    * @param \HuaweiCloud\SDK\Swr\V2\Model\Artifact[]|null $artifacts 制品列表
    *
    * @return $this
    */
    ...
    * Sets nextMarker
    *
    * @param int|null $nextMarker 下一次分页查询的起始ID。如果未返回该值，则表示数据已查询完毕
    *
    * @return $this
    */
