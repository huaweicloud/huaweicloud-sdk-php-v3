...
class SignRuleSelector implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SignRuleSelector';
    ...
    * extras  预留字段，镜像签名策略中，对无版本的制品进行签名则传入{\"untagged\":true}
    *
    * @var string[]
    */
    ...
    * Sets extras
    *
    * @param string|null $extras 预留字段，镜像签名策略中，对无版本的制品进行签名则传入{\"untagged\":true}
    *
    * @return $this
    */
