...
class ListInstanceReplicationPolicyExecSubTasksResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstanceReplicationPolicyExecSubTasksResponse';
