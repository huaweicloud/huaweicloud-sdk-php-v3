...
class ListNamespaceRepositoriesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListNamespaceRepositoriesRequest';
    ...
    * orderColumn  排序字段，支持created_at、updated_at，默认为created_at
    * orderType  排序方式，支持desc、asc，默认desc;order_column和order_type参数需要配套使用
    * namespaceName  所属命名空间名称
    *
    * @var string[]
    */
    ...
    * Sets orderColumn
    *
    * @param string|null $orderColumn 排序字段，支持created_at、updated_at，默认为created_at
    *
    * @return $this
    */
    ...
    * Sets orderType
    *
    * @param string|null $orderType 排序方式，支持desc、asc，默认desc;order_column和order_type参数需要配套使用
    *
    * @return $this
    */
