...
class ListRepoAccessoriesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRepoAccessoriesRequest';
    ...
    * repository  镜像仓库名称
    * tag  镜像版本
    * limit  返回条数。如果不传该参数默认返回10条记录，最大支持100条记录
    * offset  起始索引,默认值为0
    *
    * @var string[]
    */
    ...
    * Sets limit
    *
    * @param int|null $limit 返回条数。如果不传该参数默认返回10条记录，最大支持100条记录
    *
    * @return $this
    */
    ...
    * Sets offset
    *
    * @param int|null $offset 起始索引,默认值为0
    *
    * @return $this
    */
