...
class ExecuteInstanceRetentionPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExecuteInstanceRetentionPolicyRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'policyId' => 'int',
            'body' => '\HuaweiCloud\SDK\Swr\V2\Model\ExecuteRetentionPolicyRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Swr\V2\Model\ExecuteRetentionPolicyRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Swr\V2\Model\ExecuteRetentionPolicyRequestBody|null $body body
    *
    * @return $this
    */
