...
class ListInstanceReplicationPoliciesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstanceReplicationPoliciesRequest';
    ...
    * Sets registryId
    *
    * @param int|null $registryId 仓库ID
    *
    * @return $this
    */
