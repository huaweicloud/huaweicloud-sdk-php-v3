...
class UpdateImmutableRuleBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateImmutableRuleBody';
    ...
    * Sets priority
    *
    * @param int|null $priority 优先级，默认值为0
    *
    * @return $this
    */
    ...
    * Sets action
    *
    * @param string|null $action 预留字段，支持填immutable
    *
    * @return $this
    */
    ...
    * Sets template
    *
    * @param string|null $template 预留字段，支持填immutable_template
    *
    * @return $this
    */
    ...
    *  制品版本选择器，目前只支持长度为1
    *
    * @return \HuaweiCloud\SDK\Swr\V2\Model\RuleSelector[]
    */
    ...
    * Sets tagSelectors
    *
    * @param \HuaweiCloud\SDK\Swr\V2\Model\RuleSelector[] $tagSelectors 制品版本选择器，目前只支持长度为1
    *
    * @return $this
    */
    ...
    *
    * @return map[string,\HuaweiCloud\SDK\Swr\V2\Model\RuleSelector[]]
    */
    ...
    * Sets scopeSelectors
    *
    * @param map[string,\HuaweiCloud\SDK\Swr\V2\Model\RuleSelector[]] $scopeSelectors 制品仓库选择器，目前只支持repository且长度为1
    *
    * @return $this
    */
