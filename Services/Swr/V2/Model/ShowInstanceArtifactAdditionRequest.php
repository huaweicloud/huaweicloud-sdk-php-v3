...
class ShowInstanceArtifactAdditionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowInstanceArtifactAdditionRequest';
    ...
    */
    ...
    const ADDITION_BUILD_HISTORY = 'build_history';
    ...
    * @return string[]
    */
    public function getAdditionAllowableValues()
    {
        return [
            self::ADDITION_BUILD_HISTORY,
        ];
    }
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['addition'] === null) {
            ...
            $allowedValues = $this->getAdditionAllowableValues();
                if (!is_null($this->container['addition']) && !in_array($this->container['addition'], $allowedValues, true)) {
                $invalidProperties[] = sprintf(
                "invalid value for 'addition', must be one of '%s'",
