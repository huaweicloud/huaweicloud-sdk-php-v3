...
class ListInstanceWebhooksResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstanceWebhooksResponse';
    ...
    */
    protected static $openAPITypes = [
            'policies' => '\HuaweiCloud\SDK\Swr\V2\Model\WebhookPolicyDetail[]',
            'total' => 'int'
    ];
