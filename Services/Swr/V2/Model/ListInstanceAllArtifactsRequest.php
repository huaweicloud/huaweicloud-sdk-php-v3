...
class ListInstanceAllArtifactsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstanceAllArtifactsRequest';
    ...
    * Sets limit
    *
    * @param int|null $limit 返回条数，默认为10，最大值为100。**注意：marker和limit参数需要配套使用。**
    *
    * @return $this
    */
