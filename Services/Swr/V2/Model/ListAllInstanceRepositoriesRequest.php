...
class ListAllInstanceRepositoriesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAllInstanceRepositoriesRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * marker  分页查询时的查询标记，使用上一次接口调用返回的next_marker值，默认值从第一条数据查询。**注意：marker和limit参数需要配套使用。**
    * limit  条目数量，用于分页查询，默认值为100，最大值为100
    * name  仓库名称
    *
    * @var string[]
    */
    ...
    * Sets limit
    *
    * @param int|null $limit 条目数量，用于分页查询，默认值为100，最大值为100
    *
    * @return $this
    */
