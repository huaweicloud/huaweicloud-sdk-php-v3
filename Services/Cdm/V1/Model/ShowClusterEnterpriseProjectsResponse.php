...
class ShowClusterEnterpriseProjectsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowClusterEnterpriseProjectsResponse';
    ...
    * Sets sysTags
    *
    * @param \HuaweiCloud\SDK\Cdm\V1\Model\SysTags[]|null $sysTags 企业项目列表
    *
    * @return $this
    */
