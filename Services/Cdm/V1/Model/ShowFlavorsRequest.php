...
class ShowFlavorsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowFlavorsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * projectId  项目ID。
    * datastoreId  版本ID，获取方法请参见[CDM支持的版本](ShowDatastores.xml)。
    *
    * @var string[]
    */
