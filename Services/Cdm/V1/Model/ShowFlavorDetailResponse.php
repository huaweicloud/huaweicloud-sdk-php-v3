...
class ShowFlavorDetailResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'name' => 'string',
            'strId' => 'string',
            'flavorDetail' => '\HuaweiCloud\SDK\Cdm\V1\Model\FlavorAttribute[]'
    ];
    ...
    *  规格详细列表
    *
    * @return \HuaweiCloud\SDK\Cdm\V1\Model\FlavorAttribute[]|null
    */
    ...
    * Sets flavorDetail
    *
    * @param \HuaweiCloud\SDK\Cdm\V1\Model\FlavorAttribute[]|null $flavorDetail 规格详细列表
    *
    * @return $this
    */
