...
class PutWarmPoolOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PutWarmPoolOption';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * minCapacity  暖池最小容量，暖池最小与最大容量必须同时填写或不填写。暖池最小容量和最大容量填写时必须相等
    * maxCapacity  暖池最大容量，暖池最小与最大容量必须同时填写或不填写。暖池最小容量和最大容量填写时必须相等
    * instanceInitWaitTime  实例初始化等待时间，单位：秒
    *
    * @var string[]
    */
    ...
    * Sets minCapacity
    *
    * @param int|null $minCapacity 暖池最小容量，暖池最小与最大容量必须同时填写或不填写。暖池最小容量和最大容量填写时必须相等
    *
    * @return $this
    */
    ...
    * Sets maxCapacity
    *
    * @param int|null $maxCapacity 暖池最大容量，暖池最小与最大容量必须同时填写或不填写。暖池最小容量和最大容量填写时必须相等
    *
    * @return $this
    */
    ...
    *
    * @param int|null $instanceInitWaitTime 实例初始化等待时间，单位：秒
    *
    * @return $this
    */
