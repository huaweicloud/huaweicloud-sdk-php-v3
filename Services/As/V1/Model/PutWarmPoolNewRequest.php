...
class PutWarmPoolNewRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PutWarmPoolNewRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'projectId' => 'string',
            'body' => '\HuaweiCloud\SDK\_As\V1\Model\PutWarmPoolOption'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\_As\V1\Model\PutWarmPoolOption|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\_As\V1\Model\PutWarmPoolOption|null $body body
    *
    * @return $this
    */
