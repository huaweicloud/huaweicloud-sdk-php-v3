...
class AsAsyncClient extends Client
{
     ...
     * @return response
     */
    public function updateScalingConfigAsync($request)
    {
        return $this->updateScalingConfigAsyncWithHttpInfo($request);
    }
    
    public function updateScalingConfigAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/autoscaling-api/v1/{project_id}/scaling_configuration/{scaling_configuration_id}';
        $formParams = [];
        $queryParams = [];
