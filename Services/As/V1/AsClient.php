...
class AsClient extends Client
{
     ...
     * @return response
     */
    public function closeWarmPool($request)
    {
        return $this->closeWarmPoolWithHttpInfo($request);
    }

    public function closeWarmPoolWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function closeWarmPoolNew($request)
    {
        return $this->closeWarmPoolNewWithHttpInfo($request);
    }

    public function closeWarmPoolNewWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function listWarmPoolInstances($request)
    {
        return $this->listWarmPoolInstancesWithHttpInfo($request);
    }

    public function listWarmPoolInstancesWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function listWarmPoolInstancesNew($request)
    {
        return $this->listWarmPoolInstancesNewWithHttpInfo($request);
    }

    public function listWarmPoolInstancesNewWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function putWarmPool($request)
    {
        return $this->putWarmPoolWithHttpInfo($request);
    }

    public function putWarmPoolWithHttpInfo($request)
    {
        $resourcePath = '/autoscaling-api/{project_id}/scaling-groups/{scaling_group_id}/warm-pool';
        $formParams = [];
        $queryParams = [];
     ...
     * @return response
     */
    public function putWarmPoolNew($request)
    {
        return $this->putWarmPoolNewWithHttpInfo($request);
    }

    public function putWarmPoolNewWithHttpInfo($request)
    {
        $resourcePath = '/v2/{project_id}/scaling-groups/{scaling_group_id}/warm-pool';
        $formParams = [];
        $queryParams = [];
     ...
     * @return response
     */
    public function showWarmPool($request)
    {
        return $this->showWarmPoolWithHttpInfo($request);
    }

    public function showWarmPoolWithHttpInfo($request)
    {
        $resourcePath = '/autoscaling-api/{project_id}/scaling-groups/{scaling_group_id}/warm-pool';
        $formParams = [];
        $queryParams = [];
     ...
     * @return response
     */
    public function showWarmPoolNew($request)
    {
        return $this->showWarmPoolNewWithHttpInfo($request);
    }

    public function showWarmPoolNewWithHttpInfo($request)
    {
        $resourcePath = '/v2/{project_id}/scaling-groups/{scaling_group_id}/warm-pool';
        $formParams = [];
        $queryParams = [];
     ...
     * @return response
     */
    public function updateScalingConfig($request)
    {
        return $this->updateScalingConfigWithHttpInfo($request);
    }

    public function updateScalingConfigWithHttpInfo($request)
    {
        $resourcePath = '/autoscaling-api/v1/{project_id}/scaling_configuration/{scaling_configuration_id}';
        $formParams = [];
        $queryParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\_As\V1\Model\UpdateScalingConfigResponse',
            $requestType='\HuaweiCloud\SDK\_As\V1\Model\UpdateScalingConfigRequest');
    }
