...
class FlowGraph2Result implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'FlowGraph2_result';
    ...
    */
    protected static $openAPITypes = [
            'edges' => '\HuaweiCloud\SDK\CodeArtsBuild\V3\Model\FlowGraph2ResultEdges[]',
    ...
    *  edges
    *
    * @return \HuaweiCloud\SDK\CodeArtsBuild\V3\Model\FlowGraph2ResultEdges[]|null
    */
    ...
    * Sets edges
    *
    * @param \HuaweiCloud\SDK\CodeArtsBuild\V3\Model\FlowGraph2ResultEdges[]|null $edges edges
    *
    * @return $this
    */
