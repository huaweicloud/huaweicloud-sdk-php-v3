...
class ListRelatedProjectInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRelatedProjectInfoRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * pageSize  每页显示的条目数量，page_size小于等于100
    * pageNo  分页页码，表示从此页开始查询， page大于等于1
    * search  搜索内容
    *
    * @var string[]
    */
    ...
    * Sets pageNo
    *
    * @param int|null $pageNo 分页页码，表示从此页开始查询， page大于等于1
    *
    * @return $this
    */
