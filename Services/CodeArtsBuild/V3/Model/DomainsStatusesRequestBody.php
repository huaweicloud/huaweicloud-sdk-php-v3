...
class DomainsStatusesRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DomainsStatusesRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * domainIds  **参数解释**： 租户id集合。 **约束限制**： 不涉及。 **取值范围**： 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets domainIds
    *
    * @param string|null $domainIds **参数解释**： 租户id集合。 **约束限制**： 不涉及。 **取值范围**： 不涉及。
    *
    * @return $this
    */
