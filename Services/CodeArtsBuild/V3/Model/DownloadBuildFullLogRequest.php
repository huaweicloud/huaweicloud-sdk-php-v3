...
class DownloadBuildFullLogRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DownloadBuildFullLogRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * recordId  记录ID,36位数字、小写字母、'-'组组合。
    * logLevel  日志等级 值为INFO | DEBUG。
    * compress  **参数解释**： 是否压缩日志。 **约束限制**： 不涉及。 **取值范围**： true|false。 **默认取值**： false
    *
    * @var string[]
    */
    ...
    * Sets compress
    *
    * @param bool|null $compress **参数解释**： 是否压缩日志。 **约束限制**： 不涉及。 **取值范围**： true|false。 **默认取值**： false
    *
    * @return $this
    */
