...
class ShowBuildRecordFullStagesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowBuildRecordFullStagesRequest';
    ...
    * Sets cascade
    *
    * @param bool|null $cascade 是否联级获取steps
    *
    * @return $this
    */
