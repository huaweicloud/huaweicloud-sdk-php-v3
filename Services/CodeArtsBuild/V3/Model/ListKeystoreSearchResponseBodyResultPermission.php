...
class ListKeystoreSearchResponseBodyResultPermission implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListKeystoreSearchResponseBody_result_permission';
    ...
    * Sets keystoreId
    *
    * @param string|null $keystoreId 文件ID
    *
    * @return $this
    */
    ...
    * Sets setting
    *
    * @param bool|null $setting 是否有设置权限
    *
    * @return $this
    */
