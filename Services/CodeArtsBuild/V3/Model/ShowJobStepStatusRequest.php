...
class ShowJobStepStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowJobStepStatusRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['jobId'] === null) {
            ...
            if (!is_null($this->container['buildNo']) && ($this->container['buildNo'] > 2147483647)) {
                $invalidProperties[] = "invalid value for 'buildNo', must be smaller than or equal to 2147483647.";
            }
            if (!is_null($this->container['buildNo']) && ($this->container['buildNo'] < 1)) {
