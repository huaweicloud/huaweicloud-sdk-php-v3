...
class UpdateKeystoreRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateKeystoreRequestBody';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['keystoreName'] === null) {
            $invalidProperties[] = "'keystoreName' can't be null";
        }
    ...
    * Sets share
    *
    * @param int $share 是否租户内共享，1-共享，0-不共享
    *
    * @return $this
    */
