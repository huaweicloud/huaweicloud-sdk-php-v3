...
class SaveTemplateUsedInfoRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SaveTemplateUsedInfoRequestBody';
    ...
    * Sets templateId
    *
    * @param string $templateId 构建模版ID
    *
    * @return $this
    */
