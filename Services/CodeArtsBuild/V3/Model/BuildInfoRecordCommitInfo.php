...
class BuildInfoRecordCommitInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BuildInfoRecord_commit_info';
    ...
    * Sets createdAt
    *
    * @param string|null $createdAt 提交时间
    *
    * @return $this
    */
