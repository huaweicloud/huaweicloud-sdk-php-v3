...
class DownloadBuildRealTimeLogRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DownloadBuildRealTimeLogRequest';
    ...
    * size  **参数解释**： 可控制返回内容长度，固定1000。 **约束限制**： 不涉及。 **取值范围**： 只能使用数字，大于等于0。 **默认取值**： 1000
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['buildNo'] === null) {
            ...
            if (!is_null($this->container['endOffset']) && ($this->container['endOffset'] < 0)) {
    ...
    * Sets startOffset
    *
    * @param int|null $startOffset **参数解释**： 起始偏移量，表示从此开始查询。 **约束限制**： 不涉及。 **取值范围**： 只能使用数字，大于等于0。
    *
    * @return $this
    */
    ...
    * Sets endOffset
    *
    * @param int|null $endOffset **参数解释**： 结束偏移量，表示查询到此结束。 **约束限制**： 不涉及。 **取值范围**： 只能使用数字，大于等于0。
    *
    * @return $this
    */
