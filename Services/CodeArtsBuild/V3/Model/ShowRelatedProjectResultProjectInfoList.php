...
class ShowRelatedProjectResultProjectInfoList implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowRelatedProject_result_project_info_list';
    ...
    * Sets isCreator
    *
    * @param bool|null $isCreator 是否为项目创建者
    *
    * @return $this
    */
