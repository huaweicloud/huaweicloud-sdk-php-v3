...
class MoveJobGroupResponseBodyResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MoveJobGroupResponseBody_result';
    ...
    * Sets groupPathId
    *
    * @param string|null $groupPathId 分组路径
    *
    * @return $this
    */
