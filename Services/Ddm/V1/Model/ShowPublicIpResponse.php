...
class ShowPublicIpResponse implements ModelInterface, ArrayAccess
{
    ...
    * totalCount  总数。
    * publicIpList  弹性公网IP信息。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalCount' => 'int',
            'publicIpList' => '\HuaweiCloud\SDK\Ddm\V1\Model\PublicIpInfo[]'
    ];
    ...
    *  弹性公网IP信息。
    *
    * @return \HuaweiCloud\SDK\Ddm\V1\Model\PublicIpInfo[]|null
    */
    ...
    * Sets publicIpList
    *
    * @param \HuaweiCloud\SDK\Ddm\V1\Model\PublicIpInfo[]|null $publicIpList 弹性公网IP信息。
    *
    * @return $this
    */
