...
class CopyConfigurationRequest implements ModelInterface, ArrayAccess
{
    ...
    * configId  **参数解释**：  参数组ID。不能使用默认参数组进行复制  **约束限制**：  不涉及。  **取值范围**：  只能由英文字母、数字组成，长度为36个字符。  **默认取值**：  不涉及。
    * body  body
    *
    * @var string[]
    */
    ...
    * Sets configId
    *
    * @param string $configId **参数解释**：  参数组ID。不能使用默认参数组进行复制  **约束限制**：  不涉及。  **取值范围**：  只能由英文字母、数字组成，长度为36个字符。  **默认取值**：  不涉及。
    *
    * @return $this
    */
