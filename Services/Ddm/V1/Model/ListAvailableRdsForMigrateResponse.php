...
class ListAvailableRdsForMigrateResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAvailableRdsForMigrateResponse';
    ...
    *  可用后端DN信息。
    *
    * @return \HuaweiCloud\SDK\Ddm\V1\Model\AvailableDnInstance[]|null
    */
    ...
    * Sets dataNodes
    *
    * @param \HuaweiCloud\SDK\Ddm\V1\Model\AvailableDnInstance[]|null $dataNodes 可用后端DN信息。
    *
    * @return $this
    */
