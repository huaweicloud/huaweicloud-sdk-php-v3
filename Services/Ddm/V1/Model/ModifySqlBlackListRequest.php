...
class ModifySqlBlackListRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ModifySqlBlackListRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'logicDbName' => 'string',
            'body' => '\HuaweiCloud\SDK\Ddm\V1\Model\ConfigSqlBlacklistReqV3VO'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['logicDbName'] === null) {
            $invalidProperties[] = "'logicDbName' can't be null";
        }
            if ((mb_strlen($this->container['logicDbName']) > 1024)) {
                $invalidProperties[] = "invalid value for 'logicDbName', the character length must be smaller than or equal to 1024.";
            }
            if ((mb_strlen($this->container['logicDbName']) < 0)) {
    ...
    * Sets logicDbName
    *
    * @param string $logicDbName **参数解释**：  逻辑库名称。  **约束限制**：  不涉及  **取值范围**：  不涉及。  **默认取值**：  不涉及。
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ddm\V1\Model\ConfigSqlBlacklistReqV3VO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ddm\V1\Model\ConfigSqlBlacklistReqV3VO|null $body body
    *
    * @return $this
    */
