...
class MoveTmlogFilesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MoveTmlogFilesRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ddm\V1\Model\MoveTmlogsRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ddm\V1\Model\MoveTmlogsRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ddm\V1\Model\MoveTmlogsRequest|null $body body
    *
    * @return $this
    */
