...
class ListReadWriteRatioRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListReadWriteRatioRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  DDM实例ID。
    * curPage  分页参数：起始值 [大于等于0] 。
    * perPage  分页参数：每页多少条。
    * startDate  开始时间，UTC time，精确到毫秒。
    * endDate  结束时间，UTC time，精确到毫秒。结束时间与开始时间，间隔不能超过1个月。
    *
    * @var string[]
    */
