...
class ListSlowLogAnalysisResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSlowLogAnalysisResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * total  **参数解释**：  分页参数: 每页记录数。  **参数范围**：  不涉及。
    * slowLogList  **参数解释**：  慢日志列表。  **参数范围**：  不涉及。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'slowLogList' => '\HuaweiCloud\SDK\Ddm\V1\Model\ESDBSlowSqlTemplateItem[]'
    ];
    ...
    *  **参数解释**：  慢日志列表。  **参数范围**：  不涉及。
    *
    * @return \HuaweiCloud\SDK\Ddm\V1\Model\ESDBSlowSqlTemplateItem[]|null
    */
    ...
    * Sets slowLogList
    *
    * @param \HuaweiCloud\SDK\Ddm\V1\Model\ESDBSlowSqlTemplateItem[]|null $slowLogList **参数解释**：  慢日志列表。  **参数范围**：  不涉及。
    *
    * @return $this
    */
