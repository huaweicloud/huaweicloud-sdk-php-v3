...
class UnbindLogicDbRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UnbindLogicDbRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  DDM实例ID
    * logicDbName  需要解绑的逻辑库名
    *
    * @var string[]
    */
