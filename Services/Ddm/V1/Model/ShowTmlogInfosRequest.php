...
class ShowTmlogInfosRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowTmlogInfosRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  **参数解释**：  实例ID，此参数是实例的唯一标识。  **约束限制**：  不涉及。  **取值范围**：  只能由英文字母、数字组成，后缀为in09，长度为36个字符。  **默认取值**：  不涉及。
    * offset  参数解释：  索引位置，偏移量。  约束限制：  不涉及。  取值范围：  大于等于0。  默认取值：  默认值是0。
    * limit  参数解释：  查询记录数。  约束限制：  不涉及。  取值范围：  大于0且小于等于128。  默认取值：  默认值是10。
    *
    * @var string[]
    */
    ...
    * Sets offset
    *
    * @param int|null $offset 参数解释：  索引位置，偏移量。  约束限制：  不涉及。  取值范围：  大于等于0。  默认取值：  默认值是0。
    *
    * @return $this
    */
    ...
    * Sets limit
    *
    * @param int|null $limit 参数解释：  查询记录数。  约束限制：  不涉及。  取值范围：  大于0且小于等于128。  默认取值：  默认值是10。
    *
    * @return $this
    */
