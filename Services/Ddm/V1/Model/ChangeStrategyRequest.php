...
class ChangeStrategyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeStrategyRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'dbName' => 'string',
            'jobId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ddm\V1\Model\MigrateRouteSwitchReqVO'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['dbName'] === null) {
            ...
            if ((mb_strlen($this->container['dbName']) > 1024)) {
        ...
        if ($this->container['jobId'] === null) {
            ...
            if ((mb_strlen($this->container['jobId']) > 1024)) {
                $invalidProperties[] = "invalid value for 'jobId', the character length must be smaller than or equal to 1024.";
            }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ddm\V1\Model\MigrateRouteSwitchReqVO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ddm\V1\Model\MigrateRouteSwitchReqVO|null $body body
    *
    * @return $this
    */
