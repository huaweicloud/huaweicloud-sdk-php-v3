...
class ListSlowLogResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'totalRecord' => 'int',
            'slowLogList' => '\HuaweiCloud\SDK\Ddm\V1\Model\SlowLogList[]'
    ];
    ...
    *  DDM慢sql日志信息列表的集合。
    *
    * @return \HuaweiCloud\SDK\Ddm\V1\Model\SlowLogList[]|null
    */
    ...
    * Sets slowLogList
    *
    * @param \HuaweiCloud\SDK\Ddm\V1\Model\SlowLogList[]|null $slowLogList DDM慢sql日志信息列表的集合。
    *
    * @return $this
    */
