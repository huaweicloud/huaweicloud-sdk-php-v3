...
class ResetDdmUserPasswordRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResetDdmUserPasswordRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  **参数解释**：  实例ID，此参数是实例的唯一标识。  **约束限制**：  不涉及。  **取值范围**：  只能由英文字母、数字组成，后缀为in09，长度为36个字符。  **默认取值**：  不涉及。
    * username  **参数解释**：  需要重置密码的账号名称。  **约束限制**：  不涉及。  **取值范围**：  不涉及。  **默认取值**：  不涉及。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'username' => 'string',
            'body' => '\HuaweiCloud\SDK\Ddm\V1\Model\ResetUserPasswordV3RequestBody'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['username'] === null) {
            ...
            if ((mb_strlen($this->container['username']) > 36)) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ddm\V1\Model\ResetUserPasswordV3RequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ddm\V1\Model\ResetUserPasswordV3RequestBody|null $body body
    *
    * @return $this
    */
