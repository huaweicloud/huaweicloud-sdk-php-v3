...
class ListFlavorsResponse implements ModelInterface, ArrayAccess
{
    ...
    * computeFlavorGroups  计算类型规格组。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'computeFlavorGroups' => '\HuaweiCloud\SDK\Ddm\V1\Model\ComputeFlavorGroupsInfo[]'
    ];
    ...
    */
    protected static $attributeMap = [
            'computeFlavorGroups' => 'computeFlavorGroups'
    ];
    ...
    *  计算类型规格组。
    *
    * @return \HuaweiCloud\SDK\Ddm\V1\Model\ComputeFlavorGroupsInfo[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Ddm\V1\Model\ComputeFlavorGroupsInfo[]|null $computeFlavorGroups 计算类型规格组。
    *
    * @return $this
    */
