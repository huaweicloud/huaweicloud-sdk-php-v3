...
class AvailableZone implements ModelInterface, ArrayAccess
{
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['supportIpv6'] === null) {
            $invalidProperties[] = "'supportIpv6' can't be null";
        }
    ...
    * Sets supportIpv6
    *
    * @param bool $supportIpv6 是否支持IPV6
    *
    * @return $this
    */
