...
class ShowLogicalProcessesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowLogicalProcessesRequest';
    ...
    * keyword  会话结果筛选关键字，支持返回结果全字段模糊匹配，长度最大255
    *
    * @var string[]
    */
    ...
    * Sets keyword
    *
    * @param string|null $keyword 会话结果筛选关键字，支持返回结果全字段模糊匹配，长度最大255
    *
    * @return $this
    */
