...
class BatchModifyReadWriteStrategyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchModifyReadWriteStrategyRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ddm\V1\Model\BatchModifyReadAndWriteStrategyRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ddm\V1\Model\BatchModifyReadAndWriteStrategyRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ddm\V1\Model\BatchModifyReadAndWriteStrategyRequest|null $body body
    *
    * @return $this
    */
