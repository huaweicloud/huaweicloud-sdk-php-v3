...
class ConfigurationParameter implements ModelInterface, ArrayAccess
{
    ...
    * readonly  是否只读。  “false”表示否。 “true”表示是。
    * valueRange  参数值范围，如integer取值0-1、boolean取值true或者false等。
    ...
    *
    * @param bool $restartRequired 是否需要重启。  “false”表示否。 “true”表示是。
    *
    * @return $this
    */
    ...
    * Sets readonly
    *
    * @param bool $readonly 是否只读。  “false”表示否。 “true”表示是。
    *
    * @return $this
    */
    ...
    * Sets valueRange
    *
    * @param string|null $valueRange 参数值范围，如integer取值0-1、boolean取值true或者false等。
    *
    * @return $this
    */
