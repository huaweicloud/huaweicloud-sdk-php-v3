...
class RestoreMetaDataSource implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RestoreMetaDataSource';
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['restoreTime']) && ($this->container['restoreTime'] > 9223372036854775807)) {
                $invalidProperties[] = "invalid value for 'restoreTime', must be smaller than or equal to 9223372036854775807.";
            }
            if (!is_null($this->container['restoreTime']) && ($this->container['restoreTime'] < 1)) {
                $invalidProperties[] = "invalid value for 'restoreTime', must be bigger than or equal to 1.";
            }
            if (!is_null($this->container['backupId']) && (mb_strlen($this->container['backupId']) > 2147483647)) {
                $invalidProperties[] = "invalid value for 'backupId', the character length must be smaller than or equal to 2147483647.";
            }
    ...
    * Sets restoreTime
    *
    * @param float|null $restoreTime 恢复时间。
    *
    * @return $this
    */
