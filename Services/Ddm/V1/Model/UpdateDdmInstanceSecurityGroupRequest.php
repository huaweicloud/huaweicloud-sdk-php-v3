...
class UpdateDdmInstanceSecurityGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDdmInstanceSecurityGroupRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ddm\V1\Model\UpdateInstanceSecurityGroupV3RequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ddm\V1\Model\UpdateInstanceSecurityGroupV3RequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ddm\V1\Model\UpdateInstanceSecurityGroupV3RequestBody|null $body body
    *
    * @return $this
    */
