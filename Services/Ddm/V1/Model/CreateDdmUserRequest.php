...
class CreateDdmUserRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateDdmUserRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ddm\V1\Model\CreateUserRequestV3'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ddm\V1\Model\CreateUserRequestV3|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ddm\V1\Model\CreateUserRequestV3|null $body body
    *
    * @return $this
    */
