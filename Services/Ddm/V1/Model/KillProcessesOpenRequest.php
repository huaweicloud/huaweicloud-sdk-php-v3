...
class KillProcessesOpenRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'KillProcessesOpenRequest';
    ...
    * Sets processIds
    *
    * @param string[] $processIds 会话id集合
    *
    * @return $this
    */
