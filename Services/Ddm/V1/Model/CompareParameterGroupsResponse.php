...
class CompareParameterGroupsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CompareParameterGroupsResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'targetId' => 'string',
            'targetName' => 'string',
            'parameters' => '\HuaweiCloud\SDK\Ddm\V1\Model\ParamGroupParameterDiffV3[]'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['sourceName']) && (mb_strlen($this->container['sourceName']) > 2147483647)) {
                $invalidProperties[] = "invalid value for 'sourceName', the character length must be smaller than or equal to 2147483647.";
            }
    ...
    * Sets sourceName
    *
    * @param string|null $sourceName **参数解释**：  源参数组名称。  **参数范围**：  不涉及。
    *
    * @return $this
    */
    ...
    * Sets targetName
    *
    * @param string|null $targetName **参数解释**：  目标参数组名称。  **参数范围**：  不涉及。
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\Ddm\V1\Model\ParamGroupParameterDiffV3[]|null
    */
    ...
    * Sets parameters
    *
    * @param \HuaweiCloud\SDK\Ddm\V1\Model\ParamGroupParameterDiffV3[]|null $parameters **参数解释**：  比较参数组返回相关信息的集合。  **参数范围**：  不涉及。
    *
    * @return $this
    */
