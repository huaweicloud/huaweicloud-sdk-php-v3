...
class CheckMigrateLogicDbRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CheckMigrateLogicDbRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'dbName' => 'string',
            'body' => '\HuaweiCloud\SDK\Ddm\V1\Model\MigrateLogicDbOpenReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ddm\V1\Model\MigrateLogicDbOpenReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ddm\V1\Model\MigrateLogicDbOpenReq|null $body body
    *
    * @return $this
    */
