...
class BatchModifyReadWriteStrategyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchModifyReadWriteStrategyResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * success  **参数解释**：  是否成功。  **参数范围**：  不涉及。
    * requestId  **参数解释**：  请求id。  **参数范围**：  不涉及。
    * data  **参数解释**：  返回信息。  **参数范围**：  不涉及。
    *
    * @var string[]
    */
    ...
    * Sets success
    *
    * @param bool|null $success **参数解释**：  是否成功。  **参数范围**：  不涉及。
    *
    * @return $this
    */
    ...
    * Sets requestId
    *
    * @param string|null $requestId **参数解释**：  请求id。  **参数范围**：  不涉及。
    *
    * @return $this
    */
    ...
    * Sets data
    *
    * @param object|null $data **参数解释**：  返回信息。  **参数范围**：  不涉及。
    *
    * @return $this
    */
