...
class SetReadOnlyStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SetReadOnlyStatusRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ddm\V1\Model\ReadOnlySwitchReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ddm\V1\Model\ReadOnlySwitchReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ddm\V1\Model\ReadOnlySwitchReq|null $body body
    *
    * @return $this
    */
