...
class ReduceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ReduceRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * nodeNumber  需要缩容的节点数量，最大值为实例节点数减1。
    ...
    * Sets nodeNumber
    *
    * @param int $nodeNumber 需要缩容的节点数量，最大值为实例节点数减1。
    *
    * @return $this
    */
