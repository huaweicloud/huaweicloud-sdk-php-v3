...
class SwitchIpGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    * groupId  **参数解释**：  组ID，此参数是组的唯一标识。  **约束限制**：  不涉及。  **取值范围**：  只能由英文字母、数字组成。  **默认取值**：  不涉及。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'groupId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ddm\V1\Model\ElbIpGroupOpsReq'
    ];
    ...
    * Sets groupId
    *
    * @param string $groupId **参数解释**：  组ID，此参数是组的唯一标识。  **约束限制**：  不涉及。  **取值范围**：  只能由英文字母、数字组成。  **默认取值**：  不涉及。
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ddm\V1\Model\ElbIpGroupOpsReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ddm\V1\Model\ElbIpGroupOpsReq|null $body body
    *
    * @return $this
    */
