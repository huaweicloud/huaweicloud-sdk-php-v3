...
class ResetParameterGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResetParameterGroupRequest';
    ...
    */
    protected static $openAPITypes = [
            'configId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ddm\V1\Model\ConfigurationUpdateReqV3'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ddm\V1\Model\ConfigurationUpdateReqV3|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ddm\V1\Model\ConfigurationUpdateReqV3|null $body body
    *
    * @return $this
    */
