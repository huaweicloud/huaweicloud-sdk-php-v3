...
class RestoreInstTarget implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RestoreInstTarget';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['instanceId'] === null) {
            ...
            if ((mb_strlen($this->container['instanceId']) > 2147483647)) {
