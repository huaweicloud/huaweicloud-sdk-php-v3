...
class UpdateUserV3RequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateUserV3RequestBody';
    ...
    */
    protected static $openAPITypes = [
            ...
            'databases' => '\HuaweiCloud\SDK\Ddm\V1\Model\UpdateUserRelatedLogicDbV3[]'
    ];
    ...
    * Sets baseAuthority
    *
    * @param string[]|null $baseAuthority **参数解释**：  DDM实例账号的基础权限。  **约束限制**：  无  **取值范围**：  CREATE、DROP、ALTER、INDEX、INSERT、DELETE、UPDATE、SELECT的任意集合  **默认取值**：  不涉及。
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\Ddm\V1\Model\UpdateUserRelatedLogicDbV3[]|null
    */
    ...
    * Sets databases
    *
    * @param \HuaweiCloud\SDK\Ddm\V1\Model\UpdateUserRelatedLogicDbV3[]|null $databases 关联的逻辑库的集合。 databases字段可以省略，即创建用户时可以不关联逻辑库。
    *
    * @return $this
    */
