...
class ListGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGroupRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  DDM实例ID。
    * offset  分页参数：起始值 [大于等于0] 。默认值是0。
    * limit  分页参数：每页多少条 [大于0且小于等于128]。默认值是10。
    *
    * @var string[]
    */
    ...
    * Sets limit
    *
    * @param int|null $limit 分页参数：每页多少条 [大于0且小于等于128]。默认值是10。
    *
    * @return $this
    */
