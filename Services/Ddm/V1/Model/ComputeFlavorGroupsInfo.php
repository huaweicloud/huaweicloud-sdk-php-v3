...
class ComputeFlavorGroupsInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ComputeFlavorGroupsInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * groupType  计算资源架构类型，目前分X86和ARM两种。
    * computeFlavors  计算类型规格详情。
    * offset  分页参数: 起始值。
    * limit  分页参数：每页多少条。
    * total  计算类型规格总数。
    *
    ...
    */
    protected static $openAPITypes = [
            'groupType' => 'string',
            'computeFlavors' => '\HuaweiCloud\SDK\Ddm\V1\Model\ComputeFlavors[]',
            'offset' => 'int',
            'limit' => 'int',
            'total' => 'int'
    ];
    ...
    *  计算类型规格详情。
    *
    * @return \HuaweiCloud\SDK\Ddm\V1\Model\ComputeFlavors[]|null
    */
    ...
    * Sets computeFlavors
    *
    * @param \HuaweiCloud\SDK\Ddm\V1\Model\ComputeFlavors[]|null $computeFlavors 计算类型规格详情。
    *
    * @return $this
    */
