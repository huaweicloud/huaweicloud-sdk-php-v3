...
class CheckPreliminaryResultsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CheckPreliminaryResultsRequest';
