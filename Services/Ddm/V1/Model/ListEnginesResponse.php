...
class ListEnginesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'engineGroups' => '\HuaweiCloud\SDK\Ddm\V1\Model\EngineGroupsInfo[]',
            'offset' => 'int',
            'limit' => 'int',
            'total' => 'int'
    ];
    ...
    *  引擎信息列表。
    *
    * @return \HuaweiCloud\SDK\Ddm\V1\Model\EngineGroupsInfo[]|null
    */
    ...
    * Sets engineGroups
    *
    * @param \HuaweiCloud\SDK\Ddm\V1\Model\EngineGroupsInfo[]|null $engineGroups 引擎信息列表。
    *
    * @return $this
    */
