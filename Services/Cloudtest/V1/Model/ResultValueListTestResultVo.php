...
class ResultValueListTestResultVo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResultValueListTestResultVo';
    ...
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'value' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\TestResultVo[]',
            'reason' => 'string',
            'pageSize' => 'int',
            'pageNo' => 'int',
            'hasMore' => 'bool'
    ...
    * Sets value
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\TestResultVo[]|null $value 实际的数据类型：单个对象，集合 或 NULL
    *
    * @return $this
    */
