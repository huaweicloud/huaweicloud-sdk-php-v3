...
class TmssStep implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TmssStep';
    ...
    * Sets expectResult
    *
    * @param string|null $expectResult 测试步骤
    *
    * @return $this
    */
    ...
    * Sets testStep
    *
    * @param string|null $testStep 预期结果对象
    *
    * @return $this
    */
