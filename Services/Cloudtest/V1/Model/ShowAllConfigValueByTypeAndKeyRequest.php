...
class ShowAllConfigValueByTypeAndKeyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAllConfigValueByTypeAndKeyRequest';
