...
class UpdateTestCaseCommentResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateTestCaseCommentResponse';
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'result' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\ResultValueTestCaseCommentVo',
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\ResultValueTestCaseCommentVo|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\ResultValueTestCaseCommentVo|null $result result
    *
    * @return $this
    */
