...
class ListTestCaseHistoriesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTestCaseHistoriesRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * projectId  项目ID，固定长度32位字符（字母和数字）。
    * testcaseId  用例ID，长度11-34位字符（字母和数字）。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'testcaseId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\ListTestCaseHistoriesRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\ListTestCaseHistoriesRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\ListTestCaseHistoriesRequestBody|null $body body
    *
    * @return $this
    */
