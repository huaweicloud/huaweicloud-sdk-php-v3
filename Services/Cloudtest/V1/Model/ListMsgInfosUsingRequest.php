...
class ListMsgInfosUsingRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListMsgInfosUsingRequest';
    ...
    */
    protected static $openAPITypes = [
            'serviceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\MsgInfoQuery'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\MsgInfoQuery|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\MsgInfoQuery|null $body body
    *
    * @return $this
    */
