...
class CreateTaskDefaultResultRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateTaskDefaultResultRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'taskUri' => 'string',
            'body' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\InitExecuteTaskInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\InitExecuteTaskInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\InitExecuteTaskInfo|null $body body
    *
    * @return $this
    */
