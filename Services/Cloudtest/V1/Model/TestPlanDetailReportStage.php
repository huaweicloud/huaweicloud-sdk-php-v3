...
class TestPlanDetailReportStage implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TestPlanDetail_report_stage';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * caseCompleteRate  用例完成率,按状态统计
    *
    * @var string[]
    */
    ...
    *
    * @param string|null $caseCompleteRate 用例完成率,按状态统计
    *
    * @return $this
    */
