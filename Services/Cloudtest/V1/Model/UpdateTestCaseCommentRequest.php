...
class UpdateTestCaseCommentRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateTestCaseCommentRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'testcaseId' => 'string',
            'commentId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\TestCaseCommentInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\TestCaseCommentInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\TestCaseCommentInfo|null $body body
    *
    * @return $this
    */
