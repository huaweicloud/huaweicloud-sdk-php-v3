...
class BatchDeleteTestCaseRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteTestCaseRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * serviceId  注册测试类型服务接口返回的服务id，取值范围为10-9999
    * testcaseIdList  测试用例唯一标识，数组长度小于50个
    *
    * @var string[]
    */
    ...
    * Sets testcaseIdList
    *
    * @param string[] $testcaseIdList 测试用例唯一标识，数组长度小于50个
    *
    * @return $this
    */
