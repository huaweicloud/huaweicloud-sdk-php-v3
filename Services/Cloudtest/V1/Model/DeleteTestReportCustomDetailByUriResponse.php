...
class DeleteTestReportCustomDetailByUriResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteTestReportCustomDetailByUriResponse';
