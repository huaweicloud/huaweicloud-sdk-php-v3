...
class BatchAddCaseResultInTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchAddCaseResultInTaskRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'versionUri' => 'string',
            'body' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\BatchAddTestCaseResultInTaskInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\BatchAddTestCaseResultInTaskInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\BatchAddTestCaseResultInTaskInfo|null $body body
    *
    * @return $this
    */
