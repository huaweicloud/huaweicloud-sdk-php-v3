...
class TaskInfoV4VoReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TaskInfoV4VoReq';
    ...
    */
    protected static $attributeMap = [
            ...
            'executeStrategies' => 'execute_strategies',
    ...
    * Sets alertConfig
    *
    * @param object|null $alertConfig 告警配置
    *
    * @return $this
    */
    ...
    * Sets envType
    *
    * @param int|null $envType 环境类型：0表示用例包环境，1表示全局环境
    *
    * @return $this
    */
    ...
    * Sets favorite
    *
    * @param string|null $favorite favorite
    *
    * @return $this
    */
    ...
    * Sets labelName
    *
    * @param string|null $labelName 资源池名称
    *
    * @return $this
    */
    ...
    * Sets labelType
    *
    * @param string|null $labelType 资源池类型
    *
    * @return $this
    */
    ...
    * Sets subtaskId
    *
    * @param string|null $subtaskId subtaskId
    *
    * @return $this
    */
