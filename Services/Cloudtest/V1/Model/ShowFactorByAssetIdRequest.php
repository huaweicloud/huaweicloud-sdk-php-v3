...
class ShowFactorByAssetIdRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowFactorByAssetIdRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'id' => 'string',
            'body' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\CommRequestListFactorParam'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\CommRequestListFactorParam|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\CommRequestListFactorParam|null $body body
    *
    * @return $this
    */
