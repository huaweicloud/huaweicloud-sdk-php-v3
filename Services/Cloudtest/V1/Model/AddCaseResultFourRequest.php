...
class AddCaseResultFourRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddCaseResultFourRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'versionUri' => 'string',
            'caseUri' => 'string',
            'body' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\AddTestCaseResultInfo'
    ];
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\AddTestCaseResultInfo|null $body body
    *
    * @return $this
    */
