...
class UpdateBasicAwByIdRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateBasicAwByIdRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'awId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\UpdateBasicAwReq'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['awId'] === null) {
            $invalidProperties[] = "'awId' can't be null";
        }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\UpdateBasicAwReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\UpdateBasicAwReq|null $body body
    *
    * @return $this
    */
