...
class AddOrUpdateTestsuiteInfoUsingResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddOrUpdateTestsuiteInfoUsingResponse';
    ...
    * Sets etTraceId
    *
    * @param string|null $etTraceId 对应traceId
    *
    * @return $this
    */
