...
class ExternalServiceCaseStep implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExternalServiceCaseStep';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * expectResult  测试用例预期结果信息，长度为[0-500]位字符
    * testStep  测试步骤描述信息，长度为[0-500]位字符
    *
    * @var string[]
    */
    ...
    * Sets expectResult
    *
    * @param string|null $expectResult 测试用例预期结果信息，长度为[0-500]位字符
    *
    * @return $this
    */
    ...
    * Sets testStep
    *
    * @param string|null $testStep 测试步骤描述信息，长度为[0-500]位字符
    *
    * @return $this
    */
