...
class ResultValueListCustomReportListVo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResultValueListCustomReportListVo';
    ...
    * Sets value
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\CustomReportListVo[]|null $value 实际的数据类型：单个对象，集合 或 NULL
    *
    * @return $this
    */
