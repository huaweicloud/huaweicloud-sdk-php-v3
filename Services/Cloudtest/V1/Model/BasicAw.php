...
class BasicAw implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BasicAw';
    ...
    */
    protected static $openAPITypes = [
            ...
            'awInsList' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\AwInstance[]',
            'awMark' => 'int',
            ...
            'createUser' => 'string',
            'createUserId' => 'string',
            'customAwLibs' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\UploadFile[]',
            'deleteTime' => 'string',
            'deleteUser' => 'string',
            'description' => 'string',
            ...
            'projectId' => 'string',
            'protocolType' => 'string',
            'publicAwLib' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\PublicAwLib',
    ...
    * Sets awInsList
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\AwInstance[]|null $awInsList 组合aw包含的aw实例信息，awType为2时该字段有效
    *
    * @return $this
    */
    ...
    *  aw库的文件列表
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\UploadFile[]|null
    */
    ...
    * Sets customAwLibs
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\UploadFile[]|null $customAwLibs aw库的文件列表
    *
    * @return $this
    */
    ...
    *  publicAwLib
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\PublicAwLib|null
    */
    ...
    * Sets publicAwLib
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\PublicAwLib|null $publicAwLib publicAwLib
    *
    * @return $this
    */
