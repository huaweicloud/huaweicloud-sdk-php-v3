...
class ShowStatisticByIdRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowStatisticByIdRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['mindmapId'] === null) {
            $invalidProperties[] = "'mindmapId' can't be null";
        }
            if (!preg_match("/^[A-Za-z0-9]{32}$/", $this->container['mindmapId'])) {
                $invalidProperties[] = "invalid value for 'mindmapId', must be conform to the pattern /^[A-Za-z0-9]{32}$/.";
            }
