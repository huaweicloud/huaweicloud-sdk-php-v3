...
class TemplateV2 implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TemplateV2';
    ...
    */
    protected static $setters = [
            ...
            'editPermission' => 'setEditPermission',
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['editPermission'] = isset($data['editPermission']) ? $data['editPermission'] : null;
    ...
    */
    ...
    {
        return $this->container['editPermission'];
    }

    /**
    * Sets editPermission
    *
    * @param bool|null $editPermission 编辑权限
    *
    * @return $this
    */
    public function setEditPermission($editPermission)
    {
        $this->container['editPermission'] = $editPermission;
        return $this;
    }
    ...
    *
    * @param bool|null $deletePermission 删除权限
    *
    * @return $this
    */
