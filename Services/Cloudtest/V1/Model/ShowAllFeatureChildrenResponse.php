...
class ShowAllFeatureChildrenResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAllFeatureChildrenResponse';
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'result' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\ResultValueListTestItemVo',
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\ResultValueListTestItemVo|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\ResultValueListTestItemVo|null $result result
    *
    * @return $this
    */
