...
class TestCaseTimeoutPolicy implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TestCaseTimeoutPolicy';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * timeoutTimes  用例超时多少次告警
    *
    * @var string[]
    */
    ...
    * Sets timeoutTimes
    *
    * @param int|null $timeoutTimes 用例超时多少次告警
    *
    * @return $this
    */
