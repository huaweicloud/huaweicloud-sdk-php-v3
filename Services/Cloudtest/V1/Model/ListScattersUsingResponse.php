...
class ListScattersUsingResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListScattersUsingResponse';
    ...
    */
    protected static $openAPITypes = [
            'list' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\TaskCaseResponseTimeDetailVo[]',
            'pageNum' => 'int',
            'pageSize' => 'int',
            'totalPage' => 'int',
            'totalSize' => 'int'
    ...
    *  返回结果
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\TaskCaseResponseTimeDetailVo[]|null
    */
    ...
    * Sets list
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\TaskCaseResponseTimeDetailVo[]|null $list 返回结果
    *
    * @return $this
    */
