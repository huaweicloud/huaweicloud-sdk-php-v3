...
class CreateReportRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'versionId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\OprReportInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\OprReportInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\OprReportInfo|null $body body
    *
    * @return $this
    */
