...
class ShowConcurrencyPackageUsingRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowConcurrencyPackageUsingRequest';
    ...
    * Sets testType
    *
    * @param string|null $testType test_type
    *
    * @return $this
    */
