...
class ShowIteratorDetailResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowIteratorDetailResponse';
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'result' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\ResultValueIteratorVersionSummaryVo',
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\ResultValueIteratorVersionSummaryVo|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\ResultValueIteratorVersionSummaryVo|null $result result
    *
    * @return $this
    */
