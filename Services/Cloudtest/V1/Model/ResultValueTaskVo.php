...
class ResultValueTaskVo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResultValueTaskVo';
    ...
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'value' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\TaskVo',
            'reason' => 'string',
            'pageSize' => 'int',
            'pageNo' => 'int',
            'hasMore' => 'bool'
    ...
    * Sets value
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\TaskVo|null $value value
    *
    * @return $this
    */
