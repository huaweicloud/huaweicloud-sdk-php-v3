...
class CaseOperationVo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CaseOperationVo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * testCasesInfo  用例关联信息
    * setUpCasesInfo  前置用例关联信息
    * tearDownCasesInfo  后置用例关联信息
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'testCasesInfo' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\TaskAssignCaseVo[]',
            'setUpCasesInfo' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\TaskAssignCaseVo[]',
            'tearDownCasesInfo' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\TaskAssignCaseVo[]'
    ];
    ...
    */
    protected static $attributeMap = [
            'testCasesInfo' => 'test_cases_info',
            'setUpCasesInfo' => 'set_up_cases_info',
            'tearDownCasesInfo' => 'tear_down_cases_info'
    ];
    ...
    *  用例关联信息
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\TaskAssignCaseVo[]|null
    */
    ...
    * Sets testCasesInfo
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\TaskAssignCaseVo[]|null $testCasesInfo 用例关联信息
    *
    * @return $this
    */
    ...
    * Sets setUpCasesInfo
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\TaskAssignCaseVo[]|null $setUpCasesInfo 前置用例关联信息
    *
    * @return $this
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\TaskAssignCaseVo[]|null $tearDownCasesInfo 后置用例关联信息
    *
    * @return $this
    */
