...
class TaskBasicInfoVo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TaskBasicInfoVo';
    ...
    * Sets errorReason
    *
    * @param string|null $errorReason 任务状态
    *
    * @return $this
    */
