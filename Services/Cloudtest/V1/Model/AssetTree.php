...
class AssetTree implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssetTree';
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['factorCnt'] = isset($data['factorCnt']) ? $data['factorCnt'] : null;
    }
    ...
    * @return int|null
    */
    public function getFactorCnt()
    {
        return $this->container['factorCnt'];
    }

    /**
    * Sets factorCnt
    *
    * @param int|null $factorCnt factorCnt
    *
    * @return $this
    */
    public function setFactorCnt($factorCnt)
    {
        $this->container['factorCnt'] = $factorCnt;
        return $this;
    }
