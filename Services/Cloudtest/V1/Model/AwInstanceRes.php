...
class AwInstanceRes implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AwInstanceRes';
    ...
    * level  用例级别
    * name  名称
    * paramDependent  参数依赖规则
    * paramDependentEnabled  是否启用参数依赖
    * paramTypeAndValue  参数类型和参数值对应List
    * projectId  awinstance所在的用例\\逻辑用例\\组合aw所属项目,该字段是新增字段,因此部分awinstance是无值的,所以只可写该值,而不能读取该值
    * region  区域名称
    * relation  awId层级关系
    ...
    */
    protected static $openAPITypes = [
            ...
            'awId' => 'string',
            'awType' => 'int',
            'basicAw' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\BasicAwRes',
            'bodyParamType' => 'string',
            'byOrder' => 'int',
            'changeSign' => 'int',
            'checkPointList' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\CheckPoint[]',
            'children' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\AwInstanceRes[]',
    ...
    * Sets basicAw
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\BasicAwRes|null $basicAw basicAw
    *
    * @return $this
    */
    ...
    * Sets children
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\AwInstanceRes[]|null $children aw实例
    *
    * @return $this
    */
    ...
    * Sets paramDependent
    *
    * @param string|null $paramDependent 参数依赖规则
    *
    * @return $this
    */
    ...
    * Sets projectId
    *
    * @param string|null $projectId awinstance所在的用例\\逻辑用例\\组合aw所属项目,该字段是新增字段,因此部分awinstance是无值的,所以只可写该值,而不能读取该值
    *
    * @return $this
    */
    ...
    * Sets variableList
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\AwVariable[]|null $variableList 定义的变量信息
    *
    * @return $this
    */
