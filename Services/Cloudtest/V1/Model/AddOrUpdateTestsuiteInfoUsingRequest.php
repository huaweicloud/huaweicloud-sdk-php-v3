...
class AddOrUpdateTestsuiteInfoUsingRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddOrUpdateTestsuiteInfoUsingRequest';
