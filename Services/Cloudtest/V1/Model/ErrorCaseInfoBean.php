...
class ErrorCaseInfoBean implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ErrorCaseInfoBean';
    ...
    * Sets errorMsg
    *
    * @param string|null $errorMsg 失败错误信息
    *
    * @return $this
    */
    ...
    * Sets testcaseId
    *
    * @param string|null $testcaseId 失败资源信息
    *
    * @return $this
    */
