...
class ListTestcasePlansRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTestcasePlansRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectUuid' => 'string',
            'branchUri' => 'string',
            'body' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\TestcasePlanQueryParam'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['branchUri'] === null) {
            $invalidProperties[] = "'branchUri' can't be null";
        }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\TestcasePlanQueryParam|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\TestcasePlanQueryParam|null $body body
    *
    * @return $this
    */
