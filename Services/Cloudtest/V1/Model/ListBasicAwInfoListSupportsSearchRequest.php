...
class ListBasicAwInfoListSupportsSearchRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListBasicAwInfoListSupportsSearchRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'pageSize' => 'string',
            'parentId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\SearchRequest'
    ];
    ...
    * Sets parentId
    *
    * @param string|null $parentId 父目录ID
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\SearchRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\SearchRequest|null $body body
    *
    * @return $this
    */
