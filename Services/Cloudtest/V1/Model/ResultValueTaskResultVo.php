...
class ResultValueTaskResultVo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResultValueTaskResultVo';
    ...
    * Sets value
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\TaskResultVo|null $value value
    *
    * @return $this
    */
