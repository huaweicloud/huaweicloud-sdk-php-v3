...
class ListUserPackageUsageResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListUserPackageUsageResponse';
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'result' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\PackageUsage[]',
    ...
    * Sets status
    *
    * @param string|null $status 是否请求成功
    *
    * @return $this
    */
    ...
    *  套餐用量信息列表
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\PackageUsage[]|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\PackageUsage[]|null $result 套餐用量信息列表
    *
    * @return $this
    */
