...
class ListScattersUsingRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListScattersUsingRequest';
    ...
    */
    protected static $openAPITypes = [
            'serviceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\DashboardDataQuery'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\DashboardDataQuery|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\DashboardDataQuery|null $body body
    *
    * @return $this
    */
