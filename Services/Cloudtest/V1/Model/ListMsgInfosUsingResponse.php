...
class ListMsgInfosUsingResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListMsgInfosUsingResponse';
    ...
    */
    protected static $openAPITypes = [
            'list' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\MsgInfoVo[]',
            'pageNum' => 'int',
            'pageSize' => 'int',
            'totalPage' => 'int',
            'totalSize' => 'int'
    ...
    *  返回结果
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\MsgInfoVo[]|null
    */
    ...
    * Sets list
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\MsgInfoVo[]|null $list 返回结果
    *
    * @return $this
    */
