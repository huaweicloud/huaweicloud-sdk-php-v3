...
class ShowOperationalDataCurrentMonthUsingRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowOperationalDataCurrentMonthUsingRequest';
