...
class CreateTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'projectUuid' => 'string',
            'body' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\TaskInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\TaskInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\TaskInfo|null $body body
    *
    * @return $this
    */
