...
class BasePageInfoMindmapBackup implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BasePageInfoMindmapBackup';
    ...
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'list' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\MindmapBackup[]',
            'limit' => 'int',
            'offset' => 'int',
            'pages' => 'int',
            'size' => 'int'
    ...
    *  入参集合
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\MindmapBackup[]|null
    */
    ...
    * Sets list
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\MindmapBackup[]|null $list 入参集合
    *
    * @return $this
    */
