...
class ListTestCasesByIssueRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTestCasesByIssueRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'issueId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\QueryTestCasesByIssueInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\QueryTestCasesByIssueInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\QueryTestCasesByIssueInfo|null $body body
    *
    * @return $this
    */
