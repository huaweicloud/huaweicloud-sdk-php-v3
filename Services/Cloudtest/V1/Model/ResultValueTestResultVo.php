...
class ResultValueTestResultVo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResultValueTestResultVo';
    ...
    * Sets value
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\TestResultVo|null $value value
    *
    * @return $this
    */
