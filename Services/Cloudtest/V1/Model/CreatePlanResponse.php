...
class CreatePlanResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePlanResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * planId  接口调用成功返回的计划id
    ...
    * Sets planId
    *
    * @param string|null $planId 接口调用成功返回的计划id
    *
    * @return $this
    */
