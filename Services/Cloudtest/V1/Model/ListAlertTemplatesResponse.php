...
class ListAlertTemplatesResponse implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAlertTemplatesResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'isFirstPage' => 'bool',
            'isLastPage' => 'bool',
            'list' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\AlertTemplateVo[]',
    ...
    *  返回结果
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\AlertTemplateVo[]|null
    */
    ...
    * Sets list
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\AlertTemplateVo[]|null $list 返回结果
    *
    * @return $this
    */
