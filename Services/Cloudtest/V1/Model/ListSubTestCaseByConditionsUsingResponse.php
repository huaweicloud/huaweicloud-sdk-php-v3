...
class ListSubTestCaseByConditionsUsingResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSubTestCaseByConditionsUsingResponse';
