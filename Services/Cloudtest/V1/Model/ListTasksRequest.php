...
class ListTasksRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'versionId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\TasksQueryInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\TasksQueryInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\TasksQueryInfo|null $body body
    *
    * @return $this
    */
