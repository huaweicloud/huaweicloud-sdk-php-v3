...
class PublicAwLibRes implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PublicAwLibRes';
    ...
    * Sets documentLink
    *
    * @param string|null $documentLink 关联公共aw时的编辑链接
    *
    * @return $this
    */
