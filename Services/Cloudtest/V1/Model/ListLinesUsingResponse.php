...
class ListLinesUsingResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListLinesUsingResponse';
    ...
    */
    protected static $openAPITypes = [
            'list' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\SubTaskCaseSuccessLineVo[]',
            'pageNum' => 'int',
            'pageSize' => 'int',
            'totalPage' => 'int',
            'totalSize' => 'int'
    ...
    *  返回结果
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\SubTaskCaseSuccessLineVo[]|null
    */
    ...
    * Sets list
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\SubTaskCaseSuccessLineVo[]|null $list 返回结果
    *
    * @return $this
    */
