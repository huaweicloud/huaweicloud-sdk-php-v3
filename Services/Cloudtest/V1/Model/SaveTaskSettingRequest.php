...
class SaveTaskSettingRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SaveTaskSettingRequest';
    ...
    */
    protected static $openAPITypes = [
            'serviceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\SaveTaskSettingRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\SaveTaskSettingRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\SaveTaskSettingRequestBody|null $body body
    *
    * @return $this
    */
