...
class UpdateTestCaseRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateTestCaseRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * projectId  项目唯一标识，固定长度32位字符
    * testcaseId  测试用例唯一标识，固定长度32位字符
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'testcaseId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\UpdateTestCaseRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\UpdateTestCaseRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\UpdateTestCaseRequestBody|null $body body
    *
    * @return $this
    */
