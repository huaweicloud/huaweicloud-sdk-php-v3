...
class TestCaseTemplateVo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TestCaseTemplateVo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * alertTemplateId  用例对应的告警模板id
    * testcaseId  测试用例id
    *
    * @var string[]
    */
    ...
    *
    * @param string|null $alertTemplateId 用例对应的告警模板id
    *
    * @return $this
    */
