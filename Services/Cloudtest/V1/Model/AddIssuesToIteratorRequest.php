...
class AddIssuesToIteratorRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddIssuesToIteratorRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectUuid' => 'string',
            'iteratorUri' => 'string',
            'body' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\IssuesInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\IssuesInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\IssuesInfo|null $body body
    *
    * @return $this
    */
