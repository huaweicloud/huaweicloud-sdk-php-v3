...
class UpdateTestReportCustomDetailByUriResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateTestReportCustomDetailByUriResponse';
