...
class ResultValueTestCaseVo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResultValueTestCaseVo';
    ...
    * Sets value
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\TestCaseVo|null $value value
    *
    * @return $this
    */
