...
class ListAlarmStatisticsUsingRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAlarmStatisticsUsingRequest';
    ...
    */
    protected static $openAPITypes = [
            'serviceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\AlarmStatisticsQuery'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\AlarmStatisticsQuery|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\AlarmStatisticsQuery|null $body body
    *
    * @return $this
    */
