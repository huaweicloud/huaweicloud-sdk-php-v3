...
class UploadStepImgResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UploadStepImgResponse';
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'result' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\ResultValueStepImageVo',
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\ResultValueStepImageVo|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\ResultValueStepImageVo|null $result result
    *
    * @return $this
    */
