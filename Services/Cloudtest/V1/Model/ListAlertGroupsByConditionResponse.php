...
class ListAlertGroupsByConditionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAlertGroupsByConditionResponse';
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['errorCode']) && (mb_strlen($this->container['errorCode']) > 50)) {
                $invalidProperties[] = "invalid value for 'errorCode', the character length must be smaller than or equal to 50.";
            }
    ...
    * Sets errorMsg
    *
    * @param string|null $errorMsg 错误原因
    *
    * @return $this
    */
