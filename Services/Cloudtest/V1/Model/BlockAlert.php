...
class BlockAlert implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BlockAlert';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * alertTemplate  alertTemplate
    * enable  阻塞告警开启 0关闭 1开启
    * waitingCount  等待队列大于多少个开始阻塞
    *
    * @var string[]
    */
    ...
    * Sets enable
    *
    * @param string|null $enable 阻塞告警开启 0关闭 1开启
    *
    * @return $this
    */
    ...
    * Sets waitingCount
    *
    * @param int|null $waitingCount 等待队列大于多少个开始阻塞
    *
    * @return $this
    */
