...
class ShowTestCasesChangeStatisticsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowTestCasesChangeStatisticsRequest';
