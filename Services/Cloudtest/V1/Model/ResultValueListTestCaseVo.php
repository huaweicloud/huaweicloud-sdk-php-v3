...
class ResultValueListTestCaseVo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResultValueListTestCaseVo';
    ...
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'value' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\TestCaseVo[]',
            'reason' => 'string',
            'pageSize' => 'int',
            'pageNo' => 'int',
            'hasMore' => 'bool'
    ...
    * Sets value
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\TestCaseVo[]|null $value 实际的数据类型：单个对象，集合 或 NULL
    *
    * @return $this
    */
