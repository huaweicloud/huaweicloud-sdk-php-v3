...
class ImportAssetRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImportAssetRequestBody';
    ...
    * Sets excelFile
    *
    * @param \SplFileObject $excelFile 导入文件
    *
    * @return $this
    */
