...
class AddTestCaseResultLogRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddTestCaseResultLogRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'versionUri' => 'string',
            'caseUri' => 'string',
            'body' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\AddTestCaseResultLogInfo'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['caseUri'] === null) {
            $invalidProperties[] = "'caseUri' can't be null";
        }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\AddTestCaseResultLogInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\AddTestCaseResultLogInfo|null $body body
    *
    * @return $this
    */
