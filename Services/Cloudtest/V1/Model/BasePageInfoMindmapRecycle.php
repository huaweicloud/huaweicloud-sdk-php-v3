...
class BasePageInfoMindmapRecycle implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BasePageInfoMindmapRecycle';
    ...
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'list' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\MindmapRecycle[]',
            'limit' => 'int',
            'offset' => 'int',
            'pages' => 'int',
            'size' => 'int'
    ...
    *  入参集合
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\MindmapRecycle[]|null
    */
    ...
    * Sets list
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\MindmapRecycle[]|null $list 入参集合
    *
    * @return $this
    */
