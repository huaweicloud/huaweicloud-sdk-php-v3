...
class UpdateTestCaseResultRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateTestCaseResultRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * serviceId  注册测试类型服务接口返回的服务id
    * planId  测试计划id
    * executeList  测试用例状态信息，数组长度小于等于50
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'serviceId' => 'int',
            'planId' => 'string',
            'executeList' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\UpdateTestCaseResultBean[]'
    ];
    ...
    *  测试用例状态信息，数组长度小于等于50
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\UpdateTestCaseResultBean[]
    */
    ...
    * Sets executeList
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\UpdateTestCaseResultBean[] $executeList 测试用例状态信息，数组长度小于等于50
    *
    * @return $this
    */
