...
class CaseOperationInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CaseOperationInfo';
    ...
    */
    protected static $openAPITypes = [
            'testCasesInfo' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\AssignCaseInfo[]',
            'setUpCasesInfo' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\AssignCaseInfo[]',
            'tearDownCasesInfo' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\AssignCaseInfo[]'
    ];
    ...
    *  用例关联信息
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\AssignCaseInfo[]|null
    */
    ...
    * Sets testCasesInfo
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\AssignCaseInfo[]|null $testCasesInfo 用例关联信息
    *
    * @return $this
    */
    ...
    * Sets setUpCasesInfo
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\AssignCaseInfo[]|null $setUpCasesInfo 前置用例关联信息
    *
    * @return $this
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\AssignCaseInfo[]|null $tearDownCasesInfo 后置用例关联信息
    *
    * @return $this
    */
