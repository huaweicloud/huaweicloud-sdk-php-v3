...
class ListCasesStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCasesStatusRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * testServiceId  projectUUId
    * body  body
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['testServiceId'] === null) {
            $invalidProperties[] = "'testServiceId' can't be null";
        }
