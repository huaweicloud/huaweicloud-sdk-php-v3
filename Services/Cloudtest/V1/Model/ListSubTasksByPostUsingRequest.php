...
class ListSubTasksByPostUsingRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSubTasksByPostUsingRequest';
    ...
    */
    protected static $openAPITypes = [
            'serviceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\SubTaskQueryByPageParams'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\SubTaskQueryByPageParams|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\SubTaskQueryByPageParams|null $body body
    *
    * @return $this
    */
