...
class AttributeChange implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AttributeChange';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * newValue  变更后的取值
    * oldValue  变更前的取值
    * attributeType  发生变更的测试计划属性
    *
    * @var string[]
    */
    ...
    * Sets newValue
    *
    * @param string|null $newValue 变更后的取值
    *
    * @return $this
    */
    ...
    * Sets oldValue
    *
    * @param string|null $oldValue 变更前的取值
    *
    * @return $this
    */
    ...
    * Sets attributeType
    *
    * @param string|null $attributeType 发生变更的测试计划属性
    *
    * @return $this
    */
