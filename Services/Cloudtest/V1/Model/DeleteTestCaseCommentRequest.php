...
class DeleteTestCaseCommentRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteTestCaseCommentRequest';
    ...
    * Sets versionUri
    *
    * @param string|null $versionUri 分支或者测试计划uri
    *
    * @return $this
    */
