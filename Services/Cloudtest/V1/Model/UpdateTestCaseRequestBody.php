...
class UpdateTestCaseRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateTestCaseRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  页面上显示的用例名称，长度为[3-128]位字符
    * serviceId  注册测试类型服务接口返回的服务id，取值范围为10-9999
    ...
    */
    protected static $openAPITypes = [
            ...
            'extendInfo' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\ExternalServiceBizCase'
    ];
    ...
    * Sets serviceId
    *
    * @param int $serviceId 注册测试类型服务接口返回的服务id，取值范围为10-9999
    *
    * @return $this
    */
    ...
    *  extendInfo
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\ExternalServiceBizCase|null
    */
    ...
    * Sets extendInfo
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\ExternalServiceBizCase|null $extendInfo extendInfo
    *
    * @return $this
    */
