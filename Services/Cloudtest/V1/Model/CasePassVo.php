...
class CasePassVo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CasePassVo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * passRate  需求关联用例通过率
    * resultNumberList  需求关联用例结果与对应的用例数目列表
    *
    * @var string[]
    */
    ...
    * Sets passRate
    *
    * @param string|null $passRate 需求关联用例通过率
    *
    * @return $this
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\NameAndValueVo[]|null $resultNumberList 需求关联用例结果与对应的用例数目列表
    *
    * @return $this
    */
