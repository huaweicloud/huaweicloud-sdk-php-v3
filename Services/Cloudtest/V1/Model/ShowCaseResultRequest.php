...
class ShowCaseResultRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowCaseResultRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'versionUri' => 'string',
            'caseUri' => 'string',
            'body' => '\HuaweiCloud\SDK\Cloudtest\V1\Model\QueryCaseResultInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cloudtest\V1\Model\QueryCaseResultInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cloudtest\V1\Model\QueryCaseResultInfo|null $body body
    *
    * @return $this
    */
