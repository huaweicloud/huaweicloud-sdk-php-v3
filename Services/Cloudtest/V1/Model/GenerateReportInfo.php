...
class GenerateReportInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GenerateReportInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  报表名称
    * workpieceType  工件类型(用例：case,测试套：suite)
    * analysisDimRow  分析维度。该参数选择横坐标（X轴）维度，不传会返回空列表。
    ...
    * Sets analysisDimRow
    *
    * @param string|null $analysisDimRow 分析维度。该参数选择横坐标（X轴）维度，不传会返回空列表。
    *
    * @return $this
    */
