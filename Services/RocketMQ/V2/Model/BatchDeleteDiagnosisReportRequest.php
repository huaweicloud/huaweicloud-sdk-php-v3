...
class BatchDeleteDiagnosisReportRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteDiagnosisReportRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * engine  **参数解释**： 引擎。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    ...
    */
    protected static $openAPITypes = [
            'engine' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\RocketMQ\V2\Model\BatchDeleteDiagnosisReportReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\RocketMQ\V2\Model\BatchDeleteDiagnosisReportReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\RocketMQ\V2\Model\BatchDeleteDiagnosisReportReq|null $body body
    *
    * @return $this
    */
