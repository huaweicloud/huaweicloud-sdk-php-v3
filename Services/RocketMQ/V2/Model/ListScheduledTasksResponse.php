...
class ListScheduledTasksResponse implements ModelInterface, ArrayAccess
{
    ...
    * jobCount  **参数解释**： 任务总数。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    * jobs  **参数解释**： 任务列表。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @var string[]
    */
    ...
    *
    * @return \HuaweiCloud\SDK\RocketMQ\V2\Model\ScheduledTaskEntity[]|null
    */
    ...
    * Sets jobs
    *
    * @param \HuaweiCloud\SDK\RocketMQ\V2\Model\ScheduledTaskEntity[]|null $jobs **参数解释**： 任务列表。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
