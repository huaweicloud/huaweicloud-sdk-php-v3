...
class ListRocketInstanceTopicsResponse implements ModelInterface, ArrayAccess
{
    ...
    * max  **参数解释**： 最大可创建Topic数量。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    * remaining  **参数解释**： 剩余可创建Topic数量。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    * nextOffset  **参数解释**： 下个分页的offset。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    * previousOffset  **参数解释**： 上个分页的offset。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    * topics  **参数解释**： 剩余可创建Topic数量。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets max
    *
    * @param int|null $max **参数解释**： 最大可创建Topic数量。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets remaining
    *
    * @param int|null $remaining **参数解释**： 剩余可创建Topic数量。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets topics
    *
    * @param \HuaweiCloud\SDK\RocketMQ\V2\Model\Topic[]|null $topics **参数解释**： 剩余可创建Topic数量。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
