...
class ShowDiagnosisReportForRocketMqRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDiagnosisReportForRocketMqRequest';
