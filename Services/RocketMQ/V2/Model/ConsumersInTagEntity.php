...
class ConsumersInTagEntity implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ConsumersInTagEntity';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * consumers  **参数解释**： 消费者列表。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    * tagName  **参数解释**： 标签名。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets consumers
    *
    * @param string[]|null $consumers **参数解释**： 消费者列表。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets tagName
    *
    * @param string|null $tagName **参数解释**： 标签名。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
