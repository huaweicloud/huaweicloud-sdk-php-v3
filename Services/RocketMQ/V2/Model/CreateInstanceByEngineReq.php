...
class CreateInstanceByEngineReq implements ModelInterface, ArrayAccess
{
    ...
    */
    ...
    const PRODUCT_ID_C6_4U8G_CLUSTER_SMALL = 'c6.4u8g.cluster.small';
    ...
    */
    ...
    {
        return [
            self::PRODUCT_ID_C6_4U8G_CLUSTER_SMALL,
    ...
    * Sets productId
    *
    * @param string $productId RocketMQ实例规格。   - c6.4u8g.cluster.small：单个代理最大Topic数2000，单个代理最大消费组数2000   - c6.4u8g.cluster：单个代理最大Topic数4000，单个代理最大消费组数4000   - c6.8u16g.cluster：单个代理最大Topic数8000，单个代理最大消费组数8000   - c6.12u24g.cluster：单个代理最大Topic数12000，单个代理最大消费组数12000   - c6.16u32g.cluster：单个代理最大Topic数16000，单个代理最大消费组数16000
    *
    * @return $this
    */
