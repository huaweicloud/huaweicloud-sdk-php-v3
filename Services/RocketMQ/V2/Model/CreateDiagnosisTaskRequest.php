...
class CreateDiagnosisTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'engine' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\RocketMQ\V2\Model\DiagnosisRep'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\RocketMQ\V2\Model\DiagnosisRep|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\RocketMQ\V2\Model\DiagnosisRep|null $body body
    *
    * @return $this
    */
