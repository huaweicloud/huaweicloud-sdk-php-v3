...
class ShowRocketMqScalePreCheckInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowRocketMqScalePreCheckInfoRequest';
