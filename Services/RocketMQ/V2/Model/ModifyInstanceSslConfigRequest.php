...
class ModifyInstanceSslConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ModifyInstanceSslConfigRequest';
    ...
    */
    protected static $openAPITypes = [
            'engine' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\RocketMQ\V2\Model\PlainSSLSwitchRep'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\RocketMQ\V2\Model\PlainSSLSwitchRep|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\RocketMQ\V2\Model\PlainSSLSwitchRep|null $body body
    *
    * @return $this
    */
