...
class UpdateVolumeExpansionConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\RocketMQ\V2\Model\AlterAutoVolumeExpandConfig'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\RocketMQ\V2\Model\AlterAutoVolumeExpandConfig|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\RocketMQ\V2\Model\AlterAutoVolumeExpandConfig|null $body body
    *
    * @return $this
    */
