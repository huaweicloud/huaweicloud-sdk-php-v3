...
class BatchDeleteDiagnosisRecordsForRocketMqResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteDiagnosisRecordsForRocketMqResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * reportIdList  **参数解释**： 诊断报告ID列表。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets reportIdList
    *
    * @param string[]|null $reportIdList **参数解释**： 诊断报告ID列表。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
