...
class UserResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UserResp';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * accessKey  **参数解释**： 用户名。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    * secretKey  **参数解释**： 密钥。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    ...
    */
    protected static $openAPITypes = [
            ...
            'groupPerms' => '\HuaweiCloud\SDK\RocketMQ\V2\Model\UserRespGroupPerms[]'
    ];
    ...
    * Sets secretKey
    *
    * @param string|null $secretKey **参数解释**： 密钥。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\RocketMQ\V2\Model\UserRespGroupPerms[]|null
    */
    ...
    * Sets groupPerms
    *
    * @param \HuaweiCloud\SDK\RocketMQ\V2\Model\UserRespGroupPerms[]|null $groupPerms **参数解释**： 特殊的消费组权限。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
