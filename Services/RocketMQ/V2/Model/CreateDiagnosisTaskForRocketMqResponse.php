...
class CreateDiagnosisTaskForRocketMqResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateDiagnosisTaskForRocketMqResponse';
