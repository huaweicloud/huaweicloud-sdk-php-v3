...
class ProductEntityProperties implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ProductEntity_properties';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * maxTopic  **参数解释**： 最大topic数。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    * brokerNum  **参数解释**： broker数量。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    * core  **参数解释**： 整个实例的计费核数。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    * maxConsumer  **参数解释**： 实例消费者的最大数。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    * rcu  **参数解释**： 流量单元，rcu * max_tpc_per_rcu = 规格最大TPS。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    * maxStorage  **参数解释**： 最大存储空间，单位为GB。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    ...
    * maxBroker  **参数解释**： Broker的最大个数。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    * maxTopicPerBroker  **参数解释**： 每个节点最多能创建的Topic个数。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    * maxConsumerPerBroker  **参数解释**： 每个节点的最大消费者数。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    * minBroker  **参数解释**： Broker的最小个数。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets maxTopic
    *
    * @param string|null $maxTopic **参数解释**： 最大topic数。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets brokerNum
    *
    * @param string|null $brokerNum **参数解释**： broker数量。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets core
    *
    * @param string|null $core **参数解释**： 整个实例的计费核数。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets maxConsumer
    *
    * @param string|null $maxConsumer **参数解释**： 实例消费者的最大数。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets rcu
    *
    * @param string|null $rcu **参数解释**： 流量单元，rcu * max_tpc_per_rcu = 规格最大TPS。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets maxStorage
    *
    * @param string|null $maxStorage **参数解释**： 最大存储空间，单位为GB。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets maxTpsPerRcu
    *
    * @param string|null $maxTpsPerRcu **参数解释**： 单个rcu最大TPS。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets engineVersions
    *
    * @param string|null $engineVersions **参数解释**： 消息引擎版本。  **约束限制**： 不涉及。  **取值范围**： [- 4.8.0](tag:hws,hws_eu,hws_hk,ocb,hws_ocb,ctc,g42,hk_g42,tm,sbc,hk_sbc,hk_tm,cmcc,ax,srg) [- 5.x](tag:hws,hws_eu,hws_hk,ctc,g42,hk_g42,tm,sbc,hk_sbc,hk_tm,dt,srg) **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets minStorage
    *
    * @param string|null $minStorage **参数解释**： 最小存储空间，单位为GB。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets maxBroker
    *
    * @param string|null $maxBroker **参数解释**： Broker的最大个数。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    *
    * @param string|null $maxTopicPerBroker **参数解释**： 每个节点最多能创建的Topic个数。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    *
    * @param string|null $maxConsumerPerBroker **参数解释**： 每个节点的最大消费者数。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets minBroker
    *
    * @param string|null $minBroker **参数解释**： Broker的最小个数。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
