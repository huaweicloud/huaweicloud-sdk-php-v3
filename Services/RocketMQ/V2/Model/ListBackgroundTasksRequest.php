...
class ListBackgroundTasksRequest implements ModelInterface, ArrayAccess
{
    ...
    * Sets beginTime
    *
    * @param string|null $beginTime **参数解释**： 查询任务的最小时间，格式为YYYYMMDDHHmmss。 **约束限制**： 不涉及。 **取值范围**： 大于等于0。 **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets endTime
    *
    * @param string|null $endTime **参数解释**： 查询任务的最大时间，格式为YYYYMMDDHHmmss。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
