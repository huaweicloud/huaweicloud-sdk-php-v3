...
class ShowVolumeExpandConfigResponse implements ModelInterface, ArrayAccess
{
    ...
    * autoVolumeExpandEnable  **参数解释**： 是否开启磁盘自动扩容。 **约束限制**： 不涉及。 **取值范围**： - true：开启。 - false：关闭。 **默认取值**： 不涉及。
    * expandThreshold  **参数解释**： 触发磁盘自动扩容的阈值。 **约束限制**： 不涉及。 **取值范围**： 20%-80%。 **默认取值**： 不涉及。
    * maxVolumeSize  **参数解释**： 磁盘自动扩容的上限值。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    ...
    *
    * @param bool|null $autoVolumeExpandEnable **参数解释**： 是否开启磁盘自动扩容。 **约束限制**： 不涉及。 **取值范围**： - true：开启。 - false：关闭。 **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets maxVolumeSize
    *
    * @param int|null $maxVolumeSize **参数解释**： 磁盘自动扩容的上限值。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
