...
class ShowCeshierarchyRespGroups implements ModelInterface, ArrayAccess
{
    ...
    * topics  **参数解释**： 订阅Topic信息。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets topics
    *
    * @param \HuaweiCloud\SDK\RocketMQ\V2\Model\ShowCeshierarchyRespTopics[]|null $topics **参数解释**： 订阅Topic信息。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
