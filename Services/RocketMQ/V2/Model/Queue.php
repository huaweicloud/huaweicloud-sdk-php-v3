...
class Queue implements ModelInterface, ArrayAccess
{
    ...
    * id  **参数解释**： 队列ID。 **取值范围**： 不涉及。
    * lag  **参数解释**： 队列消费堆积总数。 **取值范围**： 不涉及。
    * brokerOffset  **参数解释**： 队列消息总数。 **取值范围**： 不涉及。
    * consumerOffset  **参数解释**： 已消费消息数。 **取值范围**： 不涉及。
    * lastMessageTime  **参数解释**： 最新消费消息的存储时间，Unix毫秒时间戳格式。 **取值范围**： 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets id
    *
    * @param int|null $id **参数解释**： 队列ID。 **取值范围**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets lag
    *
    * @param int|null $lag **参数解释**： 队列消费堆积总数。 **取值范围**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets brokerOffset
    *
    * @param int|null $brokerOffset **参数解释**： 队列消息总数。 **取值范围**： 不涉及。
    *
    * @return $this
    */
    ...
    *
    * @param int|null $lastMessageTime **参数解释**： 最新消费消息的存储时间，Unix毫秒时间戳格式。 **取值范围**： 不涉及。
    *
    * @return $this
    */
