...
class ShowCeshierarchyRespChildren implements ModelInterface, ArrayAccess
{
    ...
    * name  **参数解释**： 子维度名称。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    * metrics  **参数解释**： 监控指标名称列表。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    ...
    * Sets name
    *
    * @param string|null $name **参数解释**： 子维度名称。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets metrics
    *
    * @param string[]|null $metrics **参数解释**： 监控指标名称列表。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
