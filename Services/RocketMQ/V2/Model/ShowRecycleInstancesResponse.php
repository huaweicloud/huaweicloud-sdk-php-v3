...
class ShowRecycleInstancesResponse implements ModelInterface, ArrayAccess
{
    ...
    * recycleInstances  **参数解释**： 回收实例列表。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'recycleInstances' => '\HuaweiCloud\SDK\RocketMQ\V2\Model\InstanceRecycleInfo[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\RocketMQ\V2\Model\InstanceRecycleInfo[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\RocketMQ\V2\Model\InstanceRecycleInfo[]|null $recycleInstances **参数解释**： 回收实例列表。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
