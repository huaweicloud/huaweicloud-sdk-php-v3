...
class RestartInstanceResponse implements ModelInterface, ArrayAccess
{
    ...
    * nodes  **参数解释**： node列表 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    ...
    * Sets nodes
    *
    * @param string[]|null $nodes **参数解释**： node列表 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets result
    *
    * @param string|null $result **参数解释**： 结果。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
