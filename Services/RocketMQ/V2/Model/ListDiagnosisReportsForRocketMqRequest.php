...
class ListDiagnosisReportsForRocketMqRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDiagnosisReportsForRocketMqRequest';
