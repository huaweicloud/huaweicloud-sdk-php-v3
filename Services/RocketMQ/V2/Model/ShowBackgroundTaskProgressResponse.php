...
class ShowBackgroundTaskProgressResponse implements ModelInterface, ArrayAccess
{
    ...
    * progressPercentage  **参数解释**： 后台任务处理进度。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    * remainTime  **参数解释**： 剩余时间。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    * stepList  **参数解释**： 步骤列表。   **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'remainTime' => 'int',
            'stepList' => '\HuaweiCloud\SDK\RocketMQ\V2\Model\StepDetail[]'
    ];
    ...
    *
    * @param int|null $progressPercentage **参数解释**： 后台任务处理进度。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\RocketMQ\V2\Model\StepDetail[]|null
    */
    ...
    * Sets stepList
    *
    * @param \HuaweiCloud\SDK\RocketMQ\V2\Model\StepDetail[]|null $stepList **参数解释**： 步骤列表。   **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
