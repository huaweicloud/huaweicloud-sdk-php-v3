...
class ListMessageTraceForRocketMqResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListMessageTraceForRocketMqResponse';
    ...
    * trace  **参数解释**： 消息轨迹列表。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets trace
    *
    * @param \HuaweiCloud\SDK\RocketMQ\V2\Model\ListMessageTraceRespTrace[]|null $trace **参数解释**： 消息轨迹列表。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
