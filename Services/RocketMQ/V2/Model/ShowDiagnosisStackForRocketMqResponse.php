...
class ShowDiagnosisStackForRocketMqResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDiagnosisStackForRocketMqResponse';
