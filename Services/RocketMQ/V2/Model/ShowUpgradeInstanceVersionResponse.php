...
class ShowUpgradeInstanceVersionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowUpgradeInstanceVersionResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * currentVersion  **参数解释**： 当前版本。  **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    * latestVersion  **参数解释**： 最新版本。   **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets currentVersion
    *
    * @param string|null $currentVersion **参数解释**： 当前版本。  **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets latestVersion
    *
    * @param string|null $latestVersion **参数解释**： 最新版本。   **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
