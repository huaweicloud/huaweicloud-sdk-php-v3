...
class SetDisasterRecoverySettingsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SetDisasterRecoverySettingsRequestBody';
