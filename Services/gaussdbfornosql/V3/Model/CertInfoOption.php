...
class CertInfoOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CertInfoOption';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * certId  **参数解释：** 证书ID。 **取值范围：** 根据CCM证书列表接口获取证书ID。
    * certType  **参数解释：** 证书类型。 **取值范围：**   - PCA：CCM PCA 证书。   - SSL：CCM SSL 证书。
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['certId'] === null) {
            $invalidProperties[] = "'certId' can't be null";
        }
    ...
    * Sets certId
    *
    * @param string $certId **参数解释：** 证书ID。 **取值范围：** 根据CCM证书列表接口获取证书ID。
    *
    * @return $this
    */
    ...
    * Sets certType
    *
    * @param string $certType **参数解释：** 证书类型。 **取值范围：**   - PCA：CCM PCA 证书。   - SSL：CCM SSL 证书。
    *
    * @return $this
    */
