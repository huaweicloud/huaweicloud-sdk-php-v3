...
class SaveRedisDisabledCommandsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SaveRedisDisabledCommandsRequestBody';
