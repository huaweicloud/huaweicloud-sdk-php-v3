...
class SetInstanceDataDumpRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SetInstanceDataDumpRequestBody';
    ...
    * Sets action
    *
    * @param string $action 开启/关闭实例数据导出。
    *
    * @return $this
    */
