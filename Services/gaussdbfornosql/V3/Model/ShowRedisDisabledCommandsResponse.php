...
class ShowRedisDisabledCommandsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowRedisDisabledCommandsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalCount  总数。
    * disabledType  禁用类型。
    * commands  disabled_type为command时展示该参数。
    * keys  disabled_type为key时展示该参数，最多20个。
    *
    * @var string[]
    */
    ...
    * Sets disabledType
    *
    * @param string|null $disabledType 禁用类型。
    *
    * @return $this
    */
    ...
    * Sets commands
    *
    * @param string[]|null $commands disabled_type为command时展示该参数。
    *
    * @return $this
    */
    ...
    * Sets keys
    *
    * @param \HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\RedisDisabledCommandsDetail[]|null $keys disabled_type为key时展示该参数，最多20个。
    *
    * @return $this
    */
