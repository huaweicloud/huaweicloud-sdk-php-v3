...
class ListConfigurationsResult implements ModelInterface, ArrayAccess
{
    ...
    * Sets mode
    *
    * @param string $mode 数据库实例类型。 GaussDB(for Cassandra)集群类型为\"Cluster\"。 GaussDB(for Mongo)副本集类型为\"ReplicaSet\"。 GaussDB(for Mongo)集群类型为\"Sharding\"。 GaussDB(for Influx)集群类型为\"Cluster\"。 GaussDB(for Influx)单节点类型为\"InfluxdbSingle\"。
    *
    * @return $this
    */
