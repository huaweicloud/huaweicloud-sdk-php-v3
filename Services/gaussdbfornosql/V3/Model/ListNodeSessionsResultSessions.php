...
class ListNodeSessionsResultSessions implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListNodeSessionsResult_sessions';
    ...
    * Sets db
    *
    * @param string|null $db 该客户端正在使用的数据库ID。
    *
    * @return $this
    */
