...
class CertInfo implements ModelInterface, ArrayAccess
{
    ...
    * category  **参数解释：** 证书种类。 **取值范围：** - international：国际证书。
    * downloadLink  **参数解释：** 证书下载链接。 **取值范围：** 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets category
    *
    * @param string $category **参数解释：** 证书种类。 **取值范围：** - international：国际证书。
    *
    * @return $this
    */
    ...
    * Sets downloadLink
    *
    * @param string $downloadLink **参数解释：** 证书下载链接。 **取值范围：** 不涉及。
    *
    * @return $this
    */
