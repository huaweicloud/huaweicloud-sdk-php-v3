...
class ShowRedisHotKeysRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowRedisHotKeysRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  实例ID。
    * offset  索引位置偏移量，表示从指定offset条数据后查询对应的实例信息。 取值大于或等于0。不传该参数时，查询偏移量默认为0。
    * limit  查询数据的上限值。   - 取值范围：1~50。不传该参数时，默认查询前50条实例信息。
    *
    * @var string[]
    */
    ...
    * Sets limit
    *
    * @param int|null $limit 查询数据的上限值。   - 取值范围：1~50。不传该参数时，默认查询前50条实例信息。
    *
    * @return $this
    */
