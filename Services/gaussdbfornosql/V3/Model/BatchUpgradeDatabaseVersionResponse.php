...
class BatchUpgradeDatabaseVersionResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'upgradeResults' => '\HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\UpgradeResult[]'
    ];
    ...
    *  批量升级结果。
    *
    * @return \HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\UpgradeResult[]|null
    */
    ...
    * Sets upgradeResults
    *
    * @param \HuaweiCloud\SDK\GaussDBforNoSQL\V3\Model\UpgradeResult[]|null $upgradeResults 批量升级结果。
    *
    * @return $this
    */
