...
class ShareTypeAvailableZone implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShareTypeAvailableZone';
    ...
    * Sets status
    *
    * @param string|null $status 在可用区的状态
    *
    * @return $this
    */
