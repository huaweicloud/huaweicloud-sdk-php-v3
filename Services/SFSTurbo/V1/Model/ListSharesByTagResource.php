...
class ListSharesByTagResource implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSharesByTagResource';
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\SFSTurbo\V1\Model\ResourceTag[]|null $tags 资源的标签列表
    *
    * @return $this
    */
