...
class UpdateObsTargetAttributesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateObsTargetAttributesRequest';
    ...
    */
    protected static $openAPITypes = [
            'shareId' => 'string',
            'targetId' => 'string',
            'body' => '\HuaweiCloud\SDK\SFSTurbo\V1\Model\UpdateObsTargetAttributesRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SFSTurbo\V1\Model\UpdateObsTargetAttributesRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SFSTurbo\V1\Model\UpdateObsTargetAttributesRequestBody|null $body body
    *
    * @return $this
    */
