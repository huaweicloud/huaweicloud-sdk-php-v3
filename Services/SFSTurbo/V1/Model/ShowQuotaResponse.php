...
class ShowQuotaResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'quotas' => '\HuaweiCloud\SDK\SFSTurbo\V1\Model\ShowQuotaResource',
            'xRequestId' => 'string'
    ];
    ...
    *  quotas
    *
    * @return \HuaweiCloud\SDK\SFSTurbo\V1\Model\ShowQuotaResource|null
    */
    ...
    * Sets quotas
    *
    * @param \HuaweiCloud\SDK\SFSTurbo\V1\Model\ShowQuotaResource|null $quotas quotas
    *
    * @return $this
    */
