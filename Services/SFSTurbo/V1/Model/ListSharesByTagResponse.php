...
class ListSharesByTagResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSharesByTagResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * resources  通过标签查询文件系统的资源列表
    * totalCount  返回的文件系统的总量
    ...
    * Sets totalCount
    *
    * @param int|null $totalCount 返回的文件系统的总量
    *
    * @return $this
    */
