...
class QuotaResource implements ModelInterface, ArrayAccess
{
    ...
    * type  租户资源类型。shares表示文件系统数量，capacity表示文件系统容量。
    * used  已用配额。
    * quota  总配额。
    * unit  配额单位。
    *
    ...
    * Sets type
    *
    * @param string|null $type 租户资源类型。shares表示文件系统数量，capacity表示文件系统容量。
    *
    * @return $this
    */
