...
class Share implements ModelInterface, ArrayAccess
{
    ...
    * shareType  文件系统类型，有效值为STANDARD或者PERFORMANCE。
    * size  普通文件系统容量，单位GB，取值范围500~32768。 增强型文件系统，即在“metadata”字段中设置了expand_type字段，则容量范围是10240~327680
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['size'] === null) {
            ...
            if (($this->container['size'] >= 327680)) {
                $invalidProperties[] = "invalid value for 'size', must be smaller than 327680.";
            }
    ...
    * Sets shareType
    *
    * @param string $shareType 文件系统类型，有效值为STANDARD或者PERFORMANCE。
    *
    * @return $this
    */
    ...
    * Sets size
    *
    * @param int $size 普通文件系统容量，单位GB，取值范围500~32768。 增强型文件系统，即在“metadata”字段中设置了expand_type字段，则容量范围是10240~327680
    *
    * @return $this
    */
