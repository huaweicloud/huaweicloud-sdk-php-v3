...
class ChangeShareChargeModeV2Response implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeShareChargeModeV2Response';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * orderIds  转包周期生成的订单数组
    ...
    * Sets orderIds
    *
    * @param string[]|null $orderIds 转包周期生成的订单数组
    *
    * @return $this
    */
