...
class ShowFsDirQuotaResponse implements ModelInterface, ArrayAccess
{
    ...
    * inode  目录的inode数量限制
    * usedCapacity  目录已使用的容量大小，单位：MB。仅SFSTurbo 20MB/s/TiB、40MB/s/TiB、125MB/s/TiB、250MB/s/TiB、500MB/s/TiB、1000MB/s/TiB返回该字段。数据可能有延迟。
    * usedInode  目录的已使用的inode数量。仅SFSTurbo 20MB/s/TiB、40MB/s/TiB、125MB/s/TiB、250MB/s/TiB、500MB/s/TiB、1000MB/s/TiB返回该字段。数据可能有延迟。
    *
    * @var string[]
    */
    ...
    * Sets usedCapacity
    *
    * @param int|null $usedCapacity 目录已使用的容量大小，单位：MB。仅SFSTurbo 20MB/s/TiB、40MB/s/TiB、125MB/s/TiB、250MB/s/TiB、500MB/s/TiB、1000MB/s/TiB返回该字段。数据可能有延迟。
    *
    * @return $this
    */
    ...
    * Sets usedInode
    *
    * @param int|null $usedInode 目录的已使用的inode数量。仅SFSTurbo 20MB/s/TiB、40MB/s/TiB、125MB/s/TiB、250MB/s/TiB、500MB/s/TiB、1000MB/s/TiB返回该字段。数据可能有延迟。
    *
    * @return $this
    */
