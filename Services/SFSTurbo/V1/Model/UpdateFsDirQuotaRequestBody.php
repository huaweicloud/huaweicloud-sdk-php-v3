...
class UpdateFsDirQuotaRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * path  合法的已存在的目录的全路径
    * capacity  目录的容量大小，单位：MB; 不填写则默认为0; 设置为0会导致数据无法写入目录; capacity和quota至少二选一
    * inode  目录的inode数量限制; 不填写则默认为0; 设置为0会导致数据无法写入目录; capacity和quota至少二选一
    *
    * @var string[]
    */
    ...
    * Sets capacity
    *
    * @param int|null $capacity 目录的容量大小，单位：MB; 不填写则默认为0; 设置为0会导致数据无法写入目录; capacity和quota至少二选一
    *
    * @return $this
    */
    ...
    * Sets inode
    *
    * @param int|null $inode 目录的inode数量限制; 不填写则默认为0; 设置为0会导致数据无法写入目录; capacity和quota至少二选一
    *
    * @return $this
    */
