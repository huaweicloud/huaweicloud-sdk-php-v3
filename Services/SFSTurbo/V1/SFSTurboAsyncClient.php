...
class SFSTurboAsyncClient extends Client
{
     ...
     * @return response
     */
    public function addActiveDirectoryDomainAsync($request)
    {
        return $this->addActiveDirectoryDomainAsyncWithHttpInfo($request);
    }
    
    public function addActiveDirectoryDomainAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function changeShareChargeModeV2Async($request)
    {
        return $this->changeShareChargeModeV2AsyncWithHttpInfo($request);
    }
    
    public function changeShareChargeModeV2AsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function deleteActiveDirectoryDomainAsync($request)
    {
        return $this->deleteActiveDirectoryDomainAsyncWithHttpInfo($request);
    }
    
    public function deleteActiveDirectoryDomainAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v1/{project_id}/sfs-turbo/shares/{share_id}/fs/active-directory-domain';
        $formParams = [];
        $queryParams = [];
     ...
     * @return response
     */
    public function deleteHpcCacheTaskAsync($request)
    {
        return $this->deleteHpcCacheTaskAsyncWithHttpInfo($request);
    }
    
    public function deleteHpcCacheTaskAsyncWithHttpInfo($request){
        $collection_formats = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\SFSTurbo\V1\Model\DeleteHpcCacheTaskResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\SFSTurbo\V1\Model\DeleteHpcCacheTaskRequest',
            $asyncRequest = true);
    }
     ...
     * @return response
     */
    public function listShareTypesAsync($request)
    {
        return $this->listShareTypesAsyncWithHttpInfo($request);
    }
    
    public function listShareTypesAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function listSharesByTagAsync($request)
    {
        return $this->listSharesByTagAsyncWithHttpInfo($request);
    }
    
    public function listSharesByTagAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function showActiveDirectoryDomainAsync($request)
    {
        return $this->showActiveDirectoryDomainAsyncWithHttpInfo($request);
    }
    
    public function showActiveDirectoryDomainAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v1/{project_id}/sfs-turbo/shares/{share_id}/fs/active-directory-domain';
        $formParams = [];
        $queryParams = [];
     ...
     * @return response
     */
    public function showClientIpInfoAsync($request)
    {
        return $this->showClientIpInfoAsyncWithHttpInfo($request);
    }
    
    public function showClientIpInfoAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/03 /v1/{project_id}/sfs-turbo/shares/{share_id}/action';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
     ...
     * @return response
     */
    public function updateActiveDirectoryDomainAsync($request)
    {
        return $this->updateActiveDirectoryDomainAsyncWithHttpInfo($request);
    }
    
    public function updateActiveDirectoryDomainAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v1/{project_id}/sfs-turbo/shares/{share_id}/fs/active-directory-domain';
        $formParams = [];
        $queryParams = [];
     ...
     * @return response
     */
    public function updateObsTargetAttributesAsync($request)
    {
        return $this->updateObsTargetAttributesAsyncWithHttpInfo($request);
    }
    
    public function updateObsTargetAttributesAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v1/{project_id}/sfs-turbo/shares/{share_id}/targets/{target_id}/attributes';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\SFSTurbo\V1\Model\UpdateObsTargetAttributesResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\SFSTurbo\V1\Model\UpdateObsTargetAttributesRequest',
            $asyncRequest = true);
    }
     ...
     * @return response
     */
    public function updateObsTargetPolicyAsync($request)
    {
        return $this->updateObsTargetPolicyAsyncWithHttpInfo($request);
    }
    
    public function updateObsTargetPolicyAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v1/{project_id}/sfs-turbo/shares/{share_id}/targets/{target_id}/policy';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\SFSTurbo\V1\Model\UpdateObsTargetPolicyResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\SFSTurbo\V1\Model\UpdateObsTargetPolicyRequest',
            $asyncRequest = true);
    }
