...
class ListLogContextRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListLogContextRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * logGroupId  日志组ID，获取方式请参见：[获取项目ID，获取账号ID，日志组ID、日志流ID](lts_api_0006.xml)
    * logStreamId  日志流ID，获取方式请参见：[获取项目ID，获取账号ID，日志组ID、日志流ID](lts_api_0006.xml)
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'logGroupId' => 'string',
            'logStreamId' => 'string',
            'body' => '\HuaweiCloud\SDK\Lts\V2\Model\ListLogContextRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Lts\V2\Model\ListLogContextRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Lts\V2\Model\ListLogContextRequestBody|null $body body
    *
    * @return $this
    */
