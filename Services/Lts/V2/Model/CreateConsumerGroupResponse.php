...
class CreateConsumerGroupResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateConsumerGroupResponse';
    ...
    *
    * @param string|null $consumerGroupName 创建的消费组名
    *
    * @return $this
    */
