...
class UpdateNotificationTemplateRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateNotificationTemplateRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  通知规则名称，必填，只含有汉字、数字、字母、下划线、中划线，不能以下划线等特殊符号开头和结尾，长度为 1 - 100，创建后不可修改
    * type  保留字段，非必填
    * desc  模板描述，非必填，只含有汉字、数字、字母、下划线不能以下划线开头和结尾，长度为0--1024
    ...
    */
    protected static $openAPITypes = [
            ...
            'source' => 'string',
            'locale' => 'string',
            'templates' => '\HuaweiCloud\SDK\Lts\V2\Model\UpdateSubTemplate[]'
    ];
    ...
    * Sets type
    *
    * @param string[]|null $type 保留字段，非必填
    *
    * @return $this
    */
    ...
    * Sets desc
    *
    * @param string|null $desc 模板描述，非必填，只含有汉字、数字、字母、下划线不能以下划线开头和结尾，长度为0--1024
    *
    * @return $this
    */
    ...
    *  模板正文，为一个数组
    *
    * @return \HuaweiCloud\SDK\Lts\V2\Model\UpdateSubTemplate[]
    */
    ...
    * Sets templates
    *
    * @param \HuaweiCloud\SDK\Lts\V2\Model\UpdateSubTemplate[] $templates 模板正文，为一个数组
    *
    * @return $this
    */
