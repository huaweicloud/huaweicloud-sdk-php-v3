...
class ListLogStreamIndexResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListLogStreamIndexResponse';
    ...
    *  fullTextIndex
    *
    * @return \HuaweiCloud\SDK\Lts\V2\Model\LTSFullTextIndexInfo|null
    */
    ...
    * Sets fullTextIndex
    *
    * @param \HuaweiCloud\SDK\Lts\V2\Model\LTSFullTextIndexInfo|null $fullTextIndex fullTextIndex
    *
    * @return $this
    */
