...
class AccessConfigDeatilCreate implements ModelInterface, ArrayAccess
{
    ...
    * customKeyValue  自定义键值对：配置日志接入规则时，可以配置自定义键值对规则，上报日志后，每条日志数据的标签数据中将会有用户自定义的键值对字段，键值对数量不超过20 键的长度限制为128，允许的字符有a-zA-Z0-9_- 值的长度限制为1024
    ...
    */
    protected static $setters = [
            ...
            'logK8s' => 'setLogK8s',
            'repeatCollect' => 'setRepeatCollect',
    ...
    */
    protected static $getters = [
            ...
            'logK8s' => 'getLogK8s',
            'repeatCollect' => 'getRepeatCollect',
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['repeatCollect'] = isset($data['repeatCollect']) ? $data['repeatCollect'] : null;
    ...
    * @return bool|null
    */
    public function getRepeatCollect()
    {
        return $this->container['repeatCollect'];
    }

    /**
    * Sets repeatCollect
    *
    * @param bool|null $repeatCollect 是否允许此文件重复采集
    *
    * @return $this
    */
    public function setRepeatCollect($repeatCollect)
    {
        $this->container['repeatCollect'] = $repeatCollect;
        return $this;
    }
    ...
    * Sets customKeyValue
    *
    * @param map[string,string]|null $customKeyValue 自定义键值对：配置日志接入规则时，可以配置自定义键值对规则，上报日志后，每条日志数据的标签数据中将会有用户自定义的键值对字段，键值对数量不超过20 键的长度限制为128，允许的字符有a-zA-Z0-9_- 值的长度限制为1024
    *
    * @return $this
    */
