...
class UpdateCheckPointRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateCheckPointRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'consumerName' => 'string',
            'body' => '\HuaweiCloud\SDK\Lts\V2\Model\ConsumerShardCheckpointInfo[]'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['consumerName'] === null) {
            $invalidProperties[] = "'consumerName' can't be null";
        }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Lts\V2\Model\ConsumerShardCheckpointInfo[]|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Lts\V2\Model\ConsumerShardCheckpointInfo[]|null $body body
    *
    * @return $this
    */
