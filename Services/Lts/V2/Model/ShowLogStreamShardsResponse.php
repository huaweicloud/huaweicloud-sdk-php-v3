...
class ShowLogStreamShardsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowLogStreamShardsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * errorCode  错误码
    * isQueryComplete  是否完全查询
    * result  查询结果
    *
    * @var string[]
    */
    ...
    *
    * @param bool|null $isQueryComplete 是否完全查询
    *
    * @return $this
    */
