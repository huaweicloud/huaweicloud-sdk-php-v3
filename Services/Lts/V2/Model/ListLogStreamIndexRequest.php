...
class ListLogStreamIndexRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListLogStreamIndexRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * groupId  日志组ID，获取方式请参见：[获取项目ID，获取账号ID，日志组ID、日志流ID](lts_api_0006.xml)
    * streamId  日志流ID，获取方式请参见：[获取项目ID，获取账号ID，日志组ID、日志流ID](lts_api_0006.xml)
    *
    * @var string[]
    */
