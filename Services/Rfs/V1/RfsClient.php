...
class RfsClient extends Client
{
    ...
    {
        $client = new ClientBuilder(new RfsClient());
        return $client;
    }
     ...
     * @return response
     */
    public function listPrivateHookVersions($request)
    {
        return $this->listPrivateHookVersionsWithHttpInfo($request);
    }

    public function listPrivateHookVersionsWithHttpInfo($request)
    {
        $resourcePath = '/v1/private-hooks/{hook_name}/versions';
        $formParams = [];
        $queryParams = [];
