...
class CreateTemplateVersionRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'templateName' => 'string',
            'templateId' => 'string',
            'body' => '\HuaweiCloud\SDK\Rfs\V1\Model\CreateTemplateVersionRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\CreateTemplateVersionRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\CreateTemplateVersionRequestBody|null $body body
    *
    * @return $this
    */
