...
class ListStacksResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'stacks' => '\HuaweiCloud\SDK\Rfs\V1\Model\Stack[]',
    ...
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\Stack[]|null
    */
    ...
    * Sets stacks
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\Stack[]|null $stacks 资源栈列表。默认按照生成时间降序排序，最新生成的在最前
    *
    * @return $this
    */
