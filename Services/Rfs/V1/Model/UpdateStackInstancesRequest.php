...
class UpdateStackInstancesRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'stackSetName' => 'string',
            'body' => '\HuaweiCloud\SDK\Rfs\V1\Model\UpdateStackInstancesRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\UpdateStackInstancesRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\UpdateStackInstancesRequestBody|null $body body
    *
    * @return $this
    */
