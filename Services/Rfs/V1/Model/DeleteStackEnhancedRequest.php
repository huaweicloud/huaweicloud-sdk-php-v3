...
class DeleteStackEnhancedRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'stackName' => 'string',
            'body' => '\HuaweiCloud\SDK\Rfs\V1\Model\DeleteStackEnhancedRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\DeleteStackEnhancedRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\DeleteStackEnhancedRequestBody|null $body body
    *
    * @return $this
    */
