...
class ListTemplatesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'templates' => '\HuaweiCloud\SDK\Rfs\V1\Model\Template[]',
    ...
    *  模板列表
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\Template[]|null
    */
    ...
    * Sets templates
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\Template[]|null $templates 模板列表
    *
    * @return $this
    */
