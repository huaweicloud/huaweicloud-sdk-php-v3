...
class UpdateTemplateMetadataRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'templateName' => 'string',
            'body' => '\HuaweiCloud\SDK\Rfs\V1\Model\UpdateTemplateMetadataRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\UpdateTemplateMetadataRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\UpdateTemplateMetadataRequestBody|null $body body
    *
    * @return $this
    */
