...
class EstimateExecutionPlanPriceResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'currency' => 'string',
            'items' => '\HuaweiCloud\SDK\Rfs\V1\Model\ItemsResponse[]'
    ];
    ...
    *  执行计划中所有资源的询价结果
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\ItemsResponse[]|null
    */
    ...
    * Sets items
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\ItemsResponse[]|null $items 执行计划中所有资源的询价结果
    *
    * @return $this
    */
