...
class DeployStackRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'stackName' => 'string',
            'body' => '\HuaweiCloud\SDK\Rfs\V1\Model\DeployStackRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\DeployStackRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\DeployStackRequestBody|null $body body
    *
    * @return $this
    */
