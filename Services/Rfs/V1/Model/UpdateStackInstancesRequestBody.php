...
class UpdateStackInstancesRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'stackSetId' => 'string',
            'deploymentTargets' => '\HuaweiCloud\SDK\Rfs\V1\Model\DeploymentTargets',
            'varOverrides' => '\HuaweiCloud\SDK\Rfs\V1\Model\VarOverridesPrimitiveTypeHolderVarOverrides',
    ...
    *  deploymentTargets
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\DeploymentTargets
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\DeploymentTargets $deploymentTargets deploymentTargets
    *
    * @return $this
    */
    ...
    *  varOverrides
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\VarOverridesPrimitiveTypeHolderVarOverrides|null
    */
    ...
    * Sets varOverrides
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\VarOverridesPrimitiveTypeHolderVarOverrides|null $varOverrides varOverrides
    *
    * @return $this
    */
