...
class PrivateModuleVersionPrimitiveTypeHolder implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PrivateModuleVersionPrimitiveTypeHolder';
