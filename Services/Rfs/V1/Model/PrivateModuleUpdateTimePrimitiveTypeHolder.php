...
class PrivateModuleUpdateTimePrimitiveTypeHolder implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PrivateModuleUpdateTimePrimitiveTypeHolder';
