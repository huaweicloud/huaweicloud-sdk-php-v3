...
class CreateStackInstanceRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'stackSetName' => 'string',
            'body' => '\HuaweiCloud\SDK\Rfs\V1\Model\CreateStackInstanceRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\CreateStackInstanceRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\CreateStackInstanceRequestBody|null $body body
    *
    * @return $this
    */
