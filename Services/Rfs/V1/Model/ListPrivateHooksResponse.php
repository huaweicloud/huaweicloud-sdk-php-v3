...
class ListPrivateHooksResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'hooks' => '\HuaweiCloud\SDK\Rfs\V1\Model\PrivateHookSummary[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\PrivateHookSummary[]|null
    */
    ...
    * Sets hooks
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\PrivateHookSummary[]|null $hooks 私有hook的列表。默认以创建时间降序排序。
    *
    * @return $this
    */
