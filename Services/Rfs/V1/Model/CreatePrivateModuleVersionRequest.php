...
class CreatePrivateModuleVersionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePrivateModuleVersionRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'moduleName' => 'string',
            'body' => '\HuaweiCloud\SDK\Rfs\V1\Model\CreatePrivateModuleVersionRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\CreatePrivateModuleVersionRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\CreatePrivateModuleVersionRequestBody|null $body body
    *
    * @return $this
    */
