...
class ListStackEventsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'stackEvents' => '\HuaweiCloud\SDK\Rfs\V1\Model\StackEvent[]',
    ...
    *  资源栈事件列表
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\StackEvent[]|null
    */
    ...
    * Sets stackEvents
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\StackEvent[]|null $stackEvents 资源栈事件列表
    *
    * @return $this
    */
