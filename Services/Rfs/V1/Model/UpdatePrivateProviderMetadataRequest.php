...
class UpdatePrivateProviderMetadataRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'providerName' => 'string',
            'body' => '\HuaweiCloud\SDK\Rfs\V1\Model\UpdatePrivateProviderMetadataRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\UpdatePrivateProviderMetadataRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\UpdatePrivateProviderMetadataRequestBody|null $body body
    *
    * @return $this
    */
