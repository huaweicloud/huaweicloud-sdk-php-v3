...
class VariableResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'sensitive' => 'bool',
            'nullable' => 'bool',
            'validations' => '\HuaweiCloud\SDK\Rfs\V1\Model\VariableValidationResponse[]'
    ];
    ...
    *  参数的校验模块
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\VariableValidationResponse[]|null
    */
    ...
    * Sets validations
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\VariableValidationResponse[]|null $validations 参数的校验模块
    *
    * @return $this
    */
