...
class GetExecutionPlanMetadataResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'createTime' => 'string',
            'applyTime' => 'string',
            'summary' => '\HuaweiCloud\SDK\Rfs\V1\Model\ExecutionPlanSummary'
    ];
    ...
    *  summary
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\ExecutionPlanSummary|null
    */
    ...
    * Sets summary
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\ExecutionPlanSummary|null $summary summary
    *
    * @return $this
    */
