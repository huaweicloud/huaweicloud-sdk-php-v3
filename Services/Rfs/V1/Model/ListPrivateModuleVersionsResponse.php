...
class ListPrivateModuleVersionsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'versions' => '\HuaweiCloud\SDK\Rfs\V1\Model\PrivateModuleVersionSummary[]',
    ...
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\PrivateModuleVersionSummary[]|null
    */
    ...
    * Sets versions
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\PrivateModuleVersionSummary[]|null $versions 私有模块版本的列表。默认以创建时间升序排序。
    *
    * @return $this
    */
