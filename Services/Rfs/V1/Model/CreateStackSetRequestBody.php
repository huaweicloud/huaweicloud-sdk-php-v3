...
class CreateStackSetRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'managedOperation' => '\HuaweiCloud\SDK\Rfs\V1\Model\ManagedOperation',
            'callIdentity' => 'string'
    ];
    ...
    *  managedOperation
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\ManagedOperation|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\ManagedOperation|null $managedOperation managedOperation
    *
    * @return $this
    */
