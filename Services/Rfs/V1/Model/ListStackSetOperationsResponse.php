...
class ListStackSetOperationsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'stackSetOperations' => '\HuaweiCloud\SDK\Rfs\V1\Model\StackSetOperation[]',
    ...
    *  资源栈集操作列表
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\StackSetOperation[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\StackSetOperation[]|null $stackSetOperations 资源栈集操作列表
    *
    * @return $this
    */
