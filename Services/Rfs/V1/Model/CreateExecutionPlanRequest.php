...
class CreateExecutionPlanRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'stackName' => 'string',
            'body' => '\HuaweiCloud\SDK\Rfs\V1\Model\CreateExecutionPlanRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\CreateExecutionPlanRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\CreateExecutionPlanRequestBody|null $body body
    *
    * @return $this
    */
