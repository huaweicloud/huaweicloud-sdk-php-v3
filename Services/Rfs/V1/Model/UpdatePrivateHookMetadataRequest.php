...
class UpdatePrivateHookMetadataRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'hookName' => 'string',
            'body' => '\HuaweiCloud\SDK\Rfs\V1\Model\UpdatePrivateHookMetadataRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\UpdatePrivateHookMetadataRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\UpdatePrivateHookMetadataRequestBody|null $body body
    *
    * @return $this
    */
