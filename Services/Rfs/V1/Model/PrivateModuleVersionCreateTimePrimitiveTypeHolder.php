...
class PrivateModuleVersionCreateTimePrimitiveTypeHolder implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PrivateModuleVersionCreateTimePrimitiveTypeHolder';
