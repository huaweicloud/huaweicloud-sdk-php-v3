...
class ListExecutionPlansResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'executionPlans' => '\HuaweiCloud\SDK\Rfs\V1\Model\ExecutionPlan[]',
    ...
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\ExecutionPlan[]|null
    */
    ...
    * Sets executionPlans
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\ExecutionPlan[]|null $executionPlans 执行计划列表。默认按照生成时间降序排序，最新生成的在最前
    *
    * @return $this
    */
