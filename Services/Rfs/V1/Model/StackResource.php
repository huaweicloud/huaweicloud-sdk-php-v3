...
class StackResource implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'resourceAttributes' => '\HuaweiCloud\SDK\Rfs\V1\Model\ResourceAttribute[]'
    ];
    ...
    *  资源属性列表
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\ResourceAttribute[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\ResourceAttribute[]|null $resourceAttributes 资源属性列表
    *
    * @return $this
    */
