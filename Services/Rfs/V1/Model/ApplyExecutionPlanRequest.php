...
class ApplyExecutionPlanRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Rfs\V1\Model\ApplyExecutionPlanRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\ApplyExecutionPlanRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\ApplyExecutionPlanRequestBody|null $body body
    *
    * @return $this
    */
