...
class CreatePrivateProviderVersionRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'providerName' => 'string',
            'body' => '\HuaweiCloud\SDK\Rfs\V1\Model\CreatePrivateProviderVersionRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\CreatePrivateProviderVersionRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\CreatePrivateProviderVersionRequestBody|null $body body
    *
    * @return $this
    */
