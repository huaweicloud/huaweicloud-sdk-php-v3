...
class CreatePrivateHookVersionRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'hookName' => 'string',
            'body' => '\HuaweiCloud\SDK\Rfs\V1\Model\CreatePrivateHookVersionRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\CreatePrivateHookVersionRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\CreatePrivateHookVersionRequestBody|null $body body
    *
    * @return $this
    */
