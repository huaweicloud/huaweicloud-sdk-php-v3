...
class ListPrivateModulesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'modules' => '\HuaweiCloud\SDK\Rfs\V1\Model\PrivateModuleSummary[]',
    ...
    *  私有模块的列表。默认以创建时间升序排序。
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\PrivateModuleSummary[]|null
    */
    ...
    * Sets modules
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\PrivateModuleSummary[]|null $modules 私有模块的列表。默认以创建时间升序排序。
    *
    * @return $this
    */
