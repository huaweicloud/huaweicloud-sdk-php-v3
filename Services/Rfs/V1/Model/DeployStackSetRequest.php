...
class DeployStackSetRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'stackSetName' => 'string',
            'body' => '\HuaweiCloud\SDK\Rfs\V1\Model\DeployStackSetRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\DeployStackSetRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\DeployStackSetRequestBody|null $body body
    *
    * @return $this
    */
