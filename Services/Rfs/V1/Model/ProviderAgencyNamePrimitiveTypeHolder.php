...
class ProviderAgencyNamePrimitiveTypeHolder implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ProviderAgencyNamePrimitiveTypeHolder';
