...
class PrivateProviderVersionCreateTimePrimitiveTypeHolder implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PrivateProviderVersionCreateTimePrimitiveTypeHolder';
