...
class UpdatePrivateModuleMetadataRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'moduleName' => 'string',
            'body' => '\HuaweiCloud\SDK\Rfs\V1\Model\UpdatePrivateModuleMetadataRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\UpdatePrivateModuleMetadataRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\UpdatePrivateModuleMetadataRequestBody|null $body body
    *
    * @return $this
    */
