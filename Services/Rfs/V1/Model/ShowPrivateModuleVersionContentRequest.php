...
class ShowPrivateModuleVersionContentRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowPrivateModuleVersionContentRequest';
