...
class ListStackInstancesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'stackInstances' => '\HuaweiCloud\SDK\Rfs\V1\Model\StackInstance[]',
    ...
    *  资源栈实例列表
    *
    * @return \HuaweiCloud\SDK\Rfs\V1\Model\StackInstance[]|null
    */
    ...
    * Sets stackInstances
    *
    * @param \HuaweiCloud\SDK\Rfs\V1\Model\StackInstance[]|null $stackInstances 资源栈实例列表
    *
    * @return $this
    */
