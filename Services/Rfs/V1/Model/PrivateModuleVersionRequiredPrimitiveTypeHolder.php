...
class PrivateModuleVersionRequiredPrimitiveTypeHolder implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PrivateModuleVersionRequiredPrimitiveTypeHolder';
