...
class ImageMediaTaggingDetItemBodyI18nTag implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImageMediaTaggingDetItemBody_i18n_tag';
