...
class ImageMediaTaggingReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImageMediaTaggingReq';
    ...
    * threshold  置信度的阈值（0~100），低于此置信数的标签，将不会返回。  默认值：60。  最小值：0。  最大值：100。  默认值：0。
    * limit  最多返回的tag数（取值范围：1~150），默认值： 10。
    *
    * @var string[]
    */
    ...
    * Sets threshold
    *
    * @param float|null $threshold 置信度的阈值（0~100），低于此置信数的标签，将不会返回。  默认值：60。  最小值：0。  最大值：100。  默认值：0。
    *
    * @return $this
    */
    ...
    * Sets limit
    *
    * @param int|null $limit 最多返回的tag数（取值范围：1~150），默认值： 10。
    *
    * @return $this
    */
