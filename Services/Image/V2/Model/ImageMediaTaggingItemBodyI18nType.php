...
class ImageMediaTaggingItemBodyI18nType implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImageMediaTaggingItemBody_i18n_type';
