...
class SmsAsyncClient extends Client
{
     ...
     * @return response
     */
    public function exportConsistencyResultsAsync($request)
    {
        return $this->exportConsistencyResultsAsyncWithHttpInfo($request);
    }
    
    public function exportConsistencyResultsAsyncWithHttpInfo($request){
        $collection_formats = [];
