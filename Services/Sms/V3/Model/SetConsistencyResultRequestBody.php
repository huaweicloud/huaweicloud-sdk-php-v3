...
class SetConsistencyResultRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SetConsistencyResultRequestBody';
    ...
    *
    * @param \HuaweiCloud\SDK\Sms\V3\Model\ConsistencyResult[]|null $consistencyResult 一致性校验结果
    *
    * @return $this
    */
