...
class TemplateDisk implements ModelInterface, ArrayAccess
{
    ...
    * index  磁盘序号，从0开始
    * name  磁盘名称
    * disktype  磁盘类型，同volumetype字段（非枚举数据，来源于EVS服务） 详细类型请参考EIP服务API文档中“查询单个云硬盘详情”部分，查看响应参数的中volume_type字段描述
    * size  磁盘大小，单位：GB
    * deviceUse  磁盘使用
    *
    * @var string[]
    ...
    * Sets disktype
    *
    * @param string $disktype 磁盘类型，同volumetype字段（非枚举数据，来源于EVS服务） 详细类型请参考EIP服务API文档中“查询单个云硬盘详情”部分，查看响应参数的中volume_type字段描述
    *
    * @return $this
    */
