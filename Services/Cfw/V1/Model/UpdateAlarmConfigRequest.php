...
class UpdateAlarmConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Cfw\V1\Model\UpdateAttackLogAlarmConfigDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cfw\V1\Model\UpdateAttackLogAlarmConfigDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cfw\V1\Model\UpdateAttackLogAlarmConfigDto|null $body body
    *
    * @return $this
    */
