...
class UpdateRuleAclDto implements ModelInterface, ArrayAccess
{
    ...
    * status  **参数解释**： 规则启用状态，用于区分规则是否启用 **约束限制**： 仅能使用数字0和1 **取值范围**： 0表示禁用，1表示启用 **默认取值**： 不涉及
    ...
    * Sets status
    *
    * @param int|null $status **参数解释**： 规则启用状态，用于区分规则是否启用 **约束限制**： 仅能使用数字0和1 **取值范围**： 0表示禁用，1表示启用 **默认取值**： 不涉及
    *
    * @return $this
    */
