...
class IpBlacklistDeleteDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'IpBlacklistDeleteDto';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * effectScope  指定生效范围，1指定生效范围为EIP进行删除,2指定生效范围为NAT进行删除，1,2生效范围为EIP和NAT进行删除
    *
    * @var string[]
    */
    ...
    * Sets effectScope
    *
    * @param int[]|null $effectScope 指定生效范围，1指定生效范围为EIP进行删除,2指定生效范围为NAT进行删除，1,2生效范围为EIP和NAT进行删除
    *
    * @return $this
    */
