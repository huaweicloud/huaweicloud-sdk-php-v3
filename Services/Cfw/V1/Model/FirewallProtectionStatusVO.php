...
class FirewallProtectionStatusVO implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'FirewallProtectionStatusVO';
    ...
    * failedEipList  **参数解释**： bypass失败的eip列表。 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及
    * failedEipIdList  **参数解释**： bypass失败的eip id列表。 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'id' => 'string',
            'objectId' => 'string',
            'failedEipList' => 'string[]',
            'failedEipIdList' => 'string[]'
    ];
    ...
    */
    protected static $attributeMap = [
            ...
            'id' => 'id',
            'objectId' => 'object_id',
            'failedEipList' => 'failed_eip_list',
            'failedEipIdList' => 'failed_eip_id_list'
    ];
    ...
    */
    protected static $setters = [
            ...
            'failedEipList' => 'setFailedEipList',
            'failedEipIdList' => 'setFailedEipIdList'
    ];
    ...
    */
    protected static $getters = [
            ...
            'failedEipList' => 'getFailedEipList',
            'failedEipIdList' => 'getFailedEipIdList'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['failedEipList'] = isset($data['failedEipList']) ? $data['failedEipList'] : null;
        $this->container['failedEipIdList'] = isset($data['failedEipIdList']) ? $data['failedEipIdList'] : null;
    }
    ...
    * @return string[]|null
    */
    public function getFailedEipList()
    {
        return $this->container['failedEipList'];
    }

    /**
    * Sets failedEipList
    *
    * @param string[]|null $failedEipList **参数解释**： bypass失败的eip列表。 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及
    *
    * @return $this
    */
    public function setFailedEipList($failedEipList)
    {
        $this->container['failedEipList'] = $failedEipList;
        return $this;
    }

    /**
    * Gets failedEipIdList
    *  **参数解释**： bypass失败的eip id列表。 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及
    *
    * @return string[]|null
    */
    public function getFailedEipIdList()
    {
        return $this->container['failedEipIdList'];
    }

    /**
    * Sets failedEipIdList
    *
    * @param string[]|null $failedEipIdList **参数解释**： bypass失败的eip id列表。 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及
    *
    * @return $this
    */
    public function setFailedEipIdList($failedEipIdList)
    {
        $this->container['failedEipIdList'] = $failedEipIdList;
        return $this;
    }
