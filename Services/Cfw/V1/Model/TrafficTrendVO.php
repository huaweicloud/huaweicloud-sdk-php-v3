...
class TrafficTrendVO implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TrafficTrendVO';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * aggTime  **参数解释**： 聚合时间点 **取值范围**： 不涉及
    * bps  **参数解释**： bps **取值范围**： 不涉及
    ...
    * Sets aggTime
    *
    * @param int|null $aggTime **参数解释**： 聚合时间点 **取值范围**： 不涉及
    *
    * @return $this
    */
    ...
    * Sets bps
    *
    * @param double|null $bps **参数解释**： bps **取值范围**： 不涉及
    *
    * @return $this
    */
