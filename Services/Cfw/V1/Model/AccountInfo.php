...
class AccountInfo implements ModelInterface, ArrayAccess
{
    ...
    * accountId  **参数解释**： 账号ID，可以通过调用[查询组织账号列表接口]获得，通过返回值中的data.id获得 **约束限制**： 不涉及 **默认取值**： 不涉及
    *
    * @var string[]
    */
    ...
    * Sets accountId
    *
    * @param string $accountId **参数解释**： 账号ID，可以通过调用[查询组织账号列表接口]获得，通过返回值中的data.id获得 **约束限制**： 不涉及 **默认取值**： 不涉及
    *
    * @return $this
    */
