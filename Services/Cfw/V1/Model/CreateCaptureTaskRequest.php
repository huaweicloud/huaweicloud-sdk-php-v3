...
class CreateCaptureTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCaptureTaskRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'fwInstanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cfw\V1\Model\CaptureTaskDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cfw\V1\Model\CaptureTaskDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cfw\V1\Model\CaptureTaskDto|null $body body
    *
    * @return $this
    */
