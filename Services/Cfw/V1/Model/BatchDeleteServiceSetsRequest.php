...
class BatchDeleteServiceSetsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteServiceSetsRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cfw\V1\Model\BatchDeleteServiceSetsDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cfw\V1\Model\BatchDeleteServiceSetsDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cfw\V1\Model\BatchDeleteServiceSetsDto|null $body body
    *
    * @return $this
    */
