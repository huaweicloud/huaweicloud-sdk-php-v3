...
class UpdateIpsWhitelistDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateIpsWhitelistDto';
    ...
    * ipsId  **参数解释**：  ips规则id，不填写时默认为全部ips规则  **约束限制**：  不涉及  **取值范围**： 不涉及  **默认取值**：  不涉及
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['name'] === null) {
            ...
            if (!is_null($this->container['ipsId']) && (mb_strlen($this->container['ipsId']) > 10)) {
                $invalidProperties[] = "invalid value for 'ipsId', the character length must be smaller than or equal to 10.";
            }
    ...
    * Sets sourceAddress
    *
    * @param string $sourceAddress **参数解释**： 白名单源地址 **约束限制**： 不涉及  **取值范围**： 不涉及  **默认取值**： 不涉及
    *
    * @return $this
    */
    ...
    * Sets ipsId
    *
    * @param string|null $ipsId **参数解释**：  ips规则id，不填写时默认为全部ips规则  **约束限制**：  不涉及  **取值范围**： 不涉及  **默认取值**：  不涉及
    *
    * @return $this
    */
