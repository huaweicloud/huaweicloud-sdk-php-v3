...
class StatisticPeriod implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StatisticPeriod';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * endTime  **参数解释**： 结束时间 **约束限制**： 不涉及 **取值范围**： 毫秒级时间戳 **默认取值**： 不涉及
    * startTime  **参数解释**： 结束时间 **约束限制**： 不涉及 **取值范围**： 毫秒级时间戳 **默认取值**： 不涉及
    *
    * @var string[]
    */
    ...
    * Sets startTime
    *
    * @param int|null $startTime **参数解释**： 结束时间 **约束限制**： 不涉及 **取值范围**： 毫秒级时间戳 **默认取值**： 不涉及
    *
    * @return $this
    */
