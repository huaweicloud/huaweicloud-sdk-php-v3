...
class ExportLogsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExportLogsRequestBody';
    ...
    * timeZone  **参数解释**： 时区 **约束限制**： 不涉及 **取值范围**： \"GMT+08:00\" **默认取值**： 不涉及
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['type'] === null) {
            ...
            if (!is_null($this->container['timeZone']) && (mb_strlen($this->container['timeZone']) > 20)) {
                $invalidProperties[] = "invalid value for 'timeZone', the character length must be smaller than or equal to 20.";
            }
    ...
    * Sets timeZone
    *
    * @param string|null $timeZone **参数解释**： 时区 **约束限制**： 不涉及 **取值范围**： \"GMT+08:00\" **默认取值**： 不涉及
    *
    * @return $this
    */
