...
class DeleteIpBlacklistRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteIpBlacklistRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'fwInstanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cfw\V1\Model\IpBlacklistDeleteDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cfw\V1\Model\IpBlacklistDeleteDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cfw\V1\Model\IpBlacklistDeleteDto|null $body body
    *
    * @return $this
    */
