...
class EnableMultiAccountRespData implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'EnableMultiAccountResp_data';
    ...
    * Sets id
    *
    * @param string|null $id **参数解释**： 防火墙ID **取值范围**： 不涉及
    *
    * @return $this
    */
