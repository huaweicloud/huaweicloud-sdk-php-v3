...
class Eip implements ModelInterface, ArrayAccess
{
    ...
    * protected  protected
    * total  **参数解释**： EIP数量 **取值范围**： 不涉及
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'protected' => '\HuaweiCloud\SDK\Cfw\V1\Model\ChangedVO',
            'total' => 'int'
    ];
    ...
    * Sets protected
    *
    * @param \HuaweiCloud\SDK\Cfw\V1\Model\ChangedVO|null $protected protected
    *
    * @return $this
    */
    ...
    * Sets total
    *
    * @param int|null $total **参数解释**： EIP数量 **取值范围**： 不涉及
    *
    * @return $this
    */
