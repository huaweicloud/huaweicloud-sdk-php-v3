...
class AddEipAlarmWhitelistRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddEipAlarmWhitelistRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cfw\V1\Model\AddEipAlarmWhitelistRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cfw\V1\Model\AddEipAlarmWhitelistRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cfw\V1\Model\AddEipAlarmWhitelistRequestBody|null $body body
    *
    * @return $this
    */
