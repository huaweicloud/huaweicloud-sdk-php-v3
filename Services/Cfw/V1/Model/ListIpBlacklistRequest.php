...
class ListIpBlacklistRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListIpBlacklistRequest';
    ...
    * Sets limit
    *
    * @param int $limit 在分页查询的情况下，每页查询的记录条数，范围为1-1024
    *
    * @return $this
    */
    ...
    * Sets offset
    *
    * @param int $offset 数据查询的偏移量，在分页查询的时候使用，指定查询记录的起始位置，必须为数字，取值范围为大于等于0
    *
    * @return $this
    */
