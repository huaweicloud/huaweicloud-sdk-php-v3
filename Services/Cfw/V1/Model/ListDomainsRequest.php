...
class ListDomainsRequest implements ModelInterface, ArrayAccess
{
    ...
    * domainSetId  域名组id，可通过[查询域名组列表接口](ListDomainSets.xml)查询获得，通过返回值中的data.records.set_id（.表示各对象之间层级的区分）获得。
    ...
    * Sets domainName
    *
    * @param string|null $domainName 域名名称，如www.test.com
    *
    * @return $this
    */
