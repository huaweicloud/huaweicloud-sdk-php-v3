...
class IpRegionResponseBodyData implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'IpRegionResponseBodyData';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * regionId  **参数解释**： 区域ID，用于明确规则引用地域，可通过[获取账号、IAM用户、项目、用户组、区域、委托的名称和ID](cfw_02_0030.xml)获取。 **取值范围**： 不涉及
    * descriptionCn  **参数解释**： 区域中文描述，仅当区域为中国区域时使用，可通过[地域信息表](cfw_02_0031.xml)获取 **取值范围**： 不涉及
    * descriptionEn  **参数解释**： 区域英文描述，仅当区域为非中国区域时使用，可通过[地域信息表](cfw_02_0031.xml)获取。 **取值范围**： 不涉及
    * regionType  **参数解释**： 区域类型 **取值范围**： - 0：国家 - 1：省份 - 2：大洲
    * superiorRegionId  **参数解释**： 上级区域ID **取值范围**： 不涉及
    *
    * @var string[]
    */
    ...
    */
    protected static $attributeMap = [
            ...
            'superiorRegionId' => 'superior_region_id'
    ];
    ...
    */
    protected static $setters = [
            ...
            'superiorRegionId' => 'setSuperiorRegionId'
    ];
    ...
    */
    protected static $getters = [
            ...
            'superiorRegionId' => 'getSuperiorRegionId'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['superiorRegionId'] = isset($data['superiorRegionId']) ? $data['superiorRegionId'] : null;
    }
    ...
    * Sets regionId
    *
    * @param string|null $regionId **参数解释**： 区域ID，用于明确规则引用地域，可通过[获取账号、IAM用户、项目、用户组、区域、委托的名称和ID](cfw_02_0030.xml)获取。 **取值范围**： 不涉及
    *
    * @return $this
    */
    ...
    * Sets descriptionCn
    *
    * @param string|null $descriptionCn **参数解释**： 区域中文描述，仅当区域为中国区域时使用，可通过[地域信息表](cfw_02_0031.xml)获取 **取值范围**： 不涉及
    *
    * @return $this
    */
    ...
    * Sets descriptionEn
    *
    * @param string|null $descriptionEn **参数解释**： 区域英文描述，仅当区域为非中国区域时使用，可通过[地域信息表](cfw_02_0031.xml)获取。 **取值范围**： 不涉及
    *
    * @return $this
    */
    ...
    */
    ...
    {
        return $this->container['superiorRegionId'];
    }
    ...
    * @return $this
    */
    public function setSuperiorRegionId($superiorRegionId)
    {
        $this->container['superiorRegionId'] = $superiorRegionId;
        return $this;
    }
