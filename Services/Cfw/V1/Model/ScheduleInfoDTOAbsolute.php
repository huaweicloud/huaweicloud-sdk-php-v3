...
class ScheduleInfoDTOAbsolute implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ScheduleInfoDTO_absolute';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * startTime  **参数解释**： 绝对计划开始时间 **约束限制**： 不涉及 **取值范围**： 时间戳（毫秒级） **默认取值**： 不涉及
    * endTime  **参数解释**： 绝对计划结束时间 **约束限制**： 不涉及 **取值范围**： 时间戳（毫秒级） **默认取值**： 不涉及
    *
    * @var string[]
    */
    ...
    * Sets startTime
    *
    * @param int|null $startTime **参数解释**： 绝对计划开始时间 **约束限制**： 不涉及 **取值范围**： 时间戳（毫秒级） **默认取值**： 不涉及
    *
    * @return $this
    */
    ...
    * Sets endTime
    *
    * @param int|null $endTime **参数解释**： 绝对计划结束时间 **约束限制**： 不涉及 **取值范围**： 时间戳（毫秒级） **默认取值**： 不涉及
    *
    * @return $this
    */
