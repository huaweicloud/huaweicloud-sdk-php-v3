...
class ListServiceItemsRequest implements ModelInterface, ArrayAccess
{
    ...
    * keyWord  查询字段，可为服务组成员名称或服务组成员描述的一部分。
    ...
    * queryServiceSetType  查询服务组类型，0表示自定义服务组，1表示预定义服务组。仅当set_id为预定义服务组id时生效
    *
    * @var string[]
    */
    ...
    * Sets keyWord
    *
    * @param string|null $keyWord 查询字段，可为服务组成员名称或服务组成员描述的一部分。
    *
    * @return $this
    */
    ...
    *
    * @param int|null $queryServiceSetType 查询服务组类型，0表示自定义服务组，1表示预定义服务组。仅当set_id为预定义服务组id时生效
    *
    * @return $this
    */
