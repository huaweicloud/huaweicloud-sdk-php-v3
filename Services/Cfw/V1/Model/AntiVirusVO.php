...
class AntiVirusVO implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AntiVirusVO';
    ...
    *
    * @param int|null $antiVirusStatus 反病毒开关状态，0表示关闭，1表示开启
    *
    * @return $this
    */
