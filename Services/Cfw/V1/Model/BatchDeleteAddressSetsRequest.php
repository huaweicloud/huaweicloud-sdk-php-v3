...
class BatchDeleteAddressSetsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteAddressSetsRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cfw\V1\Model\BatchDeleteAddressSetsDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cfw\V1\Model\BatchDeleteAddressSetsDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cfw\V1\Model\BatchDeleteAddressSetsDto|null $body body
    *
    * @return $this
    */
