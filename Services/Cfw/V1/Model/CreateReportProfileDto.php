...
class CreateReportProfileDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateReportProfileDto';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * category  **参数解释**： 报告类型 **约束限制**： 不涉及 **取值范围**： daily 日报 weekly 周报 custom 自定义报告 **默认取值**： 不涉及
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['name'] === null) {
            ...
            if (!preg_match("/^$|^[a-zA-Z0-9\\u4E00-\\u9FA5_\\s-]{1,255}/", $this->container['name'])) {
    ...
    * Sets category
    *
    * @param string $category **参数解释**： 报告类型 **约束限制**： 不涉及 **取值范围**： daily 日报 weekly 周报 custom 自定义报告 **默认取值**： 不涉及
    *
    * @return $this
    */
