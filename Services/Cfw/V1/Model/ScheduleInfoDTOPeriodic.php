...
class ScheduleInfoDTOPeriodic implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ScheduleInfoDTO_periodic';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * type  **参数解释**： 周期计划类型 **约束限制**： 不涉及 **取值范围**： 0：每天 1：每周的某几天 2：每周的一段时间 **默认取值**： 不涉及
    * startTime  **参数解释**： 周期计划开始时间 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及
    * endTime  **参数解释**： 周期计划结束时间 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及
    * weekMask  **参数解释**： 每周的某几天 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及
    * startWeek  **参数解释**： 每周周期计划开始日 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及
    * endWeek  **参数解释**： 每周周期计划结束日 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['startTime'] === null) {
            ...
            if (!preg_match("/^([01]?[0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9]$/", $this->container['startTime'])) {
                $invalidProperties[] = "invalid value for 'startTime', must be conform to the pattern /^([01]?[0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9]$/.";
            }
        if ($this->container['endTime'] === null) {
            $invalidProperties[] = "'endTime' can't be null";
        }
            if (!preg_match("/^([01]?[0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9]$/", $this->container['endTime'])) {
                $invalidProperties[] = "invalid value for 'endTime', must be conform to the pattern /^([01]?[0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9]$/.";
            }
    ...
    * Sets type
    *
    * @param int $type **参数解释**： 周期计划类型 **约束限制**： 不涉及 **取值范围**： 0：每天 1：每周的某几天 2：每周的一段时间 **默认取值**： 不涉及
    *
    * @return $this
    */
    ...
    * Sets startTime
    *
    * @param string $startTime **参数解释**： 周期计划开始时间 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及
    *
    * @return $this
    */
    ...
    * Sets endTime
    *
    * @param string $endTime **参数解释**： 周期计划结束时间 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及
    *
    * @return $this
    */
    ...
    * Sets weekMask
    *
    * @param int[]|null $weekMask **参数解释**： 每周的某几天 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及
    *
    * @return $this
    */
    ...
    * Sets startWeek
    *
    * @param int|null $startWeek **参数解释**： 每周周期计划开始日 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及
    *
    * @return $this
    */
    ...
    * Sets endWeek
    *
    * @param int|null $endWeek **参数解释**： 每周周期计划结束日 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及
    *
    * @return $this
    */
