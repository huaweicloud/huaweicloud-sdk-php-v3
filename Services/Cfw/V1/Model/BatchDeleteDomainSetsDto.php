...
class BatchDeleteDomainSetsDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteDomainSetsDto';
    ...
    * setIds  **参数解释**： 域名组ID列表，域名组ID，可通过[查询域名组列表接口](ListDomainSets.xml)查询获得，通过返回值中的data.records.set_id（.表示各对象之间层级的区分）获得。 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及
    *
    * @var string[]
    */
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['setIds'] = isset($data['setIds']) ? $data['setIds'] : null;
    }
    ...
    */
    ...
    {
        return $this->container['setIds'];
    }

    /**
    * Sets setIds
    *
    * @param string[]|null $setIds **参数解释**： 域名组ID列表，域名组ID，可通过[查询域名组列表接口](ListDomainSets.xml)查询获得，通过返回值中的data.records.set_id（.表示各对象之间层级的区分）获得。 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及
    *
    * @return $this
    */
    public function setSetIds($setIds)
    {
        $this->container['setIds'] = $setIds;
        return $this;
    }
