...
class BatchDeleteIpsWhiteListRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteIpsWhiteListRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * listIds  **参数解释**：  要删除的白名单ID列表  **约束限制**：  不涉及  **取值范围**：  不涉及  **默认取值**：  不涉及
    *
    * @var string[]
    */
    ...
    * Sets listIds
    *
    * @param string[] $listIds **参数解释**：  要删除的白名单ID列表  **约束限制**：  不涉及  **取值范围**：  不涉及  **默认取值**：  不涉及
    *
    * @return $this
    */
