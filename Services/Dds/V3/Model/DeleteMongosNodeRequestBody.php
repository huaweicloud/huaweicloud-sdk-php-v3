...
class DeleteMongosNodeRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteMongosNodeRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * nodeList  所有需要删除的mongos节点ID，至少保留两个mongos节点。
    *
    * @var string[]
    */
    ...
    * Sets nodeList
    *
    * @param string[] $nodeList 所有需要删除的mongos节点ID，至少保留两个mongos节点。
    *
    * @return $this
    */
