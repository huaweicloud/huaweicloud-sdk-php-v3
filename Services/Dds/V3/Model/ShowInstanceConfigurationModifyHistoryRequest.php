...
class ShowInstanceConfigurationModifyHistoryRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowInstanceConfigurationModifyHistoryRequest';
