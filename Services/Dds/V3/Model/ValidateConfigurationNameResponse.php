...
class ValidateConfigurationNameResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ValidateConfigurationNameResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * isExisted  **参数解释：** 参数组名称是否存在。 **取值范围：** - true：参数组名称存在。 - false：参数组名称不存在。
    *
    * @var string[]
    */
    ...
    * Sets isExisted
    *
    * @param bool|null $isExisted **参数解释：** 参数组名称是否存在。 **取值范围：** - true：参数组名称存在。 - false：参数组名称不存在。
    *
    * @return $this
    */
