...
class ShowAutoEnlargePolicyResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'switchOption' => 'string',
            'policy' => '\HuaweiCloud\SDK\Dds\V3\Model\DiskAutoExpansionPolicy'
    ];
    ...
    *  policy
    *
    * @return \HuaweiCloud\SDK\Dds\V3\Model\DiskAutoExpansionPolicy|null
    */
    ...
    * Sets policy
    *
    * @param \HuaweiCloud\SDK\Dds\V3\Model\DiskAutoExpansionPolicy|null $policy policy
    *
    * @return $this
    */
