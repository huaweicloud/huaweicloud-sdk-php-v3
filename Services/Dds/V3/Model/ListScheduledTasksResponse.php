...
class ListScheduledTasksResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'totalCount' => 'int',
            'schedules' => '\HuaweiCloud\SDK\Dds\V3\Model\ScheduledTasksRspSchedules[]'
    ];
    ...
    * Sets totalCount
    *
    * @param int|null $totalCount 记录数量
    *
    * @return $this
    */
    ...
    *  任务详情
    *
    * @return \HuaweiCloud\SDK\Dds\V3\Model\ScheduledTasksRspSchedules[]|null
    */
    ...
    * Sets schedules
    *
    * @param \HuaweiCloud\SDK\Dds\V3\Model\ScheduledTasksRspSchedules[]|null $schedules 任务详情
    *
    * @return $this
    */
