...
class EnableDefensePolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'EnableDefensePolicyRequest';
    ...
    */
    protected static $openAPITypes = [
            'floatingIpId' => 'string',
            'body' => '\HuaweiCloud\SDK\AntiDDoS\V1\Model\OpenAntiDDosServiceRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\AntiDDoS\V1\Model\OpenAntiDDosServiceRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\AntiDDoS\V1\Model\OpenAntiDDosServiceRequestBody|null $body body
    *
    * @return $this
    */
