...
class ListDDosStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * ips  IP地址，支持IPv4格式和IPv6格式输入，支持部分查询。例如“？ip=192.168”，会返回192.168.111.1和10.192.168.8所对应的EIP防护状态。
    *
    * @var string[]
    */
    ...
    * Sets ips
    *
    * @param string|null $ips IP地址，支持IPv4格式和IPv6格式输入，支持部分查询。例如“？ip=192.168”，会返回192.168.111.1和10.192.168.8所对应的EIP防护状态。
    *
    * @return $this
    */
