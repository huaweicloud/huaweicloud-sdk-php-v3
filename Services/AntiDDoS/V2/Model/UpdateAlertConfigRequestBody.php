...
class UpdateAlertConfigRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'displayName' => 'string',
            'topicUrn' => 'string',
            'warnConfig' => '\HuaweiCloud\SDK\AntiDDoS\V2\Model\WarnConfig'
    ];
    ...
    *  warnConfig
    *
    * @return \HuaweiCloud\SDK\AntiDDoS\V2\Model\WarnConfig
    */
    ...
    * Sets warnConfig
    *
    * @param \HuaweiCloud\SDK\AntiDDoS\V2\Model\WarnConfig $warnConfig warnConfig
    *
    * @return $this
    */
