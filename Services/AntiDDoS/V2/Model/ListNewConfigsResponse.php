...
class ListNewConfigsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'trafficLimitedList' => '\HuaweiCloud\SDK\AntiDDoS\V2\Model\TriggerBpsDict[]',
            'httpLimitedList' => '\HuaweiCloud\SDK\AntiDDoS\V2\Model\TriggerQpsDict[]',
            'connectionLimitedList' => '\HuaweiCloud\SDK\AntiDDoS\V2\Model\CleanLimitDict[]',
            'extendDdosConfig' => '\HuaweiCloud\SDK\AntiDDoS\V2\Model\ExtendDDoSSet[]'
    ];
    ...
    *  流量限制列表
    *
    * @return \HuaweiCloud\SDK\AntiDDoS\V2\Model\TriggerBpsDict[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\AntiDDoS\V2\Model\TriggerBpsDict[]|null $trafficLimitedList 流量限制列表
    *
    * @return $this
    */
    ...
    *  HTTP限制列表
    *
    * @return \HuaweiCloud\SDK\AntiDDoS\V2\Model\TriggerQpsDict[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\AntiDDoS\V2\Model\TriggerQpsDict[]|null $httpLimitedList HTTP限制列表
    *
    * @return $this
    */
    ...
    *  连接数限制列表
    *
    * @return \HuaweiCloud\SDK\AntiDDoS\V2\Model\CleanLimitDict[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\AntiDDoS\V2\Model\CleanLimitDict[]|null $connectionLimitedList 连接数限制列表
    *
    * @return $this
    */
    ...
    *  扩展配置列表
    *
    * @return \HuaweiCloud\SDK\AntiDDoS\V2\Model\ExtendDDoSSet[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\AntiDDoS\V2\Model\ExtendDDoSSet[]|null $extendDdosConfig 扩展配置列表
    *
    * @return $this
    */
