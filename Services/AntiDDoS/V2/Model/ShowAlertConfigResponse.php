...
class ShowAlertConfigResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'topicUrn' => 'string',
            'displayName' => 'string',
            'warnConfig' => '\HuaweiCloud\SDK\AntiDDoS\V2\Model\AlertConfigRespWarnConfig'
    ];
    ...
    *  warnConfig
    *
    * @return \HuaweiCloud\SDK\AntiDDoS\V2\Model\AlertConfigRespWarnConfig|null
    */
    ...
    * Sets warnConfig
    *
    * @param \HuaweiCloud\SDK\AntiDDoS\V2\Model\AlertConfigRespWarnConfig|null $warnConfig warnConfig
    *
    * @return $this
    */
