...
class GrantDTO implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GrantDTO';
    ...
    */
    protected static $openAPITypes = [
            ...
            'name' => 'string',
            'type' => 'string',
            'granteeUser' => '\HuaweiCloud\SDK\Csms\V1\Model\GrantUserInfo[]',
            'createTime' => 'int',
            'updateTime' => 'int'
    ];
    ...
    * Sets type
    *
    * @param string|null $type 授权类型（SECRET，GROUP）
    *
    * @return $this
    */
    ...
    *  被授权用户信息
    *
    * @return \HuaweiCloud\SDK\Csms\V1\Model\GrantUserInfo[]
    */
    ...
    * Sets granteeUser
    *
    * @param \HuaweiCloud\SDK\Csms\V1\Model\GrantUserInfo[] $granteeUser 被授权用户信息
    *
    * @return $this
    */
