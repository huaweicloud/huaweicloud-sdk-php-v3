...
class UsersDetailsResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UsersDetailsResult';
    ...
    * Sets disabled
    *
    * @param string|null $disabled 是否禁用。
    *
    * @return $this
    */
    ...
    * Sets extension
    *
    * @param string|null $extension 自定义扩展属性。
    *
    * @return $this
    */
