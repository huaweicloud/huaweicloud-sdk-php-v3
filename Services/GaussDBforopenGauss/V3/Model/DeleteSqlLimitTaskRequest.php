...
class DeleteSqlLimitTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteSqlLimitTaskRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * taskId  **参数解释**: 限流任务ID。 **约束限制**: 不涉及。 **取值范围**: 不涉及。 **默认取值**: 不涉及。
    ...
    */
    protected static $openAPITypes = [
            ...
            'instanceId' => 'string',
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\DeleteSqlLimitTaskRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\DeleteSqlLimitTaskRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\DeleteSqlLimitTaskRequestBody|null $body body
    *
    * @return $this
    */
