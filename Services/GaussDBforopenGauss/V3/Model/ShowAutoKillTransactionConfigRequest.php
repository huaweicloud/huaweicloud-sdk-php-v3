...
class ShowAutoKillTransactionConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAutoKillTransactionConfigRequest';
    ...
    * type  **参数解释**: 自动查杀配置类型。 **约束限制**: 不涉及。 **取值范围**: - exec_time：代表长事务。 - xlog_quantity：代表大事务。  **默认取值**: 不涉及。
    *
    * @var string[]
    */
