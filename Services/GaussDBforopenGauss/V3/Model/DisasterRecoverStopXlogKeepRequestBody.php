...
class DisasterRecoverStopXlogKeepRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DisasterRecoverStopXlogKeepRequestBody';
