...
class CreateLimitTaskNodeResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateLimitTaskNodeResult';
    ...
    * Sets sqlId
    *
    * @param string|null $sqlId 该节点执行的sql语句id。
    *
    * @return $this
    */
