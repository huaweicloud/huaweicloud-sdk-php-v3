...
class ShowUpgradeCandidateVersionsDetailsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowUpgradeCandidateVersionsDetailsRequest';
