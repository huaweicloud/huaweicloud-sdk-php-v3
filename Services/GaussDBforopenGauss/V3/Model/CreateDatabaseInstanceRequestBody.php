...
class CreateDatabaseInstanceRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateDatabaseInstanceRequestBody';
    ...
    * replicaNum  实例副本数，支持取值3。不填默认为3。仅支持V2.0-1.3.0及以上版本的实例。
    * enableForceSwitch  enable_force_switch表示是否开启备机强升主功能，enable_force_switch=true表示开启备机强升主功能，enable_force_switch=false表示关闭，默认关闭。仅支持V2.0-1.2.2及以上版本。  说明：  备机强升主功能适用场景：在主机发生故障后，为了保障集群的可用性，强制拉起备机作为新主机对外提供服务的场景。 本功能在集群故障状态下，以丢失部分数据为代价换取集群尽可能快的恢复服务。本功能是集群状态为不可用时的一个逃生方法，如果操作者不清楚备机强升后丢失数据对业务的影响，请勿使用本功能。 备机强升主相关介绍请参考《故障处理》备机强升主章节。
    * enableSingleFloatIp  单浮动IP策略，仅主备版支持。默认值是false，表示不开启单浮动IP策略。 取值范围： true：开启单浮动IP策略，实例将只有一个浮动IP绑定主节点，如果发生主备倒换，浮动IP不会发生变化。 false：不开启单浮动IP策略，每个节点都会绑定一个浮动IP，如果发生主备倒换，浮动IP会发生变化。 说明： 仅支持V2.0-3.206及以上版本的主备版实例。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'name' => 'string',
            'datastore' => '\HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\CreateInstanceDatastoreOption',
    ...
    */
    protected static $attributeMap = [
            ...
            'enableSingleFloatIp' => 'enable_single_float_ip'
    ];
    ...
    */
    protected static $setters = [
            ...
            'enableSingleFloatIp' => 'setEnableSingleFloatIp'
    ];
    ...
    */
    protected static $getters = [
            ...
            'enableSingleFloatIp' => 'getEnableSingleFloatIp'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['enableSingleFloatIp'] = isset($data['enableSingleFloatIp']) ? $data['enableSingleFloatIp'] : null;
    }
    ...
    *  datastore
    *
    * @return \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\CreateInstanceDatastoreOption
    */
    ...
    * Sets datastore
    *
    * @param \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\CreateInstanceDatastoreOption $datastore datastore
    *
    * @return $this
    */
    ...
    * Sets replicaNum
    *
    * @param int|null $replicaNum 实例副本数，支持取值3。不填默认为3。仅支持V2.0-1.3.0及以上版本的实例。
    *
    * @return $this
    */
    ...
    *
    * @param bool|null $enableForceSwitch enable_force_switch表示是否开启备机强升主功能，enable_force_switch=true表示开启备机强升主功能，enable_force_switch=false表示关闭，默认关闭。仅支持V2.0-1.2.2及以上版本。  说明：  备机强升主功能适用场景：在主机发生故障后，为了保障集群的可用性，强制拉起备机作为新主机对外提供服务的场景。 本功能在集群故障状态下，以丢失部分数据为代价换取集群尽可能快的恢复服务。本功能是集群状态为不可用时的一个逃生方法，如果操作者不清楚备机强升后丢失数据对业务的影响，请勿使用本功能。 备机强升主相关介绍请参考《故障处理》备机强升主章节。
    *
    * @return $this
    */
    ...
    * @return bool|null
    */
    public function getEnableSingleFloatIp()
    {
        return $this->container['enableSingleFloatIp'];
    }

    /**
    * Sets enableSingleFloatIp
    *
    * @param bool|null $enableSingleFloatIp 单浮动IP策略，仅主备版支持。默认值是false，表示不开启单浮动IP策略。 取值范围： true：开启单浮动IP策略，实例将只有一个浮动IP绑定主节点，如果发生主备倒换，浮动IP不会发生变化。 false：不开启单浮动IP策略，每个节点都会绑定一个浮动IP，如果发生主备倒换，浮动IP会发生变化。 说明： 仅支持V2.0-3.206及以上版本的主备版实例。
    *
    * @return $this
    */
    public function setEnableSingleFloatIp($enableSingleFloatIp)
    {
        $this->container['enableSingleFloatIp'] = $enableSingleFloatIp;
        return $this;
    }
