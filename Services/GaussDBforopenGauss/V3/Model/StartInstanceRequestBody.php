...
class StartInstanceRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StartInstanceRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * nodeIds  需要启动的节点的ID，取值不能为null，如果为空列表则启动整个实例
    *
    * @var string[]
    */
    ...
    * Sets nodeIds
    *
    * @param string[] $nodeIds 需要启动的节点的ID，取值不能为null，如果为空列表则启动整个实例
    *
    * @return $this
    */
