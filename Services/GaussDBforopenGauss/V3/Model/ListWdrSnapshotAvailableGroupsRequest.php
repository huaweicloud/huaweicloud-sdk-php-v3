...
class ListWdrSnapshotAvailableGroupsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListWdrSnapshotAvailableGroupsRequest';
    ...
    * beginTime  **参数解释**: 开始时间。 **约束限制**: 不涉及。 **取值范围**: 格式为“yyyy-mm-ddThh:mm:ssZ”。注意，对于时区的+号，需要进行编码，替换为%2B。 **默认取值**: 不涉及。
    * endTime  **参数解释**: 结束时间。 **约束限制**: 不涉及。 **取值范围**: 格式为“yyyy-mm-ddThh:mm:ssZ”。对于时区的+号，需要进行编码，替换为%2B。 **默认取值**: 不涉及。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['instanceId'] === null) {
            ...
            if (!preg_match("/^[a-zA-Z0-9-_]{32}in(14|20)$/", $this->container['instanceId'])) {
                $invalidProperties[] = "invalid value for 'instanceId', must be conform to the pattern /^[a-zA-Z0-9-_]{32}in(14|20)$/.";
            }
    ...
    * Sets beginTime
    *
    * @param string $beginTime **参数解释**: 开始时间。 **约束限制**: 不涉及。 **取值范围**: 格式为“yyyy-mm-ddThh:mm:ssZ”。注意，对于时区的+号，需要进行编码，替换为%2B。 **默认取值**: 不涉及。
    *
    * @return $this
    */
    ...
    * Sets endTime
    *
    * @param string $endTime **参数解释**: 结束时间。 **约束限制**: 不涉及。 **取值范围**: 格式为“yyyy-mm-ddThh:mm:ssZ”。对于时区的+号，需要进行编码，替换为%2B。 **默认取值**: 不涉及。
    *
    * @return $this
    */
