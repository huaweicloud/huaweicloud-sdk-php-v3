...
class ShowInstancesStatisticsResponse implements ModelInterface, ArrayAccess
{
    ...
    * totalCount  **参数解释**: 实例总数。 **取值范围**: 不涉及。
    * instancesStatistics  **参数解释**: 实例统计信息。 **取值范围**: 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets totalCount
    *
    * @param int|null $totalCount **参数解释**: 实例总数。 **取值范围**: 不涉及。
    *
    * @return $this
    */
    ...
    *
    * @param \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\InstancesStatisticsResponseBodyInstancesStatistics[]|null $instancesStatistics **参数解释**: 实例统计信息。 **取值范围**: 不涉及。
    *
    * @return $this
    */
