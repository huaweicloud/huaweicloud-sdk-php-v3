...
class ListReadonlyNodesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListReadonlyNodesResponse';
    ...
    */
    ...
    /**
    * Gets maxReadonlyNodeNum
    *  **参数解释**: 数据库名称。 **取值范围**: 不涉及。
    *
    * @return int|null
    */
    public function getMaxReadonlyNodeNum()
    {
        return $this->container['maxReadonlyNodeNum'];
    }

    /**
    * Sets maxReadonlyNodeNum
    *
    * @param int|null $maxReadonlyNodeNum **参数解释**: 数据库名称。 **取值范围**: 不涉及。
    *
    * @return $this
    */
    public function setMaxReadonlyNodeNum($maxReadonlyNodeNum)
    {
        $this->container['maxReadonlyNodeNum'] = $maxReadonlyNodeNum;
        return $this;
    }
