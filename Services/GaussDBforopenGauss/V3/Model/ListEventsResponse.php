...
class ListEventsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'executingCount' => 'int',
            'failedCount' => 'int',
            'events' => '\HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\ScheduleEventInfoResult[]'
    ];
    ...
    *  **参数解释**: 事件详情列表。
    *
    * @return \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\ScheduleEventInfoResult[]|null
    */
    ...
    * Sets events
    *
    * @param \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\ScheduleEventInfoResult[]|null $events **参数解释**: 事件详情列表。
    *
    * @return $this
    */
