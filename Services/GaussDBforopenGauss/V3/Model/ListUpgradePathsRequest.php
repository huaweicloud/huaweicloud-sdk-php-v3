...
class ListUpgradePathsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListUpgradePathsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * xLanguage  **参数解释**: 语言。 **约束限制**: 不涉及。 **取值范围**: - zh-cn  - en-us  **默认取值**: en-us
    * sourceVersion  **参数解释**: 源引擎版本号。 **约束限制**: 不涉及 **取值范围**: 不涉及 **默认取值**: 不涉及。
    * targetVersion  **参数解释**: 目标引擎版本号。 **约束限制**: 不涉及 **取值范围**: 不涉及 **默认取值**: 不涉及。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sourceVersion'] === null) {
            $invalidProperties[] = "'sourceVersion' can't be null";
        }
    ...
    * Sets targetVersion
    *
    * @param string|null $targetVersion **参数解释**: 目标引擎版本号。 **约束限制**: 不涉及 **取值范围**: 不涉及 **默认取值**: 不涉及。
    *
    * @return $this
    */
