...
class DeleteHbaConfRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteHbaConfRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * hbaConfs  **参数解释**: 需要删除的hba配置信息。 **取值范围**: 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets hbaConfs
    *
    * @param \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\HbaConfOption[] $hbaConfs **参数解释**: 需要删除的hba配置信息。 **取值范围**: 不涉及。
    *
    * @return $this
    */
