...
class DisasterRecoverStartSimulationRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DisasterRecoverStartSimulationRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * xlogKeepRatio  主实例下发容灾演练时必填，备实例下发容灾演练是不必填   - 日志保留空间占可使用剩余磁盘容量的比例, 可设置范围为1-100。
    * disasterType  容灾类型。
    *
    * @var string[]
    */
    ...
    * Sets xlogKeepRatio
    *
    * @param int|null $xlogKeepRatio 主实例下发容灾演练时必填，备实例下发容灾演练是不必填   - 日志保留空间占可使用剩余磁盘容量的比例, 可设置范围为1-100。
    *
    * @return $this
    */
