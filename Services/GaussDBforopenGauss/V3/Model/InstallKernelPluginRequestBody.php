...
class InstallKernelPluginRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'InstallKernelPluginRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * pluginName  插件名称
    * url  插件安装包链接
    * sha256  插件安装包的sha256值
    *
    * @var string[]
    */
    ...
    * Sets sha256
    *
    * @param string $sha256 插件安装包的sha256值
    *
    * @return $this
    */
