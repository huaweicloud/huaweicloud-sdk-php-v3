...
class EventScheduleWindowOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'EventScheduleWindowOption';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * plannedDay  **参数解释**: 计划执行日期，格式为yyyy-MM-dd。 **约束限制**: 不涉及。 **取值范围**: 不涉及。 **默认取值**: 不涉及。
    ...
    * Sets plannedDay
    *
    * @param string $plannedDay **参数解释**: 计划执行日期，格式为yyyy-MM-dd。 **约束限制**: 不涉及。 **取值范围**: 不涉及。 **默认取值**: 不涉及。
    *
    * @return $this
    */
