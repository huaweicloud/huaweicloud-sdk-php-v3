...
class ListLtsConfigsResponse implements ModelInterface, ArrayAccess
{
    ...
    * instanceLtsConfigs  **参数解释**: 实例下Lts明细列表。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalCount' => 'int',
            'instanceLtsConfigs' => '\HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\InstanceLtsLogConfigResult[]'
    ];
    ...
    *  **参数解释**: 实例下Lts明细列表。
    *
    * @return \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\InstanceLtsLogConfigResult[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\InstanceLtsLogConfigResult[]|null $instanceLtsConfigs **参数解释**: 实例下Lts明细列表。
    *
    * @return $this
    */
