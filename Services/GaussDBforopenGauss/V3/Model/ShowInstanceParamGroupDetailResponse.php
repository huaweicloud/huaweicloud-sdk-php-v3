...
class ShowInstanceParamGroupDetailResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowInstanceParamGroupDetailResponse';
