...
class AllowDbRolePrivilegesRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AllowDbRolePrivilegesRequestBody';
    ...
    * Sets dbName
    *
    * @param string $dbName 数据库名称。 不能使用模板库，且是已存在的数据库名称。 模板库包括postgres， template0 ，template1，templatea，template_pdb，templatem。
    *
    * @return $this
    */
