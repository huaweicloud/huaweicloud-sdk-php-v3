...
class InstanceSaveLtsConfigOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'InstanceSaveLtsConfigOption';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  **参数解释**: 实例ID。 **约束限制**: 不涉及。 **取值范围**: 不涉及。 **默认取值**: 不涉及。
    * logType  **参数解释**: 日志类型。 **约束限制**: 不涉及。 **取值范围**: - audit_log：审计日志。  **默认取值**: 不涉及。
    * ltsGroupId  **参数解释**: LTS日志组ID。 **约束限制**: 不涉及。 **取值范围**: 可通过云日志服务-\"查询账号下所有日志组\"API接口获取。 **默认取值**: 不涉及。
    * ltsStreamId  **参数解释**: LTS日志流ID。 **约束限制**: 不涉及。 **取值范围**: 可通过云日志服务-”查询指定日志组下的所有日志流“API接口获取。 **默认取值**: 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets logType
    *
    * @param string $logType **参数解释**: 日志类型。 **约束限制**: 不涉及。 **取值范围**: - audit_log：审计日志。  **默认取值**: 不涉及。
    *
    * @return $this
    */
    ...
    * Sets ltsGroupId
    *
    * @param string $ltsGroupId **参数解释**: LTS日志组ID。 **约束限制**: 不涉及。 **取值范围**: 可通过云日志服务-\"查询账号下所有日志组\"API接口获取。 **默认取值**: 不涉及。
    *
    * @return $this
    */
    ...
    * Sets ltsStreamId
    *
    * @param string $ltsStreamId **参数解释**: LTS日志流ID。 **约束限制**: 不涉及。 **取值范围**: 可通过云日志服务-”查询指定日志组下的所有日志流“API接口获取。 **默认取值**: 不涉及。
    *
    * @return $this
    */
