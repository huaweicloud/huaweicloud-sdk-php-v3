...
class ListEnterpriseProjectsRequest implements ModelInterface, ArrayAccess
{
    ...
    * nameKeyword  **参数解释**: 企业项目名称关键字。 **约束限制**: 不涉及。 **取值范围**: 不涉及。 **默认取值**: 不涉及。
    * offset  **参数解释**: 索引位置，偏移量。从第一条数据偏移offset条数据后开始查询。 **约束限制**: 必须为数字，不能为负数。 **取值范围**: 不涉及。 **默认取值**: 默认为0（偏移0条数据，表示从第一条数据开始查询）。
    * limit  **参数解释**: 查询记录数。 **约束限制**: 不能为负数。 **取值范围**: 最小值为1，最大值为1000。 **默认取值**: 100
    *
    * @var string[]
    */
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['nameKeyword'] = isset($data['nameKeyword']) ? $data['nameKeyword'] : null;
    ...
    */
    ...
    {
        return $this->container['nameKeyword'];
    }

    /**
    * Sets nameKeyword
    *
    * @param string|null $nameKeyword **参数解释**: 企业项目名称关键字。 **约束限制**: 不涉及。 **取值范围**: 不涉及。 **默认取值**: 不涉及。
    *
    * @return $this
    */
    public function setNameKeyword($nameKeyword)
    {
        $this->container['nameKeyword'] = $nameKeyword;
        return $this;
    }
    ...
    * Sets limit
    *
    * @param int|null $limit **参数解释**: 查询记录数。 **约束限制**: 不能为负数。 **取值范围**: 最小值为1，最大值为1000。 **默认取值**: 100
    *
    * @return $this
    */
