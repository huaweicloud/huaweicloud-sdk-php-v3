...
class SwitchLoggerReplicaAvailabilityZonesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SwitchLoggerReplicaAvailabilityZonesRequest';
