...
class ListHbaInfoHistoryResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListHbaInfoHistoryResponse';
    ...
    * Sets totalCount
    *
    * @param int|null $totalCount **参数解释**: hba配置总数。 **取值范围**: 不涉及。
    *
    * @return $this
    */
