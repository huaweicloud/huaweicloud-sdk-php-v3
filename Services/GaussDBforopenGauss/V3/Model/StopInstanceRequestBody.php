...
class StopInstanceRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StopInstanceRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * nodeIds  需要停止的节点的ID，取值不能为null，如果为空列表则停止整个实例
    *
    * @var string[]
    */
    ...
    * Sets nodeIds
    *
    * @param string[] $nodeIds 需要停止的节点的ID，取值不能为null，如果为空列表则停止整个实例
    *
    * @return $this
    */
