...
class ListNodeLimitSqlModelRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListNodeLimitSqlModelRequest';
    ...
    * Sets sqlModel
    *
    * @param string|null $sqlModel sql模板。
    *
    * @return $this
    */
