...
class DatabaseVersionResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DatabaseVersionResult';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * softwareVersion  **参数解释**： 数据库三位引擎版本。 **取值范围**： 不涉及。
    * hotfixes  **参数解释**： 数据库三位引擎版本对应的热补丁信息。 **取值范围**： 不涉及。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'softwareVersion' => 'string',
            'hotfixes' => '\HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\DbHotfixInfoResult[]'
    ];
