...
class ShowBatchUpgradeCandidateVersionsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowBatchUpgradeCandidateVersionsResponse';
