...
class ListInstancesResult implements ModelInterface, ArrayAccess
{
    ...
    * id  实例ID。
    * name  创建的实例名称。
    * status  实例状态。  取值：  值为“BUILD”，表示实例正在创建。  值为“ACTIVE”，表示实例正常。  值为“FAILED”，表示实例异常。  值为“FROZEN”，表示实例冻结。  值为“EXPANDING”，表示实例正在扩容CN或DN。  值为“REBOOTING”，表示实例正在重启。  值为“UPGRADING”，表示实例正在升级。  值为“RESTORING”，表示实例正在恢复。  值为“BACKING UP”，表示实例正在进行备份。  值为“REDUCING REPLICATION”，表示实例正在降副本。  值为“STORAGE FULL”，表示实例磁盘空间满。  值为“REPAIRING”，表示实例正在修复。
    ...
    * mysqlCompatibility  mysqlCompatibility
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'replicaNum' => 'int',
            'region' => 'string',
            'datastore' => '\HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\ListInstanceDatastore',
            'created' => 'string',
            'updated' => 'string',
            'dbUserName' => 'string',
            'vpcId' => 'string',
            ...
            'diskUsage' => 'string',
            'mysqlCompatibility' => '\HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\MySQLCompatibilityResult'
    ];
    ...
    */
    protected static $attributeMap = [
            ...
            'mysqlCompatibility' => 'mysql_compatibility'
    ];
    ...
    */
    protected static $setters = [
            ...
            'mysqlCompatibility' => 'setMysqlCompatibility'
    ];
    ...
    */
    protected static $getters = [
            ...
            'mysqlCompatibility' => 'getMysqlCompatibility'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['mysqlCompatibility'] = isset($data['mysqlCompatibility']) ? $data['mysqlCompatibility'] : null;
    }
    ...
    * Sets status
    *
    * @param string $status 实例状态。  取值：  值为“BUILD”，表示实例正在创建。  值为“ACTIVE”，表示实例正常。  值为“FAILED”，表示实例异常。  值为“FROZEN”，表示实例冻结。  值为“EXPANDING”，表示实例正在扩容CN或DN。  值为“REBOOTING”，表示实例正在重启。  值为“UPGRADING”，表示实例正在升级。  值为“RESTORING”，表示实例正在恢复。  值为“BACKING UP”，表示实例正在进行备份。  值为“REDUCING REPLICATION”，表示实例正在降副本。  值为“STORAGE FULL”，表示实例磁盘空间满。  值为“REPAIRING”，表示实例正在修复。
    *
    * @return $this
    */
    ...
    *  datastore
    *
    * @return \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\ListInstanceDatastore
    */
    ...
    * Sets datastore
    *
    * @param \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\ListInstanceDatastore $datastore datastore
    *
    * @return $this
    */
    ...
    */
    ...
    /**
    * Gets mysqlCompatibility
    *  mysqlCompatibility
    *
    * @return \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\MySQLCompatibilityResult|null
    */
    public function getMysqlCompatibility()
    {
        return $this->container['mysqlCompatibility'];
    }

    /**
    * Sets mysqlCompatibility
    *
    * @param \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\MySQLCompatibilityResult|null $mysqlCompatibility mysqlCompatibility
    *
    * @return $this
    */
    public function setMysqlCompatibility($mysqlCompatibility)
    {
        $this->container['mysqlCompatibility'] = $mysqlCompatibility;
        return $this;
    }
