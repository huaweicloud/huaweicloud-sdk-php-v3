...
class ReduceCnRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ReduceCnRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * nodeIdList  **参数解释**： 缩容节点ID集合。 **约束限制**： 不涉及。
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['nodeIdList'] === null) {
            $invalidProperties[] = "'nodeIdList' can't be null";
        }
    ...
    * Sets nodeIdList
    *
    * @param string[] $nodeIdList **参数解释**： 缩容节点ID集合。 **约束限制**： 不涉及。
    *
    * @return $this
    */
