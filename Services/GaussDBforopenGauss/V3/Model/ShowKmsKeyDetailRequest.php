...
class ShowKmsKeyDetailRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowKmsKeyDetailRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * xLanguage  **参数解释**: 语言。 **约束限制**: 不涉及。 **取值范围**: - zh-cn  - en-us  **默认取值**: en-us
    * kmsKeyId  **参数解释**: kms秘钥ID。 **约束限制**: 不涉及。 **取值范围**: 不涉及。 **默认取值**: 不涉及。
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['kmsKeyId'] === null) {
            $invalidProperties[] = "'kmsKeyId' can't be null";
        }
