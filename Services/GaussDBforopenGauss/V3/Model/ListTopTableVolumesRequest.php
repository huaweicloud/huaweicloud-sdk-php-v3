...
class ListTopTableVolumesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTopTableVolumesRequest';
    ...
    * jobId  **参数解释**: 工作流ID。 **约束限制**: 不涉及 **取值范围**: 不涉及 **默认取值**: 不涉及。
    * nodeId  **参数解释**: 工作流执行节点ID。 **约束限制**: 不涉及 **取值范围**: 不涉及 **默认取值**: 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets jobId
    *
    * @param string|null $jobId **参数解释**: 工作流ID。 **约束限制**: 不涉及 **取值范围**: 不涉及 **默认取值**: 不涉及。
    *
    * @return $this
    */
    ...
    * Sets nodeId
    *
    * @param string|null $nodeId **参数解释**: 工作流执行节点ID。 **约束限制**: 不涉及 **取值范围**: 不涉及 **默认取值**: 不涉及。
    *
    * @return $this
    */
