...
class ShowCrossCloudDisasterInstanceMonitorRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowCrossCloudDisasterInstanceMonitorRequest';
