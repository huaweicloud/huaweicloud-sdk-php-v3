...
class CollectAspRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CollectAspRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * startTime  **参数解释**: 采集开始时间，格式为“yyyy-mm-ddThh:mm:ssZ”。其中，T指某个时间的开始；Z指时区偏移量，例如北京时间偏移显示为+0800。 **约束限制**: 不涉及。 **取值范围**: 当前时间前两天的时间。 **默认取值**: 不涉及。
    * endTime  **参数解释**: 采集结束时间，格式为“yyyy-mm-ddThh:mm:ssZ”。其中，T指某个时间的开始；Z指时区偏移量，例如北京时间偏移显示为+0800。 **约束限制**: 不涉及。 **取值范围**: 当前时间前两天的时间。 **默认取值**: 不涉及。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['startTime'] === null) {
            ...
            if (!preg_match("/^[a-zA-Z:+.\\s\\-0-9]{0,64}$/", $this->container['startTime'])) {
        ...
        if ($this->container['endTime'] === null) {
            ...
            if (!preg_match("/^[a-zA-Z:+.\\s\\-0-9]{0,64}$/", $this->container['endTime'])) {
    ...
    * Sets startTime
    *
    * @param string $startTime **参数解释**: 采集开始时间，格式为“yyyy-mm-ddThh:mm:ssZ”。其中，T指某个时间的开始；Z指时区偏移量，例如北京时间偏移显示为+0800。 **约束限制**: 不涉及。 **取值范围**: 当前时间前两天的时间。 **默认取值**: 不涉及。
    *
    * @return $this
    */
    ...
    * Sets endTime
    *
    * @param string $endTime **参数解释**: 采集结束时间，格式为“yyyy-mm-ddThh:mm:ssZ”。其中，T指某个时间的开始；Z指时区偏移量，例如北京时间偏移显示为+0800。 **约束限制**: 不涉及。 **取值范围**: 当前时间前两天的时间。 **默认取值**: 不涉及。
    *
    * @return $this
    */
