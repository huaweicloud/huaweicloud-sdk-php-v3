...
class UpdateAgencyPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * agencyName  **参数解释**: 委托名称 **约束限制**: 不涉及。 **取值范围**: RDSAccessProjectResource **默认取值**: RDSAccessProjectResource
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'xLanguage' => 'string',
            'agencyName' => 'string',
            'body' => '\HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\UpdateAgencyPolicyRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\UpdateAgencyPolicyRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\UpdateAgencyPolicyRequestBody|null $body body
    *
    * @return $this
    */
