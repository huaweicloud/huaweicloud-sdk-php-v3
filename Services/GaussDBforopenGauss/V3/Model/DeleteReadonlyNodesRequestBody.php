...
class DeleteReadonlyNodesRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteReadonlyNodesRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * nodeIds  **参数解释**: 即将删除的只读节点ID列表。 **约束限制**: 不涉及。 **取值范围**： 不涉及。 **默认取值**: 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets nodeIds
    *
    * @param string[] $nodeIds **参数解释**: 即将删除的只读节点ID列表。 **约束限制**: 不涉及。 **取值范围**： 不涉及。 **默认取值**: 不涉及。
    *
    * @return $this
    */
