...
class ListNodeLimitSqlModelResponseResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListNodeLimitSqlModelResponseResult';
    ...
    * Sets sqlId
    *
    * @param string|null $sqlId 限流任务SQL_ID。
    *
    * @return $this
    */
    ...
    * Sets sqlModel
    *
    * @param string|null $sqlModel 限流任务SQL模板。
    *
    * @return $this
    */
