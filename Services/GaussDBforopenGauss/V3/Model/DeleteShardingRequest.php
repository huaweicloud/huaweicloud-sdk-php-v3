...
class DeleteShardingRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteShardingRequest';
    ...
    */
    protected static $openAPITypes = [
            'xLanguage' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\ReduceDnRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\ReduceDnRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\ReduceDnRequestBody|null $body body
    *
    * @return $this
    */
