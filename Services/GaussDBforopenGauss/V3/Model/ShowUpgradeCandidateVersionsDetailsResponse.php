...
class ShowUpgradeCandidateVersionsDetailsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowUpgradeCandidateVersionsDetailsResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'hotfixUpgradeInfos' => '\HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\CanBeUpgradedHotfixDetail[]',
            'hotfixRollbackInfos' => '\HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\CanBeRollbackedHotfixDetail[]'
    ];
    ...
    *  可以升级的热补丁信息。
    *
    * @return \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\CanBeUpgradedHotfixDetail[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\CanBeUpgradedHotfixDetail[]|null $hotfixUpgradeInfos 可以升级的热补丁信息。
    *
    * @return $this
    */
    ...
    *  可以回滚的热补丁信息。
    *
    * @return \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\CanBeRollbackedHotfixDetail[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\CanBeRollbackedHotfixDetail[]|null $hotfixRollbackInfos 可以回滚的热补丁信息。
    *
    * @return $this
    */
