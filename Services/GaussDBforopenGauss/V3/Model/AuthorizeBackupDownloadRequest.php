...
class AuthorizeBackupDownloadRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AuthorizeBackupDownloadRequest';
    ...
    * backupId  **参数解释**: 备份ID。 **约束限制**: 不涉及。 **取值范围**: 不涉及。 **默认取值**: 不涉及。
    *
    * @var string[]
    */
