...
class ScheduleEventInfoResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ScheduleEventInfoResult';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  **参数解释**: 事件ID。 **取值范围**: 不涉及。
    * instanceId  **参数解释**: 实例ID。 **取值范围**: 不涉及。
    * instanceName  **参数解释**: 实例名称。 **取值范围**: 不涉及。
    * dbType  **参数解释**: 数据库类型。 **取值范围**: 不涉及。
    * createdTime  **参数解释**: 创建时间，格式为\"yyyy-mm-ddThh:mm:ssZ\"。其中，T指某个时间的开始；Z指时区偏移量，例如北京时间偏移显示为+0800。 **取值范围**: 不涉及。
    * updateTime  **参数解释**: 更新时间，格式为\"yyyy-mm-ddThh:mm:ssZ\"。其中，T指某个时间的开始；Z指时区偏移量，例如北京时间偏移显示为+0800。 **取值范围**: 不涉及。
    * type  **参数解释**: 事件类型。 **取值范围**: - RESTAT_NODE：重启实例节点
    * impact  **参数解释**: 事件对业务的影响。 **取值范围**: 不涉及。
    * status  **参数解释**: 事件状态。 **取值范围**: - WAITING：等待中 - INQUIRING：待授权 - SCHEDULED：待执行 - EXECUTING：执行中 - COMPLETED：已完成 - FAILED：失败 - CANCELED：已取消
    * reason  **参数解释**: 事件发生的原因。 **取值范围**: 不涉及。
    * executionTimeWindow  executionTimeWindow
    * level  **参数解释**: 事件级别。 **取值范围**: - CRITICAL：紧急 - MAJOR：重要 - MINOR：一般 - INFO：提示
    * executeTime  **参数解释**: 事件执行时间，格式为\"yyyy-mm-ddThh:mm:ssZ\"。其中，T指某个时间的开始；Z指时区偏移量，例如北京时间偏移显示为+0800。 **取值范围**: 不涉及。
    * latestExecutionTime  **参数解释**: 最晚执行时间，事件将在该时间之前执行。格式为\"yyyy-mm-ddThh:mm:ssZ\"。其中，T指某个时间的开始；Z指时区偏移量，例如北京时间偏移显示为+0800。 **取值范围**: 不涉及。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'status' => 'string',
            'reason' => 'string',
            'executionTimeWindow' => '\HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\ExecuteWindowResult',
            'level' => 'string',
            'executeTime' => 'string',
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['executionTimeWindow'] === null) {
            $invalidProperties[] = "'executionTimeWindow' can't be null";
        }
    ...
    * Sets id
    *
    * @param string $id **参数解释**: 事件ID。 **取值范围**: 不涉及。
    *
    * @return $this
    */
    ...
    * Sets dbType
    *
    * @param string $dbType **参数解释**: 数据库类型。 **取值范围**: 不涉及。
    *
    * @return $this
    */
    ...
    * Sets createdTime
    *
    * @param string $createdTime **参数解释**: 创建时间，格式为\"yyyy-mm-ddThh:mm:ssZ\"。其中，T指某个时间的开始；Z指时区偏移量，例如北京时间偏移显示为+0800。 **取值范围**: 不涉及。
    *
    * @return $this
    */
    ...
    * Sets updateTime
    *
    * @param string $updateTime **参数解释**: 更新时间，格式为\"yyyy-mm-ddThh:mm:ssZ\"。其中，T指某个时间的开始；Z指时区偏移量，例如北京时间偏移显示为+0800。 **取值范围**: 不涉及。
    *
    * @return $this
    */
    ...
    * Sets type
    *
    * @param string $type **参数解释**: 事件类型。 **取值范围**: - RESTAT_NODE：重启实例节点
    *
    * @return $this
    */
    ...
    * Sets impact
    *
    * @param string $impact **参数解释**: 事件对业务的影响。 **取值范围**: 不涉及。
    *
    * @return $this
    */
    ...
    * Sets status
    *
    * @param string $status **参数解释**: 事件状态。 **取值范围**: - WAITING：等待中 - INQUIRING：待授权 - SCHEDULED：待执行 - EXECUTING：执行中 - COMPLETED：已完成 - FAILED：失败 - CANCELED：已取消
    *
    * @return $this
    */
    ...
    * Sets reason
    *
    * @param string $reason **参数解释**: 事件发生的原因。 **取值范围**: 不涉及。
    *
    * @return $this
    */
    ...
    *  executionTimeWindow
    *
    * @return \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\ExecuteWindowResult
    */
    ...
    *
    * @param \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\ExecuteWindowResult $executionTimeWindow executionTimeWindow
    *
    * @return $this
    */
    ...
    * Sets level
    *
    * @param string $level **参数解释**: 事件级别。 **取值范围**: - CRITICAL：紧急 - MAJOR：重要 - MINOR：一般 - INFO：提示
    *
    * @return $this
    */
    ...
    * Sets executeTime
    *
    * @param string|null $executeTime **参数解释**: 事件执行时间，格式为\"yyyy-mm-ddThh:mm:ssZ\"。其中，T指某个时间的开始；Z指时区偏移量，例如北京时间偏移显示为+0800。 **取值范围**: 不涉及。
    *
    * @return $this
    */
    ...
    *
    * @param string|null $latestExecutionTime **参数解释**: 最晚执行时间，事件将在该时间之前执行。格式为\"yyyy-mm-ddThh:mm:ssZ\"。其中，T指某个时间的开始；Z指时区偏移量，例如北京时间偏移显示为+0800。 **取值范围**: 不涉及。
    *
    * @return $this
    */
