...
class ListBackupsResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListBackupsResult';
    ...
    *  datastore
    *
    * @return \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\DatastoreResult|null
    */
    ...
    * Sets datastore
    *
    * @param \HuaweiCloud\SDK\GaussDBforopenGauss\V3\Model\DatastoreResult|null $datastore datastore
    *
    * @return $this
    */
