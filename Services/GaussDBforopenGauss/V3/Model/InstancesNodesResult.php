...
class InstancesNodesResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'InstancesNodesResult';
    ...
    * Sets componentIds
    *
    * @param string[]|null $componentIds **参数解释**： 组件ID列表。
    *
    * @return $this
    */
