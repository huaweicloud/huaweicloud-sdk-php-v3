...
class ListTransactionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTransactionResponse';
    ...
    * Sets total
    *
    * @param int|null $total **参数解释**: 查到的事务数量。 **取值范围**: 不涉及。
    *
    * @return $this
    */
