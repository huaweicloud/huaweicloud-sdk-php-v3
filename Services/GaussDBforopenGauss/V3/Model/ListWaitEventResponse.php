...
class ListWaitEventResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListWaitEventResponse';
    ...
    * Sets total
    *
    * @param int|null $total **参数解释**: 等待事件的总数量。 **取值范围**: 不涉及。
    *
    * @return $this
    */
