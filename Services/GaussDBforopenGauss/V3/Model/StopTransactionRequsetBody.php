...
class StopTransactionRequsetBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StopTransactionRequsetBody';
    ...
    * sessionIds  **参数解释**: 查杀事务的ID列表。 **约束限制**: 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets sessionIds
    *
    * @param int[] $sessionIds **参数解释**: 查杀事务的ID列表。 **约束限制**: 不涉及。
    *
    * @return $this
    */
