...
class ListTransactionRequestBodyTransactionQueryOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTransactionRequestBody_transaction_query_option';
