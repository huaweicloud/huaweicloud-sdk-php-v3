...
class RedistributionParameterResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RedistributionParameterResult';
    ...
    * Sets valueRange
    *
    * @param string|null $valueRange **参数解释**: 参数取值范围。 **取值范围**: 不涉及。
    *
    * @return $this
    */
