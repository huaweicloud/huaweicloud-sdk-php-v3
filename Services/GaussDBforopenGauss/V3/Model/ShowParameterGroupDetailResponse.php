...
class ShowParameterGroupDetailResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowParameterGroupDetailResponse';
    ...
    * name  参数模板名称。
    * description  参数模板描述。
    * engineVersion  引擎版本。 [数据库版本。支持V2.0-2.3版本，取值为“V2.0-2.3”]。
    ...
    * Sets engineVersion
    *
    * @param string|null $engineVersion 引擎版本。 [数据库版本。支持V2.0-2.3版本，取值为“V2.0-2.3”]。
    *
    * @return $this
    */
