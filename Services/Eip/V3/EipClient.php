...
class EipClient extends Client
{
    ...
    {
        $client = new ClientBuilder(new EipClient());
        return $client;
    }
     ...
     * @return response
     */
    public function listBandwidthsLimit($request)
    {
        return $this->listBandwidthsLimitWithHttpInfo($request);
    }

    public function listBandwidthsLimitWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function listEipBandwidths($request)
    {
        return $this->listEipBandwidthsWithHttpInfo($request);
    }

    public function listEipBandwidthsWithHttpInfo($request)
    {
        $resourcePath = '/v3/{project_id}/eip-bandwidths';
        $formParams = [];
        $queryParams = [];
     ...
     * @return response
     */
    public function showPublicipPoolTypes($request)
    {
        return $this->showPublicipPoolTypesWithHttpInfo($request);
    }

    public function showPublicipPoolTypesWithHttpInfo($request)
    {
        $resourcePath = '/v3/{project_id}/eip/publicip-pool-types';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Eip\V3\Model\ShowPublicipPoolTypesResponse',
            $requestType='\HuaweiCloud\SDK\Eip\V3\Model\ShowPublicipPoolTypesRequest');
    }
