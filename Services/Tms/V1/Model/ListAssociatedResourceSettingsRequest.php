...
class ListAssociatedResourceSettingsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAssociatedResourceSettingsRequest';
