...
class SetSensitiveMaskRuleSwitchRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SetSensitiveMaskRuleSwitchRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dbss\V1\Model\BatchSwitchesRequestNew'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dbss\V1\Model\BatchSwitchesRequestNew|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dbss\V1\Model\BatchSwitchesRequestNew|null $body body
    *
    * @return $this
    */
