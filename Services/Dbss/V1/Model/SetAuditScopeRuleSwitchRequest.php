...
class SetAuditScopeRuleSwitchRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SetAuditScopeRuleSwitchRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dbss\V1\Model\AuditScopeSwitchRequestNew'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dbss\V1\Model\AuditScopeSwitchRequestNew|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dbss\V1\Model\AuditScopeSwitchRequestNew|null $body body
    *
    * @return $this
    */
