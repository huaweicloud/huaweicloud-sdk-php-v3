...
class SetAuditInstanceTimeZoneRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SetAuditInstanceTimeZoneRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dbss\V1\Model\TimezoneRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dbss\V1\Model\TimezoneRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dbss\V1\Model\TimezoneRequest|null $body body
    *
    * @return $this
    */
