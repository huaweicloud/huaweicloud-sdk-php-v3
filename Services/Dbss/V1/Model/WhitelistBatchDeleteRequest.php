...
class WhitelistBatchDeleteRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'WhitelistBatchDeleteRequest';
    ...
    * Sets whitelists
    *
    * @param string[] $whitelists 白名单记录ID
    *
    * @return $this
    */
