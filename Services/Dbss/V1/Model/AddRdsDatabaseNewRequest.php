...
class AddRdsDatabaseNewRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddRdsDatabaseNewRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dbss\V1\Model\RdsDbRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dbss\V1\Model\RdsDbRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dbss\V1\Model\RdsDbRequest|null $body body
    *
    * @return $this
    */
