...
class UpdateAuditRiskBucketPathRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAuditRiskBucketPathRequest';
    ...
    */
    protected static $openAPITypes = [
            'domainId' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dbss\V1\Model\RiskBackupConfig'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dbss\V1\Model\RiskBackupConfig|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dbss\V1\Model\RiskBackupConfig|null $body body
    *
    * @return $this
    */
