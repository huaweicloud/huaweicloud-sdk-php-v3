...
class PublicIp implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'eip' => '\HuaweiCloud\SDK\Dbss\V1\Model\Eip',
            'id' => 'string'
    ];
    ...
    *  eip
    *
    * @return \HuaweiCloud\SDK\Dbss\V1\Model\Eip|null
    */
    ...
    * Sets eip
    *
    * @param \HuaweiCloud\SDK\Dbss\V1\Model\Eip|null $eip eip
    *
    * @return $this
    */
