...
class UpdateAuditScopeRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAuditScopeRuleRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  **参数解释**： 实例ID。可通过查询实例列表接口ID字段获取 **约束限制**： 不涉及 **取值范围**： 以查询实例列表接口值为准，字符长度32-64。 **默认取值**： 不涉及
    * id  **参数解释**： 审计范围ID。可通过查询审计范围策略列表接口ID字段获取。 **约束限制**： 不涉及 **取值范围**： 以查询审计范围策略列表接口值为准，字符长度16-64。 **默认取值**： 不涉及
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'id' => 'string',
            'body' => '\HuaweiCloud\SDK\Dbss\V1\Model\RuleScopeRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dbss\V1\Model\RuleScopeRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dbss\V1\Model\RuleScopeRequest|null $body body
    *
    * @return $this
    */
