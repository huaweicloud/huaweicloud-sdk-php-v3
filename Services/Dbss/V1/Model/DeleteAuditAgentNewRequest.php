...
class DeleteAuditAgentNewRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteAuditAgentNewRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  **参数解释**： 实例ID。可通过查询实例列表接口ID字段获取 **约束限制**： 不涉及 **取值范围**： 以查询实例列表接口值为准，字符长度32-64。 **默认取值**： 不涉及
    * agentId  **参数解释**： 审计Agent ID。可通过获取agent列表接口agent_id字段获取 **约束限制**： 不涉及 **取值范围**： 以获取agent列表接口agent_id值为准，字符长度16-64。 **默认取值**： 不涉及
    * dbId  **参数解释**： 数据库ID, 可在查询数据库列表接口ID字段获取。 **约束限制**： 不涉及 **取值范围**： 以查询数据库列表接口值为准，字符长度16-64。 **默认取值**： 不涉及
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['agentId'] === null) {
            ...
            if ((mb_strlen($this->container['agentId']) < 16)) {
                $invalidProperties[] = "invalid value for 'agentId', the character length must be bigger than or equal to 16.";
            }
        if ($this->container['dbId'] === null) {
            $invalidProperties[] = "'dbId' can't be null";
        }
            if ((mb_strlen($this->container['dbId']) > 64)) {
                $invalidProperties[] = "invalid value for 'dbId', the character length must be smaller than or equal to 64.";
            }
            if ((mb_strlen($this->container['dbId']) < 16)) {
                $invalidProperties[] = "invalid value for 'dbId', the character length must be bigger than or equal to 16.";
            }
