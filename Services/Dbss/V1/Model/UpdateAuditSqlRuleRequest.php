...
class UpdateAuditSqlRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAuditSqlRuleRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  **参数解释**： 实例ID。可通过查询实例列表接口ID字段获取 **约束限制**： 不涉及 **取值范围**： 以查询实例列表接口值为准，字符长度32-64。 **默认取值**： 不涉及
    * id  **参数解释**： SQL规则ID。可通过查询SQL注入规则策略接口的ID字段获取。 **约束限制**： 不涉及 **取值范围**： 以查询SQL注入规则策略接口值为准，字符长度16-64。 **默认取值**： 不涉及
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'id' => 'string',
            'body' => '\HuaweiCloud\SDK\Dbss\V1\Model\RuleAddSqlRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dbss\V1\Model\RuleAddSqlRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dbss\V1\Model\RuleAddSqlRequest|null $body body
    *
    * @return $this
    */
