...
class RdsDbRequestDatabases implements ModelInterface, ArrayAccess
{
    ...
    * type  数据库类型 - MYSQL - POSTGRESQL - SQLSERVER - TAURUS - DWS - MARIADB - GAUSSDBOPENGAUSS
    *
    * @var string[]
    */
    ...
    * Sets type
    *
    * @param string $type 数据库类型 - MYSQL - POSTGRESQL - SQLSERVER - TAURUS - DWS - MARIADB - GAUSSDBOPENGAUSS
    *
    * @return $this
    */
