...
class ReportInfo implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'report' => '\HuaweiCloud\SDK\Dbss\V1\Model\ReportBean'
    ];
    ...
    *  report
    *
    * @return \HuaweiCloud\SDK\Dbss\V1\Model\ReportBean|null
    */
    ...
    * Sets report
    *
    * @param \HuaweiCloud\SDK\Dbss\V1\Model\ReportBean|null $report report
    *
    * @return $this
    */
