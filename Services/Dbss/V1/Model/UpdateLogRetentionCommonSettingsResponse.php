...
class UpdateLogRetentionCommonSettingsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateLogRetentionCommonSettingsResponse';
