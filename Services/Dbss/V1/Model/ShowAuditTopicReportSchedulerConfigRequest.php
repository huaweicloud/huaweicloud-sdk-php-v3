...
class ShowAuditTopicReportSchedulerConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAuditTopicReportSchedulerConfigRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  **参数解释**： 实例ID。可通过查询实例列表接口ID字段获取 **约束限制**： 不涉及 **取值范围**： 以查询实例列表接口值为准，字符长度32-64。 **默认取值**： 不涉及
    * id  **参数解释**： 模板ID。可通过获取报表模板接口ID字段获取。 **约束限制**： 不涉及 **取值范围**： 以获取报表模板接口值为准，字符长度16-64。 **默认取值**： 不涉及
    *
    * @var string[]
    */
