...
class ListWhitelistsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'whitelists' => '\HuaweiCloud\SDK\Dbss\V1\Model\WhitelistBean[]'
    ];
    ...
    *  白名单列表
    *
    * @return \HuaweiCloud\SDK\Dbss\V1\Model\WhitelistBean[]|null
    */
    ...
    * Sets whitelists
    *
    * @param \HuaweiCloud\SDK\Dbss\V1\Model\WhitelistBean[]|null $whitelists 白名单列表
    *
    * @return $this
    */
