...
class UpdateAuditTopicReportSchedulerConfigResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAuditTopicReportSchedulerConfigResponse';
    ...
    * Sets status
    *
    * @param string|null $status 状态  - success: 成功  - fail: 失败
    *
    * @return $this
    */
