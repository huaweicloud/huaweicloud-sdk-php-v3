...
class CreateAuditDbAgentRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAuditDbAgentRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'agentId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dbss\V1\Model\AgentEditRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dbss\V1\Model\AgentEditRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dbss\V1\Model\AgentEditRequest|null $body body
    *
    * @return $this
    */
