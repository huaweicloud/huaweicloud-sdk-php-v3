...
class SetAuditBackupSwitchRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SetAuditBackupSwitchRequest';
    ...
    */
    protected static $openAPITypes = [
            'domainId' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dbss\V1\Model\BackupSwitchRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dbss\V1\Model\BackupSwitchRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dbss\V1\Model\BackupSwitchRequest|null $body body
    *
    * @return $this
    */
