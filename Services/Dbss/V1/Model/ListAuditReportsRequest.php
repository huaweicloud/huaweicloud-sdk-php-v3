...
class ListAuditReportsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAuditReportsRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dbss\V1\Model\ReportGetReportsRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dbss\V1\Model\ReportGetReportsRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dbss\V1\Model\ReportGetReportsRequest|null $body body
    *
    * @return $this
    */
