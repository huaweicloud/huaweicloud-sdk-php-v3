...
class ListAuditInstanceJobsNewRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAuditInstanceJobsNewRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * resourceId  资源ID。可在查询实例列表接口的resource_id获取。
    *
    * @var string[]
    */
