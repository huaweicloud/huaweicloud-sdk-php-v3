...
class UpdateAuditWhitelistRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAuditWhitelistRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  **参数解释**： 实例ID。可通过查询实例列表接口ID字段获取 **约束限制**： 不涉及 **取值范围**： 以查询实例列表接口值为准，字符长度32-64。 **默认取值**： 不涉及
    * id  **参数解释**： 白名单ID。可通过查询白名单列表接口ID字段获取 **约束限制**： 不涉及 **取值范围**： 以查询白名单列表接口值为准，字符长度16-64。 **默认取值**： 不涉及
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'id' => 'string',
            'body' => '\HuaweiCloud\SDK\Dbss\V1\Model\UpdateWhitelistRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dbss\V1\Model\UpdateWhitelistRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dbss\V1\Model\UpdateWhitelistRequest|null $body body
    *
    * @return $this
    */
