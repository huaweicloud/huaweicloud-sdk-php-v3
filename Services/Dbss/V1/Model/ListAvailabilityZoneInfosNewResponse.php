...
class ListAvailabilityZoneInfosNewResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAvailabilityZoneInfosNewResponse';
