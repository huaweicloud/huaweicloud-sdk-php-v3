...
class GeneralRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GeneralRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * dbId  数据库ID
    * regenerate  是否重新生成  - 1：是  - 0：否
    * time  time
    *
    * @var string[]
    */
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['regenerate'] = isset($data['regenerate']) ? $data['regenerate'] : null;
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['regenerate'] === null) {
            $invalidProperties[] = "'regenerate' can't be null";
        }
    ...
    * Sets regenerate
    *
    * @param int $regenerate 是否重新生成  - 1：是  - 0：否
    *
    * @return $this
    */
