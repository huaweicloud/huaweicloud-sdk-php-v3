...
class ShowLogRetentionCommonSettingsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowLogRetentionCommonSettingsRequest';
