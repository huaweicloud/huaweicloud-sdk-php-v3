...
class WarRoomTenantInfoRegions implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'WarRoomTenantInfo_regions';
