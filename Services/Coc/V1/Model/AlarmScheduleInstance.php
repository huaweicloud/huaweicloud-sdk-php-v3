...
class AlarmScheduleInstance implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AlarmScheduleInstance';
    ...
    * orderNo  步骤号
    * batchStrategy  实例分批策略 AUTO_BATCH 自动分批，MANUAL_BATCH手动分批，NONE不分批
    * subTargetInstances  子目标实例
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'subTargetInstances' => '\HuaweiCloud\SDK\Coc\V1\Model\AlarmScheduleInstance[]'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['targetSelection'] === null) {
            ...
            if ((mb_strlen($this->container['targetSelection']) > 36)) {
                $invalidProperties[] = "invalid value for 'targetSelection', the character length must be smaller than or equal to 36.";
            }
        ...
        if ($this->container['orderNo'] === null) {
            ...
            if (($this->container['orderNo'] > 2147483647)) {
                $invalidProperties[] = "invalid value for 'orderNo', must be smaller than or equal to 2147483647.";
            }
    ...
    * Sets batchStrategy
    *
    * @param string|null $batchStrategy 实例分批策略 AUTO_BATCH 自动分批，MANUAL_BATCH手动分批，NONE不分批
    *
    * @return $this
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\AlarmScheduleInstance[]|null $subTargetInstances 子目标实例
    *
    * @return $this
    */
