...
class BatchCreateApplicationViewRequestBodyComponentList implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateApplicationViewRequestBody_component_list';
