...
class ListApplicationGroupsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListApplicationGroupsRequest';
    ...
    * Sets idList
    *
    * @param string[]|null $idList 分组id集合。
    *
    * @return $this
    */
    ...
    * Sets nameLike
    *
    * @param string|null $nameLike 分组名称模糊匹配。
    *
    * @return $this
    */
