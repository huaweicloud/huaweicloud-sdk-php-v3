...
class SyncMultiCloudResourceRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SyncMultiCloudResourceRequestBody';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['vendor'] === null) {
            ...
            if ((mb_strlen($this->container['vendor']) > 64)) {
