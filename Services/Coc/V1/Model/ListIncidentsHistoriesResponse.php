...
class ListIncidentsHistoriesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListIncidentsHistoriesResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'errorCode' => 'string',
            'errorMsg' => 'string',
            'data' => '\HuaweiCloud\SDK\Coc\V1\Model\CocListHistoryResponseDataV2'
    ];
    ...
    *  data
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\CocListHistoryResponseDataV2|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\CocListHistoryResponseDataV2|null $data data
    *
    * @return $this
    */
