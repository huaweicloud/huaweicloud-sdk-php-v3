...
class GroupRmsResourceRelationQueryResponseTags implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GroupRmsResourceRelationQueryResponse_tags';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * key  **参数解释：** 标签键。 **取值范围：** 不涉及。
    * value  **参数解释：** 标签值。 **取值范围：** 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets value
    *
    * @param string|null $value **参数解释：** 标签值。 **取值范围：** 不涉及。
    *
    * @return $this
    */
