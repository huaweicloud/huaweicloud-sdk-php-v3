...
class ComponentCreateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ComponentCreateRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['applicationId'] === null) {
            ...
            if ((mb_strlen($this->container['applicationId']) > 24)) {
