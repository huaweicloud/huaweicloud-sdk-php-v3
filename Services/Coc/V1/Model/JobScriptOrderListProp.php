...
class JobScriptOrderListProp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'JobScriptOrderListProp';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * regionIds  CMDB服务实例区域id，可能有多个
    *
    * @var string[]
    */
    ...
    * Sets regionIds
    *
    * @param string|null $regionIds CMDB服务实例区域id，可能有多个
    *
    * @return $this
    */
