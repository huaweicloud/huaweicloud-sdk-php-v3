...
class ListTicketsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTicketsRequest';
    ...
    */
    protected static $openAPITypes = [
            'ticketType' => 'string',
            'body' => '\HuaweiCloud\SDK\Coc\V1\Model\ListTicketParamsWithPage'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\ListTicketParamsWithPage|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\ListTicketParamsWithPage|null $body body
    *
    * @return $this
    */
