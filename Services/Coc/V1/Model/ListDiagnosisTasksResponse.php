...
class ListDiagnosisTasksResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'errorCode' => 'string',
            'errorMsg' => 'string',
            'data' => '\HuaweiCloud\SDK\Coc\V1\Model\DiagnosisTaskPage'
    ];
    ...
    *  data
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\DiagnosisTaskPage|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\DiagnosisTaskPage|null $data data
    *
    * @return $this
    */
