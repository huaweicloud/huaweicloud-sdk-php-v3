...
class ListIncidentsHistoriesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListIncidentsHistoriesRequest';
    ...
    */
    protected static $openAPITypes = [
            'incidentId' => 'string',
            'body' => '\HuaweiCloud\SDK\Coc\V1\Model\ListTicketParamsV2'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\ListTicketParamsV2|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\ListTicketParamsV2|null $body body
    *
    * @return $this
    */
