...
class CreateScriptResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateScriptResponse';
    ...
    * Sets data
    *
    * @param string|null $data script_uuid
    *
    * @return $this
    */
