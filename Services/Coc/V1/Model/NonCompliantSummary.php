...
class NonCompliantSummary implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NonCompliantSummary';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * nonCompliantCount  不合规补丁数量
    ...
    *
    * @param int|null $nonCompliantCount 不合规补丁数量
    *
    * @return $this
    */
