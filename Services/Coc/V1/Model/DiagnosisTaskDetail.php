...
class DiagnosisTaskDetail implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DiagnosisTaskDetail';
    ...
    */
    protected static $openAPITypes = [
            ...
            'osType' => 'string',
            'region' => 'string',
            'nodeList' => '\HuaweiCloud\SDK\Coc\V1\Model\DiagnosisTaskNode[]',
            'message' => 'string'
    ];
    ...
    * Sets region
    *
    * @param string|null $region 诊断资源所属局点
    *
    * @return $this
    */
    ...
    *  诊断步骤
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\DiagnosisTaskNode[]|null
    */
    ...
    * Sets nodeList
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\DiagnosisTaskNode[]|null $nodeList 诊断步骤
    *
    * @return $this
    */
    ...
    * Sets message
    *
    * @param string|null $message 诊断结果
    *
    * @return $this
    */
