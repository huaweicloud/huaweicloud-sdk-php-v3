...
class SyncResourcesOfResourceViewRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SyncResourcesOfResourceViewRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  **参数解释**: 视图ID。 **约束限制**: 不涉及。 **取值范围**: 自定义生成，长度1~32之间。 **默认取值**: 不涉及。
    *
    * @var string[]
    */
