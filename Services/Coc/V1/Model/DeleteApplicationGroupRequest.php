...
class DeleteApplicationGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteApplicationGroupRequest';
    ...
    * Sets forceDelete
    *
    * @param bool|null $forceDelete 是否强制删除。
    *
    * @return $this
    */
