...
class DeleteDocumentResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteDocumentResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * data  **参数解释：** 删除作业，系统返回的作业id。 **取值范围：** 不涉及。
    ...
    * Sets data
    *
    * @param string|null $data **参数解释：** 删除作业，系统返回的作业id。 **取值范围：** 不涉及。
    *
    * @return $this
    */
