...
class WarRoomTenantInfoImpactedApplication implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'WarRoomTenantInfo_impacted_application';
