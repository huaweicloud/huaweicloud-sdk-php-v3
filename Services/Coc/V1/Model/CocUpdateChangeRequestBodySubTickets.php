...
class CocUpdateChangeRequestBodySubTickets implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CocUpdateChangeRequestBody_sub_tickets';
    ...
    * Sets verifiedDocs
    *
    * @param string|null $verifiedDocs 验证文档ID。
    *
    * @return $this
    */
    ...
    * Sets comment
    *
    * @param string|null $comment 变更失败原因描述。
    *
    * @return $this
    */
    ...
    * Sets isMonitorFound
    *
    * @param bool|null $isMonitorFound 是否被监控发现。
    *
    * @return $this
    */
