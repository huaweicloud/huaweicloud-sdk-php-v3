...
class GetDocumentAtomicInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GetDocumentAtomicInfoRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * atomicUniqueKey  atomicUniqueKey
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['atomicUniqueKey'] === null) {
            $invalidProperties[] = "'atomicUniqueKey' can't be null";
        }
    ...
    *
    * @param string $atomicUniqueKey atomicUniqueKey
    *
    * @return $this
    */
