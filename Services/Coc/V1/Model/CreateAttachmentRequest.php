...
class CreateAttachmentRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAttachmentRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * ticketType  **参数解释：** 需要创建的工单类型，此处为固定值incident。此处的ticket_type传递的值为固定值incident，但是创建变更单或者问题单时，如需上传附件使用的依然是此接口。 **约束限制：** 不涉及 **取值范围：** 固定值incident **默认取值：** 不涉及
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'ticketType' => 'string',
            'body' => '\HuaweiCloud\SDK\Coc\V1\Model\CreateAttachmentRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\CreateAttachmentRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\CreateAttachmentRequestBody|null $body body
    *
    * @return $this
    */
