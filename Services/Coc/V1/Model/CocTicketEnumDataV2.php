...
class CocTicketEnumDataV2 implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CocTicketEnumDataV2';
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['propId']) && (mb_strlen($this->container['propId']) > 100)) {
                $invalidProperties[] = "invalid value for 'propId', the character length must be smaller than or equal to 100.";
            }
            ...
            if (!is_null($this->container['bizId']) && (mb_strlen($this->container['bizId']) > 100)) {
                $invalidProperties[] = "invalid value for 'bizId', the character length must be smaller than or equal to 100.";
            }
            ...
            if (!is_null($this->container['nameZh']) && (mb_strlen($this->container['nameZh']) > 100)) {
                $invalidProperties[] = "invalid value for 'nameZh', the character length must be smaller than or equal to 100.";
            }
    ...
    * Sets propId
    *
    * @param string|null $propId 匹配属性字段
    *
    * @return $this
    */
