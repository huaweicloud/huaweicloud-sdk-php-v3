...
class ListInstancesBatchRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstancesBatchRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xProjectId' => 'string',
            'xUserProfile' => 'string',
            'body' => '\HuaweiCloud\SDK\Coc\V1\Model\InstancesBatchesMode'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\InstancesBatchesMode|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\InstancesBatchesMode|null $body body
    *
    * @return $this
    */
