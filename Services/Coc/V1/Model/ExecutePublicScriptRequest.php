...
class ExecutePublicScriptRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExecutePublicScriptRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xProjectId' => 'string',
            'xUserProfile' => 'string',
            'body' => '\HuaweiCloud\SDK\Coc\V1\Model\ScriptExecuteModel'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\ScriptExecuteModel|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\ScriptExecuteModel|null $body body
    *
    * @return $this
    */
