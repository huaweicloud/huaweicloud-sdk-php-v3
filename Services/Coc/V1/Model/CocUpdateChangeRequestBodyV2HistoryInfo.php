...
class CocUpdateChangeRequestBodyV2HistoryInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CocUpdateChangeRequestBodyV2_history_info';
