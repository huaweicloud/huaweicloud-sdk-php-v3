...
class ListAlarmHandleHistoriesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAlarmHandleHistoriesRequest';
