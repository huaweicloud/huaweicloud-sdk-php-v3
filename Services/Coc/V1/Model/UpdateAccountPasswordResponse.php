...
class UpdateAccountPasswordResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAccountPasswordResponse';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['errorCode'] === null) {
            ...
            if ((mb_strlen($this->container['errorCode']) > 256)) {
            ...
            if (!is_null($this->container['data']) && (mb_strlen($this->container['data']) > 64)) {
                $invalidProperties[] = "invalid value for 'data', the character length must be smaller than or equal to 64.";
            }
