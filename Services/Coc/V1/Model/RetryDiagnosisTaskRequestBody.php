...
class RetryDiagnosisTaskRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RetryDiagnosisTaskRequestBody';
    ...
    * Sets instanceId
    *
    * @param string|null $instanceId 被重试实例的ID
    *
    * @return $this
    */
