...
class ListCocTicketOperationHistoriesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCocTicketOperationHistoriesResponse';
