...
class VendorAccountCreateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'VendorAccountCreateRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['vendor'] === null) {
            ...
            if ((mb_strlen($this->container['vendor']) > 32)) {
    ...
    * Sets accountName
    *
    * @param string $accountName **参数解释：** 账户名。 **约束限制：** 不涉及。 **取值范围：** 字符串，长度0到64个字符。 **默认取值：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets ak
    *
    * @param string $ak **参数解释：** 访问密钥id。 **约束限制：** 不涉及。 **取值范围：** 字符串，长度0到64个字符。 **默认取值：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets sk
    *
    * @param string $sk **参数解释：** 访问密钥密码。 **约束限制：** 不涉及。 **取值范围：** 字符串，长度0到64个字符。 **默认取值：** 不涉及。
    *
    * @return $this
    */
