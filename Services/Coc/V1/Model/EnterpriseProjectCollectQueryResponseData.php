...
class EnterpriseProjectCollectQueryResponseData implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'EnterpriseProjectCollectQueryResponse_data';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  **参数解释：** 唯一标识id。 **取值范围：** 不涉及。
    * userId  **参数解释：** 用户id。 **取值范围：** 不涉及。
    * epIdList  **参数解释：** 企业项目收藏列表。 **取值范围：** 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets id
    *
    * @param string|null $id **参数解释：** 唯一标识id。 **取值范围：** 不涉及。
    *
    * @return $this
    */
    ...
    * Sets epIdList
    *
    * @param string[]|null $epIdList **参数解释：** 企业项目收藏列表。 **取值范围：** 不涉及。
    *
    * @return $this
    */
