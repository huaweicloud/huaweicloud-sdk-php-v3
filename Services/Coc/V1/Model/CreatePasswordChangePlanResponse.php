...
class CreatePasswordChangePlanResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePasswordChangePlanResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'errorCode' => 'string',
            'errorMsg' => 'string',
            'data' => '\HuaweiCloud\SDK\Coc\V1\Model\CreatePasswordChangePlanResponseBodyData'
    ];
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['providerCode']) && (mb_strlen($this->container['providerCode']) > 256)) {
                $invalidProperties[] = "invalid value for 'providerCode', the character length must be smaller than or equal to 256.";
            }
    ...
    *  data
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\CreatePasswordChangePlanResponseBodyData|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\CreatePasswordChangePlanResponseBodyData|null $data data
    *
    * @return $this
    */
