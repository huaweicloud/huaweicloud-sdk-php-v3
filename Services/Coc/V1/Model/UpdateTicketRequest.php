...
class UpdateTicketRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateTicketRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * ticketType  需要修改的工单类型，此处需传递固定值change，表示更新变更单状态。
    * ticketId  变更单工单单号。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'ticketType' => 'string',
            'ticketId' => 'string',
            'body' => '\HuaweiCloud\SDK\Coc\V1\Model\CocUpdateChangeRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\CocUpdateChangeRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\CocUpdateChangeRequestBody|null $body body
    *
    * @return $this
    */
