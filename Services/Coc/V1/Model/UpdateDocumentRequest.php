...
class UpdateDocumentRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'documentId' => 'string',
            'body' => '\HuaweiCloud\SDK\Coc\V1\Model\UpdateRunbookRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\UpdateRunbookRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\UpdateRunbookRequestBody|null $body body
    *
    * @return $this
    */
