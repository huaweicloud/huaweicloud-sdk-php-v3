...
class ShowDiagnosisTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDiagnosisTaskRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * taskId  诊断工单ID
    * instanceId  非必填，被诊断实例的ID，传入后查询该实例诊断报告
    *
    * @var string[]
    */
