...
class CreateReportPrometheusEventRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateReportPrometheusEventRequest';
    ...
    * Sets body
    *
    * @param map[string,object]|null $body body
    *
    * @return $this
    */
