...
class CreateCocIncidentResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCocIncidentResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'errorCode' => 'string',
            'errorMsg' => 'string',
            'data' => '\HuaweiCloud\SDK\Coc\V1\Model\CreateExternalIncidentResponseData'
    ];
    ...
    *  data
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\CreateExternalIncidentResponseData|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\CreateExternalIncidentResponseData|null $data data
    *
    * @return $this
    */
