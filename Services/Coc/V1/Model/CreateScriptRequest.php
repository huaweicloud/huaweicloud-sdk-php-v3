...
class CreateScriptRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateScriptRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xUserProfile' => 'string',
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\Coc\V1\Model\AddScriptModel'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\AddScriptModel|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\AddScriptModel|null $body body
    *
    * @return $this
    */
