...
class ShowDiagnosisNodeResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDiagnosisNodeResponse';
    ...
    */
    protected static $openAPITypes = [
            'errorCode' => 'string',
            'errorMsg' => 'string',
            'data' => '\HuaweiCloud\SDK\Coc\V1\Model\DiagnosisTaskNodeDetail'
    ];
    ...
    *  data
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\DiagnosisTaskNodeDetail|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\DiagnosisTaskNodeDetail|null $data data
    *
    * @return $this
    */
