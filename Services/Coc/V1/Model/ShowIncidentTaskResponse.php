...
class ShowIncidentTaskResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowIncidentTaskResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'errorCode' => 'string',
            'errorMsg' => 'string',
            'data' => '\HuaweiCloud\SDK\Coc\V1\Model\CocTaskDetailV2[]'
    ];
    ...
    *  任务列表
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\CocTaskDetailV2[]|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\CocTaskDetailV2[]|null $data 任务列表
    *
    * @return $this
    */
