...
class ShowDiagnosisSummaryResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDiagnosisSummaryResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'region' => 'string',
            'startTime' => 'int',
            'instanceSummary' => '\HuaweiCloud\SDK\Coc\V1\Model\DiagnosisSummaryItem[]'
    ];
    ...
    */
    protected static $setters = [
            ...
            'instanceSummary' => 'setInstanceSummary'
    ];
    ...
    */
    protected static $getters = [
            ...
            'instanceSummary' => 'getInstanceSummary'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['instanceSummary'] = isset($data['instanceSummary']) ? $data['instanceSummary'] : null;
    }
    ...
    */
    ...
    /**
    * Gets instanceSummary
    *  被诊断实例的概览信息列表
    *
    * @return \HuaweiCloud\SDK\Coc\V1\Model\DiagnosisSummaryItem[]|null
    */
    public function getInstanceSummary()
    {
        return $this->container['instanceSummary'];
    }

    /**
    * Sets instanceSummary
    *
    * @param \HuaweiCloud\SDK\Coc\V1\Model\DiagnosisSummaryItem[]|null $instanceSummary 被诊断实例的概览信息列表
    *
    * @return $this
    */
    public function setInstanceSummary($instanceSummary)
    {
        $this->container['instanceSummary'] = $instanceSummary;
        return $this;
    }
