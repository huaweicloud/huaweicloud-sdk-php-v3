...
class ExecuteDocumentRequestBodyParameters implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExecuteDocumentRequestBody_parameters';
