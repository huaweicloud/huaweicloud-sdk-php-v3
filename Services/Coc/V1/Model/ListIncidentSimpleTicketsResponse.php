...
class ListIncidentSimpleTicketsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListIncidentSimpleTicketsResponse';
    ...
    * Sets data
    *
    * @param object|null $data 根据条件查到的事件单信息
    *
    * @return $this
    */
