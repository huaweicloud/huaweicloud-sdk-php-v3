...
class ImsAsyncClient extends Client
{
     ...
     * @return response
     */
    public function copyImageInRegionInSafeModeAsync($request)
    {
        return $this->copyImageInRegionInSafeModeAsyncWithHttpInfo($request);
    }
    
    public function copyImageInRegionInSafeModeAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function createDataImageInSafeModeAsync($request)
    {
        return $this->createDataImageInSafeModeAsyncWithHttpInfo($request);
    }
    
    public function createDataImageInSafeModeAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function createImageInSafeModeAsync($request)
    {
        return $this->createImageInSafeModeAsyncWithHttpInfo($request);
    }
    
    public function createImageInSafeModeAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function exportImageInSafeModeAsync($request)
    {
        return $this->exportImageInSafeModeAsyncWithHttpInfo($request);
    }
    
    public function exportImageInSafeModeAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function importImageQuickInSafeModeAsync($request)
    {
        return $this->importImageQuickInSafeModeAsyncWithHttpInfo($request);
    }
    
    public function importImageQuickInSafeModeAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function showImageMemberAsync($request)
    {
        return $this->showImageMemberAsyncWithHttpInfo($request);
    }
    
    public function showImageMemberAsyncWithHttpInfo($request){
        $collection_formats = [];
