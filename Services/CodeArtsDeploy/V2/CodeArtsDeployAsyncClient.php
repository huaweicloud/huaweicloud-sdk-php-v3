...
class CodeArtsDeployAsyncClient extends Client
{
    ...
    {
        $client = new ClientBuilder(new CodeArtsDeployAsyncClient());
        return $client;
    }
     ...
     * @return response
     */
    public function checkDeployStatusAsync($request)
    {
        return $this->checkDeployStatusAsyncWithHttpInfo($request);
    }
    
    public function checkDeployStatusAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function stopDeployTaskAsync($request)
    {
        return $this->stopDeployTaskAsyncWithHttpInfo($request);
    }
    
    public function stopDeployTaskAsyncWithHttpInfo($request){
        $collection_formats = [];
