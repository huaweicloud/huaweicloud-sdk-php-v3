...
class BatchUpdateApplicationPermissionsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchUpdateApplicationPermissionsRequestBody';
    ...
    */
    protected static $openAPITypes = [
            ...
            'roles' => '\HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\AppPermission[]'
    ];
    ...
    * Sets applicationIds
    *
    * @param string[] $applicationIds 应用列表
    *
    * @return $this
    */
    ...
    *  角色权限
    *
    * @return \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\AppPermission[]
    */
    ...
    * Sets roles
    *
    * @param \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\AppPermission[] $roles 角色权限
    *
    * @return $this
    */
