...
class EnvironmentRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'EnvironmentRequest';
    ...
    * Sets description
    *
    * @param string|null $description 环境描述信息
    *
    * @return $this
    */
