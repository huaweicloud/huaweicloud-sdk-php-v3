...
class UpdateAppDisableStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAppDisableStatusRequest';
    ...
    */
    protected static $openAPITypes = [
            'appId' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\UpdateAppDisableStatusRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\UpdateAppDisableStatusRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\UpdateAppDisableStatusRequestBody|null $body body
    *
    * @return $this
    */
