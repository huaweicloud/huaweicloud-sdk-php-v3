...
class BatchDeleteHostsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteHostsRequest';
    ...
    */
    protected static $openAPITypes = [
            'contentType' => 'string',
            'groupId' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\DeploymentHostListEntity'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\DeploymentHostListEntity|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\DeploymentHostListEntity|null $body body
    *
    * @return $this
    */
