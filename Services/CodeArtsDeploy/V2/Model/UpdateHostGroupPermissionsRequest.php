...
class UpdateHostGroupPermissionsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateHostGroupPermissionsRequest';
    ...
    */
    protected static $openAPITypes = [
            'contentType' => 'string',
            'groupId' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\PermissionUpdateV2Body'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\PermissionUpdateV2Body|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\PermissionUpdateV2Body|null $body body
    *
    * @return $this
    */
