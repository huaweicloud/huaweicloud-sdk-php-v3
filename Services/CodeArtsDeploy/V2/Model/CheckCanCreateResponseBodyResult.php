...
class CheckCanCreateResponseBodyResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CheckCanCreateResponseBody_result';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * creatable  是否具有创建应用的权限
    *
    * @var string[]
    */
    ...
    * Sets creatable
    *
    * @param bool|null $creatable 是否具有创建应用的权限
    *
    * @return $this
    */
