...
class UpdateAppGroupsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAppGroupsRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'groupId' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\UpdateAppGroupsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\UpdateAppGroupsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\UpdateAppGroupsRequestBody|null $body body
    *
    * @return $this
    */
