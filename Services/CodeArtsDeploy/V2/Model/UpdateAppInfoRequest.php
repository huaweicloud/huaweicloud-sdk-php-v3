...
class UpdateAppInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAppInfoRequest';
    ...
    */
    protected static $openAPITypes = [
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\UpdateAppInfoRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\UpdateAppInfoRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\UpdateAppInfoRequestBody|null $body body
    *
    * @return $this
    */
