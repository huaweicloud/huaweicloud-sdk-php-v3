...
class UpdateEnvironmentRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\EnvironmentRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\EnvironmentRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\EnvironmentRequest|null $body body
    *
    * @return $this
    */
