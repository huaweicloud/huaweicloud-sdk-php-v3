...
class UpdateHostInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateHostInfoRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'groupId' => 'string',
            'hostId' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\DeploymentHostRequestExternal'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['hostId'] === null) {
            ...
            if (!preg_match("/^[0-9a-z]{32}$/", $this->container['hostId'])) {
                $invalidProperties[] = "invalid value for 'hostId', must be conform to the pattern /^[0-9a-z]{32}$/.";
            }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\DeploymentHostRequestExternal|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\DeploymentHostRequestExternal|null $body body
    *
    * @return $this
    */
