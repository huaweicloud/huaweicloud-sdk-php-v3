...
class UpdateHostClusterRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateHostClusterRequest';
    ...
    */
    protected static $openAPITypes = [
            'contentType' => 'string',
            'groupId' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\HostClusterRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\HostClusterRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\HostClusterRequest|null $body body
    *
    * @return $this
    */
