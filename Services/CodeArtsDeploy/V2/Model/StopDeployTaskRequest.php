...
class StopDeployTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StopDeployTaskRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['recordId'] === null) {
            ...
            if ((mb_strlen($this->container['recordId']) > 32)) {
            ...
            if (!preg_match("/^[A-Za-z0-9]{32}$/", $this->container['recordId'])) {
