...
class CopyHostsToTargetRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CopyHostsToTargetRequest';
    ...
    */
    protected static $openAPITypes = [
            'contentType' => 'string',
            'groupId' => 'string',
            'body' => '\HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\DeploymentHostsCopyRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\DeploymentHostsCopyRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CodeArtsDeploy\V2\Model\DeploymentHostsCopyRequest|null $body body
    *
    * @return $this
    */
