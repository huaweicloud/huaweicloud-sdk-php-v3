...
class WordPronunciation implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'WordPronunciation';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * score  单词发音综合得分 0-100
    * gop  单词发音好坏得分 0-100
    *
    * @var string[]
    */
    ...
    * Sets score
    *
    * @param float $score 单词发音综合得分 0-100
    *
    * @return $this
    */
    ...
    * Sets gop
    *
    * @param float $gop 单词发音好坏得分 0-100
    *
    * @return $this
    */
