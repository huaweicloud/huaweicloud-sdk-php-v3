...
class SisClient extends Client
{
     ...
     * @return response
     */
    public function runAudioAssessment($request)
    {
        return $this->runAudioAssessmentWithHttpInfo($request);
    }

    public function runAudioAssessmentWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function runMultiModalAssessment($request)
    {
        return $this->runMultiModalAssessmentWithHttpInfo($request);
    }

    public function runMultiModalAssessmentWithHttpInfo($request)
    {
