...
class SourceCommunityMQParameters implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SourceCommunityMQParameters';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['subnetId'] === null) {
            ...
            if ((mb_strlen($this->container['subnetId']) > 256)) {
                $invalidProperties[] = "invalid value for 'subnetId', the character length must be smaller than or equal to 256.";
            }
    ...
    * Sets instanceId
    *
    * @param string|null $instanceId 实例ID，仅dms的rockectMq需要该字段
    *
    * @return $this
    */
    ...
    * Sets addr
    *
    * @param string $addr rockectMq连接地址
    *
    * @return $this
    */
