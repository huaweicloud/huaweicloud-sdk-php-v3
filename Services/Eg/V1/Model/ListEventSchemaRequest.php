...
class ListEventSchemaRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListEventSchemaRequest';
    ...
    * name  指定查询的事件模型名称，精准匹配
    * fuzzyName  指定查询的事件模型名称，模糊匹配
    *
    * @var string[]
    */
    ...
    * Sets name
    *
    * @param string|null $name 指定查询的事件模型名称，精准匹配
    *
    * @return $this
    */
    ...
    * Sets fuzzyName
    *
    * @param string|null $fuzzyName 指定查询的事件模型名称，模糊匹配
    *
    * @return $this
    */
