...
class ListChannelsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'size' => 'int',
            'items' => '\HuaweiCloud\SDK\Eg\V1\Model\ChannelInfo[]'
    ];
    ...
    *  对象列表
    *
    * @return \HuaweiCloud\SDK\Eg\V1\Model\ChannelInfo[]|null
    */
    ...
    * Sets items
    *
    * @param \HuaweiCloud\SDK\Eg\V1\Model\ChannelInfo[]|null $items 对象列表
    *
    * @return $this
    */
