...
class ResumeEventStreamingRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResumeEventStreamingRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Eg\V1\Model\EventStreamingOperateReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Eg\V1\Model\EventStreamingOperateReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Eg\V1\Model\EventStreamingOperateReq|null $body body
    *
    * @return $this
    */
