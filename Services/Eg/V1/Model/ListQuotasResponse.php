...
class ListQuotasResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'quotas' => '\HuaweiCloud\SDK\Eg\V1\Model\QuotaResourceResp'
    ];
    ...
    *  quotas
    *
    * @return \HuaweiCloud\SDK\Eg\V1\Model\QuotaResourceResp|null
    */
    ...
    * Sets quotas
    *
    * @param \HuaweiCloud\SDK\Eg\V1\Model\QuotaResourceResp|null $quotas quotas
    *
    * @return $this
    */
