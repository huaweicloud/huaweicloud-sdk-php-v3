...
class CreateSubscriptionRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Eg\V1\Model\SubscriptionCreateReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Eg\V1\Model\SubscriptionCreateReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Eg\V1\Model\SubscriptionCreateReq|null $body body
    *
    * @return $this
    */
