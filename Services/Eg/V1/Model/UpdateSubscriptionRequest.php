...
class UpdateSubscriptionRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Eg\V1\Model\SubscriptionUpdateReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Eg\V1\Model\SubscriptionUpdateReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Eg\V1\Model\SubscriptionUpdateReq|null $body body
    *
    * @return $this
    */
