...
class ShowDetailOfSubscriptionTargetResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDetailOfSubscriptionTargetResponse';
