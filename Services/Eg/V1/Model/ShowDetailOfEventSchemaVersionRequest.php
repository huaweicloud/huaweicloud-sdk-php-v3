...
class ShowDetailOfEventSchemaVersionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDetailOfEventSchemaVersionRequest';
