...
class ShowDetailOfSubscriptionTargetRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDetailOfSubscriptionTargetRequest';
