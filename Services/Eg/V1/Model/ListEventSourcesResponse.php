...
class ListEventSourcesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListEventSourcesResponse';
    ...
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'size' => 'int',
            'items' => '\HuaweiCloud\SDK\Eg\V1\Model\CustomizeSourceInfo[]'
    ];
    ...
    *  对象列表
    *
    * @return \HuaweiCloud\SDK\Eg\V1\Model\CustomizeSourceInfo[]|null
    */
    ...
    * Sets items
    *
    * @param \HuaweiCloud\SDK\Eg\V1\Model\CustomizeSourceInfo[]|null $items 对象列表
    *
    * @return $this
    */
