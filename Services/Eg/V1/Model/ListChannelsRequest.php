...
class ListChannelsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListChannelsRequest';
    ...
    * name  指定查询的事件通道名称，精准匹配
    * fuzzyName  指定查询的事件通道名称，模糊匹配
    * enterpriseProjectId  指定查询的企业项目id，精确匹配
    *
    * @var string[]
    */
    ...
    * Sets name
    *
    * @param string|null $name 指定查询的事件通道名称，精准匹配
    *
    * @return $this
    */
    ...
    * Sets fuzzyName
    *
    * @param string|null $fuzzyName 指定查询的事件通道名称，模糊匹配
    *
    * @return $this
    */
    ...
    *
    * @param string|null $enterpriseProjectId 指定查询的企业项目id，精确匹配
    *
    * @return $this
    */
