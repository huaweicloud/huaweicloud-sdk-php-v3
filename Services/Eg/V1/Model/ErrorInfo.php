    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['errorDetail']) && (mb_strlen($this->container['errorDetail']) > 128)) {
                $invalidProperties[] = "invalid value for 'errorDetail', the character length must be smaller than or equal to 128.";
            }
