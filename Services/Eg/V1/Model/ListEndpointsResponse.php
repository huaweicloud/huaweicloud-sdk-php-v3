...
class ListEndpointsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'size' => 'int',
            'items' => '\HuaweiCloud\SDK\Eg\V1\Model\EndpointInfo[]',
            'xRequestId' => 'string'
    ];
    ...
    *  对象列表
    *
    * @return \HuaweiCloud\SDK\Eg\V1\Model\EndpointInfo[]|null
    */
    ...
    * Sets items
    *
    * @param \HuaweiCloud\SDK\Eg\V1\Model\EndpointInfo[]|null $items 对象列表
    *
    * @return $this
    */
