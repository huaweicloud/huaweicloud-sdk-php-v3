...
class UpdateSubscriptionTargetRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateSubscriptionTargetRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Eg\V1\Model\SubscriptionTarget'
    ];
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Eg\V1\Model\SubscriptionTarget|null $body body
    *
    * @return $this
    */
