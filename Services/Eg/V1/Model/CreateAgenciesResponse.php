...
class CreateAgenciesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAgenciesResponse';
    ...
    * Sets agencies
    *
    * @param string[]|null $agencies 服务委托授权记录。
    *
    * @return $this
    */
