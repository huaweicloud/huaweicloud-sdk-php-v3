...
class ListEventTargetResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListEventTargetResponse';
    ...
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'size' => 'int',
            'items' => '\HuaweiCloud\SDK\Eg\V1\Model\CatalogTargetInfo[]'
    ];
    ...
    *  对象列表
    *
    * @return \HuaweiCloud\SDK\Eg\V1\Model\CatalogTargetInfo[]|null
    */
    ...
    * Sets items
    *
    * @param \HuaweiCloud\SDK\Eg\V1\Model\CatalogTargetInfo[]|null $items 对象列表
    *
    * @return $this
    */
