...
class ListConnectionsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'size' => 'int',
            'items' => '\HuaweiCloud\SDK\Eg\V1\Model\ConnectionInfo[]'
    ];
    ...
    *  对象列表
    *
    * @return \HuaweiCloud\SDK\Eg\V1\Model\ConnectionInfo[]|null
    */
    ...
    * Sets items
    *
    * @param \HuaweiCloud\SDK\Eg\V1\Model\ConnectionInfo[]|null $items 对象列表
    *
    * @return $this
    */
