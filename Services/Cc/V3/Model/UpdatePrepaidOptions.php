...
class UpdatePrepaidOptions implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePrepaidOptions';
    ...
    * isAutoPay  下单订购后，是否自动从客户的账户中支付； true：自动支付； false：不自动支付。 自动支付时，只能使用账户的现金支付；如果要使用代金券，请选择不自动支付，然后在用户费用中心，选择代金券支付。
    *
    * @var string[]
    */
    ...
    * Sets periodType
    *
    * @param string|null $periodType 订购周期类型，当前支持包月和包年： month：月； year：年；
    *
    * @return $this
    */
    ...
    * Sets isAutoPay
    *
    * @param bool|null $isAutoPay 下单订购后，是否自动从客户的账户中支付； true：自动支付； false：不自动支付。 自动支付时，只能使用账户的现金支付；如果要使用代金券，请选择不自动支付，然后在用户费用中心，选择代金券支付。
    *
    * @return $this
    */
