...
class ListBandwidthPackageLevelsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListBandwidthPackageLevelsRequest';
    ...
    * Sets level
    *
    * @param string|null $level 根据带宽包等级进行查询
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string|null $name 根据名称进行模糊查询
    *
    * @return $this
    */
