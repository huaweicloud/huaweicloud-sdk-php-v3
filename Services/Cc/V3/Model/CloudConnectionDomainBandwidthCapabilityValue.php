...
class CloudConnectionDomainBandwidthCapabilityValue implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CloudConnectionDomainBandwidthCapabilityValue';
