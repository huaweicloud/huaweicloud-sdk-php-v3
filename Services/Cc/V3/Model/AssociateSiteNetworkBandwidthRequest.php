...
class AssociateSiteNetworkBandwidthRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateSiteNetworkBandwidthRequest';
