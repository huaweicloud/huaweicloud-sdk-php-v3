...
class ListResourceByFilterTagRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'limit' => 'int',
            'offset' => 'int',
            'tags' => '\HuaweiCloud\SDK\Cc\V3\Model\AggTag[]',
            'matches' => '\HuaweiCloud\SDK\Cc\V3\Model\Tag[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\AggTag[]|null
    */
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\AggTag[]|null $tags 是否包含以下tag（多个key取\"与\"关系，多个value取\"或\"关系）
    *
    * @return $this
    */
    ...
    * Sets matches
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\Tag[]|null $matches 是否匹配以下tag，key必须为\"resource_name\"，value如果有值则模糊匹配，如果为空字符串则精确匹配
    *
    * @return $this
    */
