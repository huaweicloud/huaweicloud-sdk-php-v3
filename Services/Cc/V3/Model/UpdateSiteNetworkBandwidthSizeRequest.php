...
class UpdateSiteNetworkBandwidthSizeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateSiteNetworkBandwidthSizeRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Cc\V3\Model\UpdateSiteConnectionBandwidthSizeRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\UpdateSiteConnectionBandwidthSizeRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\UpdateSiteConnectionBandwidthSizeRequestBody|null $body body
    *
    * @return $this
    */
