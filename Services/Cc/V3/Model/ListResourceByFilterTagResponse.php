...
class ListResourceByFilterTagResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'resources' => '\HuaweiCloud\SDK\Cc\V3\Model\FilterTagResource[]',
            'requestId' => 'string',
            'totalCount' => 'int'
    ];
    ...
    *  资源实例实例列表。
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\FilterTagResource[]|null
    */
    ...
    * Sets resources
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\FilterTagResource[]|null $resources 资源实例实例列表。
    *
    * @return $this
    */
