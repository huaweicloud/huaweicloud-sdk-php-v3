...
class AssociateSiteConnectionBandwidthRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateSiteConnectionBandwidthRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'siteConnection' => '\HuaweiCloud\SDK\Cc\V3\Model\AssociateSiteConnectionBandwidth'
    ];
    ...
    *  siteConnection
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\AssociateSiteConnectionBandwidth
    */
    ...
    * Sets siteConnection
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\AssociateSiteConnectionBandwidth $siteConnection siteConnection
    *
    * @return $this
    */
