...
class ListGcbResourceByTagResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'resources' => '\HuaweiCloud\SDK\Cc\V3\Model\TmsResource[]',
            'totalCount' => 'int',
            'requestId' => 'string'
    ];
    ...
    *  资源列表。
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\TmsResource[]|null
    */
    ...
    * Sets resources
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\TmsResource[]|null $resources 资源列表。
    *
    * @return $this
    */
