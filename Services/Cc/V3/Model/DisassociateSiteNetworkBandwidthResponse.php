...
class DisassociateSiteNetworkBandwidthResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DisassociateSiteNetworkBandwidthResponse';
