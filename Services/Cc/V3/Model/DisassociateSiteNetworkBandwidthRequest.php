...
class DisassociateSiteNetworkBandwidthRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DisassociateSiteNetworkBandwidthRequest';
