...
class CloudConnectionIsSupportCapabilityValue implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CloudConnectionIsSupportCapabilityValue';
