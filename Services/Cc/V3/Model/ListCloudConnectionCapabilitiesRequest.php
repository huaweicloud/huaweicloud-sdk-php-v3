...
class ListCloudConnectionCapabilitiesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCloudConnectionCapabilitiesRequest';
    ...
    * Sets resourceType
    *
    * @param string|null $resourceType 类型。
    *
    * @return $this
    */
