...
class UpdateSiteConnectionBandwidthSizeRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateSiteConnectionBandwidthSizeRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'siteConnection' => '\HuaweiCloud\SDK\Cc\V3\Model\UpdateSiteConnectionBandwidthSize'
    ];
    ...
    *  siteConnection
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\UpdateSiteConnectionBandwidthSize
    */
    ...
    * Sets siteConnection
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\UpdateSiteConnectionBandwidthSize $siteConnection siteConnection
    *
    * @return $this
    */
