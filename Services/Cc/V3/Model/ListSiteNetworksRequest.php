...
class ListSiteNetworksRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSiteNetworksRequest';
    ...
    *  根据状态查询，可查询多个状态。
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\SiteNetworkStateEnum[]|null
    */
    ...
    * Sets state
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\SiteNetworkStateEnum[]|null $state 根据状态查询，可查询多个状态。
    *
    * @return $this
    */
    ...
    * Sets connectionId
    *
    * @param string[]|null $connectionId 分支连接的ID。
    *
    * @return $this
    */
