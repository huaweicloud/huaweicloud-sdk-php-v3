...
class ListGcbTenantTagsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'tags' => '\HuaweiCloud\SDK\Cc\V3\Model\TmsTagValues[]',
            'totalCount' => 'int',
            'requestId' => 'string'
    ];
    ...
    *  标签列表。
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\TmsTagValues[]|null
    */
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\TmsTagValues[]|null $tags 标签列表。
    *
    * @return $this
    */
