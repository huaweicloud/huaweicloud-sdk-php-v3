...
class ListAreasResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAreasResponse';
    ...
    *  大区列表。
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\Area[]
    */
    ...
    * Sets areas
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\Area[] $areas 大区列表。
    *
    * @return $this
    */
