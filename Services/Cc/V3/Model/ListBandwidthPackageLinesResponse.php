...
class ListBandwidthPackageLinesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListBandwidthPackageLinesResponse';
    ...
    */
    ...
    /**
    * Gets bandwidthPackageLines
    *  带宽包线路列表。
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\BandwidthPackageLine[]|null
    */
    public function getBandwidthPackageLines()
    {
        return $this->container['bandwidthPackageLines'];
    }

    /**
    * Sets bandwidthPackageLines
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\BandwidthPackageLine[]|null $bandwidthPackageLines 带宽包线路列表。
    *
    * @return $this
    */
    public function setBandwidthPackageLines($bandwidthPackageLines)
    {
        $this->container['bandwidthPackageLines'] = $bandwidthPackageLines;
        return $this;
    }
