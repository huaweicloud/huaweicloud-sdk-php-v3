...
class AttachedEnterpriseRouterAttachmentId implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AttachedEnterpriseRouterAttachmentId';
