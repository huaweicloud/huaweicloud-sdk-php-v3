...
class ListSiteNetworkQuotasRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSiteNetworkQuotasRequest';
    ...
    */
    protected static $openAPITypes = [
            'quotaType' => '\HuaweiCloud\SDK\Cc\V3\Model\SiteNetworkQuotaKeyEnum[]',
            'limit' => 'int',
            'marker' => 'string'
    ];
    ...
    *  根据配额类型查询，可查询多个类型。
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\SiteNetworkQuotaKeyEnum[]|null
    */
    ...
    * Sets quotaType
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\SiteNetworkQuotaKeyEnum[]|null $quotaType 根据配额类型查询，可查询多个类型。
    *
    * @return $this
    */
