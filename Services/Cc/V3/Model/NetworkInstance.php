...
class NetworkInstance implements ModelInterface, ArrayAccess
{
    ...
    * createdAt  网络实例的创建时间。 UTC时间格式，yyyy-MM-ddTHH:mm:ss
    * updatedAt  网络实例的更新时间。 UTC时间格式，yyyy-MM-ddTHH:mm:ss
    * type  网络实例的类型。 - vpc：虚拟私有云。 - vgw：虚拟网关。
    * cloudConnectionId  云连接实例ID。
    * instanceId  网络实例的ID。
    * instanceDomainId  网络实例所属账户ID。
    * regionId  网络实例所在Region的ID。
    * projectId  网络实例所在租户的项目ID。
    * cidrs  网络实例发布的网段路由列表。
    *
    * @var string[]
    */
    ...
    * Sets name
    *
    * @param string|null $name 网络实例的名字。
    *
    * @return $this
    */
    ...
    * Sets description
    *
    * @param string|null $description 网络实例的描述。
    *
    * @return $this
    */
    ...
    * Sets createdAt
    *
    * @param \DateTime|null $createdAt 网络实例的创建时间。 UTC时间格式，yyyy-MM-ddTHH:mm:ss
    *
    * @return $this
    */
    ...
    * Sets updatedAt
    *
    * @param \DateTime|null $updatedAt 网络实例的更新时间。 UTC时间格式，yyyy-MM-ddTHH:mm:ss
    *
    * @return $this
    */
    ...
    *
    * @param string|null $cloudConnectionId 云连接实例ID。
    *
    * @return $this
    */
    ...
    * Sets instanceId
    *
    * @param string|null $instanceId 网络实例的ID。
    *
    * @return $this
    */
    ...
    *
    * @param string|null $instanceDomainId 网络实例所属账户ID。
    *
    * @return $this
    */
    ...
    * Sets regionId
    *
    * @param string|null $regionId 网络实例所在Region的ID。
    *
    * @return $this
    */
    ...
    * Sets projectId
    *
    * @param string|null $projectId 网络实例所在租户的项目ID。
    *
    * @return $this
    */
