...
class CloudConnectionEnterpriseSupportSitesCapabilityValue implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CloudConnectionEnterpriseSupportSitesCapabilityValue';
