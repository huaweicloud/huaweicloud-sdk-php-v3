...
class ListSiteNetworkCapabilitiesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSiteNetworkCapabilitiesResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * requestId  请求ID。
    * capabilities  分支网络租户能力列表。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'capabilities' => '\HuaweiCloud\SDK\Cc\V3\Model\SiteNetworkCapabilityEntry[]'
    ];
    ...
    *  分支网络租户能力列表。
    *
    * @return \HuaweiCloud\SDK\Cc\V3\Model\SiteNetworkCapabilityEntry[]
    */
    ...
    * Sets capabilities
    *
    * @param \HuaweiCloud\SDK\Cc\V3\Model\SiteNetworkCapabilityEntry[] $capabilities 分支网络租户能力列表。
    *
    * @return $this
    */
