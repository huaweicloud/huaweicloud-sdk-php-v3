...
class AssociateBandwidthPackage implements ModelInterface, ArrayAccess
{
    ...
    * resourceId  带宽包实例待关联的资源实例ID。
    * resourceType  带宽包实例待关联的资源实例类型，cloud_connection：表示云连接实例。
    *
    * @var string[]
    */
    ...
    * Sets resourceId
    *
    * @param string $resourceId 带宽包实例待关联的资源实例ID。
    *
    * @return $this
    */
    ...
    * Sets resourceType
    *
    * @param string $resourceType 带宽包实例待关联的资源实例类型，cloud_connection：表示云连接实例。
    *
    * @return $this
    */
