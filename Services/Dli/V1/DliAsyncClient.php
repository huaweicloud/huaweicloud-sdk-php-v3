...
class DliAsyncClient extends Client
{
     ...
     * @return response
     */
    public function createStreamJobAsync($request)
    {
        return $this->createStreamJobAsyncWithHttpInfo($request);
    }
    
    public function createStreamJobAsyncWithHttpInfo($request){
        $collection_formats = [];
