...
class QueueScalingPoliciesResponse implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'QueueScalingPoliciesResponse';
    ...
    * Sets priority
    *
    * @param int|null $priority 策略优先级1-100，100优先级最高
    *
    * @return $this
    */
    ...
    *
    * @param string|null $impactStartTime 开始时间
    *
    * @return $this
    */
    ...
    * Sets impactStopTime
    *
    * @param string|null $impactStopTime 结束时间
    *
    * @return $this
    */
