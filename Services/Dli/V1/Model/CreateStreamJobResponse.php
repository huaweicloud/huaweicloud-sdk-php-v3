...
class CreateStreamJobResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateStreamJobResponse';
    ...
    */
    protected static $openAPITypes = [
            'isSuccess' => 'string',
            'message' => 'string',
            'job' => '\HuaweiCloud\SDK\Dli\V1\Model\StreamJobStatus'
    ];
    ...
    *  job
    *
    * @return \HuaweiCloud\SDK\Dli\V1\Model\StreamJobStatus|null
    */
    ...
    * Sets job
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\StreamJobStatus|null $job job
    *
    * @return $this
    */
