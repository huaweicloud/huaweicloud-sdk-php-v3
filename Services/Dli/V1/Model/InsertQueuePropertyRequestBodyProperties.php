...
class InsertQueuePropertyRequestBodyProperties implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'InsertQueuePropertyRequestBody_properties';
