...
class ChangeQueuePlanRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeQueuePlanRequest';
    ...
    */
    protected static $openAPITypes = [
            'planId' => 'string',
            'queueName' => 'string',
            'body' => '\HuaweiCloud\SDK\Dli\V1\Model\SetQueuePlanReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dli\V1\Model\SetQueuePlanReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\SetQueuePlanReq|null $body body
    *
    * @return $this
    */
