...
class QueueInfo implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'queueType' => 'string',
            'queueScalingPolicies' => '\HuaweiCloud\SDK\Dli\V1\Model\QueueScalingPoliciesResponse[]',
            'owner' => 'string',
            'createTime' => 'int',
            'engine' => 'string'
    ];
    ...
    *  队列扩缩容策略
    *
    * @return \HuaweiCloud\SDK\Dli\V1\Model\QueueScalingPoliciesResponse[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\QueueScalingPoliciesResponse[]|null $queueScalingPolicies 队列扩缩容策略
    *
    * @return $this
    */
