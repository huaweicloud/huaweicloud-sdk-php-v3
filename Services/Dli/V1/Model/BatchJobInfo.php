...
class BatchJobInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchJobInfo';
    ...
    */
    protected static $openAPITypes = [
            ...
            'files' => 'string[]',
            'modules' => 'string[]',
            'resources' => '\HuaweiCloud\SDK\Dli\V1\Model\CreateSessionReqResource[]',
            'groups' => '\HuaweiCloud\SDK\Dli\V1\Model\CreateSessionReqGroup[]',
    ...
    *
    * @return \HuaweiCloud\SDK\Dli\V1\Model\CreateSessionReqResource[]|null
    */
    ...
    * Sets resources
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\CreateSessionReqResource[]|null $resources JSON对象列表，填写用户已上传到队列的类型为JSON的资源包名和类型。
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\Dli\V1\Model\CreateSessionReqGroup[]|null
    */
    ...
    * Sets groups
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\CreateSessionReqGroup[]|null $groups JSON对象列表，填写用户组类型资源，格式详见请求示例。resources中的name未进行type校验，只要此分组中存在这个名字的包即可。
    *
    * @return $this
    */
