...
class UpdateFlinkSqlRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateFlinkSqlRequestBody';
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['runMode'] = isset($data['runMode']) ? $data['runMode'] : 'shared_cluster';
        ...
        $this->container['checkpointMode'] = isset($data['checkpointMode']) ? $data['checkpointMode'] : 1;
        ...
        $this->container['idleStateRetention'] = isset($data['idleStateRetention']) ? $data['idleStateRetention'] : 3600;
        $this->container['edgeGroupIds'] = isset($data['edgeGroupIds']) ? $data['edgeGroupIds'] : null;
        $this->container['dirtyDataStrategy'] = isset($data['dirtyDataStrategy']) ? $data['dirtyDataStrategy'] : '“0”';
