...
class UpdateElasticResourcePoolQueueInfoResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateElasticResourcePoolQueueInfoResponse';
