...
class UpdateElasticResourcePoolQueueInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateElasticResourcePoolQueueInfoRequest';
