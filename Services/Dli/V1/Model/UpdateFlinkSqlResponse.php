...
class UpdateFlinkSqlResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateFlinkSqlResponse';
    ...
    */
    protected static $openAPITypes = [
            'isSuccess' => 'bool',
            'message' => 'string',
            'job' => '\HuaweiCloud\SDK\Dli\V1\Model\UpdateJobRespJob'
    ];
    ...
    *  job
    *
    * @return \HuaweiCloud\SDK\Dli\V1\Model\UpdateJobRespJob|null
    */
    ...
    * Sets job
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\UpdateJobRespJob|null $job job
    *
    * @return $this
    */
