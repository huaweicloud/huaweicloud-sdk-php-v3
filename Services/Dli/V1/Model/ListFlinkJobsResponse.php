...
class ListFlinkJobsResponse implements ModelInterface, ArrayAccess
{
    ...
    * isSuccess  参数解释:  执行请求是否成功。“true”表示请求执行成功 示例: true 约束限制:  无 取值范围: true,false 默认取值: 无
    ...
    * Sets isSuccess
    *
    * @param string|null $isSuccess 参数解释:  执行请求是否成功。“true”表示请求执行成功 示例: true 约束限制:  无 取值范围: true,false 默认取值: 无
    *
    * @return $this
    */
