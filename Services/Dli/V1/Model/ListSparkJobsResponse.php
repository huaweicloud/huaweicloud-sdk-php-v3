...
class ListSparkJobsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'from' => 'int',
            'total' => 'int',
            'sessions' => '\HuaweiCloud\SDK\Dli\V1\Model\SparkJob[]',
            'createTime' => 'int'
    ];
    ...
    *  批处理作业信息。
    *
    * @return \HuaweiCloud\SDK\Dli\V1\Model\SparkJob[]|null
    */
    ...
    * Sets sessions
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\SparkJob[]|null $sessions 批处理作业信息。
    *
    * @return $this
    */
