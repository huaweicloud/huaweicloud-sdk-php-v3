...
class CreateEnhancedConnectionsReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateEnhancedConnectionsReq';
    ...
    * Sets hosts
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\EnhancedConnectionsHost[]|null $hosts 用户自定义主机信息，最大支持2万条记录。
    *
    * @return $this
    */
