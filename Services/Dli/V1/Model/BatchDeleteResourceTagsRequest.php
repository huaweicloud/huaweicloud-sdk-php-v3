...
class BatchDeleteResourceTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'resourceType' => 'string',
            'resourceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Dli\V1\Model\BatchDeleteResourceTagsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dli\V1\Model\BatchDeleteResourceTagsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\BatchDeleteResourceTagsRequestBody|null $body body
    *
    * @return $this
    */
