...
class CountResourcesByTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'resourceType' => 'string',
            'body' => '\HuaweiCloud\SDK\Dli\V1\Model\CountResourcesByTagsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Dli\V1\Model\CountResourcesByTagsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Dli\V1\Model\CountResourcesByTagsRequestBody|null $body body
    *
    * @return $this
    */
