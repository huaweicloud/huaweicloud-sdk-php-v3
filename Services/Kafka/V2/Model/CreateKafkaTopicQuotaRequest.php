...
class CreateKafkaTopicQuotaRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateKafkaTopicQuotaRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Kafka\V2\Model\KafkaTopicQuota'
    ];
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Kafka\V2\Model\KafkaTopicQuota|null $body body
    *
    * @return $this
    */
