...
class ListConfigFeaturesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'features' => '\HuaweiCloud\SDK\Kafka\V2\Model\ListConfigFeatures[]',
            'totalRecord' => 'int'
    ];
    ...
    *  **参数解释**： 特性列表。
    *
    * @return \HuaweiCloud\SDK\Kafka\V2\Model\ListConfigFeatures[]|null
    */
    ...
    * Sets features
    *
    * @param \HuaweiCloud\SDK\Kafka\V2\Model\ListConfigFeatures[]|null $features **参数解释**： 特性列表。
    *
    * @return $this
    */
