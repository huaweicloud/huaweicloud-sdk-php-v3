...
class CreateShrinkageJobRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateShrinkageJobRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * newBrokerNum  缩容后集群节点数
    *
    * @var string[]
    */
    ...
    * Sets newBrokerNum
    *
    * @param string|null $newBrokerNum 缩容后集群节点数
    *
    * @return $this
    */
