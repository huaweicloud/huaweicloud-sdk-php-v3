...
class ResizeEngineInstanceReq implements ModelInterface, ArrayAccess
{
    ...
    * newProductId  垂直扩容时的新产品ID。  当oper_type类型是vertical时，该参数才有效且必填。
    ...
    * Sets newBrokerNum
    *
    * @param int|null $newBrokerNum 当oper_type参数为horizontal时，该参数有效。  取值范围：最多支持30个broker。
    *
    * @return $this
    */
    ...
    * Sets newProductId
    *
    * @param string|null $newProductId 垂直扩容时的新产品ID。  当oper_type类型是vertical时，该参数才有效且必填。
    *
    * @return $this
    */
