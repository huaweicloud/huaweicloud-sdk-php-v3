...
class ScheduledTaskEntity implements ModelInterface, ArrayAccess
{
    ...
    * status  **参数解释**： 任务状态。 **取值范围**： - CREATED：定时任务状态为创建成功。 - SUCCESS：定时任务状态为成功。 - FAILED：定时任务状态为失败。 - DELETED：定时任务状态为已删除。 - EXECUTING：定时任务状态为执行中。 - CANCELLED：定时任务状态为取消。
    * createdAt  **参数解释**： 创建时间。 **取值范围**： 不涉及。
    * updatedAt  **参数解释**： 更新时间。 **取值范围**： 不涉及。
    * scheduleAt  **参数解释**： 定时执行时间。 **取值范围**： 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets status
    *
    * @param string|null $status **参数解释**： 任务状态。 **取值范围**： - CREATED：定时任务状态为创建成功。 - SUCCESS：定时任务状态为成功。 - FAILED：定时任务状态为失败。 - DELETED：定时任务状态为已删除。 - EXECUTING：定时任务状态为执行中。 - CANCELLED：定时任务状态为取消。
    *
    * @return $this
    */
    ...
    * Sets scheduleAt
    *
    * @param string|null $scheduleAt **参数解释**： 定时执行时间。 **取值范围**： 不涉及。
    *
    * @return $this
    */
