...
class SetUserPoliciesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SetUserPoliciesRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'instanceId' => 'string',
            'userName' => 'string',
            'body' => '\HuaweiCloud\SDK\Kafka\V2\Model\SetUserPoliciesReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Kafka\V2\Model\SetUserPoliciesReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Kafka\V2\Model\SetUserPoliciesReq|null $body body
    *
    * @return $this
    */
