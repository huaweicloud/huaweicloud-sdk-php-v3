...
class ListEngineProductsEntity implements ModelInterface, ArrayAccess
{
    ...
    * billingCode  账单计费类型。
    * archTypes  CPU架构。
    * chargingMode  [计费模式。monthly：包年/包月类型。hourly：按需类型。](tag:hws,hws_hk,ctc,sbc,hk_sbc,cmcc,hws_eu)[暂未使用。](tag:hws_ocb,ocb)[计费模式。hourly：按需类型。](tag:dt,g42,tm,hk_g42,hk_tm)
    * ios  支持的磁盘IO类型列表。
    ...
    */
    ...
    /**
    * Gets chargingMode
    *  [计费模式。monthly：包年/包月类型。hourly：按需类型。](tag:hws,hws_hk,ctc,sbc,hk_sbc,cmcc,hws_eu)[暂未使用。](tag:hws_ocb,ocb)[计费模式。hourly：按需类型。](tag:dt,g42,tm,hk_g42,hk_tm)
    *
    * @return string[]|null
    */
    ...
    * Sets chargingMode
    *
    * @param string[]|null $chargingMode [计费模式。monthly：包年/包月类型。hourly：按需类型。](tag:hws,hws_hk,ctc,sbc,hk_sbc,cmcc,hws_eu)[暂未使用。](tag:hws_ocb,ocb)[计费模式。hourly：按需类型。](tag:dt,g42,tm,hk_g42,hk_tm)
    *
    * @return $this
    */
