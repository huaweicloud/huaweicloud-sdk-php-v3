...
class ShowUpgradeInstanceVersionResponse implements ModelInterface, ArrayAccess
{
    ...
    * currentVersion  **参数解释**： 当前版本。   **取值范围**： 不涉及。
    * latestVersion  **参数解释**： 最新版本。   **取值范围**： 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets currentVersion
    *
    * @param string|null $currentVersion **参数解释**： 当前版本。   **取值范围**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets latestVersion
    *
    * @param string|null $latestVersion **参数解释**： 最新版本。   **取值范围**： 不涉及。
    *
    * @return $this
    */
