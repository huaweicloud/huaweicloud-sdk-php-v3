...
class ListProductsRespDetail1 implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'productId' => 'string',
            'specCode' => 'string',
            'io' => '\HuaweiCloud\SDK\Kafka\V2\Model\ListProductsRespIo1[]',
            'bandwidth' => 'string',
    ...
    *  **参数解释**： IO信息。 **取值范围**： 不涉及。
    *
    * @return \HuaweiCloud\SDK\Kafka\V2\Model\ListProductsRespIo1[]|null
    */
    ...
    * Sets io
    *
    * @param \HuaweiCloud\SDK\Kafka\V2\Model\ListProductsRespIo1[]|null $io **参数解释**： IO信息。 **取值范围**： 不涉及。
    *
    * @return $this
    */
