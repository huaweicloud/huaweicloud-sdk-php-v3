...
class StartKafkaLogTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StartKafkaLogTaskRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  **参数解释**： 实例ID。获取方法如下：调用“查询所有实例列表”接口，从响应体中获取实例ID。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    * logType  **参数解释**： 日志任务类型。 **约束限制**： 不涉及。 **取值范围**： - REBALANCE：重平衡日志。 - topic_log：Topic日志。 **默认取值**： 不涉及。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'logType' => 'string',
            'body' => '\HuaweiCloud\SDK\Kafka\V2\Model\StartKafkaLogTaskReq'
    ];
    ...
    */
    ...
    const LOG_TYPE_REBALANCE = 'REBALANCE';
    const LOG_TYPE_TOPIC_LOG = 'topic_log';
    ...
    */
    ...
    {
        return [
            self::LOG_TYPE_REBALANCE,
            self::LOG_TYPE_TOPIC_LOG,
        ];
    }
    ...
    * Sets logType
    *
    * @param string $logType **参数解释**： 日志任务类型。 **约束限制**： 不涉及。 **取值范围**： - REBALANCE：重平衡日志。 - topic_log：Topic日志。 **默认取值**： 不涉及。
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Kafka\V2\Model\StartKafkaLogTaskReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Kafka\V2\Model\StartKafkaLogTaskReq|null $body body
    *
    * @return $this
    */
