...
class ListInstanceConsumerGroupMessageOffsetResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstanceConsumerGroupMessageOffsetResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * groupMessageOffsets  消费组消息位点详情
    * total  总数
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'groupMessageOffsets' => '\HuaweiCloud\SDK\Kafka\V2\Model\GroupMessageOffsetsDetailEntity[]',
            'total' => 'int'
    ];
    ...
    *  消费组消息位点详情
    *
    * @return \HuaweiCloud\SDK\Kafka\V2\Model\GroupMessageOffsetsDetailEntity[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Kafka\V2\Model\GroupMessageOffsetsDetailEntity[]|null $groupMessageOffsets 消费组消息位点详情
    *
    * @return $this
    */
