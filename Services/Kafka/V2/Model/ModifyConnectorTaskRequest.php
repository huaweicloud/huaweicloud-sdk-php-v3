...
class ModifyConnectorTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ModifyConnectorTaskRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  **参数解释**： 实例ID。获取方法如下：调用“查询所有实例列表”接口，从响应体中获取实例ID。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    * taskId  **参数解释**： 任务ID。获取方法如下：调用“查询Smart Connect任务列表”接口，从响应体中获取Smart Connect任务ID。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'taskId' => 'string',
            'body' => '\HuaweiCloud\SDK\Kafka\V2\Model\SmartConnectTaskEntity'
    ];
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Kafka\V2\Model\SmartConnectTaskEntity|null $body body
    *
    * @return $this
    */
