...
class KafkaClient extends Client
{
    ...
    {
        return new ClientBuilder(new KafkaClient());
    }
     ...
     * @return response
     */
    public function createDeleteConnectorOrder($request)
    {
        return $this->createDeleteConnectorOrderWithHttpInfo($request);
    }

    public function createDeleteConnectorOrderWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function createSinkTask($request)
    {
        return $this->createSinkTaskWithHttpInfo($request);
    }

    public function createSinkTaskWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function deleteSinkTask($request)
    {
        return $this->deleteSinkTaskWithHttpInfo($request);
    }

    public function deleteSinkTaskWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function listSinkTasks($request)
    {
        return $this->listSinkTasksWithHttpInfo($request);
    }

    public function listSinkTasksWithHttpInfo($request)
    {
        $resourcePath = '/v2/{project_id}/connectors/{connector_id}/sink-tasks';
        $formParams = [];
        $queryParams = [];
     ...
     * @return response
     */
    public function showSinkTaskDetail($request)
    {
        return $this->showSinkTaskDetailWithHttpInfo($request);
    }

    public function showSinkTaskDetailWithHttpInfo($request)
    {
        $resourcePath = '/v2/{project_id}/connectors/{connector_id}/sink-tasks/{task_id}';
        $formParams = [];
        $queryParams = [];
        ...
        if ($localVarParams['topicInfo'] !== null) {
            $queryParams['topic-info'] = $localVarParams['topicInfo'];
        }
        if ($localVarParams['connectorId'] !== null) {
            $pathParams['connector_id'] = $localVarParams['connectorId'];
        }
