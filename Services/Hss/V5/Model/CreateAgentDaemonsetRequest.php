...
class CreateAgentDaemonsetRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAgentDaemonsetRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'clusterId' => 'string',
            'body' => '\HuaweiCloud\SDK\Hss\V5\Model\CreateDaemonsetRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\CreateDaemonsetRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\CreateDaemonsetRequestBody|null $body body
    *
    * @return $this
    */
