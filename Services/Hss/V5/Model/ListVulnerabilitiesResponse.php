...
class ListVulnerabilitiesResponse implements ModelInterface, ArrayAccess
{
    ...
    * totalNum  **参数解释**: 漏洞总数 **取值范围**: 取值0-2147483647
    * dataList  **参数解释**: 漏洞数据列表 **取值范围**: 不涉及
    *
    * @var string[]
    */
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum **参数解释**: 漏洞总数 **取值范围**: 取值0-2147483647
    *
    * @return $this
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\VulInfo[]|null $dataList **参数解释**: 漏洞数据列表 **取值范围**: 不涉及
    *
    * @return $this
    */
