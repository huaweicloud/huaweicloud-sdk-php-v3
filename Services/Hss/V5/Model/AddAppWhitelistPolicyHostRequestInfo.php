...
class AddAppWhitelistPolicyHostRequestInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddAppWhitelistPolicyHostRequestInfo';
