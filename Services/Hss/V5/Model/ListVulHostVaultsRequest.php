...
class ListVulHostVaultsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListVulHostVaultsRequest';
    ...
    * backupInfoId  **参数解释**: 本次漏洞处置对应的备份信息id **约束限制**: 不涉及 **取值范围**: 字符长度1-128位 **默认取值**: 不涉及
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['backupInfoId'] === null) {
            $invalidProperties[] = "'backupInfoId' can't be null";
        }
            if ((mb_strlen($this->container['backupInfoId']) > 128)) {
                $invalidProperties[] = "invalid value for 'backupInfoId', the character length must be smaller than or equal to 128.";
            }
            if ((mb_strlen($this->container['backupInfoId']) < 1)) {
