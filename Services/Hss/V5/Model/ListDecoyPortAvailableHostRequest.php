...
class ListDecoyPortAvailableHostRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDecoyPortAvailableHostRequest';
    ...
    * Sets ports
    *
    * @param string|null $ports 要设置的端口号,以,分割
    *
    * @return $this
    */
