...
class ListVulAffectImageContainersResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListVulAffectImageContainersResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\VulAffectImageContainersResponseInfo[]'
    ];
    ...
    *  列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\VulAffectImageContainersResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\VulAffectImageContainersResponseInfo[]|null $dataList 列表
    *
    * @return $this
    */
