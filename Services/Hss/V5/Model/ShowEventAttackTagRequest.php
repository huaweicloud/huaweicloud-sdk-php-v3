...
class ShowEventAttackTagRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowEventAttackTagRequest';
    ...
    * category  **参数解释**: 事件类别 **约束限制**: 必填 **取值范围**: - host : 主机安全事件 - container : 容器安全事件 - serverless : serverless场景安全事件  **默认取值**: 不涉及
    ...
    */
    ...
    /**
    * Gets category
    *  **参数解释**: 事件类别 **约束限制**: 必填 **取值范围**: - host : 主机安全事件 - container : 容器安全事件 - serverless : serverless场景安全事件  **默认取值**: 不涉及
    *
    * @return string
    */
