...
class ListVulContainerAppsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListVulContainerAppsResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\VulAffectContainerAppInfo[]'
    ];
    ...
    *  软件信息列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\VulAffectContainerAppInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\VulAffectContainerAppInfo[]|null $dataList 软件信息列表
    *
    * @return $this
    */
