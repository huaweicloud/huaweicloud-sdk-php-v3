...
class ChangeBaselineWhiteListRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeBaselineWhiteListRequestBody';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['id'] === null) {
            ...
            if (!preg_match("/^.*$/", $this->container['id'])) {
