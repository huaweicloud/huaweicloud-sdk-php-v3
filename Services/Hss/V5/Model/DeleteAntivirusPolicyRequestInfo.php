...
class DeleteAntivirusPolicyRequestInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteAntivirusPolicyRequestInfo';
    ...
    * Sets policyIds
    *
    * @param string[]|null $policyIds 策略Id列表
    *
    * @return $this
    */
