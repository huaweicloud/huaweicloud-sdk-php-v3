...
class ShowMonthlyOperationReportDetailRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowMonthlyOperationReportDetailRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * reportId  **参数解释**: reportId，生成的月度运营报告年月 **约束限制**: 不涉及 **取值范围**: 字符长度1-32位 **默认取值**: 不涉及
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['reportId'] === null) {
            ...
            if ((mb_strlen($this->container['reportId']) > 32)) {
    ...
    * Sets reportId
    *
    * @param string $reportId **参数解释**: reportId，生成的月度运营报告年月 **约束限制**: 不涉及 **取值范围**: 字符长度1-32位 **默认取值**: 不涉及
    *
    * @return $this
    */
