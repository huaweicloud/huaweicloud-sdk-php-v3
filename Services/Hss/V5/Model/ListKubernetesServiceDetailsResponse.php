...
class ListKubernetesServiceDetailsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListKubernetesServiceDetailsResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'lastUpdateTime' => 'int',
            'serviceInfoList' => '\HuaweiCloud\SDK\Hss\V5\Model\KubernetesServiceInfo[]'
    ];
    ...
    */
    protected static $setters = [
            ...
            'serviceInfoList' => 'setServiceInfoList'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['serviceInfoList'] = isset($data['serviceInfoList']) ? $data['serviceInfoList'] : null;
    }
    ...
    */
    ...
    /**
    * Gets serviceInfoList
    *  服务列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\KubernetesServiceInfo[]|null
    */
    public function getServiceInfoList()
    {
        return $this->container['serviceInfoList'];
    }

    /**
    * Sets serviceInfoList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\KubernetesServiceInfo[]|null $serviceInfoList 服务列表
    *
    * @return $this
    */
    public function setServiceInfoList($serviceInfoList)
    {
        $this->container['serviceInfoList'] = $serviceInfoList;
        return $this;
    }
