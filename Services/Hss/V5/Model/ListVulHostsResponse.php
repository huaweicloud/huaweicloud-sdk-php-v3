...
class ListVulHostsResponse implements ModelInterface, ArrayAccess
{
    ...
    * totalNum  **参数解释**: 受影响的云服务器总数 **取值范围**: 最小值0，最大值10000
    * dataList  **参数解释**: 受影响的云服务器列表 **取值范围**: 最小值1，最大值10000
    *
    * @var string[]
    */
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum **参数解释**: 受影响的云服务器总数 **取值范围**: 最小值0，最大值10000
    *
    * @return $this
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\VulHostInfo[]|null $dataList **参数解释**: 受影响的云服务器列表 **取值范围**: 最小值1，最大值10000
    *
    * @return $this
    */
