...
class ListCustomRuleConfigsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCustomRuleConfigsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * ruleId  **参数解释**： 规则ID **约束限制**： 不涉及 **取值范围**： 字符长度1-36位 **默认取值**： 不涉及
    ...
    * Sets ruleId
    *
    * @param string|null $ruleId **参数解释**： 规则ID **约束限制**： 不涉及 **取值范围**： 字符长度1-36位 **默认取值**： 不涉及
    *
    * @return $this
    */
    ...
    * Sets ruleName
    *
    * @param string|null $ruleName **参数解释**： 规则名称 **约束限制**： 不涉及 **取值范围**： 字符长度1-64位 **默认取值**： 不涉及
    *
    * @return $this
    */
