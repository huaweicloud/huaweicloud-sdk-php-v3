...
class BatchExportBaselineTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchExportBaselineTaskRequest';
    ...
    * exportSize  **参数解释**: 导出数据条数 **约束限制**: 不涉及 **取值范围**: 最小值0，最大值2147483647 **默认取值**: 不涉及
    * body  body
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['exportSize'] === null) {
            ...
            if (($this->container['exportSize'] > 2147483647)) {
                $invalidProperties[] = "invalid value for 'exportSize', must be smaller than or equal to 2147483647.";
            }
            if (($this->container['exportSize'] < 0)) {
                $invalidProperties[] = "invalid value for 'exportSize', must be bigger than or equal to 0.";
            }
    ...
    * Sets exportSize
    *
    * @param int $exportSize **参数解释**: 导出数据条数 **约束限制**: 不涉及 **取值范围**: 最小值0，最大值2147483647 **默认取值**: 不涉及
    *
    * @return $this
    */
