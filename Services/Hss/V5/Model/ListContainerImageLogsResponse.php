...
class ListContainerImageLogsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListContainerImageLogsResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\ContainerImageLogResponseInfo[]'
    ];
    ...
    *  容器镜像使用日志列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ContainerImageLogResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ContainerImageLogResponseInfo[]|null $dataList 容器镜像使用日志列表
    *
    * @return $this
    */
