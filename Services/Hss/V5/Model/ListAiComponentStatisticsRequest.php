...
class ListAiComponentStatisticsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAiComponentStatisticsRequest';
    ...
    * aiComponentName  **参数解释**： AI组件对应类型的名称 **取值范围**： 字符长度1-256位 **约束限制**: 不涉及 **默认取值**: 不涉及
    *
    * @var string[]
    */
    ...
    *
    * @param string|null $aiComponentName **参数解释**： AI组件对应类型的名称 **取值范围**： 字符长度1-256位 **约束限制**: 不涉及 **默认取值**: 不涉及
    *
    * @return $this
    */
