...
class ListLocalImageAppInfoResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListLocalImageAppInfoResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\LocalImageAppList[]'
    ];
    ...
    *  列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\LocalImageAppList[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\LocalImageAppList[]|null $dataList 列表
    *
    * @return $this
    */
