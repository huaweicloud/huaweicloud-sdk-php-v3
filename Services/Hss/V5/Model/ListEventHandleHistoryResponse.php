...
class ListEventHandleHistoryResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListEventHandleHistoryResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\EventHandleHistory[]'
    ];
    ...
    *  告警事件历史处置记录
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\EventHandleHistory[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\EventHandleHistory[]|null $dataList 告警事件历史处置记录
    *
    * @return $this
    */
