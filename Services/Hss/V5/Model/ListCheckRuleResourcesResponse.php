...
class ListCheckRuleResourcesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCheckRuleResourcesResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  受配置检测影响的镜像数据总量
    * dataList  数据列表
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\CheckRuleImageResponseInfo[]'
    ];
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum 受配置检测影响的镜像数据总量
    *
    * @return $this
    */
    ...
    *  数据列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\CheckRuleImageResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\CheckRuleImageResponseInfo[]|null $dataList 数据列表
    *
    * @return $this
    */
