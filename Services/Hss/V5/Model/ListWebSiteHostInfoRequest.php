...
class ListWebSiteHostInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListWebSiteHostInfoRequest';
    ...
    * domain  **参数解释**: 域名 **约束限制**: 不涉及 **取值范围**: 字符长度1-256 **默认取值**: 不涉及
    * hostName  **参数解释**: 服务器名称 **约束限制**: 不涉及 **取值范围**: 字符长度0-64 **默认取值**: 不涉及
    * hostIp  **参数解释**: 服务器IP **约束限制**: 不涉及 **取值范围**: 字符长度0-64 **默认取值**: 不涉及
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['domain'] === null) {
            ...
            if (!preg_match("/^.*$/", $this->container['domain'])) {
                $invalidProperties[] = "invalid value for 'domain', must be conform to the pattern /^.*$/.";
            }
    ...
    * Sets hostName
    *
    * @param string|null $hostName **参数解释**: 服务器名称 **约束限制**: 不涉及 **取值范围**: 字符长度0-64 **默认取值**: 不涉及
    *
    * @return $this
    */
    ...
    * Sets hostIp
    *
    * @param string|null $hostIp **参数解释**: 服务器IP **约束限制**: 不涉及 **取值范围**: 字符长度0-64 **默认取值**: 不涉及
    *
    * @return $this
    */
