...
class ListImageFilesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListImageFilesResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  **参数解释**: 总数 **取值范围**: 字符长度1-65535
    * dataList  **参数解释**: 列表 **取值范围**: 最小值0，最大值10000
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\ImageFileInfo[]'
    ];
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum **参数解释**: 总数 **取值范围**: 字符长度1-65535
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ImageFileInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ImageFileInfo[]|null $dataList **参数解释**: 列表 **取值范围**: 最小值0，最大值10000
    *
    * @return $this
    */
