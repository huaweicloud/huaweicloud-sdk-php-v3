...
class ListWebTamperImageOptionsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListWebTamperImageOptionsResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\WebTamperImageOptionsResponseInfo[]'
    ];
    ...
    *  data list
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\WebTamperImageOptionsResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\WebTamperImageOptionsResponseInfo[]|null $dataList data list
    *
    * @return $this
    */
