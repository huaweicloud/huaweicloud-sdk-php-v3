...
class ListAntiVirusPaidHostsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAntiVirusPaidHostsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  **参数解释**: 总数 **取值范围**: 最小值0，最大值2147483647
    * dataList  **参数解释**: 查询到的按量杀毒服务器详细信息列表 **取值范围**: 最小值0，最大值100
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\AntiVirusPaidHostResponseInfo[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\AntiVirusPaidHostResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\AntiVirusPaidHostResponseInfo[]|null $dataList **参数解释**: 查询到的按量杀毒服务器详细信息列表 **取值范围**: 最小值0，最大值100
    *
    * @return $this
    */
