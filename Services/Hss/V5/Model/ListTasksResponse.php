...
class ListTasksResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\ListTasksResponseInfoDataList[]'
    ];
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum 任务列表数量
    *
    * @return $this
    */
    ...
    *  任务列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ListTasksResponseInfoDataList[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ListTasksResponseInfoDataList[]|null $dataList 任务列表
    *
    * @return $this
    */
