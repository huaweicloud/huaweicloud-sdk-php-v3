...
class ListImageNonCompliantAppRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListImageNonCompliantAppRequest';
    ...
    * appName  **参数解释**: 不合格的软件名称 **约束限制**: 不涉及 **取值范围**: 字符长度0-65535位 **默认取值**: 不涉及
    *
    * @var string[]
    */
    ...
    * Sets appName
    *
    * @param string|null $appName **参数解释**: 不合格的软件名称 **约束限制**: 不涉及 **取值范围**: 字符长度0-65535位 **默认取值**: 不涉及
    *
    * @return $this
    */
