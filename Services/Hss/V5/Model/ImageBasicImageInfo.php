...
class ImageBasicImageInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImageBasicImageInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * osName  基础镜像的系统名称
    * osVersion  基础镜像的系统版本
    * layerDigest  基础镜像的层digest
    *
    * @var string[]
    */
    ...
    * Sets osName
    *
    * @param string|null $osName 基础镜像的系统名称
    *
    * @return $this
    */
    ...
    * Sets osVersion
    *
    * @param string|null $osVersion 基础镜像的系统版本
    *
    * @return $this
    */
    ...
    * Sets layerDigest
    *
    * @param string|null $layerDigest 基础镜像的层digest
    *
    * @return $this
    */
