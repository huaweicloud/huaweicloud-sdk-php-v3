...
class ChangeExtendedWeakPasswordRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeExtendedWeakPasswordRequest';
    ...
    */
    protected static $openAPITypes = [
            'region' => 'string',
            'body' => '\HuaweiCloud\SDK\Hss\V5\Model\ChangeExtendedWeakPasswordRequestInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ChangeExtendedWeakPasswordRequestInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ChangeExtendedWeakPasswordRequestInfo|null $body body
    *
    * @return $this
    */
