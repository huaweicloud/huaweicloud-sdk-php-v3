...
class ShowCommonPortRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowCommonPortRequest';
    ...
    * Sets port
    *
    * @param int $port **参数解释**: 端口号 **约束限制**: 不涉及 **取值范围**: 最小值1，最大值65535 **默认取值**: 不涉及
    *
    * @return $this
    */
