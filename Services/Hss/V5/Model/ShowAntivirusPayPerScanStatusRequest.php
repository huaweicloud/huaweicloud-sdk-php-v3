...
class ShowAntivirusPayPerScanStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAntivirusPayPerScanStatusRequest';
