...
class CCEClusterInfoListRequestBodyClusterInfoList implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CCEClusterInfoListRequestBody_cluster_info_list';
