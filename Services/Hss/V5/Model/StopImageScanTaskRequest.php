...
class StopImageScanTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StopImageScanTaskRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['taskId'] === null) {
            ...
            if (!preg_match("/^[a-z0-9-]*$/", $this->container['taskId'])) {
                $invalidProperties[] = "invalid value for 'taskId', must be conform to the pattern /^[a-z0-9-]*$/.";
            }
