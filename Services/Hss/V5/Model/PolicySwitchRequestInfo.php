...
class PolicySwitchRequestInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PolicySwitchRequestInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * policyName  **参数解释**： 策略名称 **约束限制**： 必填 **取值范围**： - sp_feature：自保护策略。  **默认取值**： 不涉及
    * enable  **参数解释**: 策略总开关是否开启 **约束限制**: 不涉及 **取值范围**: - true：是。 - false：否。  **默认取值**: 不涉及
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['policyName'] === null) {
            ...
            if (!preg_match("/^sp_feature$/", $this->container['policyName'])) {
                $invalidProperties[] = "invalid value for 'policyName', must be conform to the pattern /^sp_feature$/.";
            }
    ...
    * Sets policyName
    *
    * @param string $policyName **参数解释**： 策略名称 **约束限制**： 必填 **取值范围**： - sp_feature：自保护策略。  **默认取值**： 不涉及
    *
    * @return $this
    */
    ...
    * Sets enable
    *
    * @param bool $enable **参数解释**: 策略总开关是否开启 **约束限制**: 不涉及 **取值范围**: - true：是。 - false：否。  **默认取值**: 不涉及
    *
    * @return $this
    */
