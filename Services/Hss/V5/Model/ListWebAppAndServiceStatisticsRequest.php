...
class ListWebAppAndServiceStatisticsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListWebAppAndServiceStatisticsRequest';
    ...
    * Sets name
    *
    * @param string|null $name **参数解释**: web应用，web服务或数据库名称 **约束限制**: 不涉及 **取值范围**: 字符长度0-64 **默认取值**: 不涉及
    *
    * @return $this
    */
