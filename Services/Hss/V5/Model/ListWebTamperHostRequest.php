...
class ListWebTamperHostRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListWebTamperHostRequest';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['webAppName']) && !preg_match("/^.*$/", $this->container['webAppName'])) {
                $invalidProperties[] = "invalid value for 'webAppName', must be conform to the pattern /^.*$/.";
            }
    ...
    * Sets groupId
    *
    * @param string|null $groupId 服务器组的唯一标识ID
    *
    * @return $this
    */
    ...
    * Sets webAppName
    *
    * @param string|null $webAppName Web应用名称
    *
    * @return $this
    */
