...
class ListImageHandleAffectVulnerabilitiesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListImageHandleAffectVulnerabilitiesRequest';
    ...
    * imageName  **参数解释**: 镜像名称 **约束限制**: 不涉及 **取值范围**: 字符长度0-512 **默认取值**: 不涉及
    * vulName  **参数解释**: 漏洞名称 **约束限制**: 不涉及 **取值范围**: 字符长度0-512 **默认取值**: 不涉及
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'imageName' => 'string',
            'vulName' => 'string',
            'body' => '\HuaweiCloud\SDK\Hss\V5\Model\HandleImageVulnerabilityRequestBody'
    ];
    ...
    * Sets imageName
    *
    * @param string|null $imageName **参数解释**: 镜像名称 **约束限制**: 不涉及 **取值范围**: 字符长度0-512 **默认取值**: 不涉及
    *
    * @return $this
    */
    ...
    * Sets vulName
    *
    * @param string|null $vulName **参数解释**: 漏洞名称 **约束限制**: 不涉及 **取值范围**: 字符长度0-512 **默认取值**: 不涉及
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\HandleImageVulnerabilityRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\HandleImageVulnerabilityRequestBody|null $body body
    *
    * @return $this
    */
