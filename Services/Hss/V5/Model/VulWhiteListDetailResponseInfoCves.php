...
class VulWhiteListDetailResponseInfoCves implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'VulWhiteListDetailResponseInfo_cves';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * cveId  **参数解释**: cve id **取值范围**: 字符长度0-256
    * cvss  **参数解释**: cve的cvss评分 **取值范围**: 最小值0，最大值10
    *
    * @var string[]
    */
    ...
    * Sets cveId
    *
    * @param string|null $cveId **参数解释**: cve id **取值范围**: 字符长度0-256
    *
    * @return $this
    */
    ...
    * Sets cvss
    *
    * @param float|null $cvss **参数解释**: cve的cvss评分 **取值范围**: 最小值0，最大值10
    *
    * @return $this
    */
