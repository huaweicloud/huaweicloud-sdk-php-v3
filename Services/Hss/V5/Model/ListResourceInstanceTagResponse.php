...
class ListResourceInstanceTagResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListResourceInstanceTagResponse';
    ...
    * Sets sysTags
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ResourceTagInfo[]|null $sysTags 系统标签对象列表
    *
    * @return $this
    */
