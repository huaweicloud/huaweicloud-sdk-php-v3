...
class ContainerImageInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ContainerImageInfo';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['imageName']) && (mb_strlen($this->container['imageName']) > 4096)) {
                $invalidProperties[] = "invalid value for 'imageName', the character length must be smaller than or equal to 4096.";
            }
            ...
            if (!is_null($this->container['imageVersion']) && (mb_strlen($this->container['imageVersion']) > 32)) {
                $invalidProperties[] = "invalid value for 'imageVersion', the character length must be smaller than or equal to 32.";
            }
    ...
    * Sets imageId
    *
    * @param string|null $imageId 镜像唯一标识(虚拟)
    *
    * @return $this
    */
    ...
    * Sets imageVersion
    *
    * @param string|null $imageVersion 镜像版本号
    *
    * @return $this
    */
    ...
    * Sets createTime
    *
    * @param int|null $createTime 镜像创建时间(本地保存时间)
    *
    * @return $this
    */
