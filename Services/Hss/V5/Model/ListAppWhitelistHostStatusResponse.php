...
class ListAppWhitelistHostStatusResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAppWhitelistHostStatusResponse';
    ...
    */
    protected static $openAPITypes = [
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\AppWhitelistHostResponseInfo[]',
            'totalNum' => 'int'
    ];
    ...
    *  data list
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\AppWhitelistHostResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\AppWhitelistHostResponseInfo[]|null $dataList data list
    *
    * @return $this
    */
