...
class ListClusterRiskAffectResourcesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListClusterRiskAffectResourcesRequest';
