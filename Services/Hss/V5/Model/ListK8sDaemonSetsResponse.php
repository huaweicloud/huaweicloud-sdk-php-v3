...
class ListK8sDaemonSetsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListK8sDaemonSetsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  daemonset总量
    * dataList  daemonset基本信息列表
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\DaemonSetInfo[]'
    ];
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum daemonset总量
    *
    * @return $this
    */
    ...
    *  daemonset基本信息列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\DaemonSetInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\DaemonSetInfo[]|null $dataList daemonset基本信息列表
    *
    * @return $this
    */
