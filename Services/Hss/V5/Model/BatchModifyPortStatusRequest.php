...
class BatchModifyPortStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchModifyPortStatusRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'category' => 'string',
            'body' => '\HuaweiCloud\SDK\Hss\V5\Model\ListPortStatusRequestInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ListPortStatusRequestInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ListPortStatusRequestInfo|null $body body
    *
    * @return $this
    */
