...
class CreateSecurityGroupPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSecurityGroupPolicyRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'clusterId' => 'string',
            'namespace' => 'string',
            'body' => '\HuaweiCloud\SDK\Hss\V5\Model\CreateSecurityGroupPolicyRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\CreateSecurityGroupPolicyRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\CreateSecurityGroupPolicyRequestBody|null $body body
    *
    * @return $this
    */
