...
class ListRelatedEventsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRelatedEventsRequest';
    ...
    * eventId  **参数解释**： 事件编号 **约束限制**： 必填 **取值范围**： 字符长度1-256位 **默认取值**： 不涉及
    * occurTime  **参数解释**: 事件发生时间 **约束限制**: 不涉及 **取值范围**: 最小值0，最大值9223372036854775807 **默认取值**: 不涉及
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['eventId'] === null) {
            ...
            if ((mb_strlen($this->container['eventId']) > 256)) {
                $invalidProperties[] = "invalid value for 'eventId', the character length must be smaller than or equal to 256.";
            }
    ...
    * Sets eventId
    *
    * @param string $eventId **参数解释**： 事件编号 **约束限制**： 必填 **取值范围**： 字符长度1-256位 **默认取值**： 不涉及
    *
    * @return $this
    */
    ...
    * Sets occurTime
    *
    * @param int $occurTime **参数解释**: 事件发生时间 **约束限制**: 不涉及 **取值范围**: 最小值0，最大值9223372036854775807 **默认取值**: 不涉及
    *
    * @return $this
    */
