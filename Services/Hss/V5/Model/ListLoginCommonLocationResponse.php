...
class ListLoginCommonLocationResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListLoginCommonLocationResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\LoginCommonLocationResponseInfo[]'
    ];
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum 常用登录地已设置的个数
    *
    * @return $this
    */
