...
class ImageWhiteListDetailResponseInfoQueryInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImageWhiteListDetailResponseInfo_query_info';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * imageType  **参数解释**： 镜像类型（多个类型用逗号间隔） **取值范围**： - private_image：SWR私有镜像仓库。 - shared_image：SWR共享镜像仓库。 - instance_image：SWR企业仓库。 - harbor：harbor仓库。 - jfrog：jfrog仓库。
    *
    * @var string[]
    */
    ...
    * Sets imageType
    *
    * @param string|null $imageType **参数解释**： 镜像类型（多个类型用逗号间隔） **取值范围**： - private_image：SWR私有镜像仓库。 - shared_image：SWR共享镜像仓库。 - instance_image：SWR企业仓库。 - harbor：harbor仓库。 - jfrog：jfrog仓库。
    *
    * @return $this
    */
