...
class WebAppAndServiceStatisticResponseInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'WebAppAndServiceStatisticResponseInfo';
