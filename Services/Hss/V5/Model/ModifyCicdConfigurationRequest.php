...
class ModifyCicdConfigurationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ModifyCicdConfigurationRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'cicdId' => 'string',
            'body' => '\HuaweiCloud\SDK\Hss\V5\Model\ModifyCicdConfigurationRequestBody'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cicdId'] === null) {
            ...
            if ((mb_strlen($this->container['cicdId']) < 0)) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ModifyCicdConfigurationRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ModifyCicdConfigurationRequestBody|null $body body
    *
    * @return $this
    */
