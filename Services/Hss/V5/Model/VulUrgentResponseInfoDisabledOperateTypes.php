...
class VulUrgentResponseInfoDisabledOperateTypes implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'VulUrgentResponseInfo_disabled_operate_types';
