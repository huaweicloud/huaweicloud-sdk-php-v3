...
class VulWhiteListVulOptionsResponseInfoDataList implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'VulWhiteListVulOptionsResponseInfo_data_list';
