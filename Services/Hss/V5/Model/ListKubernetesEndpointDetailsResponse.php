...
class ListKubernetesEndpointDetailsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListKubernetesEndpointDetailsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  端点总数
    * lastUpdateTime  最近更新时间
    * endpointInfoList  端点列表
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'lastUpdateTime' => 'int',
            'endpointInfoList' => '\HuaweiCloud\SDK\Hss\V5\Model\KubernetesEndpointInfo[]'
    ];
    ...
    */
    protected static $attributeMap = [
            ...
            'endpointInfoList' => 'endpoint_info_list'
    ];
    ...
    */
    protected static $setters = [
            ...
            'endpointInfoList' => 'setEndpointInfoList'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['endpointInfoList'] = isset($data['endpointInfoList']) ? $data['endpointInfoList'] : null;
    }
    ...
    */
    ...
    /**
    * Gets endpointInfoList
    *  端点列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\KubernetesEndpointInfo[]|null
    */
    public function getEndpointInfoList()
    {
        return $this->container['endpointInfoList'];
    }

    /**
    * Sets endpointInfoList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\KubernetesEndpointInfo[]|null $endpointInfoList 端点列表
    *
    * @return $this
    */
    public function setEndpointInfoList($endpointInfoList)
    {
        $this->container['endpointInfoList'] = $endpointInfoList;
        return $this;
    }
