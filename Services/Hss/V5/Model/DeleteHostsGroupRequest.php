...
class DeleteHostsGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    * groupId  **参数解释**: 服务器组id **约束限制**: 不涉及 **取值范围**: 字符范围0-128位 **默认取值**: 不涉及
    *
    * @var string[]
    */
    ...
    */
    ...
    /**
    * Gets groupId
    *  **参数解释**: 服务器组id **约束限制**: 不涉及 **取值范围**: 字符范围0-128位 **默认取值**: 不涉及
    *
    * @return string
    */
    ...
    * Sets groupId
    *
    * @param string $groupId **参数解释**: 服务器组id **约束限制**: 不涉及 **取值范围**: 字符范围0-128位 **默认取值**: 不涉及
    *
    * @return $this
    */
