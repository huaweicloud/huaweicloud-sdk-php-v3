...
class ServerlessJobInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ServerlessJobInfo';
    ...
    * Sets executeTime
    *
    * @param int|null $executeTime 执行时间
    *
    * @return $this
    */
