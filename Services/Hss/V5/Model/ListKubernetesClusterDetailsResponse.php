...
class ListKubernetesClusterDetailsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListKubernetesClusterDetailsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * lastUpdateTime  最近更新时间
    * totalNum  集群总数
    * clusterInfoList  集群列表
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'lastUpdateTime' => 'int',
            'totalNum' => 'int',
            'clusterInfoList' => '\HuaweiCloud\SDK\Hss\V5\Model\KubernetesClusterInfo[]'
    ];
    ...
    *  集群列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\KubernetesClusterInfo[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\KubernetesClusterInfo[]|null $clusterInfoList 集群列表
    *
    * @return $this
    */
