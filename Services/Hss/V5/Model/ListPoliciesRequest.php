    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['agentId'] === null) {
            ...
            if ((mb_strlen($this->container['agentId']) < 1)) {
                $invalidProperties[] = "invalid value for 'agentId', the character length must be bigger than or equal to 1.";
            }
            if (!preg_match("/^[\\w.-]*$/", $this->container['agentId'])) {
                $invalidProperties[] = "invalid value for 'agentId', must be conform to the pattern /^[\\w.-]*$/.";
            }
