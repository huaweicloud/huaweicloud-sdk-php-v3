...
class AddAppWhitelistPolicyHostRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddAppWhitelistPolicyHostRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'policyId' => 'string',
            'body' => '\HuaweiCloud\SDK\Hss\V5\Model\AddAppWhitelistPolicyHostRequestInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\AddAppWhitelistPolicyHostRequestInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\AddAppWhitelistPolicyHostRequestInfo|null $body body
    *
    * @return $this
    */
