...
class ShowImageBaselineStatisticRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowImageBaselineStatisticRequest';
    ...
    * imageType  **参数解释**: 镜像类型 **约束限制**: 不涉及 **取值范围**: - private_image：私有镜像仓库。 - shared_image：共享镜像仓库。 - local_image : 本地镜像。 - instance_image：企业镜像。 - registry : 仓库镜像。 - local : 本地镜像，用于查询全局数据。  **默认取值**: 不涉及
    * namespace  **参数解释**: 组织名称（没有镜像相关信息时，表示查询所有镜像） **约束限制**: 不涉及 **取值范围**: 字符长度0-65535位 **默认取值**: 不涉及
    ...
    * Sets imageType
    *
    * @param string $imageType **参数解释**: 镜像类型 **约束限制**: 不涉及 **取值范围**: - private_image：私有镜像仓库。 - shared_image：共享镜像仓库。 - local_image : 本地镜像。 - instance_image：企业镜像。 - registry : 仓库镜像。 - local : 本地镜像，用于查询全局数据。  **默认取值**: 不涉及
    *
    * @return $this
    */
    ...
    * Sets namespace
    *
    * @param string|null $namespace **参数解释**: 组织名称（没有镜像相关信息时，表示查询所有镜像） **约束限制**: 不涉及 **取值范围**: 字符长度0-65535位 **默认取值**: 不涉及
    *
    * @return $this
    */
