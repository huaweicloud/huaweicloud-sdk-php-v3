...
class UninstallAgentsRequestInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UninstallAgentsRequestInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * hostIdList  **参数解释**： 服务器ID列表 **约束限制**： 不涉及 **取值范围**： 列表长度为1-200 **默认取值**： 不涉及
    *
    * @var string[]
    */
    ...
    * Sets hostIdList
    *
    * @param string[] $hostIdList **参数解释**： 服务器ID列表 **约束限制**： 不涉及 **取值范围**： 列表长度为1-200 **默认取值**： 不涉及
    *
    * @return $this
    */
