...
class ListVulContainerAppsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListVulContainerAppsRequest';
    ...
    * containerId  受影响容器id
    * vulId  漏洞ID
    * handleStatus  漏洞的处理状态，包含如下：   -unhandled : 未处理   -handled : 已处理
    * limit  每页条数
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['containerId'] === null) {
            ...
            if ((mb_strlen($this->container['containerId']) < 0)) {
