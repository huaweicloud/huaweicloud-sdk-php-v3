...
class ListGlobalVulnerabilitiesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGlobalVulnerabilitiesResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  **参数解释** 漏洞总数 **取值范围** 取值0-65535
    * dataList  **参数解释** 漏洞对应的记录
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\GlobalVulInfo[]'
    ];
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum **参数解释** 漏洞总数 **取值范围** 取值0-65535
    *
    * @return $this
    */
    ...
    *  **参数解释** 漏洞对应的记录
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\GlobalVulInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\GlobalVulInfo[]|null $dataList **参数解释** 漏洞对应的记录
    *
    * @return $this
    */
