...
class UpdateAgentDaemonsetRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAgentDaemonsetRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'clusterId' => 'string',
            'body' => '\HuaweiCloud\SDK\Hss\V5\Model\UpdateDaemonsetRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\UpdateDaemonsetRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\UpdateDaemonsetRequestBody|null $body body
    *
    * @return $this
    */
