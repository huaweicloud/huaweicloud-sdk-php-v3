...
class RemoveSystemUserWhiteListRequestInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RemoveSystemUserWhiteListRequestInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * dataList  删除系统用户白名单详情
    * deleteAll  是否删除所有白名单内容
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\SystemUserWhiteListRequestInfo[]',
            'deleteAll' => 'bool'
    ];
    ...
    *  删除系统用户白名单详情
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\SystemUserWhiteListRequestInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\SystemUserWhiteListRequestInfo[]|null $dataList 删除系统用户白名单详情
    *
    * @return $this
    */
