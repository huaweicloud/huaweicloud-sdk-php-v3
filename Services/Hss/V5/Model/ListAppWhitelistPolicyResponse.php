...
class ListAppWhitelistPolicyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAppWhitelistPolicyResponse';
    ...
    */
    protected static $openAPITypes = [
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\AppWhitelistPolicyResponseInfo[]',
            'totalNum' => 'int'
    ];
    ...
    *  data list
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\AppWhitelistPolicyResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\AppWhitelistPolicyResponseInfo[]|null $dataList data list
    *
    * @return $this
    */
