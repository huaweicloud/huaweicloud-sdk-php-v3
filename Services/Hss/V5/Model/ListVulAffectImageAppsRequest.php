...
class ListVulAffectImageAppsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListVulAffectImageAppsRequest';
    ...
    * Sets imageType
    *
    * @param string $imageType 镜像类型，包含如下：   -local : 本地镜像   -registry : 仓库镜像   -cicd : CI/CD镜像   -cluster : 集群镜像
    *
    * @return $this
    */
