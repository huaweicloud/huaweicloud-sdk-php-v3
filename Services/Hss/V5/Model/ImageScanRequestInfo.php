...
class ImageScanRequestInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImageScanRequestInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * scanType  **参数解释**: 扫描类型 **约束限制**: 不涉及 **取值范围**: - local_image：本地镜像，镜像扫描参数。 - remote_image：远程镜像仓，镜像扫描参数。  **默认取值**: 不涉及
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['scanType']) && !preg_match("/^local_image|remote_image$/", $this->container['scanType'])) {
                $invalidProperties[] = "invalid value for 'scanType', must be conform to the pattern /^local_image|remote_image$/.";
            }
    ...
    * Sets scanType
    *
    * @param string|null $scanType **参数解释**: 扫描类型 **约束限制**: 不涉及 **取值范围**: - local_image：本地镜像，镜像扫描参数。 - remote_image：远程镜像仓，镜像扫描参数。  **默认取值**: 不涉及
    *
    * @return $this
    */
