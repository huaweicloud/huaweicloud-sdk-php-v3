...
class ListClusterProtectionInfoResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListClusterProtectionInfoResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  **参数解释**: 总数 **取值范围**: 最小值0，最大值10000
    * dataList  **参数解释**: 集群防护信息列表 **取值范围**: 取值0-10000个ClusterResponseInfo对象
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\ClusterResponseInfo[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ClusterResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ClusterResponseInfo[]|null $dataList **参数解释**: 集群防护信息列表 **取值范围**: 取值0-10000个ClusterResponseInfo对象
    *
    * @return $this
    */
