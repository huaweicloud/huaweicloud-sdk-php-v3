...
class ListCheckFeatureRuleResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCheckFeatureRuleResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\FeatureRuleInfo[]'
    ];
    ...
    *  检测特性规则列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\FeatureRuleInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\FeatureRuleInfo[]|null $dataList 检测特性规则列表
    *
    * @return $this
    */
