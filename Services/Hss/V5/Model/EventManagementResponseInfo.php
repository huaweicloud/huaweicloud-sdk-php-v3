...
class EventManagementResponseInfo implements ModelInterface, ArrayAccess
{
    ...
    * protectStatus  **参数解释**： 防护状态 **取值范围**： - closed：未防护 - opened：防护中
    ...
    * recommendation  **参数解释**： 处置建议 **取值范围**： 字符长度1-256位
    * description  **参数解释**： 告警说明 **取值范围**： 字符长度0-1024位
    ...
    * Sets protectStatus
    *
    * @param string|null $protectStatus **参数解释**： 防护状态 **取值范围**： - closed：未防护 - opened：防护中
    *
    * @return $this
    */
    ...
    * Sets handler
    *
    * @param string|null $handler **参数解释**： 备注信息，已处理的告警才有 **取值范围**： 字符长度1-256位
    *
    * @return $this
    */
    ...
    * Sets recommendation
    *
    * @param string|null $recommendation **参数解释**： 处置建议 **取值范围**： 字符长度1-256位
    *
    * @return $this
    */
    ...
    * Sets description
    *
    * @param string|null $description **参数解释**： 告警说明 **取值范围**： 字符长度0-1024位
    *
    * @return $this
    */
    ...
    * Sets eventDetails
    *
    * @param string|null $eventDetails **参数解释**： 事件信息的简述 **取值范围**： 字符长度0-204800位
    *
    * @return $this
    */
    ...
    * Sets eventCount
    *
    * @param int|null $eventCount **参数解释**： 事件发生次数 **取值范围**： 最小值0，最大值2147483647
    *
    * @return $this
    */
