...
class ListK8sJobsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListK8sJobsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  普通任务总量
    * lastUpdateTime  最近更新时间
    * jobInfoList  普通任务基本信息列表
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'lastUpdateTime' => 'int',
            'jobInfoList' => '\HuaweiCloud\SDK\Hss\V5\Model\ServerlessJobInfo[]'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['jobInfoList'] = isset($data['jobInfoList']) ? $data['jobInfoList'] : null;
    }
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum 普通任务总量
    *
    * @return $this
    */
    ...
    *  普通任务基本信息列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ServerlessJobInfo[]|null
    */
    public function getJobInfoList()
    {
        return $this->container['jobInfoList'];
    }

    /**
    * Sets jobInfoList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ServerlessJobInfo[]|null $jobInfoList 普通任务基本信息列表
    *
    * @return $this
    */
    public function setJobInfoList($jobInfoList)
    {
        $this->container['jobInfoList'] = $jobInfoList;
        return $this;
    }
