...
class ListAgentDaemonsetClusterNodesLabelRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAgentDaemonsetClusterNodesLabelRequest';
    ...
    * type  **参数解释**: 是否开启远端备份 **约束限制**: 不涉及 **取值范围**: - label ：标签检索。 - tolerate：污点检索。  **默认取值**: label
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['type'] === null) {
            ...
            if (!preg_match("/^(label|tolerate)$/", $this->container['type'])) {
                $invalidProperties[] = "invalid value for 'type', must be conform to the pattern /^(label|tolerate)$/.";
            }
    ...
    * Sets clusterId
    *
    * @param string $clusterId **参数解释**: 集群id **约束限制**: 不涉及 **取值范围**: 字符长度1-256位 **默认取值**: 不涉及
    *
    * @return $this
    */
    ...
    /**
    * Gets type
    *  **参数解释**: 是否开启远端备份 **约束限制**: 不涉及 **取值范围**: - label ：标签检索。 - tolerate：污点检索。  **默认取值**: label
    *
    * @return string
    */
    ...
    * Sets type
    *
    * @param string $type **参数解释**: 是否开启远端备份 **约束限制**: 不涉及 **取值范围**: - label ：标签检索。 - tolerate：污点检索。  **默认取值**: label
    *
    * @return $this
    */
