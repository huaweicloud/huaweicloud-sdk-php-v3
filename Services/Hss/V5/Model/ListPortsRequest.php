...
class ListPortsRequest implements ModelInterface, ArrayAccess
{
    ...
    * status  **参数解释**: 端口状态 **约束限制**: 不涉及 **取值范围**: - danger: 危险端口 - unknown: 无已知危险的端口  **默认取值**: 不涉及
    ...
    * Sets status
    *
    * @param string|null $status **参数解释**: 端口状态 **约束限制**: 不涉及 **取值范围**: - danger: 危险端口 - unknown: 无已知危险的端口  **默认取值**: 不涉及
    *
    * @return $this
    */
