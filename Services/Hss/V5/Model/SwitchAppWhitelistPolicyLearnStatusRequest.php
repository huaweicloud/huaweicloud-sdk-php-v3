...
class SwitchAppWhitelistPolicyLearnStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SwitchAppWhitelistPolicyLearnStatusRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'policyId' => 'string',
            'body' => '\HuaweiCloud\SDK\Hss\V5\Model\SwitchAppWhitelistPolicyLearnStatusRequestInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\SwitchAppWhitelistPolicyLearnStatusRequestInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\SwitchAppWhitelistPolicyLearnStatusRequestInfo|null $body body
    *
    * @return $this
    */
