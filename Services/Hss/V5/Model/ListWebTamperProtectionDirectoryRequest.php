...
class ListWebTamperProtectionDirectoryRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListWebTamperProtectionDirectoryRequest';
    ...
    * status  **参数解释**: 防护状态 **约束限制**: type为container_wtp时必传 **取值范围**: - protected：防护中 - protect_failed：防护失败 **默认取值**: 不涉及
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['protectionConfigId'] === null) {
            ...
            if (!is_null($this->container['protectDirectory']) && !preg_match("/^.*$/", $this->container['protectDirectory'])) {
                $invalidProperties[] = "invalid value for 'protectDirectory', must be conform to the pattern /^.*$/.";
            }
    ...
    * Sets status
    *
    * @param string|null $status **参数解释**: 防护状态 **约束限制**: type为container_wtp时必传 **取值范围**: - protected：防护中 - protect_failed：防护失败 **默认取值**: 不涉及
    *
    * @return $this
    */
    ...
    *
    * @param string|null $protectDirectory **参数解释**: 防护目录 **约束限制**: 不涉及。 **取值范围**: 字符长度1-256位 **默认取值**: 不涉及
    *
    * @return $this
    */
