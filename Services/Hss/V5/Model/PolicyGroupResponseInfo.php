...
class PolicyGroupResponseInfo implements ModelInterface, ArrayAccess
{
    ...
    * deletable  **参数解释**: 是否可以删除，只有default_group为false且host_num为0时可以删除 **取值范围**: - true: 可以删除。 - false: 不可以删除。
    ...
    * Sets deletable
    *
    * @param bool|null $deletable **参数解释**: 是否可以删除，只有default_group为false且host_num为0时可以删除 **取值范围**: - true: 可以删除。 - false: 不可以删除。
    *
    * @return $this
    */
