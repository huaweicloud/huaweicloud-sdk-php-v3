...
class ListSystemUserWhiteListRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSystemUserWhiteListRequest';
    ...
    */
    protected static $setters = [
            ...
            'systemUserName' => 'setSystemUserName',
            'offset' => 'setOffset',
            'limit' => 'setLimit'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['systemUserName'] = isset($data['systemUserName']) ? $data['systemUserName'] : null;
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['systemUserName']) && (mb_strlen($this->container['systemUserName']) > 512)) {
                $invalidProperties[] = "invalid value for 'systemUserName', the character length must be smaller than or equal to 512.";
            }
            if (!is_null($this->container['systemUserName']) && (mb_strlen($this->container['systemUserName']) < 1)) {
                $invalidProperties[] = "invalid value for 'systemUserName', the character length must be bigger than or equal to 1.";
            }
            if (!is_null($this->container['systemUserName']) && !preg_match("/^.*$/", $this->container['systemUserName'])) {
                $invalidProperties[] = "invalid value for 'systemUserName', must be conform to the pattern /^.*$/.";
            }
    ...
    */
    ...
    {
        return $this->container['systemUserName'];
    }

    /**
    * Sets systemUserName
    *
    * @param string|null $systemUserName 系统用户名
    *
    * @return $this
    */
    public function setSystemUserName($systemUserName)
    {
        $this->container['systemUserName'] = $systemUserName;
        return $this;
    }
