...
class ListVulContainersResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListVulContainersResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\VulContainerInfo[]'
    ];
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum 受影响的容器总数
    *
    * @return $this
    */
    ...
    *  受影响的容器列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\VulContainerInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\VulContainerInfo[]|null $dataList 受影响的容器列表
    *
    * @return $this
    */
