...
class ShowDefaultSecurityCheckPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDefaultSecurityCheckPolicyRequest';
