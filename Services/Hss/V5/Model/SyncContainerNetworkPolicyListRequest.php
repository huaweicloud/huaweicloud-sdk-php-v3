...
class SyncContainerNetworkPolicyListRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SyncContainerNetworkPolicyListRequest';
