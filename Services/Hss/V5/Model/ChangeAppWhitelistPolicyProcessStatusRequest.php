...
class ChangeAppWhitelistPolicyProcessStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeAppWhitelistPolicyProcessStatusRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'policyId' => 'string',
            'body' => '\HuaweiCloud\SDK\Hss\V5\Model\ChangeAppWhitelistPolicyProcessStatusRequestInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ChangeAppWhitelistPolicyProcessStatusRequestInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ChangeAppWhitelistPolicyProcessStatusRequestInfo|null $body body
    *
    * @return $this
    */
