...
class ListHostVulsResponse implements ModelInterface, ArrayAccess
{
    ...
    * totalNum  **参数解释**: 服务器上的漏洞总数 **取值范围**: 最小值0，最大值2147483647
    * dataList  **参数解释**: 服务器上的漏洞列表 **取值范围**: 最小值0，最大值2147483647
    *
    * @var string[]
    */
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum **参数解释**: 服务器上的漏洞总数 **取值范围**: 最小值0，最大值2147483647
    *
    * @return $this
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\HostVulInfo[]|null $dataList **参数解释**: 服务器上的漏洞列表 **取值范围**: 最小值0，最大值2147483647
    *
    * @return $this
    */
