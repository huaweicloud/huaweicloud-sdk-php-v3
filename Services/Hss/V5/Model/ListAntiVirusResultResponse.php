...
class ListAntiVirusResultResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAntiVirusResultResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  **参数解释**: 总数 **取值范围**: 最小值0，最大值2147483647
    * dataList  **参数解释**: 病毒查杀结果详细信息列表 **取值范围**: 最小值0，最大值1000
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\AntiVirusResultResponseInfo[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\AntiVirusResultResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\AntiVirusResultResponseInfo[]|null $dataList **参数解释**: 病毒查杀结果详细信息列表 **取值范围**: 最小值0，最大值1000
    *
    * @return $this
    */
