...
class ListTaskResourcesResponseInfoClusterScanDataList implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTaskResourcesResponseInfo_cluster_scan_data_list';
    ...
    * startTime  该集群扫描开始的时间
    * endTime  该集群扫描结束的时间
    * scanDetailList  当前集群的扫描详情信息
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'startTime' => 'int',
            'endTime' => 'int',
            'scanDetailList' => '\HuaweiCloud\SDK\Hss\V5\Model\ListTaskResourcesResponseInfoScanDetailList[]'
    ];
    ...
    */
    protected static $attributeMap = [
            ...
            'endTime' => 'end_time',
            'scanDetailList' => 'scan_detail_list'
    ];
    ...
    */
    protected static $setters = [
            ...
            'endTime' => 'setEndTime',
            'scanDetailList' => 'setScanDetailList'
    ];
    ...
    */
    protected static $getters = [
            ...
            'endTime' => 'getEndTime',
            'scanDetailList' => 'getScanDetailList'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['scanDetailList'] = isset($data['scanDetailList']) ? $data['scanDetailList'] : null;
    }
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['clusterVersion']) && (mb_strlen($this->container['clusterVersion']) > 64)) {
                $invalidProperties[] = "invalid value for 'clusterVersion', the character length must be smaller than or equal to 64.";
            }
    ...
    * Sets startTime
    *
    * @param int|null $startTime 该集群扫描开始的时间
    *
    * @return $this
    */
    ...
    * Sets endTime
    *
    * @param int|null $endTime 该集群扫描结束的时间
    *
    * @return $this
    */
    ...
    *  当前集群的扫描详情信息
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ListTaskResourcesResponseInfoScanDetailList[]|null
    */
    public function getScanDetailList()
    {
        return $this->container['scanDetailList'];
    }

    /**
    * Sets scanDetailList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ListTaskResourcesResponseInfoScanDetailList[]|null $scanDetailList 当前集群的扫描详情信息
    *
    * @return $this
    */
    public function setScanDetailList($scanDetailList)
    {
        $this->container['scanDetailList'] = $scanDetailList;
        return $this;
    }
