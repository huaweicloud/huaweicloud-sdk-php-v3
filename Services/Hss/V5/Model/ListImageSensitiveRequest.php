...
class ListImageSensitiveRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListImageSensitiveRequest';
    ...
    * imageType  **参数解释**: 镜像类型 **约束限制**: 不涉及 **取值范围**: - private_image：SWR私有镜像。 - shared_image：SWR共享镜像。 - instance_image：SWR企业版镜像。 - cicd : cicd镜像。 - harbor ：Harbor仓库镜像。  **默认取值**: 不涉及
    ...
    * filePath  **参数解释**: 文件路径 **约束限制**: 不涉及 **取值范围**: 字符长度0-65535位 **默认取值**: 不涉及
    * severity  **参数解释**: 威胁等级 **约束限制**: 不涉及 **取值范围**: - critical：致命。 - high：高危。 - medium：中危。 - low : 低危。  **默认取值**: 不涉及
    * handleStatus  **参数解释**: 是否已处理 **约束限制**: 不涉及 **取值范围**: - unhandled：未处理。 - handled：已处理。  **默认取值**: 不涉及
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['imageType'] === null) {
            ...
            if (!is_null($this->container['severity']) && (mb_strlen($this->container['severity']) > 65535)) {
                $invalidProperties[] = "invalid value for 'severity', the character length must be smaller than or equal to 65535.";
            }
            ...
            if (!is_null($this->container['severity']) && !preg_match("/^critical|high|medium|low$/", $this->container['severity'])) {
                $invalidProperties[] = "invalid value for 'severity', must be conform to the pattern /^critical|high|medium|low$/.";
            }
            if (!is_null($this->container['handleStatus']) && (mb_strlen($this->container['handleStatus']) > 65535)) {
                $invalidProperties[] = "invalid value for 'handleStatus', the character length must be smaller than or equal to 65535.";
            }
    ...
    * Sets imageType
    *
    * @param string $imageType **参数解释**: 镜像类型 **约束限制**: 不涉及 **取值范围**: - private_image：SWR私有镜像。 - shared_image：SWR共享镜像。 - instance_image：SWR企业版镜像。 - cicd : cicd镜像。 - harbor ：Harbor仓库镜像。  **默认取值**: 不涉及
    *
    * @return $this
    */
    ...
    * Sets filePath
    *
    * @param string|null $filePath **参数解释**: 文件路径 **约束限制**: 不涉及 **取值范围**: 字符长度0-65535位 **默认取值**: 不涉及
    *
    * @return $this
    */
    ...
    * Sets severity
    *
    * @param string|null $severity **参数解释**: 威胁等级 **约束限制**: 不涉及 **取值范围**: - critical：致命。 - high：高危。 - medium：中危。 - low : 低危。  **默认取值**: 不涉及
    *
    * @return $this
    */
    ...
    * Sets handleStatus
    *
    * @param string|null $handleStatus **参数解释**: 是否已处理 **约束限制**: 不涉及 **取值范围**: - unhandled：未处理。 - handled：已处理。  **默认取值**: 不涉及
    *
    * @return $this
    */
