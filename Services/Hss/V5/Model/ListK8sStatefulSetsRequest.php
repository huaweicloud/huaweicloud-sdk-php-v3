...
class ListK8sStatefulSetsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListK8sStatefulSetsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * enterpriseProjectId  **参数解释**: 企业项目ID，用于过滤不同企业项目下的资产。获取方式请参见[获取企业项目ID](hss_02_0027.xml)。 如需查询所有企业项目下的资产请传参“all_granted_eps”。 **约束限制**: 开通企业项目功能后才需要配置企业项目ID参数。 **取值范围**: 字符长度1-256位 **默认取值**: 0，表示默认企业项目（default）。
    * offset  **参数解释**: 偏移量：指定返回记录的开始位置 **约束限制**: 不涉及 **取值范围**: 最小值0，最大值2000000 **默认取值**: 默认为0
    * statefulsetName  statefulset名称
    ...
    */
    protected static $setters = [
            ...
            'offset' => 'setOffset',
            'statefulsetName' => 'setStatefulsetName',
    ...
    */
    protected static $getters = [
            ...
            'offset' => 'getOffset',
            'statefulsetName' => 'getStatefulsetName',
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['statefulsetName'] = isset($data['statefulsetName']) ? $data['statefulsetName'] : null;
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['statefulsetName']) && (mb_strlen($this->container['statefulsetName']) > 256)) {
                $invalidProperties[] = "invalid value for 'statefulsetName', the character length must be smaller than or equal to 256.";
            }
            if (!is_null($this->container['statefulsetName']) && (mb_strlen($this->container['statefulsetName']) < 0)) {
                $invalidProperties[] = "invalid value for 'statefulsetName', the character length must be bigger than or equal to 0.";
            }
            if (!is_null($this->container['statefulsetName']) && !preg_match("/^.*$/", $this->container['statefulsetName'])) {
                $invalidProperties[] = "invalid value for 'statefulsetName', must be conform to the pattern /^.*$/.";
            }
    ...
    */
    ...
    {
        return $this->container['statefulsetName'];
    }

    /**
    * Sets statefulsetName
    *
    * @param string|null $statefulsetName statefulset名称
    *
    * @return $this
    */
    public function setStatefulsetName($statefulsetName)
    {
        $this->container['statefulsetName'] = $statefulsetName;
        return $this;
    }
