...
class ListAppWhitelistHostStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAppWhitelistHostStatusRequest';
    ...
    * Sets version
    *
    * @param string|null $version 主机防护版本
    *
    * @return $this
    */
