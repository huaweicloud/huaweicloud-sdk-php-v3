...
class ShowDefaultSecurityCheckPolicyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDefaultSecurityCheckPolicyResponse';
