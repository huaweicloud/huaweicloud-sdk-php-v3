...
class ListSecurityReportResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSecurityReportResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  **参数解释**: 总数 **取值范围**: 最小值0，最大值2147483647
    * dataList  **参数解释**:  报告总览页列表  **取值范围**:  最少0条，最多2147483647条
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\SecurityReportResponseInfo[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\SecurityReportResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\SecurityReportResponseInfo[]|null $dataList **参数解释**:  报告总览页列表  **取值范围**:  最少0条，最多2147483647条
    *
    * @return $this
    */
