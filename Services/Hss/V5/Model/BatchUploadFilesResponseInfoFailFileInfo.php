...
class BatchUploadFilesResponseInfoFailFileInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchUploadFilesResponseInfo_fail_file_info';
