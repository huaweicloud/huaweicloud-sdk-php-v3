...
class CreateTaskRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateTaskRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'taskType' => 'string',
            'clusterScanInfo' => '\HuaweiCloud\SDK\Hss\V5\Model\CreateTaskRequestBodyClusterScanInfo',
            'iacScanInfo' => '\HuaweiCloud\SDK\Hss\V5\Model\CreateTaskRequestBodyIacScanInfo'
    ];
    ...
    *  clusterScanInfo
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\CreateTaskRequestBodyClusterScanInfo|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\CreateTaskRequestBodyClusterScanInfo|null $clusterScanInfo clusterScanInfo
    *
    * @return $this
    */
    ...
    *  iacScanInfo
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\CreateTaskRequestBodyIacScanInfo|null
    */
    ...
    * Sets iacScanInfo
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\CreateTaskRequestBodyIacScanInfo|null $iacScanInfo iacScanInfo
    *
    * @return $this
    */
