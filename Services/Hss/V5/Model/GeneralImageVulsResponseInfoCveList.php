...
class GeneralImageVulsResponseInfoCveList implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GeneralImageVulsResponseInfo_cve_list';
