...
class ListSecurityReportRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSecurityReportRequest';
    ...
    * reportCategory  **参数解释**: \"报告类别(不传默认是全部)\"  **约束限制**:  不涉及  **取值范围**:  - daily_report：安全日报  - weekly_report：安全周报  - monthly_report：安全月报  - custom_report：自定义报告  **默认取值**:  不涉及，不传默认是全部
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['reportCategory']) && (mb_strlen($this->container['reportCategory']) > 32)) {
                $invalidProperties[] = "invalid value for 'reportCategory', the character length must be smaller than or equal to 32.";
            }
            ...
            if (!is_null($this->container['reportCategory']) && !preg_match("/^daily_report|weekly_report|monthly_report|custom_report$/", $this->container['reportCategory'])) {
                $invalidProperties[] = "invalid value for 'reportCategory', must be conform to the pattern /^daily_report|weekly_report|monthly_report|custom_report$/.";
            }
    ...
    * Sets reportCategory
    *
    * @param string|null $reportCategory **参数解释**: \"报告类别(不传默认是全部)\"  **约束限制**:  不涉及  **取值范围**:  - daily_report：安全日报  - weekly_report：安全周报  - monthly_report：安全月报  - custom_report：自定义报告  **默认取值**:  不涉及，不传默认是全部
    *
    * @return $this
    */
