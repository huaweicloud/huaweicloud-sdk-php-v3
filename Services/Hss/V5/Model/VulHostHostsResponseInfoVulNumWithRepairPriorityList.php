...
class VulHostHostsResponseInfoVulNumWithRepairPriorityList implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'VulHostHostsResponseInfo_vul_num_with_repair_priority_list';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * repairPriority  **参数解释**: 漏洞修复优先级 **取值范围**: 字符长度0-64位
    * vulNum  **参数解释**: 该优先级下的漏洞数量 **取值范围**: 最小值0，最大值2147483647
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['repairPriority']) && (mb_strlen($this->container['repairPriority']) > 64)) {
                $invalidProperties[] = "invalid value for 'repairPriority', the character length must be smaller than or equal to 64.";
            }
            if (!is_null($this->container['repairPriority']) && (mb_strlen($this->container['repairPriority']) < 0)) {
                $invalidProperties[] = "invalid value for 'repairPriority', the character length must be bigger than or equal to 0.";
            }
    ...
    * Sets repairPriority
    *
    * @param string|null $repairPriority **参数解释**: 漏洞修复优先级 **取值范围**: 字符长度0-64位
    *
    * @return $this
    */
    ...
    * Sets vulNum
    *
    * @param int|null $vulNum **参数解释**: 该优先级下的漏洞数量 **取值范围**: 最小值0，最大值2147483647
    *
    * @return $this
    */
