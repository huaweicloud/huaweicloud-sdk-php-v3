...
class ListSameEventsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSameEventsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  **参数解释**： 告警事件总数 **取值范围**： 最小值0，最大值2147483647
    * dataList  事件列表详情
    *
    * @var string[]
    */
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum **参数解释**： 告警事件总数 **取值范围**： 最小值0，最大值2147483647
    *
    * @return $this
    */
