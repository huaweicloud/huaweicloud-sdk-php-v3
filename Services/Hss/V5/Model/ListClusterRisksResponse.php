...
class ListClusterRisksResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListClusterRisksResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\ListClusterRisksResponseInfoDataList[]'
    ];
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum 集群风险列表数量
    *
    * @return $this
    */
    ...
    *  集群风险列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ListClusterRisksResponseInfoDataList[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ListClusterRisksResponseInfoDataList[]|null $dataList 集群风险列表
    *
    * @return $this
    */
