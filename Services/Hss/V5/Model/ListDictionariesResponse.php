...
class ListDictionariesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDictionariesResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\Dictionary[]'
    ];
    ...
    *  字典项数量
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\Dictionary[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\Dictionary[]|null $dataList 字典项数量
    *
    * @return $this
    */
