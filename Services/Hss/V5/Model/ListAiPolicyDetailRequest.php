...
class ListAiPolicyDetailRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAiPolicyDetailRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * policyId  **参数解释**： 策略组ID **约束限制**： 必填 **取值范围**： 最小值0，最大值9223372036854775807 **默认取值**： 不涉及
