...
class WebSiteStatisticsResponseInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'WebSiteStatisticsResponseInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * domain  **参数解释**: Web站点域名 **取值范围**: 字符长度0-256
    * num  **参数解释** Web站点统计信息总数 **取值范围** 最小值0，最大值300000
    *
    * @var string[]
    */
    ...
    * Sets domain
    *
    * @param string|null $domain **参数解释**: Web站点域名 **取值范围**: 字符长度0-256
    *
    * @return $this
    */
    ...
    * Sets num
    *
    * @param int|null $num **参数解释** Web站点统计信息总数 **取值范围** 最小值0，最大值300000
    *
    * @return $this
    */
