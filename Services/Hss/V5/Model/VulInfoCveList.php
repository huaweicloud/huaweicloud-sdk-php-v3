...
class VulInfoCveList implements ModelInterface, ArrayAccess
{
    ...
    * cveId  **参数解释**: CVE ID **取值范围**: 字符长度0-32位
    * cvss  **参数解释**: CVSS分值 **取值范围**: 取值0-10
    *
    * @var string[]
    */
    ...
    * Sets cveId
    *
    * @param string|null $cveId **参数解释**: CVE ID **取值范围**: 字符长度0-32位
    *
    * @return $this
    */
    ...
    * Sets cvss
    *
    * @param float|null $cvss **参数解释**: CVSS分值 **取值范围**: 取值0-10
    *
    * @return $this
    */
