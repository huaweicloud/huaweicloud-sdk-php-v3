...
class WebTamperProtectionConfigResponseInfoContainerWtpInfoClusterLabelList implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'WebTamperProtectionConfigResponseInfo_container_wtp_info_cluster_label_list';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * key  **参数解释**: 集群资源标签的键名 **取值范围**: 字符长度1-64位
    * value  **参数解释**: 集群资源标签的值 **取值范围**: 字符长度0-128位
    *
    * @var string[]
    */
    ...
    * Sets key
    *
    * @param string|null $key **参数解释**: 集群资源标签的键名 **取值范围**: 字符长度1-64位
    *
    * @return $this
    */
    ...
    * Sets value
    *
    * @param string|null $value **参数解释**: 集群资源标签的值 **取值范围**: 字符长度0-128位
    *
    * @return $this
    */
