...
class ShowBackupInfoByBackupIdResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowBackupInfoByBackupIdResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  **参数解释** 备份ID **取值范围** 字符长度0-65535位
    * name  **参数解释** 备份名称 **取值范围** 字符长度0-65535位
    ...
    * children  **参数解释** 子备份就是卷备份信息 **取值范围** 字符长度0-65535位
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'resourceType' => 'string',
            'resourceName' => 'string',
            'children' => '\HuaweiCloud\SDK\Hss\V5\Model\BackupResp[]'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['createdAt']) && ($this->container['createdAt'] > 9223372036854775807)) {
                $invalidProperties[] = "invalid value for 'createdAt', must be smaller than or equal to 9223372036854775807.";
            }
    ...
    * Sets id
    *
    * @param string|null $id **参数解释** 备份ID **取值范围** 字符长度0-65535位
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string|null $name **参数解释** 备份名称 **取值范围** 字符长度0-65535位
    *
    * @return $this
    */
    ...
    * Sets createdAt
    *
    * @param int|null $createdAt **参数解释** 创建时间 **取值范围** 取值0-9223372036854775807
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\BackupResp[]|null
    */
    ...
    * Sets children
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\BackupResp[]|null $children **参数解释** 子备份就是卷备份信息 **取值范围** 字符长度0-65535位
    *
    * @return $this
    */
