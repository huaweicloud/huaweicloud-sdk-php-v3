...
class RelatedEventInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RelatedEventInfo';
    ...
    * abstract  **参数解释**： 告警摘要 **取值范围**： 字符长度0-512位
    * eventAbstract  **参数解释**： 告警摘要 **取值范围**： 字符长度0-512位
    * similiarType  **参数解释**： 相似类型 **取值范围**： 字符长度0-128位
    ...
    * handler  **参数解释**： 处置账号信息 **取值范围**： 字符长度1-256位
    * memo  **参数解释**： 处置备注信息 **取值范围**： 字符长度1-2048位
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['handler']) && (mb_strlen($this->container['handler']) > 256)) {
                $invalidProperties[] = "invalid value for 'handler', the character length must be smaller than or equal to 256.";
            }
            if (!is_null($this->container['handler']) && (mb_strlen($this->container['handler']) < 1)) {
                $invalidProperties[] = "invalid value for 'handler', the character length must be bigger than or equal to 1.";
            }
    ...
    * Sets eventName
    *
    * @param string|null $eventName **参数解释**： 事件名称 **取值范围**： 字符长度1-256位
    *
    * @return $this
    */
    ...
    * Sets abstract
    *
    * @param string|null $abstract **参数解释**： 告警摘要 **取值范围**： 字符长度0-512位
    *
    * @return $this
    */
    ...
    * Sets eventAbstract
    *
    * @param string|null $eventAbstract **参数解释**： 告警摘要 **取值范围**： 字符长度0-512位
    *
    * @return $this
    */
    ...
    * Sets similiarType
    *
    * @param string|null $similiarType **参数解释**： 相似类型 **取值范围**： 字符长度0-128位
    *
    * @return $this
    */
    ...
    * Sets handler
    *
    * @param string|null $handler **参数解释**： 处置账号信息 **取值范围**： 字符长度1-256位
    *
    * @return $this
    */
    ...
    * Sets memo
    *
    * @param string|null $memo **参数解释**： 处置备注信息 **取值范围**： 字符长度1-2048位
    *
    * @return $this
    */
