...
class ShowClusterProtectPolicyTemplateResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowClusterProtectPolicyTemplateResponse';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['targetKind']) && !preg_match("/[1-9]*/", $this->container['targetKind'])) {
    ...
    * Sets targetKind
    *
    * @param string|null $targetKind **参数解释**: 策略模板应用资源类型，多个资源类型通过分号分隔连接 **取值范围**: 字符长度1-255
    *
    * @return $this
    */
