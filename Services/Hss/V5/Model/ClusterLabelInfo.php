...
class ClusterLabelInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ClusterLabelInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * key  **参数解释**: 集群资源标签的键名 **约束限制**: 不涉及 **取值范围**: 字符长度1-64位 **默认取值**: 不涉及
    * value  **参数解释**: 集群资源标签的值 **约束限制**: 不涉及 **取值范围**: 字符长度0-128位 **默认取值**: 不涉及
    *
    * @var string[]
    */
    ...
    * Sets key
    *
    * @param string|null $key **参数解释**: 集群资源标签的键名 **约束限制**: 不涉及 **取值范围**: 字符长度1-64位 **默认取值**: 不涉及
    *
    * @return $this
    */
    ...
    * Sets value
    *
    * @param string|null $value **参数解释**: 集群资源标签的值 **约束限制**: 不涉及 **取值范围**: 字符长度0-128位 **默认取值**: 不涉及
    *
    * @return $this
    */
