...
class ListHostsRiskResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListHostsRiskResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\HostRiskResponseInfo[]'
    ];
    ...
    *  查询ECS风险列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\HostRiskResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\HostRiskResponseInfo[]|null $dataList 查询ECS风险列表
    *
    * @return $this
    */
