...
class UpdateMultiCloudClustersRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateMultiCloudClustersRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'clusterId' => 'string',
            'body' => '\HuaweiCloud\SDK\Hss\V5\Model\UpdateMultiCloudClusterRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\UpdateMultiCloudClusterRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\UpdateMultiCloudClusterRequestBody|null $body body
    *
    * @return $this
    */
