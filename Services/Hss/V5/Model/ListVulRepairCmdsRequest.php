...
class ListVulRepairCmdsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListVulRepairCmdsRequest';
    ...
    * hostName  **参数解释**: 主机名称 **约束限制**: 不涉及 **取值范围**: 字符长度0-256位 **默认取值**: 不涉及
    * vulName  **参数解释**: 漏洞名称 **约束限制**: 不涉及 **取值范围**: 字符长度0-256位 **默认取值**: 不涉及
    * category  **参数解释**: 类别 **约束限制**: 不涉及 **取值范围**: - host：主机 - container：容器 - serverless：serverless场景  **默认取值**: host
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'vulName' => 'string',
            'category' => 'string',
            'body' => '\HuaweiCloud\SDK\Hss\V5\Model\ListVulRepairCmdsRequestBody'
    ];
    ...
    * Sets hostName
    *
    * @param string|null $hostName **参数解释**: 主机名称 **约束限制**: 不涉及 **取值范围**: 字符长度0-256位 **默认取值**: 不涉及
    *
    * @return $this
    */
    ...
    * Sets category
    *
    * @param string|null $category **参数解释**: 类别 **约束限制**: 不涉及 **取值范围**: - host：主机 - container：容器 - serverless：serverless场景  **默认取值**: host
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ListVulRepairCmdsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ListVulRepairCmdsRequestBody|null $body body
    *
    * @return $this
    */
