...
class SecurityRiskResponseImageRisk implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SecurityRiskResponse_image_risk';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * deductScore  **参数解释**： 扣分 **取值范围**: 最小值0，最大值10
    * unScannedImageNum  **参数解释**： 未扫描镜像数 **取值范围**: 最小值0，最大值2147483647
    ...
    */
    protected static $openAPITypes = [
            'deductScore' => 'float',
            'unScannedImageNum' => 'int',
            'riskList' => '\HuaweiCloud\SDK\Hss\V5\Model\SecurityRiskResponseImageRiskRiskList[]',
            'totalRiskNum' => 'int'
    ];
    ...
    */
    protected static $attributeMap = [
            ...
            'unScannedImageNum' => 'un_scanned_image_num',
            'riskList' => 'risk_list',
    ...
    */
    protected static $setters = [
            ...
            'unScannedImageNum' => 'setUnScannedImageNum',
    ...
    */
    protected static $getters = [
            ...
            'unScannedImageNum' => 'getUnScannedImageNum',
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['unScannedImageNum'] = isset($data['unScannedImageNum']) ? $data['unScannedImageNum'] : null;
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['unScannedImageNum']) && ($this->container['unScannedImageNum'] > 2147483647)) {
                $invalidProperties[] = "invalid value for 'unScannedImageNum', must be smaller than or equal to 2147483647.";
            }
            if (!is_null($this->container['unScannedImageNum']) && ($this->container['unScannedImageNum'] < 0)) {
                $invalidProperties[] = "invalid value for 'unScannedImageNum', must be bigger than or equal to 0.";
            }
    ...
    */
    ...
    /**
    * Gets unScannedImageNum
    *  **参数解释**： 未扫描镜像数 **取值范围**: 最小值0，最大值2147483647
    *
    * @return int|null
    */
    public function getUnScannedImageNum()
    {
        return $this->container['unScannedImageNum'];
    }

    /**
    * Sets unScannedImageNum
    *
    * @param int|null $unScannedImageNum **参数解释**： 未扫描镜像数 **取值范围**: 最小值0，最大值2147483647
    *
    * @return $this
    */
    public function setUnScannedImageNum($unScannedImageNum)
    {
        $this->container['unScannedImageNum'] = $unScannedImageNum;
        return $this;
    }
    ...
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\SecurityRiskResponseImageRiskRiskList[]|null
    */
    ...
    * Sets riskList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\SecurityRiskResponseImageRiskRiskList[]|null $riskList **参数解释**： 风险列表 **取值范围**: 最小值0，最大值4
    *
    * @return $this
    */
