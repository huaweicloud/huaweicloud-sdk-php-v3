...
class VulScanPolicyResponseInfoTime implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'VulScanPolicyResponseInfo_time';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * dayPart  **参数解释**: 扫描日期或者星期列表 **取值范围**: 最小值0，最大值31
    * hourPart  **参数解释**: 扫描时间的小时部分 **取值范围**: 最小值0，最大值11
    * minutePart  **参数解释**: 扫描时间的分钟部分 **取值范围**: 最小值0，最大值59
    * nextScanTime  **参数解释**: 下一次扫描时间 **取值范围**: 最小值0，最大值2^63-1
    * timezoneOffset  **参数解释**: 距离标准时区的差值，如东八区（GMT+8）为-480 **取值范围**: 最小值-840，最大值720
    *
    * @var string[]
    */
    ...
    * Sets dayPart
    *
    * @param int[]|null $dayPart **参数解释**: 扫描日期或者星期列表 **取值范围**: 最小值0，最大值31
    *
    * @return $this
    */
    ...
    * Sets hourPart
    *
    * @param int|null $hourPart **参数解释**: 扫描时间的小时部分 **取值范围**: 最小值0，最大值11
    *
    * @return $this
    */
    ...
    * Sets minutePart
    *
    * @param int|null $minutePart **参数解释**: 扫描时间的分钟部分 **取值范围**: 最小值0，最大值59
    *
    * @return $this
    */
    ...
    * Sets nextScanTime
    *
    * @param int|null $nextScanTime **参数解释**: 下一次扫描时间 **取值范围**: 最小值0，最大值2^63-1
    *
    * @return $this
    */
    ...
    * Sets timezoneOffset
    *
    * @param int|null $timezoneOffset **参数解释**: 距离标准时区的差值，如东八区（GMT+8）为-480 **取值范围**: 最小值-840，最大值720
    *
    * @return $this
    */
