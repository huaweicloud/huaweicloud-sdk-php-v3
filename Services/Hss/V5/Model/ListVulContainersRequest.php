...
class ListVulContainersRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListVulContainersRequest';
    ...
    * minScanTime  首次扫描时间最小值
    * maxScanTime  首次扫描时间最大值
    * limit  每页条数
    ...
    * Sets minScanTime
    *
    * @param int|null $minScanTime 首次扫描时间最小值
    *
    * @return $this
    */
    ...
    * Sets maxScanTime
    *
    * @param int|null $maxScanTime 首次扫描时间最大值
    *
    * @return $this
    */
