...
class ListAppWhitelistPolicyProcessResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAppWhitelistPolicyProcessResponse';
    ...
    */
    protected static $openAPITypes = [
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\AppWhitelistPolicyProcessResponseInfo[]',
            'totalNum' => 'int'
    ];
    ...
    *  data list
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\AppWhitelistPolicyProcessResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\AppWhitelistPolicyProcessResponseInfo[]|null $dataList data list
    *
    * @return $this
    */
