...
class CopyBaselinePolicyGroupRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CopyBaselinePolicyGroupRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * description  新策略组描述信息
    * groupName  新策略组名称
    * groupId  被复制策略组id
    *
    * @var string[]
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['groupName'] === null) {
            ...
            if ((mb_strlen($this->container['groupName']) > 61)) {
                $invalidProperties[] = "invalid value for 'groupName', the character length must be smaller than or equal to 61.";
            }
    ...
    * Sets description
    *
    * @param string|null $description 新策略组描述信息
    *
    * @return $this
    */
