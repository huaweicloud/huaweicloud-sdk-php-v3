...
class ListAiPoliciesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAiPoliciesRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * policyGroupId  **参数解释**： 策略组ID **约束限制**： 不涉及 **取值范围**： 字符长度1-20位 **默认取值**： 不涉及
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['policyGroupId'] === null) {
            $invalidProperties[] = "'policyGroupId' can't be null";
        }
            if ((mb_strlen($this->container['policyGroupId']) > 20)) {
                $invalidProperties[] = "invalid value for 'policyGroupId', the character length must be smaller than or equal to 20.";
            }
            if ((mb_strlen($this->container['policyGroupId']) < 1)) {
