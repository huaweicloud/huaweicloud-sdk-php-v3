...
class ListBackupHostsInfoResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListBackupHostsInfoResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * dataList  **参数解释**: 远端备份服务器列表 **取值范围**: 最小值0，最大值200
    * totalNum  **参数解释**: 总数 **取值范围**: 最小值0，最大值2147483647
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\WtpBackupHostResponseInfo[]',
            'totalNum' => 'int'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\WtpBackupHostResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\WtpBackupHostResponseInfo[]|null $dataList **参数解释**: 远端备份服务器列表 **取值范围**: 最小值0，最大值200
    *
    * @return $this
    */
