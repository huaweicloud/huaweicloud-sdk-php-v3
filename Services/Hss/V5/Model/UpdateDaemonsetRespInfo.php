...
class UpdateDaemonsetRespInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDaemonsetRespInfo';
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['failedReson']) && (mb_strlen($this->container['failedReson']) > 65535)) {
                $invalidProperties[] = "invalid value for 'failedReson', the character length must be smaller than or equal to 65535.";
            }
    ...
    * @return string|null
    */
    public function getFailedReson()
    {
        return $this->container['failedReson'];
    }
