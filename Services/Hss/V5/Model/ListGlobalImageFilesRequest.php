...
class ListGlobalImageFilesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGlobalImageFilesRequest';
    ...
    * imageType  **参数解释**: 镜像类型 **约束限制**: 不涉及 **取值范围**: - registry：仓库镜像。 - cicd：cicd镜像。 **默认取值**: 不涉及
    * fileName  **参数解释**: 文件名称过滤查询(支持模糊匹配) **约束限制**: 不涉及 **取值范围**: 字符长度0-65535 **默认取值**: 不涉及
    *
    * @var string[]
    */
    ...
    * Sets imageType
    *
    * @param string|null $imageType **参数解释**: 镜像类型 **约束限制**: 不涉及 **取值范围**: - registry：仓库镜像。 - cicd：cicd镜像。 **默认取值**: 不涉及
    *
    * @return $this
    */
    ...
    * Sets fileName
    *
    * @param string|null $fileName **参数解释**: 文件名称过滤查询(支持模糊匹配) **约束限制**: 不涉及 **取值范围**: 字符长度0-65535 **默认取值**: 不涉及
    *
    * @return $this
    */
