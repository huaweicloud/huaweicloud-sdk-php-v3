...
class ListProtectionServersRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListProtectionServersRequest';
    ...
    */
    ...
    const APP_STATUS_CLOSED = 'closed';
    const APP_STATUS_OPENED = 'opened';
    ...
    */
    ...
    {
        return [
            self::APP_STATUS_CLOSED,
            self::APP_STATUS_OPENED,
        ];
    }
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['offset'] === null) {
            ...
            if (($this->container['offset'] > 2147483547)) {
        ...
        if ($this->container['limit'] === null) {
            ...
            if (!is_null($this->container['hostIp']) && !preg_match("/^((25[0-5]|2[0-4]\\d|[01]?\\d\\d?)\\.){3}(25[0-5]|2[0-4]\\d|[01]?\\d\\d?)$/", $this->container['hostIp'])) {
                $invalidProperties[] = "invalid value for 'hostIp', must be conform to the pattern /^((25[0-5]|2[0-4]\\d|[01]?\\d\\d?)\\.){3}(25[0-5]|2[0-4]\\d|[01]?\\d\\d?)$/.";
            }
        ...
        if ($this->container['appStatus'] === null) {
            ...
            $allowedValues = $this->getAppStatusAllowableValues();
                if (!is_null($this->container['appStatus']) && !in_array($this->container['appStatus'], $allowedValues, true)) {
                $invalidProperties[] = sprintf(
                "invalid value for 'appStatus', must be one of '%s'",
                implode("', '", $allowedValues)
                );
            }
    ...
    * Sets hostName
    *
    * @param string|null $hostName 云主机名称
    *
    * @return $this
    */
    ...
    * Sets hostIp
    *
    * @param string|null $hostIp 云主机私有IP
    *
    * @return $this
    */
    ...
    * Sets appStatus
    *
    * @param string $appStatus 应用防护状态，包含如下2种。   - closed ：未开启。   - opened ：防护中。
    *
    * @return $this
    */
