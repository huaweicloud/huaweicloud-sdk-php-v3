...
class ShowSingleBackupPolicyInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowSingleBackupPolicyInfoRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['policyId'] === null) {
            ...
            if (!preg_match("/^[a-zA-Z0-9_-]+$/", $this->container['policyId'])) {
