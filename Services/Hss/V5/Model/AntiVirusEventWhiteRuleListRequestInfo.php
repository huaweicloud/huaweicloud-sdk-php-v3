...
class AntiVirusEventWhiteRuleListRequestInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AntiVirusEventWhiteRuleListRequestInfo';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['fieldKey'] === null) {
            ...
            if ((mb_strlen($this->container['fieldKey']) > 512)) {
                $invalidProperties[] = "invalid value for 'fieldKey', the character length must be smaller than or equal to 512.";
            }
            if ((mb_strlen($this->container['fieldKey']) < 0)) {
                $invalidProperties[] = "invalid value for 'fieldKey', the character length must be bigger than or equal to 0.";
            }
        if ($this->container['fieldValue'] === null) {
            $invalidProperties[] = "'fieldValue' can't be null";
        }
            if ((mb_strlen($this->container['fieldValue']) > 512)) {
                $invalidProperties[] = "invalid value for 'fieldValue', the character length must be smaller than or equal to 512.";
            }
            if ((mb_strlen($this->container['fieldValue']) < 0)) {
                $invalidProperties[] = "invalid value for 'fieldValue', the character length must be bigger than or equal to 0.";
            }
        if ($this->container['judgeType'] === null) {
            ...
            if ((mb_strlen($this->container['judgeType']) < 0)) {
                $invalidProperties[] = "invalid value for 'judgeType', the character length must be bigger than or equal to 0.";
            }
    ...
    * Sets fieldKey
    *
    * @param string $fieldKey 加白字段，包含如下: - file_path ：文件路径
    *
    * @return $this
    */
