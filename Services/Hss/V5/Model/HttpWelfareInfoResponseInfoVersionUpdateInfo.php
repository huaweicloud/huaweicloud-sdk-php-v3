...
class HttpWelfareInfoResponseInfoVersionUpdateInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'HttpWelfareInfoResponseInfo_version_update_info';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * title  **参数解释**: 版本更新标题 **取值范围**: 字符长度1-256
    * urlJson  **参数解释**: 版本更新链接，包括中国站，国际站欧洲站，由console根据不同的场景选择跳转 **取值范围**: 字符长度0-65535
    *
    * @var string[]
    */
    ...
    * Sets title
    *
    * @param string|null $title **参数解释**: 版本更新标题 **取值范围**: 字符长度1-256
    *
    * @return $this
    */
    ...
    * Sets urlJson
    *
    * @param string|null $urlJson **参数解释**: 版本更新链接，包括中国站，国际站欧洲站，由console根据不同的场景选择跳转 **取值范围**: 字符长度0-65535
    *
    * @return $this
    */
