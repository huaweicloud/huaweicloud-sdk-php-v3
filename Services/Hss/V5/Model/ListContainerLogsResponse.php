...
class ListContainerLogsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListContainerLogsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  日志总条数
    * dataList  k8s集群容器日志列表
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\ClusterContainerLogResponseInfo[]'
    ];
    ...
    *  k8s集群容器日志列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ClusterContainerLogResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ClusterContainerLogResponseInfo[]|null $dataList k8s集群容器日志列表
    *
    * @return $this
    */
