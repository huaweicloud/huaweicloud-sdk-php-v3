...
class ShowLinuxVulDetailRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowLinuxVulDetailRequest';
    ...
    * vulId  **参数解释**: 漏洞补丁编号 **约束限制**: 不涉及 **取值范围**: 字符长度1-256 **默认取值**: 不涉及
    * cveId  **参数解释**: 漏洞编号 **约束限制**: 不涉及 **取值范围**: 字符长度1-32 **默认取值**: 不涉及
    * handleStatus  **参数解释**: 漏洞处置状态 **约束限制**: 不涉及 **取值范围**: - unhandled：未处理 - handled：已处理  **默认取值**: 不涉及
    *
    * @var string[]
    */
    ...
    * Sets vulId
    *
    * @param string $vulId **参数解释**: 漏洞补丁编号 **约束限制**: 不涉及 **取值范围**: 字符长度1-256 **默认取值**: 不涉及
    *
    * @return $this
    */
    ...
    * Sets cveId
    *
    * @param string|null $cveId **参数解释**: 漏洞编号 **约束限制**: 不涉及 **取值范围**: 字符长度1-32 **默认取值**: 不涉及
    *
    * @return $this
    */
    ...
    * Sets handleStatus
    *
    * @param string|null $handleStatus **参数解释**: 漏洞处置状态 **约束限制**: 不涉及 **取值范围**: - unhandled：未处理 - handled：已处理  **默认取值**: 不涉及
    *
    * @return $this
    */
