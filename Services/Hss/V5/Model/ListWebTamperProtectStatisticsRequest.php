...
class ListWebTamperProtectStatisticsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListWebTamperProtectStatisticsRequest';
