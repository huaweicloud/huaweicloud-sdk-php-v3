...
class EventProcessResInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'EventProcessResInfo';
    ...
    * parentProcessName  **参数解释**： 父进程名称 **取值范围**： 字符长度1-64位
    * parentProcessPath  **参数解释**： 父进程文件路径 **取值范围**： 字符长度1-64位
    * parentProcessPid  **参数解释**: 父进程id **取值范围**: 最小值0，最大值2147483647
    * parentProcessUid  **参数解释**: 父进程用户id **取值范围**: 最小值0，最大值2147483647
    * parentProcessCmdline  **参数解释**： 父进程文件命令行 **取值范围**： 字符长度1-64位
    * parentProcessFilename  **参数解释**： 父进程文件名 **取值范围**： 字符长度1-64位
    ...
    * childProcessName  **参数解释**： 子进程名称 **取值范围**： 字符长度1-64位
    * childProcessPath  **参数解释**： 子进程文件路径 **取值范围**： 字符长度1-64位
    * childProcessPid  **参数解释**: 子进程id **取值范围**: 最小值0，最大值2147483647
    * childProcessUid  **参数解释**: 子进程用户id **取值范围**: 最小值0，最大值2147483647
    * childProcessCmdline  **参数解释**： 子进程文件命令行 **取值范围**： 字符长度1-64位
    * childProcessFilename  **参数解释**： 子进程文件名 **取值范围**： 字符长度1-64位
    ...
    * score  **参数解释**： 分数 **取值范围**： 字符长度1-64位
    * processFileHash  **参数解释**： 进程文件hash **取值范围**： 字符长度1-64位
    * parentProcessFileHash  **参数解释**： 父进程文件hash **取值范围**： 字符长度1-64位
    * ancestorProcessPid  **参数解释**: 祖父进程id **取值范围**: 最小值1，最大值2147483647
    * ancestorProcessCmdline  **参数解释**： 祖父进程命令行 **取值范围**： 字符长度1-64位
    * ancestorProcessPath  **参数解释**： 祖父进程路径 **取值范围**： 字符长度1-64位
    * operateType  **参数解释**: 操作类型 **取值范围**: 最小值1，最大值2147483647
    * sessionId  **参数解释**: 会话id **取值范围**: 最小值1，最大值2147483647
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['processUsername']) && (mb_strlen($this->container['processUsername']) > 128)) {
                $invalidProperties[] = "invalid value for 'processUsername', the character length must be smaller than or equal to 128.";
            }
            if (!is_null($this->container['processUsername']) && (mb_strlen($this->container['processUsername']) < 1)) {
                $invalidProperties[] = "invalid value for 'processUsername', the character length must be bigger than or equal to 1.";
            }
            ...
            if (!is_null($this->container['processFilename']) && (mb_strlen($this->container['processFilename']) > 64)) {
                $invalidProperties[] = "invalid value for 'processFilename', the character length must be smaller than or equal to 64.";
            }
            if (!is_null($this->container['processFilename']) && (mb_strlen($this->container['processFilename']) < 1)) {
                $invalidProperties[] = "invalid value for 'processFilename', the character length must be bigger than or equal to 1.";
            }
            ...
            if (!is_null($this->container['processEuid']) && ($this->container['processEuid'] > 9223372036854775807)) {
                $invalidProperties[] = "invalid value for 'processEuid', must be smaller than or equal to 9223372036854775807.";
            }
            ...
            if (!is_null($this->container['mode']) && !preg_match("/^.*$/", $this->container['mode'])) {
                $invalidProperties[] = "invalid value for 'mode', must be conform to the pattern /^.*$/.";
            }
    ...
    * Sets processUid
    *
    * @param int|null $processUid **参数解释**： 进程名称 **取值范围**： 最小值0，最大值2147483647
    *
    * @return $this
    */
    ...
    *
    * @param string|null $processUsername **参数解释**： 运行进程的用户名 **取值范围**： 字符长度1-128位
    *
    * @return $this
    */
    ...
    * Sets processCmdline
    *
    * @param string|null $processCmdline **参数解释**： 进程命令行 **约束限制**： 不涉及
    *
    * @return $this
    */
    ...
    *
    * @param string|null $processFilename **参数解释**： 进程文件名 **取值范围**： 字符长度1-64位
    *
    * @return $this
    */
    ...
    * Sets processEuid
    *
    * @param int|null $processEuid **参数解释**: 进程有效用户ID **取值范围**: 最小值0，最大值9223372036854775807
    *
    * @return $this
    */
    ...
    *
    * @param string|null $parentProcessName **参数解释**： 父进程名称 **取值范围**： 字符长度1-64位
    *
    * @return $this
    */
    ...
    *
    * @param string|null $parentProcessPath **参数解释**： 父进程文件路径 **取值范围**： 字符长度1-64位
    *
    * @return $this
    */
    ...
    *
    * @param string|null $parentProcessCmdline **参数解释**： 父进程文件命令行 **取值范围**： 字符长度1-64位
    *
    * @return $this
    */
    ...
    *
    * @param string|null $parentProcessFilename **参数解释**： 父进程文件名 **取值范围**： 字符长度1-64位
    *
    * @return $this
    */
    ...
    *
    * @param string|null $childProcessName **参数解释**： 子进程名称 **取值范围**： 字符长度1-64位
    *
    * @return $this
    */
    ...
    *
    * @param string|null $childProcessPath **参数解释**： 子进程文件路径 **取值范围**： 字符长度1-64位
    *
    * @return $this
    */
    ...
    *
    * @param string|null $childProcessCmdline **参数解释**： 子进程文件命令行 **取值范围**： 字符长度1-64位
    *
    * @return $this
    */
    ...
    *
    * @param string|null $childProcessFilename **参数解释**： 子进程文件名 **取值范围**： 字符长度1-64位
    *
    * @return $this
    */
    ...
    * Sets virtCmd
    *
    * @param string|null $virtCmd **参数解释**： 虚拟化命令 **取值范围**： 字符长度1-64位
    *
    * @return $this
    */
    ...
    *
    * @param string|null $virtProcessName **参数解释**： 虚拟化进程名称 **取值范围**： 字符长度1-64位
    *
    * @return $this
    */
    ...
    * Sets escapeMode
    *
    * @param string|null $escapeMode **参数解释**： 逃逸方式 **取值范围**： 字符长度1-64位
    *
    * @return $this
    */
    ...
    * Sets processHash
    *
    * @param string|null $processHash **参数解释**： 进程启动文件hash **取值范围**： 字符长度1-64位
    *
    * @return $this
    */
    ...
    * Sets mode
    *
    * @param string|null $mode **参数解释**： 文件属性 **取值范围**： 字符长度1-64位
    *
    * @return $this
    */
    ...
    * Sets rule
    *
    * @param int|null $rule **参数解释**： 规则 **取值范围**： 字符长度1-64位
    *
    * @return $this
    */
    ...
    * Sets score
    *
    * @param int|null $score **参数解释**： 分数 **取值范围**： 字符长度1-64位
    *
    * @return $this
    */
    ...
    *
    * @param string|null $processFileHash **参数解释**： 进程文件hash **取值范围**： 字符长度1-64位
    *
    * @return $this
    */
    ...
    *
    * @param string|null $parentProcessFileHash **参数解释**： 父进程文件hash **取值范围**： 字符长度1-64位
    *
    * @return $this
    */
    ...
    *
    * @param int|null $ancestorProcessPid **参数解释**: 祖父进程id **取值范围**: 最小值1，最大值2147483647
    *
    * @return $this
    */
    ...
    *
    * @param string|null $ancestorProcessCmdline **参数解释**： 祖父进程命令行 **取值范围**： 字符长度1-64位
    *
    * @return $this
    */
    ...
    *
    * @param string|null $ancestorProcessPath **参数解释**： 祖父进程路径 **取值范围**： 字符长度1-64位
    *
    * @return $this
    */
    ...
    * Sets operateType
    *
    * @param int|null $operateType **参数解释**: 操作类型 **取值范围**: 最小值1，最大值2147483647
    *
    * @return $this
    */
    ...
    * Sets sessionId
    *
    * @param int|null $sessionId **参数解释**: 会话id **取值范围**: 最小值1，最大值2147483647
    *
    * @return $this
    */
