...
class ListBackedupByHostIdRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListBackedupByHostIdRequest';
    ...
    * status  **参数解释**: 状态 **约束限制**: 不涉及 **取值范围**: - available：可用 - protecting：保护中 - deleting：删除中 - restoring：恢复中 - error：异常 - waiting_protect：等待保护 - waiting_delete：等待删除 - waiting_restore：等待恢复  **默认取值**: 不涉及
    * name  **参数解释**: 备份名称 **约束限制**: 不涉及 **取值范围**: 字符长度0-65535位 **默认取值**: 不涉及
    * lastDays  **参数解释**: 查询时间范围 **约束限制**: 不涉及 **取值范围**: 取值1-30 **默认取值**: 不涉及
    *
    * @var string[]
    */
    ...
    * Sets status
    *
    * @param string|null $status **参数解释**: 状态 **约束限制**: 不涉及 **取值范围**: - available：可用 - protecting：保护中 - deleting：删除中 - restoring：恢复中 - error：异常 - waiting_protect：等待保护 - waiting_delete：等待删除 - waiting_restore：等待恢复  **默认取值**: 不涉及
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string|null $name **参数解释**: 备份名称 **约束限制**: 不涉及 **取值范围**: 字符长度0-65535位 **默认取值**: 不涉及
    *
    * @return $this
    */
    ...
    * Sets lastDays
    *
    * @param int|null $lastDays **参数解释**: 查询时间范围 **约束限制**: 不涉及 **取值范围**: 取值1-30 **默认取值**: 不涉及
    *
    * @return $this
    */
