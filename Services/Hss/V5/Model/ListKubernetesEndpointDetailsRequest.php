...
class ListKubernetesEndpointDetailsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListKubernetesEndpointDetailsRequest';
