...
class ShowMultiCloudClusterProxyScriptRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowMultiCloudClusterProxyScriptRequest';
