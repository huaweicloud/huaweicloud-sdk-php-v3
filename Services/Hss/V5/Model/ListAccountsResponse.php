...
class ListAccountsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\AccountResponseInfo[]',
            'xRequestId' => 'string'
    ];
    ...
    *  事件列表详情
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\AccountResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\AccountResponseInfo[]|null $dataList 事件列表详情
    *
    * @return $this
    */
