...
class TagInfo implements ModelInterface, ArrayAccess
{
    ...
    * key  **参数解释**： 键 **取值范围**: 最大长度128个unicode字符。 key不能为空
    * value  **参数解释**： 值 **取值范围**: 最大长度255个unicode字符。
    *
    * @var string[]
    */
    ...
    * Sets key
    *
    * @param string|null $key **参数解释**： 键 **取值范围**: 最大长度128个unicode字符。 key不能为空
    *
    * @return $this
    */
    ...
    * Sets value
    *
    * @param string|null $value **参数解释**： 值 **取值范围**: 最大长度255个unicode字符。
    *
    * @return $this
    */
