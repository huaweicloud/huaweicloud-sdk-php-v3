...
class ListLocalImageHostsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListLocalImageHostsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  总数
    * dataList  查询本地镜像的主机列表
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\LocalImageHostInfo[]'
    ];
    ...
    *  查询本地镜像的主机列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\LocalImageHostInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\LocalImageHostInfo[]|null $dataList 查询本地镜像的主机列表
    *
    * @return $this
    */
