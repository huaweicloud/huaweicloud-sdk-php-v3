...
class SecurityRiskResponseVulRisk implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SecurityRiskResponse_vul_risk';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * riskList  **参数解释**： 漏洞风险列表 **取值范围**: 最小值0，最大值4
    * deductScore  **参数解释**： 扣分 **取值范围**: 最小值0，最大值20
    * unScannedHostNum  **参数解释**： 未进行漏洞扫描主机数(一个月内) **取值范围**: 最小值0，最大值2147483647
    ...
    */
    protected static $attributeMap = [
            ...
            'unScannedHostNum' => 'un_scanned_host_num',
    ...
    */
    protected static $setters = [
            ...
            'unScannedHostNum' => 'setUnScannedHostNum',
    ...
    */
    protected static $getters = [
            ...
            'unScannedHostNum' => 'getUnScannedHostNum',
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['unScannedHostNum'] = isset($data['unScannedHostNum']) ? $data['unScannedHostNum'] : null;
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['unScannedHostNum']) && ($this->container['unScannedHostNum'] > 2147483647)) {
                $invalidProperties[] = "invalid value for 'unScannedHostNum', must be smaller than or equal to 2147483647.";
            }
            if (!is_null($this->container['unScannedHostNum']) && ($this->container['unScannedHostNum'] < 0)) {
                $invalidProperties[] = "invalid value for 'unScannedHostNum', must be bigger than or equal to 0.";
            }
    ...
    * Sets riskList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\RiskListInfo[]|null $riskList **参数解释**： 漏洞风险列表 **取值范围**: 最小值0，最大值4
    *
    * @return $this
    */
    ...
    */
    ...
    /**
    * Gets unScannedHostNum
    *  **参数解释**： 未进行漏洞扫描主机数(一个月内) **取值范围**: 最小值0，最大值2147483647
    *
    * @return int|null
    */
    public function getUnScannedHostNum()
    {
        return $this->container['unScannedHostNum'];
    }

    /**
    * Sets unScannedHostNum
    *
    * @param int|null $unScannedHostNum **参数解释**： 未进行漏洞扫描主机数(一个月内) **取值范围**: 最小值0，最大值2147483647
    *
    * @return $this
    */
    public function setUnScannedHostNum($unScannedHostNum)
    {
        $this->container['unScannedHostNum'] = $unScannedHostNum;
        return $this;
    }
