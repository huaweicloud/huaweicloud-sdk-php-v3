...
class WebFrameworkInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'WebFrameworkInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * catalogue  **参数解释**: 分类 **取值范围**: 字符长度1-32
    ...
    * Sets catalogue
    *
    * @param string|null $catalogue **参数解释**: 分类 **取值范围**: 字符长度1-32
    *
    * @return $this
    */
