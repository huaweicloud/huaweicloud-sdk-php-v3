...
class ExportTaskInfoRequestBodyOperationalReportData implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExportTaskInfoRequestBody_operational_report_data';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * reportId  **参数解释**: 导出的报告的id **约束限制**: 不涉及 **取值范围**: 字符长度1-32位 **默认取值**: 不涉及
    *
    * @var string[]
    */
    ...
    * Sets reportId
    *
    * @param string $reportId **参数解释**: 导出的报告的id **约束限制**: 不涉及 **取值范围**: 字符长度1-32位 **默认取值**: 不涉及
    *
    * @return $this
    */
