...
class ListSystemConfigsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSystemConfigsResponse';
    ...
    * Sets dataList
    *
    * @param string[]|null $dataList 系统配置信息列表
    *
    * @return $this
    */
