...
class ListClusterProtectionPolicyDetailRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListClusterProtectionPolicyDetailRequest';
