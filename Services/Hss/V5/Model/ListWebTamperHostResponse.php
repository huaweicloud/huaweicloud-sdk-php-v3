...
class ListWebTamperHostResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListWebTamperHostResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  **参数解释**: 总数 **取值范围**: 最小值0，最大值2147483647
    * dataList  可开启网页防篡改的服务器列表
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\WebTamperHostResponseInfo[]'
    ];
    ...
    *  可开启网页防篡改的服务器列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\WebTamperHostResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\WebTamperHostResponseInfo[]|null $dataList 可开启网页防篡改的服务器列表
    *
    * @return $this
    */
