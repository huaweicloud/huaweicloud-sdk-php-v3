...
class CreateImageSynchronizeTaskRequestInfoRegistryInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateImageSynchronizeTaskRequestInfo_registry_info';
