...
class CheckFeatureRuleInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CheckFeatureRuleInfo';
    ...
    * protectiveAction  **参数解释**: 防护动作 **约束限制**: 不涉及 **取值范围**: - 1：检测 - 2: 检测并阻断/拦截     **默认取值**: 不涉及
    * optionalProtectiveAction  **参数解释**: 可选防护动作 **约束限制**: 不涉及 **取值范围**: - 1：检测 - 2: 检测并阻断/拦截 - 3: 都可以       **默认取值**: 不涉及
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['enabled']) && ($this->container['enabled'] > 2097152)) {
    ...
    * Sets chkFeatureId
    *
    * @param int|null $chkFeatureId 检测规则ID
    *
    * @return $this
    */
    ...
    * Sets chkFeatureDesc
    *
    * @param string|null $chkFeatureDesc 检测规则描述
    *
    * @return $this
    */
    ...
    *
    * @param int|null $protectiveAction **参数解释**: 防护动作 **约束限制**: 不涉及 **取值范围**: - 1：检测 - 2: 检测并阻断/拦截     **默认取值**: 不涉及
    *
    * @return $this
    */
    ...
    *
    * @param int|null $optionalProtectiveAction **参数解释**: 可选防护动作 **约束限制**: 不涉及 **取值范围**: - 1：检测 - 2: 检测并阻断/拦截 - 3: 都可以       **默认取值**: 不涉及
    *
    * @return $this
    */
