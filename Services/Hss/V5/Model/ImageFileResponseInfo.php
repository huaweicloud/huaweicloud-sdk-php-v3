...
class ImageFileResponseInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImageFileResponseInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * fileName  **参数解释**: 文件名称 **取值范围**: 字符长度0-256
    * filePath  **参数解释**: 文件路径 **取值范围**: 字符长度0-256
    ...
    * Sets filePath
    *
    * @param string|null $filePath **参数解释**: 文件路径 **取值范围**: 字符长度0-256
    *
    * @return $this
    */
