...
class DeleteImageWhiteListsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteImageWhiteListsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'type' => 'string',
            'body' => '\HuaweiCloud\SDK\Hss\V5\Model\DeleteImageWhiteListsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\DeleteImageWhiteListsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\DeleteImageWhiteListsRequestBody|null $body body
    *
    * @return $this
    */
