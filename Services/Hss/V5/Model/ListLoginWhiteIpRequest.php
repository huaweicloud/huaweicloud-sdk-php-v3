...
class ListLoginWhiteIpRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListLoginWhiteIpRequest';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['whiteIp']) && (mb_strlen($this->container['whiteIp']) > 128)) {
                $invalidProperties[] = "invalid value for 'whiteIp', the character length must be smaller than or equal to 128.";
            }
            if (!is_null($this->container['whiteIp']) && (mb_strlen($this->container['whiteIp']) < 1)) {
