...
class ListDecoyPortPolicyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDecoyPortPolicyResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  **参数解释**: 总数 **取值范围**: 最小值0，最大值2147483647
    * dataList  policy list
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\PolicyListDataList[]'
    ];
    ...
    *  policy list
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\PolicyListDataList[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\PolicyListDataList[]|null $dataList policy list
    *
    * @return $this
    */
