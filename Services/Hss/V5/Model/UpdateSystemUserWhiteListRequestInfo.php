...
class UpdateSystemUserWhiteListRequestInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateSystemUserWhiteListRequestInfo';
