...
class EventTypeResponseInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'EventTypeResponseInfo';
    ...
    * eventNum  事件数量
    * status  状态，目前包含如下2种。   - locked ：加锁。   - unlocked ：解锁。
    *
    * @var string[]
    */
    ...
    * Sets status
    *
    * @param string|null $status 状态，目前包含如下2种。   - locked ：加锁。   - unlocked ：解锁。
    *
    * @return $this
    */
