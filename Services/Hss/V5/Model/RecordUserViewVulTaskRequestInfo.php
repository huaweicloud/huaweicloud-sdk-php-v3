...
class RecordUserViewVulTaskRequestInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RecordUserViewVulTaskRequestInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * taskType  任务类型 - vul_repair：修复任务 - vul_scan：扫描任务
    *
    * @var string[]
    */
    ...
    * Sets taskType
    *
    * @param string $taskType 任务类型 - vul_repair：修复任务 - vul_scan：扫描任务
    *
    * @return $this
    */
