...
class ChangeExtendedWeakPasswordRequestInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeExtendedWeakPasswordRequestInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * extendedWeakPassword  **参数解释**: 自定义弱口令，选填，可编辑 **取值范围**: 最小值0，最大值300
    *
    * @var string[]
    */
    ...
    *
    * @param string[]|null $extendedWeakPassword **参数解释**: 自定义弱口令，选填，可编辑 **取值范围**: 最小值0，最大值300
    *
    * @return $this
    */
