...
class ExportSecurityCheckReportResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExportSecurityCheckReportResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\ExportSecurityCheckInfoResponseInfo[]'
    ];
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum 配置检测信息总数
    *
    * @return $this
    */
    ...
    *  数据列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ExportSecurityCheckInfoResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ExportSecurityCheckInfoResponseInfo[]|null $dataList 数据列表
    *
    * @return $this
    */
