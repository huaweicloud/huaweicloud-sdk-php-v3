...
class ListSimilarHandledEventsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSimilarHandledEventsResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\SimilarHandledEvent[]'
    ];
    ...
    *  相似已处置的告警列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\SimilarHandledEvent[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\SimilarHandledEvent[]|null $dataList 相似已处置的告警列表
    *
    * @return $this
    */
