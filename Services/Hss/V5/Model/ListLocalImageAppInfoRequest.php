...
class ListLocalImageAppInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListLocalImageAppInfoRequest';
    ...
    * appName  **参数解释**: 软件名称过滤查询(支持模糊匹配) **约束限制**： 不涉及 **取值范围**: 字符长度0-256位 **默认取值**: 不涉及
    *
    * @var string[]
    */
    ...
    * Sets appName
    *
    * @param string|null $appName **参数解释**: 软件名称过滤查询(支持模糊匹配) **约束限制**： 不涉及 **取值范围**: 字符长度0-256位 **默认取值**: 不涉及
    *
    * @return $this
    */
