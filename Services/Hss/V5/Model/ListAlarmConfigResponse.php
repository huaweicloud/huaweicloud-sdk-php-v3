...
class ListAlarmConfigResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAlarmConfigResponse';
    ...
    *
    * @param string[]|null $ignoredEventClassList 忽略的事件列表
    *
    * @return $this
    */
