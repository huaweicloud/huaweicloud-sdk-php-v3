...
class ListPluginsRequest implements ModelInterface, ArrayAccess
{
    ...
    * name  **参数解释**： 插件名称 **约束限制**: 不涉及 **取值范围**: 字符长度1-256位 **默认取值**: 不涉及
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['code']) && !preg_match("/^[\\w.-]*$/", $this->container['code'])) {
    ...
    * Sets code
    *
    * @param string|null $code **参数解释**： 插件编码 **约束限制**: 不涉及 **取值范围**: 字符长度1-64位 **默认取值**: 不涉及
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string|null $name **参数解释**： 插件名称 **约束限制**: 不涉及 **取值范围**: 字符长度1-256位 **默认取值**: 不涉及
    *
    * @return $this
    */
