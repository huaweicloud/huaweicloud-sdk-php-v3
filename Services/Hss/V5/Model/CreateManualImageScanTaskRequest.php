...
class CreateManualImageScanTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateManualImageScanTaskRequest';
    ...
    * globalImageType  **参数解释**: 镜像类型 **约束限制**: 不涉及 **取值范围**: - local：本地镜像。 - registry：仓库镜像。  **默认取值**: registry
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Hss\V5\Model\CreateManualImageScanTaskReqInfo'
    ];
    ...
    *
    * @param string|null $globalImageType **参数解释**: 镜像类型 **约束限制**: 不涉及 **取值范围**: - local：本地镜像。 - registry：仓库镜像。  **默认取值**: registry
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\CreateManualImageScanTaskReqInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\CreateManualImageScanTaskReqInfo|null $body body
    *
    * @return $this
    */
