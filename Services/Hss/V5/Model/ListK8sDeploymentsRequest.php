...
class ListK8sDeploymentsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListK8sDeploymentsRequest';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['deploymentName']) && (mb_strlen($this->container['deploymentName']) > 256)) {
                $invalidProperties[] = "invalid value for 'deploymentName', the character length must be smaller than or equal to 256.";
            }
            if (!is_null($this->container['deploymentName']) && (mb_strlen($this->container['deploymentName']) < 0)) {
                $invalidProperties[] = "invalid value for 'deploymentName', the character length must be bigger than or equal to 0.";
            }
            if (!is_null($this->container['deploymentName']) && !preg_match("/^.*$/", $this->container['deploymentName'])) {
                $invalidProperties[] = "invalid value for 'deploymentName', must be conform to the pattern /^.*$/.";
            }
    ...
    * Sets deploymentName
    *
    * @param string|null $deploymentName deployment名称
    *
    * @return $this
    */
