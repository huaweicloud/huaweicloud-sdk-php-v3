...
class ListVulAffectImageAppsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListVulAffectImageAppsResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\VulAffectImageAppsResponseInfo[]'
    ];
    ...
    *  列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\VulAffectImageAppsResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\VulAffectImageAppsResponseInfo[]|null $dataList 列表
    *
    * @return $this
    */
