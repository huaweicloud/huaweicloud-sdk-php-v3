...
class ExportHandledVulnerabilitiesRequestBodySpecificVuls implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExportHandledVulnerabilitiesRequestBody_specific_vuls';
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['hostId']) && (mb_strlen($this->container['hostId']) > 512)) {
                $invalidProperties[] = "invalid value for 'hostId', the character length must be smaller than or equal to 512.";
            }
