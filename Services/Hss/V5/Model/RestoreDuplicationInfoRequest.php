...
class RestoreDuplicationInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RestoreDuplicationInfoRequest';
    ...
    * backupId  **参数解释**: 备份ID **约束限制**: 不涉及 **取值范围**: 字符串大小0-64 **默认取值**: 不涉及
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'backupId' => 'string',
            'body' => '\HuaweiCloud\SDK\Hss\V5\Model\RestoreDuplicationRequestInfo'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['backupId'] === null) {
            ...
            if ((mb_strlen($this->container['backupId']) > 64)) {
                $invalidProperties[] = "invalid value for 'backupId', the character length must be smaller than or equal to 64.";
            }
            if ((mb_strlen($this->container['backupId']) < 0)) {
                $invalidProperties[] = "invalid value for 'backupId', the character length must be bigger than or equal to 0.";
            }
            if (!preg_match("/^.*$/", $this->container['backupId'])) {
                $invalidProperties[] = "invalid value for 'backupId', must be conform to the pattern /^.*$/.";
            }
    ...
    * Sets backupId
    *
    * @param string $backupId **参数解释**: 备份ID **约束限制**: 不涉及 **取值范围**: 字符串大小0-64 **默认取值**: 不涉及
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\RestoreDuplicationRequestInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\RestoreDuplicationRequestInfo|null $body body
    *
    * @return $this
    */
