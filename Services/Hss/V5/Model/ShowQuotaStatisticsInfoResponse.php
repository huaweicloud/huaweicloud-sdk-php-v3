...
class ShowQuotaStatisticsInfoResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowQuotaStatisticsInfoResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\QuotaStatisticsInfo[]'
    ];
    ...
    *  防护配额统计列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\QuotaStatisticsInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\QuotaStatisticsInfo[]|null $dataList 防护配额统计列表
    *
    * @return $this
    */
