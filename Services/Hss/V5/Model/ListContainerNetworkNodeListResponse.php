...
class ListContainerNetworkNodeListResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListContainerNetworkNodeListResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'lastUpdateTime' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\NetworkNodeInfo[]'
    ];
    ...
    *  网络节点列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\NetworkNodeInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\NetworkNodeInfo[]|null $dataList 网络节点列表
    *
    * @return $this
    */
