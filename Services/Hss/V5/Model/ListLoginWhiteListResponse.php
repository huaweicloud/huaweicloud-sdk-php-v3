...
class ListLoginWhiteListResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListLoginWhiteListResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\LoginWhiteListResponseInfo[]'
    ];
    ...
    *  登录白名单详情
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\LoginWhiteListResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\LoginWhiteListResponseInfo[]|null $dataList 登录白名单详情
    *
    * @return $this
    */
