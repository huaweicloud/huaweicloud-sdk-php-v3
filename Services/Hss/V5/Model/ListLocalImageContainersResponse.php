...
class ListLocalImageContainersResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListLocalImageContainersResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  总数
    * dataList  查询本地镜像的容器列表
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\LocalImageContainerInfo[]'
    ];
    ...
    *  查询本地镜像的容器列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\LocalImageContainerInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\LocalImageContainerInfo[]|null $dataList 查询本地镜像的容器列表
    *
    * @return $this
    */
