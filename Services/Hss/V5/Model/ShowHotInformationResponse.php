...
class ShowHotInformationResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowHotInformationResponse';
    ...
    */
    protected static $openAPITypes = [
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\HotInfo',
            'totalNum' => 'int'
    ];
    ...
    *  dataList
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\HotInfo|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\HotInfo|null $dataList dataList
    *
    * @return $this
    */
