...
class AssetValueHostNumInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssetValueHostNumInfo';
    ...
    */
    ...
    const VALUE_TYPE_IMPORTANT = 'important';
    const VALUE_TYPE_COMMON = 'common';
    const VALUE_TYPE_TEST = 'test';
    ...
    */
    ...
    {
        return [
            self::VALUE_TYPE_IMPORTANT,
            self::VALUE_TYPE_COMMON,
    ...
    * Sets valueType
    *
    * @param string|null $valueType 重要性类型
    *
    * @return $this
    */
