...
class ListAppWhitelistPolicyProcessExtendRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAppWhitelistPolicyProcessExtendRequest';
