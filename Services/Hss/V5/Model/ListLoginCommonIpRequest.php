...
class ListLoginCommonIpRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListLoginCommonIpRequest';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['ipAddr']) && (mb_strlen($this->container['ipAddr']) > 128)) {
    ...
    * Sets ipAddr
    *
    * @param string|null $ipAddr 登录IP地址+掩码
    *
    * @return $this
    */
