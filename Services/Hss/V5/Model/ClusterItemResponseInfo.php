...
class ClusterItemResponseInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ClusterItemResponseInfo';
    ...
    * Sets clusterNs
    *
    * @param string[]|null $clusterNs 集群命名空间
    *
    * @return $this
    */
    ...
    */
    ...
    {
        return $this->container['clusterLabels'];
    }

    /**
    * Sets clusterLabels
    *
    * @param string[]|null $clusterLabels 集群标签
    *
    * @return $this
    */
