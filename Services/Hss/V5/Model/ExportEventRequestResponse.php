...
class ExportEventRequestResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExportEventRequestResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * recordTotalNum  **参数解释**： 导出记录总数 **取值范围**： 不涉及
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['recordTotalNum']) && ($this->container['recordTotalNum'] > 200000)) {
                $invalidProperties[] = "invalid value for 'recordTotalNum', must be smaller than or equal to 200000.";
            }
    ...
    * Sets recordTotalNum
    *
    * @param int|null $recordTotalNum **参数解释**： 导出记录总数 **取值范围**： 不涉及
    *
    * @return $this
    */
