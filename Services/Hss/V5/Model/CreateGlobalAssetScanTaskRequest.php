...
class CreateGlobalAssetScanTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateGlobalAssetScanTaskRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'category' => 'string',
            'body' => '\HuaweiCloud\SDK\Hss\V5\Model\CreateGlobalAssetScanTaskRequestInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\CreateGlobalAssetScanTaskRequestInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\CreateGlobalAssetScanTaskRequestInfo|null $body body
    *
    * @return $this
    */
