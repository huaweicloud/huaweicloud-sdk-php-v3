...
class CheckRuleFixParamInfo implements ModelInterface, ArrayAccess
{
    ...
    * ruleParamId  **参数解释** 检查项参数ID **取值范围** 取值0-10
    * ruleDesc  **参数解释** 检查项参数描述 **取值范围** 字符长度0-256位
    * defaultValue  **参数解释** 检查项参数默认值 **取值范围** 取值0-2147483647
    * rangeMin  **参数解释** 检查项参数可取最小值 **取值范围** 取值0-2147483647
    * rangeMax  **参数解释** 检查项参数可取最大值 **取值范围** 取值0-2147483647
    *
    * @var string[]
    */
    ...
    * Sets ruleParamId
    *
    * @param int|null $ruleParamId **参数解释** 检查项参数ID **取值范围** 取值0-10
    *
    * @return $this
    */
    ...
    * Sets ruleDesc
    *
    * @param string|null $ruleDesc **参数解释** 检查项参数描述 **取值范围** 字符长度0-256位
    *
    * @return $this
    */
    ...
    * Sets defaultValue
    *
    * @param int|null $defaultValue **参数解释** 检查项参数默认值 **取值范围** 取值0-2147483647
    *
    * @return $this
    */
    ...
    * Sets rangeMin
    *
    * @param int|null $rangeMin **参数解释** 检查项参数可取最小值 **取值范围** 取值0-2147483647
    *
    * @return $this
    */
    ...
    * Sets rangeMax
    *
    * @param int|null $rangeMax **参数解释** 检查项参数可取最大值 **取值范围** 取值0-2147483647
    *
    * @return $this
    */
