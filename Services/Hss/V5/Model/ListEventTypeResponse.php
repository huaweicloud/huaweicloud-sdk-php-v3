...
class ListEventTypeResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListEventTypeResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\EventTypeDetailResponseInfo[]'
    ];
    ...
    *  各种类型详情
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\EventTypeDetailResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\EventTypeDetailResponseInfo[]|null $dataList 各种类型详情
    *
    * @return $this
    */
