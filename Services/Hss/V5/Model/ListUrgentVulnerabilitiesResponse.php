...
class ListUrgentVulnerabilitiesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListUrgentVulnerabilitiesResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  **参数解释**： 总数 **取值范围**： 字符长度0-2147483647位
    * dataList  **参数解释**： 应急漏洞列表
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\UrgentVulInfo[]'
    ];
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum **参数解释**： 总数 **取值范围**： 字符长度0-2147483647位
    *
    * @return $this
    */
    ...
    *  **参数解释**： 应急漏洞列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\UrgentVulInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\UrgentVulInfo[]|null $dataList **参数解释**： 应急漏洞列表
    *
    * @return $this
    */
