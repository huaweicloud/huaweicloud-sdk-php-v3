...
class ListGlobalImageFilesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGlobalImageFilesResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  **参数解释**: 总数 **取值范围**: 最小值0，最大值65535
    * dataList  列表
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\ImageFileResponseInfo[]'
    ];
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum **参数解释**: 总数 **取值范围**: 最小值0，最大值65535
    *
    * @return $this
    */
    ...
    *  列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ImageFileResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ImageFileResponseInfo[]|null $dataList 列表
    *
    * @return $this
    */
