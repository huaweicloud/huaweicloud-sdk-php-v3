...
class ListFileEventsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListFileEventsResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\FileEventResponseInfo[]'
    ];
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum 变更文件数量
    *
    * @return $this
    */
    ...
    *  变更文件信息列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\FileEventResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\FileEventResponseInfo[]|null $dataList 变更文件信息列表
    *
    * @return $this
    */
