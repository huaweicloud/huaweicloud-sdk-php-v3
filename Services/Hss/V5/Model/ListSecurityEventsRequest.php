...
class ListSecurityEventsRequest implements ModelInterface, ArrayAccess
{
    ...
    * hostId  **参数解释**： 服务器ID **约束限制**： 不涉及 **取值范围**： 字符长度0-64位 **默认取值**： 不涉及
    ...
    * limit  **参数解释**: 每页显示个数 **约束限制**: 不涉及 **取值范围**: 最小值10，最大值1000 **默认取值**: 10
    ...
    * beginTime  **参数解释**： 自定义查询时间，与查询时间范围天数互斥，查询时间段的起始时间，毫秒级时间戳，end_time减去begin_time小于等于2天，与查询时间范围天数互斥 **约束限制**： 不涉及 **取值范围**： 字符长度13位 **默认取值**： 不涉及
    * endTime  **参数解释**： 自定义时间，查询时间段的终止时间，毫秒级时间戳，end_time减去begin_time小于等于2天，与查询时间范围天数互斥 **约束限制**： 不涉及 **取值范围**： 字符长度13位 **默认取值**： 不涉及
    ...
    * assetValue  **参数解释**: 资产重要性 **约束限制**: 不涉及 **取值范围**: - important：重要资产 - common：般资产 - test：测试资产  **默认取值**: 不涉及
    ...
    * Sets hostId
    *
    * @param string|null $hostId **参数解释**： 服务器ID **约束限制**： 不涉及 **取值范围**： 字符长度0-64位 **默认取值**： 不涉及
    *
    * @return $this
    */
    ...
    * Sets offset
    *
    * @param int|null $offset **参数解释**: 偏移量，指定返回记录的开始位置 **约束限制**: 不涉及 **取值范围**: 最小值0，最大值2000000 **默认取值**: 不涉及
    *
    * @return $this
    */
    ...
    * Sets limit
    *
    * @param int|null $limit **参数解释**: 每页显示个数 **约束限制**: 不涉及 **取值范围**: 最小值10，最大值1000 **默认取值**: 10
    *
    * @return $this
    */
    ...
    * Sets beginTime
    *
    * @param string|null $beginTime **参数解释**： 自定义查询时间，与查询时间范围天数互斥，查询时间段的起始时间，毫秒级时间戳，end_time减去begin_time小于等于2天，与查询时间范围天数互斥 **约束限制**： 不涉及 **取值范围**： 字符长度13位 **默认取值**： 不涉及
    *
    * @return $this
    */
    ...
    * Sets endTime
    *
    * @param string|null $endTime **参数解释**： 自定义时间，查询时间段的终止时间，毫秒级时间戳，end_time减去begin_time小于等于2天，与查询时间范围天数互斥 **约束限制**： 不涉及 **取值范围**： 字符长度13位 **默认取值**： 不涉及
    *
    * @return $this
    */
    ...
    * Sets assetValue
    *
    * @param string|null $assetValue **参数解释**: 资产重要性 **约束限制**: 不涉及 **取值范围**: - important：重要资产 - common：般资产 - test：测试资产  **默认取值**: 不涉及
    *
    * @return $this
    */
