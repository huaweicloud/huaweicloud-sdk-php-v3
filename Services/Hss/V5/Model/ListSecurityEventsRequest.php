...
class ListSecurityEventsRequest implements ModelInterface, ArrayAccess
{
    ...
    * beginTime  **参数解释**： 自定义查询时间，开始时间 **约束限制**： 不涉及 **取值范围**： 字符长度13位 **默认取值**： 不涉及
    * endTime  **参数解释**： 自定义查询时间，结束时间 **约束限制**： 不涉及 **取值范围**： 字符长度13位 **默认取值**： 不涉及
    ...
    */
    ...
    /**
    * Gets beginTime
    *  **参数解释**： 自定义查询时间，开始时间 **约束限制**： 不涉及 **取值范围**： 字符长度13位 **默认取值**： 不涉及
    *
    * @return string|null
    */
    ...
    * Sets beginTime
    *
    * @param string|null $beginTime **参数解释**： 自定义查询时间，开始时间 **约束限制**： 不涉及 **取值范围**： 字符长度13位 **默认取值**： 不涉及
    *
    * @return $this
    */
    ...
    /**
    * Gets endTime
    *  **参数解释**： 自定义查询时间，结束时间 **约束限制**： 不涉及 **取值范围**： 字符长度13位 **默认取值**： 不涉及
    *
    * @return string|null
    */
    ...
    * Sets endTime
    *
    * @param string|null $endTime **参数解释**： 自定义查询时间，结束时间 **约束限制**： 不涉及 **取值范围**： 字符长度13位 **默认取值**： 不涉及
    *
    * @return $this
    */
