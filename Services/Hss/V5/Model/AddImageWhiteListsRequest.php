...
class AddImageWhiteListsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddImageWhiteListsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'type' => 'string',
            'body' => '\HuaweiCloud\SDK\Hss\V5\Model\AddImageWhiteListsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\AddImageWhiteListsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\AddImageWhiteListsRequestBody|null $body body
    *
    * @return $this
    */
