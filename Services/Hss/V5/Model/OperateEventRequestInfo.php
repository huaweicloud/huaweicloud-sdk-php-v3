...
class OperateEventRequestInfo implements ModelInterface, ArrayAccess
{
    ...
    * operateDetailList  操作详情信息列表，当operate_type为add_to_alarm_whitelist或remove_from_alarm_whitelist时，必传keyword和hash；当operate_type为add_to_login_whitelist或remove_from_login_whitelist时，必传login_ip，private_ip和login_user_name；当operate_type为isolate_and_kill或do_not_isolate_or_kill时，必传agent_id，file_hash，file_path，process_pid；其余情况可不填写内容。
    *
    * @var string[]
    */
    ...
    * Sets eventId
    *
    * @param string $eventId **参数解释**： 事件ID **取值范围**： 字符长度1-64位
    *
    * @return $this
    */
    ...
    * Sets occurTime
    *
    * @param int $occurTime **参数解释**： 发生时间，毫秒 **取值范围**： 最小值0，最大值9223372036854775807，时间格式：毫秒级时间戳（UTC时区，从1970-01-01 00:00:00开始计算），单位：ms
    *
    * @return $this
    */
