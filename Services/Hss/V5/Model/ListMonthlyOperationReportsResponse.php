...
class ListMonthlyOperationReportsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListMonthlyOperationReportsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * dataList  **参数解释**: 运营报告列表 **取值范围**: 最小值0，最大值10000
    * totalNum  **参数解释**: 总数 **取值范围**: 最小值0，最大值10000
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\OperationSummaryInfo[]',
            'totalNum' => 'int'
    ];
    ...
    */
    ...
    /**
    * Gets dataList
    *  **参数解释**: 运营报告列表 **取值范围**: 最小值0，最大值10000
    *
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\OperationSummaryInfo[]|null $dataList **参数解释**: 运营报告列表 **取值范围**: 最小值0，最大值10000
    *
    * @return $this
    */
