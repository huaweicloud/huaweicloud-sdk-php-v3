...
class ListCustomRuleConfigsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCustomRuleConfigsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  **参数解释**: 总数 **取值范围**: 最小值0，最大值2147483647
    * dataList  **参数解释**: 自定义规则列表 **取值范围**: 取值0-200个ListCustomRuleConfigResponse对象
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\ListCustomRuleConfigResponse[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ListCustomRuleConfigResponse[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ListCustomRuleConfigResponse[]|null $dataList **参数解释**: 自定义规则列表 **取值范围**: 取值0-200个ListCustomRuleConfigResponse对象
    *
    * @return $this
    */
