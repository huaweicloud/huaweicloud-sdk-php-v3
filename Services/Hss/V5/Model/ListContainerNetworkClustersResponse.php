...
class ListContainerNetworkClustersResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListContainerNetworkClustersResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\ClustersResponseInfo[]'
    ];
    ...
    *  集群信息列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ClustersResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ClustersResponseInfo[]|null $dataList 集群信息列表
    *
    * @return $this
    */
