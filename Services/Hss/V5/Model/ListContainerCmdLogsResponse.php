...
class ListContainerCmdLogsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListContainerCmdLogsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  日志总条数
    * dataList  容器内运行命令的日志列表
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\ContainerCmdLogResponseInfo[]'
    ];
    ...
    *  容器内运行命令的日志列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ContainerCmdLogResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ContainerCmdLogResponseInfo[]|null $dataList 容器内运行命令的日志列表
    *
    * @return $this
    */
