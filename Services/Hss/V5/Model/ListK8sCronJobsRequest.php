...
class ListK8sCronJobsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListK8sCronJobsRequest';
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['cronjobName'] = isset($data['cronjobName']) ? $data['cronjobName'] : null;
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['cronjobName']) && (mb_strlen($this->container['cronjobName']) > 256)) {
                $invalidProperties[] = "invalid value for 'cronjobName', the character length must be smaller than or equal to 256.";
            }
            if (!is_null($this->container['cronjobName']) && (mb_strlen($this->container['cronjobName']) < 0)) {
                $invalidProperties[] = "invalid value for 'cronjobName', the character length must be bigger than or equal to 0.";
            }
            if (!is_null($this->container['cronjobName']) && !preg_match("/^.*$/", $this->container['cronjobName'])) {
                $invalidProperties[] = "invalid value for 'cronjobName', must be conform to the pattern /^.*$/.";
            }
    ...
    */
    ...
    {
        return $this->container['cronjobName'];
    }

    /**
    * Sets cronjobName
    *
    * @param string|null $cronjobName job名称
    *
    * @return $this
    */
    public function setCronjobName($cronjobName)
    {
        $this->container['cronjobName'] = $cronjobName;
        return $this;
    }
