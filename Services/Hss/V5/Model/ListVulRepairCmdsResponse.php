...
class ListVulRepairCmdsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListVulRepairCmdsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  **参数解释**: 总数 **取值范围**: 最小值0，最大值10000
    * dataList  **参数解释**: 漏洞修复命令列表 **取值范围**: 最少0条，最多2147483647条
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\VulRepairCmdInfo[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\VulRepairCmdInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\VulRepairCmdInfo[]|null $dataList **参数解释**: 漏洞修复命令列表 **取值范围**: 最少0条，最多2147483647条
    *
    * @return $this
    */
