    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['workloadType'] === null) {
            ...
            if ((mb_strlen($this->container['workloadType']) > 32)) {
                $invalidProperties[] = "invalid value for 'workloadType', the character length must be smaller than or equal to 32.";
            }
            ...
            if (!preg_match("/^deployments|statefulsets|daemonsets$/", $this->container['workloadType'])) {
                $invalidProperties[] = "invalid value for 'workloadType', must be conform to the pattern /^deployments|statefulsets|daemonsets$/.";
            }
