...
class ShowDefaultSecurityCheckPolicyDetailsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDefaultSecurityCheckPolicyDetailsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  **参数解释** 检查项列表总数 **取值范围** 取值0-2147483647
    * checkDetails  **参数解释** 检查项列表
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'checkDetails' => '\HuaweiCloud\SDK\Hss\V5\Model\SecurityCheckPolicyDetailInfoResponseInfo[]'
    ];
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum **参数解释** 检查项列表总数 **取值范围** 取值0-2147483647
    *
    * @return $this
    */
    ...
    *  **参数解释** 检查项列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\SecurityCheckPolicyDetailInfoResponseInfo[]|null
    */
    ...
    * Sets checkDetails
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\SecurityCheckPolicyDetailInfoResponseInfo[]|null $checkDetails **参数解释** 检查项列表
    *
    * @return $this
    */
