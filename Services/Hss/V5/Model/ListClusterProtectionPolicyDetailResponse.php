...
class ListClusterProtectionPolicyDetailResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListClusterProtectionPolicyDetailResponse';
