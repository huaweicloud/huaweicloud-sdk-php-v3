...
class HoneypotPortPolicyContentPortsList implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'HoneypotPortPolicyContent_ports_list';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * port  端口
    * protocol  协议类型： - \"tcp\" - \"tcp6\"
    *
    * @var string[]
    */
    ...
    * Sets protocol
    *
    * @param string $protocol 协议类型： - \"tcp\" - \"tcp6\"
    *
    * @return $this
    */
