...
class HostTagValuesInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'HostTagValuesInfo';
    ...
    * Sets key
    *
    * @param string|null $key 资源标签key值
    *
    * @return $this
    */
    ...
    * Sets values
    *
    * @param string[]|null $values 资源标签values
    *
    * @return $this
    */
