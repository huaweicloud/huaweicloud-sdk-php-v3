...
class BatchDeleteTagsRequestInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteTagsRequestInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * tags  **参数解释**: 标签列表 **约束限制**: 不涉及 **取值范围**: 最小值0，最大值200 **默认取值**: 不涉及
    * sysTags  **参数解释**: 系统标签列表，当前为保留字段 **约束限制**: 不涉及 **取值范围**: 最小值0，最大值200 **默认取值**: 不涉及
    *
    * @var string[]
    */
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ResourceTagInfo[] $tags **参数解释**: 标签列表 **约束限制**: 不涉及 **取值范围**: 最小值0，最大值200 **默认取值**: 不涉及
    *
    * @return $this
    */
    ...
    * Sets sysTags
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ResourceTagInfo[]|null $sysTags **参数解释**: 系统标签列表，当前为保留字段 **约束限制**: 不涉及 **取值范围**: 最小值0，最大值200 **默认取值**: 不涉及
    *
    * @return $this
    */
