...
class ListVulHostVaultsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListVulHostVaultsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  **参数解释**: 总数 **取值范围**: 取值0-10000
    * dataList  **参数解释**: 主机存储库信息列表 **取值范围**: 不涉及
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\HostVaultInfo[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\HostVaultInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\HostVaultInfo[]|null $dataList **参数解释**: 主机存储库信息列表 **取值范围**: 不涉及
    *
    * @return $this
    */
