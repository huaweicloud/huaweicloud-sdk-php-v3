...
class ListContainerImagesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListContainerImagesResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\ContainerImageInfo[]'
    ];
    ...
    *  容器镜像信息列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ContainerImageInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ContainerImageInfo[]|null $dataList 容器镜像信息列表
    *
    * @return $this
    */
