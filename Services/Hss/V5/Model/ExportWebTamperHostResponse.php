...
class ExportWebTamperHostResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExportWebTamperHostResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * taskId  **参数解释**： 导出任务的ID **取值范围**： 字符长度0-128位
    *
    * @var string[]
    */
    ...
    * Sets taskId
    *
    * @param string|null $taskId **参数解释**： 导出任务的ID **取值范围**： 字符长度0-128位
    *
    * @return $this
    */
