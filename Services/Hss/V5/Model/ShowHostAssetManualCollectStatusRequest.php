...
class ShowHostAssetManualCollectStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowHostAssetManualCollectStatusRequest';
