...
class ProtectDirectoryInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ProtectDirectoryInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * protectDirectory  **参数解释**： 防护目录 **约束限制**: 不涉及 **取值范围**： 字符长度1-256位 **默认取值**: 不涉及
    * excludeChildDirectoryList  **参数解释**： 需要排除的子目录列表 **约束限制**: 不涉及 **取值范围**： 最少0条，最多10条 **默认取值**: 不涉及
    * excludeFileList  **参数解释**： 需要排除的子文件列表 **约束限制**: 不涉及 **取值范围**： 最少0条，最多10条 **默认取值**: 不涉及
    * backupDirectory  **参数解释**： 备份目录 **约束限制**: 不涉及 **取值范围**： 字符长度1-256位 **默认取值**: 不涉及
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['protectDirectory'] === null) {
            $invalidProperties[] = "'protectDirectory' can't be null";
        }
            if ((mb_strlen($this->container['protectDirectory']) > 256)) {
                $invalidProperties[] = "invalid value for 'protectDirectory', the character length must be smaller than or equal to 256.";
            }
            if ((mb_strlen($this->container['protectDirectory']) < 1)) {
    ...
    *
    * @param string $protectDirectory **参数解释**： 防护目录 **约束限制**: 不涉及 **取值范围**： 字符长度1-256位 **默认取值**: 不涉及
    *
    * @return $this
    */
    ...
    *
    * @param string[]|null $excludeChildDirectoryList **参数解释**： 需要排除的子目录列表 **约束限制**: 不涉及 **取值范围**： 最少0条，最多10条 **默认取值**: 不涉及
    *
    * @return $this
    */
    ...
    *
    * @param string[]|null $excludeFileList **参数解释**： 需要排除的子文件列表 **约束限制**: 不涉及 **取值范围**： 最少0条，最多10条 **默认取值**: 不涉及
    *
    * @return $this
    */
    ...
    *
    * @param string|null $backupDirectory **参数解释**： 备份目录 **约束限制**: 不涉及 **取值范围**： 字符长度1-256位 **默认取值**: 不涉及
    *
    * @return $this
    */
