...
class ServerlessDeploymentInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ServerlessDeploymentInfo';
    ...
    * Sets name
    *
    * @param string|null $name deployment名称
    *
    * @return $this
    */
