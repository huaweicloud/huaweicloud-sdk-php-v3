...
class DeleteAppWhitelistPolicyHostRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteAppWhitelistPolicyHostRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'policyId' => 'string',
            'body' => '\HuaweiCloud\SDK\Hss\V5\Model\DeleteAppWhitelistPolicyHostRequestInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\DeleteAppWhitelistPolicyHostRequestInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\DeleteAppWhitelistPolicyHostRequestInfo|null $body body
    *
    * @return $this
    */
