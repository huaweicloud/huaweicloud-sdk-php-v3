...
class CommonHostResponseInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CommonHostResponseInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * hostId  **参数解释**: 服务器的唯一标识ID **取值范围**: 字符长度1-64位
    * hostName  **参数解释**: 服务器名称 **取值范围**: 字符长度1-256位
    * publicIp  **参数解释**: 服务器弹性IP地址 **取值范围**: IPv4格式（长度7-15位）、IPv6格式（长度15-39位）
    ...
    * osName  **参数解释**: 操作系统名称 **取值范围**: 字符长度1-64位
    * osVersion  **参数解释**: 操作系统版本 **取值范围**: 字符长度1-64位
    * assetValue  **参数解释**: 资产重要性 **约束限制**: 不涉及 **取值范围**： - important：重要资产 - common：一般资产 - test：测试资产  **默认取值**: 不涉及
    * clusterId  **参数解释**: 集群ID **取值范围**: 字符长度1-64位
    * clusterName  **参数解释**: 集群名称 **取值范围**: 字符长度1-256位
    * groupId  **参数解释**: 服务器组ID **取值范围**: 字符范围1-64位
    * groupName  **参数解释**: 集群名称 **取值范围**: 字符长度1-256位
    *
    * @var string[]
    */
    ...
    * Sets hostId
    *
    * @param string|null $hostId **参数解释**: 服务器的唯一标识ID **取值范围**: 字符长度1-64位
    *
    * @return $this
    */
    ...
    * Sets publicIp
    *
    * @param string|null $publicIp **参数解释**: 服务器弹性IP地址 **取值范围**: IPv4格式（长度7-15位）、IPv6格式（长度15-39位）
    *
    * @return $this
    */
    ...
    * Sets osName
    *
    * @param string|null $osName **参数解释**: 操作系统名称 **取值范围**: 字符长度1-64位
    *
    * @return $this
    */
    ...
    * Sets osVersion
    *
    * @param string|null $osVersion **参数解释**: 操作系统版本 **取值范围**: 字符长度1-64位
    *
    * @return $this
    */
    ...
    * Sets clusterId
    *
    * @param string|null $clusterId **参数解释**: 集群ID **取值范围**: 字符长度1-64位
    *
    * @return $this
    */
    ...
    * Sets groupId
    *
    * @param string|null $groupId **参数解释**: 服务器组ID **取值范围**: 字符范围1-64位
    *
    * @return $this
    */
    ...
    * Sets groupName
    *
    * @param string|null $groupName **参数解释**: 集群名称 **取值范围**: 字符长度1-256位
    *
    * @return $this
    */
