...
class ListVulAffectImageContainersRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListVulAffectImageContainersRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['imageVersion'] === null) {
            ...
            if ((mb_strlen($this->container['imageVersion']) < 0)) {
