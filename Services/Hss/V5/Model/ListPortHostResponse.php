...
class ListPortHostResponse implements ModelInterface, ArrayAccess
{
    ...
    * totalNum  **参数解释**: 机器总数 **取值范围**: 最小值0， 最大值10000
    * dataList  **参数解释**: 机器信息列表 **取值范围**: 最小值0， 最大值10000
    *
    * @var string[]
    */
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum **参数解释**: 机器总数 **取值范围**: 最小值0， 最大值10000
    *
    * @return $this
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\PortHostResponseInfo[]|null $dataList **参数解释**: 机器信息列表 **取值范围**: 最小值0， 最大值10000
    *
    * @return $this
    */
