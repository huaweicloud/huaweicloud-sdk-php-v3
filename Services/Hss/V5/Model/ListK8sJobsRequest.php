...
class ListK8sJobsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListK8sJobsRequest';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['jobName']) && (mb_strlen($this->container['jobName']) < 0)) {
                $invalidProperties[] = "invalid value for 'jobName', the character length must be bigger than or equal to 0.";
            }
            if (!is_null($this->container['jobName']) && !preg_match("/^.*$/", $this->container['jobName'])) {
                $invalidProperties[] = "invalid value for 'jobName', must be conform to the pattern /^.*$/.";
            }
    ...
    * Sets jobName
    *
    * @param string|null $jobName job名称
    *
    * @return $this
    */
