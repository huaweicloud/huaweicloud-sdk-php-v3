...
class ListClusterProtectionDefaultPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListClusterProtectionDefaultPolicyRequest';
