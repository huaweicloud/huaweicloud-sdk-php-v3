...
class ListCommonTipsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCommonTipsRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['limit'] === null) {
            ...
            if (!is_null($this->container['type']) && !preg_match("/^host_name|host_id|public_ip|private_ip|vpc_id|cluster_id|host_tags$/", $this->container['type'])) {
                $invalidProperties[] = "invalid value for 'type', must be conform to the pattern /^host_name|host_id|public_ip|private_ip|vpc_id|cluster_id|host_tags$/.";
            }
