...
class ListImageAppsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListImageAppsResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\ImageAppsInfo[]'
    ];
    ...
    *  列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ImageAppsInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ImageAppsInfo[]|null $dataList 列表
    *
    * @return $this
    */
