...
class ListImageBasicImageResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListImageBasicImageResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\ImageBasicImageInfo[]'
    ];
    ...
    *  镜像的基础镜像信息
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ImageBasicImageInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ImageBasicImageInfo[]|null $dataList 镜像的基础镜像信息
    *
    * @return $this
    */
