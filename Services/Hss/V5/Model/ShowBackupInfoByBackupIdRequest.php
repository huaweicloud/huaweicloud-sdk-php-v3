...
class ShowBackupInfoByBackupIdRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowBackupInfoByBackupIdRequest';
    ...
    * backupId  **参数解释**: 备份ID **约束限制**: 不涉及 **取值范围**: 字符长度0-64位 **默认取值**: 不涉及
    *
    * @var string[]
    */
    ...
    */
    ...
    /**
    * Gets backupId
    *  **参数解释**: 备份ID **约束限制**: 不涉及 **取值范围**: 字符长度0-64位 **默认取值**: 不涉及
    *
    * @return string
    */
    ...
    * Sets backupId
    *
    * @param string $backupId **参数解释**: 备份ID **约束限制**: 不涉及 **取值范围**: 字符长度0-64位 **默认取值**: 不涉及
    *
    * @return $this
    */
