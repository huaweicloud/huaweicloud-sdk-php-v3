...
class AddAppWhitelistPolicyProcessRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddAppWhitelistPolicyProcessRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'policyId' => 'string',
            'hostId' => 'string',
            'body' => '\HuaweiCloud\SDK\Hss\V5\Model\AddAppWhitelistPolicyProcessRequestInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\AddAppWhitelistPolicyProcessRequestInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\AddAppWhitelistPolicyProcessRequestInfo|null $body body
    *
    * @return $this
    */
