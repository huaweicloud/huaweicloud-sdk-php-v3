...
class ListRiskConfigHostsResponse implements ModelInterface, ArrayAccess
{
    ...
    * totalNum  **参数解释**: 受配置检测影响的服务器数据总量 **取值范围**: 不涉及
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum **参数解释**: 受配置检测影响的服务器数据总量 **取值范围**: 不涉及
    *
    * @return $this
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\SecurityCheckHostInfoResponseInfo[]|null $dataList **参数解释**: 数据列表 **取值范围**: 不涉及
    *
    * @return $this
    */
