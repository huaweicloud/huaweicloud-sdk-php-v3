...
class ListVulHostHostsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListVulHostHostsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalNum  **参数解释**: 总数 **取值范围**: 最小值0，最大值2147483647
    * dataList  **参数解释**: 主机信息列表
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\VulHostHostsResponseInfoDataList[]'
    ];
    ...
    *  **参数解释**: 主机信息列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\VulHostHostsResponseInfoDataList[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\VulHostHostsResponseInfoDataList[]|null $dataList **参数解释**: 主机信息列表
    *
    * @return $this
    */
