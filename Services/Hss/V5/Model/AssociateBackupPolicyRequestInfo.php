...
class AssociateBackupPolicyRequestInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AssociateBackupPolicyRequestInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * vaultId  **参数解释**: 需要绑定的存储库id **约束限制**: 不涉及 **取值范围**: 字符长度0-128位 **默认取值**: 不涉及
    * policyId  **参数解释**: 需要绑定的策略id **约束限制**: 不涉及 **取值范围**: 字符长度0-128位 **默认取值**: 不涉及
    *
    * @var string[]
    */
    ...
    * Sets vaultId
    *
    * @param string|null $vaultId **参数解释**: 需要绑定的存储库id **约束限制**: 不涉及 **取值范围**: 字符长度0-128位 **默认取值**: 不涉及
    *
    * @return $this
    */
    ...
    * Sets policyId
    *
    * @param string|null $policyId **参数解释**: 需要绑定的策略id **约束限制**: 不涉及 **取值范围**: 字符长度0-128位 **默认取值**: 不涉及
    *
    * @return $this
    */
