...
class ListWebFrameworkHostInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListWebFrameworkHostInfoRequest';
    ...
    * fileName  **参数解释**: 文件名称 **约束限制**: 不涉及 **取值范围**: 字符长度1-256 **默认取值**: 不涉及
    ...
    * Sets fileName
    *
    * @param string|null $fileName **参数解释**: 文件名称 **约束限制**: 不涉及 **取值范围**: 字符长度1-256 **默认取值**: 不涉及
    *
    * @return $this
    */
