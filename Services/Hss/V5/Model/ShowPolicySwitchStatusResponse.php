...
class ShowPolicySwitchStatusResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowPolicySwitchStatusResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * policyName  **参数解释**： 策略名称 **取值范围**： 字符长度1-128位
    * enable  **参数解释**： 策略总开关是否开启 **取值范围**： - true：是。 - false：否。
    *
    * @var string[]
    */
    ...
    * Sets enable
    *
    * @param bool|null $enable **参数解释**： 策略总开关是否开启 **取值范围**： - true：是。 - false：否。
    *
    * @return $this
    */
