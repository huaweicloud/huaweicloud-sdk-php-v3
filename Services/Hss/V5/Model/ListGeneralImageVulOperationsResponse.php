...
class ListGeneralImageVulOperationsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGeneralImageVulOperationsResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\GeneralImageVulOperationsResponseInfo[]'
    ];
    ...
    *  漏洞处置记录详情
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\GeneralImageVulOperationsResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\GeneralImageVulOperationsResponseInfo[]|null $dataList 漏洞处置记录详情
    *
    * @return $this
    */
