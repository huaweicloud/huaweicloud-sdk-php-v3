...
class ListIacFilesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListIacFilesResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\ListIacFilesResponseInfoDataList[]'
    ];
    ...
    *  IAC文件列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\ListIacFilesResponseInfoDataList[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\ListIacFilesResponseInfoDataList[]|null $dataList IAC文件列表
    *
    * @return $this
    */
