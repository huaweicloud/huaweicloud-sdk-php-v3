...
class VulAffectContainerAppInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'VulAffectContainerAppInfo';
    ...
    */
    protected static $openAPITypes = [
            'appName' => 'string',
            'paths' => '\HuaweiCloud\SDK\Hss\V5\Model\VulAffectContainerAppPath[]',
            'rule' => 'string'
    ];
    ...
    *  列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\VulAffectContainerAppPath[]|null
    */
    ...
    * Sets paths
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\VulAffectContainerAppPath[]|null $paths 列表
    *
    * @return $this
    */
