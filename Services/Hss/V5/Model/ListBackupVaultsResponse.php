...
class ListBackupVaultsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListBackupVaultsResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\BackupVaultInfo[]'
    ];
    ...
    * Sets totalNum
    *
    * @param int|null $totalNum 查询备份存储库总数
    *
    * @return $this
    */
    ...
    *  查询备份存储库列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\BackupVaultInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\BackupVaultInfo[]|null $dataList 查询备份存储库列表
    *
    * @return $this
    */
