...
class UpdateSecurityGroupPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateSecurityGroupPolicyRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'clusterId' => 'string',
            'namespace' => 'string',
            'body' => '\HuaweiCloud\SDK\Hss\V5\Model\UpdateSecurityGroupPolicyRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\UpdateSecurityGroupPolicyRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\UpdateSecurityGroupPolicyRequestBody|null $body body
    *
    * @return $this
    */
