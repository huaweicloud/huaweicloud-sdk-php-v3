...
class SetProtectDirSwitchInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SetProtectDirSwitchInfoRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'hostId' => 'string',
            'body' => '\HuaweiCloud\SDK\Hss\V5\Model\SetProtectDirSwitchRequestInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\SetProtectDirSwitchRequestInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\SetProtectDirSwitchRequestInfo|null $body body
    *
    * @return $this
    */
