...
class ListAppWhitelistPolicyHostResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAppWhitelistPolicyHostResponse';
    ...
    */
    protected static $openAPITypes = [
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\AppWhitelistPolicyHostResponseInfo[]',
            'totalNum' => 'int'
    ];
    ...
    *  data list
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\AppWhitelistPolicyHostResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\AppWhitelistPolicyHostResponseInfo[]|null $dataList data list
    *
    * @return $this
    */
