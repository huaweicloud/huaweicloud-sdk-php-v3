...
class ListGeneralImageVulsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListGeneralImageVulsResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\GeneralImageVulsResponseInfo[]'
    ];
    ...
    *  漏洞详情
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\GeneralImageVulsResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\GeneralImageVulsResponseInfo[]|null $dataList 漏洞详情
    *
    * @return $this
    */
