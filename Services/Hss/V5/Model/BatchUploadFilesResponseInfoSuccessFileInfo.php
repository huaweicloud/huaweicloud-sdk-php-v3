...
class BatchUploadFilesResponseInfoSuccessFileInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchUploadFilesResponseInfo_success_file_info';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * fileName  文件名称
    * fileId  文件ID，服务对保存的文件生成的唯一ID
    *
    * @var string[]
    */
    ...
    * Sets fileId
    *
    * @param string|null $fileId 文件ID，服务对保存的文件生成的唯一ID
    *
    * @return $this
    */
