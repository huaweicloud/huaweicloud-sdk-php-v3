...
class ShowHostProtectionStatusResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowHostProtectionStatusResponse';
    ...
    * Sets noProtect
    *
    * @param int|null $noProtect 未防护的主机数
    *
    * @return $this
    */
