...
class BaselineWhiteListsResponseInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BaselineWhiteListsResponseInfo';
