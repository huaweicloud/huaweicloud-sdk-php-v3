...
class HostVaultInfoDefaultVault implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'HostVaultInfo_default_vault';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * vaultName  **参数解释**: 存储库名称 **取值范围**: 字符长度1-128位
    * vaultId  **参数解释**: 存储库id **取值范围**: 字符长度1-128位
    *
    * @var string[]
    */
    ...
    * Sets vaultName
    *
    * @param string|null $vaultName **参数解释**: 存储库名称 **取值范围**: 字符长度1-128位
    *
    * @return $this
    */
    ...
    * Sets vaultId
    *
    * @param string|null $vaultId **参数解释**: 存储库id **取值范围**: 字符长度1-128位
    *
    * @return $this
    */
