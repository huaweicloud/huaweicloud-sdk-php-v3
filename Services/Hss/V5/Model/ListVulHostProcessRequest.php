...
class ListVulHostProcessRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListVulHostProcessRequest';
    ...
    * containerId  **参数解释**： 受影响容器ID **约束限制**： 不涉及 **取值范围**： 字符长度1-128位 **默认取值**： 不涉及
    *
    * @var string[]
    */
    ...
    * Sets containerId
    *
    * @param string|null $containerId **参数解释**： 受影响容器ID **约束限制**： 不涉及 **取值范围**： 字符长度1-128位 **默认取值**： 不涉及
    *
    * @return $this
    */
