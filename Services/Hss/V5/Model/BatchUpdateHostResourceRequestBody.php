...
class BatchUpdateHostResourceRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchUpdateHostResourceRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * operateAll  **参数解释**: 是否全量处理所有主机Agent，false的时候host_ids有值 **约束限制**: 必填 **取值范围**: - true：是。 - false：否。  **默认取值**: 不涉及
    * hostIds  **参数解释**: 批量修改的HostId列表。operate_all参数为false时,需要填写此批量查询条件,operate_all参数为true时不处理host_ids参数 **约束限制**： 不涉及 **取值范围**: 最小值0，最大值200 **默认取值**： 不涉及
    ...
    * Sets operateAll
    *
    * @param bool $operateAll **参数解释**: 是否全量处理所有主机Agent，false的时候host_ids有值 **约束限制**: 必填 **取值范围**: - true：是。 - false：否。  **默认取值**: 不涉及
    *
    * @return $this
    */
    ...
    * Sets hostIds
    *
    * @param string[]|null $hostIds **参数解释**: 批量修改的HostId列表。operate_all参数为false时,需要填写此批量查询条件,operate_all参数为true时不处理host_ids参数 **约束限制**： 不涉及 **取值范围**: 最小值0，最大值200 **默认取值**： 不涉及
    *
    * @return $this
    */
