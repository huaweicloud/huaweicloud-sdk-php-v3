...
class CopyAiPolicyGroupRequestInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CopyAiPolicyGroupRequestInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * groupId  **参数解释**： 策略组ID **约束限制**： 必填 **取值范围**： 字符长度1-20位 **默认取值**： 不涉及
    * groupName  **参数解释**： 策略组名称 **约束限制**： 必填 **取值范围**： 字符长度1-128位 **默认取值**： 不涉及
    * description  **参数解释**： 策略描述 **约束限制**： 不涉及 **取值范围**： 字符长度1-256位 **默认取值**： 不涉及
    *
    * @var string[]
    */
    ...
    * Sets groupName
    *
    * @param string $groupName **参数解释**： 策略组名称 **约束限制**： 必填 **取值范围**： 字符长度1-128位 **默认取值**： 不涉及
    *
    * @return $this
    */
    ...
    * Sets description
    *
    * @param string|null $description **参数解释**： 策略描述 **约束限制**： 不涉及 **取值范围**： 字符长度1-256位 **默认取值**： 不涉及
    *
    * @return $this
    */
