...
class ExportHandledVulnerabilitiesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExportHandledVulnerabilitiesResponse';
