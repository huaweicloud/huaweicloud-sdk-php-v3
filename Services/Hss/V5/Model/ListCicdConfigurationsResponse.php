...
class ListCicdConfigurationsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCicdConfigurationsResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\CicdConfigurationsResponseInfo[]'
    ];
    ...
    *  CI/CD配置列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\CicdConfigurationsResponseInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\CicdConfigurationsResponseInfo[]|null $dataList CI/CD配置列表
    *
    * @return $this
    */
