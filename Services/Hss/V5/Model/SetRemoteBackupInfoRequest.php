...
class SetRemoteBackupInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SetRemoteBackupInfoRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'hostId' => 'string',
            'body' => '\HuaweiCloud\SDK\Hss\V5\Model\SetRemoteBackupInfoRequestInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\SetRemoteBackupInfoRequestInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\SetRemoteBackupInfoRequestInfo|null $body body
    *
    * @return $this
    */
