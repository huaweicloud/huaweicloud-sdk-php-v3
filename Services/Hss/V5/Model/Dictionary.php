...
class Dictionary implements ModelInterface, ArrayAccess
{
    ...
    * code  **参数解释**： 字典编码 **取值范围**： 字符长度1-256位
    * value  **参数解释**： 字典值（单个值） **取值范围**： 字符长度1-65535位
    * values  **参数解释**： 字典值（多个值） **取值范围**：
    *
    * @var string[]
    */
    ...
    * Sets code
    *
    * @param string|null $code **参数解释**： 字典编码 **取值范围**： 字符长度1-256位
    *
    * @return $this
    */
    ...
    * Sets value
    *
    * @param string|null $value **参数解释**： 字典值（单个值） **取值范围**： 字符长度1-65535位
    *
    * @return $this
    */
    ...
    * Sets values
    *
    * @param string[]|null $values **参数解释**： 字典值（多个值） **取值范围**：
    *
    * @return $this
    */
