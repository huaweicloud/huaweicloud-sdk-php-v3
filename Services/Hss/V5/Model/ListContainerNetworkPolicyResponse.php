...
class ListContainerNetworkPolicyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListContainerNetworkPolicyResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalNum' => 'int',
            'dataList' => '\HuaweiCloud\SDK\Hss\V5\Model\GetNetworkPolicy[]',
            'lastUpdateTime' => 'int'
    ];
    ...
    *  网络策略列表
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\GetNetworkPolicy[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\GetNetworkPolicy[]|null $dataList 网络策略列表
    *
    * @return $this
    */
