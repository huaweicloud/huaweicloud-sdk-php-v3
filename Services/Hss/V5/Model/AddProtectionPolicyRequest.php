...
class AddProtectionPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddProtectionPolicyRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'region' => 'string',
            'body' => '\HuaweiCloud\SDK\Hss\V5\Model\AddProtectionPolicyInfoRequestInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Hss\V5\Model\AddProtectionPolicyInfoRequestInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Hss\V5\Model\AddProtectionPolicyInfoRequestInfo|null $body body
    *
    * @return $this
    */
