...
class AppWhitelistPolicyProcessExtendResponseInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AppWhitelistPolicyProcessExtendResponseInfo';
    ...
    * Sets cmdline
    *
    * @param string|null $cmdline **参数解释**: 进程命令行 **取值范围**: 不涉及
    *
    * @return $this
    */
