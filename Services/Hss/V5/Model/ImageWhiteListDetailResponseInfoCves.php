...
class ImageWhiteListDetailResponseInfoCves implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImageWhiteListDetailResponseInfo_cves';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * cveId  **参数解释**: CVE ID **取值范围**: 字符长度0-256位
    * cvss  **参数解释**: CVE评分 **取值范围**: 取值0-10
    *
    * @var string[]
    */
    ...
    * Sets cveId
    *
    * @param string|null $cveId **参数解释**: CVE ID **取值范围**: 字符长度0-256位
    *
    * @return $this
    */
    ...
    * Sets cvss
    *
    * @param float|null $cvss **参数解释**: CVE评分 **取值范围**: 取值0-10
    *
    * @return $this
    */
