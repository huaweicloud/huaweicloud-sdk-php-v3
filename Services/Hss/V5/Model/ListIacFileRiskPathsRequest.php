...
class ListIacFileRiskPathsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListIacFileRiskPathsRequest';
    ...
    * ruleId  **参数解释**: 风险检测规则ID **约束限制**: 不涉及 **取值范围**: 字符长度1-64  **默认取值**: 不涉及
    * resourceName  资源名称
    * resourceType  资源类型
    * namespace  资源所属的命名空间
    *
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ruleId'] === null) {
            ...
            if (!preg_match("/^.*$/", $this->container['ruleId'])) {
                $invalidProperties[] = "invalid value for 'ruleId', must be conform to the pattern /^.*$/.";
            }
