...
namespace HuaweiCloud\SDK\Frs\V1;
...
class FrsAsyncClient extends Client
{
    ...
    public function addFacesByBase64AsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/03 /v1/{project_id}/face-sets/{face_set_name}/faces';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\AddFacesByBase64Response',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\AddFacesByBase64Request',
            $asyncRequest = true);
    }
    ...
    public function addFacesByFileAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/01 /v1/{project_id}/face-sets/{face_set_name}/faces';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\AddFacesByFileResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\AddFacesByFileRequest',
            $asyncRequest = true);
    }
    ...
    public function addFacesByUrlAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/02 /v1/{project_id}/face-sets/{face_set_name}/faces';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\AddFacesByUrlResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\AddFacesByUrlRequest',
            $asyncRequest = true);
    }
    ...
    public function batchDeleteFacesAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/01 /v1/{project_id}/face-sets/{face_set_name}/faces/batch';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\BatchDeleteFacesResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\BatchDeleteFacesRequest',
            $asyncRequest = true);
    }
    ...
    public function compareFaceByBase64AsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/03 /v1/{project_id}/face-compare';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\CompareFaceByBase64Response',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\CompareFaceByBase64Request',
            $asyncRequest = true);
    }
    ...
    public function compareFaceByFileAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/01 /v1/{project_id}/face-compare';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\CompareFaceByFileResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\CompareFaceByFileRequest',
            $asyncRequest = true);
    }
    ...
    public function compareFaceByUrlAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/02 /v1/{project_id}/face-compare';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\CompareFaceByUrlResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\CompareFaceByUrlRequest',
            $asyncRequest = true);
    }
    ...
    public function createFaceSetAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/01 /v1/{project_id}/face-sets';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\CreateFaceSetResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\CreateFaceSetRequest',
            $asyncRequest = true);
    }
    ...
    public function deleteFaceByExternalImageIdAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/05 /v1/{project_id}/face-sets/{face_set_name}/faces';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\DeleteFaceByExternalImageIdResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\DeleteFaceByExternalImageIdRequest',
            $asyncRequest = true);
    }
    ...
    public function deleteFaceByFaceIdAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/04 /v1/{project_id}/face-sets/{face_set_name}/faces';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\DeleteFaceByFaceIdResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\DeleteFaceByFaceIdRequest',
            $asyncRequest = true);
    }
    ...
    public function deleteFaceSetAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/01 /v1/{project_id}/face-sets/{face_set_name}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\DeleteFaceSetResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\DeleteFaceSetRequest',
            $asyncRequest = true);
    }
    ...
    public function detectFaceByBase64AsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/03 /v1/{project_id}/face-detect';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\DetectFaceByBase64Response',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\DetectFaceByBase64Request',
            $asyncRequest = true);
    }
    ...
    public function detectFaceByFileAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/01 /v1/{project_id}/face-detect';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\DetectFaceByFileResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\DetectFaceByFileRequest',
            $asyncRequest = true);
    }
    ...
    public function detectFaceByUrlAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/02 /v1/{project_id}/face-detect';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\DetectFaceByUrlResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\DetectFaceByUrlRequest',
            $asyncRequest = true);
    }
    ...
    public function detectLiveByBase64AsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\DetectLiveByBase64Response',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\DetectLiveByBase64Request',
            $asyncRequest = true);
    }
    ...
    public function detectLiveByFileAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\DetectLiveByFileResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\DetectLiveByFileRequest',
            $asyncRequest = true);
    }
    ...
    public function detectLiveByUrlAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\DetectLiveByUrlResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\DetectLiveByUrlRequest',
            $asyncRequest = true);
    }
    ...
    public function detectLiveFaceByBase64AsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\DetectLiveFaceByBase64Response',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\DetectLiveFaceByBase64Request',
            $asyncRequest = true);
    }
    ...
    public function detectLiveFaceByFileAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\DetectLiveFaceByFileResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\DetectLiveFaceByFileRequest',
            $asyncRequest = true);
    }
    ...
    public function detectLiveFaceByUrlAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\DetectLiveFaceByUrlResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\DetectLiveFaceByUrlRequest',
            $asyncRequest = true);
    }
    ...
    public function searchFaceByBase64AsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/03 /v1/{project_id}/face-sets/{face_set_name}/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\SearchFaceByBase64Response',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\SearchFaceByBase64Request',
            $asyncRequest = true);
    }
    ...
    public function searchFaceByFaceIdAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/04 /v1/{project_id}/face-sets/{face_set_name}/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\SearchFaceByFaceIdResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\SearchFaceByFaceIdRequest',
            $asyncRequest = true);
    }
    ...
    public function searchFaceByFileAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/01 /v1/{project_id}/face-sets/{face_set_name}/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\SearchFaceByFileResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\SearchFaceByFileRequest',
            $asyncRequest = true);
    }
    ...
    public function searchFaceByUrlAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/02 /v1/{project_id}/face-sets/{face_set_name}/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\SearchFaceByUrlResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\SearchFaceByUrlRequest',
            $asyncRequest = true);
    }
    ...
    public function showAllFaceSetsAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\ShowAllFaceSetsResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\ShowAllFaceSetsRequest',
            $asyncRequest = true);
    }
    ...
    public function showFaceSetAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\ShowFaceSetResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\ShowFaceSetRequest',
            $asyncRequest = true);
    }
    ...
    public function showFacesByFaceIdAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\ShowFacesByFaceIdResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\ShowFacesByFaceIdRequest',
            $asyncRequest = true);
    }
    ...
    public function showFacesByLimitAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\ShowFacesByLimitResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\ShowFacesByLimitRequest',
            $asyncRequest = true);
    }
     ...
     * @return response
     */
    public function showSubscribesAsync($request)
    {
        return $this->showSubscribesAsyncWithHttpInfo($request);
    }
    
    public function showSubscribesAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/01 /v1/{project_id}/subscribe';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\ShowSubscribesResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\ShowSubscribesRequest',
            $asyncRequest = true);
    }
    ...
    public function updateFaceAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/06 /v1/{project_id}/face-sets/{face_set_name}/faces';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Frs\V1\Model\UpdateFaceResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Frs\V1\Model\UpdateFaceRequest',
            $asyncRequest = true);
    }
