...
class FrsClient extends Client
{
    ...
    {
        $collection_formats = [];
        $resourcePath = '/v1/{project_id}/face-sets/{face_set_name}/faces';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
    ...
    {
        $collection_formats = [];
        $resourcePath = '/v1/{project_id}/face-sets/{face_set_name}/faces/batch';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
    ...
    {
        $collection_formats = [];
        $resourcePath = '/v1/{project_id}/face-compare';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
    ...
    {
        $collection_formats = [];
        $resourcePath = '/v1/{project_id}/face-sets';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
    ...
    {
        $collection_formats = [];
        $resourcePath = '/v1/{project_id}/face-sets/{face_set_name}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
    ...
    {
        $collection_formats = [];
        $resourcePath = '/v1/{project_id}/face-detect';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
    ...
    {
        $collection_formats = [];
        $resourcePath = '/v1/{project_id}/face-sets/{face_set_name}/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
     ...
     * @return response
     */
    public function showSubscribes($request)
    {
        return $this->showSubscribesWithHttpInfo($request);
    }

    public function showSubscribesWithHttpInfo($request)
    {
        $collection_formats = [];
        $resourcePath = '/v1/{project_id}/subscribe';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
