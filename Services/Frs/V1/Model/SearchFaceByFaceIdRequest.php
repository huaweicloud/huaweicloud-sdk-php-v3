...
class SearchFaceByFaceIdRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'faceSetName' => 'string',
            'body' => '\HuaweiCloud\SDK\Frs\V1\Model\FaceSearchFaceIdReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Frs\V1\Model\FaceSearchFaceIdReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Frs\V1\Model\FaceSearchFaceIdReq|null $body body
    *
    * @return $this
    */
