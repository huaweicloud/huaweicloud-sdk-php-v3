...
class AddFacesByFileRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'faceSetName' => 'string',
            'body' => '\HuaweiCloud\SDK\Frs\V1\Model\AddFacesByFileRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Frs\V1\Model\AddFacesByFileRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Frs\V1\Model\AddFacesByFileRequestBody|null $body body
    *
    * @return $this
    */
