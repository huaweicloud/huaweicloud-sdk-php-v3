...
class AddFacesByUrlRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'faceSetName' => 'string',
            'body' => '\HuaweiCloud\SDK\Frs\V1\Model\AddFacesUrlReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Frs\V1\Model\AddFacesUrlReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Frs\V1\Model\AddFacesUrlReq|null $body body
    *
    * @return $this
    */
