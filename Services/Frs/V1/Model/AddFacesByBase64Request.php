...
class AddFacesByBase64Request implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'faceSetName' => 'string',
            'body' => '\HuaweiCloud\SDK\Frs\V1\Model\AddFacesBase64Req'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Frs\V1\Model\AddFacesBase64Req|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Frs\V1\Model\AddFacesBase64Req|null $body body
    *
    * @return $this
    */
