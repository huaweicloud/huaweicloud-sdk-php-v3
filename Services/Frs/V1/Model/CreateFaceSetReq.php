...
class CreateFaceSetReq implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'externalFields' => 'map[string,\HuaweiCloud\SDK\Frs\V1\Model\TypeInfo]',
            'faceSetName' => 'string',
            'faceSetCapacity' => 'int'
    ];
    ...
    *
    * @return map[string,\HuaweiCloud\SDK\Frs\V1\Model\TypeInfo]|null
    */
    ...
    * Sets externalFields
    *
    * @param map[string,\HuaweiCloud\SDK\Frs\V1\Model\TypeInfo]|null $externalFields 用户自定义数据，自定义字段不能以系统保留字段vector、bounding_box、external_image_id、face_id、create_time、_id、_all、_source等字段命名。 Json字符串不校验重复性，自定义字段的key值长度范围为[1,36]，string类型的value长度范围为[1,256]，具体参见[自定义字段](zh-cn_topic_0130807044.xml)。
    *
    * @return $this
    */
