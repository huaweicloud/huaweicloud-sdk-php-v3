...
class LiveDetectRespVideoresult implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'alive' => 'bool',
            'actions' => '\HuaweiCloud\SDK\Frs\V1\Model\ActionsList[]',
            'picture' => 'string'
    ];
    ...
    *  动作列表。
    *
    * @return \HuaweiCloud\SDK\Frs\V1\Model\ActionsList[]|null
    */
    ...
    * Sets actions
    *
    * @param \HuaweiCloud\SDK\Frs\V1\Model\ActionsList[]|null $actions 动作列表。
    *
    * @return $this
    */
