...
class BatchDeleteFacesRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'faceSetName' => 'string',
            'body' => '\HuaweiCloud\SDK\Frs\V1\Model\DeleteFacesBatchReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Frs\V1\Model\DeleteFacesBatchReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Frs\V1\Model\DeleteFacesBatchReq|null $body body
    *
    * @return $this
    */
