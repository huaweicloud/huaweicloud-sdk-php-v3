...
class AddFacesByUrlResponse implements ModelInterface, ArrayAccess
{
    ...
    * faces  人脸库当中的人脸结构，详见[FaceSetFace](zh-cn_topic_0106912070.xml)。 调用失败时无此字段。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'faceSetId' => 'string',
            'faceSetName' => 'string',
            'faces' => '\HuaweiCloud\SDK\Frs\V1\Model\FaceSetFace[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Frs\V1\Model\FaceSetFace[]|null
    */
    ...
    * Sets faces
    *
    * @param \HuaweiCloud\SDK\Frs\V1\Model\FaceSetFace[]|null $faces 人脸库当中的人脸结构，详见[FaceSetFace](zh-cn_topic_0106912070.xml)。 调用失败时无此字段。
    *
    * @return $this
    */
