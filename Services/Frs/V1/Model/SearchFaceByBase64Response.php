...
class SearchFaceByBase64Response implements ModelInterface, ArrayAccess
{
    ...
    * faces  查找的人脸集合，详见[SearchFace](zh-cn_topic_0106912071.xml)。 调用失败时无此字段。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'faces' => '\HuaweiCloud\SDK\Frs\V1\Model\SearchFace[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Frs\V1\Model\SearchFace[]|null
    */
    ...
    * Sets faces
    *
    * @param \HuaweiCloud\SDK\Frs\V1\Model\SearchFace[]|null $faces 查找的人脸集合，详见[SearchFace](zh-cn_topic_0106912071.xml)。 调用失败时无此字段。
    *
    * @return $this
    */
