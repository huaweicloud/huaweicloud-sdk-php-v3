...
class Attributes implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'dress' => '\HuaweiCloud\SDK\Frs\V1\Model\Dress',
            'glass' => 'string',
            'gender' => 'string',
            'yawAngle' => 'double',
            'rollAngle' => 'double',
            ...
            'ethnic' => 'string',
            'phototype' => 'string',
            'quality' => '\HuaweiCloud\SDK\Frs\V1\Model\FaceQuality',
            'hair' => 'string',
            'expression' => '\HuaweiCloud\SDK\Frs\V1\Model\AttributesExpression',
            'faceAngle' => 'int'
    ];
    ...
    *  dress
    *
    * @return \HuaweiCloud\SDK\Frs\V1\Model\Dress
    */
    ...
    * Sets dress
    *
    * @param \HuaweiCloud\SDK\Frs\V1\Model\Dress $dress dress
    *
    * @return $this
    */
    ...
    *  quality
    *
    * @return \HuaweiCloud\SDK\Frs\V1\Model\FaceQuality
    */
    ...
    * Sets quality
    *
    * @param \HuaweiCloud\SDK\Frs\V1\Model\FaceQuality $quality quality
    *
    * @return $this
    */
    ...
    *  expression
    *
    * @return \HuaweiCloud\SDK\Frs\V1\Model\AttributesExpression
    */
    ...
    * Sets expression
    *
    * @param \HuaweiCloud\SDK\Frs\V1\Model\AttributesExpression $expression expression
    *
    * @return $this
    */
