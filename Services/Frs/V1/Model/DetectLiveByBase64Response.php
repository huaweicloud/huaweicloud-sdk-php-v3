...
class DetectLiveByBase64Response implements ModelInterface, ArrayAccess
{
    ...
    * warningList  警告信息列表，WarningList结构见[WarningList](zh-cn_topic_0146322261.xml)。 调用失败时无此字段
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'videoResult' => '\HuaweiCloud\SDK\Frs\V1\Model\LiveDetectRespVideoresult',
    ...
    *  videoResult
    *
    * @return \HuaweiCloud\SDK\Frs\V1\Model\LiveDetectRespVideoresult|null
    */
    ...
    * Sets videoResult
    *
    * @param \HuaweiCloud\SDK\Frs\V1\Model\LiveDetectRespVideoresult|null $videoResult videoResult
    *
    * @return $this
    */
    ...
    * Sets warningList
    *
    * @param \HuaweiCloud\SDK\Frs\V1\Model\WarningList[]|null $warningList 警告信息列表，WarningList结构见[WarningList](zh-cn_topic_0146322261.xml)。 调用失败时无此字段
    *
    * @return $this
    */
