...
class Landmark implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'eyesContour' => '\HuaweiCloud\SDK\Frs\V2\Model\Point[]',
            'mouthContour' => '\HuaweiCloud\SDK\Frs\V2\Model\Point[]',
            'faceContour' => '\HuaweiCloud\SDK\Frs\V2\Model\Point[]',
            'eyebrowContour' => 'map[string,\HuaweiCloud\SDK\Frs\V2\Model\Point][]',
            'noseContour' => '\HuaweiCloud\SDK\Frs\V2\Model\Point[]'
    ];
    ...
    *  眼睛轮廓，Point为轮廓坐标值。
    *
    * @return \HuaweiCloud\SDK\Frs\V2\Model\Point[]
    */
    ...
    * Sets eyesContour
    *
    * @param \HuaweiCloud\SDK\Frs\V2\Model\Point[] $eyesContour 眼睛轮廓，Point为轮廓坐标值。
    *
    * @return $this
    */
    ...
    * Sets mouthContour
    *
    * @param \HuaweiCloud\SDK\Frs\V2\Model\Point[] $mouthContour 嘴巴轮廓，Point为轮廓坐标值。
    *
    * @return $this
    */
    ...
    * Sets faceContour
    *
    * @param \HuaweiCloud\SDK\Frs\V2\Model\Point[] $faceContour 人脸轮廓，Point为轮廓坐标值。
    *
    * @return $this
    */
    ...
    *  眉毛轮廓，Point为轮廓坐标值。
    *
    * @return map[string,\HuaweiCloud\SDK\Frs\V2\Model\Point][]
    */
    ...
    * Sets eyebrowContour
    *
    * @param map[string,\HuaweiCloud\SDK\Frs\V2\Model\Point][] $eyebrowContour 眉毛轮廓，Point为轮廓坐标值。
    *
    * @return $this
    */
    ...
    * Sets noseContour
    *
    * @param \HuaweiCloud\SDK\Frs\V2\Model\Point[] $noseContour 鼻子轮廓，Point为轮廓坐标值。
    *
    * @return $this
    */
