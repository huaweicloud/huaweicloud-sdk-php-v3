...
class FullUpdateRulesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'FullUpdateRulesRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * rules  **参数解释：** 规则配置内容，可以配置多个规则 **约束限制：** 不涉及
    *
    * @var string[]
    */
