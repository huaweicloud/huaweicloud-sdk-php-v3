...
class ListDomainClientStatsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDomainClientStatsRequest';
    ...
    * statType  **参数解释：** 客户端访问资源指标类别 **约束限制：** 不涉及 **取值范围：** - uv：5分钟内访问加速域名的IP数，同一个IP访问域名多次时记1次 **默认取值：** 不涉及
