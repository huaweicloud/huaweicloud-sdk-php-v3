...
class TopUaSummary implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TopUaSummary';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * ua  UA值。
    * value  **参数解释：** 对应查询类型的值 **取值范围：** 若值为流量，流量单位：Byte
    * ratio  **参数解释：** 该ua的流量（或请求数）占当前查询条件下总流量（或请求数）的比例 **取值范围：** 保留4位小数
    *
    * @var string[]
    */
    ...
    * Sets ratio
    *
    * @param double|null $ratio **参数解释：** 该ua的流量（或请求数）占当前查询条件下总流量（或请求数）的比例 **取值范围：** 保留4位小数
    *
    * @return $this
    */
