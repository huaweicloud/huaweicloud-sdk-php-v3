...
class ListDomainClientStatsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDomainClientStatsResponse';
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['serviceArea']) && (mb_strlen($this->container['serviceArea']) > 256)) {
                $invalidProperties[] = "invalid value for 'serviceArea', the character length must be smaller than or equal to 256.";
            }
