...
class AccessControlTask implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AccessControlTask';
    ...
    * action  任务类型，unban：解禁任务；ban：封禁任务。
    * createTime  创建时间戳（毫秒）。
    *
    * @var string[]
    */
    ...
    * Sets action
    *
    * @param string|null $action 任务类型，unban：解禁任务；ban：封禁任务。
    *
    * @return $this
    */
