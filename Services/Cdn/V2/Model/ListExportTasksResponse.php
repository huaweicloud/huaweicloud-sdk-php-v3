...
class ListExportTasksResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'data' => '\HuaweiCloud\SDK\Cdn\V2\Model\ExportTask[]'
    ];
    ...
    * Sets total
    *
    * @param int|null $total **参数解释：** 导出任务总数 **取值范围：** 不涉及
    *
    * @return $this
    */
    ...
    *  data
    *
    * @return \HuaweiCloud\SDK\Cdn\V2\Model\ExportTask[]|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\Cdn\V2\Model\ExportTask[]|null $data data
    *
    * @return $this
    */
