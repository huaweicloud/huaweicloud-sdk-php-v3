...
class ExportStatsOpenRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExportStatsOpenRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Cdn\V2\Model\ExportVo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cdn\V2\Model\ExportVo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cdn\V2\Model\ExportVo|null $body body
    *
    * @return $this
    */
