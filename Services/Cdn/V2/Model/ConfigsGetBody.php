...
class ConfigsGetBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'sources' => '\HuaweiCloud\SDK\Cdn\V2\Model\SourcesConfigResponseBody[]',
    ...
    *  源站配置。
    *
    * @return \HuaweiCloud\SDK\Cdn\V2\Model\SourcesConfigResponseBody[]|null
    */
    ...
    * Sets sources
    *
    * @param \HuaweiCloud\SDK\Cdn\V2\Model\SourcesConfigResponseBody[]|null $sources 源站配置。
    *
    * @return $this
    */
