...
class StatsConfigDetails implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StatsConfigDetails';
    ...
    */
    protected static $openAPITypes = [
            ...
            'resourceType' => 'string',
            'resourceName' => 'string',
            'configInfo' => '\HuaweiCloud\SDK\Cdn\V2\Model\ConfigInfo',
            'expiredTime' => 'int'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['resourceType']) && (mb_strlen($this->container['resourceType']) > 65536)) {
            ...
            if (!is_null($this->container['resourceName']) && (mb_strlen($this->container['resourceName']) > 65536)) {
    ...
    *  configInfo
    *
    * @return \HuaweiCloud\SDK\Cdn\V2\Model\ConfigInfo|null
    */
    ...
    * Sets configInfo
    *
    * @param \HuaweiCloud\SDK\Cdn\V2\Model\ConfigInfo|null $configInfo configInfo
    *
    * @return $this
    */
    ...
    * Sets expiredTime
    *
    * @param int|null $expiredTime 统计配置失效时间，秒时间戳
    *
    * @return $this
    */
