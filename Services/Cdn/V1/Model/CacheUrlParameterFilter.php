...
class CacheUrlParameterFilter implements ModelInterface, ArrayAccess
{
    ...
    * type  缓存URL参数操作类型（full_url：缓存所有参数，ignore_url_params：忽略所有参数，del_args：忽略指定URL参数，reserve_args：保留指定URL参数）
    ...
    * Sets type
    *
    * @param string|null $type 缓存URL参数操作类型（full_url：缓存所有参数，ignore_url_params：忽略所有参数，del_args：忽略指定URL参数，reserve_args：保留指定URL参数）
    *
    * @return $this
    */
