...
class UpdateClusterGroupAssociatedClustersRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateClusterGroupAssociatedClustersRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Ucs\V1\Model\UpdateClusterGroupAssociatedClustersRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ucs\V1\Model\UpdateClusterGroupAssociatedClustersRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ucs\V1\Model\UpdateClusterGroupAssociatedClustersRequestBody|null $body body
    *
    * @return $this
    */
