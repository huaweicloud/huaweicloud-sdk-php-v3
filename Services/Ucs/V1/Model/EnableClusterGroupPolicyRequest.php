...
class EnableClusterGroupPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'EnableClusterGroupPolicyRequest';
    ...
    * Sets retry
    *
    * @param string|null $retry 重试启动策略管理功能
    *
    * @return $this
    */
