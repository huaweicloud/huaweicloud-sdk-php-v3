...
class CreateClusterGroupPolicyInstanceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateClusterGroupPolicyInstanceRequest';
