...
class ResourceKinds implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResourceKinds';
    ...
    * Sets apiGroups
    *
    * @param string[]|null $apiGroups 资源所属的API组
    *
    * @return $this
    */
