...
class ClusterGroupCondition implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ClusterGroupCondition';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * type  类型。 - Federation：舰队启用联邦状态类型 - Policy：权限策略
    * status  舰队启用的联邦或权限策略的状态
    * reason  状态原因
    * message  状态信息
    * lastTransitionTime  状态更新时间
    *
    * @var string[]
    */
    ...
    * Sets type
    *
    * @param string|null $type 类型。 - Federation：舰队启用联邦状态类型 - Policy：权限策略
    *
    * @return $this
    */
    ...
    * Sets status
    *
    * @param string|null $status 舰队启用的联邦或权限策略的状态
    *
    * @return $this
    */
    ...
    *
    * @param \DateTime|null $lastTransitionTime 状态更新时间
    *
    * @return $this
    */
