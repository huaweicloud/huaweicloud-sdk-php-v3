...
class ShowQuotaResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'quotas' => '\HuaweiCloud\SDK\Ucs\V1\Model\CommonQuotas'
    ];
    ...
    *  quotas
    *
    * @return \HuaweiCloud\SDK\Ucs\V1\Model\CommonQuotas|null
    */
    ...
    * Sets quotas
    *
    * @param \HuaweiCloud\SDK\Ucs\V1\Model\CommonQuotas|null $quotas quotas
    *
    * @return $this
    */
