...
class Constraint implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'spec' => '\HuaweiCloud\SDK\Ucs\V1\Model\ConstraintSpec'
    ];
    ...
    *  spec
    *
    * @return \HuaweiCloud\SDK\Ucs\V1\Model\ConstraintSpec|null
    */
    ...
    * Sets spec
    *
    * @param \HuaweiCloud\SDK\Ucs\V1\Model\ConstraintSpec|null $spec spec
    *
    * @return $this
    */
