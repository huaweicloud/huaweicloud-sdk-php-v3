...
class UpdateAssociatedZonesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAssociatedZonesRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * dnsSuffix  在联邦管理的域名访问功能中，用于更改根域名
    *
    * @var string[]
    */
    ...
    * Sets dnsSuffix
    *
    * @param string[]|null $dnsSuffix 在联邦管理的域名访问功能中，用于更改根域名
    *
    * @return $this
    */
