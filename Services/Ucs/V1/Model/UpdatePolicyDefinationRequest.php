...
class UpdatePolicyDefinationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePolicyDefinationRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Ucs\V1\Model\UCSConstraintTemplateTagRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ucs\V1\Model\UCSConstraintTemplateTagRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ucs\V1\Model\UCSConstraintTemplateTagRequest|null $body body
    *
    * @return $this
    */
