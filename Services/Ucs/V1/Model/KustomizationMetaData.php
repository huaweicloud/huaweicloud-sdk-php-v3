...
class KustomizationMetaData implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'KustomizationMetaData';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * name  Kustomization名称
    * namespace  所属命名空间
    * uid  唯一标识符
    ...
    * Sets name
    *
    * @param string|null $name Kustomization名称
    *
    * @return $this
    */
