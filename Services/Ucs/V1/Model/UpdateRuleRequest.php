...
class UpdateRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'ruleid' => 'string',
            'body' => '\HuaweiCloud\SDK\Ucs\V1\Model\UpdateRuleRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ucs\V1\Model\UpdateRuleRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ucs\V1\Model\UpdateRuleRequestBody|null $body body
    *
    * @return $this
    */
