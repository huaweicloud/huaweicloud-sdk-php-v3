...
class DownloadFederationKubeconfigRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DownloadFederationKubeconfigRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * duration  kubeconfig中证书的有效期
    *
    * @var string[]
    */
    ...
    * Sets duration
    *
    * @param int $duration kubeconfig中证书的有效期
    *
    * @return $this
    */
