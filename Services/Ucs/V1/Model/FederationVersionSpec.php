...
class FederationVersionSpec implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'FederationVersionSpec';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * federationVersion  联邦版本
    *
    * @var string[]
    */
    ...
    *
    * @param string|null $federationVersion 联邦版本
    *
    * @return $this
    */
