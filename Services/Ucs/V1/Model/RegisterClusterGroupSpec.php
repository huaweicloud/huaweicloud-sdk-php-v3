...
class RegisterClusterGroupSpec implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RegisterClusterGroupSpec';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * clusterIds  关联的集群id
    * description  容器舰队描述信息
    *
    * @var string[]
    */
    ...
    * Sets clusterIds
    *
    * @param string[]|null $clusterIds 关联的集群id
    *
    * @return $this
    */
    ...
    * Sets description
    *
    * @param string|null $description 容器舰队描述信息
    *
    * @return $this
    */
