...
class CreateProxyUnitedWorkloadRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateProxyUnitedWorkloadRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Ucs\V1\Model\MutiWorkload'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ucs\V1\Model\MutiWorkload|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ucs\V1\Model\MutiWorkload|null $body body
    *
    * @return $this
    */
