...
class Cluster implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'spec' => '\HuaweiCloud\SDK\Ucs\V1\Model\ClusterSpec',
            'status' => '\HuaweiCloud\SDK\Ucs\V1\Model\ClusterStatus'
    ];
    ...
    * Sets kind
    *
    * @param string|null $kind API类型，固定值“Cluster”，该值不可修改。
    *
    * @return $this
    */
    ...
    *  spec
    *
    * @return \HuaweiCloud\SDK\Ucs\V1\Model\ClusterSpec|null
    */
    ...
    * Sets spec
    *
    * @param \HuaweiCloud\SDK\Ucs\V1\Model\ClusterSpec|null $spec spec
    *
    * @return $this
    */
    ...
    *  status
    *
    * @return \HuaweiCloud\SDK\Ucs\V1\Model\ClusterStatus|null
    */
    ...
    * Sets status
    *
    * @param \HuaweiCloud\SDK\Ucs\V1\Model\ClusterStatus|null $status status
    *
    * @return $this
    */
