...
class ShowPolicyDefinitionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowPolicyDefinitionResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * kind  API类型，固定值“ConstraintTemplate”
    * apiVersion  API版本
    * metadata  metadata
    * spec  约束模板的详细属性
    *
    ...
    * Sets kind
    *
    * @param string|null $kind API类型，固定值“ConstraintTemplate”
    *
    * @return $this
    */
    ...
    * Sets spec
    *
    * @param object|null $spec 约束模板的详细属性
    *
    * @return $this
    */
