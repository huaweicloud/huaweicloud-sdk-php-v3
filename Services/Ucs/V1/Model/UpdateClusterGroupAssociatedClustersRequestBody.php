...
class UpdateClusterGroupAssociatedClustersRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateClusterGroupAssociatedClustersRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * clusterIds  更新容器舰队关联集群信息。
    *
    * @var string[]
    */
    ...
    * Sets clusterIds
    *
    * @param string[]|null $clusterIds 更新容器舰队关联集群信息。
    *
    * @return $this
    */
