...
class MaStudioAsyncClient extends Client
{
    ...
    {
        $client = new ClientBuilder(new MaStudioAsyncClient());
        return $client;
    }
    ...
    public function executeChatCompletionAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $responseType='\HuaweiCloud\SDK\MaStudio\V1\Model\ExecuteChatCompletionResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\MaStudio\V1\Model\ExecuteChatCompletionRequest',
            $asyncRequest = true);
    }
    ...
    public function executeTextCompletionAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\MaStudio\V1\Model\ExecuteTextCompletionResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\MaStudio\V1\Model\ExecuteTextCompletionRequest',
            $asyncRequest = true);
    }
