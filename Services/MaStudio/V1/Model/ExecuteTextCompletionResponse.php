...
class ExecuteTextCompletionResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'id' => 'string',
            'created' => 'int',
            'choices' => '\HuaweiCloud\SDK\MaStudio\V1\Model\TextChoice[]',
    ...
    *  模型回复
    *
    * @return \HuaweiCloud\SDK\MaStudio\V1\Model\TextChoice[]|null
    */
    ...
    * Sets choices
    *
    * @param \HuaweiCloud\SDK\MaStudio\V1\Model\TextChoice[]|null $choices 模型回复
    *
    * @return $this
    */
