...
class ChatCompletionReq implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'messages' => '\HuaweiCloud\SDK\MaStudio\V1\Model\Message[]',
            'user' => 'string',
            'stream' => 'bool',
            'temperature' => 'float',
            'topP' => 'float',
    ...
    *  多轮对话问答对
    *
    * @return \HuaweiCloud\SDK\MaStudio\V1\Model\Message[]
    */
    ...
    * Sets messages
    *
    * @param \HuaweiCloud\SDK\MaStudio\V1\Model\Message[] $messages 多轮对话问答对
    *
    * @return $this
    */
