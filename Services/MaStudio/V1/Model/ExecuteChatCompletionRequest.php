...
class ExecuteChatCompletionRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'contentType' => 'string',
            'deploymentId' => 'string',
            'body' => '\HuaweiCloud\SDK\MaStudio\V1\Model\ChatCompletionReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MaStudio\V1\Model\ChatCompletionReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MaStudio\V1\Model\ChatCompletionReq|null $body body
    *
    * @return $this
    */
