...
class ExecuteTextCompletionRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'contentType' => 'string',
            'deploymentId' => 'string',
            'body' => '\HuaweiCloud\SDK\MaStudio\V1\Model\TextCompletionReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\MaStudio\V1\Model\TextCompletionReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\MaStudio\V1\Model\TextCompletionReq|null $body body
    *
    * @return $this
    */
