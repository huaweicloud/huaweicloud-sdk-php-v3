...
class CreateQueueRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'vhost' => 'string',
            'body' => '\HuaweiCloud\SDK\RabbitMQ\V2\Model\CreateQueueBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\RabbitMQ\V2\Model\CreateQueueBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\RabbitMQ\V2\Model\CreateQueueBody|null $body body
    *
    * @return $this
    */
