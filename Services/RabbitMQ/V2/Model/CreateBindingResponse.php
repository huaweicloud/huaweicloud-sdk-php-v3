...
class CreateBindingResponse implements ModelInterface, ArrayAccess
{
    ...
    * source  绑定对象
    * destinationType  **参数解释**： 绑定目标端类型。 **取值范围**： - exchange：交换机。 - queue：队列。[AMQP版本只支持绑定queue。](tag:hws,hws_hk,hws_eu,srg)
    ...
    *
    * @param string|null $destinationType **参数解释**： 绑定目标端类型。 **取值范围**： - exchange：交换机。 - queue：队列。[AMQP版本只支持绑定queue。](tag:hws,hws_hk,hws_eu,srg)
    *
    * @return $this
    */
