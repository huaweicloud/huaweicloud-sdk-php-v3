...
class ListProductsRespValues1 implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'detail' => '\HuaweiCloud\SDK\RabbitMQ\V2\Model\ListProductsRespDetail1[]',
            'name' => 'string',
    ...
    *  **参数解释**： 规格详情。
    *
    * @return \HuaweiCloud\SDK\RabbitMQ\V2\Model\ListProductsRespDetail1[]|null
    */
    ...
    * Sets detail
    *
    * @param \HuaweiCloud\SDK\RabbitMQ\V2\Model\ListProductsRespDetail1[]|null $detail **参数解释**： 规格详情。
    *
    * @return $this
    */
