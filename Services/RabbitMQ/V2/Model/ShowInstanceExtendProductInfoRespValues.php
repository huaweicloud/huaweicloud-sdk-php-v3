...
class ShowInstanceExtendProductInfoRespValues implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'detail' => '\HuaweiCloud\SDK\RabbitMQ\V2\Model\ShowInstanceExtendProductInfoRespDetail[]',
            'name' => 'string',
    ...
    *  规格详情。
    *
    * @return \HuaweiCloud\SDK\RabbitMQ\V2\Model\ShowInstanceExtendProductInfoRespDetail[]|null
    */
    ...
    * Sets detail
    *
    * @param \HuaweiCloud\SDK\RabbitMQ\V2\Model\ShowInstanceExtendProductInfoRespDetail[]|null $detail 规格详情。
    *
    * @return $this
    */
