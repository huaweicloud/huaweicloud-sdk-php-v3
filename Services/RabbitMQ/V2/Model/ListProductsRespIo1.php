...
class ListProductsRespIo1 implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListProductsResp_io_1';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * ioType  **参数解释**： IO类型。 **取值范围**： 不涉及。
    * storageSpecCode  **参数解释**： IO规格。 **取值范围**： 不涉及。
    * availableZones  **参数解释**： IO未售罄的可用区列表。
    * unavailableZones  **参数解释**： IO已售罄的不可用区列表。
    ...
    * Sets availableZones
    *
    * @param string[]|null $availableZones **参数解释**： IO未售罄的可用区列表。
    *
    * @return $this
    */
    ...
    *
    * @param string[]|null $unavailableZones **参数解释**： IO已售罄的不可用区列表。
    *
    * @return $this
    */
