...
class ListScheduledTasksResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'jobCount' => 'int',
            'jobs' => '\HuaweiCloud\SDK\RabbitMQ\V2\Model\ScheduledTaskEntity[]'
    ];
    ...
    * Sets jobCount
    *
    * @param int|null $jobCount **参数解释**： 任务总数。 **取值范围**： 不涉及。
    *
    * @return $this
    */
    ...
    *  **参数解释**： 任务列表。 **取值范围**： 不涉及。
    *
    * @return \HuaweiCloud\SDK\RabbitMQ\V2\Model\ScheduledTaskEntity[]|null
    */
    ...
    * Sets jobs
    *
    * @param \HuaweiCloud\SDK\RabbitMQ\V2\Model\ScheduledTaskEntity[]|null $jobs **参数解释**： 任务列表。 **取值范围**： 不涉及。
    *
    * @return $this
    */
