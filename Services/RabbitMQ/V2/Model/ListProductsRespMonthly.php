...
class ListProductsRespMonthly implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListProductsResp_Monthly';
    ...
    */
    protected static $openAPITypes = [
            'name' => 'string',
            'version' => 'string',
            'values' => '\HuaweiCloud\SDK\RabbitMQ\V2\Model\ListProductsRespValues1[]'
    ];
    ...
    *  **参数解释**： 产品规格列表。
    *
    * @return \HuaweiCloud\SDK\RabbitMQ\V2\Model\ListProductsRespValues1[]|null
    */
    ...
    * Sets values
    *
    * @param \HuaweiCloud\SDK\RabbitMQ\V2\Model\ListProductsRespValues1[]|null $values **参数解释**： 产品规格列表。
    *
    * @return $this
    */
