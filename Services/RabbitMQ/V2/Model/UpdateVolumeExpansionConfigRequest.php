...
class UpdateVolumeExpansionConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateVolumeExpansionConfigRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\RabbitMQ\V2\Model\AlterAutoVolumeExpandConfig'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\RabbitMQ\V2\Model\AlterAutoVolumeExpandConfig|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\RabbitMQ\V2\Model\AlterAutoVolumeExpandConfig|null $body body
    *
    * @return $this
    */
