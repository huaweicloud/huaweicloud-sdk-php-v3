...
class ShowVhostDetailResp implements ModelInterface, ArrayAccess
{
    ...
    * tracing  **参数解释**： 是否开启消息轨迹[（AMQP版本不涉及此字段）](tag:hws,hws_hk,hws_eu,srg)。 **取值范围**： - true：开启。 - false：不开启。
    *
    * @var string[]
    */
    ...
    * Sets tracing
    *
    * @param bool|null $tracing **参数解释**： 是否开启消息轨迹[（AMQP版本不涉及此字段）](tag:hws,hws_hk,hws_eu,srg)。 **取值范围**： - true：开启。 - false：不开启。
    *
    * @return $this
    */
