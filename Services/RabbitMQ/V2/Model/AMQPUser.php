...
class AMQPUser implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AMQPUser';
    ...
    * Sets accessKey
    *
    * @param string $accessKey **参数解释**： 用户名。 **取值范围**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets secretKey
    *
    * @param string $secretKey **参数解释**： 密钥。 **取值范围**： - 8-32个字符。 - 至少包含以下字符中的3种：    - 大写字母    - 小写字母    - 数字    - 特殊字符`~!@#$%^&*()-_=+\\\\|[{}];:\\'\\\",<.>/?。 - 不能与名称或倒序的名称相同。
    *
    * @return $this
    */
    ...
    * Sets vhosts
    *
    * @param \HuaweiCloud\SDK\RabbitMQ\V2\Model\AMQPUserPerm[] $vhosts **参数解释**： 需要配置权限的Vhost，一个用户可以配置多个Vhost下的资源权限。
    *
    * @return $this
    */
