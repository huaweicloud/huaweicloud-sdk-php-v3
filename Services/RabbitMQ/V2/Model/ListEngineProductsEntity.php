...
class ListEngineProductsEntity implements ModelInterface, ArrayAccess
{
    ...
    * type  **参数解释**： 产品类型。 **取值范围**： - single：单机。    - cluster：集群。 [- single.professional：单机专业版，AMQP版本产品类型。](tag:hws,hws_hk,hws_eu) [- cluster.professional：集群专业版，AMQP版本产品类型。](tag:hws,hws_hk,hws_eu)
    ...
    * Sets type
    *
    * @param string|null $type **参数解释**： 产品类型。 **取值范围**： - single：单机。    - cluster：集群。 [- single.professional：单机专业版，AMQP版本产品类型。](tag:hws,hws_hk,hws_eu) [- cluster.professional：集群专业版，AMQP版本产品类型。](tag:hws,hws_hk,hws_eu)
    *
    * @return $this
    */
