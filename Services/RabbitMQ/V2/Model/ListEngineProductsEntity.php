...
class ListEngineProductsEntity implements ModelInterface, ArrayAccess
{
    ...
    * type  **参数解释**： 产品类型。 **取值范围**： - single：单机。    - cluster：集群。 [- single.professional：单机专业版，AMQP版本产品类型。](tag:hws,hws_hk,hws_eu,srg) [- cluster.professional：集群专业版，AMQP版本产品类型。](tag:hws,hws_hk,hws_eu,srg)
    ...
    * Sets type
    *
    * @param string|null $type **参数解释**： 产品类型。 **取值范围**： - single：单机。    - cluster：集群。 [- single.professional：单机专业版，AMQP版本产品类型。](tag:hws,hws_hk,hws_eu,srg) [- cluster.professional：集群专业版，AMQP版本产品类型。](tag:hws,hws_hk,hws_eu,srg)
    *
    * @return $this
    */
    ...
    * Sets ios
    *
    * @param \HuaweiCloud\SDK\RabbitMQ\V2\Model\ListEngineIosEntity[]|null $ios **参数解释**： 支持的磁盘IO类型列表。
    *
    * @return $this
    */
    ...
    *
    * @param object[]|null $supportFeatures **参数解释**： 当前规格实例支持的功能特性列表。
    *
    * @return $this
    */
