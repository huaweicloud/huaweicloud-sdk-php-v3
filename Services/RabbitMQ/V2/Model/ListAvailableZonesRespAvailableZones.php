...
class ListAvailableZonesRespAvailableZones implements ModelInterface, ArrayAccess
{
    ...
    * Sets soldOut
    *
    * @param bool|null $soldOut **参数解释**： 是否售罄。 **取值范围**： - true：售罄 - false：没有售罄
    *
    * @return $this
    */
    ...
    *
    * @param string|null $resourceAvailability **参数解释**： 分区上是否还有可用资源。 **取值范围**： - true：有可用资源。 - false：没有可用资源。
    *
    * @return $this
    */
    ...
    * Sets remainTime
    *
    * @param int|null $remainTime **参数解释**： 剩余时间，以Unix时间戳显示。 **取值范围**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets ipv6Enable
    *
    * @param bool|null $ipv6Enable **参数解释**： 是否支持IPv6。 **取值范围**： - true：支持IPv6 - false：不支持IPv6
    *
    * @return $this
    */
