...
class ListConfigFeaturesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'features' => '\HuaweiCloud\SDK\RabbitMQ\V2\Model\ListConfigFeatures[]',
            'totalRecord' => 'int'
    ];
    ...
    *  **参数解释**： 特性列表。
    *
    * @return \HuaweiCloud\SDK\RabbitMQ\V2\Model\ListConfigFeatures[]|null
    */
    ...
    * Sets features
    *
    * @param \HuaweiCloud\SDK\RabbitMQ\V2\Model\ListConfigFeatures[]|null $features **参数解释**： 特性列表。
    *
    * @return $this
    */
