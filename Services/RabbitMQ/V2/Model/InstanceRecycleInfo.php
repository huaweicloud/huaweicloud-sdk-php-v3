...
class InstanceRecycleInfo implements ModelInterface, ArrayAccess
{
    ...
    * engine  **参数解释**： 消息引擎。  **取值范围**： - rocketmq：RocketMQ消息引擎。 - reliability：RocketMQ消息引擎别称。
    * inRecycleTime  **参数解释**： 回收时间。  **取值范围**： 不涉及。
    * saveTime  **参数解释**： 保留时间。  **取值范围**： 1~7。
    ...
    * Sets engine
    *
    * @param string|null $engine **参数解释**： 消息引擎。  **取值范围**： - rocketmq：RocketMQ消息引擎。 - reliability：RocketMQ消息引擎别称。
    *
    * @return $this
    */
    ...
    * Sets saveTime
    *
    * @param int|null $saveTime **参数解释**： 保留时间。  **取值范围**： 1~7。
    *
    * @return $this
    */
