...
class ListProductsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'monthly' => '\HuaweiCloud\SDK\RabbitMQ\V2\Model\ListProductsRespMonthly[]'
    ];
    ...
    * Sets hourly
    *
    * @param \HuaweiCloud\SDK\RabbitMQ\V2\Model\ListProductsRespHourly[]|null $hourly **参数解释**： 表示按需付费的产品列表。
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\RabbitMQ\V2\Model\ListProductsRespMonthly[]|null
    */
    ...
    * Sets monthly
    *
    * @param \HuaweiCloud\SDK\RabbitMQ\V2\Model\ListProductsRespMonthly[]|null $monthly **参数解释**： 表示包年包月的产品列表。当前暂不支持通过API创建包年包月的Kafka实例。
    *
    * @return $this
    */
