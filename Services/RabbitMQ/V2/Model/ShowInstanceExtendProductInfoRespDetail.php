...
class ShowInstanceExtendProductInfoRespDetail implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'productId' => 'string',
            'specCode' => 'string',
            'io' => '\HuaweiCloud\SDK\RabbitMQ\V2\Model\ShowInstanceExtendProductInfoRespIo[]',
    ...
    *  IO信息。
    *
    * @return \HuaweiCloud\SDK\RabbitMQ\V2\Model\ShowInstanceExtendProductInfoRespIo[]|null
    */
    ...
    * Sets io
    *
    * @param \HuaweiCloud\SDK\RabbitMQ\V2\Model\ShowInstanceExtendProductInfoRespIo[]|null $io IO信息。
    *
    * @return $this
    */
