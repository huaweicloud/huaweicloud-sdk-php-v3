...
class BatchDeleteExchangesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteExchangesRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'vhost' => 'string',
            'body' => '\HuaweiCloud\SDK\RabbitMQ\V2\Model\BatchDeleteBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\RabbitMQ\V2\Model\BatchDeleteBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\RabbitMQ\V2\Model\BatchDeleteBody|null $body body
    *
    * @return $this
    */
