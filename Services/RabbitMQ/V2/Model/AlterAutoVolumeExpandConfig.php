...
class AlterAutoVolumeExpandConfig implements ModelInterface, ArrayAccess
{
    ...
    * maxVolumeSize  **参数解释**： 磁盘自动扩容的上限值。 **约束限制**： - 能被100整除。 -大于当前实例磁盘容量，且小于节点数*30000。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    ...
    * Sets maxVolumeSize
    *
    * @param int|null $maxVolumeSize **参数解释**： 磁盘自动扩容的上限值。 **约束限制**： - 能被100整除。 -大于当前实例磁盘容量，且小于节点数*30000。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    *
    * @return $this
    */
