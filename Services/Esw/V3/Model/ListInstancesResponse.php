...
class ListInstancesResponse implements ModelInterface, ArrayAccess
{
    ...
    * pageInfo  pageInfo
    * instances  - 参数解释：查询实例列表响应体。 - 约束限制：不涉及。 - 取值范围：不涉及。 - 默认取值：不涉及。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'instances' => '\HuaweiCloud\SDK\Esw\V3\Model\Instance[]'
    ];
    ...
    * Sets instances
    *
    * @param \HuaweiCloud\SDK\Esw\V3\Model\Instance[]|null $instances - 参数解释：查询实例列表响应体。 - 约束限制：不涉及。 - 取值范围：不涉及。 - 默认取值：不涉及。
    *
    * @return $this
    */
