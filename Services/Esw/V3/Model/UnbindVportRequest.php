...
class UnbindVportRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UnbindVportRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * connectionId  - 参数解释：二层连接的唯一标识。 - 约束限制：带“-”的UUID格式。 - 取值范围：不涉及。 - 默认取值：不涉及。
    ...
    */
    protected static $openAPITypes = [
            'connectionId' => 'string',
            'projectId' => 'string',
            'body' => '\HuaweiCloud\SDK\Esw\V3\Model\UnbindVportRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Esw\V3\Model\UnbindVportRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Esw\V3\Model\UnbindVportRequestBody|null $body body
    *
    * @return $this
    */
