...
class TunnelInfoOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TunnelInfoOption';
    ...
    * tunnelIp  - 参数解释：ESW的隧道IP。 - 约束限制：不能与已存在的子网IP冲突。 - 取值范围：标准的IPv4格式，例：192.168.1.1。 - 默认取值：不涉及。
    *
    * @var string[]
    */
    ...
    * Sets tunnelIp
    *
    * @param string|null $tunnelIp - 参数解释：ESW的隧道IP。 - 约束限制：不能与已存在的子网IP冲突。 - 取值范围：标准的IPv4格式，例：192.168.1.1。 - 默认取值：不涉及。
    *
    * @return $this
    */
