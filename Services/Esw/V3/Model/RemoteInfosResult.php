...
class RemoteInfosResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RemoteInfosResult';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * segmentationId  - 参数解释：二层连接的隧道号，对应VXLAN网络标识VNI。 - 约束限制：需与对端VXLAN设置的VNI保持一致。 - 取值范围：1-16777216。 - 默认取值：不涉及。
    * tunnelIp  - 参数解释：ESW实例的远端隧道IP。 - 约束限制：不能与已存在的子网IP冲突。 - 取值范围：标准的IPv4格式，例：192.168.1.1。 - 默认取值：不涉及。
    ...
    * Sets tunnelIp
    *
    * @param string $tunnelIp - 参数解释：ESW实例的远端隧道IP。 - 约束限制：不能与已存在的子网IP冲突。 - 取值范围：标准的IPv4格式，例：192.168.1.1。 - 默认取值：不涉及。
    *
    * @return $this
    */
    ...
    * Sets tunnelPort
    *
    * @param int $tunnelPort - 参数解释：二层连接的远端隧道端口。 - 约束限制：不涉及。 - 取值范围：4789。 - 默认取值：不涉及。
    *
    * @return $this
    */
