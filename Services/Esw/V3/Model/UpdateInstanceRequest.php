...
class UpdateInstanceRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'projectId' => 'string',
            'body' => '\HuaweiCloud\SDK\Esw\V3\Model\UpdateInstanceRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Esw\V3\Model\UpdateInstanceRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Esw\V3\Model\UpdateInstanceRequestBody|null $body body
    *
    * @return $this
    */
