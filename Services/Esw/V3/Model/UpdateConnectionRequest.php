...
class UpdateConnectionRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'instanceId' => 'string',
            'projectId' => 'string',
            'body' => '\HuaweiCloud\SDK\Esw\V3\Model\UpdateConnectionRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Esw\V3\Model\UpdateConnectionRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Esw\V3\Model\UpdateConnectionRequestBody|null $body body
    *
    * @return $this
    */
