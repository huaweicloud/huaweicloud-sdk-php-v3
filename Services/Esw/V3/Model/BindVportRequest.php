...
class BindVportRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BindVportRequest';
    ...
    */
    protected static $openAPITypes = [
            'connectionId' => 'string',
            'projectId' => 'string',
            'body' => '\HuaweiCloud\SDK\Esw\V3\Model\BindVportRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Esw\V3\Model\BindVportRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Esw\V3\Model\BindVportRequestBody|null $body body
    *
    * @return $this
    */
