...
class CreateInstanceResponse implements ModelInterface, ArrayAccess
{
    ...
    * instance  instance
    * jobId  - 参数解释：任务的唯一标识。 - 约束限制：带“-”的UUID格式。 - 取值范围：不涉及。 - 默认取值：不涉及。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'instance' => '\HuaweiCloud\SDK\Esw\V3\Model\Instance',
            'jobId' => 'string'
    ];
    ...
    *  instance
    *
    * @return \HuaweiCloud\SDK\Esw\V3\Model\Instance|null
    */
    ...
    * Sets instance
    *
    * @param \HuaweiCloud\SDK\Esw\V3\Model\Instance|null $instance instance
    *
    * @return $this
    */
    ...
    * Sets jobId
    *
    * @param string|null $jobId - 参数解释：任务的唯一标识。 - 约束限制：带“-”的UUID格式。 - 取值范围：不涉及。 - 默认取值：不涉及。
    *
    * @return $this
    */
