...
class CreateConnectionRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'projectId' => 'string',
            'body' => '\HuaweiCloud\SDK\Esw\V3\Model\CreateConnectionRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Esw\V3\Model\CreateConnectionRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Esw\V3\Model\CreateConnectionRequestBody|null $body body
    *
    * @return $this
    */
