...
class ListConnectionsAllInstancesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListConnectionsAllInstancesResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * requestId  - 参数解释：请求的唯一标识。 - 约束限制：UUID格式。 - 取值范围：不涉及。 - 默认取值：不涉及。
    * pageInfo  pageInfo
    * connections  - 参数解释：查询二层连接列表的响应体。 - 约束限制：不涉及。 - 取值范围：不涉及。 - 默认取值：不涉及。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'connections' => '\HuaweiCloud\SDK\Esw\V3\Model\Connection[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Esw\V3\Model\Connection[]|null
    */
    ...
    * Sets connections
    *
    * @param \HuaweiCloud\SDK\Esw\V3\Model\Connection[]|null $connections - 参数解释：查询二层连接列表的响应体。 - 约束限制：不涉及。 - 取值范围：不涉及。 - 默认取值：不涉及。
    *
    * @return $this
    */
