...
class ShowDeviceAuthenticationTemplateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDeviceAuthenticationTemplateRequest';
