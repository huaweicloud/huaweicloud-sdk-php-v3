...
class ListDeviceAuthenticationTemplatesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDeviceAuthenticationTemplatesRequest';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['templateName']) && !preg_match("/^[a-zA-Z0-9_-]{1,128}$/", $this->container['templateName'])) {
    ...
    * Sets templateName
    *
    * @param string|null $templateName **参数说明**：鉴权模板名称。 **取值范围**：长度不超过128，只允许字母、数字、下划线（_）、连接符（-）的组合。
    *
    * @return $this
    */
