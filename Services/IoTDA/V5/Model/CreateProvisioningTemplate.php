...
class CreateProvisioningTemplate implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateProvisioningTemplate';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['templateName'] === null) {
            ...
            if (!preg_match("/^[\\u4e00-\\u9fa5a-zA-Z0-9_-]{1,128}$/", $this->container['templateName'])) {
                $invalidProperties[] = "invalid value for 'templateName', must be conform to the pattern /^[\\u4e00-\\u9fa5a-zA-Z0-9_-]{1,128}$/.";
            }
    ...
    *  templateBody
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\ProvisioningTemplateBody
    */
    ...
    * Sets templateBody
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\ProvisioningTemplateBody $templateBody templateBody
    *
    * @return $this
    */
