...
class ListDeviceGroupsRequest implements ModelInterface, ArrayAccess
{
    ...
    * lastModifiedTime  查询设备组在last_modified_time之后修改的记录，格式：yyyyMMdd'T'HHmmss'Z'，如20151212T121212Z。
    * appId  资源空间ID。此参数为非必选参数，存在多资源空间的用户需要使用该接口时，可以携带该参数查询指定资源空间下的设备组列表，不携带该参数则会查询该用户下所有设备组列表。
    *
    * @var string[]
    */
    ...
    *
    * @param string|null $lastModifiedTime 查询设备组在last_modified_time之后修改的记录，格式：yyyyMMdd'T'HHmmss'Z'，如20151212T121212Z。
    *
    * @return $this
    */
    ...
    * Sets appId
    *
    * @param string|null $appId 资源空间ID。此参数为非必选参数，存在多资源空间的用户需要使用该接口时，可以携带该参数查询指定资源空间下的设备组列表，不携带该参数则会查询该用户下所有设备组列表。
    *
    * @return $this
    */
