...
class ResetBridgeSecretRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResetBridgeSecretRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'bridgeId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTDA\V5\Model\ResetBridgeSecret'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bridgeId'] === null) {
            ...
            if (!preg_match("/^[a-zA-Z0-9_-]{1,36}$/", $this->container['bridgeId'])) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\ResetBridgeSecret|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\ResetBridgeSecret|null $body body
    *
    * @return $this
    */
