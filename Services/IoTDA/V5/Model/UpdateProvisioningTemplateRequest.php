...
class UpdateProvisioningTemplateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateProvisioningTemplateRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'templateId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTDA\V5\Model\UpdateProvisioningTemplate'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateProvisioningTemplate|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateProvisioningTemplate|null $body body
    *
    * @return $this
    */
