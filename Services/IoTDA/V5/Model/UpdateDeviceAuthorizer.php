...
class UpdateDeviceAuthorizer implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDeviceAuthorizer';
    ...
    * status  **参数说明**：是否激活该鉴权方式，默认为激活。 - ACTIVE：该鉴权为激活状态。 - INACTIVE：该鉴权为停用状态。
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['funcUrn']) && !preg_match("/^[a-zA-Z0-9:_-]{0,256}$/", $this->container['funcUrn'])) {
    ...
    * Sets status
    *
    * @param string|null $status **参数说明**：是否激活该鉴权方式，默认为激活。 - ACTIVE：该鉴权为激活状态。 - INACTIVE：该鉴权为停用状态。
    *
    * @return $this
    */
