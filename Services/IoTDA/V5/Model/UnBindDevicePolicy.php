...
class UnBindDevicePolicy implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UnBindDevicePolicy';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * targetType  **参数说明**：解除策略绑定的目标类型。 **取值范围**：device|product|app，device表示设备，product表示产品，app表示整个资源空间。
    * targetIds  策略解绑的目标ID列表
    *
    * @var string[]
    */
    ...
    * Sets targetType
    *
    * @param string $targetType **参数说明**：解除策略绑定的目标类型。 **取值范围**：device|product|app，device表示设备，product表示产品，app表示整个资源空间。
    *
    * @return $this
    */
    ...
    * Sets targetIds
    *
    * @param string[] $targetIds 策略解绑的目标ID列表
    *
    * @return $this
    */
