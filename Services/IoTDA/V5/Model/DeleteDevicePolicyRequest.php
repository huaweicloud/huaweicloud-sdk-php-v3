...
class DeleteDevicePolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteDevicePolicyRequest';
    ...
    * policyId  策略ID。**取值范围**：仅允许A-F,a-f和数字的组合，长度为24。
    *
    * @var string[]
    */
