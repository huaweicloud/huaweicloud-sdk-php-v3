...
class ListRulesRequest implements ModelInterface, ArrayAccess
{
    ...
    * appId  资源空间ID。此参数为非必选参数，存在多资源空间的用户需要使用该接口时，可以携带该参数查询指定资源空间下的规则列表，不携带该参数则会查询该用户下所有规则列表。
    * ruleType  规则类型。此参数为非必选参数，指定对应的规则类型结果进行返回，不携带该参数则会返回所有类型规则。
    * limit  分页查询时每页显示的记录数，查询结果根据limit进行分页，默认值为10，取值范围为1-50的整数。
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['ruleType']) && !preg_match("/(DEVICE_LINKAGE|DATA_FORWARDING)/", $this->container['ruleType'])) {
                $invalidProperties[] = "invalid value for 'ruleType', must be conform to the pattern /(DEVICE_LINKAGE|DATA_FORWARDING)/.";
            }
    ...
    * Sets appId
    *
    * @param string|null $appId 资源空间ID。此参数为非必选参数，存在多资源空间的用户需要使用该接口时，可以携带该参数查询指定资源空间下的规则列表，不携带该参数则会查询该用户下所有规则列表。
    *
    * @return $this
    */
    ...
    * Sets ruleType
    *
    * @param string|null $ruleType 规则类型。此参数为非必选参数，指定对应的规则类型结果进行返回，不携带该参数则会返回所有类型规则。
    *
    * @return $this
    */
    ...
    * Sets limit
    *
    * @param int|null $limit 分页查询时每页显示的记录数，查询结果根据limit进行分页，默认值为10，取值范围为1-50的整数。
    *
    * @return $this
    */
