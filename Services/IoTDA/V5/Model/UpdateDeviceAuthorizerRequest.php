...
class UpdateDeviceAuthorizerRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDeviceAuthorizerRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'authorizerId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTDA\V5\Model\UpdateDeviceAuthorizer'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['authorizerId'] === null) {
            ...
            if (!preg_match("/^[a-fA-F0-9-]{36}$/", $this->container['authorizerId'])) {
                $invalidProperties[] = "invalid value for 'authorizerId', must be conform to the pattern /^[a-fA-F0-9-]{36}$/.";
            }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateDeviceAuthorizer|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateDeviceAuthorizer|null $body body
    *
    * @return $this
    */
