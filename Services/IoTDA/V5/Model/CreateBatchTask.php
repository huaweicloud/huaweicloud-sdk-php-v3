    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['taskType'] === null) {
            ...
            if (!preg_match("/softwareUpgrade|firmwareUpgrade|moduleUpgrade|createDevices|deleteDevices|freezeDevices|unfreezeDevices|createCommands|createAsyncCommands|sendEmails|sendSmss|updateDeviceShadows|createMessages|addDevicesToGroup|deviceConfig|updateDevices|deviceJob/", $this->container['taskType'])) {
                $invalidProperties[] = "invalid value for 'taskType', must be conform to the pattern /softwareUpgrade|firmwareUpgrade|moduleUpgrade|createDevices|deleteDevices|freezeDevices|unfreezeDevices|createCommands|createAsyncCommands|sendEmails|sendSmss|updateDeviceShadows|createMessages|addDevicesToGroup|deviceConfig|updateDevices|deviceJob/.";
            }
