...
class UpdateOtaModuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateOtaModuleRequest';
    ...
    * moduleId  **参数说明**：OTA模块ID，平台自动生成，用于唯一标识一个模块，创建模块后获得。 **取值范围**：长度不超过36，只允许字母、数字、连接符（-）的组合。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'moduleId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTDA\V5\Model\UpdateOtaModule'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['moduleId'] === null) {
            ...
            if (!preg_match("/^[a-zA-Z0-9-]{1,36}$/", $this->container['moduleId'])) {
                $invalidProperties[] = "invalid value for 'moduleId', must be conform to the pattern /^[a-zA-Z0-9-]{1,36}$/.";
            }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateOtaModule|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateOtaModule|null $body body
    *
    * @return $this
    */
