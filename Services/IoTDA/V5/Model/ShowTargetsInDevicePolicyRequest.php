...
class ShowTargetsInDevicePolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowTargetsInDevicePolicyRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'policyId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTDA\V5\Model\ShowTargetsInDevicePolicyRequestBody'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['policyId'] === null) {
            ...
            if (!preg_match("/^[a-fA-F0-9]{24}$/", $this->container['policyId'])) {
                $invalidProperties[] = "invalid value for 'policyId', must be conform to the pattern /^[a-fA-F0-9]{24}$/.";
            }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\ShowTargetsInDevicePolicyRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\ShowTargetsInDevicePolicyRequestBody|null $body body
    *
    * @return $this
    */
