...
class CreateRoutingFlowControlPolicyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateRoutingFlowControlPolicyResponse';
