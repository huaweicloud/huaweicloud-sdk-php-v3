...
class UpdateDeviceProxyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDeviceProxyRequest';
    ...
    * proxyId  **参数说明**：设备代理ID，用于唯一标识一个设备代理。在注册设备代理时由物联网平台分配获得。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'proxyId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTDA\V5\Model\UpdateDeviceProxy'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['proxyId'] === null) {
            ...
            if (!preg_match("/^[a-fA-F0-9-]{36}$/", $this->container['proxyId'])) {
                $invalidProperties[] = "invalid value for 'proxyId', must be conform to the pattern /^[a-fA-F0-9-]{36}$/.";
            }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateDeviceProxy|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateDeviceProxy|null $body body
    *
    * @return $this
    */
