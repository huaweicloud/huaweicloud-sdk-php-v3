...
class ListProvisioningTemplatesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListProvisioningTemplatesRequest';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['templateName']) && !preg_match("/^[\\u4e00-\\u9fa5a-zA-Z0-9_-]{1,128}$/", $this->container['templateName'])) {
