...
class UpdateDomainConfigurationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDomainConfigurationRequest';
    ...
    * configurationId  域配置ID，由平台分配的唯一标识。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\IoTDA\V5\Model\UpdateDomainConfigurationDTO'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['configurationId'] === null) {
            ...
            if (!preg_match("/^[a-fA-F0-9]{24}$/", $this->container['configurationId'])) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateDomainConfigurationDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateDomainConfigurationDTO|null $body body
    *
    * @return $this
    */
