    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['taskType'] === null) {
            ...
            if (!preg_match("/firmwareUpgrade|softwareUpgrade|createDevices|deleteDevices|freezeDevices|unfreezeDevices|createCommands|createAsyncCommands|sendEmails|sendSmss/", $this->container['taskType'])) {
                $invalidProperties[] = "invalid value for 'taskType', must be conform to the pattern /firmwareUpgrade|softwareUpgrade|createDevices|deleteDevices|freezeDevices|unfreezeDevices|createCommands|createAsyncCommands|sendEmails|sendSmss/.";
            }
