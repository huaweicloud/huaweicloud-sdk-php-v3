...
class DeleteServerCertificateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteServerCertificateRequest';
    ...
    * serverCertificateId  服务器证书ID，由平台分配的唯一标识。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['serverCertificateId'] === null) {
            ...
            if (!preg_match("/^[a-fA-F0-9]{24}$/", $this->container['serverCertificateId'])) {
