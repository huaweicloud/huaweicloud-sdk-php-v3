...
class AuthenticationTemplateBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AuthenticationTemplateBody';
    ...
    */
    protected static $openAPITypes = [
            'parameters' => 'object',
            'resources' => '\HuaweiCloud\SDK\IoTDA\V5\Model\AuthenticationTemplateResource'
    ];
    ...
    * Sets parameters
    *
    * @param object $parameters **参数说明**：鉴权模板参数，目前平台预制了mqtt协议连接参数中的clientId，username与设备证书中的属性，参数名定义如下: - iotda::mqtt::client_id ：mqtt连接参数三元组中的Client Id - iotda::mqtt::username ：mqtt连接参数三元组中的User Name - iotda::certificate::country (国家/地区,C ) - iotda::certificate::organization (组织,O) - iotda::certificate::organizational_unit (组织单位,OU) - iotda::certificate::distinguished_name_qualifier (可辨别名称限定符,dnQualifier) - iotda::certificate::state_name (省市,ST) - iotda::certificate::common_name (公用名,CN) - iotda::certificate::serial_number (序列号,serialNumber) - iotda::device::secret ：表示设备原始秘钥
    *
    * @return $this
    */
    ...
    *  resources
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\AuthenticationTemplateResource
    */
    ...
    * Sets resources
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\AuthenticationTemplateResource $resources resources
    *
    * @return $this
    */
