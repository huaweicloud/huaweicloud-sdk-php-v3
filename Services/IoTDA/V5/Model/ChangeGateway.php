...
class ChangeGateway implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeGateway';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * gatewayId  网关ID，用于标识设备所属的父设备，即父设备的设备ID。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['gatewayId'] === null) {
            ...
            if (!preg_match("/^[a-zA-Z0-9_-]{1,128}$/", $this->container['gatewayId'])) {
    ...
    * Sets gatewayId
    *
    * @param string $gatewayId 网关ID，用于标识设备所属的父设备，即父设备的设备ID。
    *
    * @return $this
    */
