...
class ListProtocolConfigsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListProtocolConfigsRequest';
    ...
    * limit  分页查询时每页显示的记录数，默认值为10，取值范围1-50的整数。
    ...
    */
    ...
    /**
    * Gets limit
    *  分页查询时每页显示的记录数，默认值为10，取值范围1-50的整数。
    *
    * @return int|null
    */
    ...
    * Sets limit
    *
    * @param int|null $limit 分页查询时每页显示的记录数，默认值为10，取值范围1-50的整数。
    *
    * @return $this
    */
