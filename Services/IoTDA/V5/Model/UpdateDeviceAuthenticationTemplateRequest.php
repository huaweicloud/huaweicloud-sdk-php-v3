...
class UpdateDeviceAuthenticationTemplateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDeviceAuthenticationTemplateRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'templateId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTDA\V5\Model\UpdateAuthenticationTemplate'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['templateId'] === null) {
            ...
            if (!preg_match("/^[a-fA-F0-9]{24}$/", $this->container['templateId'])) {
    ...
    * Sets templateId
    *
    * @param string $templateId 鉴权模板ID
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateAuthenticationTemplate|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateAuthenticationTemplate|null $body body
    *
    * @return $this
    */
