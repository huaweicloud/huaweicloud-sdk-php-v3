...
class AddHarmonySoftBusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddHarmonySoftBusRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTDA\V5\Model\AddHarmonySoftBusDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\AddHarmonySoftBusDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\AddHarmonySoftBusDTO|null $body body
    *
    * @return $this
    */
