...
class AddFunctionsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddFunctionsResponse';
    ...
    * functionId  **参数说明**：函数ID，产品配置函数后生成的唯一标识。 **取值范围**：长度不超过36，只允许字母、数字、下划线（_）、连接符（-）的组合。
    * urn  **参数说明**：产品关联函数的URN（Uniform Resource Name）。 **取值范围**：长度不超过128，只允许字母、数字、下划线（_）、连接符（-）、分隔符（:）的组合。
    * description  **参数说明**：编解码函数描述信息。 **取值范围**：128，只允许中文、字母、数字、以及_? '#().,&%@!-等字符的组合。
    * createTime  **参数说明**：产品函数创建时间。**格式**：yyyyMMdd'T'HHmmss'Z'，如20151212T121212Z。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['functionId']) && !preg_match("/^[a-zA-Z0-9_-]{1,36}$/", $this->container['functionId'])) {
                $invalidProperties[] = "invalid value for 'functionId', must be conform to the pattern /^[a-zA-Z0-9_-]{1,36}$/.";
            }
            if (!is_null($this->container['urn']) && !preg_match("/^[a-zA-Z0-9_:-]{1,256}$/", $this->container['urn'])) {
                $invalidProperties[] = "invalid value for 'urn', must be conform to the pattern /^[a-zA-Z0-9_:-]{1,256}$/.";
            }
    ...
    * Sets functionId
    *
    * @param string|null $functionId **参数说明**：函数ID，产品配置函数后生成的唯一标识。 **取值范围**：长度不超过36，只允许字母、数字、下划线（_）、连接符（-）的组合。
    *
    * @return $this
    */
    ...
    * Sets urn
    *
    * @param string|null $urn **参数说明**：产品关联函数的URN（Uniform Resource Name）。 **取值范围**：长度不超过128，只允许字母、数字、下划线（_）、连接符（-）、分隔符（:）的组合。
    *
    * @return $this
    */
    ...
    * Sets createTime
    *
    * @param string|null $createTime **参数说明**：产品函数创建时间。**格式**：yyyyMMdd'T'HHmmss'Z'，如20151212T121212Z。
    *
    * @return $this
    */
