...
class UpdateDeviceCertificateResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDeviceCertificateResponse';
    ...
    * certificatePem  **参数说明**：设备证书PEM格式内容。
    *
    * @var string[]
    */
    ...
    * Sets certificatePem
    *
    * @param string|null $certificatePem **参数说明**：设备证书PEM格式内容。
    *
    * @return $this
    */
