...
class AddProduct implements ModelInterface, ArrayAccess
{
    ...
    * protocolType  **参数说明**：设备使用的协议类型。 **取值范围**：MQTT，CoAP，HTTP，HTTPS，Modbus，ONVIF，OPC-UA，OPC-DA，Other，TCP，UDP。
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['protocolType'] === null) {
            ...
            if (!preg_match("/(MQTT|CoAP|HTTP|HTTPS|Modbus|ONVIF|OPC-UA|OPC-DA|Other|TCP|UDP)/", $this->container['protocolType'])) {
    ...
    * Sets protocolType
    *
    * @param string $protocolType **参数说明**：设备使用的协议类型。 **取值范围**：MQTT，CoAP，HTTP，HTTPS，Modbus，ONVIF，OPC-UA，OPC-DA，Other，TCP，UDP。
    *
    * @return $this
    */
