...
class DeleteExportTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteExportTaskRequest';
    ...
    * exportTaskId  导出任务id，在物联网平台创建导出任务后由平台分配获得。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['exportTaskId'] === null) {
            $invalidProperties[] = "'exportTaskId' can't be null";
        }
            if (!preg_match("/^[a-f0-9-]{1,36}$/", $this->container['exportTaskId'])) {
                $invalidProperties[] = "invalid value for 'exportTaskId', must be conform to the pattern /^[a-f0-9-]{1,36}$/.";
            }
