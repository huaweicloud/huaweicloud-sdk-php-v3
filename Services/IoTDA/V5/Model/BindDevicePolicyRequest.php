...
class BindDevicePolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BindDevicePolicyRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'policyId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTDA\V5\Model\BindDevicePolicy'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\BindDevicePolicy|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\BindDevicePolicy|null $body body
    *
    * @return $this
    */
