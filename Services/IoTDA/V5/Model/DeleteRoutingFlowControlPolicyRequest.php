...
class DeleteRoutingFlowControlPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteRoutingFlowControlPolicyRequest';
