...
class UpdateProtocolConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateProtocolConfigRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'protocolId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTDA\V5\Model\UpdateProtocolConfigDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateProtocolConfigDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateProtocolConfigDTO|null $body body
    *
    * @return $this
    */
