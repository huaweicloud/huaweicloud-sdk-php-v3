...
class ShowServerCertificateResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowServerCertificateResponse';
    ...
    * Sets certificatePem
    *
    * @param string|null $certificatePem **参数说明**：证书内容，PEM格式
    *
    * @return $this
    */
