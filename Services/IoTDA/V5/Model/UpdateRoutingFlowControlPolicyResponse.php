...
class UpdateRoutingFlowControlPolicyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateRoutingFlowControlPolicyResponse';
