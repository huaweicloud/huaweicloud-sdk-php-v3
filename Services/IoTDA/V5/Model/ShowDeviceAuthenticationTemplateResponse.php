...
class ShowDeviceAuthenticationTemplateResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDeviceAuthenticationTemplateResponse';
