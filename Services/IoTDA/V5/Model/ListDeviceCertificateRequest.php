...
class ListDeviceCertificateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDeviceCertificateRequest';
    ...
    * commonName  **参数说明**：证书通用名称，支持前缀模糊查询。 **取值范围**：长度不超过32，只允许字母、数字、下划线（_）、连接符（-）以及（? '#()\\.,&%@!*）等字符的组合。
    * fingerprint  **参数说明**：证书指纹。 **取值范围**：长度为40的十六进制字符串或者长度为64的十六进制字符串。
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['commonName']) && !preg_match("/^[a-zA-Z0-9_? '#()\\.,&%@!-*]{4,32}$/", $this->container['commonName'])) {
                $invalidProperties[] = "invalid value for 'commonName', must be conform to the pattern /^[a-zA-Z0-9_? '#()\\.,&%@!-*]{4,32}$/.";
            }
    ...
    * Sets commonName
    *
    * @param string|null $commonName **参数说明**：证书通用名称，支持前缀模糊查询。 **取值范围**：长度不超过32，只允许字母、数字、下划线（_）、连接符（-）以及（? '#()\\.,&%@!*）等字符的组合。
    *
    * @return $this
    */
    ...
    * Sets fingerprint
    *
    * @param string|null $fingerprint **参数说明**：证书指纹。 **取值范围**：长度为40的十六进制字符串或者长度为64的十六进制字符串。
    *
    * @return $this
    */
