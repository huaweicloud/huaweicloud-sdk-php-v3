...
class DeleteDeviceMessageRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteDeviceMessageRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['messageId'] === null) {
            ...
            if (!preg_match("/^[a-zA-Z0-9_-]{1,128}$/", $this->container['messageId'])) {
                $invalidProperties[] = "invalid value for 'messageId', must be conform to the pattern /^[a-zA-Z0-9_-]{1,128}$/.";
            }
