...
class ShowTargetsInDevicePolicyRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowTargetsInDevicePolicyRequestBody';
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['targetType']) && !preg_match("/(device|product|app)/", $this->container['targetType'])) {
    ...
    * Sets targetType
    *
    * @param string|null $targetType **参数说明**：策略绑定的目标类型。 **取值范围**：device|product|app，device表示设备，product表示产品，app表示整个资源空间。
    *
    * @return $this
    */
