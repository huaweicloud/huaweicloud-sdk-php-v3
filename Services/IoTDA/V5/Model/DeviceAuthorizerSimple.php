...
class DeviceAuthorizerSimple implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeviceAuthorizerSimple';
    ...
    * createTime  在物联网平台查询自定义鉴权的时间。格式：yyyyMMdd'T'HHmmss'Z'，如：20151212T121212Z。
    * updateTime  在物联网平台更新查询自定义鉴权的时间。格式：yyyyMMdd'T'HHmmss'Z'，如：20151212T121212Z。
    *
    * @var string[]
    */
    ...
    * Sets funcName
    *
    * @param string|null $funcName **参数说明**：自定义鉴权器对应的函数名称。
    *
    * @return $this
    */
    ...
    * Sets createTime
    *
    * @param string|null $createTime 在物联网平台查询自定义鉴权的时间。格式：yyyyMMdd'T'HHmmss'Z'，如：20151212T121212Z。
    *
    * @return $this
    */
    ...
    * Sets updateTime
    *
    * @param string|null $updateTime 在物联网平台更新查询自定义鉴权的时间。格式：yyyyMMdd'T'HHmmss'Z'，如：20151212T121212Z。
    *
    * @return $this
    */
