...
class FunctionDTO implements ModelInterface, ArrayAccess
{
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['functionId'] === null) {
            ...
            if (!preg_match("/^[a-zA-Z0-9_-]{1,36}$/", $this->container['functionId'])) {
        ...
        if ($this->container['urn'] === null) {
            ...
            if (!preg_match("/^[a-zA-Z0-9_:-]{1,256}$/", $this->container['urn'])) {
    ...
    * Sets functionId
    *
    * @param string $functionId **参数说明**：函数ID，产品配置函数后生成的唯一标识。 **取值范围**：长度不超过36，只允许字母、数字、下划线（_）、连接符（-）的组合。
    *
    * @return $this
    */
    ...
    * Sets urn
    *
    * @param string $urn **参数说明**：产品关联函数的URN（Uniform Resource Name）。 **取值范围**：长度不超过128，只允许字母、数字、下划线（_）、连接符（-）、分隔符（:）的组合。
    *
    * @return $this
    */
