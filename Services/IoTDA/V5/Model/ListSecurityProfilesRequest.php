...
class ListSecurityProfilesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSecurityProfilesRequest';
    ...
    * securityType  **参数说明**：具体安全态势感知配置项名称。
    * targetType  **参数说明**：绑定资源类型，当前仅支持产品。
    * targetId  **参数说明**：绑定资源ID。必须配合target_type一起使用，target_type为PRODUCT时，target_id格式为:资源空间ID:产品ID
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['targetId']) && !preg_match("/^[a-zA-Z0-9:_-]{1,128}$/", $this->container['targetId'])) {
                $invalidProperties[] = "invalid value for 'targetId', must be conform to the pattern /^[a-zA-Z0-9:_-]{1,128}$/.";
            }
    ...
    * Sets securityType
    *
    * @param string|null $securityType **参数说明**：具体安全态势感知配置项名称。
    *
    * @return $this
    */
    ...
    * Sets targetType
    *
    * @param string|null $targetType **参数说明**：绑定资源类型，当前仅支持产品。
    *
    * @return $this
    */
    ...
    * Sets targetId
    *
    * @param string|null $targetId **参数说明**：绑定资源ID。必须配合target_type一起使用，target_type为PRODUCT时，target_id格式为:资源空间ID:产品ID
    *
    * @return $this
    */
