...
class UnbindDevicePolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UnbindDevicePolicyRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'policyId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTDA\V5\Model\UnBindDevicePolicy'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\UnBindDevicePolicy|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\UnBindDevicePolicy|null $body body
    *
    * @return $this
    */
