...
class DeleteDeviceAuthenticationTemplateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteDeviceAuthenticationTemplateRequest';
