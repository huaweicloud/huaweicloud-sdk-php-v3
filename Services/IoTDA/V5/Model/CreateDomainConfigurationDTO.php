...
class CreateDomainConfigurationDTO implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateDomainConfigurationDTO';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * domainName  **参数说明**：自定义域名
    * accessProtocol  **参数说明**：接入协议，当前仅支持Device-MQTTS：设备接入MQTTS场景
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['domainName'] === null) {
            ...
            if ((mb_strlen($this->container['domainName']) > 128)) {
        ...
        if ($this->container['accessProtocol'] === null) {
            $invalidProperties[] = "'accessProtocol' can't be null";
        }
            if (!preg_match("/Device-MQTTS/", $this->container['accessProtocol'])) {
                $invalidProperties[] = "invalid value for 'accessProtocol', must be conform to the pattern /Device-MQTTS/.";
            }
        if ($this->container['serverCertificateId'] === null) {
            $invalidProperties[] = "'serverCertificateId' can't be null";
        }
            if (!preg_match("/^[a-f0-9-]{1,36}$/", $this->container['serverCertificateId'])) {
    ...
    * Sets domainName
    *
    * @param string $domainName **参数说明**：自定义域名
    *
    * @return $this
    */
    ...
    * Sets accessProtocol
    *
    * @param string $accessProtocol **参数说明**：接入协议，当前仅支持Device-MQTTS：设备接入MQTTS场景
    *
    * @return $this
    */
    ...
    *
    * @param string $serverCertificateId **参数说明**：自定义服务端证书ID
    *
    * @return $this
    */
