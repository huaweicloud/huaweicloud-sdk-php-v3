...
class UpdateRoutingFlowControlPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateRoutingFlowControlPolicyRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'policyId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTDA\V5\Model\UpdateFlowControlPolicy'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateFlowControlPolicy|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateFlowControlPolicy|null $body body
    *
    * @return $this
    */
