...
class UpdateDeviceAuthenticationTemplateResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDeviceAuthenticationTemplateResponse';
