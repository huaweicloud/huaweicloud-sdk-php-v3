...
class DmsKafkaForwarding implements ModelInterface, ArrayAccess
{
    ...
    * Sets regionName
    *
    * @param string $regionName Kafka服务对应的region区域
    *
    * @return $this
    */
    ...
    * Sets projectId
    *
    * @param string $projectId Kafka服务对应的projectId信息
    *
    * @return $this
    */
    ...
    * Sets username
    *
    * @param string|null $username 转发kafka关联的用户名信息。
    *
    * @return $this
    */
    ...
    * Sets password
    *
    * @param string|null $password 转发kafka关联的密码信息。
    *
    * @return $this
    */
    ...
    * Sets mechanism
    *
    * @param string|null $mechanism 转发kafka关联的鉴权机制。 类型说明： PAAS：非SASL鉴权。 PLAIN：SASL/PLAIN模式。需要填写对应的用户名密码信息。
    *
    * @return $this
    */
