...
class ModuleSearchDTO implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ModuleSearchDTO';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['moduleVersion'] === null) {
            ...
            if (!preg_match("/^[a-zA-Z0-9_.\\-]{1,64}$/", $this->container['moduleVersion'])) {
                $invalidProperties[] = "invalid value for 'moduleVersion', must be conform to the pattern /^[a-zA-Z0-9_.\\-]{1,64}$/.";
            }
