...
class UpdateDevicePolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDevicePolicyRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'policyId' => 'string',
            'body' => '\HuaweiCloud\SDK\IoTDA\V5\Model\UpdateDevicePolicy'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateDevicePolicy|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\IoTDA\V5\Model\UpdateDevicePolicy|null $body body
    *
    * @return $this
    */
