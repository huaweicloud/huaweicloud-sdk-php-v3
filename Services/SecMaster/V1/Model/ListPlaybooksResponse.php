...
class ListPlaybooksResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'size' => 'int',
            'page' => 'int',
            'data' => '\HuaweiCloud\SDK\SecMaster\V1\Model\PlaybookInfo[]',
            'xRequestId' => 'string'
    ];
    ...
    *  剧本列表信息
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\PlaybookInfo[]|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\PlaybookInfo[]|null $data 剧本列表信息
    *
    * @return $this
    */
