...
class ListDatapanelObjectsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDatapanelObjectsResponse';
    ...
    *  详情列表
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\DataObjectDetail[]|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\DataObjectDetail[]|null $data 详情列表
    *
    * @return $this
    */
