...
class DpeOperateFunctionDetail implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DpeOperateFunctionDetail';
    ...
    */
    protected static $openAPITypes = [
            ...
            'params' => '\HuaweiCloud\SDK\SecMaster\V1\Model\Params[]'
    ];
    ...
    */
    protected static $setters = [
            ...
            'example' => 'setExample',
            'operationfunc' => 'setOperationfunc',
            'params' => 'setParams'
    ];
    ...
    */
    protected static $getters = [
            ...
            'example' => 'getExample',
            'operationfunc' => 'getOperationfunc',
            'params' => 'getParams'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['operationfunc'] = isset($data['operationfunc']) ? $data['operationfunc'] : null;
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['operationfunc']) && (mb_strlen($this->container['operationfunc']) > 256)) {
                $invalidProperties[] = "invalid value for 'operationfunc', the character length must be smaller than or equal to 256.";
            }
            if (!is_null($this->container['operationfunc']) && (mb_strlen($this->container['operationfunc']) < 1)) {
                $invalidProperties[] = "invalid value for 'operationfunc', the character length must be bigger than or equal to 1.";
            }
    ...
    * @return string|null
    */
    public function getOperationfunc()
    {
        return $this->container['operationfunc'];
    }

    /**
    * Sets operationfunc
    *
    * @param string|null $operationfunc 转换方法Key
    *
    * @return $this
    */
    public function setOperationfunc($operationfunc)
    {
        $this->container['operationfunc'] = $operationfunc;
        return $this;
    }
    ...
    *  参数集合
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\Params[]|null
    */
    ...
    * Sets params
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\Params[]|null $params 参数集合
    *
    * @return $this
    */
