...
class ListHistoryComponentConfigurationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListHistoryComponentConfigurationRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['componentId'] === null) {
            ...
            if ((mb_strlen($this->container['componentId']) < 36)) {
                $invalidProperties[] = "invalid value for 'componentId', the character length must be bigger than or equal to 36.";
            }
