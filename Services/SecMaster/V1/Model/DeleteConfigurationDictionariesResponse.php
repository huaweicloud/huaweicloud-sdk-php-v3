...
class DeleteConfigurationDictionariesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteConfigurationDictionariesResponse';
