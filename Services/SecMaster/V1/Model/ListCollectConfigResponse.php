...
class ListCollectConfigResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'configStatistics' => '\HuaweiCloud\SDK\SecMaster\V1\Model\ListCollectConfigResponseBodyConfigStatistics',
    ...
    *  configStatistics
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\ListCollectConfigResponseBodyConfigStatistics|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\ListCollectConfigResponseBodyConfigStatistics|null $configStatistics configStatistics
    *
    * @return $this
    */
