...
class UpdateMappingInfoStatusResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateMappingInfoStatusResponse';
    ...
    */
    protected static $openAPITypes = [
            'code' => 'string',
            'message' => 'string',
            'data' => '\HuaweiCloud\SDK\SecMaster\V1\Model\UpdateDpeInfoStatusRequestBody'
    ];
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\UpdateDpeInfoStatusRequestBody|null $data data
    *
    * @return $this
    */
