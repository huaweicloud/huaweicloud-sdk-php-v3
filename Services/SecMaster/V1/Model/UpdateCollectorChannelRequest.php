...
class UpdateCollectorChannelRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateCollectorChannelRequest';
    ...
    */
    protected static $openAPITypes = [
            'workspaceId' => 'string',
            'channelId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\CreateChannelDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\CreateChannelDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\CreateChannelDto|null $body body
    *
    * @return $this
    */
