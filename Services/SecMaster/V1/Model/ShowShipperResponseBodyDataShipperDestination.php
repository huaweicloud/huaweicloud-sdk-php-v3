...
class ShowShipperResponseBodyDataShipperDestination implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowShipperResponseBody_data_shipper_destination';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['destinationInfo']) && (mb_strlen($this->container['destinationInfo']) > 256)) {
                $invalidProperties[] = "invalid value for 'destinationInfo', the character length must be smaller than or equal to 256.";
            }
            if (!is_null($this->container['destinationInfo']) && (mb_strlen($this->container['destinationInfo']) < 1)) {
                $invalidProperties[] = "invalid value for 'destinationInfo', the character length must be bigger than or equal to 1.";
            }
    ...
    * Sets dataParam
    *
    * @param string|null $dataParam 目的参数
    *
    * @return $this
    */
    ...
    *
    * @param string|null $destinationInfo 目的信息
    *
    * @return $this
    */
