...
class ModifyActionInfo implements ModelInterface, ArrayAccess
{
    ...
    * name  名称
    * description  描述
    * actionType  **参数解释：** 动作类型 - AOP_WORKFLOW    流程  **约束限制：** 不涉及 **取值范围：** - AOP_WORKFLOW  **默认取值：** AOP_WORKFLOW
    * actionId  剧本动作ID
    * sortOrder  排序方式
    *
    * @var string[]
    ...
    * Sets actionType
    *
    * @param string|null $actionType **参数解释：** 动作类型 - AOP_WORKFLOW    流程  **约束限制：** 不涉及 **取值范围：** - AOP_WORKFLOW  **默认取值：** AOP_WORKFLOW
    *
    * @return $this
    */
