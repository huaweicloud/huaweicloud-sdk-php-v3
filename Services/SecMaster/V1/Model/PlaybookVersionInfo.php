...
class PlaybookVersionInfo implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'actions' => '\HuaweiCloud\SDK\SecMaster\V1\Model\ActionInfo[]',
            'ruleEnable' => 'bool',
            'rules' => '\HuaweiCloud\SDK\SecMaster\V1\Model\RuleInfo',
            'dataclassId' => 'string',
            'triggerType' => 'string',
    ...
    * Sets actions
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\ActionInfo[]|null $actions 剧本关联流程列表信息
    *
    * @return $this
    */
    ...
    * Sets rules
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\RuleInfo|null $rules rules
    *
    * @return $this
    */
