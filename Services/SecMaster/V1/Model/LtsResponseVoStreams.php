...
class LtsResponseVoStreams implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'LtsResponseVo_streams';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['logStreamName']) && (mb_strlen($this->container['logStreamName']) > 255)) {
                $invalidProperties[] = "invalid value for 'logStreamName', the character length must be smaller than or equal to 255.";
            }
