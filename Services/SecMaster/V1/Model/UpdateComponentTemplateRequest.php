...
class UpdateComponentTemplateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateComponentTemplateRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'templateId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\CreateTemplateReq'
    ];
    ...
    * Sets templateId
    *
    * @param string $templateId 插件配置模板ID
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\CreateTemplateReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\CreateTemplateReq|null $body body
    *
    * @return $this
    */
