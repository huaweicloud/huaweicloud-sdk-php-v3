...
class ListLayoutRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListLayoutRequest';
    ...
    */
    protected static $openAPITypes = [
            'contentType' => 'string',
            'workspaceId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\LayoutSearch'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\LayoutSearch|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\LayoutSearch|null $body body
    *
    * @return $this
    */
