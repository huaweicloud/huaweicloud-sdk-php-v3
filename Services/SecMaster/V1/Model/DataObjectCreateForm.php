...
class DataObjectCreateForm implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DataObjectCreateForm';
    ...
    * type  描述
    * triggerFlag  触发标志
    * dataObject  单个数据对象json体，键值根据对应数据类所需的字段添加
    *
    * @var string[]
    */
    ...
    * Sets dataObject
    *
    * @param object|null $dataObject 单个数据对象json体，键值根据对应数据类所需的字段添加
    *
    * @return $this
    */
