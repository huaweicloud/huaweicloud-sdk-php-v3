...
class ListRecipientsStatusRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRecipientsStatusRequestBody';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['emailAddress'] === null) {
            ...
            if ((mb_strlen($this->container['emailAddress']) > 256)) {
                $invalidProperties[] = "invalid value for 'emailAddress', the character length must be smaller than or equal to 256.";
            }
