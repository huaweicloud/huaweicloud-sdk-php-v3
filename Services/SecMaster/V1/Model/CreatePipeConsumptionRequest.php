...
class CreatePipeConsumptionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePipeConsumptionRequest';
    ...
    */
    protected static $openAPITypes = [
            'workspaceId' => 'string',
            'pipeId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\EnableConsumptionRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\EnableConsumptionRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\EnableConsumptionRequestBody|null $body body
    *
    * @return $this
    */
