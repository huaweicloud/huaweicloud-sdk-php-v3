...
class BatchUntagResourcesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchUntagResourcesRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'resourceId' => 'string',
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\AlterResourceTagsInBatchesRequestBody'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['contentType'] === null) {
            ...
            if ((mb_strlen($this->container['contentType']) > 100)) {
                $invalidProperties[] = "invalid value for 'contentType', the character length must be smaller than or equal to 100.";
            }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\AlterResourceTagsInBatchesRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\AlterResourceTagsInBatchesRequestBody|null $body body
    *
    * @return $this
    */
