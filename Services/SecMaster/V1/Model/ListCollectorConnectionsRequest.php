...
class ListCollectorConnectionsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCollectorConnectionsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * workspaceId  工作空间ID
    * connectionType  **参数解释**: 连接类型 - FILTER 过滤 - INPUT 输入 - OUTPUT 输出  **约束限制** 不涉及 **取值范围**: - FILTER - INPUT - OUTPUT  **默认值** 不涉及
    * title  标题
    * description  相关描述
    * offset  第几页
    * limit  每页数量
    ...
    */
    ...
    const CONNECTION_TYPE_FILTER = 'FILTER';
    const CONNECTION_TYPE_INPUT = 'INPUT';
    const CONNECTION_TYPE_OUTPUT = 'OUTPUT';
    ...
    */
    ...
    {
        return [
            self::CONNECTION_TYPE_FILTER,
            self::CONNECTION_TYPE_INPUT,
            self::CONNECTION_TYPE_OUTPUT,
        ];
    }
    ...
    * Sets connectionType
    *
    * @param string|null $connectionType **参数解释**: 连接类型 - FILTER 过滤 - INPUT 输入 - OUTPUT 输出  **约束限制** 不涉及 **取值范围**: - FILTER - INPUT - OUTPUT  **默认值** 不涉及
    *
    * @return $this
    */
