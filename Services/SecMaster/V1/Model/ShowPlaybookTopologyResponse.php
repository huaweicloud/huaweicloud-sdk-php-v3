...
class ShowPlaybookTopologyResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'count' => 'int',
            'actionInstances' => '\HuaweiCloud\SDK\SecMaster\V1\Model\ActionInstanceInfo[]',
            'xRequestId' => 'string'
    ];
    ...
    *  流程实例列表
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\ActionInstanceInfo[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\ActionInstanceInfo[]|null $actionInstances 流程实例列表
    *
    * @return $this
    */
