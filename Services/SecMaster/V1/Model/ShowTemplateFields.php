...
class ShowTemplateFields implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowTemplateFields';
    ...
    */
    protected static $openAPITypes = [
            'fields' => '\HuaweiCloud\SDK\SecMaster\V1\Model\TemplateField[]',
            'templateId' => 'string'
    ];
    ...
    *  相关描述信息
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\TemplateField[]|null
    */
    ...
    * Sets fields
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\TemplateField[]|null $fields 相关描述信息
    *
    * @return $this
    */
