...
class ListAlertDetail implements ModelInterface, ArrayAccess
{
    ...
    * formatVersion  格式版本
    * id  告警唯一标识，UUID格式，最大36个字符
    * type  数据类型（SIMULATION--告警, PLAYBOOK--剧本, MANUAL--手动触发,DATA_SOURCE--数据源）
    * projectId  当前项目的id
    ...
    */
    protected static $openAPITypes = [
            'createTime' => 'string',
            'dataObject' => '\HuaweiCloud\SDK\SecMaster\V1\Model\ListAlertRsp',
    ...
    *  dataObject
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\ListAlertRsp|null
    */
    ...
    * Sets dataObject
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\ListAlertRsp|null $dataObject dataObject
    *
    * @return $this
    */
    ...
    *  dataclassRef
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\AlertDetailDataclassRef|null
    */
    ...
    * Sets dataclassRef
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\AlertDetailDataclassRef|null $dataclassRef dataclassRef
    *
    * @return $this
    */
    ...
    * Sets id
    *
    * @param string|null $id 告警唯一标识，UUID格式，最大36个字符
    *
    * @return $this
    */
    ...
    * Sets type
    *
    * @param string|null $type 数据类型（SIMULATION--告警, PLAYBOOK--剧本, MANUAL--手动触发,DATA_SOURCE--数据源）
    *
    * @return $this
    */
