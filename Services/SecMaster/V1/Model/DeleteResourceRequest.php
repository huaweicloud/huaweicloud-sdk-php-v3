...
class DeleteResourceRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'xLanguage' => 'string',
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\DeleteResourceRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\DeleteResourceRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\DeleteResourceRequestBody|null $body body
    *
    * @return $this
    */
