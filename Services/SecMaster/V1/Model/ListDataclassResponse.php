...
class ListDataclassResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'dataclassDetails' => '\HuaweiCloud\SDK\SecMaster\V1\Model\DataClassResponseBody[]',
            'total' => 'float',
            'xRequestId' => 'string'
    ];
    ...
    *  数据类详情
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\DataClassResponseBody[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\DataClassResponseBody[]|null $dataclassDetails 数据类详情
    *
    * @return $this
    */
