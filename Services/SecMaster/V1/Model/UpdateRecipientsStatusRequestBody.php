...
class UpdateRecipientsStatusRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateRecipientsStatusRequestBody';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['emailAddress'] === null) {
            ...
            if ((mb_strlen($this->container['emailAddress']) > 65526)) {
                $invalidProperties[] = "invalid value for 'emailAddress', the character length must be smaller than or equal to 65526.";
            }
    ...
    * Sets emailAddress
    *
    * @param string $emailAddress 收件人邮箱
    *
    * @return $this
    */
