...
class IncidentDetail implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'createTime' => 'string',
            'dataObject' => '\HuaweiCloud\SDK\SecMaster\V1\Model\Incident',
    ...
    *  dataObject
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\Incident|null
    */
    ...
    * Sets dataObject
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\Incident|null $dataObject dataObject
    *
    * @return $this
    */
