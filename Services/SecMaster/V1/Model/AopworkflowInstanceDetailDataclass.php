...
class AopworkflowInstanceDetailDataclass implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AopworkflowInstanceDetail_dataclass';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * enName  **参数解释**: 数据类的英文名字 **约束限制**: 不涉及
    * id  **参数解释**: 数据类的ID **约束限制**: 不涉及
    * name  **参数解释**: 数据类的中文名字 **约束限制**: 不涉及
    *
    * @var string[]
    */
    ...
    * Sets enName
    *
    * @param string|null $enName **参数解释**: 数据类的英文名字 **约束限制**: 不涉及
    *
    * @return $this
    */
    ...
    * Sets id
    *
    * @param string|null $id **参数解释**: 数据类的ID **约束限制**: 不涉及
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string|null $name **参数解释**: 数据类的中文名字 **约束限制**: 不涉及
    *
    * @return $this
    */
