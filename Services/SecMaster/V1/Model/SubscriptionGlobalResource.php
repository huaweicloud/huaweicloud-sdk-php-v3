...
class SubscriptionGlobalResource implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SubscriptionGlobalResource';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * projectId  项目ID
    * regionId  当前region编码，默认为null，即为当前region
    * resources  当前demo-regionon已购资源列表
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'regionId' => 'string',
            'resources' => '\HuaweiCloud\SDK\SecMaster\V1\Model\SubscriptionResourceInfo[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\SubscriptionResourceInfo[]|null
    */
    ...
    * Sets resources
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\SubscriptionResourceInfo[]|null $resources 当前demo-regionon已购资源列表
    *
    * @return $this
    */
