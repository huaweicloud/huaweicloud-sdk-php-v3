...
class ListComponentTemplatesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListComponentTemplatesResponse';
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\TemplateInfo[]|null $data 插件配置模板列表
    *
    * @return $this
    */
