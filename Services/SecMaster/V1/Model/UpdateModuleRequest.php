...
class UpdateModuleRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'moduleId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\ModuleUpdateRequestPojo'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['moduleId'] === null) {
            ...
            if ((mb_strlen($this->container['moduleId']) < 0)) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\ModuleUpdateRequestPojo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\ModuleUpdateRequestPojo|null $body body
    *
    * @return $this
    */
