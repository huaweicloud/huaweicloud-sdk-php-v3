...
class ReportRuleRequestEndTime implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ReportRuleRequest_end_time';
    ...
    * Sets time
    *
    * @param string|null $time 报告统计周期的结束，具体时间，时分秒格式
    *
    * @return $this
    */
