...
class UpdateSearchConditionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateSearchConditionRequest';
    ...
    */
    protected static $openAPITypes = [
            'workspaceId' => 'string',
            'conditionId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\UpdateSearchConditionRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\UpdateSearchConditionRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\UpdateSearchConditionRequestBody|null $body body
    *
    * @return $this
    */
