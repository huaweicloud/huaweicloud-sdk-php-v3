...
class DeleteDataclassTypeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteDataclassTypeRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'dataclassId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\DeleteDataclassTypeRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\DeleteDataclassTypeRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\DeleteDataclassTypeRequestBody|null $body body
    *
    * @return $this
    */
