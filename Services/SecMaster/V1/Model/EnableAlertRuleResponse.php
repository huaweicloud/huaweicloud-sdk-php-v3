...
class EnableAlertRuleResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'failList' => '\HuaweiCloud\SDK\SecMaster\V1\Model\AlertRule[]',
            'successList' => '\HuaweiCloud\SDK\SecMaster\V1\Model\AlertRule[]',
            'xRequestId' => 'string'
    ];
    ...
    *  失败列表
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\AlertRule[]|null
    */
    ...
    * Sets failList
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\AlertRule[]|null $failList 失败列表
    *
    * @return $this
    */
    ...
    * Sets successList
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\AlertRule[]|null $successList 成功列表
    *
    * @return $this
    */
