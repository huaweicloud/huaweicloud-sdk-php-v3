...
class BatchCreateDataobjectRelationsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateDataobjectRelationsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\BatchCreateDataobjectRelationsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\BatchCreateDataobjectRelationsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\BatchCreateDataobjectRelationsRequestBody|null $body body
    *
    * @return $this
    */
