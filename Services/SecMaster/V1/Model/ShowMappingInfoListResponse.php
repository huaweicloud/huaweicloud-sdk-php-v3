...
class ShowMappingInfoListResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowMappingInfoListResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'offset' => 'int',
            'limit' => 'int',
            'data' => '\HuaweiCloud\SDK\SecMaster\V1\Model\DpeInfo[]'
    ];
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\DpeInfo[]|null $data 分类映射信息集合
    *
    * @return $this
    */
