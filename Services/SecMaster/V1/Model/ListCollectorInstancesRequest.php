...
class ListCollectorInstancesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCollectorInstancesRequest';
    ...
    * Sets channelId
    *
    * @param string|null $channelId 采集通道ID
    *
    * @return $this
    */
    ...
    * Sets nodeName
    *
    * @param string|null $nodeName 节点Name
    *
    * @return $this
    */
