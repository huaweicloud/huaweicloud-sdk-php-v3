...
class UpdateAlertRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'workspaceId' => 'string',
            'ruleId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\UpdateAlertRuleRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\UpdateAlertRuleRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\UpdateAlertRuleRequestBody|null $body body
    *
    * @return $this
    */
