...
class UpdateConnectionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateConnectionResponse';
    ...
    */
    protected static $openAPITypes = [
            'code' => 'string',
            'message' => 'string',
            'asset' => '\HuaweiCloud\SDK\SecMaster\V1\Model\AssetInfoResponseBody'
    ];
    ...
    *  asset
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\AssetInfoResponseBody|null
    */
    ...
    * Sets asset
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\AssetInfoResponseBody|null $asset asset
    *
    * @return $this
    */
