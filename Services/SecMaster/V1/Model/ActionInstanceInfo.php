...
class ActionInstanceInfo implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'action' => '\HuaweiCloud\SDK\SecMaster\V1\Model\ActionInfo',
            'instanceLog' => '\HuaweiCloud\SDK\SecMaster\V1\Model\AuditLogInfo'
    ];
    ...
    *  action
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\ActionInfo|null
    */
    ...
    * Sets action
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\ActionInfo|null $action action
    *
    * @return $this
    */
    ...
    * Sets instanceLog
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\AuditLogInfo|null $instanceLog instanceLog
    *
    * @return $this
    */
