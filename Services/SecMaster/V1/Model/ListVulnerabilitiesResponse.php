...
class ListVulnerabilitiesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'page' => 'int',
            'success' => 'bool',
            'data' => '\HuaweiCloud\SDK\SecMaster\V1\Model\VulnerabilityDetail[]'
    ];
    ...
    *  漏洞列表
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\VulnerabilityDetail[]|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\VulnerabilityDetail[]|null $data 漏洞列表
    *
    * @return $this
    */
