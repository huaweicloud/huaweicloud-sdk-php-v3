...
class FieldResponseBody implements ModelInterface, ArrayAccess
{
    ...
    * defaultValue  默认值
    * displayType  显示类型
    * fieldType  **参数解释：** 字段类型  **约束限制：** 不涉及  **取值范围：** - String: 字符串   Object: 对象   Timestamp: 时间   Integer: 整型   List<String>: 字符串数组   Numeric: 数字   Boolean: 布尔值   List<Object>: 对象数组   Long: 长整型   Enum: 枚举   Double: 双精度浮点数   Float: 浮点数   Password: 密码  **默认取值：** 不涉及
    * extraJson  附加json
    * fieldTooltip  工具提示
    * iuType  输入输出类型
    * usedBy  使用业务
    ...
    * Sets fieldType
    *
    * @param string|null $fieldType **参数解释：** 字段类型  **约束限制：** 不涉及  **取值范围：** - String: 字符串   Object: 对象   Timestamp: 时间   Integer: 整型   List<String>: 字符串数组   Numeric: 数字   Boolean: 布尔值   List<Object>: 对象数组   Long: 长整型   Enum: 枚举   Double: 双精度浮点数   Float: 浮点数   Password: 密码  **默认取值：** 不涉及
    *
    * @return $this
    */
