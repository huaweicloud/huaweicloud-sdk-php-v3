...
class ValidateAopWorkflowVersionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ValidateAopWorkflowVersionRequest';
    ...
    */
    protected static $openAPITypes = [
            'contentType' => 'string',
            'workspaceId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\AopworkflowVersionValidateRes'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\AopworkflowVersionValidateRes|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\AopworkflowVersionValidateRes|null $body body
    *
    * @return $this
    */
