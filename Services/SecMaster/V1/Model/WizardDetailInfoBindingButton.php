...
class WizardDetailInfoBindingButton implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'WizardDetailInfo_binding_button';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['buttonId'] === null) {
            ...
            if ((mb_strlen($this->container['buttonId']) > 64)) {
                $invalidProperties[] = "invalid value for 'buttonId', the character length must be smaller than or equal to 64.";
            }
