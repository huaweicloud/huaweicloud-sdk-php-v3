...
class ListAlertRsp implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'severity' => 'string',
            'criticality' => 'int',
            'alertType' => '\HuaweiCloud\SDK\SecMaster\V1\Model\AlertAlertType',
    ...
    *  alertType
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\AlertAlertType|null
    */
    ...
    * Sets alertType
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\AlertAlertType|null $alertType alertType
    *
    * @return $this
    */
