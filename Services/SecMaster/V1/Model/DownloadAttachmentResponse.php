...
class DownloadAttachmentResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DownloadAttachmentResponse';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['data']) && (mb_strlen($this->container['data']) > 65535)) {
                $invalidProperties[] = "invalid value for 'data', the character length must be smaller than or equal to 65535.";
            }
    ...
    * Sets data
    *
    * @param string|null $data 附件的obs下载地址
    *
    * @return $this
    */
