...
class ExportResourcesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExportResourcesRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'type' => 'string',
            'provider' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\ExportResourcesRequestBody'
    ];
    ...
    * Sets provider
    *
    * @param string|null $provider 资产提供商
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\ExportResourcesRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\ExportResourcesRequestBody|null $body body
    *
    * @return $this
    */
