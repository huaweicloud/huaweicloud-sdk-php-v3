...
class UpdatePipeRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'workspaceId' => 'string',
            'pipeId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\UpdatePipeRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\UpdatePipeRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\UpdatePipeRequestBody|null $body body
    *
    * @return $this
    */
