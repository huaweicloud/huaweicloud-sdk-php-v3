...
class ShowMetricMetaDataResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowMetricMetaDataResponse';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['metricType'] === null) {
            $invalidProperties[] = "'metricType' can't be null";
        }
            if ((mb_strlen($this->container['metricType']) > 64)) {
                $invalidProperties[] = "invalid value for 'metricType', the character length must be smaller than or equal to 64.";
            }
            if ((mb_strlen($this->container['metricType']) < 1)) {
        ...
        if ($this->container['dataType'] === null) {
            ...
            if ((mb_strlen($this->container['dataType']) > 64)) {
        ...
        if ($this->container['cacheTtl'] === null) {
            $invalidProperties[] = "'cacheTtl' can't be null";
        }
            if (($this->container['cacheTtl'] > 86400)) {
                $invalidProperties[] = "invalid value for 'cacheTtl', must be smaller than or equal to 86400.";
            }
            if (($this->container['cacheTtl'] < 0)) {
    ...
    * Sets metricType
    *
    * @param string $metricType 指标类型， 当前仅支持创建日志类型指标
    *
    * @return $this
    */
    ...
    * Sets dataType
    *
    * @param string $dataType 数据类型, 当前仅支持创建统计指标
    *
    * @return $this
    */
