...
class AlertDetail implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'createTime' => 'string',
            'dataObject' => '\HuaweiCloud\SDK\SecMaster\V1\Model\Alert',
    ...
    *  dataObject
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\Alert|null
    */
    ...
    * Sets dataObject
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\Alert|null $dataObject dataObject
    *
    * @return $this
    */
