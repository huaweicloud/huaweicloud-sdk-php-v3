...
class ValidateAopWorkflowVersionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ValidateAopWorkflowVersionResponse';
    ...
    * Sets data
    *
    * @param object|null $data 流程校验响应结果对象
    *
    * @return $this
    */
