...
class ShowPlaybookStatisticsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'code' => 'string',
            'message' => 'string',
            'data' => '\HuaweiCloud\SDK\SecMaster\V1\Model\PlaybookStatisticDetail',
            'xRequestId' => 'string',
    ...
    *  data
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\PlaybookStatisticDetail|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\PlaybookStatisticDetail|null $data data
    *
    * @return $this
    */
