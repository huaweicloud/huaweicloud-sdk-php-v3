...
class ExecuteReportActionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExecuteReportActionRequest';
    ...
    */
    protected static $openAPITypes = [
            'workspaceId' => 'string',
            'reportId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\ExecuteReportActionInfo'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['reportId'] === null) {
            ...
            if (!preg_match("/[a-f0-9]{32}/", $this->container['reportId'])) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\ExecuteReportActionInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\ExecuteReportActionInfo|null $body body
    *
    * @return $this
    */
