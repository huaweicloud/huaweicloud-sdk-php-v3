...
class ChangeAlertRequest implements ModelInterface, ArrayAccess
{
    ...
    * alertId  **参数解释：** 告警id **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'alertId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\ChangeAlertRequestBody'
    ];
    ...
    * Sets alertId
    *
    * @param string $alertId **参数解释：** 告警id **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\ChangeAlertRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\ChangeAlertRequestBody|null $body body
    *
    * @return $this
    */
