...
class UpdateDataobjectRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDataobjectRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'dataObjectId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\DataObjectBatchUpdateForm'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\DataObjectBatchUpdateForm|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\DataObjectBatchUpdateForm|null $body body
    *
    * @return $this
    */
