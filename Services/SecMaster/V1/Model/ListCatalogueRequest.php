...
class ListCatalogueRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCatalogueRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'limit' => 'int',
            'offset' => 'int',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\SearchInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\SearchInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\SearchInfo|null $body body
    *
    * @return $this
    */
