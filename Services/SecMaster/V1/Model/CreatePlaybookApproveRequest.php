...
class CreatePlaybookApproveRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'versionId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\ApprovePlaybookInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\ApprovePlaybookInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\ApprovePlaybookInfo|null $body body
    *
    * @return $this
    */
