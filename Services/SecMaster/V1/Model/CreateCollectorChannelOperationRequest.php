...
class CreateCollectorChannelOperationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCollectorChannelOperationRequest';
    ...
    */
    protected static $openAPITypes = [
            'workspaceId' => 'string',
            'channelId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\OperationDto'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['channelId'] === null) {
            ...
            if ((mb_strlen($this->container['channelId']) > 36)) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\OperationDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\OperationDto|null $body body
    *
    * @return $this
    */
