...
class UpdateAopWorkflowVersionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAopWorkflowVersionRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'versionId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\ModifyAopWorkflowVersionInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\ModifyAopWorkflowVersionInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\ModifyAopWorkflowVersionInfo|null $body body
    *
    * @return $this
    */
