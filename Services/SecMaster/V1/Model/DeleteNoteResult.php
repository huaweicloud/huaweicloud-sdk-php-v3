...
class DeleteNoteResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteNoteResult';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * successIds  成功删除的 note ID 列表
    * errorIds  删除失败的 note ID 列表
    *
    * @var string[]
    */
    ...
    * Sets successIds
    *
    * @param string[]|null $successIds 成功删除的 note ID 列表
    *
    * @return $this
    */
    ...
    * Sets errorIds
    *
    * @param string[]|null $errorIds 删除失败的 note ID 列表
    *
    * @return $this
    */
