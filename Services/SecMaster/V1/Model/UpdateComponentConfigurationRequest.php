...
class UpdateComponentConfigurationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateComponentConfigurationRequest';
    ...
    */
    protected static $openAPITypes = [
            'componentId' => 'string',
            'workspaceId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\ConfigurationInfoDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\ConfigurationInfoDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\ConfigurationInfoDto|null $body body
    *
    * @return $this
    */
