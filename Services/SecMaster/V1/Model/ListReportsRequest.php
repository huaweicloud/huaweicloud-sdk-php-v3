...
class ListReportsRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['reportPeriod'] === null) {
            ...
            if ((mb_strlen($this->container['reportPeriod']) > 64)) {
                $invalidProperties[] = "invalid value for 'reportPeriod', the character length must be smaller than or equal to 64.";
            }
            if ((mb_strlen($this->container['reportPeriod']) < 1)) {
                $invalidProperties[] = "invalid value for 'reportPeriod', the character length must be bigger than or equal to 1.";
            }
    ...
    * Sets reportPeriod
    *
    * @param string $reportPeriod 报告周期
    *
    * @return $this
    */
