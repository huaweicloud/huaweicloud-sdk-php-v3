...
class CreateConfigurationDictionariesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateConfigurationDictionariesRequest';
    ...
    */
    protected static $openAPITypes = [
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\CreateDictionaryRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\CreateDictionaryRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\CreateDictionaryRequest|null $body body
    *
    * @return $this
    */
