...
class UpdateWorkspaceResponseBodyWorkspaceAgencyList implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateWorkspaceResponseBody_workspace_agency_list';
