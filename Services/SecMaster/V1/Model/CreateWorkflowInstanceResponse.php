...
class CreateWorkflowInstanceResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateWorkflowInstanceResponse';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['commandType']) && (mb_strlen($this->container['commandType']) > 64)) {
                $invalidProperties[] = "invalid value for 'commandType', the character length must be smaller than or equal to 64.";
            }
            if (!is_null($this->container['commandType']) && (mb_strlen($this->container['commandType']) < 0)) {
    ...
    * Sets commandType
    *
    * @param string|null $commandType **参数解释**: 操作流程实例的指令 - ActionInstanceRunCommand 运行流程实例  **约束限制**: 不涉及         **取值范围**: - ActionInstanceRunCommand  **默认值**:  不涉及
    *
    * @return $this
    */
    ...
    * Sets actionType
    *
    * @param string|null $actionType **参数解释**: action的类型 - workflow 流程  **约束限制**: 不涉及         **取值范围**: - workflow  **默认值**:  不涉及
    *
    * @return $this
    */
