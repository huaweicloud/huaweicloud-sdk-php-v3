...
class ExportParserDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExportParserDto';
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['parserIds'] === null) {
            $invalidProperties[] = "'parserIds' can't be null";
        }
