...
class HwcEipBandwidth implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'HwcEipBandwidth';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  带宽ID
    * size  带宽大小 取值范围：默认5Mbit/s~2000Mbit/s
    * shareType  带宽类型，标识是否是共享带宽 取值范围： PER：独享带宽 WHOLE：共享带宽 约束：其中IPv6暂不支持WHOLE类型带宽。
    * name  带宽名称
    *
    * @var string[]
    */
    ...
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['size']) && ($this->container['size'] >= 2000)) {
                $invalidProperties[] = "invalid value for 'size', must be smaller than 2000.";
            }
            if (!is_null($this->container['size']) && ($this->container['size'] <= 5)) {
                $invalidProperties[] = "invalid value for 'size', must be bigger than 5.";
            }
    ...
    * Sets size
    *
    * @param int|null $size 带宽大小 取值范围：默认5Mbit/s~2000Mbit/s
    *
    * @return $this
    */
    ...
    * Sets shareType
    *
    * @param string|null $shareType 带宽类型，标识是否是共享带宽 取值范围： PER：独享带宽 WHOLE：共享带宽 约束：其中IPv6暂不支持WHOLE类型带宽。
    *
    * @return $this
    */
