...
class ExportVulnerabilitiesRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExportVulnerabilitiesRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'dataObjectFiltersForm' => '\HuaweiCloud\SDK\SecMaster\V1\Model\VulnerabilityDataObjectSearch',
            'title' => 'string[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\VulnerabilityDataObjectSearch|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\VulnerabilityDataObjectSearch|null $dataObjectFiltersForm dataObjectFiltersForm
    *
    * @return $this
    */
