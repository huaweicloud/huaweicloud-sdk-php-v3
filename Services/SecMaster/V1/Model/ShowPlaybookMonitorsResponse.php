...
class ShowPlaybookMonitorsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'code' => 'string',
            'message' => 'string',
            'data' => '\HuaweiCloud\SDK\SecMaster\V1\Model\PlaybookInstanceMonitorDetail',
            'xRequestId' => 'string',
    ...
    *  data
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\PlaybookInstanceMonitorDetail|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\PlaybookInstanceMonitorDetail|null $data data
    *
    * @return $this
    */
