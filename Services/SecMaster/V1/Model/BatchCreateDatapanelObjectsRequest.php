...
class BatchCreateDatapanelObjectsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateDatapanelObjectsRequest';
    ...
    * dataclass  数据类ID, 您可通过调用[查询数据类列表](ListDataclass.xml)接口获取数据类ID
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'dataclass' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\DataObjectBatchCreateForm'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['dataclass'] === null) {
            $invalidProperties[] = "'dataclass' can't be null";
        }
            if ((mb_strlen($this->container['dataclass']) > 64)) {
                $invalidProperties[] = "invalid value for 'dataclass', the character length must be smaller than or equal to 64.";
            }
            if ((mb_strlen($this->container['dataclass']) < 1)) {
                $invalidProperties[] = "invalid value for 'dataclass', the character length must be bigger than or equal to 1.";
            }
    ...
    * Sets dataclass
    *
    * @param string $dataclass 数据类ID, 您可通过调用[查询数据类列表](ListDataclass.xml)接口获取数据类ID
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\DataObjectBatchCreateForm|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\DataObjectBatchCreateForm|null $body body
    *
    * @return $this
    */
