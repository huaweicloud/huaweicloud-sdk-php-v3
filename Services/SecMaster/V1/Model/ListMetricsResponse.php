...
class ListMetricsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'code' => 'string',
            'data' => '\HuaweiCloud\SDK\SecMaster\V1\Model\MetricMetaData[]',
            'message' => 'string',
            'offset' => 'int',
            'requestId' => 'string',
            'limit' => 'int',
    ...
    *  数据列表
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\MetricMetaData[]|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\MetricMetaData[]|null $data 数据列表
    *
    * @return $this
    */
