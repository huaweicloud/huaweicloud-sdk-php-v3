...
class DeleteResourceResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'code' => 'string',
            'message' => 'string',
            'data' => '\HuaweiCloud\SDK\SecMaster\V1\Model\BatchOperateResourceResult'
    ];
    ...
    *  data
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\BatchOperateResourceResult|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\BatchOperateResourceResult|null $data data
    *
    * @return $this
    */
