...
class ListCollectorParserTemplateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCollectorParserTemplateRequest';
    ...
    * Sets description
    *
    * @param string|null $description 解析器相关描述
    *
    * @return $this
    */
