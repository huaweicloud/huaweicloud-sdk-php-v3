...
class ShowAopWorkflowInstanceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAopWorkflowInstanceRequest';
    ...
    * instanceId  **参数解释**: 流程实例的ID **约束限制**: 不涉及
    * showTopology  **参数解释**: 是否查询流程拓扑图的信息 - true 查询 - false 不查询  **约束限制**: 不涉及               **取值范围**: - true - false  **默认值**:  false
    *
    * @var string[]
    */
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['showTopology'] = isset($data['showTopology']) ? $data['showTopology'] : null;
    }
    ...
    * Sets instanceId
    *
    * @param string $instanceId **参数解释**: 流程实例的ID **约束限制**: 不涉及
    *
    * @return $this
    */
    ...
    * @return bool|null
    */
    public function getShowTopology()
    {
        return $this->container['showTopology'];
    }

    /**
    * Sets showTopology
    *
    * @param bool|null $showTopology **参数解释**: 是否查询流程拓扑图的信息 - true 查询 - false 不查询  **约束限制**: 不涉及               **取值范围**: - true - false  **默认值**:  false
    *
    * @return $this
    */
    public function setShowTopology($showTopology)
    {
        $this->container['showTopology'] = $showTopology;
        return $this;
    }
