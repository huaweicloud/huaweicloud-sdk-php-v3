...
class ImportIndicatorsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImportIndicatorsRequestBody';
    ...
    * Sets uploadFile
    *
    * @param \SplFileObject $uploadFile 要上传的文件
    *
    * @return $this
    */
