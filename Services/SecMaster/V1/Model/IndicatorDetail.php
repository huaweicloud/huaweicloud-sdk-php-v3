...
class IndicatorDetail implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'id' => 'string',
            'name' => 'string',
            'dataObject' => '\HuaweiCloud\SDK\SecMaster\V1\Model\IndicatorDataObjectDetail',
            'workspaceId' => 'string',
            'projectId' => 'string',
            'dataclassRef' => '\HuaweiCloud\SDK\SecMaster\V1\Model\DataClassRefPojo',
            'createTime' => 'string',
            'updateTime' => 'string'
    ];
    ...
    *  dataObject
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\IndicatorDataObjectDetail|null
    */
    ...
    * Sets dataObject
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\IndicatorDataObjectDetail|null $dataObject dataObject
    *
    * @return $this
    */
    ...
    * Sets dataclassRef
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\DataClassRefPojo|null $dataclassRef dataclassRef
    *
    * @return $this
    */
