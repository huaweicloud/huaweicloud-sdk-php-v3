...
class ShowCollectorConnectionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowCollectorConnectionResponse';
    ...
    */
    protected static $openAPITypes = [
            'connectionId' => 'string',
            'description' => 'string',
            'fields' => '\HuaweiCloud\SDK\SecMaster\V1\Model\ConnectionModuleFieldShowVo[]',
            'moduleId' => 'string',
            'name' => 'string',
            'templateId' => 'string',
            'title' => 'string'
    ...
    *  相关描述信息
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\ConnectionModuleFieldShowVo[]|null
    */
    ...
    * Sets fields
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\ConnectionModuleFieldShowVo[]|null $fields 相关描述信息
    *
    * @return $this
    */
