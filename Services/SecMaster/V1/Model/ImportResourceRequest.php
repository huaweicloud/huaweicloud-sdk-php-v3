...
class ImportResourceRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'type' => 'string',
            'provider' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\ImportResourceRequestBody'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['provider'] === null) {
            ...
            if ((mb_strlen($this->container['provider']) > 255)) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\ImportResourceRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\ImportResourceRequestBody|null $body body
    *
    * @return $this
    */
