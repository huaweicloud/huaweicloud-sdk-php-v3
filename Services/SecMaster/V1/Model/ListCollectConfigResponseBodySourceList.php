...
class ListCollectConfigResponseBodySourceList implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCollectConfigResponseBody_source_list';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['sourceDisplay']) && (mb_strlen($this->container['sourceDisplay']) > 1024)) {
                $invalidProperties[] = "invalid value for 'sourceDisplay', the character length must be smaller than or equal to 1024.";
            }
            ...
            if (!is_null($this->container['sourceHelp']) && (mb_strlen($this->container['sourceHelp']) > 1024)) {
                $invalidProperties[] = "invalid value for 'sourceHelp', the character length must be smaller than or equal to 1024.";
            }
