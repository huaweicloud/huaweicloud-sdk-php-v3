...
class CreatePlaybookVersionRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'playbookId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\CreatePlaybookVersionInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\CreatePlaybookVersionInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\CreatePlaybookVersionInfo|null $body body
    *
    * @return $this
    */
