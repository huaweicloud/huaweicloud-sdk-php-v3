...
class UpdateClassifierRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateClassifierRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'classifierId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\CreateDpeClassifyRequestBody'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['classifierId'] === null) {
            $invalidProperties[] = "'classifierId' can't be null";
        }
            if ((mb_strlen($this->container['classifierId']) > 36)) {
                $invalidProperties[] = "invalid value for 'classifierId', the character length must be smaller than or equal to 36.";
            }
            if ((mb_strlen($this->container['classifierId']) < 32)) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\CreateDpeClassifyRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\CreateDpeClassifyRequestBody|null $body body
    *
    * @return $this
    */
