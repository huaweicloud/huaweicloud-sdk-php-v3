...
class ShipperDestination implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShipperDestination';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * dataParam  数据参数，通常为JSON格式
    * dataType  数据类型，具体含义根据业务定义
    * dataspace  数据空间ID
    * dataspaceName  数据空间名称
    * destinationInfo  目的详细信息
    * id  唯一标识ID
    * identity  身份标识
    * pipe  管道ID
    * pipeName  管道名称
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['destinationInfo'] = isset($data['destinationInfo']) ? $data['destinationInfo'] : null;
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['dataParam'] === null) {
            $invalidProperties[] = "'dataParam' can't be null";
        }
        if ($this->container['dataType'] === null) {
            $invalidProperties[] = "'dataType' can't be null";
        }
        if ($this->container['dataspace'] === null) {
            $invalidProperties[] = "'dataspace' can't be null";
        }
            if ((mb_strlen($this->container['dataspace']) > 36)) {
        ...
        if ($this->container['destinationInfo'] === null) {
            $invalidProperties[] = "'destinationInfo' can't be null";
        }
        ...
        if ($this->container['pipe'] === null) {
            ...
            if ((mb_strlen($this->container['pipe']) > 36)) {
        ...
        if ($this->container['workspace'] === null) {
            ...
            if ((mb_strlen($this->container['workspace']) > 36)) {
        ...
        if ($this->container['workspaceName'] === null) {
            $invalidProperties[] = "'workspaceName' can't be null";
        }
            if ((mb_strlen($this->container['workspaceName']) > 128)) {
                $invalidProperties[] = "invalid value for 'workspaceName', the character length must be smaller than or equal to 128.";
            }
            if ((mb_strlen($this->container['workspaceName']) < 1)) {
    ...
    * Sets dataParam
    *
    * @param string $dataParam 数据参数，通常为JSON格式
    *
    * @return $this
    */
    ...
    * Sets dataType
    *
    * @param int $dataType 数据类型，具体含义根据业务定义
    *
    * @return $this
    */
    ...
    */
    ...
    {
        return $this->container['destinationInfo'];
    }

    /**
    * Sets destinationInfo
    *
    * @param string $destinationInfo 目的详细信息
    *
    * @return $this
    */
    public function setDestinationInfo($destinationInfo)
    {
        $this->container['destinationInfo'] = $destinationInfo;
        return $this;
    }
