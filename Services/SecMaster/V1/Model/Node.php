...
class Node implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'createBy' => 'string',
            'createTime' => 'int',
            'description' => '\HuaweiCloud\SDK\SecMaster\V1\Model\IsapErrorRsp',
            'deviceType' => 'string',
            'ipAddress' => 'string',
    ...
    */
    protected static $attributeMap = [
            ...
            'vpcId' => 'vpc_id',
            'vpcepServiceIp' => 'vpcep_service_ip'
    ];
    ...
    */
    protected static $setters = [
            ...
            'vpcId' => 'setVpcId',
            'vpcepServiceIp' => 'setVpcepServiceIp'
    ];
    ...
    */
    protected static $getters = [
            ...
            'vpcId' => 'getVpcId',
            'vpcepServiceIp' => 'getVpcepServiceIp'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['vpcepServiceIp'] = isset($data['vpcepServiceIp']) ? $data['vpcepServiceIp'] : null;
    }
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['vpcepServiceIp']) && (mb_strlen($this->container['vpcepServiceIp']) > 15)) {
                $invalidProperties[] = "invalid value for 'vpcepServiceIp', the character length must be smaller than or equal to 15.";
            }
            if (!is_null($this->container['vpcepServiceIp']) && (mb_strlen($this->container['vpcepServiceIp']) < 7)) {
                $invalidProperties[] = "invalid value for 'vpcepServiceIp', the character length must be bigger than or equal to 7.";
            }
            if (!is_null($this->container['vpcepServiceIp']) && !preg_match("/((25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)/", $this->container['vpcepServiceIp'])) {
                $invalidProperties[] = "invalid value for 'vpcepServiceIp', must be conform to the pattern /((25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)/.";
            }
    ...
    *  description
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\IsapErrorRsp|null
    */
    ...
    * Sets description
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\IsapErrorRsp|null $description description
    *
    * @return $this
    */
    ...
    * @return string|null
    */
    public function getVpcepServiceIp()
    {
        return $this->container['vpcepServiceIp'];
    }

    /**
    * Sets vpcepServiceIp
    *
    * @param string|null $vpcepServiceIp IP地址
    *
    * @return $this
    */
    public function setVpcepServiceIp($vpcepServiceIp)
    {
        $this->container['vpcepServiceIp'] = $vpcepServiceIp;
        return $this;
    }
