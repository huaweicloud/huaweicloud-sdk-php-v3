...
class UpdateNodeRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'workspaceId' => 'string',
            'nodeId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\NodeExpansionInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\NodeExpansionInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\NodeExpansionInfo|null $body body
    *
    * @return $this
    */
