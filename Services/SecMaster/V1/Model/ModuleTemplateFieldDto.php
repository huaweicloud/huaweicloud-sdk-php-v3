...
class ModuleTemplateFieldDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ModuleTemplateFieldDto';
    ...
    * Sets templateIds
    *
    * @param string[] $templateIds 相关描述信息
    *
    * @return $this
    */
