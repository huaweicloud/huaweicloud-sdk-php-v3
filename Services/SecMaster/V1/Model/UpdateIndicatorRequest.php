...
class UpdateIndicatorRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'indicatorId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\UpdateIndicatorRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\UpdateIndicatorRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\UpdateIndicatorRequestBody|null $body body
    *
    * @return $this
    */
