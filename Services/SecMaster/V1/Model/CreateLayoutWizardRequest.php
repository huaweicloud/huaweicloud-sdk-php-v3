...
class CreateLayoutWizardRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateLayoutWizardRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'layoutId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\WizardCreateRequestPojo'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['layoutId'] === null) {
            ...
            if ((mb_strlen($this->container['layoutId']) > 36)) {
                $invalidProperties[] = "invalid value for 'layoutId', the character length must be smaller than or equal to 36.";
            }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\WizardCreateRequestPojo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\WizardCreateRequestPojo|null $body body
    *
    * @return $this
    */
