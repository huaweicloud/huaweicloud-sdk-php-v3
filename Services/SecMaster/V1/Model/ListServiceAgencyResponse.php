...
class ListServiceAgencyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListServiceAgencyResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * createAgency  当前账号是否已创建云服务关联委托
    ...
    */
    ...
    {
        $this->container['createAgency'] = isset($data['createAgency']) ? $data['createAgency'] : null;
    ...
    * @return bool|null
    */
    public function getCreateAgency()
    {
        return $this->container['createAgency'];
    }

    /**
    * Sets createAgency
    *
    * @param bool|null $createAgency 当前账号是否已创建云服务关联委托
    *
    * @return $this
    */
    public function setCreateAgency($createAgency)
    {
        $this->container['createAgency'] = $createAgency;
        return $this;
    }
