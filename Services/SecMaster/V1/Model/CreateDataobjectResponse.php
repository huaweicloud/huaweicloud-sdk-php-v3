...
class CreateDataobjectResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateDataobjectResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'message' => 'string',
            'success' => 'bool',
            'data' => '\HuaweiCloud\SDK\SecMaster\V1\Model\DataObjectCreateUpdateResponse'
    ];
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\DataObjectCreateUpdateResponse|null $data data
    *
    * @return $this
    */
