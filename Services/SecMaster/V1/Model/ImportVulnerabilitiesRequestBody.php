...
class ImportVulnerabilitiesRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImportVulnerabilitiesRequestBody';
    ...
    * Sets uploadFile
    *
    * @param \SplFileObject $uploadFile 导入漏洞文件
    *
    * @return $this
    */
