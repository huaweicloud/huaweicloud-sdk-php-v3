...
class CreatePreProcessRulesResponseBodyData implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePreProcessRulesResponseBody_data';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'mappingId' => 'string',
            'preprocessRules' => '\HuaweiCloud\SDK\SecMaster\V1\Model\CreatePreProcessRulesResponseBodyDataPreprocessRules[]'
    ];
    ...
    *  预处理规则列表
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\CreatePreProcessRulesResponseBodyDataPreprocessRules[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\CreatePreProcessRulesResponseBodyDataPreprocessRules[]|null $preprocessRules 预处理规则列表
    *
    * @return $this
    */
