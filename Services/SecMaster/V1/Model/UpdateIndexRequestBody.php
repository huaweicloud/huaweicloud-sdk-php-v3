...
class UpdateIndexRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateIndexRequestBody';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['timestampField'] === null) {
            $invalidProperties[] = "'timestampField' can't be null";
        }
            if ((mb_strlen($this->container['timestampField']) > 256)) {
                $invalidProperties[] = "invalid value for 'timestampField', the character length must be smaller than or equal to 256.";
            }
            if ((mb_strlen($this->container['timestampField']) < 1)) {
    ...
    *  索引映射信息
    *
    * @return map[string,\HuaweiCloud\SDK\SecMaster\V1\Model\KeyIndex]
    */
    ...
    * Sets mapping
    *
    * @param map[string,\HuaweiCloud\SDK\SecMaster\V1\Model\KeyIndex] $mapping 索引映射信息
    *
    * @return $this
    */
    ...
    * Sets status
    *
    * @param string $status 索引状态；open 开启，closed 关闭
    *
    * @return $this
    */
    ...
    * Sets timestampField
    *
    * @param string $timestampField 时间戳字段名称
    *
    * @return $this
    */
