...
class UpdateCatalogueRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateCatalogueRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'catalogueId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\CatalogueUpdateRequestPojo'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['catalogueId'] = isset($data['catalogueId']) ? $data['catalogueId'] : null;
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['catalogueId'] === null) {
            $invalidProperties[] = "'catalogueId' can't be null";
        }
            if ((mb_strlen($this->container['catalogueId']) > 64)) {
                $invalidProperties[] = "invalid value for 'catalogueId', the character length must be smaller than or equal to 64.";
            }
            if ((mb_strlen($this->container['catalogueId']) < 1)) {
                $invalidProperties[] = "invalid value for 'catalogueId', the character length must be bigger than or equal to 1.";
            }
    ...
    */
    ...
    {
        return $this->container['catalogueId'];
    }
    ...
    */
    ...
    {
        $this->container['catalogueId'] = $catalogueId;
        return $this;
    }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\CatalogueUpdateRequestPojo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\CatalogueUpdateRequestPojo|null $body body
    *
    * @return $this
    */
