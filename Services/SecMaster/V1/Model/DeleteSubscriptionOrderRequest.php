...
class DeleteSubscriptionOrderRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteSubscriptionOrderRequest';
    ...
    */
    protected static $openAPITypes = [
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\UnsubscribeParam'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\UnsubscribeParam|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\UnsubscribeParam|null $body body
    *
    * @return $this
    */
