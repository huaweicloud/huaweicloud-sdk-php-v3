...
class UpdateMetricsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateMetricsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'metricId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\CreateMetricRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\CreateMetricRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\CreateMetricRequestBody|null $body body
    *
    * @return $this
    */
