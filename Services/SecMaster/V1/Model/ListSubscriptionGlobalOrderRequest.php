...
class ListSubscriptionGlobalOrderRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSubscriptionGlobalOrderRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * xLanguage  用户当前语言环境， zh-cn简体中文，en-us英文环境
    *
    * @var string[]
    */
