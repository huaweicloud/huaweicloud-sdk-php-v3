...
class ShowClassifierInfoResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowClassifierInfoResponse';
    ...
    */
    protected static $openAPITypes = [
            'code' => 'string',
            'message' => 'string',
            'data' => '\HuaweiCloud\SDK\SecMaster\V1\Model\DpeClassifyDetail'
    ];
    ...
    *  data
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\DpeClassifyDetail|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\DpeClassifyDetail|null $data data
    *
    * @return $this
    */
