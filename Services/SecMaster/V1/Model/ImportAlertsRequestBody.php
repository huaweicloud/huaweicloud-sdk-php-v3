...
class ImportAlertsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImportAlertsRequestBody';
    ...
    * Sets uploadFile
    *
    * @param \SplFileObject $uploadFile 导入告警文件
    *
    * @return $this
    */
