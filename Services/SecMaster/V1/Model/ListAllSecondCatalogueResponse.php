...
class ListAllSecondCatalogueResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAllSecondCatalogueResponse';
    ...
    */
    protected static $openAPITypes = [
            'code' => 'string',
            'data' => '\HuaweiCloud\SDK\SecMaster\V1\Model\CatalogueDetailInfo[]',
            'message' => 'string',
            'requestId' => 'string',
            'success' => 'bool',
            'total' => 'int',
    ...
    *  数据列表
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\CatalogueDetailInfo[]|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\CatalogueDetailInfo[]|null $data 数据列表
    *
    * @return $this
    */
