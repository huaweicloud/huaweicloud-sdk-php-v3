...
class ShowLayoutWizardByFieldRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowLayoutWizardByFieldRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['fieldId'] === null) {
            ...
            if ((mb_strlen($this->container['fieldId']) < 0)) {
                $invalidProperties[] = "invalid value for 'fieldId', the character length must be bigger than or equal to 0.";
            }
