...
class ListDatapanelObjectsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDatapanelObjectsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'dataclass' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\DataobjectSearch'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\DataobjectSearch|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\DataobjectSearch|null $body body
    *
    * @return $this
    */
