...
class UpdateMappingInfoStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateMappingInfoStatusRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'mappingId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\UpdateDpeInfoStatusRequestBody'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['mappingId'] === null) {
            ...
            if ((mb_strlen($this->container['mappingId']) > 36)) {
                $invalidProperties[] = "invalid value for 'mappingId', the character length must be smaller than or equal to 36.";
            }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\UpdateDpeInfoStatusRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\UpdateDpeInfoStatusRequestBody|null $body body
    *
    * @return $this
    */
