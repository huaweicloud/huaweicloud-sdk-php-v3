...
class ChangePlaybookInstanceRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\OperationPlaybookInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\OperationPlaybookInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\OperationPlaybookInfo|null $body body
    *
    * @return $this
    */
