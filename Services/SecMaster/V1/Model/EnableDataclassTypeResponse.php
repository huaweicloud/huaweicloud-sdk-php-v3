...
class EnableDataclassTypeResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'EnableDataclassTypeResponse';
    ...
    * Sets message
    *
    * @param string|null $message 成功信息
    *
    * @return $this
    */
