...
class Organization implements ModelInterface, ArrayAccess
{
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['accountId'] === null) {
            ...
            if ((mb_strlen($this->container['accountId']) < 32)) {
                $invalidProperties[] = "invalid value for 'accountId', the character length must be bigger than or equal to 32.";
            }
        if ($this->container['organizationId'] === null) {
            ...
            if ((mb_strlen($this->container['organizationId']) < 12)) {
                $invalidProperties[] = "invalid value for 'organizationId', the character length must be bigger than or equal to 12.";
            }
    ...
    * Sets organizationId
    *
    * @param string $organizationId 角色id
    *
    * @return $this
    */
