...
class DeleteLayoutWizardRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteLayoutWizardRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['wizardId'] === null) {
            $invalidProperties[] = "'wizardId' can't be null";
        }
            if ((mb_strlen($this->container['wizardId']) > 64)) {
                $invalidProperties[] = "invalid value for 'wizardId', the character length must be smaller than or equal to 64.";
            }
            if ((mb_strlen($this->container['wizardId']) < 0)) {
