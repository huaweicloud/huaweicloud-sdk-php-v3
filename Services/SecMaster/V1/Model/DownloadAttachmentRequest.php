...
class DownloadAttachmentRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['attachId'] = isset($data['attachId']) ? $data['attachId'] : null;
    }
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['attachId'] === null) {
            $invalidProperties[] = "'attachId' can't be null";
        }
            if ((mb_strlen($this->container['attachId']) > 64)) {
                $invalidProperties[] = "invalid value for 'attachId', the character length must be smaller than or equal to 64.";
            }
            if ((mb_strlen($this->container['attachId']) < 0)) {
                $invalidProperties[] = "invalid value for 'attachId', the character length must be bigger than or equal to 0.";
            }
    ...
    */
    ...
    {
        return $this->container['attachId'];
    }
    ...
    */
    ...
    {
        $this->container['attachId'] = $attachId;
        return $this;
    }
