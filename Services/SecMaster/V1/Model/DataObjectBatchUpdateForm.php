...
class DataObjectBatchUpdateForm implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DataObjectBatchUpdateForm';
    ...
    * Sets batchIds
    *
    * @param string[]|null $batchIds 批量更新ID列表
    *
    * @return $this
    */
