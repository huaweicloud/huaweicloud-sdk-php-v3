...
class CreateCatalogueResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCatalogueResponse';
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\CatalogueDetailInfo|null $data data
    *
    * @return $this
    */
