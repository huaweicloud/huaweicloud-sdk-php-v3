...
class UpdateLayoutWizardsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateLayoutWizardsResponse';
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\WizardDetailInfo[]|null $data 数据列表
    *
    * @return $this
    */
