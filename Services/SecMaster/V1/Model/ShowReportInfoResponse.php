...
class ShowReportInfoResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowReportInfoResponse';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['reportName']) && (mb_strlen($this->container['reportName']) > 256)) {
            ...
            if (!is_null($this->container['layoutId']) && !preg_match("/[a-f0-9]{32}/", $this->container['layoutId'])) {
    ...
    *  reportRange
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\CreateReportRequestBodyReportRange|null
    */
    ...
    * Sets reportRange
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\CreateReportRequestBodyReportRange|null $reportRange reportRange
    *
    * @return $this
    */
    ...
    * Sets isGenerated
    *
    * @param bool|null $isGenerated 报告是否已生成
    *
    * @return $this
    */
