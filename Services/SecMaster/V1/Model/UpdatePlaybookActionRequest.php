...
class UpdatePlaybookActionRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'versionId' => 'string',
            'actionId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\ModifyActionInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\ModifyActionInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\ModifyActionInfo|null $body body
    *
    * @return $this
    */
