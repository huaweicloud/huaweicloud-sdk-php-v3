...
class AlertRuleTemplate implements ModelInterface, ArrayAccess
{
    ...
    * Sets severity
    *
    * @param string $severity **参数解释**: 告警等级 - TIPS 提示 - LOW 低危 - MEDIUM 中危 - HIGH 高危 - FATAL 致命  **约束限制** 不涉及 **取值范围**: - TIPS - LOW - MEDIUM - HIGH - FATAL  **默认值** 不涉及
    *
    * @return $this
    */
    ...
    * Sets templateId
    *
    * @param string $templateId 告警规则模板 ID
    *
    * @return $this
    */
    ...
    * Sets templateName
    *
    * @param string $templateName 告警规则模板名称
    *
    * @return $this
    */
