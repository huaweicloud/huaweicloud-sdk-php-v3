...
class ListAllSecondCatalogueRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAllSecondCatalogueRequest';
    ...
    */
    protected static $setters = [
            ...
            'catalogueCode' => 'setCatalogueCode'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['catalogueCode'] = isset($data['catalogueCode']) ? $data['catalogueCode'] : null;
    }
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['workspaceId'] === null) {
            ...
            if (!is_null($this->container['catalogueType']) && (mb_strlen($this->container['catalogueType']) < 1)) {
                $invalidProperties[] = "invalid value for 'catalogueType', the character length must be bigger than or equal to 1.";
            }
            if (!is_null($this->container['catalogueCode']) && (mb_strlen($this->container['catalogueCode']) > 64)) {
                $invalidProperties[] = "invalid value for 'catalogueCode', the character length must be smaller than or equal to 64.";
            }
            if (!is_null($this->container['catalogueCode']) && (mb_strlen($this->container['catalogueCode']) < 1)) {
                $invalidProperties[] = "invalid value for 'catalogueCode', the character length must be bigger than or equal to 1.";
            }
    ...
    * Sets catalogueType
    *
    * @param string|null $catalogueType 目录类型（内置或自定义）
    *
    * @return $this
    */
    ...
    * @return string|null
    */
    public function getCatalogueCode()
    {
        return $this->container['catalogueCode'];
    }

    /**
    * Sets catalogueCode
    *
    * @param string|null $catalogueCode 目录编码
    *
    * @return $this
    */
    public function setCatalogueCode($catalogueCode)
    {
        $this->container['catalogueCode'] = $catalogueCode;
        return $this;
    }
