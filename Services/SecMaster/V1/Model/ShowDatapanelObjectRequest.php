...
class ShowDatapanelObjectRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDatapanelObjectRequest';
    ...
    * Sets dataobjectId
    *
    * @param string $dataobjectId 数据对象ID
    *
    * @return $this
    */
