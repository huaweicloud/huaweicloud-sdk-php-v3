...
class CreateConnectionDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateConnectionDto';
    ...
    */
    protected static $openAPITypes = [
            'description' => 'string',
            'fields' => '\HuaweiCloud\SDK\SecMaster\V1\Model\ConnectionModuleFieldCreateVo[]',
            'name' => 'string',
            'templateId' => 'string',
            'title' => 'string'
    ];
    ...
    *  相关描述信息
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\ConnectionModuleFieldCreateVo[]
    */
    ...
    * Sets fields
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\ConnectionModuleFieldCreateVo[] $fields 相关描述信息
    *
    * @return $this
    */
