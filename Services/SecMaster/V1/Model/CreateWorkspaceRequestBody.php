...
class CreateWorkspaceRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'description' => 'string',
            'projectName' => 'string',
            'tags' => '\HuaweiCloud\SDK\SecMaster\V1\Model\TagsPojo[]'
    ];
    ...
    *  标签数组
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\TagsPojo[]|null
    */
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\TagsPojo[]|null $tags 标签数组
    *
    * @return $this
    */
