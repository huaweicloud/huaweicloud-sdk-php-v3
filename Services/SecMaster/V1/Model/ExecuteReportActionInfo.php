...
class ExecuteReportActionInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExecuteReportActionInfo';
    ...
    * emailContent  邮件内容
    * reportFileType  附件类型
    * action  API的动作支持send和download
    * reportPage  安全报告Base64编码的内容
    ...
    */
    protected static $openAPITypes = [
            ...
            'action' => 'string',
            'reportPage' => 'string',
            'pageConfig' => '\HuaweiCloud\SDK\SecMaster\V1\Model\PageConfigPx'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['reportPage'] = isset($data['reportPage']) ? $data['reportPage'] : null;
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['action'] === null) {
            ...
            if (!is_null($this->container['reportPage']) && (mb_strlen($this->container['reportPage']) > 65536)) {
                $invalidProperties[] = "invalid value for 'reportPage', the character length must be smaller than or equal to 65536.";
            }
            if (!is_null($this->container['reportPage']) && (mb_strlen($this->container['reportPage']) < 1)) {
                $invalidProperties[] = "invalid value for 'reportPage', the character length must be bigger than or equal to 1.";
            }
    ...
    * Sets action
    *
    * @param string $action API的动作支持send和download
    *
    * @return $this
    */
    ...
    */
    ...
    {
        return $this->container['reportPage'];
    }

    /**
    * Sets reportPage
    *
    * @param string|null $reportPage 安全报告Base64编码的内容
    *
    * @return $this
    */
    public function setReportPage($reportPage)
    {
        $this->container['reportPage'] = $reportPage;
        return $this;
    }
    ...
    *  pageConfig
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\PageConfigPx|null
    */
    ...
    * Sets pageConfig
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\PageConfigPx|null $pageConfig pageConfig
    *
    * @return $this
    */
