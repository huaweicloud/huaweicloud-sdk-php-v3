...
class CreatePipeRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['storagePeriod'] === null) {
            ...
            if (($this->container['storagePeriod'] > 180)) {
                $invalidProperties[] = "invalid value for 'storagePeriod', must be smaller than or equal to 180.";
            }
            if (($this->container['storagePeriod'] < 7)) {
                $invalidProperties[] = "invalid value for 'storagePeriod', must be bigger than or equal to 7.";
            }
    ...
    * Sets mapping
    *
    * @param map[string,\HuaweiCloud\SDK\SecMaster\V1\Model\KeyIndex]|null $mapping 索引字段映射；每个key对象承载一个字段的信息；存在多个key对象，key可变，表示字段名称；可嵌套
    *
    * @return $this
    */
    ...
    * Sets storagePeriod
    *
    * @param int $storagePeriod 数据的保存时间，单位为天；默认30天，取值范围为7~180. 配置180天需提工单申请
    *
    * @return $this
    */
