...
class CopyPlaybookVersionRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'versionId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\CopyPlaybookInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\CopyPlaybookInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\CopyPlaybookInfo|null $body body
    *
    * @return $this
    */
