...
class UpdateComponentConfigurationResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateComponentConfigurationResponse';
    ...
    * Sets message
    *
    * @param string|null $message 结果详情
    *
    * @return $this
    */
