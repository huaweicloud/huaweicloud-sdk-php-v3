...
class ShowMapperListRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowMapperListRequest';
    ...
    */
    protected static $openAPITypes = [
            'contentType' => 'string',
            'workspaceId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\QueryDpeMapperRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\QueryDpeMapperRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\QueryDpeMapperRequestBody|null $body body
    *
    * @return $this
    */
