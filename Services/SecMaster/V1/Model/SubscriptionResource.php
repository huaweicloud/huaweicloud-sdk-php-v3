...
class SubscriptionResource implements ModelInterface, ArrayAccess
{
    ...
    * tagList  资源列表
    * usages  资源使用量，当usage=true时返回该字段
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'orderId' => 'string',
            'chargingMode' => 'string',
            'tagList' => '\HuaweiCloud\SDK\SecMaster\V1\Model\SubscriptionTagInfo[]',
            'usages' => '\HuaweiCloud\SDK\SecMaster\V1\Model\ResourceUsage[]'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['cloudService']) && (mb_strlen($this->container['cloudService']) > 64)) {
                $invalidProperties[] = "invalid value for 'cloudService', the character length must be smaller than or equal to 64.";
            }
            if (!is_null($this->container['cloudService']) && (mb_strlen($this->container['cloudService']) < 2)) {
                $invalidProperties[] = "invalid value for 'cloudService', the character length must be bigger than or equal to 2.";
            }
    ...
    *
    * @param string|null $resourceTypeName 资源名称
    *
    * @return $this
    */
    ...
    * Sets cloudService
    *
    * @param string|null $cloudService 订单来源，默认数据为SecMaster
    *
    * @return $this
    */
    ...
    *  资源列表
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\SubscriptionTagInfo[]|null
    */
    ...
    * Sets tagList
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\SubscriptionTagInfo[]|null $tagList 资源列表
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\ResourceUsage[]|null
    */
    ...
    * Sets usages
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\ResourceUsage[]|null $usages 资源使用量，当usage=true时返回该字段
    *
    * @return $this
    */
