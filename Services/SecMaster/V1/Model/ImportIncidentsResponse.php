...
class ImportIncidentsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImportIncidentsResponse';
    ...
    */
    protected static $openAPITypes = [
            'code' => 'string',
            'message' => 'string',
            'data' => '\HuaweiCloud\SDK\SecMaster\V1\Model\ImportIncidentsResponseBodyData'
    ];
    ...
    *  data
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\ImportIncidentsResponseBodyData|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\ImportIncidentsResponseBodyData|null $data data
    *
    * @return $this
    */
