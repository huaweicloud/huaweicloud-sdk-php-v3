...
class ShowPreProcessRulesListResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowPreProcessRulesListResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'offset' => 'int',
            'limit' => 'int',
            'data' => '\HuaweiCloud\SDK\SecMaster\V1\Model\ShowPreProcessRulesListResponseBodyData[]'
    ];
    ...
    *  分类映射信息集合
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\ShowPreProcessRulesListResponseBodyData[]|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\ShowPreProcessRulesListResponseBodyData[]|null $data 分类映射信息集合
    *
    * @return $this
    */
