...
class ListResourceTagRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListResourceTagRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['contentType'] === null) {
            ...
            if ((mb_strlen($this->container['contentType']) > 255)) {
