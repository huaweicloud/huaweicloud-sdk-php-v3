...
class OrderAlert implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'ids' => 'string[]',
            'incidentContent' => '\HuaweiCloud\SDK\SecMaster\V1\Model\OrderAlertIncidentContent'
    ];
    ...
    *  incidentContent
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\OrderAlertIncidentContent|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\OrderAlertIncidentContent|null $incidentContent incidentContent
    *
    * @return $this
    */
