...
class Incident implements ModelInterface, ArrayAccess
{
    ...
    * criticality  关键性，是指事件涉及的资产的重要性级别。 取值范围：0-100，0表示资产不关键，100表示最关键资产
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'labels' => 'string',
            'environment' => '\HuaweiCloud\SDK\SecMaster\V1\Model\IncidentEnvironment',
            ...
            'closeReason' => 'string',
            'closeComment' => 'string',
            'malware' => '\HuaweiCloud\SDK\SecMaster\V1\Model\AlertMalware',
            'systemInfo' => 'object',
            'process' => '\HuaweiCloud\SDK\SecMaster\V1\Model\AlertProcess[]',
            'userInfo' => '\HuaweiCloud\SDK\SecMaster\V1\Model\AlertUserInfo[]',
            'fileInfo' => '\HuaweiCloud\SDK\SecMaster\V1\Model\AlertFileInfo[]',
    ...
    *  environment
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\IncidentEnvironment|null
    */
    ...
    * Sets environment
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\IncidentEnvironment|null $environment environment
    *
    * @return $this
    */
    ...
    *  dataSource
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\AlertDataSource|null
    */
    ...
    * Sets dataSource
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\AlertDataSource|null $dataSource dataSource
    *
    * @return $this
    */
    ...
    * Sets criticality
    *
    * @param int|null $criticality 关键性，是指事件涉及的资产的重要性级别。 取值范围：0-100，0表示资产不关键，100表示最关键资产
    *
    * @return $this
    */
    ...
    *  incidentType
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\IncidentIncidentType|null
    */
    ...
    * Sets incidentType
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\IncidentIncidentType|null $incidentType incidentType
    *
    * @return $this
    */
    ...
    *  网络信息
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\AlertNetworkList[]|null
    */
    ...
    * Sets networkList
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\AlertNetworkList[]|null $networkList 网络信息
    *
    * @return $this
    */
    ...
    *  remediation
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\AlertRemediation|null
    */
    ...
    * Sets remediation
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\AlertRemediation|null $remediation remediation
    *
    * @return $this
    */
    ...
    *  malware
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\AlertMalware|null
    */
    ...
    * Sets malware
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\AlertMalware|null $malware malware
    *
    * @return $this
    */
    ...
    *  进程信息
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\AlertProcess[]|null
    */
    ...
    * Sets process
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\AlertProcess[]|null $process 进程信息
    *
    * @return $this
    */
    ...
    *  用户信息
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\AlertUserInfo[]|null
    */
    ...
    * Sets userInfo
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\AlertUserInfo[]|null $userInfo 用户信息
    *
    * @return $this
    */
    ...
    *  文件信息
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\AlertFileInfo[]|null
    */
    ...
    * Sets fileInfo
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\AlertFileInfo[]|null $fileInfo 文件信息
    *
    * @return $this
    */
