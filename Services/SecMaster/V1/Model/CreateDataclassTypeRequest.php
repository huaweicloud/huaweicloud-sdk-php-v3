...
class CreateDataclassTypeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateDataclassTypeRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'dataclassId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\CreateDataclassTypeRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\CreateDataclassTypeRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\CreateDataclassTypeRequestBody|null $body body
    *
    * @return $this
    */
