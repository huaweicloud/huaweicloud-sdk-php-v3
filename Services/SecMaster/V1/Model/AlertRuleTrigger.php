...
class AlertRuleTrigger implements ModelInterface, ArrayAccess
{
    ...
    * expression  表达式
    * mode  **参数解释**: 指标模式 - COUNT 数量  **约束限制** 不涉及 **取值范围**: - COUNT  **默认值** 不涉及
    ...
    * Sets mode
    *
    * @param string|null $mode **参数解释**: 指标模式 - COUNT 数量  **约束限制** 不涉及 **取值范围**: - COUNT  **默认值** 不涉及
    *
    * @return $this
    */
    ...
    * Sets operator
    *
    * @param string|null $operator **参数解释**: 操作符类型 - GT 大于 - LT 小于 - EQ 等于 - NE 不等于  **约束限制** 不涉及 **取值范围**: - GT - LT - EQ - NE  **默认值** 不涉及
    *
    * @return $this
    */
