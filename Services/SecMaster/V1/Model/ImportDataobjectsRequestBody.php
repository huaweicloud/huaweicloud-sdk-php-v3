...
class ImportDataobjectsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImportDataobjectsRequestBody';
    ...
    * Sets uploadFile
    *
    * @param \SplFileObject|null $uploadFile 导入数据对象
    *
    * @return $this
    */
