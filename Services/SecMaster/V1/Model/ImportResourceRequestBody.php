...
class ImportResourceRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImportResourceRequestBody';
    ...
    * Sets uploadFile
    *
    * @param \SplFileObject $uploadFile 导入资产文件
    *
    * @return $this
    */
