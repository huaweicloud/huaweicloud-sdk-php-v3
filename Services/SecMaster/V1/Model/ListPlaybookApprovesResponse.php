...
class ListPlaybookApprovesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'code' => 'string',
            'message' => 'string',
            'data' => '\HuaweiCloud\SDK\SecMaster\V1\Model\ApproveOpinionDetail[]',
            'xRequestId' => 'string'
    ];
    ...
    *  剧本审核详情
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\ApproveOpinionDetail[]|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\ApproveOpinionDetail[]|null $data 剧本审核详情
    *
    * @return $this
    */
