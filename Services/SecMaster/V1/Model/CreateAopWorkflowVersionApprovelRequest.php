...
class CreateAopWorkflowVersionApprovelRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAopWorkflowVersionApprovelRequest';
    ...
    * versionId  **参数解释**: 流程版本ID **取值范围**: 不涉及
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'versionId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\CreateAopWorkflowVersionApprovelInfo'
    ];
    ...
    * Sets versionId
    *
    * @param string $versionId **参数解释**: 流程版本ID **取值范围**: 不涉及
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\CreateAopWorkflowVersionApprovelInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\CreateAopWorkflowVersionApprovelInfo|null $body body
    *
    * @return $this
    */
