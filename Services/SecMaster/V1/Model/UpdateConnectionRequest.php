...
class UpdateConnectionRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'assetId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\CreateAssetsRequestBody'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['assetId'] === null) {
            ...
            if ((mb_strlen($this->container['assetId']) < 32)) {
                $invalidProperties[] = "invalid value for 'assetId', the character length must be bigger than or equal to 32.";
            }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\CreateAssetsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\CreateAssetsRequestBody|null $body body
    *
    * @return $this
    */
