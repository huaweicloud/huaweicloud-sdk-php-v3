...
class HwcEcsSchedulerHint implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'HwcEcsSchedulerHint';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * group  云服务器组ID，UUID格式。 云服务器组的ID可以从控制台或者参考查询云服务器组列表获取。
    * tenancy  在指定的专属主机或者共享主机上创建弹性云服务器。 参数值为shared或者dedicated。
    * dedicatedHostId  专属主机的ID。 说明： 专属主机的ID仅在tenancy为dedicated时生效。
    *
    * @var string[]
    */
    ...
    * Sets group
    *
    * @param string[]|null $group 云服务器组ID，UUID格式。 云服务器组的ID可以从控制台或者参考查询云服务器组列表获取。
    *
    * @return $this
    */
    ...
    *
    * @param string[]|null $dedicatedHostId 专属主机的ID。 说明： 专属主机的ID仅在tenancy为dedicated时生效。
    *
    * @return $this
    */
