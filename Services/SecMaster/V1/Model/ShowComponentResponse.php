...
class ShowComponentResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'success' => 'bool',
            'requestId' => 'string',
            'data' => '\HuaweiCloud\SDK\SecMaster\V1\Model\ComponentInfo'
    ];
    ...
    * Sets code
    *
    * @param string $code **参数解释**: 响应的返回码 **约束限制**: 不涉及
    *
    * @return $this
    */
    ...
    *  data
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\ComponentInfo|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\ComponentInfo|null $data data
    *
    * @return $this
    */
