...
class CreateModuleRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateModuleRequest';
    ...
    */
    protected static $openAPITypes = [
            'contentType' => 'string',
            'workspaceId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\ModuleCreateRequestPojo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\ModuleCreateRequestPojo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\ModuleCreateRequestPojo|null $body body
    *
    * @return $this
    */
