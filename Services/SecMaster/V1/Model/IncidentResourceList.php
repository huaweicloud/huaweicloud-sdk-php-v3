...
class IncidentResourceList implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'Incident_resource_list';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  云服务资产id
    * name  资产名称
    * type  资产类型(cloudservers;servers;vm;pm;instances;publicips;ip;website;vpcs;securityGroups;device)
    * provider  云服务名称；引用云RMS provider字段
    * regionId  区域；按照云regionId填写
    * domainId  资产所属账号ID，UUID格式
    * projectId  资产所属项目ID，UUID格式
    * epId  企业项目id
    * epName  企业项目名称
    * tags  资产标签 1、最多50个key/values对 2、values：最大255字符，取值范围：字母数字,空格,+, -, =, ., _, :, /,@
    *
    * @var string[]
    */
    ...
    * Sets type
    *
    * @param string|null $type 资产类型(cloudservers;servers;vm;pm;instances;publicips;ip;website;vpcs;securityGroups;device)
    *
    * @return $this
    */
    ...
    * Sets domainId
    *
    * @param string|null $domainId 资产所属账号ID，UUID格式
    *
    * @return $this
    */
    ...
    * Sets projectId
    *
    * @param string|null $projectId 资产所属项目ID，UUID格式
    *
    * @return $this
    */
