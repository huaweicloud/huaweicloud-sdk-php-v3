...
class UpdateLayoutRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateLayoutRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'layoutId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\LayoutUpdateRequestPojo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\LayoutUpdateRequestPojo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\LayoutUpdateRequestPojo|null $body body
    *
    * @return $this
    */
