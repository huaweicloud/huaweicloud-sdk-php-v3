...
class ListWorkspacesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'workspaces' => '\HuaweiCloud\SDK\SecMaster\V1\Model\CreateWorkspaceResponseBody[]',
            'count' => 'float'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\CreateWorkspaceResponseBody[]|null
    */
    ...
    * Sets workspaces
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\CreateWorkspaceResponseBody[]|null $workspaces list of informations of workspaces
    *
    * @return $this
    */
