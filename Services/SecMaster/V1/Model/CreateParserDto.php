...
class CreateParserDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateParserDto';
    ...
    */
    protected static $openAPITypes = [
            'description' => 'string',
            'modules' => '\HuaweiCloud\SDK\SecMaster\V1\Model\CreateModuleVo[]',
            'parserId' => 'string',
            'title' => 'string'
    ];
    ...
    * Sets modules
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\CreateModuleVo[]|null $modules 相关描述信息
    *
    * @return $this
    */
