...
class CreateSubscriptionOrderRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSubscriptionOrderRequest';
    ...
    */
    protected static $openAPITypes = [
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\OrderInfoReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\OrderInfoReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\OrderInfoReq|null $body body
    *
    * @return $this
    */
