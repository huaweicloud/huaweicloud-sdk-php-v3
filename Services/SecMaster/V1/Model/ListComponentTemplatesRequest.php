...
class ListComponentTemplatesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListComponentTemplatesRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['workspaceId'] === null) {
            ...
            if (!is_null($this->container['searchValue']) && (mb_strlen($this->container['searchValue']) > 64)) {
                $invalidProperties[] = "invalid value for 'searchValue', the character length must be smaller than or equal to 64.";
            }
            if (!is_null($this->container['searchValue']) && (mb_strlen($this->container['searchValue']) < 1)) {
    ...
    * Sets searchValue
    *
    * @param string|null $searchValue 插件配置模板名称
    *
    * @return $this
    */
