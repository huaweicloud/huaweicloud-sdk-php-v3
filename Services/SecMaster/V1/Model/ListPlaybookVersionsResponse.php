...
class ListPlaybookVersionsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'page' => 'int',
            'total' => 'int',
            'data' => '\HuaweiCloud\SDK\SecMaster\V1\Model\PlaybookVersionListEntity[]',
            'xRequestId' => 'string'
    ];
    ...
    *  剧本版本列表信息
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\PlaybookVersionListEntity[]|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\PlaybookVersionListEntity[]|null $data 剧本版本列表信息
    *
    * @return $this
    */
