...
class UpdatePlaybookRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'playbookId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\ModifyPlaybookInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\ModifyPlaybookInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\ModifyPlaybookInfo|null $body body
    *
    * @return $this
    */
