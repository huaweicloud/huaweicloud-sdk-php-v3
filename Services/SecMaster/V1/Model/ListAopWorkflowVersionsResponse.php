...
class ListAopWorkflowVersionsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAopWorkflowVersionsResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'size' => 'int',
            'page' => 'int',
            'data' => '\HuaweiCloud\SDK\SecMaster\V1\Model\AopWorkflowVersionInfo[]'
    ];
    ...
    *  流程版本详情的列表对象
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\AopWorkflowVersionInfo[]|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\AopWorkflowVersionInfo[]|null $data 流程版本详情的列表对象
    *
    * @return $this
    */
