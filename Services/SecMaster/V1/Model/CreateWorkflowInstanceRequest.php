...
class CreateWorkflowInstanceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateWorkflowInstanceRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'workflowId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\AopInstanceEventData'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['workflowId'] === null) {
            ...
            if ((mb_strlen($this->container['workflowId']) < 0)) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\AopInstanceEventData|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\AopInstanceEventData|null $body body
    *
    * @return $this
    */
