...
class UpdateDataspaceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDataspaceRequest';
    ...
    */
    protected static $openAPITypes = [
            'workspaceId' => 'string',
            'dataspaceId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\UpdateDataspaceRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\UpdateDataspaceRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\UpdateDataspaceRequestBody|null $body body
    *
    * @return $this
    */
