...
class CreateDictionaryRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateDictionaryRequest';
    ...
    */
    protected static $openAPITypes = [
            'dictList' => '\HuaweiCloud\SDK\SecMaster\V1\Model\DictionaryCreate[]',
            'isBuiltIn' => 'bool'
    ];
    ...
    *  字典列表
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\DictionaryCreate[]|null
    */
    ...
    * Sets dictList
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\DictionaryCreate[]|null $dictList 字典列表
    *
    * @return $this
    */
    ...
    * Sets isBuiltIn
    *
    * @param bool|null $isBuiltIn 是否创建内置字典
    *
    * @return $this
    */
