...
class CreateAopWorkflowVersionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAopWorkflowVersionRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'workflowId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\CreateAopWorkflowVersionInfo'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['workflowId'] === null) {
            ...
            if ((mb_strlen($this->container['workflowId']) < 32)) {
    ...
    * Sets workflowId
    *
    * @param string $workflowId **参数解释**: 流程ID **取值范围**: 不涉及
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\CreateAopWorkflowVersionInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\CreateAopWorkflowVersionInfo|null $body body
    *
    * @return $this
    */
