...
class UpdateWorkflowInstanceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateWorkflowInstanceRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\AopInstanceUpdateDataPojo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\AopInstanceUpdateDataPojo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\AopInstanceUpdateDataPojo|null $body body
    *
    * @return $this
    */
