...
class UpdateAopWorkflowRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAopWorkflowRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'workflowId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\ModifyAopWorkflowInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\ModifyAopWorkflowInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\ModifyAopWorkflowInfo|null $body body
    *
    * @return $this
    */
