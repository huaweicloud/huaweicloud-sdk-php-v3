...
class DeleteConfigurationDictionariesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteConfigurationDictionariesRequest';
    ...
    */
    protected static $openAPITypes = [
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\DeleteDictionaryRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\DeleteDictionaryRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\DeleteDictionaryRequest|null $body body
    *
    * @return $this
    */
