...
class HwcVpcCloudResource implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'HwcVpcCloudResource';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['resourceCount']) && ($this->container['resourceCount'] > 65535)) {
                $invalidProperties[] = "invalid value for 'resourceCount', must be smaller than or equal to 65535.";
            }
    ...
    * Sets resourceType
    *
    * @param string|null $resourceType 资产类型
    *
    * @return $this
    */
    ...
    * Sets resourceCount
    *
    * @param int|null $resourceCount 资产数量
    *
    * @return $this
    */
