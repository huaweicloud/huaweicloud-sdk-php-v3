...
class UpdateMapperRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateMapperRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'mapperId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\CreateDpeMappingRequestBody'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['mapperId'] === null) {
            $invalidProperties[] = "'mapperId' can't be null";
        }
            if ((mb_strlen($this->container['mapperId']) > 36)) {
                $invalidProperties[] = "invalid value for 'mapperId', the character length must be smaller than or equal to 36.";
            }
            if ((mb_strlen($this->container['mapperId']) < 32)) {
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\CreateDpeMappingRequestBody|null $body body
    *
    * @return $this
    */
