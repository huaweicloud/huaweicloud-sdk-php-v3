...
class CreatePreProcessRulesRequestBodyPreprocessRules implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePreProcessRulesRequestBody_preprocess_rules';
