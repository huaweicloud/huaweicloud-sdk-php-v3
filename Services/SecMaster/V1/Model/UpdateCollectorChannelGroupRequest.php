...
class UpdateCollectorChannelGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateCollectorChannelGroupRequest';
    ...
    */
    protected static $openAPITypes = [
            'workspaceId' => 'string',
            'groupId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\GroupDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\GroupDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\GroupDto|null $body body
    *
    * @return $this
    */
