...
class UpdateAopWorkflowResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAopWorkflowResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'success' => 'bool',
            'requestId' => 'string',
            'data' => '\HuaweiCloud\SDK\SecMaster\V1\Model\AopWorkflowInfo'
    ];
    ...
    *  data
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\AopWorkflowInfo|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\AopWorkflowInfo|null $data data
    *
    * @return $this
    */
