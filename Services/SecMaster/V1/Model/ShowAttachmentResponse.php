...
class ShowAttachmentResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'success' => 'bool',
            'requestId' => 'string',
            'data' => '\HuaweiCloud\SDK\SecMaster\V1\Model\AttachmentInfo'
    ];
    ...
    *  data
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\AttachmentInfo|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\AttachmentInfo|null $data data
    *
    * @return $this
    */
