...
class ImportIncidentsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImportIncidentsRequestBody';
    ...
    * Sets uploadFile
    *
    * @param \SplFileObject $uploadFile 导入事件文件
    *
    * @return $this
    */
