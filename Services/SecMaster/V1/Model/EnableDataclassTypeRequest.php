...
class EnableDataclassTypeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'EnableDataclassTypeRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'dataclassId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\EnableDataclassTypeRequestBody'
    ];
    ...
    * Sets dataclassId
    *
    * @param string $dataclassId 数据类的唯一ID
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\EnableDataclassTypeRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\EnableDataclassTypeRequestBody|null $body body
    *
    * @return $this
    */
