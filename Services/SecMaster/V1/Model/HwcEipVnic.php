...
class HwcEipVnic implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'HwcEipVnic';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * privateIpAddress  私网IP地址
    * deviceId  端口所属设备ID
    * deviceOwner  设备所属 取值范围：合法设备所属 network:dhcp network:VIP_PORT network:router_interface_distributed network:router_centralized_snat 约束：不支持设置和更新,由系统自动维护
    * vpcId  虚拟私有云ID
    * portId  端口ID
    * portProfile  端口profile信息
    * mac  端口MAC地址
    * vtep  VTEP IP
    * vni  VXLAN ID
    * instanceId  端口所属实例ID,例如RDS实例ID
    * instanceType  端口所属实例类型,例如“RDS”
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['portId']) && (mb_strlen($this->container['portId']) < 32)) {
    ...
    * Sets deviceId
    *
    * @param string|null $deviceId 端口所属设备ID
    *
    * @return $this
    */
    ...
    * Sets deviceOwner
    *
    * @param string|null $deviceOwner 设备所属 取值范围：合法设备所属 network:dhcp network:VIP_PORT network:router_interface_distributed network:router_centralized_snat 约束：不支持设置和更新,由系统自动维护
    *
    * @return $this
    */
    ...
    * Sets portProfile
    *
    * @param string|null $portProfile 端口profile信息
    *
    * @return $this
    */
    ...
    * Sets vtep
    *
    * @param string|null $vtep VTEP IP
    *
    * @return $this
    */
    ...
    * Sets vni
    *
    * @param string|null $vni VXLAN ID
    *
    * @return $this
    */
    ...
    * Sets instanceId
    *
    * @param string|null $instanceId 端口所属实例ID,例如RDS实例ID
    *
    * @return $this
    */
    ...
    * Sets instanceType
    *
    * @param string|null $instanceType 端口所属实例类型,例如“RDS”
    *
    * @return $this
    */
