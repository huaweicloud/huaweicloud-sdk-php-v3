...
class CopyPlaybookVersionResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'code' => 'string',
            'message' => 'string',
            'data' => '\HuaweiCloud\SDK\SecMaster\V1\Model\PlaybookVersionInfo',
            'xRequestId' => 'string',
    ...
    *  data
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\PlaybookVersionInfo|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\PlaybookVersionInfo|null $data data
    *
    * @return $this
    */
