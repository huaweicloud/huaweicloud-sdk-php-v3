...
class BatchCreateDataobjectRelationsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateDataobjectRelationsResponse';
    ...
    *  data
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\BatchOperateDataobjectResult|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\BatchOperateDataobjectResult|null $data data
    *
    * @return $this
    */
