...
class CreateSearchAnalysisResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSearchAnalysisResponse';
    ...
    *  统计分析结果字段类型
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\AnalysisField[]|null
    */
    ...
    * Sets schema
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\AnalysisField[]|null $schema 统计分析结果字段类型
    *
    * @return $this
    */
