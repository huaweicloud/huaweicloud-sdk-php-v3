...
class ListAlertRuleMetricsResponse implements ModelInterface, ArrayAccess
{
    ...
    * category  **参数解释**: 指标类型 - GROUP_COUNT 分组数量  **约束限制** 不涉及 **取值范围**: - GROUP_COUNT  **默认值** 不涉及
    * metric  指标值
    ...
    * Sets category
    *
    * @param string|null $category **参数解释**: 指标类型 - GROUP_COUNT 分组数量  **约束限制** 不涉及 **取值范围**: - GROUP_COUNT  **默认值** 不涉及
    *
    * @return $this
    */
    ...
    * Sets metric
    *
    * @param map[string,float]|null $metric 指标值
    *
    * @return $this
    */
