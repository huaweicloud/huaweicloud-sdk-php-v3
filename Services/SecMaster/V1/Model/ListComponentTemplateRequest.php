...
class ListComponentTemplateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListComponentTemplateRequest';
    ...
    */
    ...
    const FILE_TYPE_JVM = 'JVM';
    const FILE_TYPE_LOG4_J2 = 'LOG4J2';
    ...
    * Sets fileType
    *
    * @param string|null $fileType **参数解释**: 文件类型 - JVM JVM配置文件类型 - LOG4J2 Log4j2日志配置文件类型 - YML YAML配置文件类型  **约束限制** 不涉及 **取值范围**: - JVM - LOG4J2 - YML   **默认值** 不涉及
    *
    * @return $this
    */
