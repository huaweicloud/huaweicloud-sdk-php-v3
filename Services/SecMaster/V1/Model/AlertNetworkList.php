...
class AlertNetworkList implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'srcPort' => 'int',
            'srcDomain' => 'string',
            'srcGeo' => '\HuaweiCloud\SDK\SecMaster\V1\Model\AlertSrcGeo',
            'destIp' => 'string',
            'destPort' => 'string',
            'destDomain' => 'string',
            'destGeo' => '\HuaweiCloud\SDK\SecMaster\V1\Model\AlertDestGeo'
    ];
    ...
    *  srcGeo
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\AlertSrcGeo|null
    */
    ...
    * Sets srcGeo
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\AlertSrcGeo|null $srcGeo srcGeo
    *
    * @return $this
    */
    ...
    *  destGeo
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\AlertDestGeo|null
    */
    ...
    * Sets destGeo
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\AlertDestGeo|null $destGeo destGeo
    *
    * @return $this
    */
