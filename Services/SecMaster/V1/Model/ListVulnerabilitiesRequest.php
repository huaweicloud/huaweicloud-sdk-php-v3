...
class ListVulnerabilitiesRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'workspaceId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\VulnerabilityDataObjectSearch'
    ];
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\VulnerabilityDataObjectSearch|null $body body
    *
    * @return $this
    */
