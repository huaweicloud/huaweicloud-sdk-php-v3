...
class ShowDatapanelObjectResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDatapanelObjectResponse';
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\DataObjectDetail|null $data data
    *
    * @return $this
    */
