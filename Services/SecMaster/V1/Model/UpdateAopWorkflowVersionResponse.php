...
class UpdateAopWorkflowVersionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateAopWorkflowVersionResponse';
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\AopWorkflowVersionInfo|null $data data
    *
    * @return $this
    */
