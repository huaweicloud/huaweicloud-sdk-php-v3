...
class UpdateReportRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateReportRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'reportId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\UpdateReportRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\UpdateReportRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\UpdateReportRequestBody|null $body body
    *
    * @return $this
    */
