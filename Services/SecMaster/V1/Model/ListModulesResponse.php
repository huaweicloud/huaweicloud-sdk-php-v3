...
class ListModulesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListModulesResponse';
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\ModuleDetailInfo[]|null $data 数据列表
    *
    * @return $this
    */
