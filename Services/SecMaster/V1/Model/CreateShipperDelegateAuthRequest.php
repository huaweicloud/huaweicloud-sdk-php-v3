...
class CreateShipperDelegateAuthRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateShipperDelegateAuthRequest';
    ...
    */
    protected static $openAPITypes = [
            'workspaceId' => 'string',
            'domainId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\CreateShipperDelegateAuthRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\CreateShipperDelegateAuthRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\CreateShipperDelegateAuthRequestBody|null $body body
    *
    * @return $this
    */
