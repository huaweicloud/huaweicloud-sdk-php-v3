...
class UpdateTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'taskId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V1\Model\ModifyTaskInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\ModifyTaskInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\ModifyTaskInfo|null $body body
    *
    * @return $this
    */
