...
class CreateAnalysisRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAnalysisRequestBody';
    ...
    * Sets queryType
    *
    * @param string $queryType 查询类型：SQL, CBSL.
    *
    * @return $this
    */
