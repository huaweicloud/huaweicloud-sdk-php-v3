...
class DataobjectSearchCondition implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'conditions' => '\HuaweiCloud\SDK\SecMaster\V1\Model\DataobjectSearchConditionConditions[]',
            'logics' => 'string[]'
    ];
    ...
    *  表达式列表
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\DataobjectSearchConditionConditions[]|null
    */
    ...
    * Sets conditions
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\DataobjectSearchConditionConditions[]|null $conditions 表达式列表
    *
    * @return $this
    */
