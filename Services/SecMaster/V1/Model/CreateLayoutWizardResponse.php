...
class CreateLayoutWizardResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateLayoutWizardResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'requestId' => 'string',
            'success' => 'bool',
            'data' => '\HuaweiCloud\SDK\SecMaster\V1\Model\WizardDetailInfo',
            'xRequestId' => 'string'
    ];
    ...
    *  data
    *
    * @return \HuaweiCloud\SDK\SecMaster\V1\Model\WizardDetailInfo|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V1\Model\WizardDetailInfo|null $data data
    *
    * @return $this
    */
