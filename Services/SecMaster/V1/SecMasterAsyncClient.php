...
class SecMasterAsyncClient extends Client
{
     ...
     * @return response
     */
    public function createGenericActionAsync($request)
    {
        return $this->createGenericActionAsyncWithHttpInfo($request);
    }
    
    public function createGenericActionAsyncWithHttpInfo($request){
        $collection_formats = [];
