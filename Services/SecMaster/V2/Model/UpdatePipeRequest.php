...
class UpdatePipeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePipeRequest';
    ...
    */
    protected static $openAPITypes = [
            'workspaceId' => 'string',
            'pipeId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V2\Model\UpdatePipeRequestBody'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pipeId'] === null) {
            ...
            if ((mb_strlen($this->container['pipeId']) < 0)) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\UpdatePipeRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\UpdatePipeRequestBody|null $body body
    *
    * @return $this
    */
