...
class CompliancePackageModel implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CompliancePackageModel';
    ...
    * Sets state
    *
    * @param int $state 表示遵从包的状态 0：未启用 1: 启用
    *
    * @return $this
    */
