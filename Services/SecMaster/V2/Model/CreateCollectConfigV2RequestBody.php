...
class CreateCollectConfigV2RequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'config' => '\HuaweiCloud\SDK\SecMaster\V2\Model\ConfigInfo[]',
            'dataspaceId' => 'string',
            'dataspaceName' => 'string',
            'domainId' => 'string',
            'ltsConfig' => '\HuaweiCloud\SDK\SecMaster\V2\Model\LtsRquestVo[]',
            'workspaceId' => 'string'
    ];
    ...
    *  数据集列表
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\ConfigInfo[]
    */
    ...
    * Sets config
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\ConfigInfo[] $config 数据集列表
    *
    * @return $this
    */
    ...
    *  lts配置
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\LtsRquestVo[]|null
    */
    ...
    * Sets ltsConfig
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\LtsRquestVo[]|null $ltsConfig lts配置
    *
    * @return $this
    */
