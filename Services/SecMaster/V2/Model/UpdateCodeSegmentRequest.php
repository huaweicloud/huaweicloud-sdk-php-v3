...
class UpdateCodeSegmentRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateCodeSegmentRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * workspaceId  工作空间ID
    * codeSegmentId  代码片段 ID
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\SecMaster\V2\Model\UpdateCodeSegmentRequestBody'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['codeSegmentId'] === null) {
            $invalidProperties[] = "'codeSegmentId' can't be null";
        }
            if ((mb_strlen($this->container['codeSegmentId']) > 36)) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\UpdateCodeSegmentRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\UpdateCodeSegmentRequestBody|null $body body
    *
    * @return $this
    */
