...
class ListTableHistogramsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTableHistogramsRequest';
    ...
    */
    protected static $openAPITypes = [
            'workspaceId' => 'string',
            'tableId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V2\Model\ListTableHistogramsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\ListTableHistogramsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\ListTableHistogramsRequestBody|null $body body
    *
    * @return $this
    */
