...
class CreateWorkspaceRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'contentType' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V2\Model\CreateWorkspaceRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\CreateWorkspaceRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\CreateWorkspaceRequestBody|null $body body
    *
    * @return $this
    */
