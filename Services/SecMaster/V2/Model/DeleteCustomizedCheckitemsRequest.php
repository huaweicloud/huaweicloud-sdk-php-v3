...
class DeleteCustomizedCheckitemsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteCustomizedCheckitemsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V2\Model\DeleteCustomizedCheckitemsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\DeleteCustomizedCheckitemsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\DeleteCustomizedCheckitemsRequestBody|null $body body
    *
    * @return $this
    */
