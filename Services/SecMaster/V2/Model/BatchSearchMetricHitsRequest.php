...
class BatchSearchMetricHitsRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'timespan' => 'string',
            'cache' => 'bool',
            'body' => '\HuaweiCloud\SDK\SecMaster\V2\Model\BatchSearchMetricHitsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\BatchSearchMetricHitsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\BatchSearchMetricHitsRequestBody|null $body body
    *
    * @return $this
    */
