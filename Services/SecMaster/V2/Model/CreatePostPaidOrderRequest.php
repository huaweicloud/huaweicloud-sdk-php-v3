...
class CreatePostPaidOrderRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePostPaidOrderRequest';
    ...
    */
    protected static $openAPITypes = [
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V2\Model\PostPaidParam'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\PostPaidParam|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\PostPaidParam|null $body body
    *
    * @return $this
    */
