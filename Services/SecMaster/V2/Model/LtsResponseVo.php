...
class LtsResponseVo implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'logStreamId' => 'string',
            'logType' => 'string',
            'logTypes' => '\HuaweiCloud\SDK\SecMaster\V2\Model\LtsResponseVoLogTypes',
            'ltsInfos' => '\HuaweiCloud\SDK\SecMaster\V2\Model\LtsResponseVoLtsInfos[]',
            'pipeAlias' => 'string',
            'typePrefix' => 'string'
    ];
    ...
    *  logTypes
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\LtsResponseVoLogTypes|null
    */
    ...
    * Sets logTypes
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\LtsResponseVoLogTypes|null $logTypes logTypes
    *
    * @return $this
    */
    ...
    *  lts日志信息map
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\LtsResponseVoLtsInfos[]|null
    */
    ...
    * Sets ltsInfos
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\LtsResponseVoLtsInfos[]|null $ltsInfos lts日志信息map
    *
    * @return $this
    */
