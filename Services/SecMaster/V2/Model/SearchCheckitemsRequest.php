...
class SearchCheckitemsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchCheckitemsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V2\Model\SearchCheckitemsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\SearchCheckitemsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\SearchCheckitemsRequestBody|null $body body
    *
    * @return $this
    */
