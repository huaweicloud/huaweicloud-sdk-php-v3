...
class ListCollectConfigResponseBodyDataList implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'csvc' => 'string',
            'datasets' => '\HuaweiCloud\SDK\SecMaster\V2\Model\ListCollectConfigResponseBodyDatasets[]',
    ...
    *  日志数据
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\ListCollectConfigResponseBodyDatasets[]|null
    */
    ...
    * Sets datasets
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\ListCollectConfigResponseBodyDatasets[]|null $datasets 日志数据
    *
    * @return $this
    */
