...
class UpdateLayoutFieldRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateLayoutFieldRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'workspaceId' => 'string',
            'fieldId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V2\Model\UpdateLayoutFieldRequestBody'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['fieldId'] === null) {
            ...
            if ((mb_strlen($this->container['fieldId']) > 64)) {
                $invalidProperties[] = "invalid value for 'fieldId', the character length must be smaller than or equal to 64.";
            }
            if ((mb_strlen($this->container['fieldId']) < 32)) {
                $invalidProperties[] = "invalid value for 'fieldId', the character length must be bigger than or equal to 32.";
            }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\UpdateLayoutFieldRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\UpdateLayoutFieldRequestBody|null $body body
    *
    * @return $this
    */
