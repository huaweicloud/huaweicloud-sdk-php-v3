...
class ListCollectConfigResponseBodyDatasets implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'accounts' => '\HuaweiCloud\SDK\SecMaster\V2\Model\ListCollectConfigResponseBodyAccounts[]',
            'alert' => 'bool',
            'allAccounts' => 'bool',
            'allowAlert' => 'bool',
            'dataspaceId' => 'string',
            ...
            'reference' => '\HuaweiCloud\SDK\SecMaster\V2\Model\ListCollectConfigResponseBodyReference',
            'regionId' => 'string',
            'sinkMsg' => 'string',
            'sourceId' => 'float',
            'sourceName' => 'string',
            'target' => '\HuaweiCloud\SDK\SecMaster\V2\Model\ListCollectConfigResponseBodyTarget',
            'type' => 'string',
            'workspaceId' => 'string'
    ];
    ...
    *  账号列表
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\ListCollectConfigResponseBodyAccounts[]|null
    */
    ...
    * Sets accounts
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\ListCollectConfigResponseBodyAccounts[]|null $accounts 账号列表
    *
    * @return $this
    */
    ...
    *  reference
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\ListCollectConfigResponseBodyReference|null
    */
    ...
    * Sets reference
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\ListCollectConfigResponseBodyReference|null $reference reference
    *
    * @return $this
    */
    ...
    *  target
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\ListCollectConfigResponseBodyTarget|null
    */
    ...
    * Sets target
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\ListCollectConfigResponseBodyTarget|null $target target
    *
    * @return $this
    */
