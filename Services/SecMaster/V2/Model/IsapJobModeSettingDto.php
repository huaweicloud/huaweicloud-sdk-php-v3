...
class IsapJobModeSettingDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'IsapJobModeSettingDto';
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['dssId'] = isset($data['dssId']) ? $data['dssId'] : null;
    }
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['dssId']) && ($this->container['dssId'] > 9223372036854775800)) {
                $invalidProperties[] = "invalid value for 'dssId', must be smaller than or equal to 9223372036854775800.";
            }
            if (!is_null($this->container['dssId']) && ($this->container['dssId'] < 0)) {
                $invalidProperties[] = "invalid value for 'dssId', must be bigger than or equal to 0.";
            }
    ...
    * @return int|null
    */
    public function getDssId()
    {
        return $this->container['dssId'];
    }

    /**
    * Sets dssId
    *
    * @param int|null $dssId 长整型间隔时长
    *
    * @return $this
    */
    public function setDssId($dssId)
    {
        $this->container['dssId'] = $dssId;
        return $this;
    }
