...
class CheckitemModel implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CheckitemModel';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cloudServer'] === null) {
            $invalidProperties[] = "'cloudServer' can't be null";
        }
            if ((mb_strlen($this->container['cloudServer']) > 64)) {
                $invalidProperties[] = "invalid value for 'cloudServer', the character length must be smaller than or equal to 64.";
            }
            if ((mb_strlen($this->container['cloudServer']) < 0)) {
    ...
    * Sets cloudServer
    *
    * @param string $cloudServer 检查项所属云服务
    *
    * @return $this
    */
    ...
    * Sets description
    *
    * @param string $description 对检查项的描述
    *
    * @return $this
    */
    ...
    * Sets level
    *
    * @param string $level 表示该检查项的严重程度 informational：提示 low: 低危 medium：中危 high: 高危 fatal：致命
    *
    * @return $this
    */
    ...
    * Sets method
    *
    * @param int $method 表示该检查项的检查方式 0：手动 1：自动 3: 自动-剧本流程 4: 自动-企业主机安全 5：自动-配置审计服务
    *
    * @return $this
    */
