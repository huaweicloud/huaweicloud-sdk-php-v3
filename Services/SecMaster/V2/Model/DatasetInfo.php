...
class DatasetInfo implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'enable' => 'string',
            'isRegion' => 'int',
            'reference' => '\HuaweiCloud\SDK\SecMaster\V2\Model\DatasetInfoReference',
            'sourceId' => 'int',
            'sourceName' => 'string',
            'target' => 'object',
            'type' => 'int'
    ...
    *  reference
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\DatasetInfoReference
    */
    ...
    * Sets reference
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\DatasetInfoReference $reference reference
    *
    * @return $this
    */
