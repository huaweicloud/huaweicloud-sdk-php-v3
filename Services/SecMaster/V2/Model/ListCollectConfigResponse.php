...
class ListCollectConfigResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'domainId' => 'string',
            'ltsSets' => '\HuaweiCloud\SDK\SecMaster\V2\Model\LtsResponseVo[]',
            'projectId' => 'string',
            'regionId' => 'string',
            'workspaceId' => 'string'
    ];
    ...
    *  所有的云厂商、云产品和日志
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\ListCollectConfigResponseBodyAllVendors[]|null
    */
    ...
    * Sets allVendors
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\ListCollectConfigResponseBodyAllVendors[]|null $allVendors 所有的云厂商、云产品和日志
    *
    * @return $this
    */
    ...
    *  数据
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\ListCollectConfigResponseBodyDataList[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\ListCollectConfigResponseBodyDataList[]|null $dataList 数据
    *
    * @return $this
    */
    ...
    * Sets datasets
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\DatasetInfo[]|null $datasets 数据集列表
    *
    * @return $this
    */
    ...
    *  lts日志配置
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\LtsResponseVo[]|null
    */
    ...
    * Sets ltsSets
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\LtsResponseVo[]|null $ltsSets lts日志配置
    *
    * @return $this
    */
