...
class ShowCheckitemDetailRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowCheckitemDetailRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['checkitemId'] === null) {
            ...
            if ((mb_strlen($this->container['checkitemId']) > 64)) {
                $invalidProperties[] = "invalid value for 'checkitemId', the character length must be smaller than or equal to 64.";
            }
