...
class Object1Map implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'Object1Map';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * metric  表示一个 Map<String, Integer>，用于存储整数类型的指标
    * category  目录状态相关描述
    *
    * @var string[]
    */
    ...
    * Sets metric
    *
    * @param map[string,int]|null $metric 表示一个 Map<String, Integer>，用于存储整数类型的指标
    *
    * @return $this
    */
