...
class AnalysisScriptParam implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AnalysisScriptParam';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['key']) && !preg_match("/^\\\\{\\\\{[0-9a-zA-Z_]+\\\\}\\\\}$/", $this->container['key'])) {
                $invalidProperties[] = "invalid value for 'key', must be conform to the pattern /^\\\\{\\\\{[0-9a-zA-Z_]+\\\\}\\\\}$/.";
            }
    ...
    * Sets value
    *
    * @param string|null $value 值 value
    *
    * @return $this
    */
