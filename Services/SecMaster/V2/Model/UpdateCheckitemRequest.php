...
class UpdateCheckitemRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateCheckitemRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'xLanguage' => 'string',
            'checkitemId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V2\Model\CheckitemModel'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['checkitemId'] === null) {
            ...
            if ((mb_strlen($this->container['checkitemId']) > 36)) {
                $invalidProperties[] = "invalid value for 'checkitemId', the character length must be smaller than or equal to 36.";
            }
            if ((mb_strlen($this->container['checkitemId']) < 0)) {
                $invalidProperties[] = "invalid value for 'checkitemId', the character length must be bigger than or equal to 0.";
            }
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\CheckitemModel|null $body body
    *
    * @return $this
    */
