...
class ListCollectConfigResponseBodyCsvcList implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'csvc' => 'string',
            'sourceList' => '\HuaweiCloud\SDK\SecMaster\V2\Model\ListCollectConfigResponseBodySourceList[]'
    ];
    ...
    *  所有的日志类型
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\ListCollectConfigResponseBodySourceList[]|null
    */
    ...
    * Sets sourceList
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\ListCollectConfigResponseBodySourceList[]|null $sourceList 所有的日志类型
    *
    * @return $this
    */
