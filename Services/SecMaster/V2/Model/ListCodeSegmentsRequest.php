...
class ListCodeSegmentsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCodeSegmentsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * workspaceId  工作空间ID
    * codeSegmentId  代码片段 ID
    * codeSegmentName  代码片段名称
    ...
    * Sets codeSegmentId
    *
    * @param string|null $codeSegmentId 代码片段 ID
    *
    * @return $this
    */
    ...
    *
    * @param string|null $codeSegmentName 代码片段名称
    *
    * @return $this
    */
