...
class UpdateDataTransformationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDataTransformationRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * workspaceId  工作空间ID
    * dataTransformationId  数据转换 ID
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\SecMaster\V2\Model\UpdateDataTransformationRequestBody'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['dataTransformationId'] === null) {
            ...
            if ((mb_strlen($this->container['dataTransformationId']) < 0)) {
                $invalidProperties[] = "invalid value for 'dataTransformationId', the character length must be bigger than or equal to 0.";
            }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\UpdateDataTransformationRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\UpdateDataTransformationRequestBody|null $body body
    *
    * @return $this
    */
