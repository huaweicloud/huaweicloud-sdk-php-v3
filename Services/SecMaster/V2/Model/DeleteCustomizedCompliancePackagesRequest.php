...
class DeleteCustomizedCompliancePackagesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteCustomizedCompliancePackagesRequest';
    ...
    * Sets body
    *
    * @param string[]|null $body 需要删除的自定义遵从包列表uuid
    *
    * @return $this
    */
