...
class ListDataTransformationMetricsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDataTransformationMetricsRequest';
