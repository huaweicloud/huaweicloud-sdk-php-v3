...
class ListTableLogsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTableLogsResponse';
    ...
    * size  Returned count of results
    ...
    * Sets schema
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\SearchQueryField[]|null $schema 查询结果 schema
    *
    * @return $this
    */
    ...
    * Sets total
    *
    * @param int|null $total Total count of results
    *
    * @return $this
    */
    ...
    * Sets size
    *
    * @param int|null $size Returned count of results
    *
    * @return $this
    */
    ...
    * Sets results
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\SearchQueryResult[]|null $results Results in JSON format
    *
    * @return $this
    */
