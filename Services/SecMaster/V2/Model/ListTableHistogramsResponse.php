...
class ListTableHistogramsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTableHistogramsResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalCount' => 'int',
            'histograms' => '\HuaweiCloud\SDK\SecMaster\V2\Model\SearchQueryResultHistogram[]'
    ];
    ...
    *  直方图
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\SearchQueryResultHistogram[]|null
    */
    ...
    * Sets histograms
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\SearchQueryResultHistogram[]|null $histograms 直方图
    *
    * @return $this
    */
