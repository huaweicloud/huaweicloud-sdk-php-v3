...
class LtsResponseVoLtsInfos implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'logGroupId' => 'string',
            'logGroupName' => 'string',
            'streams' => '\HuaweiCloud\SDK\SecMaster\V2\Model\LtsResponseVoStreams[]'
    ];
    ...
    *  流列表
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\LtsResponseVoStreams[]|null
    */
    ...
    * Sets streams
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\LtsResponseVoStreams[]|null $streams 流列表
    *
    * @return $this
    */
