...
class CreateCodeSegmentRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCodeSegmentRequestBody';
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['codeSegmentName'] === null) {
            $invalidProperties[] = "'codeSegmentName' can't be null";
        }
            if ((mb_strlen($this->container['codeSegmentName']) > 256)) {
                $invalidProperties[] = "invalid value for 'codeSegmentName', the character length must be smaller than or equal to 256.";
            }
            if ((mb_strlen($this->container['codeSegmentName']) < 1)) {
        ...
        if ($this->container['code'] === null) {
            ...
            if ((mb_strlen($this->container['code']) > 10240)) {
    ...
    *
    * @param string $codeSegmentName 代码段名称
    *
    * @return $this
    */
