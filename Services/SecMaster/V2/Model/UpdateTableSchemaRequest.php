...
class UpdateTableSchemaRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateTableSchemaRequest';
    ...
    */
    protected static $openAPITypes = [
            'workspaceId' => 'string',
            'tableId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V2\Model\TableSchemaDto'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\TableSchemaDto|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\TableSchemaDto|null $body body
    *
    * @return $this
    */
