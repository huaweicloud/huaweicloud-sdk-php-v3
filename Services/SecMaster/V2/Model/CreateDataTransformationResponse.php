...
class CreateDataTransformationResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateDataTransformationResponse';
    ...
    *  processError
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\DataTransformationProcessError|null
    */
    ...
    * Sets processError
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\DataTransformationProcessError|null $processError processError
    *
    * @return $this
    */
