...
class UpdatePipeSchemaRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePipeSchemaRequest';
    ...
    */
    protected static $openAPITypes = [
            'workspaceId' => 'string',
            'pipeId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V2\Model\PipeSchema'
    ];
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\PipeSchema|null $body body
    *
    * @return $this
    */
