...
class CreateCustomizedCompliancePackageRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCustomizedCompliancePackageRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'contentType' => 'string',
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V2\Model\CompliancePackageModel'
    ];
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\CompliancePackageModel|null $body body
    *
    * @return $this
    */
