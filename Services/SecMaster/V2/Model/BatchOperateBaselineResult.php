...
class BatchOperateBaselineResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchOperateBaselineResult';
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['errorIds'] === null) {
            $invalidProperties[] = "'errorIds' can't be null";
        }
    ...
    * Sets successIds
    *
    * @param string[] $successIds 失败id列表
    *
    * @return $this
    */
