...
class ListTablesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'count' => 'int',
            'records' => '\HuaweiCloud\SDK\SecMaster\V2\Model\IsapTable[]'
    ];
    ...
    *  表具体内容
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\IsapTable[]|null
    */
    ...
    * Sets records
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\IsapTable[]|null $records 表具体内容
    *
    * @return $this
    */
