...
class SearchCompliancePackagesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchCompliancePackagesRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'contentType' => 'string',
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V2\Model\SearchCompliancePackagesRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\SearchCompliancePackagesRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\SearchCompliancePackagesRequestBody|null $body body
    *
    * @return $this
    */
