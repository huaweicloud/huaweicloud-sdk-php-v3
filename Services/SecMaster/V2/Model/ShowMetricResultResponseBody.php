...
class ShowMetricResultResponseBody implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'metricId' => 'string',
            'result' => '\HuaweiCloud\SDK\SecMaster\V2\Model\ShowMetricResultResponseBodyResult',
            'metricFormat' => '\HuaweiCloud\SDK\SecMaster\V2\Model\MetricFormat[]',
            'logMsg' => 'string',
            'status' => 'string'
    ];
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\ShowMetricResultResponseBodyResult
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\ShowMetricResultResponseBodyResult $result result
    *
    * @return $this
    */
    ...
    *  指标显示格式，根据不同指标固定返回。
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\MetricFormat[]|null
    */
    ...
    * Sets metricFormat
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\MetricFormat[]|null $metricFormat 指标显示格式，根据不同指标固定返回。
    *
    * @return $this
    */
