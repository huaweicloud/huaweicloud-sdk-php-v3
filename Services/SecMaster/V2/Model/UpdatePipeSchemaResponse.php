...
class UpdatePipeSchemaResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePipeSchemaResponse';
    ...
    *  管道列
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\TableColumnForIsapPipe[]|null
    */
    ...
    * Sets columns
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\TableColumnForIsapPipe[]|null $columns 管道列
    *
    * @return $this
    */
    ...
    * Sets timeFilter
    *
    * @param string|null $timeFilter 管道过滤列
    *
    * @return $this
    */
