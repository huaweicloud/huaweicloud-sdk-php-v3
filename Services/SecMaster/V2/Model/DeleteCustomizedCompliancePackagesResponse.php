...
class DeleteCustomizedCompliancePackagesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteCustomizedCompliancePackagesResponse';
    ...
    */
    protected static $openAPITypes = [
            'code' => 'string',
            'message' => 'string',
            'data' => '\HuaweiCloud\SDK\SecMaster\V2\Model\BatchOperateBaselineResult'
    ];
    ...
    *  data
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\BatchOperateBaselineResult|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\BatchOperateBaselineResult|null $data data
    *
    * @return $this
    */
