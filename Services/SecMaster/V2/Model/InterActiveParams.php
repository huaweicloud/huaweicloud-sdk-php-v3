...
class InterActiveParams implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'InterActiveParams';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['operator']) && (mb_strlen($this->container['operator']) > 128)) {
                $invalidProperties[] = "invalid value for 'operator', the character length must be smaller than or equal to 128.";
            }
    ...
    * Sets operator
    *
    * @param string|null $operator 查询操作
    *
    * @return $this
    */
