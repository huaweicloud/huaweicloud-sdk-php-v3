...
class DisableDataConsumptionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DisableDataConsumptionRequest';
    ...
    */
    protected static $openAPITypes = [
            'workspaceId' => 'string',
            'tableId' => 'string',
            'body' => '\HuaweiCloud\SDK\SecMaster\V2\Model\DisableConsumptionV2RequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\SecMaster\V2\Model\DisableConsumptionV2RequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\SecMaster\V2\Model\DisableConsumptionV2RequestBody|null $body body
    *
    * @return $this
    */
