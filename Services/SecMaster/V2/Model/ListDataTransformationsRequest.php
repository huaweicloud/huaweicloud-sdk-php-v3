...
class ListDataTransformationsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDataTransformationsRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['workspaceId'] === null) {
            ...
            if (!is_null($this->container['dataTransformationId']) && (mb_strlen($this->container['dataTransformationId']) < 0)) {
    ...
    * Sets outputTableId
    *
    * @param string|null $outputTableId 输出表ID
    *
    * @return $this
    */
    ...
    *
    * @param string|null $dataTransformationId 数据转换 ID
    *
    * @return $this
    */
