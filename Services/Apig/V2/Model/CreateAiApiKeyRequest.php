...
class CreateAiApiKeyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateAiApiKeyRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'appId' => 'string',
            'body' => '\HuaweiCloud\SDK\Apig\V2\Model\AiApiKeyCreate'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Apig\V2\Model\AiApiKeyCreate|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Apig\V2\Model\AiApiKeyCreate|null $body body
    *
    * @return $this
    */
