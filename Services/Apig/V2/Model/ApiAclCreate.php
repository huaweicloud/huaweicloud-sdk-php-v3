...
class ApiAclCreate implements ModelInterface, ArrayAccess
{
    ...
    * aclValue  ACL策略值，支持一个或多个值，使用英文半角逗号分隔。 - entity_type为IP时，策略值需填写IP地址，最多可支持100个IP地址。 - entity_type为DOMAIN时，策略值需填写账号名，账号支持除英文半角逗号以外的任意ASCII字符，帐号名长度限制在1-64个字符，不支持纯数字。多帐号名字符的总长度不超过1024。 - entity_type为DOMAIN_ID时，策略值需填写账号ID，获取方式请参见API参考的“附录 > 获取帐号ID”章节。
    * entityType  对象类型： - IP：IP地址 - DOMAIN：帐号名 - DOMAIN_ID：帐号ID
    *
    * @var string[]
    */
    ...
    */
    ...
    /**
    * Gets aclValue
    *  ACL策略值，支持一个或多个值，使用英文半角逗号分隔。 - entity_type为IP时，策略值需填写IP地址，最多可支持100个IP地址。 - entity_type为DOMAIN时，策略值需填写账号名，账号支持除英文半角逗号以外的任意ASCII字符，帐号名长度限制在1-64个字符，不支持纯数字。多帐号名字符的总长度不超过1024。 - entity_type为DOMAIN_ID时，策略值需填写账号ID，获取方式请参见API参考的“附录 > 获取帐号ID”章节。
    *
    * @return string
    */
    ...
    * Sets aclValue
    *
    * @param string $aclValue ACL策略值，支持一个或多个值，使用英文半角逗号分隔。 - entity_type为IP时，策略值需填写IP地址，最多可支持100个IP地址。 - entity_type为DOMAIN时，策略值需填写账号名，账号支持除英文半角逗号以外的任意ASCII字符，帐号名长度限制在1-64个字符，不支持纯数字。多帐号名字符的总长度不超过1024。 - entity_type为DOMAIN_ID时，策略值需填写账号ID，获取方式请参见API参考的“附录 > 获取帐号ID”章节。
    *
    * @return $this
    */
    ...
    * Sets entityType
    *
    * @param string $entityType 对象类型： - IP：IP地址 - DOMAIN：帐号名 - DOMAIN_ID：帐号ID
    *
    * @return $this
    */
