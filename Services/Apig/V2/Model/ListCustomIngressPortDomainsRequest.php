...
class ListCustomIngressPortDomainsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCustomIngressPortDomainsRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ingressPortId'] === null) {
            $invalidProperties[] = "'ingressPortId' can't be null";
        }
    ...
    * Sets domainName
    *
    * @param string|null $domainName 使用入方向端口的域名。
    *
    * @return $this
    */
