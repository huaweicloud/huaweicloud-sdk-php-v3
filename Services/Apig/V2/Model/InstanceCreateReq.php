...
class InstanceCreateReq implements ModelInterface, ArrayAccess
{
    ...
    * bandwidthChargingMode  出公网带宽计费类型，实例需要开启出公网功能时需要填写： - bandwidth：按带宽计费 - [traffic：按流量计费](tag:hws_test)
    ...
    * ingressBandwidthChargingMode  入公网带宽计费类型，实例需要开启入公网功能，且loadbalancer_provider为elb时需要填写： - bandwidth：按带宽计费 - [traffic：按流量计费](tag:hws_test)
    *
    * @var string[]
    */
    ...
    *
    * @param string|null $bandwidthChargingMode 出公网带宽计费类型，实例需要开启出公网功能时需要填写： - bandwidth：按带宽计费 - [traffic：按流量计费](tag:hws_test)
    *
    * @return $this
    */
    ...
    *
    * @param string|null $ingressBandwidthChargingMode 入公网带宽计费类型，实例需要开启入公网功能，且loadbalancer_provider为elb时需要填写： - bandwidth：按带宽计费 - [traffic：按流量计费](tag:hws_test)
    *
    * @return $this
    */
