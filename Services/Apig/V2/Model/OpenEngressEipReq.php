...
class OpenEngressEipReq implements ModelInterface, ArrayAccess
{
    ...
    * bandwidthChargingMode  出公网带宽计费类型： - bandwidth：按带宽计费 - [traffic：按流量计费](tag:hws_test)
    *
    * @var string[]
    */
    ...
    *
    * @param string|null $bandwidthChargingMode 出公网带宽计费类型： - bandwidth：按带宽计费 - [traffic：按流量计费](tag:hws_test)
    *
    * @return $this
    */
