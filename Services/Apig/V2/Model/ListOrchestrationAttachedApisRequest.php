...
class ListOrchestrationAttachedApisRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListOrchestrationAttachedApisRequest';
