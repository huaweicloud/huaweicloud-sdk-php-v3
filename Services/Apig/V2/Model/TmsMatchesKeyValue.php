...
class TmsMatchesKeyValue implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TmsMatchesKeyValue';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * key  要匹配的字段 - resource_name 表示按照APIG实例的名称去匹配
    ...
    * Sets key
    *
    * @param string|null $key 要匹配的字段 - resource_name 表示按照APIG实例的名称去匹配
    *
    * @return $this
    */
