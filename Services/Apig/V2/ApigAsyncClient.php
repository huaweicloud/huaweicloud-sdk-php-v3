...
class ApigAsyncClient extends Client
{
     ...
     * @return response
     */
    public function createAiApiKeyAsync($request)
    {
        return $this->createAiApiKeyAsyncWithHttpInfo($request);
    }
    
    public function createAiApiKeyAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/{project_id}/apigw/instances/{instance_id}/apps/{app_id}/ai-api-keys';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
     ...
     * @return response
     */
    public function deleteAiApiKeyAsync($request)
    {
        return $this->deleteAiApiKeyAsyncWithHttpInfo($request);
    }
    
    public function deleteAiApiKeyAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/{project_id}/apigw/instances/{instance_id}/apps/{app_id}/ai-api-keys/{ai_api_key_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
     ...
     * @return response
     */
    public function listAiApiKeysAsync($request)
    {
        return $this->listAiApiKeysAsyncWithHttpInfo($request);
    }
    
    public function listAiApiKeysAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/{project_id}/apigw/instances/{instance_id}/apps/{app_id}/ai-api-keys';
        $formParams = [];
        $queryParams = [];
     ...
     * @return response
     */
    public function showDetailsOfAiApiKeyAsync($request)
    {
        return $this->showDetailsOfAiApiKeyAsyncWithHttpInfo($request);
    }
    
    public function showDetailsOfAiApiKeyAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/{project_id}/apigw/instances/{instance_id}/apps/{app_id}/ai-api-keys/{ai_api_key_id}';
        $formParams = [];
        $queryParams = [];
