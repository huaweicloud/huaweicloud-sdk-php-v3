...
class CrlConfiguration implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CrlConfiguration';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * enabled  是否启用CRL发布功能。 - **true** - **false**
    * crlName  吊销列表文件名称。 > 若用户不指定，系统将默认采用当前证书的父CA ID。
    * obsBucketName  OBS桶名称。 > 当需要启用CRL发布功能： > - 此参数为必填项，且用户必须已创建委托授权，授予PCA服务对OBS的相关权限，具体参见本文档：**证书吊销处理>查看是否具有委托权限**、**证书吊销处理>创建委托**； > - 指定的OBS桶必须存在，否则将报错。
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['enabled'] === null) {
            ...
            if (!is_null($this->container['validDays']) && ($this->container['validDays'] > 30)) {
                $invalidProperties[] = "invalid value for 'validDays', must be smaller than or equal to 30.";
            }
            if (!is_null($this->container['validDays']) && ($this->container['validDays'] < 7)) {
    ...
    * Sets obsBucketName
    *
    * @param string|null $obsBucketName OBS桶名称。 > 当需要启用CRL发布功能： > - 此参数为必填项，且用户必须已创建委托授权，授予PCA服务对OBS的相关权限，具体参见本文档：**证书吊销处理>查看是否具有委托权限**、**证书吊销处理>创建委托**； > - 指定的OBS桶必须存在，否则将报错。
    *
    * @return $this
    */
    ...
    * Sets validDays
    *
    * @param int|null $validDays CRL更新周期，单位为\"天\"。当启用CRL发布功能，为必填项。
    *
    * @return $this
    */
