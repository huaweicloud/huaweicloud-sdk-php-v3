...
class Resources implements ModelInterface, ArrayAccess
{
    ...
    * type  证书类型:  - **CERTIFICATE_AUTHORITY**: CA证书；  - **CERTIFICATE**: 私有证书。
    * used  已使用配额数。
    * quota  配额总数：   - **CERTIFICATE_AUTHORITY**: 当前系统指定100；   - **CERTIFICATE**: 当前系统指定100000。
    *
    * @var string[]
    */
    ...
    * Sets type
    *
    * @param string $type 证书类型:  - **CERTIFICATE_AUTHORITY**: CA证书；  - **CERTIFICATE**: 私有证书。
    *
    * @return $this
    */
    ...
    * Sets quota
    *
    * @param int $quota 配额总数：   - **CERTIFICATE_AUTHORITY**: 当前系统指定100；   - **CERTIFICATE**: 当前系统指定100000。
    *
    * @return $this
    */
