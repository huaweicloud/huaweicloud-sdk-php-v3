...
class ExportCertificateAuthorityCsrRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExportCertificateAuthorityCsrRequest';
