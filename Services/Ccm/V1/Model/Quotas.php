...
class Quotas implements ModelInterface, ArrayAccess
{
    ...
    * resources  资源配额列表，详情请参见**Resources**字段数据结构说明。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'resources' => '\HuaweiCloud\SDK\Ccm\V1\Model\Resources[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Ccm\V1\Model\Resources[]
    */
    ...
    * Sets resources
    *
    * @param \HuaweiCloud\SDK\Ccm\V1\Model\Resources[] $resources 资源配额列表，详情请参见**Resources**字段数据结构说明。
    *
    * @return $this
    */
