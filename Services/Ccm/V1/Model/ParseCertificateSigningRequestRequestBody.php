...
class ParseCertificateSigningRequestRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ParseCertificateSigningRequestRequestBody';
