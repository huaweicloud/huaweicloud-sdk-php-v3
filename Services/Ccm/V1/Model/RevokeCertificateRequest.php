...
class RevokeCertificateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RevokeCertificateRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * certificateId  所要吊销的私有证书ID。
    * body  body
    *
    * @var string[]
    */
