...
class BatchDeleteCertTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteCertTagsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * certificateId  所需要批量删除标签的证书ID。
    * body  body
    *
    * @var string[]
    */
