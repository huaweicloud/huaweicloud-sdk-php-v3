...
class CreateCertificateByCsrResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCertificateByCsrResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * certificateId  当前签发的证书ID。
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['certificateId']) && (mb_strlen($this->container['certificateId']) > 36)) {
    ...
    * Sets certificateId
    *
    * @param string|null $certificateId 当前签发的证书ID。
    *
    * @return $this
    */
