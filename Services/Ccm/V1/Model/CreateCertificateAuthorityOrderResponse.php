...
class CreateCertificateAuthorityOrderResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCertificateAuthorityOrderResponse';
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['caIds'] = isset($data['caIds']) ? $data['caIds'] : null;
    }
    ...
    * @return string[]|null
    */
    public function getCaIds()
    {
        return $this->container['caIds'];
    }

    /**
    * Sets caIds
    *
    * @param string[]|null $caIds 当前购买的CA证书ID列表。
    *
    * @return $this
    */
    public function setCaIds($caIds)
    {
        $this->container['caIds'] = $caIds;
        return $this;
    }
