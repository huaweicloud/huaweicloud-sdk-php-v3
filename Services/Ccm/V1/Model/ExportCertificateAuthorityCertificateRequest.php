...
class ExportCertificateAuthorityCertificateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExportCertificateAuthorityCertificateRequest';
