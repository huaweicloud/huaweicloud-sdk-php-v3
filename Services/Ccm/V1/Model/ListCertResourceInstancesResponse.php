...
class ListCertResourceInstancesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCertResourceInstancesResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalCount  总记录数。
    * resources  资源实例列表，详情请参见TagResource字段数据结构说明。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalCount' => 'int',
            'resources' => '\HuaweiCloud\SDK\Ccm\V1\Model\TagResource[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Ccm\V1\Model\TagResource[]|null
    */
    ...
    * Sets resources
    *
    * @param \HuaweiCloud\SDK\Ccm\V1\Model\TagResource[]|null $resources 资源实例列表，详情请参见TagResource字段数据结构说明。
    *
    * @return $this
    */
