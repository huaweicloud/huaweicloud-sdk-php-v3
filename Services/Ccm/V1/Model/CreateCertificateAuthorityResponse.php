...
class CreateCertificateAuthorityResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCertificateAuthorityResponse';
    ...
    * Sets caId
    *
    * @param string|null $caId 当前签发的CA证书ID。
    *
    * @return $this
    */
