...
class DisableCertificateAuthorityCrlRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DisableCertificateAuthorityCrlRequest';
