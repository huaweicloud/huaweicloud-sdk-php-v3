...
class DistinguishedName implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DistinguishedName';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * commonName  证书通用名称（CN），名称只能由\"-\"、\"_\"、\" \"、\".\"、\",\"、\"*\"、字母、数字、汉字组成，长度不能超过64位字符。
    * country  国家编码，只能由英文组成，长度为2位字符。
    * state  省市名称，名称只能由\"-\"、\"_\"、\" \"、\".\"、\",\"、字母、数字、汉字组成，长度不能超过128位字符。
    * locality  地区名称，名称只能由\"-\"、\"_\"、\" \"、\".\"、\",\"、字母、数字、汉字组成，长度不能超过128位字符。
    * organization  组织名称，名称只能由\"-\"、\"_\"、\" \"、\".\"、\",\"、字母、数字、汉字组成，长度不能超过64位字符。
    * organizationalUnit  组织单元名称，名称只能由\"-\"、\"_\"、\" \"、\".\"、\",\"、字母、数字、汉字组成，长度不能超过64位字符。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['state'] === null) {
            ...
            if ((mb_strlen($this->container['state']) > 128)) {
        ...
        if ($this->container['organizationalUnit'] === null) {
            $invalidProperties[] = "'organizationalUnit' can't be null";
        }
            if ((mb_strlen($this->container['organizationalUnit']) > 64)) {
                $invalidProperties[] = "invalid value for 'organizationalUnit', the character length must be smaller than or equal to 64.";
            }
            if ((mb_strlen($this->container['organizationalUnit']) < 1)) {
    ...
    * Sets country
    *
    * @param string $country 国家编码，只能由英文组成，长度为2位字符。
    *
    * @return $this
    */
    ...
    * Sets state
    *
    * @param string $state 省市名称，名称只能由\"-\"、\"_\"、\" \"、\".\"、\",\"、字母、数字、汉字组成，长度不能超过128位字符。
    *
    * @return $this
    */
    ...
    * Sets locality
    *
    * @param string $locality 地区名称，名称只能由\"-\"、\"_\"、\" \"、\".\"、\",\"、字母、数字、汉字组成，长度不能超过128位字符。
    *
    * @return $this
    */
    ...
    * Sets organization
    *
    * @param string $organization 组织名称，名称只能由\"-\"、\"_\"、\" \"、\".\"、\",\"、字母、数字、汉字组成，长度不能超过64位字符。
    *
    * @return $this
    */
    ...
    *
    * @param string $organizationalUnit 组织单元名称，名称只能由\"-\"、\"_\"、\" \"、\".\"、\",\"、字母、数字、汉字组成，长度不能超过64位字符。
    *
    * @return $this
    */
