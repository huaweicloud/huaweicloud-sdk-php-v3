...
class CertificateAuthorities implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CertificateAuthorities';
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['caId'] === null) {
            $invalidProperties[] = "'caId' can't be null";
        }
            if ((mb_strlen($this->container['caId']) > 36)) {
        ...
        if ($this->container['pathLength'] === null) {
            $invalidProperties[] = "'pathLength' can't be null";
        }
            if (($this->container['pathLength'] > 6)) {
                $invalidProperties[] = "invalid value for 'pathLength', must be smaller than or equal to 6.";
            }
            if (($this->container['pathLength'] < 0)) {
        ...
        if ($this->container['crlConfiguration'] === null) {
            $invalidProperties[] = "'crlConfiguration' can't be null";
        }
    ...
    * Sets type
    *
    * @param string $type CA类型:   - **ROOT**: 根CA   - **SUBORDINATE**: 从属CA
    *
    * @return $this
    */
    ...
    * Sets status
    *
    * @param string $status CA证书状态：   - **PENDING** : 待激活，此状态下，不可用于签发证书；   - **ACTIVED** : 已激活，此状态下，可用于签发证书；   - **DISABLED** : 已禁用，此状态下，不可用于签发证书；   - **DELETED** : 计划删除，此状态下，不可用于签发证书；   - **EXPIRED** : 已过期，此状态下，不可用于签发证书。
    *
    * @return $this
    */
    ...
    * Sets pathLength
    *
    * @param int $pathLength CA路径长度。 > 注：生成的根CA证书，其路径长度不做限制，但本字段在数据库中统一置为7。从属CA的路径长度在创建时由用户指定，缺省值为0。
    *
    * @return $this
    */
    ...
    * Sets issuerId
    *
    * @param string $issuerId 父CA证书ID，即签发此证书的CA证书ID。根CA中，此参数为**null**。
    *
    * @return $this
    */
    ...
    * Sets issuerName
    *
    * @param string $issuerName 父CA证书名称。根CA中，此参数为**null**。
    *
    * @return $this
    */
    ...
    *
    * @param string $signatureAlgorithm 签名哈希算法。
    *
    * @return $this
    */
    ...
    *  crlConfiguration
    *
    * @return \HuaweiCloud\SDK\Ccm\V1\Model\ListCrlConfiguration
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Ccm\V1\Model\ListCrlConfiguration $crlConfiguration crlConfiguration
    *
    * @return $this
    */
