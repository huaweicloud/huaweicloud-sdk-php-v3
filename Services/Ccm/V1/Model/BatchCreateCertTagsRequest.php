...
class BatchCreateCertTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateCertTagsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * certificateId  所需要批量创建标签的证书ID。
    * body  body
    *
    * @var string[]
    */
