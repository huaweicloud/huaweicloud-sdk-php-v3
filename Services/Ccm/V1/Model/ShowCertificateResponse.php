...
class ShowCertificateResponse implements ModelInterface, ArrayAccess
{
    ...
    * Sets certificateId
    *
    * @param string|null $certificateId 私有证书ID。
    *
    * @return $this
    */
    ...
    * Sets status
    *
    * @param string|null $status 证书状态：   - **ISSUED** : 已签发；   - **EXPIRED** : 已过期；   - **REVOKED** : 已吊销。
    *
    * @return $this
    */
    ...
    * Sets issuerId
    *
    * @param string|null $issuerId 父CA证书ID。
    *
    * @return $this
    */
    ...
    * Sets issuerName
    *
    * @param string|null $issuerName 父CA证书名称。
    *
    * @return $this
    */
