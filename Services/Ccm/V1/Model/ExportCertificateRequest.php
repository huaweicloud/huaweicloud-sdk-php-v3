...
class ExportCertificateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExportCertificateRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * certificateId  所要导出的私有证书ID。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Ccm\V1\Model\ExportCertificateRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ccm\V1\Model\ExportCertificateRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ccm\V1\Model\ExportCertificateRequestBody|null $body body
    *
    * @return $this
    */
