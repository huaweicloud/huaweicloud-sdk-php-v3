...
class ListSubscriptionUserResponseWelinkEndpointInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSubscriptionUserResponseWelinkEndpointInfo';
