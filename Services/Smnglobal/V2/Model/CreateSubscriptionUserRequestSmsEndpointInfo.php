...
class CreateSubscriptionUserRequestSmsEndpointInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSubscriptionUserRequestSmsEndpointInfo';
