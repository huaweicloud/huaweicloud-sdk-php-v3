...
class CreateSubscriptionUserRequestFeishuEndpointInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSubscriptionUserRequestFeishuEndpointInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * endpoint  终端地址。必须是一个飞书群机器人的地址。
    * keyword  feishu协议订阅用户的关键字。feishu协议订阅用户必须指定keyword和sign_secret二者之一。当用户在飞书机器人端添加关键字校验的安全策略时，这里的关键字必须是飞书端所填写的关键字之一。
    * signSecret  feishu协议订阅用户的加签密钥字段。feishu协议订阅用户必须指定keyword和sign_secret二者之一。当用户在飞书机器人端添加关键字校验的安全策略时，这里的关键字必须是飞书端所填写的关键字之一。
    *
    * @var string[]
    */
    ...
    * Sets endpoint
    *
    * @param string $endpoint 终端地址。必须是一个飞书群机器人的地址。
    *
    * @return $this
    */
    ...
    * Sets keyword
    *
    * @param string|null $keyword feishu协议订阅用户的关键字。feishu协议订阅用户必须指定keyword和sign_secret二者之一。当用户在飞书机器人端添加关键字校验的安全策略时，这里的关键字必须是飞书端所填写的关键字之一。
    *
    * @return $this
    */
    ...
    * Sets signSecret
    *
    * @param string|null $signSecret feishu协议订阅用户的加签密钥字段。feishu协议订阅用户必须指定keyword和sign_secret二者之一。当用户在飞书机器人端添加关键字校验的安全策略时，这里的关键字必须是飞书端所填写的关键字之一。
    *
    * @return $this
    */
