...
class ListSubscriptionUserResponseHttpsEndpointInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSubscriptionUserResponseHttpsEndpointInfo';
