...
class CreateSubscriptionUserRequestDingdingEndpointInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSubscriptionUserRequestDingdingEndpointInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * endpoint  终端地址。必须是一个钉钉群机器人的地址。
    * keyword  dingding协议订阅用户的关键字。dingding协议订阅用户必须指定keyword和sign_secret二者之一。当用户在钉钉机器人端添加关键字校验的安全策略时，这里的关键字必须是钉钉端所填写的关键字之一。
    * signSecret  dingding协议订阅用户的加签密钥字段。dingding协议订阅用户必须指定keyword和sign_secret二者之一。当用户在钉钉机器人端添加关键字校验的安全策略时，这里的关键字必须是钉钉端所填写的关键字之一。
    *
    * @var string[]
    */
    ...
    * Sets endpoint
    *
    * @param string $endpoint 终端地址。必须是一个钉钉群机器人的地址。
    *
    * @return $this
    */
    ...
    * Sets keyword
    *
    * @param string|null $keyword dingding协议订阅用户的关键字。dingding协议订阅用户必须指定keyword和sign_secret二者之一。当用户在钉钉机器人端添加关键字校验的安全策略时，这里的关键字必须是钉钉端所填写的关键字之一。
    *
    * @return $this
    */
    ...
    * Sets signSecret
    *
    * @param string|null $signSecret dingding协议订阅用户的加签密钥字段。dingding协议订阅用户必须指定keyword和sign_secret二者之一。当用户在钉钉机器人端添加关键字校验的安全策略时，这里的关键字必须是钉钉端所填写的关键字之一。
    *
    * @return $this
    */
