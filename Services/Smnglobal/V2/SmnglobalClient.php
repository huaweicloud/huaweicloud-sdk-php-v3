...
class SmnglobalClient extends Client
{
    ...
    {
        $client = new ClientBuilder(new SmnglobalClient(), "GlobalCredentials");
        return $client;
    }
     ...
     * @return response
     */
    public function createSubscriptionUser($request)
    {
        return $this->createSubscriptionUserWithHttpInfo($request);
    }

    public function createSubscriptionUserWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function deleteSubscriptionUser($request)
    {
        return $this->deleteSubscriptionUserWithHttpInfo($request);
    }

    public function deleteSubscriptionUserWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function listSubscriptionUser($request)
    {
        return $this->listSubscriptionUserWithHttpInfo($request);
    }

    public function listSubscriptionUserWithHttpInfo($request)
    {
        $resourcePath = '/v2/{domain_id}/subscription-users';
        $formParams = [];
        $queryParams = [];
     ...
     * @return response
     */
    public function updateSubscriptionUser($request)
    {
        return $this->updateSubscriptionUserWithHttpInfo($request);
    }

    public function updateSubscriptionUserWithHttpInfo($request)
    {
        $resourcePath = '/v2/{domain_id}/subscription-users/{id}';
        $formParams = [];
        $queryParams = [];
