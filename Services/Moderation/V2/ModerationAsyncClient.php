...
class ModerationAsyncClient extends Client
{
     ...
     * @return response
     */
    public function runCheckResultAsync($request)
    {
        return $this->runCheckResultAsyncWithHttpInfo($request);
    }
    
    public function runCheckResultAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function runCheckTaskJobsAsync($request)
    {
        return $this->runCheckTaskJobsAsyncWithHttpInfo($request);
    }
    
    public function runCheckTaskJobsAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function runImageBatchModerationAsync($request)
    {
        return $this->runImageBatchModerationAsyncWithHttpInfo($request);
    }
    
    public function runImageBatchModerationAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v2/{project_id}/moderation/image/batch';
        $formParams = [];
        $queryParams = [];
     ...
     * @return response
     */
    public function runImageModerationAsync($request)
    {
        return $this->runImageModerationAsyncWithHttpInfo($request);
    }
    
    public function runImageModerationAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function runModerationAudioAsync($request)
    {
        return $this->runModerationAudioAsyncWithHttpInfo($request);
    }
    
    public function runModerationAudioAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function runTaskSumbitAsync($request)
    {
        return $this->runTaskSumbitAsyncWithHttpInfo($request);
    }
    
    public function runTaskSumbitAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v2/{project_id}/moderation/image/batch/jobs';
        $formParams = [];
        $queryParams = [];
