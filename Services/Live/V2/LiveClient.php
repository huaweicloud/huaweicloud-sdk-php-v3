...
class LiveClient extends Client
{
     ...
     * @return response
     */
    public function listCarouselTaskDetail($request)
    {
        return $this->listCarouselTaskDetailWithHttpInfo($request);
    }

    public function listCarouselTaskDetailWithHttpInfo($request)
    {
