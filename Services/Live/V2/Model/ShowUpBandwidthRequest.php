...
class ShowUpBandwidthRequest implements ModelInterface, ArrayAccess
{
    ...
    * publishDomains  推流域名列表，最多支持查询10个域名，多个域名以逗号分隔，若查询多个域名，则返回的是多个域名合并数据。
    * app  应用名称。
    * stream  流名。
    ...
    * endTime  结束时间。日期格式按照ISO8601表示法，并使用UTC时间。 格式为：YYYY-MM-DDThh:mm:ssZ。  若参数为空，默认为当前时间，最大查询跨度31天，最大查询周期90天。结束时间需大于起始时间。
    *
    * @var string[]
    */
    ...
    * Sets publishDomains
    *
    * @param string[] $publishDomains 推流域名列表，最多支持查询10个域名，多个域名以逗号分隔，若查询多个域名，则返回的是多个域名合并数据。
    *
    * @return $this
    */
    ...
    * Sets endTime
    *
    * @param string|null $endTime 结束时间。日期格式按照ISO8601表示法，并使用UTC时间。 格式为：YYYY-MM-DDThh:mm:ssZ。  若参数为空，默认为当前时间，最大查询跨度31天，最大查询周期90天。结束时间需大于起始时间。
    *
    * @return $this
    */
