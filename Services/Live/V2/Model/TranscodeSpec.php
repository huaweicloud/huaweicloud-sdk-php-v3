...
class TranscodeSpec implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TranscodeSpec';
    ...
    * Sets value
    *
    * @param double|null $value 采样时间点转码时长，单位为分钟，保留两位小数。
    *
    * @return $this
    */
