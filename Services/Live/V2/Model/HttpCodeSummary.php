...
class HttpCodeSummary implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'HttpCodeSummary';
    ...
    */
    protected static $openAPITypes = [
            'httpCodes' => '\HuaweiCloud\SDK\Live\V2\Model\HttpCode[]',
            'time' => 'string'
    ];
    ...
    */
    ...
    {
        $this->container['httpCodes'] = isset($data['httpCodes']) ? $data['httpCodes'] : null;
    ...
    *  状态码信息
    *
    * @return \HuaweiCloud\SDK\Live\V2\Model\HttpCode[]|null
    */
    public function getHttpCodes()
    {
        return $this->container['httpCodes'];
    }

    /**
    * Sets httpCodes
    *
    * @param \HuaweiCloud\SDK\Live\V2\Model\HttpCode[]|null $httpCodes 状态码信息
    *
    * @return $this
    */
    public function setHttpCodes($httpCodes)
    {
        $this->container['httpCodes'] = $httpCodes;
        return $this;
    }
