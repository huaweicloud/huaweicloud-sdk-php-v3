...
class ModifyFlowOutputRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ModifyFlowOutputRequest';
    ...
    */
    protected static $openAPITypes = [
            'flowId' => 'string',
            'outputName' => 'string',
            'body' => '\HuaweiCloud\SDK\Live\V1\Model\UpdateFlowOutputRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Live\V1\Model\UpdateFlowOutputRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Live\V1\Model\UpdateFlowOutputRequestBody|null $body body
    *
    * @return $this
    */
