...
class SetRefererChainInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SetRefererChainInfo';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['guardSwitch'] === null) {
            $invalidProperties[] = "'guardSwitch' can't be null";
        }
    ...
    * Sets guardSwitch
    *
    * @param string $guardSwitch referer防盗链开关：true表示开启；false表示关闭
    *
    * @return $this
    */
