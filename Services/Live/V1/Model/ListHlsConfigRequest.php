...
class ListHlsConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListHlsConfigRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pushDomain'] === null) {
            ...
            if ((mb_strlen($this->container['pushDomain']) > 512)) {
                $invalidProperties[] = "invalid value for 'pushDomain', the character length must be smaller than or equal to 512.";
            }
