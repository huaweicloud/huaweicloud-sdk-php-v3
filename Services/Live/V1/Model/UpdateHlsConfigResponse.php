...
class UpdateHlsConfigResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateHlsConfigResponse';
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['pushDomain']) && (mb_strlen($this->container['pushDomain']) > 255)) {
    ...
    * Sets pushDomain
    *
    * @param string|null $pushDomain 推流域名
    *
    * @return $this
    */
    ...
    *  推流域名APP配置
    *
    * @return \HuaweiCloud\SDK\Live\V1\Model\PushDomainApplication[]|null
    */
    ...
    * Sets application
    *
    * @param \HuaweiCloud\SDK\Live\V1\Model\PushDomainApplication[]|null $application 推流域名APP配置
    *
    * @return $this
    */
