...
class ModifyFlowSourcesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ModifyFlowSourcesRequest';
    ...
    */
    protected static $openAPITypes = [
            'flowId' => 'string',
            'sourceName' => 'string',
            'body' => '\HuaweiCloud\SDK\Live\V1\Model\ModifyFlowSourcesRequestBody'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sourceName'] === null) {
            ...
            if ((mb_strlen($this->container['sourceName']) > 64)) {
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Live\V1\Model\ModifyFlowSourcesRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Live\V1\Model\ModifyFlowSourcesRequestBody|null $body body
    *
    * @return $this
    */
