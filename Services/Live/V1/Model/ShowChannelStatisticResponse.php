...
class ShowChannelStatisticResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowChannelStatisticResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'id' => 'string',
            'type' => 'string',
            'scte35' => '\HuaweiCloud\SDK\Live\V1\Model\SCTE35StatisticRsp'
    ];
    ...
    * Sets type
    *
    * @param string|null $type 统计信息的类型，scte35。
    *
    * @return $this
    */
    ...
    *  scte35
    *
    * @return \HuaweiCloud\SDK\Live\V1\Model\SCTE35StatisticRsp|null
    */
    ...
    * Sets scte35
    *
    * @param \HuaweiCloud\SDK\Live\V1\Model\SCTE35StatisticRsp|null $scte35 scte35
    *
    * @return $this
    */
