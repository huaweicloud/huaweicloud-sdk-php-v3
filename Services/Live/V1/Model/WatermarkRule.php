...
class WatermarkRule implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'WatermarkRule';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['templateId'] === null) {
            ...
            if ((mb_strlen($this->container['templateId']) > 255)) {
    ...
    * Sets templateId
    *
    * @param string $templateId 水印模板ID，只包含数字字母中划线，创建模板时生成
    *
    * @return $this
    */
