...
class StreamForbiddenOnceSetting implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StreamForbiddenOnceSetting';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['streamName'] === null) {
            ...
            if ((mb_strlen($this->container['streamName']) > 512)) {
