...
class CreateHarvestTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateHarvestTaskRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Live\V1\Model\CreateHarvestTaskInfoReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Live\V1\Model\CreateHarvestTaskInfoReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Live\V1\Model\CreateHarvestTaskInfoReq|null $body body
    *
    * @return $this
    */
