...
class ScheduleRecordTasksReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ScheduleRecordTasksReq';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['templateId'] === null) {
            ...
            if ((mb_strlen($this->container['templateId']) > 128)) {
