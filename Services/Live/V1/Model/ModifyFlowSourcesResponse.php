...
class ModifyFlowSourcesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ModifyFlowSourcesResponse';
    ...
    */
    protected static $openAPITypes = [
            'flowId' => 'string',
            'source' => '\HuaweiCloud\SDK\Live\V1\Model\FlowSource'
    ];
    ...
    *  source
    *
    * @return \HuaweiCloud\SDK\Live\V1\Model\FlowSource|null
    */
    ...
    * Sets source
    *
    * @param \HuaweiCloud\SDK\Live\V1\Model\FlowSource|null $source source
    *
    * @return $this
    */
