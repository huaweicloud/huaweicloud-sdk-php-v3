...
class UpdateHarvestJobStatusResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateHarvestJobStatusResponse';
    ...
    * Sets startTime
    *
    * @param int|null $startTime 开始时间。Unix时间错，单位为秒
    *
    * @return $this
    */
    ...
    * Sets endTime
    *
    * @param int|null $endTime 结束时间。Unix时间错，单位为秒
    *
    * @return $this
    */
    ...
    * Sets status
    *
    * @param string|null $status 任务状态，取值为 [ UNSTART、IN_PROGRESS、SUCCEEDED、FAILED ]
    *
    * @return $this
    */
    ...
    * Sets maxRetryCnt
    *
    * @param int|null $maxRetryCnt 任务状态为FAILED时，最大允许重试的次数
    *
    * @return $this
    */
