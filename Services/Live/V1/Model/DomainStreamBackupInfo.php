...
class DomainStreamBackupInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DomainStreamBackupInfo';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['publishDomain'] === null) {
            ...
            if ((mb_strlen($this->container['publishDomain']) > 255)) {
        ...
        if ($this->container['streamBackupEnable'] === null) {
            $invalidProperties[] = "'streamBackupEnable' can't be null";
        }
    ...
    *
    * @param bool $streamBackupEnable **参数解释**： 主备流开关 **约束限制**： 不涉及 **取值范围**： - true： 开启主备流功能 - false：关闭主备流功能 **默认取值**： false
    *
    * @return $this
    */
