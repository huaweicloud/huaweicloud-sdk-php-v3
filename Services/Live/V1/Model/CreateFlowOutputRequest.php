...
class CreateFlowOutputRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateFlowOutputRequest';
    ...
    */
    protected static $openAPITypes = [
            'flowId' => 'string',
            'body' => '\HuaweiCloud\SDK\Live\V1\Model\AddFlowOutputsRequest[]'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Live\V1\Model\AddFlowOutputsRequest[]|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Live\V1\Model\AddFlowOutputsRequest[]|null $body body
    *
    * @return $this
    */
