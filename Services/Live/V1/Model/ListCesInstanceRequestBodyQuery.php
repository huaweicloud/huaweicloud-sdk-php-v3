...
class ListCesInstanceRequestBodyQuery implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCesInstanceRequestBody_query';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['dimName'] === null) {
            ...
            if ((mb_strlen($this->container['dimName']) > 256)) {
                $invalidProperties[] = "invalid value for 'dimName', the character length must be smaller than or equal to 256.";
            }
            if ((mb_strlen($this->container['dimName']) < 1)) {
