...
class DeleteFlowOutputResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteFlowOutputResponse';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['outputName']) && (mb_strlen($this->container['outputName']) > 64)) {
    ...
    * Sets outputName
    *
    * @param string|null $outputName 输出名称
    *
    * @return $this
    */
