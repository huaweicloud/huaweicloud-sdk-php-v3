...
class ModifyFlowOutputResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ModifyFlowOutputResponse';
    ...
    * listenerAddress  srt-listener模式，监听地址，不支持修改
    ...
    * healthStatus  转推流状态，CONNECTED：转推中，DISCONNECTED：转推中断
    * type  输出类型
    *
    * @var string[]
    */
    ...
    */
    protected static $setters = [
            ...
            'listenerAddress' => 'setListenerAddress',
            'port' => 'setPort',
    ...
    */
    protected static $getters = [
            ...
            'listenerAddress' => 'getListenerAddress',
            'port' => 'getPort',
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['listenerAddress'] = isset($data['listenerAddress']) ? $data['listenerAddress'] : null;
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['listenerAddress']) && (mb_strlen($this->container['listenerAddress']) > 15)) {
                $invalidProperties[] = "invalid value for 'listenerAddress', the character length must be smaller than or equal to 15.";
            }
            if (!is_null($this->container['listenerAddress']) && (mb_strlen($this->container['listenerAddress']) < 7)) {
                $invalidProperties[] = "invalid value for 'listenerAddress', the character length must be bigger than or equal to 7.";
            }
    ...
    * Sets name
    *
    * @param string|null $name output名称，有效字符：大小写字母，数字，中划线，下划线;且只能以字母开头
    *
    * @return $this
    */
    ...
    */
    ...
    /**
    * Gets listenerAddress
    *  srt-listener模式，监听地址，不支持修改
    *
    * @return string|null
    */
    public function getListenerAddress()
    {
        return $this->container['listenerAddress'];
    }

    /**
    * Sets listenerAddress
    *
    * @param string|null $listenerAddress srt-listener模式，监听地址，不支持修改
    *
    * @return $this
    */
    public function setListenerAddress($listenerAddress)
    {
        $this->container['listenerAddress'] = $listenerAddress;
        return $this;
    }
    ...
    * Sets protocol
    *
    * @param string|null $protocol 协议，srt-caller，srt-listener
    *
    * @return $this
    */
    ...
    * Sets healthStatus
    *
    * @param string|null $healthStatus 转推流状态，CONNECTED：转推中，DISCONNECTED：转推中断
    *
    * @return $this
    */
