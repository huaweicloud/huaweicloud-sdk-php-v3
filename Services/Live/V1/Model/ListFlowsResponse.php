...
class ListFlowsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListFlowsResponse';
    ...
    */
    protected static $openAPITypes = [
            'total' => 'int',
            'flows' => '\HuaweiCloud\SDK\Live\V1\Model\ListFlowRespItem[]'
    ];
    ...
    *  流列表
    *
    * @return \HuaweiCloud\SDK\Live\V1\Model\ListFlowRespItem[]|null
    */
    ...
    * Sets flows
    *
    * @param \HuaweiCloud\SDK\Live\V1\Model\ListFlowRespItem[]|null $flows 流列表
    *
    * @return $this
    */
