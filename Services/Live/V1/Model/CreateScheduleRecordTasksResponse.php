...
class CreateScheduleRecordTasksResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateScheduleRecordTasksResponse';
    ...
    * Sets taskId
    *
    * @param string|null $taskId 创建成功的任务ID
    *
    * @return $this
    */
