...
class ListRecordConfigsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRecordConfigsRequest';
    ...
    * recordType  录制类型 configer_record：按照配置录制
    *
    * @var string[]
    */
    ...
    * Sets appName
    *
    * @param string|null $appName 流应用名称
    *
    * @return $this
    */
    ...
    * Sets recordType
    *
    * @param string|null $recordType 录制类型 configer_record：按照配置录制
    *
    * @return $this
    */
