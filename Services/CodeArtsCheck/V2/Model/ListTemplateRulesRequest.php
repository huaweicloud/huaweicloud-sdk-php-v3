...
class ListTemplateRulesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListTemplateRulesRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * projectId  项目ID
    * rulesetId  规则集ID
    * types  规则状态  '1查询全部，2已启动，3未启用'
    * languages  规则语言
    * tags  规则所属标签
    * offset  分页索引，偏移量
    * limit  每页显示的数量
    ...
    * Sets languages
    *
    * @param string|null $languages 规则语言
    *
    * @return $this
    */
