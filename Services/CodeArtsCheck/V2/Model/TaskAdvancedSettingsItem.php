...
class TaskAdvancedSettingsItem implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TaskAdvancedSettingsItem';
