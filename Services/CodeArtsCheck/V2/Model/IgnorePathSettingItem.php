...
class IgnorePathSettingItem implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'IgnorePathSettingItem';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['checkboxStatus'] === null) {
            $invalidProperties[] = "'checkboxStatus' can't be null";
        }
    ...
    * Sets checkboxStatus
    *
    * @param string $checkboxStatus 屏蔽状态，包括unchecked(不屏蔽)、all(全屏蔽)、half(半屏蔽)
    *
    * @return $this
    */
