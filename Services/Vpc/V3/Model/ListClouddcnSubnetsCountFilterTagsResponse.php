...
class ListClouddcnSubnetsCountFilterTagsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListClouddcnSubnetsCountFilterTagsResponse';
