...
class ShowVirsubnetResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowVirsubnetResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'virsubnet' => '\HuaweiCloud\SDK\Vpc\V3\Model\Virsubnet'
    ];
    ...
    * Sets virsubnet
    *
    * @param \HuaweiCloud\SDK\Vpc\V3\Model\Virsubnet|null $virsubnet virsubnet
    *
    * @return $this
    */
