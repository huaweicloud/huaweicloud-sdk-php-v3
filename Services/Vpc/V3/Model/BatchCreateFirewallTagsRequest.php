...
class BatchCreateFirewallTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateFirewallTagsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * firewallId  功能说明：ACL唯一标识 取值范围：合法UUID 约束：ID对应的ACL必须存在
    * projectId  项目ID
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'firewallId' => 'string',
            'projectId' => 'string',
            'body' => '\HuaweiCloud\SDK\Vpc\V3\Model\BatchCreateFirewallTagsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpc\V3\Model\BatchCreateFirewallTagsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpc\V3\Model\BatchCreateFirewallTagsRequestBody|null $body body
    *
    * @return $this
    */
