...
class CreatePortTagRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePortTagRequest';
    ...
    */
    protected static $openAPITypes = [
            'portId' => 'string',
            'projectId' => 'string',
            'body' => '\HuaweiCloud\SDK\Vpc\V3\Model\CreatePortTagRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpc\V3\Model\CreatePortTagRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpc\V3\Model\CreatePortTagRequestBody|null $body body
    *
    * @return $this
    */
