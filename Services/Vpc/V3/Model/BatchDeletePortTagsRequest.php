...
class BatchDeletePortTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeletePortTagsRequest';
    ...
    */
    protected static $openAPITypes = [
            'portId' => 'string',
            'projectId' => 'string',
            'body' => '\HuaweiCloud\SDK\Vpc\V3\Model\BatchDeletePortTagsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpc\V3\Model\BatchDeletePortTagsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpc\V3\Model\BatchDeletePortTagsRequestBody|null $body body
    *
    * @return $this
    */
