...
class CreateClouddcnSubnetRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateClouddcnSubnetRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'clouddcnSubnet' => '\HuaweiCloud\SDK\Vpc\V3\Model\CreateClouddcnSubnetOption'
    ];
    ...
    *  clouddcnSubnet
    *
    * @return \HuaweiCloud\SDK\Vpc\V3\Model\CreateClouddcnSubnetOption
    */
    ...
    * Sets clouddcnSubnet
    *
    * @param \HuaweiCloud\SDK\Vpc\V3\Model\CreateClouddcnSubnetOption $clouddcnSubnet clouddcnSubnet
    *
    * @return $this
    */
