...
class CreateClouddcnSubnetResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateClouddcnSubnetResponse';
    ...
    */
    protected static $openAPITypes = [
            'clouddcnSubnet' => '\HuaweiCloud\SDK\Vpc\V3\Model\ClouddcnSubnet'
    ];
    ...
    * Sets clouddcnSubnet
    *
    * @param \HuaweiCloud\SDK\Vpc\V3\Model\ClouddcnSubnet|null $clouddcnSubnet clouddcnSubnet
    *
    * @return $this
    */
