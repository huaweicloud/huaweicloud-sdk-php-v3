...
class UpdateVirsubnetCidrReservationOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateVirsubnetCidrReservationOption';
