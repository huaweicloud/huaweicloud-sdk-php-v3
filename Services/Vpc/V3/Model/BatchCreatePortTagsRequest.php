...
class BatchCreatePortTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreatePortTagsRequest';
    ...
    */
    protected static $openAPITypes = [
            'portId' => 'string',
            'projectId' => 'string',
            'body' => '\HuaweiCloud\SDK\Vpc\V3\Model\BatchCreatePortTagsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpc\V3\Model\BatchCreatePortTagsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpc\V3\Model\BatchCreatePortTagsRequestBody|null $body body
    *
    * @return $this
    */
