...
class DeleteResourceTagRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteResourceTagRequestBody';
    ...
    * Sets value
    *
    * @param string|null $value 功能说明：标签值
    *
    * @return $this
    */
