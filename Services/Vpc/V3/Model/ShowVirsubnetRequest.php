...
class ShowVirsubnetRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowVirsubnetRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * projectId  **参数解释**： 子网所属的项目ID。 **取值范围**： 不涉及。
    * virsubnetId  **参数解释**： 子网的资源ID。 **取值范围**： 不涉及。
    *
    * @var string[]
    */
