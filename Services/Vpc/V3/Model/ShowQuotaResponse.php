...
class ShowQuotaResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'quota' => '\HuaweiCloud\SDK\Vpc\V3\Model\VpcQuotas',
            'requestId' => 'string'
    ];
    ...
    *  quota
    *
    * @return \HuaweiCloud\SDK\Vpc\V3\Model\VpcQuotas|null
    */
    ...
    * Sets quota
    *
    * @param \HuaweiCloud\SDK\Vpc\V3\Model\VpcQuotas|null $quota quota
    *
    * @return $this
    */
