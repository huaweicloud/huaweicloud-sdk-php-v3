...
class UpdateClouddcnSubnetOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateClouddcnSubnetOption';
    ...
    * Sets name
    *
    * @param string|null $name 功能说明：子网名称 取值范围：1-64，支持数字、字母、中文、_(下划线)、-（中划线）、.（点）
    *
    * @return $this
    */
