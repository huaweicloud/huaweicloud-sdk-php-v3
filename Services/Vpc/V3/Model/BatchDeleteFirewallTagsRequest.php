...
class BatchDeleteFirewallTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteFirewallTagsRequest';
    ...
    */
    protected static $openAPITypes = [
            'firewallId' => 'string',
            'projectId' => 'string',
            'body' => '\HuaweiCloud\SDK\Vpc\V3\Model\BatchDeleteFirewallTagsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpc\V3\Model\BatchDeleteFirewallTagsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpc\V3\Model\BatchDeleteFirewallTagsRequestBody|null $body body
    *
    * @return $this
    */
