...
class ListClouddcnSubnetsFilterTagsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListClouddcnSubnetsFilterTagsResponse';
    ...
    */
    protected static $openAPITypes = [
            'resources' => '\HuaweiCloud\SDK\Vpc\V3\Model\ClouddcnResource[]',
            'totalCount' => 'int',
            'requestId' => 'string'
    ];
    ...
    *  资源列表
    *
    * @return \HuaweiCloud\SDK\Vpc\V3\Model\ClouddcnResource[]|null
    */
    ...
    * Sets resources
    *
    * @param \HuaweiCloud\SDK\Vpc\V3\Model\ClouddcnResource[]|null $resources 资源列表
    *
    * @return $this
    */
