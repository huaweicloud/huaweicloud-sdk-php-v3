...
class CountSubNetworkInterfacesByTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CountSubNetworkInterfacesByTagsRequest';
    ...
    */
    protected static $openAPITypes = [
            'projectId' => 'string',
            'body' => '\HuaweiCloud\SDK\Vpc\V3\Model\CountSubNetworkInterfacesByTagsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpc\V3\Model\CountSubNetworkInterfacesByTagsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpc\V3\Model\CountSubNetworkInterfacesByTagsRequestBody|null $body body
    *
    * @return $this
    */
