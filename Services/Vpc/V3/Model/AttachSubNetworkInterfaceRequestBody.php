...
class AttachSubNetworkInterfaceRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AttachSubNetworkInterfaceRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * dryRun  **参数解释**： 是否只预检此次请求。 **约束限制**： 不涉及。 **取值范围**： - true：发送检查请求，不会挂载辅助弹性网卡。检查项包括是否填写了必需参数、请求格式、业务限制。如果检查不通过，则返回对应错误。如果检查通过，则返回响应码202。 - false：发送正常请求，并直接挂载辅助弹性网卡。 **默认取值**： false
    ...
    */
    protected static $openAPITypes = [
            'dryRun' => 'bool',
            'subNetworkInterface' => '\HuaweiCloud\SDK\Vpc\V3\Model\AttachSubNetworkInterfaceOption'
    ];
    ...
    * Sets dryRun
    *
    * @param bool|null $dryRun **参数解释**： 是否只预检此次请求。 **约束限制**： 不涉及。 **取值范围**： - true：发送检查请求，不会挂载辅助弹性网卡。检查项包括是否填写了必需参数、请求格式、业务限制。如果检查不通过，则返回对应错误。如果检查通过，则返回响应码202。 - false：发送正常请求，并直接挂载辅助弹性网卡。 **默认取值**： false
    *
    * @return $this
    */
    ...
    *  subNetworkInterface
    *
    * @return \HuaweiCloud\SDK\Vpc\V3\Model\AttachSubNetworkInterfaceOption|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Vpc\V3\Model\AttachSubNetworkInterfaceOption|null $subNetworkInterface subNetworkInterface
    *
    * @return $this
    */
