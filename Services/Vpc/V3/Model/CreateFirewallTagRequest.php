...
class CreateFirewallTagRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateFirewallTagRequest';
    ...
    */
    protected static $openAPITypes = [
            'firewallId' => 'string',
            'projectId' => 'string',
            'body' => '\HuaweiCloud\SDK\Vpc\V3\Model\CreateFirewallTagRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpc\V3\Model\CreateFirewallTagRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpc\V3\Model\CreateFirewallTagRequestBody|null $body body
    *
    * @return $this
    */
