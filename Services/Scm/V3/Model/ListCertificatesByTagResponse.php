...
class ListCertificatesByTagResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCertificatesByTagResponse';
    ...
    */
    protected static $openAPITypes = [
            'totalCount' => 'int',
            'resources' => '\HuaweiCloud\SDK\Scm\V3\Model\TagResource[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Scm\V3\Model\TagResource[]|null
    */
    ...
    * Sets resources
    *
    * @param \HuaweiCloud\SDK\Scm\V3\Model\TagResource[]|null $resources 资源实例列表，详情请参见TagResource字段数据结构说明。
    *
    * @return $this
    */
