...
class NoticeRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NoticeRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * resourceId  资源ID。
    * noticeType  提醒类型，取值如下： - CERT_EXPIRING(证书到期) - CERT_EXPIRED(证书过期)
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['resourceId']) && (mb_strlen($this->container['resourceId']) < 3)) {
                $invalidProperties[] = "invalid value for 'resourceId', the character length must be bigger than or equal to 3.";
            }
    ...
    * Sets noticeType
    *
    * @param string[]|null $noticeType 提醒类型，取值如下： - CERT_EXPIRING(证书到期) - CERT_EXPIRED(证书过期)
    *
    * @return $this
    */
