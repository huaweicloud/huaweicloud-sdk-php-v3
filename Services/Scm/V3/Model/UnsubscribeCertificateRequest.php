...
class UnsubscribeCertificateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UnsubscribeCertificateRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['certId'] === null) {
            ...
            if ((mb_strlen($this->container['certId']) > 16)) {
