...
class BatchPushCertificateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchPushCertificateRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Scm\V3\Model\BatchPushCertificateRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Scm\V3\Model\BatchPushCertificateRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Scm\V3\Model\BatchPushCertificateRequestBody|null $body body
    *
    * @return $this
    */
