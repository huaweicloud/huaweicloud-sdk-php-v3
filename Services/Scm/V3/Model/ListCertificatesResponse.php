...
class ListCertificatesResponse implements ModelInterface, ArrayAccess
{
    ...
    * certificates  证书列表，详情请参见CertificateDetail字段数据结构说明。
    * totalCount  证书数量。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'certificates' => '\HuaweiCloud\SDK\Scm\V3\Model\CertificateDetail[]',
            'totalCount' => 'int'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Scm\V3\Model\CertificateDetail[]|null
    */
    ...
    * Sets certificates
    *
    * @param \HuaweiCloud\SDK\Scm\V3\Model\CertificateDetail[]|null $certificates 证书列表，详情请参见CertificateDetail字段数据结构说明。
    *
    * @return $this
    */
    ...
    * Sets totalCount
    *
    * @param int|null $totalCount 证书数量。
    *
    * @return $this
    */
