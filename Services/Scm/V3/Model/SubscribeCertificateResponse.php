...
class SubscribeCertificateResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SubscribeCertificateResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * orderId  订单号。
    * cert  证书列表，详情请参见CertDetail字段数据结构说明。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'orderId' => 'string',
            'cert' => '\HuaweiCloud\SDK\Scm\V3\Model\CertDetail[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Scm\V3\Model\CertDetail[]|null
    */
    ...
    * Sets cert
    *
    * @param \HuaweiCloud\SDK\Scm\V3\Model\CertDetail[]|null $cert 证书列表，详情请参见CertDetail字段数据结构说明。
    *
    * @return $this
    */
