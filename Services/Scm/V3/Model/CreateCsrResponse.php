...
class CreateCsrResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCsrResponse';
    ...
    * companyCountry  国家，当“usage”取值为“ENTERPRISE”时，本参数必填。
    * companyProvince  省份，当“usage”取值为“ENTERPRISE”时，本参数必填。
    * companyCity  城市，当“usage”取值为“ENTERPRISE”时，本参数必填。
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['privateKeyAlgo']) && (mb_strlen($this->container['privateKeyAlgo']) > 63)) {
            ...
            if (!is_null($this->container['usage']) && (mb_strlen($this->container['usage']) > 255)) {
    ...
    * Sets name
    *
    * @param string|null $name 自定义CSR名称。
    *
    * @return $this
    */
    ...
    * Sets usage
    *
    * @param string|null $usage CSR用途。取值如下： - PERSONAL：个人证书 - ENTERPRISE：企业证书
    *
    * @return $this
    */
    ...
    * Sets companyCountry
    *
    * @param string|null $companyCountry 国家，当“usage”取值为“ENTERPRISE”时，本参数必填。
    *
    * @return $this
    */
    ...
    *
    * @param string|null $companyProvince 省份，当“usage”取值为“ENTERPRISE”时，本参数必填。
    *
    * @return $this
    */
    ...
    * Sets companyCity
    *
    * @param string|null $companyCity 城市，当“usage”取值为“ENTERPRISE”时，本参数必填。
    *
    * @return $this
    */
