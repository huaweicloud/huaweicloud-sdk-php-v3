...
class CancelCertificateRequestResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CancelCertificateRequestResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * certId  证书ID。
    * message  执行结果。取值如下： success：申请成功。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['message']) && (mb_strlen($this->container['message']) > 16)) {
                $invalidProperties[] = "invalid value for 'message', the character length must be smaller than or equal to 16.";
            }
    ...
    * Sets message
    *
    * @param string|null $message 执行结果。取值如下： success：申请成功。
    *
    * @return $this
    */
