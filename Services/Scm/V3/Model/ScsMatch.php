...
class ScsMatch implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ScsMatch';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * key  标签键。 可用 UTF-8 格式表示的字母(包含中文、西班牙语、葡语等)、数字和空格，以及以下字符： _ . : = + - @
    * value  标签值。 可用 UTF-8 格式表示的字母(包含中文、西班牙语、葡语等)、数字和空格，以及以下字符： _ . : / = + - @
    *
    * @var string[]
    */
    ...
    * Sets value
    *
    * @param string|null $value 标签值。 可用 UTF-8 格式表示的字母(包含中文、西班牙语、葡语等)、数字和空格，以及以下字符： _ . : / = + - @
    *
    * @return $this
    */
