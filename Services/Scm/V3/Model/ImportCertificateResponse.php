...
class ImportCertificateResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImportCertificateResponse';
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['certificateId']) && (mb_strlen($this->container['certificateId']) > 16)) {
