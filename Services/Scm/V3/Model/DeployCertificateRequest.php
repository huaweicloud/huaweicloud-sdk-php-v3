...
class DeployCertificateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeployCertificateRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Scm\V3\Model\DeployCertificateRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Scm\V3\Model\DeployCertificateRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Scm\V3\Model\DeployCertificateRequestBody|null $body body
    *
    * @return $this
    */
