...
class UploadCsrRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UploadCsrRequestBody';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['csr'] === null) {
            ...
            if ((mb_strlen($this->container['csr']) > 2555)) {
                $invalidProperties[] = "invalid value for 'csr', the character length must be smaller than or equal to 2555.";
            }
            if ((mb_strlen($this->container['csr']) < 0)) {
                $invalidProperties[] = "invalid value for 'csr', the character length must be bigger than or equal to 0.";
            }
            if (!is_null($this->container['privateKey']) && (mb_strlen($this->container['privateKey']) > 63)) {
                $invalidProperties[] = "invalid value for 'privateKey', the character length must be smaller than or equal to 63.";
            }
    ...
    * Sets privateKey
    *
    * @param string|null $privateKey 证书私钥文件。
    *
    * @return $this
    */
