...
class ShowControlsForOrganizationalUnitRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowControlsForOrganizationalUnitRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['controlId'] === null) {
            ...
            if (!preg_match("/^[a-zA-Z0-9-_]+$/", $this->container['controlId'])) {
