...
class ShowComplianceStatusForAccountResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowComplianceStatusForAccountResponse';
