...
class OrganizationStructureBaseLine implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'OrganizationStructureBaseLine';
    ...
    */
    protected static $openAPITypes = [
            ...
            'accounts' => '\HuaweiCloud\SDK\Rgc\V1\Model\AccountBaseline[]'
    ];
    ...
    *  纳管账号基本信息。
    *
    * @return \HuaweiCloud\SDK\Rgc\V1\Model\AccountBaseline[]|null
    */
    ...
    * Sets accounts
    *
    * @param \HuaweiCloud\SDK\Rgc\V1\Model\AccountBaseline[]|null $accounts 纳管账号基本信息。
    *
    * @return $this
    */
