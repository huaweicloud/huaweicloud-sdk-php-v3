...
class ShowControlOperateRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowControlOperateRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * operationControlStatusId  操作控制策略的请求ID。
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['operationControlStatusId'] === null) {
            $invalidProperties[] = "'operationControlStatusId' can't be null";
        }
            if ((mb_strlen($this->container['operationControlStatusId']) > 36)) {
                $invalidProperties[] = "invalid value for 'operationControlStatusId', the character length must be smaller than or equal to 36.";
            }
            if ((mb_strlen($this->container['operationControlStatusId']) < 1)) {
