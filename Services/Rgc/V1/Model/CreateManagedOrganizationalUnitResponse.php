...
class CreateManagedOrganizationalUnitResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateManagedOrganizationalUnitResponse';
