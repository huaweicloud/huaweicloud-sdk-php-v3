...
class ListExternalConfigRuleCompliancesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListExternalConfigRuleCompliancesRequest';
