...
class ShowManagedOrganizationalUnitResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowManagedOrganizationalUnitResponse';
    ...
    * Sets message
    *
    * @param string|null $message 错误信息描述。
    *
    * @return $this
    */
