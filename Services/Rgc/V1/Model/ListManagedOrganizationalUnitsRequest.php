...
class ListManagedOrganizationalUnitsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListManagedOrganizationalUnitsRequest';
