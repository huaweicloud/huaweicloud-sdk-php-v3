...
class ListControlsForOrganizationalUnitRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListControlsForOrganizationalUnitRequest';
