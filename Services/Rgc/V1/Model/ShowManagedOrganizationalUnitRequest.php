...
class ShowManagedOrganizationalUnitRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowManagedOrganizationalUnitRequest';
