...
class DeleteManagedOrganizationalUnitsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteManagedOrganizationalUnitsRequest';
