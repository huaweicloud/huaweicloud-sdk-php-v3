...
class ShowOperationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowOperationRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['operationId'] === null) {
            ...
            if ((mb_strlen($this->container['operationId']) > 36)) {
                $invalidProperties[] = "invalid value for 'operationId', the character length must be smaller than or equal to 36.";
            }
            if ((mb_strlen($this->container['operationId']) < 1)) {
