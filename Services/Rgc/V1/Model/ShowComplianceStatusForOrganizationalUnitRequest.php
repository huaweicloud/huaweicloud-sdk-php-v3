...
class ShowComplianceStatusForOrganizationalUnitRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowComplianceStatusForOrganizationalUnitRequest';
