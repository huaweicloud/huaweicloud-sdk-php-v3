...
class OrganizationalPercentageDetail implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'OrganizationalPercentageDetail';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * percentageName  进度名称。
    * percentageStatus  创建账号、注册OU、纳管账号的进度完成状态。
    *
    * @var string[]
    */
    ...
    *
    * @param string|null $percentageStatus 创建账号、注册OU、纳管账号的进度完成状态。
    *
    * @return $this
    */
