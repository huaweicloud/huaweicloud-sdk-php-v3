...
class ListControlsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListControlsResponse';
    ...
    */
    protected static $openAPITypes = [
            'controls' => '\HuaweiCloud\SDK\Rgc\V1\Model\Control[]',
    ...
    *  控制策略信息。
    *
    * @return \HuaweiCloud\SDK\Rgc\V1\Model\Control[]|null
    */
    ...
    * Sets controls
    *
    * @param \HuaweiCloud\SDK\Rgc\V1\Model\Control[]|null $controls 控制策略信息。
    *
    * @return $this
    */
