...
class UpdateBandwidthRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * bandWidthSize  - 小于等于300Mbit/s：默认最小增长步长为1Mbit/s。 - 300Mbit/s~1000Mbit/s：默认最小增长步长为50Mbit/s。 - 大于1000Mbit/s：默认最小增长步长为500Mbit/s。
    *
    * @var string[]
    */
    ...
    * Sets bandWidthSize
    *
    * @param int $bandWidthSize - 小于等于300Mbit/s：默认最小增长步长为1Mbit/s。 - 300Mbit/s~1000Mbit/s：默认最小增长步长为50Mbit/s。 - 大于1000Mbit/s：默认最小增长步长为500Mbit/s。
    *
    * @return $this
    */
