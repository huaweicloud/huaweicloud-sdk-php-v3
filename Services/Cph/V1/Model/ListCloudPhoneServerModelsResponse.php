...
class ListCloudPhoneServerModelsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCloudPhoneServerModelsResponse';
    ...
    *  云手机服务器的规格信息。
    *
    * @return \HuaweiCloud\SDK\Cph\V1\Model\ServerModel[]|null
    */
    public function getServerModels()
    {
        return $this->container['serverModels'];
    }

    /**
    * Sets serverModels
    *
    * @param \HuaweiCloud\SDK\Cph\V1\Model\ServerModel[]|null $serverModels 云手机服务器的规格信息。
    *
    * @return $this
    */
