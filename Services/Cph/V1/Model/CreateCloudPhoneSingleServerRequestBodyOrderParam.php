...
class CreateCloudPhoneSingleServerRequestBodyOrderParam implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCloudPhoneSingleServerRequestBody_order_param';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * chargingMode  计费类型。 0：包周期
    * periodType  订购周期类型。 2：月 3：年
    * periodNum  订购周期数。 当订购周期为月时，取值范围[1, 9]。 当订购周期为年时，取值范围[1,10]。
    * isAutoPay  是否自动付款。默认不自动付款。 0：不自动付款 1：自动付款
    * isAutoRenew  是否自动续订。默认不自动续订。 0：不自动续订 1：自动续订
    *
    * @var string[]
    */
    ...
    * Sets chargingMode
    *
    * @param int $chargingMode 计费类型。 0：包周期
    *
    * @return $this
    */
    ...
    * Sets isAutoPay
    *
    * @param int|null $isAutoPay 是否自动付款。默认不自动付款。 0：不自动付款 1：自动付款
    *
    * @return $this
    */
    ...
    * Sets isAutoRenew
    *
    * @param int|null $isAutoRenew 是否自动续订。默认不自动续订。 0：不自动续订 1：自动续订
    *
    * @return $this
    */
