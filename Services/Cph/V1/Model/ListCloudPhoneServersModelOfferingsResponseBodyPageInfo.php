...
class ListCloudPhoneServersModelOfferingsResponseBodyPageInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCloudPhoneServersModelOfferingsResponseBody_page_info';
