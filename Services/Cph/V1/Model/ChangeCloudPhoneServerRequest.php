...
class ChangeCloudPhoneServerRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeCloudPhoneServerRequest';
    ...
    */
    protected static $openAPITypes = [
            'serverId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cph\V1\Model\ChangeCloudPhoneServerRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cph\V1\Model\ChangeCloudPhoneServerRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cph\V1\Model\ChangeCloudPhoneServerRequestBody|null $body body
    *
    * @return $this
    */
