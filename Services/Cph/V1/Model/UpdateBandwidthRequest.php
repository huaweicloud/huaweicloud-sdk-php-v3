...
class UpdateBandwidthRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'bandWidthId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cph\V1\Model\UpdateBandwidthRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cph\V1\Model\UpdateBandwidthRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cph\V1\Model\UpdateBandwidthRequestBody|null $body body
    *
    * @return $this
    */
