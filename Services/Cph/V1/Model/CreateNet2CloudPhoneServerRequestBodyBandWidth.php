...
class CreateNet2CloudPhoneServerRequestBodyBandWidth implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateNet2CloudPhoneServerRequestBody_band_width';
