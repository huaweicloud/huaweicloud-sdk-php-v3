...
class RunShellCommandResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RunShellCommandResponse';
    ...
    * Sets jobs
    *
    * @param \HuaweiCloud\SDK\Cph\V1\Model\PhoneJob[]|null $jobs 任务列表。
    *
    * @return $this
    */
