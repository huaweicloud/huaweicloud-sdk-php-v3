...
class ShowCloudPhoneServerDetailResponseBodyMetadata implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowCloudPhoneServerDetailResponseBody_metadata';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * chargingMode  计费类型。 [- 0：包周期](tag:hws,hws_hk,cmcc,ctc)
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['chargingMode']) && ($this->container['chargingMode'] > 128)) {
    ...
    * Sets chargingMode
    *
    * @param int|null $chargingMode 计费类型。 [- 0：包周期](tag:hws,hws_hk,cmcc,ctc)
    *
    * @return $this
    */
