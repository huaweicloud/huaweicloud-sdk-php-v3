...
class AttachShareFilesystemResponseBody200Jobs implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AttachShareFilesystemResponseBody200_jobs';
