...
class UpdateServerNameRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'serverId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cph\V1\Model\UpdateServerNameRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cph\V1\Model\UpdateServerNameRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cph\V1\Model\UpdateServerNameRequestBody|null $body body
    *
    * @return $this
    */
