...
class ResetPhoneProperty implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResetPhoneProperty';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * phoneId  云手机id。
    * property  云手机属性列表，为Json格式字符串。
    * factoryResetEnabled  是否恢复出厂设置，设为true 会在重置手机的基础上，清除手机所有历史属性配置记录。
    *
    * @var string[]
    */
    ...
    */
    protected static $attributeMap = [
            'phoneId' => 'phone_id',
            'property' => 'property',
            'factoryResetEnabled' => 'factory_reset_enabled'
    ];
    ...
    */
    protected static $setters = [
            ...
            'factoryResetEnabled' => 'setFactoryResetEnabled'
    ];
    ...
    */
    protected static $getters = [
            ...
            'factoryResetEnabled' => 'getFactoryResetEnabled'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['factoryResetEnabled'] = isset($data['factoryResetEnabled']) ? $data['factoryResetEnabled'] : null;
    }
    ...
    * Sets property
    *
    * @param string|null $property 云手机属性列表，为Json格式字符串。
    *
    * @return $this
    */
    ...
    /**
    * Gets factoryResetEnabled
    *  是否恢复出厂设置，设为true 会在重置手机的基础上，清除手机所有历史属性配置记录。
    *
    * @return bool|null
    */
    public function getFactoryResetEnabled()
    {
        return $this->container['factoryResetEnabled'];
    }

    /**
    * Sets factoryResetEnabled
    *
    * @param bool|null $factoryResetEnabled 是否恢复出厂设置，设为true 会在重置手机的基础上，清除手机所有历史属性配置记录。
    *
    * @return $this
    */
    public function setFactoryResetEnabled($factoryResetEnabled)
    {
        $this->container['factoryResetEnabled'] = $factoryResetEnabled;
        return $this;
    }
