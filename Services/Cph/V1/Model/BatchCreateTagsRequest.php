...
class BatchCreateTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'resourceType' => 'string',
            'resourceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cph\V1\Model\BatchCreateTagsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cph\V1\Model\BatchCreateTagsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cph\V1\Model\BatchCreateTagsRequestBody|null $body body
    *
    * @return $this
    */
