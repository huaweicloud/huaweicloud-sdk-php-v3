...
class ServerMetadata implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'Server_metadata';
    ...
    * Sets chargingMode
    *
    * @param int|null $chargingMode 计费类型。 [- 0：包周期](tag:hws,hws_hk,cmcc,ctc) [- 1：按需](tag:fcs)
    *
    * @return $this
    */
