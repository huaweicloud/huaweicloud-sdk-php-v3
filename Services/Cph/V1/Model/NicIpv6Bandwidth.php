...
class NicIpv6Bandwidth implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'Nic_ipv6_bandwidth';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * bandWidthId  ipv6绑定的共享带宽ID。
    *
    * @var string[]
    */
    ...
    * Sets bandWidthId
    *
    * @param string $bandWidthId ipv6绑定的共享带宽ID。
    *
    * @return $this
    */
