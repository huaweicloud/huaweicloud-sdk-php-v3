...
class BatchDeleteTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'resourceType' => 'string',
            'resourceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cph\V1\Model\BatchDeleteTagsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cph\V1\Model\BatchDeleteTagsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cph\V1\Model\BatchDeleteTagsRequestBody|null $body body
    *
    * @return $this
    */
