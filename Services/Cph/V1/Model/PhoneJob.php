...
class PhoneJob implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PhoneJob';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * phoneId  云手机的唯一标识ID，云手机相关任务包含此字段。
    * jobId  任务的唯一标识。
    * errorCode  错误码。
    * errorMsg  错误说明。
    *
    ...
    * Sets phoneId
    *
    * @param string|null $phoneId 云手机的唯一标识ID，云手机相关任务包含此字段。
    *
    * @return $this
    */
