...
class Server implements ModelInterface, ArrayAccess
{
    ...
    * vpcId  云手机服务器所属虚拟私有云（简称VPC）的ID。 网络版本network_version取值为“v1”时，表示云手机服务器所属资源租户的VPC ID；取值为“v2”时，表示租户创建服务器时指定VPC的 VPC ID。
    * cidr  云手机服务器所属虚拟私有云（简称VPC）的网段。网络版本 network_version 取值为“v1”时，表示云手机服务器所属资源租户的VPC CIDR；取值为“v2”时，表示租户创建服务器时指定 VPC 的 VPC CIDR。
    * vpcCidr  云手机服务器所属虚拟私有云（简称VPC  网络版本 network_version 取值为“v1”时，表示云手机服务器所属资源租户的VPC CIDR；取值为“v2”时，表示租户创建服务器时指定 VPC 的 VPC CIDR
    * subnetId  云手机服务器所属子网的ID。仅在网络版本 network_version 取值为“v2”时，该取值表示租户创建服务器时指定子网的 ID，网络版本取值为“v1”时，该字段表示云手机服务器所属资源租户的子网ID。
    * subnetCidr  云手机服务器所属子网网段。网络版本 network_version 取值为“v2”时，表示租户创建服务器时指定子网的 CIDR; 取值为“v1”时，表示云手机服务器所属资源租户的子网CIDR。
    ...
    */
    protected static $openAPITypes = [
            ...
            'metadata' => '\HuaweiCloud\SDK\Cph\V1\Model\ServerMetadata',
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['vpcId']) && (mb_strlen($this->container['vpcId']) > 1024)) {
                $invalidProperties[] = "invalid value for 'vpcId', the character length must be smaller than or equal to 1024.";
            }
            ...
            if (!is_null($this->container['subnetId']) && (mb_strlen($this->container['subnetId']) > 1024)) {
                $invalidProperties[] = "invalid value for 'subnetId', the character length must be smaller than or equal to 1024.";
            }
            ...
            if (!is_null($this->container['networkVersion']) && (mb_strlen($this->container['networkVersion']) > 64)) {
                $invalidProperties[] = "invalid value for 'networkVersion', the character length must be smaller than or equal to 64.";
            }
    ...
    * Sets vpcId
    *
    * @param string|null $vpcId 云手机服务器所属虚拟私有云（简称VPC）的ID。 网络版本network_version取值为“v1”时，表示云手机服务器所属资源租户的VPC ID；取值为“v2”时，表示租户创建服务器时指定VPC的 VPC ID。
    *
    * @return $this
    */
    ...
    * Sets vpcCidr
    *
    * @param string|null $vpcCidr 云手机服务器所属虚拟私有云（简称VPC  网络版本 network_version 取值为“v1”时，表示云手机服务器所属资源租户的VPC CIDR；取值为“v2”时，表示租户创建服务器时指定 VPC 的 VPC CIDR
    *
    * @return $this
    */
    ...
    * Sets subnetCidr
    *
    * @param string|null $subnetCidr 云手机服务器所属子网网段。网络版本 network_version 取值为“v2”时，表示租户创建服务器时指定子网的 CIDR; 取值为“v1”时，表示云手机服务器所属资源租户的子网CIDR。
    *
    * @return $this
    */
    ...
    *  metadata
    *
    * @return \HuaweiCloud\SDK\Cph\V1\Model\ServerMetadata|null
    */
    ...
    * Sets metadata
    *
    * @param \HuaweiCloud\SDK\Cph\V1\Model\ServerMetadata|null $metadata metadata
    *
    * @return $this
    */
