...
class UpdatePhoneNameRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePhoneNameRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * phoneName  云手机名称，必须为小写字母（a-z）、大写字母（A-Z）、数字（0-9）、中文字符、中划线-、下划线_，且不得超过60个字符。
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['phoneName'] === null) {
            $invalidProperties[] = "'phoneName' can't be null";
        }
            if ((mb_strlen($this->container['phoneName']) > 64)) {
                $invalidProperties[] = "invalid value for 'phoneName', the character length must be smaller than or equal to 64.";
            }
            if ((mb_strlen($this->container['phoneName']) < 0)) {
    ...
    * Sets phoneName
    *
    * @param string $phoneName 云手机名称，必须为小写字母（a-z）、大写字母（A-Z）、数字（0-9）、中文字符、中划线-、下划线_，且不得超过60个字符。
    *
    * @return $this
    */
