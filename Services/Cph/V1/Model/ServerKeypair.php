...
class ServerKeypair implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ServerKeypair';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * serverId  云手机服务器ID，不得超过32个字节。
    * keypairName  密钥对名称。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['keypairName'] === null) {
            ...
            if ((mb_strlen($this->container['keypairName']) > 1024)) {
    ...
    * Sets serverId
    *
    * @param string $serverId 云手机服务器ID，不得超过32个字节。
    *
    * @return $this
    */
