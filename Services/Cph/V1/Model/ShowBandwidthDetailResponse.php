...
class ShowBandwidthDetailResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowBandwidthDetailResponse';
    ...
    * Sets bandWidths
    *
    * @param \HuaweiCloud\SDK\Cph\V1\Model\Bandwidth[]|null $bandWidths 带宽信息。
    *
    * @return $this
    */
