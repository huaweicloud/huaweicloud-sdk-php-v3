...
class CreateNet2CloudPhoneServerRequestBodyServerShareDataVolume implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateNet2CloudPhoneServerRequestBody_server_share_data_volume';
