...
class RestartEncodeServerResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RestartEncodeServerResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'jobs' => '\HuaweiCloud\SDK\Cph\V1\Model\EncodeServerJob[]'
    ];
    ...
    *  任务信息。
    *
    * @return \HuaweiCloud\SDK\Cph\V1\Model\EncodeServerJob[]|null
    */
    ...
    * Sets jobs
    *
    * @param \HuaweiCloud\SDK\Cph\V1\Model\EncodeServerJob[]|null $jobs 任务信息。
    *
    * @return $this
    */
