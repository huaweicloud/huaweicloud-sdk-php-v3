...
class RunSyncCommandRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RunSyncCommandRequestBody';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['command'] === null) {
            ...
            if ((mb_strlen($this->container['command']) > 5)) {
                $invalidProperties[] = "invalid value for 'command', the character length must be smaller than or equal to 5.";
            }
            if ((mb_strlen($this->container['command']) < 5)) {
                $invalidProperties[] = "invalid value for 'command', the character length must be bigger than or equal to 5.";
            }
    ...
    * Sets command
    *
    * @param string $command ADB命令，固定填写shell。
    *
    * @return $this
    */
    ...
    * Sets phoneIds
    *
    * @param string[]|null $phoneIds 云手机ID列表。 server_ids参数不存在时必选，同时存在只处理phone_ids。最多支持传入15个phone_id。
    *
    * @return $this
    */
