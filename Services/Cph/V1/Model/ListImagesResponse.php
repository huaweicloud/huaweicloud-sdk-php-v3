...
class ListImagesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'imageInfos' => '\HuaweiCloud\SDK\Cph\V1\Model\ListImagesView[]',
            'total' => 'int',
            'requestId' => 'string'
    ];
    ...
    *  镜像详情
    *
    * @return \HuaweiCloud\SDK\Cph\V1\Model\ListImagesView[]|null
    */
    ...
    * Sets imageInfos
    *
    * @param \HuaweiCloud\SDK\Cph\V1\Model\ListImagesView[]|null $imageInfos 镜像详情
    *
    * @return $this
    */
