...
class CreateCloudPhoneSingleServerRequestBodyDataVolume implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCloudPhoneSingleServerRequestBody_data_volume';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * volumeType  数据盘类型，只支持如下类型： SSD GPSSD
    * size  数据盘大小，单位GiB，取值范围[1，32768]
    * count  数据盘数量，默认值为1
    *
    * @var string[]
    */
    ...
    * Sets volumeType
    *
    * @param string $volumeType 数据盘类型，只支持如下类型： SSD GPSSD
    *
    * @return $this
    */
    ...
    * Sets size
    *
    * @param int $size 数据盘大小，单位GiB，取值范围[1，32768]
    *
    * @return $this
    */
    ...
    * Sets count
    *
    * @param int|null $count 数据盘数量，默认值为1
    *
    * @return $this
    */
