...
class ListCloudPhoneModelsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCloudPhoneModelsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * status  规格状态 - 0：下线状态 - 1：正常使用 不传该参数表示查询所有状态的规格。
    ...
    * Sets status
    *
    * @param int|null $status 规格状态 - 0：下线状态 - 1：正常使用 不传该参数表示查询所有状态的规格。
    *
    * @return $this
    */
