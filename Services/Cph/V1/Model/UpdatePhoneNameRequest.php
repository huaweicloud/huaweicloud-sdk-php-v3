...
class UpdatePhoneNameRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePhoneNameRequest';
    ...
    */
    protected static $openAPITypes = [
            'phoneId' => 'string',
            'body' => '\HuaweiCloud\SDK\Cph\V1\Model\UpdatePhoneNameRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cph\V1\Model\UpdatePhoneNameRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cph\V1\Model\UpdatePhoneNameRequestBody|null $body body
    *
    * @return $this
    */
