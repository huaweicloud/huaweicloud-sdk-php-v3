...
class ListCloudPhoneImagesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCloudPhoneImagesResponse';
    ...
    *  手机镜像信息。
    *
    * @return \HuaweiCloud\SDK\Cph\V1\Model\PhoneImage[]|null
    */
    public function getPhoneImages()
    {
        return $this->container['phoneImages'];
    }

    /**
    * Sets phoneImages
    *
    * @param \HuaweiCloud\SDK\Cph\V1\Model\PhoneImage[]|null $phoneImages 手机镜像信息。
    *
    * @return $this
    */
