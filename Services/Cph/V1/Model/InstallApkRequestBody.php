...
class InstallApkRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'InstallApkRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * command  安装单apk场景填写install，多apk场景填写install-multiple。
    * content  指定OBS桶中的apk文件（需要提前上传到指定桶中）。 只支持大小写字母、数字、下划线（_）、点（.）、斜线（/）、冒号（:）、中划线（-）。推送的文件只支持apk文件类型。  单apk场景，只能传一个apk，最大长度为1024字节；多apk场景，最多传50个apk，中间用空格分开，最大长度8100字节。
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['command'] === null) {
            ...
            if ((mb_strlen($this->container['command']) > 7)) {
                $invalidProperties[] = "invalid value for 'command', the character length must be smaller than or equal to 7.";
            }
            if ((mb_strlen($this->container['command']) < 7)) {
                $invalidProperties[] = "invalid value for 'command', the character length must be bigger than or equal to 7.";
            }
        if ($this->container['content'] === null) {
            $invalidProperties[] = "'content' can't be null";
        }
            if ((mb_strlen($this->container['content']) > 8096)) {
                $invalidProperties[] = "invalid value for 'content', the character length must be smaller than or equal to 8096.";
            }
    ...
    * Sets command
    *
    * @param string $command 安装单apk场景填写install，多apk场景填写install-multiple。
    *
    * @return $this
    */
    ...
    * Sets content
    *
    * @param string $content 指定OBS桶中的apk文件（需要提前上传到指定桶中）。 只支持大小写字母、数字、下划线（_）、点（.）、斜线（/）、冒号（:）、中划线（-）。推送的文件只支持apk文件类型。  单apk场景，只能传一个apk，最大长度为1024字节；多apk场景，最多传50个apk，中间用空格分开，最大长度8100字节。
    *
    * @return $this
    */
