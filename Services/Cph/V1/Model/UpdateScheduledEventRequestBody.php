...
class UpdateScheduledEventRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateScheduledEventRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * notBefore  计划执行开始时间，预约的时间需要比当前时间多5分钟以上，传空字符串表示立即执行。
    *
    * @var string[]
    */
    ...
    * Sets notBefore
    *
    * @param string $notBefore 计划执行开始时间，预约的时间需要比当前时间多5分钟以上，传空字符串表示立即执行。
    *
    * @return $this
    */
