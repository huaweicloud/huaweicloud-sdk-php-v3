...
class CreateCloudPhoneSingleServerResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateCloudPhoneSingleServerResponse';
