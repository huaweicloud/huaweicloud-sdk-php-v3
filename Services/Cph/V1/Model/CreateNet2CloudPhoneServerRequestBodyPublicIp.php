...
class CreateNet2CloudPhoneServerRequestBodyPublicIp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateNet2CloudPhoneServerRequestBody_public_ip';
