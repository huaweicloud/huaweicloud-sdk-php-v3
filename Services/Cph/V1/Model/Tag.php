...
class Tag implements ModelInterface, ArrayAccess
{
    ...
    * key  键。  - 最大长度127个unicode字符。          - 不能为空，可以包含任意语种字母、数字、空格和_.：=+-@，不能以_sys_开头。
    * value  值列表。  - 每个值最大长度255个unicode字符。 - 不能为空，可以包含任意语种字母、数字、空格和_.：=+-@，但首尾不能含有空格。
    *
    * @var string[]
    */
    ...
    */
    ...
    /**
    * Gets key
    *  键。  - 最大长度127个unicode字符。          - 不能为空，可以包含任意语种字母、数字、空格和_.：=+-@，不能以_sys_开头。
    *
    * @return string
    */
    ...
    * Sets key
    *
    * @param string $key 键。  - 最大长度127个unicode字符。          - 不能为空，可以包含任意语种字母、数字、空格和_.：=+-@，不能以_sys_开头。
    *
    * @return $this
    */
    ...
    * Sets value
    *
    * @param string $value 值列表。  - 每个值最大长度255个unicode字符。 - 不能为空，可以包含任意语种字母、数字、空格和_.：=+-@，但首尾不能含有空格。
    *
    * @return $this
    */
