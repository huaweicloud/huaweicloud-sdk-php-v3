...
class Nic implements ModelInterface, ArrayAccess
{
    ...
    * subnetId  租户自定义的子网 ID，为待创建的云服务器所属的子网。  需要指定tenant_vpc_id对应VPC下已创建的子网（subnet）的网络ID，UUID格式。
    ...
    */
    protected static $openAPITypes = [
            'subnetId' => 'string',
            'ipv6Enable' => 'bool',
            'ipv6Bandwidth' => '\HuaweiCloud\SDK\Cph\V1\Model\NicIpv6Bandwidth'
    ];
    ...
    * Sets subnetId
    *
    * @param string $subnetId 租户自定义的子网 ID，为待创建的云服务器所属的子网。  需要指定tenant_vpc_id对应VPC下已创建的子网（subnet）的网络ID，UUID格式。
    *
    * @return $this
    */
    ...
    *  ipv6Bandwidth
    *
    * @return \HuaweiCloud\SDK\Cph\V1\Model\NicIpv6Bandwidth|null
    */
    ...
    * Sets ipv6Bandwidth
    *
    * @param \HuaweiCloud\SDK\Cph\V1\Model\NicIpv6Bandwidth|null $ipv6Bandwidth ipv6Bandwidth
    *
    * @return $this
    */
