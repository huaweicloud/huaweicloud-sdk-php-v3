...
class ChangeCloudPhoneServerRequestBodyBandWidth implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeCloudPhoneServerRequestBody_band_width';
