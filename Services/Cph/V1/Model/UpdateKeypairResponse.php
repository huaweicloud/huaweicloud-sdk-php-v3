...
class UpdateKeypairResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateKeypairResponse';
    ...
    * Sets jobs
    *
    * @param \HuaweiCloud\SDK\Cph\V1\Model\ServerJob[]|null $jobs 任务信息。
    *
    * @return $this
    */
