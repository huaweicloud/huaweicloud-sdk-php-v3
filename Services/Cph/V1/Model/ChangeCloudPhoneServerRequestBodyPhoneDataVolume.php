...
class ChangeCloudPhoneServerRequestBodyPhoneDataVolume implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeCloudPhoneServerRequestBody_phone_data_volume';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * volumeType  磁盘类型，只支持如下类型： - SSD - GPSSD
    * size  手机磁盘大小，单位GiB，取值范围[10，32768]。
    *
    * @var string[]
    */
    ...
    * Sets size
    *
    * @param int $size 手机磁盘大小，单位GiB，取值范围[10，32768]。
    *
    * @return $this
    */
