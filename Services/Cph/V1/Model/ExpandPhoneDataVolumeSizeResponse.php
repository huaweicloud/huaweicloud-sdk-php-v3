...
class ExpandPhoneDataVolumeSizeResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExpandPhoneDataVolumeSizeResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'jobs' => '\HuaweiCloud\SDK\Cph\V1\Model\PhoneJob[]'
    ];
    ...
    *  任务信息。
    *
    * @return \HuaweiCloud\SDK\Cph\V1\Model\PhoneJob[]|null
    */
    ...
    * Sets jobs
    *
    * @param \HuaweiCloud\SDK\Cph\V1\Model\PhoneJob[]|null $jobs 任务信息。
    *
    * @return $this
    */
