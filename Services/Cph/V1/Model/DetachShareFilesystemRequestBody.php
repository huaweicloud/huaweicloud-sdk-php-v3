...
class DetachShareFilesystemRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DetachShareFilesystemRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * type  共享文件系统类型，当前仅支持“sfs_turbo”。
    * id  共享文件系统id。
    * serverIds  云手机服务器id列表。一次最多卸载20台。
    *
    * @var string[]
    */
    ...
    * Sets serverIds
    *
    * @param string[] $serverIds 云手机服务器id列表。一次最多卸载20台。
    *
    * @return $this
    */
