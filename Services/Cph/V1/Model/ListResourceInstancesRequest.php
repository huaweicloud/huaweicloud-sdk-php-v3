...
class ListResourceInstancesRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'resourceType' => 'string',
            'body' => '\HuaweiCloud\SDK\Cph\V1\Model\ListResourceInstancesRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Cph\V1\Model\ListResourceInstancesRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Cph\V1\Model\ListResourceInstancesRequestBody|null $body body
    *
    * @return $this
    */
