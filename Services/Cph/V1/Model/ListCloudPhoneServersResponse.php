...
class ListCloudPhoneServersResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCloudPhoneServersResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'count' => 'int',
            'servers' => '\HuaweiCloud\SDK\Cph\V1\Model\Server[]'
    ];
    ...
    *  云手机服务器信息。
    *
    * @return \HuaweiCloud\SDK\Cph\V1\Model\Server[]|null
    */
    ...
    * Sets servers
    *
    * @param \HuaweiCloud\SDK\Cph\V1\Model\Server[]|null $servers 云手机服务器信息。
    *
    * @return $this
    */
