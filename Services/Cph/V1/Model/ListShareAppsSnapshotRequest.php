...
class ListShareAppsSnapshotRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListShareAppsSnapshotRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * serverId  云手机服务器的唯一标识。
    * limit  每页返回的资源个数。取值范围：1~500（默认值为100）。
    * marker  分页标记。
    * packageName  应用包名称，只包含大小写字母、数字、下划线、点，不能以数字和下划线开头，点不能作为结尾且包名中至少有一个点，长度不超过128
    *
    * @var string[]
    */
    ...
    * Sets limit
    *
    * @param int|null $limit 每页返回的资源个数。取值范围：1~500（默认值为100）。
    *
    * @return $this
    */
    ...
    * Sets packageName
    *
    * @param string|null $packageName 应用包名称，只包含大小写字母、数字、下划线、点，不能以数字和下划线开头，点不能作为结尾且包名中至少有一个点，长度不超过128
    *
    * @return $this
    */
