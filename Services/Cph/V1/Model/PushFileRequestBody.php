...
class PushFileRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PushFileRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * command  推送文件固定填写push。
    * content  推送的文件只支持tar文件类型，指定OBS桶中的tar文件。 最大长度为1024字节，只支持大小写字母、数字、下划线（_）、点（.）、斜线（/）、冒号（:）、中划线（-）。文件格式：obs://obs-bucket-name/obs-file-path/file.tar，文件路径与OBS桶对象路径对应。
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['command'] === null) {
            ...
            if ((mb_strlen($this->container['command']) > 4)) {
                $invalidProperties[] = "invalid value for 'command', the character length must be smaller than or equal to 4.";
            }
            if ((mb_strlen($this->container['command']) < 4)) {
                $invalidProperties[] = "invalid value for 'command', the character length must be bigger than or equal to 4.";
            }
    ...
    * Sets command
    *
    * @param string $command 推送文件固定填写push。
    *
    * @return $this
    */
    ...
    * Sets content
    *
    * @param string $content 推送的文件只支持tar文件类型，指定OBS桶中的tar文件。 最大长度为1024字节，只支持大小写字母、数字、下划线（_）、点（.）、斜线（/）、冒号（:）、中划线（-）。文件格式：obs://obs-bucket-name/obs-file-path/file.tar，文件路径与OBS桶对象路径对应。
    *
    * @return $this
    */
