...
class ShowCloudPhoneDetailResponseBodyMetadata implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowCloudPhoneDetailResponseBody_metadata';
