...
class RunSyncCommandResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RunSyncCommandResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'jobs' => '\HuaweiCloud\SDK\Cph\V1\Model\RunSyncCommandJob[]'
    ];
    ...
    *  任务列表。
    *
    * @return \HuaweiCloud\SDK\Cph\V1\Model\RunSyncCommandJob[]|null
    */
    ...
    * Sets jobs
    *
    * @param \HuaweiCloud\SDK\Cph\V1\Model\RunSyncCommandJob[]|null $jobs 任务列表。
    *
    * @return $this
    */
