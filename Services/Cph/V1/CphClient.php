...
class CphClient extends Client
{
     ...
     * @return response
     */
    public function attachShareFilesystem($request)
    {
        return $this->attachShareFilesystemWithHttpInfo($request);
    }

    public function attachShareFilesystemWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function authorizeScheduledEvent($request)
    {
        return $this->authorizeScheduledEventWithHttpInfo($request);
    }

    public function authorizeScheduledEventWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function detachShareFilesystem($request)
    {
        return $this->detachShareFilesystemWithHttpInfo($request);
    }

    public function detachShareFilesystemWithHttpInfo($request)
    {
     ...
     * @return response
     */
    public function listShareAppsSnapshot($request)
    {
        return $this->listShareAppsSnapshotWithHttpInfo($request);
    }

    public function listShareAppsSnapshotWithHttpInfo($request)
    {
