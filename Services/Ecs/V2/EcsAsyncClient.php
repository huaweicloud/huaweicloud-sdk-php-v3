...
class EcsAsyncClient extends Client
{
     ...
     * @return response
     */
    public function batchAddServerGroupMemberAsync($request)
    {
        return $this->batchAddServerGroupMemberAsyncWithHttpInfo($request);
    }
    
    public function batchAddServerGroupMemberAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function batchDeleteServerGroupMemberAsync($request)
    {
        return $this->batchDeleteServerGroupMemberAsyncWithHttpInfo($request);
    }
    
    public function batchDeleteServerGroupMemberAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function changeServerChargeModeAsync($request)
    {
        return $this->changeServerChargeModeAsyncWithHttpInfo($request);
    }
    
    public function changeServerChargeModeAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function changeServerNetworkInterfaceAsync($request)
    {
        return $this->changeServerNetworkInterfaceAsyncWithHttpInfo($request);
    }
    
    public function changeServerNetworkInterfaceAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function changeVpcAsync($request)
    {
        return $this->changeVpcAsyncWithHttpInfo($request);
    }
    
    public function changeVpcAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function createLaunchTemplateAsync($request)
    {
        return $this->createLaunchTemplateAsyncWithHttpInfo($request);
    }
    
    public function createLaunchTemplateAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function deleteLaunchTemplatesAsync($request)
    {
        return $this->deleteLaunchTemplatesAsyncWithHttpInfo($request);
    }
    
    public function deleteLaunchTemplatesAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function deleteRecycleBinServerAsync($request)
    {
        return $this->deleteRecycleBinServerAsyncWithHttpInfo($request);
    }
    
    public function deleteRecycleBinServerAsyncWithHttpInfo($request){
        $collection_formats = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Ecs\V2\Model\DeleteRecycleBinServerResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Ecs\V2\Model\DeleteRecycleBinServerRequest',
            $asyncRequest = true);
    }
     ...
     * @return response
     */
    public function listCloudServersAsync($request)
    {
        return $this->listCloudServersAsyncWithHttpInfo($request);
    }
    
    public function listCloudServersAsyncWithHttpInfo($request){
        $collection_formats = [];
        ...
        if ($localVarParams['metadataKey'] !== null) {
            $queryParams['metadata_key'] = $localVarParams['metadataKey'];
        }
     ...
     * @return response
     */
    public function listLaunchTemplateVersionsAsync($request)
    {
        return $this->listLaunchTemplateVersionsAsyncWithHttpInfo($request);
    }
    
    public function listLaunchTemplateVersionsAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function listRecycleBinServersAsync($request)
    {
        return $this->listRecycleBinServersAsyncWithHttpInfo($request);
    }
    
    public function listRecycleBinServersAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v1/{project_id}/recycle-bin/cloudservers';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        if ($localVarParams['allTenants'] !== null) {
            $queryParams['all_tenants'] = $localVarParams['allTenants'];
        }
        if ($localVarParams['availabilityZone'] !== null) {
            $queryParams['availability_zone'] = $localVarParams['availabilityZone'];
        }
        ...
        if ($localVarParams['tagsKey'] !== null) {
            $queryParams['tags_key'] = $localVarParams['tagsKey'];
        }
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Ecs\V2\Model\ListRecycleBinServersResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Ecs\V2\Model\ListRecycleBinServersRequest',
            $asyncRequest = true);
    }
    ...
    public function listScheduledEventsAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v3/{project_id}/instance-scheduled-events';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Ecs\V2\Model\ListScheduledEventsResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Ecs\V2\Model\ListScheduledEventsRequest',
            $asyncRequest = true);
    }
     ...
     * @return response
     */
    public function listServerAzInfoAsync($request)
    {
        return $this->listServerAzInfoAsyncWithHttpInfo($request);
    }
    
    public function listServerAzInfoAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v1/{project_id}/availability-zones';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Ecs\V2\Model\ListServerAzInfoResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Ecs\V2\Model\ListServerAzInfoRequest',
            $asyncRequest = true);
    }
     ...
     * @return response
     */
    public function novaListServersAsync($request)
    {
        return $this->novaListServersAsyncWithHttpInfo($request);
    }
    
    public function novaListServersAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v2.1/{project_id}/servers';
        $formParams = [];
        $queryParams = [];
     ...
     * @return response
     */
    public function novaShowServerInterfaceAsync($request)
    {
        return $this->novaShowServerInterfaceAsyncWithHttpInfo($request);
    }
    
    public function novaShowServerInterfaceAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function revertRecycleBinServerAsync($request)
    {
        return $this->revertRecycleBinServerAsyncWithHttpInfo($request);
    }
    
    public function revertRecycleBinServerAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v1/{project_id}/recycle-bin/cloudservers/{server_id}/actions/revert';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
     ...
     * @return response
     */
    public function showFlavorCapacityAsync($request)
    {
        return $this->showFlavorCapacityAsyncWithHttpInfo($request);
    }
    
    public function showFlavorCapacityAsyncWithHttpInfo($request){
        $collection_formats = [];
    ...
    public function showRecycleBinAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v1/{project_id}/recycle-bin';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Ecs\V2\Model\ShowRecycleBinResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Ecs\V2\Model\ShowRecycleBinRequest',
            $asyncRequest = true);
    }
     ...
     * @return response
     */
    public function showSerialConsoleActionsAsync($request)
    {
        return $this->showSerialConsoleActionsAsyncWithHttpInfo($request);
    }
    
    public function showSerialConsoleActionsAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function showServerAttachableNicNumAsync($request)
    {
        return $this->showServerAttachableNicNumAsyncWithHttpInfo($request);
    }
    
    public function showServerAttachableNicNumAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function updateRecycleBinAsync($request)
    {
        return $this->updateRecycleBinAsyncWithHttpInfo($request);
    }
    
    public function updateRecycleBinAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v1/{project_id}/recycle-bin';
        $formParams = [];
        $queryParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Ecs\V2\Model\UpdateRecycleBinResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Ecs\V2\Model\UpdateRecycleBinRequest',
            $asyncRequest = true);
    }
    ...
    public function updateRecycleBinPolicyAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/v1/{project_id}/recycle-bin/policy';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
     ...
     * @return response
     */
    public function updateSerialConsoleOptionsAsync($request)
    {
        return $this->updateSerialConsoleOptionsAsyncWithHttpInfo($request);
    }
    
    public function updateSerialConsoleOptionsAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function updateServerInterfaceAsync($request)
    {
        return $this->updateServerInterfaceAsyncWithHttpInfo($request);
    }
    
    public function updateServerInterfaceAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function novaListVersionsAsync($request)
    {
        return $this->novaListVersionsAsyncWithHttpInfo($request);
    }
    
    public function novaListVersionsAsyncWithHttpInfo($request){
        $collection_formats = [];
        $resourcePath = '/';
        $formParams = [];
        $queryParams = [];
     ...
     * @return response
     */
    public function novaShowVersionAsync($request)
    {
        return $this->novaShowVersionAsyncWithHttpInfo($request);
    }
    
    public function novaShowVersionAsyncWithHttpInfo($request){
        $collection_formats = [];
