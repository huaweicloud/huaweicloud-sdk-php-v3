...
class ShowServerAttachableNicNumResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowServerAttachableNicNumResponse';
    ...
    */
    protected static $openAPITypes = [
            'attachableQuantity' => '\HuaweiCloud\SDK\Ecs\V2\Model\AttachableQuantityForNic',
            'interfaceAttachments' => '\HuaweiCloud\SDK\Ecs\V2\Model\InterfaceExt[]'
    ];
    ...
    *  attachableQuantity
    *
    * @return \HuaweiCloud\SDK\Ecs\V2\Model\AttachableQuantityForNic|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Ecs\V2\Model\AttachableQuantityForNic|null $attachableQuantity attachableQuantity
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\Ecs\V2\Model\InterfaceExt[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Ecs\V2\Model\InterfaceExt[]|null $interfaceAttachments interfaceAttachments
    *
    * @return $this
    */
