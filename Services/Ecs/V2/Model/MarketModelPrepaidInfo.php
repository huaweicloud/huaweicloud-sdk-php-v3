...
class MarketModelPrepaidInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'MarketModel_prepaid_info';
    ...
    * Sets expiredTime
    *
    * @param string|null $expiredTime expiredTime
    *
    * @return $this
    */
