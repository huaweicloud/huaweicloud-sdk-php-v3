...
class NovaListServersRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NovaListServersRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * changesSince  云服务器上次更新状态的时间戳信息。格式符合ISO 8601，例如：  CCYY-MM-DDThh:mm:ss+/-hh:mm  > 说明： >  > 可以查询到“deleted”状态的弹性云服务器。
    * flavor  云服务器类型ID。
    * host  主机节点名称。
    ...
    * Sets changesSince
    *
    * @param string|null $changesSince 云服务器上次更新状态的时间戳信息。格式符合ISO 8601，例如：  CCYY-MM-DDThh:mm:ss+/-hh:mm  > 说明： >  > 可以查询到“deleted”状态的弹性云服务器。
    *
    * @return $this
    */
    ...
    * Sets flavor
    *
    * @param string|null $flavor 云服务器类型ID。
    *
    * @return $this
    */
    ...
    * Sets status
    *
    * @param string|null $status 云服务器状态。  取值范围： ACTIVE， BUILD，DELETED，ERROR，HARD_REBOOT，MIGRATING，REBOOT，RESIZE，REVERT_RESIZE，SHELVED，SHELVED_OFFLOADED，SHUTOFF，UNKNOWN，VERIFY_RESIZE 其中DELETED 状态虚拟机只有管理员有权限查 直到2.37微版本，非上面范围的status字段将返回空列表，2.38之后的微版本，将返回400错误。  云服务器状态说明请参考[云服务器状态](https://support.huaweicloud.com/api-ecs/ecs_08_0002.html)。
    *
    * @return $this
    */
