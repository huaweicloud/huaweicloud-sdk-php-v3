...
class NovaListServersResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'NovaListServersResponse';
    ...
    */
    protected static $openAPITypes = [
            'servers' => '\HuaweiCloud\SDK\Ecs\V2\Model\NovaSimpleServer[]',
    ...
    *  查询云服务器信息列表
    *
    * @return \HuaweiCloud\SDK\Ecs\V2\Model\NovaSimpleServer[]|null
    */
    ...
    * Sets servers
    *
    * @param \HuaweiCloud\SDK\Ecs\V2\Model\NovaSimpleServer[]|null $servers 查询云服务器信息列表
    *
    * @return $this
    */
