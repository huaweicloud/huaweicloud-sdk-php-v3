...
class ListServerVolumeAttachmentsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListServerVolumeAttachmentsResponse';
    ...
    */
    protected static $openAPITypes = [
            'volumeAttachments' => '\HuaweiCloud\SDK\Ecs\V2\Model\ServerVolumeAttachment[]'
    ];
    ...
    *  云服务器挂载信息列表
    *
    * @return \HuaweiCloud\SDK\Ecs\V2\Model\ServerVolumeAttachment[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Ecs\V2\Model\ServerVolumeAttachment[]|null $volumeAttachments 云服务器挂载信息列表
    *
    * @return $this
    */
