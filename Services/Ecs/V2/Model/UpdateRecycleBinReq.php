...
class UpdateRecycleBinReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateRecycleBinReq';
    ...
    */
    protected static $openAPITypes = [
            'recycleBin' => '\HuaweiCloud\SDK\Ecs\V2\Model\UpdateRecycleBinOption'
    ];
