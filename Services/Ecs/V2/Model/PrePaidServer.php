...
class PrePaidServer implements ModelInterface, ArrayAccess
{
    ...
    * keyName  如果需要使用SSH密钥方式登录云服务器，请指定已创建密钥的名称。  密钥可以通过密钥创建接口进行创建（请参见[创建和导入SSH密钥](https://support.huaweicloud.com/api-dew/CreateKeypair.html)），或使用SSH密钥查询接口查询已有的密钥（请参见[查询SSH密钥列表](https://support.huaweicloud.com/api-dew/ListKeypairs.html) ）。
    ...
    * publicip  publicip
    * count  创建云服务器数量。  约束：  - 不传该字段时默认取值为1。 - 租户的配额足够时，最大值为100。
    ...
    * Sets keyName
    *
    * @param string|null $keyName 如果需要使用SSH密钥方式登录云服务器，请指定已创建密钥的名称。  密钥可以通过密钥创建接口进行创建（请参见[创建和导入SSH密钥](https://support.huaweicloud.com/api-dew/CreateKeypair.html)），或使用SSH密钥查询接口查询已有的密钥（请参见[查询SSH密钥列表](https://support.huaweicloud.com/api-dew/ListKeypairs.html) ）。
    *
    * @return $this
    */
    ...
    * Sets count
    *
    * @param int|null $count 创建云服务器数量。  约束：  - 不传该字段时默认取值为1。 - 租户的配额足够时，最大值为100。
    *
    * @return $this
    */
    ...
    *  metadataOptions
    *
    * @return \HuaweiCloud\SDK\Ecs\V2\Model\UpdateServerMetadataOptionsRequestBody|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Ecs\V2\Model\UpdateServerMetadataOptionsRequestBody|null $metadataOptions metadataOptions
    *
    * @return $this
    */
