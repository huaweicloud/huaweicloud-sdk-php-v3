...
class UpdateServerInterfaceRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateServerInterfaceRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * serverId  云服务器ID。
    * portId  The network card ID of the cloud server.
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'serverId' => 'string',
            'portId' => 'string',
            'body' => '\HuaweiCloud\SDK\Ecs\V2\Model\UpdateNicInfoRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ecs\V2\Model\UpdateNicInfoRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ecs\V2\Model\UpdateNicInfoRequestBody|null $body body
    *
    * @return $this
    */
