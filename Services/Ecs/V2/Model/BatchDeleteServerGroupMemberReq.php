...
class BatchDeleteServerGroupMemberReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteServerGroupMemberReq';
    ...
    * Sets serverIds
    *
    * @param string[] $serverIds serverIds
    *
    * @return $this
    */
