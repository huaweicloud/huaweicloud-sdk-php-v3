...
class TemplateTag implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TemplateTag';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['key']) && !preg_match("/^[^<>\\=\\,\/\\|\\*\\\\\\x00-\\x1f]*$/", $this->container['key'])) {
                $invalidProperties[] = "invalid value for 'key', must be conform to the pattern /^[^<>\\=\\,\/\\|\\*\\\\\\x00-\\x1f]*$/.";
            }
            ...
            if (!is_null($this->container['value']) && !preg_match("/^[^<>\\=\\,\\|\\*\\\\\\x00-\\x1f]*$/", $this->container['value'])) {
                $invalidProperties[] = "invalid value for 'value', must be conform to the pattern /^[^<>\\=\\,\\|\\*\\\\\\x00-\\x1f]*$/.";
            }
