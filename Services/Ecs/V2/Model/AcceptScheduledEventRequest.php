...
class AcceptScheduledEventRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'id' => 'string',
            'body' => '\HuaweiCloud\SDK\Ecs\V2\Model\ScheduledEventAcceptBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Ecs\V2\Model\ScheduledEventAcceptBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Ecs\V2\Model\ScheduledEventAcceptBody|null $body body
    *
    * @return $this
    */
