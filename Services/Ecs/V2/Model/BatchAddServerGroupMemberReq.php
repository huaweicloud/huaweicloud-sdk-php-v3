...
class BatchAddServerGroupMemberReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchAddServerGroupMemberReq';
    ...
    * Sets serverIds
    *
    * @param string[]|null $serverIds serverIds
    *
    * @return $this
    */
