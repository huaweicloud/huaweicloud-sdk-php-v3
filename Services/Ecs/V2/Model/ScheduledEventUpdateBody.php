...
class ScheduledEventUpdateBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ScheduledEventUpdateBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * notBefore  计划执行开始时间，新的开始时间必须早于not_before_deadline
    *
    * @var string[]
    */
    ...
    * Sets notBefore
    *
    * @param string $notBefore 计划执行开始时间，新的开始时间必须早于not_before_deadline
    *
    * @return $this
    */
