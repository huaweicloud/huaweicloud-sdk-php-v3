...
class ListRecycleBinLoadBalancersRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListRecycleBinLoadBalancersRequest';
    ...
    * logTopicId  **参数解释**：LB所关联的云日志服务（LTS）的日志流ID。 支持多值查询，查询条件格式： *log_topic_id=xxx&log_topic_id=xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
    ...
    * Sets logTopicId
    *
    * @param string|null $logTopicId **参数解释**：LB所关联的云日志服务（LTS）的日志流ID。 支持多值查询，查询条件格式： *log_topic_id=xxx&log_topic_id=xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
    *
    * @return $this
    */
