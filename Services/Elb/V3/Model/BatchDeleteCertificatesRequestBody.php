...
class BatchDeleteCertificatesRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteCertificatesRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * certificates  待删除的证书id列表。
    *
    * @var string[]
    */
