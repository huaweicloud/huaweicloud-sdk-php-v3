...
class DeleteLoadBalancerCascadeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteLoadBalancerCascadeRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Elb\V3\Model\DeleteLoadBalancerCascadeRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Elb\V3\Model\DeleteLoadBalancerCascadeRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\DeleteLoadBalancerCascadeRequestBody|null $body body
    *
    * @return $this
    */
