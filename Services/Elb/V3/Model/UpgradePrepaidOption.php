...
class UpgradePrepaidOption implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpgradePrepaidOption';
    ...
    * resourcePackageType  参数解释：购买定向套餐包。
    ...
    */
    protected static $attributeMap = [
            ...
            'resourcePackageType' => 'resource_package_type',
            'autoPay' => 'auto_pay'
    ];
    ...
    */
    protected static $setters = [
            ...
            'resourcePackageType' => 'setResourcePackageType',
            'autoPay' => 'setAutoPay'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['resourcePackageType'] = isset($data['resourcePackageType']) ? $data['resourcePackageType'] : null;
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['resourcePackageType'] === null) {
            $invalidProperties[] = "'resourcePackageType' can't be null";
        }
    ...
    */
    ...
    /**
    * Gets resourcePackageType
    *  参数解释：购买定向套餐包。
    *
    * @return string[]
    */
    public function getResourcePackageType()
    {
        return $this->container['resourcePackageType'];
    }

    /**
    * Sets resourcePackageType
    *
    * @param string[] $resourcePackageType 参数解释：购买定向套餐包。
    *
    * @return $this
    */
    public function setResourcePackageType($resourcePackageType)
    {
        $this->container['resourcePackageType'] = $resourcePackageType;
        return $this;
    }
