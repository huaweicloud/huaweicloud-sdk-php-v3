...
class CreateLoadBalancerResponse implements ModelInterface, ArrayAccess
{
    ...
    * orderId  订单号。[（包周期场景返回该字段）](tag:hws)  [不支持该字段，请勿使用](tag:hws_ocb,ocb,hws_eu,g42,hk_g42,dt,dt_test,hcso_dt,fcs,ctc,cmcc)
    ...
    * Sets orderId
    *
    * @param string|null $orderId 订单号。[（包周期场景返回该字段）](tag:hws)  [不支持该字段，请勿使用](tag:hws_ocb,ocb,hws_eu,g42,hk_g42,dt,dt_test,hcso_dt,fcs,ctc,cmcc)
    *
    * @return $this
    */
