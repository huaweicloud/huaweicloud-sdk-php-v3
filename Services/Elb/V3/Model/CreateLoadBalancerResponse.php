...
class CreateLoadBalancerResponse implements ModelInterface, ArrayAccess
{
    ...
    * loadbalancerId  负载均衡器的id（包周期场景返回该字段）  [不支持该字段，请勿使用](tag:hws_eu,g42,hk_g42,dt,dt_test,hcso_dt,ctc,cmcc,hcso,fcs,fcs_vm,mix,hcso_g42,hcso_g42_b)
    * orderId  订单号（包周期场景返回该字段）  [不支持该字段，请勿使用](tag:hws_eu,g42,hk_g42,dt,dt_test,hcso_dt,ctc,cmcc,hcso,fcs,fcs_vm,mix,hcso_g42,hcso_g42_b)
    ...
    * Sets loadbalancerId
    *
    * @param string|null $loadbalancerId 负载均衡器的id（包周期场景返回该字段）  [不支持该字段，请勿使用](tag:hws_eu,g42,hk_g42,dt,dt_test,hcso_dt,ctc,cmcc,hcso,fcs,fcs_vm,mix,hcso_g42,hcso_g42_b)
    *
    * @return $this
    */
    ...
    * Sets orderId
    *
    * @param string|null $orderId 订单号（包周期场景返回该字段）  [不支持该字段，请勿使用](tag:hws_eu,g42,hk_g42,dt,dt_test,hcso_dt,ctc,cmcc,hcso,fcs,fcs_vm,mix,hcso_g42,hcso_g42_b)
    *
    * @return $this
    */
