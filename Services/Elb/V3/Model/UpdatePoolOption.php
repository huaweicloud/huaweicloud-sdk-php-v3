...
class UpdatePoolOption implements ModelInterface, ArrayAccess
{
    ...
    * vpcId  后端云服务器组关联的虚拟私有云的ID。 [- pool的protocol为IP时，必须指定vpc_id，且与LB的vpc_id相同。](tag:hws_eu)  只有vpc_id为空时允许更新。
    ...
    * Sets vpcId
    *
    * @param string|null $vpcId 后端云服务器组关联的虚拟私有云的ID。 [- pool的protocol为IP时，必须指定vpc_id，且与LB的vpc_id相同。](tag:hws_eu)  只有vpc_id为空时允许更新。
    *
    * @return $this
    */
