...
class L7Limit implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'L7Limit';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * connection  **参数解释**：负载均衡实例的七层规格的最大并发连接数限速值。  **取值范围**：不涉及
    * cps  **参数解释**：负载均衡实例的七层规格的每秒新建连接数限速值。  **取值范围**：不涉及
    *
    * @var string[]
    */
    ...
    * Sets connection
    *
    * @param int|null $connection **参数解释**：负载均衡实例的七层规格的最大并发连接数限速值。  **取值范围**：不涉及
    *
    * @return $this
    */
    ...
    * Sets cps
    *
    * @param int|null $cps **参数解释**：负载均衡实例的七层规格的每秒新建连接数限速值。  **取值范围**：不涉及
    *
    * @return $this
    */
