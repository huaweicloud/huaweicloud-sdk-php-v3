...
class ListenerQuicConfig implements ModelInterface, ArrayAccess
{
    ...
    * quicListenerId  **参数解释**：监听器关联的QUIC监听器ID。  **取值范围**：不涉及  [不支持QUIC。](tag:tm,hws_eu,g42,hk_g42,hcso_dt,dt)
    ...
    * Sets quicListenerId
    *
    * @param string|null $quicListenerId **参数解释**：监听器关联的QUIC监听器ID。  **取值范围**：不涉及  [不支持QUIC。](tag:tm,hws_eu,g42,hk_g42,hcso_dt,dt)
    *
    * @return $this
    */
