...
class ListenerQuicConfig implements ModelInterface, ArrayAccess
{
    ...
    * quicListenerId  监听器关联的QUIC监听器ID。 创建时必选，更新时非必选。 指定的listener id必须已存在，且协议类型为QUIC，不能指定为null，否则与enable_quic_upgrade冲突。  [不支持QUIC。](tag:hws_eu,g42,hk_g42,hcso_dt,dt,dt_test,tm)
    ...
    */
    ...
    /**
    * Gets quicListenerId
    *  监听器关联的QUIC监听器ID。 创建时必选，更新时非必选。 指定的listener id必须已存在，且协议类型为QUIC，不能指定为null，否则与enable_quic_upgrade冲突。  [不支持QUIC。](tag:hws_eu,g42,hk_g42,hcso_dt,dt,dt_test,tm)
    *
    * @return string|null
    */
    ...
    * Sets quicListenerId
    *
    * @param string|null $quicListenerId 监听器关联的QUIC监听器ID。 创建时必选，更新时非必选。 指定的listener id必须已存在，且协议类型为QUIC，不能指定为null，否则与enable_quic_upgrade冲突。  [不支持QUIC。](tag:hws_eu,g42,hk_g42,hcso_dt,dt,dt_test,tm)
    *
    * @return $this
    */
