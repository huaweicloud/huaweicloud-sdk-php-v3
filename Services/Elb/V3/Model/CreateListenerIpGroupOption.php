...
class CreateListenerIpGroupOption implements ModelInterface, ArrayAccess
{
    ...
    * Sets enableIpgroup
    *
    * @param bool|null $enableIpgroup **参数解释**：访问控制组的状态。  **约束限制**：不涉及  **取值范围**： - true：开启访问控制，默认值。 - false：关闭访问控制。  **默认取值**：不涉及
    *
    * @return $this
    */
    ...
    * Sets type
    *
    * @param string|null $type **参数解释**：访问控制组的类型。  **约束限制**：不涉及  **取值范围**： - white：白名单，只允许指定ip访问。 - black：黑名单，不允许指定ip访问。  **默认取值**：white
    *
    * @return $this
    */
