...
class TrafficMirrorConfig implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TrafficMirrorConfig';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * targetIds  **参数解释**：流量镜像的目的后端服务器组ID。  **取值范围**：不涉及
    * mirrorRequestBodyEnable  **参数解释**：镜像请求是否携带请求体，默认true。  **取值范围**：不涉及
    *
    * @var string[]
    */
    ...
    * Sets targetIds
    *
    * @param string[]|null $targetIds **参数解释**：流量镜像的目的后端服务器组ID。  **取值范围**：不涉及
    *
    * @return $this
    */
    ...
    *
    * @param bool|null $mirrorRequestBodyEnable **参数解释**：镜像请求是否携带请求体，默认true。  **取值范围**：不涉及
    *
    * @return $this
    */
