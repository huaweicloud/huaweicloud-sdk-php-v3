...
class Member implements ModelInterface, ArrayAccess
{
    ...
    * status  **参数解释**：后端服务器监听器粒度的的健康状态。  **取值范围**：不涉及
    * reason  reason
    ...
    * Sets name
    *
    * @param string $name **参数解释**：后端服务器名称。  **取值范围**：不涉及  注意：该名称并非ECS名称。
    *
    * @return $this
    */
    ...
    * Sets status
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\MemberStatus[] $status **参数解释**：后端服务器监听器粒度的的健康状态。  **取值范围**：不涉及
    *
    * @return $this
    */
