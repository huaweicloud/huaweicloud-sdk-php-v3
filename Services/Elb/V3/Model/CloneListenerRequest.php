...
class CloneListenerRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CloneListenerRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * listenerId  **参数解释**：被复制监听器ID（UUID）。  **约束限制**：不涉及  **取值范围**：标准的UUID格式，长度为36个字符。  **默认取值**：不涉及
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'listenerId' => 'string',
            'body' => '\HuaweiCloud\SDK\Elb\V3\Model\CloneListenerRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Elb\V3\Model\CloneListenerRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\CloneListenerRequestBody|null $body body
    *
    * @return $this
    */
