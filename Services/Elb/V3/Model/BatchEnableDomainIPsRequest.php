...
class BatchEnableDomainIPsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchEnableDomainIPsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Elb\V3\Model\BatchEnableDomainIPsRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Elb\V3\Model\BatchEnableDomainIPsRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\BatchEnableDomainIPsRequestBody|null $body body
    *
    * @return $this
    */
