...
class BatchDeleteLoadbalancersResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteLoadbalancersResponse';
    ...
    *
    * @param string[]|null $loadbalancerIds 待删除的负载均衡器id列表。
    *
    * @return $this
    */
