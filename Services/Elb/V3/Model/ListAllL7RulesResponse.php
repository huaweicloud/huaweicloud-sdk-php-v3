...
class ListAllL7RulesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAllL7RulesResponse';
    ...
    * Sets rules
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\L7Rule[]|null $rules **参数解释**：规则对象列表。
    *
    * @return $this
    */
