...
class Listener implements ModelInterface, ArrayAccess
{
    ...
    * adminStateUp  **参数解释**：监听器的管理状态。  **取值范围**：true
    * clientCaTlsContainerRef  **参数解释**：监听器使用的CA证书ID。当且仅当type=client时，才会使用该字段对应的证书。  **取值范围**：不涉及
    * connectionLimit  **参数解释**：监听器的最大连接数。  **取值范围**：大于等于-1的整数。
    * createdAt  **参数解释**：监听器的创建时间。  **取值范围**：不涉及 格式：yyyy-MM-dd'T'HH:mm:ss'Z'，如：2021-07-30T12:03:44Z
    * defaultPoolId  **参数解释**：监听器的默认后端服务器组ID。当请求没有匹配的转发策略时，转发到默认后端服务器组上处理。  **取值范围**：不涉及
    * defaultTlsContainerRef  **参数解释**：监听器使用的服务器证书ID。  **取值范围**：不涉及
    * description  **参数解释**：监听器的描述信息。  **取值范围**：不涉及
    * http2Enable  **参数解释**：客户端与LB之间的HTTPS请求的HTTP2功能的开启状态。 开启后，可提升客户端与LB间的访问性能，但LB与后端服务器间仍采用HTTP1.X协议。  **取值范围**：不涉及
    * id  **参数解释**：监听器ID。  **取值范围**：不涉及
    * insertHeaders  insertHeaders
    * loadbalancers  **参数解释**：监听器所属的负载均衡器的ID列表。实际上一个监听器只支持关联到一个LB。
    ...
    * ipgroup  ipgroup
    * transparentClientIpEnable  **参数解释**：是否透传客户端IP地址。开启后客户端IP地址将透传到后端服务器。 [仅作用于共享型LB的TCP/UDP监听器。](tag:hws,hws_hk,ocb,ctc,hcs,g42,tm,cmcc,hk_g42,hws_ocb,hk_vdf,srg,fcs,dt)  **取值范围**： - 共享型LB的TCP/UDP监听器可设置为true或false，不传默认为false。 - 共享型LB的HTTP/HTTPS监听器只支持设置为true，不传默认为true。 - 独享型负载均衡器所有协议的监听器只支持设置为true，不传默认为true。
    * proxyProtocolEnable  **参数解释**：是否开启proxy_protocol。仅TLS监听器可指定，其他协议的监听器该字段不生效，proxy_protocol不开启。  **取值范围**：true 开启，false 不开启。
    * enhanceL7policyEnable  **参数解释**：是否开启高级转发策略功能。开启高级转发策略后，支持更灵活的转发策略和转发规则设置。 开启后支持如下场景： - 转发策略的action字段支持指定为REDIRECT_TO_URL、FIXED_RESPONSE，即支持URL重定向和响应固定的内容给客户端。 - 转发策略支持指定priority、redirect_url_config、fixed_response_config字段。 - 转发规则rule的type可以指定METHOD, HEADER, QUERY_STRING, SOURCE_IP这几种取值。 - 转发规则rule的type为HOST_NAME时，转发规则rule的value支持通配符*。 - 转发规则支持指定conditions字段。  **取值范围**：true开启，false不开启。
    ...
    * gzipEnable  **参数解释**：ELB是否开启gzip压缩。  **取值范围**：true开启，false不开启。
    * portRanges  **参数解释**：全端口监听，指定端口监听范围（闭区间)。
    * sslEarlyDataEnable  **参数解释**：监听器0-RTT能力开关  **约束限制**：仅HTTPS类型监听器支持配置，需要依赖TLSv1.3安全策略协议。
    * cps  **参数解释**：监听器新建限速。当该限速值大于LB的限速值时，以LB的限速值生效。  **取值范围**：0-1000000
    * connection  **参数解释**：监听器并发限速。当该限速值大于LB的限速值时，以LB的限速值生效。  **取值范围**：0-1000000
    * nat64Enable  **参数解释**：监听器地址转换能力开关，可以实现客户端通过访问LB的IPv4或者IPv6地址，来访问IPv4后端和IPv6后端。  **取值范围**： - true：开启地址转换功能。 - false：关闭地址转换功能。
    *
    * @var string[]
    */
    ...
    * Sets adminStateUp
    *
    * @param bool $adminStateUp **参数解释**：监听器的管理状态。  **取值范围**：true
    *
    * @return $this
    */
    ...
    *
    * @param string $clientCaTlsContainerRef **参数解释**：监听器使用的CA证书ID。当且仅当type=client时，才会使用该字段对应的证书。  **取值范围**：不涉及
    *
    * @return $this
    */
    ...
    *
    * @param int $connectionLimit **参数解释**：监听器的最大连接数。  **取值范围**：大于等于-1的整数。
    *
    * @return $this
    */
    ...
    * Sets createdAt
    *
    * @param string $createdAt **参数解释**：监听器的创建时间。  **取值范围**：不涉及 格式：yyyy-MM-dd'T'HH:mm:ss'Z'，如：2021-07-30T12:03:44Z
    *
    * @return $this
    */
    ...
    * Sets defaultPoolId
    *
    * @param string $defaultPoolId **参数解释**：监听器的默认后端服务器组ID。当请求没有匹配的转发策略时，转发到默认后端服务器组上处理。  **取值范围**：不涉及
    *
    * @return $this
    */
    ...
    *
    * @param string $defaultTlsContainerRef **参数解释**：监听器使用的服务器证书ID。  **取值范围**：不涉及
    *
    * @return $this
    */
    ...
    * Sets description
    *
    * @param string $description **参数解释**：监听器的描述信息。  **取值范围**：不涉及
    *
    * @return $this
    */
    ...
    * Sets http2Enable
    *
    * @param bool $http2Enable **参数解释**：客户端与LB之间的HTTPS请求的HTTP2功能的开启状态。 开启后，可提升客户端与LB间的访问性能，但LB与后端服务器间仍采用HTTP1.X协议。  **取值范围**：不涉及
    *
    * @return $this
    */
    ...
    * Sets loadbalancers
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\LoadBalancerRef[] $loadbalancers **参数解释**：监听器所属的负载均衡器的ID列表。实际上一个监听器只支持关联到一个LB。
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string $name **参数解释**：监听器的名称。若名称为空，则在控制台的监听器列表无法选择并查看监听器详情。  **取值范围**：不涉及
    *
    * @return $this
    */
    ...
    * Sets projectId
    *
    * @param string $projectId **参数解释**：监听器所在的项目ID。  **取值范围**：不涉及
    *
    * @return $this
    */
    ...
    *
    * @param string $enterpriseProjectId **参数解释**：企业项目ID。  **取值范围**：不涉及
    *
    * @return $this
    */
    ...
    * Sets protocolPort
    *
    * @param int $protocolPort **参数解释**：监听器的监听端口。  **取值范围**：不涉及
    *
    * @return $this
    */
    ...
    *
    * @param string[] $sniContainerRefs **参数解释**：监听器使用的SNI证书（带域名的服务器证书）ID列表。  **取值范围**：不涉及
    *
    * @return $this
    */
    ...
    * Sets sniMatchAlgo
    *
    * @param string $sniMatchAlgo **参数解释**：监听器使用的SNI证书泛域名匹配方式。  **取值范围**：longest_suffix表示最长尾缀匹配；wildcard表示标准域名分级匹配。
    *
    * @return $this
    */
    ...
    *
    * @param string $securityPolicyId **参数解释**：自定义安全策略的ID。  **取值范围**：不涉及
    *
    * @return $this
    */
    ...
    *
    * @param bool $enableMemberRetry **参数解释**：是否开启后端服务器的重试。  **取值范围**：true 开启重试，false 不开启重试。
    *
    * @return $this
    */
    ...
    * Sets clientTimeout
    *
    * @param int $clientTimeout **参数解释**：等待客户端请求超时时间，包括两种情况： - 读取整个客户端请求头的超时时长：如果客户端未在超时时长内发送完整个请求头，则请求将被中断 - 两个连续body体的数据包到达LB的时间间隔，超出client_timeout将会断开连接。  **取值范围**：1-300，单位：秒。
    *
    * @return $this
    */
    ...
    * Sets memberTimeout
    *
    * @param int $memberTimeout **参数解释**：等待后端服务器响应超时时间。请求转发后端服务器后，在等待超时member_timeout时长没有响应，负载均衡将终止等待，并返回HTTP504错误码。  **取值范围**：1-300，单位：秒。
    *
    * @return $this
    */
    ...
    *
    * @param bool $transparentClientIpEnable **参数解释**：是否透传客户端IP地址。开启后客户端IP地址将透传到后端服务器。 [仅作用于共享型LB的TCP/UDP监听器。](tag:hws,hws_hk,ocb,ctc,hcs,g42,tm,cmcc,hk_g42,hws_ocb,hk_vdf,srg,fcs,dt)  **取值范围**： - 共享型LB的TCP/UDP监听器可设置为true或false，不传默认为false。 - 共享型LB的HTTP/HTTPS监听器只支持设置为true，不传默认为true。 - 独享型负载均衡器所有协议的监听器只支持设置为true，不传默认为true。
    *
    * @return $this
    */
    ...
    *
    * @param bool|null $proxyProtocolEnable **参数解释**：是否开启proxy_protocol。仅TLS监听器可指定，其他协议的监听器该字段不生效，proxy_protocol不开启。  **取值范围**：true 开启，false 不开启。
    *
    * @return $this
    */
    ...
    *
    * @param bool $enhanceL7policyEnable **参数解释**：是否开启高级转发策略功能。开启高级转发策略后，支持更灵活的转发策略和转发规则设置。 开启后支持如下场景： - 转发策略的action字段支持指定为REDIRECT_TO_URL、FIXED_RESPONSE，即支持URL重定向和响应固定的内容给客户端。 - 转发策略支持指定priority、redirect_url_config、fixed_response_config字段。 - 转发规则rule的type可以指定METHOD, HEADER, QUERY_STRING, SOURCE_IP这几种取值。 - 转发规则rule的type为HOST_NAME时，转发规则rule的value支持通配符*。 - 转发规则支持指定conditions字段。  **取值范围**：true开启，false不开启。
    *
    * @return $this
    */
    ...
    * Sets gzipEnable
    *
    * @param bool|null $gzipEnable **参数解释**：ELB是否开启gzip压缩。  **取值范围**：true开启，false不开启。
    *
    * @return $this
    */
    ...
    * Sets portRanges
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\PortRange[]|null $portRanges **参数解释**：全端口监听，指定端口监听范围（闭区间)。
    *
    * @return $this
    */
    ...
    *
    * @param bool|null $sslEarlyDataEnable **参数解释**：监听器0-RTT能力开关  **约束限制**：仅HTTPS类型监听器支持配置，需要依赖TLSv1.3安全策略协议。
    *
    * @return $this
    */
    ...
    * Sets cps
    *
    * @param int|null $cps **参数解释**：监听器新建限速。当该限速值大于LB的限速值时，以LB的限速值生效。  **取值范围**：0-1000000
    *
    * @return $this
    */
    ...
    * Sets connection
    *
    * @param int|null $connection **参数解释**：监听器并发限速。当该限速值大于LB的限速值时，以LB的限速值生效。  **取值范围**：0-1000000
    *
    * @return $this
    */
    ...
    * Sets nat64Enable
    *
    * @param bool|null $nat64Enable **参数解释**：监听器地址转换能力开关，可以实现客户端通过访问LB的IPv4或者IPv6地址，来访问IPv4后端和IPv6后端。  **取值范围**： - true：开启地址转换功能。 - false：关闭地址转换功能。
    *
    * @return $this
    */
