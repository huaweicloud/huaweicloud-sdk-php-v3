...
class CreateLoadBalancerPublicIpOption implements ModelInterface, ArrayAccess
{
    ...
    * Sets billingInfo
    *
    * @param string|null $billingInfo 参数解释：计费订单信息。  约束限制： - 空：按需计费。 [ - 非空：包周期计费。格式：order_id:product_id:region_id:project_id ](tag:hws)  [不支持该字段，请勿使用。](tag:hws_hk,hws_eu,hws_eu_wb,hws_test,srg,fcs,fcs_vm,dt,ctc,cmcc,tm,sbc,hk_sbc,hk_tm,hk_vdf,ct)
    *
    * @return $this
    */
