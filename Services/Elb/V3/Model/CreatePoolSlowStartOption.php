...
class CreatePoolSlowStartOption implements ModelInterface, ArrayAccess
{
    ...
    * enable  **参数解释**：慢启动的开关。  **约束限制**：不涉及  **取值范围**： - true：开启。 - false：关闭。  **默认取值**：false
    * duration  **参数解释**：慢启动的持续时间。  **约束限制**：不涉及  **取值范围**：30-1200，单位：秒。  **默认取值**：30
    *
    * @var string[]
    */
    ...
    * Sets enable
    *
    * @param bool|null $enable **参数解释**：慢启动的开关。  **约束限制**：不涉及  **取值范围**： - true：开启。 - false：关闭。  **默认取值**：false
    *
    * @return $this
    */
    ...
    * Sets duration
    *
    * @param int|null $duration **参数解释**：慢启动的持续时间。  **约束限制**：不涉及  **取值范围**：30-1200，单位：秒。  **默认取值**：30
    *
    * @return $this
    */
