...
class CreateMemberHealthCheckJobResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateMemberHealthCheckJobResponse';
    ...
    */
    protected static $openAPITypes = [
            'memberCheck' => '\HuaweiCloud\SDK\Elb\V3\Model\MemberCheckJob',
            'requestId' => 'string'
    ];
    ...
    *  memberCheck
    *
    * @return \HuaweiCloud\SDK\Elb\V3\Model\MemberCheckJob|null
    */
    ...
    * Sets memberCheck
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\MemberCheckJob|null $memberCheck memberCheck
    *
    * @return $this
    */
