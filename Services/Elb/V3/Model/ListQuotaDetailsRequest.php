...
class ListQuotaDetailsRequest implements ModelInterface, ArrayAccess
{
    ...
    * Sets quotaKey
    *
    * @param string[]|null $quotaKey 资源类型。  取值： loadbalancer、listener、ipgroup、pool、member、healthmonitor、l7policy、certificate、security_policy、listeners_per_loadbalancer、listeners_per_pool、members_per_pool、condition_per_policy、ipgroup_bindings、ipgroup_max_length、ipgroups_per_listener、pools_per_l7policy、l7policies_per_listener。  支持多值查询，查询条件格式：quota_key=xxx&quota_key=xxx。
    *
    * @return $this
    */
