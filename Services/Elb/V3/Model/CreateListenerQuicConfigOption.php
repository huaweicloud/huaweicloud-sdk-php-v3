...
class CreateListenerQuicConfigOption implements ModelInterface, ArrayAccess
{
    ...
    * enableQuicUpgrade  QUIC升级的开启状态。 True:开启QUIC升级； Flase：关闭QUIC升级（默认）。 开启HTTPS监听器升级QUIC监听器能力。  [不支持QUIC。](tag:hws_eu,g42,hk_g42,hcso_dt,dt,dt_test,tm)
    *
    * @var string[]
    */
    ...
    * Sets quicListenerId
    *
    * @param string $quicListenerId 监听器关联的QUIC监听器ID。指定的listener id必须已存在，且协议类型为QUIC，不能指定为null，否则与enable_quic_upgrade冲突。  [不支持QUIC。](tag:hws_eu,g42,hk_g42,hcso_dt,dt,dt_test,tm)
    *
    * @return $this
    */
    ...
    *  QUIC升级的开启状态。 True:开启QUIC升级； Flase：关闭QUIC升级（默认）。 开启HTTPS监听器升级QUIC监听器能力。  [不支持QUIC。](tag:hws_eu,g42,hk_g42,hcso_dt,dt,dt_test,tm)
    *
    * @return bool|null
    */
    ...
    *
    * @param bool|null $enableQuicUpgrade QUIC升级的开启状态。 True:开启QUIC升级； Flase：关闭QUIC升级（默认）。 开启HTTPS监听器升级QUIC监听器能力。  [不支持QUIC。](tag:hws_eu,g42,hk_g42,hcso_dt,dt,dt_test,tm)
    *
    * @return $this
    */
