...
class QuotaInfo implements ModelInterface, ArrayAccess
{
    ...
    * quotaKey  资源类型。  取值：loadbalancer、listener、ipgroup、pool、member、members_per_pool、 healthmonitor、l7policy、certificate、security_policy、condition_per_policy、listeners_per_pool、ipgroup_bindings、ipgroup_bindings，  其中members_per_pool表示一个pool下最多可关联的member数量。
    ...
    * Sets quotaKey
    *
    * @param string $quotaKey 资源类型。  取值：loadbalancer、listener、ipgroup、pool、member、members_per_pool、 healthmonitor、l7policy、certificate、security_policy、condition_per_policy、listeners_per_pool、ipgroup_bindings、ipgroup_bindings，  其中members_per_pool表示一个pool下最多可关联的member数量。
    *
    * @return $this
    */
