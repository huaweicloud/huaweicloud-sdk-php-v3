...
class CreateRuleOption implements ModelInterface, ArrayAccess
{
    ...
    * invert  参数解释：是否反向匹配。  取值范围：true、false，默认false。  不支持该字段，请勿使用。
    ...
    * Sets projectId
    *
    * @param string|null $projectId 参数解释：转发规则所在的项目ID。
    *
    * @return $this
    */
    ...
    * Sets invert
    *
    * @param bool|null $invert 参数解释：是否反向匹配。  取值范围：true、false，默认false。  不支持该字段，请勿使用。
    *
    * @return $this
    */
