...
class UpdateLoadbalancerAutoscalingOption implements ModelInterface, ArrayAccess
{
    ...
    * enable  **参数解释**：当前负载均衡器是否开启弹性扩缩容。  **约束限制**：不涉及  **取值范围**： - true：开启。 - false：不开启。  **默认取值**：不涉及
    * minL7FlavorId  **参数解释**：弹性扩缩容的最小七层规格ID（规格类型L7_elastic）。  **约束限制**：有七层监听器时，该字段不能为空。  **取值范围**：不涉及  **默认取值**：不涉及
    *
    * @var string[]
    */
    ...
    * Sets enable
    *
    * @param bool $enable **参数解释**：当前负载均衡器是否开启弹性扩缩容。  **约束限制**：不涉及  **取值范围**： - true：开启。 - false：不开启。  **默认取值**：不涉及
    *
    * @return $this
    */
    ...
    * Sets minL7FlavorId
    *
    * @param string|null $minL7FlavorId **参数解释**：弹性扩缩容的最小七层规格ID（规格类型L7_elastic）。  **约束限制**：有七层监听器时，该字段不能为空。  **取值范围**：不涉及  **默认取值**：不涉及
    *
    * @return $this
    */
