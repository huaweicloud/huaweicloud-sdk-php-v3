...
class UpdateListenerOption implements ModelInterface, ArrayAccess
{
    ...
    * adminStateUp  **参数解释**：监听器的管理状态。  **约束限制**：只支持更新为true。  **取值范围**：不涉及  **默认取值**：不涉及 [不支持该字段，请勿使用。](tag:dt,hcso_dt)
    * clientCaTlsContainerRef  **参数解释**：监听器使用的CA证书ID。  **约束限制**： - 当且仅当type=client时，才会使用该字段对应的证书。 - 监听器协议为QUIC时不支持该字段。  **取值范围**：不涉及  **默认取值**：不涉及  [不支持QUIC。](tag:tm,hws_eu,g42,hk_g42,hcso_dt,dt)
    * defaultPoolId  **参数解释**：监听器的默认后端服务器组ID。当请求没有匹配的转发策略时，转发到默认后端服务器组上处理。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
    * defaultTlsContainerRef  **参数解释**：监听器使用的服务器证书ID。  **约束限制**：当监听器协议为HTTPS时，该字段必传，且对应的证书的type必须是server类型。  **取值范围**：不涉及  **默认取值**：不涉及
    * description  **参数解释**：监听器的描述信息。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
    * http2Enable  **参数解释**：客户端与LB之间的HTTPS请求的HTTP2功能的开启状态。 开启后，可提升客户端与LB间的访问性能，但LB与后端服务器间仍采用HTTP1.X协议。  **约束限制**： - 仅HTTPS协议监听器有效。 - QUIC监听器不能设置该字段，固定返回为true。 - 其他协议的监听器可设置该字段但无效，无论取值如何都不影响监听器正常运行。  **取值范围**：不涉及  **默认取值**：不涉及  [不支持QUIC。](tag:tm,hws_eu,g42,hk_g42,hcso_dt,dt)
    * insertHeaders  insertHeaders
    * name  **参数解释**：监听器的名称。  **约束限制**：若名称为空，则在控制台的监听器列表无法选择并查看监听器详情。  **取值范围**：不涉及  **默认取值**：不涉及
    * sniContainerRefs  **参数解释**：监听器使用的SNI证书（带域名的服务器证书）ID列表。  **约束限制**： - QUIC监听器仅支持RSA证书。 - 列表对应的所有SNI证书的域名不允许存在重复。 - 列表对应的所有SNI证书的域名总数不超过200。  **取值范围**：不涉及  **默认取值**：不涉及  [不支持QUIC。](tag:tm,hws_eu,g42,hk_g42,hcso_dt,dt)
    * sniMatchAlgo  **参数解释**：监听器使用的SNI证书泛域名匹配方式。  **约束限制**：不涉及  **取值范围**： - longest_suffix表示最长尾缀匹配。 - wildcard表示标准域名分级匹配。  **默认取值**：wildcard。
    ...
    * enableMemberRetry  **参数解释**：是否开启后端服务器的重试。  [**约束限制**： - 若关联是共享型LB，仅在protocol为HTTP、TERMINATED_HTTPS时才能传入该字段。 - 若关联是独享型LB，仅在protocol为HTTP、HTTPS和QUIC时才能传入该字段。 ](tag:hws,hws_hk,ocb,ctc,hcs,g42,tm,cmcc,hk_g42,hws_ocb,hk_vdf,srg,fcs,dt)  [**约束限制**： - 仅在protocol为HTTP、HTTPS时才能传入该字段。](tag:hws_eu,hcso_dt)  **取值范围**：true 开启重试；false 不开启重试。  **默认取值**：true。  [不支持QUIC。](tag:tm,hws_eu,g42,hk_g42,hcso_dt,dt)
    ...
    * gzipEnable  **参数解释**：ELB是否开启gzip压缩。  [**约束限制**：仅HTTP/HTTPS类型监听器支持配置。](tag:tm,hws_eu,g42,hk_g42,hcso_dt,dt) [**约束限制**：仅HTTP/HTTPS/QUIC类型监听器支持配置。](tag:hws,hws_hk,hws_test,hcs,hcs_sm,hcso,hk_vdf,srg,fcs,fcs_vm,mix,ocb,ctc,cmcc,ct,sbc,hws_ocb,hk_sbc)  **取值范围**：不涉及  **默认取值**：false
    * sslEarlyDataEnable  **参数解释**：监听器0-RTT能力开关。  **约束限制**：仅HTTPS类型监听器支持配置，需要依赖TLSv1.3安全策略协议。开启 ssl_early_data 后，有重放攻击的风险，请谨慎开启。  **取值范围**：不涉及  **默认取值**：false
    ...
    */
    ...
    /**
    * Gets adminStateUp
    *  **参数解释**：监听器的管理状态。  **约束限制**：只支持更新为true。  **取值范围**：不涉及  **默认取值**：不涉及 [不支持该字段，请勿使用。](tag:dt,hcso_dt)
    *
    * @return bool|null
    */
    ...
    * Sets adminStateUp
    *
    * @param bool|null $adminStateUp **参数解释**：监听器的管理状态。  **约束限制**：只支持更新为true。  **取值范围**：不涉及  **默认取值**：不涉及 [不支持该字段，请勿使用。](tag:dt,hcso_dt)
    *
    * @return $this
    */
    ...
    *  **参数解释**：监听器使用的CA证书ID。  **约束限制**： - 当且仅当type=client时，才会使用该字段对应的证书。 - 监听器协议为QUIC时不支持该字段。  **取值范围**：不涉及  **默认取值**：不涉及  [不支持QUIC。](tag:tm,hws_eu,g42,hk_g42,hcso_dt,dt)
    *
    * @return string|null
    */
    ...
    *
    * @param string|null $clientCaTlsContainerRef **参数解释**：监听器使用的CA证书ID。  **约束限制**： - 当且仅当type=client时，才会使用该字段对应的证书。 - 监听器协议为QUIC时不支持该字段。  **取值范围**：不涉及  **默认取值**：不涉及  [不支持QUIC。](tag:tm,hws_eu,g42,hk_g42,hcso_dt,dt)
    *
    * @return $this
    */
    ...
    /**
    * Gets defaultPoolId
    *  **参数解释**：监听器的默认后端服务器组ID。当请求没有匹配的转发策略时，转发到默认后端服务器组上处理。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
    *
    * @return string|null
    */
    ...
    * Sets defaultPoolId
    *
    * @param string|null $defaultPoolId **参数解释**：监听器的默认后端服务器组ID。当请求没有匹配的转发策略时，转发到默认后端服务器组上处理。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
    *
    * @return $this
    */
    ...
    *  **参数解释**：监听器使用的服务器证书ID。  **约束限制**：当监听器协议为HTTPS时，该字段必传，且对应的证书的type必须是server类型。  **取值范围**：不涉及  **默认取值**：不涉及
    *
    * @return string|null
    */
    ...
    *
    * @param string|null $defaultTlsContainerRef **参数解释**：监听器使用的服务器证书ID。  **约束限制**：当监听器协议为HTTPS时，该字段必传，且对应的证书的type必须是server类型。  **取值范围**：不涉及  **默认取值**：不涉及
    *
    * @return $this
    */
    ...
    */
    ...
    /**
    * Gets http2Enable
    *  **参数解释**：客户端与LB之间的HTTPS请求的HTTP2功能的开启状态。 开启后，可提升客户端与LB间的访问性能，但LB与后端服务器间仍采用HTTP1.X协议。  **约束限制**： - 仅HTTPS协议监听器有效。 - QUIC监听器不能设置该字段，固定返回为true。 - 其他协议的监听器可设置该字段但无效，无论取值如何都不影响监听器正常运行。  **取值范围**：不涉及  **默认取值**：不涉及  [不支持QUIC。](tag:tm,hws_eu,g42,hk_g42,hcso_dt,dt)
    *
    * @return bool|null
    */
    ...
    * Sets http2Enable
    *
    * @param bool|null $http2Enable **参数解释**：客户端与LB之间的HTTPS请求的HTTP2功能的开启状态。 开启后，可提升客户端与LB间的访问性能，但LB与后端服务器间仍采用HTTP1.X协议。  **约束限制**： - 仅HTTPS协议监听器有效。 - QUIC监听器不能设置该字段，固定返回为true。 - 其他协议的监听器可设置该字段但无效，无论取值如何都不影响监听器正常运行。  **取值范围**：不涉及  **默认取值**：不涉及  [不支持QUIC。](tag:tm,hws_eu,g42,hk_g42,hcso_dt,dt)
    *
    * @return $this
    */
    ...
    */
    ...
    /**
    * Gets name
    *  **参数解释**：监听器的名称。  **约束限制**：若名称为空，则在控制台的监听器列表无法选择并查看监听器详情。  **取值范围**：不涉及  **默认取值**：不涉及
    *
    * @return string|null
    */
    ...
    * Sets name
    *
    * @param string|null $name **参数解释**：监听器的名称。  **约束限制**：若名称为空，则在控制台的监听器列表无法选择并查看监听器详情。  **取值范围**：不涉及  **默认取值**：不涉及
    *
    * @return $this
    */
    ...
    *  **参数解释**：监听器使用的SNI证书（带域名的服务器证书）ID列表。  **约束限制**： - QUIC监听器仅支持RSA证书。 - 列表对应的所有SNI证书的域名不允许存在重复。 - 列表对应的所有SNI证书的域名总数不超过200。  **取值范围**：不涉及  **默认取值**：不涉及  [不支持QUIC。](tag:tm,hws_eu,g42,hk_g42,hcso_dt,dt)
    *
    * @return string[]|null
    */
    ...
    *
    * @param string[]|null $sniContainerRefs **参数解释**：监听器使用的SNI证书（带域名的服务器证书）ID列表。  **约束限制**： - QUIC监听器仅支持RSA证书。 - 列表对应的所有SNI证书的域名不允许存在重复。 - 列表对应的所有SNI证书的域名总数不超过200。  **取值范围**：不涉及  **默认取值**：不涉及  [不支持QUIC。](tag:tm,hws_eu,g42,hk_g42,hcso_dt,dt)
    *
    * @return $this
    */
    ...
    /**
    * Gets sniMatchAlgo
    *  **参数解释**：监听器使用的SNI证书泛域名匹配方式。  **约束限制**：不涉及  **取值范围**： - longest_suffix表示最长尾缀匹配。 - wildcard表示标准域名分级匹配。  **默认取值**：wildcard。
    *
    * @return string|null
    */
    ...
    * Sets sniMatchAlgo
    *
    * @param string|null $sniMatchAlgo **参数解释**：监听器使用的SNI证书泛域名匹配方式。  **约束限制**：不涉及  **取值范围**： - longest_suffix表示最长尾缀匹配。 - wildcard表示标准域名分级匹配。  **默认取值**：wildcard。
    *
    * @return $this
    */
    ...
    */
    ...
    /**
    * Gets gzipEnable
    *  **参数解释**：ELB是否开启gzip压缩。  [**约束限制**：仅HTTP/HTTPS类型监听器支持配置。](tag:tm,hws_eu,g42,hk_g42,hcso_dt,dt) [**约束限制**：仅HTTP/HTTPS/QUIC类型监听器支持配置。](tag:hws,hws_hk,hws_test,hcs,hcs_sm,hcso,hk_vdf,srg,fcs,fcs_vm,mix,ocb,ctc,cmcc,ct,sbc,hws_ocb,hk_sbc)  **取值范围**：不涉及  **默认取值**：false
    *
    * @return bool|null
    */
    ...
    * Sets gzipEnable
    *
    * @param bool|null $gzipEnable **参数解释**：ELB是否开启gzip压缩。  [**约束限制**：仅HTTP/HTTPS类型监听器支持配置。](tag:tm,hws_eu,g42,hk_g42,hcso_dt,dt) [**约束限制**：仅HTTP/HTTPS/QUIC类型监听器支持配置。](tag:hws,hws_hk,hws_test,hcs,hcs_sm,hcso,hk_vdf,srg,fcs,fcs_vm,mix,ocb,ctc,cmcc,ct,sbc,hws_ocb,hk_sbc)  **取值范围**：不涉及  **默认取值**：false
    *
    * @return $this
    */
    ...
    *  **参数解释**：监听器0-RTT能力开关。  **约束限制**：仅HTTPS类型监听器支持配置，需要依赖TLSv1.3安全策略协议。开启 ssl_early_data 后，有重放攻击的风险，请谨慎开启。  **取值范围**：不涉及  **默认取值**：false
    *
    * @return bool|null
    */
    ...
    *
    * @param bool|null $sslEarlyDataEnable **参数解释**：监听器0-RTT能力开关。  **约束限制**：仅HTTPS类型监听器支持配置，需要依赖TLSv1.3安全策略协议。开启 ssl_early_data 后，有重放攻击的风险，请谨慎开启。  **取值范围**：不涉及  **默认取值**：false
    *
    * @return $this
    */
