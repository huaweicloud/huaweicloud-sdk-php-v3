...
class ListFeatureConfigsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListFeatureConfigsResponse';
    ...
    */
    protected static $openAPITypes = [
            'configs' => '\HuaweiCloud\SDK\Elb\V3\Model\FeatureConfig[]',
    ...
    *  参数解释：特性配置列表。
    *
    * @return \HuaweiCloud\SDK\Elb\V3\Model\FeatureConfig[]|null
    */
    ...
    * Sets configs
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\FeatureConfig[]|null $configs 参数解释：特性配置列表。
    *
    * @return $this
    */
