...
class UpdateFixtedResponseConfig implements ModelInterface, ArrayAccess
{
    ...
    * contentType  **参数解释**：返回body的格式。  **约束限制**：不涉及  **取值范围**： - text/plain - text/css - text/html - application/javascript - application/json  **默认取值**：application/json
    ...
    * Sets statusCode
    *
    * @param string|null $statusCode **参数解释**：返回码。  **约束限制**：不涉及  **取值范围**：200-299，400-499，500-599。  **默认取值**：不涉及
    *
    * @return $this
    */
    ...
    * Sets contentType
    *
    * @param string|null $contentType **参数解释**：返回body的格式。  **约束限制**：不涉及  **取值范围**： - text/plain - text/css - text/html - application/javascript - application/json  **默认取值**：application/json
    *
    * @return $this
    */
