...
class FixtedResponseConfig implements ModelInterface, ArrayAccess
{
    ...
    * Sets statusCode
    *
    * @param string $statusCode **参数解释**：返回码。  **取值范围**：200~299、400~499和500~599。
    *
    * @return $this
    */
    ...
    * Sets messageBody
    *
    * @param string $messageBody **参数解释**：返回消息内容。  **取值范围**：不涉及
    *
    * @return $this
    */
