...
class UpdateRedirectPoolsExtendConfig implements ModelInterface, ArrayAccess
{
    ...
    * rewriteUrlEnable  **参数解释**：是否开启url重定向。  **约束限制**：不涉及  **取值范围**：true 开启，false 未开启。  **默认取值**：不涉及
    ...
    */
    protected static $openAPITypes = [
            ...
            'rewriteUrlConfig' => '\HuaweiCloud\SDK\Elb\V3\Model\UpdateRewriteUrlConfig',
            ...
            'trafficLimitConfig' => '\HuaweiCloud\SDK\Elb\V3\Model\UpdateTrafficLimitConfig',
            'corsConfig' => '\HuaweiCloud\SDK\Elb\V3\Model\CreateCorsConfig',
            'trafficMirrorConfig' => '\HuaweiCloud\SDK\Elb\V3\Model\CreateTrafficMirrorConfig'
    ];
    ...
    *
    * @param bool|null $rewriteUrlEnable **参数解释**：是否开启url重定向。  **约束限制**：不涉及  **取值范围**：true 开启，false 未开启。  **默认取值**：不涉及
    *
    * @return $this
    */
    ...
    *  rewriteUrlConfig
    *
    * @return \HuaweiCloud\SDK\Elb\V3\Model\UpdateRewriteUrlConfig|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\UpdateRewriteUrlConfig|null $rewriteUrlConfig rewriteUrlConfig
    *
    * @return $this
    */
    ...
    *  trafficLimitConfig
    *
    * @return \HuaweiCloud\SDK\Elb\V3\Model\UpdateTrafficLimitConfig|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\UpdateTrafficLimitConfig|null $trafficLimitConfig trafficLimitConfig
    *
    * @return $this
    */
    ...
    *  corsConfig
    *
    * @return \HuaweiCloud\SDK\Elb\V3\Model\CreateCorsConfig|null
    */
    ...
    * Sets corsConfig
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\CreateCorsConfig|null $corsConfig corsConfig
    *
    * @return $this
    */
    ...
    *  trafficMirrorConfig
    *
    * @return \HuaweiCloud\SDK\Elb\V3\Model\CreateTrafficMirrorConfig|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Elb\V3\Model\CreateTrafficMirrorConfig|null $trafficMirrorConfig trafficMirrorConfig
    *
    * @return $this
    */
