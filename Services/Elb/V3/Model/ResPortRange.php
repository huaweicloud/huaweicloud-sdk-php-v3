...
class ResPortRange implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResPortRange';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * startPort  **参数解释**：起始端口。 **取值范围**：1-65535
    * endPort  **参数解释**：结束端口。 **取值范围**：1-65535
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['startPort'] === null) {
            $invalidProperties[] = "'startPort' can't be null";
        }
        if ($this->container['endPort'] === null) {
            $invalidProperties[] = "'endPort' can't be null";
        }
    ...
    * Sets startPort
    *
    * @param int $startPort **参数解释**：起始端口。 **取值范围**：1-65535
    *
    * @return $this
    */
    ...
    * Sets endPort
    *
    * @param int $endPort **参数解释**：结束端口。 **取值范围**：1-65535
    *
    * @return $this
    */
