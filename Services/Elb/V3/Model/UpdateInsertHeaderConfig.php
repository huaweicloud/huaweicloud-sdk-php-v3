...
class UpdateInsertHeaderConfig implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateInsertHeaderConfig';
    ...
    * valueType  **参数解释**：请求头参数类别。  **约束限制**：不涉及  **取值范围**：USER_DEFINED,REFERENCE_HEADER,SYSTEM_DEFINED  **默认取值**：不涉及
    * value  **参数解释**：请求头参数的值。  **约束限制**：当value_type为SYSTEM_DEFINED时，value只可从CLIENT-PORT,CLIENT-IP, ELB-PROTOCOL, ELB-ID, ELB-PORT, ELB-EIP, ELB-VIP中取值。  **取值范围**：1-128个字符，支持ascii码值32<=ch<=127范围内可打印字符，*和英文问号?。不能以空格开头或结尾。  **默认取值**：不涉及
    *
    * @var string[]
    */
    ...
    * Sets valueType
    *
    * @param string $valueType **参数解释**：请求头参数类别。  **约束限制**：不涉及  **取值范围**：USER_DEFINED,REFERENCE_HEADER,SYSTEM_DEFINED  **默认取值**：不涉及
    *
    * @return $this
    */
    ...
    * Sets value
    *
    * @param string $value **参数解释**：请求头参数的值。  **约束限制**：当value_type为SYSTEM_DEFINED时，value只可从CLIENT-PORT,CLIENT-IP, ELB-PROTOCOL, ELB-ID, ELB-PORT, ELB-EIP, ELB-VIP中取值。  **取值范围**：1-128个字符，支持ascii码值32<=ch<=127范围内可打印字符，*和英文问号?。不能以空格开头或结尾。  **默认取值**：不涉及
    *
    * @return $this
    */
