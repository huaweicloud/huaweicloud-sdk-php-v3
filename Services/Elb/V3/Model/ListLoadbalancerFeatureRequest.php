...
class ListLoadbalancerFeatureRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListLoadbalancerFeatureRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * loadbalancerId  ELB实例ID。
    *
    * @var string[]
    */
    ...
    * Sets loadbalancerId
    *
    * @param string $loadbalancerId ELB实例ID。
    *
    * @return $this
    */
