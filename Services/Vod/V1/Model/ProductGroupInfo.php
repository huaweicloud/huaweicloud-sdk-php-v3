...
class ProductGroupInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ProductGroupInfo';
    ...
    */
    protected static $openAPITypes = [
            'groupId' => 'string',
            'products' => '\HuaweiCloud\SDK\Vod\V1\Model\ProductUrlInfo[]'
    ];
    ...
    *  产物信息
    *
    * @return \HuaweiCloud\SDK\Vod\V1\Model\ProductUrlInfo[]|null
    */
    ...
    * Sets products
    *
    * @param \HuaweiCloud\SDK\Vod\V1\Model\ProductUrlInfo[]|null $products 产物信息
    *
    * @return $this
    */
