...
class DeleteThumbnailResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteThumbnailResult';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * assetId  删除截图结果对应的媒资id
    * taskId  删除截图结果对应的任务id
    * status  删除状态。  取值如下： - DELETED：已删除。 - FAILED：删除失败。 - UNKNOW：未知原因
    *
    * @var string[]
    */
    ...
    * Sets assetId
    *
    * @param string|null $assetId 删除截图结果对应的媒资id
    *
    * @return $this
    */
    ...
    * Sets taskId
    *
    * @param string|null $taskId 删除截图结果对应的任务id
    *
    * @return $this
    */
    ...
    * Sets status
    *
    * @param string|null $status 删除状态。  取值如下： - DELETED：已删除。 - FAILED：删除失败。 - UNKNOW：未知原因
    *
    * @return $this
    */
