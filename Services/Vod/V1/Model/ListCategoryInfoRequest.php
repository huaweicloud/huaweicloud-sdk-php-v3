...
class ListCategoryInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCategoryInfoRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * xSdkDate  使用AK/SK方式认证时必选，请求的发生时间。
    * id  视频分类ID，最多支持10个，传0表示查询所有一级分类
    *
    * @var string[]
    */
    ...
    * Sets id
    *
    * @param int[] $id 视频分类ID，最多支持10个，传0表示查询所有一级分类
    *
    * @return $this
    */
