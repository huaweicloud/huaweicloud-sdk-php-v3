...
class DeleteTranscodeProductRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteTranscodeProductRequest';
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vod\V1\Model\DeleteTranscodeProductReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vod\V1\Model\DeleteTranscodeProductReq|null $body body
    *
    * @return $this
    */
