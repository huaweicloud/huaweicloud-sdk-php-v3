...
class CreateObjectProcessTaskResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateObjectProcessTaskResponse';
    ...
    * Sets taskId
    *
    * @param string|null $taskId 转码工作流任务ID
    *
    * @return $this
    */
