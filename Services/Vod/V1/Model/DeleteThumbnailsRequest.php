...
class DeleteThumbnailsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteThumbnailsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * xSdkDate  使用AK/SK方式认证时必选，请求的发生时间。
    * assetId  媒资ID
    * taskId  删除指定截图任务的截图结果，一次最多10个
    *
    * @var string[]
    */
    ...
    * Sets taskId
    *
    * @param string[]|null $taskId 删除指定截图任务的截图结果，一次最多10个
    *
    * @return $this
    */
