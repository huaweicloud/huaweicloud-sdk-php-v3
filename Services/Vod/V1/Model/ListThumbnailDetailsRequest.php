...
class ListThumbnailDetailsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListThumbnailDetailsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * xSdkDate  使用AK/SK方式认证时必选，请求的发生时间。
    * taskId  截图对应的任务id
    * offset  查询偏移量。取值范围[0,20480]，默认值：0。
    * limit  查询一页返回数。取值范围[1,100]，默认值：20。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['taskId'] === null) {
            ...
            if (!is_null($this->container['offset']) && ($this->container['offset'] > 20480)) {
                $invalidProperties[] = "invalid value for 'offset', must be smaller than or equal to 20480.";
            }
    ...
    * Sets offset
    *
    * @param int|null $offset 查询偏移量。取值范围[0,20480]，默认值：0。
    *
    * @return $this
    */
    ...
    * Sets limit
    *
    * @param int|null $limit 查询一页返回数。取值范围[1,100]，默认值：20。
    *
    * @return $this
    */
