...
class CreateObjectRetrievalResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateObjectRetrievalResponse';
    ...
    * Sets taskId
    *
    * @param string|null $taskId 取回数据的任务id
    *
    * @return $this
    */
