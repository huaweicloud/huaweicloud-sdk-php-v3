...
class RefreshAssetRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RefreshAssetRequest';
    ...
    */
    protected static $openAPITypes = [
            'xSdkDate' => 'string',
            'body' => '\HuaweiCloud\SDK\Vod\V1\Model\RefreshTaskReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vod\V1\Model\RefreshTaskReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vod\V1\Model\RefreshTaskReq|null $body body
    *
    * @return $this
    */
