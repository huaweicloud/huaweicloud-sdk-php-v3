...
class ListAssetEditTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAssetEditTaskRequest';
    ...
    * Sets offset
    *
    * @param int|null $offset 查询偏移量，默认0
    *
    * @return $this
    */
    ...
    * Sets limit
    *
    * @param int|null $limit 查询一页返回数，默认10，最大支持100
    *
    * @return $this
    */
