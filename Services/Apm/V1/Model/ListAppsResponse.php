...
class ListAppsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'apps' => '\HuaweiCloud\SDK\Apm\V1\Model\AppNodeModel[]'
    ];
    ...
    *  组件信息列表。
    *
    * @return \HuaweiCloud\SDK\Apm\V1\Model\AppNodeModel[]|null
    */
    ...
    * Sets apps
    *
    * @param \HuaweiCloud\SDK\Apm\V1\Model\AppNodeModel[]|null $apps 组件信息列表。
    *
    * @return $this
    */
