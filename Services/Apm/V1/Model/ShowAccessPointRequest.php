...
class ShowAccessPointRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAccessPointRequest';
    ...
    */
    protected static $openAPITypes = [
            'businessId' => 'string',
            'xBusinessId' => 'int',
            'body' => '\HuaweiCloud\SDK\Apm\V1\Model\AccessPointModel'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Apm\V1\Model\AccessPointModel|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Apm\V1\Model\AccessPointModel|null $body body
    *
    * @return $this
    */
