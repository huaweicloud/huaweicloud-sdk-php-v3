...
class ShowFlameLineTreeRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowFlameLineTreeRequest';
    ...
    */
    protected static $openAPITypes = [
            'xBusinessId' => 'int',
            'body' => '\HuaweiCloud\SDK\Apm\V1\Model\FlameLineTreeInfo'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Apm\V1\Model\FlameLineTreeInfo|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Apm\V1\Model\FlameLineTreeInfo|null $body body
    *
    * @return $this
    */
