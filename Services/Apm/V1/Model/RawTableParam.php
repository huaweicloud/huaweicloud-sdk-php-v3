...
class RawTableParam implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RawTableParam';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * lastRowId  上一次扫描的数据ID。
    ...
    */
    protected static $openAPITypes = [
            'lastRowId' => 'string',
            'viewConfig' => '\HuaweiCloud\SDK\Apm\V1\Model\RawTableView',
            'page' => 'int',
            'pageSize' => 'int',
            'orderBy' => 'string',
            'searchWord' => 'string',
    ...
    */
    ...
    {
        $this->container['lastRowId'] = isset($data['lastRowId']) ? $data['lastRowId'] : null;
    ...
    */
    ...
    {
        return $this->container['lastRowId'];
    }

    /**
    * Sets lastRowId
    *
    * @param string|null $lastRowId 上一次扫描的数据ID。
    *
    * @return $this
    */
    public function setLastRowId($lastRowId)
    {
        $this->container['lastRowId'] = $lastRowId;
        return $this;
    }
    ...
    *  viewConfig
    *
    * @return \HuaweiCloud\SDK\Apm\V1\Model\RawTableView
    */
    ...
    * Sets viewConfig
    *
    * @param \HuaweiCloud\SDK\Apm\V1\Model\RawTableView $viewConfig viewConfig
    *
    * @return $this
    */
