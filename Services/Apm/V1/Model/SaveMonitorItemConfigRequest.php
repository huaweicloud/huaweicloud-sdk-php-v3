...
class SaveMonitorItemConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SaveMonitorItemConfigRequest';
    ...
    */
    protected static $openAPITypes = [
            'xBusinessId' => 'int',
            'body' => '\HuaweiCloud\SDK\Apm\V1\Model\SaveMonitorItemParam'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Apm\V1\Model\SaveMonitorItemParam|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Apm\V1\Model\SaveMonitorItemParam|null $body body
    *
    * @return $this
    */
