...
class ShowSumTableRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowSumTableRequest';
    ...
    */
    protected static $openAPITypes = [
            'xBusinessId' => 'int',
            'body' => '\HuaweiCloud\SDK\Apm\V1\Model\SumTableParam'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Apm\V1\Model\SumTableParam|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Apm\V1\Model\SumTableParam|null $body body
    *
    * @return $this
    */
