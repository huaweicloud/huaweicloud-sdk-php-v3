...
class FieldItem implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'FieldItem';
    ...
    * Sets trace
    *
    * @param bool|null $trace 是否是trace。
    *
    * @return $this
    */
