...
class TrendView implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TrendView';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * viewType  视图类型。
    * collectorName  采集器名称。
    * metricSet  视图对应的指标集名称。
    * title  图标所需展示的标题。
    * tableDirection  表格的方向，H：默认，表头横向，V：表头纵向。
    * groupBy  分组。
    * filter  过滤列表模型。
    * fieldItemList  所需展示的字段列表模型列表。
    * span  跨度。
    * spanField  span字段属性。
    * orderBy  排序。
    * latest  是否只展示最近一笔数据。
    ...
    * Sets metricSet
    *
    * @param string $metricSet 视图对应的指标集名称。
    *
    * @return $this
    */
    ...
    * Sets fieldItemList
    *
    * @param \HuaweiCloud\SDK\Apm\V1\Model\FieldItem[] $fieldItemList 所需展示的字段列表模型列表。
    *
    * @return $this
    */
    ...
    * Sets latest
    *
    * @param string|null $latest 是否只展示最近一笔数据。
    *
    * @return $this
    */
