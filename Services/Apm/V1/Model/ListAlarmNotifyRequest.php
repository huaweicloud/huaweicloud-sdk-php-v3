...
class ListAlarmNotifyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAlarmNotifyRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * xBusinessId  应用id，用于鉴权。
    * body  body
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'xBusinessId' => 'int',
            'body' => '\HuaweiCloud\SDK\Apm\V1\Model\AlarmNotifyListRequest'
    ];
    ...
    * Sets xBusinessId
    *
    * @param int $xBusinessId 应用id，用于鉴权。
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Apm\V1\Model\AlarmNotifyListRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Apm\V1\Model\AlarmNotifyListRequest|null $body body
    *
    * @return $this
    */
