...
class SearchEnvTopologyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchEnvTopologyRequest';
    ...
    */
    protected static $openAPITypes = [
            'xBusinessId' => 'int',
            'body' => '\HuaweiCloud\SDK\Apm\V1\Model\EnvTopoRequest'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Apm\V1\Model\EnvTopoRequest|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Apm\V1\Model\EnvTopoRequest|null $body body
    *
    * @return $this
    */
