...
class ShowMavenInfoResponse implements ModelInterface, ArrayAccess
{
    ...
    * result  **参数解释**： Maven仓库列表。 **取值范围**： 不涉及。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'traceId' => 'string',
            'result' => '\HuaweiCloud\SDK\CodeArtsArtifact\V2\Model\RepositoryBuildVO[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\CodeArtsArtifact\V2\Model\RepositoryBuildVO[]|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\CodeArtsArtifact\V2\Model\RepositoryBuildVO[]|null $result **参数解释**： Maven仓库列表。 **取值范围**： 不涉及。
    *
    * @return $this
    */
