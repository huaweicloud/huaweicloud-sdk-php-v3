...
class UpdateRepoRolesPrivilegeResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'traceId' => 'string',
            'result' => '\HuaweiCloud\SDK\CodeArtsArtifact\V2\Model\Privilege[]'
    ];
    ...
    *  参数解释: 权限信息。 取值范围: 不涉及。
    *
    * @return \HuaweiCloud\SDK\CodeArtsArtifact\V2\Model\Privilege[]|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\CodeArtsArtifact\V2\Model\Privilege[]|null $result 参数解释: 权限信息。 取值范围: 不涉及。
    *
    * @return $this
    */
