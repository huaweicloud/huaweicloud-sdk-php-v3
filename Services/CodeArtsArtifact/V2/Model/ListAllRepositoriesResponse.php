...
class ListAllRepositoriesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'traceId' => 'string',
            'result' => '\HuaweiCloud\SDK\CodeArtsArtifact\V2\Model\ListAllRepositoriesResult'
    ];
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\CodeArtsArtifact\V2\Model\ListAllRepositoriesResult|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\CodeArtsArtifact\V2\Model\ListAllRepositoriesResult|null $result result
    *
    * @return $this
    */
