...
class ListAttentionPageResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListAttentionPageResult';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalRecords  **参数解释**： 总记录数。 **取值范围**： 不涉及。
    * totalPages  **参数解释**： 总页数。 **取值范围**： 不涉及。
    * data  **参数解释**： 关注列表。 **取值范围**： 不涉及。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'totalRecords' => 'int',
            'totalPages' => 'int',
            'data' => '\HuaweiCloud\SDK\CodeArtsArtifact\V2\Model\ListAttentionResult[]'
    ];
    ...
    *  **参数解释**： 关注列表。 **取值范围**： 不涉及。
    *
    * @return \HuaweiCloud\SDK\CodeArtsArtifact\V2\Model\ListAttentionResult[]|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\CodeArtsArtifact\V2\Model\ListAttentionResult[]|null $data **参数解释**： 关注列表。 **取值范围**： 不涉及。
    *
    * @return $this
    */
