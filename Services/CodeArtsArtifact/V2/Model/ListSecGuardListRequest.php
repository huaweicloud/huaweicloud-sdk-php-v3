...
class ListSecGuardListRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSecGuardListRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * date  **参数解释**: 查询多少天内的任务。 **约束限制**: 不涉及。 **取值范围**: 不涉及。 **默认取值**: 1。
    ...
    * Sets date
    *
    * @param int|null $date **参数解释**: 查询多少天内的任务。 **约束限制**: 不涉及。 **取值范围**: 不涉及。 **默认取值**: 1。
    *
    * @return $this
    */
