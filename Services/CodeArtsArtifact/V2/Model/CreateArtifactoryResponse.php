...
class CreateArtifactoryResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'traceId' => 'string',
            'result' => '\HuaweiCloud\SDK\CodeArtsArtifact\V2\Model\CreateArtifactoryResult'
    ];
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\CodeArtsArtifact\V2\Model\CreateArtifactoryResult|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\CodeArtsArtifact\V2\Model\CreateArtifactoryResult|null $result result
    *
    * @return $this
    */
