...
class ListNetProxyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'traceId' => 'string',
            'result' => '\HuaweiCloud\SDK\CodeArtsArtifact\V2\Model\NetProxyModelV5[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\CodeArtsArtifact\V2\Model\NetProxyModelV5[]|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\CodeArtsArtifact\V2\Model\NetProxyModelV5[]|null $result **参数解释**: 网络代理列表。 **取值范围**: 不涉及。
    *
    * @return $this
    */
