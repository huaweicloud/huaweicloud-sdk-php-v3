...
class CreateMavenRepoResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateMavenRepoResult';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * release  **参数解释**： release仓库ID。 **取值范围**： 不涉及。
    * snapshot  **参数解释**： snapshot仓库ID。 **取值范围**： 不涉及。
    *
    * @var string[]
    */
    ...
    * Sets release
    *
    * @param string|null $release **参数解释**： release仓库ID。 **取值范围**： 不涉及。
    *
    * @return $this
    */
    ...
    * Sets snapshot
    *
    * @param string|null $snapshot **参数解释**： snapshot仓库ID。 **取值范围**： 不涉及。
    *
    * @return $this
    */
