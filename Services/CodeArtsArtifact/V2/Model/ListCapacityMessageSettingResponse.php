...
class ListCapacityMessageSettingResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListCapacityMessageSettingResponse';
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'traceId' => 'string',
            'result' => '\HuaweiCloud\SDK\CodeArtsArtifact\V2\Model\CapacitySettingVO'
    ];
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\CodeArtsArtifact\V2\Model\CapacitySettingVO|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\CodeArtsArtifact\V2\Model\CapacitySettingVO|null $result result
    *
    * @return $this
    */
