...
class ShowDomainReleaseRepoStorageResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDomainReleaseRepoStorageResponse';
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'traceId' => 'string',
            'result' => '\HuaweiCloud\SDK\CodeArtsArtifact\V2\Model\ReleaseStorageVOV5'
    ];
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\CodeArtsArtifact\V2\Model\ReleaseStorageVOV5|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\CodeArtsArtifact\V2\Model\ReleaseStorageVOV5|null $result result
    *
    * @return $this
    */
