...
class ShowFileTreeResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'status' => 'string',
            'traceId' => 'string',
            'result' => '\HuaweiCloud\SDK\CodeArtsArtifact\V2\Model\ShowFileTreeResult'
    ];
    ...
    *  result
    *
    * @return \HuaweiCloud\SDK\CodeArtsArtifact\V2\Model\ShowFileTreeResult|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\CodeArtsArtifact\V2\Model\ShowFileTreeResult|null $result result
    *
    * @return $this
    */
