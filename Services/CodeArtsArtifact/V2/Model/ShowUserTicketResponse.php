...
class ShowUserTicketResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * Sets result
    *
    * @param string|null $result 参数解释: ticket信息。 取值范围: 不涉及。
    *
    * @return $this
    */
