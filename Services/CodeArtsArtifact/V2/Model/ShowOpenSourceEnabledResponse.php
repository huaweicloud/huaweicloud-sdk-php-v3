...
class ShowOpenSourceEnabledResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * Sets result
    *
    * @param bool|null $result 参数解释: 查询结果。 取值范围: true：是； false：否。
    *
    * @return $this
    */
