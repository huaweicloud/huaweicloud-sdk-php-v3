...
class ShowAgencyPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAgencyPolicyRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * agencyName  委托名称。目前仅支持RDSAccessProjectResource。
