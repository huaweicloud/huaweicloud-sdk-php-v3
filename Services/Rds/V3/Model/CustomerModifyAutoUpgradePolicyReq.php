...
class CustomerModifyAutoUpgradePolicyReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CustomerModifyAutoUpgradePolicyReq';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * switchOption  自动小版本升级开关选项 true：打开自动小版本升级 false：关闭自动小版本升级
    *
    * @var string[]
    */
    ...
    * Sets switchOption
    *
    * @param bool $switchOption 自动小版本升级开关选项 true：打开自动小版本升级 false：关闭自动小版本升级
    *
    * @return $this
    */
