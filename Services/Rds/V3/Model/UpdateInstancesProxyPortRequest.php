...
class UpdateInstancesProxyPortRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'instanceId' => 'string',
            'proxyId' => 'string',
            'body' => '\HuaweiCloud\SDK\Rds\V3\Model\UpdateInstancesProxyPortRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\UpdateInstancesProxyPortRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\UpdateInstancesProxyPortRequestBody|null $body body
    *
    * @return $this
    */
