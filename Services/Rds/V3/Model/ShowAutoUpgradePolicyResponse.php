...
class ShowAutoUpgradePolicyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAutoUpgradePolicyResponse';
    ...
    * Sets switchOption
    *
    * @param bool|null $switchOption 自动小版本升级开关选项 true：打开自动小版本升级 false：关闭自动小版本升级
    *
    * @return $this
    */
