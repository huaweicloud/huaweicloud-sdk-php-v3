...
class ShowRestoreTablesRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowRestoreTablesRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * workflowId  **参数解释**：  任务流ID。  **约束限制**：  不涉及。  **取值范围**：  不涉及。  **默认取值**：  不涉及。
    * workflowName  **参数解释**：  任务名称。  **约束限制**：  不涉及。  **取值范围**：  - RestoreTableMysql - RestoreDatabaseMysql  **默认取值**：  不涉及。
    *
    * @var string[]
    */
    ...
    * Sets workflowId
    *
    * @param string $workflowId **参数解释**：  任务流ID。  **约束限制**：  不涉及。  **取值范围**：  不涉及。  **默认取值**：  不涉及。
    *
    * @return $this
    */
    ...
    * Sets workflowName
    *
    * @param string $workflowName **参数解释**：  任务名称。  **约束限制**：  不涉及。  **取值范围**：  - RestoreTableMysql - RestoreDatabaseMysql  **默认取值**：  不涉及。
    *
    * @return $this
    */
