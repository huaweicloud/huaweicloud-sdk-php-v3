...
class BackupPolicy implements ModelInterface, ArrayAccess
{
    ...
    * keepDays  指定已生成的备份文件可以保存的天数。  取值范围：1～732。如果需要延长保留时间请联系客服人员申请，自动备份最长可以保留10年。
    ...
    * Sets keepDays
    *
    * @param int $keepDays 指定已生成的备份文件可以保存的天数。  取值范围：1～732。如果需要延长保留时间请联系客服人员申请，自动备份最长可以保留10年。
    *
    * @return $this
    */
