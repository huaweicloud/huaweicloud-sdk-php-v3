...
class UpdateInstanceBackupMethodRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateInstanceBackupMethodRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * contentType  **参数解释**：  内容类型。  **约束限制**：  不涉及。  **取值范围**：  application/json。  **默认取值**：  application/json。
    ...
    */
    protected static $openAPITypes = [
            ...
            'xLanguage' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Rds\V3\Model\UpdateInstanceBackupMethodRequestBody'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['contentType'] === null) {
            ...
            if ((mb_strlen($this->container['contentType']) > 36)) {
                $invalidProperties[] = "invalid value for 'contentType', the character length must be smaller than or equal to 36.";
            }
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\UpdateInstanceBackupMethodRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\UpdateInstanceBackupMethodRequestBody|null $body body
    *
    * @return $this
    */
