...
class SwitchMySqlProxySlowLogRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SwitchMySqlProxySlowLogRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * ltsSlowLogEnabled  **参数解释**：  慢日志上报开关。  **约束限制**：  不涉及。  **取值范围**：  - on：开启。 - off：关闭。  **默认取值**：  不涉及。
    *
    * @var string[]
    */
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['ltsSlowLogEnabled'] === null) {
            $invalidProperties[] = "'ltsSlowLogEnabled' can't be null";
        }
    ...
    *
    * @param string $ltsSlowLogEnabled **参数解释**：  慢日志上报开关。  **约束限制**：  不涉及。  **取值范围**：  - on：开启。 - off：关闭。  **默认取值**：  不涉及。
    *
    * @return $this
    */
