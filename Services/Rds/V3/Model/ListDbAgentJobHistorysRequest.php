...
class ListDbAgentJobHistorysRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDbAgentJobHistorysRequest';
    ...
    * instanceId  实例ID
    * jobId  作业ID
    * runStatus  作业执行状态。默认不传，查询所有执行历史。 若传，则取值如下: failed:失败。 succeeded:成功。 retrying:重试中。 canceled:已取消。 in_progress:正在运行。
    ...
    * Sets runStatus
    *
    * @param string|null $runStatus 作业执行状态。默认不传，查询所有执行历史。 若传，则取值如下: failed:失败。 succeeded:成功。 retrying:重试中。 canceled:已取消。 in_progress:正在运行。
    *
    * @return $this
    */
