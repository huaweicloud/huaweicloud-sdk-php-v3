...
class ListInstanceBackupSummaryResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstanceBackupSummaryResponse';
    ...
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\InstanceBackupSummary[]|null
    */
    ...
    * Sets infos
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\InstanceBackupSummary[]|null $infos **参数解释**：  实例备份概览列表  **约束限制**：  不涉及。  **取值范围**：  不涉及。  **默认取值**：  不涉及。
    *
    * @return $this
    */
