...
class ShowBackupUsageExceededInstancesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowBackupUsageExceededInstancesRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * xLanguage  **参数解释**：  请求语言类型。  **约束限制**：  不涉及。  **取值范围**：  - en-us - zh-cn  **默认取值**：  en-us。
    * limit  **参数解释**：  查询记录数。  **约束限制**：  不涉及。  **取值范围**：  1-100。  **默认取值**：  100。
    * offset  **参数解释**：  索引位置，偏移量。  **约束限制**：  不涉及。  **取值范围**：  0及以上。  **默认取值**：  0。
    *
    * @var string[]
    */
    ...
    * Sets limit
    *
    * @param int|null $limit **参数解释**：  查询记录数。  **约束限制**：  不涉及。  **取值范围**：  1-100。  **默认取值**：  100。
    *
    * @return $this
    */
    ...
    * Sets offset
    *
    * @param int|null $offset **参数解释**：  索引位置，偏移量。  **约束限制**：  不涉及。  **取值范围**：  0及以上。  **默认取值**：  0。
    *
    * @return $this
    */
