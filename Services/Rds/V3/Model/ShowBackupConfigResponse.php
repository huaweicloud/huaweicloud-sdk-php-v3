...
class ShowBackupConfigResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowBackupConfigResponse';
    ...
    */
    ...
    {
        $invalidProperties = [];
            if (!is_null($this->container['defaultBackupMethod']) && (mb_strlen($this->container['defaultBackupMethod']) > 36)) {
                $invalidProperties[] = "invalid value for 'defaultBackupMethod', the character length must be smaller than or equal to 36.";
            }
            if (!is_null($this->container['defaultBackupMethod']) && (mb_strlen($this->container['defaultBackupMethod']) < 0)) {
    ...
    *
    * @param string|null $defaultBackupMethod 备份方式 - EBACKUP - PHYSICALBACKUP
    *
    * @return $this
    */
