...
class ResetConfigurationRequest implements ModelInterface, ArrayAccess
{
    ...
    * configId  **参数解释**：  参数模板id。  **约束限制**：  只允许填写自定义参数模板。
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['configId'] === null) {
            ...
            if ((mb_strlen($this->container['configId']) > 72)) {
                $invalidProperties[] = "invalid value for 'configId', the character length must be smaller than or equal to 72.";
            }
