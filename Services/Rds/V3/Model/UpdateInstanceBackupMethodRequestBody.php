...
class UpdateInstanceBackupMethodRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateInstanceBackupMethodRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * backupMethod  **参数解释**：  修改的备份方式。Db为物理备份（OBS），EBackup为CBR快照备份。  **约束限制**：  不涉及。
    *
    * @var string[]
    */
    ...
    * Sets backupMethod
    *
    * @param string|null $backupMethod **参数解释**：  修改的备份方式。Db为物理备份（OBS），EBackup为CBR快照备份。  **约束限制**：  不涉及。
    *
    * @return $this
    */
