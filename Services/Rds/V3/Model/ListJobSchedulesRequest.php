...
class ListJobSchedulesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListJobSchedulesRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * scheduleType  策略类型，snapshot:快照策略, sync:同步策略，默认查询所有类型
    * scheduleId  策略id
    * offset  索引位置，偏移量。从第一条数据偏移offset条数据后开始查询，默认为0（偏移0条数据，表示从第一条数据开始查询），必须为数字，不能为负数。
    * limit  查询记录数。默认为10，不能为负数，最小值为1，最大值为200。
    *
    * @var string[]
    */
    ...
    * Sets scheduleType
    *
    * @param string|null $scheduleType 策略类型，snapshot:快照策略, sync:同步策略，默认查询所有类型
    *
    * @return $this
    */
    ...
    * Sets scheduleId
    *
    * @param string|null $scheduleId 策略id
    *
    * @return $this
    */
    ...
    * Sets limit
    *
    * @param int|null $limit 查询记录数。默认为10，不能为负数，最小值为1，最大值为200。
    *
    * @return $this
    */
