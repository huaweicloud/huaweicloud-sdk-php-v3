...
class ModifyDbAgentJobResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ModifyDbAgentJobResponse';
    ...
    * runStatus  作业执行状态。取值如下:  0:失败。 1:成功。 2:重试中。 3:已取消。 4:正在运行。
    ...
    * Sets runStatus
    *
    * @param string|null $runStatus 作业执行状态。取值如下:  0:失败。 1:成功。 2:重试中。 3:已取消。 4:正在运行。
    *
    * @return $this
    */
