...
class PostgreSQLRestoreDatabaseInstance implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PostgreSQLRestoreDatabaseInstance';
    ...
    */
    protected static $openAPITypes = [
            'restoreTime' => 'int',
            'instanceId' => 'string',
            'databases' => '\HuaweiCloud\SDK\Rds\V3\Model\PostgreSQLRestoreDatabaseInfo[]'
    ];
    ...
    *  库信息
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\PostgreSQLRestoreDatabaseInfo[]|null
    */
    ...
    * Sets databases
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\PostgreSQLRestoreDatabaseInfo[]|null $databases 库信息
    *
    * @return $this
    */
