...
class UpgradeLargeVersionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpgradeLargeVersionRequest';
    ...
    */
    protected static $openAPITypes = [
            'xLanguage' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Rds\V3\Model\CustomerUpgradeMajorVersionReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\CustomerUpgradeMajorVersionReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\CustomerUpgradeMajorVersionReq|null $body body
    *
    * @return $this
    */
