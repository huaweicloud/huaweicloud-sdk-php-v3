...
class ShowHistorySessionAnalyseDownloadInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowHistorySessionAnalyseDownloadInfoRequest';
