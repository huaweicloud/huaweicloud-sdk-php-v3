...
class JobScheduleInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'JobScheduleInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  策略id。
    * userDefined  是否是用户自定义模板。false表示为系统默认模板。true表示为用户自定义模板。
    * scheduleType  策略类型，snapshot:快照策略, sync:同步策略。
    * jobScheduleType  计划类型。  automatically：SQL Server代理启动时自动启动。 cpu_idle：CPU空闲时启动。 recurring：重复执行。 one_time：执行一次。
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['dailyFrequency'] === null) {
            $invalidProperties[] = "'dailyFrequency' can't be null";
        }
    ...
    * Sets userDefined
    *
    * @param bool $userDefined 是否是用户自定义模板。false表示为系统默认模板。true表示为用户自定义模板。
    *
    * @return $this
    */
    ...
    * Sets scheduleType
    *
    * @param string $scheduleType 策略类型，snapshot:快照策略, sync:同步策略。
    *
    * @return $this
    */
    ...
    *
    * @param string|null $jobScheduleType 计划类型。  automatically：SQL Server代理启动时自动启动。 cpu_idle：CPU空闲时启动。 recurring：重复执行。 one_time：执行一次。
    *
    * @return $this
    */
    ...
    *  frequency
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\JobScheduleFrequencyInfo
    */
    ...
    * Sets frequency
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\JobScheduleFrequencyInfo $frequency frequency
    *
    * @return $this
    */
    ...
    *  dailyFrequency
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\JobScheduleDailyFrequencyInfo
    */
    ...
    * Sets dailyFrequency
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\JobScheduleDailyFrequencyInfo $dailyFrequency dailyFrequency
    *
    * @return $this
    */
    ...
    *  duration
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\JobScheduleDurationInfo
    */
    ...
    * Sets duration
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\JobScheduleDurationInfo $duration duration
    *
    * @return $this
    */
