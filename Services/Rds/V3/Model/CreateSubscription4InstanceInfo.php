...
class CreateSubscription4InstanceInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSubscription4InstanceInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * publicationId  直接创建订阅时，服务器来源为云上实例的发布id。
    * publicationName  直接创建订阅时，服务器来源为云上实例的发布名称。
    *
    * @var string[]
    */
    ...
    * Sets publicationId
    *
    * @param string $publicationId 直接创建订阅时，服务器来源为云上实例的发布id。
    *
    * @return $this
    */
    ...
    *
    * @param string|null $publicationName 直接创建订阅时，服务器来源为云上实例的发布名称。
    *
    * @return $this
    */
