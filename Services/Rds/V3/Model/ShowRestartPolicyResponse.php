...
class ShowRestartPolicyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowRestartPolicyResponse';
    ...
    * Sets restartPolicy
    *
    * @param object|null $restartPolicy 重启策略。
    *
    * @return $this
    */
