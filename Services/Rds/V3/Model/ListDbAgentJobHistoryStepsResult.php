...
class ListDbAgentJobHistoryStepsResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDbAgentJobHistoryStepsResult';
    ...
    * Sets stepName
    *
    * @param string|null $stepName 步骤名。
    *
    * @return $this
    */
