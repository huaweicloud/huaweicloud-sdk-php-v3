...
class ShowAgencyPolicyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAgencyPolicyResponse';
    ...
    */
    protected static $openAPITypes = [
            'isExisted' => 'bool',
            'name' => 'string',
            'roles' => '\HuaweiCloud\SDK\Rds\V3\Model\AgencyRole[]'
    ];
    ...
    *  委托角色列表。
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\AgencyRole[]|null
    */
    ...
    * Sets roles
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\AgencyRole[]|null $roles 委托角色列表。
    *
    * @return $this
    */
