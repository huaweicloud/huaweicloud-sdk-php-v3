...
class TargetConfig implements ModelInterface, ArrayAccess
{
    ...
    * flavor  当name=RESIZE_FLAVOR时，表示规格变更任务的目标规格。
    * cpu  当name=RESIZE_FLAVOR时，表示规格变更任务的的目标cpu。
    * mem  当name=RESIZE_FLAVOR时，表示规格变更任务的目标内存。
    *
    * @var string[]
    */
    ...
    * Sets flavor
    *
    * @param string|null $flavor 当name=RESIZE_FLAVOR时，表示规格变更任务的目标规格。
    *
    * @return $this
    */
    ...
    * Sets cpu
    *
    * @param string|null $cpu 当name=RESIZE_FLAVOR时，表示规格变更任务的的目标cpu。
    *
    * @return $this
    */
    ...
    * Sets mem
    *
    * @param string|null $mem 当name=RESIZE_FLAVOR时，表示规格变更任务的目标内存。
    *
    * @return $this
    */
