...
class ShowRestoreTablesResponse implements ModelInterface, ArrayAccess
{
    ...
    * dataList  **参数解释**：  已恢复库表信息列表。  **约束限制**：  不涉及。  **取值范围**：  不涉及。  **默认取值**：  不涉及。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'dataList' => '\HuaweiCloud\SDK\Rds\V3\Model\RestoreTablesInfo[]'
    ];
    ...
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\RestoreTablesInfo[]|null
    */
    ...
    * Sets dataList
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\RestoreTablesInfo[]|null $dataList **参数解释**：  已恢复库表信息列表。  **约束限制**：  不涉及。  **取值范围**：  不涉及。  **默认取值**：  不涉及。
    *
    * @return $this
    */
