...
class UpdateInstanceBackupMethodResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateInstanceBackupMethodResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * backupMethod  **参数解释**：  成功修改后的备份方式。  **约束限制**：  不涉及。
    *
    * @var string[]
    */
    ...
    * Sets backupMethod
    *
    * @param string|null $backupMethod **参数解释**：  成功修改后的备份方式。  **约束限制**：  不涉及。
    *
    * @return $this
    */
