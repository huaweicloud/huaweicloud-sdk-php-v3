...
class SwitchMySqlProxyEipRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SwitchMySqlProxyEipRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * publicIp  **参数解释**：  待绑定的弹性公网IP地址。  **约束限制**：  不涉及。  **取值范围**：  不涉及。  **默认取值**：  不涉及。
    * publicIpId  **参数解释**：  弹性公网IP地址对应的ID。请求为绑定弹性公网IP时需传入该参数，请求为解绑弹性公网IP时无需传入。  **约束限制**：  不涉及。  **取值范围**：  不涉及。  **默认取值**：  不涉及。
    * bind  **参数解释**：  请求是否为绑定弹性公网IP。  **约束限制**：  不涉及。  **取值范围**：  - true：表示请求为绑定弹性公网IP。 - false：表示请求为解绑弹性公网IP。  **默认取值**：  不涉及。
    *
    * @var string[]
    */
    ...
    * Sets publicIp
    *
    * @param string $publicIp **参数解释**：  待绑定的弹性公网IP地址。  **约束限制**：  不涉及。  **取值范围**：  不涉及。  **默认取值**：  不涉及。
    *
    * @return $this
    */
    ...
    * Sets publicIpId
    *
    * @param string|null $publicIpId **参数解释**：  弹性公网IP地址对应的ID。请求为绑定弹性公网IP时需传入该参数，请求为解绑弹性公网IP时无需传入。  **约束限制**：  不涉及。  **取值范围**：  不涉及。  **默认取值**：  不涉及。
    *
    * @return $this
    */
    ...
    * Sets bind
    *
    * @param string $bind **参数解释**：  请求是否为绑定弹性公网IP。  **约束限制**：  不涉及。  **取值范围**：  - true：表示请求为绑定弹性公网IP。 - false：表示请求为解绑弹性公网IP。  **默认取值**：  不涉及。
    *
    * @return $this
    */
