...
class UpdateBackupUsageAlarmConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateBackupUsageAlarmConfigRequest';
    ...
    */
    protected static $openAPITypes = [
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\Rds\V3\Model\UpdateBackupUsageAlarmConfigRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\UpdateBackupUsageAlarmConfigRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\UpdateBackupUsageAlarmConfigRequestBody|null $body body
    *
    * @return $this
    */
