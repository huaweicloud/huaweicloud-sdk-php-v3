...
class SwitchMySqlProxyEipRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SwitchMySqlProxyEipRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'instanceId' => 'string',
            'proxyId' => 'string',
            'body' => '\HuaweiCloud\SDK\Rds\V3\Model\SwitchMySqlProxyEipRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\SwitchMySqlProxyEipRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\SwitchMySqlProxyEipRequestBody|null $body body
    *
    * @return $this
    */
