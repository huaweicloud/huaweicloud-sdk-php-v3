...
class Task implements ModelInterface, ArrayAccess
{
    ...
    * orderId  订单ID。
    * process  任务进度，单位百分比，取值范围：0-100。当任务成功或者失败状态下，该值为空字符串。
    * failReason  失败原因。
    ...
    * status  任务状态。取值范围如下： Running:运行中 Completed:已完成 Failed:已失败
    *
    * @var string[]
    */
    ...
    * Sets process
    *
    * @param string|null $process 任务进度，单位百分比，取值范围：0-100。当任务成功或者失败状态下，该值为空字符串。
    *
    * @return $this
    */
    ...
    * Sets status
    *
    * @param string|null $status 任务状态。取值范围如下： Running:运行中 Completed:已完成 Failed:已失败
    *
    * @return $this
    */
