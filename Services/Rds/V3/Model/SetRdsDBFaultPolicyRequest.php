...
class SetRdsDBFaultPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SetRdsDBFaultPolicyRequest';
    ...
    */
    protected static $openAPITypes = [
            'xLanguage' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Rds\V3\Model\RdsDBFaultPolicyReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\RdsDBFaultPolicyReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\RdsDBFaultPolicyReq|null $body body
    *
    * @return $this
    */
