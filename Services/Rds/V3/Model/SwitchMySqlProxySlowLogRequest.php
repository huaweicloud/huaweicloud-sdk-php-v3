...
class SwitchMySqlProxySlowLogRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SwitchMySqlProxySlowLogRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  **参数解释**：  实例ID，此参数是实例的唯一标识。  **约束限制**：  不涉及。  **取值范围**：  只能由英文字母、数字组成，长度为36个字符。  **默认取值**：  不涉及。
    * proxyId  **参数解释**：  数据库代理ID，此参数是数据库代理的唯一标识。  **约束限制**：  不涉及。  **取值范围**：  只能由英文字母、数字组成，长度为36个字符。  **默认取值**：  不涉及。
    ...
    */
    protected static $openAPITypes = [
            ...
            'proxyId' => 'string',
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\Rds\V3\Model\SwitchMySqlProxySlowLogRequestBody'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['proxyId'] === null) {
            ...
            if ((mb_strlen($this->container['proxyId']) < 0)) {
                $invalidProperties[] = "invalid value for 'proxyId', the character length must be bigger than or equal to 0.";
            }
    ...
    * Sets proxyId
    *
    * @param string $proxyId **参数解释**：  数据库代理ID，此参数是数据库代理的唯一标识。  **约束限制**：  不涉及。  **取值范围**：  只能由英文字母、数字组成，长度为36个字符。  **默认取值**：  不涉及。
    *
    * @return $this
    */
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\SwitchMySqlProxySlowLogRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\SwitchMySqlProxySlowLogRequestBody|null $body body
    *
    * @return $this
    */
