...
class CreateDiskSpaceDiagnosisRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateDiskSpaceDiagnosisRequest';
    ...
    */
    protected static $openAPITypes = [
            'xLanguage' => 'string',
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Rds\V3\Model\CreateDiskSpaceDiagnosisRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\CreateDiskSpaceDiagnosisRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\CreateDiskSpaceDiagnosisRequestBody|null $body body
    *
    * @return $this
    */
