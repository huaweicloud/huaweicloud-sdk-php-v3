...
class UpdateSparseBackupPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateSparseBackupPolicyRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'body' => '\HuaweiCloud\SDK\Rds\V3\Model\UpdateSparseBackupPolicyReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\UpdateSparseBackupPolicyReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\UpdateSparseBackupPolicyReq|null $body body
    *
    * @return $this
    */
