...
class SubscriptionOptionsResult implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SubscriptionOptionsResult';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * independentAgent  独立的分发代理。  true：使用。 false：不使用。
    * replicateDdl  复制架构更改。  true：可更改。 false：不可更改。
    * snapshotAlwaysAvailable  快照始终可用。  true：可用。 false：不可用。
    ...
    *
    * @param bool|null $snapshotAlwaysAvailable 快照始终可用。  true：可用。 false：不可用。
    *
    * @return $this
    */
