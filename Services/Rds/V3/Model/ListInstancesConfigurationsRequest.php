...
class ListInstancesConfigurationsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstancesConfigurationsRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['configId'] === null) {
            ...
            if ((mb_strlen($this->container['configId']) > 64)) {
                $invalidProperties[] = "invalid value for 'configId', the character length must be smaller than or equal to 64.";
            }
            ...
            if (!is_null($this->container['xLanguage']) && (mb_strlen($this->container['xLanguage']) > 100)) {
                $invalidProperties[] = "invalid value for 'xLanguage', the character length must be smaller than or equal to 100.";
            }
