...
class ListDbAgentJobsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDbAgentJobsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * xLanguage  语言。默认en-us。
    * instanceId  实例ID
    * jobType  作业类型。默认不传，查询所有作业。 若传，则取值如下: replication:发布订阅相关作业。
    ...
    * Sets jobType
    *
    * @param string|null $jobType 作业类型。默认不传，查询所有作业。 若传，则取值如下: replication:发布订阅相关作业。
    *
    * @return $this
    */
