...
class CompareConfigurationRequestBody implements ModelInterface, ArrayAccess
{
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sourceId'] === null) {
            ...
            if ((mb_strlen($this->container['sourceId']) > 72)) {
                $invalidProperties[] = "invalid value for 'sourceId', the character length must be smaller than or equal to 72.";
            }
        ...
        if ($this->container['targetId'] === null) {
            ...
            if ((mb_strlen($this->container['targetId']) > 72)) {
                $invalidProperties[] = "invalid value for 'targetId', the character length must be smaller than or equal to 72.";
            }
            if ((mb_strlen($this->container['targetId']) < 0)) {
    ...
    * Sets sourceId
    *
    * @param string $sourceId **参数解释**：  源参数模板id。  **约束限制**：  不涉及。
    *
    * @return $this
    */
    ...
    * Sets targetId
    *
    * @param string $targetId **参数解释**：  目标参数模板id。  **约束限制**：  不涉及。
    *
    * @return $this
    */
