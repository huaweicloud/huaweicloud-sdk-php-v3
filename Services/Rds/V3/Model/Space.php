...
class Space implements ModelInterface, ArrayAccess
{
    ...
    * db  **参数解释**：  全量备份大小，单位GB。  **约束限制**：  不涉及。  **取值范围**：  不涉及。  **默认取值**：  不涉及。
    * log  **参数解释**：  增量备份大小，单位GB。  **约束限制**：  不涉及。  **取值范围**：  不涉及。  **默认取值**：  不涉及。
    *
    * @var string[]
    */
    ...
    * Sets db
    *
    * @param double|null $db **参数解释**：  全量备份大小，单位GB。  **约束限制**：  不涉及。  **取值范围**：  不涉及。  **默认取值**：  不涉及。
    *
    * @return $this
    */
    ...
    * Sets log
    *
    * @param double|null $log **参数解释**：  增量备份大小，单位GB。  **约束限制**：  不涉及。  **取值范围**：  不涉及。  **默认取值**：  不涉及。
    *
    * @return $this
    */
