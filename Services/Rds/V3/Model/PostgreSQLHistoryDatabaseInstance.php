...
class PostgreSQLHistoryDatabaseInstance implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PostgreSQLHistoryDatabaseInstance';
    ...
    */
    protected static $openAPITypes = [
            ...
            'name' => 'string',
            'totalTables' => 'int',
            'databases' => '\HuaweiCloud\SDK\Rds\V3\Model\PostgreSQLHistoryDatabaseInfo[]'
    ];
    ...
    *  数据库信息
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\PostgreSQLHistoryDatabaseInfo[]|null
    */
    ...
    * Sets databases
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\PostgreSQLHistoryDatabaseInfo[]|null $databases 数据库信息
    *
    * @return $this
    */
