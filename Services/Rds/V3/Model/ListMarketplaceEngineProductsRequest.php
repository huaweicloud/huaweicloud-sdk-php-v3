...
class ListMarketplaceEngineProductsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListMarketplaceEngineProductsRequest';
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['bpDomainId'] === null) {
            $invalidProperties[] = "'bpDomainId' can't be null";
        }
    ...
    * Sets engineId
    *
    * @param string|null $engineId 按照引擎ID查询。
    *
    * @return $this
    */
