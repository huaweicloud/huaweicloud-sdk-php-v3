...
class ListDbAgentJobHistorysResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListDbAgentJobHistorysResponse';
    ...
    * Sets totalCount
    *
    * @param int|null $totalCount 执行历史总数。
    *
    * @return $this
    */
