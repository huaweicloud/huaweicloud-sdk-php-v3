...
class ValidateConnectionUserInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ValidateConnectionUserInfo';
    ...
    * Sets serverIp
    *
    * @param string|null $serverIp 服务器ip。
    *
    * @return $this
    */
    ...
    * Sets loginUserName
    *
    * @param string|null $loginUserName 登录名。
    *
    * @return $this
    */
    ...
    *
    * @param string|null $loginUserPassword 登录密码。要求密码长度在5~64位之间。
    *
    * @return $this
    */
