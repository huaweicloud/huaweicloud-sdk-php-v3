...
class OperateUsedJobScheduleModify implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'OperateUsedJobScheduleModify';
    ...
    * Sets scheduleType
    *
    * @param string|null $scheduleType 策略类型。
    *
    * @return $this
    */
    ...
    * Sets userDefined
    *
    * @param bool|null $userDefined 是否自定义策略。
    *
    * @return $this
    */
