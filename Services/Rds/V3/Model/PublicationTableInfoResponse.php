...
class PublicationTableInfoResponse implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PublicationTableInfoResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * tableName  表名。
    * schema  命名空间。
    * columns  发布的字段（未传或为空说明选择所有字段）。
    * primaryKey  主键。
    * filterStatement  筛选语句。
    * filter  filter
    ...
    */
    protected static $openAPITypes = [
            ...
            'filter' => '\HuaweiCloud\SDK\Rds\V3\Model\PublicationTableFilterInfoResponse',
            'articleProperties' => '\HuaweiCloud\SDK\Rds\V3\Model\ArticlePropertiesResponse'
    ];
    ...
    * Sets columns
    *
    * @param string[]|null $columns 发布的字段（未传或为空说明选择所有字段）。
    *
    * @return $this
    */
    ...
    *
    * @param string|null $filterStatement 筛选语句。
    *
    * @return $this
    */
    ...
    * Sets filter
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\PublicationTableFilterInfoResponse|null $filter filter
    *
    * @return $this
    */
    ...
    *  articleProperties
    *
    * @return \HuaweiCloud\SDK\Rds\V3\Model\ArticlePropertiesResponse|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Rds\V3\Model\ArticlePropertiesResponse|null $articleProperties articleProperties
    *
    * @return $this
    */
