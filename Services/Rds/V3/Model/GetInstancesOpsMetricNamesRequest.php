...
class GetInstancesOpsMetricNamesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'GetInstancesOpsMetricNamesRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  **参数解释**：  实例ID，此参数是实例的唯一标识。  **约束限制**：  不涉及。  **取值范围**：  只能由英文字母、数字组成，长度为36个字符。  **默认取值**：  不涉及。
    * metricGroup  **参数解释**：  监控指标分组名称。  **约束限制**：  不涉及。  **取值范围**：  - realtimeMetric（实时指标） - highRequest（高请求指标） - slowSql（慢SQL指标） - lockWait（锁等待指标） - diskLimit（磁盘限制指标） - memoryLimit（内存限制指标） - importantMetric（重要指标）  **默认取值**：  不涉及。
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['metricGroup'] = isset($data['metricGroup']) ? $data['metricGroup'] : null;
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['metricGroup'] === null) {
            $invalidProperties[] = "'metricGroup' can't be null";
        }
    ...
    */
    ...
    {
        return $this->container['metricGroup'];
    }

    /**
    * Sets metricGroup
    *
    * @param string $metricGroup **参数解释**：  监控指标分组名称。  **约束限制**：  不涉及。  **取值范围**：  - realtimeMetric（实时指标） - highRequest（高请求指标） - slowSql（慢SQL指标） - lockWait（锁等待指标） - diskLimit（磁盘限制指标） - memoryLimit（内存限制指标） - importantMetric（重要指标）  **默认取值**：  不涉及。
    *
    * @return $this
    */
    public function setMetricGroup($metricGroup)
    {
        $this->container['metricGroup'] = $metricGroup;
        return $this;
    }
