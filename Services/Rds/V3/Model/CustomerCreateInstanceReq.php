...
class CustomerCreateInstanceReq implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CustomerCreateInstanceReq';
    ...
    * subscriptionAgency  授权给Billing服务的委托URN。使用RAM共享密钥创建包周期RDS实例时，需要传入该字段。
    *
    * @var string[]
    */
    ...
    */
    protected static $attributeMap = [
            ...
            'subscriptionAgency' => 'subscription_agency'
    ];
    ...
    *
    * @param string|null $subscriptionAgency 授权给Billing服务的委托URN。使用RAM共享密钥创建包周期RDS实例时，需要传入该字段。
    *
    * @return $this
    */
