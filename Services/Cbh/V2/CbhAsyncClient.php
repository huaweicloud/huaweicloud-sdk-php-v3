...
class CbhAsyncClient extends Client
{
     ...
     * @return response
     */
    public function listSwitchConfigInfoAsync($request)
    {
        return $this->listSwitchConfigInfoAsyncWithHttpInfo($request);
    }
    
    public function listSwitchConfigInfoAsyncWithHttpInfo($request){
        $collection_formats = [];
