...
class SwitchVirtualPrivateCloudRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SwitchVirtualPrivateCloudRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * serverId  需要切换vpc的实例id
    * network  network
    *
    * @var string[]
    */
    ...
    * Sets serverId
    *
    * @param string $serverId 需要切换vpc的实例id
    *
    * @return $this
    */
