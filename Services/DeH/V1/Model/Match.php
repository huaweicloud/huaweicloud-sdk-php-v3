...
class Match implements ModelInterface, ArrayAccess
{
    ...
    * key  键，表示要匹配的字段。  key不能重复，value为匹配的值。  此字段为固定字典值。  不允许为空字符串。  当前key的参数值仅支持resource_name，此时value的参数值为专属主机名称。
    * value  值。  每个值最大长度为255个unicode字符。  不可以为空 。
    *
    * @var string[]
    */
    ...
    * Sets key
    *
    * @param string $key 键，表示要匹配的字段。  key不能重复，value为匹配的值。  此字段为固定字典值。  不允许为空字符串。  当前key的参数值仅支持resource_name，此时value的参数值为专属主机名称。
    *
    * @return $this
    */
    ...
    * Sets value
    *
    * @param string $value 值。  每个值最大长度为255个unicode字符。  不可以为空 。
    *
    * @return $this
    */
