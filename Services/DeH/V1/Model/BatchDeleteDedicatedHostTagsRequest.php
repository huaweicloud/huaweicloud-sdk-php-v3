...
class BatchDeleteDedicatedHostTagsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteDedicatedHostTagsRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\DeH\V1\Model\ReqSetOrDeleteTags'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\DeH\V1\Model\ReqSetOrDeleteTags|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\DeH\V1\Model\ReqSetOrDeleteTags|null $body body
    *
    * @return $this
    */
