...
class Tag implements ModelInterface, ArrayAccess
{
    ...
    * values  值列表。  最多10个value。  value不允许重复。  每个值最大长度255个unicode字符。  如果value缺失则表示any_value。  value之间为“或”的关系。
    *
    * @var string[]
    */
    ...
    * Sets values
    *
    * @param string[]|null $values 值列表。  最多10个value。  value不允许重复。  每个值最大长度255个unicode字符。  如果value缺失则表示any_value。  value之间为“或”的关系。
    *
    * @return $this
    */
