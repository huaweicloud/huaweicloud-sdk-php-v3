...
class RespDeh implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RespDeh';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * resourceId  专属主机ID。
    * resourceDetail  专属主机详情。  该字段用于后续扩展，默认为空。
    * tags  标签列表。
    * resourceName  资源名称。
    *
    * @var string[]
    ...
    * Sets resourceId
    *
    * @param string $resourceId 专属主机ID。
    *
    * @return $this
    */
    ...
    * Sets resourceDetail
    *
    * @param string $resourceDetail 专属主机详情。  该字段用于后续扩展，默认为空。
    *
    * @return $this
    */
    ...
    *  标签列表。
    *
    * @return \HuaweiCloud\SDK\DeH\V1\Model\ResourceTag[]
    */
    ...
    * Sets tags
    *
    * @param \HuaweiCloud\SDK\DeH\V1\Model\ResourceTag[] $tags 标签列表。
    *
    * @return $this
    */
