...
class UpdateVpnAccessPolicyRequestBodyContent implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateVpnAccessPolicyRequestBodyContent';
    ...
    * Sets destIpCidrs
    *
    * @param string[]|null $destIpCidrs 目的IP网段列表，至少有一个网段
    *
    * @return $this
    */
