...
class DeleteVpnConnectionsLogConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteVpnConnectionsLogConfigRequest';
