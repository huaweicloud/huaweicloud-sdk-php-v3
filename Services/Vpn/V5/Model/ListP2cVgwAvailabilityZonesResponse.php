...
class ListP2cVgwAvailabilityZonesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListP2cVgwAvailabilityZonesResponse';
    ...
    *
    * @param string[]|null $availabilityZones 可用区列表
    *
    * @return $this
    */
