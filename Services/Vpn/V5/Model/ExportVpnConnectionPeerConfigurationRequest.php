...
class ExportVpnConnectionPeerConfigurationRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExportVpnConnectionPeerConfigurationRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Vpn\V5\Model\ExportPeerConfigurationRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\ExportPeerConfigurationRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\ExportPeerConfigurationRequestBody|null $body body
    *
    * @return $this
    */
