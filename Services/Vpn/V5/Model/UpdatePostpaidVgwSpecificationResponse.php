...
class UpdatePostpaidVgwSpecificationResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePostpaidVgwSpecificationResponse';
