...
class ListConnectionIpsecSaResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListConnectionIpsecSaResponse';
    ...
    */
    protected static $openAPITypes = [
            'saInfos' => '\HuaweiCloud\SDK\Vpn\V5\Model\SaInfo[]',
            'requestId' => 'string',
    ...
    */
    ...
    {
        $this->container['saInfos'] = isset($data['saInfos']) ? $data['saInfos'] : null;
    ...
    *  saInfos
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\SaInfo[]|null
    */
    public function getSaInfos()
    {
        return $this->container['saInfos'];
    }

    /**
    * Sets saInfos
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\SaInfo[]|null $saInfos saInfos
    *
    * @return $this
    */
    public function setSaInfos($saInfos)
    {
        $this->container['saInfos'] = $saInfos;
        return $this;
    }
