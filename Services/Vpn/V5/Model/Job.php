...
class Job implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'finishedAt' => '\DateTime',
            'errorMessage' => 'string',
            'subJobs' => '\HuaweiCloud\SDK\Vpn\V5\Model\SubJob[]'
    ];
    ...
    */
    ...
    const JOB_TYPE_UPGRADE = 'upgrade';
    const JOB_TYPE_ROLLBACK = 'rollback';
    const STATUS_UPGRADING = 'upgrading';
    const STATUS_PENDING_UPGRADE_CONFIRM = 'pending_upgrade_confirm';
    const STATUS_SUCCESS = 'success';
    const STATUS_ROLLING_BACK = 'rolling_back';
    const STATUS_ROLLBACK_SUCCESS = 'rollback_success';
    ...
    */
    ...
    {
        return [
            self::JOB_TYPE_UPGRADE,
            self::JOB_TYPE_ROLLBACK,
        ];
    }
    ...
    */
    public function getStatusAllowableValues()
    {
        return [
            ...
            self::STATUS_PENDING_UPGRADE_CONFIRM,
            self::STATUS_SUCCESS,
    ...
    *  子任务列表
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\SubJob[]|null
    */
    ...
    * Sets subJobs
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\SubJob[]|null $subJobs 子任务列表
    *
    * @return $this
    */
