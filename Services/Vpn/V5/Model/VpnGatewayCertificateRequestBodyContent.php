...
class VpnGatewayCertificateRequestBodyContent implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'VpnGatewayCertificateRequestBodyContent';
