...
class UpdateVpnUserResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateVpnUserResponse';
    ...
    */
    protected static $openAPITypes = [
            'user' => '\HuaweiCloud\SDK\Vpn\V5\Model\VpnUser',
            'requestId' => 'string',
    ...
    * Sets user
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\VpnUser|null $user user
    *
    * @return $this
    */
