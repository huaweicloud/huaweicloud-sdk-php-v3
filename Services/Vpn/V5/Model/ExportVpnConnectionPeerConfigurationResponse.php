...
class ExportVpnConnectionPeerConfigurationResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExportVpnConnectionPeerConfigurationResponse';
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['peerConfig'] = isset($data['peerConfig']) ? $data['peerConfig'] : null;
    ...
    * @return string|null
    */
    public function getPeerConfig()
    {
        return $this->container['peerConfig'];
    }

    /**
    * Sets peerConfig
    *
    * @param string|null $peerConfig 对端配置
    *
    * @return $this
    */
    public function setPeerConfig($peerConfig)
    {
        $this->container['peerConfig'] = $peerConfig;
        return $this;
    }
