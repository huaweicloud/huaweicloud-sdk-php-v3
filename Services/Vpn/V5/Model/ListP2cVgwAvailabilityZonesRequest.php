...
class ListP2cVgwAvailabilityZonesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListP2cVgwAvailabilityZonesRequest';
    ...
    * Sets flavor
    *
    * @param string|null $flavor flavor规格
    *
    * @return $this
    */
