...
class CreateVpnUserResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateVpnUserResponse';
    ...
    */
    protected static $openAPITypes = [
            'user' => '\HuaweiCloud\SDK\Vpn\V5\Model\CreateVpnUserResponseBodyUser',
            'requestId' => 'string',
    ...
    *  user
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\CreateVpnUserResponseBodyUser|null
    */
    ...
    * Sets user
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\CreateVpnUserResponseBodyUser|null $user user
    *
    * @return $this
    */
