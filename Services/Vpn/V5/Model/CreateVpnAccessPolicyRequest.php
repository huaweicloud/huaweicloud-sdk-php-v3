...
class CreateVpnAccessPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateVpnAccessPolicyRequest';
    ...
    */
    protected static $openAPITypes = [
            'vpnServerId' => 'string',
            'xClientToken' => 'string',
            'body' => '\HuaweiCloud\SDK\Vpn\V5\Model\CreateVpnAccessPolicyRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\CreateVpnAccessPolicyRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\CreateVpnAccessPolicyRequestBody|null $body body
    *
    * @return $this
    */
