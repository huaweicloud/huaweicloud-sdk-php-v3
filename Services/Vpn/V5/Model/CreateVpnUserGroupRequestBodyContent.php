...
class CreateVpnUserGroupRequestBodyContent implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateVpnUserGroupRequestBodyContent';
