...
class UpdateVpnServerRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateVpnServerRequest';
    ...
    */
    protected static $openAPITypes = [
            'vpnServerId' => 'string',
            'body' => '\HuaweiCloud\SDK\Vpn\V5\Model\UpdateServerRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\UpdateServerRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\UpdateServerRequestBody|null $body body
    *
    * @return $this
    */
