...
class ListVpnAccessPoliciesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListVpnAccessPoliciesResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * accessPolicies  访问资源策略信息
    * totalCount  总数
    * pageInfo  pageInfo
    * requestId  请求ID
    *
    ...
    */
    protected static $openAPITypes = [
            'accessPolicies' => '\HuaweiCloud\SDK\Vpn\V5\Model\VpnAccessPolicy[]',
            'totalCount' => 'int',
    ...
    *  访问资源策略信息
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\VpnAccessPolicy[]|null
    */
    ...
    * Sets accessPolicies
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\VpnAccessPolicy[]|null $accessPolicies 访问资源策略信息
    *
    * @return $this
    */
