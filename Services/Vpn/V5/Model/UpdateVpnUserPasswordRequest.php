...
class UpdateVpnUserPasswordRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateVpnUserPasswordRequest';
    ...
    */
    protected static $openAPITypes = [
            'vpnServerId' => 'string',
            'userId' => 'string',
            'body' => '\HuaweiCloud\SDK\Vpn\V5\Model\UpdateVpnUserPasswordRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\UpdateVpnUserPasswordRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\UpdateVpnUserPasswordRequestBody|null $body body
    *
    * @return $this
    */
