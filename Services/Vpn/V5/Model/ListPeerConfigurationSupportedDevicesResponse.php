...
class ListPeerConfigurationSupportedDevicesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListPeerConfigurationSupportedDevicesResponse';
    ...
    */
    protected static $openAPITypes = [
            'supportedDevices' => '\HuaweiCloud\SDK\Vpn\V5\Model\SupportedDevice[]',
            'requestId' => 'string',
    ...
    */
    ...
    {
        $this->container['supportedDevices'] = isset($data['supportedDevices']) ? $data['supportedDevices'] : null;
    ...
    */
    ...
    /**
    * Gets supportedDevices
    *  supportedDevices
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\SupportedDevice[]|null
    */
    public function getSupportedDevices()
    {
        return $this->container['supportedDevices'];
    }

    /**
    * Sets supportedDevices
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\SupportedDevice[]|null $supportedDevices supportedDevices
    *
    * @return $this
    */
    public function setSupportedDevices($supportedDevices)
    {
        $this->container['supportedDevices'] = $supportedDevices;
        return $this;
    }
