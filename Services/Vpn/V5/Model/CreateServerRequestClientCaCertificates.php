...
class CreateServerRequestClientCaCertificates implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateServerRequest_client_ca_certificates';
