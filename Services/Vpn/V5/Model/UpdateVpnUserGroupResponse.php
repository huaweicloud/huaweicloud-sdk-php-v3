...
class UpdateVpnUserGroupResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateVpnUserGroupResponse';
    ...
    */
    protected static $openAPITypes = [
            'userGroup' => '\HuaweiCloud\SDK\Vpn\V5\Model\VpnUserGroup',
            'requestId' => 'string',
    ...
    * Sets userGroup
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\VpnUserGroup|null $userGroup userGroup
    *
    * @return $this
    */
