...
class BatchCreateVpnUsersResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateVpnUsersResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * invalidUsers  异常的用户列表
    * requestId  请求ID
    ...
    */
    protected static $openAPITypes = [
            'invalidUsers' => '\HuaweiCloud\SDK\Vpn\V5\Model\InvalidVpnUser[]',
            'requestId' => 'string',
    ...
    */
    ...
    {
        $this->container['invalidUsers'] = isset($data['invalidUsers']) ? $data['invalidUsers'] : null;
    ...
    *  异常的用户列表
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\InvalidVpnUser[]|null
    */
    public function getInvalidUsers()
    {
        return $this->container['invalidUsers'];
    }

    /**
    * Sets invalidUsers
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\InvalidVpnUser[]|null $invalidUsers 异常的用户列表
    *
    * @return $this
    */
    public function setInvalidUsers($invalidUsers)
    {
        $this->container['invalidUsers'] = $invalidUsers;
        return $this;
    }
