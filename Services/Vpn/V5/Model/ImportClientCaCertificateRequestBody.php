...
class ImportClientCaCertificateRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ImportClientCaCertificateRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'clientCaCertificate' => '\HuaweiCloud\SDK\Vpn\V5\Model\ImportClientCaCertificateRequestBodyClientCaCertificate'
    ];
