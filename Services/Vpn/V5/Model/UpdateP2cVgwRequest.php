...
class UpdateP2cVgwRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateP2cVgwRequest';
    ...
    */
    protected static $openAPITypes = [
            'p2cVgwId' => 'string',
            'body' => '\HuaweiCloud\SDK\Vpn\V5\Model\UpdateP2cVgwRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\UpdateP2cVgwRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\UpdateP2cVgwRequestBody|null $body body
    *
    * @return $this
    */
