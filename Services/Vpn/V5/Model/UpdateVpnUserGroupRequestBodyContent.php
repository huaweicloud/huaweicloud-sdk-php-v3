...
class UpdateVpnUserGroupRequestBodyContent implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateVpnUserGroupRequestBodyContent';
    ...
    * Sets description
    *
    * @param string|null $description 用户组描述
    *
    * @return $this
    */
