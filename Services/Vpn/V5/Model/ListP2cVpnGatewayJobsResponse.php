...
class ListP2cVpnGatewayJobsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListP2cVpnGatewayJobsResponse';
    ...
    */
    protected static $openAPITypes = [
            'requestId' => 'string',
            'jobs' => '\HuaweiCloud\SDK\Vpn\V5\Model\Job[]'
    ];
    ...
    *  任务列表
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\Job[]|null
    */
    ...
    * Sets jobs
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\Job[]|null $jobs 任务列表
    *
    * @return $this
    */
