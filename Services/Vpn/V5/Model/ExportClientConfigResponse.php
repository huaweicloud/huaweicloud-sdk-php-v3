...
class ExportClientConfigResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExportClientConfigResponse';
    ...
    * Sets clientConfig
    *
    * @param string|null $clientConfig 客户端配置
    *
    * @return $this
    */
