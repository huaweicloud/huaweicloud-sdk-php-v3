...
class CreateP2cRequestEip implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateP2cRequestEip';
    ...
    * chargeMode  功能说明：按流量计费还是按带宽计费  取值范围：bandwidth，traffic
    * bandwidthSize  带宽大小Mbit/s。flavor为Professional1时，取值不能大于300
    * bandwidthName  带宽名称
    *
    * @var string[]
    */
    ...
    * Sets chargeMode
    *
    * @param string|null $chargeMode 功能说明：按流量计费还是按带宽计费  取值范围：bandwidth，traffic
    *
    * @return $this
    */
    ...
    * Sets bandwidthSize
    *
    * @param int|null $bandwidthSize 带宽大小Mbit/s。flavor为Professional1时，取值不能大于300
    *
    * @return $this
    */
