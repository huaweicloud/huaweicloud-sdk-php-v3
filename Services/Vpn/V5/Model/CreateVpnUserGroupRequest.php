...
class CreateVpnUserGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateVpnUserGroupRequest';
    ...
    */
    protected static $openAPITypes = [
            'vpnServerId' => 'string',
            'xClientToken' => 'string',
            'body' => '\HuaweiCloud\SDK\Vpn\V5\Model\CreateVpnUserGroupRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\CreateVpnUserGroupRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\CreateVpnUserGroupRequestBody|null $body body
    *
    * @return $this
    */
