...
class BatchCreateVpnConnectionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateVpnConnectionResponse';
    ...
    */
    protected static $openAPITypes = [
            'vpnConnections' => '\HuaweiCloud\SDK\Vpn\V5\Model\CreateResponseVpnConnection[]',
            'requestId' => 'string'
    ];
    ...
    * Sets vpnConnections
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\CreateResponseVpnConnection[]|null $vpnConnections vpnConnections
    *
    * @return $this
    */
