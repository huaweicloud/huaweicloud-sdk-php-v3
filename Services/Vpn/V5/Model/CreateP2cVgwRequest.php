...
class CreateP2cVgwRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateP2cVgwRequest';
    ...
    */
    protected static $openAPITypes = [
            'xClientToken' => 'string',
            'body' => '\HuaweiCloud\SDK\Vpn\V5\Model\CreateP2cVgwRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\CreateP2cVgwRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\CreateP2cVgwRequestBody|null $body body
    *
    * @return $this
    */
