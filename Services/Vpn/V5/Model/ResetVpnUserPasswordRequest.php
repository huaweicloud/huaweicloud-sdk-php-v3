...
class ResetVpnUserPasswordRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResetVpnUserPasswordRequest';
    ...
    */
    protected static $openAPITypes = [
            'vpnServerId' => 'string',
            'userId' => 'string',
            'body' => '\HuaweiCloud\SDK\Vpn\V5\Model\ResetVpnUserPasswordRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\ResetVpnUserPasswordRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\ResetVpnUserPasswordRequestBody|null $body body
    *
    * @return $this
    */
