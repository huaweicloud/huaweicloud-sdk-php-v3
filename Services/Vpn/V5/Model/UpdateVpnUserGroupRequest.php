...
class UpdateVpnUserGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateVpnUserGroupRequest';
    ...
    */
    protected static $openAPITypes = [
            'vpnServerId' => 'string',
            'groupId' => 'string',
            'body' => '\HuaweiCloud\SDK\Vpn\V5\Model\UpdateVpnUserGroupRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\UpdateVpnUserGroupRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\UpdateVpnUserGroupRequestBody|null $body body
    *
    * @return $this
    */
