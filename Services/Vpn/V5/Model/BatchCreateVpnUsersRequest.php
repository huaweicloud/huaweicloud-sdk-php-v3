...
class BatchCreateVpnUsersRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchCreateVpnUsersRequest';
    ...
    */
    protected static $openAPITypes = [
            'vpnServerId' => 'string',
            'xClientToken' => 'string',
            'body' => '\HuaweiCloud\SDK\Vpn\V5\Model\BatchCreateVpnUsersRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\BatchCreateVpnUsersRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\BatchCreateVpnUsersRequestBody|null $body body
    *
    * @return $this
    */
