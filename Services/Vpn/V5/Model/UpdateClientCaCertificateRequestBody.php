...
class UpdateClientCaCertificateRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateClientCaCertificateRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'clientCaCertificate' => '\HuaweiCloud\SDK\Vpn\V5\Model\UpdateClientCaCertificateRequestBodyClientCaCertificate'
    ];
    ...
    *  clientCaCertificate
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\UpdateClientCaCertificateRequestBodyClientCaCertificate|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\UpdateClientCaCertificateRequestBodyClientCaCertificate|null $clientCaCertificate clientCaCertificate
    *
    * @return $this
    */
