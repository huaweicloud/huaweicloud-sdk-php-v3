...
class UpdateVpnUserGroupRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateVpnUserGroupRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'userGroup' => '\HuaweiCloud\SDK\Vpn\V5\Model\UpdateVpnUserGroupRequestBodyContent'
    ];
