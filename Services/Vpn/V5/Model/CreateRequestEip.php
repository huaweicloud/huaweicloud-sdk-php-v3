...
class CreateRequestEip implements ModelInterface, ArrayAccess
{
    ...
    * bandwidthSize  带宽大小Mbit/s。flavor为Basic时，取值不能大于100；flavor为Professional1时，取值不能大于300；flavor为Professional2时，取值不能大于1024
    * bandwidthName  带宽名称
    *
    * @var string[]
    */
    ...
    * Sets bandwidthSize
    *
    * @param int|null $bandwidthSize 带宽大小Mbit/s。flavor为Basic时，取值不能大于100；flavor为Professional1时，取值不能大于300；flavor为Professional2时，取值不能大于1024
    *
    * @return $this
    */
