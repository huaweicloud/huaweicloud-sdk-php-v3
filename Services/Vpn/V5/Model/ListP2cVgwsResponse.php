...
class ListP2cVgwsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListP2cVgwsResponse';
    ...
    */
    public function getP2cVpnGateways()
    {
        return $this->container['p2cVpnGateways'];
    }

    /**
    * Sets p2cVpnGateways
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\ShowResponseP2cVgw[]|null $p2cVpnGateways 网关信息
    *
    * @return $this
    */
