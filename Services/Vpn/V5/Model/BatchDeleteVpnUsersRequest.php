...
class BatchDeleteVpnUsersRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'BatchDeleteVpnUsersRequest';
    ...
    */
    protected static $openAPITypes = [
            'vpnServerId' => 'string',
            'body' => '\HuaweiCloud\SDK\Vpn\V5\Model\BatchDeleteVpnUsersRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\BatchDeleteVpnUsersRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\BatchDeleteVpnUsersRequestBody|null $body body
    *
    * @return $this
    */
