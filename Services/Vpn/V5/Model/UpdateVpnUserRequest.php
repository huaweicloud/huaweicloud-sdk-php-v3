...
class UpdateVpnUserRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateVpnUserRequest';
    ...
    */
    protected static $openAPITypes = [
            'vpnServerId' => 'string',
            'userId' => 'string',
            'body' => '\HuaweiCloud\SDK\Vpn\V5\Model\UpdateVpnUserRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\UpdateVpnUserRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\UpdateVpnUserRequestBody|null $body body
    *
    * @return $this
    */
