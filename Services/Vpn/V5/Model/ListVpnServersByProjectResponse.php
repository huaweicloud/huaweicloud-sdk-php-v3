...
class ListVpnServersByProjectResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListVpnServersByProjectResponse';
    ...
    *  vpnServers
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\ShowServerResponse[]|null
    */
    public function getVpnServers()
    {
        return $this->container['vpnServers'];
    }

    /**
    * Sets vpnServers
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\ShowServerResponse[]|null $vpnServers vpnServers
    *
    * @return $this
    */
