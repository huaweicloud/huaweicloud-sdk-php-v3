...
class AddVpnUsersToGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddVpnUsersToGroupRequest';
    ...
    */
    protected static $openAPITypes = [
            'vpnServerId' => 'string',
            'groupId' => 'string',
            'body' => '\HuaweiCloud\SDK\Vpn\V5\Model\AddVpnUserToGroupRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\AddVpnUserToGroupRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\AddVpnUserToGroupRequestBody|null $body body
    *
    * @return $this
    */
