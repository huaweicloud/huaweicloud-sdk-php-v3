...
class CreateVpnUserRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateVpnUserRequest';
    ...
    */
    protected static $openAPITypes = [
            'vpnServerId' => 'string',
            'xClientToken' => 'string',
            'body' => '\HuaweiCloud\SDK\Vpn\V5\Model\CreateVpnUserRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Vpn\V5\Model\CreateVpnUserRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\CreateVpnUserRequestBody|null $body body
    *
    * @return $this
    */
