...
class UpdateVpnAccessPolicyResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateVpnAccessPolicyResponse';
    ...
    */
    protected static $openAPITypes = [
            'accessPolicy' => '\HuaweiCloud\SDK\Vpn\V5\Model\VpnAccessPolicy',
            'requestId' => 'string',
    ...
    * Sets accessPolicy
    *
    * @param \HuaweiCloud\SDK\Vpn\V5\Model\VpnAccessPolicy|null $accessPolicy accessPolicy
    *
    * @return $this
    */
