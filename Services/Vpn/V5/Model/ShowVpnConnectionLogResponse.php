...
class ShowVpnConnectionLogResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowVpnConnectionLogResponse';
    ...
    */
    protected static $openAPITypes = [
            'logs' => '\HuaweiCloud\SDK\Vpn\V5\Model\Log[]',
            'requestId' => 'string',
