...
class UpdateEmailTemplateRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateEmailTemplateRequestBody';
    ...
    * Sets templateName
    *
    * @param string|null $templateName 邮件模板名称
    *
    * @return $this
    */
    ...
    * Sets groupId
    *
    * @param int[]|null $groupId 实例组ID列表
    *
    * @return $this
    */
    ...
    * Sets healthRank
    *
    * @param string[]|null $healthRank 健康等级列表
    *
    * @return $this
    */
    ...
    * Sets inspectionTime
    *
    * @param string|null $inspectionTime 诊断时间，12:00-12:00（默认）或00:00-00:00
    *
    * @return $this
    */
    ...
    * Sets sendTime
    *
    * @param string|null $sendTime 发送时间
    *
    * @return $this
    */
