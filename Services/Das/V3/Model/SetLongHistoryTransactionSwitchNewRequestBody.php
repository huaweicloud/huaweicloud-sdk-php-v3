...
class SetLongHistoryTransactionSwitchNewRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SetLongHistoryTransactionSwitchNewRequestBody';
