...
class ShowDeadLockOriginDataRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDeadLockOriginDataRequest';
