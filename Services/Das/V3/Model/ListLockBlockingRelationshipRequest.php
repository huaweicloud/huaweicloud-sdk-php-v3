...
class ListLockBlockingRelationshipRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListLockBlockingRelationshipRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['uniqueId'] === null) {
            ...
            if ((mb_strlen($this->container['uniqueId']) > 1024)) {
                $invalidProperties[] = "invalid value for 'uniqueId', the character length must be smaller than or equal to 1024.";
            }
            if ((mb_strlen($this->container['uniqueId']) < 0)) {
                $invalidProperties[] = "invalid value for 'uniqueId', the character length must be bigger than or equal to 0.";
            }
        if ($this->container['spid'] === null) {
            $invalidProperties[] = "'spid' can't be null";
        }
            if (($this->container['spid'] > 253370736001000)) {
                $invalidProperties[] = "invalid value for 'spid', must be smaller than or equal to 253370736001000.";
            }
            if (($this->container['spid'] < 0)) {
