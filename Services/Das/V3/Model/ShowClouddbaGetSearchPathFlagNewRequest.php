...
class ShowClouddbaGetSearchPathFlagNewRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowClouddbaGetSearchPathFlagNewRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['connectionId'] === null) {
            ...
            if ((mb_strlen($this->container['connectionId']) > 0)) {
                $invalidProperties[] = "invalid value for 'connectionId', the character length must be smaller than or equal to 0.";
            }
            if ((mb_strlen($this->container['connectionId']) < 0)) {
