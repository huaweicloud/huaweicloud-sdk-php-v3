...
class ShowFullDeadLockListRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowFullDeadLockListRequest';
    ...
    * Sets pageSize
    *
    * @param int|null $pageSize 每页返回数量，默认10
    *
    * @return $this
    */
