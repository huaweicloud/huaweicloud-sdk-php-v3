...
class CreateMissingIndexExportTaskNewRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateMissingIndexExportTaskNewRequestBody';
    ...
    */
    protected static $openAPITypes = [
            ...
            'collectTime' => 'int',
            'bucketName' => 'string',
            'conditions' => '\HuaweiCloud\SDK\Das\V3\Model\ExportCondition[]',
            'objectName' => 'string',
            'sortField' => 'string',
            'sortAsc' => 'bool',
            'curPage' => 'int',
    ...
    *  过滤条件
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\ExportCondition[]
    */
    ...
    * Sets conditions
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\ExportCondition[] $conditions 过滤条件
    *
    * @return $this
    */
