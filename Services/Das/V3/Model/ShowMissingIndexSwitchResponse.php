...
class ShowMissingIndexSwitchResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowMissingIndexSwitchResponse';
    ...
    * Sets retentionHours
    *
    * @param int|null $retentionHours 保留时长
    *
    * @return $this
    */
    ...
    * Sets cantOpenMsg
    *
    * @param string|null $cantOpenMsg 无法开启的原因
    *
    * @return $this
    */
