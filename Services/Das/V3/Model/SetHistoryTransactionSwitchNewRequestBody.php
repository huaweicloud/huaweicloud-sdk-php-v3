...
class SetHistoryTransactionSwitchNewRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SetHistoryTransactionSwitchNewRequestBody';
