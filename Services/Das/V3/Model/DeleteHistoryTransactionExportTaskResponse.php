...
class DeleteHistoryTransactionExportTaskResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteHistoryTransactionExportTaskResponse';
