...
class SlowLogStatistics implements ModelInterface, ArrayAccess
{
    ...
    * nodeId  节点ID，按nodeId统计时赋值
    * nodeName  节点名称，按nodeId统计时赋值
    * sqlType  语句类型，按sqlType统计时赋值
    * dbName  库名，按dbName、collection统计时赋值
    ...
    * Sets executeCount
    *
    * @param int|null $executeCount 执行次数
    *
    * @return $this
    */
    ...
    * Sets avgExecuteTime
    *
    * @param double|null $avgExecuteTime 平均执行耗时(s)
    *
    * @return $this
    */
    ...
    * Sets maxExecuteTime
    *
    * @param double|null $maxExecuteTime 最大执行耗时(s)
    *
    * @return $this
    */
    ...
    *
    * @param double|null $avgLockWaitTime 平均锁等待时间(s)
    *
    * @return $this
    */
    ...
    *
    * @param double|null $maxLockWaitTime 最大锁等待时间(s)
    *
    * @return $this
    */
    ...
    * Sets avgKeyExamined
    *
    * @param double|null $avgKeyExamined 平均扫描索引数
    *
    * @return $this
    */
    ...
    * Sets maxKeyExamined
    *
    * @param double|null $maxKeyExamined 最大扫描索引数
    *
    * @return $this
    */
    ...
    * Sets nodeId
    *
    * @param string|null $nodeId 节点ID，按nodeId统计时赋值
    *
    * @return $this
    */
    ...
    * Sets nodeName
    *
    * @param string|null $nodeName 节点名称，按nodeId统计时赋值
    *
    * @return $this
    */
    ...
    * Sets sqlType
    *
    * @param string|null $sqlType 语句类型，按sqlType统计时赋值
    *
    * @return $this
    */
    ...
    * Sets dbName
    *
    * @param string|null $dbName 库名，按dbName、collection统计时赋值
    *
    * @return $this
    */
