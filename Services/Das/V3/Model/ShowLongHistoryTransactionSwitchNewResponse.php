...
class ShowLongHistoryTransactionSwitchNewResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowLongHistoryTransactionSwitchNewResponse';
    ...
    * Sets threshold
    *
    * @param int|null $threshold 长事务阈值
    *
    * @return $this
    */
