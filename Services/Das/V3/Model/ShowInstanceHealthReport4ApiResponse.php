...
class ShowInstanceHealthReport4ApiResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowInstanceHealthReport4ApiResponse';
    ...
    */
    protected static $openAPITypes = [
            ...
            'endAt' => 'int',
            'taskId' => 'string',
            'summaryInfo' => '\HuaweiCloud\SDK\Das\V3\Model\SummaryInfo',
            'instanceInfo' => '\HuaweiCloud\SDK\Das\V3\Model\HealthReportInstanceInfo',
            'performanceStat' => '\HuaweiCloud\SDK\Das\V3\Model\PerformanceStat',
            'diskStat' => '\HuaweiCloud\SDK\Das\V3\Model\DiskStat',
            'tableSpaceStat' => '\HuaweiCloud\SDK\Das\V3\Model\TableSpaceStat',
            'slowLogStat' => '\HuaweiCloud\SDK\Das\V3\Model\SlowLogStat',
            'fullSqlStat' => '\HuaweiCloud\SDK\Das\V3\Model\FullSqlStat',
            'inspectionStat' => '\HuaweiCloud\SDK\Das\V3\Model\InspectionStat',
            'errorMessage' => 'string',
            'suffixUri' => 'string'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['suffixUri'] = isset($data['suffixUri']) ? $data['suffixUri'] : null;
    }
    ...
    *  summaryInfo
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\SummaryInfo|null
    */
    ...
    * Sets summaryInfo
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\SummaryInfo|null $summaryInfo summaryInfo
    *
    * @return $this
    */
    ...
    *  performanceStat
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\PerformanceStat|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\PerformanceStat|null $performanceStat performanceStat
    *
    * @return $this
    */
    ...
    *  diskStat
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\DiskStat|null
    */
    ...
    * Sets diskStat
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\DiskStat|null $diskStat diskStat
    *
    * @return $this
    */
    ...
    *  tableSpaceStat
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\TableSpaceStat|null
    */
    ...
    * Sets tableSpaceStat
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\TableSpaceStat|null $tableSpaceStat tableSpaceStat
    *
    * @return $this
    */
    ...
    *  slowLogStat
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\SlowLogStat|null
    */
    ...
    * Sets slowLogStat
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\SlowLogStat|null $slowLogStat slowLogStat
    *
    * @return $this
    */
    ...
    *  fullSqlStat
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\FullSqlStat|null
    */
    ...
    * Sets fullSqlStat
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\FullSqlStat|null $fullSqlStat fullSqlStat
    *
    * @return $this
    */
    ...
    *  inspectionStat
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\InspectionStat|null
    */
    ...
    * Sets inspectionStat
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\InspectionStat|null $inspectionStat inspectionStat
    *
    * @return $this
    */
    ...
    * @return string|null
    */
    public function getSuffixUri()
    {
        return $this->container['suffixUri'];
    }

    /**
    * Sets suffixUri
    *
    * @param string|null $suffixUri 报告链接
    *
    * @return $this
    */
    public function setSuffixUri($suffixUri)
    {
        $this->container['suffixUri'] = $suffixUri;
        return $this;
    }
