...
class ListInstancesApiResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstancesApiResponse';
    ...
    */
    protected static $openAPITypes = [
            'instanceInfos' => '\HuaweiCloud\SDK\Das\V3\Model\DASInstanceInfoDto[]',
            'totalCount' => 'int'
    ];
    ...
    *  实例列表
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\DASInstanceInfoDto[]|null
    */
    ...
    * Sets instanceInfos
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\DASInstanceInfoDto[]|null $instanceInfos 实例列表
    *
    * @return $this
    */
