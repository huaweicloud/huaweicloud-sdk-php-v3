...
class UpdateDbUserRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateDbUserRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'dbUserId' => 'string',
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\Das\V3\Model\UpdateDbUserRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\UpdateDbUserRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\UpdateDbUserRequestBody|null $body body
    *
    * @return $this
    */
