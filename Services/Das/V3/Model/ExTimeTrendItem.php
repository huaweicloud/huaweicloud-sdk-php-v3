...
class ExTimeTrendItem implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExTimeTrendItem';
    ...
    * Sets executeAt
    *
    * @param int|null $executeAt SQL执行的时间点
    *
    * @return $this
    */
    ...
    * Sets executeTime
    *
    * @param double|null $executeTime SQL执行耗时
    *
    * @return $this
    */
