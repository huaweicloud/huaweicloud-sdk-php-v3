...
class SetRapidGrowthThresholdNewRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SetRapidGrowthThresholdNewRequestBody';
