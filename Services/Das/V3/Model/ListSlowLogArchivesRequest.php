...
class ListSlowLogArchivesRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSlowLogArchivesRequest';
    ...
    * Sets startTime
    *
    * @param int $startTime 开始时间（Unix时间戳，毫秒）
    *
    * @return $this
    */
    ...
    * Sets endTime
    *
    * @param int $endTime 结束时间（Unix时间戳，毫秒）
    *
    * @return $this
    */
