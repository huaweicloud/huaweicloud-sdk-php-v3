...
class CreateInstanceHealthReportTaskNewResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateInstanceHealthReportTaskNewResponse';
    ...
    * Sets createSuccess
    *
    * @param bool|null $createSuccess 是否成功
    *
    * @return $this
    */
