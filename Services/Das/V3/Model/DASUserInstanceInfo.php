...
class DASUserInstanceInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DASUserInstanceInfo';
    ...
    * Sets engineVersion
    *
    * @param string|null $engineVersion 实例版本号
    *
    * @return $this
    */
