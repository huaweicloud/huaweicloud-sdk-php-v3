...
class ObsObjectInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ObsObjectInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * objectKey  对象的名称
    * contentLength  对象文件的大小
    *
    * @var string[]
    */
    ...
    * Sets objectKey
    *
    * @param string|null $objectKey 对象的名称
    *
    * @return $this
    */
    ...
    * Sets contentLength
    *
    * @param int|null $contentLength 对象文件的大小
    *
    * @return $this
    */
