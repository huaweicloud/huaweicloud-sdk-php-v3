...
class ListMissingIndexDetailsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListMissingIndexDetailsRequestBody';
    ...
    */
    protected static $openAPITypes = [
            'conditions' => '\HuaweiCloud\SDK\Das\V3\Model\MissingIndexCondition[]',
            'objectName' => 'string',
            'sortField' => 'string',
            'sortAsc' => 'bool',
            'curPage' => 'int',
    ...
    *  过滤条件
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\MissingIndexCondition[]
    */
    ...
    * Sets conditions
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\MissingIndexCondition[] $conditions 过滤条件
    *
    * @return $this
    */
