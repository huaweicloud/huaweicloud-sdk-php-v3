...
class ShowDeadLockStatisticsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDeadLockStatisticsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * lastDayCount  近1天死锁/锁阻塞总数
    * lastWeekCount  近1周死锁/锁阻塞总数
    * lastTwoWeekCount  近2周死锁/锁阻塞总数
    * lastMonthCount  近1月死锁/锁阻塞总数
    *
    * @var string[]
    */
    ...
    * Sets lastDayCount
    *
    * @param int|null $lastDayCount 近1天死锁/锁阻塞总数
    *
    * @return $this
    */
    ...
    * Sets lastWeekCount
    *
    * @param int|null $lastWeekCount 近1周死锁/锁阻塞总数
    *
    * @return $this
    */
    ...
    *
    * @param int|null $lastTwoWeekCount 近2周死锁/锁阻塞总数
    *
    * @return $this
    */
    ...
    * Sets lastMonthCount
    *
    * @param int|null $lastMonthCount 近1月死锁/锁阻塞总数
    *
    * @return $this
    */
