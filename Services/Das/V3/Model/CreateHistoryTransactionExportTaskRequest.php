...
class CreateHistoryTransactionExportTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateHistoryTransactionExportTaskRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\Das\V3\Model\CreateExportTaskReq'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\CreateExportTaskReq|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\CreateExportTaskReq|null $body body
    *
    * @return $this
    */
