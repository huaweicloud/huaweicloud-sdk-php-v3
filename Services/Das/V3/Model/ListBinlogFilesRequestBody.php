...
class ListBinlogFilesRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListBinlogFilesRequestBody';
    ...
    * Sets binlogType
    *
    * @param string $binlogType binlog类型
    *
    * @return $this
    */
