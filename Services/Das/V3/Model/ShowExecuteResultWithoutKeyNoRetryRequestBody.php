...
class ShowExecuteResultWithoutKeyNoRetryRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowExecuteResultWithoutKeyNoRetryRequestBody';
    ...
    * Sets executeId
    *
    * @param string $executeId SQL执行ID
    *
    * @return $this
    */
