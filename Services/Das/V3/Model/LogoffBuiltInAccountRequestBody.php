...
class LogoffBuiltInAccountRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'LogoffBuiltInAccountRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * datastoreType  数据库引擎，仅支持MySQL
    *
    * @var string[]
    */
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['datastoreType'] === null) {
            ...
            if ((mb_strlen($this->container['datastoreType']) > 1024)) {
                $invalidProperties[] = "invalid value for 'datastoreType', the character length must be smaller than or equal to 1024.";
            }
    ...
    * Sets datastoreType
    *
    * @param string $datastoreType 数据库引擎，仅支持MySQL
    *
    * @return $this
    */
