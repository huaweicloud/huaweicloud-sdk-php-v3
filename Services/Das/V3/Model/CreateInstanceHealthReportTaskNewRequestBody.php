...
class CreateInstanceHealthReportTaskNewRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateInstanceHealthReportTaskNewRequestBody';
    ...
    * Sets startAt
    *
    * @param int $startAt 开始时间（Unix时间戳，毫秒）
    *
    * @return $this
    */
    ...
    * Sets endAt
    *
    * @param int $endAt 结束时间（Unix时间戳，毫秒）
    *
    * @return $this
    */
