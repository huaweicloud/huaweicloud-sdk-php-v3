...
class ListInstanceEmergencyLogsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstanceEmergencyLogsRequest';
    ...
    * Sets startTime
    *
    * @param int|null $startTime 开始时间（Unix时间戳，毫秒）
    *
    * @return $this
    */
    ...
    * Sets endTime
    *
    * @param int|null $endTime 结束时间（Unix时间戳，毫秒）
    *
    * @return $this
    */
