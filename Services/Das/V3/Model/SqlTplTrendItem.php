...
class SqlTplTrendItem implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SqlTplTrendItem';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * executeAt  执行时间 ms
    * queryTimeIn500ms  耗时在500ms的个数
    * queryTimeIn100ms  耗时在100ms的个数
    * queryTimeIn1s  耗时在1s的个数
    * queryTimeOver1s  耗时超过1s的个数
    * queryExecutions  总个数
    *
    * @var string[]
    */
    ...
    */
    protected static $attributeMap = [
            ...
            'queryTimeIn500ms' => 'query_time_in500ms',
            'queryTimeIn100ms' => 'query_time_in100ms',
            'queryTimeIn1s' => 'query_time_in1s',
            'queryTimeOver1s' => 'query_time_over1s',
    ...
    */
    protected static $setters = [
            ...
            'queryExecutions' => 'setQueryExecutions'
    ];
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['queryExecutions'] = isset($data['queryExecutions']) ? $data['queryExecutions'] : null;
    }
    ...
    * Sets executeAt
    *
    * @param int|null $executeAt 执行时间 ms
    *
    * @return $this
    */
    ...
    *
    * @param int|null $queryTimeIn500ms 耗时在500ms的个数
    *
    * @return $this
    */
    ...
    *
    * @param int|null $queryTimeIn100ms 耗时在100ms的个数
    *
    * @return $this
    */
    ...
    * Sets queryTimeIn1s
    *
    * @param int|null $queryTimeIn1s 耗时在1s的个数
    *
    * @return $this
    */
    ...
    *
    * @param int|null $queryTimeOver1s 耗时超过1s的个数
    *
    * @return $this
    */
    ...
    /**
    * Gets queryExecutions
    *  总个数
    *
    * @return int|null
    */
    public function getQueryExecutions()
    {
        return $this->container['queryExecutions'];
    }

    /**
    * Sets queryExecutions
    *
    * @param int|null $queryExecutions 总个数
    *
    * @return $this
    */
    public function setQueryExecutions($queryExecutions)
    {
        $this->container['queryExecutions'] = $queryExecutions;
        return $this;
    }
