...
class ShowSqlTemplateTrendResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowSqlTemplateTrendResponse';
    ...
    */
    protected static $openAPITypes = [
            'intervalMillis' => 'int',
            'itemList' => '\HuaweiCloud\SDK\Das\V3\Model\SqlTplTrendItem[]'
    ];
    ...
    *  趋势列表
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\SqlTplTrendItem[]|null
    */
    ...
    * Sets itemList
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\SqlTplTrendItem[]|null $itemList 趋势列表
    *
    * @return $this
    */
