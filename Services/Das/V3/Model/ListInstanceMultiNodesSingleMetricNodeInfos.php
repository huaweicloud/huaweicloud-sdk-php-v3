...
class ListInstanceMultiNodesSingleMetricNodeInfos implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstanceMultiNodesSingleMetric_node_infos';
