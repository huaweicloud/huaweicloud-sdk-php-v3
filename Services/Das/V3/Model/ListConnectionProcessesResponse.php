...
class ListConnectionProcessesResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListConnectionProcessesResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * processInfoList  会话信息列表
    * total  根据条件筛选的总会话数
    * userInfoList  用户列表
    * dbInfoList  数据库列表
    * hostInfoList  来源IP列表
    ...
    * showWarnMessage  是否告警信息
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'processInfoList' => '\HuaweiCloud\SDK\Das\V3\Model\ProcessInfo[]',
            'total' => 'int',
            'userInfoList' => 'string[]',
            'dbInfoList' => 'string[]',
            'hostInfoList' => 'string[]',
            ...
            'idleSession' => 'int',
            'activeSession' => 'int',
            'summary' => '\HuaweiCloud\SDK\Das\V3\Model\ProcessSummary[]',
            'userStats' => '\HuaweiCloud\SDK\Das\V3\Model\ProcessStats[]',
            'hostStats' => '\HuaweiCloud\SDK\Das\V3\Model\ProcessStats[]',
            'dbStats' => '\HuaweiCloud\SDK\Das\V3\Model\ProcessStats[]',
    ...
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\ProcessInfo[]|null $processInfoList 会话信息列表
    *
    * @return $this
    */
    ...
    * Sets total
    *
    * @param int|null $total 根据条件筛选的总会话数
    *
    * @return $this
    */
    ...
    *  概要
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\ProcessSummary[]|null
    */
    ...
    * Sets summary
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\ProcessSummary[]|null $summary 概要
    *
    * @return $this
    */
    ...
    *  按用户统计信息
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\ProcessStats[]|null
    */
    ...
    * Sets userStats
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\ProcessStats[]|null $userStats 按用户统计信息
    *
    * @return $this
    */
    ...
    * Sets hostStats
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\ProcessStats[]|null $hostStats 按访问来源统计
    *
    * @return $this
    */
    ...
    * Sets dbStats
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\ProcessStats[]|null $dbStats 按数据库统计
    *
    * @return $this
    */
    ...
    *
    * @param bool|null $showWarnMessage 是否告警信息
    *
    * @return $this
    */
