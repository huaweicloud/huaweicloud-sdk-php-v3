...
class ListSharedConnectionsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSharedConnectionsRequest';
    ...
    * Sets curPage
    *
    * @param string|null $curPage 当前页码
    *
    * @return $this
    */
