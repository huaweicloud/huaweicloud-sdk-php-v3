...
class ExportSlowQueryLogsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExportSlowQueryLogsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  实例ID。
    * datastoreType  数据库类型。支持MySQL、GaussDB(for MySQL)、PostgreSQL。
