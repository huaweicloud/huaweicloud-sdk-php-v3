...
class DeleteHistoryTransactionExportTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteHistoryTransactionExportTaskRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\Das\V3\Model\CreateExportTaskResp'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\CreateExportTaskResp|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\CreateExportTaskResp|null $body body
    *
    * @return $this
    */
