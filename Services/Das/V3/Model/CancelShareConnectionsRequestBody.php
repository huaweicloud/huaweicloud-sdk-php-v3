...
class CancelShareConnectionsRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CancelShareConnectionsRequestBody';
    ...
    * Sets sharedConnId
    *
    * @param string $sharedConnId 共享链接ID
    *
    * @return $this
    */
