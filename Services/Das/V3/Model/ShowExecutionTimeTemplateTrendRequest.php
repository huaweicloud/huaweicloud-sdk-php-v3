...
class ShowExecutionTimeTemplateTrendRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowExecutionTimeTemplateTrendRequest';
