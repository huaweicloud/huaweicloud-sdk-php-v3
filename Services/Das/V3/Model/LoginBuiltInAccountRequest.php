...
class LoginBuiltInAccountRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'LoginBuiltInAccountRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\Das\V3\Model\LoginBuiltInAccountRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\LoginBuiltInAccountRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\LoginBuiltInAccountRequestBody|null $body body
    *
    * @return $this
    */
