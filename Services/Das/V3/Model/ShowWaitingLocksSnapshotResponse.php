...
class ShowWaitingLocksSnapshotResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowWaitingLocksSnapshotResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * trx  InnoDB锁对应的事务的信息
    * lockWaitsInfos  InnoDB锁等待信息
    * waitLockCount  等待锁的会话的数量
    * holdLockCount  持有锁的会话的数量
    * timeGreaterThanCount  等锁时间大于阈值的会话的数量
    * lockWaitThresholdSecond  InnoDB锁等待时间阈值
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'trx' => '\HuaweiCloud\SDK\Das\V3\Model\InnodbTrxInfo[]',
            'lockWaitsInfos' => 'object[]',
            'waitLockCount' => 'int',
            'holdLockCount' => 'int',
    ...
    */
    protected static $attributeMap = [
            'trx' => 'trx',
            'lockWaitsInfos' => 'lock_waits_infos',
    ...
    */
    protected static $setters = [
            'trx' => 'setTrx',
            'lockWaitsInfos' => 'setLockWaitsInfos',
    ...
    */
    protected static $getters = [
            'trx' => 'getTrx',
            'lockWaitsInfos' => 'getLockWaitsInfos',
    ...
    */
    public function __construct(array $data = null)
    {
        ...
        $this->container['lockWaitsInfos'] = isset($data['lockWaitsInfos']) ? $data['lockWaitsInfos'] : null;
    ...
    *  InnoDB锁对应的事务的信息
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\InnodbTrxInfo[]|null
    */
    ...
    * Sets trx
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\InnodbTrxInfo[]|null $trx InnoDB锁对应的事务的信息
    *
    * @return $this
    */
    ...
    * @return object[]|null
    */
    public function getLockWaitsInfos()
    {
        return $this->container['lockWaitsInfos'];
    }

    /**
    * Sets lockWaitsInfos
    *
    * @param object[]|null $lockWaitsInfos InnoDB锁等待信息
    *
    * @return $this
    */
    public function setLockWaitsInfos($lockWaitsInfos)
    {
        $this->container['lockWaitsInfos'] = $lockWaitsInfos;
        return $this;
    }
    ...
    *
    * @param int|null $lockWaitThresholdSecond InnoDB锁等待时间阈值
    *
    * @return $this
    */
