...
class TableSpaceStat implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TableSpaceStat';
    ...
    *  表大小Top列表
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\HealthReportTableSpaceInfo[]|null
    */
    ...
    * Sets sizeTop
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\HealthReportTableSpaceInfo[]|null $sizeTop 表大小Top列表
    *
    * @return $this
    */
    ...
    * Sets rowsTop
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\HealthReportTableSpaceInfo[]|null $rowsTop 表行数量Top列表
    *
    * @return $this
    */
    ...
    *  表大小增长Top列表
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\HealthReportTableSpaceIncrInfo[]|null
    */
    ...
    * Sets sizeIncrTop
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\HealthReportTableSpaceIncrInfo[]|null $sizeIncrTop 表大小增长Top列表
    *
    * @return $this
    */
    ...
    * Sets rowsIncrTop
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\HealthReportTableSpaceIncrInfo[]|null $rowsIncrTop 表行数量增长Top列表
    *
    * @return $this
    */
