...
class ListSlowLogExportTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSlowLogExportTaskRequest';
    ...
    * curPage  页码
    * perPage  每页记录数
    * exportType  导出类型，取值范围：slowsql、slowsqldetails
    *
    * @var string[]
    */
    ...
    * Sets exportType
    *
    * @param string|null $exportType 导出类型，取值范围：slowsql、slowsqldetails
    *
    * @return $this
    */
