...
class AddRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddRequestBody';
    ...
    * statusList  执行状态，可组合，用逗号分隔（0：成功，1：失败）
    ...
    * Sets statusList
    *
    * @param string|null $statusList 执行状态，可组合，用逗号分隔（0：成功，1：失败）
    *
    * @return $this
    */
