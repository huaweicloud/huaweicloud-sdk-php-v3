...
class ShowExecutionTimeTemplateTrendResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowExecutionTimeTemplateTrendResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * intervalMillis  趋势图的时间间隔
    * itemList  SQL趋势列表
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'intervalMillis' => 'int',
            'itemList' => '\HuaweiCloud\SDK\Das\V3\Model\ExTimeTrendItem[]'
    ];
    ...
    * Sets intervalMillis
    *
    * @param int|null $intervalMillis 趋势图的时间间隔
    *
    * @return $this
    */
    ...
    *  SQL趋势列表
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\ExTimeTrendItem[]|null
    */
    ...
    * Sets itemList
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\ExTimeTrendItem[]|null $itemList SQL趋势列表
    *
    * @return $this
    */
