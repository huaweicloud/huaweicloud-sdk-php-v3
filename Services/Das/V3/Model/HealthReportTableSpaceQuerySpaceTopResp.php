...
class HealthReportTableSpaceQuerySpaceTopResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'HealthReportTableSpaceQuerySpaceTopResp';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * topDataList  库/表大小Top列表。
    * collectTimestamp  采集时间
    * totalCount  总大小。
    *
    * @var string[]
    */
    ...
    * Sets topDataList
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\HealthReportTableSpaceTopDataDto[]|null $topDataList 库/表大小Top列表。
    *
    * @return $this
    */
