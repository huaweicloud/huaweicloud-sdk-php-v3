...
class ShowHistoryTransactionExportTaskInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowHistoryTransactionExportTaskInfoRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['taskId'] === null) {
            ...
            if (($this->container['taskId'] > 10000000)) {
                $invalidProperties[] = "invalid value for 'taskId', must be smaller than or equal to 10000000.";
            }
