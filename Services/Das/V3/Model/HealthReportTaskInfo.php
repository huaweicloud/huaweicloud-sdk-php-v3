...
class HealthReportTaskInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'HealthReportTaskInfo';
    ...
    * Sets reportStatus
    *
    * @param string|null $reportStatus 诊断状态
    *
    * @return $this
    */
    ...
    * Sets riskCount
    *
    * @param int|null $riskCount 风险点数量
    *
    * @return $this
    */
