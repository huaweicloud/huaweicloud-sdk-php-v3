...
class ShowAnalysisSessionResultRespTopStateDuration implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowAnalysisSessionResultResp_top_state_duration';
