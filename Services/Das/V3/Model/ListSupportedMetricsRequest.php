...
class ListSupportedMetricsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSupportedMetricsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * engineType  数据库引擎类型
    * instanceMode  数据库引擎模式
    *
    * @var string[]
    */
    ...
    * Sets instanceMode
    *
    * @param string|null $instanceMode 数据库引擎模式
    *
    * @return $this
    */
