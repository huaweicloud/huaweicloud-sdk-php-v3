...
class ShowBinlogTaskInfoResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowBinlogTaskInfoResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * id  解析任务ID
    * gmtCreate  任务创建时间，单位毫秒
    * gmtModified  任务修改时间，单位毫秒
    * tenantId  租户ID
    * tenantName  租户名称
    * userId  用户ID
    * userName  用户名称
    ...
    * Sets gmtCreate
    *
    * @param int|null $gmtCreate 任务创建时间，单位毫秒
    *
    * @return $this
    */
    ...
    * Sets gmtModified
    *
    * @param int|null $gmtModified 任务修改时间，单位毫秒
    *
    * @return $this
    */
    ...
    * Sets position
    *
    * @param string|null $position binlog文件解析位置
    *
    * @return $this
    */
