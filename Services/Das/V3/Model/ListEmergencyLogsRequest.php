...
class ListEmergencyLogsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListEmergencyLogsRequest';
    ...
    * Sets startTime
    *
    * @param int|null $startTime 开始时间（Unix timestamp，毫秒）
    *
    * @return $this
    */
    ...
    * Sets endTime
    *
    * @param int|null $endTime 结束时间（Unix timestamp，毫秒）
    *
    * @return $this
    */
