...
class CheckCredentialForBatchInspectionResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CheckCredentialForBatchInspectionResponse';
    ...
    * Sets checkResult
    *
    * @param bool|null $checkResult 测试结果
    *
    * @return $this
    */
