...
class ListMetadataLocksRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListMetadataLocksRequest';
    ...
    * Sets threadId
    *
    * @param string|null $threadId 会话ID
    *
    * @return $this
    */
