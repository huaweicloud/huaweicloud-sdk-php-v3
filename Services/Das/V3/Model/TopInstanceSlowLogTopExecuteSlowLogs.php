...
class TopInstanceSlowLogTopExecuteSlowLogs implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TopInstanceSlowLog_top_execute_slow_logs';
    ...
    *
    * @param double|null $sumRowsExamined 扫描行数总和
    *
    * @return $this
    */
