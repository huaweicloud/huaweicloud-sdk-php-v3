...
class ShowLockBlockingStatisticsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowLockBlockingStatisticsRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  实例ID。
    * currentTime  当前时间戳（Unix timestamp），单位：毫秒。
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['currentTime'] === null) {
            $invalidProperties[] = "'currentTime' can't be null";
        }
            if (($this->container['currentTime'] > 253370736001000)) {
                $invalidProperties[] = "invalid value for 'currentTime', must be smaller than or equal to 253370736001000.";
            }
    ...
    * Sets currentTime
    *
    * @param int $currentTime 当前时间戳（Unix timestamp），单位：毫秒。
    *
    * @return $this
    */
