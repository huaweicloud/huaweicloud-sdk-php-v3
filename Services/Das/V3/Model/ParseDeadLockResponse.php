...
class ParseDeadLockResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ParseDeadLockResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * jobId  一键分析死锁日志任务唯一标识符
    * status  任务状态
    * sqlInsightJobId  SQL洞察任务唯一标识符
    *
    * @var string[]
    */
    ...
    * Sets jobId
    *
    * @param string|null $jobId 一键分析死锁日志任务唯一标识符
    *
    * @return $this
    */
    ...
    *
    * @param int|null $sqlInsightJobId SQL洞察任务唯一标识符
    *
    * @return $this
    */
