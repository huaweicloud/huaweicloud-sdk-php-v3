...
class ListHealthReportTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListHealthReportTaskRequest';
    ...
    * Sets limit
    *
    * @param int|null $limit 每页记录数，默认为10，最大取值200。
    *
    * @return $this
    */
