...
class SearchNewRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SearchNewRequest';
    ...
    * taskId  SQL洞察任务ID，与task_ids参数二选一
    * taskIds  SQL洞察任务ID列表，时间范围大于1天的SQL洞察任务后台将拆分为多个任务解析，与task_id参数二选一
    ...
    * clientIpList  客户端IP，可组合，用逗号分隔
    * threadIdList  线程ID，可组合，用逗号分隔
    * trxIdList  事务ID，可组合，用逗号分隔
    * sessionIdList  会话ID，可组合，用逗号分隔
    ...
    * returnMin  最小返回行数
    * returnMax  最大返回行数
    * sortField  排序字段，取值范围：execute_at（执行时间）、execute_cost（执行耗时）、lock_wait_time（锁等待时间）、rows_examined（扫描行数）、rows_returned（返回行数）
    ...
    * Sets taskId
    *
    * @param int|null $taskId SQL洞察任务ID，与task_ids参数二选一
    *
    * @return $this
    */
    ...
    * Sets taskIds
    *
    * @param int[]|null $taskIds SQL洞察任务ID列表，时间范围大于1天的SQL洞察任务后台将拆分为多个任务解析，与task_id参数二选一
    *
    * @return $this
    */
    ...
    * Sets clientIpList
    *
    * @param string|null $clientIpList 客户端IP，可组合，用逗号分隔
    *
    * @return $this
    */
    ...
    * Sets sessionIdList
    *
    * @param string|null $sessionIdList 会话ID，可组合，用逗号分隔
    *
    * @return $this
    */
    ...
    * Sets sortField
    *
    * @param string|null $sortField 排序字段，取值范围：execute_at（执行时间）、execute_cost（执行耗时）、lock_wait_time（锁等待时间）、rows_examined（扫描行数）、rows_returned（返回行数）
    *
    * @return $this
    */
