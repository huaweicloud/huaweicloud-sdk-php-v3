...
class UnsubscribeInstanceReportNewRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UnsubscribeInstanceReportNewRequestBody';
    ...
    */
    ...
    {
        $invalidProperties = [];
        if ($this->container['subscribeId'] === null) {
            $invalidProperties[] = "'subscribeId' can't be null";
        }
