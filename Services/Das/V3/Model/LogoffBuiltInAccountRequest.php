...
class LogoffBuiltInAccountRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'LogoffBuiltInAccountRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'xLanguage' => 'string',
            'body' => '\HuaweiCloud\SDK\Das\V3\Model\LogoffBuiltInAccountRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\LogoffBuiltInAccountRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\LogoffBuiltInAccountRequestBody|null $body body
    *
    * @return $this
    */
