...
class AddEmailTemplateResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'AddEmailTemplateResponse';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['templateId']) && ($this->container['templateId'] < 1)) {
    ...
    * Sets templateId
    *
    * @param int|null $templateId 邮件模板ID
    *
    * @return $this
    */
