...
class StartAnalysisSessionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'StartAnalysisSessionRequest';
    ...
    */
    protected static $openAPITypes = [
            'instanceId' => 'string',
            'nodeId' => 'string',
            'body' => '\HuaweiCloud\SDK\Das\V3\Model\StartAnalysisSessionRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\StartAnalysisSessionRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\StartAnalysisSessionRequestBody|null $body body
    *
    * @return $this
    */
