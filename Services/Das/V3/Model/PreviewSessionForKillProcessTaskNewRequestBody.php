...
class PreviewSessionForKillProcessTaskNewRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PreviewSessionForKillProcessTaskNewRequestBody';
