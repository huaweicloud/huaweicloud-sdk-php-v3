...
class CreateSharedConnectionRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateSharedConnectionRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * sharedConnId  共享连接ID
    * expiredTime  过期时间。格式为yyyy-MM-ddTHH:mm:ss.SSSZ
    * users  用户列表
    *
    * @var string[]
    */
    ...
    * Sets expiredTime
    *
    * @param string|null $expiredTime 过期时间。格式为yyyy-MM-ddTHH:mm:ss.SSSZ
    *
    * @return $this
    */
    ...
    * Sets users
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\ShareConnUserInfo[] $users 用户列表
    *
    * @return $this
    */
