...
class ListIndexUsageDetailsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListIndexUsageDetailsResponse';
    ...
    */
    protected static $openAPITypes = [
            'detailList' => '\HuaweiCloud\SDK\Das\V3\Model\IndexUsageDetail[]',
            'total' => 'int',
            'collectTime' => 'int'
    ];
    ...
    *  索引缺失明细列表
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\IndexUsageDetail[]|null
    */
    ...
    * Sets detailList
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\IndexUsageDetail[]|null $detailList 索引缺失明细列表
    *
    * @return $this
    */
