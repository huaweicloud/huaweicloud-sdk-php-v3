...
class ExecuteSplitSqlResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExecuteSplitSqlResponse';
    ...
    * Sets sqlList
    *
    * @param string[]|null $sqlList 切分后的SQL语句列表
    *
    * @return $this
    */
