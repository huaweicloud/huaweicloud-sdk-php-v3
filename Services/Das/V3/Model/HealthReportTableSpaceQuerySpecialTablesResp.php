...
class HealthReportTableSpaceQuerySpecialTablesResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'HealthReportTableSpaceQuerySpecialTablesResp';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * totalCount  总数。
    * lastDiagnoseTimestamp  最近诊断时间。
    * tables  库表信息列表。
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'tables' => '\HuaweiCloud\SDK\Das\V3\Model\HealthReportTableSpaceTablesDto[]'
    ];
    ...
    *
    * @param int|null $lastDiagnoseTimestamp 最近诊断时间。
    *
    * @return $this
    */
    ...
    *  库表信息列表。
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\HealthReportTableSpaceTablesDto[]|null
    */
    ...
    * Sets tables
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\HealthReportTableSpaceTablesDto[]|null $tables 库表信息列表。
    *
    * @return $this
    */
