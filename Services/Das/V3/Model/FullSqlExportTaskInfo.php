...
class FullSqlExportTaskInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'FullSqlExportTaskInfo';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * taskId  任务ID
    * instanceId  实例ID
    * taskStatus  任务状态。取值范围：0（等待）、1（运行中）、2（失败）、3（成功）、4（超时）、5（OBS文件已删除）
    * startTime  导出任务开始时间
    * endTime  导出任务结束时间
    * lastRecordTime  最后一条SQL执行的时间点
    * createAt  导出任务创建时间
    * exportLineNum  导出行数
    * downloadUrl  导出文件下载URL
    *
    * @var string[]
    */
    ...
    * Sets taskStatus
    *
    * @param int|null $taskStatus 任务状态。取值范围：0（等待）、1（运行中）、2（失败）、3（成功）、4（超时）、5（OBS文件已删除）
    *
    * @return $this
    */
    ...
    * Sets lastRecordTime
    *
    * @param int|null $lastRecordTime 最后一条SQL执行的时间点
    *
    * @return $this
    */
    ...
    * Sets downloadUrl
    *
    * @param string|null $downloadUrl 导出文件下载URL
    *
    * @return $this
    */
