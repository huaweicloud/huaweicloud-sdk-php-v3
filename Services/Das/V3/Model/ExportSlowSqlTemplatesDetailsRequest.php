...
class ExportSlowSqlTemplatesDetailsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExportSlowSqlTemplatesDetailsRequest';
