...
class ConfigurationParameterDto implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ConfigurationParameterDto';
    ...
    *
    * @param bool|null $restartRequired 是否需要重启
    *
    * @return $this
    */
    ...
    * Sets valueRange
    *
    * @param string|null $valueRange 参数区间
    *
    * @return $this
    */
