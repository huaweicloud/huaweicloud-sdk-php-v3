...
class ShowHistoryTransactionSwitchNewResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowHistoryTransactionSwitchNewResponse';
