...
class SlowLogExportTask implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'SlowLogExportTask';
    ...
    * instanceId  实例ID
    * taskStatus  任务状态
    * createAt  任务创建时间（Unix timestamp），单位：毫秒
    * startTime  任务开始时间（Unix timestamp），单位：毫秒
    * endTime  任务结束时间（Unix timestamp），单位：毫秒
    * downloadUrl  下载地址
    *
    * @var string[]
    */
    ...
    * Sets createAt
    *
    * @param int|null $createAt 任务创建时间（Unix timestamp），单位：毫秒
    *
    * @return $this
    */
    ...
    * Sets startTime
    *
    * @param int|null $startTime 任务开始时间（Unix timestamp），单位：毫秒
    *
    * @return $this
    */
    ...
    * Sets endTime
    *
    * @param int|null $endTime 任务结束时间（Unix timestamp），单位：毫秒
    *
    * @return $this
    */
