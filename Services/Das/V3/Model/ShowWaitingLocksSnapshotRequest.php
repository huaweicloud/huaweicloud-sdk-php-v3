...
class ShowWaitingLocksSnapshotRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowWaitingLocksSnapshotRequest';
