...
class DeleteExportTaskNewRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeleteExportTaskNewRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * exportTaskId  binlog导出任务ID
    *
    * @var string[]
    */
    ...
    * Sets exportTaskId
    *
    * @param int $exportTaskId binlog导出任务ID
    *
    * @return $this
    */
