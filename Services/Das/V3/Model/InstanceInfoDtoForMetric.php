...
class InstanceInfoDtoForMetric implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'InstanceInfoDtoForMetric';
    ...
    */
    protected static $openAPITypes = [
            ...
            'nodeInfos' => '\HuaweiCloud\SDK\Das\V3\Model\NodeInfoForMetric[]'
    ];
    ...
    *  实例信息列表
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\NodeInfoForMetric[]
    */
    ...
    * Sets nodeInfos
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\NodeInfoForMetric[] $nodeInfos 实例信息列表
    *
    * @return $this
    */
