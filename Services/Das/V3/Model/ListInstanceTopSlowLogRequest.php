...
class ListInstanceTopSlowLogRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstanceTopSlowLogRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['num'] === null) {
            ...
            if (($this->container['num'] > 30)) {
                $invalidProperties[] = "invalid value for 'num', must be smaller than or equal to 30.";
            }
