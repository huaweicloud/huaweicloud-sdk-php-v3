...
class ShowBinlogExportTaskInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowBinlogExportTaskInfoRequest';
