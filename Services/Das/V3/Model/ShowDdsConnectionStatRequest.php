...
class ShowDdsConnectionStatRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDdsConnectionStatRequest';
    ...
    * Sets curPage
    *
    * @param int|null $curPage curPage
    *
    * @return $this
    */
