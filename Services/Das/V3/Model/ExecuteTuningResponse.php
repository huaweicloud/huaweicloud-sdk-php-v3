...
class ExecuteTuningResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExecuteTuningResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * messageId  SQL诊断消息ID列表
    * status  诊断任务创建状态
    * quotaExceeded  是否超过诊断任务创建限额
    *
    * @var string[]
    */
    ...
    * Sets messageId
    *
    * @param string[]|null $messageId SQL诊断消息ID列表
    *
    * @return $this
    */
    ...
    * Sets status
    *
    * @param bool|null $status 诊断任务创建状态
    *
    * @return $this
    */
    ...
    * Sets quotaExceeded
    *
    * @param bool|null $quotaExceeded 是否超过诊断任务创建限额
    *
    * @return $this
    */
