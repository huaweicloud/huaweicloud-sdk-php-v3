...
class ShowDeadLockTrendResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowDeadLockTrendResponse';
    ...
    */
    protected static $openAPITypes = [
            'intervalMillis' => 'int',
            'trendList' => '\HuaweiCloud\SDK\Das\V3\Model\DeadLockTrendPoint[]'
    ];
    ...
    *  趋势数量列表
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\DeadLockTrendPoint[]|null
    */
    ...
    * Sets trendList
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\DeadLockTrendPoint[]|null $trendList 趋势数量列表
    *
    * @return $this
    */
