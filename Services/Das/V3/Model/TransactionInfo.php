...
class TransactionInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'TransactionInfo';
    ...
    * Sets waitLocks
    *
    * @param int|null $waitLocks 等待锁数量
    *
    * @return $this
    */
    ...
    * Sets holdLocks
    *
    * @param int|null $holdLocks 持有锁数量
    *
    * @return $this
    */
    ...
    * Sets collectTime
    *
    * @param int|null $collectTime 收集时间
    *
    * @return $this
    */
