...
class UpdateSqlLimitRulesBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateSqlLimitRulesBody';
    ...
    */
    protected static $openAPITypes = [
            ...
            'databaseName' => 'string',
            'sqlLimitRule' => '\HuaweiCloud\SDK\Das\V3\Model\UpdateSqlLimitRuleOption'
    ];
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sqlLimitRule'] === null) {
            $invalidProperties[] = "'sqlLimitRule' can't be null";
        }
    ...
    *  sqlLimitRule
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\UpdateSqlLimitRuleOption
    */
    ...
    * Sets sqlLimitRule
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\UpdateSqlLimitRuleOption $sqlLimitRule sqlLimitRule
    *
    * @return $this
    */
