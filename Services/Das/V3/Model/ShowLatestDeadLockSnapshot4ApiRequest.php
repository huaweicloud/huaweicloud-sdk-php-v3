...
class ShowLatestDeadLockSnapshot4ApiRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowLatestDeadLockSnapshot4ApiRequest';
