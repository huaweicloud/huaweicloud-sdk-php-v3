...
class FilterColumn implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'FilterColumn';
    ...
    * Sets columnName
    *
    * @param string|null $columnName 筛选条件字段名
    *
    * @return $this
    */
    ...
    * Sets columnValue
    *
    * @param string|null $columnValue 筛选条件值
    *
    * @return $this
    */
