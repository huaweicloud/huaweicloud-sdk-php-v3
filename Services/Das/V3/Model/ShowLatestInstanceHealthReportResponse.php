...
class ShowLatestInstanceHealthReportResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowLatestInstanceHealthReportResponse';
    ...
    *  tableSpaceStat
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\HealthReportTableSpaceNewStat|null
    */
    ...
    * Sets tableSpaceStat
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\HealthReportTableSpaceNewStat|null $tableSpaceStat tableSpaceStat
    *
    * @return $this
    */
