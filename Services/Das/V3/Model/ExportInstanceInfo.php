...
class ExportInstanceInfo implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ExportInstanceInfo';
    ...
    * Sets metrics
    *
    * @param map[string,double]|null $metrics 指标信息
    *
    * @return $this
    */
