...
class ShowLockBlockingSwitchRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowLockBlockingSwitchRequest';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * instanceId  实例ID。
    * engineType  数据库类型。当前支持的数据库类型包括SQLServer
