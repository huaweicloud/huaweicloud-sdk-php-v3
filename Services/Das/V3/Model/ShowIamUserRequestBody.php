...
class ShowIamUserRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowIamUserRequestBody';
    ...
    * Sets userIds
    *
    * @param string|null $userIds 账号ID
    *
    * @return $this
    */
    ...
    * Sets connectionId
    *
    * @param string|null $connectionId 账号名称
    *
    * @return $this
    */
