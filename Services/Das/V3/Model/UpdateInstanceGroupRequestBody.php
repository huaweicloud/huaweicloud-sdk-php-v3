...
class UpdateInstanceGroupRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdateInstanceGroupRequestBody';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['groupId'] === null) {
            ...
            if (($this->container['groupId'] < 0)) {
                $invalidProperties[] = "invalid value for 'groupId', must be bigger than or equal to 0.";
            }
    ...
    * Sets groupName
    *
    * @param string|null $groupName 实例组名称
    *
    * @return $this
    */
