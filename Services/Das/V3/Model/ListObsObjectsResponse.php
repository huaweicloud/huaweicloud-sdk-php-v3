...
class ListObsObjectsResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListObsObjectsResponse';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * bucketName  桶名称
    * marker  当前页marker
    * nextMarker  下一页marker
    * commonPrefixes  文件夹列表
    *
    * @var string[]
    */
    ...
    * Sets marker
    *
    * @param string|null $marker 当前页marker
    *
    * @return $this
    */
    ...
    * Sets nextMarker
    *
    * @param string|null $nextMarker 下一页marker
    *
    * @return $this
    */
    ...
    * Sets commonPrefixes
    *
    * @param string[]|null $commonPrefixes 文件夹列表
    *
    * @return $this
    */
