...
class HealthReportTableSpaceQueryRapidGrowthTablesResp implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'HealthReportTableSpaceQueryRapidGrowthTablesResp';
    ...
    */
    protected static $openAPITypes = [
            'tables' => '\HuaweiCloud\SDK\Das\V3\Model\HealthReportTableSpaceTopDataDto[]',
            'threshold' => 'int',
    ...
    *  表列表。
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\HealthReportTableSpaceTopDataDto[]|null
    */
    ...
    * Sets tables
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\HealthReportTableSpaceTopDataDto[]|null $tables 表列表。
    *
    * @return $this
    */
