...
class ChangeTransactionSwitchStatusResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ChangeTransactionSwitchStatusResponse';
    ...
    */
    ...
    const SWITCH_STATUS_ENABLED = 'Enabled';
    const SWITCH_STATUS_DISABLED = 'Disabled';
    ...
    */
    ...
    {
        return [
            self::SWITCH_STATUS_ENABLED,
            self::SWITCH_STATUS_DISABLED,
        ];
    }
    ...
    * Sets switchStatus
    *
    * @param string|null $switchStatus 开关状态
    *
    * @return $this
    */
