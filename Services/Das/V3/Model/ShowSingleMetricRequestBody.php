...
class ShowSingleMetricRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowSingleMetricRequestBody';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * metricName  指标名称
    * startAt  开始时间（Unix timestamp，毫秒）
    * endAt  结束时间（Unix timestamp，毫秒）
    ...
    */
    protected static $openAPITypes = [
            ...
            'startAt' => 'int',
            'endAt' => 'int',
            'instanceInfos' => '\HuaweiCloud\SDK\Das\V3\Model\InstanceInfoDtoForMetric[]'
    ];
    ...
    * Sets startAt
    *
    * @param int $startAt 开始时间（Unix timestamp，毫秒）
    *
    * @return $this
    */
    ...
    * Sets endAt
    *
    * @param int $endAt 结束时间（Unix timestamp，毫秒）
    *
    * @return $this
    */
    ...
    *  实例信息列表
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\InstanceInfoDtoForMetric[]
    */
    ...
    * Sets instanceInfos
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\InstanceInfoDtoForMetric[] $instanceInfos 实例信息列表
    *
    * @return $this
    */
