...
class ListSubUsersResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListSubUsersResponse';
    ...
    */
    protected static $openAPITypes = [
            'data' => '\HuaweiCloud\SDK\Das\V3\Model\SubUserInfo[]',
            'total' => 'int',
    ...
    *  IAM用户信息
    *
    * @return \HuaweiCloud\SDK\Das\V3\Model\SubUserInfo[]|null
    */
    ...
    * Sets data
    *
    * @param \HuaweiCloud\SDK\Das\V3\Model\SubUserInfo[]|null $data IAM用户信息
    *
    * @return $this
    */
