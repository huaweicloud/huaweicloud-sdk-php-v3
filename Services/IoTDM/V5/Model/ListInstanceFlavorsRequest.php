...
class ListInstanceFlavorsRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstanceFlavorsRequest';
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['instanceType']) && !preg_match("/(standard|enterprise|valueaddedservice)/", $this->container['instanceType'])) {
