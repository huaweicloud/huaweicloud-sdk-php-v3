...
class ListInstancesRequest implements ModelInterface, ArrayAccess
{
    ...
    * limit  **参数说明**：分页查询时每页显示的记录数。 **取值范围**：1-500的整数，默认为500。
    ...
    * name  **参数说明**：设备接入实例名称，匹配规则为模糊匹配。 **取值范围**：由中文字符，英文字母、数字及“_”、“-”组成，且长度为[1-64]个字符。
    ...
    */
    public function listInvalidProperties()
    {
        $invalidProperties = [];
            ...
            if (!is_null($this->container['marker']) && !preg_match("/^[a-fA-F0-9]{1,20}$/", $this->container['marker'])) {
                $invalidProperties[] = "invalid value for 'marker', must be conform to the pattern /^[a-fA-F0-9]{1,20}$/.";
            }
    ...
    * Sets limit
    *
    * @param int|null $limit **参数说明**：分页查询时每页显示的记录数。 **取值范围**：1-500的整数，默认为500。
    *
    * @return $this
    */
    ...
    * Sets name
    *
    * @param string|null $name **参数说明**：设备接入实例名称，匹配规则为模糊匹配。 **取值范围**：由中文字符，英文字母、数字及“_”、“-”组成，且长度为[1-64]个字符。
    *
    * @return $this
    */
