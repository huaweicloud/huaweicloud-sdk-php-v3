...
class ShowInstanceTaskRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowInstanceTaskRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['taskId'] === null) {
            ...
            if (!preg_match("/[0-9a-f-]{1,64}/", $this->container['taskId'])) {
