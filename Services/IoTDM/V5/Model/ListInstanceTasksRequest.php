...
class ListInstanceTasksRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ListInstanceTasksRequest';
    ...
    */
    public function listInvalidProperties()
    {
        ...
        if ($this->container['instanceId'] === null) {
            ...
            if (!is_null($this->container['marker']) && !preg_match("/^[a-fA-F0-9]{1,32}$/", $this->container['marker'])) {
                $invalidProperties[] = "invalid value for 'marker', must be conform to the pattern /^[a-fA-F0-9]{1,32}$/.";
            }
