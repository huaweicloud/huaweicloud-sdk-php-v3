...
class RetryInstanceTaskResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'RetryInstanceTaskResponse';
    ...
    * Sets progress
    *
    * @param int|null $progress **参数说明**：任务进度\"
    *
    * @return $this
    */
