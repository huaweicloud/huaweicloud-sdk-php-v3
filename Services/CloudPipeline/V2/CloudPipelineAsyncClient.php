...
namespace HuaweiCloud\SDK\CloudPipeline\V2;
...
class CloudPipelineAsyncClient extends Client
{
    ...
    {
        return new ClientBuilder(new CloudPipelineAsyncClient());
    }
    ...
    public function batchShowPipelinesLatestStatusAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $responseType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\BatchShowPipelinesLatestStatusResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\BatchShowPipelinesLatestStatusRequest',
            $asyncRequest = true);
    }
    ...
    public function batchShowPipelinesStatusAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\BatchShowPipelinesStatusResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\BatchShowPipelinesStatusRequest',
            $asyncRequest = true);
    }
    ...
    public function createPipelineByTemplateAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\CreatePipelineByTemplateResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\CreatePipelineByTemplateRequest',
            $asyncRequest = true);
    }
    ...
    public function createPipelineByTemplateIdAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\CreatePipelineByTemplateIdResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\CreatePipelineByTemplateIdRequest',
            $asyncRequest = true);
    }
    ...
    public function deletePipelineAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\DeletePipelineResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\DeletePipelineRequest',
            $asyncRequest = true);
    }
    ...
    public function listPipelineRunsAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\ListPipelineRunsResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\ListPipelineRunsRequest',
            $asyncRequest = true);
    }
    ...
    public function listPipelineSimpleInfoAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\ListPipelineSimpleInfoResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\ListPipelineSimpleInfoRequest',
            $asyncRequest = true);
    }
    ...
    public function listPipelineTemplatesAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\ListPipelineTemplatesResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\ListPipelineTemplatesRequest',
            $asyncRequest = true);
    }
    ...
    public function listPipelinesAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\ListPipelinesResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\ListPipelinesRequest',
            $asyncRequest = true);
    }
    ...
    public function listPipleineBuildResultAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\ListPipleineBuildResultResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\ListPipleineBuildResultRequest',
            $asyncRequest = true);
    }
    ...
    public function listTemplatesAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\ListTemplatesResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\ListTemplatesRequest',
            $asyncRequest = true);
    }
    ...
    public function removePipelineAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\RemovePipelineResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\RemovePipelineRequest',
            $asyncRequest = true);
    }
    ...
    public function runPipelineAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\RunPipelineResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\RunPipelineRequest',
            $asyncRequest = true);
    }
    ...
    public function showInstanceStatusAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\ShowInstanceStatusResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\ShowInstanceStatusRequest',
            $asyncRequest = true);
    }
    ...
    public function showPipelineRunDetailAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\ShowPipelineRunDetailResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\ShowPipelineRunDetailRequest',
            $asyncRequest = true);
    }
    ...
    public function showPipelineTemplateDetailAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\ShowPipelineTemplateDetailResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\ShowPipelineTemplateDetailRequest',
            $asyncRequest = true);
    }
    ...
    public function showPipleineStatusAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\ShowPipleineStatusResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\ShowPipleineStatusRequest',
            $asyncRequest = true);
    }
    ...
    public function showTemplateDetailAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\ShowTemplateDetailResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\ShowTemplateDetailRequest',
            $asyncRequest = true);
    }
    ...
    public function startNewPipelineAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\StartNewPipelineResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\StartNewPipelineRequest',
            $asyncRequest = true);
    }
    ...
    public function stopPipelineNewAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\StopPipelineNewResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\StopPipelineNewRequest',
            $asyncRequest = true);
    }
    ...
    public function stopPipelineRunAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\StopPipelineRunResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\CloudPipeline\V2\Model\StopPipelineRunRequest',
            $asyncRequest = true);
    }
