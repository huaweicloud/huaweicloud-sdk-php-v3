...
class RunPipelineRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'pipelineId' => 'string',
            'body' => '\HuaweiCloud\SDK\CloudPipeline\V2\Model\RunPipelineDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CloudPipeline\V2\Model\RunPipelineDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CloudPipeline\V2\Model\RunPipelineDTO|null $body body
    *
    * @return $this
    */
