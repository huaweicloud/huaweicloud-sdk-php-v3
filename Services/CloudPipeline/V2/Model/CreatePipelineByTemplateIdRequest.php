...
class CreatePipelineByTemplateIdRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'templateId' => 'string',
            'componentId' => 'string',
            'body' => '\HuaweiCloud\SDK\CloudPipeline\V2\Model\PipelineByTemplateDTO'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CloudPipeline\V2\Model\PipelineByTemplateDTO|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CloudPipeline\V2\Model\PipelineByTemplateDTO|null $body body
    *
    * @return $this
    */
