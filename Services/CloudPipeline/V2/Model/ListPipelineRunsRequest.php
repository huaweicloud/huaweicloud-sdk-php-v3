...
class ListPipelineRunsRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'pipelineId' => 'string',
            'body' => '\HuaweiCloud\SDK\CloudPipeline\V2\Model\ListPipelineRunsQuery'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\CloudPipeline\V2\Model\ListPipelineRunsQuery|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\CloudPipeline\V2\Model\ListPipelineRunsQuery|null $body body
    *
    * @return $this
    */
