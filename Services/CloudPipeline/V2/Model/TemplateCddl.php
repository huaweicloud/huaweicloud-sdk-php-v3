...
class TemplateCddl implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'workflow' => '\HuaweiCloud\SDK\CloudPipeline\V2\Model\Workflow'
    ];
    ...
    *
    * @return map[string,\HuaweiCloud\SDK\CloudPipeline\V2\Model\TemplateState]
    */
    ...
    * Sets states
    *
    * @param map[string,\HuaweiCloud\SDK\CloudPipeline\V2\Model\TemplateState] $states 编排State详情，map类型数据。本字段为描述流水线基础编排数据之一，建议可通过流水线真实界面基于模板创建接口中获取
    *
    * @return $this
    */
    ...
    *  workflow
    *
    * @return \HuaweiCloud\SDK\CloudPipeline\V2\Model\Workflow
    */
    ...
    * Sets workflow
    *
    * @param \HuaweiCloud\SDK\CloudPipeline\V2\Model\Workflow $workflow workflow
    *
    * @return $this
    */
