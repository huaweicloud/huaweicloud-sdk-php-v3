...
class RunPipelineSourceParams implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'codehubId' => 'string',
            'alias' => 'string',
            'buildParams' => '\HuaweiCloud\SDK\CloudPipeline\V2\Model\RunPipelineSourceParamsBuildParams'
    ];
    ...
    *  buildParams
    *
    * @return \HuaweiCloud\SDK\CloudPipeline\V2\Model\RunPipelineSourceParamsBuildParams|null
    */
    ...
    * Sets buildParams
    *
    * @param \HuaweiCloud\SDK\CloudPipeline\V2\Model\RunPipelineSourceParamsBuildParams|null $buildParams buildParams
    *
    * @return $this
    */
