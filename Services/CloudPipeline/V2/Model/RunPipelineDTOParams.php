...
class RunPipelineDTOParams implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'gitUrl' => 'string',
            'endpointId' => 'string',
            'buildParams' => '\HuaweiCloud\SDK\CloudPipeline\V2\Model\RunPipelineDTOParamsBuildParams'
    ];
    ...
    * Sets gitUrl
    *
    * @param string|null $gitUrl git仓库https地址
    *
    * @return $this
    */
    ...
    *  buildParams
    *
    * @return \HuaweiCloud\SDK\CloudPipeline\V2\Model\RunPipelineDTOParamsBuildParams|null
    */
    ...
    * Sets buildParams
    *
    * @param \HuaweiCloud\SDK\CloudPipeline\V2\Model\RunPipelineDTOParamsBuildParams|null $buildParams buildParams
    *
    * @return $this
    */
