...
class PipelineByTemplateDTO implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'description' => 'string',
            'isPublish' => 'bool',
            'sources' => '\HuaweiCloud\SDK\CloudPipeline\V2\Model\CodeSource[]'
    ];
    ...
    *  流水线源
    *
    * @return \HuaweiCloud\SDK\CloudPipeline\V2\Model\CodeSource[]|null
    */
    ...
    * Sets sources
    *
    * @param \HuaweiCloud\SDK\CloudPipeline\V2\Model\CodeSource[]|null $sources 流水线源
    *
    * @return $this
    */
