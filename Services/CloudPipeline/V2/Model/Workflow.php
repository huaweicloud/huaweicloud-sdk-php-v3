...
class Workflow implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'parameter' => '\HuaweiCloud\SDK\CloudPipeline\V2\Model\PipelineParam[]',
            'source' => '\HuaweiCloud\SDK\CloudPipeline\V2\Model\Source[]',
            'name' => 'string',
            'projectId' => 'string',
            'projectName' => 'string'
    ];
    ...
    *  任务类型,list类型数据
    *
    * @return \HuaweiCloud\SDK\CloudPipeline\V2\Model\PipelineParam[]
    */
    ...
    * Sets parameter
    *
    * @param \HuaweiCloud\SDK\CloudPipeline\V2\Model\PipelineParam[] $parameter 任务类型,list类型数据
    *
    * @return $this
    */
    ...
    *  源码仓,list类型数据
    *
    * @return \HuaweiCloud\SDK\CloudPipeline\V2\Model\Source[]
    */
    ...
    * Sets source
    *
    * @param \HuaweiCloud\SDK\CloudPipeline\V2\Model\Source[] $source 源码仓,list类型数据
    *
    * @return $this
    */
