...
class ListPipelinesPageLatestRun implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'executorId' => 'string',
            'executorName' => 'string',
            'stageStatusList' => '\HuaweiCloud\SDK\CloudPipeline\V2\Model\ListPipelinesPageLatestRunStageStatusList[]',
            'status' => 'string',
            'runNumber' => 'int',
            'triggerType' => 'string',
            'buildParams' => '\HuaweiCloud\SDK\CloudPipeline\V2\Model\ListPipelinesPageLatestRunBuildParams',
            'artifactParams' => '\HuaweiCloud\SDK\CloudPipeline\V2\Model\ListPipelinesPageLatestRunArtifactParams',
            'startTime' => 'int',
            'endTime' => 'int'
    ];
    ...
    *  阶段信息列表
    *
    * @return \HuaweiCloud\SDK\CloudPipeline\V2\Model\ListPipelinesPageLatestRunStageStatusList[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CloudPipeline\V2\Model\ListPipelinesPageLatestRunStageStatusList[]|null $stageStatusList 阶段信息列表
    *
    * @return $this
    */
    ...
    *  buildParams
    *
    * @return \HuaweiCloud\SDK\CloudPipeline\V2\Model\ListPipelinesPageLatestRunBuildParams|null
    */
    ...
    * Sets buildParams
    *
    * @param \HuaweiCloud\SDK\CloudPipeline\V2\Model\ListPipelinesPageLatestRunBuildParams|null $buildParams buildParams
    *
    * @return $this
    */
    ...
    *  artifactParams
    *
    * @return \HuaweiCloud\SDK\CloudPipeline\V2\Model\ListPipelinesPageLatestRunArtifactParams|null
    */
    ...
    * Sets artifactParams
    *
    * @param \HuaweiCloud\SDK\CloudPipeline\V2\Model\ListPipelinesPageLatestRunArtifactParams|null $artifactParams artifactParams
    *
    * @return $this
    */
