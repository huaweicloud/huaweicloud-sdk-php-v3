...
class ListPipelineRunsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'limit' => 'int',
            'total' => 'int',
            'pipelineRuns' => '\HuaweiCloud\SDK\CloudPipeline\V2\Model\ListPipelineRunsPagePipelineRuns[]'
    ];
    ...
    *  流水线运行信息
    *
    * @return \HuaweiCloud\SDK\CloudPipeline\V2\Model\ListPipelineRunsPagePipelineRuns[]|null
    */
    ...
    * Sets pipelineRuns
    *
    * @param \HuaweiCloud\SDK\CloudPipeline\V2\Model\ListPipelineRunsPagePipelineRuns[]|null $pipelineRuns 流水线运行信息
    *
    * @return $this
    */
