...
class ShowPipleineStatusResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'startTime' => 'string',
            'endTime' => 'string',
            'parameters' => '\HuaweiCloud\SDK\CloudPipeline\V2\Model\PipelineParameter[]',
            'states' => '\HuaweiCloud\SDK\CloudPipeline\V2\Model\PipelineStateStatus[]',
            'elapsedTime' => 'string',
            'status' => 'string',
            'outcome' => 'string',
            'detailUrl' => 'string'
    ...
    *  流水线参数
    *
    * @return \HuaweiCloud\SDK\CloudPipeline\V2\Model\PipelineParameter[]|null
    */
    ...
    * Sets parameters
    *
    * @param \HuaweiCloud\SDK\CloudPipeline\V2\Model\PipelineParameter[]|null $parameters 流水线参数
    *
    * @return $this
    */
    ...
    *  流水线执行情况
    *
    * @return \HuaweiCloud\SDK\CloudPipeline\V2\Model\PipelineStateStatus[]|null
    */
    ...
    * Sets states
    *
    * @param \HuaweiCloud\SDK\CloudPipeline\V2\Model\PipelineStateStatus[]|null $states 流水线执行情况
    *
    * @return $this
    */
