...
class ListPipelineSimpleInfoResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'limit' => 'int',
            'total' => 'int',
            'result' => '\HuaweiCloud\SDK\CloudPipeline\V2\Model\PipelineBasicInfo[]'
    ];
    ...
    *  执行状况数据列表
    *
    * @return \HuaweiCloud\SDK\CloudPipeline\V2\Model\PipelineBasicInfo[]|null
    */
    ...
    * Sets result
    *
    * @param \HuaweiCloud\SDK\CloudPipeline\V2\Model\PipelineBasicInfo[]|null $result 执行状况数据列表
    *
    * @return $this
    */
