...
class ListPipelineSimpleInfoRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * projectIds  devCloud项目ids。该参数存在，则获取对应项目下的流水线列表，逗号分隔，id个数取值[0,10]；如果不存在，则获取调用方所属租户的流水线列表
    ...
    * Sets projectIds
    *
    * @param string|null $projectIds devCloud项目ids。该参数存在，则获取对应项目下的流水线列表，逗号分隔，id个数取值[0,10]；如果不存在，则获取调用方所属租户的流水线列表
    *
    * @return $this
    */
