...
class ListPipelinesResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'limit' => 'int',
            'total' => 'int',
            'pipelines' => '\HuaweiCloud\SDK\CloudPipeline\V2\Model\ListPipelinesPagePipelines[]'
    ];
    ...
    *  流水线
    *
    * @return \HuaweiCloud\SDK\CloudPipeline\V2\Model\ListPipelinesPagePipelines[]|null
    */
    ...
    * Sets pipelines
    *
    * @param \HuaweiCloud\SDK\CloudPipeline\V2\Model\ListPipelinesPagePipelines[]|null $pipelines 流水线
    *
    * @return $this
    */
