...
class PipelineLatestRun implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'executorId' => 'string',
            'executorName' => 'string',
            'stageStatusList' => '\HuaweiCloud\SDK\CloudPipeline\V2\Model\PipelineLatestRunStageStatusList[]',
            'status' => 'string',
            'runNumber' => 'int',
            'triggerType' => 'string',
            'buildParams' => '\HuaweiCloud\SDK\CloudPipeline\V2\Model\PipelineLatestRunBuildParams',
            'artifactParams' => '\HuaweiCloud\SDK\CloudPipeline\V2\Model\PipelineLatestRunArtifactParams',
            'startTime' => 'int',
            'endTime' => 'int'
    ];
    ...
    *  阶段状态信息
    *
    * @return \HuaweiCloud\SDK\CloudPipeline\V2\Model\PipelineLatestRunStageStatusList[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\CloudPipeline\V2\Model\PipelineLatestRunStageStatusList[]|null $stageStatusList 阶段状态信息
    *
    * @return $this
    */
    ...
    *  buildParams
    *
    * @return \HuaweiCloud\SDK\CloudPipeline\V2\Model\PipelineLatestRunBuildParams|null
    */
    ...
    * Sets buildParams
    *
    * @param \HuaweiCloud\SDK\CloudPipeline\V2\Model\PipelineLatestRunBuildParams|null $buildParams buildParams
    *
    * @return $this
    */
    ...
    *  artifactParams
    *
    * @return \HuaweiCloud\SDK\CloudPipeline\V2\Model\PipelineLatestRunArtifactParams|null
    */
    ...
    * Sets artifactParams
    *
    * @param \HuaweiCloud\SDK\CloudPipeline\V2\Model\PipelineLatestRunArtifactParams|null $artifactParams artifactParams
    *
    * @return $this
    */
