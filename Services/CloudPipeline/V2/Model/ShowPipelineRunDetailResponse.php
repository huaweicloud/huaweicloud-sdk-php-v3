...
class ShowPipelineRunDetailResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'startTime' => 'int',
            'endTime' => 'int',
            'stages' => '\HuaweiCloud\SDK\CloudPipeline\V2\Model\StageRun[]',
            'domainId' => 'string',
            'projectId' => 'string',
            'region' => 'string',
            'componentId' => 'string',
            'language' => 'string',
            'sources' => '\HuaweiCloud\SDK\CloudPipeline\V2\Model\RunPipelineSource[]',
            'artifacts' => '\HuaweiCloud\SDK\CloudPipeline\V2\Model\PackageInfo[]',
            'subjectId' => 'string'
    ];
    ...
    *  阶段信息
    *
    * @return \HuaweiCloud\SDK\CloudPipeline\V2\Model\StageRun[]|null
    */
    ...
    * Sets stages
    *
    * @param \HuaweiCloud\SDK\CloudPipeline\V2\Model\StageRun[]|null $stages 阶段信息
    *
    * @return $this
    */
    ...
    *  运行源信息
    *
    * @return \HuaweiCloud\SDK\CloudPipeline\V2\Model\RunPipelineSource[]|null
    */
    ...
    * Sets sources
    *
    * @param \HuaweiCloud\SDK\CloudPipeline\V2\Model\RunPipelineSource[]|null $sources 运行源信息
    *
    * @return $this
    */
    ...
    *  流水线运行产物
    *
    * @return \HuaweiCloud\SDK\CloudPipeline\V2\Model\PackageInfo[]|null
    */
    ...
    * Sets artifacts
    *
    * @param \HuaweiCloud\SDK\CloudPipeline\V2\Model\PackageInfo[]|null $artifacts 流水线运行产物
    *
    * @return $this
    */
