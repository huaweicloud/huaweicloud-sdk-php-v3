...
class CreatePrivateModuleVersionRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'moduleName' => 'string',
            'body' => '\HuaweiCloud\SDK\Aos\V1\Model\CreatePrivateModuleVersionRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Aos\V1\Model\CreatePrivateModuleVersionRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Aos\V1\Model\CreatePrivateModuleVersionRequestBody|null $body body
    *
    * @return $this
    */
