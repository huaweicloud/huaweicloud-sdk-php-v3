...
class UpdatePrivateModuleMetadataRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePrivateModuleMetadataRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'moduleName' => 'string',
            'body' => '\HuaweiCloud\SDK\Aos\V1\Model\UpdatePrivateModuleMetadataRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Aos\V1\Model\UpdatePrivateModuleMetadataRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Aos\V1\Model\UpdatePrivateModuleMetadataRequestBody|null $body body
    *
    * @return $this
    */
