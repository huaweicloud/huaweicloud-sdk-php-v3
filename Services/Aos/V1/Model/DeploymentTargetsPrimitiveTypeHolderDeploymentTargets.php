...
class DeploymentTargetsPrimitiveTypeHolderDeploymentTargets implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DeploymentTargetsPrimitiveTypeHolder_deployment_targets';
