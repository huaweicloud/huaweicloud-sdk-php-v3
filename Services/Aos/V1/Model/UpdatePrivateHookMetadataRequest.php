...
class UpdatePrivateHookMetadataRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePrivateHookMetadataRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'hookName' => 'string',
            'body' => '\HuaweiCloud\SDK\Aos\V1\Model\UpdatePrivateHookMetadataRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Aos\V1\Model\UpdatePrivateHookMetadataRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Aos\V1\Model\UpdatePrivateHookMetadataRequestBody|null $body body
    *
    * @return $this
    */
