...
class PrivateHookDefaultVersionPrimitiveTypeHolder implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PrivateHookDefaultVersionPrimitiveTypeHolder';
