...
class DomainIdFilterTypePrimitiveTypeHolder implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'DomainIdFilterTypePrimitiveTypeHolder';
