...
class VariableResponse implements ModelInterface, ArrayAccess
{
    ...
    * type  参数类型
    * description  描述参数的用途
    * default  参数默认值。该类型与type保持一致
    * sensitive  参数是否为敏感字段
    * nullable  参数是否可设置为null
    * validations  参数校验模块
    *
    * @var string[]
    */
    ...
    * Sets description
    *
    * @param string|null $description 描述参数的用途
    *
    * @return $this
    */
    ...
    * Sets default
    *
    * @param object|null $default 参数默认值。该类型与type保持一致
    *
    * @return $this
    */
    ...
    * Sets nullable
    *
    * @param bool|null $nullable 参数是否可设置为null
    *
    * @return $this
    */
    ...
    * Sets validations
    *
    * @param \HuaweiCloud\SDK\Aos\V1\Model\VariableValidationResponse[]|null $validations 参数校验模块
    *
    * @return $this
    */
