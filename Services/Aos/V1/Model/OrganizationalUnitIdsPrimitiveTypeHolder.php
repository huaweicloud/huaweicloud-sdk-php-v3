...
class OrganizationalUnitIdsPrimitiveTypeHolder implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'OrganizationalUnitIdsPrimitiveTypeHolder';
