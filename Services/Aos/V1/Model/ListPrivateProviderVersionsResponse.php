...
class ListPrivateProviderVersionsResponse implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            'versions' => '\HuaweiCloud\SDK\Aos\V1\Model\PrivateProviderVersionSummary[]',
    ...
    *
    * @return \HuaweiCloud\SDK\Aos\V1\Model\PrivateProviderVersionSummary[]|null
    */
    ...
    * Sets versions
    *
    * @param \HuaweiCloud\SDK\Aos\V1\Model\PrivateProviderVersionSummary[]|null $versions 私有provider版本的列表。默认以创建时间降序排序。
    *
    * @return $this
    */
