...
class PrivateProviderUpdateTimePrimitiveTypeHolder implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PrivateProviderUpdateTimePrimitiveTypeHolder';
