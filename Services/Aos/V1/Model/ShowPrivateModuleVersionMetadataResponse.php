...
class ShowPrivateModuleVersionMetadataResponse implements ModelInterface, ArrayAccess
{
    use SdkResponse;
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowPrivateModuleVersionMetadataResponse';
