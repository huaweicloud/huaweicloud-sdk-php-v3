...
class CreateTemplateRequest implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'body' => '\HuaweiCloud\SDK\Aos\V1\Model\CreateTemplateRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Aos\V1\Model\CreateTemplateRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Aos\V1\Model\CreateTemplateRequestBody|null $body body
    *
    * @return $this
    */
