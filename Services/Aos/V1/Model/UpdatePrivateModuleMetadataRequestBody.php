...
class UpdatePrivateModuleMetadataRequestBody implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'UpdatePrivateModuleMetadataRequestBody';
