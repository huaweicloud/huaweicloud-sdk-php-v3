...
class PrivateHookVersionDescriptionPrimitiveTypeHolder implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PrivateHookVersionDescriptionPrimitiveTypeHolder';
