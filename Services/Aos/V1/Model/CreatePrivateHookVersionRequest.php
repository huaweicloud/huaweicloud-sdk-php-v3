...
class CreatePrivateHookVersionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreatePrivateHookVersionRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'hookName' => 'string',
            'body' => '\HuaweiCloud\SDK\Aos\V1\Model\CreatePrivateHookVersionRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Aos\V1\Model\CreatePrivateHookVersionRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Aos\V1\Model\CreatePrivateHookVersionRequestBody|null $body body
    *
    * @return $this
    */
