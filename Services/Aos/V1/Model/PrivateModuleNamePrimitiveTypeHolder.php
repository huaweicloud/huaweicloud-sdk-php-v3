...
class PrivateModuleNamePrimitiveTypeHolder implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'PrivateModuleNamePrimitiveTypeHolder';
