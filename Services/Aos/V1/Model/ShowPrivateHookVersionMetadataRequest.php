...
class ShowPrivateHookVersionMetadataRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ShowPrivateHookVersionMetadataRequest';
