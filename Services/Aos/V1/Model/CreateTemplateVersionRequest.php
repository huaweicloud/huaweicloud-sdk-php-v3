...
class CreateTemplateVersionRequest implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'CreateTemplateVersionRequest';
    ...
    */
    protected static $openAPITypes = [
            ...
            'templateName' => 'string',
            'templateId' => 'string',
            'body' => '\HuaweiCloud\SDK\Aos\V1\Model\CreateTemplateVersionRequestBody'
    ];
    ...
    *  body
    *
    * @return \HuaweiCloud\SDK\Aos\V1\Model\CreateTemplateVersionRequestBody|null
    */
    ...
    * Sets body
    *
    * @param \HuaweiCloud\SDK\Aos\V1\Model\CreateTemplateVersionRequestBody|null $body body
    *
    * @return $this
    */
