...
class AosAsyncClient extends Client
{
    ...
    {
        $client = new ClientBuilder(new AosAsyncClient());
        return $client;
    }
    ...
    public function listPrivateHookVersionsAsyncWithHttpInfo($request){
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Aos\V1\Model\ListPrivateHookVersionsResponse',
            $collectionFormats=$collection_formats,
            $requestType='\HuaweiCloud\SDK\Aos\V1\Model\ListPrivateHookVersionsRequest',
            $asyncRequest = true);
    }
