...
class BssintlAsyncClient extends Client
{
     ...
     * @return response
     */
    public function listResourceSpecsPriceAsync($request)
    {
        return $this->listResourceSpecsPriceAsyncWithHttpInfo($request);
    }
    
    public function listResourceSpecsPriceAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function setResourcesRenewConfigAsync($request)
    {
        return $this->setResourcesRenewConfigAsyncWithHttpInfo($request);
    }
    
    public function setResourcesRenewConfigAsyncWithHttpInfo($request){
        $collection_formats = [];
     ...
     * @return response
     */
    public function showPartnerConsumptionQuotaAsync($request)
    {
        return $this->showPartnerConsumptionQuotaAsyncWithHttpInfo($request);
    }
    
    public function showPartnerConsumptionQuotaAsyncWithHttpInfo($request){
        $collection_formats = [];
