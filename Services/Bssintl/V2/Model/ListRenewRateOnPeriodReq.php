...
class ListRenewRateOnPeriodReq implements ModelInterface, ArrayAccess
{
    ...
    * includeRelativeResources  |参数名称：是否包含关联资源一起询价| |参数的约束及描述：该参数非必填，true:包含。false:不包含|
    *
    * @var string[]
    */
    ...
    *
    * @param bool|null $includeRelativeResources |参数名称：是否包含关联资源一起询价| |参数的约束及描述：该参数非必填，true:包含。false:不包含|
    *
    * @return $this
    */
