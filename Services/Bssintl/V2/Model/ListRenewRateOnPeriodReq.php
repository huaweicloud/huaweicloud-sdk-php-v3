...
class ListRenewRateOnPeriodReq implements ModelInterface, ArrayAccess
{
    ...
    * includeRelativeResources  是否包含关联资源一起续费询价。true:包含。false:不包含。此参数不携带或携带值为空串时，默认值为“false”。
    *
    * @var string[]
    */
    ...
    *
    * @param bool|null $includeRelativeResources 是否包含关联资源一起续费询价。true:包含。false:不包含。此参数不携带或携带值为空串时，默认值为“false”。
    *
    * @return $this
    */
