...
class OrderInstanceV2 implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'updateTime' => 'string',
            'enterpriseProject' => '\HuaweiCloud\SDK\Bssintl\V2\Model\EnterpriseProject'
    ];
    ...
    *
    * @param \HuaweiCloud\SDK\Bssintl\V2\Model\EnterpriseProject|null $enterpriseProject enterpriseProject
    *
    * @return $this
    */
