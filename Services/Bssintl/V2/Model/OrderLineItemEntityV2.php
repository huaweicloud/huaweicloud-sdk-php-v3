...
class OrderLineItemEntityV2 implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'baseProductInfo' => '\HuaweiCloud\SDK\Bssintl\V2\Model\ProductObject'
    ];
    ...
    *  baseProductInfo
    *
    * @return \HuaweiCloud\SDK\Bssintl\V2\Model\ProductObject|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Bssintl\V2\Model\ProductObject|null $baseProductInfo baseProductInfo
    *
    * @return $this
    */
