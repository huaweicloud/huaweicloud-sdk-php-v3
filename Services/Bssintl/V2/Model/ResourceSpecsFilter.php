...
class ResourceSpecsFilter implements ModelInterface, ArrayAccess
{
    ...
    * @var string
    */
    protected static $openAPIModelName = 'ResourceSpecsFilter';

    /**
    * Array of property to type mappings. Used for (de)serialization
    * key  |参数名称：过滤条件键| |参数的约束及描述：必填，仅支持RESOURCE_SPEC|
    * value  |参数名称：过滤条件值| |参数的约束及描述：必填，过滤条件值|
    *
    * @var string[]
    */
    ...
    * Sets key
    *
    * @param string $key |参数名称：过滤条件键| |参数的约束及描述：必填，仅支持RESOURCE_SPEC|
    *
    * @return $this
    */
    ...
    * Sets value
    *
    * @param string $value |参数名称：过滤条件值| |参数的约束及描述：必填，过滤条件值|
    *
    * @return $this
    */
