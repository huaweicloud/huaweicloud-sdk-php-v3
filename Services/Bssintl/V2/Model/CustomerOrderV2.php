...
class CustomerOrderV2 implements ModelInterface, ArrayAccess
{
    ...
    */
    protected static $openAPITypes = [
            ...
            'agentPayInfo' => '\HuaweiCloud\SDK\Bssintl\V2\Model\AgentPayInfoV2'
    ];
    ...
    *  agentPayInfo
    *
    * @return \HuaweiCloud\SDK\Bssintl\V2\Model\AgentPayInfoV2|null
    */
    ...
    * Sets agentPayInfo
    *
    * @param \HuaweiCloud\SDK\Bssintl\V2\Model\AgentPayInfoV2|null $agentPayInfo agentPayInfo
    *
    * @return $this
    */
