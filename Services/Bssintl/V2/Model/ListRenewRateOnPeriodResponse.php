...
class ListRenewRateOnPeriodResponse implements ModelInterface, ArrayAccess
{
    ...
    *
    * @param \HuaweiCloud\SDK\Bssintl\V2\Model\RenewInquiryResultInfo[]|null $renewInquiryResults 主资源（包含从资源）询价结果。具体请参见表RenewInquiryResultInfo。
    *
    * @return $this
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Bssintl\V2\Model\OptionalDiscountRatingResultV2[]|null $optionalDiscountRatingResults 存在可选折扣优惠时返回折扣优惠维度询价结果，每个折扣优惠一组询价结果，具体参见表OptionalDiscountRatingResultV2。
    *
    * @return $this
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Bssintl\V2\Model\FailResourceInfo[]|null $failResourceInfos 失败的资源信息列表。具体请参见表FailResourceInfo。
    *
    * @return $this
    */
