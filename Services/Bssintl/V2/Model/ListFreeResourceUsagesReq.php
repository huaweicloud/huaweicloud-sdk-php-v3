...
class ListFreeResourceUsagesReq implements ModelInterface, ArrayAccess
{
    ...
    * freeResourceIds  |参数名称：免费资源ID列表，每个最大64字节| |参数约束以及描述：免费资源ID列表，每个最大64字节|
    *
    * @var string[]
    */
    ...
    *  |参数名称：免费资源ID列表，每个最大64字节| |参数约束以及描述：免费资源ID列表，每个最大64字节|
    *
    * @return string[]
    */
    ...
    *
    * @param string[] $freeResourceIds |参数名称：免费资源ID列表，每个最大64字节| |参数约束以及描述：免费资源ID列表，每个最大64字节|
    *
    * @return $this
    */
