...
class DiscountSimpleInfoV3 implements ModelInterface, ArrayAccess
{
    ...
    * id  折扣ID。
    * type  折扣类型。取值为 0：促销折扣 2：商务优惠 3：合作伙伴授予折扣 609：订单调价折扣 说明： 订单支付时，如果包含609折扣（订单调价折扣），则必须使用，不能再更换折扣类型。
    *
    * @var string[]
    */
    ...
    * Sets type
    *
    * @param int $type 折扣类型。取值为 0：促销折扣 2：商务优惠 3：合作伙伴授予折扣 609：订单调价折扣 说明： 订单支付时，如果包含609折扣（订单调价折扣），则必须使用，不能再更换折扣类型。
    *
    * @return $this
    */
