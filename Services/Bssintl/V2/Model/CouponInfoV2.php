...
class CouponInfoV2 implements ModelInterface, ArrayAccess
{
    ...
    * status  |参数名称：优惠券状态：2：待使用。| |参数的约束及描述：优惠券状态：2：待使用。|
    * couponType  |参数名称：优惠券类型：301：代金券；302：现金券。| |参数的约束及描述：优惠券类型：301：代金券；302：现金券。|
    * measureId  |参数名称：面额单位：1：元。| |参数的约束及描述：面额单位：1：元。|
    * faceValue  |参数名称：优惠券金额。| |参数的约束及描述：优惠券金额。|
    * effectiveTime  |参数名称：生效时间。UTC时间，格式：yyyy-MM-dTHH:mm:ssZ，如2019-05-06T08:05:01Z。| |参数约束及描述：生效时间。UTC时间，格式：yyyy-MM-dTHH:mm:ssZ，如2019-05-06T08:05:01Z。|
    * expireTime  |参数名称：失效时间。UTC时间，格式：yyyy-MM-ddTHH:mm:ssZ，如2019-05-06T08:05:01Z。| |参数约束及描述：失效时间。UTC时间，格式：yyyy-MM-ddTHH:mm:ssZ，如2019-05-06T08:05:01Z。|
    * planName  |参数名称：促销计划名称。| |参数约束及描述：促销计划名称。|
    * planDesc  |参数名称：促销计划描述。| |参数约束及描述：促销计划描述。|
    * useLimits  |参数名称：优惠券限制。具体请参见表 LimitInfo。| |参数约束以及描述：优惠券限制。具体请参见表 LimitInfo。|
    * activeTime  |参数名称：激活时间。UTC时间，格式：yyyy-MM-ddTHH:mm:ssZ，如2019-05-06T08:05:01Z。| |参数约束及描述：激活时间。UTC时间，格式：yyyy-MM-ddTHH:mm:ssZ，如2019-05-06T08:05:01Z。|
    * lastUsedTime  |参数名称：上一次使用时间。UTC时间，格式：yyyy-MM-ddTHH:mm:ssZ，如2019-05-06T08:05:01Z。| |参数约束及描述：上一次使用时间。UTC时间，格式：yyyy-MM-ddTHH:mm:ssZ，如2019-05-06T08:05:01Z。|
    * createTime  |参数名称：创建时间。UTC时间，格式：yyyy-MM-ddTHH:mm:ssZ，如2019-05-06T08:05:01Z。| |参数约束及描述：创建时间。UTC时间，格式：yyyy-MM-ddTHH:mm:ssZ，如2019-05-06T08:05:01Z。|
    * couponVersion  |参数名称：优惠券版本。1：老版本（原本分为三种：代金券/折扣券/奖金券）；2：新版本（只有代金券）。| |参数的约束及描述：优惠券版本。1：老版本（原本分为三种：代金券/折扣券/奖金券）；2：新版本（只有代金券）。|
    * balance  |参数名称：余额。| |参数约束及描述： 余额。|
    * usedByOrderId  |参数名称：使用优惠券的订单ID，表示正在有另外一张订单正在使用这个优惠券。正在锁定的时候，只有锁定优惠券的订单才能使用这个优惠券，其他订单不能使用该优惠券。| |参数约束及描述：使用优惠券的订单ID，表示正在有另外一张订单正在使用这个优惠券。正在锁定的时候，只有锁定优惠券的订单才能使用这个优惠券，其他订单不能使用该优惠券。|
    * couponUsage  |参数名称：优惠券用途。| |参数约束及描述：优惠券用途。|
    * couponGroup  |参数名称：代金券分组| |参数的约束及描述：1-云市场发放的券，2-华为云券-1024-专用代金券，3-华为云券-使用限制-抵扣硬件的券，0-华为云服务券（排除上述取值之外的券）|
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            ...
            'planName' => 'string',
            'planDesc' => 'string',
            'useLimits' => '\HuaweiCloud\SDK\Bssintl\V2\Model\LimitInfoV2[]',
            'activeTime' => 'string',
            'lastUsedTime' => 'string',
            'createTime' => 'string',
            'couponVersion' => 'int',
    ...
    * Sets status
    *
    * @param int|null $status |参数名称：优惠券状态：2：待使用。| |参数的约束及描述：优惠券状态：2：待使用。|
    *
    * @return $this
    */
    ...
    * Sets couponType
    *
    * @param int|null $couponType |参数名称：优惠券类型：301：代金券；302：现金券。| |参数的约束及描述：优惠券类型：301：代金券；302：现金券。|
    *
    * @return $this
    */
    ...
    * Sets measureId
    *
    * @param int|null $measureId |参数名称：面额单位：1：元。| |参数的约束及描述：面额单位：1：元。|
    *
    * @return $this
    */
    ...
    * Sets effectiveTime
    *
    * @param string|null $effectiveTime |参数名称：生效时间。UTC时间，格式：yyyy-MM-dTHH:mm:ssZ，如2019-05-06T08:05:01Z。| |参数约束及描述：生效时间。UTC时间，格式：yyyy-MM-dTHH:mm:ssZ，如2019-05-06T08:05:01Z。|
    *
    * @return $this
    */
    ...
    * Sets expireTime
    *
    * @param string|null $expireTime |参数名称：失效时间。UTC时间，格式：yyyy-MM-ddTHH:mm:ssZ，如2019-05-06T08:05:01Z。| |参数约束及描述：失效时间。UTC时间，格式：yyyy-MM-ddTHH:mm:ssZ，如2019-05-06T08:05:01Z。|
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\Bssintl\V2\Model\LimitInfoV2[]|null
    */
    ...
    * Sets useLimits
    *
    * @param \HuaweiCloud\SDK\Bssintl\V2\Model\LimitInfoV2[]|null $useLimits |参数名称：优惠券限制。具体请参见表 LimitInfo。| |参数约束以及描述：优惠券限制。具体请参见表 LimitInfo。|
    *
    * @return $this
    */
    ...
    * Sets activeTime
    *
    * @param string|null $activeTime |参数名称：激活时间。UTC时间，格式：yyyy-MM-ddTHH:mm:ssZ，如2019-05-06T08:05:01Z。| |参数约束及描述：激活时间。UTC时间，格式：yyyy-MM-ddTHH:mm:ssZ，如2019-05-06T08:05:01Z。|
    *
    * @return $this
    */
    ...
    * Sets lastUsedTime
    *
    * @param string|null $lastUsedTime |参数名称：上一次使用时间。UTC时间，格式：yyyy-MM-ddTHH:mm:ssZ，如2019-05-06T08:05:01Z。| |参数约束及描述：上一次使用时间。UTC时间，格式：yyyy-MM-ddTHH:mm:ssZ，如2019-05-06T08:05:01Z。|
    *
    * @return $this
    */
    ...
    * Sets createTime
    *
    * @param string|null $createTime |参数名称：创建时间。UTC时间，格式：yyyy-MM-ddTHH:mm:ssZ，如2019-05-06T08:05:01Z。| |参数约束及描述：创建时间。UTC时间，格式：yyyy-MM-ddTHH:mm:ssZ，如2019-05-06T08:05:01Z。|
    *
    * @return $this
    */
    ...
    * Sets couponVersion
    *
    * @param int|null $couponVersion |参数名称：优惠券版本。1：老版本（原本分为三种：代金券/折扣券/奖金券）；2：新版本（只有代金券）。| |参数的约束及描述：优惠券版本。1：老版本（原本分为三种：代金券/折扣券/奖金券）；2：新版本（只有代金券）。|
    *
    * @return $this
    */
    ...
    * Sets balance
    *
    * @param double|null $balance |参数名称：余额。| |参数约束及描述： 余额。|
    *
    * @return $this
    */
    ...
    * Sets usedByOrderId
    *
    * @param string|null $usedByOrderId |参数名称：使用优惠券的订单ID，表示正在有另外一张订单正在使用这个优惠券。正在锁定的时候，只有锁定优惠券的订单才能使用这个优惠券，其他订单不能使用该优惠券。| |参数约束及描述：使用优惠券的订单ID，表示正在有另外一张订单正在使用这个优惠券。正在锁定的时候，只有锁定优惠券的订单才能使用这个优惠券，其他订单不能使用该优惠券。|
    *
    * @return $this
    */
    ...
    * Sets couponGroup
    *
    * @param int|null $couponGroup |参数名称：代金券分组| |参数的约束及描述：1-云市场发放的券，2-华为云券-1024-专用代金券，3-华为云券-使用限制-抵扣硬件的券，0-华为云服务券（排除上述取值之外的券）|
    *
    * @return $this
    */
