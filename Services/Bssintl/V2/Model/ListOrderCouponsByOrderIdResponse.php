...
class ListOrderCouponsByOrderIdResponse implements ModelInterface, ArrayAccess
{
    ...
    * count  |参数名称：符合条件的记录总数。| |参数的约束及描述：符合条件的记录总数。|
    * userCoupons  |参数名称：客户订单详情信息。具体请参见表 CustomerOrderV2| |参数约束以及描述：客户订单详情信息。具体请参见表 CustomerOrderV2|
    * couponMaxUseQuantity  |参数名称：代金券使用的最大数量。具体请参见表 CouponMaxUseQuantity| |参数约束以及描述：代金券使用的最大数量。具体请参见表 CouponMaxUseQuantity|
    *
    * @var string[]
    */
    protected static $openAPITypes = [
            'count' => 'int',
            'userCoupons' => '\HuaweiCloud\SDK\Bssintl\V2\Model\CouponInfoV2[]',
            'couponMaxUseQuantity' => '\HuaweiCloud\SDK\Bssintl\V2\Model\CouponMaxUseQuantity[]'
    ];
    ...
    * Sets count
    *
    * @param int|null $count |参数名称：符合条件的记录总数。| |参数的约束及描述：符合条件的记录总数。|
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\Bssintl\V2\Model\CouponInfoV2[]|null
    */
    ...
    * Sets userCoupons
    *
    * @param \HuaweiCloud\SDK\Bssintl\V2\Model\CouponInfoV2[]|null $userCoupons |参数名称：客户订单详情信息。具体请参见表 CustomerOrderV2| |参数约束以及描述：客户订单详情信息。具体请参见表 CustomerOrderV2|
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\Bssintl\V2\Model\CouponMaxUseQuantity[]|null
    */
    ...
    *
    * @param \HuaweiCloud\SDK\Bssintl\V2\Model\CouponMaxUseQuantity[]|null $couponMaxUseQuantity |参数名称：代金券使用的最大数量。具体请参见表 CouponMaxUseQuantity| |参数约束以及描述：代金券使用的最大数量。具体请参见表 CouponMaxUseQuantity|
    *
    * @return $this
    */
