...
class UnfreezeSubCustomersReq implements ModelInterface, ArrayAccess
{
    ...
    * customerIds  |参数名称：需要解冻的客户ID列表。| |参数约束以及描述：需要解冻的客户ID列表。|
    * reason  |参数名称：解冻原因。| |参数约束及描述：解冻原因。|
    *
    * @var string[]
    */
    ...
    * Sets customerIds
    *
    * @param string[] $customerIds |参数名称：需要解冻的客户ID列表。| |参数约束以及描述：需要解冻的客户ID列表。|
    *
    * @return $this
    */
    ...
    * Sets reason
    *
    * @param string $reason |参数名称：解冻原因。| |参数约束及描述：解冻原因。|
    *
    * @return $this
    */
