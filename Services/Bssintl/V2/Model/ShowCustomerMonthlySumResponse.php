...
class ShowCustomerMonthlySumResponse implements ModelInterface, ArrayAccess
{
    ...
    * totalCount  |参数名称：总条数，必须大于等于0。| |参数的约束及描述：总条数，必须大于等于0。|
    * billSums  |参数名称：账单记录，具体参考表 BillSumRecordInfo。| |参数约束以及描述：账单记录，具体参考表 BillSumRecordInfo。|
    * consumeAmount  |参数名称：总金额（包含退订）。| |参数的约束及描述：总金额（包含退订）。|
    * debtAmount  |参数名称：总欠费金额。| |参数的约束及描述：总欠费金额。|
    ...
    */
    protected static $openAPITypes = [
            'totalCount' => 'int',
            'billSums' => '\HuaweiCloud\SDK\Bssintl\V2\Model\BillSumRecordInfoV2[]',
            'consumeAmount' => 'float',
            'debtAmount' => 'float',
            'couponAmount' => 'float',
    ...
    * Sets totalCount
    *
    * @param int|null $totalCount |参数名称：总条数，必须大于等于0。| |参数的约束及描述：总条数，必须大于等于0。|
    *
    * @return $this
    */
    ...
    *
    * @return \HuaweiCloud\SDK\Bssintl\V2\Model\BillSumRecordInfoV2[]|null
    */
    ...
    * Sets billSums
    *
    * @param \HuaweiCloud\SDK\Bssintl\V2\Model\BillSumRecordInfoV2[]|null $billSums |参数名称：账单记录，具体参考表 BillSumRecordInfo。| |参数约束以及描述：账单记录，具体参考表 BillSumRecordInfo。|
    *
    * @return $this
    */
    ...
    * Sets consumeAmount
    *
    * @param float|null $consumeAmount |参数名称：总金额（包含退订）。| |参数的约束及描述：总金额（包含退订）。|
    *
    * @return $this
    */
    ...
    * Sets debtAmount
    *
    * @param float|null $debtAmount |参数名称：总欠费金额。| |参数的约束及描述：总欠费金额。|
    *
    * @return $this
    */
