...
class BssintlClient extends Client
{
    ...
    {
        $client = new ClientBuilder(new BssintlClient(), "GlobalCredentials");
        return $client;
    }
     ...
     * @return response
     */
    public function listResourceSpecsPrice($request)
    {
        return $this->listResourceSpecsPriceWithHttpInfo($request);
    }

    public function listResourceSpecsPriceWithHttpInfo($request)
    {
        $resourcePath = '/v2/products/resource-specs-price/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $pathParams = [];
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Bssintl\V2\Model\ListResourceSpecsPriceResponse',
            $requestType='\HuaweiCloud\SDK\Bssintl\V2\Model\ListResourceSpecsPriceRequest');
    }
     ...
     * @return response
     */
    public function listSubCustomerBudgetRecords($request)
    {
        return $this->listSubCustomerBudgetRecordsWithHttpInfo($request);
    }

    public function listSubCustomerBudgetRecordsWithHttpInfo($request)
    {
    ...
    public function setResourcesRenewConfigWithHttpInfo($request)
    {
        ...
        return $this->callApi(
            ...
            $multipart = $multipart,
            $postParams=$formParams,
            $responseType='\HuaweiCloud\SDK\Bssintl\V2\Model\SetResourcesRenewConfigResponse',
            $requestType='\HuaweiCloud\SDK\Bssintl\V2\Model\SetResourcesRenewConfigRequest');
    }
     ...
     * @return response
     */
    public function showCustomerExpenditureQuota($request)
    {
        return $this->showCustomerExpenditureQuotaWithHttpInfo($request);
    }

    public function showCustomerExpenditureQuotaWithHttpInfo($request)
    {
